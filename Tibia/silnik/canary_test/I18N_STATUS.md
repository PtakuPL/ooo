...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.04% / real 10.97%**. Tempo: **670.0 kluczy/h**. Tłumaczeń netto: **148,172**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 13:05:20

> **Aktualizacja:** 2026-04-29 13:05:20 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,436 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: it | Plik: items.json | Heartbeat: 2026-04-29T13:02:40Z
> **Okno godzinowe:** okno=1.0h | cykli=80 | pominięte=0.0% | odrzucone=6.7% | przepustowość=670.0/h  
> **Tłumaczeń netto:** 148,172

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 13:05:20 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T13:02:40Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 16s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 13:05:20 |
| TRANSLATION | 🟢 AKTYWNY | 50s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T13:04:39.096884Z |
| QUALITY | 🔒 NIEAKTYWNY | 3min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T13:02:27.428552Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 13:05:20 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T13:05:29.574895Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T13:02:40Z
...
| 🔄 **Ostatni cykl** | 30 kluczy, 1 odrzuconych, 99.0s, tryb: AUTO_TRANSLATE, cel: it/items.json |
| ❤️ **Heartbeat** | 2026-04-29T13:02:40Z |
...
| ⏳ Oldest pending (visible tail) | 17169 s |
...
| 🌍 Recent provider mix | TM/simple(302), Free Google Translate(174), canonical_name_semantic_autofix(17), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=496, fallbacks=24) |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 395, 'oldest_s': 17169}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~185 dni (2,982,709 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 79.2% | 59,024/74,536 | ~18h |
...
> Tempo obliczone na bazie ostatniej godziny: ~670 kluczy/h.
...
> Świeżość: 16s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 13:05:20
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 50s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T13:04:39.096884Z
...
- ornamented wall → muro ornato (item.1428.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14280.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14281.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14282.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14283.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14284.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14285.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14286.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14287.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14288.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14289.name)
- ornamented wall → muro ornato (item.1429.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14290.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14291.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14292.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14293.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14294.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14295.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14296.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14297.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4957**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4810**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T13:02:59.987500Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.04%** (699,359/3,875,872)
- **Pokrycie globalne (real):** **10.97%** (425,074/3,875,872)
- **Kopie EN (łącznie):** **410,372**
- **Placeholdery [EN]/puste (łącznie):** **2,186,304**
...
| 🕒 Evidence window | 24h (span=42.22h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=42.22h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T12:05:21.257839Z → 2026-04-29T13:05:21.257839Z) |
...
| Przepustowość (kluczy/h) | **670.0 kluczy/h** |
| Podejrzane tłumaczenia | **1046** |
| Najgorsze cele (strażnik) | cs/items.json (gf=26), ro/items.json (gf=12), ru/items.json (gf=3), it/items.json (gf=3), de/otclient_modules.json (gf=2) |
...
> Świeżość: 3min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T13:02:27.428552Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T13:02:27.428552Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=748489), ro(60.1, issues=443095), de(60.1, issues=125674), cs(60.1, issues=115926), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 748489 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 78%, 178295 problemów
⚠️ **RU**: jakość 62%, 372937 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,436 |
| Heartbeat | 169s temu | 2026-04-29T13:02:40Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T13:04:56.306549Z
...
- 2026-04-29 13:04:56 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-29 13:04:39 | AUTO_TRANSLATE:auto_done | it | ok | items.json
- 2026-04-29 13:04:31 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-04-29 13:03:01 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-04-29 13:03:00 | AUTO_TRANSLATE:auto_start | it | ok | items.json
- 2026-04-29 13:02:26 | AUTO_TRANSLATE:auto_done | ro | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **148,172** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=7.56%, reason=stable_fail_rate=7.6%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 13:05:20

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+30, skipped+0) — lang=it file=items.json strict_skipped_done=3954 guard_fail=1 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **10,874** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 211 |
| ❌ Błędów | 476 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,894), **RU** (1,749), **TR** (1,670), **IT** (1,603), **DE** (1,530) |
| 📊 Porównanie | ↑ 32.2% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **29,854** kluczy
...
| 🔄 Cykli wykonanych | **#18,436** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,436 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 13:05:20  
