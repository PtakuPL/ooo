...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.87% / real 10.79%**. Tempo: **751.0 kluczy/h**. Tłumaczeń netto: **136,318**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-28 21:40:46

> **Aktualizacja:** 2026-04-28 21:40:46 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,152 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: tr | Plik: items.json | Heartbeat: 2026-04-28T21:39:36Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=3.8% | przepustowość=751.0/h  
> **Tłumaczeń netto:** 136,318

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-28 21:40:46 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-28T21:39:36Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 58s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-28 21:40:46 |
| TRANSLATION | 🟢 AKTYWNY | 4min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-28T21:35:59.253497Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-28T21:39:36.367647Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-28 21:40:46 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-28T21:40:52.585169Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-28T21:39:36Z
...
| ❤️ **Heartbeat** | 2026-04-28T21:39:36Z |
...
| ⏳ Oldest pending (visible tail) | 20031 s |
...
| 🌍 Recent provider mix | TM/simple(315), Free Google Translate(176), OpenAI model pool(32), canonical_name_semantic_autofix(14), ter... |
...
| ❤️ Pool health | `critical` (writes=540, fallbacks=18) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=330/330 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 388, 'oldest_s': 20031}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~166 dni (2,989,270 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 78.5% | 58,541/74,536 | ~16h |
| PL | ██████████████░░░░░░ | 71.0% | 52,911/74,536 | ~24h |
| IT | █████████████░░░░░░░ | 68.7% | 51,232/74,536 | ~26h |
| RO | █████████████░░░░░░░ | 69.6% | 51,874/74,536 | ~25h |
| RU | █████████░░░░░░░░░░░ | 45.1% | 33,616/74,536 | ~2d |
| FR | ███████████░░░░░░░░░ | 57.5% | 42,864/74,536 | ~37h |
| PT | ████████████████░░░░ | 81.2% | 60,516/74,536 | ~14h |
| SR | ██████░░░░░░░░░░░░░░ | 33.3% | 24,827/74,536 | ~3d |
| NL | ███████████████░░░░░ | 77.6% | 57,814/74,536 | ~17h |
| CS | █████████░░░░░░░░░░░ | 49.0% | 36,523/74,536 | ~46h |
| TR | ██████░░░░░░░░░░░░░░ | 32.8% | 24,430/74,536 | ~3d |
...
> Tempo obliczone na bazie ostatniej godziny: ~751 kluczy/h.
...
> Świeżość: 58s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-28 21:40:46
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 4min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-28T21:35:59.253497Z
...
- Where do you want to go today? We serve the routes to Senja, {Folda} and {Vega}  → ¿A dónde quieres ir hoy? Ofrecemos rutas a Senja, {Folda} y {Vega} y de regreso  (npc.anderson.stdmod_5)
- I am so angry I could spit grit! That damn {Horned Fox} and his attacks! Let's s → ¡Estoy tan enojado que podría escupir arena! ¡Ese maldito {Horned Fox} y sus ata (npc.budrik.say_15)
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-28T21:40:07.015200Z |
...
| 🕒 Evidence window | 24h (span=26.81h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=26.81h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-28T20:40:47.627908Z → 2026-04-28T21:40:47.627908Z) |
...
| Przepustowość (kluczy/h) | **751.0 kluczy/h** |
| Podejrzane tłumaczenia | **1084** |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-28T21:39:36.367647Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-28T21:39:36.367647Z
- **Top 5 typów problemów:** suspicious_rejected_critical=197, suspicious_log_medium=92, suspicious_log_high=54, suspicious_log_low=52, suspicious_rejected_high=3
- **Języki o najsłabszej jakości:** es(60.1, issues=722437), ro(60.1, issues=421578), ru(60.1, issues=355420), de(60.1, issues=104838), cs(60.1, issues=78985)
- **Pliki:** `i18n/status/quality_audit_latest.json`, `i18n/status/quality_dashboard.json`, `i18n/status/quality_report.jsonl`

### 📈 Statystyki Pracy
| Metryka | Wartość | Info |
|---------|---------|------|
| 🔄 Cykl aktualny | **#78** | od uruchomienia |
...
⚠️ **ES**: jakość 60%, 722437 problemów
⚠️ **PT**: jakość 67%, 57331 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 65%, 166907 problemów
⚠️ **RU**: jakość 60%, 355420 problemów
⚠️ **NL**: jakość 60%, 72019 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,152 |
| Heartbeat | 76s temu | 2026-04-28T21:39:36Z |
...
- 2026-04-28 21:40:08 | AUTO_TRANSLATE:auto_start | tr | ok | items.json
- 2026-04-28 21:39:19 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **136,318** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=3.39%, reason=increase_low_fail_rate=3.4%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-28 21:40:46
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [cs] → warn (files+1, translated+192, skipped+0) — lang=cs file=items.json strict_skipped_done=7239 guard_fail=55 placeholder=0 command=0 pipe=0
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+1) — repair_identical lang=es file=quests.json target_identical=1 limit=180 tier=low_backlog domain_cap=180 gt=true suspicious_pct=100.00
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+15, skipped+0) — lang=pl file=otclient_modules.json strict_skipped_done=2031
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [fr] → warn (files+1, translated+183, skipped+0) — lang=fr file=monsters.json strict_skipped_done=5630 guard_fail=58 placeholder=0 command=0 pipe=0
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [tr] → warn (files+1, translated+342, skipped+0) — lang=tr file=npc.json strict_skipped_done=1619 guard_fail=89 placeholder=18 command=0 pipe=0
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [nl] → warn (files+1, translated+66, skipped+0) — lang=nl file=npc.json strict_skipped_done=642 guard_fail=6 placeholder=6 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **6,190** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 77 |
| ❌ Błędów | 246 |
| 🌍 Aktywnych języków | 9 |
| 🏆 TOP 5 | **DE** (1,092), **RU** (932), **IT** (744), **RO** (637), **TR** (637) |
| 📊 Porównanie | ↑ 19.3% vs wczoraj (5,188) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **29,050** kluczy
...
| 🔄 Cykli wykonanych | **#17,152** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,152 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-28 21:40:46  
