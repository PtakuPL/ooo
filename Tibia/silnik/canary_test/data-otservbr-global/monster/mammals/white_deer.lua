...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "*bell*", yell = false , i18nKey = "monster.white_deer.voice_1"},
	{ text = "ROOOAAARR!!", yell = true , i18nKey = "monster.white_deer.voice_2"},
	{ text = "*sniff*", yell = false , i18nKey = "monster.white_deer.voice_3"},
	{ text = "*wheeze*", yell = false , i18nKey = "monster.white_deer.voice_4"},
}
