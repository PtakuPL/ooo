...
local charms = {
    ...
    [charmRune_t.CHARM_CRIPPLE] = {
        ...
        type = charm_t.CHARM_OFFENSIVE,
        chance = {6, 9, 12},
        messageCancel = tr("You crippled a monster. (cripple charm)"),
        points = {100, 150, 225}
    },
    [charmRune_t.CHARM_PARRY] = {
        ...
        chance = {5, 10, 11},
        messageCancel = tr("You parried an attack. (parry charm)"),
        points = {400, 600, 2000}
    },
    [charmRune_t.CHARM_DODGE] = {
        ...
        type = charm_t.CHARM_DEFENSIVE,
        chance = {5, 10, 11},
        messageCancel = tr("You dodged an attack. (dodge charm)"),
        points = {240, 360, 1200}
    },
    [charmRune_t.CHARM_ADRENALINE] = {
        ...
        type = charm_t.CHARM_DEFENSIVE,
        chance = {6, 9, 12},
        messageCancel = tr("Your movements where bursted. (adrenaline burst charm)"),
        points = {100, 150, 225}
    },
    [charmRune_t.CHARM_NUMB] = {
        ...
        type = charm_t.CHARM_DEFENSIVE,
        chance = {6, 9, 12},
        messageCancel = tr("You numbed a monster. (numb charm)"),
        points = {100, 150, 225}
    },
    [charmRune_t.CHARM_CLEANSE] = {
        ...
        type = charm_t.CHARM_DEFENSIVE,
        chance = {6, 9, 12},
        messageCancel = tr("You purified an attack. (cleanse charm)"),
        points = {100, 150, 225}
    },
    ...
    [charmRune_t.CHARM_FATAL] = {
        ...
        type = charm_t.CHARM_PASSIVE,
        chance = {30, 45, 60},
        messageCancel = tr("Your enemy is not able to flee now for 30 seconds. (fatal hold charm)"),
        points = {100, 150, 225}
    },
