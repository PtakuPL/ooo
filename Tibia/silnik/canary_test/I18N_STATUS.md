...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **18.99%**. Tempo: **2882.0 kluczy/h**. Tłumaczeń netto: **65,358**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-23 16:38:32

> **Aktualizacja:** 2026-03-23 16:38:32 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **LIVE:** Cykl #10,853 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: cs | Plik: server.json | Heartbeat: 2026-03-23T16:37:30Z  
> **Okno godzinowe:** okno=1.0h | cykli=76 | pominięte=0.0% | odrzucone=11.6% | przepustowość=2882.0/h  
> **Tłumaczeń netto:** 65,358

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-23 16:38:32 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-03-23T16:37:30Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 22s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-23 16:38:32 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-23T16:37:15.721077Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-23T16:37:16.651037Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-23 16:38:32 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-23T16:37:30Z
...
| ❤️ **Heartbeat** | 2026-03-23T16:37:30Z |
...
| PT | 52,527 | 74,536 | 70.47% ↑+0.07% | 59,494 |
...
> **ETA globalne:** ~43 dni (2,945,885 kluczy do celu 95%)
...
| PT | ██████████████░░░░░░ | 70.5% | 52,527/74,536 | ~6h |
| CS | █████████████░░░░░░░ | 68.4% | 50,992/74,536 | ~7h |
| NL | █████████████░░░░░░░ | 68.2% | 50,874/74,536 | ~7h |
| DE | █████████████░░░░░░░ | 66.4% | 49,499/74,536 | ~7h |
| SR | ██████░░░░░░░░░░░░░░ | 33.3% | 24,827/74,536 | ~16h |
| TR | ███░░░░░░░░░░░░░░░░░ | 16.8% | 12,539/74,536 | ~20h |
...
> Tempo obliczone na bazie ostatniej godziny: ~2882 kluczy/h.
...
> Świeżość: 22s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-23 16:38:32
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-23T16:37:15.721077Z
...
| PT (Portugalski) | 52,527/74,536 | 70.47% | 59,494 | 64 |
...
- Hello and welcome in the Gnomprona Gardens → Hallo en welkom in de Gnomprona-tuinen (data.otservbr.global.npc.gnomish.operative.raiders.L56.246)
- Hello and welcome in the Gnomprona Gardens → Hallo en welkom in de Gnomprona-tuinen (data.otservbr.global.npc.gnomish.operative.resonating.L56.174)
- Hello and welcome in the Gnomprona Gardens → Hallo en welkom in de Gnomprona-tuinen (data.otservbr.global.npc.gnomish.operative.volcano.L56.1367)
- Hello |PLAYERNAME|. You are probably eager to enter the {warzones}. → Hallo |PLAYERNAME|. U staat waarschijnlijk te popelen om de {warzones} binnen te (data.otservbr.global.npc.gnomission.L161.4)
- Hi there! Welcome to the spike. → Hoi! Welkom bij de piek. (data.otservbr.global.npc.gnommander.L174.870)
- Hi there! I'm ready to brief you with {tactical} advice. → Hoi! Ik ben klaar om u te informeren met {tactical} advies. (data.otservbr.global.npc.gnomole.L77.803)
- Good bye and take care! → Tot ziens en wees voorzichtig! (data.otservbr.global.npc.gnomole.L78.804)
- You earned → Je hebt verdiend (data.otservbr.global.npc.gnomus.L262.1013)
- You earned → Je hebt verdiend (data.otservbr.global.npc.gnomus.L275.1014)
- You earned → Je hebt verdiend (data.otservbr.global.npc.gnomus.L288.1015)
- Greetings, member of the Bigfoot Brigade. We could really use some {help} from y → Gegroet, lid van de Bigfoot Brigade. We kunnen nu wel wat {help} van je gebruike (data.otservbr.global.npc.gnomus.L335.1016)
- Oh, please come in, |PLAYERNAME|. What do you need? → Oh, kom alsjeblieft binnen, |PLAYERNAME|. Wat heb je nodig? (data.otservbr.global.npc.gorn.L109.58)
- Ahoi, young man |PLAYERNAME|. Looking for work on my ship? → Ahoi, jongeman |PLAYERNAME|. Op zoek naar werk op mijn schip? (data.otservbr.global.npc.graubart.L65.179)
- Greetings, |PLAYERNAME|. What do you want? → Gegroet, |PLAYERNAME|. Wat wil je? (data.otservbr.global.npc.gregor.L347.159)
- Be careful on your journeys. → Wees voorzichtig tijdens uw reizen. (data.otservbr.global.npc.gregor.L348.160)
- Be careful on your journeys. → Wees voorzichtig tijdens uw reizen. (data.otservbr.global.npc.gregor.L349.161)
- Good to see you again |PLAYERNAME|. You gained → Fijn je weer te zien |PLAYERNAME|. Jij hebt gewonnen (data.otservbr.global.npc.grizzly.adams.L144.90)
- Happy hunting, old chap! → Veel jachtplezier, oude kerel! (data.otservbr.global.npc.grizzly.adams.L948.92)
- STOP RIGHT THERE!..... Oh, just a human. What's up big guy? → STOP DAAR!... Oh, maar een mens. Hoe gaat het grote kerel? (data.otservbr.global.npc.grombur.L93.1129)
- Welcome to Carlin, |PLAYERNAME| Would you like some information and a map guide? → Welkom bij Carlin, |PLAYERNAME| Wilt u informatie en een kaartgids? (data.otservbr.global.npc.guide.alexena.L104.1375)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **3088**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2946**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **18.99%** (736,183/3,875,872)
- **Kopie EN (łącznie):** **590,915**
...
| PT | 51,252/70,637 | 72.6% | 1,275/3,899 | 32.7% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-23T15:38:32.993331Z → 2026-03-23T16:38:32.993331Z) |
...
| Przepustowość (kluczy/h) | **2882.0 kluczy/h** |
| Podejrzane tłumaczenia | **1167** |
| Najgorsze cele (strażnik) | nl/monsters.json (gf=70), cs/monsters.json (gf=69), pt/monsters.json (gf=67), tr/monsters.json (gf=49), pt/server.json (gf=25) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-23T16:37:16.651037Z

- **Ostatni audyt:** OK | 1 issue(s) / 100 entries | 2026-03-23T16:37:16.651037Z
- **Top 5 typów problemów:** suspicious_rejected_critical=187, suspicious_log_high=129, suspicious_log_medium=60, suspicious_rejected_high=13, suspicious_log_low=11
- **Języki o najsłabszej jakości:** es(60.1, issues=631675), nl(60.1, issues=15914), cs(60.1, issues=15210), tr(60.1, issues=8282), de(64.4, issues=68539)
...
⚠️ **TR**: jakość 60%, 8282 problemów
⚠️ **PL**: jakość 91%, 330767 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 631675 problemów
⚠️ **PT**: jakość 74%, 23217 problemów
⚠️ **FR**: jakość 86%, 20511 problemów
⚠️ **IT**: jakość 84%, 115327 problemów
⚠️ **RU**: jakość 72%, 297785 problemów
⚠️ **NL**: jakość 60%, 15914 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #10,853 |
| Heartbeat | 64s temu | 2026-03-23T16:37:30Z |
...
- **TOP 5 języków:** DE (23,700), NL (22,524), CS (22,146), PT (20,830), FR (17,809)
- **Aktualnie naprawia:** ES / -
- **Ostatnia aktualizacja:** 2026-03-23T16:35:18.189218Z
...
- 2026-03-23 16:37:30 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | server.json
- 2026-03-23 16:37:29 | AUTO_TRANSLATE:auto_start | cs | ok | server.json
- 2026-03-23 16:37:16 | AUTO_TRANSLATE:auto_done | nl | ok | server.json
- 2026-03-23 16:37:14 | AUTO_TRANSLATE:heartbeat_tick | nl | ok | server.json
- 2026-03-23 16:35:43 | AUTO_TRANSLATE:heartbeat_tick | nl | ok | server.json
- 2026-03-23 16:35:43 | AUTO_TRANSLATE:auto_start | nl | ok | server.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 77.4% | 13,769 | 12,449 | 900 | 353 (28.2%) | 25 |
| 🟡 ES | 94.1% | 2,385 | 24,045 | 877 | 497 (36.2%) | 26 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **65,358** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=10.76%, reason=stable_fail_rate=10.8% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,777 kluczy / 51 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-23 16:38:32
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **42,160** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 174 |
| ❌ Błędów | 632 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **ES** (11,696), **TR** (7,538), **RO** (5,711), **PL** (3,031), **FR** (2,956) |
| 📊 Porównanie | ↑ 103.4% vs wczoraj (20,729) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **62,889** kluczy
...
| 🔄 Cykli wykonanych | **#10,853** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #10,853 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-23 16:38:32  
