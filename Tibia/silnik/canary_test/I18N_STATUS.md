...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.69%**. Tempo: **2066.8 kluczy/h**. Tłumaczeń netto: **101,031**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-17 06:22:56

> **Aktualizacja:** 2026-02-17 06:22:56 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #316 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ro | Plik: npc.json | Heartbeat: 2026-02-17T06:22:34Z  
> **Okno godzinowe:** okno=1.0h | cykli=160 | pominięte=0.0% | odrzucone=46.8% | przepustowość=2066.8/h  
> **Tłumaczeń netto:** 101,031

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-17 06:22:56 |
| LIVE | 🟢 AKTYWNY | 24s temu | - | `activity.json / worker_state.json` | 2026-02-17T06:22:34Z |
| MIGRATION | 🔒 NIEAKTYWNY | 40s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-17 06:22:56 |
| TRANSLATION | 🟢 AKTYWNY | 20s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-17T06:22:37.736437Z |
| QUALITY | 🔒 NIEAKTYWNY | 19s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-17T06:22:38.546223Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-17 06:22:56 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 24s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-17T06:22:34Z
...
| ❤️ **Heartbeat** | 2026-02-17T06:22:34Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **3,716** kluczy |
| ❌ Odrzucone (guard) | 3275 |
| 🔁 Cykli | 160 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (840 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~2067 kluczy/h |
| 🛡️ Guard fail rate | 46.8% |
| ⚠️ Podejrzane | 10918 |
...
| RO | 14,013 | 53,586 | 26.15% | 2,396 |
| IT | 9,234 | 53,586 | 17.23% | 2,427 |
...
> **ETA globalne:** ~47 dni (2,349,335 kluczy do celu 95%)
...
| RO | █████░░░░░░░░░░░░░░░ | 26.1% | 14,013/53,586 | ~18h |
| IT | ███░░░░░░░░░░░░░░░░░ | 17.2% | 9,234/53,586 | ~20h |
| ZH_TW | ██░░░░░░░░░░░░░░░░░░ | 14.5% | 7,776/53,586 | ~21h |
| SR | ██░░░░░░░░░░░░░░░░░░ | 12.1% | 6,500/53,586 | ~21h |
| SV | █░░░░░░░░░░░░░░░░░░░ | 9.9% | 5,302/53,586 | ~22h |
...
> Tempo obliczone na bazie ostatniej godziny: ~2067 kluczy/h.
...
> Świeżość: 40s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-17 06:22:56
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 20s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-17T06:22:37.736437Z
...
| RO (Rumuński) | 14,013/53,586 | 26.15% | 2,396 | 0 |
| IT (Włoski) | 9,234/53,586 | 17.23% | 2,427 | 0 |
...
- Well, can I help you with something else? → Ei bine, te pot ajuta cu altceva? (npc.paulie.say_39)
- There is not enough gold on your account. → Nu există suficient aur în contul tău. (npc.plunderpurse.say_17)
- The customer is king! Come back anytime you want to if you wish to {withdraw} yo → Clientul este rege! Reveniți oricând doriți dacă doriți să vă {withdraw} banii. (npc.plunderpurse.say_18)
- How many platinum coins would you like to get? → Câte monede de platină ai vrea să obții? (npc.plunderpurse.say_19)
- Sorry, you do not have enough gold coins. → Ne pare rău, nu aveți suficiente monede de aur. (npc.plunderpurse.say_20)
- Sorry, you do not have enough gold coins. → Ne pare rău, nu aveți suficiente monede de aur. (npc.plunderpurse.say_22)
- Well, can I help you with something else? → Ei bine, te pot ajuta cu altceva? (npc.plunderpurse.say_23)
- How many crystal coins would you like to get? → Câte monede de cristal ați dori să obțineți? (npc.plunderpurse.say_26)
- Well, can I help you with something else? → Ei bine, te pot ajuta cu altceva? (npc.plunderpurse.say_27)
- Sorry, you do not have enough platinum coins. → Ne pare rău, nu aveți suficiente monede de platină. (npc.plunderpurse.say_28)
- Sorry, you do not have enough platinum coins. → Ne pare rău, nu aveți suficiente monede de platină. (npc.plunderpurse.say_30)
- Well, can I help you with something else? → Ei bine, te pot ajuta cu altceva? (npc.plunderpurse.say_31)
- Sorry, you do not have enough platinum coins. → Ne pare rău, nu aveți suficiente monede de platină. (npc.plunderpurse.say_32)
- Sorry, you do not have enough platinum coins. → Ne pare rău, nu aveți suficiente monede de platină. (npc.plunderpurse.say_34)
- Well, can I help you with something else? → Ei bine, te pot ajuta cu altceva? (npc.plunderpurse.say_35)
- How many crystal coins would you like to change into platinum? → Câte monede de cristal ai vrea să schimbi în platină? (npc.plunderpurse.say_36)
- Sorry, you do not have enough crystal coins. → Ne pare rău, nu aveți suficiente monede de cristal. (npc.plunderpurse.say_37)
- Sorry, you do not have enough crystal coins. → Ne pare rău, nu aveți suficiente monede de cristal. (npc.plunderpurse.say_39)
- Well, can I help you with something else? → Ei bine, te pot ajuta cu altceva? (npc.plunderpurse.say_40)
- Fine. → Fine. (npc.robson.say_4)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **3166**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3098**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **10.69%** (297,777/2,786,472)
...
| RO | 13,215/49,731 | 26.6% | 798/3,855 | 20.7% |
| IT | 8,493/49,731 | 17.1% | 741/3,855 | 19.2% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-17T05:22:56.507426Z → 2026-02-17T06:22:56.507426Z) |
...
| Przepustowość (kluczy/h) | **2066.8 kluczy/h** |
| Podejrzane tłumaczenia | **10918** |
...
> Świeżość: 19s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-17T06:22:38.546223Z

- **Ostatni audyt:** SLOW_MODE | 11 issue(s) / 100 entries | 2026-02-17T06:22:38.546223Z
- **Top 5 typów problemów:** suspicious_rejected_critical=172, suspicious_log_critical=100, suspicious_log_high=100, suspicious_rejected_high=28, identical_to_en_exempt=13
- **Języki o najsłabszej jakości:** es(60.1, issues=211896), pl(60.1, issues=129454), ru(60.1, issues=36804), ro(60.2, issues=48381), it(60.2, issues=14645)
- **Pliki:** `i18n/status/quality_audit_latest.json`, `i18n/status/quality_dashboard.json`, `i18n/status/quality_report.jsonl`

### 📈 Statystyki Pracy
| Metryka | Wartość | Info |
|---------|---------|------|
| 🔄 Cykl aktualny | **#316** | od uruchomienia |
...
⚠️ **PL**: jakość 60%, 129454 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 211896 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 14645 problemów
⚠️ **RU**: jakość 60%, 36804 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 75%, 11840 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #316 |
| Heartbeat | 24s temu | 2026-02-17T06:22:34Z |
...
- 2026-02-17 06:22:34 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | npc.json
- 2026-02-17 06:22:34 | AUTO_TRANSLATE:parallel_start | ro | ok | npc.json
- 2026-02-17 06:22:26 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | npc.json
- 2026-02-17 06:22:26 | AUTO_TRANSLATE:parallel_start | ru | ok | npc.json
- 2026-02-17 06:22:25 | AUTO_TRANSLATE:auto_done | it | ok | npc.json
- 2026-02-17 06:22:21 | AUTO_TRANSLATE:heartbeat_tick | it | ok | npc.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 48.0% | 0 | 1,891 | 997 | 4720 (82.6%) | 31 |
| 🟡 ES | 75.0% | 0 | 2,630 | 762 | 483 (38.8%) | 29 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **101,031** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=78.84%, reason=decrease_high_fail_rate=78.8% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,759 kluczy / 60 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-17 06:22:56
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+50, skipped+0) — lang=it file=npc.json strict_skipped_done=1114
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **26,209** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 255 |
| ❌ Błędów | 440 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (5,331), **IT** (4,792), **RU** (4,684), **RO** (4,316), **PL** (3,551) |
| 📊 Porównanie | ↑ 29.2% vs wczoraj (20,288) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **126,403** kluczy
...
| 🔄 Cykli wykonanych | **#316** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-17 06:22:56  
