...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.94% / real 10.86%**. Tempo: **984.0 kluczy/h**. Tłumaczeń netto: **140,605**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 02:58:00

> **Aktualizacja:** 2026-04-29 02:58:00 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,580 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: it | Plik: items.json | Heartbeat: 2026-04-29T02:55:22Z
> **Okno godzinowe:** okno=1.0h | cykli=72 | pominięte=0.0% | odrzucone=3.2% | przepustowość=984.0/h  
> **Tłumaczeń netto:** 140,605

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 02:58:00 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T02:55:22Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 02:58:00 |
| TRANSLATION | 🟢 AKTYWNY | 3min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T02:55:05.439230Z |
| QUALITY | 🔒 NIEAKTYWNY | 4min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T02:53:13.125893Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 02:58:00 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T02:58:08.924774Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T02:55:22Z
...
| 🔄 **Ostatni cykl** | 58 kluczy, 1 odrzuconych, 92.0s, tryb: AUTO_TRANSLATE, cel: it/items.json |
| ❤️ **Heartbeat** | 2026-04-29T02:55:22Z |
...
| 🌍 Recent provider mix | TM/simple(252), Free Google Translate(223), canonical_name_semantic_autofix(16), canonical_name_case_autofi... |
...
| ❤️ Pool health | `critical` (writes=506, fallbacks=21) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=570/570 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `NO_WRITE` | OK | OK | `192` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 17651}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 02:58:00
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T02:55:05.439230Z
...
- rocky floor → pavimento roccioso (item.12364.name)
- rocky floor → pavimento roccioso (item.12365.name)
- rocky floor → pavimento roccioso (item.12366.name)
- rocky floor → pavimento roccioso (item.12367.name)
- rocky floor → pavimento roccioso (item.12379.name)
- rocky floor → pavimento roccioso (item.12380.name)
- rocky floor → pavimento roccioso (item.12381.name)
- rocky floor → pavimento roccioso (item.12382.name)
- rocky floor → pavimento roccioso (item.12383.name)
- rocky floor → pavimento roccioso (item.12384.name)
- rocky floor → pavimento roccioso (item.12385.name)
- rocky floor → pavimento roccioso (item.12386.name)
- rocky wall → parete rocciosa (item.12406.name)
- rocky wall → parete rocciosa (item.12407.name)
- rocky wall → parete rocciosa (item.12408.name)
- rocky wall → parete rocciosa (item.12409.name)
- rocky wall → parete rocciosa (item.12410.name)
- rocky wall → parete rocciosa (item.12411.name)
- rocky wall → parete rocciosa (item.12429.name)
- rocky wall → parete rocciosa (item.12430.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4742**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4595**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T02:53:32.314862Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.94%** (695,338/3,875,872)
- **Pokrycie globalne (real):** **10.86%** (420,854/3,875,872)
- **Kopie EN (łącznie):** **410,571**
- **Placeholdery [EN]/puste (łącznie):** **2,190,325**
...
| 🕒 Evidence window | 24h (span=32.10h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=32.10h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T01:58:01.140678Z → 2026-04-29T02:58:01.140678Z) |
...
> Świeżość: 4min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T02:53:13.125893Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T02:53:13.125893Z
- **Top 5 typów problemów:** suspicious_rejected_critical=187, suspicious_log_low=102, suspicious_log_high=97, suspicious_rejected_high=13, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=730416), ro(60.1, issues=429580), de(60.1, issues=112585), cs(60.1, issues=89604), fr(60.1, issues=60621)
- **Pliki:** `i18n/status/quality_audit_latest.json`, `i18n/status/quality_dashboard.json`, `i18n/status/quality_report.jsonl`

### 📈 Statystyki Pracy
| Metryka | Wartość | Info |
|---------|---------|------|
| 🔄 Cykl aktualny | **#185** | od uruchomienia |
...
⚠️ **ES**: jakość 60%, 730416 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 70%, 170860 problemów
⚠️ **RU**: jakość 63%, 361549 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,580 |
| Heartbeat | 166s temu | 2026-04-29T02:55:22Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T02:55:21.910966Z
...
- 2026-04-29 02:56:53 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 02:55:22 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 02:55:05 | AUTO_TRANSLATE:auto_done | it | ok | items.json
- 2026-04-29 02:55:03 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-04-29 02:53:33 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-04-29 02:53:33 | AUTO_TRANSLATE:auto_start | it | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **140,605** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=2.95%, reason=increase_low_fail_rate=3.0%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 02:58:00

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+58, skipped+0) — lang=it file=items.json strict_skipped_done=2169 guard_fail=1 placeholder=0 command=0 pipe=0
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pt] → warn (files+1, translated+84, skipped+0) — lang=pt file=monsters.json strict_skipped_done=5407 guard_fail=90 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [fr] → warn (files+1, translated+1, skipped+0) — lang=fr file=achievements.json strict_skipped_done=30
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **2,599** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 57 |
| ❌ Błędów | 100 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **RU** (604), **CS** (528), **IT** (346), **DE** (315), **TR** (285) |
| 📊 Porównanie | ↓ 68.4% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **21,579** kluczy
...
| 🔄 Cykli wykonanych | **#17,580** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,580 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 02:58:00  
