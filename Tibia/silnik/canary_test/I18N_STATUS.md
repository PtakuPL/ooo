...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.88% / real 10.79%**. Tempo: **855.0 kluczy/h**. Tłumaczeń netto: **136,421**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-28 21:43:11

> **Aktualizacja:** 2026-04-28 21:43:11 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,156 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: server.json | Heartbeat: 2026-04-28T21:40:57Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=3.5% | przepustowość=855.0/h  
> **Tłumaczeń netto:** 136,421

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-28 21:43:11 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-28T21:40:57Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 59s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-28 21:43:11 |
| TRANSLATION | 🟢 AKTYWNY | 49s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-28T21:42:27.876142Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-28T21:40:56.445342Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-28 21:43:11 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-28T21:43:17.223820Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-28T21:40:57Z
...
| 🔄 **Ostatni cykl** | 51 kluczy, 1 odrzuconych, 74.0s, tryb: AUTO_TRANSLATE, cel: ru/items.json |
| ❤️ **Heartbeat** | 2026-04-28T21:40:57Z |
...
| ⏳ Oldest pending (visible tail) | 14832 s |
...
| ♻️ Deferred stats | enqueued=33, cooldown=0, deduped=0, manual_review=0, partial_staged=0, partial_completed=0 |
...
| 🌍 Recent provider mix | TM/simple(300), Free Google Translate(195), OpenAI model pool(32), canonical_name_semantic_autofix(15), ter... |
...
| ❤️ Pool health | `critical` (writes=545, fallbacks=12) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=332/332 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
|-------|--------|----------|-------|-----------|--------|
| `HEARTBEAT_STALE` | OK | OK | `80` | `300` | Heartbeat świeży (80s, src=worker_runtime_heartbeat) Runtime[status=healthy, reason=heartbeat_fresh, phase=... |
| `NO_WRITE` | OK | OK | `59` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 389, 'oldest_s': 14832}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~146 dni (2,989,199 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 78.5% | 58,541/74,536 | ~14h |
| PL | ██████████████░░░░░░ | 71.0% | 52,911/74,536 | ~21h |
| IT | █████████████░░░░░░░ | 68.7% | 51,232/74,536 | ~23h |
| RO | █████████████░░░░░░░ | 69.6% | 51,874/74,536 | ~22h |
...
> Świeżość: 59s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-28 21:43:11
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 49s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-28T21:42:27.876142Z
...
- molten lava well → колодец с расплавленной лавой (item.11495.name)
- molten lava well → колодец с расплавленной лавой (item.11496.name)
- molten lava well → колодец с расплавленной лавой (item.11497.name)
- molten lava well → колодец с расплавленной лавой (item.11498.name)
- molten lava well → колодец с расплавленной лавой (item.11499.name)
- molten lava well → колодец с расплавленной лавой (item.11500.name)
- molten lava well → колодец с расплавленной лавой (item.11501.name)
- molten lava well → колодец с расплавленной лавой (item.11502.name)
- molten lava well → колодец с расплавленной лавой (item.11503.name)
- molten lava well → колодец с расплавленной лавой (item.11504.name)
- molten lava well → колодец с расплавленной лавой (item.11505.name)
- molten lava well → колодец с расплавленной лавой (item.11506.name)
- molten lava well → колодец с расплавленной лавой (item.11507.name)
- molten lava well → колодец с расплавленной лавой (item.11508.name)
- molten lava well → колодец с расплавленной лавой (item.11509.name)
- floating chair → плавающий стул (item.11522.name)
- floating chair → плавающий стул (item.11523.name)
- magic portal → магический портал (item.11553.name)
- magic portal → магический портал (item.11554.name)
- bed → кровать (item.115.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4636**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4489**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-28T21:41:13.427591Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.88%** (692,869/3,875,872)
- **Pokrycie globalne (real):** **10.79%** (418,126/3,875,872)
- **Kopie EN (łącznie):** **410,830**
- **Placeholdery [EN]/puste (łącznie):** **2,192,794**
...
| 🕒 Evidence window | 24h (span=26.85h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=26.85h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-28T20:43:11.704304Z → 2026-04-28T21:43:11.704304Z) |
...
| Najgorsze cele (strażnik) | ro/items.json (gf=12), cs/items.json (gf=10), de/otclient_modules.json (gf=3), de/npc.json (gf=3), it/items.json (gf=2) |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 92 | 94.8% | ru/items.json (92) |
| `existing_canonical_name_quality_mixed_scripts` | 4 | 4.1% | ru/items.json (4) |
| `gt_rejected_high_mixed_scripts` | 1 | 1.0% | ru/items.json (1) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-28T21:40:56.445342Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-28T21:40:56.445342Z
- **Top 5 typów problemów:** suspicious_rejected_critical=197, suspicious_log_medium=92, suspicious_log_low=60, suspicious_log_high=46, suspicious_rejected_high=3
- **Języki o najsłabszej jakości:** es(60.1, issues=722581), ro(60.1, issues=421722), ru(60.1, issues=355420), de(60.1, issues=105096), cs(60.1, issues=79077)
...
⚠️ **TR**: jakość 67%, 52301 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 722581 problemów
⚠️ **PT**: jakość 68%, 57363 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 76%, 166925 problemów
⚠️ **RU**: jakość 60%, 355420 problemów
⚠️ **NL**: jakość 60%, 72093 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,156 |
| Heartbeat | 140s temu | 2026-04-28T21:40:57Z |
...
- **Ostatnia aktualizacja:** 2026-04-28T21:42:44.937797Z
...
- 2026-04-28 21:42:45 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-28 21:42:28 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
- 2026-04-28 21:41:14 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-04-28 21:41:14 | AUTO_TRANSLATE:auto_start | ru | ok | items.json
- 2026-04-28 21:40:55 | AUTO_TRANSLATE:auto_done | tr | ok | items.json
- 2026-04-28 21:40:08 | AUTO_TRANSLATE:heartbeat_tick | tr | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **136,421** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=2.89%, reason=increase_low_fail_rate=2.9%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-28 21:43:11
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → warn (files+1, translated+30, skipped+0) — lang=ru file=items.json strict_skipped_done=850 guard_fail=5 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [cs] → warn (files+1, translated+44, skipped+0) — lang=cs file=npc.json strict_skipped_done=1276 guard_fail=12 placeholder=9 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **6,294** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 79 |
| ❌ Błędów | 249 |
| 🌍 Aktywnych języków | 9 |
| 🏆 TOP 5 | **DE** (1,092), **RU** (983), **IT** (744), **TR** (690), **RO** (637) |
| 📊 Porównanie | ↑ 21.3% vs wczoraj (5,188) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **29,154** kluczy
...
| 🔄 Cykli wykonanych | **#17,156** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,156 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-28 21:43:11  
