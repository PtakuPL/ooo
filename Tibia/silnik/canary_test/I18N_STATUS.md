...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.85%**. Tempo: **1444.9 kluczy/h**. Tłumaczeń netto: **117,476**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 18:31:57

> **Aktualizacja:** 2026-02-20 18:31:57 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #57 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: es | Plik: - | Heartbeat: 2026-02-20T18:31:54Z  
> **Okno godzinowe:** okno=1.0h | cykli=197 | pominięte=0.0% | odrzucone=74.7% | przepustowość=1444.9/h  
> **Tłumaczeń netto:** 117,476

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 18:31:57 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T18:31:54Z |
| MIGRATION | 🔒 NIEAKTYWNY | 10s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 18:31:57 |
| TRANSLATION | 🟢 AKTYWNY | 39s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T18:31:19.096702Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T18:31:58.987400Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 18:31:57 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T18:31:54Z
...
| ❤️ **Heartbeat** | 2026-02-20T18:31:54Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **2,566** kluczy |
| ❌ Odrzucone (guard) | 7596 |
| 🔁 Cykli | 197 |
| 🌍 Języków | 7 |
...
| IT | 27,841 | 53,586 | 51.96% | 2,142 |
| RU | 26,980 | 53,586 | 50.35% | 1,457 |
| SR | 24,350 | 53,586 | 45.44% | 1,070 |
| RO | 22,876 | 53,586 | 42.69% | 2,353 |
...
> Świeżość: 10s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 18:31:57
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 39s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T18:31:19.096702Z
...
| IT (Włoski) | 27,841/53,586 | 51.96% | 2,142 | 0 |
| RU (Rosyjski) | 26,980/53,586 | 50.35% | 1,457 | 0 |
| SR (SR) | 24,350/53,586 | 45.44% | 1,070 | 0 |
| RO (Rumuński) | 22,876/53,586 | 42.69% | 2,353 | 0 |
...
| IT | 26,482/49,731 | 53.2% | 1,359/3,855 | 35.2% |
| RU | 24,184/49,731 | 48.6% | 2,796/3,855 | 72.5% |
| SR | 24,249/49,731 | 48.8% | 101/3,855 | 2.6% |
| RO | 21,610/49,731 | 43.5% | 1,266/3,855 | 32.8% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T17:31:58.322204Z → 2026-02-20T18:31:58.322204Z) |
...
| Przepustowość (kluczy/h) | **1444.9 kluczy/h** |
| Podejrzane tłumaczenia | **3277** |
| Najgorsze cele (strażnik) | pl/items.json (gf=3264), pl/npc.json (gf=1936), es/items.json (gf=1551), it/npc.json (gf=86), es/server.json (gf=82) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T18:31:58.987400Z

- **Ostatni audyt:** SLOW_MODE | 48 issue(s) / 100 entries | 2026-02-20T18:31:54.044370Z | recent_hidden=0
- **Alarm recent hidden HIGH/CRITICAL:** ✅ OK | hidden=0, threshold=5, trend=→ last10=0.00, prev10=0.00, latest=0
- **Regresja critical bad keys pack:** 🚨 FAIL: pl(critical=42, pack=0), es(critical=33, pack=0)
- **Top 5 typów problemów:** suspicious_log_critical=82, suspicious_rejected_critical=62, suspicious_log_high=41, artifact_token=32, identical_to_en=16
- **Języki o najsłabszej jakości:** es(60.1, issues=327485), pl(60.1, issues=183526), ro(60.1, issues=179066), sr(61.4, issues=86229), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 60%, 183526 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 327485 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 70%, 72924 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #57 |
| Heartbeat | 5s temu | 2026-02-20T18:31:54Z |
...
- 2026-02-20 18:31:27 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 18:31:13 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | monsters.json
- 2026-02-20 18:31:13 | AUTO_TRANSLATE:parallel_start | pl | ok | monsters.json
- 2026-02-20 18:31:12 | AUTO_TRANSLATE:auto_done | es | ok | npc.json
- 2026-02-20 18:30:57 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 18:30:57 | AUTO_TRANSLATE:auto_start | es | ok | npc.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,829 | 731 | 7059 (90.6%) | 39 |
| 🟡 ES | 84.7% | 0 | 2,160 | 742 | 3208 (81.2%) | 39 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **117,476** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=17.0%, reason=stable_fail_rate=17.0% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,473 kluczy / 78 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 18:31:57
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ro] → ok (translated+50, skipped+0) — parallel lang=ro file=otclient_modules.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ru] → ok (translated+28, skipped+0) — parallel lang=ru file=questlog.json
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+24) — repair_identical lang=es file=npc.json target_identical=24 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=284.40
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+50, skipped+0) — lang=ro file=npc.json strict_skipped_done=302
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **7,230** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 57 |
| ❌ Błędów | 166 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (2,081), **RU** (1,367), **IT** (1,195), **RO** (852), **PL** (848) |
| 📊 Porównanie | ↑ 98.6% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **104,815** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 18:31:57  
