...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.03%**. Tempo: **3746.4 kluczy/h**. Tłumaczeń netto: **75,294**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-16 21:33:40

> **Aktualizacja:** 2026-02-16 21:33:40 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #62 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: - | Heartbeat: 2026-02-16T21:33:33Z  
> **Okno godzinowe:** okno=1.0h | cykli=197 | pominięte=0.0% | odrzucone=37.4% | przepustowość=3746.4/h  
> **Tłumaczeń netto:** 75,294

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-16 21:33:40 |
| LIVE | 🟢 AKTYWNY | 9s temu | - | `activity.json / worker_state.json` | 2026-02-16T21:33:33Z |
| MIGRATION | 🔒 NIEAKTYWNY | 1h temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-16 21:33:40 |
| TRANSLATION | 🟢 AKTYWNY | 10s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-16T21:33:31.749819Z |
| QUALITY | 🔒 NIEAKTYWNY | 9s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-16T21:33:32.717597Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-16 21:33:40 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 9s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-16T21:33:33Z
...
| ❤️ **Heartbeat** | 2026-02-16T21:33:33Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **6,856** kluczy |
| ❌ Odrzucone (guard) | 4099 |
| 🔁 Cykli | 197 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | IT (1,100 kluczy) |
| 📄 Najczęstszy plik | server.json |
| ⚡ Przepustowość | ~3746 kluczy/h |
| 🛡️ Guard fail rate | 37.4% |
| ⚠️ Podejrzane | 33729 |
...
|-------|---------------|-----------|----------|----------|
| ES | 39,460 | 53,586 | 73.64% | 2,606 |
| PL | 23,077 | 53,586 | 43.07% | 1,854 |
| RU | 18,298 | 53,586 | 34.15% | 3,201 |
| FR | 17,709 | 53,586 | 33.05% | 4,078 |
| RO | 9,598 | 53,586 | 17.91% | 2,513 |
| ZH_TW | 7,776 | 53,586 | 14.51% | 9,749 |
| IT | 4,766 | 53,586 | 8.89% | 2,452 |
| SR | 4,657 | 53,586 | 8.69% | 2,520 |
...
> **ETA globalne:** ~26 dni (2,367,520 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ██████████████░░░░░░ | 73.6% | 39,460/53,586 | ~3h |
| PL | ████████░░░░░░░░░░░░ | 43.1% | 23,077/53,586 | ~7h |
| RU | ██████░░░░░░░░░░░░░░ | 34.1% | 18,298/53,586 | ~9h |
| FR | ██████░░░░░░░░░░░░░░ | 33.0% | 17,709/53,586 | ~9h |
| RO | ███░░░░░░░░░░░░░░░░░ | 17.9% | 9,598/53,586 | ~11h |
| ZH_TW | ██░░░░░░░░░░░░░░░░░░ | 14.5% | 7,776/53,586 | ~12h |
| IT | █░░░░░░░░░░░░░░░░░░░ | 8.9% | 4,766/53,586 | ~12h |
| SR | █░░░░░░░░░░░░░░░░░░░ | 8.7% | 4,657/53,586 | ~12h |
...
> Tempo obliczone na bazie ostatniej godziny: ~3746 kluczy/h.
...
> Świeżość: 1h temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-16 21:33:40
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 10s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-16T21:33:31.749819Z
...
|-------|----------------|-------------------------------|---------|--------------|
| ES (Hiszpański) | 39,460/53,586 | 73.64% | 2,606 | 0 |
| PL (Polski) | 23,077/53,586 | 43.07% | 1,854 | 0 |
| RU (Rosyjski) | 18,298/53,586 | 34.15% | 3,201 | 0 |
| FR (Francuski) | 17,709/53,586 | 33.05% | 4,078 | 0 |
| RO (Rumuński) | 9,598/53,586 | 17.91% | 2,513 | 0 |
| ZH_TW (ZH_TW) | 7,776/53,586 | 14.51% | 9,749 | 2,155 |
| IT (Włoski) | 4,766/53,586 | 8.89% | 2,452 | 0 |
| SR (SR) | 4,657/53,586 | 8.69% | 2,520 | 0 |
...
- Greetings, {wayfarer}. → Hälsningar, {wayfarer}. (data.otservbr.global.npc.a.sleeping.dragon.L53.151)
- Hi? What do you mean 'hi' - can't you see I am a... I have to lower my voice. Di → Hej? Vad menar du 'hi' - kan du inte se att jag är en... Jag måste sänka rösten. (data.otservbr.global.npc.a.strange.chalice.L117.1623)
- I salute you, mortal being. → Jag hälsar dig, dödlig varelse. (data.otservbr.global.npc.a.swan.L95.88)
- Hum Humm! Welcume lil' |PLAYERNAME|. → Hum Hmm! Välkommen lil' |PLAYERNAME|. (data.otservbr.global.npc.a.sweaty.cyclops.L227.68)
- Good bye lil' one. → Farväl lil' one. (data.otservbr.global.npc.a.sweaty.cyclops.L228.69)
- I greet you, human. This is a time of distress, more than ever are we in need of → Jag hälsar dig, människa. Det här är en tid av nöd, mer än någonsin är vi i beho (data.otservbr.global.npc.a.weakened.forest.fury.L122.711)
- What is this? An optically challenged entity called |PLAYERNAME|. How fascinatin → Vad är det här? En optiskt utmanad enhet som heter |PLAYERNAME|. Vad fascinerand (data.otservbr.global.npc.a.wrinkled.bonelord.L80.1421)
- Wait right there. I will eat you after writing down what I found out. → Vänta där. Jag äter dig efter att ha skrivit ner vad jag fick reda på. (data.otservbr.global.npc.a.wrinkled.bonelord.L81.1422)
- Wait right there. I will eat you after writing down what I found out. → Vänta där. Jag äter dig efter att ha skrivit ner vad jag fick reda på. (data.otservbr.global.npc.a.wrinkled.bonelord.L82.1423)
- Be mourned pilgrim in flesh. I'm selling general goods. Just ask me for a {trade → Sörjas pilgrim i kött. Jag säljer allmänna varor. Fråga mig bara om en {trade}. (data.otservbr.global.npc.ahmet.L182.407)
- You back. You know, you right. Brother is right. Fist not always good. Tell him  → Du tillbaka. Du vet, du har rätt. Bror har rätt. Fist inte alltid bra. Säg det t (data.otservbr.global.npc.ajax.L58.355)
- Whatcha do in my place? → Vad gör du i mitt ställe? (data.otservbr.global.npc.ajax.L61.356)
- Bye, bye |PLAYERNAME|. → Hejdå, hejdå |PLAYERNAME|. (data.otservbr.global.npc.al.dee.L167.597)
- Take a look in the trade window to your left. → Ta en titt i handelsfönstret till vänster. (data.otservbr.global.npc.al.dee.L168.598)
- Greetings, pilgrim. Welcome to the halls of hope. We are the keepers of this {te → Hälsningar, pilgrim. Välkommen till hoppets salar. Vi är innehavare av denna {te (data.otservbr.global.npc.albinius.L267.1035)
- Oh... farewell, child. → Åh... farväl, barn. (data.otservbr.global.npc.albinius.L268.1036)
- Finally. → Slutligen. (data.otservbr.global.npc.alesar.L206.1591)
- Finally. → Slutligen. (data.otservbr.global.npc.alesar.L207.1592)
- At your service, just browse through my wares. → Till din tjänst, bläddra bara igenom mina varor. (data.otservbr.global.npc.alesar.L208.1593)
- See you, |PLAYERNAME|. → Vi ses, |PLAYERNAME|. (data.otservbr.global.npc.alexander.L172.1568)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **2271**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2209**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **10.03%** (279,592/2,786,472)
- **Kopie EN (łącznie):** **167,040**
...
|-------|--------|----------|----------|------------|
| ES | 36,984/49,731 | 74.4% | 2,476/3,855 | 64.2% |
| PL | 20,430/49,731 | 41.1% | 2,647/3,855 | 68.7% |
| RU | 15,573/49,731 | 31.3% | 2,725/3,855 | 70.7% |
| FR | 15,162/49,731 | 30.5% | 2,547/3,855 | 66.1% |
| RO | 9,504/49,731 | 19.1% | 94/3,855 | 2.4% |
| ZH_TW | 7,763/49,731 | 15.6% | 13/3,855 | 0.3% |
| IT | 4,716/49,731 | 9.5% | 50/3,855 | 1.3% |
| SR | 4,607/49,731 | 9.3% | 50/3,855 | 1.3% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-16T20:33:40.982037Z → 2026-02-16T21:33:40.982037Z) |
...
| Przepustowość (kluczy/h) | **3746.4 kluczy/h** |
| Podejrzane tłumaczenia | **33729** |
| Najgorsze cele (strażnik) | pl/items.json (gf=2385), pl/npc.json (gf=812), pl/server.json (gf=400), pl/monsters.json (gf=210), ro/monsters.json (gf=112) |
...
> Świeżość: 9s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-16T21:33:32.717597Z

- **Ostatni audyt:** OK | 7 issue(s) / 100 entries | 2026-02-16T21:33:32.717597Z
- **Top 5 typów problemów:** suspicious_rejected_critical=117, suspicious_log_high=110, suspicious_log_critical=90, suspicious_rejected_high=83, identical_to_en_exempt=11
- **Języki o najsłabszej jakości:** ru(59.9, issues=8507), ro(60.2, issues=4547), es(61.7, issues=152993), it(63.9, issues=4045), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 75%, 115200 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 62%, 152993 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 64%, 4045 problemów
⚠️ **RU**: jakość 60%, 8507 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 92%, 1771 problemów
...
| Heartbeat | 9s temu | 2026-02-16T21:33:33Z |
...
- 2026-02-16 21:33:04 | AUTO_TRANSLATE:heartbeat_tick | sv | ok | server.json
- 2026-02-16 21:33:03 | AUTO_TRANSLATE:parallel_start | sv | ok | server.json
- 2026-02-16 21:32:36 | AUTO_TRANSLATE:heartbeat_tick | sr | ok | server.json
- 2026-02-16 21:32:36 | AUTO_TRANSLATE:parallel_start | sr | ok | server.json
- 2026-02-16 21:32:33 | AUTO_TRANSLATE:auto_done | it | ok | server.json
- 2026-02-16 21:32:30 | AUTO_TRANSLATE:heartbeat_tick | it | ok | server.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 43.1% | 0 | 1,854 | 1,034 | 3930 (79.2%) | 27 |
| 🟡 ES | 73.6% | 0 | 2,606 | 1,118 | 101 (8.3%) | 24 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **75,294** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=18.47%, reason=stable_fail_rate=18.5% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 2,152 kluczy / 51 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-16 21:33:40
...
| ❌ Błędów | 82 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (1,663), **IT** (1,388), **SV** (1,385), **SR** (1,381), **RU** (1,293) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **89,307** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-16 21:33:40  
