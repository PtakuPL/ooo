...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.89%**. Tempo: **1617.6 kluczy/h**. Tłumaczeń netto: **123,982**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 21:26:56

> **Aktualizacja:** 2026-02-20 21:26:56 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #204 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: es | Plik: - | Heartbeat: 2026-02-20T21:26:53Z  
> **Okno godzinowe:** okno=1.0h | cykli=205 | pominięte=0.0% | odrzucone=54.4% | przepustowość=1617.6/h  
> **Tłumaczeń netto:** 123,982

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 21:26:56 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T21:26:53Z |
| MIGRATION | 🔒 NIEAKTYWNY | 57s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 21:26:56 |
| TRANSLATION | 🟢 AKTYWNY | 38s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T21:26:19.409143Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T21:26:58.023328Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 21:26:56 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T21:26:53Z
...
| ❤️ **Heartbeat** | 2026-02-20T21:26:53Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **2,818** kluczy |
| ❌ Odrzucone (guard) | 3357 |
| 🔁 Cykli | 205 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (709 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~1618 kluczy/h |
| 🛡️ Guard fail rate | 54.4% |
| ⚠️ Podejrzane | 25227 |
| 🌐 GT aktywny (1h) | ✅ TAK |
| 🔤 GT tłumaczeń (1h) | 48 |
...
> **ETA globalne:** ~58 dni (2,260,121 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~1618 kluczy/h.
...
> Świeżość: 57s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 21:26:56
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 38s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T21:26:19.409143Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T20:26:57.317135Z → 2026-02-20T21:26:57.317135Z) |
...
| Przepustowość (kluczy/h) | **1617.6 kluczy/h** |
| Podejrzane tłumaczenia | **3249** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T21:26:58.023328Z

- **Ostatni audyt:** SLOW_MODE | 30 issue(s) / 100 entries | 2026-02-20T21:26:52.852269Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=97, suspicious_log_high=60, suspicious_log_critical=49, artifact_token=27, identical_to_en_exempt=22
- **Języki o najsłabszej jakości:** es(60.1, issues=346150), ro(60.1, issues=187635), tl(64.2, issues=466), zh_TW(64.8, issues=337), fr(65.2, issues=2470)
...
⚠️ **PL**: jakość 66%, 192272 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 346150 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 81%, 76440 problemów
⚠️ **RU**: jakość 74%, 214384 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 83%, 31877 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #204 |
| Heartbeat | 5s temu | 2026-02-20T21:26:53Z |
...
- 2026-02-20 21:26:27 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 21:26:16 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | scripts.json
- 2026-02-20 21:26:15 | AUTO_TRANSLATE:parallel_start | ru | ok | scripts.json
- 2026-02-20 21:25:57 | AUTO_TRANSLATE:heartbeat_tick | it | ok | scripts.json
- 2026-02-20 21:25:57 | AUTO_TRANSLATE:parallel_start | it | ok | scripts.json
- 2026-02-20 21:25:56 | AUTO_TRANSLATE:auto_done | es | ok | otclient_modules.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,830 | 695 | 4700 (87.1%) | 37 |
| 🟡 ES | 84.8% | 0 | 2,160 | 605 | 2676 (81.6%) | 39 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **123,982** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=52.24%, reason=decrease_high_fail_rate=52.2% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,300 kluczy / 76 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 21:26:56
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+50, skipped+0) — lang=pl file=monsters.json strict_skipped_done=2379
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **16,847** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 204 |
| ❌ Błędów | 407 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (4,944), **RU** (3,314), **IT** (2,704), **PL** (1,990), **RO** (1,988) |
| 📊 Porównanie | ↑ 362.7% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **114,432** kluczy
...
| 🔄 Cykli wykonanych | **#204** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 21:26:56  
