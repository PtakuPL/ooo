...
> **Aktualizacja:** 2025-12-21 08:25:02 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 54 | **Klucze EN:** 36454  
> **LIVE:** Cykl #31 | Status: 🟢 RUNNING | Faza: MIGRATION | Etap: pending_skip | Kategoria: pending_skip | Plik: - | ETA: 0 | Heartbeat: 2025-12-21T07:24:53Z
...
|---------|---------|---------|------|
| 📂 **Wszystkie pliki** | **18,903** | 100% | cały projekt |
| 📜 Do skanowania (kod) | **8,156** | 43.1% | pliki z kodem/tekstami |
| 🔍 **Przeskanowane** | **6,412** | **78.6%** | historia workera |
| ⏳ Nie przeskanowane | **1,744** | 21.4% | czekają na skan |
...
|--------|-------|---------|------|
| ✅ Zmigrowane | **1890** | 29.5% | mają klucze i18n |
| 🔄 Wymaga migracji | **0** | - | trzeba dodać i18n |
| ⚪ Czyste | **327** | - | bez tekstów |
...
├─────────────────────────────────────────────────────────────────┤
│ ❤️ Heartbeat: 2025-12-21T07:24:53Z           │
└─────────────────────────────────────────────────────────────────┘
```

### 🧾 Ostatnie akcje (dla czytelności)

- 2025-12-21 06:10:52 | MIGRATION:file | npc | ok | data-otservbr-global/npc/faloriel.lua
- 2025-12-21 06:10:50 | MIGRATION:file | npc | ok | data-otservbr-global/npc/falonzo.lua
- 2025-12-21 06:10:49 | MIGRATION:file | npc | ok | data-otservbr-global/npc/falk.lua
- 2025-12-21 06:10:48 | MIGRATION:file | npc | ok | data-otservbr-global/npc/fa_hradin.lua
- 2025-12-21 06:10:47 | MIGRATION:file | npc | ok | data-otservbr-global/npc/fadil.lua
- 2025-12-21 06:10:45 | MIGRATION:file | npc | ok | data-otservbr-global/npc/ezebeth.lua
...
- 🔧 MIGRATION: mini-batch [monsters] → ok (keys+45) — mini_batch=4 processed=40/50
- 🔧 MIGRATION: mini-batch [monsters] → ok (keys+35) — mini_batch=3 processed=30/50
- 🔧 MIGRATION: mini-batch [monsters] → ok (keys+36) — mini_batch=2 processed=20/50
- 🔧 MIGRATION: mini-batch [monsters] → ok (keys+32) — mini_batch=1 processed=10/50
...
- 🔧 MIGRATION: mini-batch [creaturescripts] → ok (keys+0) — mini_batch=1 processed=10/10
...
|---------|---------|-----------|
| 📁 Plików przeskanowanych | **2221** | w tej sesji |
| ✅ Plików z kluczami | **1890** | zawierały hardcoded strings |
...
📅 Auto-updated by Worker v1.1 | Last: 2025-12-21 08:25:02  
...
- ✅ `items_classification.hpp` - ukończono 2025-12-21 08:17
- ✅ `pch.hpp` - ukończono 2025-12-21 08:17
- ✅ `canary_server.cpp` - ukończono 2025-12-21 08:17
- ✅ `account.cpp` - ukończono 2025-12-21 08:17
- ✅ `account_info.hpp` - ukończono 2025-12-21 08:17
- ✅ `account_repository_db.hpp` - ukończono 2025-12-21 08:17
- ✅ `account.hpp` - ukończono 2025-12-21 08:17
- ✅ `pch.cpp` - ukończono 2025-12-21 08:17
- ✅ `game_definitions.hpp` - ukończono 2025-12-21 08:17
- ✅ `zone.hpp` - ukończono 2025-12-21 08:17
