...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.88%**. Tempo: **1265.0 kluczy/h**. Tłumaczeń netto: **121,941**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 20:37:41

> **Aktualizacja:** 2026-02-20 20:37:41 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #162 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: sv | Plik: - | Heartbeat: 2026-02-20T20:37:37Z  
> **Okno godzinowe:** okno=1.0h | cykli=195 | pominięte=0.0% | odrzucone=77.6% | przepustowość=1265.0/h  
> **Tłumaczeń netto:** 121,941

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 20:37:41 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T20:37:37Z |
| MIGRATION | 🔒 NIEAKTYWNY | 18s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 20:37:41 |
| TRANSLATION | 🟢 AKTYWNY | 37s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T20:37:05.157784Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T20:37:42.578384Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 20:37:41 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T20:37:37Z
...
| ❤️ **Heartbeat** | 2026-02-20T20:37:37Z |
...
> **ETA globalne:** ~74 dni (2,260,369 kluczy do celu 95%)
...
> Świeżość: 18s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 20:37:41
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 37s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T20:37:05.157784Z
...
| RO (Rumuński) | 23,183/53,586 | 43.26% | 2,345 | 0 |
...
- Raporty strażnika jakości: **7042**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4148**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **13.88%** (386,743/2,786,472)
...
| RO | 21,902/49,731 | 44.0% | 1,281/3,855 | 33.2% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T19:37:41.903450Z → 2026-02-20T20:37:41.903450Z) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T20:37:42.578384Z

- **Ostatni audyt:** SLOW_MODE | 37 issue(s) / 100 entries | 2026-02-20T20:37:37.717549Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=145, suspicious_log_high=56, suspicious_log_critical=54, identical_to_en=21, artifact_token=16
- **Języki o najsłabszej jakości:** es(60.1, issues=340831), pl(60.1, issues=189998), ro(60.1, issues=184937), tl(64.2, issues=466), zh_TW(64.8, issues=337)
...
⚠️ **PL**: jakość 60%, 189998 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 340831 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 70%, 75669 problemów
⚠️ **RU**: jakość 74%, 213562 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 74%, 31178 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #162 |
| Heartbeat | 5s temu | 2026-02-20T20:37:37Z |
...
- 2026-02-20 20:37:11 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 20:36:49 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | otclient_modules.json
- 2026-02-20 20:36:49 | AUTO_TRANSLATE:parallel_start | pl | ok | otclient_modules.json
- 2026-02-20 20:36:43 | AUTO_TRANSLATE:heartbeat_tick | sr | ok | monsters.json
- 2026-02-20 20:36:43 | AUTO_TRANSLATE:parallel_start | sr | ok | monsters.json
- 2026-02-20 20:36:42 | AUTO_TRANSLATE:auto_done | sv | ok | monsters.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,830 | 679 | 5491 (89.0%) | 39 |
| 🟡 ES | 84.8% | 0 | 2,160 | 577 | 2102 (78.5%) | 37 |
...
| Przepustowość (okno) | 1,256 kluczy / 76 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 20:37:41
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [sv] → warn (files+1, translated+50, skipped+0) — lang=sv file=npc.json strict_skipped_done=795
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+41, skipped+0) — parallel lang=es file=talkactions.json
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **13,978** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 162 |
| ❌ Błędów | 341 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (4,147), **RU** (2,702), **IT** (2,231), **PL** (1,681), **RO** (1,643) |
| 📊 Porównanie | ↑ 283.9% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **111,563** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 20:37:41  
