...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.77%**. Tempo: **1060.9 kluczy/h**. Tłumaczeń netto: **111,734**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-19 21:05:58

> **Aktualizacja:** 2026-02-19 21:05:58 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #1 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-02-19T21:05:54Z  
> **Okno godzinowe:** okno=1.0h | cykli=81 | pominięte=0.0% | odrzucone=60.6% | przepustowość=1060.9/h  
> **Tłumaczeń netto:** 111,734

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-19 21:05:58 |
| LIVE | 🟢 AKTYWNY | 10s temu | - | `activity.json / worker_state.json` | 2026-02-19T21:05:54Z |
| MIGRATION | 🔒 NIEAKTYWNY | 2d temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-19 21:05:58 |
| TRANSLATION | 🟢 AKTYWNY | 25s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-19T21:05:38.947984Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-19T21:06:04.577046Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-19 21:05:58 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 10s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-19T21:05:54Z
...
| ❤️ **Heartbeat** | 2026-02-19T21:05:54Z |
...
| ❌ Odrzucone (guard) | 2683 |
| 🔁 Cykli | 81 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | IT (343 kluczy) |
...
| ES | 45,239 | 53,586 | 84.42% | 2,152 |
| IT | 27,052 | 53,586 | 50.48% | 2,115 |
| RU | 26,963 | 53,586 | 50.32% | 1,457 |
| SR | 24,274 | 53,586 | 45.3% | 1,091 |
| RO | 22,251 | 53,586 | 41.52% | 2,300 |
...
> **ETA globalne:** ~89 dni (2,263,288 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| PL | █████████████████░░░ | 87.4% | 46,855/53,586 | ~4h |
| ES | ████████████████░░░░ | 84.4% | 45,239/53,586 | ~5h |
| IT | ██████████░░░░░░░░░░ | 50.5% | 27,052/53,586 | ~22h |
| RU | ██████████░░░░░░░░░░ | 50.3% | 26,963/53,586 | ~23h |
| SR | █████████░░░░░░░░░░░ | 45.3% | 24,274/53,586 | ~25h |
| RO | ████████░░░░░░░░░░░░ | 41.5% | 22,251/53,586 | ~27h |
| FR | ██████░░░░░░░░░░░░░░ | 33.1% | 17,731/53,586 | ~31h |
| SV | █████░░░░░░░░░░░░░░░ | 27.9% | 14,939/53,586 | ~34h |
...
> Świeżość: 2d temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-19 21:05:58

### 📁 Pliki Projektu (pełny skan)
| Metryka | Wartość | Procent | Info |
|---------|---------|---------|------|
| 📂 **Wszystkie pliki** | **20,582** | 100% | cały projekt |
| 📜 Do skanowania (kod) | **9,601** | 46.6% | pliki z kodem/tekstami |
| 🔍 **Przeskanowane (historia)** | **6,443** | **67.1%** | `i18n_processed_files.txt` |
| 🧭 Przeskanowane (LIVE) | **15** | **0.2%** | `i18n_file_status.json` |
| ⏳ Nie przeskanowane (historia) | **3,158** | 32.9% | wg historii workera |
| ⏳ Nie przeskanowane (LIVE) | **9,586** | 99.8% | wg rejestru LIVE |
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 25s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-19T21:05:38.947984Z
...
| ES (Hiszpański) | 45,239/53,586 | 84.42% | 2,152 | 0 |
| IT (Włoski) | 27,052/53,586 | 50.48% | 2,115 | 0 |
| RU (Rosyjski) | 26,963/53,586 | 50.32% | 1,457 | 0 |
| SR (SR) | 24,274/53,586 | 45.30% | 1,091 | 0 |
| RO (Rumuński) | 22,251/53,586 | 41.52% | 2,300 | 0 |
...
- Raporty strażnika jakości: **6453**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3583**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **13.77%** (383,824/2,786,472)
- **Kopie EN (łącznie):** **162,269**
...
- **Profiler cyklu (ostatni):** cykl #1 (AUTO_TRANSLATE): dispatch 1846ms, mode 166293ms, status 11506ms, total 202732ms
...
| ES | 42,173/49,731 | 84.8% | 3,066/3,855 | 79.5% |
| IT | 25,726/49,731 | 51.7% | 1,326/3,855 | 34.4% |
| RU | 24,167/49,731 | 48.6% | 2,796/3,855 | 72.5% |
| SR | 24,173/49,731 | 48.6% | 101/3,855 | 2.6% |
| RO | 20,995/49,731 | 42.2% | 1,256/3,855 | 32.6% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-19T20:05:59.327439Z → 2026-02-19T21:05:59.327439Z) |
...
| Przepustowość (kluczy/h) | **1060.9 kluczy/h** |
| Podejrzane tłumaczenia | **8344** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-19T21:06:04.577046Z

- **Ostatni audyt:** SLOW_MODE | 23 issue(s) / 100 entries | 2026-02-19T21:02:16.669322Z
- **Top 5 typów problemów:** suspicious_rejected_critical=187, suspicious_log_high=164, suspicious_log_critical=33, artifact_token=19, suspicious_rejected_high=13
- **Języki o najsłabszej jakości:** es(60.1, issues=307430), pl(60.1, issues=175575), ro(60.1, issues=169497), it(60.1, issues=68110), ru(62.8, issues=206231)
...
⚠️ **PL**: jakość 60%, 175575 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 307430 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 68110 problemów
⚠️ **RU**: jakość 63%, 206231 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 75%, 28920 problemów
...
| Heartbeat | 10s temu | 2026-02-19T21:05:54Z |
...
- 2026-02-19 21:05:54 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-19 21:05:34 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | html.json
- 2026-02-19 21:05:34 | AUTO_TRANSLATE:parallel_start | ru | ok | html.json
- 2026-02-19 21:05:27 | AUTO_TRANSLATE:heartbeat_tick | it | ok | html.json
- 2026-02-19 21:05:26 | AUTO_TRANSLATE:parallel_start | it | ok | html.json
- 2026-02-19 21:05:24 | AUTO_TRANSLATE:auto_done | ro | ok | html.json
...
| 🟡 ES | 84.4% | 0 | 2,152 | 261 | 695 (72.7%) | 27 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **111,734** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=17.71%, reason=stable_fail_rate=17.7% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 497 kluczy / 54 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-19 21:05:58
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [it] → ok (translated+48, skipped+0) — parallel lang=it file=otclient_modules.json
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **2,052** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 9 |
| ❌ Błędów | 54 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (511), **IT** (346), **RU** (335), **RO** (327), **PL** (236) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **142,069** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-19 21:05:58  
