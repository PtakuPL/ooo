...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-27 16:36:53

> **Aktualizacja:** 2026-04-27 16:36:53 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #16,424 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: nl | Plik: questlog.json | Heartbeat: 2026-04-27T16:33:42Z
...
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-27 16:36:53 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-04-27T16:33:42Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 53s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-27 16:36:53 |
| TRANSLATION | 🟢 AKTYWNY | 17min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-27T16:19:48.635194Z |
| QUALITY | 🔒 NIEAKTYWNY | 17min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-27T16:19:49.915224Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-27 16:36:53 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 2 alarmów | `doctor_alerts_latest.json` | 2026-04-27T16:36:59.039640Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-27T16:33:42Z
...
| ❤️ **Heartbeat** | 2026-04-27T16:33:42Z |
...
| ⏳ Oldest pending (visible tail) | 335977 s |
...
| `NO_WRITE` | ALERT | WARNING | `1016` | `900` | Brak świeżych zapisów przy pending=400. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 335977}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 53s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-27 16:36:53
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 17min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-27T16:19:48.635194Z
...
| 🕒 Evidence window | 24h (span=69.46h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=69.46h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-0.10pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-27T15:36:53.356498Z → 2026-04-27T16:36:53.356498Z) |
...
|--------|-----------|--------|----------------|
| `gt_validate_fail_placeholder` | 109 | 46.6% | nl/npc.json (49) |
| `gt_validate_fail_identical_to_en` | 61 | 26.1% | nl/npc.json (28) |
| `gt_partial_validate_word_salad` | 23 | 9.8% | es/server.json (10) |
| `gt_rejected_critical` | 14 | 6.0% | nl/npc.json (3) |
| `gt_partial_translation_mix` | 11 | 4.7% | nl/html.json (4) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 17min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-27T16:19:49.915224Z
...
| Heartbeat | 197s temu | 2026-04-27T16:33:42Z |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-27 16:36:53
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-27 16:36:53  
