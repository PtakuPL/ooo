...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **18.84%**. Tempo: **498.2 kluczy/h**. Tłumaczeń netto: **54,516**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-23 10:36:42

> **Aktualizacja:** 2026-03-23 10:36:42 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **LIVE:** Cykl #10,100 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-03-23T10:36:06Z  
> **Okno godzinowe:** okno=1.0h | cykli=104 | pominięte=0.0% | odrzucone=24.4% | przepustowość=498.2/h  
> **Tłumaczeń netto:** 54,516

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-23 10:36:42 |
| LIVE | 🟢 AKTYWNY | 37s temu | - | `activity.json / worker_state.json` | 2026-03-23T10:36:06Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 12s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-23 10:36:42 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-23T10:34:19.534649Z |
| QUALITY | 🔒 NIEAKTYWNY | 3min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-23T10:33:32.517530Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-23 10:36:42 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 37s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-23T10:36:06Z
...
| ❤️ **Heartbeat** | 2026-03-23T10:36:06Z |
...
| PT | 51,979 | 74,536 | 69.74% ↑+0.02% | 60,565 |
| CS | 50,598 | 74,536 | 67.88% | 61,557 |
| NL | 50,360 | 74,536 | 67.56% | 62,508 |
...
> Świeżość: 12s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-23 10:36:42
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-23T10:34:19.534649Z
...
| PT (Portugalski) | 51,979/74,536 | 69.74% | 60,565 | 64 |
| CS (Czeski) | 50,598/74,536 | 67.88% | 61,557 | 213 |
| NL (Niderlandzki) | 50,360/74,536 | 67.56% | 62,508 | 64 |
...
- May enlightenment be your path. → Moge verlichting jouw pad zijn. (data.otservbr.global.npc.fenech.L171.1390)
- Good day, |PLAYERNAME|. I hope you bring a lot of {magical ingredients} with you → Goedendag, |PLAYERNAME|. Ik hoop dat je veel {magical ingredients} meeneemt. (data.otservbr.global.npc.fiona.L61.819)
- Good bye and please come back soon. → Tot ziens en kom alsjeblieft snel terug. (data.otservbr.global.npc.fiona.L62.820)
- Good bye and please come back soon. → Tot ziens en kom alsjeblieft snel terug. (data.otservbr.global.npc.fiona.L63.821)
- Sure, take a look. Apart from those, I also buy some of the possessions from fam → Zeker, kijk eens. Daarnaast koop ik ook een aantal bezittingen van beroemde demo (data.otservbr.global.npc.fiona.L64.822)
- Be greeted, living soul! → Wees gegroet, levende ziel! (data.otservbr.global.npc.flickering.soul.L198.1612)
- Come back soon. → Kom snel terug. (data.otservbr.global.npc.flora.L93.35)
- Welcome, |PLAYERNAME|. What can I do for you? → Welkom, |PLAYERNAME|. Wat kan ik voor je doen? (data.otservbr.global.npc.florentine.L59.579)
- Don't you see that I'm trying to write a poem? <sighs> So what's the matter? → Zie je niet dat ik een gedicht probeer te schrijven? <sighs> Wat is er aan de ha (data.otservbr.global.npc.frafnar.L92.107)
- Beeee greeeeted, Simula! What is your neeeed? → Groetjes, Simula! Wat is je behoefte? (data.otservbr.global.npc.frans.L130.252)
- Hi there and welcome to my little magic shop. → Hallo daar en welkom in mijn kleine magische winkel. (data.otservbr.global.npc.frederik.L153.759)
- Yeah, bye. → Ja, doei. (data.otservbr.global.npc.frederik.L154.760)
- Yeah, bye. → Ja, doei. (data.otservbr.global.npc.frederik.L155.761)
- I hope you have a cold day, friend. → Ik hoop dat je een koude dag hebt, vriend. (data.otservbr.global.npc.freezhild.L80.1296)
- I hope you have a cold day, friend. → Ik hoop dat je een koude dag hebt, vriend. (data.otservbr.global.npc.freezhild.L81.1297)
- Welcome, to my cool home. → Welkom in mijn coole huis. (data.otservbr.global.npc.freezhild.L82.1298)
- Welcome to Frodo's Hut. You heard about the {news}? → Welkom in Frodo's hut. Heb je gehoord van de {news}? (data.otservbr.global.npc.frodo.L107.970)
- No, you can't have my nose! If you're in need of a {carrot}, go to the market or → Nee, je mag mijn neus niet hebben! Als je een {wortel} nodig hebt, ga dan naar d (data.otservbr.global.npc.frosty.L148.1121)
- Farewell, stranger. May Uman open your minds and your hearts to Daraman's wisdom → Vaarwel, vreemdeling. Moge Uman uw geest en hart openen voor Daramans wijsheid! (data.otservbr.global.npc.gabel.L182.1216)
- Farewell, stranger. May Uman open your minds and your hearts to Daraman's wisdom → Vaarwel, vreemdeling. Moge Uman uw geest en hart openen voor Daramans wijsheid! (data.otservbr.global.npc.gabel.L183.1217)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **2965**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2828**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **18.84%** (730,336/3,875,872)
- **Kopie EN (łącznie):** **598,399**
...
| PT | 50,840/70,637 | 72.0% | 1,139/3,899 | 29.2% |
| CS | 49,548/70,637 | 70.1% | 1,050/3,899 | 26.9% |
| NL | 49,356/70,637 | 69.9% | 1,004/3,899 | 25.8% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-23T09:36:42.413884Z → 2026-03-23T10:36:42.413884Z) |
| Cykle | **104** (TŁUMACZENIE=104, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **24.4%** |
| Cykle bez postępu % | **0.0%** |
| Przepustowość (kluczy/h) | **498.2 kluczy/h** |
| Podejrzane tłumaczenia | **2426** |
| Najgorsze cele (strażnik) | pt/monsters.json (gf=37), nl/monsters.json (gf=35), it/monsters.json (gf=31), tr/monsters.json (gf=27), pt/server.json (gf=25) |
...
> Świeżość: 3min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-23T10:33:32.517530Z

- **Ostatni audyt:** OK | 2 issue(s) / 100 entries | 2026-03-23T10:33:32.517530Z
- **Top 5 typów problemów:** suspicious_rejected_critical=177, suspicious_log_high=146, suspicious_log_medium=54, suspicious_rejected_high=23, identical_to_en_exempt=4
- **Języki o najsłabszej jakości:** es(60.1, issues=610285), ru(60.1, issues=289826), it(60.1, issues=113842), pt(60.1, issues=21116), nl(60.2, issues=13482)
...
⚠️ **TR**: jakość 68%, 6986 problemów
⚠️ **PL**: jakość 66%, 328572 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 610285 problemów
⚠️ **PT**: jakość 60%, 21116 problemów
⚠️ **FR**: jakość 78%, 19007 problemów
⚠️ **IT**: jakość 60%, 113842 problemów
⚠️ **RU**: jakość 60%, 289826 problemów
⚠️ **NL**: jakość 60%, 13482 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #10,100 |
| Heartbeat | 37s temu | 2026-03-23T10:36:06Z |
...
- **TOP 5 języków:** DE (23,792), NL (22,879), CS (22,503), PT (21,378), FR (18,530)
- **Aktualnie naprawia:** ES / -
- **Ostatnia aktualizacja:** 2026-03-23T10:34:36.072275Z
...
- 2026-03-23 10:36:06 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-03-23 10:34:36 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-03-23 10:34:19 | AUTO_TRANSLATE:auto_done | nl | ok | server.json
- 2026-03-23 10:33:39 | AUTO_TRANSLATE:heartbeat_tick | nl | ok | server.json
- 2026-03-23 10:33:38 | AUTO_TRANSLATE:auto_start | nl | ok | server.json
- 2026-03-23 10:33:32 | AUTO_TRANSLATE:auto_done | pt | ok | server.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **54,516** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=20.42%, reason=decrease_high_fail_rate=20.4% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-23 10:36:42
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **27,975** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 174 |
| ❌ Błędów | 416 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **ES** (8,964), **TR** (5,606), **PL** (2,622), **RO** (1,968), **RU** (1,524) |
| 📊 Porównanie | ↑ 35.0% vs wczoraj (20,729) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **48,704** kluczy
...
| 🔄 Cykli wykonanych | **#10,100** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #10,100 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-23 10:36:42  
