...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.05%**. Tempo: **3874.5 kluczy/h**. Tłumaczeń netto: **76,110**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-16 21:41:59

> **Aktualizacja:** 2026-02-16 21:41:59 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #69 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: pl | Plik: - | Heartbeat: 2026-02-16T21:41:50Z  
> **Okno godzinowe:** okno=1.0h | cykli=201 | pominięte=0.0% | odrzucone=37.9% | przepustowość=3874.5/h  
> **Tłumaczeń netto:** 76,110

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-16 21:41:59 |
| LIVE | 🟢 AKTYWNY | 11s temu | - | `activity.json / worker_state.json` | 2026-02-16T21:41:50Z |
| MIGRATION | 🔒 NIEAKTYWNY | 1h temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-16 21:41:59 |
| TRANSLATION | 🟢 AKTYWNY | 46s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-16T21:41:15.475095Z |
| QUALITY | 🔒 NIEAKTYWNY | 11s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-16T21:41:50.445334Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-16 21:41:59 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 11s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-16T21:41:50Z
...
| ❤️ **Heartbeat** | 2026-02-16T21:41:50Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **7,009** kluczy |
| ❌ Odrzucone (guard) | 4278 |
| 🔁 Cykli | 201 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | IT (1,150 kluczy) |
| 📄 Najczęstszy plik | monsters.json |
| ⚡ Przepustowość | ~3875 kluczy/h |
...
> **ETA globalne:** ~25 dni (2,367,071 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~3875 kluczy/h.
...
> Świeżość: 1h temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-16 21:41:59
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 46s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-16T21:41:15.475095Z
...
| SR (SR) | 4,771/53,586 | 8.90% | 2,510 | 0 |
...
- Raporty strażnika jakości: **2292**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2230**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **10.05%** (280,041/2,786,472)
- **Kopie EN (łącznie):** **167,007**
...
| SR | 4,721/49,731 | 9.5% | 50/3,855 | 1.3% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-16T20:42:00.395744Z → 2026-02-16T21:42:00.395744Z) |
...
| Przepustowość (kluczy/h) | **3874.5 kluczy/h** |
| Podejrzane tłumaczenia | **35017** |
| Najgorsze cele (strażnik) | pl/items.json (gf=2300), pl/npc.json (gf=1053), pl/server.json (gf=338), pl/monsters.json (gf=213), ro/monsters.json (gf=142) |
...
> Świeżość: 11s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-16T21:41:50.445334Z

- **Ostatni audyt:** SLOW_MODE | 39 issue(s) / 100 entries | 2026-02-16T21:41:50.445334Z
- **Top 5 typów problemów:** suspicious_log_high=147, suspicious_rejected_critical=127, suspicious_rejected_high=73, suspicious_log_critical=53, identical_to_en=28
- **Języki o najsłabszej jakości:** ro(59.9, issues=5723), es(60.1, issues=153759), ru(60.4, issues=9215), it(62.2, issues=4202), tl(64.2, issues=466)
...
⚠️ **ES**: jakość 60%, 153759 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 62%, 4202 problemów
⚠️ **RU**: jakość 60%, 9215 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 67%, 2115 problemów
...
| Heartbeat | 11s temu | 2026-02-16T21:41:50Z |
...
- 2026-02-16 21:41:32 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-16 21:41:10 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | server.json
- 2026-02-16 21:41:10 | AUTO_TRANSLATE:parallel_start | ru | ok | server.json
- 2026-02-16 21:40:56 | AUTO_TRANSLATE:heartbeat_tick | es | ok | monsters.json
- 2026-02-16 21:40:56 | AUTO_TRANSLATE:parallel_start | es | ok | monsters.json
- 2026-02-16 21:40:52 | AUTO_TRANSLATE:auto_done | pl | ok | monsters.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **76,110** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=40.49%, reason=decrease_high_fail_rate=40.5% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-16 21:41:59
...
| ❌ Błędów | 92 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (1,892), **IT** (1,538), **SV** (1,535), **SR** (1,531), **RU** (1,473) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **90,372** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-16 21:41:59  
