...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-27 17:20:11

> **Aktualizacja:** 2026-04-27 17:20:11 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #16,436 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: pt | Plik: books.json | Heartbeat: 2026-04-27T17:16:52Z
> **Okno godzinowe:** okno=1.0h | cykli=17 | pominięte=0.0% | odrzucone=0.6% | przepustowość=2035.0/h  
> **Tłumaczeń netto:** 128,418

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-27 17:20:11 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-04-27T17:16:52Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 27s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-27 17:20:11 |
| TRANSLATION | 🟢 AKTYWNY | 11min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-27T17:09:02.473064Z |
| QUALITY | 🔒 NIEAKTYWNY | 11min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-27T17:09:03.585577Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-27 17:20:11 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-27T17:20:19.310128Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-27T17:16:52Z
...
| ❤️ **Heartbeat** | 2026-04-27T17:16:52Z |
...
| ⏳ Oldest pending (visible tail) | 338577 s |
| 🌍 Top języki | NL(138), PT(129), ES(117), TR(7) |
| 🧱 Top reason_bucket | placeholder(164), default(84), provider_error(79), critical(25) |
| 🗂️ Deferred state keys | 7767 |
...
| ❤️ Pool health | `critical` (writes=431, fallbacks=192) |
...
|-------|--------|----------|-------|-----------|--------|
| `HEARTBEAT_STALE` | OK | OK | `179` | `300` | Heartbeat świeży (179s, src=worker_runtime_heartbeat) Runtime[status=healthy, reason=heartbeat_fresh, phase... |
| `NO_WRITE` | OK | OK | `679` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 338577}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 27s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-27 17:20:11
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 11min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-27T17:09:02.473064Z
...
| 🕒 Evidence window | 24h (span=70.18h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=70.18h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-0.10pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-27T16:20:11.682860Z → 2026-04-27T17:20:11.682860Z) |
...
|--------|-----------|--------|----------------|
| `gt_validate_fail_placeholder` | 12 | 31.6% | pt/questlog.json (6) |
| `gt_rejected_critical` | 10 | 26.3% | nl/questlog.json (4) |
| `gt_partial_validate_word_salad` | 5 | 13.2% | nl/questlog.json (3) |
| `gt_partial_translation_mix` | 5 | 13.2% | nl/cpp.json (2) |
| `gt_validate_fail_identical_to_en` | 5 | 13.2% | pt/books.json (3) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 11min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-27T17:09:03.585577Z
...
| Heartbeat | 207s temu | 2026-04-27T17:16:52Z |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-27 17:20:11
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-27 17:20:11  
