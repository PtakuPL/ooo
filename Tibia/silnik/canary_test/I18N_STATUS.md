...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.98% / real 10.9%**. Tempo: **918.0 kluczy/h**. Tłumaczeń netto: **143,557**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 06:38:28

> **Aktualizacja:** 2026-04-29 06:38:28 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,896 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ro | Plik: items.json | Heartbeat: 2026-04-29T06:37:28Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=4.0% | przepustowość=918.0/h  
> **Tłumaczeń netto:** 143,557

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 06:38:28 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T06:37:28Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 18s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 06:38:28 |
| TRANSLATION | 🟢 AKTYWNY | 3min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T06:35:17.735355Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T06:37:15.392258Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 06:38:28 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T06:38:35.356124Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T06:37:28Z
...
| ❤️ **Heartbeat** | 2026-04-29T06:37:28Z |
...
| ⏳ Oldest pending (visible tail) | 16823 s |
...
| 🌍 Recent provider mix | TM/simple(303), Free Google Translate(168), canonical_name_semantic_autofix(15), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=489, fallbacks=24) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=743/743 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 16823}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
|-------|---------------|-----------|----------|----------|
| ES | 58,875 | 74,536 | 78.99% →0% | 9,715 |
...
> **ETA globalne:** ~135 dni (2,985,014 kluczy do celu 95%)
...
> Świeżość: 18s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 06:38:28
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T06:35:17.735355Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T06:37:55.028507Z |
...
| 🕒 Evidence window | 24h (span=35.77h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=35.77h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T05:38:28.664946Z → 2026-04-29T06:38:28.664946Z) |
...
| Podejrzane tłumaczenia | **1225** |
| Najgorsze cele (strażnik) | cs/items.json (gf=20), ro/items.json (gf=8), ru/items.json (gf=3), it/items.json (gf=3), de/otclient_modules.json (gf=2) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T06:37:15.392258Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T06:37:15.392258Z
- **Top 5 typów problemów:** suspicious_rejected_critical=188, suspicious_log_high=101, suspicious_log_low=98, suspicious_rejected_high=12, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=737265), ro(60.1, issues=434995), de(60.1, issues=117653), cs(60.1, issues=98463), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 737265 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 68%, 173934 problemów
⚠️ **RU**: jakość 63%, 365512 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,896 |
| Heartbeat | 67s temu | 2026-04-29T06:37:28Z |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 06:38:28
...
| 🔄 Cykli wykonanych | **#17,896** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,896 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 06:38:28  
