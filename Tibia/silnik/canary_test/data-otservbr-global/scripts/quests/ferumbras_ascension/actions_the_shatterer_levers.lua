...
function ferumbrasAscendantTheShattererLevers.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if player:getStorageValue(Storage.Quest.U10_90.FerumbrasAscension.TheShatterer) >= 1 then
		player:sendLocalizedCancelMessage("quests.ferumbras_ascension.you_cannot_use_this_lever_again")
		return true
	end
	...
	elseif item.itemid == 8912 then
		player:sendLocalizedCancelMessage("quests.ferumbras_ascension.sorry_not_possible")
		return true
	end
	return true
end
