...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.66% / real 9.02%**. Tempo: **2521.0 kluczy/h**. Tłumaczeń netto: **77,490**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-29 08:19:53

> **Aktualizacja:** 2026-03-29 08:19:53 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #11,518 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: tr | Plik: monsters.json | Heartbeat: 2026-03-29T08:19:10Z  
> **Okno godzinowe:** okno=1.0h | cykli=80 | pominięte=0.0% | odrzucone=25.1% | przepustowość=2521.0/h  
> **Tłumaczeń netto:** 77,490

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-29 08:19:53 |
| LIVE | 🟢 AKTYWNY | 44s temu | - | `activity.json / worker_state.json` | 2026-03-29T08:19:10Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 13s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-29 08:19:53 |
| TRANSLATION | 🟢 AKTYWNY | 7min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-29T08:12:32.978831Z |
| QUALITY | 🔒 NIEAKTYWNY | 7min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-29T08:12:53.935804Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-29 08:19:53 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 44s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-29T08:19:10Z
...
| ❤️ **Heartbeat** | 2026-03-29T08:19:10Z |
...
> Tempo obliczone na bazie ostatniej godziny: ~2521 kluczy/h.
...
> Świeżość: 13s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-29 08:19:53
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 7min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-29T08:12:32.978831Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-29T07:19:53.230805Z → 2026-03-29T08:19:53.230805Z) |
...
| Przepustowość (kluczy/h) | **2521.0 kluczy/h** |
...
|--------|-----------|--------|----------------|
| `gt_rejected_critical` | 91 | 41.7% | tr/npc.json (39) |
| `gt_validate_fail_placeholder` | 86 | 39.4% | tr/npc.json (75) |
| `gt_validate_fail_quality` | 25 | 11.5% | tr/npc.json (16) |
| `gt_validate_fail_word_salad` | 13 | 6.0% | pt/items.json (7) |
| `gt_rejected_high_cyrillic_latin_mix` | 1 | 0.5% | ru/items.json (1) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 7min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-29T08:12:53.935804Z
...
| Heartbeat | 44s temu | 2026-03-29T08:19:10Z |
...
- 2026-03-29 08:13:08 | AUTO_TRANSLATE:auto_start | tr | ok | monsters.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-29 08:19:53
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-29 08:19:53  
