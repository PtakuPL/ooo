...
HEARTBEAT_AGING_SECONDS="${GUARDIAN_HEARTBEAT_AGING_SECONDS:-300}"
HEARTBEAT_STALE_SECONDS="${GUARDIAN_HEARTBEAT_STALE_SECONDS:-480}"
HEARTBEAT_STUCK_SECONDS="${GUARDIAN_HEARTBEAT_STUCK_SECONDS:-900}"
HEARTBEAT_ACTIVE_LOG_GRACE_SECONDS="${GUARDIAN_HEARTBEAT_ACTIVE_LOG_GRACE_SECONDS:-300}"
STUCK_WINDOW_MINUTES="${GUARDIAN_STUCK_WINDOW_MINUTES:-20}"
GUARD_FAIL_RATE_ALERT="${GUARDIAN_GUARD_FAIL_RATE_ALERT:-50}"
