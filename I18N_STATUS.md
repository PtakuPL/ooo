...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.89%**. Tempo: **1513.6 kluczy/h**. Tłumaczeń netto: **125,130**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 22:05:25

> **Aktualizacja:** 2026-02-20 22:05:25 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #8 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-02-20T22:04:59Z  
> **Okno godzinowe:** okno=1.0h | cykli=184 | pominięte=0.0% | odrzucone=74.2% | przepustowość=1513.6/h  
> **Tłumaczeń netto:** 125,130

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 22:05:25 |
| LIVE | 🟢 AKTYWNY | 28s temu | - | `activity.json / worker_state.json` | 2026-02-20T22:04:59Z |
| MIGRATION | 🔒 NIEAKTYWNY | 57s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 22:05:25 |
| TRANSLATION | 🟢 AKTYWNY | 38s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T22:04:49.148320Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T22:05:27.098844Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 22:05:25 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 28s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T22:04:59Z
...
| ❤️ **Heartbeat** | 2026-02-20T22:04:59Z |
...
> **ETA globalne:** ~62 dni (2,259,936 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~1514 kluczy/h.
...
> Świeżość: 57s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 22:05:25
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 38s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T22:04:49.148320Z
...
- Would you really like to deposit {} gold? → Chiar ți-ar plăcea să depui {} aur? (npc.wentworth.say_8)
- Farewell, |PLAYERNAME|. → La revedere, |PLAYERNAME|. (npc.willard.farewell_msg_1)
- Farewell, |PLAYERNAME|. → La revedere, |PLAYERNAME|. (npc.willard.walkaway_msg_1)
- You have no cookie that I'd like. → Nu ai nicio prăjitură pe care mi-aș dori. (npc.wyda.say_3)
- Wrong Word. → Cuvânt greșit. (npc.wyrdin.say_10)
- Good bye and come again. → La revedere și vino din nou. (npc.xodet.farewell_msg_1)
- So you ask me for a {{}} to begin your adventure? → Deci îmi ceri un {{}} pentru a-ți începe aventura? (npc.xodet.say_1)
- What? I have already gave you one {{}}! → Ce? Ți-am dat deja unul {{}}! (npc.xodet.say_2)
- Of course, just browse through my wares. You can also look at {}. → Desigur, răsfoiește-mi produsele. Puteți să vă uitați și la {}. (npc.xodet.say_3)
- Good bye and come again. → La revedere și vino din nou. (npc.xodet.walkaway_msg_1)
- |PLAYERNAME|, that almost sounded like the word of greeting. Humans - cute they  → |PLAYERNAME|, aproape că a sunat ca un cuvânt de salut. Oamenii - drăguți sunt! (npc.yaman.multi_2)
- Shove off, little one! Humans are not welcome here, |PLAYERNAME|! → Îndepărtează-te, micuțo! Oamenii nu sunt bineveniți aici, |PLAYERNAME|! (npc.yaman.say_1)
- You have no cookie that I'd like. → Nu ai nicio prăjitură pe care mi-aș dori. (npc.yaman.say_11)
- Ok then. → Bine atunci. (npc.yaman.say_13)
- I'm sorry, but you don't have Malor's permission to trade with me. → Îmi pare rău, dar nu ai permisiunea lui Malor să faci schimb cu mine. (npc.yaman.say_15)
- So receive the protection of the twist of fate, pilgrim. → Așa că primește protecția întorsăturii destinului, pelerine. (npc.yberius.keyword_1)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T21:05:25.878389Z → 2026-02-20T22:05:25.878389Z) |
...
| Przepustowość (kluczy/h) | **1513.6 kluczy/h** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T22:05:27.098844Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=349969), pl(60.1, issues=194010), ro(60.2, issues=189548), sr(64.1, issues=87233), tl(64.2, issues=466)
...
| Heartbeat | 28s temu | 2026-02-20T22:04:59Z |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 22:05:25
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+50, skipped+0) — lang=ro file=npc.json strict_skipped_done=5351
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **18,678** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 224 |
| ❌ Błędów | 454 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (5,543), **RU** (3,639), **IT** (2,957), **PL** (2,252), **RO** (2,207) |
| 📊 Porównanie | ↑ 413.0% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **116,263** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 22:05:25  
