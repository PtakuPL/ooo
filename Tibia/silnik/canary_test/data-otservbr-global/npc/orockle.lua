...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "fight") then
		NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.orockle.say_1")
		npcHandler:setTopic(playerId, 0)
	elseif MsgContains(message, "mission") then
		NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.orockle.say_2")
		npcHandler:setTopic(playerId, 2)

	elseif MsgContains(message, "yes") then
		if npcHandler:getTopic(playerId) == 2 then
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.orockle.say_3")
			npcHandler:setTopic(playerId, 0)
		end
	end
--]]
