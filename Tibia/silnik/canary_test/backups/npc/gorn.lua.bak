...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "football") then
		NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.gorn.say_1")
		npcHandler:setTopic(playerId, 1)
	elseif MsgContains(message, "yes") then
		if npcHandler:getTopic(playerId) == 1 then
			local player = Player(creature)
			if player:getMoney() + player:getBankBalance() >= 111 then
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.gorn.say_2")
				player:addItem(2990, 1)
				player:removeMoneyBank(111)
			else
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.gorn.say_3")
			end
...
-- Basic
keywordHandler:addKeyword({ "job" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.gorn.stdmod_1" })
keywordHandler:addKeyword({ "king" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.gorn.stdmod_2" })
keywordHandler:addAliasKeyword({ "tibianus" })
keywordHandler:addKeyword({ "magic" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.gorn.stdmod_3" })
keywordHandler:addKeyword({ "name" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.gorn.stdmod_4" })
keywordHandler:addKeyword({ "time" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.gorn.stdmod_5" })
keywordHandler:addKeyword({ "druids" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.gorn.stdmod_6" })
keywordHandler:addKeyword({ "knights" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.gorn.stdmod_7" })
keywordHandler:addKeyword({ "sorcerers" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.gorn.stdmod_8" })
keywordHandler:addKeyword({ "elane" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.gorn.stdmod_9" })
keywordHandler:addKeyword({ "baxter" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.gorn.stdmod_10" })
keywordHandler:addKeyword({ "bozo" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.gorn.stdmod_11" })
keywordHandler:addKeyword({ "frodo" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.gorn.stdmod_12" })
keywordHandler:addKeyword({ "ferumbras" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.gorn.stdmod_13" })
keywordHandler:addKeyword({ "gregor" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.gorn.stdmod_14" })
keywordHandler:addKeyword({ "lynda" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.gorn.stdmod_15" })
keywordHandler:addKeyword({ "mcronald" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.gorn.stdmod_16" })
keywordHandler:addKeyword({ "muriel" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.gorn.stdmod_17" })
keywordHandler:addKeyword({ "oswald" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.gorn.stdmod_18" })
