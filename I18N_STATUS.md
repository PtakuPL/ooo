...
> **Aktualizacja:** 2025-12-11 01:35:19 UTC  
...
| 🌐 Pozostałe (0/53) | 🔄 | 735683 | Aktualnie: MK |
...
│ Kategoria: 🌍 MK/scripts.json                        │
├─────────────────────────────────────────────────────────────────┤
│ 📊 Ostatnia aktywność: MK/scripts.json                                │
│ [█████████████████████████████████████████████████░] │
│ 28501/28550 kluczy (100%)                                          │
├─────────────────────────────────────────────────────────────────┤
│ ⏳ Total processed: 30712 operacji               │
│ 🌍 Języki zsync: 0/53                                │
│ 📅 Ostatnia aktualizacja: 2025-12-11 01:35:19                 │
└─────────────────────────────────────────────────────────────────┘
```
...
- 🌍 `MK/scripts.json` +28501 kluczy @ 01:35:19
...
|-----------|--------|--------------|-----------|--------|
| items | 13749 | 11689 | 4 | ⏭️ Skip 33m |
| monsters | 7341 | 9549 | 4 | ⏭️ Skip 33m |
| npc | 5334 | 2 | 0 | ✅ Active |
| html | 1495 | 3245 | 4 | ⏭️ Skip 38m |
| scripts | 385 | 0 | 4 | ⏭️ Skip 32m |
| raids | 147 | 351 | 4 | ⏭️ Skip 33m |
| startup | 23 | 23 | 4 | ⏭️ Skip 34m |
| libs | 21 | 53 | 4 | ⏭️ Skip 33m |
| modules | 16 | 16 | 4 | ⏭️ Skip 34m |
| spells | 15 | 0 | 0 | ✅ Active |
| messages | 11 | 0 | 0 | ✅ Active |
| chatchannels | 8 | 8 | 4 | ⏭️ Skip 33m |
| events | 5 | 5 | 4 | ⏭️ Skip 33m |
| actions | 0 | 0 | 0 | ⏳ Empty |
| client | 0 | 821 | 6 | ⏭️ Skip 114m |
| cpp | 0 | 0 | 0 | ⏳ Empty |
| errors | 0 | 0 | 0 | ⏳ Empty |
| npclib | 0 | 0 | 4 | ⏭️ Skip 34m |
| php | 0 | 4521 | 8 | ⏭️ Skip 114m |
| quests | 0 | 0 | 0 | ⏳ Empty |
| server | 0 | 0 | 0 | ⏳ Empty |
| ui | 0 | 0 | 0 | ⏳ Empty |
| world | 0 | 0 | 4 | ⏭️ Skip 33m |
...
|-----------|----------------|-----------|-------|
| scripts | 32m | 4x | Progresywny backoff |
| monsters | 33m | 4x | Progresywny backoff |
| raids | 33m | 4x | Progresywny backoff |
| world | 33m | 4x | Progresywny backoff |
| items | 33m | 4x | Progresywny backoff |
| libs | 33m | 4x | Progresywny backoff |
| events | 33m | 4x | Progresywny backoff |
| chatchannels | 33m | 4x | Progresywny backoff |
| modules | 34m | 4x | Progresywny backoff |
| startup | 34m | 4x | Progresywny backoff |
| npclib | 34m | 4x | Progresywny backoff |
| php | 114m | 8x | Progresywny backoff |
| html | 38m | 4x | Progresywny backoff |
| client | 114m | 6x | Progresywny backoff |
| sendtextmessage | 38m | 4x | Progresywny backoff |
| keywordhandler | 38m | 4x | Progresywny backoff |
| twig | 38m | 4x | Progresywny backoff |
...
📅 Auto-updated by Worker v1.1 | Last: 2025-12-11 01:35:19  
