...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "svargrond") or MsgContains(message, "passage") then
		NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nilsor.travel_ask")
	...
	if MsgContains(message, "mission") then
		if player:getStorageValue(Storage.Quest.U8_0.TheIceIslands.Questline) == 20 then
			NPC_LIB.i18n.npcSayMultiple(npcHandler, npc, creature, {
				"npc.nilsor.mission_intro_1",
				"npc.nilsor.mission_intro_2",
				"npc.nilsor.mission_intro_3",
			}, 2000)
			npcHandler:setTopic(playerId, 1)
		elseif player:getStorageValue(Storage.Quest.U8_0.TheIceIslands.Questline) == 28 then
			NPC_LIB.i18n.npcSayMultiple(npcHandler, npc, creature, {
				"npc.nilsor.mission_complete_1",
				"npc.nilsor.mission_complete_2",
			}, 2000)
		...
		elseif player:getStorageValue(Storage.Quest.U8_0.TheIceIslands.Questline) > 20 and player:getStorageValue(Storage.Quest.U8_0.TheIceIslands.Questline) < 28 then
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nilsor.mission_progress")
			npcHandler:setTopic(playerId, 0)
		else
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nilsor.no_mission")
			npcHandler:setTopic(playerId, 0)
		end
	elseif MsgContains(message, "waterskin") then
		NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nilsor.waterskin_ask")
		npcHandler:setTopic(playerId, 2)
	elseif MsgContains(message, "cactus") then
		if player:getStorageValue(Storage.Quest.U8_0.TheIceIslands.Questline) == 21 then
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nilsor.cactus_info")
			npcHandler:setTopic(playerId, 3)
		end
	elseif MsgContains(message, "water") then
		if player:getStorageValue(Storage.Quest.U8_0.TheIceIslands.Questline) == 22 then
			NPC_LIB.i18n.npcSayMultiple(npcHandler, npc, creature, {
				"npc.nilsor.water_info_1",
				"npc.nilsor.water_info_2",
			}, 2000)
	...
	elseif MsgContains(message, "sulphur") then
		if player:getStorageValue(Storage.Quest.U8_0.TheIceIslands.Questline) == 23 then
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nilsor.sulphur_info")
			npcHandler:setTopic(playerId, 5)
		end
	elseif MsgContains(message, "herb") then
		if player:getStorageValue(Storage.Quest.U8_0.TheIceIslands.Questline) == 24 then
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nilsor.herb_info")
	...
	elseif MsgContains(message, "blossom") then
		if player:getStorageValue(Storage.Quest.U8_0.TheIceIslands.Questline) == 25 then
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nilsor.blossom_info")
	...
	elseif MsgContains(message, "hydra tongue") then
		if player:getStorageValue(Storage.Quest.U8_0.TheIceIslands.Questline) == 26 then
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nilsor.hydra_tongue_info")
			npcHandler:setTopic(playerId, 8)
		end
	elseif MsgContains(message, "spores") then
		if player:getStorageValue(Storage.Quest.U8_0.TheIceIslands.Questline) == 27 then
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nilsor.spores_info")
			npcHandler:setTopic(playerId, 9)
		end
	elseif MsgContains(message, "yes") then
		if npcHandler:getTopic(playerId) == 1 then
			NPC_LIB.i18n.npcSayMultiple(npcHandler, npc, creature, {
				"npc.nilsor.mission_accept_1",
				"npc.nilsor.mission_accept_2",
				"npc.nilsor.mission_accept_3",
			}, 2000)
		...
		elseif npcHandler:getTopic(playerId) == 2 then
			if player:getMoney() + player:getBankBalance() >= 25 then
				...
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nilsor.waterskin_given")
				player:addItem(7286, 1)
			else
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nilsor.not_enough_money")
			end
			npcHandler:setTopic(playerId, 0)
		elseif npcHandler:getTopic(playerId) == 3 then
			if player:removeItem(7245, 1) then
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nilsor.thanks_cactus")
				...
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nilsor.comeback")
			end
			npcHandler:setTopic(playerId, 0)
		elseif npcHandler:getTopic(playerId) == 4 then
			if player:removeItem(7246, 1) then
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nilsor.thanks_water")
		...
		elseif npcHandler:getTopic(playerId) == 5 then
			if player:removeItem(7247, 1) then
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nilsor.thanks_sulphur")
		...
		elseif npcHandler:getTopic(playerId) == 6 then
			if player:removeItem(7248, 1) then
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nilsor.thanks_herb")
		...
		elseif npcHandler:getTopic(playerId) == 7 then
			if player:removeItem(7249, 1) then
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nilsor.thanks_blossom")
		...
		elseif npcHandler:getTopic(playerId) == 8 then
			if player:removeItem(7250, 1) then
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nilsor.thanks_hydra")
		...
		elseif npcHandler:getTopic(playerId) == 9 then
			if player:removeItem(7251, 1) then
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nilsor.thanks_spores")
	...
	elseif MsgContains(message, "no") then
		if npcHandler:getTopic(playerId) >= 2 then
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nilsor.no_ingredient")
		end
	end
	return true
end
