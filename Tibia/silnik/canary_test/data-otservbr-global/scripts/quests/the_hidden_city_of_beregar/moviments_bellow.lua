...
function bellow.onStepIn(creature, item, position, fromPosition)
	...
	elseif crucibleItem.actionid == 50121 then
		player:sayLocalized("scripts.moviments_bellow.say_2", TALKTYPE_MONSTER_SAY, false, 0, Position(32695, 31494, 11))
		player:sayLocalized("scripts.moviments_bellow.say_1", TALKTYPE_MONSTER_SAY, false, 0, Position(32698, 31492, 11))
	end
	return true
end
