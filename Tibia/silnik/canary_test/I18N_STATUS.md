...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.78%**. Tempo: **667.8 kluczy/h**. Tłumaczeń netto: **111,846**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-19 21:31:21

> **Aktualizacja:** 2026-02-19 21:31:21 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #2 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: it | Plik: client.json | Heartbeat: 2026-02-19T21:31:20Z  
> **Okno godzinowe:** okno=1.0h | cykli=70 | pominięte=0.0% | odrzucone=38.9% | przepustowość=667.8/h  
> **Tłumaczeń netto:** 111,846

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-19 21:31:21 |
| LIVE | 🟢 AKTYWNY | 6s temu | - | `activity.json / worker_state.json` | 2026-02-19T21:31:20Z |
| MIGRATION | 🔒 NIEAKTYWNY | 2d temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-19 21:31:21 |
| TRANSLATION | 🟢 AKTYWNY | 3min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-19T21:27:44.989509Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-19T21:31:25.895826Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-19 21:31:21 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-19T21:31:20Z
...
| ❤️ **Heartbeat** | 2026-02-19T21:31:20Z |
...
> **ETA globalne:** ~141 dni (2,263,152 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| PL | █████████████████░░░ | 87.4% | 46,855/53,586 | ~6h |
| ES | ████████████████░░░░ | 84.4% | 45,239/53,586 | ~8h |
| IT | ██████████░░░░░░░░░░ | 50.6% | 27,109/53,586 | ~36h |
| RU | ██████████░░░░░░░░░░ | 50.3% | 26,963/53,586 | ~36h |
| SR | █████████░░░░░░░░░░░ | 45.4% | 24,316/53,586 | ~40h |
| RO | ████████░░░░░░░░░░░░ | 41.6% | 22,288/53,586 | ~43h |
...
> Świeżość: 2d temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-19 21:31:21
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-19T21:27:44.989509Z
...
- Raporty strażnika jakości: **6473**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3597**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **13.78%** (383,960/2,786,472)
- **Kopie EN (łącznie):** **162,265**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-19T20:31:21.760101Z → 2026-02-19T21:31:21.760101Z) |
...
| Przepustowość (kluczy/h) | **667.8 kluczy/h** |
| Podejrzane tłumaczenia | **2382** |
| Najgorsze cele (strażnik) | pl/books.json (gf=50), es/books.json (gf=48), ru/raids.json (gf=45), sv/spells.json (gf=44), es/talkactions.json (gf=43) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-19T21:31:25.895826Z

- **Ostatni audyt:** SLOW_MODE | 17 issue(s) / 100 entries | 2026-02-19T21:28:41.299043Z
- **Top 5 typów problemów:** suspicious_rejected_critical=175, suspicious_log_critical=88, suspicious_log_high=88, suspicious_rejected_high=25, suspicious_log_low=24
- **Języki o najsłabszej jakości:** es(60.1, issues=309220), ro(60.1, issues=169933), tl(64.2, issues=466), ru(64.4, issues=206752), zh_TW(64.8, issues=337)
...
⚠️ **PL**: jakość 65%, 175857 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 309220 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 75%, 68342 problemów
⚠️ **RU**: jakość 64%, 206752 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 65%, 29008 problemów
...
| Heartbeat | 6s temu | 2026-02-19T21:31:20Z |
...
- 2026-02-19 21:31:20 | AUTO_TRANSLATE:heartbeat_tick | it | ok | client.json
- 2026-02-19 21:31:20 | AUTO_TRANSLATE:auto_start | it | ok | client.json
- 2026-02-19 21:28:04 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-19 21:27:37 | AUTO_TRANSLATE:heartbeat_tick | es | ok | startup.json
- 2026-02-19 21:27:35 | AUTO_TRANSLATE:parallel_start | es | ok | startup.json
- 2026-02-19 21:27:21 | AUTO_TRANSLATE:heartbeat_tick | es | ok | libs.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.4% | 0 | 1,813 | 244 | 1734 (87.7%) | 31 |
| 🟡 ES | 84.4% | 0 | 2,152 | 262 | 748 (74.1%) | 33 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **111,846** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=50.81%, reason=decrease_high_fail_rate=50.8% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 506 kluczy / 64 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-19 21:31:21
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-19 21:31:21  
