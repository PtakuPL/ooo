...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.9% / real 10.82%**. Tempo: **807.0 kluczy/h**. Tłumaczeń netto: **138,271**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 00:09:00

> **Aktualizacja:** 2026-04-29 00:09:00 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,364 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: server.json | Heartbeat: 2026-04-29T00:06:25Z
> **Okno godzinowe:** okno=1.0h | cykli=87 | pominięte=0.0% | odrzucone=4.4% | przepustowość=807.0/h  
> **Tłumaczeń netto:** 138,271

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 00:09:00 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T00:06:25Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 52s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 00:09:00 |
| TRANSLATION | 🟢 AKTYWNY | 59s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T00:08:06.418666Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T00:06:24.945667Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 00:09:00 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T00:09:05.617450Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T00:06:25Z
...
| 🔄 **Ostatni cykl** | 25 kluczy, 0 odrzuconych, 81.0s, tryb: AUTO_TRANSLATE, cel: es/items.json |
| ❤️ **Heartbeat** | 2026-04-29T00:06:25Z |
...
| ⏳ Oldest pending (visible tail) | 16772 s |
...
| 🌍 Recent provider mix | TM/simple(278), Free Google Translate(208), canonical_name_semantic_autofix(21), term_consistency_autofix(3) |
| 🔁 Latest fallback | TM/simple → fallback to google translate high [high_reject_types] server.json |
| 📉 Fallback breakdown | fallback to google translate high(11), fallback to next provider validate fail(10), fallback to google tran... |
...
| ❤️ Pool health | `critical` (writes=510, fallbacks=23) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=446/446 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 390, 'oldest_s': 16772}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| 🔔 Open alarms | 10 |
| 🆕 Newly opened (cycle) | - |
| ✅ Resolved (cycle) | PROVIDER_BUDGET_80PCT |
...
> **ETA globalne:** ~154 dni (2,988,173 kluczy do celu 95%)
...
> Świeżość: 52s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 00:09:00
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 59s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T00:08:06.418666Z
...
- unknown item → artículo desconocido (item.11132.name)
- unknown item → artículo desconocido (item.11133.name)
- unknown item → artículo desconocido (item.11134.name)
- unknown item → artículo desconocido (item.11135.name)
- corrupted wall → muro corrompido (item.11202.name)
- corrupted wall → muro corrompido (item.11203.name)
- corrupted wall → muro corrompido (item.11204.name)
- corrupted wall → muro corrompido (item.11205.name)
- corrupted wall → muro corrompido (item.11206.name)
- corrupted wall → muro corrompido (item.11207.name)
- dragon spike → pico de dragón (item.11153.name)
- dragon spike → pico de dragón (item.11154.name)
- dragon spike → pico de dragón (item.11155.name)
- decorative spear → lanza decorativa (item.11182.name)
- decorative spear → lanza decorativa (item.11183.name)
- decorative spear → lanza decorativa (item.11184.name)
- decorative spear → lanza decorativa (item.11185.name)
...
- Raporty strażnika jakości: **4688**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4541**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T00:06:44.818904Z |
...
| 🕒 Evidence window | 24h (span=29.28h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=29.28h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-28T23:09:00.411543Z → 2026-04-29T00:09:00.411543Z) |
...
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T00:06:24.945667Z
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,364 |
| Heartbeat | 160s temu | 2026-04-29T00:06:25Z |
...
- 2026-04-29 00:08:24 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-29 00:08:06 | AUTO_TRANSLATE:auto_done | es | ok | items.json
- 2026-04-29 00:06:45 | AUTO_TRANSLATE:heartbeat_tick | es | ok | items.json
- 2026-04-29 00:06:45 | AUTO_TRANSLATE:auto_start | es | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 00:09:00

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+25, skipped+0) — lang=es file=items.json strict_skipped_done=1003
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+282, skipped+0) — lang=it file=items.json strict_skipped_done=15461 guard_fail=26 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+0) — repair_identical lang=es file=otclient_modules.json target_identical=37 limit=180 tier=low_backlog domain_cap=220 gt=true suspicious_pct=6.81
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+1, skipped+0) — lang=pl file=quests.json strict_skipped_done=609 guard_fail=2 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+23, skipped+0) — lang=pl file=otclient_modules.json strict_skipped_done=2008 guard_fail=4 placeholder=0 command=0 pipe=0
...
| ❌ Błędów | 5 |
| 🌍 Aktywnych języków | 3 |
| 🏆 TOP 5 | **RO** (39), **IT** (30), **ES** (29) |
| 📊 Porównanie | ↓ 98.8% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **19,078** kluczy
...
| 🔄 Cykli wykonanych | **#17,364** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,364 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 00:09:00  
