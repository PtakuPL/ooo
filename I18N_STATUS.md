...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-19 14:15:10

> **Aktualizacja:** 2026-02-19 14:15:10 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #1 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ru | Plik: movements.json | Heartbeat: 2026-02-19T14:15:08Z  
...
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-19 14:15:10 |
| LIVE | 🟢 AKTYWNY | 6s temu | - | `activity.json / worker_state.json` | 2026-02-19T14:15:08Z |
| MIGRATION | 🔒 NIEAKTYWNY | 2d temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-19 14:15:10 |
| TRANSLATION | 🟢 AKTYWNY | 8s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-19T14:15:05.700472Z |
| QUALITY | 🔒 NIEAKTYWNY | 33s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-19T14:14:41.342948Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-19 14:15:10 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-19T14:15:08Z
...
| ❤️ **Heartbeat** | 2026-02-19T14:15:08Z |
...
> Świeżość: 2d temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-19 14:15:10
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 8s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-19T14:15:05.700472Z
...
- Raporty strażnika jakości: **5116**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3513**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-19T13:15:10.331664Z → 2026-02-19T14:15:10.331664Z) |
...
| Najgorsze cele (strażnik) | ro/achievements.json (gf=0), it/talkactions.json (gf=0), ru/talkactions.json (gf=0), ro/otclient_data.json (gf=0), sv/spells.json (gf=0) |
...
> Świeżość: 33s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-19T14:14:41.342948Z

- **Ostatni audyt:** SLOW_MODE | 31 issue(s) / 100 entries | 2026-02-19T14:14:41.342948Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=277417), pl(60.1, issues=157496), ro(60.1, issues=119190), ru(60.1, issues=116002), sr(60.1, issues=63066)
...
⚠️ **PL**: jakość 60%, 157496 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 277417 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 46221 problemów
⚠️ **RU**: jakość 60%, 116002 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 90%, 26155 problemów
...
| Heartbeat | 6s temu | 2026-02-19T14:15:08Z |
...
- 2026-02-19 14:15:08 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | movements.json
- 2026-02-19 14:15:08 | AUTO_TRANSLATE:parallel_start | ru | ok | movements.json
- 2026-02-19 14:15:05 | AUTO_TRANSLATE:auto_done | it | ok | globalevents.json
- 2026-02-19 14:15:02 | AUTO_TRANSLATE:heartbeat_tick | it | ok | globalevents.json
- 2026-02-19 14:15:02 | AUTO_TRANSLATE:auto_start | it | ok | globalevents.json
- 2026-02-19 14:14:36 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | globalevents.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-19 14:15:10
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-19 14:15:10  
