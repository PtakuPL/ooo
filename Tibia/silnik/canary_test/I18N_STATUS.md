...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.86%**. Tempo: **1729.7 kluczy/h**. Tłumaczeń netto: **118,880**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 19:03:51

> **Aktualizacja:** 2026-02-20 19:03:51 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #84 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: - | Heartbeat: 2026-02-20T19:03:47Z  
> **Okno godzinowe:** okno=1.0h | cykli=205 | pominięte=0.0% | odrzucone=70.9% | przepustowość=1729.7/h  
> **Tłumaczeń netto:** 118,880

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 19:03:51 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T19:03:47Z |
| MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 19:03:51 |
| TRANSLATION | 🟢 AKTYWNY | 37s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T19:03:14.876627Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T19:03:52.219471Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 19:03:51 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T19:03:47Z
...
| ❤️ **Heartbeat** | 2026-02-20T19:03:47Z |
...
> **ETA globalne:** ~54 dni (2,260,922 kluczy do celu 95%)
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 19:03:51
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 37s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T19:03:14.876627Z
...
| RO (Rumuński) | 22,964/53,586 | 42.85% | 2,351 | 0 |
...
| RO | 21,698/49,731 | 43.6% | 1,266/3,855 | 32.8% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T18:03:51.542236Z → 2026-02-20T19:03:51.542236Z) |
...
| Przepustowość (kluczy/h) | **1729.7 kluczy/h** |
| Podejrzane tłumaczenia | **3110** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T19:03:52.219471Z

- **Ostatni audyt:** SLOW_MODE | 29 issue(s) / 100 entries | 2026-02-20T19:03:47.414361Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_log_high=64, suspicious_rejected_critical=64, suspicious_log_critical=41, artifact_token=16, identical_to_en=13
- **Języki o najsłabszej jakości:** es(60.1, issues=330108), pl(60.1, issues=185104), ro(60.1, issues=180860), sr(61.3, issues=86259), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 60%, 185104 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 330108 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 84%, 73359 problemów
⚠️ **RU**: jakość 67%, 211455 problemów
...
| Heartbeat | 5s temu | 2026-02-20T19:03:47Z |
...
- 2026-02-20 19:03:21 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 19:02:57 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | monsters.json
- 2026-02-20 19:02:57 | AUTO_TRANSLATE:parallel_start | ro | ok | monsters.json
- 2026-02-20 19:02:52 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | monsters.json
- 2026-02-20 19:02:51 | AUTO_TRANSLATE:parallel_start | ru | ok | monsters.json
- 2026-02-20 19:02:50 | AUTO_TRANSLATE:auto_done | it | ok | monsters.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,829 | 585 | 6760 (92.0%) | 35 |
| 🟡 ES | 84.8% | 0 | 2,160 | 710 | 2978 (80.7%) | 39 |
...
| Przepustowość (okno) | 1,295 kluczy / 74 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 19:03:51
...
| ❌ Błędów | 206 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (2,673), **RU** (1,817), **IT** (1,550), **RO** (1,134), **PL** (1,002) |
| 📊 Porównanie | ↑ 152.2% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **106,768** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 19:03:51  
