...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.07% / real 11.0%**. Tempo: **877.2 kluczy/h**. Tłumaczeń netto: **150,461**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 16:50:38

> **Aktualizacja:** 2026-04-29 16:50:38 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,675 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: auto_done | Kategoria: es | Plik: items.json | Heartbeat: 2026-04-29T16:48:30Z
> **Okno godzinowe:** okno=1.0h | cykli=42 | pominięte=0.0% | odrzucone=0.6% | przepustowość=877.2/h  
> **Tłumaczeń netto:** 150,461

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 16:50:38 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T16:48:30Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 31s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 16:50:38 |
| TRANSLATION | 🟢 AKTYWNY | 21s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T16:50:27.100050Z |
| QUALITY | 🔒 NIEAKTYWNY | 19s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T16:50:28.489437Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 16:50:38 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T16:50:48.207402Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T16:48:30Z
...
| 🧭 **Surface** | Serwer |
| 📊 **Status** | 🟢 DZIAŁA |
| 📈 **Postęp** | █████████████████████████████████ 25/15 keys (166.7%) |
| 🔧 **Metoda** | Google Translate + TM fallback |
| 🧠 **Detail** | translated=25 guard_fail=0 strict_missing_key=0 strict_skipped_done=2162 |
| 🔑 **Current key** | `es:items.json` |
| 🔄 **Ostatni cykl** | 25 kluczy, 0 odrzuconych, 117.0s, tryb: AUTO_TRANSLATE, cel: es/items.json |
| ❤️ **Heartbeat** | 2026-04-29T16:48:30Z |
...
| ⏳ Oldest pending (visible tail) | 16938 s |
...
| ♻️ Deferred stats | enqueued=0, cooldown=0, deduped=0, manual_review=43, partial_staged=0, partial_completed=0 |
...
| ♻️ Provider debt | `56` |
| 🌍 Recent provider mix | TM/simple(293), Free Google Translate(156), OpenAI model pool(69), canonical_name_semantic_autofix(18), ter... |
| 🔁 Latest fallback | TM/simple → fallback to google translate high [high_reject_types] npc.json |
| 📉 Fallback breakdown | fallback to google translate high(15) |
...
| ❤️ Pool health | `critical` (writes=539, fallbacks=15) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=1093/1093 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 399, 'oldest_s': 16938}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
|---------|---------|
| 🔔 Open alarms | 14 |
| 🆕 Newly opened (cycle) | DISPATCH_STALE, NO_PID_FILE, NO_RUNTIME_PID, WORKER_PROCESS_WATCH_UNAVAILABLE, WORKER_TRANSLA... |
| ✅ Resolved (cycle) | - |
...
> Świeżość: 31s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 16:50:38
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 21s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T16:50:27.100050Z
...
- mill board → tablero de molino (item.1234.name)
- slime fungus → hongo de limo (item.12345.name)
- slime fungus → hongo de limo (item.12346.name)
- slime fungus → hongo de limo (item.12347.name)
- slime fungus → hongo de limo (item.12348.name)
- slime fungus → hongo de limo (item.12349.name)
- mill board → tablero de molino (item.1235.name)
- slime fungus → hongo de limo (item.12350.name)
...
- Raporty strażnika jakości: **5025**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4878**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T16:48:29.571628Z |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=24.00h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-0.74pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T15:50:39.478064Z → 2026-04-29T16:50:39.478064Z) |
...
| Przepustowość (kluczy/h) | **877.2 kluczy/h** |
| Podejrzane tłumaczenia | **1005** |
| Najgorsze cele (strażnik) | ru/items.json (gf=4), it/items.json (gf=0), de/otclient_modules.json (gf=0), de/npc.json (gf=0), tr/items.json (gf=0) |
...
> Świeżość: 19s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T16:50:28.489437Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=752738), ro(60.1, issues=447292), de(60.1, issues=129045), cs(60.1, issues=123474), fr(60.1, issues=60621)
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,675 |
| Heartbeat | 138s temu | 2026-04-29T16:48:30Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T16:50:20.651793Z
...
│ Plik: items.json                                              │
│ Postęp: 25/15 keys                                            │
│ …5 guard_fail=0 strict_missing_key=0 strict_skipped_done=2162 │
├─────────────────────────────────────────────────────────────────┤
│ ❤️ Heartbeat: 2026-04-29T16:48:30Z           │
└─────────────────────────────────────────────────────────────────┘
```
...
- 2026-04-29 16:48:30 | AUTO_TRANSLATE:heartbeat_tick | es | ok | items.json
- 2026-04-29 16:48:30 | AUTO_TRANSLATE:auto_start | es | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **150,461** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=0.53%, reason=increase_low_fail_rate=0.5%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 16:50:38
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **13,325** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 216 |
| ❌ Błędów | 586 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (2,371), **RU** (2,091), **TR** (2,075), **DE** (1,935), **IT** (1,848) |
| 📊 Porównanie | ↑ 61.9% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **32,305** kluczy
...
| 🔄 Cykli wykonanych | **#18,675** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,675 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 16:50:38  
