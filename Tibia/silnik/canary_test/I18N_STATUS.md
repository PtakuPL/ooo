...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-19 15:00:26

> **Aktualizacja:** 2026-02-19 15:00:26 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #1 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: pl | Plik: talkactions.json | Heartbeat: 2026-02-19T15:00:27Z  
...
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-19 15:00:26 |
| LIVE | 🟢 AKTYWNY | 2s temu | - | `activity.json / worker_state.json` | 2026-02-19T15:00:27Z |
| MIGRATION | 🔒 NIEAKTYWNY | 2d temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-19 15:00:26 |
| TRANSLATION | 🟢 AKTYWNY | 4s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-19T15:00:25.408037Z |
| QUALITY | 🔒 NIEAKTYWNY | 19s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-19T15:00:10.263949Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-19 15:00:26 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-19T15:00:27Z
...
| ❤️ **Heartbeat** | 2026-02-19T15:00:27Z |
...
> Świeżość: 2d temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-19 15:00:26
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 4s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-19T15:00:25.408037Z
...
- Raporty strażnika jakości: **5261**  
- Raporty blokad: **0**  
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-19T14:00:27.091083Z → 2026-02-19T15:00:27.091083Z) |
...
| Najgorsze cele (strażnik) | pl/modules.json (gf=0), es/php.json (gf=0), es/otclient_data.json (gf=0), pl/talkactions.json (gf=0), es/talkactions.json (gf=0) |
...
> Świeżość: 19s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-19T15:00:10.263949Z

- **Ostatni audyt:** SLOW_MODE | 31 issue(s) / 100 entries | 2026-02-19T15:00:10.263949Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=280817), pl(60.1, issues=159743), ru(60.1, issues=127544), ro(60.1, issues=125446), sr(60.1, issues=65869)
...
⚠️ **ES**: jakość 60%, 280817 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 48941 problemów
⚠️ **RU**: jakość 60%, 127544 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 90%, 26495 problemów
...
| Heartbeat | 2s temu | 2026-02-19T15:00:27Z |
...
- 2026-02-19 15:00:27 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | talkactions.json
- 2026-02-19 15:00:27 | AUTO_TRANSLATE:parallel_start | pl | ok | talkactions.json
- 2026-02-19 15:00:25 | AUTO_TRANSLATE:auto_done | es | ok | modules.json
- 2026-02-19 15:00:19 | AUTO_TRANSLATE:heartbeat_tick | es | ok | modules.json
- 2026-02-19 15:00:19 | AUTO_TRANSLATE:auto_start | es | ok | modules.json
- 2026-02-19 15:00:05 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-19 15:00:26
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-19 15:00:26  
