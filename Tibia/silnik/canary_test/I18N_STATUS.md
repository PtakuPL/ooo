...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.7% / real 11.67%**. Tempo: **288.0 kluczy/h**. Tłumaczeń netto: **168,802**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-05-02 04:48:20

> **Aktualizacja:** 2026-05-02 04:48:20 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #19,231 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: auto_done | Kategoria: it | Plik: items.json | Heartbeat: 2026-05-02T04:43:32Z
> **Okno godzinowe:** okno=1.0h | cykli=64 | pominięte=0.0% | odrzucone=0.0% | przepustowość=288.0/h  
> **Tłumaczeń netto:** 168,802

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-05-02 04:48:20 |
| LIVE | 🟢 AKTYWNY | 4min temu | - | `activity.json / worker_state.json` | 2026-05-02T04:43:32Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 19h temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-05-02 04:48:20 |
| TRANSLATION | 🟢 AKTYWNY | 11s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-05-02T04:48:16.248006Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-05-02T04:46:10.405718Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-05-02 04:48:20 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-05-02T04:48:27.335638Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 4min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-05-02T04:43:32Z
...
| 🧭 **Surface** | Serwer |
| 📊 **Status** | 🟢 DZIAŁA |
| 📈 **Postęp** | ████░░░░░░░░░░░░░░░░ 7/30 keys (23.3%) |
| 🔧 **Metoda** | Google Translate + TM fallback |
| 🧠 **Detail** | auto translate in progress |
| 🔑 **Current key** | `it:items.json` |
| 🔄 **Ostatni cykl** | 7 kluczy, 0 odrzuconych, 118.0s, tryb: AUTO_TRANSLATE, cel: it/items.json |
...
| ⏳ Oldest pending (visible tail) | 121067 s |
...
| 🧮 OpenAI budget | `80/250 (31.2%); policy=telemetry_only` |
| ♻️ Provider debt | `767` |
| 🌍 Recent provider mix | tm_dedup_file(99), OpenAI model pool(96), canonical_name_semantic_autofix(19), tm_dedup_propagate(15), term... |
...
| ❤️ Pool health | `degraded` (writes=230, fallbacks=31) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=140/140 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 393, 'oldest_s': 121067}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 19h temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-05-02 04:48:20
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 11s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-05-02T04:48:16.248006Z
...
- Raporty strażnika jakości: **5164**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **5016**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-05-02T04:46:17.370221Z |
...
| 🕒 Evidence window | 24h (span=32.25h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=32.25h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=+0.00pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-05-02T03:48:20.783976Z → 2026-05-02T04:48:20.783976Z) |
...
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-05-02T04:46:10.405718Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-05-02T04:46:10.405718Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=761166), ro(60.1, issues=456733), ru(60.1, issues=386045), de(60.1, issues=139374), cs(60.1, issues=138279)
...
⚠️ **TR**: jakość 60%, 62382 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 761166 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 86%, 182196 problemów
⚠️ **RU**: jakość 60%, 386045 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #19,231 |
| Heartbeat | 295s temu | 2026-05-02T04:43:32Z |
...
│ Plik: items.json                                              │
│ Postęp: 7/30 keys                                             │
│ …7 guard_fail=0 strict_missing_key=0 strict_skipped_done=4682 │
├─────────────────────────────────────────────────────────────────┤
│ ❤️ Heartbeat: 2026-05-02T04:43:32Z           │
└─────────────────────────────────────────────────────────────────┘
```
...
- 2026-05-02 04:48:16 | AUTO_TRANSLATE:auto_done | it | ok | items.json
- 2026-05-02 04:47:48 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-05-02 04:46:18 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-05-02 04:46:18 | AUTO_TRANSLATE:auto_start | it | ok | items.json
- 2026-05-02 04:46:09 | AUTO_TRANSLATE:auto_done | cs | ok | items.json
...
| 🟡 ES | 79.9% | 0 | 9,501 | 1,091 | 0 (0.0%) | 26 |
...
| Przepustowość (okno) | 1,091 kluczy / 26 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-05-02 04:48:20
...
| 🔄 Cykli wykonanych | **#19,231** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #19,231 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-05-02 04:48:20  
