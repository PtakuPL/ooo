...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **9.92%**. Tempo: **3312.7 kluczy/h**. Tłumaczeń netto: **70,837**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-16 20:47:27

> **Aktualizacja:** 2026-02-16 20:47:27 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #24 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: sr | Plik: server.json | Heartbeat: 2026-02-16T20:47:22Z  
> **Okno godzinowe:** okno=1.0h | cykli=93 | pominięte=0.0% | odrzucone=15.4% | przepustowość=3312.7/h  
> **Tłumaczeń netto:** 70,837

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-16 20:47:27 |
| LIVE | 🟢 AKTYWNY | 6s temu | - | `activity.json / worker_state.json` | 2026-02-16T20:47:22Z |
| MIGRATION | 🔒 NIEAKTYWNY | 35min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-16 20:47:27 |
| TRANSLATION | 🟢 AKTYWNY | 1s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-16T20:47:27.286621Z |
| QUALITY | 🔒 NIEAKTYWNY | 0s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-16T20:47:28.323237Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-16 20:47:27 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-16T20:47:22Z
...
| ❤️ **Heartbeat** | 2026-02-16T20:47:22Z |
...
| ⚡ Przepustowość | ~3313 kluczy/h |
| 🛡️ Guard fail rate | 15.4% |
| ⚠️ Podejrzane | 10106 |
...
> **ETA globalne:** ~30 dni (2,370,753 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ██████████████░░░░░░ | 73.3% | 39,284/53,586 | ~4h |
| PL | ████████░░░░░░░░░░░░ | 42.5% | 22,754/53,586 | ~8h |
...
> Tempo obliczone na bazie ostatniej godziny: ~3313 kluczy/h.
...
> Świeżość: 35min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-16 20:47:27
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-16T20:47:27.286621Z
...
- Good bye. → Збогом. (data.otservbr.global.npc.dalbrect.L186.167)
- Good bye. → Збогом. (data.otservbr.global.npc.duncan.L185.163)
- Good bye. → Збогом. (data.otservbr.global.npc.eleonore.L146.244)
- Good bye. → Збогом. (data.otservbr.global.npc.galuna.L60.1205)
- Good bye. → Збогом. (data.otservbr.global.npc.galuna.L61.1206)
- Good bye. → Збогом. (data.otservbr.global.npc.gamon.L77.378)
- Good bye. → Збогом. (data.otservbr.global.npc.gorn.L110.59)
- Good bye. → Збогом. (data.otservbr.global.npc.gorn.L111.60)
- Good bye and don't forget me! → Збогом и не заборави ме! (data.otservbr.global.npc.graubart.L64.178)
- Good bye. → Збогом. (data.otservbr.global.npc.guide.alexena.L105.1376)
- Good bye. → Збогом. (data.otservbr.global.npc.guide.behil.L103.613)
- Good bye. → Збогом. (data.otservbr.global.npc.guide.davina.L104.1065)
- Good bye. → Збогом. (data.otservbr.global.npc.guide.edna.L101.148)
- Good bye. → Збогом. (data.otservbr.global.npc.guide.elena.L108.12)
- Good bye. → Збогом. (data.otservbr.global.npc.guide.jonathan.L103.402)
- Good bye. → Збогом. (data.otservbr.global.npc.guide.kunibert.L102.836)
- Good bye. → Збогом. (data.otservbr.global.npc.guide.luke.L104.467)
- Good bye. → Збогом. (data.otservbr.global.npc.guide.rahlkora.L105.1326)
- Good bye. → Збогом. (data.otservbr.global.npc.guide.thelandil.L100.628)
- Good bye. → Збогом. (data.otservbr.global.npc.guide.tiko.L104.801)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **2157**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2095**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **9.92%** (276,359/2,786,472)
- **Kopie EN (łącznie):** **167,879**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-16T19:47:28.226436Z → 2026-02-16T20:47:28.226436Z) |
...
| Przepustowość (kluczy/h) | **3312.7 kluczy/h** |
| Podejrzane tłumaczenia | **10106** |
...
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-16T20:47:28.323237Z

- **Ostatni audyt:** OK | 7 issue(s) / 100 entries | 2026-02-16T20:47:28.323237Z
- **Top 5 typów problemów:** suspicious_log_high=103, suspicious_log_critical=97, suspicious_rejected_critical=33, suspicious_rejected_high=13, identical_to_en_exempt=11
- **Języki o najsłabszej jakości:** es(60.1, issues=147886), sv(64.0, issues=989), tl(64.2, issues=466), zh_TW(64.8, issues=337), fr(65.2, issues=2470)
...
⚠️ **PL**: jakość 71%, 113359 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 147886 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 69%, 3199 problemów
⚠️ **RU**: jakość 67%, 5645 problemów
...
| Heartbeat | 6s temu | 2026-02-16T20:47:22Z |
...
- 2026-02-16 20:47:22 | AUTO_TRANSLATE:heartbeat_tick | sr | ok | server.json
- 2026-02-16 20:47:22 | AUTO_TRANSLATE:parallel_start | sr | ok | server.json
- 2026-02-16 20:47:13 | AUTO_TRANSLATE:heartbeat_tick | it | ok | server.json
- 2026-02-16 20:47:12 | AUTO_TRANSLATE:parallel_start | it | ok | server.json
- 2026-02-16 20:47:09 | AUTO_TRANSLATE:auto_done | ro | ok | server.json
- 2026-02-16 20:47:06 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | server.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **70,837** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=26.74%, reason=decrease_high_fail_rate=26.7% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-16 20:47:27
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **3,645** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 24 |
| ❌ Błędów | 31 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (624), **RU** (550), **IT** (538), **RO** (531), **SR** (489) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **83,551** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-16 20:47:27  
