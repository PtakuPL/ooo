...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.23%**. Tempo: **2385.2 kluczy/h**. Tłumaczeń netto: **83,226**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-16 23:51:32

> **Aktualizacja:** 2026-02-16 23:51:32 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #56 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: - | Heartbeat: 2026-02-16T23:51:28Z  
> **Okno godzinowe:** okno=1.0h | cykli=161 | pominięte=0.0% | odrzucone=34.5% | przepustowość=2385.2/h  
> **Tłumaczeń netto:** 83,226

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-16 23:51:32 |
| LIVE | 🟢 AKTYWNY | 6s temu | - | `activity.json / worker_state.json` | 2026-02-16T23:51:28Z |
| MIGRATION | 🔒 NIEAKTYWNY | 59s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-16 23:51:32 |
| TRANSLATION | 🟢 AKTYWNY | 21s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-16T23:51:12.865350Z |
| QUALITY | 🔒 NIEAKTYWNY | 5s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-16T23:51:28.552124Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-16 23:51:32 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-16T23:51:28Z
...
| ❤️ **Heartbeat** | 2026-02-16T23:51:28Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **4,340** kluczy |
| ❌ Odrzucone (guard) | 2291 |
| 🔁 Cykli | 161 |
| 🌍 Języków | 7 |
...
| RU | 19,212 | 53,586 | 35.85% | 2,669 |
| FR | 17,711 | 53,586 | 33.05% | 4,028 |
| RO | 10,772 | 53,586 | 20.1% | 2,478 |
...
> Świeżość: 59s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-16 23:51:32
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 21s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-16T23:51:12.865350Z
...
| RU (Rosyjski) | 19,212/53,586 | 35.85% | 2,669 | 0 |
| FR (Francuski) | 17,711/53,586 | 33.05% | 4,028 | 0 |
| RO (Rumuński) | 10,772/53,586 | 20.10% | 2,478 | 0 |
...
- Raporty strażnika jakości: **2494**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2431**
...
| RU | 16,486/49,731 | 33.1% | 2,726/3,855 | 70.7% |
| FR | 15,164/49,731 | 30.5% | 2,547/3,855 | 66.1% |
| RO | 10,587/49,731 | 21.3% | 185/3,855 | 4.8% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-16T22:51:32.956679Z → 2026-02-16T23:51:32.956679Z) |
...
| Przepustowość (kluczy/h) | **2385.2 kluczy/h** |
| Podejrzane tłumaczenia | **14175** |
| Najgorsze cele (strażnik) | pl/items.json (gf=1025), pl/npc.json (gf=297), ru/raids.json (gf=100), pl/server.json (gf=86), pl/scripts.json (gf=77) |
...
> Świeżość: 5s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-16T23:51:28.552124Z

- **Ostatni audyt:** SLOW_MODE | 23 issue(s) / 100 entries | 2026-02-16T23:51:28.552124Z
- **Top 5 typów problemów:** suspicious_rejected_critical=159, suspicious_log_high=104, suspicious_log_low=49, suspicious_log_critical=47, suspicious_rejected_high=41
- **Języki o najsłabszej jakości:** es(60.1, issues=165164), ru(60.1, issues=15875), ro(60.5, issues=16990), tl(64.2, issues=466), zh_TW(64.8, issues=337)
...
⚠️ **PL**: jakość 74%, 117196 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 165164 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 75%, 6132 problemów
⚠️ **RU**: jakość 60%, 15875 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 68%, 3450 problemów
...
| Heartbeat | 6s temu | 2026-02-16T23:51:28Z |
...
- 2026-02-16 23:51:19 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-16 23:51:10 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | raids.json
- 2026-02-16 23:51:10 | AUTO_TRANSLATE:parallel_start | ro | ok | raids.json
- 2026-02-16 23:50:42 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | raids.json
- 2026-02-16 23:50:42 | AUTO_TRANSLATE:parallel_start | ru | ok | raids.json
...
| 🟡 ES | 74.1% | 0 | 2,635 | 1,152 | 328 (22.2%) | 33 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-16 23:51:32
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **19,782** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 87 |
| ❌ Błędów | 211 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (3,900), **IT** (3,200), **RU** (2,925), **RO** (2,803), **SV** (2,344) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **99,688** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-16 23:51:32  
