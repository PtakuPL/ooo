...
keywordHandler:addKeyword({ "style" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.the_first_dragon.stdmod_3" })
keywordHandler:addKeyword({ "humans" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.the_first_dragon.stdmod_4" })
keywordHandler:addKeyword({ "concept" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.the_first_dragon.stdmod_5" })
keywordHandler:addKeyword({ "lava" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.the_first_dragon.stdmod_6" })
