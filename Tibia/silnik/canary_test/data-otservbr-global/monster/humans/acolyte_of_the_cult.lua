...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "Praise the voodoo!", yell = false , i18nKey = "monster.acolyte_of_the_cult.voice_1"},
	{ text = "Power to the cult!", yell = false , i18nKey = "monster.acolyte_of_the_cult.voice_2"},
	{ text = "Feel the power of the cult!", yell = false , i18nKey = "monster.acolyte_of_the_cult.voice_3"},
}
