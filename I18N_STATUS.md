...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.98% / real 10.9%**. Tempo: **949.0 kluczy/h**. Tłumaczeń netto: **143,654**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 06:47:14

> **Aktualizacja:** 2026-04-29 06:47:14 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,908 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: de | Plik: npc.json | Heartbeat: 2026-04-29T06:45:25Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=4.3% | przepustowość=949.0/h  
> **Tłumaczeń netto:** 143,654

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 06:47:14 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T06:45:25Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 24s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 06:47:14 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T06:46:14.548840Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T06:45:24.564198Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 06:47:14 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T06:47:20.533872Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T06:45:25Z
...
| ❤️ **Heartbeat** | 2026-04-29T06:45:25Z |
...
| 06:31:45 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 06:28:38 | RU | Serwer | items.json | 30 | `simple` | `item.13577.name` | рампа |
| 06:27:05 | TR | Serwer | items.json | 129 | `google_translate` | `item.12642.name` | gövde |
| 06:25:07 | ES | Serwer | server.json | 2 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
...
| 06:38:24 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10192.name` |
| 06:38:22 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10191.name` |
| 06:38:20 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10190.name` |
| 06:34:40 | IT | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 06:33:05 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.14077.name` |
| 06:33:05 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.14023.name` |
| 06:33:03 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.11586.name` |
| 06:33:01 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 06:33:00 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10456.name` |
| 06:32:58 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10338.name` |
| 06:32:56 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10026.name` |
| 06:30:42 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.say_2` |
| 06:28:07 | RU | Serwer | items.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `item.11541.name` |
...
| ⏳ Oldest pending (visible tail) | 17348 s |
| 🌍 Top języki | RU(398), CS(2) |
| 🧱 Top reason_bucket | quality(398), default(2) |
| 🗂️ Deferred state keys | 7952 |
...
| 🌍 Recent provider mix | TM/simple(330), Free Google Translate(148), canonical_name_semantic_autofix(18), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=499, fallbacks=21) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=750/750 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 17348}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| �📊 Przetłumaczono | **949** kluczy |
| ❌ Odrzucone (guard) | 43 |
| 🔁 Cykli | 84 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (222 kluczy) |
| 📄 Najczęstszy plik | items.json |
| ⚡ Przepustowość | ~949 kluczy/h |
...
> Tempo obliczone na bazie ostatniej godziny: ~949 kluczy/h.
...
> Świeżość: 24s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 06:47:14
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T06:46:14.548840Z
...
|-------|-----------|--------|----------|--------------|--------------|
| ES (Hiszpański) | 78.99% (58,875/74,536) | 67.83% (50,561/74,536) | 9,703 | 14,296 | 0 |
| PL (Polski) | 70.99% (52,911/74,536) | 65.08% (48,507/74,536) | 5,861 | 20,194 | 0 |
| IT (Włoski) | 70.23% (52,346/74,536) | 62.01% (46,222/74,536) | 10,028 | 18,311 | 0 |
| RO (Rumuński) | 69.73% (51,972/74,536) | 56.69% (42,253/74,536) | 13,005 | 19,303 | 0 |
| RU (Rosyjski) | 45.96% (34,256/74,536) | 44.39% (33,086/74,536) | 4,775 | 36,693 | 0 |
...
| CS (Czeski) | 50.40% (37,565/74,536) | 32.63% (24,319/74,536) | 29,858 | 20,385 | 0 |
...
| TR (Turecki) | 34.16% (25,458/74,536) | 30.67% (22,861/74,536) | 3,832 | 47,857 | 0 |
...
- Raporty strażnika jakości: **4825**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4678**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T06:45:48.667267Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.98%** (697,054/3,875,872)
- **Pokrycie globalne (real):** **10.9%** (422,640/3,875,872)
- **Kopie EN (łącznie):** **410,501**
- **Placeholdery [EN]/puste (łącznie):** **2,188,609**
...
| 🕒 Evidence window | 24h (span=35.92h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=35.92h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T05:47:14.488801Z → 2026-04-29T06:47:14.488801Z) |
...
| Przepustowość (kluczy/h) | **949.0 kluczy/h** |
| Podejrzane tłumaczenia | **1206** |
| Najgorsze cele (strażnik) | cs/items.json (gf=20), ro/items.json (gf=12), it/items.json (gf=3), de/otclient_modules.json (gf=3), de/npc.json (gf=3) |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 54 | 81.8% | ru/items.json (54) |
| `existing_canonical_name_quality_mixed_scripts` | 10 | 15.2% | ru/items.json (10) |
| `gt_validate_fail_identical_to_en` | 2 | 3.0% | cs/items.json (2) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T06:45:24.564198Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T06:45:24.564198Z
- **Top 5 typów problemów:** suspicious_rejected_critical=188, suspicious_log_high=91, suspicious_log_low=77, suspicious_log_medium=31, suspicious_rejected_high=12
- **Języki o najsłabszej jakości:** es(60.1, issues=737513), ro(60.1, issues=435208), de(60.1, issues=117756), cs(60.1, issues=98847), fr(60.1, issues=60621)
- **Pliki:** `i18n/status/quality_audit_latest.json`, `i18n/status/quality_dashboard.json`, `i18n/status/quality_report.jsonl`

### 📈 Statystyki Pracy
| Metryka | Wartość | Info |
|---------|---------|------|
| 🔄 Cykl aktualny | **#79** | od uruchomienia |
...
⚠️ **TR**: jakość 73%, 55084 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 737513 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 62%, 174060 problemów
⚠️ **RU**: jakość 64%, 365638 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,908 |
| Heartbeat | 115s temu | 2026-04-29T06:45:25Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T06:46:30.254768Z
...
- 2026-04-29 06:46:30 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-29 06:46:14 | AUTO_TRANSLATE:auto_done | de | ok | npc.json
- 2026-04-29 06:45:49 | AUTO_TRANSLATE:heartbeat_tick | de | ok | npc.json
- 2026-04-29 06:45:49 | AUTO_TRANSLATE:auto_start | de | ok | npc.json
- 2026-04-29 06:45:23 | AUTO_TRANSLATE:auto_done | de | ok | otclient_modules.json
- 2026-04-29 06:45:03 | AUTO_TRANSLATE:heartbeat_tick | de | ok | otclient_modules.json
...
| Przepustowość (okno) | 539 kluczy / 25 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 06:47:14
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+2) — repair_identical lang=es file=server.json target_identical=9 limit=108 tier=low_backlog+suspicious_guard domain_cap=240 gt=true suspicious_pct=447.92
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → warn (files+1, translated+51, skipped+0) — lang=ru file=items.json strict_skipped_done=1345 guard_fail=1 placeholder=0 command=0 pipe=0
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+0, translated+0, skipped+0) — lang=es file=otclient_modules.json strict_skipped_done=2031
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+16) — repair_identical lang=es file=html.json target_identical=583 limit=132 tier=base+domain_cap+suspicious_guard domain_cap=220 gt=true suspicious_pct=56.07
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **5,909** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 136 |
| ❌ Błędów | 245 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,163), **RU** (1,075), **IT** (838), **DE** (810), **TR** (762) |
| 📊 Porównanie | ↓ 28.2% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **24,889** kluczy
...
| 🔄 Cykli wykonanych | **#17,908** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,908 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 06:47:14  
