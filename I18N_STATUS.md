...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-19 07:44:34

> **Aktualizacja:** 2026-02-19 07:44:34 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #1 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: it | Plik: startup.json | Heartbeat: 2026-02-19T07:44:35Z  
> **Okno godzinowe:** okno=1.0h | cykli=40 | pominięte=0.0% | odrzucone=0.0% | przepustowość=0.0/h  
> **Tłumaczeń netto:** 110,341

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-19 07:44:34 |
| LIVE | 🟢 AKTYWNY | 2s temu | - | `activity.json / worker_state.json` | 2026-02-19T07:44:35Z |
| MIGRATION | 🔒 NIEAKTYWNY | 1d temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-19 07:44:34 |
| TRANSLATION | 🟢 AKTYWNY | 4s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-19T07:44:32.854669Z |
| QUALITY | 🔒 NIEAKTYWNY | 22s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-19T07:44:14.966614Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-19 07:44:34 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-19T07:44:35Z
...
| ❤️ **Heartbeat** | 2026-02-19T07:44:35Z |
...
> Świeżość: 1d temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-19 07:44:34
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 4s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-19T07:44:32.854669Z
...
- Raporty strażnika jakości: **3661**  
- Raporty blokad: **0**  
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-19T06:44:34.560122Z → 2026-02-19T07:44:34.560122Z) |
...
> Świeżość: 22s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-19T07:44:14.966614Z

- **Ostatni audyt:** SLOW_MODE | 31 issue(s) / 100 entries | 2026-02-19T07:44:14.966614Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=249348), pl(60.1, issues=140297), ro(60.1, issues=64471), ru(60.1, issues=50510), it(60.1, issues=22621)
...
⚠️ **PL**: jakość 60%, 140297 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 249348 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 22621 problemów
⚠️ **RU**: jakość 60%, 50510 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 60%, 15457 problemów
...
| Heartbeat | 2s temu | 2026-02-19T07:44:35Z |
...
- 2026-02-19 07:44:35 | AUTO_TRANSLATE:heartbeat_tick | it | ok | startup.json
- 2026-02-19 07:44:34 | AUTO_TRANSLATE:parallel_start | it | ok | startup.json
- 2026-02-19 07:44:33 | AUTO_TRANSLATE:auto_done | ro | ok | example_merchant.json
- 2026-02-19 07:44:28 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | example_merchant.json
- 2026-02-19 07:44:28 | AUTO_TRANSLATE:auto_start | ro | ok | example_merchant.json
- 2026-02-19 07:44:09 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-19 07:44:34

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → ok (files+0, translated+0, skipped+0) — lang=ro file=example_merchant.json
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ru] → ok (translated+0, skipped+0) — parallel lang=ru file=creaturescripts.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [it] → ok (translated+0, skipped+0) — parallel lang=it file=otclient_data.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → ok (files+0, translated+0, skipped+0) — lang=ro file=startup.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ru] → ok (translated+0, skipped+0) — parallel lang=ru file=npclib.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [it] → ok (translated+0, skipped+0) — parallel lang=it file=modules.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [sr] → ok (files+0, translated+0, skipped+0) — lang=sr file=scripts.json
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+0) — repair_identical lang=es file=npc.json target_identical=51 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=276.00
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [sv] → ok (translated+0, skipped+0) — parallel lang=sv file=scripts.json
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-19 07:44:34  
