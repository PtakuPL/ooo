...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 16.87% / real 9.69%**. Tempo: **1902.0 kluczy/h**. Tłumaczeń netto: **102,530**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-02 18:43:36

> **Aktualizacja:** 2026-04-02 18:43:36 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #13,060 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: fr | Plik: monsters.json | Heartbeat: 2026-04-02T18:43:30Z  
> **Okno godzinowe:** okno=1.0h | cykli=52 | pominięte=0.0% | odrzucone=28.4% | przepustowość=1902.0/h  
> **Tłumaczeń netto:** 102,530

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-02 18:43:36 |
| LIVE | 🟢 AKTYWNY | 9s temu | - | `activity.json / worker_state.json` | 2026-04-02T18:43:30Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 18s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-02 18:43:36 |
| TRANSLATION | 🟢 AKTYWNY | 23s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-02T18:43:15.846722Z |
| QUALITY | 🔒 NIEAKTYWNY | 22s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-02T18:43:17.009134Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-02 18:43:36 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 9s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-02T18:43:30Z
...
| ❤️ **Heartbeat** | 2026-04-02T18:43:30Z |
...
> **ETA globalne:** ~66 dni (3,028,096 kluczy do celu 95%)
...
> Świeżość: 18s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-02 18:43:36
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 23s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-02T18:43:15.846722Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 280 | 0 | 0 | - | 2026-04-02T18:43:29.657979Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **16.87%** (653,972/3,875,872)
- **Pokrycie globalne (real):** **9.69%** (375,724/3,875,872)
- **Kopie EN (łącznie):** **429,070**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-02T17:43:37.108925Z → 2026-04-02T18:43:37.108925Z) |
| Cykle | **52** (TŁUMACZENIE=52, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **28.4%** |
| Cykle bez postępu % | **7.7%** |
| Przepustowość (kluczy/h) | **1902.0 kluczy/h** |
| Podejrzane tłumaczenia | **1492** |
...
|--------|-----------|--------|----------------|
| `gt_rejected_critical` | 350 | 75.3% | es/questlog.json (258) |
| `gt_validate_fail_word_salad` | 90 | 19.4% | es/questlog.json (68) |
| `gt_rejected_high_partial_translation_mix` | 15 | 3.2% | it/monsters.json (15) |
| `gt_validate_fail_placeholder` | 8 | 1.7% | es/questlog.json (6) |
| `gt_validate_fail_quality` | 2 | 0.4% | tr/npc.json (1) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 22s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-02T18:43:17.009134Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-02T18:43:17.009134Z
- **Top 5 typów problemów:** suspicious_rejected_critical=182, suspicious_log_high=178, suspicious_rejected_high=18, suspicious_log_critical=14, suspicious_log_low=8
- **Języki o najsłabszej jakości:** es(60.1, issues=678066), ro(60.1, issues=376925), pl(60.1, issues=360690), pt(60.1, issues=29860), nl(60.1, issues=28111)
...
⚠️ **TR**: jakość 74%, 18999 problemów
⚠️ **PL**: jakość 60%, 360690 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 678066 problemów
⚠️ **PT**: jakość 60%, 29860 problemów
⚠️ **FR**: jakość 61%, 40824 problemów
⚠️ **IT**: jakość 62%, 135997 problemów
⚠️ **RU**: jakość 65%, 309962 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #13,060 |
| Heartbeat | 9s temu | 2026-04-02T18:43:30Z |
...
- **Ostatnia aktualizacja:** 2026-04-02T18:39:56.417086Z
...
- 2026-04-02 18:43:30 | AUTO_TRANSLATE:heartbeat_tick | fr | ok | monsters.json
- 2026-04-02 18:43:30 | AUTO_TRANSLATE:auto_start | fr | ok | monsters.json
- 2026-04-02 18:43:16 | AUTO_TRANSLATE:auto_done | it | ok | monsters.json
- 2026-04-02 18:43:15 | AUTO_TRANSLATE:heartbeat_tick | it | ok | monsters.json
- 2026-04-02 18:41:47 | AUTO_TRANSLATE:heartbeat_tick | it | ok | monsters.json
- 2026-04-02 18:40:18 | AUTO_TRANSLATE:heartbeat_tick | it | ok | monsters.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 70.7% | 0 | 5,887 | 1,089 | 3375 (75.6%) | 21 |
| 🟡 ES | 76.8% | 0 | 9,719 | 2,443 | 850 (25.8%) | 33 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **102,530** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=27.04%, reason=decrease_high_fail_rate=27.0%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 3,532 kluczy / 54 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-02 18:43:36
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **7,257** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 67 |
| ❌ Błędów | 140 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **RO** (1,425), **FR** (960), **ES** (953), **CS** (858), **TR** (781) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **47,544** kluczy
...
| 🔄 Cykli wykonanych | **#13,060** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #13,060 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-02 18:43:36  
