...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.03% / real 10.95%**. Tempo: **685.0 kluczy/h**. Tłumaczeń netto: **146,829**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 11:14:52

> **Aktualizacja:** 2026-04-29 11:14:52 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,284 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-04-29T11:12:23Z
> **Okno godzinowe:** okno=1.0h | cykli=80 | pominięte=0.0% | odrzucone=6.3% | przepustowość=685.0/h  
> **Tłumaczeń netto:** 146,829

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 11:14:52 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T11:12:23Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 11:14:52 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T11:12:08.385191Z |
| QUALITY | 🔒 NIEAKTYWNY | 3min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T11:11:27.999356Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 11:14:52 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T11:14:58.962438Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T11:12:23Z
...
| ❤️ **Heartbeat** | 2026-04-29T11:12:23Z |
...
|----------|------|---------|------|-------|--------|------------|--------|
| 11:12:04 | DE | Klient | otclient_modules.json | 15 | `tm` | `otclient_modules.blessing.tr_11` | - Abhängig von den Regeln des fairen Kampfes verlierst du zwischendurch |
| 11:11:16 | ES | Serwer | items.json | 43 | `google_translate` | `item.11929.name` | teja arenosa |
| 11:09:18 | ES | Serwer | server.json | 1 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 11:07:17 | IT | Serwer | items.json | 33 | `simple` | `item.13956.name` | pavimento dell'alveare |
| 11:05:18 | RO | Serwer | items.json | 39 | `google_translate` | `item.10216.name` | kit statuie dragon |
| 11:03:33 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 11:00:14 | CS | Serwer | items.json | 41 | `simple` | `item.14561.name` | REZERVOVANÝ SPRITE |
| 10:58:33 | RU | Serwer | items.json | 30 | `transliteration_cyrillic` | `item.14372.name` | РЕСЕРВЕД СПРИТЕ |
| 10:56:42 | ES | Serwer | server.json | 1 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 10:54:48 | TR | Serwer | items.json | 39 | `simple` | `item.13232.name` | kovan zemin |
| 10:53:41 | DE | Serwer | npc.json | 30 | `tm` | `npc.a_dead_bureaucrat1.say_1` | Klar, wo sonst. Jeder trifft gerne meinen Meister, er ist ein großer Dämon, nicht wah... |
| 10:52:29 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 10:49:21 | DE | Klient | otclient_modules.json | 15 | `tm` | `otclient_modules.blessing.tr_11` | - Abhängig von den Regeln des fairen Kampfes verlierst du zwischendurch |
| 10:48:36 | ES | Serwer | items.json | 19 | `simple` | `item.11907.name` | muro de tumba |
| 10:46:55 | ES | Serwer | server.json | 1 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 10:44:56 | IT | Serwer | items.json | 34 | `simple` | `item.13911.name` | lampioni |
| 10:43:02 | RO | Serwer | items.json | 39 | `google_translate` | `item.10216.name` | kit statuie dragon |
| 10:41:17 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 10:38:06 | CS | Serwer | items.json | 41 | `simple` | `item.14534.name` | REZERVOVANÝ SPRITE |
| 10:36:22 | RU | Serwer | items.json | 30 | `transliteration_cyrillic` | `item.14345.name` | РЕСЕРВЕД СПРИТЕ |
...
|----------|------|---------|-----------|-------|----------|--------------|-----|
| 11:14:10 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.say_1` |
| 11:14:08 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.multi_1` |
| 11:12:01 | DE | Klient | otclient_modules.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `otclient_modules.charms.tr_34` |
| 11:06:39 | IT | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 11:04:40 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10193.name` |
| 11:04:38 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10192.name` |
| 11:04:37 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10191.name` |
| 11:04:35 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10190.name` |
| 11:02:21 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.say_2` |
| 10:59:48 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.14250.name` |
| 10:59:46 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.14077.name` |
| 10:59:44 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.14023.name` |
| 10:59:43 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.11586.name` |
| 10:59:41 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 10:59:39 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10456.name` |
| 10:59:38 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10338.name` |
| 10:59:36 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10026.name` |
| 10:58:02 | RU | Serwer | items.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `item.11541.name` |
| 10:53:35 | DE | Serwer | npc.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `npc.a_fluffy_squirrel.stdmod_1` |
| 10:51:27 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.say_1` |
...
| 📨 Pending queue (visible tail) | 385 z ostatnich 400 poprawnych wpisów JSONL |
| ⏳ Oldest pending (visible tail) | 15804 s |
| 🌍 Top języki | RU(384), CS(1) |
| 🧱 Top reason_bucket | quality(384), default(1) |
| 🗂️ Deferred state keys | 8336 |
...
| 🧮 OpenAI budget | `201/250 stale:2026-04-28 13 h` |
| ♻️ Provider debt | `1246` |
| 🌍 Recent provider mix | TM/simple(334), Free Google Translate(144), canonical_name_semantic_autofix(19), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=500, fallbacks=23) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=956/956 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 385, 'oldest_s': 15804}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| �📊 Przetłumaczono | **685** kluczy |
| ❌ Odrzucone (guard) | 46 |
| 🔁 Cykli | 80 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | CS (123 kluczy) |
| 📄 Najczęstszy plik | items.json |
| ⚡ Przepustowość | ~685 kluczy/h |
...
> **ETA globalne:** ~181 dni (2,983,419 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 79.1% | 58,962/74,536 | ~17h |
| PL | ██████████████░░░░░░ | 71.0% | 52,911/74,536 | ~26h |
| IT | ██████████████░░░░░░ | 71.0% | 52,913/74,536 | ~26h |
| RO | █████████████░░░░░░░ | 69.7% | 51,972/74,536 | ~27h |
| RU | █████████░░░░░░░░░░░ | 46.1% | 34,393/74,536 | ~2d |
| FR | ███████████░░░░░░░░░ | 57.5% | 42,864/74,536 | ~41h |
| CS | ██████████░░░░░░░░░░ | 50.9% | 37,924/74,536 | ~2d |
| PT | ████████████████░░░░ | 81.2% | 60,516/74,536 | ~15h |
| SR | ██████░░░░░░░░░░░░░░ | 33.3% | 24,827/74,536 | ~3d |
| NL | ███████████████░░░░░ | 77.6% | 57,814/74,536 | ~19h |
| TR | ██████░░░░░░░░░░░░░░ | 34.8% | 25,903/74,536 | ~3d |
| DE | █████████████░░░░░░░ | 67.8% | 50,562/74,536 | ~30h |
...
> Tempo obliczone na bazie ostatniej godziny: ~685 kluczy/h.
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 11:14:52
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T11:12:08.385191Z
...
|-------|-----------|--------|----------|--------------|--------------|
| ES (Hiszpański) | 79.11% (58,962/74,536) | 68.08% (50,747/74,536) | 9,604 | 14,209 | 0 |
| PL (Polski) | 70.99% (52,911/74,536) | 65.08% (48,507/74,536) | 5,861 | 20,194 | 0 |
| IT (Włoski) | 70.99% (52,913/74,536) | 62.77% (46,787/74,536) | 10,030 | 17,744 | 0 |
| RO (Rumuński) | 69.73% (51,972/74,536) | 56.69% (42,253/74,536) | 13,005 | 19,303 | 0 |
| RU (Rosyjski) | 46.14% (34,393/74,536) | 44.57% (33,223/74,536) | 4,775 | 36,556 | 0 |
| FR (Francuski) | 57.51% (42,864/74,536) | 41.87% (31,206/74,536) | 26,153 | 17,199 | 0 |
| CS (Czeski) | 50.88% (37,924/74,536) | 33.13% (24,694/74,536) | 29,842 | 20,026 | 0 |
...
| TR (Turecki) | 34.75% (25,903/74,536) | 31.27% (23,306/74,536) | 3,832 | 47,412 | 0 |
...
- Raporty strażnika jakości: **4919**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4772**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T11:11:46.374337Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.03%** (698,649/3,875,872)
- **Pokrycie globalne (real):** **10.95%** (424,348/3,875,872)
- **Kopie EN (łącznie):** **410,388**
- **Placeholdery [EN]/puste (łącznie):** **2,187,014**
...
|-------|--------|--------------------------|----------|----------------------------|
| ES | 55,802/70,637 | 79.0% / 67.5% | 3,160/3,899 | 81.0% / 79.2% |
| PL | 49,763/70,637 | 70.5% / 64.3% | 3,148/3,899 | 80.7% / 78.4% |
| IT | 49,940/70,637 | 70.7% / 62.2% | 2,973/3,899 | 76.2% / 73.1% |
| RO | 49,186/70,637 | 69.6% / 56.0% | 2,786/3,899 | 71.5% / 69.6% |
| RU | 31,249/70,637 | 44.2% / 42.6% | 3,144/3,899 | 80.6% / 79.3% |
| FR | 39,937/70,637 | 56.5% / 40.1% | 2,927/3,899 | 75.1% / 73.7% |
| CS | 36,234/70,637 | 51.3% / 32.8% | 1,690/3,899 | 43.3% / 39.0% |
...
| TR | 23,944/70,637 | 33.9% / 30.3% | 1,959/3,899 | 50.2% / 48.7% |
...
| #3 | 🔴 Server | 11.03% | +0.28 pp | 51 | ZH 0.2%, TL 0.8%, BS 0.9% |
...
| 🕒 Evidence window | 24h (span=40.38h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=40.38h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T10:14:53.291952Z → 2026-04-29T11:14:53.291952Z) |
...
| Przepustowość (kluczy/h) | **685.0 kluczy/h** |
| Podejrzane tłumaczenia | **1035** |
| Najgorsze cele (strażnik) | cs/items.json (gf=24), ro/items.json (gf=12), it/items.json (gf=3), de/otclient_modules.json (gf=3), de/npc.json (gf=2) |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 51 | 78.5% | ru/items.json (51) |
| `existing_canonical_name_quality_mixed_scripts` | 13 | 20.0% | ru/items.json (13) |
| `retry_loop_cooldown_default` | 1 | 1.5% | cs/items.json (1) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 3min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T11:11:27.999356Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T11:11:27.999356Z
- **Top 5 typów problemów:** suspicious_rejected_critical=190, suspicious_log_high=110, suspicious_log_low=88, suspicious_rejected_high=10, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=745302), ro(60.1, issues=440772), de(60.1, issues=123458), cs(60.1, issues=110922), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 63%, 57012 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 745302 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 67%, 177244 problemów
⚠️ **RU**: jakość 61%, 371006 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,284 |
| Heartbeat | 155s temu | 2026-04-29T11:12:23Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T11:12:23.200644Z
...
- 2026-04-29 11:13:54 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 11:12:23 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 11:12:08 | AUTO_TRANSLATE:auto_done | de | ok | otclient_modules.json
- 2026-04-29 11:11:47 | AUTO_TRANSLATE:heartbeat_tick | de | ok | otclient_modules.json
- 2026-04-29 11:11:46 | AUTO_TRANSLATE:auto_start | de | ok | otclient_modules.json
- 2026-04-29 11:11:27 | AUTO_TRANSLATE:auto_done | es | ok | items.json
...
| 🟡 ES | 79.1% | 0 | 9,604 | 569 | 0 (0.0%) | 26 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **146,829** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=5.0%, reason=stable_fail_rate=5.0%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 569 kluczy / 26 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 11:14:52
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+4) — repair_identical lang=es file=npc.json target_identical=2 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=198.65
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **9,401** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 185 |
| ❌ Błędów | 409 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,670), **RU** (1,598), **IT** (1,407), **DE** (1,320), **TR** (1,315) |
| 📊 Porównanie | ↑ 14.3% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **28,381** kluczy
...
| 🔄 Cykli wykonanych | **#18,284** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,284 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 11:14:52  
