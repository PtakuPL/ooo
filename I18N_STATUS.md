...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.9%**. Tempo: **1444.8 kluczy/h**. Tłumaczeń netto: **125,512**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 22:12:46

> **Aktualizacja:** 2026-02-20 22:12:46 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #14 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: - | Heartbeat: 2026-02-20T22:12:42Z  
> **Okno godzinowe:** okno=1.0h | cykli=181 | pominięte=0.0% | odrzucone=74.5% | przepustowość=1444.8/h  
> **Tłumaczeń netto:** 125,512

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 22:12:46 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T22:12:42Z |
| MIGRATION | 🔒 NIEAKTYWNY | 56s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 22:12:46 |
| TRANSLATION | 🟢 AKTYWNY | 5s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T22:12:41.812724Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T22:12:47.689415Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 22:12:46 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T22:12:42Z

| Metryka | Wartość |
|---------|---------|
| 🛠️ **Co robi** | Tłumaczenie automatyczne (Google Translate + TM) → cycle_end |
| 🌍 **Aktywne języki (10 min)** | ES, IT, RO, RU, SV |
| 📝 **Faza** | AUTO_TRANSLATE |
| 📋 **Etap** | cycle_end |
| 📂 **Kategoria / Język** | it |
| 📄 **Plik** | - |
...
| ❤️ **Heartbeat** | 2026-02-20T22:12:42Z |
...
> **ETA globalne:** ~65 dni (2,259,894 kluczy do celu 95%)
...
| RO | ████████░░░░░░░░░░░░ | 43.6% | 23,368/53,586 | ~19h |
| FR | ██████░░░░░░░░░░░░░░ | 33.1% | 17,731/53,586 | ~23h |
| SV | █████░░░░░░░░░░░░░░░ | 29.0% | 15,556/53,586 | ~24h |
...
> Świeżość: 56s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 22:12:46
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T22:12:41.812724Z
...
- Done. → Done. (npc.lardoc_bashsmite.say_10)
- Done. → Done. (npc.lardoc_bashsmite.say_12)
- Done. → Done. (npc.lardoc_bashsmite.say_14)
- Excellent! Now, let me explain. If you donate 1.000.000.000 gold pieces, you wil → Excellent! Låt mig nu förklara. Om du donerar 1 000 000 000 guldpjäser har du rä (npc.queen_eloise.multi_1)
- Fine. → Fine. (npc.robson.say_4)
- Fine. → Fine. (npc.robson.say_6)
- There are four vocation: knight, druid, paladin and sorcerer. If you want to kno → Det finns fyra kallelser: riddare, druid, paladin och trollkarl. Om du vill veta (npc.ser_tybald.say_13)
- I myself teach try-out spells for both the magical classes, whereas Tybald in th → Jag undervisar själv i prova-på-trollformler för båda de magiska klasserna, meda (npc.ser_tybald.say_14)
- A very intelligent girl. Prefers to listen to wild animals' noises instead of hu → En mycket intelligent tjej. Lyssnar hellre på vilda djurs ljud istället för männ (npc.ser_tybald.say_15)
- However, she's also a very apt healer and can give you advice on your choice of  → Men hon är också en mycket lämplig healer och kan ge dig råd om ditt val av yrke (npc.ser_tybald.say_16)
- There's a broad variety of what spells can do, as you will see as you progress f → Det finns ett brett utbud av vad trollformler kan göra, vilket du kommer att se  (npc.ser_tybald.say_2)
- Some attack spells can be directed at a single target while others affect an are → Vissa attacktrollformler kan riktas mot ett enda mål medan andra påverkar ett om (npc.ser_tybald.say_3)
- Each vocation has its own individual spells that none of the other vocations can → Varje yrke har sina egna individuella besvärjelser som ingen av de andra yrkena  (npc.ser_tybald.say_4)
- The spells here on Dawnport are for trying out only, and you will forget them on → Besvärjelserna här på Dawnport är endast till för att testa, och du kommer att g (npc.ser_tybald.say_5)
- There, you can go to a spell teacher in a city to permanently learn a spell. → Där kan du gå till en stavningslärare i en stad för att permanent lära dig en tr (npc.ser_tybald.say_6)
- The Mainland offers many more adventures, dangers and quests than this small isl → Fastlandet erbjuder många fler äventyr, faror och uppdrag än den här lilla ön, o (npc.ser_tybald.say_7)
- Once you reach level 8 you may choose your definite vocation and leave for Main. → När du når nivå 8 kan du välja ditt bestämda yrke och åka till Main. Gå till en  (npc.ser_tybald.say_8)
- The art of spell teaching is complex and dangerous, and we will only impart our  → Konsten att undervisa i stavning är komplex och farlig, och vi kommer bara att f (npc.ser_tybald.say_9)
- Roughened and toughened by life's tragedies. A good man, but somber. → Ruggad och härdad av livets tragedier. En bra man, men dyster. (npc.ser_tybald.stdmod_10)
- Yes, child. If you wish to learn a spell, tell me. → Ja, barn. Om du vill lära dig en besvärjelse, berätta för mig. (npc.ser_tybald.stdmod_11)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **7235**  
- Raporty blokad: **0**  
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T21:12:46.943945Z → 2026-02-20T22:12:46.943945Z) |
...
| Przepustowość (kluczy/h) | **1444.8 kluczy/h** |
| Podejrzane tłumaczenia | **3103** |
| Najgorsze cele (strażnik) | pl/items.json (gf=3264), pl/npc.json (gf=1936), es/items.json (gf=1569), es/server.json (gf=123), it/npc.json (gf=114) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T22:12:47.689415Z

- **Ostatni audyt:** SLOW_MODE | 29 issue(s) / 100 entries | 2026-02-20T22:12:42.470260Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_log_high=81, suspicious_rejected_critical=77, suspicious_log_critical=37, artifact_token=16, identical_to_en=13
- **Języki o najsłabszej jakości:** es(60.1, issues=350625), pl(60.1, issues=194225), ro(60.1, issues=189998), sr(64.1, issues=87233), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 60%, 194225 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 350625 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 77%, 77031 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #14 |
| Heartbeat | 5s temu | 2026-02-20T22:12:42Z |
...
- 2026-02-20 22:12:36 | AUTO_TRANSLATE:heartbeat_tick | sv | ok | npc.json
- 2026-02-20 22:12:36 | AUTO_TRANSLATE:parallel_start | sv | ok | npc.json
- 2026-02-20 22:12:31 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | monsters.json
- 2026-02-20 22:12:31 | AUTO_TRANSLATE:parallel_start | ru | ok | monsters.json
- 2026-02-20 22:12:29 | AUTO_TRANSLATE:auto_done | it | ok | monsters.json
- 2026-02-20 22:12:25 | AUTO_TRANSLATE:heartbeat_tick | it | ok | monsters.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 22:12:46
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+23) — repair_identical lang=es file=npc.json target_identical=51 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=297.18
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+46, skipped+0) — parallel lang=es file=items.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+0, translated+0, skipped+0) — lang=pl file=books.json strict_skipped_done=1376 guard_fail=50 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+24) — repair_identical lang=es file=npc.json target_identical=24 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=319.06
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **19,186** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 224 |
| ❌ Błędów | 462 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (5,658), **RU** (3,789), **IT** (3,088), **RO** (2,289), **PL** (2,252) |
| 📊 Porównanie | ↑ 426.9% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **116,771** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 22:12:46  
