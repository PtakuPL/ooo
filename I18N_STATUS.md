...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-19 10:01:21

> **Aktualizacja:** 2026-02-19 10:01:21 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #1 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: pl | Plik: talkactions.json | Heartbeat: 2026-02-19T10:01:22Z  
...
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-19 10:01:21 |
| LIVE | 🟢 AKTYWNY | 2s temu | - | `activity.json / worker_state.json` | 2026-02-19T10:01:22Z |
| MIGRATION | 🔒 NIEAKTYWNY | 1d temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-19 10:01:21 |
| TRANSLATION | 🟢 AKTYWNY | 5s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-19T10:01:19.486608Z |
| QUALITY | 🔒 NIEAKTYWNY | 31s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-19T10:00:53.872619Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-19 10:01:21 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-19T10:01:22Z
...
| ❤️ **Heartbeat** | 2026-02-19T10:01:22Z |
...
> Świeżość: 1d temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-19 10:01:21
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-19T10:01:19.486608Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-19T09:01:22.055247Z → 2026-02-19T10:01:22.055247Z) |
...
| Podejrzane tłumaczenia | **17** |
| Najgorsze cele (strażnik) | sv/scripts.json (gf=0), sr/scripts.json (gf=0), it/modules.json (gf=0), ru/npclib.json (gf=0), ro/startup.json (gf=0) |
...
> Świeżość: 31s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-19T10:00:53.872619Z

- **Ostatni audyt:** SLOW_MODE | 31 issue(s) / 100 entries | 2026-02-19T10:00:53.872619Z
- **Top 5 typów problemów:** suspicious_log_high=182, suspicious_rejected_critical=171, suspicious_rejected_high=29, artifact_token=16, identical_to_en=15
- **Języki o najsłabszej jakości:** es(60.1, issues=259675), pl(60.1, issues=145781), ro(60.1, issues=83954), ru(60.1, issues=64540), sr(60.1, issues=31681)
...
⚠️ **PL**: jakość 60%, 145781 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 259675 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 30901 problemów
⚠️ **RU**: jakość 60%, 64540 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 60%, 23942 problemów
...
| Heartbeat | 2s temu | 2026-02-19T10:01:22Z |
...
- 2026-02-19 10:01:22 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | talkactions.json
- 2026-02-19 10:01:21 | AUTO_TRANSLATE:parallel_start | pl | ok | talkactions.json
- 2026-02-19 10:01:19 | AUTO_TRANSLATE:auto_done | es | ok | modules.json
- 2026-02-19 10:01:12 | AUTO_TRANSLATE:heartbeat_tick | es | ok | modules.json
- 2026-02-19 10:01:12 | AUTO_TRANSLATE:auto_start | es | ok | modules.json
- 2026-02-19 10:00:48 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | php.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟢 PL | 87.3% | 0 | 1,810 | 0 | 0 (0.0%) | 13 |
| 🟢 ES | 84.3% | 0 | 2,149 | 0 | 0 (0.0%) | 13 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-19 10:01:21

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → ok (files+0, translated+0, skipped+0) — lang=es file=modules.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [pl] → ok (translated+0, skipped+0) — parallel lang=pl file=php.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [sr] → ok (translated+0, skipped+0) — parallel lang=sr file=items.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [sv] → ok (files+0, translated+0, skipped+0) — lang=sv file=items.json
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ro] → ok (translated+0, skipped+0) — parallel lang=ro file=books.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ru] → ok (translated+0, skipped+0) — parallel lang=ru file=html.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → ok (files+0, translated+0, skipped+0) — lang=it file=html.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ro] → ok (translated+0, skipped+0) — parallel lang=ro file=html.json
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-19 10:01:21  
