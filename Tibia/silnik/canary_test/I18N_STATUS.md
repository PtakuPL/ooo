...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **18.73%**. Tempo: **1167.3 kluczy/h**. Tłumaczeń netto: **48,132**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-23 04:47:26

> **Aktualizacja:** 2026-03-23 04:47:26 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **LIVE:** Cykl #9,514 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: auto_done | Kategoria: ro | Plik: raids.json | Heartbeat: 2026-03-23T04:47:21Z  
> **Okno godzinowe:** okno=1.0h | cykli=68 | pominięte=0.0% | odrzucone=2.5% | przepustowość=1167.3/h  
> **Tłumaczeń netto:** 48,132

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-23 04:47:26 |
| LIVE | 🟢 AKTYWNY | 6s temu | - | `activity.json / worker_state.json` | 2026-03-23T04:47:21Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 50s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-23 04:47:26 |
| TRANSLATION | 🟢 AKTYWNY | 6s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-23T04:47:20.993448Z |
| QUALITY | 🔒 NIEAKTYWNY | 52s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-23T04:46:34.884770Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-23 04:47:26 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-23T04:47:21Z
...
| ❤️ **Heartbeat** | 2026-03-23T04:47:21Z |
...
> **ETA globalne:** ~106 dni (2,956,213 kluczy do celu 95%)
...
| RU | ██████████████░░░░░░ | 73.2% | 54,529/74,536 | ~14h |
| IT | ██████████████░░░░░░ | 73.0% | 54,381/74,536 | ~14h |
| FR | ██████████████░░░░░░ | 71.0% | 52,896/74,536 | ~15h |
| PT | █████████████░░░░░░░ | 68.9% | 51,388/74,536 | ~17h |
| CS | █████████████░░░░░░░ | 67.2% | 50,093/74,536 | ~18h |
| NL | █████████████░░░░░░░ | 66.7% | 49,721/74,536 | ~18h |
| DE | █████████████░░░░░░░ | 66.1% | 49,281/74,536 | ~18h |
...
> Świeżość: 50s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-23 04:47:26
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-23T04:47:20.993448Z
...
- Minotaurs are attacking Darashia from the north! → Minotaurs atacă Darashia din nord! (raids.darashia.minotaurs.msg_2)
- Minotaurs are advancing to Darashia grom the north! → Minotaurs avansează spre Darashia grom nord! (raids.darashia.minotaurs.msg_3)
- The Feroxa master has revealed itself in the mines of grimvale. → Maestrul Feroxa sa dezvăluit în minele din Grimvale. (raids.edron.feroxa.msg_3)
- Goblins are converging west of Edron. → Goblins converg spre vest de Edron. (raids.edron.goblins.msg_1)
- Lancer beetles troop up in Farmine. Beware! → Gândacii Lancer se adună în Farmine. Atenție! (raids.farmine.beetles.msg_1)
- A pack of lancer beetles heads towards the coast! → O haită de gândaci lancer se îndreaptă spre coastă! (raids.farmine.beetles.msg_2)
- Beware of Zevelon Duskbringer! → Atenție la Zevelon Duskbringer! (raids.farmine.zevelon_duskbringer.msg_1)
- Goblins are preparing to attack Kazordoon from Femor Hills! → Goblins se pregătesc să atace Kazordoon de la Femor Hills! (raids.kazordoon.goblins.msg_1)
- Goblins attack from Femor Hills! → Goblins atac de la Femor Hills! (raids.kazordoon.goblins.msg_2)
- Danger! Now the goblin leaders attack Kazordoon from Femor Hills! → Pericol! Acum, liderii spiriduși atacă Kazordoon din Femor Hills! (raids.kazordoon.goblins.msg_3)
- Beware of Diblis The Fair! → Atenție la Diblis The Fair! (raids.liberty_bay.diblis_the_fair.msg_1)
- Lizards Sentinels seem to attack Port Hope from Chor. → Lizards Sentinelele par să atace Port Hope din Chor. (raids.port_hope.kongras.msg_1)
- Lizards are advancing to Port Hope from Chor. → Lizards avansează la Port Hope din Chor. (raids.port_hope.kongras.msg_2)
- Lizards Sentinels seem to attack Port Hope from Chor. → Lizards Sentinelele par să atace Port Hope din Chor. (raids.port_hope.lizards.msg_1)
- Lizards are advancing to Port Hope from Chor. → Lizards avansează la Port Hope din Chor. (raids.port_hope.lizards.msg_2)
- Hordes of slippery spawns slither in Deeper Banuta! → Hoardele de nașteri alunecoși se alunecă în Deeper Banuta! (raids.port_hope.serpent_spawn.msg_3)
- Terrorbirds have been sighted in Trapwood south-east of Port Hope! → Terrorbirds au fost văzute în Trapwood la sud-est de Port Hope! (raids.port_hope.terrorbirds.msg_1)
- The demonic master has revealed itself in the mines of Hrodmir. → Stăpânul demonic sa dezvăluit în minele din Hrodmir. (raids.svargrond.ghazbaran.msg_3)
- Let da mashing begin! Cyclops riot east of Thais. → Să înceapă piureul! Cyclops revoltă la est de Thais. (raids.thais.cyclops.msg_1)
- Hunters on the hunt north of the Green Claw Swamp. → Vânători la vânătoare la nord de Mlaștina Gheara Verde. (raids.venore.hunter.msg_1)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-23T03:47:26.310487Z → 2026-03-23T04:47:26.310487Z) |
...
| Przepustowość (kluczy/h) | **1167.3 kluczy/h** |
...
> Świeżość: 52s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-23T04:46:34.884770Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-03-23T04:46:34.884770Z
- **Top 5 typów problemów:** suspicious_log_high=198, suspicious_rejected_critical=168, suspicious_rejected_high=32, identical_to_en_exempt=5, suspicious_log_low=2
- **Języki o najsłabszej jakości:** es(60.1, issues=578712), ru(60.1, issues=286182), pt(60.1, issues=17404), nl(60.1, issues=9634), tr(67.9, issues=4122)
...
⚠️ **TR**: jakość 68%, 4122 problemów
⚠️ **PL**: jakość 80%, 325965 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 578712 problemów
⚠️ **PT**: jakość 60%, 17404 problemów
⚠️ **FR**: jakość 90%, 15895 problemów
⚠️ **IT**: jakość 84%, 109342 problemów
⚠️ **RU**: jakość 60%, 286182 problemów
⚠️ **NL**: jakość 60%, 9634 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #9,514 |
| Heartbeat | 6s temu | 2026-03-23T04:47:21Z |
...
│ Plik: raids.json                                              │
│ Postęp: 25/30 keys                                            │
│ …25 guard_fail=0 strict_missing_key=0 strict_skipped_done=248 │
├─────────────────────────────────────────────────────────────────┤
│ ❤️ Heartbeat: 2026-03-23T04:47:21Z           │
└─────────────────────────────────────────────────────────────────┘
```
...
- 2026-03-23 04:46:41 | AUTO_TRANSLATE:auto_start | ro | ok | raids.json
- 2026-03-23 04:46:34 | AUTO_TRANSLATE:auto_done | ru | ok | raids.json
- 2026-03-23 04:46:20 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | raids.json
- 2026-03-23 04:46:20 | AUTO_TRANSLATE:auto_start | ru | ok | raids.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **48,132** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=10.72%, reason=stable_fail_rate=10.7% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-23 04:47:26
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **14,890** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 75 |
| ❌ Błędów | 137 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **TR** (3,999), **ES** (3,418), **PL** (1,892), **RO** (1,267), **RU** (1,208) |
| 📊 Porównanie | ↓ 28.2% vs wczoraj (20,729) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **35,619** kluczy
...
| 🔄 Cykli wykonanych | **#9,514** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-23 04:47:26  
