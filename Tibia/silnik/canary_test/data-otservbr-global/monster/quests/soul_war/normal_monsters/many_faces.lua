...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "I have a head start.", yell = false , i18nKey = "monster.many_faces.voice_1"},
	{ text = "Look into my eyes! No, the other ones!", yell = false , i18nKey = "monster.many_faces.voice_2"},
	{ text = "The mirrors can't contain the night!", yell = false , i18nKey = "monster.many_faces.voice_3"},
}
