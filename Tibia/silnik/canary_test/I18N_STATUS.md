...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 16.97% / real 9.79%**. Tempo: **2285.0 kluczy/h**. Tłumaczeń netto: **105,812**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-02 21:27:51

> **Aktualizacja:** 2026-04-02 21:27:51 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #13,292 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: nl | Plik: npc.json | Heartbeat: 2026-04-02T21:26:39Z  
> **Okno godzinowe:** okno=1.0h | cykli=104 | pominięte=0.0% | odrzucone=45.0% | przepustowość=2285.0/h  
> **Tłumaczeń netto:** 105,812

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-02 21:27:51 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-02T21:26:39Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 57s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-02 21:27:51 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-02T21:26:32.928318Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-02T21:26:33.636124Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-02 21:27:51 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-02T21:26:39Z
...
| ❤️ **Heartbeat** | 2026-04-02T21:26:39Z |
...
| �📊 Przetłumaczono | **2,285** kluczy |
| ❌ Odrzucone (guard) | 1872 |
| 🔁 Cykli | 104 |
| 🌍 Języków | 11 |
| 🏆 Najaktywniejszy | ES (956 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~2285 kluczy/h |
...
| PT | 54,870 | 74,536 | 73.62% ↑+0.12% | 54,406 |
...
> **ETA globalne:** ~55 dni (3,024,465 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 77.6% | 57,830/74,536 | ~6h |
| PL | ██████████████░░░░░░ | 70.8% | 52,735/74,536 | ~8h |
| IT | ████████████░░░░░░░░ | 64.0% | 47,724/74,536 | ~10h |
| RO | ████████████░░░░░░░░ | 62.1% | 46,269/74,536 | ~11h |
| RU | ████████░░░░░░░░░░░░ | 41.8% | 31,118/74,536 | ~17h |
| FR | ███████████░░░░░░░░░ | 55.3% | 41,194/74,536 | ~13h |
| SR | ██████░░░░░░░░░░░░░░ | 33.3% | 24,827/74,536 | ~20h |
| CS | ████████░░░░░░░░░░░░ | 43.8% | 32,622/74,536 | ~17h |
| PT | ██████████████░░░░░░ | 73.6% | 54,870/74,536 | ~7h |
| NL | ██████████████░░░░░░ | 70.9% | 52,823/74,536 | ~8h |
| TR | ████░░░░░░░░░░░░░░░░ | 24.2% | 18,027/74,536 | ~23h |
...
> Tempo obliczone na bazie ostatniej godziny: ~2285 kluczy/h.
...
> Świeżość: 57s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-02 21:27:51
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-02T21:26:32.928318Z
...
- In this tower, there must be some accessory used for magical scrying. Some pond, → Nesta torre deve haver algum acessório usado para vidência mágica. Algum lago, u (npc.curos.multi_6)
- Usually we would send one of our youngsters on such a mission, but we are few an → Normalmente enviaríamos um dos nossos jovens em tal missão, mas somos poucos e h (npc.curos.multi_7)
- We can't send a Mooh'Tah master on such a trivial assignment, neither can we use → Não podemos enviar um mestre Mooh'Tah para uma tarefa tão trivial, nem podemos u (npc.curos.multi_8)
- This is your chance to show us your potential. Infiltrate this tower and destroy → Esta é sua chance de nos mostrar seu potencial. Infiltre-se nesta torre e destru (npc.curos.multi_9)
- You come here to ask us to spare your people? This land has no tolerance for the → Você veio aqui para nos pedir para poupar seu povo? Esta terra não tem tolerânci (npc.curos.say_1)
- With the death of their leader, the rebels return to our camps one by one, deepl → Com a morte do seu líder, os rebeldes regressam aos nossos acampamentos, um a um (npc.curos.say_2)
- You have recovered my brooch! I shall forever be in your debt, my friend! → Você recuperou meu broche! Estarei para sempre em dívida com você, meu amigo! (npc.dalbrect.say_1)
- What? You want me to examine a brooch? → O que? Você quer que eu examine um broche? (npc.dalbrect.say_2)
- What are you talking about? I am too poor to be interested in jewelry. → O que você está falando? Sou pobre demais para me interessar por joias. (npc.dalbrect.say_3)
- I should have known better than to ask for an act of kindness in this cruel, sel → Eu deveria ter pensado melhor antes de pedir um ato de bondade neste mundo cruel (npc.dalbrect.say_4)
- Then stop being a fool. I am poor and I have to work the whole day through! → Então pare de ser um tolo. Sou pobre e tenho que trabalhar o dia inteiro! (npc.dalbrect.say_5)
- I should have known better than to ask for an act of kindness in this cruel, sel → Eu deveria ter pensado melhor antes de pedir um ato de bondade neste mundo cruel (npc.dalbrect.say_6)
- Can it be? I recognise my family's arms! You have found a treasure indeed! I am  → Pode ser? Reconheço os braços da minha família! Você realmente encontrou um teso (npc.dalbrect.say_7)
- Thank you! I shall consider you my friend from now on! Just let me know if you { → Obrigado! Vou considerá-lo meu amigo de agora em diante! Deixe-me saber se você  (npc.dalbrect.say_8)
- I have only sailed to the isle of the kings once or twice. \z
				I dare not ang → Só naveguei até à ilha dos reis uma ou duas vezes. \z
				Não me atrevo a irrita (npc.dalbrect.stdmod_1)
- Our family fortune was lost when the colonization of those cursed lands failed.  → A fortuna da nossa família foi perdida quando a colonização daquelas terras amal (npc.dalbrect.stdmod_10)
- Our family fortune was lost when the colonization of those cursed lands failed.  → A fortuna da nossa família foi perdida quando a colonização daquelas terras amal (npc.dalbrect.stdmod_11)
- To think my family used to belong to the local nobility! And now those arrogant  → E pensar que minha família pertencia à nobreza local! E agora essas mulheres arr (npc.dalbrect.stdmod_12)
- There is little I can offer you but a trip with my boat. \z
				Are you looking  → Há pouco que posso oferecer a não ser uma viagem com meu barco. \z
				Você está (npc.dalbrect.stdmod_13)
- Do you seek a passage to the isle of the kings for 10 gold coins? → Você procura uma passagem para a ilha dos reis por 10 moedas de ouro? (npc.dalbrect.stdmod_2)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **3666**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3524**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 280 | 0 | 0 | - | 2026-04-02T21:26:39.276016Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **16.97%** (657,603/3,875,872)
- **Pokrycie globalne (real):** **9.79%** (379,575/3,875,872)
- **Kopie EN (łącznie):** **428,292**
- **Placeholdery [EN]/puste (łącznie):** **2,213,866**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-02T20:27:51.900877Z → 2026-04-02T21:27:51.900877Z) |
...
| Przepustowość (kluczy/h) | **2285.0 kluczy/h** |
| Podejrzane tłumaczenia | **2787** |
...
|--------|-----------|--------|----------------|
| `gt_validate_fail_placeholder` | 509 | 98.6% | it/npc.json (141) |
| `gt_rejected_critical` | 3 | 0.6% | es/monsters.json (2) |
| `gt_validate_fail_word_salad` | 3 | 0.6% | es/monsters.json (1) |
| `gt_rejected_high_partial_translation_mix` | 1 | 0.2% | es/monsters.json (1) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-02T21:26:33.636124Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-02T21:26:33.636124Z
- **Top 5 typów problemów:** suspicious_rejected_critical=200, suspicious_log_high=101, suspicious_log_medium=60, suspicious_log_critical=21, suspicious_log_low=18
- **Języki o najsłabszej jakości:** ro(60.1, issues=380533), pl(60.1, issues=365800), pt(60.1, issues=30669), it(60.8, issues=138133), fr(66.4, issues=42726)
...
⚠️ **ES**: jakość 88%, 681456 problemów
⚠️ **PT**: jakość 60%, 30669 problemów
⚠️ **FR**: jakość 66%, 42726 problemów
⚠️ **IT**: jakość 61%, 138133 problemów
...
| Heartbeat | 74s temu | 2026-04-02T21:26:39Z |
...
- **TOP 5 języków:** DE (22,448), NL (19,670), CS (18,655), PT (17,796), FR (15,643)
- **Aktualnie naprawia:** ES / -
- **Ostatnia aktualizacja:** 2026-04-02T21:24:01.271756Z
...
- 2026-04-02 21:26:39 | AUTO_TRANSLATE:heartbeat_tick | nl | ok | npc.json
- 2026-04-02 21:26:39 | AUTO_TRANSLATE:auto_start | nl | ok | npc.json
- 2026-04-02 21:26:33 | AUTO_TRANSLATE:auto_done | pt | ok | npc.json
- 2026-04-02 21:25:52 | AUTO_TRANSLATE:heartbeat_tick | pt | ok | npc.json
- 2026-04-02 21:24:24 | AUTO_TRANSLATE:heartbeat_tick | pt | ok | npc.json
- 2026-04-02 21:24:24 | AUTO_TRANSLATE:auto_start | pt | ok | npc.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 70.8% | 0 | 5,888 | 1,054 | 3698 (77.8%) | 24 |
| 🟡 ES | 77.6% | 0 | 9,725 | 2,761 | 934 (25.3%) | 36 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **105,812** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=49.82%, reason=decrease_high_fail_rate=49.8%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 3,815 kluczy / 60 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-02 21:27:51
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [nl] → warn (files+1, translated+148, skipped+0) — lang=nl file=client.json strict_skipped_done=31 guard_fail=3 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+71) — repair_identical lang=es file=npc.json target_identical=350 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=119.72
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+3) — repair_identical lang=es file=npc.json target_identical=2825 limit=156 tier=high_backlog+domain_cap+suspicious_guard domain_cap=260 gt=true suspicious_pct=853.23
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-02 21:27:51  
