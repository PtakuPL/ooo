...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.02% / real 10.94%**. Tempo: **635.0 kluczy/h**. Tłumaczeń netto: **146,223**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 10:19:52

> **Aktualizacja:** 2026-04-29 10:19:52 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,208 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ro | Plik: items.json | Heartbeat: 2026-04-29T10:19:15Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=6.2% | przepustowość=635.0/h  
> **Tłumaczeń netto:** 146,223

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 10:19:52 |
| LIVE | 🟢 AKTYWNY | 43s temu | - | `activity.json / worker_state.json` | 2026-04-29T10:19:15Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 26s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 10:19:52 |
| TRANSLATION | 🟢 AKTYWNY | 3min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T10:16:11.796411Z |
| QUALITY | 🔒 NIEAKTYWNY | 43s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T10:19:14.415566Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 10:19:52 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T10:19:58.331474Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 43s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T10:19:15Z
...
| ❤️ **Heartbeat** | 2026-04-29T10:19:15Z |
...
| ⏳ Oldest pending (visible tail) | 15282 s |
...
| 🌍 Recent provider mix | TM/simple(318), Free Google Translate(153), canonical_name_semantic_autofix(15), term_consistency_autofix(3) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=914/914 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 386, 'oldest_s': 15282}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~196 dni (2,983,670 kluczy do celu 95%)
...
> Świeżość: 26s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 10:19:52
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T10:16:11.796411Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T10:19:41.700984Z |
...
| 🕒 Evidence window | 24h (span=39.46h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=39.46h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T09:19:52.318005Z → 2026-04-29T10:19:52.318005Z) |
...
> Świeżość: 43s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T10:19:14.415566Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T10:19:14.415566Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=743769), ro(60.1, issues=439670), de(60.1, issues=122399), cs(60.1, issues=108286), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 61%, 56568 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 743769 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 75%, 176621 problemów
⚠️ **RU**: jakość 66%, 370003 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,208 |
| Heartbeat | 43s temu | 2026-04-29T10:19:15Z |
...
- 2026-04-29 10:19:43 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-04-29 10:19:42 | AUTO_TRANSLATE:auto_start | ro | ok | items.json
- 2026-04-29 10:17:59 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **146,223** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=7.23%, reason=stable_fail_rate=7.2%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 10:19:52
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+1) — repair_identical lang=es file=quests.json target_identical=1 limit=180 tier=low_backlog domain_cap=180 gt=true suspicious_pct=100.00
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+122, skipped+0) — lang=es file=items.json strict_skipped_done=14698 guard_fail=19 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+0, translated+0, skipped+0) — lang=es file=npc.json strict_skip missing_file=-> missing_key=28 skipped_done=(reason=word_salad_pressure_2598of5326, top=gt_validate_fail_placeholder, word_salad=2598/5326)
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [fr] → warn (files+1, translated+34, skipped+0) — lang=fr file=npc.json strict_skipped_done=2999 guard_fail=95 placeholder=51 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **8,736** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 185 |
| ❌ Błędów | 374 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,588), **RU** (1,538), **IT** (1,286), **TR** (1,237), **DE** (1,215) |
| 📊 Porównanie | ↑ 6.2% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **27,716** kluczy
...
| 🔄 Cykli wykonanych | **#18,208** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,208 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 10:19:52  
