...
> **Aktualizacja:** 2025-12-10 23:33:18 UTC  
...
│ 0/1000 kluczy (0%)                                          │
├─────────────────────────────────────────────────────────────────┤
│ ⏳ Total processed: 12066 operacji               │
│ 🕐 Aktywne kategorie: 16                               │
│ 📅 Ostatnia aktualizacja: 2025-12-10 23:33:18                 │
└─────────────────────────────────────────────────────────────────┘
```
...
|---------|---------|-----------|
| 📁 Operacji wykonanych | **12066** | we wszystkich kategoriach |
| ✅ NPC zmigrowanych | **26** (318 z i18nKey) | z 1026 plików NPC |
| 🔑 Kluczy wyciągniętych | **24065** | we wszystkich kategoriach |
...
| client | 14 | 14 | 1 | ⏭️ Skip 3m |
| messages | 11 | 0 | 0 | ✅ Active |
| chatchannels | 8 | 8 | 1 | ⏭️ Skip 2m |
| events | 5 | 5 | 1 | ⏭️ Skip 1m |
| libs | 5 | 5 | 1 | ⏭️ Skip 1m |
| actions | 0 | 0 | 0 | ⏳ Empty |
| errors | 0 | 0 | 0 | ⏳ Empty |
...
| items | 1m | 1x | Progresywny backoff |
| libs | 1m | 1x | Progresywny backoff |
| events | 1m | 1x | Progresywny backoff |
| chatchannels | 2m | 1x | Progresywny backoff |
...
| keywordhandler | 4m | 1x | Progresywny backoff |
...
📅 Auto-updated by Worker v1.1 | Last: 2025-12-10 23:33:18  
