...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.88% / real 10.79%**. Tempo: **840.0 kluczy/h**. Tłumaczeń netto: **136,532**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-28 21:52:28

> **Aktualizacja:** 2026-04-28 21:52:28 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,168 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ro | Plik: items.json | Heartbeat: 2026-04-28T21:51:05Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=3.6% | przepustowość=840.0/h  
> **Tłumaczeń netto:** 136,532

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-28 21:52:28 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-28T21:51:05Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 46s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-28 21:52:28 |
| TRANSLATION | 🟢 AKTYWNY | 4min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-28T21:47:37.441019Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-28T21:51:04.778829Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-28 21:52:28 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-28T21:52:36.110237Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-28T21:51:05Z
...
| ❤️ **Heartbeat** | 2026-04-28T21:51:05Z |
...
| ⏳ Oldest pending (visible tail) | 15391 s |
...
| 🧮 OpenAI budget | `199/250` |
| ♻️ Provider debt | `1265` |
| 🌍 Recent provider mix | TM/simple(276), Free Google Translate(205), OpenAI model pool(26), canonical_name_semantic_autofix(15), ter... |
| 🔁 Latest fallback | TM/simple → fallback to google translate high [high_reject_types] items.json |
| 📉 Fallback breakdown | fallback to google translate high(10), fallback to next provider validate fail(5), fallback chain exhausted... |
...
| ❤️ Pool health | `critical` (writes=525, fallbacks=19) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=339/339 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 389, 'oldest_s': 15391}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~148 dni (2,989,108 kluczy do celu 95%)
...
> Świeżość: 46s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-28 21:52:28
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 4min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-28T21:47:37.441019Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-28T21:51:30.690868Z |
...
| 🕒 Evidence window | 24h (span=27.00h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=27.00h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-28T20:52:29.155426Z → 2026-04-28T21:52:29.155426Z) |
...
| Najgorsze cele (strażnik) | cs/items.json (gf=15), ro/items.json (gf=8), it/items.json (gf=3), de/otclient_modules.json (gf=2), de/npc.json (gf=2) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-28T21:51:04.778829Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-28T21:51:04.778829Z
- **Top 5 typów problemów:** suspicious_rejected_critical=196, suspicious_log_low=130, suspicious_log_high=68, suspicious_rejected_high=4, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=722739), ro(60.1, issues=421842), ru(60.1, issues=355669), de(60.1, issues=105293), cs(60.1, issues=79297)
...
⚠️ **ES**: jakość 60%, 722739 problemów
⚠️ **PT**: jakość 68%, 57411 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 72%, 166994 problemów
⚠️ **RU**: jakość 60%, 355669 problemów
⚠️ **NL**: jakość 60%, 72190 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,168 |
| Heartbeat | 91s temu | 2026-04-28T21:51:05Z |
...
- **Ostatnia aktualizacja:** 2026-04-28T21:47:54.242013Z
...
- 2026-04-28 21:51:31 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-04-28 21:51:31 | AUTO_TRANSLATE:auto_start | ro | ok | items.json
- 2026-04-28 21:50:52 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-28 21:49:23 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-28 21:47:54 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-28 21:52:28
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **6,419** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 81 |
| ❌ Błędów | 253 |
| 🌍 Aktywnych języków | 9 |
| 🏆 TOP 5 | **DE** (1,092), **RU** (983), **IT** (787), **TR** (690), **CS** (662) |
| 📊 Porównanie | ↑ 23.7% vs wczoraj (5,188) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **29,279** kluczy
...
| 🔄 Cykli wykonanych | **#17,168** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,168 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-28 21:52:28  
