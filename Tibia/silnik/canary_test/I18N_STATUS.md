...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.05% / real 10.97%**. Tempo: **534.0 kluczy/h**. Tłumaczeń netto: **148,713**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 14:09:34

> **Aktualizacja:** 2026-04-29 14:09:34 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,513 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: cs | Plik: items.json | Heartbeat: 2026-04-29T14:06:48Z
> **Okno godzinowe:** okno=1.0h | cykli=69 | pominięte=0.0% | odrzucone=4.6% | przepustowość=534.0/h  
> **Tłumaczeń netto:** 148,713

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 14:09:34 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T14:06:48Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 14:09:34 |
| TRANSLATION | 🟢 AKTYWNY | 56s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T14:08:45.540640Z |
| QUALITY | 🔒 NIEAKTYWNY | 55s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T14:08:46.645762Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 14:09:34 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T14:09:42.275340Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T14:06:48Z
...
| 🔄 **Ostatni cykl** | 31 kluczy, 1 odrzuconych, 87.0s, tryb: AUTO_TRANSLATE, cel: ru/items.json |
| ❤️ **Heartbeat** | 2026-04-29T14:06:48Z |
...
| ⏳ Oldest pending (visible tail) | 16835 s |
...
| 🌍 Recent provider mix | TM/simple(376), Free Google Translate(128), canonical_name_semantic_autofix(18), OpenAI model pool(8), term... |
...
| ❤️ Pool health | `critical` (writes=533, fallbacks=28) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=1089/1089 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 16835}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~233 dni (2,982,443 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 79.2% | 59,040/74,536 | ~22h |
| PL | ██████████████░░░░░░ | 71.0% | 52,911/74,536 | ~34h |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 14:09:34
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 56s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T14:08:45.540640Z
...
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14592.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14593.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14594.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14595.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14596.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14597.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14598.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14599.name)
- stone wall → каменный стена (item.1460.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14600.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14601.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14602.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14603.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14604.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14605.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14606.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14607.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14608.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14609.name)
- fire shrine → огненный храм (item.146.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4976**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4829**
...
- **Pokrycie globalne (nominal):** **18.05%** (699,625/3,875,872)
- **Pokrycie globalne (real):** **10.97%** (425,370/3,875,872)
- **Kopie EN (łącznie):** **410,342**
- **Placeholdery [EN]/puste (łącznie):** **2,186,038**
...
| 🕒 Evidence window | 24h (span=43.29h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=43.29h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T13:09:34.697561Z → 2026-04-29T14:09:34.697561Z) |
...
| Przepustowość (kluczy/h) | **534.0 kluczy/h** |
| Podejrzane tłumaczenia | **1036** |
| Najgorsze cele (strażnik) | cs/items.json (gf=9), ro/items.json (gf=8), de/npc.json (gf=3), ru/items.json (gf=3), de/otclient_modules.json (gf=2) |
...
> Świeżość: 55s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T14:08:46.645762Z
...
| Heartbeat | 174s temu | 2026-04-29T14:06:48Z |
...
- 2026-04-29 14:07:18 | AUTO_TRANSLATE:auto_start | ru | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 14:09:34
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **11,464** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 216 |
| ❌ Błędów | 508 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,935), **RU** (1,840), **TR** (1,803), **DE** (1,665), **IT** (1,633) |
| 📊 Porównanie | ↑ 39.3% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **30,444** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 14:09:34  
