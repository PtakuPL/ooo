...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.65% / real 10.53%**. Tempo: **352.4 kluczy/h**. Tłumaczeń netto: **125,945**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-23 20:01:18

> **Aktualizacja:** 2026-04-23 20:01:18 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #16,328 | Status: ✅ BEZCZYNNY | Faza: IDLE | Etap: doctor_pause | Kategoria: - | Plik: - | Heartbeat: 2026-04-23T19:58:27Z  
> **Okno godzinowe:** okno=1.0h | cykli=47 | pominięte=0.0% | odrzucone=61.5% | przepustowość=352.4/h  
> **Tłumaczeń netto:** 125,945

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-23 20:01:18 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-04-23T19:58:27Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 52s temu | worker w trybie IDLE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-23 20:01:18 |
| TRANSLATION | 🔒 NIEAKTYWNY | 43min temu | worker w trybie IDLE | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-23T19:18:02.317840Z |
| QUALITY | 🔒 NIEAKTYWNY | 42min temu | worker w trybie IDLE | `quality_audit_latest.json` | 2026-04-23T19:18:32.407318Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-23 20:01:18 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-23T20:01:31.324958Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-23T19:58:27Z
...
| ❤️ **Heartbeat** | 2026-04-23T19:58:27Z |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=176/176 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `NO_WRITE` | ALERT | WARNING | `2583` | `900` | Brak świeżych zapisów przy pending=400. |
...
| �📊 Przetłumaczono | **207** kluczy |
| ❌ Odrzucone (guard) | 331 |
| 🔁 Cykli | 47 |
| 🌍 Języków | 4 |
| 🏆 Najaktywniejszy | PL (93 kluczy) |
| 📄 Najczęstszy plik | quests.json |
| ⚡ Przepustowość | ~352 kluczy/h |
| 🛡️ Odrzucone (strażnik) | 61.5% |
| ⚠️ Podejrzane | 969 |
...
> **ETA globalne:** ~354 dni (2,998,094 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~352 kluczy/h.
...
> Świeżość: 52s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-23 20:01:18
...
> Świeżość: 43min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-23T19:18:02.317840Z
...
| 🕒 Evidence window | 24h (span=2.78h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ❌ FAIL | window=2.78h (<24h or non-decreasing); client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=+0.00pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-23T19:01:18.627478Z → 2026-04-23T20:01:18.627478Z) |
| Cykle | **47** (TŁUMACZENIE=47, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **61.5%** |
| Cykle bez postępu % | **0.0%** |
| Przepustowość (kluczy/h) | **352.4 kluczy/h** |
| Podejrzane tłumaczenia | **969** |
| Najgorsze cele (strażnik) | pl/questlog.json (gf=300), tr/html.json (gf=17), de/client.json (gf=4), pl/npc.json (gf=4), es/raids.json (gf=2) |
...
|--------|-----------|--------|----------------|
| `provider_chain_exhausted` | 344 | 52.7% | pl/npc.json (137) |
| `gt_validate_fail_identical_to_en` | 286 | 43.8% | pl/questlog.json (282) |
| `gt_validate_fail_quality` | 11 | 1.7% | pl/questlog.json (10) |
| `gt_validate_fail_placeholder` | 6 | 0.9% | pl/questlog.json (6) |
| `gt_rejected_critical` | 4 | 0.6% | tr/html.json (2) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie IDLE)  
> Świeżość: 42min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-23T19:18:32.407318Z
...
| Heartbeat | 184s temu | 2026-04-23T19:58:27Z |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-23 20:01:18
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-23 20:01:18  
