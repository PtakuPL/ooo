...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.66% / real 9.02%**. Tempo: **2419.0 kluczy/h**. Tłumaczeń netto: **77,271**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-29 08:00:18

> **Aktualizacja:** 2026-03-29 08:00:18 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #11,493 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: it | Plik: monsters.json | Heartbeat: 2026-03-29T08:00:19Z  
> **Okno godzinowe:** okno=1.0h | cykli=83 | pominięte=0.0% | odrzucone=21.2% | przepustowość=2419.0/h  
> **Tłumaczeń netto:** 77,271

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-29 08:00:18 |
| LIVE | 🟢 AKTYWNY | 1s temu | - | `activity.json / worker_state.json` | 2026-03-29T08:00:19Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 18s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-29 08:00:18 |
| TRANSLATION | 🟢 AKTYWNY | 43s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-29T07:59:37.046160Z |
| QUALITY | 🔒 NIEAKTYWNY | 22s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-29T07:59:57.822706Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-29 08:00:18 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-29T08:00:19Z
...
| ❤️ **Heartbeat** | 2026-03-29T08:00:19Z |
...
> **ETA globalne:** ~52 dni (2,997,762 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~2419 kluczy/h.
...
> Świeżość: 18s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-29 08:00:18
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 43s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-29T07:59:37.046160Z
...
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3095**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 279 | 1 | 34,369 | - | 2026-03-29T08:00:19.119326Z |
...
- **Profiler cyklu (ostatni):** cykl #115 (AUTO_TRANSLATE): dispatch 820ms, mode 116890ms, status 6193ms, total 125144ms
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-29T07:00:18.751506Z → 2026-03-29T08:00:18.751506Z) |
...
| Przepustowość (kluczy/h) | **2419.0 kluczy/h** |
| Podejrzane tłumaczenia | **889** |
| Najgorsze cele (strażnik) | ro/monsters.json (gf=141), tr/npc.json (gf=137), it/npc.json (gf=116), fr/npc.json (gf=103), es/server.json (gf=28) |
...
> Świeżość: 22s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-29T07:59:57.822706Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-03-29T07:59:57.822706Z
- **Top 5 typów problemów:** suspicious_rejected_critical=194, suspicious_log_high=119, suspicious_log_medium=60, suspicious_log_low=21, suspicious_rejected_high=6
- **Języki o najsłabszej jakości:** cs(60.1, issues=21686), tr(60.1, issues=10370), ro(60.2, issues=350169), de(61.4, issues=72705), fr(61.7, issues=25792)
...
⚠️ **TR**: jakość 60%, 10370 problemów
⚠️ **PL**: jakość 86%, 336829 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 73%, 654251 problemów
⚠️ **PT**: jakość 62%, 25535 problemów
⚠️ **FR**: jakość 62%, 25792 problemów
⚠️ **IT**: jakość 70%, 119938 problemów
⚠️ **RU**: jakość 78%, 300828 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #11,493 |
| Heartbeat | 1s temu | 2026-03-29T08:00:19Z |
...
- 2026-03-29 07:59:37 | AUTO_TRANSLATE:auto_done | ro | ok | monsters.json
- 2026-03-29 07:59:31 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | monsters.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **77,271** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=15.38%, reason=stable_fail_rate=15.4%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-29 08:00:18
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **10,142** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 99 |
| ❌ Błędów | 171 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **IT** (2,410), **CS** (1,546), **RO** (1,237), **FR** (1,164), **NL** (1,160) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **58,509** kluczy
...
| 🔄 Cykli wykonanych | **#11,493** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #11,493 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-29 08:00:18  
