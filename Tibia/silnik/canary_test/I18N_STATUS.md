...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.93% / real 10.84%**. Tempo: **721.0 kluczy/h**. Tłumaczeń netto: **139,805**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 02:07:03

> **Aktualizacja:** 2026-04-29 02:07:03 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,516 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-04-29T02:04:29Z
> **Okno godzinowe:** okno=1.0h | cykli=80 | pominięte=0.0% | odrzucone=4.4% | przepustowość=721.0/h  
> **Tłumaczeń netto:** 139,805

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 02:07:03 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T02:04:29Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 02:07:03 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T02:04:28.687269Z |
| QUALITY | 🔒 NIEAKTYWNY | 4min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T02:02:41.024230Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 02:07:03 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T02:07:08.920483Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T02:04:29Z
...
| 🔄 **Ostatni cykl** | 33 kluczy, 1 odrzuconych, 76.0s, tryb: AUTO_TRANSLATE, cel: it/items.json |
| ❤️ **Heartbeat** | 2026-04-29T02:04:29Z |
...
| ⏳ Oldest pending (visible tail) | 17274 s |
| 🌍 Top języki | RU(398) |
...
| 🌍 Recent provider mix | TM/simple(313), Free Google Translate(176), canonical_name_semantic_autofix(15), term_consistency_autofix(3) |
| 🔁 Latest fallback | TM/simple → fallback to google translate high [high_reject_types] npc.json |
| 📉 Fallback breakdown | fallback to google translate high(14), fallback to next provider validate fail(5), fallback to google trans... |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=533/533 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 17274}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~173 dni (2,987,238 kluczy do celu 95%)
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 02:07:03
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T02:04:28.687269Z
...
- unknown item → oggetto sconosciuto (item.12160.name)
- unknown item → oggetto sconosciuto (item.12161.name)
- unknown item → oggetto sconosciuto (item.12162.name)
- unknown item → oggetto sconosciuto (item.12163.name)
- unknown item → oggetto sconosciuto (item.12164.name)
- unknown item → oggetto sconosciuto (item.12165.name)
- unknown item → oggetto sconosciuto (item.12166.name)
- unknown item → oggetto sconosciuto (item.12167.name)
- unknown item → oggetto sconosciuto (item.12168.name)
- unknown item → oggetto sconosciuto (item.12169.name)
- mill board → tavola del mulino (item.1217.name)
- unknown item → oggetto sconosciuto (item.12170.name)
- wooden planks → assi di legno (item.12176.name)
- wooden planks → assi di legno (item.12177.name)
- mill board → tavola del mulino (item.1218.name)
- mill board → tavola del mulino (item.1219.name)
- tomb wall → muro della tomba (item.12190.name)
- broken wall → muro rotto (item.12183.name)
- broken wall → muro rotto (item.12184.name)
- broken wall → muro rotto (item.12185.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4726**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4579**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T02:03:13.138820Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.93%** (694,830/3,875,872)
- **Pokrycie globalne (real):** **10.84%** (420,309/3,875,872)
- **Kopie EN (łącznie):** **410,608**
- **Placeholdery [EN]/puste (łącznie):** **2,190,833**
...
| 🕒 Evidence window | 24h (span=31.25h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=31.25h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T01:07:03.486900Z → 2026-04-29T02:07:03.486900Z) |
...
| Najgorsze cele (strażnik) | cs/items.json (gf=15), ro/items.json (gf=8), ru/items.json (gf=3), it/items.json (gf=3), de/otclient_modules.json (gf=2) |
...
> Świeżość: 4min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T02:02:41.024230Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T02:02:41.024230Z
- **Top 5 typów problemów:** suspicious_rejected_critical=188, suspicious_log_low=118, suspicious_log_high=81, suspicious_rejected_high=12, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=729203), ro(60.1, issues=428474), de(60.1, issues=111651), cs(60.1, issues=87940), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 729203 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 72%, 170217 problemów
⚠️ **RU**: jakość 63%, 360469 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,516 |
| Heartbeat | 159s temu | 2026-04-29T02:04:29Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T02:04:45.123278Z
...
- 2026-04-29 02:06:16 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 02:04:45 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 02:04:29 | AUTO_TRANSLATE:auto_done | it | ok | items.json
- 2026-04-29 02:03:14 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-04-29 02:03:13 | AUTO_TRANSLATE:auto_start | it | ok | items.json
- 2026-04-29 02:02:39 | AUTO_TRANSLATE:auto_done | cs | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **139,805** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=4.87%, reason=increase_low_fail_rate=4.9%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 02:07:03

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+33, skipped+0) — lang=it file=items.json strict_skipped_done=1989 guard_fail=1 placeholder=0 command=0 pipe=0
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+1) — repair_identical lang=es file=quests.json target_identical=1 limit=180 tier=low_backlog domain_cap=180 gt=true suspicious_pct=93.33
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [nl] → warn (files+1, translated+69, skipped+0) — lang=nl file=npc.json strict_skipped_done=1335 guard_fail=14 placeholder=11 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **1,749** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 41 |
| ❌ Błędów | 72 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (439), **RU** (278), **IT** (240), **DE** (225), **TR** (202) |
| 📊 Porównanie | ↓ 78.7% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **20,729** kluczy
...
| 🔄 Cykli wykonanych | **#17,516** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,516 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 02:07:03  
