...
function init()
  ...
  function()
    if modules and modules.client_locales and modules.client_locales.openLanguagePicker then
      modules.client_locales.openLanguagePicker()
    elseif modules and modules.client_locales and modules.client_locales.createWindow then
      modules.client_locales.createWindow()
    elseif type(createWindow) == 'function' then
      createWindow()
    end
  end
)
...
function terminate()
    ...
    if languageButton and not languageButton:isDestroyed() then
