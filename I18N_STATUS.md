...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.55%**. Tempo: **1824.4 kluczy/h**. Tłumaczeń netto: **95,514**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-17 04:13:07

> **Aktualizacja:** 2026-02-17 04:13:07 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #228 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ru | Plik: - | Heartbeat: 2026-02-17T04:13:04Z  
> **Okno godzinowe:** okno=1.0h | cykli=149 | pominięte=0.0% | odrzucone=42.7% | przepustowość=1824.4/h  
> **Tłumaczeń netto:** 95,514

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-17 04:13:07 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-17T04:13:04Z |
| MIGRATION | 🔒 NIEAKTYWNY | 48s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-17 04:13:07 |
| TRANSLATION | 🟢 AKTYWNY | 6s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-17T04:13:03.533423Z |
| QUALITY | 🔒 NIEAKTYWNY | 5s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-17T04:13:04.266590Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-17 04:13:07 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-17T04:13:04Z
...
| ❤️ **Heartbeat** | 2026-02-17T04:13:04Z |
...
> Świeżość: 48s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-17 04:13:07
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-17T04:13:03.533423Z
...
| RO (Rumuński) | 12,967/53,586 | 24.20% | 2,414 | 0 |
...
| RO | 12,452/49,731 | 25.0% | 515/3,855 | 13.4% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-17T03:13:08.193681Z → 2026-02-17T04:13:08.193681Z) |
...
| Przepustowość (kluczy/h) | **1824.4 kluczy/h** |
| Podejrzane tłumaczenia | **9981** |
...
> Świeżość: 5s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-17T04:13:04.266590Z

- **Ostatni audyt:** SLOW_MODE | 21 issue(s) / 100 entries | 2026-02-17T04:13:04.266590Z
- **Top 5 typów problemów:** suspicious_rejected_critical=174, suspicious_log_high=139, suspicious_log_low=50, suspicious_rejected_high=26, identical_to_en=16
- **Języki o najsłabszej jakości:** es(60.1, issues=194619), ru(60.2, issues=29868), ro(60.3, issues=38346), it(60.5, issues=11318), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 66%, 125794 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 194619 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 11318 problemów
⚠️ **RU**: jakość 60%, 29868 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 77%, 9297 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #228 |
| Heartbeat | 5s temu | 2026-02-17T04:13:04Z |
...
- 2026-02-17 04:13:01 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | raids.json
- 2026-02-17 04:13:01 | AUTO_TRANSLATE:parallel_start | ro | ok | raids.json
- 2026-02-17 04:12:35 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | scripts.json
- 2026-02-17 04:12:34 | AUTO_TRANSLATE:parallel_start | ro | ok | scripts.json
- 2026-02-17 04:12:33 | AUTO_TRANSLATE:auto_done | ru | ok | scripts.json
- 2026-02-17 04:12:29 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | scripts.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **95,514** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=43.21%, reason=decrease_high_fail_rate=43.2% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-17 04:13:07

- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ro] → ok (translated+49, skipped+0) — parallel lang=ro file=raids.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ro] → ok (translated+43, skipped+0) — parallel lang=ro file=scripts.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → warn (files+1, translated+50, skipped+0) — lang=ru file=scripts.json strict_skipped_done=419
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+50, skipped+0) — lang=pl file=monsters.json strict_skipped_done=2424
- 🌍 TRANSLATION_SYNC: SYNC_FILE_DONE [sv] → ok (keys+66, files+1) — lang=sv file=npc.json
- 🌍 TRANSLATION_SYNC: SYNC_FILE_DONE [pl] → ok (keys+4252, files+1) — lang=pl file=npc.json
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **17,466** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 167 |
| ❌ Błędów | 286 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (3,566), **IT** (3,159), **RU** (3,043), **RO** (2,824), **PL** (2,490) |
| 📊 Porównanie | ↓ 13.9% vs wczoraj (20,288) |
...
| 🔄 Cykli wykonanych | **#228** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-17 04:13:07  
