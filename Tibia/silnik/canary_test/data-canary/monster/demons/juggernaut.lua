...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "RAAARRR!", yell = false , i18nKey = "monster.juggernaut.voice_4"},
	{ text = "GRRRRRR!", yell = false , i18nKey = "monster.juggernaut.voice_5"},
	{ text = "WAHHHH!", yell = false , i18nKey = "monster.juggernaut.voice_6"},
}
