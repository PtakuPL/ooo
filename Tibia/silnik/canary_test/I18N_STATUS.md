...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-19 11:45:32

> **Aktualizacja:** 2026-02-19 11:45:32 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #1 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ro | Plik: globalevents.json | Heartbeat: 2026-02-19T11:45:31Z  
...
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-19 11:45:32 |
| LIVE | 🟢 AKTYWNY | 4s temu | - | `activity.json / worker_state.json` | 2026-02-19T11:45:31Z |
| MIGRATION | 🔒 NIEAKTYWNY | 1d temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-19 11:45:32 |
| TRANSLATION | 🟢 AKTYWNY | 6s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-19T11:45:28.881725Z |
| QUALITY | 🔒 NIEAKTYWNY | 29s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-19T11:45:05.727431Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-19 11:45:32 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 4s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-19T11:45:31Z
...
| ❤️ **Heartbeat** | 2026-02-19T11:45:31Z |
...
> Świeżość: 1d temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-19 11:45:32
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-19T11:45:28.881725Z
...
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3507**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-19T10:45:32.749350Z → 2026-02-19T11:45:32.749350Z) |
...
| Najgorsze cele (strażnik) | ro/otclient_data.json (gf=0), sv/spells.json (gf=0), sr/spells.json (gf=0), pl/example_merchant.json (gf=0), es/chatchannels.json (gf=0) |
...
> Świeżość: 29s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-19T11:45:05.727431Z

- **Ostatni audyt:** SLOW_MODE | 31 issue(s) / 100 entries | 2026-02-19T11:45:05.727431Z
- **Top 5 typów problemów:** suspicious_log_high=194, suspicious_rejected_critical=171, suspicious_rejected_high=29, artifact_token=16, identical_to_en=15
- **Języki o najsłabszej jakości:** es(60.1, issues=266619), pl(60.1, issues=150355), ro(60.1, issues=98398), ru(60.1, issues=81787), sr(60.1, issues=48776)
...
⚠️ **PL**: jakość 60%, 150355 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 266619 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 37181 problemów
⚠️ **RU**: jakość 60%, 81787 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 90%, 25025 problemów
...
| Heartbeat | 4s temu | 2026-02-19T11:45:31Z |
...
- 2026-02-19 11:45:31 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | globalevents.json
- 2026-02-19 11:45:30 | AUTO_TRANSLATE:parallel_start | ro | ok | globalevents.json
- 2026-02-19 11:45:29 | AUTO_TRANSLATE:auto_done | ru | ok | chatchannels.json
- 2026-02-19 11:45:25 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | chatchannels.json
- 2026-02-19 11:45:25 | AUTO_TRANSLATE:auto_start | ru | ok | chatchannels.json
- 2026-02-19 11:45:00 | AUTO_TRANSLATE:heartbeat_tick | it | ok | libs.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-19 11:45:32

- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ro] → ok (translated+0, skipped+0) — parallel lang=ro file=globalevents.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → ok (files+0, translated+0, skipped+0) — lang=ru file=chatchannels.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [it] → ok (translated+0, skipped+0) — parallel lang=it file=libs.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [sr] → ok (translated+0, skipped+0) — parallel lang=sr file=actions.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [sv] → ok (files+0, translated+0, skipped+0) — lang=sv file=raids.json
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ro] → ok (translated+0, skipped+0) — parallel lang=ro file=modules.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ru] → ok (translated+0, skipped+0) — parallel lang=ru file=example_merchant.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → ok (files+0, translated+0, skipped+0) — lang=it file=startup.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ro] → ok (translated+0, skipped+0) — parallel lang=ro file=example_merchant.json
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-19 11:45:32  
