...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "Fee! Fie! Foe! Fum!", yell = false , i18nKey = "monster.cyclops_drone.voice_1"},
	{ text = "Luttl pest!", yell = false , i18nKey = "monster.cyclops_drone.voice_2"},
	{ text = "Me makking you pulp!", yell = false , i18nKey = "monster.cyclops_drone.voice_3"},
	{ text = "Humy tasy! Hum hum!", yell = false , i18nKey = "monster.cyclops_drone.voice_4"},
}
