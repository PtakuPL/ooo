...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.03%**. Tempo: **3673.3 kluczy/h**. Tłumaczeń netto: **75,404**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-16 21:35:08

> **Aktualizacja:** 2026-02-16 21:35:08 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #63 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: es | Plik: - | Heartbeat: 2026-02-16T21:35:02Z  
> **Okno godzinowe:** okno=1.0h | cykli=193 | pominięte=0.0% | odrzucone=37.9% | przepustowość=3673.3/h  
> **Tłumaczeń netto:** 75,404

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-16 21:35:08 |
| LIVE | 🟢 AKTYWNY | 7s temu | - | `activity.json / worker_state.json` | 2026-02-16T21:35:02Z |
| MIGRATION | 🔒 NIEAKTYWNY | 1h temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-16 21:35:08 |
| TRANSLATION | 🟢 AKTYWNY | 30s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-16T21:34:39.274299Z |
| QUALITY | 🔒 NIEAKTYWNY | 7s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-16T21:35:02.335864Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-16 21:35:08 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 7s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-16T21:35:02Z

| Metryka | Wartość |
|---------|---------|
| 🛠️ **Co robi** | Tłumaczenie automatyczne (Google Translate + TM) → cycle_end |
| 🌍 **Aktywne języki (10 min)** | ES, RO, RU, SV |
| 📝 **Faza** | AUTO_TRANSLATE |
| 📋 **Etap** | cycle_end |
| 📂 **Kategoria / Język** | es |
| 📄 **Plik** | - |
...
| ❤️ **Heartbeat** | 2026-02-16T21:35:02Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **6,692** kluczy |
| ❌ Odrzucone (guard) | 4092 |
| 🔁 Cykli | 193 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | SV (1,096 kluczy) |
| 📄 Najczęstszy plik | server.json |
| ⚡ Przepustowość | ~3673 kluczy/h |
...
> Tempo obliczone na bazie ostatniej godziny: ~3673 kluczy/h.
...
> Świeżość: 1h temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-16 21:35:08
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 30s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-16T21:34:39.274299Z
...
| RO (Rumuński) | 9,610/53,586 | 17.93% | 2,513 | 0 |
...
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2212**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **10.03%** (279,620/2,786,472)
- **Kopie EN (łącznie):** **167,048**
...
| RO | 9,516/49,731 | 19.1% | 94/3,855 | 2.4% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-16T20:35:08.603306Z → 2026-02-16T21:35:08.603306Z) |
...
| Przepustowość (kluczy/h) | **3673.3 kluczy/h** |
| Podejrzane tłumaczenia | **37237** |
| Najgorsze cele (strażnik) | pl/items.json (gf=2385), pl/npc.json (gf=812), pl/server.json (gf=400), pl/monsters.json (gf=177), ro/monsters.json (gf=112) |
...
> Świeżość: 7s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-16T21:35:02.335864Z

- **Ostatni audyt:** OK | 5 issue(s) / 100 entries | 2026-02-16T21:35:02.335864Z
- **Top 5 typów problemów:** suspicious_log_high=167, suspicious_rejected_critical=125, suspicious_rejected_high=75, suspicious_log_critical=28, identical_to_en_exempt=13
- **Języki o najsłabszej jakości:** ro(59.9, issues=4782), ru(60.3, issues=8582), es(61.0, issues=153086), it(63.9, issues=4045), tl(64.2, issues=466)
...
| Heartbeat | 7s temu | 2026-02-16T21:35:02Z |
...
- 2026-02-16 21:34:51 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-16 21:34:14 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-02-16 21:34:14 | AUTO_TRANSLATE:parallel_start | ro | ok | items.json
- 2026-02-16 21:34:05 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-02-16 21:34:05 | AUTO_TRANSLATE:parallel_start | ru | ok | items.json
- 2026-02-16 21:34:02 | AUTO_TRANSLATE:auto_done | es | ok | server.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-16 21:35:08
...
| ❌ Błędów | 84 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (1,729), **IT** (1,388), **SV** (1,385), **SR** (1,381), **RU** (1,343) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **89,459** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-16 21:35:08  
