...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.99% / real 10.91%**. Tempo: **745.0 kluczy/h**. Tłumaczeń netto: **144,357**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 07:46:54

> **Aktualizacja:** 2026-04-29 07:46:54 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,992 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: items.json | Heartbeat: 2026-04-29T07:45:39Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=5.3% | przepustowość=745.0/h  
> **Tłumaczeń netto:** 144,357

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 07:46:54 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T07:45:39Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 42s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 07:46:54 |
| TRANSLATION | 🟢 AKTYWNY | 3min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T07:43:45.348897Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T07:45:38.599932Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 07:46:54 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T07:47:03.475606Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T07:45:39Z
...
| ❤️ **Heartbeat** | 2026-04-29T07:45:39Z |
...
| ⏳ Oldest pending (visible tail) | 16689 s |
...
| 🌍 Recent provider mix | TM/simple(311), Free Google Translate(159), canonical_name_semantic_autofix(17), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=490, fallbacks=25) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=796/796 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 394, 'oldest_s': 16689}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~167 dni (2,984,624 kluczy do celu 95%)
...
> Świeżość: 42s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 07:46:54
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T07:43:45.348897Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T07:46:07.351672Z |
...
| 🕒 Evidence window | 24h (span=36.91h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=36.91h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T06:46:55.150262Z → 2026-04-29T07:46:55.150262Z) |
...
| Najgorsze cele (strażnik) | cs/items.json (gf=24), ro/items.json (gf=8), ru/items.json (gf=3), it/items.json (gf=3), de/otclient_modules.json (gf=2) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T07:45:38.599932Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T07:45:38.599932Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=739323), ro(60.1, issues=436527), de(60.1, issues=119158), cs(60.1, issues=101447), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 739323 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 66%, 174733 problemów
⚠️ **RU**: jakość 61%, 366987 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,992 |
| Heartbeat | 84s temu | 2026-04-29T07:45:39Z |
...
- 2026-04-29 07:46:07 | AUTO_TRANSLATE:auto_start | es | ok | items.json
- 2026-04-29 07:45:32 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **144,357** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=6.27%, reason=stable_fail_rate=6.3%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 07:46:54
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **6,686** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 156 |
| ❌ Błędów | 280 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,298), **RU** (1,189), **TR** (954), **IT** (935), **DE** (900) |
| 📊 Porównanie | ↓ 18.7% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **25,666** kluczy
...
| 🔄 Cykli wykonanych | **#17,992** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,992 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 07:46:54  
