...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **11.1%**. Tempo: **138.4 kluczy/h**. Tłumaczeń netto: **80,049**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-15 10:48:02

> **Aktualizacja:** 2026-02-15 10:48:02 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #7,996 | Status: 🟢 DZIAŁA | Faza: PRE_MIGRATION | Etap: cycle_end | Kategoria: dataroot | Plik: - | Heartbeat: 2026-02-15T10:47:55Z  
> **Okno godzinowe:** okno=1.0h | cykli=631 | pominięte=0.0% | odrzucone=38.6% | przepustowość=138.4/h  
> **Tłumaczeń netto:** 80,049

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-15 10:48:02 |
| LIVE | 🟢 AKTYWNY | 8s temu | - | `activity.json / worker_state.json` | 2026-02-15T10:47:55Z |
| MIGRATION | 🟢 AKTYWNY | 8s temu | - | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-15 10:48:02 |
| TRANSLATION | 🔒 NIEAKTYWNY | 58min temu | worker w trybie PRE_MIGRATION | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-15T09:49:55.021039Z |
| QUALITY | 🔒 NIEAKTYWNY | 34min temu | worker w trybie PRE_MIGRATION | `quality_audit_latest.json` | 2026-02-15T10:13:53.206821Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-15 10:48:02 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 8s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-15T10:47:55Z
...
| 📝 **Faza** | PRE_MIGRATION |
| 📋 **Etap** | cycle_end |
| 📂 **Kategoria / Język** | dataroot |
| 📄 **Plik** | - |
| 📊 **Status** | 🟢 DZIAŁA |
| 📈 **Postęp** | - |
| 🔧 **Metoda** | Translation Memory (GT wyłączony) |
| 🔄 **Ostatni cykl** | 0 kluczy, 0 odrzuconych, 0s, tryb: PRE_MIGRATION |
| ❤️ **Heartbeat** | 2026-02-15T10:47:55Z |

**Ostatnie operacje:**
- → scan_done (DATAROOT) [ok]
- → scan_done (NPCLIB) [ok]
- → scan_done (CHATCHANNELS) [ok]
- → scan_done (EVENTS) [ok]
- → scan_done (LIBS) [ok]
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **189** kluczy |
| ❌ Odrzucone (guard) | 119 |
| 🔁 Cykli | 631 |
| 🌍 Języków | 2 |
| 🏆 Najaktywniejszy | PL (101 kluczy) |
...
> **ETA globalne:** ~704 dni (2,337,706 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| PL | █████████████████░░░ | 87.4% | 46,847/53,586 | ~29h |
...
> Świeżość: 8s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-15 10:48:02
...
> Świeżość: 58min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-15T09:49:55.021039Z
...
- **Profiler cyklu (ostatni):** cykl #23 (PRE_MIGRATION): dispatch 723ms, mode 464ms, status 5084ms, total 7832ms
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-15T09:48:03.011187Z → 2026-02-15T10:48:03.011187Z) |
| Cykle | **631** (TŁUMACZENIE=15, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **38.6%** |
| Cykle bez postępu % | **0.0%** |
| Przepustowość (kluczy/h) | **138.4 kluczy/h** |
| Podejrzane tłumaczenia | **44** |
| Najgorsze cele (strażnik) | es/html.json (gf=56), pl/html.json (gf=44), pl/otclient_modules.json (gf=12), es/client.json (gf=4), pl/client.json (gf=3) |
...
> Świeżość: 34min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-15T10:13:53.206821Z

- **Ostatni audyt:** SLOW_MODE | 23 issue(s) / 100 entries | 2026-02-15T10:13:53.206821Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=222533), pl(60.1, issues=151907), tl(64.2, issues=466), zh_TW(64.8, issues=337), fr(66.5, issues=2470)
...
⚠️ **PL**: jakość 60%, 151907 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 222533 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #7,996 |
| Heartbeat | 8s temu | 2026-02-15T10:47:55Z |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-15 10:48:02
...
| 🔄 Cykli wykonanych | **#7,996** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-15 10:48:02  
