...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.39%**. Tempo: **2301.7 kluczy/h**. Tłumaczeń netto: **88,992**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-17 01:47:56

> **Aktualizacja:** 2026-02-17 01:47:56 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #135 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: es | Plik: - | Heartbeat: 2026-02-17T01:47:52Z  
> **Okno godzinowe:** okno=1.0h | cykli=173 | pominięte=0.0% | odrzucone=46.4% | przepustowość=2301.7/h  
> **Tłumaczeń netto:** 88,992

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-17 01:47:56 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-17T01:47:52Z |
| MIGRATION | 🔒 NIEAKTYWNY | 57s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-17 01:47:56 |
| TRANSLATION | 🟢 AKTYWNY | 25s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-17T01:47:31.657201Z |
| QUALITY | 🔒 NIEAKTYWNY | 4s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-17T01:47:52.668650Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-17 01:47:56 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-17T01:47:52Z
...
| ❤️ **Heartbeat** | 2026-02-17T01:47:52Z |
...
> Tempo obliczone na bazie ostatniej godziny: ~2302 kluczy/h.
...
> Świeżość: 57s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-17 01:47:56
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 25s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-17T01:47:31.657201Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-17T00:47:56.343910Z → 2026-02-17T01:47:56.343910Z) |
...
| Przepustowość (kluczy/h) | **2301.7 kluczy/h** |
| Podejrzane tłumaczenia | **14797** |
| Najgorsze cele (strażnik) | pl/items.json (gf=2072), pl/npc.json (gf=378), pl/scripts.json (gf=175), ro/monsters.json (gf=80), es/questlog.json (gf=61) |
...
> Świeżość: 4s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-17T01:47:52.668650Z

- **Ostatni audyt:** SLOW_MODE | 27 issue(s) / 100 entries | 2026-02-17T01:47:52.668650Z
- **Top 5 typów problemów:** suspicious_rejected_critical=162, suspicious_log_high=98, suspicious_log_critical=61, suspicious_log_low=41, suspicious_rejected_high=38
- **Języki o najsłabszej jakości:** sv(60.0, issues=6759), es(60.1, issues=178149), ro(60.1, issues=27644), ru(60.1, issues=22276), pl(62.5, issues=120621)
...
⚠️ **PL**: jakość 62%, 120621 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 178149 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 68%, 8120 problemów
⚠️ **RU**: jakość 60%, 22276 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 60%, 6759 problemów
...
| Heartbeat | 5s temu | 2026-02-17T01:47:52Z |
...
- 2026-02-17 01:47:28 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | html.json
- 2026-02-17 01:47:28 | AUTO_TRANSLATE:parallel_start | pl | ok | html.json
- 2026-02-17 01:47:26 | AUTO_TRANSLATE:auto_done | es | ok | questlog.json
- 2026-02-17 01:47:16 | AUTO_TRANSLATE:heartbeat_tick | es | ok | questlog.json
- 2026-02-17 01:47:16 | AUTO_TRANSLATE:auto_start | es | ok | questlog.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 45.4% | 0 | 1,919 | 1,149 | 4329 (79.0%) | 35 |
| 🟡 ES | 74.5% | 0 | 2,631 | 756 | 450 (37.3%) | 34 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **88,992** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=26.2%, reason=decrease_high_fail_rate=26.2% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,905 kluczy / 69 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-17 01:47:56
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **7,596** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 74 |
| ❌ Błędów | 121 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (1,541), **IT** (1,320), **RU** (1,260), **RO** (1,133), **PL** (1,060) |
| 📊 Porównanie | ↓ 62.6% vs wczoraj (20,288) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **107,790** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-17 01:47:56  
