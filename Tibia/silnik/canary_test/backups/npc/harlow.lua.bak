...
local function creatureSayCallback(npc, creature, type, message)
	...
	if message then
		NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.harlow.say_1")
	end
end
--Travel
local travelNode = keywordHandler:addKeyword({ "vengoth" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.harlow.stdmod_1" }, function(player)
