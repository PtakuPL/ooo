...
> Worker tłumaczy **53** języków. Klucze EN: **4,466**. Pokrycie globalne: **nominal 4.83% / real 4.77%**. Tempo: **245.2 kluczy/h**. Tłumaczeń netto: **172,861**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-06-07 19:16:58

> **Aktualizacja:** 2026-06-07 19:16:58 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 4466
> **Publikacja:** local-only (--no-git)
> **LIVE:** Cykl #21,236 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: fr | Plik: website_i18n.json | Heartbeat: 2026-06-07T19:12:56Z
> **Okno godzinowe:** okno=1.0h | cykli=338 | pominięte=0.0% | odrzucone=3.2% | przepustowość=245.2/h  
> **Tłumaczeń netto:** 172,861

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-06-07 19:16:58 |
| LIVE | 🟢 AKTYWNY | 4min temu | - | `activity.json / worker_state.json` | 2026-06-07T19:12:56Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 4min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-06-07 19:16:58 |
| TRANSLATION | 🟢 AKTYWNY | 10s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-06-07T19:16:50.654457Z |
| QUALITY | 🔒 NIEAKTYWNY | 8s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-06-07T19:16:52.855752Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-06-07 19:16:58 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-06-07T19:17:01.364225Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 4min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-06-07T19:12:56Z
...
| 🔄 **Ostatni cykl** | 6 kluczy, 0 odrzuconych, 85.9s, tryb: AUTO_TRANSLATE, cel: fr/website_i18n.json |
| ❤️ **Heartbeat** | 2026-06-07T19:12:56Z |
...
| ⏳ Oldest pending (visible tail) | 3153996 s |
...
| ♻️ Provider debt | `711` |
| 🌍 Recent provider mix | TM/simple(111), tm_dedup_file(85), Free Google Translate(78), tm_dedup_propagate(1) |
| 🔁 Latest fallback | OpenAI model pool → fallback to google translate all models blocked [all_models_blocked] website_i18n.json |
| 📉 Fallback breakdown | fallback to google translate all models blocked(80) |
...
| ❤️ Pool health | `degraded` (writes=275, fallbacks=80) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=21/443 (4.74%), fail=422, Δchecks=-102, dir=improving |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 349, 'oldest_s': 3153996}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| �📊 Przetłumaczono | **358** kluczy |
| ❌ Odrzucone (guard) | 12 |
| 🔁 Cykli | 338 |
| 🌍 Języków | 9 |
| 🏆 Najaktywniejszy | TR (96 kluczy) |
...
> **ETA globalne:** ~36 dni (209,364 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| PL | ███████████░░░░░░░░░ | 59.6% | 2,664/4,466 | ~6h |
| RU | ████░░░░░░░░░░░░░░░░ | 24.9% | 1,112/4,466 | ~13h |
| ES | ████░░░░░░░░░░░░░░░░ | 21.8% | 973/4,466 | ~13h |
| TR | ████░░░░░░░░░░░░░░░░ | 21.6% | 966/4,466 | ~13h |
| IT | ████░░░░░░░░░░░░░░░░ | 20.1% | 896/4,466 | ~14h |
| FR | ███░░░░░░░░░░░░░░░░░ | 19.8% | 883/4,466 | ~14h |
| RO | ███░░░░░░░░░░░░░░░░░ | 18.0% | 803/4,466 | ~14h |
| PT | ███░░░░░░░░░░░░░░░░░ | 17.1% | 762/4,466 | ~14h |
| NL | ███░░░░░░░░░░░░░░░░░ | 16.2% | 722/4,466 | ~14h |
| CS | ███░░░░░░░░░░░░░░░░░ | 15.6% | 698/4,466 | ~14h |
| DE | ██░░░░░░░░░░░░░░░░░░ | 14.7% | 658/4,466 | ~15h |
| ZH_TW | ░░░░░░░░░░░░░░░░░░░░ | 0.2% | 7/4,466 | ~17h |
| AR | ░░░░░░░░░░░░░░░░░░░░ | 0.1% | 4/4,466 | ~17h |
| BN | ░░░░░░░░░░░░░░░░░░░░ | 0.1% | 4/4,466 | ~17h |
| FA | ░░░░░░░░░░░░░░░░░░░░ | 0.1% | 4/4,466 | ~17h |
| HE | ░░░░░░░░░░░░░░░░░░░░ | 0.1% | 4/4,466 | ~17h |
...
> Świeżość: 4min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-06-07 19:16:58
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 10s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-06-07T19:16:50.654457Z
...
- `FR/website_i18n.json` Not checked → Non vérifié (`community.guilds.global.recruitment.review.result.not_checked`, `tm_dedup_file`)
- `FR/website_i18n.json` Not checked → Non vérifié (`account.guilds.recruitment_applications.eligibility.not_checked`, `google_translate`)
- `FR/website_i18n.json` Needs review → Besoin d'un examen (`account.guilds.recruitment_applications.eligibility.manual_review_required`, `google_translate`)
- `FR/website_i18n.json` Ineligible → Inéligible (`account.guilds.recruitment_applications.eligibility.ineligible`, `google_translate`)
- `FR/website_i18n.json` Eligible → Admissible (`account.guilds.recruitment_applications.eligibility.eligible`, `google_translate`)
- `FR/website_i18n.json` Submitted at → Soumis à (`account.guilds.recruitment_applications.date_label`, `google_translate`)
- `FR/website_i18n.json` Public view → Vue publique (`community.guilds.global.public_view_link`, `tm_dedup_file`)
- `FR/website_i18n.json` Quick actions → Actions rapides (`account.guilds.quick_title`, `google_translate`)
- `FR/website_i18n.json` My global guilds → Mes guildes mondiales (`account.guilds.quick_owned`, `google_translate`)
- `FR/website_i18n.json` Member view → Vue des membres (`account.guilds.quick_member`, `google_translate`)
- `FR/website_i18n.json` Public view → Vue publique (`account.guilds.public_link`, `google_translate`)
- `FR/website_i18n.json` Active guild profile: → Profil de guilde actif : (`account.guilds.profile_label`, `google_translate`)
- `FR/website_i18n.json` To create a guild directly, switch your active profile to a specific Tibia serve → Pour créer directement une guilde, passez votre profil actif sur un serveur Tibi (`account.guilds.profile_hint`, `google_translate`)
- `FR/website_i18n.json` Action: → Action: (`account.guilds.primary_action_label`, `google_translate`)
- `FR/website_i18n.json` Your global guilds: → Vos guildes mondiales : (`account.guilds.owned_label`, `google_translate`)
- `FR/website_i18n.json` You do not own a Tibia global guild yet. → Vous ne possédez pas encore de guilde mondiale Tibia. (`account.guilds.none_owned`, `google_translate`)
- `FR/website_i18n.json` Navigation: → Navigation: (`account.guilds.navigation_label`, `google_translate`)
...
- Raporty strażnika jakości: **5596**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **5299**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 33 | 0 | 0 | - | 2026-06-07T19:15:24.060947Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **4.83%** (11,220/232,232)
- **Pokrycie globalne (real):** **4.77%** (11,075/232,232)
- **Kopie EN (łącznie):** **6,065**
- **Placeholdery [EN]/puste (łącznie):** **95,709**
...
|--------|-------|---------------------|--------------------|------------------------------|--------------------------------------------|
| RedAxe/MyAAC strona WWW | `website` | 3/3 | 4,466 | 3,583 | 19.8% / 19.6% |
| Tibia WWW/Wiki publiczne | `www_tibia` | 3/14 | 4,466 | 3,583 | 19.8% / 19.6% |
...
| 🕒 Evidence window | 24h (span=337.74h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=337.74h; client.json: id=-31.40pp, ws=+0, otclient_modules.json: id=-29.79pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-06-07T18:16:58.827528Z → 2026-06-07T19:16:58.827528Z) |
| Cykle | **338** (TŁUMACZENIE=234, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **3.2%** |
| Cykle bez postępu % | **20.3%** |
| Przepustowość (kluczy/h) | **245.2 kluczy/h** |
| Podejrzane tłumaczenia | **421** |
| Najgorsze cele (strażnik) | ru/html.json (gf=8), ro/html.json (gf=4), cs/website_i18n.json (gf=0), tr/website_i18n.json (gf=0), it/html.json (gf=0) |
...
|--------|-----------|--------|----------------|
| `retry_loop_cooldown_default` | 24 | 64.9% | it/website_i18n.json (8) |
| `gt_identity_retry_identical_to_en` | 11 | 29.7% | tr/website_i18n.json (4) |
| `gt_structure_retry_placeholder` | 2 | 5.4% | ro/html.json (2) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 8s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-06-07T19:16:52.855752Z

- **Ostatni audyt:** OK | 3 issue(s) / 100 entries | 2026-06-07T19:16:52.855752Z
- **Top 5 typów problemów:** suspicious_rejected_high=104, suspicious_log_critical=103, suspicious_rejected_critical=96, suspicious_log_warning=80, identical_to_en_exempt=34
- **Języki o najsłabszej jakości:** ru(60.1, issues=431756), it(60.1, issues=191671), de(60.1, issues=164843), cs(60.1, issues=163473), nl(60.1, issues=80176)
...
⚠️ **TR**: jakość 74%, 68977 problemów
⚠️ **PL**: jakość 76%, 397942 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 82%, 782928 problemów
⚠️ **PT**: jakość 60%, 64273 problemów
⚠️ **FR**: jakość 62%, 69647 problemów
⚠️ **IT**: jakość 60%, 191671 problemów
⚠️ **RU**: jakość 60%, 431756 problemów
⚠️ **NL**: jakość 60%, 80176 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #21,236 |
| Heartbeat | 245s temu | 2026-06-07T19:12:56Z |
...
- 2026-06-07 19:16:51 | AUTO_TRANSLATE:auto_done | fr | ok | website_i18n.json
- 2026-06-07 19:15:28 | AUTO_TRANSLATE:heartbeat_tick | fr | ok | website_i18n.json
- 2026-06-07 19:15:27 | AUTO_TRANSLATE:auto_start | fr | ok | website_i18n.json
- 2026-06-07 19:14:51 | AUTO_TRANSLATE:auto_done | it | ok | website_i18n.json
- 2026-06-07 19:14:33 | AUTO_TRANSLATE:heartbeat_tick | it | ok | website_i18n.json
- 2026-06-07 19:12:56 | AUTO_TRANSLATE:heartbeat_tick | it | ok | website_i18n.json
...
| Przepustowość (okno) | 0 kluczy / 19 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-06-07 19:16:58

- 🤖 AUTO_TRANSLATE: WEBSITE_I18N_APPLY [fr] → ok — keys_updated=225 files_changed=1
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [fr] → warn (files+1, translated+6, skipped+0) — lang=fr file=website_i18n.json strict_skipped_done=11
- 🤖 AUTO_TRANSLATE: WEBSITE_I18N_APPLY [nl] → ok — keys_updated=139 files_changed=1
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [nl] → warn (files+1, translated+5, skipped+0) — lang=nl file=website_i18n.json strict_skipped_done=7
- 🌍 TRANSLATION_SYNC: SYNC_FILE_DONE [pl] → ok (keys+95, files+1) — lang=pl file=html.json
...
| 🏆 TOP 5 | **TR** (258), **FR** (226), **IT** (217), **ES** (209), **PT** (196) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **1,949** kluczy
...
| 🔄 Cykli wykonanych | **#21,236** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #21,236 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-06-07 19:16:58  
