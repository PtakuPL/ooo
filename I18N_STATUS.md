...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.65% / real 10.54%**. Tempo: **289.9 kluczy/h**. Tłumaczeń netto: **126,395**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-27 16:41:28

> **Aktualizacja:** 2026-04-27 16:41:28 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #16,424 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: nl | Plik: questlog.json | Heartbeat: 2026-04-27T16:38:13Z
> **Okno godzinowe:** okno=1.0h | cykli=70 | pominięte=0.0% | odrzucone=17.2% | przepustowość=289.9/h  
> **Tłumaczeń netto:** 126,395

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-27 16:41:28 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-04-27T16:38:13Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 53s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-27 16:41:28 |
| TRANSLATION | 🟢 AKTYWNY | 21min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-27T16:19:48.635194Z |
| QUALITY | 🔒 NIEAKTYWNY | 21min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-27T16:19:49.915224Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-27 16:41:28 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 2 alarmów | `doctor_alerts_latest.json` | 2026-04-27T16:41:35.324553Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-27T16:38:13Z
...
| ❤️ **Heartbeat** | 2026-04-27T16:38:13Z |
...
| ⏳ Oldest pending (visible tail) | 336253 s |
| 🌍 Top języki | NL(133), ES(117), PT(117), PL(19) |
| 🧱 Top reason_bucket | placeholder(164), provider_error(96), default(78), word_salad(23) |
| 🗂️ Deferred state keys | 7758 |
...
|-------|--------|----------|-------|-----------|--------|
| `HEARTBEAT_STALE` | OK | OK | `149` | `300` | Heartbeat świeży (149s, src=worker_runtime_heartbeat) Runtime[status=degraded, reason=heartbeat_stale_or_gu... |
| `NO_WRITE` | ALERT | WARNING | `1292` | `900` | Brak świeżych zapisów przy pending=400. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 336253}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~431 dni (2,997,792 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 78.3% | 58,331/74,536 | ~43h |
...
> Świeżość: 53s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-27 16:41:28
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 21min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-27T16:19:48.635194Z
...
| 🕒 Evidence window | 24h (span=69.54h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=69.54h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-0.10pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-27T15:41:28.301491Z → 2026-04-27T16:41:28.301491Z) |
| Cykle | **70** (TŁUMACZENIE=70, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **17.2%** |
| Cykle bez postępu % | **11.8%** |
| Przepustowość (kluczy/h) | **289.9 kluczy/h** |
| Podejrzane tłumaczenia | **3199** |
| Najgorsze cele (strażnik) | pt/server.json (gf=28), nl/server.json (gf=15), pt/monsters.json (gf=7), nl/html.json (gf=7), ru/monsters.json (gf=6) |
...
|--------|-----------|--------|----------------|
| `gt_validate_fail_placeholder` | 109 | 47.8% | nl/npc.json (49) |
| `gt_validate_fail_identical_to_en` | 61 | 26.8% | nl/npc.json (28) |
| `gt_partial_validate_word_salad` | 23 | 10.1% | es/server.json (10) |
| `gt_rejected_critical` | 14 | 6.1% | nl/npc.json (3) |
| `gt_partial_translation_mix` | 11 | 4.8% | nl/html.json (4) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 21min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-27T16:19:49.915224Z
...
| Heartbeat | 202s temu | 2026-04-27T16:38:13Z |
...
- 2026-04-27 16:38:13 | AUTO_TRANSLATE:heartbeat_tick | nl | ok | questlog.json
- 2026-04-27 16:36:43 | AUTO_TRANSLATE:heartbeat_tick | nl | ok | questlog.json
- 2026-04-27 16:35:12 | AUTO_TRANSLATE:heartbeat_tick | nl | ok | questlog.json
- 2026-04-27 16:33:42 | AUTO_TRANSLATE:heartbeat_tick | nl | ok | questlog.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-27 16:41:28
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-27 16:41:28  
