...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "Oink!", yell = false , i18nKey = "monster.boar_man.voice_1"},
	{ text = "Hungerrr!", yell = false , i18nKey = "monster.boar_man.voice_2"},
	{ text = "Grunt!", yell = false , i18nKey = "monster.boar_man.voice_3"},
}
