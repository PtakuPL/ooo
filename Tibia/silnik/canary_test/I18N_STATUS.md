...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.99% / real 10.92%**. Tempo: **740.0 kluczy/h**. Tłumaczeń netto: **144,390**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 07:51:47

> **Aktualizacja:** 2026-04-29 07:51:47 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,996 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-04-29T07:48:29Z
> **Okno godzinowe:** okno=1.0h | cykli=80 | pominięte=0.0% | odrzucone=5.5% | przepustowość=740.0/h  
> **Tłumaczeń netto:** 144,390

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 07:51:47 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-04-29T07:48:29Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 42s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 07:51:47 |
| TRANSLATION | 🟢 AKTYWNY | 3min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T07:48:13.971396Z |
| QUALITY | 🔒 NIEAKTYWNY | 22s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T07:51:32.249302Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 07:51:47 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T07:51:54.674322Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T07:48:29Z
...
| ❤️ **Heartbeat** | 2026-04-29T07:48:29Z |
...
| ⏳ Oldest pending (visible tail) | 16980 s |
...
| 🌍 Recent provider mix | TM/simple(309), Free Google Translate(149), canonical_name_semantic_autofix(20), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=481, fallbacks=26) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=799/799 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 394, 'oldest_s': 16980}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~168 dni (2,984,618 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 79.0% | 58,890/74,536 | ~16h |
| PL | ██████████████░░░░░░ | 71.0% | 52,911/74,536 | ~24h |
| IT | ██████████████░░░░░░ | 70.4% | 52,443/74,536 | ~25h |
...
> Świeżość: 42s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 07:51:47
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T07:48:13.971396Z
...
| 🕒 Evidence window | 24h (span=36.99h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=36.99h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T06:51:48.543326Z → 2026-04-29T07:51:48.543326Z) |
...
> Świeżość: 22s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T07:51:32.249302Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T07:51:32.249302Z
- **Top 5 typów problemów:** suspicious_rejected_critical=189, suspicious_log_high=85, suspicious_log_low=83, suspicious_log_medium=31, suspicious_rejected_high=11
- **Języki o najsłabszej jakości:** es(60.1, issues=739497), ro(60.1, issues=436655), de(60.1, issues=119235), cs(60.1, issues=101719), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 739497 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 62%, 174817 problemów
⚠️ **RU**: jakość 68%, 367052 problemów
...
| Heartbeat | 205s temu | 2026-04-29T07:48:29Z |
...
- 2026-04-29 07:51:30 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 07:50:00 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 07:51:47
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 07:51:47  
