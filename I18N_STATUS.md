...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **9.89%**. Tempo: **3173.2 kluczy/h**. Tłumaczeń netto: **69,725**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-16 20:35:42

> **Aktualizacja:** 2026-02-16 20:35:42 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #15 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ro | Plik: - | Heartbeat: 2026-02-16T20:35:35Z  
> **Okno godzinowe:** okno=1.0h | cykli=58 | pominięte=0.0% | odrzucone=12.3% | przepustowość=3173.2/h  
> **Tłumaczeń netto:** 69,725

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-16 20:35:42 |
| LIVE | 🟢 AKTYWNY | 7s temu | - | `activity.json / worker_state.json` | 2026-02-16T20:35:35Z |
| MIGRATION | 🔒 NIEAKTYWNY | 24min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-16 20:35:42 |
| TRANSLATION | 🟢 AKTYWNY | 43s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-16T20:34:59.526303Z |
| QUALITY | 🔒 NIEAKTYWNY | 14s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-16T20:35:27.859482Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-16 20:35:42 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 7s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-16T20:35:35Z
...
| ❤️ **Heartbeat** | 2026-02-16T20:35:35Z |
...
| ⚡ Przepustowość | ~3173 kluczy/h |
| 🛡️ Guard fail rate | 12.3% |
| ⚠️ Podejrzane | 4740 |
...
|-------|---------------|-----------|----------|----------|
| ES | 39,243 | 53,586 | 73.23% | 2,673 |
| PL | 22,645 | 53,586 | 42.26% | 1,846 |
...
> **ETA globalne:** ~31 dni (2,371,618 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ██████████████░░░░░░ | 73.2% | 39,243/53,586 | ~4h |
| PL | ████████░░░░░░░░░░░░ | 42.3% | 22,645/53,586 | ~9h |
...
| SR | █░░░░░░░░░░░░░░░░░░░ | 7.0% | 3,729/53,586 | ~15h |
| TE | █░░░░░░░░░░░░░░░░░░░ | 6.9% | 3,714/53,586 | ~15h |
| TH | █░░░░░░░░░░░░░░░░░░░ | 6.9% | 3,689/53,586 | ~15h |

> Tempo obliczone na bazie ostatniej godziny: ~3173 kluczy/h.
...
> Świeżość: 24min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-16 20:35:42
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 43s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-16T20:34:59.526303Z
...
|-------|----------------|-------------------------------|---------|--------------|
| ES (Hiszpański) | 39,243/53,586 | 73.23% | 2,673 | 0 |
| PL (Polski) | 22,645/53,586 | 42.26% | 1,846 | 0 |
...
- Raporty strażnika jakości: **2130**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2068**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **9.89%** (275,494/2,786,472)
- **Kopie EN (łącznie):** **168,198**
...
|-------|--------|----------|----------|------------|
| ES | 36,767/49,731 | 73.9% | 2,476/3,855 | 64.2% |
| PL | 19,998/49,731 | 40.2% | 2,647/3,855 | 68.7% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-16T19:35:42.512108Z → 2026-02-16T20:35:42.512108Z) |
...
| Przepustowość (kluczy/h) | **3173.2 kluczy/h** |
| Podejrzane tłumaczenia | **4740** |
| Najgorsze cele (strażnik) | pl/items.json (gf=84), es/books.json (gf=43), es/scripts.json (gf=36), pl/monsters.json (gf=33), pl/npc.json (gf=19) |
...
> Świeżość: 14s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-16T20:35:27.859482Z

- **Ostatni audyt:** OK | 7 issue(s) / 100 entries | 2026-02-16T20:35:27.859482Z
- **Top 5 typów problemów:** suspicious_log_critical=101, suspicious_log_high=97, suspicious_rejected_critical=23, identical_to_en_exempt=12, artifact_token=7
- **Języki o najsłabszej jakości:** es(61.1, issues=146412), tl(64.2, issues=466), zh_TW(64.8, issues=337), fr(65.2, issues=2470), sv(66.7, issues=833)
...
⚠️ **PL**: jakość 70%, 112974 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 61%, 146412 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 71%, 3007 problemów
⚠️ **RU**: jakość 84%, 5362 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 67%, 833 problemów
...
| Heartbeat | 7s temu | 2026-02-16T20:35:35Z |
...
- 2026-02-16 20:35:13 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-16 20:34:57 | AUTO_TRANSLATE:heartbeat_tick | sr | ok | server.json
- 2026-02-16 20:34:56 | AUTO_TRANSLATE:parallel_start | sr | ok | server.json
- 2026-02-16 20:34:51 | AUTO_TRANSLATE:heartbeat_tick | it | ok | server.json
- 2026-02-16 20:34:50 | AUTO_TRANSLATE:parallel_start | it | ok | server.json
- 2026-02-16 20:34:47 | AUTO_TRANSLATE:auto_done | ro | ok | server.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 42.3% | 0 | 1,846 | 1,408 | 623 (30.7%) | 47 |
| 🟡 ES | 73.2% | 0 | 2,673 | 1,238 | 408 (24.8%) | 34 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **69,725** | — | 📊 |
| Adaptacyjna paczka | batch=16, gf_rate=10.51%, reason=stable_fail_rate=10.5% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 2,646 kluczy / 81 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-16 20:35:42

- 🤖 AUTO_TRANSLATE: TIER_QUALITY_GATE [-] → ok — __TIER_GATE__ tier1_avg=22.5% pass=False tier2_avg=8.2% pass=False rec=TIER1_INCOMPLETE: priorytet na PL/ES
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+24) — repair_identical lang=es file=npc.json target_identical=24 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=47.53
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+50, skipped+0) — lang=ro file=server.json strict_skipped_done=7
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [no] → ok (translated+80, skipped+0) — parallel lang=no file=items.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [da] → warn (files+1, translated+80, skipped+0) — lang=da file=items.json strict_skip missing_file=0 missing_key=163 skipped_done=3305 strict_skipped_done=3305
- 🤖 AUTO_TRANSLATE: TIER_QUALITY_GATE [-] → ok — __TIER_GATE__ tier1_avg=73.0% pass=False tier2_avg=13.1% pass=False rec=TIER1_INCOMPLETE: priorytet na PL/ES
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **2,301** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 15 |
| ❌ Błędów | 20 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (378), **RU** (365), **RO** (342), **SR** (339), **IT** (338) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **82,207** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-16 20:35:42  
