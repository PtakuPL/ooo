...
<!-- TARGETS {'game': 100, 'items': 40000, 'misc': 100, 'monsters': 5000, 'npc': 15000, 'player': 200, 'quests': 500, 'scripts': 1000, 'server': 300, 'spells': 600, 'system': 2000, 'ui': 200, 'php': 3000, 'cpp': 500, 'html': 1500, 'client': 300, 'otclient_modules': 2000, 'otclient_data': 200, 'otclient_src': 300, 'otclient_mods': 100, 'otclient_tools': 50} -->

> **Aktualizacja (UTC):** 2025-12-17 06:01:45  |  **Lokalnie:** 2025-12-17 07:01:45 CET  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 54 | **Klucze EN:** 26264  
> **LIVE:** Cykl #16 | Status: 🟢 RUNNING | Faza: MIGRATION | Etap: cycle_end | Kategoria: spells | Plik: - | ETA: 0 | Heartbeat: 2025-12-17T06:01:41Z
...
| 🔍 **Przeskanowane** | **5,800** | **71.1%** | historia workera |
| ⏳ Nie przeskanowane | **2,353** | 28.9% | czekają na skan |
...
|--------|-------|---------|------|
| ✅ Zmigrowane | **231** | 4.0% | mają klucze i18n |
...
| 🔑 Kluczy wyekstrahowanych | **231** | w tej sesji |
...
│ Info: cycle end                                               │
├─────────────────────────────────────────────────────────────────┤
│ ❤️ Heartbeat: 2025-12-17T06:01:41Z           │
└─────────────────────────────────────────────────────────────────┘
```
...
- Cykle: **697**
- MIGRATION: **+1786** kluczy, **515** plików `.lua`
...
|---------|---------|-----------|
| 📁 Plików przeskanowanych | **248** | w tej sesji |
| ✅ Plików z kluczami | **231** | zawierały hardcoded strings |
| ⬜ Plików bez kluczy | **17** | czyste (brak hardcoded) |
| 🔑 Kluczy wyciągniętych | **231** | przez workera w tej sesji |
...
📅 Auto-updated by Worker v1.1 | Last (UTC): 2025-12-17 06:01:45 | Local: 2025-12-17 07:01:45 CET  
...
- ✅ `morgaroth_paralyze` - ukończono 2025-12-17 07:01
- ✅ `betrayed_wraith_paralyze` - ukończono 2025-12-17 07:01
- ✅ `werewolf_summon` - ukończono 2025-12-17 07:01
- ✅ `rotthing_shaper` - ukończono 2025-12-17 07:01
- ✅ `fear` - ukończono 2025-12-17 07:01
- ✅ `apprentice_sheng_summon` - ukończono 2025-12-17 07:01
- ✅ `anomaly_break` - ukończono 2025-12-17 07:01
- ✅ `mahrdis_soulfire` - ukończono 2025-12-17 07:01
- ✅ `root` - ukończono 2025-12-17 07:01
- ✅ `elder_bonelord_paralyze` - ukończono 2025-12-17 07:01
