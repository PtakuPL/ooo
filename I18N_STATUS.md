...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **9.89%**. Tempo: **1559.0 kluczy/h**. Tłumaczeń netto: **70,334**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-14 16:26:52

> **Aktualizacja:** 2026-02-14 16:26:52 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #5 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: pl | Plik: server.json | Heartbeat: 2026-02-14T16:26:16Z  
> **Okno godzinowe:** okno=1.0h | cykli=114 | pominięte=0.0% | odrzucone=50.7% | przepustowość=1559.0/h  
> **Tłumaczeń netto:** 70,334

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-14 16:26:52 |
| LIVE | 🟢 AKTYWNY | 36s temu | - | `activity.json / worker_state.json` | 2026-02-14T16:26:16Z |
| MIGRATION | 🔒 NIEAKTYWNY | 37s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-14 16:26:52 |
| TRANSLATION | 🟢 AKTYWNY | 37s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-14T16:26:15.116446Z |
| QUALITY | 🔒 NIEAKTYWNY | 56s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-14T16:25:56.402146Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-14 16:26:52 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 36s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-14T16:26:16Z
...
| ❤️ **Heartbeat** | 2026-02-14T16:26:16Z |
...
| ❌ Odrzucone (guard) | 2571 |
| 🔁 Cykli | 114 |
| 🌍 Języków | 2 |
| 🏆 Najaktywniejszy | PL (1,451 kluczy) |
...
> **ETA globalne:** ~63 dni (2,371,490 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ██████████████░░░░░░ | 74.5% | 39,902/53,586 | ~7h |
| PL | ████████░░░░░░░░░░░░ | 44.9% | 24,036/53,586 | ~17h |
| FR | ██████░░░░░░░░░░░░░░ | 33.1% | 17,722/53,586 | ~21h |
| RU | ██████░░░░░░░░░░░░░░ | 32.9% | 17,624/53,586 | ~21h |
...
> Świeżość: 37s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-14 16:26:52
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 37s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-14T16:26:15.116446Z
...
|-------|----------------|-------------------------------|---------|--------------|
| ES (Hiszpański) | 39,902/53,586 | 74.46% | 2,590 | 0 |
...
- Deadeye Devious → Devious Muerto (monster.deadeye_devious.desc)
- Tyrn → Muerto (monster.tyrn.name)
- Tyrn → Muerto (monster.tyrn.desc)
- Jinuma jamjam! → ¡Jinuma jamjam! (monster.ocyakao.voice_2)
- Necropharus → Muerto (monster.necropharus.name)
- Necropharus → Muerto (monster.necropharus.desc)
- Lethal Lissy → Lissy Muerto (monster.lethal_lissy.name)
- Lethal Lissy → Lissy Muerto (monster.lethal_lissy.desc)
- Ron the Ripper → Ron ripper (monster.ron_the_ripper.name)
- Ron the Ripper → Ron ripper (monster.ron_the_ripper.desc)
- Draptor → Muerto (monster.draptor.name)
- Zulazza the Corruptor → Zulazza corruptor (monster.zulazza_the_corruptor.name)
- Zulazza the Corruptor → Zulazza corruptor (monster.zulazza_the_corruptor.desc)
- Chizzoron the Distorter → Chizzoron distorter (monster.chizzoron_the_distorter.name)
- Chizzoron the Distorter → Chizzoron distorter (monster.chizzoron_the_distorter.desc)
- Xenia → Muerto (monster.xenia.name)
- Xenia → Muerto (monster.xenia.desc)
- THE POWER IS MINE! → ¡¡EL PODER ES MÍO!! (monster.ferumbras.voice_2)
- Back in black! → ¡De vuelta a lo oscuro! (monster.furyosa.voice_2)
- Fernfang → Muerto (monster.fernfang.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **2184**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2117**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **9.89%** (275,622/2,786,472)
...
|-------|--------|----------|----------|------------|
| ES | 37,318/49,731 | 75.0% | 2,584/3,855 | 67.0% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-14T15:26:52.526417Z → 2026-02-14T16:26:52.526417Z) |
...
| Podejrzane tłumaczenia | **5855** |
| Najgorsze cele (strażnik) | pl/items.json (gf=1344), pl/server.json (gf=211), es/scripts.json (gf=150), pl/monsters.json (gf=144), pl/scripts.json (gf=125) |
...
> Świeżość: 56s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-14T16:25:56.402146Z

- **Ostatni audyt:** SLOW_MODE | 33 issue(s) / 100 entries | 2026-02-14T16:25:56.402146Z
- **Top 5 typów problemów:** suspicious_rejected_critical=200, suspicious_log_high=92, suspicious_log_critical=77, suspicious_log_low=31, identical_to_en_exempt=28
- **Języki o najsłabszej jakości:** es(60.1, issues=156440), pl(60.1, issues=116604), tl(64.2, issues=466), zh_TW(64.8, issues=337), fr(66.5, issues=2470)
...
⚠️ **PL**: jakość 60%, 116604 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 156440 problemów
...
| Heartbeat | 36s temu | 2026-02-14T16:26:16Z |
...
- 2026-02-14 16:26:16 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | server.json
- 2026-02-14 16:26:16 | AUTO_TRANSLATE:parallel_start | pl | ok | server.json
- 2026-02-14 16:26:15 | AUTO_TRANSLATE:auto_done | es | ok | monsters.json
- 2026-02-14 16:26:08 | AUTO_TRANSLATE:heartbeat_tick | es | ok | monsters.json
- 2026-02-14 16:26:08 | AUTO_TRANSLATE:auto_start | es | ok | monsters.json
- 2026-02-14 16:25:47 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 44.9% | 0 | 1,912 | 3,332 | 3058 (47.9%) | 82 |
| 🟡 ES | 74.5% | 0 | 2,590 | 2,473 | 963 (28.0%) | 69 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **70,334** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=73.81%, reason=decrease_high_fail_rate=73.8% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 5,805 kluczy / 151 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-14 16:26:52

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+80, skipped+0) — lang=es file=monsters.json strict_skipped_done=2340
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+24) — repair_identical lang=es file=npc.json target_identical=24 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=301.01
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [pl] → ok (translated+80, skipped+0) — parallel lang=pl file=monsters.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+68, skipped+0) — lang=es file=npc.json strict_skipped_done=10091 guard_fail=12 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+24) — repair_identical lang=es file=npc.json target_identical=24 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=258.56
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+63, skipped+0) — parallel lang=es file=html.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+52, skipped+0) — lang=pl file=html.json strict_skipped_done=465 guard_fail=35 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+24) — repair_identical lang=es file=npc.json target_identical=24 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=34.49
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [pl] → ok (translated+73, skipped+0) — parallel lang=pl file=raids.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+39, skipped+0) — lang=es file=scripts.json strict_skipped_done=2097 guard_fail=56 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **37,423** kluczy |
| ⏭️ Pominięte | 1 |
| 🔁 Cykli | 49 |
| ❌ Błędów | 454 |
| 🌍 Aktywnych języków | 52 |
| 🏆 TOP 5 | **ES** (10,134), **PL** (4,126), **IT** (971), **PT** (960), **DE** (890) |
| 📊 Porównanie | ↓ 18.8% vs wczoraj (46,073) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **84,845** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-14 16:26:52  
