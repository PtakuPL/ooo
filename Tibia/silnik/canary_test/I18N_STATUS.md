...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.7% / real 11.67%**. Tempo: **284.0 kluczy/h**. Tłumaczeń netto: **168,514**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-05-02 03:49:26

> **Aktualizacja:** 2026-05-02 03:49:26 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #19,171 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ro | Plik: items.json | Heartbeat: 2026-05-02T03:46:50Z
> **Okno godzinowe:** okno=1.0h | cykli=52 | pominięte=0.0% | odrzucone=0.0% | przepustowość=284.0/h  
> **Tłumaczeń netto:** 168,514

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-05-02 03:49:26 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-05-02T03:46:50Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 18h temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-05-02 03:49:26 |
| TRANSLATION | 🟢 AKTYWNY | 3min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-05-02T03:46:32.070009Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-05-02T03:48:28.703205Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-05-02 03:49:26 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-05-02T03:49:35.037262Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-05-02T03:46:50Z
...
| 🔄 **Ostatni cykl** | 11 kluczy, 0 odrzuconych, 130.0s, tryb: AUTO_TRANSLATE, cel: es/items.json |
...
| ⏳ Oldest pending (visible tail) | 129879 s |
...
| ♻️ Provider debt | `767` |
| 🌍 Recent provider mix | tm_dedup_file(148), OpenAI model pool(84), canonical_name_semantic_autofix(22), tm_dedup_propagate(15), Fre... |
...
| ❤️ Pool health | `degraded` (writes=287, fallbacks=23) |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 393, 'oldest_s': 129879}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~434 dni (2,957,389 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| PL | ████████████████░░░░ | 84.2% | 62,753/74,536 | ~28h |
| ES | ███████████████░░░░░ | 79.9% | 59,560/74,536 | ~40h |
...
> Świeżość: 18h temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-05-02 03:49:26
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-05-02T03:46:32.070009Z
...
- Raporty strażnika jakości: **5148**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **5000**
...
| 🕒 Evidence window | 24h (span=31.27h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=31.27h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=+0.00pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-05-02T02:49:27.322171Z → 2026-05-02T03:49:27.322171Z) |
...
| Przepustowość (kluczy/h) | **284.0 kluczy/h** |
| Podejrzane tłumaczenia | **361** |
| Najgorsze cele (strażnik) | es/items.json (gf=0), ro/items.json (gf=0), tr/items.json (gf=0), ru/items.json (gf=0), cs/items.json (gf=0) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-05-02T03:48:28.703205Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-05-02T03:48:28.703205Z
- **Top 5 typów problemów:** suspicious_log_high=132, suspicious_rejected_critical=130, suspicious_rejected_high=70, suspicious_log_low=63, suspicious_log_medium=3
- **Języki o najsłabszej jakości:** es(60.1, issues=760081), ro(60.1, issues=455261), ru(60.1, issues=384685), de(60.1, issues=138711), cs(60.1, issues=136760)
...
⚠️ **TR**: jakość 69%, 61800 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 760081 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 86%, 182077 problemów
⚠️ **RU**: jakość 60%, 384685 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #19,171 |
| Heartbeat | 165s temu | 2026-05-02T03:46:50Z |
...
- 2026-05-02 03:46:32 | AUTO_TRANSLATE:auto_done | es | ok | items.json
- 2026-05-02 03:45:53 | AUTO_TRANSLATE:heartbeat_tick | es | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-05-02 03:49:26
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **11,979** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 20 |
| ❌ Błędów | 42 |
| 🌍 Aktywnych języków | 6 |
| 🏆 TOP 5 | **RO** (7,228), **TR** (4,368), **ES** (145), **RU** (105), **IT** (82) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **44,959** kluczy
...
| 🔄 Cykli wykonanych | **#19,171** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #19,171 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-05-02 03:49:26  
