...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.01%**. Tempo: **3826.3 kluczy/h**. Tłumaczeń netto: **74,265**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-16 21:21:13

> **Aktualizacja:** 2026-02-16 21:21:13 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #53 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ru | Plik: - | Heartbeat: 2026-02-16T21:21:09Z  
> **Okno godzinowe:** okno=1.0h | cykli=197 | pominięte=0.0% | odrzucone=29.9% | przepustowość=3826.3/h  
> **Tłumaczeń netto:** 74,265

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-16 21:21:13 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-16T21:21:09Z |
| MIGRATION | 🔒 NIEAKTYWNY | 1h temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-16 21:21:13 |
| TRANSLATION | 🟢 AKTYWNY | 21s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-16T21:20:52.874306Z |
| QUALITY | 🔒 NIEAKTYWNY | 4s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-16T21:21:09.238791Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-16 21:21:13 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-16T21:21:09Z
...
| ❤️ **Heartbeat** | 2026-02-16T21:21:09Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **6,977** kluczy |
| ❌ Odrzucone (guard) | 2977 |
| 🔁 Cykli | 197 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | IT (1,138 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~3826 kluczy/h |
| 🛡️ Guard fail rate | 29.9% |
| ⚠️ Podejrzane | 31432 |
...
> **ETA globalne:** ~26 dni (2,368,267 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~3826 kluczy/h.
...
> Świeżość: 1h temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-16 21:21:13
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 21s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-16T21:20:52.874306Z
...
| SR (SR) | 4,462/53,586 | 8.33% | 2,538 | 0 |
...
- **Pokrycie globalne:** **10.01%** (278,845/2,786,472)
...
| SR | 4,412/49,731 | 8.9% | 50/3,855 | 1.3% |
| TR | 4,162/49,731 | 8.4% | 152/3,855 | 3.9% |

### ⏱️ Ścisłe okno godzinowe (JSONL-only)
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-16T20:21:13.528678Z → 2026-02-16T21:21:13.528678Z) |
...
| Przepustowość (kluczy/h) | **3826.3 kluczy/h** |
| Podejrzane tłumaczenia | **31432** |
| Najgorsze cele (strażnik) | pl/items.json (gf=1449), pl/npc.json (gf=624), pl/server.json (gf=400), pl/monsters.json (gf=174), ro/monsters.json (gf=90) |
...
> Świeżość: 4s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-16T21:21:09.238791Z

- **Ostatni audyt:** OK | 7 issue(s) / 100 entries | 2026-02-16T21:21:09.238791Z
- **Top 5 typów problemów:** suspicious_log_high=148, suspicious_rejected_critical=106, suspicious_rejected_high=62, suspicious_log_critical=50, identical_to_en_exempt=30
- **Języki o najsłabszej jakości:** es(60.1, issues=151763), ro(60.2, issues=3294), ru(60.4, issues=7541), tl(64.2, issues=466), zh_TW(64.8, issues=337)
...
| Heartbeat | 5s temu | 2026-02-16T21:21:09Z |
...
- 2026-02-16 21:21:00 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-16 21:20:50 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-02-16 21:20:50 | AUTO_TRANSLATE:parallel_start | it | ok | items.json
- 2026-02-16 21:20:28 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-02-16 21:20:27 | AUTO_TRANSLATE:parallel_start | ro | ok | items.json
- 2026-02-16 21:20:26 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 42.9% | 0 | 1,854 | 1,566 | 2800 (64.1%) | 40 |
| 🟡 ES | 73.6% | 0 | 2,614 | 1,222 | 178 (12.7%) | 27 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **74,265** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=21.85%, reason=decrease_high_fail_rate=21.9% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 2,788 kluczy / 67 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-16 21:21:13
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **8,047** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 53 |
| ❌ Błędów | 71 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (1,474), **IT** (1,188), **SR** (1,139), **SV** (1,138), **RU** (1,129) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **87,953** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-16 21:21:13  
