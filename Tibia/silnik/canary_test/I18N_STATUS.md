...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.71%**. Tempo: **1648.3 kluczy/h**. Tłumaczeń netto: **108,666**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-17 10:31:54

> **Aktualizacja:** 2026-02-17 10:31:54 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #444 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: pl | Plik: - | Heartbeat: 2026-02-17T10:31:51Z  
> **Okno godzinowe:** okno=1.0h | cykli=145 | pominięte=0.0% | odrzucone=58.7% | przepustowość=1648.3/h  
> **Tłumaczeń netto:** 108,666

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-17 10:31:54 |
| LIVE | 🟢 AKTYWNY | 6s temu | - | `activity.json / worker_state.json` | 2026-02-17T10:31:51Z |
| MIGRATION | 🔒 NIEAKTYWNY | 31s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-17 10:31:54 |
| TRANSLATION | 🟢 AKTYWNY | 41s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-17T10:31:15.300587Z |
| QUALITY | 🔒 NIEAKTYWNY | 6s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-17T10:31:50.876049Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-17 10:31:54 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-17T10:31:51Z
...
| ❤️ **Heartbeat** | 2026-02-17T10:31:51Z |
...
> **ETA globalne:** ~57 dni (2,264,955 kluczy do celu 95%)
...
> Świeżość: 31s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-17 10:31:54
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 41s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-17T10:31:15.300587Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-17T09:31:55.075854Z → 2026-02-17T10:31:55.075854Z) |
| Cykle | **145** (TŁUMACZENIE=145, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **58.7%** |
| Cykle bez postępu % | **0.0%** |
| Przepustowość (kluczy/h) | **1648.3 kluczy/h** |
| Podejrzane tłumaczenia | **13684** |
| Najgorsze cele (strażnik) | pl/items.json (gf=1644), pl/npc.json (gf=1286), es/server.json (gf=129), es/scripts.json (gf=123), es/spells.json (gf=78) |
...
> Świeżość: 6s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-17T10:31:50.876049Z

- **Ostatni audyt:** SLOW_MODE | 41 issue(s) / 100 entries | 2026-02-17T10:31:50.876049Z
- **Top 5 typów problemów:** suspicious_rejected_critical=176, suspicious_log_high=126, suspicious_log_critical=48, artifact_token=34, suspicious_log_medium=26
- **Języki o najsłabszej jakości:** es(60.1, issues=239870), pl(60.1, issues=137928), ro(60.1, issues=58839), ru(60.1, issues=46938), sr(60.3, issues=4941)
- **Pliki:** `i18n/status/quality_audit_latest.json`, `i18n/status/quality_dashboard.json`, `i18n/status/quality_report.jsonl`

### 📈 Statystyki Pracy
| Metryka | Wartość | Info |
|---------|---------|------|
| 🔄 Cykl aktualny | **#444** | od uruchomienia |
...
⚠️ **PL**: jakość 60%, 137928 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 239870 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 78%, 19985 problemów
⚠️ **RU**: jakość 60%, 46938 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #444 |
| Heartbeat | 6s temu | 2026-02-17T10:31:51Z |
...
- 2026-02-17 10:31:24 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-17 10:30:51 | AUTO_TRANSLATE:heartbeat_tick | es | ok | scripts.json
- 2026-02-17 10:30:51 | AUTO_TRANSLATE:parallel_start | es | ok | scripts.json
- 2026-02-17 10:30:50 | AUTO_TRANSLATE:auto_done | pl | ok | scripts.json
- 2026-02-17 10:30:30 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | scripts.json
- 2026-02-17 10:30:30 | AUTO_TRANSLATE:auto_start | pl | ok | scripts.json
...
| 🟡 ES | 84.3% | 0 | 2,149 | 467 | 937 (66.7%) | 31 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **108,666** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=24.5%, reason=decrease_high_fail_rate=24.5% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,204 kluczy / 60 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-17 10:31:54
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **38,575** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 383 |
| ❌ Błędów | 670 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (8,008), **IT** (7,222), **RU** (7,039), **RO** (6,222), **PL** (4,707) |
| 📊 Porównanie | ↑ 90.1% vs wczoraj (20,288) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **138,769** kluczy
...
| 🔄 Cykli wykonanych | **#444** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-17 10:31:54  
