...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "I could be your evil twin!", yell = false , i18nKey = "monster.paladin's_apparition.voice_1"},
	{ text = "I'll take your place when you are gone.", yell = false , i18nKey = "monster.paladin's_apparition.voice_2"},
}
