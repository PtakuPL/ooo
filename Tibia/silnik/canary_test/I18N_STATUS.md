...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **9.97%**. Tempo: **3443.6 kluczy/h**. Tłumaczeń netto: **72,833**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-16 21:08:39

> **Aktualizacja:** 2026-02-16 21:08:39 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #41 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: pl | Plik: - | Heartbeat: 2026-02-16T21:08:35Z  
> **Okno godzinowe:** okno=1.0h | cykli=162 | pominięte=0.0% | odrzucone=21.5% | przepustowość=3443.6/h  
> **Tłumaczeń netto:** 72,833

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-16 21:08:39 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-16T21:08:35Z |
| MIGRATION | 🔒 NIEAKTYWNY | 56min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-16 21:08:39 |
| TRANSLATION | 🟢 AKTYWNY | 21s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-16T21:08:18.020263Z |
| QUALITY | 🔒 NIEAKTYWNY | 4s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-16T21:08:35.625732Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-16 21:08:39 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-16T21:08:35Z
...
| ❤️ **Heartbeat** | 2026-02-16T21:08:35Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **5,774** kluczy |
| ❌ Odrzucone (guard) | 1580 |
| 🔁 Cykli | 162 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (907 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~3444 kluczy/h |
| 🛡️ Guard fail rate | 21.5% |
| ⚠️ Podejrzane | 21564 |
...
| IT | █░░░░░░░░░░░░░░░░░░░ | 8.3% | 4,433/53,586 | ~13h |
| TR | █░░░░░░░░░░░░░░░░░░░ | 8.1% | 4,314/53,586 | ~14h |
| SR | █░░░░░░░░░░░░░░░░░░░ | 7.9% | 4,239/53,586 | ~14h |
...
> Tempo obliczone na bazie ostatniej godziny: ~3444 kluczy/h.
...
> Świeżość: 56min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-16 21:08:39
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 21s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-16T21:08:18.020263Z
...
| SR (SR) | 4,239/53,586 | 7.91% | 2,562 | 0 |
...
- Raporty strażnika jakości: **2208**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2146**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **9.97%** (277,792/2,786,472)
- **Kopie EN (łącznie):** **167,503**
...
| SR | 4,189/49,731 | 8.4% | 50/3,855 | 1.3% |

### ⏱️ Ścisłe okno godzinowe (JSONL-only)
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-16T20:08:39.625276Z → 2026-02-16T21:08:39.625276Z) |
...
| Przepustowość (kluczy/h) | **3443.6 kluczy/h** |
| Podejrzane tłumaczenia | **21564** |
...
> Świeżość: 4s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-16T21:08:35.625732Z

- **Ostatni audyt:** SLOW_MODE | 37 issue(s) / 100 entries | 2026-02-16T21:08:35.625732Z
- **Top 5 typów problemów:** suspicious_log_high=135, suspicious_rejected_critical=74, suspicious_log_critical=65, suspicious_rejected_high=42, identical_to_en=28
- **Języki o najsłabszej jakości:** ro(60.1, issues=1901), es(60.4, issues=150214), ru(60.4, issues=6479), sv(63.8, issues=1390), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 64%, 114297 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 150214 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 67%, 3519 problemów
⚠️ **RU**: jakość 60%, 6479 problemów
...
| Heartbeat | 5s temu | 2026-02-16T21:08:35Z |
...
- 2026-02-16 21:08:25 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-16 21:08:15 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | server.json
- 2026-02-16 21:08:15 | AUTO_TRANSLATE:parallel_start | ru | ok | server.json
- 2026-02-16 21:08:08 | AUTO_TRANSLATE:heartbeat_tick | es | ok | monsters.json
- 2026-02-16 21:08:07 | AUTO_TRANSLATE:parallel_start | es | ok | monsters.json
- 2026-02-16 21:08:05 | AUTO_TRANSLATE:auto_done | pl | ok | monsters.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 42.8% | 0 | 1,854 | 1,796 | 1711 (48.8%) | 53 |
| 🟡 ES | 73.5% | 0 | 2,620 | 1,469 | 372 (20.2%) | 39 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **72,833** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=31.83%, reason=decrease_high_fail_rate=31.8% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 3,265 kluczy / 92 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-16 21:08:39
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **6,278** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 41 |
| ❌ Błędów | 53 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (1,140), **RU** (907), **SR** (889), **SV** (889), **IT** (888) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **86,184** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-16 21:08:39  
