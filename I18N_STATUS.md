...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.92% / real 10.84%**. Tempo: **617.0 kluczy/h**. Tłumaczeń netto: **139,561**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 01:48:17

> **Aktualizacja:** 2026-04-29 01:48:17 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,492 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: items.json | Heartbeat: 2026-04-29T01:47:18Z
> **Okno godzinowe:** okno=1.0h | cykli=72 | pominięte=0.0% | odrzucone=4.8% | przepustowość=617.0/h  
> **Tłumaczeń netto:** 139,561

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 01:48:17 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T01:47:18Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 32s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 01:48:17 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T01:47:16.580613Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T01:47:17.594600Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 01:48:17 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T01:48:23.688585Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T01:47:18Z
...
| 🔄 **Ostatni cykl** | 39 kluczy, 4 odrzuconych, 86.0s, tryb: AUTO_TRANSLATE, cel: ro/items.json |
| ❤️ **Heartbeat** | 2026-04-29T01:47:18Z |
...
| 🌍 Recent provider mix | TM/simple(271), Free Google Translate(209), canonical_name_semantic_autofix(17), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=500, fallbacks=24) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=519/519 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 17527}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~202 dni (2,987,397 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 78.7% | 58,691/74,536 | ~20h |
| PL | ██████████████░░░░░░ | 71.0% | 52,911/74,536 | ~29h |
| IT | █████████████░░░░░░░ | 69.4% | 51,715/74,536 | ~31h |
| RO | █████████████░░░░░░░ | 69.7% | 51,971/74,536 | ~31h |
...
> Tempo obliczone na bazie ostatniej godziny: ~617 kluczy/h.
...
> Świeżość: 32s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 01:48:17
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T01:47:16.580613Z
...
- This lamp is glowing very dimly. → Această lampăăăăăăăăăăăăăăăăăăăăăăăăăă luminează foarte slab. (item.13656.desc)
- This lamp is glowing very dimly. → Această lampăăăăăăăăăăăăăăăăăăăăăăăăăă luminează foarte slab. (item.13658.desc)
- This is an emblem of wisdom. It was awarded by TibiaStat.com → Aceasta este o emblemăăăăăăăăăăăăăăăăăăăăăăăăăă a înțelepciunii. A fost acordat  (item.14760.desc)
- lamp → lampă (item.10507.name)
- ramp → rampă (item.11365.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4719**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4572**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T01:47:35.261732Z |
...
| 🕒 Evidence window | 24h (span=30.93h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=30.93h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T00:48:18.087825Z → 2026-04-29T01:48:18.087825Z) |
...
| Przepustowość (kluczy/h) | **617.0 kluczy/h** |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T01:47:17.594600Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T01:47:17.594600Z
- **Top 5 typów problemów:** suspicious_rejected_critical=189, suspicious_log_high=104, suspicious_log_low=95, suspicious_rejected_high=11, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=728728), ro(60.1, issues=428018), de(60.1, issues=111219), cs(60.1, issues=87199), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 728728 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 64%, 170031 problemów
⚠️ **RU**: jakość 62%, 360043 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,492 |
| Heartbeat | 66s temu | 2026-04-29T01:47:18Z |
...
- 2026-04-29 01:47:36 | AUTO_TRANSLATE:heartbeat_tick | es | ok | items.json
- 2026-04-29 01:47:35 | AUTO_TRANSLATE:auto_start | es | ok | items.json
- 2026-04-29 01:47:16 | AUTO_TRANSLATE:auto_done | ro | ok | items.json
- 2026-04-29 01:45:50 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-04-29 01:45:50 | AUTO_TRANSLATE:auto_start | ro | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 01:48:17
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **1,488** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 34 |
| ❌ Błędów | 60 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (398), **IT** (207), **RO** (195), **RU** (194), **DE** (180) |
| 📊 Porównanie | ↓ 81.9% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **20,468** kluczy
...
| 🔄 Cykli wykonanych | **#17,492** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,492 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 01:48:17  
