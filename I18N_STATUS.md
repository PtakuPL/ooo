...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.34% / real 11.29%**. Tempo: **570.0 kluczy/h**. Tłumaczeń netto: **151,398**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 18:56:22

> **Aktualizacja:** 2026-04-29 18:56:22 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,757 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: de | Plik: otclient_modules.json | Heartbeat: 2026-04-29T18:53:58Z
> **Okno godzinowe:** okno=1.0h | cykli=46 | pominięte=0.0% | odrzucone=0.7% | przepustowość=570.0/h  
> **Tłumaczeń netto:** 151,398

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 18:56:22 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T18:53:58Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 53s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 18:56:22 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T18:53:38.505938Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T18:53:41.977745Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 18:56:22 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T18:56:28.102178Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T18:53:58Z
...
| 🔄 **Ostatni cykl** | 55 kluczy, 0 odrzuconych, 434.0s, tryb: AUTO_TRANSLATE, cel: es/items.json |
| ❤️ **Heartbeat** | 2026-04-29T18:53:58Z |
...
| 17:51:04 | DE | Serwer | npc.json | 30 | `tm` | `npc.a_dead_bureaucrat1.say_1` | Klar, wo sonst. Jeder trifft gerne meinen Meister, er ist ein großer Dämon, nicht wah... |
...
| ⏳ Oldest pending (visible tail) | 20156 s |
| 🌍 Top języki | RU(374), CS(9), DE(8), ES(8) |
| 🧱 Top reason_bucket | quality(372), default(19), word_salad(7), partial_translation_mix(1) |
| 🗂️ Deferred state keys | 8881 |
| 🕒 Deferred state freshness | fresh (23s) |
| ♻️ Deferred stats | enqueued=0, cooldown=0, deduped=0, manual_review=4, partial_staged=0, partial_completed=0 |
...
| ♻️ Provider debt | `258` |
| 🌍 Recent provider mix | OpenAI model pool(231), TM/simple(220), Free Google Translate(79), canonical_name_semantic_autofix(22), ter... |
| 🔁 Latest fallback | TM/simple → fallback to google translate high [high_reject_types] otclient_modules.json |
| 📉 Fallback breakdown | fallback to google translate high(8) |
| ☁️ Cloud policy | `disabled` |
| 🤖 OpenAI pool | `active` |
| 🩺 Health signals | recent_fallback, provider_consistency_debt:258 |
| ❤️ Pool health | `degraded` (writes=555, fallbacks=8) |
...
| `NO_WRITE` | OK | OK | `178` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 399, 'oldest_s': 20156}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| �📊 Przetłumaczono | **570** kluczy |
| ❌ Odrzucone (guard) | 4 |
| 🔁 Cykli | 46 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (152 kluczy) |
| 📄 Najczęstszy plik | items.json |
| ⚡ Przepustowość | ~570 kluczy/h |
| 🛡️ Odrzucone (strażnik) | 0.7% |
| ⚠️ Podejrzane | 754 |
...
| DE | 50,596 | 74,536 | 67.88% →0% | 64,864 |
...
> **ETA globalne:** ~217 dni (2,971,267 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~570 kluczy/h.
...
> Świeżość: 53s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 18:56:22
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T18:53:38.505938Z
...
| DE (Niemiecki) | 67.88% (50,596/74,536) | 10.95% (8,162/74,536) | 64,864 | 1,535 | 0 |
...
- hieroglyphs → jeroglíficos (item.12444.name)
- carving of a scorpion → talla de un escorpión (item.12447.name)
- carving of a scorpion → talla de un escorpión (item.12448.name)
- carving of a scorpion → talla de un escorpión (item.12449.name)
- carving of a scorpion → talla de un escorpión (item.12450.name)
- carving of a battle → talla de una batalla (item.12453.name)
- carving of a battle → talla de una batalla (item.12454.name)
- carving of a battle → talla de una batalla (item.12455.name)
- carving of a battle → talla de una batalla (item.12458.name)
- carving of a battle → talla de una batalla (item.12459.name)
- carving of a battle → talla de una batalla (item.12460.name)
- hyaena statue → estatua de hiena (item.12465.name)
- hyaena statue → estatua de hiena (item.12466.name)
- golden scorpion → escorpión dorado (item.12467.name)
- golden scorpion → escorpión dorado (item.12468.name)
- small golden scorpion → pequeño escorpión dorado (item.12470.name)
- small golden scorpion → pequeño escorpión dorado (item.12471.name)
- baby rotworm → rotworm de bebé (item.10026.name)
- badger fur → pelaje de badger (item.10299.name)
- bamboo drawer → drawer de bambú (item.10194.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **5044**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4896**
...
- **Pokrycie globalne (nominal):** **18.34%** (710,801/3,875,872)
- **Pokrycie globalne (real):** **11.29%** (437,516/3,875,872)
- **Kopie EN (łącznie):** **409,371**
- **Placeholdery [EN]/puste (łącznie):** **2,174,863**
...
| DE | 48,927/70,637 | 69.3% / 9.4% | 1,669/3,899 | 42.8% / 39.8% |
...
| DE | 37.4% / 37.1% | 66.1% / 61.0% | 77.7% / 75.2% | 40.8% / 35.8% |
...
| #2 | 🔴 Installer | 14.44% | +0.03 pp | 51 | AR 0.0%, AZ 0.0%, BG 0.0% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T17:56:23.111861Z → 2026-04-29T18:56:23.111861Z) |
| Cykle | **46** (TŁUMACZENIE=46, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **0.7%** |
| Cykle bez postępu % | **0.0%** |
| Przepustowość (kluczy/h) | **570.0 kluczy/h** |
| Podejrzane tłumaczenia | **754** |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 46 | 65.7% | ru/items.json (46) |
| `existing_canonical_name_quality_mixed_scripts` | 18 | 25.7% | ru/items.json (18) |
| `gt_identity_retry_identical_to_en` | 5 | 7.1% | de/otclient_modules.json (5) |
| `gt_partial_translation_mix` | 1 | 1.4% | de/otclient_modules.json (1) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T18:53:41.977745Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=754097), ro(60.1, issues=448608), ru(60.1, issues=377086), de(60.1, issues=130085), cs(60.1, issues=125689)
...
| Heartbeat | 150s temu | 2026-04-29T18:53:58Z |
...
- **TOP 5 języków:** DE (19,853), CS (15,153), NL (14,061), FR (13,129), PT (11,471)
- **Aktualnie naprawia:** ES / -
- **Ostatnia aktualizacja:** 2026-04-29T18:46:47.972713Z
...
- 2026-04-29 18:52:26 | AUTO_TRANSLATE:heartbeat_tick | es | ok | items.json
- 2026-04-29 18:50:30 | AUTO_TRANSLATE:heartbeat_tick | es | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 18:56:22
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **14,336** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 216 |
| ❌ Błędów | 607 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (2,633), **RU** (2,337), **TR** (2,183), **DE** (2,070), **IT** (1,879) |
| 📊 Porównanie | ↑ 74.2% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **33,316** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 18:56:22  
