...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **18.91%**. Tempo: **2392.0 kluczy/h**. Tłumaczeń netto: **60,590**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-23 14:47:21

> **Aktualizacja:** 2026-03-23 14:47:21 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **LIVE:** Cykl #10,761 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ro | Plik: monsters.json | Heartbeat: 2026-03-23T14:46:22Z  
> **Okno godzinowe:** okno=1.0h | cykli=40 | pominięte=0.0% | odrzucone=14.3% | przepustowość=2392.0/h  
> **Tłumaczeń netto:** 60,590

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-23 14:47:21 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-03-23T14:46:22Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 12s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-23 14:47:21 |
| TRANSLATION | 🟢 AKTYWNY | 10min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-23T14:36:30.156076Z |
| QUALITY | 🔒 NIEAKTYWNY | 10min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-23T14:36:57.118068Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-23 14:47:21 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-23T14:46:22Z
...
| ❤️ **Heartbeat** | 2026-03-23T14:46:22Z |
...
> **ETA globalne:** ~51 dni (2,949,107 kluczy do celu 95%)
...
> Świeżość: 12s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-23 14:47:21
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 10min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-23T14:36:30.156076Z
...
- Raporty strażnika jakości: **3065**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2923**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **18.91%** (732,961/3,875,872)
- **Kopie EN (łącznie):** **594,431**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-23T13:47:21.542334Z → 2026-03-23T14:47:21.542334Z) |
...
| Przepustowość (kluczy/h) | **2392.0 kluczy/h** |
| Podejrzane tłumaczenia | **1180** |
| Najgorsze cele (strażnik) | es/npc.json (gf=207), ro/items.json (gf=97), pl/monsters.json (gf=47), es/monsters.json (gf=14), pt/items.json (gf=13) |
...
> Świeżość: 10min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-23T14:36:57.118068Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-03-23T14:36:57.118068Z
- **Top 5 typów problemów:** suspicious_rejected_critical=194, suspicious_log_high=104, suspicious_log_medium=60, suspicious_log_low=33, suspicious_rejected_high=6
- **Języki o najsłabszej jakości:** es(60.1, issues=627959), ro(60.1, issues=345168), pl(60.1, issues=330521), fr(60.1, issues=20288), it(60.4, issues=114587)
...
⚠️ **TR**: jakość 82%, 7739 problemów
⚠️ **PL**: jakość 60%, 330521 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 627959 problemów
⚠️ **PT**: jakość 61%, 22262 problemów
⚠️ **FR**: jakość 60%, 20288 problemów
⚠️ **IT**: jakość 60%, 114587 problemów
⚠️ **RU**: jakość 80%, 297469 problemów
⚠️ **NL**: jakość 63%, 14668 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #10,761 |
| Heartbeat | 60s temu | 2026-03-23T14:46:22Z |
...
- **Ostatnia aktualizacja:** 2026-03-23T14:36:47.874394Z
...
- 2026-03-23 14:46:22 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | monsters.json
- 2026-03-23 14:44:52 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | monsters.json
- 2026-03-23 14:43:21 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | monsters.json
- 2026-03-23 14:41:51 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | monsters.json
- 2026-03-23 14:40:20 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | monsters.json
- 2026-03-23 14:38:50 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | monsters.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-23 14:47:21
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **36,525** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 174 |
| ❌ Błędów | 590 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **ES** (11,279), **TR** (6,169), **RO** (4,743), **PL** (2,981), **PT** (2,141) |
| 📊 Porównanie | ↑ 76.2% vs wczoraj (20,729) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **57,254** kluczy
...
| 🔄 Cykli wykonanych | **#10,761** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #10,761 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-23 14:47:21  
