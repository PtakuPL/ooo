...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.99% / real 10.91%**. Tempo: **833.0 kluczy/h**. Tłumaczeń netto: **144,128**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 07:23:39

> **Aktualizacja:** 2026-04-29 07:23:39 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,956 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: items.json | Heartbeat: 2026-04-29T07:20:16Z
> **Okno godzinowe:** okno=1.0h | cykli=81 | pominięte=0.0% | odrzucone=4.7% | przepustowość=833.0/h  
> **Tłumaczeń netto:** 144,128

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 07:23:39 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-04-29T07:20:16Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 55s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 07:23:39 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T07:21:36.770717Z |
| QUALITY | 🔒 NIEAKTYWNY | 12s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T07:23:36.177382Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 07:23:39 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T07:23:48.542629Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T07:20:16Z
...
| 🔄 **Ostatni cykl** | 30 kluczy, 1 odrzuconych, 200.7s, tryb: AUTO_TRANSLATE, cel: it/items.json |
| ❤️ **Heartbeat** | 2026-04-29T07:20:16Z |
...
| ⏳ Oldest pending (visible tail) | 16600 s |
...
| 🌍 Recent provider mix | TM/simple(292), Free Google Translate(177), canonical_name_semantic_autofix(17), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=489, fallbacks=25) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=777/777 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 16600}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~149 dni (2,984,718 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~833 kluczy/h.
...
> Świeżość: 55s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 07:23:39
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T07:21:36.770717Z
...
- Raporty strażnika jakości: **4837**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4690**
...
- **Pokrycie globalne (nominal):** **17.99%** (697,350/3,875,872)
- **Pokrycie globalne (real):** **10.91%** (422,943/3,875,872)
- **Kopie EN (łącznie):** **410,494**
- **Placeholdery [EN]/puste (łącznie):** **2,188,313**
...
| 🕒 Evidence window | 24h (span=36.52h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=36.52h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T06:23:40.950174Z → 2026-04-29T07:23:40.950174Z) |
...
| Przepustowość (kluczy/h) | **833.0 kluczy/h** |
...
> Świeżość: 12s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T07:23:36.177382Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T07:23:36.177382Z
- **Top 5 typów problemów:** suspicious_rejected_critical=188, suspicious_log_high=108, suspicious_log_low=91, suspicious_rejected_high=12, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=738636), ro(60.1, issues=436009), de(60.1, issues=118673), cs(60.1, issues=100415), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 738636 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 69%, 174477 problemów
⚠️ **RU**: jakość 61%, 366529 problemów
...
| Heartbeat | 212s temu | 2026-04-29T07:20:16Z |
...
- 2026-04-29 07:21:55 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-29 07:21:37 | AUTO_TRANSLATE:auto_done | it | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 07:23:39
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+30, skipped+0) — lang=it file=items.json strict_skipped_done=2989 guard_fail=1 placeholder=0 command=0 pipe=0
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 07:23:39  
