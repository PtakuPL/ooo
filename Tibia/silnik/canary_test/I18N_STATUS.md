...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.05% / real 10.98%**. Tempo: **578.0 kluczy/h**. Tłumaczeń netto: **148,748**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 14:11:55

> **Aktualizacja:** 2026-04-29 14:11:55 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,513 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: cs | Plik: items.json | Heartbeat: 2026-04-29T14:09:04Z
> **Okno godzinowe:** okno=1.0h | cykli=69 | pominięte=0.0% | odrzucone=5.7% | przepustowość=578.0/h  
> **Tłumaczeń netto:** 148,748

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 14:11:55 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T14:09:04Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 14:11:55 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T14:10:35.530795Z |
| QUALITY | 🔒 NIEAKTYWNY | 3min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T14:08:46.645762Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 14:11:55 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T14:12:02.007279Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T14:09:04Z
...
| ❤️ **Heartbeat** | 2026-04-29T14:09:04Z |
...
| ⏳ Oldest pending (visible tail) | 16975 s |
...
| ♻️ Deferred stats | enqueued=0, cooldown=8, deduped=9, manual_review=0, partial_staged=0, partial_completed=0 |
...
| 🌍 Recent provider mix | TM/simple(370), Free Google Translate(141), canonical_name_semantic_autofix(15), OpenAI model pool(8), term... |
...
| ❤️ Pool health | `critical` (writes=537, fallbacks=25) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=1090/1090 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
|-------|--------|----------|-------|-----------|--------|
| `HEARTBEAT_STALE` | OK | OK | `113` | `300` | Heartbeat świeży (113s, src=worker_runtime_heartbeat) Runtime[status=healthy, reason=heartbeat_fresh, phase... |
| `NO_WRITE` | OK | OK | `94` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 16975}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~215 dni (2,982,412 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 79.2% | 59,040/74,536 | ~20h |
| PL | ██████████████░░░░░░ | 71.0% | 52,911/74,536 | ~31h |
| IT | ██████████████░░░░░░ | 71.3% | 53,166/74,536 | ~31h |
| RO | █████████████░░░░░░░ | 69.7% | 51,972/74,536 | ~33h |
...
> Tempo obliczone na bazie ostatniej godziny: ~578 kluczy/h.
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 14:11:55
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T14:10:35.530795Z
...
- basalt wall with crystals → čedičová stěna s krystaly (item.14874.name)
- basalt wall with crystals → čedičová stěna s krystaly (item.14875.name)
- basalt wall with crystals → čedičová stěna s krystaly (item.14876.name)
- basalt wall with crystals → čedičová stěna s krystaly (item.14877.name)
- stone wall → kamenná zeď (item.1488.name)
- basalt wall → čedičová stěna (item.14884.name)
...
- small basalt wall → malá čedičová stěna (item.14867.name)
- small basalt wall → malá čedičová stěna (item.14868.name)
- small basalt wall → malá čedičová stěna (item.14869.name)
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T14:09:03.819945Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.05%** (699,656/3,875,872)
- **Pokrycie globalne (real):** **10.98%** (425,403/3,875,872)
- **Kopie EN (łącznie):** **410,340**
- **Placeholdery [EN]/puste (łącznie):** **2,186,007**
...
| 🕒 Evidence window | 24h (span=43.33h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=43.33h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T13:11:55.880751Z → 2026-04-29T14:11:55.880751Z) |
...
| Przepustowość (kluczy/h) | **578.0 kluczy/h** |
| Podejrzane tłumaczenia | **1078** |
| Najgorsze cele (strażnik) | cs/items.json (gf=18), ro/items.json (gf=8), de/npc.json (gf=3), ru/items.json (gf=3), de/otclient_modules.json (gf=2) |
...
> Świeżość: 3min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T14:08:46.645762Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T14:08:46.645762Z
- **Top 5 typów problemów:** suspicious_rejected_critical=189, suspicious_log_high=79, suspicious_log_low=64, suspicious_log_medium=55, suspicious_rejected_high=11
- **Języki o najsłabszej jakości:** es(60.1, issues=749844), ro(60.1, issues=444295), de(60.1, issues=126836), cs(60.1, issues=118345), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 60%, 58507 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 749844 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 72%, 178872 problemów
⚠️ **RU**: jakość 70%, 373817 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,513 |
| Heartbeat | 178s temu | 2026-04-29T14:09:04Z |
...
- 2026-04-29 14:09:04 | AUTO_TRANSLATE:auto_start | cs | ok | items.json
- 2026-04-29 14:08:45 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
- 2026-04-29 14:07:18 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **148,748** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=5.23%, reason=stable_fail_rate=5.2%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 14:11:55
...
| 🔄 Cykli wykonanych | **#18,513** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,513 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 14:11:55  
