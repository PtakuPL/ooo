...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.06% / real 10.98%**. Tempo: **746.0 kluczy/h**. Tłumaczeń netto: **149,073**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 14:39:51

> **Aktualizacja:** 2026-04-29 14:39:51 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,553 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: it | Plik: items.json | Heartbeat: 2026-04-29T14:38:36Z
> **Okno godzinowe:** okno=1.0h | cykli=81 | pominięte=0.0% | odrzucone=6.2% | przepustowość=746.0/h  
> **Tłumaczeń netto:** 149,073

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 14:39:51 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T14:38:36Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 53s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 14:39:51 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T14:38:34.427248Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T14:38:35.528357Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 14:39:51 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T14:39:57.429841Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T14:38:36Z
...
| 🔄 **Ostatni cykl** | 41 kluczy, 4 odrzuconych, 87.0s, tryb: AUTO_TRANSLATE, cel: ro/items.json |
| ❤️ **Heartbeat** | 2026-04-29T14:38:36Z |
...
| ⏳ Oldest pending (visible tail) | 17360 s |
...
| 🌍 Recent provider mix | TM/simple(352), Free Google Translate(150), canonical_name_semantic_autofix(20), OpenAI model pool(4), term... |
...
| ❤️ Pool health | `critical` (writes=529, fallbacks=23) |
...
|-------|--------|----------|-------|-----------|--------|
| `HEARTBEAT_STALE` | OK | OK | `28` | `300` | Heartbeat świeży (28s, src=worker_runtime_heartbeat) Runtime[status=healthy, reason=heartbeat_fresh, phase=... |
| `NO_WRITE` | OK | OK | `92` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 17360}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 53s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 14:39:51
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T14:38:34.427248Z
...
- This lamp is glowing very dimly. → Această lampăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă lumineaz (item.13656.desc)
- This lamp is glowing very dimly. → Această lampăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă lumineaz (item.13658.desc)
...
- golden rune emblem → emblemăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă de rună de aur (item.11642.name)
- lamp → lampă (item.10507.name)
- ramp → rampă (item.11365.name)
- silver rune emblem → emblemăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă de rună de argint (item.11643.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4986**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4839**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T14:38:54.146481Z |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T13:39:51.365295Z → 2026-04-29T14:39:51.365295Z) |
...
| Podejrzane tłumaczenia | **1139** |
| Najgorsze cele (strażnik) | cs/items.json (gf=27), ro/items.json (gf=12), de/npc.json (gf=3), ru/items.json (gf=3), it/items.json (gf=2) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T14:38:35.528357Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T14:38:35.528357Z
- **Top 5 typów problemów:** suspicious_rejected_critical=190, suspicious_log_high=120, suspicious_log_low=77, suspicious_rejected_high=10, suspicious_log_critical=2
- **Języki o najsłabszej jakości:** es(60.1, issues=750651), ro(60.1, issues=444959), de(60.1, issues=127424), cs(60.1, issues=119697), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 750651 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 78%, 179109 problemów
⚠️ **RU**: jakość 64%, 374317 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,553 |
| Heartbeat | 81s temu | 2026-04-29T14:38:36Z |
...
- 2026-04-29 14:38:55 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-04-29 14:38:54 | AUTO_TRANSLATE:auto_start | it | ok | items.json
- 2026-04-29 14:38:34 | AUTO_TRANSLATE:auto_done | ro | ok | items.json
- 2026-04-29 14:37:07 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-04-29 14:37:07 | AUTO_TRANSLATE:auto_start | ro | ok | items.json
- 2026-04-29 14:36:26 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **149,073** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=7.14%, reason=stable_fail_rate=7.1%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 14:39:51
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [nl] → warn (files+1, translated+9, skipped+0) — lang=nl file=html.json strict_skipped_done=1486 guard_fail=19 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **11,865** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 216 |
| ❌ Błędów | 526 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (2,076), **RU** (1,870), **TR** (1,846), **DE** (1,710), **IT** (1,663) |
| 📊 Porównanie | ↑ 44.2% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **30,845** kluczy
...
| 🔄 Cykli wykonanych | **#18,553** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,553 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 14:39:51  
