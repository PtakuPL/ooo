...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.94% / real 10.86%**. Tempo: **921.0 kluczy/h**. Tłumaczeń netto: **140,736**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 03:11:28

> **Aktualizacja:** 2026-04-29 03:11:28 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,596 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ru | Plik: items.json | Heartbeat: 2026-04-29T03:08:09Z
> **Okno godzinowe:** okno=1.0h | cykli=72 | pominięte=0.0% | odrzucone=2.6% | przepustowość=921.0/h  
> **Tłumaczeń netto:** 140,736

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 03:11:28 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-04-29T03:08:09Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 26s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 03:11:28 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T03:09:18.870020Z |
| QUALITY | 🔒 NIEAKTYWNY | 4min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T03:07:28.940056Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 03:11:28 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T03:11:35.821898Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T03:08:09Z
...
| 🔄 **Ostatni cykl** | 30 kluczy, 1 odrzuconych, 72.7s, tryb: AUTO_TRANSLATE, cel: ru/items.json |
| ❤️ **Heartbeat** | 2026-04-29T03:08:09Z |
...
| ⏳ Oldest pending (visible tail) | 17149 s |
| 🌍 Top języki | RU(398) |
| 🧱 Top reason_bucket | quality(398) |
| 🗂️ Deferred state keys | 7664 |
| 🕒 Deferred state freshness | fresh (1s) |
| ♻️ Deferred stats | enqueued=0, cooldown=0, deduped=0, manual_review=3, partial_staged=2, partial_completed=0 |
...
| 🌍 Recent provider mix | TM/simple(284), Free Google Translate(211), canonical_name_semantic_autofix(17), canonical_name_case_autofi... |
...
| ❤️ Pool health | `critical` (writes=527, fallbacks=3) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=581/581 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 17149}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~135 dni (2,986,678 kluczy do celu 95%)
...
> Świeżość: 26s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 03:11:28
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T03:09:18.870020Z
...
- stone wall → каменный стена (item.1303.name)
- hive structure → структура улья (item.13030.name)
- hive structure → структура улья (item.13031.name)
- hive structure → структура улья (item.13032.name)
- hive structure → структура улья (item.13033.name)
- hive structure → структура улья (item.13034.name)
- hive structure → структура улья (item.13035.name)
- hive structure → структура улья (item.13036.name)
- hive structure → структура улья (item.13037.name)
- hive structure → структура улья (item.13038.name)
- insectoid hive → улей инсектоидов (item.13039.name)
- stone wall → каменный стена (item.1304.name)
- insectoid hive → улей инсектоидов (item.13040.name)
- insectoid hive → улей инсектоидов (item.13041.name)
- insectoid hive → улей инсектоидов (item.13042.name)
- insectoid hive → улей инсектоидов (item.13043.name)
- insectoid hive → улей инсектоидов (item.13044.name)
- insectoid hive → улей инсектоидов (item.13045.name)
- insectoid hive → улей инсектоидов (item.13046.name)
- insectoid hive → улей инсектоидов (item.13047.name)
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T03:08:07.904322Z |
...
- **Profiler cyklu (ostatni):** cykl #1 (AUTO_TRANSLATE): dispatch 1334ms, mode 56086ms, status 12144ms, total 72695ms
...
| 🕒 Evidence window | 24h (span=32.32h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=32.32h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T02:11:29.073000Z → 2026-04-29T03:11:29.073000Z) |
...
> Świeżość: 4min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T03:07:28.940056Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T03:07:28.940056Z
- **Top 5 typów problemów:** suspicious_rejected_critical=187, suspicious_log_medium=91, suspicious_log_low=70, suspicious_log_high=38, suspicious_rejected_high=13
- **Języki o najsłabszej jakości:** es(60.1, issues=730741), ro(60.1, issues=429854), de(60.1, issues=112812), cs(60.1, issues=90019), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 64%, 53942 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 730741 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 65%, 171089 problemów
⚠️ **RU**: jakość 71%, 361649 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,596 |
| Heartbeat | 206s temu | 2026-04-29T03:08:09Z |
...
- 2026-04-29 03:08:09 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-04-29 03:08:08 | AUTO_TRANSLATE:auto_start | ru | ok | items.json
- 2026-04-29 03:07:28 | AUTO_TRANSLATE:auto_done | tr | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 03:11:28
...
| 🔄 Cykli wykonanych | **#17,596** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,596 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 03:11:28  
