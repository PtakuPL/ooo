...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "Hmmm, turtles", yell = false , i18nKey = "monster.island_troll.voice_6"},
	{ text = "Hmmm, dogs", yell = false , i18nKey = "monster.island_troll.voice_7"},
	{ text = "Hmmm, worms", yell = false , i18nKey = "monster.island_troll.voice_8"},
	{ text = "Groar", yell = false , i18nKey = "monster.island_troll.voice_9"},
	{ text = "Gruntz!", yell = false , i18nKey = "monster.island_troll.voice_10"},
}
