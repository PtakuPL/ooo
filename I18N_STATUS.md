...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.01% / real 10.94%**. Tempo: **770.0 kluczy/h**. Tłumaczeń netto: **145,762**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 09:32:55

> **Aktualizacja:** 2026-04-29 09:32:55 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,140 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: cs | Plik: items.json | Heartbeat: 2026-04-29T09:31:28Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=5.3% | przepustowość=770.0/h  
> **Tłumaczeń netto:** 145,762

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 09:32:55 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T09:31:28Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 09:32:55 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T09:31:13.786808Z |
| QUALITY | 🔒 NIEAKTYWNY | 3min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T09:29:34.991513Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 09:32:55 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T09:33:02.509047Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T09:31:28Z
...
| 🔄 **Ostatni cykl** | 41 kluczy, 8 odrzuconych, 81.0s, tryb: AUTO_TRANSLATE, cel: cs/items.json |
| ❤️ **Heartbeat** | 2026-04-29T09:31:28Z |
...
| ⏳ Oldest pending (visible tail) | 15145 s |
...
| 🌍 Recent provider mix | TM/simple(284), Free Google Translate(206), canonical_name_semantic_autofix(16), term_consistency_autofix(3) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=877/877 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 386, 'oldest_s': 15145}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~161 dni (2,983,857 kluczy do celu 95%)
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 09:32:55
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T09:31:13.786808Z
...
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14452.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14453.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14454.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14455.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14456.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14457.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14458.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14459.name)
- lava wall → lávová stěna (item.1446.name)
...
- Raporty strażnika jakości: **4883**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4736**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T09:29:53.164439Z |
...
| 🕒 Evidence window | 24h (span=38.68h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=38.68h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T08:32:55.782322Z → 2026-04-29T09:32:55.782322Z) |
...
> Świeżość: 3min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T09:29:34.991513Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T09:29:34.991513Z
- **Top 5 typów problemów:** suspicious_rejected_critical=188, suspicious_log_high=77, suspicious_log_low=69, suspicious_log_medium=54, suspicious_rejected_high=12
- **Języki o najsłabszej jakości:** es(60.1, issues=742350), ro(60.1, issues=438675), de(60.1, issues=121433), cs(60.1, issues=105884), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 62%, 56187 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 742350 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 71%, 176117 problemów
⚠️ **RU**: jakość 69%, 369070 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,140 |
| Heartbeat | 94s temu | 2026-04-29T09:31:28Z |
...
- 2026-04-29 09:31:28 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 09:31:14 | AUTO_TRANSLATE:auto_done | cs | ok | items.json
- 2026-04-29 09:29:54 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | items.json
- 2026-04-29 09:29:53 | AUTO_TRANSLATE:auto_start | cs | ok | items.json
- 2026-04-29 09:29:34 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
- 2026-04-29 09:28:22 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 09:32:55

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [cs] → warn (files+1, translated+41, skipped+0) — lang=cs file=items.json strict_skipped_done=4124 guard_fail=8 placeholder=0 command=0 pipe=0
- • DOCTOR_REMEDIATION: ALARM_RESOLVED [-] → ok — resolved_count=1
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+4) — repair_identical lang=es file=npc.json target_identical=2 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=180.70
...
| 📊 Porównanie | ↓ 0.1% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **27,199** kluczy
...
| 🔄 Cykli wykonanych | **#18,140** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,140 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 09:32:55  
