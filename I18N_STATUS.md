...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.86%**. Tempo: **1815.9 kluczy/h**. Tłumaczeń netto: **119,744**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 19:19:55

> **Aktualizacja:** 2026-02-20 19:19:55 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #98 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: es | Plik: - | Heartbeat: 2026-02-20T19:19:52Z  
> **Okno godzinowe:** okno=1.0h | cykli=207 | pominięte=0.0% | odrzucone=63.8% | przepustowość=1815.9/h  
> **Tłumaczeń netto:** 119,744

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 19:19:55 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T19:19:52Z |
| MIGRATION | 🔒 NIEAKTYWNY | 36s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 19:19:55 |
| TRANSLATION | 🟢 AKTYWNY | 37s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T19:19:19.296204Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T19:19:57.118749Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 19:19:55 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T19:19:52Z
...
| ❤️ **Heartbeat** | 2026-02-20T19:19:52Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **3,254** kluczy |
| ❌ Odrzucone (guard) | 5743 |
| 🔁 Cykli | 207 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (870 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~1816 kluczy/h |
| 🛡️ Guard fail rate | 63.8% |
| ⚠️ Podejrzane | 25339 |
| 🌐 GT aktywny (1h) | ✅ TAK |
| 🔤 GT tłumaczeń (1h) | 31 |
...
> **ETA globalne:** ~52 dni (2,260,805 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~1816 kluczy/h.
...
> Świeżość: 36s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 19:19:55
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 37s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T19:19:19.296204Z
...
- Raporty strażnika jakości: **6881**  
- Raporty blokad: **0**  
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T18:19:56.199462Z → 2026-02-20T19:19:56.199462Z) |
...
| Przepustowość (kluczy/h) | **1815.9 kluczy/h** |
| Podejrzane tłumaczenia | **3262** |
| Najgorsze cele (strażnik) | pl/items.json (gf=2448), es/items.json (gf=1556), pl/npc.json (gf=968), it/npc.json (gf=171), es/server.json (gf=123) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T19:19:57.118749Z

- **Ostatni audyt:** SLOW_MODE | 33 issue(s) / 100 entries | 2026-02-20T19:19:52.022153Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=98, suspicious_log_high=61, suspicious_log_critical=47, artifact_token=28, identical_to_en_exempt=7
- **Języki o najsłabszej jakości:** es(60.1, issues=331551), pl(60.1, issues=186121), ro(60.1, issues=181623), ru(60.7, issues=211698), sv(64.1, issues=30259)
...
⚠️ **PL**: jakość 60%, 186121 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 331551 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 66%, 73643 problemów
⚠️ **RU**: jakość 61%, 211698 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #98 |
| Heartbeat | 5s temu | 2026-02-20T19:19:52Z |
...
- 2026-02-20 19:19:26 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 19:19:16 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | npc.json
- 2026-02-20 19:19:15 | AUTO_TRANSLATE:parallel_start | ru | ok | npc.json
- 2026-02-20 19:18:56 | AUTO_TRANSLATE:heartbeat_tick | it | ok | npc.json
- 2026-02-20 19:18:55 | AUTO_TRANSLATE:parallel_start | it | ok | npc.json
- 2026-02-20 19:18:54 | AUTO_TRANSLATE:auto_done | es | ok | monsters.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,829 | 646 | 6718 (91.2%) | 34 |
| 🟡 ES | 84.8% | 0 | 2,160 | 781 | 3020 (79.5%) | 39 |
...
| Przepustowość (okno) | 1,427 kluczy / 73 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 19:19:55
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+40, skipped+0) — parallel lang=es file=spells.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+45, skipped+0) — lang=pl file=spells.json strict_skipped_done=1045 guard_fail=5 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [pl] → ok (translated+80, skipped+0) — parallel lang=pl file=html.json
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+18, skipped+0) — parallel lang=es file=html.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+18, skipped+0) — lang=pl file=client.json strict_skipped_done=64
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **10,318** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 98 |
| ❌ Błędów | 226 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (2,982), **RU** (2,057), **IT** (1,733), **RO** (1,272), **PL** (1,147) |
| 📊 Porównanie | ↑ 183.4% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **107,903** kluczy
...
| 🔄 Cykli wykonanych | **#98** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 19:19:55  
