...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "*gulp*", yell = false , i18nKey = "monster.devourer.voice_1"},
	{ text = "*Bruaarrr!*", yell = false , i18nKey = "monster.devourer.voice_2"},
	{ text = "*omnnommm nomm*", yell = false , i18nKey = "monster.devourer.voice_3"},
}
