...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.02% / real 8.95%**. Tempo: **2558.0 kluczy/h**. Tłumaczeń netto: **74,779**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-29 06:28:59

> **Aktualizacja:** 2026-03-29 06:28:59 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #11,358 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: cs | Plik: monsters.json | Heartbeat: 2026-03-29T06:28:43Z  
> **Okno godzinowe:** okno=1.0h | cykli=68 | pominięte=0.0% | odrzucone=19.2% | przepustowość=2558.0/h  
> **Tłumaczeń netto:** 74,779

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-29 06:28:59 |
| LIVE | 🟢 AKTYWNY | 18s temu | - | `activity.json / worker_state.json` | 2026-03-29T06:28:43Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 40s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-29 06:28:59 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-29T06:28:00.957366Z |
| QUALITY | 🔒 NIEAKTYWNY | 39s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-29T06:28:21.441035Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-29 06:28:59 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 18s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-29T06:28:43Z
...
| ❤️ **Heartbeat** | 2026-03-29T06:28:43Z |
...
> **ETA globalne:** ~49 dni (2,983,676 kluczy do celu 95%)
...
| CS | █████████████░░░░░░░ | 70.0% | 52,147/74,536 | ~7h |
| NL | █████████████░░░░░░░ | 69.6% | 51,847/74,536 | ~7h |
| TR | ███░░░░░░░░░░░░░░░░░ | 17.5% | 13,039/74,536 | ~23h |
...
> Tempo obliczone na bazie ostatniej godziny: ~2558 kluczy/h.
...
> Świeżość: 40s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-29 06:28:59
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-29T06:28:00.957366Z
...
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3065**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 279 | 1 | 41,062 | - | 2026-03-29T06:28:42.400069Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.02%** (698,392/3,875,872)
- **Pokrycie globalne (real):** **8.95%** (346,817/3,875,872)
- **Kopie EN (łącznie):** **521,558**
- **Placeholdery [EN]/puste (łącznie):** **2,112,364**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-29T05:28:59.651950Z → 2026-03-29T06:28:59.651950Z) |
...
| Przepustowość (kluczy/h) | **2558.0 kluczy/h** |
| Podejrzane tłumaczenia | **1110** |
| Najgorsze cele (strażnik) | ro/monsters.json (gf=137), it/monsters.json (gf=114), pl/monsters.json (gf=113), nl/monsters.json (gf=108), fr/monsters.json (gf=58) |
...
|--------|-----------|--------|----------------|
| `gt_rejected_critical` | 208 | 66.0% | ro/monsters.json (111) |
| `gt_validate_fail_word_salad` | 48 | 15.2% | pl/monsters.json (21) |
| `gt_rejected_high_partial_translation_mix` | 25 | 7.9% | pl/monsters.json (11) |
| `gt_rejected_high_trimmed_en_copy` | 16 | 5.1% | pl/monsters.json (15) |
| `gt_validate_fail_quality` | 14 | 4.4% | it/items.json (6) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 39s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-29T06:28:21.441035Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-03-29T06:28:21.441035Z
- **Top 5 typów problemów:** suspicious_rejected_critical=158, suspicious_log_high=134, suspicious_log_medium=56, suspicious_rejected_high=42, suspicious_log_critical=10
- **Języki o najsłabszej jakości:** pl(60.1, issues=336008), nl(61.2, issues=18011), it(61.9, issues=119144), ro(64.0, issues=349558), es(65.2, issues=649252)
...
⚠️ **ES**: jakość 65%, 649252 problemów
...
⚠️ **NL**: jakość 61%, 18011 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #11,358 |
| Heartbeat | 18s temu | 2026-03-29T06:28:43Z |
...
- 2026-03-29 06:28:43 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | monsters.json
- 2026-03-29 06:28:42 | AUTO_TRANSLATE:auto_start | cs | ok | monsters.json
- 2026-03-29 06:28:14 | AUTO_TRANSLATE:heartbeat_tick | es | ok | quests.json
- 2026-03-29 06:28:01 | AUTO_TRANSLATE:auto_done | nl | ok | monsters.json
- 2026-03-29 06:26:59 | AUTO_TRANSLATE:heartbeat_tick | nl | ok | monsters.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **74,779** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=27.79%, reason=decrease_high_fail_rate=27.8%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-29 06:28:59
...
| 🏆 TOP 5 | **IT** (1,429), **NL** (1,108), **RO** (1,100), **FR** (940), **CS** (900) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **54,978** kluczy
...
| 🔄 Cykli wykonanych | **#11,358** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #11,358 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-29 06:28:59  
