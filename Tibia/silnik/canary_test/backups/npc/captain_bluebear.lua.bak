...
local function addTravelKeyword(keyword, cost, destination, action, condition)
	...
	local travelKeyword = keywordHandler:addKeyword({ keyword }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.captain_bluebear.stdmod_3", i18nArgs = { keyword:titleCase() }, cost = cost, discount = "postman" })
