...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.01% / real 8.93%**. Tempo: **2205.0 kluczy/h**. Tłumaczeń netto: **74,489**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-29 06:11:39

> **Aktualizacja:** 2026-03-29 06:11:39 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #11,334 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ro | Plik: monsters.json | Heartbeat: 2026-03-29T06:11:00Z  
> **Okno godzinowe:** okno=1.0h | cykli=132 | pominięte=0.0% | odrzucone=12.9% | przepustowość=2205.0/h  
> **Tłumaczeń netto:** 74,489

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-29 06:11:39 |
| LIVE | 🟢 AKTYWNY | 40s temu | - | `activity.json / worker_state.json` | 2026-03-29T06:11:00Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 42s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-29 06:11:39 |
| TRANSLATION | 🟢 AKTYWNY | 3min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-29T06:08:23.358824Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-29T06:09:02.408409Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-29 06:11:39 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 40s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-29T06:11:00Z
...
| ❤️ **Heartbeat** | 2026-03-29T06:11:00Z |
...
> Tempo obliczone na bazie ostatniej godziny: ~2205 kluczy/h.
...
> Świeżość: 42s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-29 06:11:39
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-29T06:08:23.358824Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-29T05:11:39.437319Z → 2026-03-29T06:11:39.437319Z) |
...
| Przepustowość (kluczy/h) | **2205.0 kluczy/h** |
| Podejrzane tłumaczenia | **1134** |
| Najgorsze cele (strażnik) | pl/monsters.json (gf=113), es/monsters.json (gf=25), fr/html.json (gf=24), ro/html.json (gf=19), cs/html.json (gf=19) |
...
|--------|-----------|--------|----------------|
| `gt_rejected_critical` | 231 | 58.2% | ro/monsters.json (73) |
| `gt_validate_fail_word_salad` | 68 | 17.1% | pl/monsters.json (21) |
| `gt_rejected_high_partial_translation_mix` | 43 | 10.8% | pl/monsters.json (11) |
| `gt_validate_fail_quality` | 17 | 4.3% | it/items.json (6) |
| `gt_rejected_high_trimmed_en_copy` | 15 | 3.8% | pl/monsters.json (15) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-29T06:09:02.408409Z
...
| Heartbeat | 40s temu | 2026-03-29T06:11:00Z |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-29 06:11:39
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-29 06:11:39  
