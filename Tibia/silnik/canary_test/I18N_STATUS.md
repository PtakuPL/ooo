...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.64% / real 10.52%**. Tempo: **1241.0 kluczy/h**. Tłumaczeń netto: **125,529**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-23 18:06:09

> **Aktualizacja:** 2026-04-23 18:06:09 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #16,191 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: pt | Plik: monsters.json | Heartbeat: 2026-04-23T18:05:13Z  
> **Okno godzinowe:** okno=1.0h | cykli=64 | pominięte=0.0% | odrzucone=49.6% | przepustowość=1241.0/h  
> **Tłumaczeń netto:** 125,529

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-23 18:06:09 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-23T18:05:13Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 59s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-23 18:06:09 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-23T18:04:47.047345Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-23T18:05:12.777972Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-23 18:06:09 |
| DOCTOR | 🟢 AKTYWNY | 0s temu | - | `doctor_alerts_latest.json` | 2026-04-23T18:06:16.896580Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-23T18:05:13Z
...
| ❤️ **Heartbeat** | 2026-04-23T18:05:13Z |
...
|----------|------|---------|-----------|-------|----------|--------------|-----|
| 18:06:11 | PT | Serwer | monsters.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `monster.minotaur_guard.voice_1` |
| 18:06:11 | PT | Serwer | monsters.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `monster.devourer.voice_3` |
| 18:06:11 | PT | Serwer | monsters.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `monster.sandstone_scorpion.voice_2` |
| 18:06:11 | PT | Serwer | monsters.json | `hard_block` | `critical_issue` | `garble_en_chunk, partial_translation_mix` | `monster.old_bonelord.voice_3` |
| 18:06:08 | PT | Serwer | monsters.json | `hard_block` | `validate_word_salad` | `word_salad` | `monster.old_bonelord.voice_2` |
| 18:06:08 | PT | Serwer | monsters.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `monster.druid_familiar.name` |
| 18:06:08 | PT | Serwer | monsters.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `monster.paladin_familiar.name` |
| 18:06:08 | PT | Serwer | monsters.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `monster.knight_familiar.name` |
| 18:06:06 | PT | Serwer | monsters.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `monster.sorcerer_familiar.name` |
| 18:04:43 | DE | Serwer | monsters.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `monster.sandstone_scorpion.voice_2` |
| 18:04:41 | DE | Serwer | monsters.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `monster.enraged_crystal_golem.voice_1` |
| 18:04:41 | DE | Serwer | monsters.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `monster.shrieking_cry_stal.voice_1` |
| 18:04:41 | DE | Serwer | monsters.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `monster.old_bonelord.voice_3` |
| 18:04:40 | DE | Serwer | monsters.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `monster.old_bonelord.voice_2` |
...
| ⏳ Oldest pending (visible tail) | 990 s |
| 🌍 Top języki | RO(154), IT(123), FR(54), RU(23) |
| 🧱 Top reason_bucket | default(326), partial_translation_mix(30), quality(20), word_salad(15) |
...
| 🧮 OpenAI budget | `28/250` |
| ♻️ Provider debt | `11` |
| 🌍 Recent provider mix | Free Google Translate(296), TM/simple(133), OpenAI model pool(19) |
| 🔁 Latest fallback | OpenAI model pool → fallback chain exhausted validate fail word salad [validate_word_salad] monsters.json |
| 📉 Fallback breakdown | fallback to google translate high(42), fallback to google translate validate fail(3), fallback to next prov... |
| ☁️ Cloud policy | `disabled` |
| 🤖 OpenAI pool | `active` |
| 🩺 Health signals | recent_fallback, provider_consistency_debt:11 |
| ❤️ Pool health | `degraded` (writes=448, fallbacks=53) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=50/50 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
|-------|--------|----------|-------|-----------|--------|
| `HEARTBEAT_STALE` | OK | OK | `4` | `300` | Heartbeat świeży (4s, src=worker_runtime_heartbeat) Runtime[status=healthy, reason=heartbeat_fresh, phase=A... |
| `NO_WRITE` | OK | OK | `68` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | OK | OK | `{'pending': 400, 'oldest_s': 990}` | `{'pending_min': 200, 'oldest_s': 3600}` | Queue bez sygnałów starvation. |
...
| �📊 Przetłumaczono | **1,241** kluczy |
| ❌ Odrzucone (guard) | 1222 |
| 🔁 Cykli | 64 |
| 🌍 Języków | 9 |
| 🏆 Najaktywniejszy | TR (354 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~1241 kluczy/h |
...
> **ETA globalne:** ~101 dni (2,998,374 kluczy do celu 95%)
...
| CS | █████████░░░░░░░░░░░ | 48.2% | 35,929/74,536 | ~28h |
| TR | ██████░░░░░░░░░░░░░░ | 31.9% | 23,796/74,536 | ~38h |
...
> Tempo obliczone na bazie ostatniej godziny: ~1241 kluczy/h.
...
> Świeżość: 59s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-23 18:06:09
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-23T18:04:47.047345Z
...
- Raporty strażnika jakości: **4384**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4241**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 280 | 0 | 0 | - | 2026-04-23T18:05:43.586992Z |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-23T17:06:09.638144Z → 2026-04-23T18:06:09.638144Z) |
...
| Przepustowość (kluczy/h) | **1241.0 kluczy/h** |
| Podejrzane tłumaczenia | **2956** |
...
|--------|-----------|--------|----------------|
| `gt_validate_fail_identical_to_en` | 677 | 49.9% | ro/items.json (167) |
| `gt_validate_fail_placeholder` | 456 | 33.6% | tr/npc.json (133) |
| `gt_validate_fail_quality` | 79 | 5.8% | tr/npc.json (53) |
| `gt_rejected_critical` | 46 | 3.4% | pt/npc.json (12) |
| `gt_validate_fail_word_salad` | 36 | 2.7% | fr/monsters.json (6) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-23T18:05:12.777972Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-23T18:05:12.777972Z
- **Top 5 typów problemów:** suspicious_rejected_critical=162, suspicious_log_high=153, suspicious_log_medium=40, suspicious_rejected_high=38, suspicious_log_critical=7
- **Języki o najsłabszej jakości:** ro(60.1, issues=417260), fr(60.1, issues=59760), it(60.2, issues=163980), cs(60.5, issues=73214), tr(63.5, issues=45410)
...
⚠️ **ES**: jakość 96%, 708514 problemów
⚠️ **PT**: jakość 67%, 41114 problemów
⚠️ **FR**: jakość 60%, 59760 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #16,191 |
| Heartbeat | 63s temu | 2026-04-23T18:05:13Z |
...
- 2026-04-23 18:05:02 | AUTO_TRANSLATE:heartbeat_tick | es | ok | quests.json
- 2026-04-23 18:04:47 | AUTO_TRANSLATE:auto_done | de | ok | monsters.json
- 2026-04-23 18:04:28 | AUTO_TRANSLATE:heartbeat_tick | de | ok | monsters.json
- 2026-04-23 18:04:28 | AUTO_TRANSLATE:auto_start | de | ok | monsters.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **125,529** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=43.96%, reason=decrease_high_fail_rate=44.0%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-23 18:06:09
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **4,769** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 147 |
| ❌ Błędów | 296 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **CS** (911), **DE** (656), **ES** (651), **TR** (634), **IT** (448) |
| 📊 Porównanie | ↓ 60.6% vs wczoraj (12,108) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **32,453** kluczy
...
| 🔄 Cykli wykonanych | **#16,191** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #16,191 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-23 18:06:09  
