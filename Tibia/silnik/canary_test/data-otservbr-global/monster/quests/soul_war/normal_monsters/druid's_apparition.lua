...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "Healing is what I do best.", yell = false , i18nKey = "monster.druid's_apparition.voice_1"},
	{ text = "I'll take your place when you are gone.", yell = false , i18nKey = "monster.druid's_apparition.voice_2"},
}
