...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.92%**. Tempo: **947.5 kluczy/h**. Tłumaczeń netto: **127,200**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 23:31:24

> **Aktualizacja:** 2026-02-20 23:31:24 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #3 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ro | Plik: - | Heartbeat: 2026-02-20T23:31:18Z  
> **Okno godzinowe:** okno=1.0h | cykli=135 | pominięte=0.0% | odrzucone=59.9% | przepustowość=947.5/h  
> **Tłumaczeń netto:** 127,200

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 23:31:24 |
| LIVE | 🟢 AKTYWNY | 7s temu | - | `activity.json / worker_state.json` | 2026-02-20T23:31:18Z |
| MIGRATION | 🔒 NIEAKTYWNY | 59s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 23:31:24 |
| TRANSLATION | 🟢 AKTYWNY | 50s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T23:30:35.970040Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T23:31:25.786928Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 23:31:24 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 7s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T23:31:18Z
...
| ❤️ **Heartbeat** | 2026-02-20T23:31:18Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **1,599** kluczy |
| ❌ Odrzucone (guard) | 2391 |
| 🔁 Cykli | 135 |
| 🌍 Języków | 7 |
...
> **ETA globalne:** ~99 dni (2,259,306 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| PL | █████████████████░░░ | 87.8% | 47,077/53,586 | ~4h |
| ES | █████████████████░░░ | 85.1% | 45,618/53,586 | ~6h |
| IT | ██████████░░░░░░░░░░ | 52.7% | 28,252/53,586 | ~24h |
| RU | ██████████░░░░░░░░░░ | 50.5% | 27,035/53,586 | ~25h |
| SR | █████████░░░░░░░░░░░ | 45.5% | 24,358/53,586 | ~28h |
| RO | ████████░░░░░░░░░░░░ | 43.9% | 23,528/53,586 | ~29h |
| FR | ██████░░░░░░░░░░░░░░ | 33.1% | 17,731/53,586 | ~35h |
| SV | █████░░░░░░░░░░░░░░░ | 29.3% | 15,687/53,586 | ~37h |
...
> Świeżość: 59s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 23:31:24
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 50s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T23:30:35.970040Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T22:31:24.787868Z → 2026-02-20T23:31:24.787868Z) |
...
| Przepustowość (kluczy/h) | **947.5 kluczy/h** |
| Podejrzane tłumaczenia | **3939** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T23:31:25.786928Z
...
| Heartbeat | 7s temu | 2026-02-20T23:31:18Z |
...
- 2026-02-20 23:30:11 | AUTO_TRANSLATE:parallel_start | sv | ok | monsters.json
- 2026-02-20 23:30:08 | AUTO_TRANSLATE:auto_done | ro | ok | otclient_modules.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **127,200** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=30.62%, reason=decrease_high_fail_rate=30.6% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 23:31:24

- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+23) — repair_identical lang=es file=npc.json target_identical=43 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=247.94
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [sr] → ok (translated+29, skipped+0) — parallel lang=sr file=monsters.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [sv] → ok (translated+25, skipped+0) — parallel lang=sv file=monsters.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+17, skipped+0) — lang=ro file=otclient_modules.json strict_skipped_done=773 guard_fail=13 placeholder=0 command=0 pipe=0
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [sv] → warn (files+1, translated+30, skipped+0) — lang=sv file=npc.json strict_skipped_done=6191
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 23:31:24  
