...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.06% / real 10.98%**. Tempo: **688.0 kluczy/h**. Tłumaczeń netto: **149,323**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 15:03:57

> **Aktualizacja:** 2026-04-29 15:03:57 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,585 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: it | Plik: items.json | Heartbeat: 2026-04-29T15:02:30Z
> **Okno godzinowe:** okno=1.0h | cykli=80 | pominięte=0.0% | odrzucone=6.5% | przepustowość=688.0/h  
> **Tłumaczeń netto:** 149,323

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 15:03:57 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T15:02:30Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 15s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 15:03:57 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T15:02:28.511248Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T15:02:29.691996Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 15:03:57 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T15:04:05.353232Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T15:02:30Z
...
| 🔄 **Ostatni cykl** | 43 kluczy, 4 odrzuconych, 89.0s, tryb: AUTO_TRANSLATE, cel: ro/items.json |
| ❤️ **Heartbeat** | 2026-04-29T15:02:30Z |
...
| ⏳ Oldest pending (visible tail) | 17409 s |
...
| 🧮 OpenAI budget | `11/250 (4.4%)` |
| ♻️ Provider debt | `1248` |
| 🌍 Recent provider mix | TM/simple(342), Free Google Translate(127), canonical_name_semantic_autofix(20), OpenAI model pool(10), ter... |
...
| ❤️ Pool health | `critical` (writes=502, fallbacks=26) |
...
| `NO_WRITE` | OK | OK | `107` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 397, 'oldest_s': 17409}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~181 dni (2,982,171 kluczy do celu 95%)
...
> Świeżość: 15s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 15:03:57
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T15:02:28.511248Z
...
- tiled roof → acoperiș cu țiglă (item.1165.name)
- tiled roof → acoperiș cu țiglă (item.1166.name)
- tiled roof → acoperiș cu țiglă (item.1167.name)
- tiled roof → acoperiș cu țiglă (item.1168.name)
- tiled roof → acoperiș cu țiglă (item.1169.name)
...
- This lamp is glowing very dimly. → Această lampăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă luminea (item.13656.desc)
- This lamp is glowing very dimly. → Această lampăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă luminea (item.13658.desc)
...
- Raporty strażnika jakości: **4994**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4847**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T15:02:48.789753Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.06%** (699,897/3,875,872)
- **Pokrycie globalne (real):** **10.98%** (425,687/3,875,872)
- **Kopie EN (łącznie):** **410,297**
- **Placeholdery [EN]/puste (łącznie):** **2,185,766**
...
| #3 | 🔴 Server | 11.06% | +0.30 pp | 51 | ZH 0.2%, TL 0.8%, BS 0.9% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T14:03:57.816686Z → 2026-04-29T15:03:57.816686Z) |
...
| Podejrzane tłumaczenia | **1097** |
| Najgorsze cele (strażnik) | cs/items.json (gf=27), ro/items.json (gf=12), ru/items.json (gf=3), it/items.json (gf=2), de/otclient_modules.json (gf=2) |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 69 | 71.1% | ru/items.json (69) |
| `existing_canonical_name_quality_mixed_scripts` | 27 | 27.8% | ru/items.json (27) |
| `retry_loop_cooldown_default` | 1 | 1.0% | cs/items.json (1) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T15:02:29.691996Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T15:02:29.691996Z
- **Top 5 typów problemów:** suspicious_rejected_critical=190, suspicious_log_high=120, suspicious_log_low=78, suspicious_rejected_high=10, suspicious_log_critical=1
- **Języki o najsłabszej jakości:** es(60.1, issues=751309), ro(60.1, issues=445526), de(60.1, issues=127880), cs(60.1, issues=120733), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 751309 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 78%, 179325 problemów
⚠️ **RU**: jakość 62%, 374758 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,585 |
| Heartbeat | 95s temu | 2026-04-29T15:02:30Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T14:58:42.273685Z
...
- 2026-04-29 15:02:49 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-04-29 15:02:49 | AUTO_TRANSLATE:auto_start | it | ok | items.json
- 2026-04-29 15:02:28 | AUTO_TRANSLATE:auto_done | ro | ok | items.json
- 2026-04-29 15:00:59 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-04-29 15:00:59 | AUTO_TRANSLATE:auto_start | ro | ok | items.json
- 2026-04-29 15:00:13 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 15:03:57
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **12,142** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 216 |
| ❌ Błędów | 540 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (2,137), **RU** (1,900), **TR** (1,885), **DE** (1,755), **IT** (1,693) |
| 📊 Porównanie | ↑ 47.6% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **31,122** kluczy
...
| 🔄 Cykli wykonanych | **#18,585** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,585 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 15:03:57  
