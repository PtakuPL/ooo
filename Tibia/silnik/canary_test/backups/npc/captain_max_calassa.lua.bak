...
local travelNode = keywordHandler:addKeyword({ "liberty bay" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.captain_max_calassa.stdmod_1" })
...
travelNode:addChildKeyword({ "no" }, StdModule.say, { npcHandler = npcHandler, reset = true, i18nKey = "npc.captain_max_calassa.stdmod_2" })

keywordHandler:addKeyword({ "back" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.captain_max_calassa.stdmod_3" })
keywordHandler:addKeyword({ "passage" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.captain_max_calassa.stdmod_4" })
