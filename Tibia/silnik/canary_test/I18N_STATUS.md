...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.89%**. Tempo: **1565.8 kluczy/h**. Tłumaczeń netto: **124,892**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 21:56:40

> **Aktualizacja:** 2026-02-20 21:56:40 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #2 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ru | Plik: - | Heartbeat: 2026-02-20T21:56:27Z  
> **Okno godzinowe:** okno=1.0h | cykli=191 | pominięte=0.0% | odrzucone=69.1% | przepustowość=1565.8/h  
> **Tłumaczeń netto:** 124,892

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 21:56:40 |
| LIVE | 🟢 AKTYWNY | 14s temu | - | `activity.json / worker_state.json` | 2026-02-20T21:56:27Z |
| MIGRATION | 🔒 NIEAKTYWNY | 40s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 21:56:40 |
| TRANSLATION | 🟢 AKTYWNY | 14s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T21:56:27.128456Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T21:56:41.717567Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 21:56:40 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 14s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T21:56:27Z
...
| ❤️ **Heartbeat** | 2026-02-20T21:56:27Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **2,787** kluczy |
| ❌ Odrzucone (guard) | 6233 |
| 🔁 Cykli | 191 |
| 🌍 Języków | 7 |
...
> Świeżość: 40s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 21:56:40
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 14s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T21:56:27.128456Z
...
- White Pale → White Pale (monster.white_pale.name)
- White Pale → White Pale (monster.white_pale.desc)
- The Welter → The Welter (monster.the_welter.name)
- The Welter → The Welter (monster.the_welter.desc)
- Water Buffalo → Water Buffalo (monster.water_buffalo.name)
- Hou hou hou! → Oh oh oh! (monster.hyaena.voice_2)
- Qjell afar gou jey! → Qjell lontano, gou jey! (monster.deepling_worker.voice_1)
- Feverish Citizen → Feverish Citizen (monster.feverish_citizen.name)
- He he he. → Eh eh eh. (monster.diabolic_imp.voice_2)
- Coo! Coooo! Coo! Cooo! → Coo! Coooo! Coo! Cooooo! (monster.pigeon.voice_2)
- Serpent Spawn → Serpent Spawn (monster.serpent_spawn.name)
- Mad Mage → Mad Mage (monster.mad_mage.name)
- Zevelon Duskbringer → Zevelon Duskbringer (monster.zevelon_duskbringer.name)
- Zevelon Duskbringer → Zevelon Duskbringer (monster.zevelon_duskbringer.desc)
- Weakened Shlorg → Weakened Shlorg (monster.weakened_shlorg.name)
- Weakened Shlorg → Weakened Shlorg (monster.weakened_shlorg.desc)
- Diblis the Fair → Diblis The Fair (monster.diblis_the_fair.name)
- Diblis The Fair → Diblis The Fair (monster.diblis_the_fair.desc)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **7204**  
- Raporty blokad: **0**  
...
- **Profiler cyklu (ostatni):** cykl #2 (AUTO_TRANSLATE): dispatch 2247ms, mode 22897ms, status 5382ms, total 38506ms
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T20:56:40.905969Z → 2026-02-20T21:56:40.905969Z) |
...
| Przepustowość (kluczy/h) | **1565.8 kluczy/h** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T21:56:41.717567Z

- **Ostatni audyt:** SLOW_MODE | 29 issue(s) / 100 entries | 2026-02-20T21:56:27.759537Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=116, suspicious_log_high=83, suspicious_log_low=19, suspicious_log_critical=17, artifact_token=16
- **Języki o najsłabszej jakości:** es(60.1, issues=349347), pl(60.1, issues=193640), ro(60.1, issues=189387), tl(64.2, issues=466), zh_TW(64.8, issues=337)
...
| Heartbeat | 14s temu | 2026-02-20T21:56:27Z |
...
- 2026-02-20 21:56:22 | AUTO_TRANSLATE:heartbeat_tick | it | ok | monsters.json
- 2026-02-20 21:56:22 | AUTO_TRANSLATE:parallel_start | it | ok | monsters.json
- 2026-02-20 21:56:11 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-02-20 21:56:11 | AUTO_TRANSLATE:parallel_start | ro | ok | items.json
- 2026-02-20 21:56:10 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
- 2026-02-20 21:56:05 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **124,892** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=80.34%, reason=decrease_high_fail_rate=80.3% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 21:56:40
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **18,310** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 224 |
| ❌ Błędów | 443 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (5,398), **RU** (3,579), **IT** (2,946), **PL** (2,190), **RO** (2,177) |
| 📊 Porównanie | ↑ 402.9% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **115,895** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 21:56:40  
