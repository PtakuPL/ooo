...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.03% / real 10.95%**. Tempo: **734.0 kluczy/h**. Tłumaczeń netto: **147,252**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 11:49:23

> **Aktualizacja:** 2026-04-29 11:49:23 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,332 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-04-29T11:45:50Z
> **Okno godzinowe:** okno=1.0h | cykli=80 | pominięte=0.0% | odrzucone=5.5% | przepustowość=734.0/h  
> **Tłumaczeń netto:** 147,252

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 11:49:23 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-04-29T11:45:50Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 43s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 11:49:23 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T11:47:21.579223Z |
| QUALITY | 🔒 NIEAKTYWNY | 3min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T11:45:32.673607Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 11:49:23 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T11:49:29.630557Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T11:45:50Z
...
| 🔄 **Ostatni cykl** | 42 kluczy, 8 odrzuconych, 91.0s, tryb: AUTO_TRANSLATE, cel: cs/items.json |
| ❤️ **Heartbeat** | 2026-04-29T11:45:50Z |
...
| ⏳ Oldest pending (visible tail) | 16612 s |
| 🌍 Top języki | RU(386) |
...
| 🌍 Recent provider mix | TM/simple(318), Free Google Translate(175), canonical_name_semantic_autofix(16), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=512, fallbacks=21) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=983/983 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 386, 'oldest_s': 16612}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~169 dni (2,983,204 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~734 kluczy/h.
...
> Świeżość: 43s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 11:49:23
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T11:47:21.579223Z
...
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14617.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14618.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14619.name)
- stone wall → kamenná zeď (item.1462.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14620.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14621.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14622.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14623.name)
...
- fire shrine → ohnivá svatyně (item.146.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4931**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4784**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T11:45:49.789165Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.03%** (698,864/3,875,872)
- **Pokrycie globalne (real):** **10.95%** (424,569/3,875,872)
- **Kopie EN (łącznie):** **410,382**
- **Placeholdery [EN]/puste (łącznie):** **2,186,799**
...
| 🕒 Evidence window | 24h (span=40.95h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=40.95h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T10:49:23.671264Z → 2026-04-29T11:49:23.671264Z) |
...
| Przepustowość (kluczy/h) | **734.0 kluczy/h** |
| Podejrzane tłumaczenia | **1130** |
...
> Świeżość: 3min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T11:45:32.673607Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T11:45:32.673607Z
- **Top 5 typów problemów:** suspicious_rejected_critical=189, suspicious_log_low=78, suspicious_log_high=77, suspicious_log_medium=45, suspicious_rejected_high=11
- **Języki o najsłabszej jakości:** es(60.1, issues=746306), ro(60.1, issues=441500), de(60.1, issues=124248), cs(60.1, issues=112396), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 61%, 57318 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 746306 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 72%, 177587 problemów
⚠️ **RU**: jakość 70%, 371561 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,332 |
| Heartbeat | 219s temu | 2026-04-29T11:45:50Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T11:47:37.184729Z
...
- 2026-04-29 11:49:08 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 11:47:37 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 11:47:21 | AUTO_TRANSLATE:auto_done | cs | ok | items.json
- 2026-04-29 11:45:50 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | items.json
- 2026-04-29 11:45:50 | AUTO_TRANSLATE:auto_start | cs | ok | items.json
- 2026-04-29 11:45:31 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 11:49:23

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [cs] → warn (files+1, translated+42, skipped+0) — lang=cs file=items.json strict_skipped_done=4305 guard_fail=8 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+4) — repair_identical lang=es file=npc.json target_identical=2 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=201.39
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **9,865** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 185 |
| ❌ Błędów | 430 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,753), **RU** (1,659), **IT** (1,463), **TR** (1,426), **DE** (1,395) |
| 📊 Porównanie | ↑ 19.9% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **28,845** kluczy
...
| 🔄 Cykli wykonanych | **#18,332** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,332 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 11:49:23  
