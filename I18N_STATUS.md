...
> **Aktualizacja:** 2025-12-11 01:29:19 UTC  
...
│ Kategoria: 🌍 EL/scripts.json                        │
├─────────────────────────────────────────────────────────────────┤
│ 📊 Ostatnia aktywność: EL/scripts.json                                │
│ [█████████████████████████████████████████████████░] │
│ 28501/28550 kluczy (100%)                                          │
├─────────────────────────────────────────────────────────────────┤
│ ⏳ Total processed: 30712 operacji               │
│ 🌍 Języki zsync: 0/53                                │
│ 📅 Ostatnia aktualizacja: 2025-12-11 01:29:19                 │
└─────────────────────────────────────────────────────────────────┘
```
...
|---------|---------|-----------|
| 📁 Operacji wykonanych | **30712** | we wszystkich kategoriach |
...
- 🌍 `EL/scripts.json` +28501 kluczy @ 01:29:18
...
|-----------|--------|--------------|-----------|--------|
| items | 13749 | 11689 | 4 | ⏭️ Skip 39m |
| monsters | 7341 | 9549 | 4 | ⏭️ Skip 39m |
| npc | 5334 | 2 | 0 | ✅ Active |
| html | 1495 | 3245 | 4 | ⏭️ Skip 44m |
| scripts | 385 | 0 | 4 | ⏭️ Skip 38m |
| raids | 147 | 351 | 4 | ⏭️ Skip 39m |
| startup | 23 | 23 | 4 | ⏭️ Skip 40m |
| libs | 21 | 53 | 4 | ⏭️ Skip 39m |
| modules | 16 | 16 | 4 | ⏭️ Skip 40m |
| spells | 15 | 0 | 0 | ✅ Active |
| messages | 11 | 0 | 0 | ✅ Active |
| chatchannels | 8 | 8 | 4 | ⏭️ Skip 39m |
| events | 5 | 5 | 4 | ⏭️ Skip 39m |
| actions | 0 | 0 | 0 | ⏳ Empty |
| client | 0 | 821 | 4 | ⏭️ Skip 44m |
| cpp | 0 | 0 | 0 | ⏳ Empty |
| errors | 0 | 0 | 0 | ⏳ Empty |
| npclib | 0 | 0 | 4 | ⏭️ Skip 40m |
| php | 0 | 4521 | 6 | ⏭️ Skip 114m |
| quests | 0 | 0 | 0 | ⏳ Empty |
| server | 0 | 0 | 0 | ⏳ Empty |
| ui | 0 | 0 | 0 | ⏳ Empty |
| world | 0 | 0 | 4 | ⏭️ Skip 39m |
...
|-----------|----------------|-----------|-------|
| scripts | 38m | 4x | Progresywny backoff |
| monsters | 39m | 4x | Progresywny backoff |
| raids | 39m | 4x | Progresywny backoff |
| world | 39m | 4x | Progresywny backoff |
| items | 39m | 4x | Progresywny backoff |
| libs | 39m | 4x | Progresywny backoff |
| events | 39m | 4x | Progresywny backoff |
| chatchannels | 39m | 4x | Progresywny backoff |
| modules | 40m | 4x | Progresywny backoff |
| startup | 40m | 4x | Progresywny backoff |
| npclib | 40m | 4x | Progresywny backoff |
| php | 114m | 6x | Progresywny backoff |
| html | 44m | 4x | Progresywny backoff |
| client | 44m | 4x | Progresywny backoff |
| sendtextmessage | 44m | 4x | Progresywny backoff |
| keywordhandler | 44m | 4x | Progresywny backoff |
| twig | 44m | 4x | Progresywny backoff |
...
📅 Auto-updated by Worker v1.1 | Last: 2025-12-11 01:29:19  
