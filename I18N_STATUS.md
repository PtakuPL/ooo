...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.71% / real 11.68%**. Tempo: **514.0 kluczy/h**. Tłumaczeń netto: **169,434**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-05-02 06:08:20

> **Aktualizacja:** 2026-05-02 06:08:20 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #19,319 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-05-02T06:05:20Z
> **Okno godzinowe:** okno=1.0h | cykli=64 | pominięte=0.0% | odrzucone=0.0% | przepustowość=514.0/h  
> **Tłumaczeń netto:** 169,434

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-05-02 06:08:20 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-05-02T06:05:20Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 20h temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-05-02 06:08:20 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-05-02T06:06:39.252819Z |
| QUALITY | 🔒 NIEAKTYWNY | 3min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-05-02T06:05:13.005660Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-05-02 06:08:20 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-05-02T06:08:29.648791Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-05-02T06:05:20Z
...
| 🔄 **Ostatni cykl** | 203 kluczy, 0 odrzuconych, 79.0s, tryb: AUTO_TRANSLATE, cel: tr/items.json |
| ❤️ **Heartbeat** | 2026-05-02T06:05:20Z |
...
| ⏳ Oldest pending (visible tail) | 18606 s |
...
| ♻️ Provider debt | `767` |
| 🌍 Recent provider mix | OpenAI model pool(100), tm_dedup_file(97), canonical_name_semantic_autofix(20), tm_dedup_propagate(3), term... |
...
| ❤️ Pool health | `degraded` (writes=221, fallbacks=22) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=189/189 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 18606}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~240 dni (2,956,979 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| PL | ████████████████░░░░ | 84.2% | 62,753/74,536 | ~16h |
| ES | ███████████████░░░░░ | 79.9% | 59,560/74,536 | ~22h |
| RO | ███████████████░░░░░ | 78.5% | 58,478/74,536 | ~24h |
| IT | ██████████████░░░░░░ | 72.2% | 53,802/74,536 | ~33h |
| RU | █████████░░░░░░░░░░░ | 46.1% | 34,375/74,536 | ~3d |
| FR | ███████████░░░░░░░░░ | 57.5% | 42,864/74,536 | ~2d |
| TR | ████████░░░░░░░░░░░░ | 42.8% | 31,912/74,536 | ~3d |
| CS | ██████████░░░░░░░░░░ | 52.2% | 38,916/74,536 | ~3d |
| PT | ████████████████░░░░ | 81.2% | 60,516/74,536 | ~20h |
| SR | ██████░░░░░░░░░░░░░░ | 33.3% | 24,827/74,536 | ~4d |
| NL | ███████████████░░░░░ | 77.6% | 57,814/74,536 | ~25h |
| DE | ██████████████░░░░░░ | 70.0% | 52,184/74,536 | ~36h |
...
> Świeżość: 20h temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-05-02 06:08:20
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-05-02T06:06:39.252819Z
...
- Raporty strażnika jakości: **5186**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **5038**
...
| 🕒 Evidence window | 24h (span=33.58h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=33.58h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=+0.00pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-05-02T05:08:20.607354Z → 2026-05-02T06:08:20.607354Z) |
...
| Przepustowość (kluczy/h) | **514.0 kluczy/h** |
...
> Świeżość: 3min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-05-02T06:05:13.005660Z
...
| Heartbeat | 190s temu | 2026-05-02T06:05:20Z |
...
- **Ostatnia aktualizacja:** 2026-05-02T06:06:56.360034Z
...
- 2026-05-02 06:06:57 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-05-02 06:06:39 | AUTO_TRANSLATE:auto_done | tr | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-05-02 06:08:20

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [tr] → warn (files+1, translated+203, skipped+0) — lang=tr file=items.json strict_skipped_done=5211
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **12,899** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 58 |
| ❌ Błędów | 80 |
| 🌍 Aktywnych języków | 6 |
| 🏆 TOP 5 | **RO** (7,400), **TR** (4,962), **ES** (200), **RU** (140), **IT** (125) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **45,879** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-05-02 06:08:20  
