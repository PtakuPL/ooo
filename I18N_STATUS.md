...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.72% / real 11.7%**. Tempo: **290.0 kluczy/h**. Tłumaczeń netto: **170,370**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-05-02 07:35:22

> **Aktualizacja:** 2026-05-02 07:35:22 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #19,415 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: tr | Plik: items.json | Heartbeat: 2026-05-02T07:31:50Z
> **Okno godzinowe:** okno=1.0h | cykli=64 | pominięte=0.0% | odrzucone=0.0% | przepustowość=290.0/h  
> **Tłumaczeń netto:** 170,370

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-05-02 07:35:22 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-05-02T07:31:50Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 22h temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-05-02 07:35:22 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-05-02T07:34:13.012006Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-05-02T07:34:14.264553Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-05-02 07:35:22 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-05-02T07:35:29.997739Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-05-02T07:31:50Z
...
| 🔄 **Ostatni cykl** | 2 kluczy, 0 odrzuconych, 143.0s, tryb: AUTO_TRANSLATE, cel: ru/items.json |
| ❤️ **Heartbeat** | 2026-05-02T07:31:50Z |
...
|----------|------|---------|------|-------|--------|------------|--------|
| 07:34:05 | RU | Serwer | items.json | 2 | `openai:openai/gpt-4.1...` | `item.15052.name` | мшистый пол |
| 07:29:27 | RO | Serwer | items.json | 22 | `openai:openai/gpt-4.1...` | `item.10190.name` | războinic draken mort |
| 07:27:01 | ES | Serwer | items.json | 9 | `openai:openai/gpt-4.1...` | `item.11695.name` | cobra de jade negro |
| 07:21:38 | IT | Serwer | items.json | 3 | `openai:openai/gpt-4.1...` | `item.14771.name` | pavimento di cristallo |
| 07:19:24 | CS | Serwer | items.json | 5 | `openai:openai/gpt-4.1...` | `item.1261.name` | tic-tac-toe deska |
| 07:13:37 | TR | Serwer | items.json | 36 | `tm_dedup_propagate` | `item.15855.name` | dağınık kristaller |
| 07:11:49 | RU | Serwer | items.json | 2 | `openai:openai/gpt-4.1...` | `item.15051.name` | мшистый пол |
| 07:05:54 | RO | Serwer | items.json | 24 | `openai:openai/gpt-4.1...` | `item.10190.name` | războinic draken mort |
| 07:03:19 | ES | Serwer | items.json | 69 | `tm_dedup_file` | `item.13198.name` | estructura de colmena |
| 06:59:05 | IT | Serwer | items.json | 5 | `openai:openai/gpt-4.1...` | `item.14765.name` | Durin L'Onnipotente |
| 06:56:43 | CS | Serwer | items.json | 8 | `openai:openai/gpt-4.1...` | `item.1261.name` | tic-tac-toe deska |
| 06:51:14 | TR | Serwer | items.json | 62 | `tm_dedup_file` | `item.6397.name` | kemikler |
| 06:49:23 | RU | Serwer | items.json | 3 | `openai:openai/gpt-4.1...` | `item.14861.name` | басальтовая стена |
...
| ⏳ Oldest pending (visible tail) | 17987 s |
| 🌍 Top języki | RU(400) |
| 🧱 Top reason_bucket | quality(400) |
| 🗂️ Deferred state keys | 9633 |
...
| 🧮 OpenAI budget | `119/250 (47.6%); policy=telemetry_only` |
| ♻️ Provider debt | `767` |
| 🌍 Recent provider mix | tm_dedup_file(87), OpenAI model pool(84), canonical_name_semantic_autofix(23), tm_dedup_propagate(14), term... |
...
| ❤️ Pool health | `degraded` (writes=209, fallbacks=22) |
...
| 🗂 Registry terms | `14112` |
| 🔎 Keys with term usages | `152` / `336` scanned |
| ⚠️ Keys with conflicts | `69` |
| 🧮 Conflict rate | `45.395%` (Δ `45.395pp`) |
| 🛠 Auto-fixed EN leaks | `0` |
| 🧭 Name semantic autofix | `0` fixed / `0` blocked |
| 🛡 Name quality cleanup | `0` fail-closed |
| 🧬 Inflection suspects | `86` |
| 🧾 Manual review | `114` |
| 🧷 Top conflicts | item.10216.desc:статуя, item.10216.desc:статуя, item.10216.desc:статуя, item.10216.desc:статуя |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=243/243 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 17987}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| �📊 Przetłumaczono | **290** kluczy |
| ❌ Odrzucone (guard) | 0 |
| 🔁 Cykli | 64 |
| 🌍 Języków | 6 |
| 🏆 Najaktywniejszy | TR (98 kluczy) |
...
| RU | 34,247 | 74,536 | 45.95% ↓-0.08% | 4,775 |
| FR | 42,864 | 74,536 | 57.51% →0% | 26,153 |
| TR | 32,609 | 74,536 | 43.75% | 3,838 |
...
> **ETA globalne:** ~425 dni (2,956,348 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| PL | ████████████████░░░░ | 84.2% | 62,753/74,536 | ~28h |
| ES | ███████████████░░░░░ | 80.0% | 59,618/74,536 | ~39h |
| RO | ███████████████░░░░░ | 78.5% | 58,478/74,536 | ~43h |
| IT | ██████████████░░░░░░ | 72.2% | 53,802/74,536 | ~2d |
| RU | █████████░░░░░░░░░░░ | 46.0% | 34,247/74,536 | ~5d |
| FR | ███████████░░░░░░░░░ | 57.5% | 42,864/74,536 | ~4d |
| TR | ████████░░░░░░░░░░░░ | 43.8% | 32,609/74,536 | ~5d |
| CS | ██████████░░░░░░░░░░ | 52.2% | 38,920/74,536 | ~5d |
| PT | ████████████████░░░░ | 81.2% | 60,516/74,536 | ~35h |
| SR | ██████░░░░░░░░░░░░░░ | 33.3% | 24,827/74,536 | ~7d |
| NL | ███████████████░░░░░ | 77.6% | 57,814/74,536 | ~45h |
...
> Świeżość: 22h temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-05-02 07:35:22
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-05-02T07:34:13.012006Z
...
| RU (Rosyjski) | 45.95% (34,247/74,536) | 44.38% (33,077/74,536) | 4,775 | 36,702 | 0 |
| FR (Francuski) | 57.51% (42,864/74,536) | 41.87% (31,206/74,536) | 26,153 | 17,199 | 0 |
| TR (Turecki) | 43.75% (32,609/74,536) | 40.26% (30,006/74,536) | 3,838 | 40,706 | 0 |
...
- scattered crystals → dağınık kristaller (item.15855.name)
- scattered crystals → dağınık kristaller (item.15856.name)
- scattered crystals → dağınık kristaller (item.15857.name)
- scattered crystals → dağınık kristaller (item.15858.name)
- scattered crystals → dağınık kristaller (item.15859.name)
- scattered crystals → dağınık kristaller (item.15860.name)
- scattered crystals → dağınık kristaller (item.15861.name)
- scattered crystals → dağınık kristaller (item.15862.name)
- broken idol → kırık idol (item.15896.name)
- strange pedestal → garip kaide (item.15899.name)
- strange pedestal → garip kaide (item.15900.name)
- strange pedestal → garip kaide (item.15901.name)
- strange pedestal → garip kaide (item.15902.name)
- strange pedestal → garip kaide (item.15903.name)
- strange pedestal → garip kaide (item.15904.name)
- strange pedestal → garip kaide (item.15905.name)
- broken idol → kırık idol (item.28738.name)
- broken idol → kırık idol (item.28739.name)
- broken idol → kırık idol (item.28740.name)
- broken idol → kırık idol (item.28741.name)



### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **5209**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **5061**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-05-02T07:34:32.244473Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.72%** (725,720/3,875,872)
- **Pokrycie globalne (real):** **11.7%** (453,338/3,875,872)
- **Kopie EN (łącznie):** **407,175**
- **Placeholdery [EN]/puste (łącznie):** **2,161,237**
...
| RU | 31,103/70,637 | 44.0% / 42.5% | 3,144/3,899 | 80.6% / 79.3% |
| FR | 39,937/70,637 | 56.5% / 40.1% | 2,927/3,899 | 75.1% / 73.7% |
| TR | 30,650/70,637 | 43.4% / 39.8% | 1,959/3,899 | 50.2% / 48.7% |
...
| #3 | 🔴 Server | 11.82% | +0.34 pp | 51 | ZH 0.2%, TL 0.8%, BS 0.9% |
...
| 🕒 Evidence window | 24h (span=35.03h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=35.03h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=+0.00pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-05-02T06:35:22.364593Z → 2026-05-02T07:35:22.364593Z) |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 92 | 95.8% | ru/items.json (92) |
| `existing_canonical_name_quality_mixed_scripts` | 4 | 4.2% | ru/items.json (4) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-05-02T07:34:14.264553Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-05-02T07:34:14.264553Z
- **Top 5 typów problemów:** suspicious_rejected_critical=130, suspicious_log_high=112, suspicious_log_low=85, suspicious_rejected_high=70, suspicious_log_medium=2
- **Języki o najsłabszej jakości:** es(60.1, issues=764264), ro(60.1, issues=460485), ru(60.1, issues=390274), cs(60.1, issues=142754), de(60.1, issues=141324)
...
⚠️ **TR**: jakość 60%, 64522 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 764264 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 85%, 182564 problemów
⚠️ **RU**: jakość 60%, 390274 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #19,415 |
| Heartbeat | 220s temu | 2026-05-02T07:31:50Z |
...
- **Ostatnia aktualizacja:** 2026-05-02T07:29:57.957999Z
...
- 2026-05-02 07:34:33 | AUTO_TRANSLATE:heartbeat_tick | tr | ok | items.json
- 2026-05-02 07:34:32 | AUTO_TRANSLATE:auto_start | tr | ok | items.json
- 2026-05-02 07:34:13 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
- 2026-05-02 07:33:21 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-05-02 07:31:50 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-05-02 07:31:50 | AUTO_TRANSLATE:auto_start | ru | ok | items.json
...
| 🟡 ES | 80.0% | 0 | 9,501 | 1,148 | 0 (0.0%) | 30 |
...
| Przepustowość (okno) | 1,148 kluczy / 30 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-05-02 07:35:22
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **13,835** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 81 |
| ❌ Błędów | 103 |
| 🌍 Aktywnych języków | 6 |
| 🏆 TOP 5 | **RO** (7,495), **TR** (5,659), **ES** (299), **RU** (151), **IT** (140) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **46,815** kluczy
...
| 🔄 Cykli wykonanych | **#19,415** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #19,415 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-05-02 07:35:22  
