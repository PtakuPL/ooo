...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "Your fragile bones are like toothpicks to me.", yell = false , i18nKey = "monster.hellspawn.voice_6"},
	{ text = "You little weasel will not live to see another day.", yell = false , i18nKey = "monster.hellspawn.voice_7"},
	{ text = "I'm just a messenger of what's yet to come.", yell = false , i18nKey = "monster.hellspawn.voice_8"},
	{ text = "HRAAAAAAAAAAAAAAAARRRR!", yell = true , i18nKey = "monster.hellspawn.voice_9"},
	{ text = "I'm taking you down with me!", yell = false , i18nKey = "monster.hellspawn.voice_10"},
}
