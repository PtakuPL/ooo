...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-19 08:47:24

> **Aktualizacja:** 2026-02-19 08:47:24 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #1 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ro | Plik: otclient_data.json | Heartbeat: 2026-02-19T08:47:23Z  
...
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-19 08:47:24 |
| LIVE | 🟢 AKTYWNY | 4s temu | - | `activity.json / worker_state.json` | 2026-02-19T08:47:23Z |
| MIGRATION | 🔒 NIEAKTYWNY | 1d temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-19 08:47:24 |
| TRANSLATION | 🟢 AKTYWNY | 6s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-19T08:47:20.972610Z |
| QUALITY | 🔒 NIEAKTYWNY | 30s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-19T08:46:57.564755Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-19 08:47:24 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 4s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-19T08:47:23Z
...
| ❤️ **Heartbeat** | 2026-02-19T08:47:23Z |
...
> Świeżość: 1d temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-19 08:47:24
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-19T08:47:20.972610Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-19T07:47:25.140976Z → 2026-02-19T08:47:25.140976Z) |
...
| Najgorsze cele (strażnik) | it/example_merchant.json (gf=0), sv/questlog.json (gf=0), sr/otclient_modules.json (gf=0), sv/html.json (gf=0), sr/html.json (gf=0) |
...
> Świeżość: 30s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-19T08:46:57.564755Z

- **Ostatni audyt:** SLOW_MODE | 31 issue(s) / 100 entries | 2026-02-19T08:46:57.564755Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=254775), pl(60.1, issues=142732), ro(60.1, issues=73650), ru(60.1, issues=55634), it(60.1, issues=26421)
...
⚠️ **PL**: jakość 60%, 142732 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 254775 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 26421 problemów
⚠️ **RU**: jakość 60%, 55634 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 60%, 20207 problemów
...
| Heartbeat | 4s temu | 2026-02-19T08:47:23Z |
...
- 2026-02-19 08:47:23 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | otclient_data.json
- 2026-02-19 08:47:23 | AUTO_TRANSLATE:parallel_start | ro | ok | otclient_data.json
- 2026-02-19 08:47:21 | AUTO_TRANSLATE:auto_done | ru | ok | talkactions.json
- 2026-02-19 08:47:17 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | talkactions.json
- 2026-02-19 08:47:17 | AUTO_TRANSLATE:auto_start | ru | ok | talkactions.json
- 2026-02-19 08:46:53 | AUTO_TRANSLATE:heartbeat_tick | it | ok | talkactions.json
...
| Przepustowość (okno) | 0 kluczy / 72 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-19 08:47:24
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → ok (files+0, translated+0, skipped+0) — lang=es file=php.json
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-19 08:47:24  
