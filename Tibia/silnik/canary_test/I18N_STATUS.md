...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-24 17:25:56

> **Aktualizacja:** 2026-04-24 17:25:56 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #16,328 | Status: ✅ BEZCZYNNY | Faza: IDLE | Etap: doctor_pause | Kategoria: - | Plik: - | Heartbeat: 2026-04-24T17:23:25Z  
...
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-24 17:25:56 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-24T17:23:25Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 15s temu | worker w trybie IDLE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-24 17:25:56 |
| TRANSLATION | 🔒 NIEAKTYWNY | 22h temu | worker w trybie IDLE | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-23T19:18:02.317840Z |
| QUALITY | 🔒 NIEAKTYWNY | 22h temu | worker w trybie IDLE | `quality_audit_latest.json` | 2026-04-23T19:18:32.407318Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-24 17:25:56 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 2 alarmów | `doctor_alerts_latest.json` | 2026-04-24T17:26:04.216733Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-24T17:23:25Z
...
| ❤️ **Heartbeat** | 2026-04-24T17:23:25Z |
...
| ⏳ Oldest pending (visible tail) | 80123 s |
...
|-------|--------|----------|-------|-----------|--------|
| `HEARTBEAT_STALE` | OK | OK | `143` | `300` | Heartbeat świeży (143s, src=worker_runtime_heartbeat) Runtime[status=critical, reason=guardian_daemon_owner... |
| `NO_WRITE` | ALERT | WARNING | `79656` | `900` | Brak świeżych zapisów przy pending=400. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 80123}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 15s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-24 17:25:56
...
> Świeżość: 22h temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-23T19:18:02.317840Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-24T16:25:56.549373Z → 2026-04-24T17:25:56.549373Z) |
...
> Świeżość: 22h temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-23T19:18:32.407318Z
...
| Metryka | Wartość | Info |
|---------|---------|------|
| 🔄 Cykl aktualny | **#2750** | od uruchomienia |
...
| Heartbeat | 159s temu | 2026-04-24T17:23:25Z |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-24 17:25:56
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-24 17:25:56  
