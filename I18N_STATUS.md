...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.68%**. Tempo: **1986.3 kluczy/h**. Tłumaczeń netto: **100,741**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-17 06:18:02

> **Aktualizacja:** 2026-02-17 06:18:02 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #312 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: - | Heartbeat: 2026-02-17T06:17:58Z  
> **Okno godzinowe:** okno=1.0h | cykli=157 | pominięte=0.0% | odrzucone=35.1% | przepustowość=1986.3/h  
> **Tłumaczeń netto:** 100,741

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-17 06:18:02 |
| LIVE | 🟢 AKTYWNY | 6s temu | - | `activity.json / worker_state.json` | 2026-02-17T06:17:58Z |
| MIGRATION | 🔒 NIEAKTYWNY | 55s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-17 06:18:02 |
| TRANSLATION | 🟢 AKTYWNY | 22s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-17T06:17:42.114556Z |
| QUALITY | 🔒 NIEAKTYWNY | 5s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-17T06:17:58.456281Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-17 06:18:02 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-17T06:17:58Z
...
| ❤️ **Heartbeat** | 2026-02-17T06:17:58Z |
...
| ❌ Odrzucone (guard) | 1914 |
| 🔁 Cykli | 157 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RO (783 kluczy) |
...
> Świeżość: 55s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-17 06:18:02
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 22s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-17T06:17:42.114556Z
...
- **Pokrycie globalne:** **10.68%** (297,594/2,786,472)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-17T05:18:02.471086Z → 2026-02-17T06:18:02.471086Z) |
...
| Przepustowość (kluczy/h) | **1986.3 kluczy/h** |
| Podejrzane tłumaczenia | **10081** |
| Najgorsze cele (strażnik) | pl/npc.json (gf=461), pl/scripts.json (gf=152), sv/server.json (gf=71), sr/server.json (gf=66), ro/questlog.json (gf=66) |
...
> Świeżość: 5s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-17T06:17:58.456281Z

- **Ostatni audyt:** SLOW_MODE | 11 issue(s) / 100 entries | 2026-02-17T06:17:58.456281Z
- **Top 5 typów problemów:** suspicious_rejected_critical=174, suspicious_log_high=143, suspicious_log_critical=47, suspicious_rejected_high=26, identical_to_en_exempt=10
- **Języki o najsłabszej jakości:** es(60.1, issues=210985), pl(60.1, issues=129099), ro(60.2, issues=48040), it(60.2, issues=14457), ru(60.7, issues=36572)
...
⚠️ **PL**: jakość 60%, 129099 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 210985 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 14457 problemów
⚠️ **RU**: jakość 61%, 36572 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 73%, 11776 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #312 |
| Heartbeat | 6s temu | 2026-02-17T06:17:58Z |
...
- 2026-02-17 06:17:49 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-17 06:17:03 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | npclib.json
- 2026-02-17 06:17:03 | AUTO_TRANSLATE:parallel_start | ro | ok | npclib.json
- 2026-02-17 06:16:25 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | php.json
- 2026-02-17 06:16:24 | AUTO_TRANSLATE:parallel_start | ru | ok | php.json
- 2026-02-17 06:16:22 | AUTO_TRANSLATE:auto_done | it | ok | client.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 47.9% | 0 | 1,891 | 927 | 3237 (77.7%) | 32 |
| 🟡 ES | 75.0% | 0 | 2,630 | 672 | 519 (43.6%) | 29 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **100,741** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=34.64%, reason=decrease_high_fail_rate=34.6% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,599 kluczy / 61 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-17 06:18:02
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **25,780** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 251 |
| ❌ Błędów | 435 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (5,190), **IT** (4,692), **RU** (4,627), **RO** (4,266), **PL** (3,470) |
| 📊 Porównanie | ↑ 27.1% vs wczoraj (20,288) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **125,974** kluczy
...
| 🔄 Cykli wykonanych | **#312** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-17 06:18:02  
