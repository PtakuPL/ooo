...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.95% / real 10.86%**. Tempo: **969.0 kluczy/h**. Tłumaczeń netto: **141,028**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 03:31:01

> **Aktualizacja:** 2026-04-29 03:31:01 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,627 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ru | Plik: items.json | Heartbeat: 2026-04-29T03:30:38Z
> **Okno godzinowe:** okno=1.0h | cykli=80 | pominięte=0.0% | odrzucone=2.8% | przepustowość=969.0/h  
> **Tłumaczeń netto:** 141,028

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 03:31:01 |
| LIVE | 🟢 AKTYWNY | 29s temu | - | `activity.json / worker_state.json` | 2026-04-29T03:30:38Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 20s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 03:31:01 |
| TRANSLATION | 🟢 AKTYWNY | 30s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T03:30:37.156476Z |
| QUALITY | 🔒 NIEAKTYWNY | 29s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T03:30:38.089460Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 03:31:01 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T03:31:07.695211Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 29s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T03:30:38Z
...
| 🔄 **Ostatni cykl** | 59 kluczy, 0 odrzuconych, 44.0s, tryb: AUTO_TRANSLATE, cel: tr/items.json |
| ❤️ **Heartbeat** | 2026-04-29T03:30:38Z |
...
| ⏳ Oldest pending (visible tail) | 18320 s |
| 🌍 Top języki | RU(398) |
...
| 🌍 Recent provider mix | TM/simple(250), Free Google Translate(227), canonical_name_semantic_autofix(16), canonical_name_case_autofi... |
...
| ❤️ Pool health | `critical` (writes=508, fallbacks=13) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=597/597 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 18320}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~128 dni (2,986,475 kluczy do celu 95%)
...
> Świeżość: 20s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 03:31:01
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 30s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T03:30:37.156476Z
...
- sandy tile → kumlu kiremit (item.11931.name)
- sandy tile → kumlu kiremit (item.11932.name)
- sandy tile → kumlu kiremit (item.11933.name)
- sandy tile → kumlu kiremit (item.11934.name)
- sandy tile → kumlu kiremit (item.11935.name)
- sandy tile → kumlu kiremit (item.11936.name)
- sandy tile → kumlu kiremit (item.11937.name)
- sandy tile → kumlu kiremit (item.11938.name)
- sandy tile → kumlu kiremit (item.11939.name)
- sandy tile → kumlu kiremit (item.11940.name)
- sandy tile → kumlu kiremit (item.11941.name)
- sandy tile → kumlu kiremit (item.11943.name)
- sandy tile → kumlu kiremit (item.11944.name)
- sandy tile → kumlu kiremit (item.11945.name)
- sandy tile → kumlu kiremit (item.11946.name)
- ornate tombstone → süslü mezar taşı (item.11963.name)
- ornate tombstone → süslü mezar taşı (item.11964.name)
- ornate tombstone → süslü mezar taşı (item.11969.name)
- dried grass roof → kurutulmuş çim çatı (item.1197.name)
- ornate tombstone → süslü mezar taşı (item.11970.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4754**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4607**
...
- **Pokrycie globalne (nominal):** **17.95%** (695,593/3,875,872)
- **Pokrycie globalne (real):** **10.86%** (421,109/3,875,872)
- **Kopie EN (łącznie):** **410,571**
- **Placeholdery [EN]/puste (łącznie):** **2,190,070**
...
| 🕒 Evidence window | 24h (span=32.65h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=32.65h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T02:31:02.208781Z → 2026-04-29T03:31:02.208781Z) |
...
> Świeżość: 29s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T03:30:38.089460Z
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,627 |
| Heartbeat | 29s temu | 2026-04-29T03:30:38Z |
...
- 2026-04-29 03:29:53 | AUTO_TRANSLATE:auto_start | tr | ok | items.json
- 2026-04-29 03:29:10 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 03:31:01
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **3,055** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 65 |
| ❌ Błędów | 120 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **RU** (634), **CS** (569), **IT** (448), **DE** (405), **TR** (374) |
| 📊 Porównanie | ↓ 62.9% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **22,035** kluczy
...
| 🔄 Cykli wykonanych | **#17,627** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,627 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 03:31:01  
