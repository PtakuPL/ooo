...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "Grow truk grrrrr.", yell = false , i18nKey = "monster.orc.voice_1"},
	{ text = "Prek tars, dekklep zurk.", yell = false , i18nKey = "monster.orc.voice_2"},
	{ text = "Grak brrretz!", yell = false , i18nKey = "monster.orc.voice_3"},
}
