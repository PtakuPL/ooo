...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.42% / real 11.38%**. Tempo: **192.3 kluczy/h**. Tłumaczeń netto: **156,768**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-05-02 01:41:25

> **Aktualizacja:** 2026-05-02 01:41:25 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #19,066 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: tr | Plik: items.json | Heartbeat: 2026-05-02T01:38:51Z
> **Okno godzinowe:** okno=1.0h | cykli=50 | pominięte=0.0% | odrzucone=4.1% | przepustowość=192.3/h  
> **Tłumaczeń netto:** 156,768

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-05-02 01:41:25 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-05-02T01:38:51Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 16h temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-05-02 01:41:25 |
| TRANSLATION | 🟢 AKTYWNY | 3min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-05-02T01:38:30.116102Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-05-02T01:40:30.694764Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-05-02 01:41:25 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-05-02T01:41:32.195385Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-05-02T01:38:51Z
...
| ⏳ Oldest pending (visible tail) | 191900 s |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 390, 'oldest_s': 191900}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~643 dni (2,968,135 kluczy do celu 95%)
...
> Świeżość: 16h temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-05-02 01:41:25
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-05-02T01:38:30.116102Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-05-02T01:41:01.906779Z |
...
| 🕒 Evidence window | 24h (span=29.13h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=29.13h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=+0.00pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-05-02T00:41:25.856804Z → 2026-05-02T01:41:25.856804Z) |
...
| Przepustowość (kluczy/h) | **192.3 kluczy/h** |
| Podejrzane tłumaczenia | **2148** |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-05-02T01:40:30.694764Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-05-02T01:40:30.694764Z
- **Top 5 typów problemów:** suspicious_log_medium=158, suspicious_rejected_critical=133, suspicious_rejected_high=67, suspicious_log_critical=26, suspicious_log_high=10
- **Języki o najsłabszej jakości:** es(60.1, issues=758661), ro(60.1, issues=453125), ru(60.1, issues=382285), de(60.1, issues=137386), cs(60.1, issues=134417)
...
⚠️ **ES**: jakość 60%, 758661 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 86%, 181873 problemów
⚠️ **RU**: jakość 60%, 382285 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #19,066 |
| Heartbeat | 161s temu | 2026-05-02T01:38:51Z |
...
- 2026-05-02 01:40:22 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-05-02 01:41:25
...
| 🔄 Cykli wykonanych | **#19,066** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #19,066 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-05-02 01:41:25  
