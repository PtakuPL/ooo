...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.02% / real 10.94%**. Tempo: **691.0 kluczy/h**. Tłumaczeń netto: **146,474**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 10:38:48

> **Aktualizacja:** 2026-04-29 10:38:48 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,236 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-04-29T10:36:33Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=5.9% | przepustowość=691.0/h  
> **Tłumaczeń netto:** 146,474

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 10:38:48 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T10:36:33Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 53s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 10:38:48 |
| TRANSLATION | 🟢 AKTYWNY | 40s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T10:38:16.030366Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T10:36:32.431676Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 10:38:48 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T10:38:56.668499Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T10:36:33Z
...
| 🔄 **Ostatni cykl** | 41 kluczy, 8 odrzuconych, 86.0s, tryb: AUTO_TRANSLATE, cel: cs/items.json |
| ❤️ **Heartbeat** | 2026-04-29T10:36:33Z |
...
| ⏳ Oldest pending (visible tail) | 15045 s |
...
| ♻️ Deferred stats | enqueued=1, cooldown=7, deduped=7, manual_review=0, partial_staged=0, partial_completed=0 |
...
| 🌍 Recent provider mix | TM/simple(344), Free Google Translate(143), canonical_name_semantic_autofix(15), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=505, fallbacks=26) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=929/929 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 385, 'oldest_s': 15045}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~180 dni (2,983,558 kluczy do celu 95%)
...
> Świeżość: 53s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 10:38:48
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 40s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T10:38:16.030366Z
...
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14534.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14535.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14536.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14537.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14538.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14539.name)
- stone wall → kamenná zeď (item.1454.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14540.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14541.name)
...
- Raporty strażnika jakości: **4907**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4760**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T10:36:50.226464Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.02%** (698,510/3,875,872)
- **Pokrycie globalne (real):** **10.94%** (424,177/3,875,872)
- **Kopie EN (łącznie):** **410,420**
- **Placeholdery [EN]/puste (łącznie):** **2,187,153**
...
| 🕒 Evidence window | 24h (span=39.78h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=39.78h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T09:38:49.101238Z → 2026-04-29T10:38:49.101238Z) |
...
| Przepustowość (kluczy/h) | **691.0 kluczy/h** |
| Podejrzane tłumaczenia | **1168** |
| Najgorsze cele (strażnik) | cs/items.json (gf=24), ro/items.json (gf=8), de/otclient_modules.json (gf=3), de/npc.json (gf=3), ru/items.json (gf=3) |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 76 | 78.4% | ru/items.json (76) |
| `existing_canonical_name_quality_mixed_scripts` | 20 | 20.6% | ru/items.json (20) |
| `retry_loop_cooldown_default` | 1 | 1.0% | cs/items.json (1) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T10:36:32.431676Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T10:36:32.431676Z
- **Top 5 typów problemów:** suspicious_rejected_critical=189, suspicious_log_high=77, suspicious_log_low=67, suspicious_log_medium=56, suspicious_rejected_high=11
- **Języki o najsłabszej jakości:** es(60.1, issues=744363), ro(60.1, issues=440084), de(60.1, issues=122924), cs(60.1, issues=109191), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 61%, 56756 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 744363 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 75%, 176924 problemów
⚠️ **RU**: jakość 71%, 370274 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,236 |
| Heartbeat | 143s temu | 2026-04-29T10:36:33Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T10:38:31.574915Z
...
- 2026-04-29 10:38:32 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 10:38:16 | AUTO_TRANSLATE:auto_done | cs | ok | items.json
- 2026-04-29 10:36:52 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | items.json
- 2026-04-29 10:36:50 | AUTO_TRANSLATE:auto_start | cs | ok | items.json
- 2026-04-29 10:36:31 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
- 2026-04-29 10:35:17 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **146,474** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=4.72%, reason=increase_low_fail_rate=4.7%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 10:38:48

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [cs] → warn (files+1, translated+41, skipped+0) — lang=cs file=items.json strict_skipped_done=4215 guard_fail=8 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+4) — repair_identical lang=es file=npc.json target_identical=2 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=195.39
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+34, skipped+0) — lang=it file=items.json strict_skipped_done=1940 guard_fail=1 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [de] → warn (files+1, translated+50, skipped+0) — lang=de file=server.json strict_skipped_done=97 guard_fail=17 placeholder=10 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **9,009** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 185 |
| ❌ Błędów | 388 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,629), **RU** (1,568), **IT** (1,340), **TR** (1,276), **DE** (1,260) |
| 📊 Porównanie | ↑ 9.5% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **27,989** kluczy
...
| 🔄 Cykli wykonanych | **#18,236** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,236 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 10:38:48  
