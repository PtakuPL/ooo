...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.78% / real 10.67%**. Tempo: **1987.0 kluczy/h**. Tłumaczeń netto: **130,372**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-27 18:10:13

> **Aktualizacja:** 2026-04-27 18:10:13 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #16,494 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: tr | Plik: monsters.json | Heartbeat: 2026-04-27T18:07:48Z
> **Okno godzinowe:** okno=1.0h | cykli=58 | pominięte=0.0% | odrzucone=1.6% | przepustowość=1987.0/h  
> **Tłumaczeń netto:** 130,372

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-27 18:10:13 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-27T18:07:48Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 41s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-27 18:10:13 |
| TRANSLATION | 🟢 AKTYWNY | 57s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-27T18:09:22.978934Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-27T18:07:34.135210Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-27 18:10:13 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-27T18:10:20.471111Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-27T18:07:48Z
...
| 🔄 **Ostatni cykl** | 0 kluczy, 0 odrzuconych, 35.0s, tryb: AUTO_TRANSLATE, cel: nl/items.json |
| ❤️ **Heartbeat** | 2026-04-27T18:07:48Z |
...
|----------|------|---------|-----------|-------|----------|--------------|-----|
| 18:10:14 | TR | Serwer | monsters.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `monster.wrath_of_the_emperor.desc` |
| 18:10:14 | TR | Serwer | monsters.json | `hard_block` | `high_reject_types` | `trimmed_en_copy` | `monster.colerian_the_barbarian.desc` |
| 18:10:14 | TR | Serwer | monsters.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `monster.wrath_of_the_emperor.name` |
| 18:10:12 | TR | Serwer | monsters.json | `hard_block` | `high_reject_types` | `trimmed_en_copy` | `monster.colerian_the_barbarian.name` |
| 18:09:52 | TR | Serwer | monsters.json | `hard_block` | `critical_issue` | `garble_en_chunk, partial_translation_mix` | `monster.goblin.voice_7` |
| 18:09:50 | TR | Serwer | monsters.json | `hard_block` | `critical_issue` | `garble_en_chunk, partial_translation_mix` | `monster.demon.voice_8` |
| 18:09:50 | TR | Serwer | monsters.json | `hard_block` | `critical_issue` | `garble_en_chunk, partial_translation_mix` | `monster.demon.voice_2` |
...
| ⏳ Oldest pending (visible tail) | 341542 s |
| 🌍 Top języki | NL(151), PT(145), ES(80), TR(16) |
| 🧱 Top reason_bucket | placeholder(164), default(98), provider_error(40), partial_translation_mix(31) |
...
| 🌍 Recent provider mix | Free Google Translate(241), TM/simple(127), OpenAI model pool(73), term_consistency_autofix(34) |
| 🔁 Latest fallback | TM/simple → fallback to google translate high [high_reject_types] monsters.json |
| 📉 Fallback breakdown | fallback to google translate high(27), fallback chain exhausted validate fail identical to en(19), fallback... |
...
| ❤️ Pool health | `critical` (writes=475, fallbacks=53) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=166/166 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 341542}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~63 dni (2,992,851 kluczy do celu 95%)
...
| RO | █████████████░░░░░░░ | 69.1% | 51,498/74,536 | ~10h |
| RU | ████████░░░░░░░░░░░░ | 44.5% | 33,138/74,536 | ~19h |
| FR | ███████████░░░░░░░░░ | 57.5% | 42,864/74,536 | ~14h |
| PT | ████████████████░░░░ | 80.5% | 60,027/74,536 | ~5h |
| SR | ██████░░░░░░░░░░░░░░ | 33.3% | 24,827/74,536 | ~23h |
| NL | ███████████████░░░░░ | 76.8% | 57,212/74,536 | ~7h |
| CS | █████████░░░░░░░░░░░ | 48.3% | 36,019/74,536 | ~18h |
| TR | ██████░░░░░░░░░░░░░░ | 32.0% | 23,847/74,536 | ~24h |
...
> Świeżość: 41s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-27 18:10:13
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 57s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-27T18:09:22.978934Z
...
- Raporty strażnika jakości: **4459**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4313**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-27T18:09:26.706104Z |
...
| 🕒 Evidence window | 24h (span=71.02h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=71.02h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-0.10pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-27T17:10:13.417845Z → 2026-04-27T18:10:13.417845Z) |
...
| Podejrzane tłumaczenia | **1234** |
| Najgorsze cele (strażnik) | nl/npc.json (gf=15), pt/books.json (gf=7), ru/monsters.json (gf=6), pt/npc.json (gf=3), de/monsters.json (gf=2) |
...
|--------|-----------|--------|----------------|
| `gt_partial_translation_mix` | 17 | 35.4% | pt/books.json (14) |
| `gt_validate_fail_identical_to_en` | 17 | 35.4% | nl/npc.json (12) |
| `gt_partial_validate_word_salad` | 5 | 10.4% | pt/books.json (4) |
| `gt_partial_validate_quality` | 5 | 10.4% | tr/monsters.json (5) |
| `gt_rejected_critical` | 3 | 6.2% | pt/books.json (3) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-27T18:07:34.135210Z
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #16,494 |
| Heartbeat | 152s temu | 2026-04-27T18:07:48Z |
...
- 2026-04-27 18:09:27 | AUTO_TRANSLATE:heartbeat_tick | tr | ok | monsters.json
- 2026-04-27 18:09:27 | AUTO_TRANSLATE:auto_start | tr | ok | monsters.json
- 2026-04-27 18:09:23 | AUTO_TRANSLATE:auto_done | nl | ok | items.json
- 2026-04-27 18:08:49 | AUTO_TRANSLATE:heartbeat_tick | nl | ok | items.json
- 2026-04-27 18:08:48 | AUTO_TRANSLATE:auto_start | nl | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **130,372** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=5.38%, reason=stable_fail_rate=5.4%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-27 18:10:13
...
| 🔄 Cykli wykonanych | **#16,494** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #16,494 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-27 18:10:13  
