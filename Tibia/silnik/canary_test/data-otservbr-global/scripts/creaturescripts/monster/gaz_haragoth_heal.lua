...
function gazHaragothHeal.onThink(creature)
	...
	if hp < 12.5 and not creature:getCondition(CONDITION_REGENERATION, CONDITIONID_DEFAULT, 88888) then
		...
		creature:sayLocalized("scripts.gaz_haragoth_heal.say_2", TALKTYPE_MONSTER_YELL)
		addEvent(function(cid)
			...
			creature:sayLocalized("scripts.gaz_haragoth_heal.say_1", TALKTYPE_MONSTER_YELL)
			return true
