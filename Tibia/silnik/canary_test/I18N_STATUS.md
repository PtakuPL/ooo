...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.84%**. Tempo: **1672.7 kluczy/h**. Tłumaczeń netto: **115,319**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 17:28:16

> **Aktualizacja:** 2026-02-20 17:28:16 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #5 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-02-20T17:28:02Z  
> **Okno godzinowe:** okno=1.0h | cykli=147 | pominięte=0.0% | odrzucone=65.5% | przepustowość=1672.7/h  
> **Tłumaczeń netto:** 115,319

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 17:28:16 |
| LIVE | 🟢 AKTYWNY | 15s temu | - | `activity.json / worker_state.json` | 2026-02-20T17:28:02Z |
| MIGRATION | 🔒 NIEAKTYWNY | 33s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 17:28:16 |
| TRANSLATION | 🟢 AKTYWNY | 23s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T17:27:53.795418Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T17:28:17.123093Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 17:28:16 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 15s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T17:28:02Z
...
| ❤️ **Heartbeat** | 2026-02-20T17:28:02Z |
...
> Świeżość: 33s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 17:28:16
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 23s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T17:27:53.795418Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T16:28:16.383182Z → 2026-02-20T17:28:16.383182Z) |
...
| Przepustowość (kluczy/h) | **1672.7 kluczy/h** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T17:28:17.123093Z

- **Ostatni audyt:** SLOW_MODE | 24 issue(s) / 100 entries | 2026-02-20T17:27:11.970395Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=142, suspicious_log_high=65, suspicious_log_critical=41, suspicious_rejected_high=25, artifact_token=16
- **Języki o najsłabszej jakości:** es(60.1, issues=320343), ro(60.2, issues=174994), sr(60.7, issues=86013), pl(61.6, issues=180848), it(62.3, issues=70356)
...
⚠️ **PL**: jakość 62%, 180848 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 320343 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 62%, 70356 problemów
⚠️ **RU**: jakość 68%, 210052 problemów
...
| Heartbeat | 15s temu | 2026-02-20T17:28:02Z |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 17:28:16
...
| ❌ Błędów | 82 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (974), **RU** (730), **IT** (700), **RO** (460), **PL** (417) |
| 📊 Porównanie | ↑ 5.3% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **101,420** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 17:28:16  
