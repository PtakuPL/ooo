...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "Rott!!", yell = false , i18nKey = "monster.ichgahal.voice_1"},
	{ text = "Putrefy!", yell = false , i18nKey = "monster.ichgahal.voice_2"},
	{ text = "Decay!", yell = false , i18nKey = "monster.ichgahal.voice_3"},
}
