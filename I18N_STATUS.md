...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **18.91%**. Tempo: **684.9 kluczy/h**. Tłumaczeń netto: **57,882**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-23 13:30:19

> **Aktualizacja:** 2026-03-23 13:30:19 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **LIVE:** Cykl #10,686 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ro | Plik: questlog.json | Heartbeat: 2026-03-23T13:29:08Z  
> **Okno godzinowe:** okno=1.0h | cykli=393 | pominięte=0.0% | odrzucone=8.0% | przepustowość=684.9/h  
> **Tłumaczeń netto:** 57,882

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-23 13:30:19 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-03-23T13:29:08Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-23 13:30:19 |
| TRANSLATION | 🟢 AKTYWNY | 15min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-23T13:15:20.235504Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-23T13:27:44.451317Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-23 13:30:19 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-23T13:29:08Z
...
| ❤️ **Heartbeat** | 2026-03-23T13:29:08Z |
...
> **ETA globalne:** ~179 dni (2,949,305 kluczy do celu 95%)
...
| RU | ██████████████░░░░░░ | 73.4% | 54,698/74,536 | ~24h |
| IT | ██████████████░░░░░░ | 73.0% | 54,445/74,536 | ~24h |
| FR | ██████████████░░░░░░ | 71.7% | 53,408/74,536 | ~25h |
| PT | ██████████████░░░░░░ | 70.2% | 52,293/74,536 | ~27h |
| CS | █████████████░░░░░░░ | 68.4% | 50,993/74,536 | ~29h |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-23 13:30:19
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 15min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-23T13:15:20.235504Z
...
- Raporty strażnika jakości: **3046**  
- Raporty blokad: **0**  
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-23T12:30:19.918364Z → 2026-03-23T13:30:19.918364Z) |
...
| Przepustowość (kluczy/h) | **684.9 kluczy/h** |
| Podejrzane tłumaczenia | **1781** |
| Najgorsze cele (strażnik) | pl/books.json (gf=12), es/questlog.json (gf=10), es/books.json (gf=7), tr/quests.json (gf=6), cs/scripts.json (gf=5) |
...
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-23T13:27:44.451317Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-03-23T13:27:44.451317Z
- **Top 5 typów problemów:** suspicious_log_medium=134, suspicious_rejected_critical=126, suspicious_rejected_high=74, suspicious_log_high=48, suspicious_log_low=15
- **Języki o najsłabszej jakości:** es(60.1, issues=626916), ro(60.1, issues=341072), ru(60.1, issues=297293), it(60.4, issues=114587), fr(60.6, issues=19744)
...
⚠️ **ES**: jakość 60%, 626916 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #10,686 |
| Heartbeat | 73s temu | 2026-03-23T13:29:08Z |
...
- **Ostatnia aktualizacja:** 2026-03-23T13:29:08.721609Z
...
- 2026-03-23 13:29:08 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | questlog.json
- 2026-03-23 13:28:51 | AUTO_TRANSLATE:auto_start | ro | ok | questlog.json
- 2026-03-23 13:15:38 | AUTO_TRANSLATE:heartbeat_tick | es | ok | quests.json
- 2026-03-23 13:15:20 | AUTO_TRANSLATE:auto_done | ru | ok | raids.json
- 2026-03-23 13:15:12 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | raids.json
- 2026-03-23 13:15:12 | AUTO_TRANSLATE:auto_start | ru | ok | raids.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **57,882** | — | 📊 |
| Adaptacyjna paczka | batch=12, gf_rate=3.82%, reason=increase_low_fail_rate=3.8% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-23 13:30:19
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **33,453** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 174 |
| ❌ Błędów | 555 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **ES** (10,778), **TR** (6,049), **RO** (3,089), **PL** (2,761), **RU** (1,889) |
| 📊 Porównanie | ↑ 61.4% vs wczoraj (20,729) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **54,182** kluczy
...
| 🔄 Cykli wykonanych | **#10,686** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #10,686 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-23 13:30:19  
