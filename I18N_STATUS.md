...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.38%**. Tempo: **2240.2 kluczy/h**. Tłumaczeń netto: **88,821**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-17 01:44:41

> **Aktualizacja:** 2026-02-17 01:44:41 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #133 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ru | Plik: quests.json | Heartbeat: 2026-02-17T01:44:36Z  
> **Okno godzinowe:** okno=1.0h | cykli=170 | pominięte=0.0% | odrzucone=46.7% | przepustowość=2240.2/h  
> **Tłumaczeń netto:** 88,821

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-17 01:44:41 |
| LIVE | 🟢 AKTYWNY | 7s temu | - | `activity.json / worker_state.json` | 2026-02-17T01:44:36Z |
| MIGRATION | 🔒 NIEAKTYWNY | 48s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-17 01:44:41 |
| TRANSLATION | 🟢 AKTYWNY | 9s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-17T01:44:33.602136Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-17T01:43:20.130133Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-17 01:44:41 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 7s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-17T01:44:36Z
...
| ❤️ **Heartbeat** | 2026-02-17T01:44:36Z |
...
| ❌ Odrzucone (guard) | 3531 |
| 🔁 Cykli | 170 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | IT (845 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~2240 kluczy/h |
| 🛡️ Guard fail rate | 46.7% |
| ⚠️ Podejrzane | 14808 |
...
|-------|---------------|-----------|----------|----------|
| ES | 39,895 | 53,586 | 74.45% | 2,631 |
| PL | 24,305 | 53,586 | 45.36% | 1,919 |
| RU | 19,747 | 53,586 | 36.85% | 2,599 |
| FR | 17,712 | 53,586 | 33.05% | 4,027 |
| RO | 11,698 | 53,586 | 21.83% | 2,439 |
| ZH_TW | 7,776 | 53,586 | 14.51% | 9,749 |
| IT | 6,997 | 53,586 | 13.06% | 2,439 |
| SR | 5,833 | 53,586 | 10.89% | 2,468 |
| SV | 4,708 | 53,586 | 8.79% | 2,528 |
...
> **ETA globalne:** ~44 dni (2,357,813 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ██████████████░░░░░░ | 74.5% | 39,895/53,586 | ~5h |
| PL | █████████░░░░░░░░░░░ | 45.4% | 24,305/53,586 | ~12h |
| RU | ███████░░░░░░░░░░░░░ | 36.9% | 19,747/53,586 | ~14h |
| FR | ██████░░░░░░░░░░░░░░ | 33.0% | 17,712/53,586 | ~15h |
| RO | ████░░░░░░░░░░░░░░░░ | 21.8% | 11,698/53,586 | ~18h |
| ZH_TW | ██░░░░░░░░░░░░░░░░░░ | 14.5% | 7,776/53,586 | ~19h |
| IT | ██░░░░░░░░░░░░░░░░░░ | 13.1% | 6,997/53,586 | ~20h |
| SR | ██░░░░░░░░░░░░░░░░░░ | 10.9% | 5,833/53,586 | ~20h |
| SV | █░░░░░░░░░░░░░░░░░░░ | 8.8% | 4,708/53,586 | ~21h |
...
> Świeżość: 48s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-17 01:44:41

### 📁 Pliki Projektu (pełny skan)
| Metryka | Wartość | Procent | Info |
|---------|---------|---------|------|
| 📂 **Wszystkie pliki** | **20,529** | 100% | cały projekt |
| 📜 Do skanowania (kod) | **9,562** | 46.6% | pliki z kodem/tekstami |
| 🔍 **Przeskanowane (historia)** | **6,443** | **67.4%** | `i18n_processed_files.txt` |
| 🧭 Przeskanowane (LIVE) | **15** | **0.2%** | `i18n_file_status.json` |
| ⏳ Nie przeskanowane (historia) | **3,119** | 32.6% | wg historii workera |
| ⏳ Nie przeskanowane (LIVE) | **9,547** | 99.8% | wg rejestru LIVE |
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 9s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-17T01:44:33.602136Z
...
|-------|----------------|-------------------------------|---------|--------------|
| ES (Hiszpański) | 39,895/53,586 | 74.45% | 2,631 | 0 |
| PL (Polski) | 24,305/53,586 | 45.36% | 1,919 | 0 |
| RU (Rosyjski) | 19,747/53,586 | 36.85% | 2,599 | 0 |
| FR (Francuski) | 17,712/53,586 | 33.05% | 4,027 | 0 |
| RO (Rumuński) | 11,698/53,586 | 21.83% | 2,439 | 0 |
| ZH_TW (ZH_TW) | 7,776/53,586 | 14.51% | 9,749 | 2,155 |
| IT (Włoski) | 6,997/53,586 | 13.06% | 2,439 | 0 |
| SR (SR) | 5,833/53,586 | 10.89% | 2,468 | 0 |
| SV (Szwedzki) | 4,708/53,586 | 8.79% | 2,528 | 0 |
...
- You sneaked into the orc fortress. Careful now, don't go outside again. → Ti sei intrufolato nella fortezza degli orchi. Attento adesso, non uscire più. (quests.rookie_guard.m12.sneaked_in)
- Got your tarantula trap ready? You might need to use it soon... → Hai pronto la trappola per tarantole? Potrebbe essere necessario usarlo presto.. (quests.rookie_guard.m12.trap_ready)
- The bank is below the academy. Go north and head down the stairs and to the righ → La banca è sotto l'accademia. Andate a nord e scendete le scale e poi a destra. (quests.rookie_guard.missions.bank_academy)
- Go to the right to find the bank and talk to Paulie. → Vai a destra per trovare la banca e parla con Paulie. (quests.rookie_guard.missions.bank_paulie)
- You're entering orcland. → Stai entrando nell'Orcland. (quests.rookie_guard.missions.entering_orcland)
- Follow the way to the east and go south to reach the graveyard. → Seguite la strada verso est e andate a sud per raggiungere il cimitero. (quests.rookie_guard.missions.graveyard_east)
- Head through the northern door and follow the hallways to find the library vault → Attraversa la porta nord e segui i corridoi per trovare il caveau della bibliote (quests.rookie_guard.missions.hallway_library)
- Follow the path to the east to find Hyacinth's little house. → Segui il sentiero verso est per trovare la casetta di Hyacinth. (quests.rookie_guard.missions.hyacinth_east)
- The library vault is below the academy. Go north and head down several stairs un → Il caveau della biblioteca è sotto l'accademia. Vai a nord e scendi diverse scal (quests.rookie_guard.missions.library_vault)
- You don't have the bag with the items yet. Open the door in the basement of the  → Non hai ancora la borsa con gli oggetti. Apri la porta nel seminterrato dell'acc (quests.rookie_guard.missions.no_bag_yet)
- This is not the way to the crypt. Go south to reach the graveyard. → Questa non è la strada per la cripta. Andate a sud per raggiungere il cimitero. (quests.rookie_guard.missions.not_crypt_south)
- This is not the way to Hyacinth. Stay on the path a little more to the south to  → Questa non è la strada per Hyacinth. Rimani sul sentiero un po' più a sud per tr (quests.rookie_guard.missions.not_hyacinth_south)
- This is not the way to the tarantula's lair. Head northwest and go up the little → Questa non è la strada per la tana della tarantola. Andate a nord-ovest e salite (quests.rookie_guard.missions.not_tarantula_nw)
- This is not the way to the troll caves. Follow the path to the north past the hi → Questa non è la strada per le caverne dei troll. Seguite il sentiero verso nord  (quests.rookie_guard.missions.not_troll_north)
- This is not the way to the wasps' lair. Choose the northern path to reach it. → Questa non è la strada per la tana delle vespe. Scegli il percorso a nord per ra (quests.rookie_guard.missions.not_wasps_north)
- Follow the path to the north, cross the bridge to the south and walk west to rea → Seguite il sentiero a nord, attraversate il ponte a sud e camminate verso ovest  (quests.rookie_guard.missions.orc_fortress_path)
- Follow the path to the west to reach the orc fortress. → Seguite il sentiero verso ovest per raggiungere la fortezza degli orchi. (quests.rookie_guard.missions.orc_west)
- This road is the main access of the village. You might want to finish your busin → Questa strada è l'accesso principale del villaggio. Potresti voler finire prima  (quests.rookie_guard.missions.road_main)
- Walk to the north and down the stairs to reach the tarantula's lair. → Cammina verso nord e scendi le scale per raggiungere la tana della tarantola. (quests.rookie_guard.missions.tarantula_stairs)
- Follow the path to the north past the hill to reach the troll caves. → Seguite il sentiero a nord oltre la collina per raggiungere le caverne dei troll (quests.rookie_guard.missions.troll_caves)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **2690**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2624**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **10.38%** (289,299/2,786,472)
- **Kopie EN (łącznie):** **166,311**
...
|-------|--------|----------|----------|------------|
| ES | 37,381/49,731 | 75.2% | 2,514/3,855 | 65.2% |
| PL | 21,630/49,731 | 43.5% | 2,675/3,855 | 69.4% |
| RU | 17,005/49,731 | 34.2% | 2,742/3,855 | 71.1% |
| FR | 15,165/49,731 | 30.5% | 2,547/3,855 | 66.1% |
| RO | 11,381/49,731 | 22.9% | 317/3,855 | 8.2% |
| ZH_TW | 7,763/49,731 | 15.6% | 13/3,855 | 0.3% |
| IT | 6,681/49,731 | 13.4% | 316/3,855 | 8.2% |
| SR | 5,733/49,731 | 11.5% | 100/3,855 | 2.6% |
| SV | 4,566/49,731 | 9.2% | 142/3,855 | 3.7% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-17T00:44:41.895866Z → 2026-02-17T01:44:41.895866Z) |
...
| Przepustowość (kluczy/h) | **2240.2 kluczy/h** |
| Podejrzane tłumaczenia | **14808** |
| Najgorsze cele (strażnik) | pl/items.json (gf=2072), pl/npc.json (gf=378), pl/scripts.json (gf=175), ro/monsters.json (gf=80), ro/spells.json (gf=58) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-17T01:43:20.130133Z

- **Ostatni audyt:** OK | 7 issue(s) / 100 entries | 2026-02-17T01:43:20.130133Z
- **Top 5 typów problemów:** suspicious_rejected_critical=162, suspicious_log_high=141, suspicious_log_critical=59, suspicious_rejected_high=38, identical_to_en_exempt=10
- **Języki o najsłabszej jakości:** ro(60.0, issues=27267), ru(60.0, issues=21995), sv(60.1, issues=6653), es(60.2, issues=177468), it(63.5, issues=8057)
...
⚠️ **PL**: jakość 65%, 120509 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 177468 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 64%, 8057 problemów
⚠️ **RU**: jakość 60%, 21995 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 60%, 6653 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #133 |
| Heartbeat | 7s temu | 2026-02-17T01:44:36Z |
...
- 2026-02-17 01:44:36 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | quests.json
- 2026-02-17 01:44:35 | AUTO_TRANSLATE:parallel_start | ru | ok | quests.json
- 2026-02-17 01:44:08 | AUTO_TRANSLATE:heartbeat_tick | it | ok | quests.json
- 2026-02-17 01:44:08 | AUTO_TRANSLATE:parallel_start | it | ok | quests.json
- 2026-02-17 01:44:06 | AUTO_TRANSLATE:auto_done | ro | ok | spells.json
- 2026-02-17 01:43:38 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | spells.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 45.4% | 0 | 1,919 | 1,099 | 4322 (79.7%) | 34 |
| 🟡 ES | 74.5% | 0 | 2,631 | 715 | 419 (36.9%) | 33 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **88,821** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=38.37%, reason=decrease_high_fail_rate=38.4% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,814 kluczy / 67 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-17 01:44:41

- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [it] → ok (translated+43, skipped+0) — parallel lang=it file=quests.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+21, skipped+0) — lang=ro file=spells.json strict_skipped_done=806 guard_fail=29 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+41, skipped+0) — parallel lang=es file=monsters.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+41, skipped+0) — lang=pl file=monsters.json strict_skipped_done=2128
- 🔧 MIGRATION: zakończono kategorię [items] → ok (keys+12, files+0) — migration finished
- 🔧 MIGRATION: mini-batch stop [items] → ok (keys+0) — no new data
- 🔧 MIGRATION: mini-batch [items] → ok (keys+0) — mini_batch=3 processed=30/50
- 🔧 MIGRATION: mini-batch [items] → ok (keys+2) — mini_batch=2 processed=20/50
...
| ❌ Błędów | 117 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (1,452), **IT** (1,320), **RU** (1,211), **RO** (1,086), **PL** (1,010) |
| 📊 Porównanie | ↓ 64.0% vs wczoraj (20,288) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **107,499** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-17 01:44:41  
