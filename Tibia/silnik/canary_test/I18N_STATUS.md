...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.84%**. Tempo: **1696.8 kluczy/h**. Tłumaczeń netto: **115,544**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 17:34:56

> **Aktualizacja:** 2026-02-20 17:34:56 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #10 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ru | Plik: - | Heartbeat: 2026-02-20T17:34:52Z  
> **Okno godzinowe:** okno=1.0h | cykli=159 | pominięte=0.0% | odrzucone=57.5% | przepustowość=1696.8/h  
> **Tłumaczeń netto:** 115,544

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 17:34:56 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T17:34:52Z |
| MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 17:34:56 |
| TRANSLATION | 🟢 AKTYWNY | 5s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T17:34:51.406006Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T17:34:57.125873Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 17:34:56 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T17:34:52Z
...
| ❤️ **Heartbeat** | 2026-02-20T17:34:52Z |
...
> **ETA globalne:** ~56 dni (2,261,439 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~1697 kluczy/h.
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 17:34:56
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T17:34:51.406006Z
...
- Raporty strażnika jakości: **6657**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3765**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **13.84%** (385,673/2,786,472)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T16:34:56.442475Z → 2026-02-20T17:34:56.442475Z) |
...
| Przepustowość (kluczy/h) | **1696.8 kluczy/h** |
| Podejrzane tłumaczenia | **3992** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T17:34:57.125873Z

- **Ostatni audyt:** SLOW_MODE | 40 issue(s) / 100 entries | 2026-02-20T17:34:52.018233Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=159, suspicious_log_low=58, suspicious_log_critical=41, suspicious_log_high=35, suspicious_rejected_high=26
- **Języki o najsłabszej jakości:** es(60.1, issues=321145), ro(60.1, issues=175579), it(60.2, issues=70644), tl(64.2, issues=466), ru(64.4, issues=210176)
...
⚠️ **PL**: jakość 82%, 180959 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 321145 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 70644 problemów
⚠️ **RU**: jakość 64%, 210176 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 83%, 29809 problemów
...
| Heartbeat | 5s temu | 2026-02-20T17:34:52Z |
...
| 🟡 ES | 84.7% | 0 | 2,164 | 779 | 2967 (79.2%) | 42 |
...
| Przepustowość (okno) | 1,584 kluczy / 82 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 17:34:56
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **4,195** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 17 |
| ❌ Błędów | 91 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (1,114), **RU** (760), **IT** (744), **RO** (504), **PL** (486) |
| 📊 Porównanie | ↑ 15.2% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **101,780** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 17:34:56  
