...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.04% / real 10.96%**. Tempo: **809.0 kluczy/h**. Tłumaczeń netto: **147,856**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 12:39:01

> **Aktualizacja:** 2026-04-29 12:39:01 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,400 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ro | Plik: items.json | Heartbeat: 2026-04-29T12:37:49Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=5.0% | przepustowość=809.0/h  
> **Tłumaczeń netto:** 147,856

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 12:39:01 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T12:37:49Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 58s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 12:39:01 |
| TRANSLATION | 🟢 AKTYWNY | 4min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T12:34:17.647693Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T12:37:33.953972Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 12:39:01 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T12:39:09.304039Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T12:37:49Z
...
| 🔄 **Ostatni cykl** | 59 kluczy, 9 odrzuconych, 97.0s, tryb: AUTO_TRANSLATE, cel: cs/items.json |
| ❤️ **Heartbeat** | 2026-04-29T12:37:49Z |
...
| ⏳ Oldest pending (visible tail) | 16931 s |
...
| 🌍 Recent provider mix | TM/simple(292), Free Google Translate(184), canonical_name_semantic_autofix(16), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=495, fallbacks=25) |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 390, 'oldest_s': 16931}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~154 dni (2,982,862 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 79.2% | 59,013/74,536 | ~15h |
...
> Świeżość: 58s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 12:39:01
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 4min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T12:34:17.647693Z
...
- Raporty strażnika jakości: **4947**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4800**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T12:38:18.960763Z |
...
| 🕒 Evidence window | 24h (span=41.78h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=41.78h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T11:39:02.107003Z → 2026-04-29T12:39:02.107003Z) |
...
| Podejrzane tłumaczenia | **1194** |
| Najgorsze cele (strażnik) | cs/items.json (gf=25), ro/items.json (gf=8), de/npc.json (gf=3), ru/items.json (gf=3), it/items.json (gf=2) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T12:37:33.953972Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T12:37:33.953972Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=747752), ro(60.1, issues=442544), de(60.1, issues=125208), cs(60.1, issues=114676), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 60%, 57867 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 747752 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 77%, 178061 problemów
⚠️ **RU**: jakość 66%, 372408 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,400 |
| Heartbeat | 80s temu | 2026-04-29T12:37:49Z |
...
- 2026-04-29 12:34:35 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 12:34:18 | AUTO_TRANSLATE:auto_done | cs | ok | items.json
- 2026-04-29 12:34:12 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **147,856** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=7.26%, reason=stable_fail_rate=7.3%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 12:39:01
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+83, skipped+0) — lang=it file=items.json strict_skipped_done=17087 guard_fail=28 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **10,526** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 201 |
| ❌ Błędów | 458 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,853), **RU** (1,719), **TR** (1,617), **IT** (1,531), **DE** (1,485) |
| 📊 Porównanie | ↑ 27.9% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **29,506** kluczy
...
| 🔄 Cykli wykonanych | **#18,400** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,400 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 12:39:01  
