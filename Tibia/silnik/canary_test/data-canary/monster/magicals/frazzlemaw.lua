...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "Mwaaahgod! Overmwaaaaah! *gurgle*", yell = false , i18nKey = "monster.frazzlemaw.voice_5"},
	{ text = "Mwaaaahnducate youuuuuu *gurgle*, mwaaah!", yell = false , i18nKey = "monster.frazzlemaw.voice_6"},
	{ text = "MMMWAHMWAHMWAHMWAAAAH!", yell = true , i18nKey = "monster.frazzlemaw.voice_7"},
	{ text = "Mmmwhamwhamwhah, mwaaah!", yell = false , i18nKey = "monster.frazzlemaw.voice_8"},
}
