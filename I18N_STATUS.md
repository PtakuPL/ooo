...
> **Aktualizacja:** 2025-12-11 01:36:13 UTC  
...
| 🌐 Pozostałe (0/53) | 🔄 | 764222 | Aktualnie: SQ |
...
│ Kategoria: 🌍 SQ/scripts.json                        │
├─────────────────────────────────────────────────────────────────┤
│ 📊 Ostatnia aktywność: SQ/scripts.json                                │
│ [█████████████████████████████████████████████████░] │
│ 28501/28550 kluczy (100%)                                          │
├─────────────────────────────────────────────────────────────────┤
│ ⏳ Total processed: 30712 operacji               │
│ 🌍 Języki zsync: 0/53                                │
│ 📅 Ostatnia aktualizacja: 2025-12-11 01:36:13                 │
└─────────────────────────────────────────────────────────────────┘
```
...
- 🌍 `SQ/scripts.json` +28501 kluczy @ 01:36:13
...
|-----------|--------|--------------|-----------|--------|
| items | 13749 | 11689 | 4 | ⏭️ Skip 32m |
| monsters | 7341 | 9549 | 4 | ⏭️ Skip 32m |
| npc | 5334 | 2 | 0 | ✅ Active |
| html | 1495 | 3245 | 4 | ⏭️ Skip 37m |
| scripts | 385 | 0 | 4 | ⏭️ Skip 32m |
| raids | 147 | 351 | 4 | ⏭️ Skip 32m |
| startup | 23 | 23 | 4 | ⏭️ Skip 33m |
| libs | 21 | 53 | 4 | ⏭️ Skip 32m |
| modules | 16 | 16 | 4 | ⏭️ Skip 33m |
| spells | 15 | 0 | 0 | ✅ Active |
| messages | 11 | 0 | 0 | ✅ Active |
| chatchannels | 8 | 8 | 4 | ⏭️ Skip 33m |
| events | 5 | 5 | 4 | ⏭️ Skip 32m |
| actions | 0 | 0 | 0 | ⏳ Empty |
| client | 0 | 821 | 6 | ⏭️ Skip 113m |
| cpp | 0 | 0 | 0 | ⏳ Empty |
| errors | 0 | 0 | 0 | ⏳ Empty |
| npclib | 0 | 0 | 4 | ⏭️ Skip 33m |
| php | 0 | 4521 | 8 | ⏭️ Skip 113m |
| quests | 0 | 0 | 0 | ⏳ Empty |
| server | 0 | 0 | 0 | ⏳ Empty |
| ui | 0 | 0 | 0 | ⏳ Empty |
| world | 0 | 0 | 4 | ⏭️ Skip 32m |
...
| monsters | 32m | 4x | Progresywny backoff |
| raids | 32m | 4x | Progresywny backoff |
| world | 32m | 4x | Progresywny backoff |
| items | 32m | 4x | Progresywny backoff |
| libs | 32m | 4x | Progresywny backoff |
| events | 32m | 4x | Progresywny backoff |
| chatchannels | 33m | 4x | Progresywny backoff |
| modules | 33m | 4x | Progresywny backoff |
| startup | 33m | 4x | Progresywny backoff |
| npclib | 33m | 4x | Progresywny backoff |
| php | 113m | 8x | Progresywny backoff |
| html | 37m | 4x | Progresywny backoff |
| client | 113m | 6x | Progresywny backoff |
| sendtextmessage | 37m | 4x | Progresywny backoff |
| keywordhandler | 37m | 4x | Progresywny backoff |
| twig | 37m | 4x | Progresywny backoff |
...
📅 Auto-updated by Worker v1.1 | Last: 2025-12-11 01:36:13  
