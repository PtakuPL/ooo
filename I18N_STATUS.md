...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.59% / real 10.46%**. Tempo: **881.0 kluczy/h**. Tłumaczeń netto: **123,816**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-23 01:35:07

> **Aktualizacja:** 2026-04-23 01:35:07 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #15,799 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: pt | Plik: - | Heartbeat: 2026-04-23T01:33:57Z  
> **Okno godzinowe:** okno=1.0h | cykli=148 | pominięte=0.0% | odrzucone=71.3% | przepustowość=881.0/h  
> **Tłumaczeń netto:** 123,816

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-23 01:35:07 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-23T01:33:57Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 39s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-23 01:35:07 |
| TRANSLATION | 🟢 AKTYWNY | 38s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-23T01:34:37.456857Z |
| QUALITY | 🔒 NIEAKTYWNY | 11s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-23T01:35:03.825217Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-23 01:35:07 |
| DOCTOR | 🟢 AKTYWNY | 0s temu | - | `doctor_alerts_latest.json` | 2026-04-23T01:35:15.684514Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-23T01:33:57Z
...
| ❤️ **Heartbeat** | 2026-04-23T01:33:57Z |
...
| 01:12:27 | ES | Serwer | quests.json | 1 | `tm` | `quests.oramond.sewer_fix_2` | <clong!> <clong!> <scrit scrit scrit>Esto debería ser suficiente. |
...
|----------|------|---------|-----------|-------|----------|--------------|-----|
| 01:34:34 | PT | Serwer | server.json | `hard_block` | `validate_placeholder` | `placeholder` | `data.otservbr.global.npc.tigo.L59.857` |
| 01:34:34 | PT | Serwer | server.json | `hard_block` | `validate_placeholder` | `placeholder` | `data.otservbr.global.npc.rock.with.a.soft.spot.L143.551` |
| 01:34:34 | PT | Serwer | server.json | `hard_block` | `validate_quality` | `quality` | `data.otservbr.global.npc.morgan.L155.479` |
| 01:34:31 | PT | Serwer | server.json | `hard_block` | `validate_placeholder` | `placeholder` | `data.otservbr.global.npc.guard.saros.L67.314` |
| 01:34:31 | PT | Serwer | server.json | `hard_block` | `validate_placeholder` | `placeholder` | `data.otservbr.global.npc.guard.saros.L64.313` |
| 01:34:31 | PT | Serwer | server.json | `hard_block` | `validate_placeholder` | `placeholder` | `data.otservbr.global.npc.grizzly.adams.L146.91` |
| 01:34:31 | PT | Serwer | server.json | `hard_block` | `validate_placeholder` | `placeholder` | `data.otservbr.global.npc.grizzly.adams.L136.89` |
| 01:34:31 | PT | Serwer | server.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `data.otservbr.global.npc.eroth.L103.511` |
| 01:34:29 | PT | Serwer | server.json | `hard_block` | `validate_placeholder` | `placeholder` | `data.otservbr.global.npc.cornell.L73.81` |
| 01:34:29 | PT | Serwer | server.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `data.otservbr.global.npc.chartan.L107.1622` |
| 01:34:29 | PT | Serwer | server.json | `hard_block` | `validate_placeholder` | `placeholder` | `data.otservbr.global.npc.buddel.tyrsung.L135.726` |
| 01:34:29 | PT | Serwer | server.json | `hard_block` | `validate_placeholder` | `placeholder` | `data.otservbr.global.npc.buddel.raider.camp.L135.1246` |
| 01:34:29 | PT | Serwer | server.json | `hard_block` | `validate_placeholder` | `placeholder` | `data.otservbr.global.npc.buddel.okolnir.L134.1427` |
| 01:34:26 | PT | Serwer | server.json | `hard_block` | `validate_placeholder` | `placeholder` | `data.otservbr.global.npc.buddel.helheim.L130.794` |
| 01:34:26 | PT | Serwer | server.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `data.otservbr.global.npc.brasith.L61.1213` |
| 01:34:26 | PT | Serwer | server.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `data.otservbr.global.npc.brasith.L60.1212` |
| 01:34:26 | PT | Serwer | server.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `data.otservbr.global.npc.anerui.L73.1489` |
| 01:34:25 | PT | Serwer | server.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `data.otservbr.global.npc.anerui.L72.1488` |
| 01:34:22 | PT | Serwer | server.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `data.otservbr.global.scripts.quests.the.secret.library.quest.the.lame...` |
| 01:34:22 | PT | Serwer | server.json | `hard_block` | `critical_issue` | `semantic_map_mismatch` | `data.otservbr.global.scripts.quests.the.inquisition.quest.actions.rew...` |
...
| ⏳ Oldest pending (visible tail) | 2754 s |
...
| 🧮 OpenAI budget | `6/250` |
| ♻️ Provider debt | `0` |
| 🌍 Recent provider mix | Free Google Translate(229), TM/simple(89) |
| 🔁 Latest fallback | TM/simple → fallback to google translate high [high_reject_types] server.json |
| 📉 Fallback breakdown | fallback to google translate high(76), fallback to google translate(2) |
...
| `QUEUE_STARVATION` | OK | OK | `{'pending': 400, 'oldest_s': 2754}` | `{'pending_min': 200, 'oldest_s': 3600}` | Queue bez sygnałów starvation. |
...
> **ETA globalne:** ~142 dni (3,000,349 kluczy do celu 95%)
...
| RU | ████████░░░░░░░░░░░░ | 44.3% | 33,038/74,536 | ~43h |
| FR | ███████████░░░░░░░░░ | 57.1% | 42,570/74,536 | ~32h |
| SR | ██████░░░░░░░░░░░░░░ | 33.3% | 24,827/74,536 | ~2d |
| CS | █████████░░░░░░░░░░░ | 47.7% | 35,557/74,536 | ~40h |
| TR | ██████░░░░░░░░░░░░░░ | 31.3% | 23,330/74,536 | ~2d |
| NL | ██████████████░░░░░░ | 73.5% | 54,813/74,536 | ~18h |
...
> Świeżość: 39s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-23 01:35:07
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 38s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-23T01:34:37.456857Z
...
| CS (Czeski) | 47.70% (35,557/74,536) | 29.35% (21,877/74,536) | 30,676 | 22,006 | 0 |
...
- Raporty strażnika jakości: **4287**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4144**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 280 | 0 | 0 | - | 2026-04-23T01:34:14.002492Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.59%** (681,719/3,875,872)
- **Pokrycie globalne (real):** **10.46%** (405,439/3,875,872)
- **Kopie EN (łącznie):** **419,438**
...
| CS | 33,871/70,637 | 48.0% / 28.8% | 1,686/3,899 | 43.2% / 38.9% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-23T00:35:08.277941Z → 2026-04-23T01:35:08.277941Z) |
| Cykle | **148** (TŁUMACZENIE=148, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **71.3%** |
| Cykle bez postępu % | **29.7%** |
| Przepustowość (kluczy/h) | **881.0 kluczy/h** |
| Podejrzane tłumaczenia | **3819** |
...
|--------|-----------|--------|----------------|
| `gt_validate_fail_placeholder` | 186 | 37.7% | ro/npc.json (90) |
| `gt_validate_fail_identical_to_en` | 133 | 27.0% | ro/npc.json (49) |
| `gt_rejected_high_mixed_scripts` | 84 | 17.0% | ru/server.json (78) |
| `gt_rejected_high_cyrillic_latin_mix` | 38 | 7.7% | ru/server.json (22) |
| `gt_rejected_high_trimmed_en_copy` | 16 | 3.2% | pl/monsters.json (15) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 11s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-23T01:35:03.825217Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-23T01:35:03.825217Z
- **Top 5 typów problemów:** suspicious_log_high=169, suspicious_rejected_high=122, suspicious_rejected_critical=76, suspicious_log_low=14, suspicious_log_medium=13
- **Języki o najsłabszej jakości:** pl(60.1, issues=385168), ru(61.3, issues=341987), pt(63.4, issues=40036), tr(64.7, issues=42874), ro(64.9, issues=413190)
- **Pliki:** `i18n/status/quality_audit_latest.json`, `i18n/status/quality_dashboard.json`, `i18n/status/quality_report.jsonl`

### 📈 Statystyki Pracy
| Metryka | Wartość | Info |
|---------|---------|------|
| 🔄 Cykl aktualny | **#162** | od uruchomienia |
...
⚠️ **ES**: jakość 90%, 705172 problemów
⚠️ **PT**: jakość 63%, 40036 problemów
⚠️ **FR**: jakość 72%, 57775 problemów
⚠️ **IT**: jakość 71%, 160840 problemów
⚠️ **RU**: jakość 61%, 341987 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #15,799 |
| Heartbeat | 78s temu | 2026-04-23T01:33:57Z |
...
- **TOP 5 języków:** DE (20,139), NL (16,792), CS (15,710), PT (14,923), FR (13,544)
- **Aktualnie naprawia:** ES / -
- **Ostatnia aktualizacja:** 2026-04-23T01:34:52.744200Z
...
- 2026-04-23 01:34:53 | AUTO_TRANSLATE:heartbeat_tick | es | ok | quests.json
- 2026-04-23 01:34:38 | AUTO_TRANSLATE:auto_done | pt | ok | server.json
- 2026-04-23 01:34:15 | AUTO_TRANSLATE:heartbeat_tick | pt | ok | server.json
- 2026-04-23 01:34:14 | AUTO_TRANSLATE:auto_start | pt | ok | server.json
- 2026-04-23 01:33:56 | AUTO_TRANSLATE:auto_done | de | ok | server.json
- 2026-04-23 01:32:59 | AUTO_TRANSLATE:heartbeat_tick | de | ok | server.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **123,816** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=78.26%, reason=decrease_high_fail_rate=78.3%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-23 01:35:07
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pt] → warn (files+1, translated+9, skipped+0) — lang=pt file=server.json strict_skipped_done=2565 guard_fail=29 placeholder=11 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+1) — repair_identical lang=es file=quests.json target_identical=1 limit=180 tier=low_backlog domain_cap=180 gt=true suspicious_pct=100.00
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [fr] → warn (files+1, translated+55, skipped+0) — lang=fr file=items.json strict_skipped_done=2865 guard_fail=2 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+0, translated+0, skipped+0) — lang=it file=npclib.json strict_skipped_done=133
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [nl] → warn (files+1, translated+1, skipped+0) — lang=nl file=quests.json strict_skipped_done=553
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **1,289** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 56 |
| ❌ Błędów | 108 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **CS** (293), **ES** (270), **DE** (177), **PL** (144), **FR** (77) |
| 📊 Porównanie | ↓ 89.4% vs wczoraj (12,108) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **28,973** kluczy
...
| 🔄 Cykli wykonanych | **#15,799** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #15,799 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-23 01:35:07  
