...
keywordHandler:addKeyword({ "hi" }, StdModule.say, { npcHandler = npcHandler, onlyUnfocus = true, i18nKey = "npc.fenbala.stdmod_1" })
keywordHandler:addKeyword({ "hello" }, StdModule.say, { npcHandler = npcHandler, onlyUnfocus = true, i18nKey = "npc.fenbala.stdmod_2" })
...
local function creatureSayCallback(npc, creature, type, message)
	...
	if table.contains({ "fuck", "idiot", "asshole", "ass", "fag", "stupid", "tyrant", "shit", "lunatic" }, message) then
		...
		NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.fenbala.say_3")
