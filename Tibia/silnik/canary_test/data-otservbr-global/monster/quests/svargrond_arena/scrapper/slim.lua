...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "Zhroozzzzs.", yell = false , i18nKey = "monster.slim.voice_1"},
	{ text = "Knooorrrrr!", yell = false , i18nKey = "monster.slim.voice_2"},
	{ text = "Cccchhhhhhhhh!", yell = false , i18nKey = "monster.slim.voice_3"},
}
