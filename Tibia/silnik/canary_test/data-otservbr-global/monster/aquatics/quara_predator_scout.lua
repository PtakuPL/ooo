...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "Gnarrr!", yell = false , i18nKey = "monster.quara_predator_scout.voice_1"},
	{ text = "Tcharrr!", yell = false , i18nKey = "monster.quara_predator_scout.voice_2"},
	{ text = "Rrrah!", yell = false , i18nKey = "monster.quara_predator_scout.voice_3"},
	{ text = "Rraaar!", yell = false , i18nKey = "monster.quara_predator_scout.voice_4"},
}
