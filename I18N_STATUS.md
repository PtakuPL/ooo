...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.45%**. Tempo: **2247.7 kluczy/h**. Tłumaczeń netto: **91,456**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-17 02:39:24

> **Aktualizacja:** 2026-02-17 02:39:24 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #170 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: es | Plik: - | Heartbeat: 2026-02-17T02:39:10Z  
> **Okno godzinowe:** okno=1.0h | cykli=166 | pominięte=0.0% | odrzucone=45.9% | przepustowość=2247.7/h  
> **Tłumaczeń netto:** 91,456

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-17 02:39:24 |
| LIVE | 🟢 AKTYWNY | 16s temu | - | `activity.json / worker_state.json` | 2026-02-17T02:39:10Z |
| MIGRATION | 🔒 NIEAKTYWNY | 54s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-17 02:39:24 |
| TRANSLATION | 🟢 AKTYWNY | 18s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-17T02:39:07.573959Z |
| QUALITY | 🔒 NIEAKTYWNY | 15s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-17T02:39:10.420593Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-17 02:39:24 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 16s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-17T02:39:10Z
...
| ❤️ **Heartbeat** | 2026-02-17T02:39:10Z |
...
| 🔁 Cykli | 166 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | PL (863 kluczy) |
| 📄 Najczęstszy plik | server.json |
| ⚡ Przepustowość | ~2248 kluczy/h |
...
| RU | 19,973 | 53,586 | 37.27% | 2,587 |
| FR | 17,713 | 53,586 | 33.06% | 4,026 |
| RO | 12,169 | 53,586 | 22.71% | 2,431 |
| ZH_TW | 7,776 | 53,586 | 14.51% | 9,749 |
| IT | 7,398 | 53,586 | 13.81% | 2,436 |
...
> **ETA globalne:** ~44 dni (2,355,972 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ██████████████░░░░░░ | 74.6% | 39,996/53,586 | ~5h |
| PL | █████████░░░░░░░░░░░ | 46.1% | 24,715/53,586 | ~12h |
| RU | ███████░░░░░░░░░░░░░ | 37.3% | 19,973/53,586 | ~14h |
| FR | ██████░░░░░░░░░░░░░░ | 33.1% | 17,713/53,586 | ~15h |
| RO | ████░░░░░░░░░░░░░░░░ | 22.7% | 12,169/53,586 | ~17h |
| ZH_TW | ██░░░░░░░░░░░░░░░░░░ | 14.5% | 7,776/53,586 | ~19h |
| IT | ██░░░░░░░░░░░░░░░░░░ | 13.8% | 7,398/53,586 | ~19h |
| SR | ██░░░░░░░░░░░░░░░░░░ | 11.0% | 5,908/53,586 | ~20h |
...
> Tempo obliczone na bazie ostatniej godziny: ~2248 kluczy/h.
...
> Świeżość: 54s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-17 02:39:24
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 18s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-17T02:39:07.573959Z
...
| RU (Rosyjski) | 19,973/53,586 | 37.27% | 2,587 | 0 |
| FR (Francuski) | 17,713/53,586 | 33.06% | 4,026 | 0 |
| RO (Rumuński) | 12,169/53,586 | 22.71% | 2,431 | 0 |
| ZH_TW (ZH_TW) | 7,776/53,586 | 14.51% | 9,749 | 2,155 |
| IT (Włoski) | 7,398/53,586 | 13.81% | 2,436 | 0 |
...
- First to dump his opponent 4 times wins → Kto pierwszy rzuci przeciwnika 4 razy, wygrywa (book.otbm.first_to_dump_his_opponent)
- Fiscal revision only. For banking, please apply at counter upstairs. Depot downs → Tylko rewizja fiskalna. W przypadku bankowości prosimy o złożenie wniosku w kasi (book.otbm.fiscal_revision_only_for_banking)
- flattered her with compliments, and he succeeded in seducing her. → schlebiał jej komplementami i udało mu się ją uwieść. (book.otbm.flattered_her_with_compliments_and)
- Flying Carpet Passage Service → Usługa przejścia latającego dywanu (book.otbm.flying_carpet_passage_service)
- Flying Carpet Passage Service → Usługa przejścia latającego dywanu (book.otbm.flying_carpet_passage_service_54553a20)
- Flying Carpet Passage Service upstairs → Usługa przejścia latającego dywanu na górze (book.otbm.flying_carpet_passage_service_upstairs)
- For 5 minutes the wand spread a mighty aura and then it suddenly stopped. → Przez 5 minut różdżka roztaczała potężną aurę, po czym nagle ustała. (book.otbm.for_5_minutes_the_wand)
- For a long time Fardos exhausted his enormous powers in futile activity. Finally → Przez długi czas Fardos wyczerpał swoje ogromne siły w daremnej działalności. W  (book.otbm.for_a_long_time_fardos)
- For a long time Malor had plotted and schemed in secrecy, using promises and thr → Przez długi czas Malor spiskował i planował w tajemnicy, wykorzystując obietnice (book.otbm.for_a_long_time_malor)
- For all the adventurers old and young. May you live in honour and courage and ne → Dla wszystkich poszukiwaczy przygód, starych i młodych. Abyście żyli w honorze i (book.otbm.for_all_the_adventurers_old)
- for all who found this place... See him broken and mad. Beware of the wrath of t → dla wszystkich, którzy znaleźli to miejsce... Zobaczcie go załamanego i szaloneg (book.otbm.for_all_who_found_this)
- For Armors and Shields, please go upstairs! → Po zbroje i tarcze idź na górę! (book.otbm.for_armors_and_shields_please)
- For centuries we have been doing research into this magic web in our world of Ti → Od wieków prowadzimy badania nad tą magiczną siecią w naszym świecie Tibia. Im b (book.otbm.for_centuries_we_have_been)
- For each missing part (on the basis of a standard rail) I recommend to use three → Na każdą brakującą część (na bazie standardowej szyny) polecam użyć trzech kawał (book.otbm.for_each_missing_part_on)
- For example, only with its help we could find the gates of teleportation of the  → Na przykład tylko za jego pomocą mogliśmy znaleźć bramy teleportacji magicznej s (book.otbm.for_example_only_with_its)
- For now the merchants seem content with their station and the place Venore takes → Na razie kupcy wydają się zadowoleni ze swojej pozycji i miejsca, jakie Venore z (book.otbm.for_now_the_merchants_seem)
- For our deeds for king and country, the king granted our order the Eastern lands → Za nasze czyny dla króla i kraju król udzielił nam rozkazu ziem wschodnich. Mias (book.otbm.for_our_deeds_for_king)
- Forbidden Secrets of Magic! → Zakazane tajemnice magii! (book.otbm.forbidden_secrets_of_magic)
- forests and in wild herds the wolves learned to defeat their bipedal opponents. → lasach i dzikich stadach wilki nauczyły się pokonywać swoich dwunożnych przeciwn (book.otbm.forests_and_in_wild_herds)
- former master, before he hid them from me. → dawny mistrz, zanim ukrył je przede mną. (book.otbm.former_master_before_he_hid)
...
- **Pokrycie globalne:** **10.45%** (291,140/2,786,472)
- **Kopie EN (łącznie):** **166,276**
...
| RU | 17,231/49,731 | 34.6% | 2,742/3,855 | 71.1% |
| FR | 15,166/49,731 | 30.5% | 2,547/3,855 | 66.1% |
| RO | 11,805/49,731 | 23.7% | 364/3,855 | 9.4% |
| ZH_TW | 7,763/49,731 | 15.6% | 13/3,855 | 0.3% |
| IT | 7,082/49,731 | 14.2% | 316/3,855 | 8.2% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-17T01:39:24.969409Z → 2026-02-17T02:39:24.969409Z) |
...
| Przepustowość (kluczy/h) | **2247.7 kluczy/h** |
| Podejrzane tłumaczenia | **14316** |
| Najgorsze cele (strażnik) | pl/items.json (gf=1038), pl/npc.json (gf=772), pl/scripts.json (gf=313), ro/spells.json (gf=100), sr/server.json (gf=95) |
...
> Świeżość: 15s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-17T02:39:10.420593Z

- **Ostatni audyt:** SLOW_MODE | 30 issue(s) / 100 entries | 2026-02-17T02:39:10.420593Z
- **Top 5 typów problemów:** suspicious_rejected_critical=166, suspicious_log_high=88, suspicious_log_critical=73, suspicious_log_low=39, suspicious_rejected_high=34
- **Języki o najsłabszej jakości:** es(60.1, issues=184334), pl(60.1, issues=122704), ro(60.1, issues=32102), ru(60.1, issues=24862), it(61.3, issues=9290)
...
⚠️ **PL**: jakość 60%, 122704 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 184334 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 61%, 9290 problemów
⚠️ **RU**: jakość 60%, 24862 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 82%, 7505 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #170 |
| Heartbeat | 16s temu | 2026-02-17T02:39:10Z |
...
- 2026-02-17 02:38:09 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | books.json
- 2026-02-17 02:38:08 | AUTO_TRANSLATE:parallel_start | pl | ok | books.json
- 2026-02-17 02:38:07 | AUTO_TRANSLATE:auto_done | es | ok | otclient_modules.json
- 2026-02-17 02:37:38 | AUTO_TRANSLATE:heartbeat_tick | es | ok | otclient_modules.json
- 2026-02-17 02:37:38 | AUTO_TRANSLATE:auto_start | es | ok | otclient_modules.json
- 2026-02-17 02:37:08 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 46.1% | 0 | 1,912 | 1,331 | 3971 (74.9%) | 35 |
| 🟡 ES | 74.6% | 0 | 2,633 | 934 | 536 (36.5%) | 36 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **91,456** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=35.73%, reason=decrease_high_fail_rate=35.7% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 2,265 kluczy / 71 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-17 02:39:24

- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [pl] → ok (translated+32, skipped+0) — parallel lang=pl file=books.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+14, skipped+0) — lang=es file=otclient_modules.json strict_skipped_done=1806 guard_fail=30 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+41, skipped+0) — parallel lang=es file=npc.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+41, skipped+0) — lang=pl file=npc.json strict_skipped_done=7375
...
- 🔧 MIGRATION: mini-batch [otclient_src] → ok (keys+0) — mini_batch=1 processed=10/50
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **11,410** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 109 |
| ❌ Błędów | 180 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (2,393), **IT** (1,979), **RU** (1,884), **PL** (1,775), **RO** (1,710) |
| 📊 Porównanie | ↓ 43.8% vs wczoraj (20,288) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **111,604** kluczy
...
| 🔄 Cykli wykonanych | **#170** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-17 02:39:24  
