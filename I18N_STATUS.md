...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.83% / real 10.74%**. Tempo: **784.0 kluczy/h**. Tłumaczeń netto: **133,887**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-28 18:54:30

> **Aktualizacja:** 2026-04-28 18:54:30 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #16,912 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ro | Plik: items.json | Heartbeat: 2026-04-28T18:53:18Z
> **Okno godzinowe:** okno=1.0h | cykli=82 | pominięte=0.0% | odrzucone=3.6% | przepustowość=784.0/h  
> **Tłumaczeń netto:** 133,887

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-28 18:54:30 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-28T18:53:18Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 53s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-28 18:54:30 |
| TRANSLATION | 🟢 AKTYWNY | 4min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-28T18:49:41.937916Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-28T18:53:17.935417Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-28 18:54:30 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-28T18:54:37.416671Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-28T18:53:18Z
...
| 🔄 **Ostatni cykl** | 31 kluczy, 1 odrzuconych, 69.0s, tryb: AUTO_TRANSLATE, cel: it/items.json |
| ❤️ **Heartbeat** | 2026-04-28T18:53:18Z |
...
| ⏳ Oldest pending (visible tail) | 13795 s |
| 🌍 Top języki | NL(141), RU(128), PT(95), DE(12) |
| 🧱 Top reason_bucket | default(196), quality(130), word_salad(34), partial_translation_mix(27) |
...
| 🧮 OpenAI budget | `173/250` |
| ♻️ Provider debt | `1254` |
| 🌍 Recent provider mix | TM/simple(334), Free Google Translate(199), OpenAI model pool(21), canonical_name_semantic_autofix(5), term... |
...
| ❤️ Pool health | `critical` (writes=564, fallbacks=24) |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 397, 'oldest_s': 13795}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| �📊 Przetłumaczono | **784** kluczy |
| ❌ Odrzucone (guard) | 29 |
| 🔁 Cykli | 82 |
| 🌍 Języków | 8 |
| 🏆 Najaktywniejszy | IT (142 kluczy) |
| 📄 Najczęstszy plik | items.json |
| ⚡ Przepustowość | ~784 kluczy/h |
...
|-------|---------------|-----------|----------|----------|
| ES | 58,439 | 74,536 | 78.4% ↑+0.02% | 9,761 |
...
> **ETA globalne:** ~159 dni (2,990,886 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 78.4% | 58,439/74,536 | ~16h |
| PL | ██████████████░░░░░░ | 71.0% | 52,911/74,536 | ~23h |
| IT | █████████████░░░░░░░ | 68.2% | 50,857/74,536 | ~25h |
| RO | █████████████░░░░░░░ | 69.3% | 51,632/74,536 | ~24h |
| RU | ████████░░░░░░░░░░░░ | 44.7% | 33,285/74,536 | ~48h |
...
| TR | ██████░░░░░░░░░░░░░░ | 32.4% | 24,117/74,536 | ~2d |
| DE | █████████████░░░░░░░ | 67.8% | 50,557/74,536 | ~26h |
...
> Tempo obliczone na bazie ostatniej godziny: ~784 kluczy/h.
...
> Świeżość: 53s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-28 18:54:30
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 4min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-28T18:49:41.937916Z
...
|-------|-----------|--------|----------|--------------|--------------|
| ES (Hiszpański) | 78.40% (58,439/74,536) | 67.17% (50,067/74,536) | 9,761 | 14,732 | 0 |
...
- Hum... what, {task}? → Hum... ¿qué, {task}? (npc.budrik.say_22)
...
- Raporty strażnika jakości: **4574**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4427**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-28T18:53:49.143765Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.83%** (691,182/3,875,872)
- **Pokrycie globalne (real):** **10.74%** (416,332/3,875,872)
- **Kopie EN (łącznie):** **410,942**
- **Placeholdery [EN]/puste (łącznie):** **2,194,476**
...
|-------|--------|--------------------------|----------|----------------------------|
| ES | 55,279/70,637 | 78.3% / 66.5% | 3,160/3,899 | 81.0% / 79.2% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-28T17:54:31.219705Z → 2026-04-28T18:54:31.219705Z) |
...
| Przepustowość (kluczy/h) | **784.0 kluczy/h** |
| Podejrzane tłumaczenia | **1020** |
| Najgorsze cele (strażnik) | cs/items.json (gf=11), ro/items.json (gf=8), nl/otclient_modules.json (gf=4), it/items.json (gf=2), de/otclient_modules.json (gf=2) |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 85 | 79.4% | ru/items.json (85) |
| `existing_canonical_name_quality_mixed_scripts` | 11 | 10.3% | ru/items.json (11) |
| `gt_validate_fail_identical_to_en` | 6 | 5.6% | ro/items.json (4) |
| `gt_rejected_critical` | 3 | 2.8% | es/npc.json (3) |
| `gt_partial_validate_word_salad` | 1 | 0.9% | es/npc.json (1) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-28T18:53:17.935417Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-28T18:53:17.935417Z
- **Top 5 typów problemów:** suspicious_rejected_critical=188, suspicious_log_low=129, suspicious_log_high=61, suspicious_rejected_high=12, suspicious_log_critical=9
- **Języki o najsłabszej jakości:** es(60.1, issues=718235), de(60.1, issues=100622), nl(60.1, issues=68569), fr(60.1, issues=60621), pt(60.1, issues=55169)
...
⚠️ **TR**: jakość 63%, 50994 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 718235 problemów
⚠️ **PT**: jakość 60%, 55169 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 80%, 165404 problemów
⚠️ **RU**: jakość 65%, 352131 problemów
⚠️ **NL**: jakość 60%, 68569 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #16,912 |
| Heartbeat | 80s temu | 2026-04-28T18:53:18Z |
...
- **Ostatnia aktualizacja:** 2026-04-28T18:49:58.206607Z
...
- 2026-04-28 18:53:50 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-04-28 18:53:49 | AUTO_TRANSLATE:auto_start | ro | ok | items.json
- 2026-04-28 18:52:58 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-28 18:51:27 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-28 18:49:58 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-28 18:49:42 | AUTO_TRANSLATE:auto_done | it | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **133,887** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=4.21%, reason=increase_low_fail_rate=4.2%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-28 18:54:30
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **3,552** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 17 |
| ❌ Błędów | 149 |
| 🌍 Aktywnych języków | 9 |
| 🏆 TOP 5 | **DE** (703), **PT** (594), **NL** (411), **RU** (375), **IT** (369) |
| 📊 Porównanie | ↓ 31.5% vs wczoraj (5,188) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **26,412** kluczy
...
| 🔄 Cykli wykonanych | **#16,912** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #16,912 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-28 18:54:30  
