...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.98% / real 10.9%**. Tempo: **848.0 kluczy/h**. Tłumaczeń netto: **143,146**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 06:07:33

> **Aktualizacja:** 2026-04-29 06:07:33 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,852 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ru | Plik: items.json | Heartbeat: 2026-04-29T06:03:43Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=3.9% | przepustowość=848.0/h  
> **Tłumaczeń netto:** 143,146

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 06:07:33 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-04-29T06:03:43Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 16s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 06:07:33 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T06:05:48.943557Z |
| QUALITY | 🔒 NIEAKTYWNY | 4min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T06:03:24.613545Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 06:07:33 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T06:07:39.316355Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T06:03:43Z
...
| 🔄 **Ostatni cykl** | 192 kluczy, 1 odrzuconych, 127.0s, tryb: AUTO_TRANSLATE, cel: ru/items.json |
| ❤️ **Heartbeat** | 2026-04-29T06:03:43Z |
...
| ⏳ Oldest pending (visible tail) | 16356 s |
...
| 🌍 Recent provider mix | TM/simple(362), Free Google Translate(125), canonical_name_semantic_autofix(15), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=505, fallbacks=10) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=719/719 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 16356}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~147 dni (2,985,298 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 79.0% | 58,867/74,536 | ~14h |
| PL | ██████████████░░░░░░ | 71.0% | 52,911/74,536 | ~21h |
| IT | ██████████████░░░░░░ | 70.2% | 52,286/74,536 | ~22h |
| RO | █████████████░░░░░░░ | 69.7% | 51,972/74,536 | ~22h |
| RU | █████████░░░░░░░░░░░ | 46.0% | 34,258/74,536 | ~43h |
| FR | ███████████░░░░░░░░░ | 57.5% | 42,864/74,536 | ~33h |
| PT | ████████████████░░░░ | 81.2% | 60,516/74,536 | ~12h |
| CS | ██████████░░░░░░░░░░ | 50.3% | 37,475/74,536 | ~39h |
...
> Tempo obliczone na bazie ostatniej godziny: ~848 kluczy/h.
...
> Świeżość: 16s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 06:07:33
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T06:05:48.943557Z
...
- hoard of gold → клад золота (item.13504.name)
- hoard of gold → клад золота (item.13505.name)
- hoard of gold → клад золота (item.13506.name)
- hoard of gold → клад золота (item.13507.name)
- hoard of gold → клад золота (item.13508.name)
- hoard of gold → клад золота (item.13509.name)
- hoard of gold → клад золота (item.13510.name)
- hoard of gold → клад золота (item.13511.name)
- hoard of gold → клад золота (item.13512.name)
- sea floor → морское дно (item.13533.name)
- sea floor → морское дно (item.13534.name)
- sea floor → морское дно (item.13535.name)
- sea floor → морское дно (item.13536.name)
- sea floor → морское дно (item.13537.name)
- sea floor → морское дно (item.13538.name)
- hoard of gold → клад золота (item.13551.name)
- hoard of gold → клад золота (item.13552.name)
- hoard of gold → клад золота (item.13553.name)
- hoard of gold → клад золота (item.13554.name)
- white stone wall → Белая каменная стена (item.1356.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4811**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4664**
...
- **Pokrycie globalne (nominal):** **17.98%** (696,770/3,875,872)
- **Pokrycie globalne (real):** **10.9%** (422,341/3,875,872)
- **Kopie EN (łącznie):** **410,516**
- **Placeholdery [EN]/puste (łącznie):** **2,188,893**
...
| 🕒 Evidence window | 24h (span=35.26h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=35.26h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T05:07:33.418310Z → 2026-04-29T06:07:33.418310Z) |
...
| Przepustowość (kluczy/h) | **848.0 kluczy/h** |
| Podejrzane tłumaczenia | **1177** |
| Najgorsze cele (strażnik) | ro/items.json (gf=12), cs/items.json (gf=11), de/otclient_modules.json (gf=3), de/npc.json (gf=3), ru/items.json (gf=3) |
...
> Świeżość: 4min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T06:03:24.613545Z
...
| Heartbeat | 236s temu | 2026-04-29T06:03:43Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T06:06:04.059640Z
...
- 2026-04-29 06:06:04 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 06:05:49 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
- 2026-04-29 06:05:13 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 06:07:33

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → warn (files+1, translated+192, skipped+0) — lang=ru file=items.json strict_skipped_done=3089 guard_fail=1 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **5,350** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 122 |
| ❌ Błędów | 220 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,051), **RU** (1,045), **IT** (778), **DE** (720), **TR** (633) |
| 📊 Porównanie | ↓ 35.0% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **24,330** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 06:07:33  
