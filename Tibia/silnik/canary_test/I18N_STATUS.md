...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.29% / real 10.14%**. Tempo: **883.4 kluczy/h**. Tłumaczeń netto: **115,557**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-21 16:41:50

> **Aktualizacja:** 2026-04-21 16:41:50 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #14,187 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: monsters.json | Heartbeat: 2026-04-21T16:41:31Z  
> **Okno godzinowe:** okno=1.0h | cykli=102 | pominięte=0.0% | odrzucone=41.7% | przepustowość=883.4/h  
> **Tłumaczeń netto:** 115,557

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-21 16:41:50 |
| LIVE | 🟢 AKTYWNY | 23s temu | - | `activity.json / worker_state.json` | 2026-04-21T16:41:31Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 50s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-21 16:41:50 |
| TRANSLATION | 🟢 AKTYWNY | 31s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-21T16:41:22.874792Z |
| QUALITY | 🔒 NIEAKTYWNY | 30s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-21T16:41:24.252522Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-21 16:41:50 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 23s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-21T16:41:31Z
...
| ❤️ **Heartbeat** | 2026-04-21T16:41:31Z |
...
| 16:41:53 | ES | Serwer | monsters.json | `hard_block` | `high_reject_types` | `partial_translation_mix` | `monster.orc_warlord.voice_4` |
| 16:41:49 | ES | Serwer | monsters.json | `hard_block` | `high_reject_types` | `partial_translation_mix` | `monster.elf.voice_5` |
| 16:41:46 | ES | Serwer | monsters.json | `hard_block` | `high_reject_types` | `partial_translation_mix` | `monster.chakoya_toolshaper.voice_3` |
| 16:41:46 | ES | Serwer | monsters.json | `hard_block` | `high_reject_types` | `partial_translation_mix` | `monster.chakoya_windcaller.voice_3` |
| 16:41:46 | ES | Serwer | monsters.json | `hard_block` | `high_reject_types` | `partial_translation_mix` | `monster.elf_scout.voice_1` |
| 16:41:42 | ES | Serwer | monsters.json | `hard_block` | `critical_issue` | `garble_en_chunk, partial_translation_mix` | `monster.old_bonelord.voice_3` |
| 16:41:36 | ES | Serwer | monsters.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `monster.fallen_mooh'tah_master_ghar.desc` |
| 16:41:36 | ES | Serwer | monsters.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `monster.fallen_mooh'tah_master_ghar.name` |
| 16:41:19 | PL | Serwer | monsters.json | `hard_block` | `high_reject_types` | `partial_translation_mix` | `monster.lovely_yielothax.voice_3` |
| 16:41:13 | PL | Serwer | monsters.json | `hard_block` | `high_reject_types` | `trimmed_en_copy` | `monster.glooth_masher.desc` |
| 16:41:08 | PL | Serwer | monsters.json | `hard_block` | `high_reject_types` | `partial_translation_mix` | `monster.orc_warrior.voice_2` |
| 16:41:08 | PL | Serwer | monsters.json | `hard_block` | `high_reject_types` | `trimmed_en_copy` | `monster.chakoya_tribewarden.voice_2` |
| 16:41:03 | PL | Serwer | monsters.json | `hard_block` | `high_reject_types` | `partial_translation_mix` | `monster.goblin.voice_1` |
| 16:40:54 | PL | Serwer | monsters.json | `hard_block` | `high_reject_types` | `partial_translation_mix, trimmed_en_copy` | `monster.chakoya_windcaller.voice_3` |
| 16:40:54 | PL | Serwer | monsters.json | `hard_block` | `high_reject_types` | `partial_translation_mix` | `monster.chakoya_windcaller.voice_2` |
| 16:40:51 | PL | Serwer | monsters.json | `hard_block` | `high_reject_types` | `trimmed_en_copy` | `monster.glooth_golem.desc` |
| 16:39:57 | RU | Serwer | npc.json | `hard_block` | `high_reject_types` | `cyrillic_latin_mix` | `npc.a_dead_bureaucrat4.say_2` |
| 16:39:57 | RU | Serwer | npc.json | `hard_block` | `high_reject_types` | `cyrillic_latin_mix` | `npc.a_dead_bureaucrat3.say_2` |
| 16:39:56 | RU | Serwer | npc.json | `hard_block` | `high_reject_types` | `cyrillic_latin_mix` | `npc.a_dead_bureaucrat1.say_3` |
...
| ⏳ Oldest pending (visible tail) | 1232 s |
| 🌍 Top języki | RO(323), IT(28), NL(26), RU(8) |
| 🧱 Top reason_bucket | default(352), quality(22), word_salad(14), critical(9) |
...
> **ETA globalne:** ~142 dni (3,012,055 kluczy do celu 95%)
...
> Świeżość: 50s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-21 16:41:50
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 31s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-21T16:41:22.874792Z
...
- Raporty strażnika jakości: **3884**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3741**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 280 | 0 | 0 | - | 2026-04-21T16:41:29.807985Z |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-21T15:41:51.026685Z → 2026-04-21T16:41:51.026685Z) |
...
| Przepustowość (kluczy/h) | **883.4 kluczy/h** |
| Podejrzane tłumaczenia | **3226** |
| Najgorsze cele (strażnik) | ro/monsters.json (gf=145), fr/npc.json (gf=121), pl/npc.json (gf=120), pl/monsters.json (gf=83), pt/npc.json (gf=74) |
...
|--------|-----------|--------|----------------|
| `gt_validate_fail_identical_to_en` | 705 | 45.5% | ro/items.json (167) |
| `gt_validate_fail_placeholder` | 641 | 41.4% | it/npc.json (169) |
| `gt_rejected_critical` | 65 | 4.2% | ro/npc.json (12) |
| `gt_validate_fail_word_salad` | 56 | 3.6% | it/npc.json (13) |
| `gt_validate_fail_quality` | 46 | 3.0% | tr/npc.json (12) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 30s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-21T16:41:24.252522Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-21T16:41:24.252522Z
- **Top 5 typów problemów:** suspicious_log_high=171, suspicious_rejected_critical=120, suspicious_rejected_high=80, suspicious_log_medium=24, suspicious_log_critical=4
- **Języki o najsłabszej jakości:** es(60.1, issues=694985), ro(60.1, issues=394280), pl(61.3, issues=373856), it(61.3, issues=146193), ru(63.1, issues=316813)
...
⚠️ **TR**: jakość 85%, 27809 problemów
⚠️ **PL**: jakość 61%, 373856 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 694985 problemów
⚠️ **PT**: jakość 72%, 34380 problemów
⚠️ **FR**: jakość 66%, 49280 problemów
⚠️ **IT**: jakość 61%, 146193 problemów
⚠️ **RU**: jakość 63%, 316813 problemów
⚠️ **NL**: jakość 73%, 36650 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #14,187 |
| Heartbeat | 23s temu | 2026-04-21T16:41:31Z |
...
- **Ostatnia aktualizacja:** 2026-04-21T16:40:18.541149Z
...
- 2026-04-21 16:41:31 | AUTO_TRANSLATE:heartbeat_tick | es | ok | monsters.json
- 2026-04-21 16:41:30 | AUTO_TRANSLATE:auto_start | es | ok | monsters.json
- 2026-04-21 16:41:23 | AUTO_TRANSLATE:auto_done | pl | ok | monsters.json
- 2026-04-21 16:40:42 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | monsters.json
- 2026-04-21 16:40:42 | AUTO_TRANSLATE:auto_start | pl | ok | monsters.json
- 2026-04-21 16:40:19 | AUTO_TRANSLATE:heartbeat_tick | es | ok | otclient_modules.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **115,557** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=41.36%, reason=decrease_high_fail_rate=41.4%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 2,306 kluczy / 57 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-21 16:41:50
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+2) — repair_identical lang=es file=server.json target_identical=38 limit=108 tier=low_backlog+suspicious_guard domain_cap=240 gt=true suspicious_pct=115.97
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+99, skipped+0) — lang=es file=items.json strict_skipped_done=14841 guard_fail=19 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **2,716** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 32 |
| ❌ Błędów | 110 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **TR** (1,152), **ES** (400), **RU** (248), **PT** (169), **FR** (162) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **9,664** kluczy
...
| 🔄 Cykli wykonanych | **#14,187** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #14,187 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-21 16:41:50  
