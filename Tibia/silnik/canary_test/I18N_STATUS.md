...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 04:41:58

> **Aktualizacja:** 2026-04-29 04:41:58 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,727 | Status: ✅ BEZCZYNNY | Faza: IDLE | Etap: cycle_start | Kategoria: ru | Plik: items.json | Heartbeat: 2026-04-29T04:38:43Z
> **Okno godzinowe:** okno=1.0h | cykli=87 | pominięte=0.0% | odrzucone=3.9% | przepustowość=803.0/h  
> **Tłumaczeń netto:** 142,005

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 04:41:58 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-04-29T04:38:43Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie IDLE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 04:41:58 |
| TRANSLATION | 🔒 NIEAKTYWNY | 3min temu | worker w trybie IDLE | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T04:38:25.446112Z |
| QUALITY | 🔒 NIEAKTYWNY | 32s temu | worker w trybie IDLE | `quality_audit_latest.json` | 2026-04-29T04:41:32.922516Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 04:41:58 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T04:42:05.354759Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T04:38:43Z
...
| 🔄 **Ostatni cykl** | 37 kluczy, 1 odrzuconych, 279.0s, tryb: AUTO_TRANSLATE, cel: ru/items.json |
| ❤️ **Heartbeat** | 2026-04-29T04:38:43Z |
...
| ⏳ Oldest pending (visible tail) | 17210 s |
| 🌍 Top języki | RU(400) |
...
| 🌍 Recent provider mix | TM/simple(304), Free Google Translate(170), canonical_name_semantic_autofix(15), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=492, fallbacks=10) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=652/652 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 17210}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 04:41:58
...
> Świeżość: 3min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T04:38:25.446112Z
...
- **Profiler cyklu (ostatni):** cykl #33 (AUTO_TRANSLATE): dispatch 1373ms, mode 263824ms, status 12149ms, total 278955ms
...
| 🕒 Evidence window | 24h (span=33.83h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=33.83h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T03:41:58.826029Z → 2026-04-29T04:41:58.826029Z) |
...
> Świeżość: 32s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T04:41:32.922516Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T04:41:32.922516Z
- **Top 5 typów problemów:** suspicious_rejected_critical=187, suspicious_log_low=75, suspicious_log_medium=63, suspicious_log_high=62, suspicious_rejected_high=13
- **Języki o najsłabszej jakości:** es(60.1, issues=733540), ro(60.1, issues=432141), de(60.1, issues=115072), cs(60.1, issues=93463), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 61%, 54453 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 733540 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 70%, 172526 problemów
⚠️ **RU**: jakość 68%, 363311 problemów
...
|-----------|--------|-----------|
| Worker | ✅ BEZCZYNNY | Cykl #17,727 |
| Heartbeat | 202s temu | 2026-04-29T04:38:43Z |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 04:41:58
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **4,112** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 90 |
| ❌ Błędów | 164 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (812), **RU** (761), **IT** (658), **DE** (540), **TR** (495) |
| 📊 Porównanie | ↓ 50.0% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **23,092** kluczy
...
| 🔄 Cykli wykonanych | **#17,727** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,727 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 04:41:58  
