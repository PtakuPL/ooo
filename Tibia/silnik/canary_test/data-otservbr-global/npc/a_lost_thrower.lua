...
local function greetCallback(npc, creature)
	...
	if table.contains({ -1, 3 }, SPIKE_STORAGE) then
		NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_GREET, "npc.a_lost_thrower.greet_msg_1")
		return true
	end
	...
	if table.contains(UNDERCOVER_CONTACTED[player:getGuid()], npc:getId()) then
		NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_GREET, "npc.a_lost_thrower.greet_msg_2")
		return true
	end
	...
	NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_GREET, "npc.a_lost_thrower.greet_msg_3")
	return true
end
