...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.9% / real 10.82%**. Tempo: **810.0 kluczy/h**. Tłumaczeń netto: **138,211**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 00:01:47

> **Aktualizacja:** 2026-04-29 00:01:47 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,356 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-04-28T23:59:43Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=4.1% | przepustowość=810.0/h  
> **Tłumaczeń netto:** 138,211

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 00:01:47 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-28T23:59:43Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 55s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 00:01:47 |
| TRANSLATION | 🟢 AKTYWNY | 43s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T00:01:09.909189Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-28T23:59:42.559702Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 00:01:47 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T00:01:53.105826Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-28T23:59:43Z
...
| ❤️ **Heartbeat** | 2026-04-28T23:59:43Z |
...
| ⏳ Oldest pending (visible tail) | 16340 s |
...
| 🌍 Recent provider mix | TM/simple(266), Free Google Translate(236), canonical_name_semantic_autofix(16), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=521, fallbacks=13) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=441/441 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 390, 'oldest_s': 16340}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Tempo obliczone na bazie ostatniej godziny: ~810 kluczy/h.
...
> Świeżość: 55s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 00:01:47
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 43s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T00:01:09.909189Z
...
- wooden roof → tetto in legno (item.1189.name)
- pillar → pilastro (item.11890.name)
- pillar → pilastro (item.11891.name)
- pillar → pilastro (item.11892.name)
- stone wall → muro di pietra (item.11893.name)
- stone wall → muro di pietra (item.11894.name)
- stone wall → muro di pietra (item.11895.name)
- stone wall → muro di pietra (item.11896.name)
- tomb wall → muro della tomba (item.11898.name)
- tomb wall → muro della tomba (item.11899.name)
- wooden roof → tetto in legno (item.1190.name)
- tomb wall → muro della tomba (item.11900.name)
- tomb wall → muro della tomba (item.11901.name)
- tomb wall → muro della tomba (item.11902.name)
- tomb wall → muro della tomba (item.11903.name)
- tomb wall → muro della tomba (item.11904.name)
- tomb wall → muro della tomba (item.11905.name)
- tomb wall → muro della tomba (item.11906.name)
- tomb wall → muro della tomba (item.11907.name)
- tomb wall → muro della tomba (item.11908.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4686**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4539**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-28T23:59:59.827206Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.9%** (693,878/3,875,872)
- **Pokrycie globalne (real):** **10.82%** (419,302/3,875,872)
- **Kopie EN (łącznie):** **410,663**
- **Placeholdery [EN]/puste (łącznie):** **2,191,785**
...
| 🕒 Evidence window | 24h (span=29.16h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=29.16h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-28T23:01:47.861060Z → 2026-04-29T00:01:47.861060Z) |
...
| Przepustowość (kluczy/h) | **810.0 kluczy/h** |
...
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-28T23:59:42.559702Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-28T23:59:42.559702Z
- **Top 5 typów problemów:** suspicious_rejected_critical=193, suspicious_log_low=90, suspicious_log_high=67, suspicious_log_medium=43, suspicious_rejected_high=7
- **Języki o najsłabszej jakości:** es(60.1, issues=726300), ro(60.1, issues=425441), de(60.1, issues=108944), cs(60.1, issues=83358), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 61%, 53139 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 726300 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 69%, 168748 problemów
⚠️ **RU**: jakość 64%, 358176 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,356 |
| Heartbeat | 130s temu | 2026-04-28T23:59:43Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T00:01:24.348108Z
...
- 2026-04-29 00:01:24 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 00:01:10 | AUTO_TRANSLATE:auto_done | it | ok | items.json
- 2026-04-29 00:00:00 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-04-29 00:00:00 | AUTO_TRANSLATE:auto_start | it | ok | items.json
- 2026-04-28 23:59:41 | AUTO_TRANSLATE:auto_done | cs | ok | items.json
- 2026-04-28 23:58:21 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **138,211** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=4.44%, reason=increase_low_fail_rate=4.4%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 00:01:47

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+30, skipped+0) — lang=it file=items.json strict_skipped_done=1718 guard_fail=1 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **30** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 1 |
| ❌ Błędów | 2 |
| 🌍 Aktywnych języków | 1 |
| 🏆 TOP 5 | **IT** (30) |
| 📊 Porównanie | ↓ 99.6% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **19,010** kluczy
...
| 🔄 Cykli wykonanych | **#17,356** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,356 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 00:01:47  
