...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.65% / real 10.53%**. Tempo: **332.2 kluczy/h**. Tłumaczeń netto: **125,945**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-23 19:58:40

> **Aktualizacja:** 2026-04-23 19:58:40 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #16,328 | Status: ✅ BEZCZYNNY | Faza: IDLE | Etap: doctor_pause | Kategoria: - | Plik: - | Heartbeat: 2026-04-23T19:55:58Z  
> **Okno godzinowe:** okno=1.0h | cykli=54 | pominięte=0.0% | odrzucone=61.2% | przepustowość=332.2/h  
> **Tłumaczeń netto:** 125,945

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-23 19:58:40 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-23T19:55:58Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 31s temu | worker w trybie IDLE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-23 19:58:40 |
| TRANSLATION | 🔒 NIEAKTYWNY | 40min temu | worker w trybie IDLE | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-23T19:18:02.317840Z |
| QUALITY | 🔒 NIEAKTYWNY | 40min temu | worker w trybie IDLE | `quality_audit_latest.json` | 2026-04-23T19:18:32.407318Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-23 19:58:40 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-23T19:58:49.620626Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-23T19:55:58Z
...
| ❤️ **Heartbeat** | 2026-04-23T19:55:58Z |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=175/175 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `NO_WRITE` | ALERT | WARNING | `2422` | `900` | Brak świeżych zapisów przy pending=400. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | OK | OK | `{'pending': 400, 'oldest_s': 2888}` | `{'pending_min': 200, 'oldest_s': 3600}` | Queue bez sygnałów starvation. |
...
| �📊 Przetłumaczono | **219** kluczy |
| ❌ Odrzucone (guard) | 345 |
| 🔁 Cykli | 54 |
| 🌍 Języków | 5 |
| 🏆 Najaktywniejszy | PL (93 kluczy) |
| 📄 Najczęstszy plik | html.json |
| ⚡ Przepustowość | ~332 kluczy/h |
| 🛡️ Odrzucone (strażnik) | 61.2% |
| ⚠️ Podejrzane | 1113 |
...
> **ETA globalne:** ~376 dni (2,998,094 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 78.2% | 58,328/74,536 | ~38h |
...
| NL | ██████████████░░░░░░ | 73.9% | 55,083/74,536 | ~47h |
| PT | ███████████████░░░░░ | 76.5% | 57,024/74,536 | ~41h |
...
> Tempo obliczone na bazie ostatniej godziny: ~332 kluczy/h.
...
> Świeżość: 31s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-23 19:58:40
...
> Świeżość: 40min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-23T19:18:02.317840Z
...
| 🕒 Evidence window | 24h (span=2.74h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ❌ FAIL | window=2.74h (<24h or non-decreasing); client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=+0.00pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-23T18:58:41.037927Z → 2026-04-23T19:58:41.037927Z) |
| Cykle | **54** (TŁUMACZENIE=54, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **61.2%** |
| Cykle bez postępu % | **0.0%** |
| Przepustowość (kluczy/h) | **332.2 kluczy/h** |
| Podejrzane tłumaczenia | **1113** |
| Najgorsze cele (strażnik) | pl/questlog.json (gf=300), tr/html.json (gf=17), cs/html.json (gf=14), de/client.json (gf=4), pl/npc.json (gf=4) |
...
|--------|-----------|--------|----------------|
| `provider_chain_exhausted` | 344 | 51.8% | pl/npc.json (137) |
| `gt_validate_fail_identical_to_en` | 290 | 43.7% | pl/questlog.json (282) |
| `gt_validate_fail_quality` | 11 | 1.7% | pl/questlog.json (10) |
| `gt_validate_fail_placeholder` | 6 | 0.9% | pl/questlog.json (6) |
| `gt_rejected_critical` | 5 | 0.8% | tr/html.json (3) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie IDLE)  
> Świeżość: 40min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-23T19:18:32.407318Z
...
| Heartbeat | 171s temu | 2026-04-23T19:55:58Z |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-23 19:58:40
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-23 19:58:40  
