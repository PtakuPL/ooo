...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 11:26:36

> **Aktualizacja:** 2026-04-29 11:26:36 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,304 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ro | Plik: items.json | Heartbeat: 2026-04-29T11:25:55Z
...
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 11:26:36 |
| LIVE | 🟢 AKTYWNY | 47s temu | - | `activity.json / worker_state.json` | 2026-04-29T11:25:55Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 41s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 11:26:36 |
| TRANSLATION | 🟢 AKTYWNY | 3min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T11:22:43.602245Z |
| QUALITY | 🔒 NIEAKTYWNY | 49s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T11:25:53.238337Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 11:26:36 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T11:26:42.927994Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 47s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T11:25:55Z
...
| ❤️ **Heartbeat** | 2026-04-29T11:25:55Z |
...
| ⏳ Oldest pending (visible tail) | 16168 s |
...
| 🌍 Recent provider mix | TM/simple(322), Free Google Translate(152), canonical_name_semantic_autofix(16), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=493, fallbacks=25) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=966/966 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 385, 'oldest_s': 16168}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 41s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 11:26:36
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T11:22:43.602245Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T11:26:23.196012Z |
...
| 🕒 Evidence window | 24h (span=40.57h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=40.57h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T10:26:37.160464Z → 2026-04-29T11:26:37.160464Z) |
...
> Świeżość: 49s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T11:25:53.238337Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T11:25:53.238337Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=745698), ro(60.1, issues=441028), de(60.1, issues=123827), cs(60.1, issues=111443), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 61%, 57166 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 745698 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 75%, 177360 problemów
⚠️ **RU**: jakość 66%, 371194 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,304 |
| Heartbeat | 47s temu | 2026-04-29T11:25:55Z |
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **146,962** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=6.78%, reason=stable_fail_rate=6.8%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 11:26:36
...
| 🔄 Cykli wykonanych | **#18,304** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,304 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 11:26:36  
