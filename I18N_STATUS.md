...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 13:07:42

> **Aktualizacja:** 2026-04-29 13:07:42 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,440 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: items.json | Heartbeat: 2026-04-29T13:07:06Z
...
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 13:07:42 |
| LIVE | 🟢 AKTYWNY | 43s temu | - | `activity.json / worker_state.json` | 2026-04-29T13:07:06Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 13:07:42 |
| TRANSLATION | 🟢 AKTYWNY | 3min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T13:04:39.096884Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T13:06:37.868669Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 13:07:42 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T13:07:49.428644Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 43s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T13:07:06Z
...
| ❤️ **Heartbeat** | 2026-04-29T13:07:06Z |
...
| ⏳ Oldest pending (visible tail) | 17309 s |
...
| 🌍 Recent provider mix | TM/simple(294), Free Google Translate(163), canonical_name_semantic_autofix(17), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=477, fallbacks=25) |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 395, 'oldest_s': 17309}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 13:07:42
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T13:04:39.096884Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T13:07:05.348031Z |
...
| 🕒 Evidence window | 24h (span=42.26h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=42.26h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T12:07:42.428381Z → 2026-04-29T13:07:42.428381Z) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T13:06:37.868669Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T13:06:37.868669Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=748556), ro(60.1, issues=443159), de(60.1, issues=125694), cs(60.1, issues=116071), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 748556 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 71%, 178336 problemów
⚠️ **RU**: jakość 61%, 373000 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,440 |
| Heartbeat | 43s temu | 2026-04-29T13:07:06Z |
...
- 2026-04-29 13:07:05 | AUTO_TRANSLATE:auto_start | es | ok | items.json
- 2026-04-29 13:06:27 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **148,172** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=6.11%, reason=stable_fail_rate=6.1%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 13:07:42
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+66, skipped+0) — lang=ro file=items.json strict_skipped_done=3758 guard_fail=51 placeholder=0 command=0 pipe=0
...
| 🔄 Cykli wykonanych | **#18,440** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,440 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 13:07:42  
