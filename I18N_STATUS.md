...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.84%**. Tempo: **1656.4 kluczy/h**. Tłumaczeń netto: **115,319**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 17:28:35

> **Aktualizacja:** 2026-02-20 17:28:35 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #5 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: - | Heartbeat: 2026-02-20T17:28:31Z  
> **Okno godzinowe:** okno=1.0h | cykli=148 | pominięte=0.0% | odrzucone=65.5% | przepustowość=1656.4/h  
> **Tłumaczeń netto:** 115,319

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 17:28:35 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T17:28:31Z |
| MIGRATION | 🔒 NIEAKTYWNY | 52s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 17:28:35 |
| TRANSLATION | 🟢 AKTYWNY | 42s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T17:27:53.795418Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T17:28:36.086128Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 17:28:35 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T17:28:31Z
...
| ❤️ **Heartbeat** | 2026-02-20T17:28:31Z |
...
| ❌ Odrzucone (guard) | 5438 |
| 🔁 Cykli | 148 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (636 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~1656 kluczy/h |
| 🛡️ Guard fail rate | 65.5% |
| ⚠️ Podejrzane | 25142 |
| 🌐 GT aktywny (1h) | ✅ TAK |
| 🔤 GT tłumaczeń (1h) | 96 |
...
> Tempo obliczone na bazie ostatniej godziny: ~1656 kluczy/h.
...
> Świeżość: 52s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 17:28:35
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 42s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T17:27:53.795418Z
...
- Raporty strażnika jakości: **6643**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3751**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T16:28:35.406610Z → 2026-02-20T17:28:35.406610Z) |
| Cykle | **148** (TŁUMACZENIE=148, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **65.5%** |
| Cykle bez postępu % | **5.1%** |
| Przepustowość (kluczy/h) | **1656.4 kluczy/h** |
| Podejrzane tłumaczenia | **3863** |
| Najgorsze cele (strażnik) | pl/items.json (gf=1672), es/items.json (gf=1549), pl/npc.json (gf=666), es/server.json (gf=183), ro/monsters.json (gf=182) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T17:28:36.086128Z

- **Ostatni audyt:** SLOW_MODE | 32 issue(s) / 100 entries | 2026-02-20T17:28:31.175805Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=144, suspicious_log_high=62, suspicious_log_critical=44, artifact_token=32, suspicious_rejected_high=25
- **Języki o najsłabszej jakości:** es(60.1, issues=320464), ro(60.1, issues=175103), sr(60.7, issues=86013), it(61.4, issues=70397), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 66%, 180862 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 320464 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 61%, 70397 problemów
⚠️ **RU**: jakość 65%, 210074 problemów
...
| Heartbeat | 5s temu | 2026-02-20T17:28:31Z |
...
- 2026-02-20 17:28:02 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 17:27:46 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | quests.json
- 2026-02-20 17:27:46 | AUTO_TRANSLATE:parallel_start | ro | ok | quests.json
- 2026-02-20 17:27:40 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | quests.json
- 2026-02-20 17:27:40 | AUTO_TRANSLATE:parallel_start | ru | ok | quests.json
- 2026-02-20 17:27:38 | AUTO_TRANSLATE:auto_done | it | ok | quests.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **115,319** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=50.96%, reason=decrease_high_fail_rate=51.0% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 17:28:35
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **3,858** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 17 |
| ❌ Błędów | 82 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (997), **RU** (730), **IT** (700), **RO** (460), **PL** (417) |
| 📊 Porównanie | ↑ 6.0% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **101,443** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 17:28:35  
