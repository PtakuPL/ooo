...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.99% / real 10.91%**. Tempo: **779.0 kluczy/h**. Tłumaczeń netto: **144,231**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 07:33:08

> **Aktualizacja:** 2026-04-29 07:33:08 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,972 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: server.json | Heartbeat: 2026-04-29T07:30:32Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=5.1% | przepustowość=779.0/h  
> **Tłumaczeń netto:** 144,231

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 07:33:08 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T07:30:32Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 43s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 07:33:08 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T07:31:18.666159Z |
| QUALITY | 🔒 NIEAKTYWNY | 3min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T07:30:14.010304Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 07:33:08 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T07:33:15.507499Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T07:30:32Z
...
| 🔄 **Ostatni cykl** | 41 kluczy, 0 odrzuconych, 47.0s, tryb: AUTO_TRANSLATE, cel: tr/items.json |
| ❤️ **Heartbeat** | 2026-04-29T07:30:32Z |
...
| ⏳ Oldest pending (visible tail) | 17167 s |
...
| 🌍 Recent provider mix | TM/simple(317), Free Google Translate(164), canonical_name_semantic_autofix(15), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=499, fallbacks=20) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=785/785 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 397, 'oldest_s': 17167}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~160 dni (2,984,682 kluczy do celu 95%)
...
> Świeżość: 43s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 07:33:08
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T07:31:18.666159Z
...
- Raporty strażnika jakości: **4841**  
- Raporty blokad: **0**  
...
- **Pokrycie globalne (nominal):** **17.99%** (697,386/3,875,872)
- **Pokrycie globalne (real):** **10.91%** (422,987/3,875,872)
- **Kopie EN (łącznie):** **410,486**
- **Placeholdery [EN]/puste (łącznie):** **2,188,277**
...
| 🕒 Evidence window | 24h (span=36.68h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=36.68h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T06:33:08.887819Z → 2026-04-29T07:33:08.887819Z) |
...
> Świeżość: 3min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T07:30:14.010304Z
...
| Heartbeat | 163s temu | 2026-04-29T07:30:32Z |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 07:33:08
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [tr] → warn (files+1, translated+41, skipped+0) — lang=tr file=items.json strict_skipped_done=2703
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **6,540** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 152 |
| ❌ Błędów | 272 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,257), **RU** (1,159), **TR** (954), **IT** (905), **DE** (900) |
| 📊 Porównanie | ↓ 20.5% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **25,520** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 07:33:08  
