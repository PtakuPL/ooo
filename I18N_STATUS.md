...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.02% / real 10.94%**. Tempo: **628.0 kluczy/h**. Tłumaczeń netto: **146,190**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 10:15:07

> **Aktualizacja:** 2026-04-29 10:15:07 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,204 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: cs | Plik: items.json | Heartbeat: 2026-04-29T10:14:27Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=5.3% | przepustowość=628.0/h  
> **Tłumaczeń netto:** 146,190

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 10:15:07 |
| LIVE | 🟢 AKTYWNY | 46s temu | - | `activity.json / worker_state.json` | 2026-04-29T10:14:27Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 34s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 10:15:07 |
| TRANSLATION | 🟢 AKTYWNY | 47s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T10:14:25.863021Z |
| QUALITY | 🔒 NIEAKTYWNY | 46s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T10:14:27.071689Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 10:15:07 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T10:15:13.325164Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 46s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T10:14:27Z
...
| 🔄 **Ostatni cykl** | 30 kluczy, 1 odrzuconych, 75.0s, tryb: AUTO_TRANSLATE, cel: ru/items.json |
| ❤️ **Heartbeat** | 2026-04-29T10:14:27Z |
...
| ⏳ Oldest pending (visible tail) | 14997 s |
...
| ♻️ Deferred stats | enqueued=32, cooldown=1, deduped=1, manual_review=4, partial_staged=0, partial_completed=0 |
...
| 🌍 Recent provider mix | TM/simple(335), Free Google Translate(152), canonical_name_semantic_autofix(15), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=505, fallbacks=28) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=911/911 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
|-------|--------|----------|-------|-----------|--------|
| `HEARTBEAT_STALE` | OK | OK | `12` | `300` | Heartbeat świeży (12s, src=worker_runtime_heartbeat) Runtime[status=healthy, reason=heartbeat_fresh, phase=... |
| `NO_WRITE` | OK | OK | `55` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 386, 'oldest_s': 14997}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Tempo obliczone na bazie ostatniej godziny: ~628 kluczy/h.
...
> Świeżość: 34s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 10:15:07
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 47s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T10:14:25.863021Z
...
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14318.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14319.name)
- ornamented wall → орнаментированная стена (item.1432.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14320.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14321.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14322.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14323.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14324.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14325.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14326.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14327.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14328.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14329.name)
- ornamented wall → орнаментированная стена (item.1433.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14330.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14331.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14332.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14333.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14334.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14335.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4898**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4751**
...
- **Pokrycie globalne (nominal):** **18.02%** (698,371/3,875,872)
- **Pokrycie globalne (real):** **10.94%** (424,023/3,875,872)
- **Kopie EN (łącznie):** **410,435**
- **Placeholdery [EN]/puste (łącznie):** **2,187,292**
...
| 🕒 Evidence window | 24h (span=39.38h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=39.38h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T09:15:07.417561Z → 2026-04-29T10:15:07.417561Z) |
...
| Przepustowość (kluczy/h) | **628.0 kluczy/h** |
| Podejrzane tłumaczenia | **1091** |
| Najgorsze cele (strażnik) | cs/items.json (gf=16), ro/items.json (gf=8), de/otclient_modules.json (gf=3), de/npc.json (gf=3), ru/items.json (gf=3) |
...
> Świeżość: 46s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T10:14:27.071689Z
...
| Heartbeat | 46s temu | 2026-04-29T10:14:27Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T10:10:41.518350Z
...
- 2026-04-29 10:13:11 | AUTO_TRANSLATE:auto_start | ru | ok | items.json
- 2026-04-29 10:12:12 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 10:15:07
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+0, translated+0, skipped+0) — lang=it file=libs.json strict_skipped_done=63
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **8,691** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 185 |
| ❌ Błędów | 372 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,547), **RU** (1,538), **IT** (1,286), **TR** (1,237), **DE** (1,215) |
| 📊 Porównanie | ↑ 5.6% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **27,671** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 10:15:07  
