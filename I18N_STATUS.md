...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.98% / real 10.9%**. Tempo: **845.0 kluczy/h**. Tłumaczeń netto: **143,307**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 06:22:00

> **Aktualizacja:** 2026-04-29 06:22:00 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,872 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: de | Plik: otclient_modules.json | Heartbeat: 2026-04-29T06:18:16Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=4.4% | przepustowość=845.0/h  
> **Tłumaczeń netto:** 143,307

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 06:22:00 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-04-29T06:18:16Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 06:22:00 |
| TRANSLATION | 🟢 AKTYWNY | 4min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T06:18:01.191618Z |
| QUALITY | 🔒 NIEAKTYWNY | 49s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T06:21:17.643546Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 06:22:00 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T06:22:07.606370Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T06:18:16Z
...
| 🔄 **Ostatni cykl** | 19 kluczy, 0 odrzuconych, 73.0s, tryb: AUTO_TRANSLATE, cel: es/items.json |
| ❤️ **Heartbeat** | 2026-04-29T06:18:16Z |
...
| ⏳ Oldest pending (visible tail) | 17224 s |
...
| 🌍 Recent provider mix | TM/simple(321), Free Google Translate(140), canonical_name_semantic_autofix(20), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=484, fallbacks=17) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=730/730 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 17224}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 06:22:00
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 4min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T06:18:01.191618Z
...
- Raporty strażnika jakości: **4815**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4668**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T06:21:44.404052Z |
...
| 🕒 Evidence window | 24h (span=35.50h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=35.50h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T05:22:00.617686Z → 2026-04-29T06:22:00.617686Z) |
...
| Najgorsze cele (strażnik) | cs/items.json (gf=18), ro/items.json (gf=12), it/items.json (gf=3), de/otclient_modules.json (gf=2), de/npc.json (gf=2) |
...
> Świeżość: 49s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T06:21:17.643546Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T06:21:17.643546Z
- **Top 5 typów problemów:** suspicious_rejected_critical=188, suspicious_log_low=113, suspicious_log_high=85, suspicious_rejected_high=12, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=736822), ro(60.1, issues=434656), de(60.1, issues=117274), cs(60.1, issues=97876), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 736822 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 62%, 173777 problemów
⚠️ **RU**: jakość 71%, 365241 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,872 |
| Heartbeat | 231s temu | 2026-04-29T06:18:16Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T06:18:16.095168Z
...
- 2026-04-29 06:21:45 | AUTO_TRANSLATE:auto_start | de | ok | otclient_modules.json
- 2026-04-29 06:19:47 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 06:18:16 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 06:18:01 | AUTO_TRANSLATE:auto_done | es | ok | items.json
- 2026-04-29 06:16:48 | AUTO_TRANSLATE:heartbeat_tick | es | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **143,307** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=3.73%, reason=increase_low_fail_rate=3.7%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 06:22:00

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [tr] → warn (files+1, translated+30, skipped+0) — lang=tr file=items.json strict_skipped_done=804
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **5,519** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 126 |
| ❌ Błędów | 227 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,122), **RU** (1,045), **IT** (808), **DE** (720), **TR** (633) |
| 📊 Porównanie | ↓ 32.9% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **24,499** kluczy
...
| 🔄 Cykli wykonanych | **#17,872** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,872 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 06:22:00  
