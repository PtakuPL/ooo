#ifndef __SRC_LUA_FUNCTIONS_CREATURES_CREATURE_FUNCTIONS_HPP_
#define __SRC_LUA_FUNCTIONS_CREATURES_CREATURE_FUNCTIONS_HPP_
...
#endif // __SRC_LUA_FUNCTIONS_CREATURES_CREATURE_FUNCTIONS_HPP_
