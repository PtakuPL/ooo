...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.81%**. Tempo: **1219.2 kluczy/h**. Tłumaczeń netto: **113,088**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 16:27:44

> **Aktualizacja:** 2026-02-20 16:27:44 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #6 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: pl | Plik: - | Heartbeat: 2026-02-20T16:27:40Z  
> **Okno godzinowe:** okno=1.0h | cykli=22 | pominięte=0.0% | odrzucone=79.9% | przepustowość=1219.2/h  
> **Tłumaczeń netto:** 113,088

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 16:27:44 |
| LIVE | 🟢 AKTYWNY | 4s temu | - | `activity.json / worker_state.json` | 2026-02-20T16:27:40Z |
| MIGRATION | 🔒 NIEAKTYWNY | 35s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 16:27:44 |
| TRANSLATION | 🟢 AKTYWNY | 6s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T16:27:38.069382Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T16:27:44.700978Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 16:27:44 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 4s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T16:27:40Z
...
| ❤️ **Heartbeat** | 2026-02-20T16:27:40Z |
...
> **ETA globalne:** ~77 dni (2,262,297 kluczy do celu 95%)
...
> Świeżość: 35s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 16:27:44
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T16:27:38.069382Z
...
- Raporty strażnika jakości: **6544**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3652**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T15:27:44.534925Z → 2026-02-20T16:27:44.534925Z) |
| Cykle | **22** (TŁUMACZENIE=22, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **79.9%** |
| Cykle bez postępu % | **6.7%** |
| Przepustowość (kluczy/h) | **1219.2 kluczy/h** |
| Podejrzane tłumaczenia | **235** |
| Najgorsze cele (strażnik) | pl/items.json (gf=836), pl/npc.json (gf=666), ro/monsters.json (gf=42), es/spells.json (gf=42), pl/spells.json (gf=36) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T16:27:44.700978Z

- **Ostatni audyt:** SLOW_MODE | 54 issue(s) / 100 entries | 2026-02-20T16:27:40.351347Z | recent_hidden=0
- **Alarm recent hidden HIGH/CRITICAL:** ✅ OK | hidden=0, threshold=5, trend=→ last10=0.00, prev10=0.00, latest=0
- **Regresja critical bad keys pack:** 🚨 FAIL: pl(critical=30, pack=0), es(critical=20, pack=0)
- **Top 5 typów problemów:** suspicious_rejected_critical=156, suspicious_log_critical=86, suspicious_log_high=72, artifact_token=48, suspicious_rejected_high=44
- **Języki o najsłabszej jakości:** es(60.1, issues=314609), pl(60.1, issues=177968), ro(60.1, issues=171898), sr(60.5, issues=85529), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 60%, 177968 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 314609 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 68%, 69264 problemów
⚠️ **RU**: jakość 86%, 208274 problemów
...
| Heartbeat | 4s temu | 2026-02-20T16:27:40Z |
...
- 2026-02-20 16:27:08 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 16:27:08 | AUTO_TRANSLATE:parallel_start | es | ok | npc.json
- 2026-02-20 16:27:06 | AUTO_TRANSLATE:auto_done | pl | ok | npc.json
- 2026-02-20 16:26:44 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | npc.json
- 2026-02-20 16:26:44 | AUTO_TRANSLATE:auto_start | pl | ok | npc.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.7% | 0 | 1,827 | 594 | 4856 (89.1%) | 38 |
| 🟡 ES | 84.5% | 0 | 2,160 | 510 | 1530 (75.0%) | 38 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **113,088** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=82.07%, reason=decrease_high_fail_rate=82.1% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,104 kluczy / 76 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 16:27:44
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ro] → ok (translated+35, skipped+0) — parallel lang=ro file=scripts.json
...
| ❌ Błędów | 11 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (100), **RU** (94), **IT** (86), **RO** (82), **SR** (50) |
| 📊 Porównanie | ↓ 86.2% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **98,086** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 16:27:44  
