...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.89%**. Tempo: **1597.8 kluczy/h**. Tłumaczeń netto: **124,728**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 21:51:59

> **Aktualizacja:** 2026-02-20 21:51:59 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #224 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: pl | Plik: - | Heartbeat: 2026-02-20T21:51:55Z  
> **Okno godzinowe:** okno=1.0h | cykli=201 | pominięte=0.0% | odrzucone=69.1% | przepustowość=1597.8/h  
> **Tłumaczeń netto:** 124,728

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 21:51:59 |
| LIVE | 🟢 AKTYWNY | 6s temu | - | `activity.json / worker_state.json` | 2026-02-20T21:51:55Z |
| MIGRATION | 🔒 NIEAKTYWNY | 8s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 21:51:59 |
| TRANSLATION | 🟢 AKTYWNY | 7s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T21:51:53.824790Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T21:52:01.031623Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 21:51:59 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T21:51:55Z
...
| ❤️ **Heartbeat** | 2026-02-20T21:51:55Z |
...
> Świeżość: 8s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 21:51:59
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 7s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T21:51:53.824790Z
...
- Raporty strażnika jakości: **7198**  
- Raporty blokad: **0**  
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T20:52:00.314563Z → 2026-02-20T21:52:00.314563Z) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T21:52:01.031623Z
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #224 |
| Heartbeat | 6s temu | 2026-02-20T21:51:55Z |
...
- 2026-02-20 21:51:35 | AUTO_TRANSLATE:parallel_start | it | ok | npc.json
- 2026-02-20 21:51:29 | AUTO_TRANSLATE:heartbeat_tick | es | ok | monsters.json
- 2026-02-20 21:51:28 | AUTO_TRANSLATE:parallel_start | es | ok | monsters.json
- 2026-02-20 21:51:27 | AUTO_TRANSLATE:auto_done | pl | ok | monsters.json
- 2026-02-20 21:51:21 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | monsters.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,830 | 671 | 5516 (89.2%) | 37 |
| 🟡 ES | 84.9% | 0 | 2,160 | 632 | 2627 (80.6%) | 39 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **124,728** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=92.43%, reason=decrease_high_fail_rate=92.4% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,303 kluczy / 76 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 21:51:59
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+35, skipped+0) — lang=it file=quests.json strict_skipped_done=575 guard_fail=12 placeholder=0 command=0 pipe=0
...
| 🔄 Cykli wykonanych | **#224** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 21:51:59  
