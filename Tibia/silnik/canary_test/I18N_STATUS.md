...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.97% / real 10.89%**. Tempo: **813.0 kluczy/h**. Tłumaczeń netto: **142,428**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 05:17:48

> **Aktualizacja:** 2026-04-29 05:17:48 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,780 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: de | Plik: npc.json | Heartbeat: 2026-04-29T05:15:51Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=4.5% | przepustowość=813.0/h  
> **Tłumaczeń netto:** 142,428

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 05:17:48 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T05:15:51Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 37s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 05:17:48 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T05:16:34.462406Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T05:15:50.852006Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 05:17:48 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T05:17:54.170867Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T05:15:51Z
...
| ❤️ **Heartbeat** | 2026-04-29T05:15:51Z |
...
| 05:02:43 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 04:59:35 | RU | Serwer | items.json | 30 | `simple` | `item.13190.name` | структура улья |
| 04:58:05 | TR | Serwer | items.json | 30 | `simple` | `item.12164.name` | bilinmeyen eşya |
| 04:56:53 | ES | Serwer | server.json | 2 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 04:54:56 | DE | Serwer | npc.json | 30 | `tm` | `npc.a_dead_bureaucrat1.say_1` | Klar, wo sonst. Jeder trifft gerne meinen Meister, er ist ein großer Dämon, nicht wah... |
| 04:54:12 | DE | Klient | otclient_modules.json | 15 | `tm` | `otclient_modules.blessing.tr_11` | - Abhängig von den Regeln des fairen Kampfes verlierst du zwischendurch |
| 04:53:23 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 04:50:07 | ES | Serwer | items.json | 20 | `simple` | `item.11518.name` | junk flotante |
| 04:48:35 | RO | Serwer | items.json | 39 | `google_translate` | `item.10216.name` | kit statuie dragon |
| 04:46:54 | ES | Serwer | server.json | 2 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 04:44:57 | IT | Serwer | items.json | 30 | `simple` | `item.12983.name` | struttura dell'alveare |
| 04:43:20 | CS | Serwer | items.json | 81 | `google_translate` | `item.13551.name` | hromada zlata |
...
| 05:09:24 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10193.name` |
| 05:09:22 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10192.name` |
| 05:09:20 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10191.name` |
| 05:09:19 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10190.name` |
| 05:05:33 | IT | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 05:03:59 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.11586.name` |
| 05:03:57 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 05:03:55 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10456.name` |
| 05:03:54 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10338.name` |
| 05:03:52 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10026.name` |
| 05:01:40 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.say_2` |
| 04:59:08 | RU | Serwer | items.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `item.11541.name` |
| 04:54:51 | DE | Serwer | npc.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `npc.a_fluffy_squirrel.stdmod_1` |
| 04:54:09 | DE | Klient | otclient_modules.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `otclient_modules.charms.tr_34` |
| 04:52:22 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.say_1` |
| 04:52:20 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.multi_1` |
...
| ⏳ Oldest pending (visible tail) | 18041 s |
| 🌍 Top języki | RU(400) |
| 🧱 Top reason_bucket | quality(400) |
| 🗂️ Deferred state keys | 7824 |
| 🕒 Deferred state freshness | fresh (77s) |
...
| 🌍 Recent provider mix | TM/simple(356), Free Google Translate(117), canonical_name_semantic_autofix(18), term_consistency_autofix(3) |
| 🔁 Latest fallback | TM/simple → fallback to google translate high [high_reject_types] server.json |
| 📉 Fallback breakdown | fallback to next provider validate fail(10), fallback to google translate high(8), fallback to google trans... |
...
| ❤️ Pool health | `critical` (writes=494, fallbacks=20) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=680/680 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
|-------|--------|----------|-------|-----------|--------|
| `HEARTBEAT_STALE` | OK | OK | `85` | `300` | Heartbeat świeży (85s, src=worker_runtime_heartbeat) Runtime[status=healthy, reason=heartbeat_fresh, phase=... |
| `NO_WRITE` | OK | OK | `83` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 18041}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| �📊 Przetłumaczono | **813** kluczy |
| ❌ Odrzucone (guard) | 38 |
| 🔁 Cykli | 88 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | CS (283 kluczy) |
| 📄 Najczęstszy plik | items.json |
| ⚡ Przepustowość | ~813 kluczy/h |
...
> Tempo obliczone na bazie ostatniej godziny: ~813 kluczy/h.
...
> Świeżość: 37s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 05:17:48
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T05:16:34.462406Z
...
|-------|-----------|--------|----------|--------------|--------------|
| ES (Hiszpański) | 78.94% (58,841/74,536) | 67.77% (50,511/74,536) | 9,719 | 14,330 | 0 |
| PL (Polski) | 70.99% (52,911/74,536) | 65.08% (48,507/74,536) | 5,861 | 20,194 | 0 |
| IT (Włoski) | 70.07% (52,226/74,536) | 61.85% (46,102/74,536) | 10,028 | 18,431 | 0 |
| RO (Rumuński) | 69.73% (51,972/74,536) | 56.69% (42,253/74,536) | 13,005 | 19,303 | 0 |
| RU (Rosyjski) | 45.75% (34,100/74,536) | 44.18% (32,930/74,536) | 4,775 | 36,849 | 0 |
...
| CS (Czeski) | 50.15% (37,381/74,536) | 32.38% (24,135/74,536) | 29,858 | 20,569 | 0 |
...
| TR (Turecki) | 33.84% (25,222/74,536) | 30.35% (22,625/74,536) | 3,832 | 48,093 | 0 |
...
- Raporty strażnika jakości: **4793**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4646**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T05:16:09.862447Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.97%** (696,324/3,875,872)
- **Pokrycie globalne (real):** **10.89%** (421,894/3,875,872)
- **Kopie EN (łącznie):** **410,517**
- **Placeholdery [EN]/puste (łącznie):** **2,189,339**
...
| 🕒 Evidence window | 24h (span=34.43h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=34.43h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T04:17:48.496541Z → 2026-04-29T05:17:48.496541Z) |
...
| Przepustowość (kluczy/h) | **813.0 kluczy/h** |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 58 | 90.6% | ru/items.json (58) |
| `existing_canonical_name_quality_mixed_scripts` | 6 | 9.4% | ru/items.json (6) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T05:15:50.852006Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T05:15:50.852006Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=734706), ro(60.1, issues=433033), de(60.1, issues=115825), cs(60.1, issues=95006), fr(60.1, issues=60621)
- **Pliki:** `i18n/status/quality_audit_latest.json`, `i18n/status/quality_dashboard.json`, `i18n/status/quality_report.jsonl`

### 📈 Statystyki Pracy
| Metryka | Wartość | Info |
|---------|---------|------|
| 🔄 Cykl aktualny | **#47** | od uruchomienia |
...
⚠️ **TR**: jakość 71%, 54579 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 734706 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 62%, 172998 problemów
⚠️ **RU**: jakość 67%, 363959 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,780 |
| Heartbeat | 123s temu | 2026-04-29T05:15:51Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T05:16:50.813349Z
...
- 2026-04-29 05:16:51 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-29 05:16:34 | AUTO_TRANSLATE:auto_done | de | ok | npc.json
- 2026-04-29 05:16:11 | AUTO_TRANSLATE:heartbeat_tick | de | ok | npc.json
- 2026-04-29 05:16:10 | AUTO_TRANSLATE:auto_start | de | ok | npc.json
- 2026-04-29 05:15:49 | AUTO_TRANSLATE:auto_done | de | ok | otclient_modules.json
- 2026-04-29 05:15:27 | AUTO_TRANSLATE:heartbeat_tick | de | ok | otclient_modules.json
...
| 🟡 ES | 78.9% | 0 | 9,719 | 543 | 0 (0.0%) | 25 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **142,428** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=4.96%, reason=increase_low_fail_rate=5.0%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 543 kluczy / 25 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 05:17:48
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+2) — repair_identical lang=es file=server.json target_identical=9 limit=108 tier=low_backlog+suspicious_guard domain_cap=240 gt=true suspicious_pct=518.82
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → warn (files+1, translated+72, skipped+0) — lang=ru file=items.json strict_skipped_done=854
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → warn (files+1, translated+21, skipped+0) — lang=ru file=server.json strict_skipped_done=636 guard_fail=225 placeholder=6 command=0 pipe=1
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+63, skipped+0) — lang=it file=items.json strict_skipped_done=16912 guard_fail=28 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+64, skipped+0) — lang=pl file=npc.json strict_skipped_done=8491 guard_fail=204 placeholder=119 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+7) — repair_identical lang=es file=talkactions.json target_identical=7 limit=108 tier=low_backlog+suspicious_guard domain_cap=200 gt=true suspicious_pct=58.50
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **4,578** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 104 |
| ❌ Błędów | 189 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (934), **RU** (791), **IT** (718), **DE** (630), **TR** (525) |
| 📊 Porównanie | ↓ 44.4% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **23,558** kluczy
...
| 🔄 Cykli wykonanych | **#17,780** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,780 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 05:17:48  
