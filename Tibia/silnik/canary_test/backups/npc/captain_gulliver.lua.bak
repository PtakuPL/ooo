...
local function addTravelKeyword(keyword, cost, destination, action)
	local travelKeyword = keywordHandler:addKeyword({ keyword }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.captain_gulliver.stdmod_2", i18nArgs = { keyword:titleCase() }, cost = cost, discount = "postman" })
