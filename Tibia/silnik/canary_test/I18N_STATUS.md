...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.02% / real 10.94%**. Tempo: **605.0 kluczy/h**. Tłumaczeń netto: **146,086**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 10:07:56

> **Aktualizacja:** 2026-04-29 10:07:56 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,188 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: de | Plik: otclient_modules.json | Heartbeat: 2026-04-29T10:05:14Z
> **Okno godzinowe:** okno=1.0h | cykli=80 | pominięte=0.0% | odrzucone=5.9% | przepustowość=605.0/h  
> **Tłumaczeń netto:** 146,086

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 10:07:56 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T10:05:14Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 44s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 10:07:56 |
| TRANSLATION | 🟢 AKTYWNY | 3min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T10:04:56.625084Z |
| QUALITY | 🔒 NIEAKTYWNY | 3min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T10:04:14.455018Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 10:07:56 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T10:08:02.871920Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T10:05:14Z
...
| ❤️ **Heartbeat** | 2026-04-29T10:05:14Z |
...
| ⏳ Oldest pending (visible tail) | 15934 s |
...
| 🌍 Recent provider mix | TM/simple(338), Free Google Translate(137), canonical_name_semantic_autofix(18), term_consistency_autofix(3) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=904/904 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `NO_WRITE` | OK | OK | `193` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 386, 'oldest_s': 15934}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~205 dni (2,983,732 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 79.1% | 58,941/74,536 | ~20h |
| PL | ██████████████░░░░░░ | 71.0% | 52,911/74,536 | ~30h |
| IT | ██████████████░░░░░░ | 70.8% | 52,794/74,536 | ~30h |
| RO | █████████████░░░░░░░ | 69.7% | 51,972/74,536 | ~31h |
| RU | █████████░░░░░░░░░░░ | 46.1% | 34,399/74,536 | ~3d |
...
> Tempo obliczone na bazie ostatniej godziny: ~605 kluczy/h.
...
> Świeżość: 44s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 10:07:56
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T10:04:56.625084Z
...
- Raporty strażnika jakości: **4895**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4748**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T10:04:32.196434Z |
...
| 🕒 Evidence window | 24h (span=39.26h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=39.26h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T09:07:56.722094Z → 2026-04-29T10:07:56.722094Z) |
...
| Przepustowość (kluczy/h) | **605.0 kluczy/h** |
| Podejrzane tłumaczenia | **953** |
| Najgorsze cele (strażnik) | cs/items.json (gf=16), ro/items.json (gf=12), it/items.json (gf=3), de/otclient_modules.json (gf=3), de/npc.json (gf=2) |
...
> Świeżość: 3min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T10:04:14.455018Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T10:04:14.455018Z
- **Top 5 typów problemów:** suspicious_rejected_critical=189, suspicious_log_high=110, suspicious_log_low=88, suspicious_rejected_high=11, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=743305), ro(60.1, issues=439373), de(60.1, issues=121981), cs(60.1, issues=107587), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 743305 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 66%, 176466 problemów
⚠️ **RU**: jakość 61%, 369801 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,188 |
| Heartbeat | 168s temu | 2026-04-29T10:05:14Z |
...
- 2026-04-29 10:05:14 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 10:04:57 | AUTO_TRANSLATE:auto_done | de | ok | otclient_modules.json
- 2026-04-29 10:04:33 | AUTO_TRANSLATE:heartbeat_tick | de | ok | otclient_modules.json
- 2026-04-29 10:04:32 | AUTO_TRANSLATE:auto_start | de | ok | otclient_modules.json
- 2026-04-29 10:04:13 | AUTO_TRANSLATE:auto_done | es | ok | items.json
...
| 🟡 ES | 79.1% | 0 | 9,643 | 555 | 0 (0.0%) | 26 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **146,086** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=5.5%, reason=stable_fail_rate=5.5%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 555 kluczy / 26 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 10:07:56
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+4) — repair_identical lang=es file=npc.json target_identical=2 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=187.34
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **8,580** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 185 |
| ❌ Błędów | 367 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,547), **RU** (1,508), **IT** (1,286), **TR** (1,191), **DE** (1,185) |
| 📊 Porównanie | ↑ 4.3% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **27,560** kluczy
...
| 🔄 Cykli wykonanych | **#18,188** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,188 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 10:07:56  
