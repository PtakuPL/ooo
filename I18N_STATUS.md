...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **9.89%**. Tempo: **2872.3 kluczy/h**. Tłumaczeń netto: **69,972**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-16 20:40:43

> **Aktualizacja:** 2026-02-16 20:40:43 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #18 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: sr | Plik: items.json | Heartbeat: 2026-02-16T20:40:29Z  
> **Okno godzinowe:** okno=1.0h | cykli=69 | pominięte=0.0% | odrzucone=13.2% | przepustowość=2872.3/h  
> **Tłumaczeń netto:** 69,972

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-16 20:40:43 |
| LIVE | 🟢 AKTYWNY | 14s temu | - | `activity.json / worker_state.json` | 2026-02-16T20:40:29Z |
| MIGRATION | 🔒 NIEAKTYWNY | 29min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-16 20:40:43 |
| TRANSLATION | 🟢 AKTYWNY | 58s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-16T20:39:45.315012Z |
| QUALITY | 🔒 NIEAKTYWNY | 33s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-16T20:40:10.606275Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-16 20:40:43 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 14s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-16T20:40:29Z
...
| ❤️ **Heartbeat** | 2026-02-16T20:40:29Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **2,383** kluczy |
| ❌ Odrzucone (guard) | 361 |
| 🔁 Cykli | 69 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (415 kluczy) |
| 📄 Najczęstszy plik | items.json |
| ⚡ Przepustowość | ~2872 kluczy/h |
| 🛡️ Guard fail rate | 13.2% |
| ⚠️ Podejrzane | 8452 |
...
| RU | 17,808 | 53,586 | 33.23% | 3,561 |
| FR | 17,709 | 53,586 | 33.05% | 4,145 |
| RO | 8,963 | 53,586 | 16.73% | 2,686 |
...
> **ETA globalne:** ~34 dni (2,371,415 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ██████████████░░░░░░ | 73.3% | 39,275/53,586 | ~4h |
| PL | ████████░░░░░░░░░░░░ | 42.3% | 22,668/53,586 | ~10h |
| RU | ██████░░░░░░░░░░░░░░ | 33.2% | 17,808/53,586 | ~12h |
| FR | ██████░░░░░░░░░░░░░░ | 33.0% | 17,709/53,586 | ~12h |
| RO | ███░░░░░░░░░░░░░░░░░ | 16.7% | 8,963/53,586 | ~15h |
...
> Tempo obliczone na bazie ostatniej godziny: ~2872 kluczy/h.
...
> Świeżość: 29min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-16 20:40:43
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 58s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-16T20:39:45.315012Z
...
| RU (Rosyjski) | 17,808/53,586 | 33.23% | 3,561 | 0 |
| FR (Francuski) | 17,709/53,586 | 33.05% | 4,145 | 0 |
| RO (Rumuński) | 8,963/53,586 | 16.73% | 2,686 | 0 |
...
| IT (Włoski) | 4,127/53,586 | 7.70% | 2,557 | 0 |
...
| RU | 15,083/49,731 | 30.3% | 2,725/3,855 | 70.7% |
| FR | 15,162/49,731 | 30.5% | 2,547/3,855 | 66.1% |
| RO | 8,869/49,731 | 17.8% | 94/3,855 | 2.4% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-16T19:40:43.549222Z → 2026-02-16T20:40:43.549222Z) |
...
| Przepustowość (kluczy/h) | **2872.3 kluczy/h** |
| Podejrzane tłumaczenia | **8452** |
...
> Świeżość: 33s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-16T20:40:10.606275Z

- **Ostatni audyt:** OK | 7 issue(s) / 100 entries | 2026-02-16T20:40:10.606275Z
- **Top 5 typów problemów:** suspicious_log_high=151, suspicious_log_critical=49, suspicious_rejected_critical=23, identical_to_en_exempt=11, artifact_token=7
- **Języki o najsłabszej jakości:** es(60.2, issues=146886), tl(64.2, issues=466), zh_TW(64.8, issues=337), fr(65.2, issues=2470), et(67.7, issues=672)
...
⚠️ **PL**: jakość 69%, 113040 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 146886 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 77%, 3051 problemów
⚠️ **RU**: jakość 92%, 5371 problemów
...
| Heartbeat | 14s temu | 2026-02-16T20:40:29Z |
...
- 2026-02-16 20:40:29 | AUTO_TRANSLATE:heartbeat_tick | sr | ok | items.json
- 2026-02-16 20:40:28 | AUTO_TRANSLATE:auto_start | sr | ok | items.json
- 2026-02-16 20:39:57 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-16 20:39:42 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-02-16 20:39:42 | AUTO_TRANSLATE:parallel_start | it | ok | items.json
- 2026-02-16 20:39:32 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 42.3% | 0 | 1,846 | 1,352 | 624 (31.6%) | 45 |
| 🟡 ES | 73.3% | 0 | 2,663 | 1,121 | 391 (25.9%) | 32 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **69,972** | — | 📊 |
| Adaptacyjna paczka | batch=16, gf_rate=12.06%, reason=stable_fail_rate=12.1% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 2,473 kluczy / 77 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-16 20:40:43
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+108) — repair_identical lang=es file=npc.json target_identical=3291
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+122) — repair_identical lang=es file=npc.json target_identical=4491
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [fi] → ok (translated+80, skipped+0) — parallel lang=fi file=items.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [no] → warn (files+1, translated+80, skipped+0) — lang=no file=items.json strict_skip missing_file=0 missing_key=163 skipped_done=3145 strict_skipped_done=3145
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+190) — repair_identical lang=es file=npc.json target_identical=5246
...
| ❌ Błędów | 23 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (452), **RU** (415), **RO** (392), **IT** (388), **SR** (339) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **82,505** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-16 20:40:43  
