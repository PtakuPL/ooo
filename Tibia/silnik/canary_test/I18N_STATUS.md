...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.18%**. Tempo: **1932.1 kluczy/h**. Tłumaczeń netto: **81,344**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-16 23:20:43

> **Aktualizacja:** 2026-02-16 23:20:43 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #35 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: es | Plik: - | Heartbeat: 2026-02-16T23:20:39Z  
> **Okno godzinowe:** okno=1.0h | cykli=129 | pominięte=0.0% | odrzucone=46.0% | przepustowość=1932.1/h  
> **Tłumaczeń netto:** 81,344

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-16 23:20:43 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-16T23:20:39Z |
| MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-16 23:20:43 |
| TRANSLATION | 🟢 AKTYWNY | 22s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-16T23:20:21.799694Z |
| QUALITY | 🔒 NIEAKTYWNY | 4s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-16T23:20:39.488258Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-16 23:20:43 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-16T23:20:39Z
...
| ❤️ **Heartbeat** | 2026-02-16T23:20:39Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **3,415** kluczy |
| ❌ Odrzucone (guard) | 2914 |
| 🔁 Cykli | 129 |
| 🌍 Języków | 7 |
...
> **ETA globalne:** ~51 dni (2,363,519 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ██████████████░░░░░░ | 74.0% | 39,668/53,586 | ~6h |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-16 23:20:43
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 22s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-16T23:20:21.799694Z
...
|-------|----------------|-------------------------------|---------|--------------|
| ES (Hiszpański) | 39,668/53,586 | 74.03% | 2,627 | 0 |
...
- Raporty strażnika jakości: **2438**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2376**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **10.18%** (283,593/2,786,472)
- **Kopie EN (łącznie):** **166,529**
...
|-------|--------|----------|----------|------------|
| ES | 37,158/49,731 | 74.7% | 2,510/3,855 | 65.1% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-16T22:20:43.262647Z → 2026-02-16T23:20:43.262647Z) |
...
| Przepustowość (kluczy/h) | **1932.1 kluczy/h** |
| Podejrzane tłumaczenia | **9012** |
...
> Świeżość: 4s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-16T23:20:39.488258Z

- **Ostatni audyt:** SLOW_MODE | 28 issue(s) / 100 entries | 2026-02-16T23:20:39.488258Z
- **Top 5 typów problemów:** suspicious_rejected_critical=165, suspicious_log_high=86, suspicious_log_critical=59, suspicious_log_low=55, suspicious_rejected_high=35
- **Języki o najsłabszej jakości:** es(60.1, issues=161647), ru(60.1, issues=13557), ro(60.2, issues=14167), sv(63.1, issues=2983), pl(63.4, issues=116535)
...
⚠️ **PL**: jakość 63%, 116535 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 161647 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 80%, 5651 problemów
⚠️ **RU**: jakość 60%, 13557 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 63%, 2983 problemów
...
| Heartbeat | 5s temu | 2026-02-16T23:20:39Z |
...
- 2026-02-16 23:20:30 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-16 23:20:17 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | client.json
- 2026-02-16 23:20:17 | AUTO_TRANSLATE:parallel_start | pl | ok | client.json
- 2026-02-16 23:20:15 | AUTO_TRANSLATE:auto_done | es | ok | client.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 43.8% | 0 | 1,924 | 1,091 | 4538 (80.6%) | 25 |
| 🟡 ES | 74.0% | 0 | 2,627 | 1,173 | 288 (19.7%) | 30 |
...
| Przepustowość (okno) | 2,264 kluczy / 55 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-16 23:20:43
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **17,294** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 87 |
| ❌ Błędów | 175 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (3,405), **IT** (2,726), **RU** (2,462), **RO** (2,343), **SV** (2,212) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **97,200** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-16 23:20:43  
