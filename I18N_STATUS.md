...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.97% / real 10.89%**. Tempo: **692.0 kluczy/h**. Tłumaczeń netto: **142,821**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 05:50:56

> **Aktualizacja:** 2026-04-29 05:50:56 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,828 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: it | Plik: items.json | Heartbeat: 2026-04-29T05:48:17Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=4.9% | przepustowość=692.0/h  
> **Tłumaczeń netto:** 142,821

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 05:50:56 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T05:48:17Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 40s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 05:50:56 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T05:49:57.843745Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T05:48:17.186578Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 05:50:56 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T05:51:02.722058Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T05:48:17Z
...
| 🔄 **Ostatni cykl** | 30 kluczy, 1 odrzuconych, 82.0s, tryb: AUTO_TRANSLATE, cel: it/items.json |
| ❤️ **Heartbeat** | 2026-04-29T05:48:17Z |
...
| ⏳ Oldest pending (visible tail) | 16712 s |
...
| 🌍 Recent provider mix | TM/simple(360), Free Google Translate(127), canonical_name_semantic_autofix(15), term_consistency_autofix(3) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=706/706 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 16712}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~180 dni (2,985,508 kluczy do celu 95%)
...
> Świeżość: 40s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 05:50:56
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T05:49:57.843745Z
...
- hive structure → struttura dell'alveare (item.13065.name)
- hive structure → struttura dell'alveare (item.13066.name)
- hive structure → struttura dell'alveare (item.13067.name)
- hive structure → struttura dell'alveare (item.13068.name)
- hive structure → struttura dell'alveare (item.13069.name)
- sandstone wall → muro di arenaria (item.1307.name)
- hive structure → struttura dell'alveare (item.13070.name)
- hive structure → struttura dell'alveare (item.13071.name)
- hive structure → struttura dell'alveare (item.13072.name)
- hive structure → struttura dell'alveare (item.13073.name)
- hive structure → struttura dell'alveare (item.13074.name)
- hive structure → struttura dell'alveare (item.13075.name)
- hive structure → struttura dell'alveare (item.13076.name)
- hive structure → struttura dell'alveare (item.13077.name)
- hive structure → struttura dell'alveare (item.13078.name)
- hive structure → struttura dell'alveare (item.13079.name)
- sandstone wall → muro di arenaria (item.1308.name)
- hive structure → struttura dell'alveare (item.13080.name)
- hive structure → struttura dell'alveare (item.13081.name)
- hive structure → struttura dell'alveare (item.13082.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4805**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4658**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T05:48:35.999894Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.97%** (696,560/3,875,872)
- **Pokrycie globalne (real):** **10.89%** (422,131/3,875,872)
- **Kopie EN (łącznie):** **410,516**
- **Placeholdery [EN]/puste (łącznie):** **2,189,103**
...
| 🕒 Evidence window | 24h (span=34.98h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=34.98h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T04:50:57.147803Z → 2026-04-29T05:50:57.147803Z) |
...
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T05:48:17.186578Z
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,828 |
| Heartbeat | 165s temu | 2026-04-29T05:48:17Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T05:50:13.166215Z
...
- 2026-04-29 05:50:13 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-29 05:49:58 | AUTO_TRANSLATE:auto_done | it | ok | items.json
- 2026-04-29 05:48:37 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-04-29 05:48:36 | AUTO_TRANSLATE:auto_start | it | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 05:50:56

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+30, skipped+0) — lang=it file=items.json strict_skipped_done=2850 guard_fail=1 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **5,010** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 116 |
| ❌ Błędów | 210 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,051), **RU** (853), **IT** (778), **DE** (675), **TR** (595) |
| 📊 Porównanie | ↓ 39.1% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **23,990** kluczy
...
| 🔄 Cykli wykonanych | **#17,828** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,828 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 05:50:56  
