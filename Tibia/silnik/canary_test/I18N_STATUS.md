...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.84%**. Tempo: **1594.9 kluczy/h**. Tłumaczeń netto: **115,050**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 17:18:57

> **Aktualizacja:** 2026-02-20 17:18:57 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #2 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: - | Heartbeat: 2026-02-20T17:18:53Z  
> **Okno godzinowe:** okno=1.0h | cykli=145 | pominięte=0.0% | odrzucone=70.7% | przepustowość=1594.9/h  
> **Tłumaczeń netto:** 115,050

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 17:18:57 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T17:18:53Z |
| MIGRATION | 🔒 NIEAKTYWNY | 35s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 17:18:57 |
| TRANSLATION | 🟢 AKTYWNY | 42s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T17:18:16.119196Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T17:18:58.303248Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 17:18:57 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T17:18:53Z
...
| ❤️ **Heartbeat** | 2026-02-20T17:18:53Z |
...
> **ETA globalne:** ~59 dni (2,261,592 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| PL | █████████████████░░░ | 87.8% | 47,031/53,586 | ~2h |
| ES | ████████████████░░░░ | 84.7% | 45,374/53,586 | ~3h |
| IT | ██████████░░░░░░░░░░ | 51.7% | 27,718/53,586 | ~15h |
| RU | ██████████░░░░░░░░░░ | 50.4% | 26,980/53,586 | ~15h |
| SR | █████████░░░░░░░░░░░ | 45.4% | 24,320/53,586 | ~17h |
| RO | ████████░░░░░░░░░░░░ | 42.4% | 22,707/53,586 | ~18h |
| FR | ██████░░░░░░░░░░░░░░ | 33.1% | 17,731/53,586 | ~21h |
| SV | █████░░░░░░░░░░░░░░░ | 28.2% | 15,139/53,586 | ~22h |
...
> Tempo obliczone na bazie ostatniej godziny: ~1595 kluczy/h.
...
> Świeżość: 35s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 17:18:57
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 42s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T17:18:16.119196Z
...
| ES | 42,308/49,731 | 85.1% | 3,066/3,855 | 79.5% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T16:18:57.553559Z → 2026-02-20T17:18:57.553559Z) |
...
| Przepustowość (kluczy/h) | **1594.9 kluczy/h** |
| Podejrzane tłumaczenia | **3843** |
| Najgorsze cele (strażnik) | pl/items.json (gf=2508), es/items.json (gf=1549), pl/npc.json (gf=1332), es/server.json (gf=183), ro/monsters.json (gf=178) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T17:18:58.303248Z

- **Ostatni audyt:** SLOW_MODE | 16 issue(s) / 100 entries | 2026-02-20T17:18:52.967494Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=114, suspicious_log_high=64, suspicious_log_critical=41, suspicious_rejected_high=26, artifact_token=16
- **Języki o najsłabszej jakości:** es(60.1, issues=319847), pl(60.1, issues=180717), ro(60.1, issues=174626), sr(60.4, issues=86013), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 60%, 180717 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 319847 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 65%, 70229 problemów
⚠️ **RU**: jakość 79%, 209872 problemów
...
| Heartbeat | 5s temu | 2026-02-20T17:18:53Z |
...
- 2026-02-20 17:18:25 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 17:17:55 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-02-20 17:17:55 | AUTO_TRANSLATE:parallel_start | ro | ok | items.json
- 2026-02-20 17:17:50 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-02-20 17:17:50 | AUTO_TRANSLATE:parallel_start | ru | ok | items.json
- 2026-02-20 17:17:48 | AUTO_TRANSLATE:auto_done | it | ok | items.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,831 | 799 | 5882 (88.0%) | 38 |
| 🟡 ES | 84.7% | 0 | 2,161 | 790 | 2998 (79.1%) | 42 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **115,050** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=62.85%, reason=decrease_high_fail_rate=62.8% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,589 kluczy / 80 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 17:18:57
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+50, skipped+0) — lang=it file=items.json strict_skipped_done=3895
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+23) — repair_identical lang=es file=npc.json target_identical=51 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=300.57
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [sv] → warn (files+1, translated+50, skipped+0) — lang=sv file=npc.json strict_skipped_done=5615
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **3,448** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 17 |
| ❌ Błędów | 70 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (906), **RU** (641), **IT** (637), **RO** (422), **PL** (388) |
| 📊 Porównanie | ↓ 5.3% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **101,033** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 17:18:57  
