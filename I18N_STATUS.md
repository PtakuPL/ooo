...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.87%**. Tempo: **1523.6 kluczy/h**. Tłumaczeń netto: **120,735**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 19:54:45

> **Aktualizacja:** 2026-02-20 19:54:45 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #127 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ro | Plik: - | Heartbeat: 2026-02-20T19:54:41Z  
> **Okno godzinowe:** okno=1.0h | cykli=205 | pominięte=0.0% | odrzucone=59.5% | przepustowość=1523.6/h  
> **Tłumaczeń netto:** 120,735

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 19:54:45 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T19:54:41Z |
| MIGRATION | 🔒 NIEAKTYWNY | 18s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 19:54:45 |
| TRANSLATION | 🟢 AKTYWNY | 5s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T19:54:41.001102Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T19:54:46.545141Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 19:54:45 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T19:54:41Z
...
| ❤️ **Heartbeat** | 2026-02-20T19:54:41Z |
...
| ❌ Odrzucone (guard) | 4025 |
| 🔁 Cykli | 205 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (686 kluczy) |
...
> **ETA globalne:** ~62 dni (2,260,542 kluczy do celu 95%)
...
> Świeżość: 18s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 19:54:45
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T19:54:41.001102Z
...
- Raporty strażnika jakości: **6953**  
- Raporty blokad: **0**  
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T18:54:45.815565Z → 2026-02-20T19:54:45.815565Z) |
...
| Przepustowość (kluczy/h) | **1523.6 kluczy/h** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T19:54:46.545141Z

- **Ostatni audyt:** SLOW_MODE | 29 issue(s) / 100 entries | 2026-02-20T19:54:41.671206Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=123, suspicious_log_high=91, suspicious_rejected_high=34, suspicious_log_low=17, artifact_token=16
- **Języki o najsłabszej jakości:** es(60.1, issues=335798), ru(60.1, issues=212720), pl(60.1, issues=187351), ro(60.1, issues=182877), it(60.1, issues=74859)
...
⚠️ **PL**: jakość 60%, 187351 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 335798 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 74859 problemów
⚠️ **RU**: jakość 60%, 212720 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 78%, 30842 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #127 |
| Heartbeat | 5s temu | 2026-02-20T19:54:41Z |
...
- 2026-02-20 19:54:37 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | monsters.json
- 2026-02-20 19:54:37 | AUTO_TRANSLATE:parallel_start | ru | ok | monsters.json
- 2026-02-20 19:54:31 | AUTO_TRANSLATE:heartbeat_tick | it | ok | monsters.json
- 2026-02-20 19:54:31 | AUTO_TRANSLATE:parallel_start | it | ok | monsters.json
- 2026-02-20 19:54:30 | AUTO_TRANSLATE:auto_done | ro | ok | items.json
- 2026-02-20 19:54:20 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **120,735** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=86.25%, reason=decrease_high_fail_rate=86.2% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 19:54:45
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+24) — repair_identical lang=es file=npc.json target_identical=24 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=323.46
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ro] → ok (translated+10, skipped+0) — parallel lang=ro file=monsters.json
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+41, skipped+0) — lang=pl file=monsters.json strict_skipped_done=2095
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **11,884** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 127 |
| ❌ Błędów | 279 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (3,465), **RU** (2,353), **IT** (1,966), **RO** (1,470), **PL** (1,295) |
| 📊 Porównanie | ↑ 226.4% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **109,469** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 19:54:45  
