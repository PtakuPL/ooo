...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.72% / real 11.7%**. Tempo: **291.0 kluczy/h**. Tłumaczeń netto: **170,368**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-05-02 07:30:55

> **Aktualizacja:** 2026-05-02 07:30:55 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #19,407 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: server.json | Heartbeat: 2026-05-02T07:27:32Z
> **Okno godzinowe:** okno=1.0h | cykli=64 | pominięte=0.0% | odrzucone=0.0% | przepustowość=291.0/h  
> **Tłumaczeń netto:** 170,368

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-05-02 07:30:55 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-05-02T07:27:32Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 22h temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-05-02 07:30:55 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-05-02T07:29:40.832057Z |
| QUALITY | 🔒 NIEAKTYWNY | 3min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-05-02T07:27:12.712000Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-05-02 07:30:55 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-05-02T07:31:02.964906Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-05-02T07:27:32Z
...
| 🔄 **Ostatni cykl** | 22 kluczy, 0 odrzuconych, 129.0s, tryb: AUTO_TRANSLATE, cel: ro/items.json |
| ❤️ **Heartbeat** | 2026-05-02T07:27:32Z |
...
| ⏳ Oldest pending (visible tail) | 18918 s |
| 🌍 Top języki | RU(400) |
...
| 🧮 OpenAI budget | `118/250 (47.2%); policy=telemetry_only` |
| ♻️ Provider debt | `767` |
| 🌍 Recent provider mix | tm_dedup_file(87), OpenAI model pool(85), canonical_name_semantic_autofix(23), tm_dedup_propagate(14), term... |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 18918}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~423 dni (2,956,316 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~291 kluczy/h.
...
> Świeżość: 22h temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-05-02 07:30:55
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-05-02T07:29:40.832057Z
...
- Raporty strażnika jakości: **5208**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **5060**
...
| 🕒 Evidence window | 24h (span=34.96h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=34.96h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=+0.00pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-05-02T06:30:55.576076Z → 2026-05-02T07:30:55.576076Z) |
...
| Przepustowość (kluczy/h) | **291.0 kluczy/h** |
...
> Świeżość: 3min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-05-02T07:27:12.712000Z
...
| Heartbeat | 210s temu | 2026-05-02T07:27:32Z |
...
- 2026-05-02 07:29:58 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-05-02 07:29:41 | AUTO_TRANSLATE:auto_done | ro | ok | items.json
- 2026-05-02 07:29:03 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-05-02 07:30:55

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+22, skipped+0) — lang=ro file=items.json strict_skipped_done=1629
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **13,833** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 80 |
| ❌ Błędów | 102 |
| 🌍 Aktywnych języków | 6 |
| 🏆 TOP 5 | **RO** (7,495), **TR** (5,659), **ES** (299), **RU** (149), **IT** (140) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **46,813** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-05-02 07:30:55  
