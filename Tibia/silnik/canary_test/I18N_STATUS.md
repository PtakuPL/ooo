...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.97% / real 10.89%**. Tempo: **704.0 kluczy/h**. Tłumaczeń netto: **142,874**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 05:58:04

> **Aktualizacja:** 2026-04-29 05:58:04 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,836 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: items.json | Heartbeat: 2026-04-29T05:55:36Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=5.1% | przepustowość=704.0/h  
> **Tłumaczeń netto:** 142,874

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 05:58:04 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T05:55:36Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 28s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 05:58:04 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T05:55:36.615371Z |
| QUALITY | 🔒 NIEAKTYWNY | 4min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T05:53:52.360850Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 05:58:04 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T05:58:11.078360Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T05:55:36Z
...
| ❤️ **Heartbeat** | 2026-04-29T05:55:36Z |
...
| ⏳ Oldest pending (visible tail) | 17140 s |
...
| 🌍 Recent provider mix | TM/simple(357), Free Google Translate(103), canonical_name_semantic_autofix(20), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=483, fallbacks=26) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=711/711 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 17140}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 28s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 05:58:04
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T05:55:36.615371Z
...
- unknown item → artículo desconocido (item.11594.name)
- unknown item → artículo desconocido (item.11595.name)
- unknown item → artículo desconocido (item.11596.name)
- unknown item → artículo desconocido (item.11597.name)
- unknown item → artículo desconocido (item.11598.name)
- unknown item → artículo desconocido (item.11599.name)
- tiled roof → techo de tejas (item.1160.name)
- unknown item → artículo desconocido (item.11600.name)
- unknown item → artículo desconocido (item.11601.name)
- unknown item → artículo desconocido (item.11602.name)
- tiled roof → techo de tejas (item.1161.name)
- tiled roof → techo de tejas (item.1162.name)
...
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4660**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T05:54:23.959305Z |
...
| 🕒 Evidence window | 24h (span=35.10h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=35.10h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T04:58:05.183857Z → 2026-04-29T05:58:05.183857Z) |
...
| Najgorsze cele (strażnik) | cs/items.json (gf=16), ro/items.json (gf=12), ru/items.json (gf=3), it/items.json (gf=3), de/otclient_modules.json (gf=2) |
...
> Świeżość: 4min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T05:53:52.360850Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T05:53:52.360850Z
- **Top 5 typów problemów:** suspicious_rejected_critical=188, suspicious_log_high=106, suspicious_log_low=93, suspicious_rejected_high=12, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=735996), ro(60.1, issues=434005), de(60.1, issues=116817), cs(60.1, issues=96668), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 735996 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 63%, 173451 problemów
⚠️ **RU**: jakość 61%, 364758 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,836 |
| Heartbeat | 155s temu | 2026-04-29T05:55:36Z |
...
- 2026-04-29 05:57:25 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 05:55:55 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 05:55:36 | AUTO_TRANSLATE:auto_done | es | ok | items.json
- 2026-04-29 05:54:25 | AUTO_TRANSLATE:heartbeat_tick | es | ok | items.json
- 2026-04-29 05:54:24 | AUTO_TRANSLATE:auto_start | es | ok | items.json
- 2026-04-29 05:53:51 | AUTO_TRANSLATE:auto_done | ro | ok | items.json
...
| 🟡 ES | 79.0% | 0 | 9,718 | 564 | 0 (0.0%) | 26 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **142,874** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=5.51%, reason=stable_fail_rate=5.5%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 564 kluczy / 26 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 05:58:04

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+18, skipped+0) — lang=es file=items.json strict_skipped_done=1440
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+6) — repair_identical lang=es file=npc.json target_identical=2 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=181.09
...
| 🔄 Cykli wykonanych | **#17,836** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,836 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 05:58:04  
