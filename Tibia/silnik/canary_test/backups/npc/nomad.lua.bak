...
keywordHandler:addKeyword({ "heal" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.nomad.stdmod_3" }, function(player)
...
keywordHandler:addKeyword({ "heal" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.nomad.stdmod_4" })
keywordHandler:addAliasKeyword({ "help" })
...
keywordHandler:addKeyword({ "spiritual" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.nomad.stdmod_6" })
keywordHandler:addAliasKeyword({ "shield" })
keywordHandler:addKeyword({ "suns" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.nomad.stdmod_7" })
keywordHandler:addAliasKeyword({ "fire" })
keywordHandler:addKeyword({ "phoenix" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.nomad.stdmod_8" })
keywordHandler:addAliasKeyword({ "spark" })
keywordHandler:addKeyword({ "solitude" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.nomad.stdmod_9" })
keywordHandler:addAliasKeyword({ "wisdom" })
keywordHandler:addKeyword({ "embrace" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.nomad.stdmod_10" })
keywordHandler:addAliasKeyword({ "tibia" })

keywordHandler:addKeyword({ "djinn" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.nomad.stdmod_11" })
