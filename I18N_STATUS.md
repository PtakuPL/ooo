...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.98% / real 10.9%**. Tempo: **963.0 kluczy/h**. Tłumaczeń netto: **143,557**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 06:36:06

> **Aktualizacja:** 2026-04-29 06:36:06 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,892 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: server.json | Heartbeat: 2026-04-29T06:33:38Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=4.0% | przepustowość=963.0/h  
> **Tłumaczeń netto:** 143,557

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 06:36:06 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T06:33:38Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 43s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 06:36:06 |
| TRANSLATION | 🟢 AKTYWNY | 55s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T06:35:17.735355Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T06:33:37.450688Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 06:36:06 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T06:36:12.940344Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T06:33:38Z
...
| ❤️ **Heartbeat** | 2026-04-29T06:33:38Z |
...
| ⏳ Oldest pending (visible tail) | 16681 s |
...
| ❤️ Pool health | `critical` (writes=508, fallbacks=21) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=741/741 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 16681}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~129 dni (2,985,014 kluczy do celu 95%)
...
> Świeżość: 43s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 06:36:06
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 55s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T06:35:17.735355Z
...
- moist wall → parete umida (item.13121.name)
- stone pillar → pilastro di pietra (item.13122.name)
- stone pillar → pilastro di pietra (item.13123.name)
- stone pillar → pilastro di pietra (item.13124.name)
- archway → arco (item.13125.name)
- archway → arco (item.13126.name)
- archway → arco (item.13127.name)
- archway → arco (item.13128.name)
- archway → arco (item.13129.name)
- sandstone wall → muro di arenaria (item.1313.name)
- archway → arco (item.13130.name)
- archway → arco (item.13131.name)
- archway → arco (item.13132.name)
- archway → arco (item.13133.name)
- archway → arco (item.13134.name)
- archway → arco (item.13138.name)
- archway → arco (item.13139.name)
- sandstone wall → muro di arenaria (item.1314.name)
- archway → arco (item.13140.name)
- archway → arco (item.13141.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4821**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4674**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T06:33:58.142380Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.98%** (697,054/3,875,872)
- **Pokrycie globalne (real):** **10.9%** (422,628/3,875,872)
...
| 🕒 Evidence window | 24h (span=35.73h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=35.73h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T05:36:07.056479Z → 2026-04-29T06:36:07.056479Z) |
...
| Przepustowość (kluczy/h) | **963.0 kluczy/h** |
| Podejrzane tłumaczenia | **1283** |
...
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T06:33:37.450688Z
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,892 |
| Heartbeat | 154s temu | 2026-04-29T06:33:38Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T06:35:33.081666Z
...
- 2026-04-29 06:35:33 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-29 06:35:18 | AUTO_TRANSLATE:auto_done | it | ok | items.json
- 2026-04-29 06:33:59 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-04-29 06:33:58 | AUTO_TRANSLATE:auto_start | it | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 06:36:06

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+30, skipped+0) — lang=it file=items.json strict_skipped_done=2915 guard_fail=1 placeholder=0 command=0 pipe=0
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+2) — repair_identical lang=es file=server.json target_identical=9 limit=108 tier=low_backlog+suspicious_guard domain_cap=240 gt=true suspicious_pct=463.16
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **5,800** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 132 |
| ❌ Błędów | 238 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,163), **RU** (1,075), **IT** (838), **DE** (765), **TR** (762) |
| 📊 Porównanie | ↓ 29.5% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **24,780** kluczy
...
| 🔄 Cykli wykonanych | **#17,892** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,892 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 06:36:06  
