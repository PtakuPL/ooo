...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.88%**. Tempo: **1460.3 kluczy/h**. Tłumaczeń netto: **123,175**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 21:08:20

> **Aktualizacja:** 2026-02-20 21:08:20 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #188 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: pl | Plik: - | Heartbeat: 2026-02-20T21:08:16Z  
> **Okno godzinowe:** okno=1.0h | cykli=197 | pominięte=0.0% | odrzucone=67.4% | przepustowość=1460.3/h  
> **Tłumaczeń netto:** 123,175

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 21:08:20 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T21:08:16Z |
| MIGRATION | 🔒 NIEAKTYWNY | 56s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 21:08:20 |
| TRANSLATION | 🟢 AKTYWNY | 39s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T21:07:42.417346Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T21:08:21.427701Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 21:08:20 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T21:08:16Z
...
| ❤️ **Heartbeat** | 2026-02-20T21:08:16Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **2,554** kluczy |
| ❌ Odrzucone (guard) | 5276 |
| 🔁 Cykli | 197 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (589 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~1460 kluczy/h |
| 🛡️ Guard fail rate | 67.4% |
| ⚠️ Podejrzane | 25264 |
| 🌐 GT aktywny (1h) | ✅ TAK |
| 🔤 GT tłumaczeń (1h) | 75 |
...
> Świeżość: 56s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 21:08:20
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 39s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T21:07:42.417346Z
...
- Raporty strażnika jakości: **7107**  
- Raporty blokad: **0**  
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T20:08:20.721740Z → 2026-02-20T21:08:20.721740Z) |
| Cykle | **197** (TŁUMACZENIE=197, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **67.4%** |
| Cykle bez postępu % | **1.6%** |
| Przepustowość (kluczy/h) | **1460.3 kluczy/h** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T21:08:21.427701Z

- **Ostatni audyt:** SLOW_MODE | 32 issue(s) / 100 entries | 2026-02-20T21:08:16.449866Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=64, suspicious_log_critical=41, artifact_token=32, suspicious_log_high=28, identical_to_en_exempt=5
- **Języki o najsłabszej jakości:** es(60.1, issues=344157), ro(60.1, issues=186892), ru(61.1, issues=214000), sr(61.1, issues=87022), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 66%, 191675 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 344157 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 78%, 76187 problemów
...
| Heartbeat | 5s temu | 2026-02-20T21:08:16Z |
...
- 2026-02-20 21:07:50 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 21:07:28 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 21:07:27 | AUTO_TRANSLATE:parallel_start | es | ok | npc.json
- 2026-02-20 21:07:26 | AUTO_TRANSLATE:auto_done | pl | ok | spells.json
- 2026-02-20 21:07:06 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | spells.json
- 2026-02-20 21:07:06 | AUTO_TRANSLATE:auto_start | pl | ok | spells.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 21:08:20
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+44, skipped+0) — lang=pl file=otclient_modules.json strict_skipped_done=623 guard_fail=3 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [de] → ok (files+1, translated+0, skipped+16) — lang=de file=modules.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [sv] → ok (files+1, translated+0, skipped+21) — lang=sv file=actions.json
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **15,713** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 188 |
| ❌ Błędów | 382 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (4,645), **RU** (3,062), **IT** (2,515), **RO** (1,871), **PL** (1,866) |
| 📊 Porównanie | ↑ 331.6% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **113,298** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 21:08:20  
