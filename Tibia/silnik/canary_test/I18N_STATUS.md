...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.71% / real 11.68%**. Tempo: **505.0 kluczy/h**. Tłumaczeń netto: **169,474**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-05-02 06:22:12

> **Aktualizacja:** 2026-05-02 06:22:12 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #19,335 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: auto_done | Kategoria: ro | Plik: items.json | Heartbeat: 2026-05-02T06:17:02Z
...
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-05-02 06:22:12 |
| LIVE | 🟢 AKTYWNY | 5min temu | - | `activity.json / worker_state.json` | 2026-05-02T06:17:02Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 21h temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-05-02 06:22:12 |
| TRANSLATION | 🟢 AKTYWNY | 12s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-05-02T06:22:07.022504Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-05-02T06:19:49.548683Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-05-02 06:22:12 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-05-02T06:22:19.854603Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-05-02T06:17:02Z
...
| ❤️ **Heartbeat** | 2026-05-02T06:17:02Z |
...
| ⏳ Oldest pending (visible tail) | 19436 s |
...
| 🧮 OpenAI budget | `103/250 (40.4%); policy=telemetry_only` |
| ♻️ Provider debt | `767` |
| 🌍 Recent provider mix | OpenAI model pool(101), tm_dedup_file(80), canonical_name_semantic_autofix(20), term_consistency_autofix(1) |
...
| ❤️ Pool health | `degraded` (writes=202, fallbacks=22) |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 19436}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 21h temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-05-02 06:22:12
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 12s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-05-02T06:22:07.022504Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-05-02T06:19:56.034046Z |
...
| 🕒 Evidence window | 24h (span=33.81h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=33.81h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=+0.00pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-05-02T05:22:13.162423Z → 2026-05-02T06:22:13.162423Z) |
...
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-05-02T06:19:49.548683Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-05-02T06:19:49.548683Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=762901), ro(60.1, issues=458818), ru(60.1, issues=388409), cs(60.1, issues=140804), de(60.1, issues=140466)
...
⚠️ **TR**: jakość 60%, 63585 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 762901 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 86%, 182392 problemów
⚠️ **RU**: jakość 60%, 388409 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #19,335 |
| Heartbeat | 317s temu | 2026-05-02T06:17:02Z |
...
- **Ostatnia aktualizacja:** 2026-05-02T06:14:38.413734Z
...
│ Plik: items.json                                              │
│ Postęp: 24/30 keys                                            │
│ …4 guard_fail=0 strict_missing_key=0 strict_skipped_done=1496 │
├─────────────────────────────────────────────────────────────────┤
│ ❤️ Heartbeat: 2026-05-02T06:17:02Z           │
└─────────────────────────────────────────────────────────────────┘
```
...
- 2026-05-02 06:19:57 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-05-02 06:19:56 | AUTO_TRANSLATE:auto_start | ro | ok | items.json
- 2026-05-02 06:19:48 | AUTO_TRANSLATE:auto_done | es | ok | items.json
- 2026-05-02 06:19:02 | AUTO_TRANSLATE:heartbeat_tick | es | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-05-02 06:22:12
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [tr] → warn (files+1, translated+30, skipped+0) — lang=tr file=items.json strict_skipped_done=773
...
| ❌ Błędów | 84 |
| 🌍 Aktywnych języków | 6 |
| 🏆 TOP 5 | **RO** (7,400), **TR** (4,962), **ES** (210), **RU** (140), **IT** (128) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **45,895** kluczy
...
| 🔄 Cykli wykonanych | **#19,335** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #19,335 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-05-02 06:22:12  
