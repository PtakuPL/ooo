...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.02% / real 10.94%**. Tempo: **775.0 kluczy/h**. Tłumaczeń netto: **145,927**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 09:49:18

> **Aktualizacja:** 2026-04-29 09:49:18 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,164 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: server.json | Heartbeat: 2026-04-29T09:46:37Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=4.8% | przepustowość=775.0/h  
> **Tłumaczeń netto:** 145,927

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 09:49:18 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T09:46:37Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 25s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 09:49:18 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T09:47:25.315717Z |
| QUALITY | 🔒 NIEAKTYWNY | 3min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T09:46:19.164319Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 09:49:18 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T09:49:24.866869Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T09:46:37Z
...
| 🔄 **Ostatni cykl** | 39 kluczy, 0 odrzuconych, 48.0s, tryb: AUTO_TRANSLATE, cel: tr/items.json |
| ❤️ **Heartbeat** | 2026-04-29T09:46:37Z |
...
| ⏳ Oldest pending (visible tail) | 16128 s |
...
| 🌍 Recent provider mix | TM/simple(312), Free Google Translate(158), canonical_name_semantic_autofix(16), term_consistency_autofix(3) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=890/890 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 386, 'oldest_s': 16128}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~160 dni (2,983,790 kluczy do celu 95%)
...
| RU | █████████░░░░░░░░░░░ | 46.1% | 34,401/74,536 | ~47h |
| FR | ███████████░░░░░░░░░ | 57.5% | 42,864/74,536 | ~36h |
| CS | ██████████░░░░░░░░░░ | 50.7% | 37,814/74,536 | ~43h |
...
> Świeżość: 25s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 09:49:18
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T09:47:25.315717Z
...
- Raporty strażnika jakości: **4889**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4742**
...
- **Pokrycie globalne (nominal):** **18.02%** (698,278/3,875,872)
- **Pokrycie globalne (real):** **10.94%** (423,918/3,875,872)
- **Kopie EN (łącznie):** **410,447**
- **Placeholdery [EN]/puste (łącznie):** **2,187,385**
...
| 🕒 Evidence window | 24h (span=38.95h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=38.95h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T08:49:19.264888Z → 2026-04-29T09:49:19.264888Z) |
...
> Świeżość: 3min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T09:46:19.164319Z
...
| Heartbeat | 167s temu | 2026-04-29T09:46:37Z |
...
- 2026-04-29 09:47:40 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-29 09:47:25 | AUTO_TRANSLATE:auto_done | tr | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 09:49:18

- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+1) — repair_identical lang=es file=server.json target_identical=9 limit=180 tier=low_backlog domain_cap=240 gt=true suspicious_pct=672.41
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [tr] → warn (files+1, translated+39, skipped+0) — lang=tr file=items.json strict_skipped_done=2893
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **8,401** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 185 |
| ❌ Błędów | 356 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,506), **RU** (1,478), **IT** (1,256), **TR** (1,191), **DE** (1,170) |
| 📊 Porównanie | ↑ 2.1% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **27,381** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 09:49:18  
