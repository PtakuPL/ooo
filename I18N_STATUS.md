...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.88% / real 10.79%**. Tempo: **825.0 kluczy/h**. Tłumaczeń netto: **136,675**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-28 22:04:09

> **Aktualizacja:** 2026-04-28 22:04:09 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,188 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ru | Plik: items.json | Heartbeat: 2026-04-28T22:03:06Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=3.6% | przepustowość=825.0/h  
> **Tłumaczeń netto:** 136,675

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-28 22:04:09 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-28T22:03:06Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 25s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-28 22:04:09 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-28T22:03:04.479586Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-28T22:03:05.442690Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-28 22:04:09 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-28T22:04:15.732641Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-28T22:03:06Z
...
| 🔄 **Ostatni cykl** | 32 kluczy, 0 odrzuconych, 42.0s, tryb: AUTO_TRANSLATE, cel: tr/items.json |
| ❤️ **Heartbeat** | 2026-04-28T22:03:06Z |
...
| ⏳ Oldest pending (visible tail) | 14758 s |
...
| 🌍 Recent provider mix | TM/simple(307), Free Google Translate(177), OpenAI model pool(23), canonical_name_semantic_autofix(16), ter... |
| 🔁 Latest fallback | TM/simple → fallback to google translate high [high_reject_types] items.json |
| 📉 Fallback breakdown | fallback to google translate high(14), fallback chain exhausted critical issue(2), fallback chain exhausted... |
...
| ❤️ Pool health | `critical` (writes=526, fallbacks=20) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=349/349 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 389, 'oldest_s': 14758}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~151 dni (2,989,035 kluczy do celu 95%)
...
> Świeżość: 25s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-28 22:04:09
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-28T22:03:04.479586Z
...
- dragon statue → ejderha heykel (item.11044.name)
- dragon statue → ejderha heykel (item.11045.name)
- dragon statue → ejderha heykel (item.11046.name)
- rocks → kayalar (item.1105.name)
- lamp → lamba (item.11051.name)
- lamp → lamba (item.11052.name)
- torch → meşale (item.11054.name)
- torch → meşale (item.11055.name)
- torch → meşale (item.11058.name)
- torch → meşale (item.11059.name)
- rocks → kayalar (item.1106.name)
- torch → meşale (item.11060.name)
- torch → meşale (item.11061.name)
- rocks → kayalar (item.1107.name)
- rocks → kayalar (item.1108.name)
- well → kuyu (item.11083.name)
- well → kuyu (item.11084.name)
- rocks → kayalar (item.1109.name)
- weapon's rack → silah rafı (item.11088.name)
- weapon's rack → silah rafı (item.11089.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4643**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4496**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-28T22:03:22.133463Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.88%** (693,033/3,875,872)
- **Pokrycie globalne (real):** **10.79%** (418,314/3,875,872)
- **Kopie EN (łącznie):** **410,806**
- **Placeholdery [EN]/puste (łącznie):** **2,192,630**
...
| 🕒 Evidence window | 24h (span=27.20h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=27.20h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-28T21:04:09.951122Z → 2026-04-28T22:04:09.951122Z) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-28T22:03:05.442690Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-28T22:03:05.442690Z
- **Top 5 typów problemów:** suspicious_rejected_critical=197, suspicious_log_medium=92, suspicious_log_low=64, suspicious_log_high=39, suspicious_log_critical=5
- **Języki o najsłabszej jakości:** es(60.1, issues=723102), ro(60.1, issues=422216), de(60.1, issues=105692), cs(60.1, issues=79660), nl(60.1, issues=72320)
...
⚠️ **TR**: jakość 69%, 52371 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 723102 problemów
⚠️ **PT**: jakość 70%, 57487 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 69%, 167177 problemów
⚠️ **RU**: jakość 90%, 355753 problemów
⚠️ **NL**: jakość 60%, 72320 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,188 |
| Heartbeat | 69s temu | 2026-04-28T22:03:06Z |
...
- 2026-04-28 22:03:23 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-04-28 22:03:22 | AUTO_TRANSLATE:auto_start | ru | ok | items.json
- 2026-04-28 22:03:04 | AUTO_TRANSLATE:auto_done | tr | ok | items.json
- 2026-04-28 22:02:22 | AUTO_TRANSLATE:heartbeat_tick | tr | ok | items.json
- 2026-04-28 22:02:22 | AUTO_TRANSLATE:auto_start | tr | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **136,675** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=3.35%, reason=increase_low_fail_rate=3.3%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-28 22:04:09
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **6,574** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 86 |
| ❌ Błędów | 261 |
| 🌍 Aktywnych języków | 9 |
| 🏆 TOP 5 | **DE** (1,141), **RU** (983), **IT** (787), **TR** (722), **RO** (687) |
| 📊 Porównanie | ↑ 26.7% vs wczoraj (5,188) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **29,434** kluczy
...
| 🔄 Cykli wykonanych | **#17,188** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,188 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-28 22:04:09  
