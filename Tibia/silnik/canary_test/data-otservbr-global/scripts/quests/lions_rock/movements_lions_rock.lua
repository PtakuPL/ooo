local signs = {
	{
		...
		message1 = "quests.lions_rock.sign_snake_1",
		message2 = "quests.lions_rock.sign_snake_2",
	},
	{
		pos = { x = 33128, y = 32300, z = 9 },
		storage = Storage.Quest.U10_70.LionsRock.InnerSanctum.LizardSign,
		message1 = "quests.lions_rock.sign_lizard_1",
		message2 = "quests.lions_rock.sign_lizard_2",
	},
	{
		pos = { x = 33109, y = 32329, z = 9 },
		storage = Storage.Quest.U10_70.LionsRock.InnerSanctum.ScorpionSign,
		message1 = "quests.lions_rock.sign_scorpion_1",
		message2 = "quests.lions_rock.sign_scorpion_2",
	},
	{
		pos = { x = 33127, y = 32340, z = 9 },
		storage = Storage.Quest.U10_70.LionsRock.InnerSanctum.HyenaSign,
		message1 = "quests.lions_rock.sign_hyaena_1",
		message2 = "quests.lions_rock.sign_hyaena_2",
	},
}
...
function lionsRockSigns.onStepIn(creature, item, position, fromPosition)
	...
	for c = 1, #signs do
		...
		if player:getStorageValue(setting.storage) < 1 and player:getItemCount(21467) >= 1 and player:getPosition() == Position(setting.pos) then
			player:sendLocalizedTextMessage(MESSAGE_EVENT_ADVANCE, setting.message1)
			player:sendLocalizedTextMessage(MESSAGE_EVENT_ADVANCE, setting.message2)
