...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.8%**. Tempo: **917.2 kluczy/h**. Tłumaczeń netto: **112,494**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-19 22:40:34

> **Aktualizacja:** 2026-02-19 22:40:34 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #6 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: pl | Plik: - | Heartbeat: 2026-02-19T22:40:26Z  
> **Okno godzinowe:** okno=1.0h | cykli=35 | pominięte=0.0% | odrzucone=31.5% | przepustowość=917.2/h  
> **Tłumaczeń netto:** 112,494

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-19 22:40:34 |
| LIVE | 🟢 AKTYWNY | 12s temu | - | `activity.json / worker_state.json` | 2026-02-19T22:40:26Z |
| MIGRATION | 🔒 NIEAKTYWNY | 2d temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-19 22:40:34 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-19T22:39:36.068736Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-19T22:40:37.962021Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-19 22:40:34 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 12s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-19T22:40:26Z
...
| ❤️ **Heartbeat** | 2026-02-19T22:40:26Z |
...
> **ETA globalne:** ~103 dni (2,262,579 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| PL | █████████████████░░░ | 87.7% | 47,004/53,586 | ~4h |
| ES | ████████████████░░░░ | 84.5% | 45,266/53,586 | ~6h |
| IT | ██████████░░░░░░░░░░ | 50.9% | 27,297/53,586 | ~26h |
| RU | ██████████░░░░░░░░░░ | 50.3% | 26,966/53,586 | ~26h |
| SR | █████████░░░░░░░░░░░ | 45.4% | 24,318/53,586 | ~29h |
| RO | ████████░░░░░░░░░░░░ | 41.9% | 22,437/53,586 | ~31h |
...
> Świeżość: 2d temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-19 22:40:34
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-19T22:39:36.068736Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-19T21:40:35.251577Z → 2026-02-19T22:40:35.251577Z) |
...
| Przepustowość (kluczy/h) | **917.2 kluczy/h** |
| Podejrzane tłumaczenia | **5154** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-19T22:40:37.962021Z

- **Ostatni audyt:** SLOW_MODE | 36 issue(s) / 100 entries | 2026-02-19T22:40:26.171163Z | recent_hidden=0
- **Alarm recent hidden HIGH/CRITICAL:** ✅ OK | hidden=0, threshold=5, trend=→ last10=0.00, prev10=0.00, latest=0
- **Regresja critical bad keys pack:** 🚨 FAIL: pl(critical=15, pack=0), es(critical=30, pack=0)
- **Top 5 typów problemów:** suspicious_rejected_critical=155, suspicious_log_critical=100, suspicious_log_high=92, suspicious_rejected_high=45, identical_to_en_exempt=35
- **Języki o najsłabszej jakości:** es(60.1, issues=311947), pl(60.1, issues=176885), ro(60.1, issues=171109), it(60.5, issues=68752), sr(61.2, issues=85408)
...
⚠️ **PL**: jakość 60%, 176885 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 311947 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 68752 problemów
⚠️ **RU**: jakość 68%, 207527 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 79%, 29416 problemów
...
| Heartbeat | 12s temu | 2026-02-19T22:40:26Z |
...
- 2026-02-19 22:39:49 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-19 22:39:30 | AUTO_TRANSLATE:heartbeat_tick | es | ok | html.json
- 2026-02-19 22:39:30 | AUTO_TRANSLATE:parallel_start | es | ok | html.json
- 2026-02-19 22:39:27 | AUTO_TRANSLATE:auto_done | pl | ok | html.json
- 2026-02-19 22:39:18 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | html.json
- 2026-02-19 22:37:50 | AUTO_TRANSLATE:auto_start | pl | ok | html.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.7% | 0 | 1,825 | 466 | 1812 (79.5%) | 38 |
| 🟡 ES | 84.5% | 0 | 2,155 | 370 | 839 (69.4%) | 37 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **112,494** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=43.51%, reason=decrease_high_fail_rate=43.5% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 836 kluczy / 75 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-19 22:40:34
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **3,177** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 9 |
| ❌ Błędów | 84 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (735), **RU** (517), **RO** (479), **PL** (466), **IT** (458) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **143,194** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-19 22:40:34  
