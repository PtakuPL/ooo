...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **9.89%**. Tempo: **1505.4 kluczy/h**. Tłumaczeń netto: **70,188**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-14 16:22:33

> **Aktualizacja:** 2026-02-14 16:22:33 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #2 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-02-14T16:22:29Z  
> **Okno godzinowe:** okno=1.0h | cykli=114 | pominięte=0.0% | odrzucone=40.4% | przepustowość=1505.4/h  
> **Tłumaczeń netto:** 70,188

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-14 16:22:33 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-14T16:22:29Z |
| MIGRATION | 🔒 NIEAKTYWNY | 43s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-14 16:22:33 |
| TRANSLATION | 🟢 AKTYWNY | 12s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-14T16:22:21.947538Z |
| QUALITY | 🔒 NIEAKTYWNY | 3min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-14T16:18:59.787557Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-14 16:22:33 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-14T16:22:29Z
...
| ❤️ **Heartbeat** | 2026-02-14T16:22:29Z |
...
| 🔁 Cykli | 114 |
| 🌍 Języków | 2 |
| 🏆 Najaktywniejszy | PL (1,377 kluczy) |
...
|-------|---------------|-----------|-----|-------|
| PL | 1,377 | 1141 | 45.3% | 14 |
| ES | 1,000 | 469 | 31.9% | 15 |
...
|-------|---------------|-----------|----------|----------|
| ES | 39,888 | 53,586 | 74.44% | 2,587 |
| PL | 23,962 | 53,586 | 44.72% | 1,912 |
...
> **ETA globalne:** ~66 dni (2,371,578 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ██████████████░░░░░░ | 74.4% | 39,888/53,586 | ~7h |
| PL | ████████░░░░░░░░░░░░ | 44.7% | 23,962/53,586 | ~18h |
...
> Świeżość: 43s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-14 16:22:33
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 12s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-14T16:22:21.947538Z
...
|-------|----------------|-------------------------------|---------|--------------|
| ES (Hiszpański) | 39,888/53,586 | 74.44% | 2,587 | 0 |
| PL (Polski) | 23,962/53,586 | 44.72% | 1,912 | 0 |
...
- Raporty strażnika jakości: **2180**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2113**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **9.89%** (275,534/2,786,472)
- **Kopie EN (łącznie):** **167,630**
...
|-------|--------|----------|----------|------------|
| ES | 37,304/49,731 | 75.0% | 2,584/3,855 | 67.0% |
| PL | 21,277/49,731 | 42.8% | 2,685/3,855 | 69.7% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-14T15:22:34.052262Z → 2026-02-14T16:22:34.052262Z) |
...
| Podejrzane tłumaczenia | **5564** |
| Najgorsze cele (strażnik) | pl/items.json (gf=410), pl/server.json (gf=211), es/scripts.json (gf=150), pl/scripts.json (gf=125), pl/quests.json (gf=123) |
...
> Świeżość: 3min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-14T16:18:59.787557Z

- **Ostatni audyt:** SLOW_MODE | 12 issue(s) / 100 entries | 2026-02-14T16:18:59.787557Z
- **Top 5 typów problemów:** suspicious_rejected_critical=200, suspicious_log_high=111, suspicious_log_critical=78, identical_to_en_exempt=21, artifact_token=12
- **Języki o najsłabszej jakości:** es(60.1, issues=155626), pl(60.1, issues=116156), tl(64.2, issues=466), zh_TW(64.8, issues=337), fr(66.5, issues=2470)
...
⚠️ **PL**: jakość 60%, 116156 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 155626 problemów
...
| Heartbeat | 5s temu | 2026-02-14T16:22:29Z |
...
- 2026-02-14 16:22:10 | AUTO_TRANSLATE:heartbeat_tick | es | ok | quests.json
- 2026-02-14 16:22:10 | AUTO_TRANSLATE:parallel_start | es | ok | quests.json
- 2026-02-14 16:22:09 | AUTO_TRANSLATE:auto_done | pl | ok | quests.json
- 2026-02-14 16:22:06 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | quests.json
- 2026-02-14 16:20:35 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | quests.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 44.7% | 0 | 1,912 | 3,177 | 1945 (38.0%) | 80 |
| 🟡 ES | 74.4% | 0 | 2,587 | 2,336 | 940 (28.7%) | 67 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **70,188** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=14.58%, reason=stable_fail_rate=14.6% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 5,513 kluczy / 147 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-14 16:22:33
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **37,067** kluczy |
| ⏭️ Pominięte | 1 |
| 🔁 Cykli | 49 |
| ❌ Błędów | 449 |
| 🌍 Aktywnych języków | 52 |
| 🏆 TOP 5 | **ES** (9,933), **PL** (3,971), **IT** (971), **PT** (960), **DE** (890) |
| 📊 Porównanie | ↓ 19.5% vs wczoraj (46,073) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **84,489** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-14 16:22:33  
