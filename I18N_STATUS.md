...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.82%**. Tempo: **1484.4 kluczy/h**. Tłumaczeń netto: **113,744**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 16:45:49

> **Aktualizacja:** 2026-02-20 16:45:49 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #10 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ro | Plik: - | Heartbeat: 2026-02-20T16:45:46Z  
> **Okno godzinowe:** okno=1.0h | cykli=67 | pominięte=0.0% | odrzucone=73.8% | przepustowość=1484.4/h  
> **Tłumaczeń netto:** 113,744

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 16:45:49 |
| LIVE | 🟢 AKTYWNY | 4s temu | - | `activity.json / worker_state.json` | 2026-02-20T16:45:46Z |
| MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 16:45:49 |
| TRANSLATION | 🟢 AKTYWNY | 37s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T16:45:12.873007Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T16:45:50.304541Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 16:45:49 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 4s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T16:45:46Z
...
| ❤️ **Heartbeat** | 2026-02-20T16:45:46Z |
...
| ❌ Odrzucone (guard) | 3651 |
| 🔁 Cykli | 67 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (303 kluczy) |
...
| IT | 27,522 | 53,586 | 51.36% | 2,132 |
| RU | 26,980 | 53,586 | 50.35% | 1,457 |
| SR | 24,318 | 53,586 | 45.38% | 1,081 |
| RO | 22,593 | 53,586 | 42.16% | 2,345 |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 16:45:49
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 37s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T16:45:12.873007Z
...
| IT (Włoski) | 27,522/53,586 | 51.36% | 2,132 | 0 |
| RU (Rosyjski) | 26,980/53,586 | 50.35% | 1,457 | 0 |
| SR (SR) | 24,318/53,586 | 45.38% | 1,081 | 0 |
| RO (Rumuński) | 22,593/53,586 | 42.16% | 2,345 | 0 |
...
- Raporty strażnika jakości: **6575**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3683**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **13.82%** (385,063/2,786,472)
- **Kopie EN (łącznie):** **162,331**
...
| IT | 26,191/49,731 | 52.7% | 1,331/3,855 | 34.5% |
| RU | 24,184/49,731 | 48.6% | 2,796/3,855 | 72.5% |
| SR | 24,217/49,731 | 48.7% | 101/3,855 | 2.6% |
| RO | 21,337/49,731 | 42.9% | 1,256/3,855 | 32.6% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T15:45:50.057149Z → 2026-02-20T16:45:50.057149Z) |
...
| Przepustowość (kluczy/h) | **1484.4 kluczy/h** |
| Podejrzane tłumaczenia | **7703** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T16:45:50.304541Z

- **Ostatni audyt:** SLOW_MODE | 33 issue(s) / 100 entries | 2026-02-20T16:45:46.052962Z | recent_hidden=0
- **Alarm recent hidden HIGH/CRITICAL:** ✅ OK | hidden=0, threshold=5, trend=→ last10=0.00, prev10=0.00, latest=0
- **Regresja critical bad keys pack:** 🚨 FAIL: pl(critical=68, pack=0), es(critical=59, pack=0)
- **Top 5 typów problemów:** suspicious_rejected_critical=170, suspicious_log_high=122, suspicious_log_critical=78, artifact_token=32, suspicious_rejected_high=30
- **Języki o najsłabszej jakości:** es(60.1, issues=316420), pl(60.1, issues=179098), ro(60.1, issues=172661), sr(60.3, issues=85681), it(63.8, issues=69504)
...
⚠️ **PL**: jakość 60%, 179098 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 316420 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 64%, 69504 problemów
⚠️ **RU**: jakość 65%, 208865 problemów
...
| Heartbeat | 4s temu | 2026-02-20T16:45:46Z |
...
- 2026-02-20 16:45:19 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 16:45:10 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | quests.json
- 2026-02-20 16:45:10 | AUTO_TRANSLATE:parallel_start | ru | ok | quests.json
- 2026-02-20 16:45:01 | AUTO_TRANSLATE:heartbeat_tick | it | ok | quests.json
- 2026-02-20 16:45:01 | AUTO_TRANSLATE:parallel_start | it | ok | quests.json
- 2026-02-20 16:45:00 | AUTO_TRANSLATE:auto_done | ro | ok | spells.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.7% | 0 | 1,827 | 672 | 5845 (89.7%) | 37 |
| 🟡 ES | 84.6% | 0 | 2,162 | 668 | 2236 (77.0%) | 39 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **113,744** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=52.21%, reason=decrease_high_fail_rate=52.2% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,340 kluczy / 76 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 16:45:49

- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+23) — repair_identical lang=es file=npc.json target_identical=51 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=294.96
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+0, translated+0, skipped+0) — lang=ro file=spells.json strict_skipped_done=1290 guard_fail=50 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+23) — repair_identical lang=es file=npc.json target_identical=51 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=283.15
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+50, skipped+0) — parallel lang=es file=monsters.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+50, skipped+0) — lang=pl file=monsters.json strict_skipped_done=4564 guard_fail=5 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+43, skipped+0) — parallel lang=es file=questlog.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [sr] → ok (translated+40, skipped+0) — parallel lang=sr file=server.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [sv] → warn (files+1, translated+42, skipped+0) — lang=sv file=server.json strict_skipped_done=477 guard_fail=8 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **1,501** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 10 |
| ❌ Błędów | 33 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (396), **RU** (303), **IT** (273), **RO** (212), **PL** (117) |
| 📊 Porównanie | ↓ 58.8% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **99,086** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 16:45:49  
