...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 02:10:00

> **Aktualizacja:** 2026-04-29 02:10:00 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,520 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ro | Plik: items.json | Heartbeat: 2026-04-29T02:08:07Z
> **Okno godzinowe:** okno=1.0h | cykli=81 | pominięte=0.0% | odrzucone=4.4% | przepustowość=721.0/h  
> **Tłumaczeń netto:** 139,805

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 02:10:00 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T02:08:07Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 23s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 02:10:00 |
| TRANSLATION | 🟢 AKTYWNY | 5min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T02:04:28.687269Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T02:08:07.324206Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 02:10:00 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T02:10:06.546946Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T02:08:07Z
...
| ❤️ **Heartbeat** | 2026-04-29T02:08:07Z |
...
| 🌍 Recent provider mix | TM/simple(298), Free Google Translate(175), canonical_name_semantic_autofix(15), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=491, fallbacks=24) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=535/535 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `NO_WRITE` | OK | OK | `129` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 17451}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 23s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 02:10:00
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 5min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T02:04:28.687269Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T02:08:35.344914Z |
...
| 🕒 Evidence window | 24h (span=31.30h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=31.30h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T01:10:00.705289Z → 2026-04-29T02:10:00.705289Z) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T02:08:07.324206Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T02:08:07.324206Z
- **Top 5 typów problemów:** suspicious_rejected_critical=188, suspicious_log_low=107, suspicious_log_high=92, suspicious_rejected_high=12, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=729260), ro(60.1, issues=428527), de(60.1, issues=111679), cs(60.1, issues=88073), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 729260 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 67%, 170264 problemów
⚠️ **RU**: jakość 62%, 360551 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,520 |
| Heartbeat | 119s temu | 2026-04-29T02:08:07Z |
...
- 2026-04-29 02:08:36 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-04-29 02:08:35 | AUTO_TRANSLATE:auto_start | ro | ok | items.json
- 2026-04-29 02:07:47 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **139,805** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=4.91%, reason=increase_low_fail_rate=4.9%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 02:10:00
...
| 🔄 Cykli wykonanych | **#17,520** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,520 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 02:10:00  
