...
> **Aktualizacja:** 2025-12-11 17:14:39 UTC  
...
├─────────────────────────────────────────────────────────────────┤
│ ⏳ Total processed: 324 operacji               │
│ 🌍 Języki zsync: 0/53                                │
│ 📅 Ostatnia aktualizacja: 2025-12-11 17:14:39                 │
└─────────────────────────────────────────────────────────────────┘
```
...
|---------|---------|-----------|
| 📁 Operacji wykonanych | **324** | we wszystkich kategoriach |
...
| npc | 5339 | 240 | 0 | ✅ Active |
| html | 1495 | 0 | 2 | ⏭️ Skip 5m |
| spells | 304 | 0 | 2 | ⏭️ Skip 2m |
| client | 242 | 0 | 2 | ⏭️ Skip 5m |
| raids | 147 | 0 | 2 | ⏭️ Skip 2m |
| php | 59 | 15 | 0 | ✅ Active |
| scripts | 43 | 69 | 0 | ✅ Active |
| startup | 23 | 0 | 2 | ⏭️ Skip 4m |
| libs | 21 | 0 | 2 | ⏭️ Skip 4m |
| modules | 16 | 0 | 2 | ⏭️ Skip 4m |
| messages | 11 | 0 | 0 | ✅ Active |
| chatchannels | 8 | 0 | 2 | ⏭️ Skip 4m |
| events | 5 | 0 | 2 | ⏭️ Skip 4m |
...
| spells | 2m | 2x | Progresywny backoff |
| talkactions | 3m | 2x | Progresywny backoff |
| movements | 3m | 2x | Progresywny backoff |
| creaturescripts | 3m | 2x | Progresywny backoff |
| globalevents | 3m | 2x | Progresywny backoff |
...
| client_modules | 8m | 2x | Progresywny backoff |
| client_mods | 8m | 2x | Progresywny backoff |
| client_data | 8m | 2x | Progresywny backoff |
| client_cpp | 8m | 2x | Progresywny backoff |
...
📅 Auto-updated by Worker v1.1 | Last: 2025-12-11 17:14:39  
...
- ✅ `the_lootmonger` - ukończono 2025-12-11 17:14
- ✅ `tandros` - ukończono 2025-12-11 17:14
- ✅ `sundara` - ukończono 2025-12-11 17:14
- ✅ `sigurd` - ukończono 2025-12-11 17:14
- ✅ `shiriel` - ukończono 2025-12-11 17:14
- ✅ `seymour` - ukończono 2025-12-11 17:14
- ✅ `romir` - ukończono 2025-12-11 17:14
- ✅ `rock_in_a_hard_place` - ukończono 2025-12-11 17:14
- ✅ `nipuna` - ukończono 2025-12-11 17:14
- ✅ `nelly` - ukończono 2025-12-11 17:14
