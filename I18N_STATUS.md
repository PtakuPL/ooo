...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.05% / real 10.97%**. Tempo: **537.0 kluczy/h**. Tłumaczeń netto: **148,683**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 14:07:07

> **Aktualizacja:** 2026-04-29 14:07:07 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,508 | Status: ✅ BEZCZYNNY | Faza: IDLE | Etap: cycle_start | Kategoria: tr | Plik: items.json | Heartbeat: 2026-04-29T14:03:50Z
> **Okno godzinowe:** okno=1.0h | cykli=68 | pominięte=0.0% | odrzucone=4.6% | przepustowość=537.0/h  
> **Tłumaczeń netto:** 148,683

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 14:07:07 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-04-29T14:03:50Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie IDLE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 14:07:07 |
| TRANSLATION | 🔒 NIEAKTYWNY | 3min temu | worker w trybie IDLE | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T14:03:31.864691Z |
| QUALITY | 🔒 NIEAKTYWNY | 26s temu | worker w trybie IDLE | `quality_audit_latest.json` | 2026-04-29T14:06:48.375733Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 14:07:07 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T14:07:15.046062Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T14:03:50Z
...
| 🔄 **Ostatni cykl** | 39 kluczy, 0 odrzuconych, 256.1s, tryb: AUTO_TRANSLATE, cel: tr/items.json |
| ❤️ **Heartbeat** | 2026-04-29T14:03:50Z |
...
| ⏳ Oldest pending (visible tail) | 18172 s |
...
| 🌍 Recent provider mix | TM/simple(357), Free Google Translate(128), canonical_name_semantic_autofix(18), OpenAI model pool(8), term... |
...
| ❤️ Pool health | `critical` (writes=514, fallbacks=23) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=1087/1087 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 18172}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~231 dni (2,982,442 kluczy do celu 95%)
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 14:07:07
...
> Świeżość: 3min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T14:03:31.864691Z
...
- Raporty strażnika jakości: **4975**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4828**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T14:02:45.402979Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.05%** (699,626/3,875,872)
- **Pokrycie globalne (real):** **10.97%** (425,371/3,875,872)
- **Kopie EN (łącznie):** **410,342**
- **Placeholdery [EN]/puste (łącznie):** **2,186,037**
...
- **Profiler cyklu (ostatni):** cykl #8 (AUTO_TRANSLATE): dispatch 2111ms, mode 241617ms, status 10786ms, total 256075ms
...
| 🕒 Evidence window | 24h (span=43.25h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=43.25h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T13:07:08.180124Z → 2026-04-29T14:07:08.180124Z) |
...
| Podejrzane tłumaczenia | **981** |
| Najgorsze cele (strażnik) | cs/items.json (gf=9), ro/items.json (gf=8), de/otclient_modules.json (gf=3), de/npc.json (gf=3), ru/items.json (gf=2) |
...
> Świeżość: 26s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T14:06:48.375733Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T14:06:48.375733Z
- **Top 5 typów problemów:** suspicious_rejected_critical=190, suspicious_log_medium=91, suspicious_log_high=58, suspicious_log_low=48, suspicious_rejected_high=10
- **Języki o najsłabszej jakości:** es(60.1, issues=749797), ro(60.1, issues=444251), de(60.1, issues=126758), cs(60.1, issues=118261), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 60%, 58450 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 749797 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 68%, 178861 problemów
⚠️ **RU**: jakość 78%, 373738 problemów
...
|-----------|--------|-----------|
| Worker | ✅ BEZCZYNNY | Cykl #18,508 |
| Heartbeat | 205s temu | 2026-04-29T14:03:50Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T14:03:49.819652Z
...
- 2026-04-29 14:05:20 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 14:03:50 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 14:03:32 | AUTO_TRANSLATE:auto_done | tr | ok | items.json
- 2026-04-29 14:02:47 | AUTO_TRANSLATE:heartbeat_tick | tr | ok | items.json
- 2026-04-29 14:02:46 | AUTO_TRANSLATE:auto_start | tr | ok | items.json
- 2026-04-29 14:02:24 | AUTO_TRANSLATE:auto_done | de | ok | npc.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **148,683** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=5.94%, reason=stable_fail_rate=5.9%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 14:07:07
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **11,433** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 216 |
| ❌ Błędów | 506 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,935), **RU** (1,809), **TR** (1,803), **DE** (1,665), **IT** (1,633) |
| 📊 Porównanie | ↑ 39.0% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **30,413** kluczy
...
| 🔄 Cykli wykonanych | **#18,508** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,508 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 14:07:07  
