...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.01% / real 10.93%**. Tempo: **884.0 kluczy/h**. Tłumaczeń netto: **145,630**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 09:22:31

> **Aktualizacja:** 2026-04-29 09:22:31 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,127 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: de | Plik: npc.json | Heartbeat: 2026-04-29T09:19:06Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=4.1% | przepustowość=884.0/h  
> **Tłumaczeń netto:** 145,630

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 09:22:31 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-04-29T09:19:06Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 54s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 09:22:31 |
| TRANSLATION | 🟢 AKTYWNY | 3min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T09:18:49.714523Z |
| QUALITY | 🔒 NIEAKTYWNY | 41s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T09:21:56.581902Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 09:22:31 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T09:22:37.740366Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T09:19:06Z
...
| ❤️ **Heartbeat** | 2026-04-29T09:19:06Z |
...
| ⏳ Oldest pending (visible tail) | 15806 s |
...
| 🌍 Recent provider mix | TM/simple(274), Free Google Translate(192), canonical_name_semantic_autofix(19), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=488, fallbacks=24) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=870/870 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 386, 'oldest_s': 15806}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~141 dni (2,983,914 kluczy do celu 95%)
...
| RU | █████████░░░░░░░░░░░ | 46.1% | 34,401/74,536 | ~41h |
| FR | ███████████░░░░░░░░░ | 57.5% | 42,864/74,536 | ~32h |
| CS | ██████████░░░░░░░░░░ | 50.7% | 37,787/74,536 | ~37h |
...
> Świeżość: 54s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 09:22:31
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T09:18:49.714523Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T09:22:27.225867Z |
...
| 🕒 Evidence window | 24h (span=38.50h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=38.50h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T08:22:31.563063Z → 2026-04-29T09:22:31.563063Z) |
...
> Świeżość: 41s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T09:21:56.581902Z

- **Ostatni audyt:** OK | 2 issue(s) / 100 entries | 2026-04-29T09:21:56.581902Z
- **Top 5 typów problemów:** suspicious_rejected_critical=189, suspicious_log_low=87, suspicious_log_high=81, suspicious_log_medium=31, suspicious_rejected_high=11
- **Języki o najsłabszej jakości:** es(60.1, issues=742123), ro(60.1, issues=438535), de(60.1, issues=121129), cs(60.1, issues=105641), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 742123 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 64%, 176044 problemów
⚠️ **RU**: jakość 68%, 368967 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,127 |
| Heartbeat | 211s temu | 2026-04-29T09:19:06Z |
...
- 2026-04-29 09:22:27 | AUTO_TRANSLATE:auto_start | de | ok | npc.json
- 2026-04-29 09:20:37 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 09:22:31
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **8,076** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 185 |
| ❌ Błędów | 339 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,465), **RU** (1,446), **IT** (1,226), **TR** (1,113), **DE** (1,095) |
| 📊 Porównanie | ↓ 1.8% vs wczoraj (8,228) |
...
| 🔄 Cykli wykonanych | **#18,127** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,127 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 09:22:31  
