...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.04% / real 10.97%**. Tempo: **783.0 kluczy/h**. Tłumaczeń netto: **148,108**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 13:00:36

> **Aktualizacja:** 2026-04-29 13:00:36 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,428 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-04-29T12:57:34Z
> **Okno godzinowe:** okno=1.0h | cykli=80 | pominięte=0.0% | odrzucone=5.3% | przepustowość=783.0/h  
> **Tłumaczeń netto:** 148,108

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 13:00:36 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-04-29T12:57:34Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 21s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 13:00:36 |
| TRANSLATION | 🟢 AKTYWNY | 3min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T12:57:18.758624Z |
| QUALITY | 🔒 NIEAKTYWNY | 5s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T13:00:38.134684Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 13:00:36 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T13:00:43.290446Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T12:57:34Z
...
| ❤️ **Heartbeat** | 2026-04-29T12:57:34Z |
...
| ⏳ Oldest pending (visible tail) | 16883 s |
...
| 🌍 Recent provider mix | TM/simple(302), Free Google Translate(171), canonical_name_semantic_autofix(15), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=491, fallbacks=21) |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 395, 'oldest_s': 16883}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~159 dni (2,982,739 kluczy do celu 95%)
...
| RU | █████████░░░░░░░░░░░ | 46.1% | 34,384/74,536 | ~47h |
| FR | ███████████░░░░░░░░░ | 57.5% | 42,864/74,536 | ~36h |
| CS | ██████████░░░░░░░░░░ | 51.1% | 38,078/74,536 | ~42h |
...
> Tempo obliczone na bazie ostatniej godziny: ~783 kluczy/h.
...
> Świeżość: 21s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 13:00:36
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T12:57:18.758624Z
...
| 🕒 Evidence window | 24h (span=42.14h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=42.14h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T12:00:37.208593Z → 2026-04-29T13:00:37.208593Z) |
...
| Przepustowość (kluczy/h) | **783.0 kluczy/h** |
| Podejrzane tłumaczenia | **1179** |
| Najgorsze cele (strażnik) | cs/items.json (gf=26), ro/items.json (gf=8), de/npc.json (gf=3), ru/items.json (gf=3), it/items.json (gf=2) |
...
> Świeżość: 5s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T13:00:38.134684Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T13:00:38.134684Z
- **Top 5 typów problemów:** suspicious_rejected_critical=190, suspicious_log_high=105, suspicious_log_low=94, suspicious_rejected_high=10, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=748355), ro(60.1, issues=442991), de(60.1, issues=125634), cs(60.1, issues=115630), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 60%, 58048 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 748355 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 75%, 178275 problemów
⚠️ **RU**: jakość 66%, 372783 problemów
...
| Heartbeat | 189s temu | 2026-04-29T12:57:34Z |
...
- 2026-04-29 13:00:35 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 12:59:05 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 13:00:36
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 13:00:36  
