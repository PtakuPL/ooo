...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.85%**. Tempo: **1435.2 kluczy/h**. Tłumaczeń netto: **116,584**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 18:10:28

> **Aktualizacja:** 2026-02-20 18:10:28 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #39 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: es | Plik: - | Heartbeat: 2026-02-20T18:10:24Z  
> **Okno godzinowe:** okno=1.0h | cykli=177 | pominięte=0.0% | odrzucone=67.7% | przepustowość=1435.2/h  
> **Tłumaczeń netto:** 116,584

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 18:10:28 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T18:10:24Z |
| MIGRATION | 🔒 NIEAKTYWNY | 22s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 18:10:28 |
| TRANSLATION | 🟢 AKTYWNY | 7s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T18:10:22.552988Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T18:10:29.451494Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 18:10:28 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T18:10:24Z
...
| ❤️ **Heartbeat** | 2026-02-20T18:10:24Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **2,481** kluczy |
| ❌ Odrzucone (guard) | 5203 |
| 🔁 Cykli | 177 |
| 🌍 Języków | 7 |
...
> Świeżość: 22s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 18:10:28
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 7s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T18:10:22.552988Z
...
- Raporty strażnika jakości: **6728**  
- Raporty blokad: **0**  
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T17:10:28.730803Z → 2026-02-20T18:10:28.730803Z) |
...
| Przepustowość (kluczy/h) | **1435.2 kluczy/h** |
| Podejrzane tłumaczenia | **4095** |
| Najgorsze cele (strażnik) | pl/items.json (gf=1632), es/items.json (gf=1551), pl/npc.json (gf=968), ro/monsters.json (gf=92), es/spells.json (gf=73) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T18:10:29.451494Z

- **Ostatni audyt:** SLOW_MODE | 32 issue(s) / 100 entries | 2026-02-20T18:10:24.493824Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=122, suspicious_log_high=98, artifact_token=32, suspicious_rejected_high=26, suspicious_log_critical=3
- **Języki o najsłabszej jakości:** es(60.1, issues=325432), pl(60.1, issues=182297), ro(60.1, issues=177900), it(60.1, issues=72118), sr(62.1, issues=86199)
...
⚠️ **PL**: jakość 60%, 182297 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 325432 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 72118 problemów
⚠️ **RU**: jakość 86%, 210761 problemów
...
| Heartbeat | 5s temu | 2026-02-20T18:10:24Z |
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,829 | 663 | 6941 (91.3%) | 38 |
...
| Przepustowość (okno) | 1,408 kluczy / 79 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 18:10:28
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **5,892** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 39 |
| ❌ Błędów | 139 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (1,642), **RU** (1,097), **IT** (982), **RO** (681), **PL** (663) |
| 📊 Porównanie | ↑ 61.8% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **103,477** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 18:10:28  
