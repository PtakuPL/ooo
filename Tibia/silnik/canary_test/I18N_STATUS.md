...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.01% / real 10.93%**. Tempo: **761.0 kluczy/h**. Tłumaczeń netto: **145,729**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 09:30:34

> **Aktualizacja:** 2026-04-29 09:30:34 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,140 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: cs | Plik: items.json | Heartbeat: 2026-04-29T09:29:35Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=4.4% | przepustowość=761.0/h  
> **Tłumaczeń netto:** 145,729

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 09:30:34 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T09:29:35Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 13s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 09:30:34 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T09:29:33.904592Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T09:29:34.991513Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 09:30:34 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T09:30:41.740299Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T09:29:35Z
...
| 🔄 **Ostatni cykl** | 32 kluczy, 1 odrzuconych, 73.0s, tryb: AUTO_TRANSLATE, cel: ru/items.json |
| ❤️ **Heartbeat** | 2026-04-29T09:29:35Z |
...
| ⏳ Oldest pending (visible tail) | 15004 s |
...
| 🌍 Recent provider mix | TM/simple(295), Free Google Translate(195), canonical_name_semantic_autofix(16), term_consistency_autofix(3) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=876/876 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 386, 'oldest_s': 15004}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~163 dni (2,983,884 kluczy do celu 95%)
...
| RU | █████████░░░░░░░░░░░ | 46.1% | 34,401/74,536 | ~48h |
| FR | ███████████░░░░░░░░░ | 57.5% | 42,864/74,536 | ~37h |
| CS | ██████████░░░░░░░░░░ | 50.7% | 37,787/74,536 | ~43h |
...
> Świeżość: 13s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 09:30:34
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T09:29:33.904592Z
...
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14265.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14266.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14267.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14268.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14269.name)
- ornamented wall → орнаментированная стена (item.1427.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14270.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14271.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14272.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14273.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14274.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14275.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14276.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14277.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14278.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14279.name)
- ornamented wall → орнаментированная стена (item.1428.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14280.name)
- true heart of the sea → настоящее сердце моря (item.14241.name)
- true heart of the sea → настоящее сердце моря (item.14242.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4882**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4735**
...
- **Pokrycie globalne (nominal):** **18.01%** (698,184/3,875,872)
- **Pokrycie globalne (real):** **10.93%** (423,816/3,875,872)
- **Kopie EN (łącznie):** **410,455**
- **Placeholdery [EN]/puste (łącznie):** **2,187,479**
...
| 🕒 Evidence window | 24h (span=38.64h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=38.64h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T08:30:34.965443Z → 2026-04-29T09:30:34.965443Z) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T09:29:34.991513Z
...
| Heartbeat | 66s temu | 2026-04-29T09:29:35Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T09:24:13.419451Z
...
- 2026-04-29 09:28:21 | AUTO_TRANSLATE:auto_start | ru | ok | items.json
- 2026-04-29 09:25:44 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 09:30:34
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **8,178** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 185 |
| ❌ Błędów | 344 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **RU** (1,478), **CS** (1,465), **IT** (1,226), **TR** (1,152), **DE** (1,125) |
| 📊 Porównanie | ↓ 0.6% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **27,158** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 09:30:34  
