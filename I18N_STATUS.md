...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-19 17:20:50

> **Aktualizacja:** 2026-02-19 17:20:50 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #1 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: it | Plik: spells.json | Heartbeat: 2026-02-19T17:20:52Z  
...
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-19 17:20:50 |
| LIVE | 🟢 AKTYWNY | 1s temu | - | `activity.json / worker_state.json` | 2026-02-19T17:20:52Z |
| MIGRATION | 🔒 NIEAKTYWNY | 2d temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-19 17:20:50 |
| TRANSLATION | 🟢 AKTYWNY | 8s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-19T17:20:45.106015Z |
| QUALITY | 🔒 NIEAKTYWNY | 26s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-19T17:20:26.405824Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-19 17:20:50 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-19T17:20:52Z
...
| ❤️ **Heartbeat** | 2026-02-19T17:20:52Z |
...
> Świeżość: 2d temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-19 17:20:50
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 8s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-19T17:20:45.106015Z
...
- Raporty strażnika jakości: **5771**  
- Raporty blokad: **0**  
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-19T16:20:50.333381Z → 2026-02-19T17:20:50.333381Z) |
...
| Podejrzane tłumaczenia | **23** |
| Najgorsze cele (strażnik) | es/otclient_modules.json (gf=0), ru/scripts.json (gf=0), es/html.json (gf=0), ro/scripts.json (gf=0), it/actions.json (gf=0) |
...
> Świeżość: 26s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-19T17:20:26.405824Z

- **Ostatni audyt:** SLOW_MODE | 31 issue(s) / 100 entries | 2026-02-19T17:20:26.405824Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=291159), pl(60.1, issues=166518), ru(60.1, issues=163425), ro(60.1, issues=144766), sr(60.1, issues=74611)
...
⚠️ **PL**: jakość 60%, 166518 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 291159 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 57341 problemów
⚠️ **RU**: jakość 60%, 163425 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 90%, 27545 problemów
...
| Heartbeat | 1s temu | 2026-02-19T17:20:52Z |
...
- 2026-02-19 17:20:52 | AUTO_TRANSLATE:heartbeat_tick | it | ok | spells.json
- 2026-02-19 17:20:52 | AUTO_TRANSLATE:parallel_start | it | ok | spells.json
- 2026-02-19 17:20:47 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | server.json
- 2026-02-19 17:20:46 | AUTO_TRANSLATE:parallel_start | ro | ok | server.json
- 2026-02-19 17:20:45 | AUTO_TRANSLATE:auto_done | ru | ok | server.json
- 2026-02-19 17:20:42 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | server.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-19 17:20:50

- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ro] → ok (translated+0, skipped+0) — parallel lang=ro file=server.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → ok (files+0, translated+0, skipped+0) — lang=ru file=server.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [it] → ok (translated+0, skipped+0) — parallel lang=it file=server.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+0, skipped+0) — parallel lang=es file=raids.json
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [pl] → ok (translated+0, skipped+0) — parallel lang=pl file=scripts.json
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-19 17:20:50  
