...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 16.82% / real 9.63%**. Tempo: **2020.0 kluczy/h**. Tłumaczeń netto: **100,503**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-02 16:53:46

> **Aktualizacja:** 2026-04-02 16:53:46 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #12,936 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: pl | Plik: npc.json | Heartbeat: 2026-04-02T16:53:37Z  
> **Okno godzinowe:** okno=1.0h | cykli=76 | pominięte=0.0% | odrzucone=38.5% | przepustowość=2020.0/h  
> **Tłumaczeń netto:** 100,503

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-02 16:53:46 |
| LIVE | 🟢 AKTYWNY | 11s temu | - | `activity.json / worker_state.json` | 2026-04-02T16:53:37Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-02 16:53:46 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-02T16:52:28.960101Z |
| QUALITY | 🔒 NIEAKTYWNY | 26s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-02T16:53:21.866977Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-02 16:53:46 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 11s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-02T16:53:37Z
...
| ❤️ **Heartbeat** | 2026-04-02T16:53:37Z |
...
| �📊 Przetłumaczono | **2,020** kluczy |
| ❌ Odrzucone (guard) | 1267 |
| 🔁 Cykli | 76 |
| 🌍 Języków | 10 |
...
> **ETA globalne:** ~63 dni (3,030,270 kluczy do celu 95%)
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-02 16:53:46
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-02T16:52:28.960101Z
...
- **Pokrycie globalne (nominal):** **16.82%** (651,798/3,875,872)
- **Pokrycie globalne (real):** **9.63%** (373,192/3,875,872)
- **Kopie EN (łącznie):** **430,028**
- **Placeholdery [EN]/puste (łącznie):** **2,218,513**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-02T15:53:46.340044Z → 2026-04-02T16:53:46.340044Z) |
...
| Przepustowość (kluczy/h) | **2020.0 kluczy/h** |
...
|--------|-----------|--------|----------------|
| `gt_validate_fail_placeholder` | 509 | 55.3% | it/npc.json (126) |
| `gt_rejected_critical` | 327 | 35.5% | ro/npc.json (58) |
| `gt_validate_fail_word_salad` | 42 | 4.6% | cs/npc.json (9) |
| `gt_validate_fail_quality` | 39 | 4.2% | tr/npc.json (25) |
| `gt_rejected_high_partial_translation_mix` | 2 | 0.2% | es/monsters.json (2) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 26s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-02T16:53:21.866977Z

- **Ostatni audyt:** SLOW_MODE | 11 issue(s) / 100 entries | 2026-04-02T16:53:21.866977Z
- **Top 5 typów problemów:** suspicious_rejected_critical=170, suspicious_log_high=162, suspicious_rejected_high=30, suspicious_log_low=17, suspicious_log_medium=14
- **Języki o najsłabszej jakości:** ro(60.1, issues=375628), pt(60.1, issues=29618), es(62.2, issues=673231), nl(63.5, issues=27519), it(66.2, issues=135117)
...
⚠️ **ES**: jakość 62%, 673231 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #12,936 |
| Heartbeat | 11s temu | 2026-04-02T16:53:37Z |
...
| Przepustowość (okno) | 3,402 kluczy / 50 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-02 16:53:46
...
| 🔄 Cykli wykonanych | **#12,936** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #12,936 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-02 16:53:46  
