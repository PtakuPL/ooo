...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.04% / real 10.96%**. Tempo: **790.0 kluczy/h**. Tłumaczeń netto: **147,932**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 12:43:59

> **Aktualizacja:** 2026-04-29 12:43:59 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,405 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: items.json | Heartbeat: 2026-04-29T12:40:01Z
> **Okno godzinowe:** okno=1.0h | cykli=79 | pominięte=0.0% | odrzucone=5.6% | przepustowość=790.0/h  
> **Tłumaczeń netto:** 147,932

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 12:43:59 |
| LIVE | 🟢 AKTYWNY | 4min temu | - | `activity.json / worker_state.json` | 2026-04-29T12:40:01Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 45s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 12:43:59 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T12:41:51.688321Z |
| QUALITY | 🔒 NIEAKTYWNY | 22s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T12:43:44.666509Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 12:43:59 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T12:44:07.238565Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 4min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T12:40:01Z
...
| 🔄 **Ostatni cykl** | 42 kluczy, 1 odrzuconych, 224.7s, tryb: AUTO_TRANSLATE, cel: it/items.json |
| ❤️ **Heartbeat** | 2026-04-29T12:40:01Z |
...
| 🌍 Recent provider mix | TM/simple(272), Free Google Translate(188), canonical_name_semantic_autofix(18), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=481, fallbacks=24) |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 390, 'oldest_s': 17228}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~157 dni (2,982,820 kluczy do celu 95%)
...
> Świeżość: 45s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 12:43:59
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T12:41:51.688321Z
...
- Raporty strażnika jakości: **4949**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4802**
...
- **Pokrycie globalne (nominal):** **18.04%** (699,248/3,875,872)
- **Pokrycie globalne (real):** **10.96%** (424,960/3,875,872)
- **Kopie EN (łącznie):** **410,375**
- **Placeholdery [EN]/puste (łącznie):** **2,186,415**
...
| 🕒 Evidence window | 24h (span=41.86h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=41.86h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T11:43:59.869818Z → 2026-04-29T12:43:59.869818Z) |
...
| Najgorsze cele (strażnik) | cs/items.json (gf=25), ro/items.json (gf=12), ru/items.json (gf=3), it/items.json (gf=3), de/otclient_modules.json (gf=2) |
...
> Świeżość: 22s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T12:43:44.666509Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T12:43:44.666509Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=747886), ro(60.1, issues=442672), de(60.1, issues=125248), cs(60.1, issues=114961), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 747886 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 71%, 178114 problemów
⚠️ **RU**: jakość 62%, 372549 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,405 |
| Heartbeat | 246s temu | 2026-04-29T12:40:01Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T12:42:07.430128Z
...
- 2026-04-29 12:43:38 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-29 12:42:08 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-29 12:41:52 | AUTO_TRANSLATE:auto_done | it | ok | items.json
- 2026-04-29 12:41:32 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 12:43:59

- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+1) — repair_identical lang=es file=server.json target_identical=9 limit=180 tier=low_backlog domain_cap=240 gt=true suspicious_pct=906.98
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+42, skipped+0) — lang=it file=items.json strict_skipped_done=3912 guard_fail=1 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **10,608** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 203 |
| ❌ Błędów | 462 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,853), **RU** (1,719), **TR** (1,617), **IT** (1,573), **DE** (1,485) |
| 📊 Porównanie | ↑ 28.9% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **29,588** kluczy
...
| 🔄 Cykli wykonanych | **#18,405** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,405 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 12:43:59  
