...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.88% / real 10.8%**. Tempo: **935.0 kluczy/h**. Tłumaczeń netto: **136,834**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-28 22:11:07

> **Aktualizacja:** 2026-04-28 22:11:07 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,196 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: it | Plik: items.json | Heartbeat: 2026-04-28T22:08:37Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=3.5% | przepustowość=935.0/h  
> **Tłumaczeń netto:** 136,834

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-28 22:11:07 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-28T22:08:37Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 15s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-28 22:11:07 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-28T22:10:03.564342Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-28T22:08:19.394006Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-28 22:11:07 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-28T22:11:13.216472Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-28T22:08:37Z
...
| 🔄 **Ostatni cykl** | 76 kluczy, 1 odrzuconych, 87.0s, tryb: AUTO_TRANSLATE, cel: it/items.json |
| ❤️ **Heartbeat** | 2026-04-28T22:08:37Z |
...
| ⏳ Oldest pending (visible tail) | 15175 s |
...
| 🌍 Recent provider mix | TM/simple(272), Free Google Translate(220), OpenAI model pool(20), canonical_name_semantic_autofix(16), ter... |
...
| ❤️ Pool health | `critical` (writes=531, fallbacks=23) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=354/354 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 389, 'oldest_s': 15175}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~133 dni (2,988,923 kluczy do celu 95%)
...
> Świeżość: 15s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-28 22:11:07
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-28T22:10:03.564342Z
...
- palisade → palizzata (item.11563.name)
- palisade → palizzata (item.11564.name)
- palisade → palizzata (item.11565.name)
- palisade → palizzata (item.11566.name)
- palisade → palizzata (item.11567.name)
- palisade → palizzata (item.11568.name)
- palisade → palizzata (item.11569.name)
- tiled roof → tetto in tegole (item.1157.name)
- palisade → palizzata (item.11570.name)
- palisade → palizzata (item.11573.name)
- palisade → palizzata (item.11574.name)
- palisade → palizzata (item.11575.name)
- palisade → palizzata (item.11576.name)
- palisade → palizzata (item.11577.name)
- palisade → palizzata (item.11578.name)
- palisade → palizzata (item.11579.name)
- tiled roof → tetto in tegole (item.1158.name)
- palisade → palizzata (item.11580.name)
- palisade → palizzata (item.11581.name)
- tiled roof → tetto in tegole (item.1159.name)
...
| 🕒 Evidence window | 24h (span=27.31h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=27.31h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-28T21:11:08.035261Z → 2026-04-28T22:11:08.035261Z) |
...
| Przepustowość (kluczy/h) | **935.0 kluczy/h** |
...
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-28T22:08:19.394006Z
...
| Heartbeat | 156s temu | 2026-04-28T22:08:37Z |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-28 22:11:07
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-28 22:11:07  
