...
local function greetCallback(npc, creature, message)
	...
	if player:getStorageValue(HiddenThreats.CorymRescued06) < 0 then
		...
		NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_GREET, "npc.corym_worker_04.greet_msg_1")
	end
	return true
end
...
-- Greeting message
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_FAREWELL, "npc.corym_worker_04.farewell_msg_1")
