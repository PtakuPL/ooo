...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.86%**. Tempo: **1736.7 kluczy/h**. Tłumaczeń netto: **118,982**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 19:05:41

> **Aktualizacja:** 2026-02-20 19:05:41 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #86 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-02-20T19:05:23Z  
> **Okno godzinowe:** okno=1.0h | cykli=204 | pominięte=0.0% | odrzucone=71.2% | przepustowość=1736.7/h  
> **Tłumaczeń netto:** 118,982

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 19:05:41 |
| LIVE | 🟢 AKTYWNY | 19s temu | - | `activity.json / worker_state.json` | 2026-02-20T19:05:23Z |
| MIGRATION | 🔒 NIEAKTYWNY | 50s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 19:05:41 |
| TRANSLATION | 🟢 AKTYWNY | 25s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T19:05:17.117494Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T19:05:42.612171Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 19:05:41 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 19s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T19:05:23Z
...
| ❤️ **Heartbeat** | 2026-02-20T19:05:23Z |
...
> **ETA globalne:** ~54 dni (2,260,904 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~1737 kluczy/h.
...
> Świeżość: 50s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 19:05:41
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 25s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T19:05:17.117494Z
...
- You already received my line of the prayer. → Ai primit deja rândul meu de rugăciune. (npc.quentin.stdmod_7)
- So receive the protection of the twist of fate, pilgrim. → Așa că primește protecția întorsăturii destinului, pelerine. (npc.quentin.stdmod_8)
- Fine. You are free to decline my offer. → Amenda. Sunteți liber să refuzați oferta mea. (npc.quentin.stdmod_9)
- Of course, just browse through my wares. You can also look at {}. → Desigur, răsfoiește-mi produsele. Puteți să vă uitați și la {}. (npc.rabaz.say_1)
- So you ask me for a {{}} to begin your adventure? → Deci îmi ceri un {{}} pentru a-ți începe aventura? (npc.rachel.say_1)
- What? I have already gave you one {{}}! → Ce? Ți-am dat deja unul {{}}! (npc.rachel.say_2)
- Of course, just browse through my wares. You can also look at {}. → Desigur, răsfoiește-mi produsele. Puteți să vă uitați și la {}. (npc.rachel.say_3)
- Don't forget to deposit your money here in the Global Bank before you head out f → Nu uitați să vă depuneți banii aici în Banca Globală înainte de a pleca în avent (npc.raffael.voice_1)
- So receive the protection of the twist of fate, pilgrim. → Așa că primește protecția întorsăturii destinului, pelerine. (npc.rahkem.keyword_1)
- Sorry, you don't have enough money. → Scuze, nu ai destui bani. (npc.rahkem.stdmod_10)
- You are hurt, my child. I will heal your wounds. → Ești rănit, copilul meu. Îți voi vindeca rănile. (npc.rahkem.stdmod_12)
- You aren't looking that bad. Sorry, I can't help you. But if you are looking for → Nu arăți așa de rău. Scuze, nu te pot ajuta. Dar dacă cauți protecție suplimenta (npc.rahkem.stdmod_13)
- I think you have forgotten to bring your stake, pilgrim. → Cred că ai uitat să-ți aduci țărușul, pelerine. (npc.rahkem.stdmod_14)
- Yes, I was informed what to do. Are you prepared to receive my line of the praye → Da, am fost informat ce să fac. Ești pregătit să primești rândul meu de rugăciun (npc.rahkem.stdmod_15)
- You already received my line of the prayer. → Ai primit deja rândul meu de rugăciune. (npc.rahkem.stdmod_19)
- So receive the protection of the twist of fate, pilgrim. → Așa că primește protecția întorsăturii destinului, pelerine. (npc.rahkem.stdmod_2)
- Whenever you receive a lethal wound, your vital force is damaged and there is a  → Ori de câte ori primești o rană letală, forța ta vitală este deteriorată și exis (npc.rahkem.stdmod_21)
- I see you received the spiritual shielding in the whiteflower temple south of Th → Văd că ai primit scutul spiritual în templul cu flori albe de la sud de Thais. (npc.rahkem.stdmod_23)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T18:05:41.931751Z → 2026-02-20T19:05:41.931751Z) |
...
| Przepustowość (kluczy/h) | **1736.7 kluczy/h** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T19:05:42.612171Z

- **Ostatni audyt:** SLOW_MODE | 48 issue(s) / 100 entries | 2026-02-20T19:04:28.628821Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_log_critical=151, suspicious_rejected_critical=64, artifact_token=32, suspicious_log_high=21, identical_to_en=16
- **Języki o najsłabszej jakości:** es(60.1, issues=330148), pl(60.1, issues=185316), ro(60.2, issues=180888), sr(61.3, issues=86259), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 60%, 185316 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 330148 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 80%, 73372 problemów
...
| Heartbeat | 19s temu | 2026-02-20T19:05:23Z |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 19:05:41
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **9,307** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 86 |
| ❌ Błędów | 210 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (2,696), **RU** (1,847), **IT** (1,561), **RO** (1,164), **PL** (1,032) |
| 📊 Porównanie | ↑ 155.6% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **106,892** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 19:05:41  
