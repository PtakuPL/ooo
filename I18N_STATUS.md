...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.89%**. Tempo: **1641.3 kluczy/h**. Tłumaczeń netto: **124,510**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 21:45:00

> **Aktualizacja:** 2026-02-20 21:45:00 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #218 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: - | Heartbeat: 2026-02-20T21:44:56Z  
> **Okno godzinowe:** okno=1.0h | cykli=205 | pominięte=0.0% | odrzucone=59.8% | przepustowość=1641.3/h  
> **Tłumaczeń netto:** 124,510

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 21:45:00 |
| LIVE | 🟢 AKTYWNY | 6s temu | - | `activity.json / worker_state.json` | 2026-02-20T21:44:56Z |
| MIGRATION | 🔒 NIEAKTYWNY | 23s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 21:45:00 |
| TRANSLATION | 🟢 AKTYWNY | 37s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T21:44:24.114431Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T21:45:01.903238Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 21:45:00 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T21:44:56Z
...
| ❤️ **Heartbeat** | 2026-02-20T21:44:56Z |
...
> **ETA globalne:** ~57 dni (2,260,052 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~1641 kluczy/h.
...
> Świeżość: 23s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 21:45:00
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 37s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T21:44:24.114431Z
...
- Raporty strażnika jakości: **7184**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4290**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **13.89%** (387,060/2,786,472)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T20:45:01.078180Z → 2026-02-20T21:45:01.078180Z) |
...
| Przepustowość (kluczy/h) | **1641.3 kluczy/h** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T21:45:01.903238Z

- **Ostatni audyt:** SLOW_MODE | 16 issue(s) / 100 entries | 2026-02-20T21:44:56.603685Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=139, suspicious_log_high=64, suspicious_log_critical=41, artifact_token=16, suspicious_rejected_high=13
- **Języki o najsłabszej jakości:** es(60.1, issues=348454), pl(60.1, issues=192882), ro(60.1, issues=188861), tl(64.2, issues=466), zh_TW(64.8, issues=337)
...
| Metryka | Wartość | Info |
|---------|---------|------|
| 🔄 Cykl aktualny | **#218** | od uruchomienia |
...
⚠️ **PL**: jakość 60%, 192882 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 348454 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 77%, 76709 problemów
⚠️ **RU**: jakość 79%, 214640 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 70%, 32133 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #218 |
| Heartbeat | 6s temu | 2026-02-20T21:44:56Z |
...
- 2026-02-20 21:44:30 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 21:44:14 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-02-20 21:44:14 | AUTO_TRANSLATE:parallel_start | ro | ok | items.json
- 2026-02-20 21:44:09 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-02-20 21:44:09 | AUTO_TRANSLATE:parallel_start | ru | ok | items.json
- 2026-02-20 21:44:08 | AUTO_TRANSLATE:auto_done | it | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **124,510** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=89.97%, reason=decrease_high_fail_rate=90.0% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 21:45:00
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+30, skipped+0) — lang=it file=items.json strict_skipped_done=4429
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [sv] → ok (translated+46, skipped+0) — parallel lang=sv file=npc.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ro] → ok (translated+7, skipped+0) — parallel lang=ro file=monsters.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → warn (files+1, translated+24, skipped+0) — lang=ru file=monsters.json strict_skipped_done=1128 guard_fail=26 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+50, skipped+0) — parallel lang=es file=raids.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+42, skipped+0) — lang=pl file=otclient_modules.json strict_skipped_done=783 guard_fail=5 placeholder=0 command=0 pipe=0
- 🌍 TRANSLATION_SYNC: SYNC_FILE_DONE [fr] → ok (keys+1122, files+1) — lang=fr file=spells.json
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **17,763** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 218 |
| ❌ Błędów | 431 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (5,251), **RU** (3,489), **IT** (2,845), **RO** (2,123), **PL** (2,095) |
| 📊 Porównanie | ↑ 387.9% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **115,348** kluczy
...
| 🔄 Cykli wykonanych | **#218** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 21:45:00  
