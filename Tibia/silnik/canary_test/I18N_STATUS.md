...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **18.81%**. Tempo: **931.6 kluczy/h**. Tłumaczeń netto: **52,657**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-23 08:30:30

> **Aktualizacja:** 2026-03-23 08:30:30 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **LIVE:** Cykl #9,892 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-03-23T08:30:31Z  
> **Okno godzinowe:** okno=1.0h | cykli=108 | pominięte=0.0% | odrzucone=8.5% | przepustowość=931.6/h  
> **Tłumaczeń netto:** 52,657

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-23 08:30:30 |
| LIVE | 🟢 AKTYWNY | 1s temu | - | `activity.json / worker_state.json` | 2026-03-23T08:30:31Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 58s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-23 08:30:30 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-23T08:28:45.049491Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-23T08:28:28.168970Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-23 08:30:30 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-23T08:30:31Z
...
| ❤️ **Heartbeat** | 2026-03-23T08:30:31Z |
...
> **ETA globalne:** ~132 dni (2,952,963 kluczy do celu 95%)
...
| IT | ██████████████░░░░░░ | 73.0% | 54,387/74,536 | ~18h |
| FR | ██████████████░░░░░░ | 71.2% | 53,098/74,536 | ~19h |
...
> Świeżość: 58s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-23 08:30:30
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-23T08:28:45.049491Z
...
- Raporty strażnika jakości: **2913**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2776**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-23T07:30:31.175800Z → 2026-03-23T08:30:31.175800Z) |
...
| Przepustowość (kluczy/h) | **931.6 kluczy/h** |
| Podejrzane tłumaczenia | **2631** |
| Najgorsze cele (strażnik) | ru/questlog.json (gf=66), pl/books.json (gf=12), ro/questlog.json (gf=11), es/questlog.json (gf=10), ru/raids.json (gf=9) |
...
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-23T08:28:28.168970Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-03-23T08:28:28.168970Z
- **Top 5 typów problemów:** suspicious_log_high=200, suspicious_rejected_critical=187, suspicious_rejected_high=13, identical_to_en_exempt=1
- **Języki o najsłabszej jakości:** es(60.1, issues=599257), pt(60.1, issues=20119), nl(60.1, issues=12241), cs(60.1, issues=12165), tr(66.1, issues=5578)
...
⚠️ **TR**: jakość 66%, 5578 problemów
⚠️ **PL**: jakość 90%, 327562 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 599257 problemów
⚠️ **PT**: jakość 60%, 20119 problemów
⚠️ **FR**: jakość 98%, 17676 problemów
⚠️ **IT**: jakość 91%, 112116 problemów
⚠️ **RU**: jakość 68%, 288461 problemów
⚠️ **NL**: jakość 60%, 12241 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #9,892 |
| Heartbeat | 1s temu | 2026-03-23T08:30:31Z |
...
- 2026-03-23 08:29:01 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-03-23 08:28:45 | AUTO_TRANSLATE:auto_done | ro | ok | questlog.json
- 2026-03-23 08:28:35 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | questlog.json
- 2026-03-23 08:28:35 | AUTO_TRANSLATE:auto_start | ro | ok | questlog.json
- 2026-03-23 08:28:27 | AUTO_TRANSLATE:auto_done | ru | ok | questlog.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **52,657** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=7.96%, reason=stable_fail_rate=8.0% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-23 08:30:30
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+3) — repair_identical lang=es file=npc.json target_identical=2825 limit=156 tier=high_backlog+domain_cap+suspicious_guard domain_cap=260 gt=true suspicious_pct=836.45
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **23,498** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 165 |
| ❌ Błędów | 318 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **ES** (6,928), **TR** (5,129), **PL** (2,454), **RO** (1,765), **RU** (1,417) |
| 📊 Porównanie | ↑ 13.4% vs wczoraj (20,729) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **44,227** kluczy
...
| 🔄 Cykli wykonanych | **#9,892** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-23 08:30:30  
