...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 06:43:14

> **Aktualizacja:** 2026-04-29 06:43:14 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,900 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: items.json | Heartbeat: 2026-04-29T06:42:43Z
> **Okno godzinowe:** okno=1.0h | cykli=80 | pominięte=0.0% | odrzucone=4.3% | przepustowość=904.0/h  
> **Tłumaczeń netto:** 143,611

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 06:43:14 |
| LIVE | 🟢 AKTYWNY | 38s temu | - | `activity.json / worker_state.json` | 2026-04-29T06:42:43Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 06:43:14 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T06:40:57.179666Z |
| QUALITY | 🔒 NIEAKTYWNY | 3min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T06:39:23.743714Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 06:43:14 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T06:43:21.402568Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 38s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T06:42:43Z
...
| ⏳ Oldest pending (visible tail) | 17109 s |
...
| 🌍 Recent provider mix | TM/simple(313), Free Google Translate(151), canonical_name_semantic_autofix(20), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=487, fallbacks=27) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=746/746 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 17109}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 06:43:14
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T06:40:57.179666Z
...
- lush grass → hierba de lush (item.11711.name)
- lush grass → hierba de lush (item.11712.name)
- lush grass → hierba de lush (item.11713.name)
- lush grass → hierba de lush (item.11717.name)
- lush grass → hierba de lush (item.11718.name)
- lush grass → hierba de lush (item.11719.name)
- tiled roof → techo de tejas (item.1172.name)
- lush grass → hierba de lush (item.11720.name)
- lush grass → hierba de lush (item.11721.name)
- lush grass → hierba de lush (item.11722.name)
- lush grass → hierba de lush (item.11723.name)
- lush grass → hierba de lush (item.11724.name)
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T06:39:41.294705Z |
...
| 🕒 Evidence window | 24h (span=35.85h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=35.85h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T05:43:14.435278Z → 2026-04-29T06:43:14.435278Z) |
...
> Świeżość: 3min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T06:39:23.743714Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T06:39:23.743714Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=737335), ro(60.1, issues=435067), de(60.1, issues=117677), cs(60.1, issues=98591), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 737335 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 65%, 173976 problemów
⚠️ **RU**: jakość 62%, 365576 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,900 |
| Heartbeat | 38s temu | 2026-04-29T06:42:43Z |
...
- 2026-04-29 06:39:42 | AUTO_TRANSLATE:heartbeat_tick | es | ok | items.json
- 2026-04-29 06:39:41 | AUTO_TRANSLATE:auto_start | es | ok | items.json
- 2026-04-29 06:39:23 | AUTO_TRANSLATE:auto_done | ro | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 06:43:14

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+19, skipped+0) — lang=es file=items.json strict_skipped_done=1555
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+6) — repair_identical lang=es file=npc.json target_identical=2 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=168.42
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **5,860** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 134 |
| ❌ Błędów | 241 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,163), **RU** (1,075), **IT** (838), **DE** (765), **TR** (762) |
| 📊 Porównanie | ↓ 28.8% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **24,840** kluczy
...
| 🔄 Cykli wykonanych | **#17,900** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,900 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 06:43:14  
