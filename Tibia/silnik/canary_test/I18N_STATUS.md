...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.99% / real 10.91%**. Tempo: **790.0 kluczy/h**. Tłumaczeń netto: **144,357**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 07:44:32

> **Aktualizacja:** 2026-04-29 07:44:32 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,988 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: server.json | Heartbeat: 2026-04-29T07:41:58Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=5.3% | przepustowość=790.0/h  
> **Tłumaczeń netto:** 144,357

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 07:44:32 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T07:41:58Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 41s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 07:44:32 |
| TRANSLATION | 🟢 AKTYWNY | 53s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T07:43:45.348897Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T07:41:58.226152Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 07:44:32 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T07:44:38.787368Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T07:41:58Z
...
| ❤️ **Heartbeat** | 2026-04-29T07:41:58Z |
...
| ⏳ Oldest pending (visible tail) | 16544 s |
...
| 🌍 Recent provider mix | TM/simple(331), Free Google Translate(158), canonical_name_semantic_autofix(17), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=509, fallbacks=24) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=794/794 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 394, 'oldest_s': 16544}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Tempo obliczone na bazie ostatniej godziny: ~790 kluczy/h.
...
> Świeżość: 41s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 07:44:32
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 53s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T07:43:45.348897Z
...
- hive floor → pavimento dell'alveare (item.13233.name)
- hive floor → pavimento dell'alveare (item.13234.name)
- hive floor → pavimento dell'alveare (item.13235.name)
- hive floor → pavimento dell'alveare (item.13236.name)
- hive floor → pavimento dell'alveare (item.13237.name)
- hive floor → pavimento dell'alveare (item.13238.name)
- hive floor → pavimento dell'alveare (item.13239.name)
- hive floor → pavimento dell'alveare (item.13240.name)
- hive floor → pavimento dell'alveare (item.13241.name)
- hive floor → pavimento dell'alveare (item.13242.name)
- hive floor → pavimento dell'alveare (item.13243.name)
- hive floor → pavimento dell'alveare (item.13244.name)
- hive floor → pavimento dell'alveare (item.13245.name)
- hive floor → pavimento dell'alveare (item.13246.name)
- hive floor → pavimento dell'alveare (item.13247.name)
- hive floor → pavimento dell'alveare (item.13248.name)
- hive floor → pavimento dell'alveare (item.13249.name)
- hive floor → pavimento dell'alveare (item.13250.name)
- hive floor → pavimento dell'alveare (item.13251.name)
- hive floor → pavimento dell'alveare (item.13252.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4845**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4698**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T07:42:21.512407Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.99%** (697,444/3,875,872)
- **Pokrycie globalne (real):** **10.91%** (423,045/3,875,872)
- **Kopie EN (łącznie):** **410,486**
- **Placeholdery [EN]/puste (łącznie):** **2,188,219**
...
| 🕒 Evidence window | 24h (span=36.87h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=36.87h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T06:44:33.180741Z → 2026-04-29T07:44:33.180741Z) |
...
| Przepustowość (kluczy/h) | **790.0 kluczy/h** |
| Podejrzane tłumaczenia | **1202** |
...
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T07:41:58.226152Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T07:41:58.226152Z
- **Top 5 typów problemów:** suspicious_rejected_critical=188, suspicious_log_high=117, suspicious_log_low=82, suspicious_rejected_high=12, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=739185), ro(60.1, issues=436399), de(60.1, issues=119110), cs(60.1, issues=101173), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 739185 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 76%, 174649 problemów
⚠️ **RU**: jakość 63%, 366859 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,988 |
| Heartbeat | 160s temu | 2026-04-29T07:41:58Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T07:44:01.615102Z
...
- 2026-04-29 07:44:02 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-29 07:43:45 | AUTO_TRANSLATE:auto_done | it | ok | items.json
- 2026-04-29 07:42:22 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-04-29 07:42:22 | AUTO_TRANSLATE:auto_start | it | ok | items.json
- 2026-04-29 07:41:57 | AUTO_TRANSLATE:auto_done | ro | ok | items.json
- 2026-04-29 07:40:40 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **144,357** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=7.93%, reason=stable_fail_rate=7.9%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 07:44:32

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+30, skipped+0) — lang=it file=items.json strict_skipped_done=3019 guard_fail=1 placeholder=0 command=0 pipe=0
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+18, skipped+0) — lang=es file=items.json strict_skipped_done=820
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+342, skipped+0) — lang=it file=items.json strict_skipped_done=15061 guard_fail=26 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+0) — repair_identical lang=es file=questlog.json target_identical=476 limit=220 tier=base+domain_cap domain_cap=220 gt=true suspicious_pct=0.32
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+94, skipped+0) — lang=it file=npc.json strict_skipped_done=5371 guard_fail=116 placeholder=61 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+7, skipped+0) — lang=es file=php.json strict_skipped_done=52
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **6,684** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 156 |
| ❌ Błędów | 280 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,298), **RU** (1,189), **TR** (954), **IT** (935), **DE** (900) |
| 📊 Porównanie | ↓ 18.8% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **25,664** kluczy
...
| 🔄 Cykli wykonanych | **#17,988** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,988 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 07:44:32  
