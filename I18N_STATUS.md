...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.01% / real 8.93%**. Tempo: **2141.0 kluczy/h**. Tłumaczeń netto: **74,374**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-29 06:07:18

> **Aktualizacja:** 2026-03-29 06:07:18 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #11,326 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: tr | Plik: items.json | Heartbeat: 2026-03-29T06:07:10Z  
> **Okno godzinowe:** okno=1.0h | cykli=140 | pominięte=0.0% | odrzucone=16.6% | przepustowość=2141.0/h  
> **Tłumaczeń netto:** 74,374

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-29 06:07:18 |
| LIVE | 🟢 AKTYWNY | 9s temu | - | `activity.json / worker_state.json` | 2026-03-29T06:07:10Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 56s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-29 06:07:18 |
| TRANSLATION | 🟢 AKTYWNY | 50s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-29T06:06:29.022836Z |
| QUALITY | 🔒 NIEAKTYWNY | 30s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-29T06:06:49.497192Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-29 06:07:18 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 9s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-29T06:07:10Z
...
| ❤️ **Heartbeat** | 2026-03-29T06:07:10Z |
...
> **ETA globalne:** ~58 dni (2,983,929 kluczy do celu 95%)
...
> Świeżość: 56s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-29 06:07:18
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 50s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-29T06:06:29.022836Z
...
- Raporty strażnika jakości: **3200**  
- Raporty blokad: **0**  
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 279 | 1 | 41,082 | - | 2026-03-29T06:07:09.710278Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.01%** (698,139/3,875,872)
- **Pokrycie globalne (real):** **8.93%** (346,190/3,875,872)
- **Kopie EN (łącznie):** **522,195**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-29T05:07:18.300592Z → 2026-03-29T06:07:18.300592Z) |
...
| Przepustowość (kluczy/h) | **2141.0 kluczy/h** |
...
|--------|-----------|--------|----------------|
| `gt_rejected_critical` | 169 | 39.5% | pl/monsters.json (52) |
| `gt_validate_fail_wrong_script` | 80 | 18.7% | ru/html.json (79) |
| `gt_validate_fail_word_salad` | 63 | 14.7% | pl/monsters.json (21) |
| `gt_rejected_high_partial_translation_mix` | 46 | 10.7% | pl/monsters.json (11) |
| `gt_validate_fail_placeholder` | 23 | 5.4% | ru/html.json (19) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 30s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-29T06:06:49.497192Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-03-29T06:06:49.497192Z
- **Top 5 typów problemów:** suspicious_rejected_critical=149, suspicious_log_high=128, suspicious_log_medium=60, suspicious_rejected_high=51, suspicious_log_critical=6
- **Języki o najsłabszej jakości:** es(60.1, issues=648719), pl(60.1, issues=335844), de(63.0, issues=71789), cs(68.3, issues=19554), nl(69.8, issues=17554)
...
⚠️ **TR**: jakość 98%, 9016 problemów
⚠️ **PL**: jakość 60%, 335844 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 648719 problemów
⚠️ **PT**: jakość 85%, 25154 problemów
⚠️ **FR**: jakość 75%, 23917 problemów
⚠️ **IT**: jakość 70%, 118567 problemów
⚠️ **RU**: jakość 84%, 300664 problemów
⚠️ **NL**: jakość 70%, 17554 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #11,326 |
| Heartbeat | 9s temu | 2026-03-29T06:07:10Z |
...
- **Ostatnia aktualizacja:** 2026-03-29T06:06:42.890893Z
...
- 2026-03-29 06:07:10 | AUTO_TRANSLATE:auto_start | tr | ok | items.json
- 2026-03-29 06:06:43 | AUTO_TRANSLATE:heartbeat_tick | es | ok | quests.json
- 2026-03-29 06:06:29 | AUTO_TRANSLATE:auto_done | nl | ok | items.json
- 2026-03-29 06:05:13 | AUTO_TRANSLATE:heartbeat_tick | nl | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **74,374** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=9.08%, reason=stable_fail_rate=9.1%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-29 06:07:18
...
| 🔄 Cykli wykonanych | **#11,326** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #11,326 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-29 06:07:18  
