...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "BOW TO THE POWER OF THE RUTHLESS SEVEN!", yell = true , i18nKey = "monster.apocalypse.voice_1"},
	{ text = "DESTRUCTION!", yell = true , i18nKey = "monster.apocalypse.voice_2"},
	{ text = "CHAOS!", yell = true , i18nKey = "monster.apocalypse.voice_3"},
	{ text = "DEATH TO ALL!", yell = true , i18nKey = "monster.apocalypse.voice_4"},
}
