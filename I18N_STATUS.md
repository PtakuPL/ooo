...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.78% / real 10.67%**. Tempo: **2249.0 kluczy/h**. Tłumaczeń netto: **130,508**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-27 18:33:28

> **Aktualizacja:** 2026-04-27 18:33:28 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #16,534 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: nl | Plik: html.json | Heartbeat: 2026-04-27T18:31:53Z
> **Okno godzinowe:** okno=1.0h | cykli=98 | pominięte=0.0% | odrzucone=9.8% | przepustowość=2249.0/h  
> **Tłumaczeń netto:** 130,508

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-27 18:33:28 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-27T18:31:53Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 50s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-27 18:33:28 |
| TRANSLATION | 🟢 AKTYWNY | 50s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-27T18:32:53.697998Z |
| QUALITY | 🔒 NIEAKTYWNY | 44s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-27T18:32:59.509182Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-27 18:33:28 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-27T18:33:43.727266Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-27T18:31:53Z
...
| 🔄 **Ostatni cykl** | 9 kluczy, 5 odrzuconych, 37.0s, tryb: AUTO_TRANSLATE, cel: pt/html.json |
| ❤️ **Heartbeat** | 2026-04-27T18:31:53Z |
...
| 18:32:46 | PT | Klient | html.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `html.credits.text4` |
| 18:32:42 | PT | Klient | html.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `html.check_relations.text5` |
| 18:32:40 | PT | Klient | html.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `html.check_relations.text3` |
| 18:31:37 | ES | Serwer | talkactions.json | `hard_block` | `validate_placeholder` | `placeholder` | `talkaction.god.tutor.msg_promoted` |
| 18:31:35 | ES | Serwer | talkactions.json | `hard_block` | `validate_command` | `command` | `talkaction.gm.teleport.msg_declare_xyz` |
...
| ⏳ Oldest pending (visible tail) | 9752 s |
| 🌍 Top języki | NL(170), TR(103), PT(98), ES(23) |
| 🧱 Top reason_bucket | default(214), partial_translation_mix(54), placeholder(49), word_salad(33) |
| 🗂️ Deferred state keys | 7793 |
| 🕒 Deferred state freshness | fresh (39s) |
| ♻️ Deferred stats | enqueued=0, cooldown=0, deduped=10, manual_review=0, partial_staged=5, partial_completed=0 |
...
| ♻️ Provider debt | `1037` |
| 🌍 Recent provider mix | TM/simple(182), Free Google Translate(178), OpenAI model pool(125), term_consistency_autofix(29), autofix_e... |
| 🔁 Latest fallback | TM/simple → fallback to google translate [critical_issue] html.json |
| 📉 Fallback breakdown | fallback to google translate high(16), fallback to google translate(3), fallback to google translate valida... |
| ☁️ Cloud policy | `disabled` |
| 🤖 OpenAI pool | `active` |
| 🩺 Health signals | recent_fallback, provider_consistency_debt:1037, provider_budget:provider_budget_exhausted, provider_circui... |
| ❤️ Pool health | `critical` (writes=515, fallbacks=23) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=186/186 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 9752}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| 🔔 Open alarms | 9 |
| 🆕 Newly opened (cycle) | - |
| ✅ Resolved (cycle) | GUARDIAN_DEGRADED, TERM_CONSISTENCY_REGRESSION |
...
| �📊 Przetłumaczono | **2,249** kluczy |
| ❌ Odrzucone (guard) | 245 |
| 🔁 Cykli | 98 |
| 🌍 Języków | 8 |
| 🏆 Najaktywniejszy | PT (1,550 kluczy) |
| 📄 Najczęstszy plik | items.json |
| ⚡ Przepustowość | ~2249 kluczy/h |
| 🛡️ Odrzucone (strażnik) | 9.8% |
| ⚠️ Podejrzane | 691 |
...
> **ETA globalne:** ~55 dni (2,992,781 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~2249 kluczy/h.
...
> Świeżość: 50s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-27 18:33:28
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 50s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-27T18:32:53.697998Z
...
- [player]Nick[/player] → [jogador]Nick[/player] (html.forum.edit_post.html.text1)
- [url]http://address.com/[/url] → [url]http://address.com/[/url] (html.forum.edit_post.html.text2)
- [player]Nick[/player] → [jogador]Nick[/player] (html.forum.new_post.html.text1)
- [url]http://address.com/[/url] → [url]http://address.com/[/url] (html.forum.new_post.html.text2)
- [player]Nick[/player] → [jogador]Nick[/player] (html.forum.new_thread.html.text1)
- [url]http://address.com/[/url] → [url]http://address.com/[/url] (html.forum.new_thread.html.text2)
- Change name cost {{ setting('core.account_change_character_name_price') }} {{ se → Custo de mudança de nome {{ setting('core.account_change_character_name_price')  (html.account.characters.change_name.html.text1)
- Change sex cost {{ setting('core.account_change_character_sex_price') }} {{ sett → Alterar custo do sexo {{ setting('core.account_change_character_sex_price') }} { (html.account.characters.change_sex.html.text1)
- books at the phpMyAdmin site → livros no site phpMyAdmin (html.other.text5)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4469**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4323**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-27T18:33:17.790193Z |
...
| 🕒 Evidence window | 24h (span=71.40h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=71.40h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-0.10pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-27T17:33:28.427862Z → 2026-04-27T18:33:28.427862Z) |
| Cykle | **98** (TŁUMACZENIE=98, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **9.8%** |
| Cykle bez postępu % | **4.0%** |
| Przepustowość (kluczy/h) | **2249.0 kluczy/h** |
| Podejrzane tłumaczenia | **691** |
...
|--------|-----------|--------|----------------|
| `gt_validate_fail_identical_to_en` | 180 | 72.3% | nl/monsters.json (81) |
| `gt_partial_translation_mix` | 27 | 10.8% | tr/monsters.json (16) |
...
> Świeżość: 44s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-27T18:32:59.509182Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-27T18:32:59.509182Z
- **Top 5 typów problemów:** suspicious_rejected_critical=198, suspicious_log_high=84, suspicious_log_medium=82, suspicious_log_low=30, suspicious_log_critical=4
- **Języki o najsłabszej jakości:** fr(60.1, issues=60621), nl(60.1, issues=55957), tr(60.1, issues=48209), pt(60.1, issues=47474), de(60.2, issues=93628)
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #16,534 |
| Heartbeat | 110s temu | 2026-04-27T18:31:53Z |
...
- 2026-04-27 18:33:18 | AUTO_TRANSLATE:heartbeat_tick | nl | ok | html.json
- 2026-04-27 18:33:18 | AUTO_TRANSLATE:auto_start | nl | ok | html.json
- 2026-04-27 18:32:58 | AUTO_TRANSLATE:auto_done | pt | ok | html.json
- 2026-04-27 18:32:22 | AUTO_TRANSLATE:heartbeat_tick | pt | ok | html.json
- 2026-04-27 18:32:21 | AUTO_TRANSLATE:auto_start | pt | ok | html.json
- 2026-04-27 18:31:11 | AUTO_TRANSLATE:heartbeat_tick | es | ok | talkactions.json
...
| 🟡 ES | 78.3% | 0 | 9,791 | 557 | 383 (40.7%) | 32 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **130,508** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=44.73%, reason=decrease_high_fail_rate=44.7%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 693 kluczy / 45 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-27 18:33:28
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **4,939** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 10 |
| ❌ Błędów | 80 |
| 🌍 Aktywnych języków | 8 |
| 🏆 TOP 5 | **NL** (2,317), **PT** (1,834), **DE** (333), **ES** (153), **TR** (123) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **31,239** kluczy
...
| 🔄 Cykli wykonanych | **#16,534** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #16,534 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-27 18:33:28  
