...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.93% / real 10.85%**. Tempo: **742.0 kluczy/h**. Tłumaczeń netto: **140,004**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 02:23:59

> **Aktualizacja:** 2026-04-29 02:23:59 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,540 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ru | Plik: items.json | Heartbeat: 2026-04-29T02:20:39Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=4.3% | przepustowość=742.0/h  
> **Tłumaczeń netto:** 140,004

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 02:23:59 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-04-29T02:20:39Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 02:23:59 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T02:22:20.721657Z |
| QUALITY | 🔒 NIEAKTYWNY | 3min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T02:20:21.011849Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 02:23:59 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T02:24:06.483091Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T02:20:39Z
...
| 🔄 **Ostatni cykl** | 63 kluczy, 1 odrzuconych, 102.0s, tryb: AUTO_TRANSLATE, cel: ru/items.json |
| ❤️ **Heartbeat** | 2026-04-29T02:20:39Z |
...
| ⏳ Oldest pending (visible tail) | 16939 s |
| 🌍 Top języki | RU(398) |
...
| 🌍 Recent provider mix | TM/simple(318), Free Google Translate(168), canonical_name_semantic_autofix(15), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=504, fallbacks=10) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=546/546 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 16939}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~168 dni (2,987,155 kluczy do celu 95%)
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 02:23:59
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T02:22:20.721657Z
...
- dirty water → грязная вода (item.12586.name)
- dirty water → грязная вода (item.12587.name)
- dirty water → грязная вода (item.12588.name)
- dirty water → грязная вода (item.12589.name)
- dirty water → грязная вода (item.12590.name)
- dirty water → грязная вода (item.12591.name)
- dirty water → грязная вода (item.12592.name)
- dirty water → грязная вода (item.12593.name)
- dirty water → грязная вода (item.12594.name)
- tic-tac-toe board → доска для игры в крестики-нолики (item.1261.name)
- tic-tac-toe board → доска для игры в крестики-нолики (item.1262.name)
- small shed → небольшой сарай (item.12624.name)
- small shed → небольшой сарай (item.12625.name)
- small shed → небольшой сарай (item.12626.name)
- small shed → небольшой сарай (item.12627.name)
- small shed → небольшой сарай (item.12628.name)
- small shed → небольшой сарай (item.12629.name)
- tic-tac-toe board → доска для игры в крестики-нолики (item.1263.name)
- small shed → небольшой сарай (item.12630.name)
- small shed → небольшой сарай (item.12631.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4732**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4585**
...
- **Pokrycie globalne (nominal):** **17.93%** (694,913/3,875,872)
- **Pokrycie globalne (real):** **10.85%** (420,392/3,875,872)
- **Kopie EN (łącznie):** **410,608**
- **Placeholdery [EN]/puste (łącznie):** **2,190,750**
...
| 🕒 Evidence window | 24h (span=31.53h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=31.53h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T01:23:59.469252Z → 2026-04-29T02:23:59.469252Z) |
...
> Świeżość: 3min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T02:20:21.011849Z
...
| Heartbeat | 207s temu | 2026-04-29T02:20:39Z |
...
- 2026-04-29 02:22:21 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
- 2026-04-29 02:22:10 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 02:23:59
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **1,965** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 47 |
| ❌ Błędów | 82 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (439), **RU** (341), **DE** (270), **TR** (243), **IT** (240) |
| 📊 Porównanie | ↓ 76.1% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **20,945** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 02:23:59  
