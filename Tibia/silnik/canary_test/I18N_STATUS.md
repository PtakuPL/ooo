...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.06%**. Tempo: **3758.6 kluczy/h**. Tłumaczeń netto: **76,471**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-16 21:47:03

> **Aktualizacja:** 2026-02-16 21:47:03 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #72 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ro | Plik: - | Heartbeat: 2026-02-16T21:46:52Z  
> **Okno godzinowe:** okno=1.0h | cykli=194 | pominięte=0.0% | odrzucone=37.9% | przepustowość=3758.6/h  
> **Tłumaczeń netto:** 76,471

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-16 21:47:03 |
| LIVE | 🟢 AKTYWNY | 16s temu | - | `activity.json / worker_state.json` | 2026-02-16T21:46:52Z |
| MIGRATION | 🔒 NIEAKTYWNY | 1h temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-16 21:47:03 |
| TRANSLATION | 🟢 AKTYWNY | 17s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-16T21:46:50.859015Z |
| QUALITY | 🔒 NIEAKTYWNY | 16s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-16T21:46:52.420609Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-16 21:47:03 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 16s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-16T21:46:52Z
...
| ❤️ **Heartbeat** | 2026-02-16T21:46:52Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **6,792** kluczy |
| ❌ Odrzucone (guard) | 4151 |
| 🔁 Cykli | 194 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | IT (1,150 kluczy) |
| 📄 Najczęstszy plik | server.json |
| ⚡ Przepustowość | ~3759 kluczy/h |
...
> **ETA globalne:** ~26 dni (2,366,800 kluczy do celu 95%)
...
| RO | ███░░░░░░░░░░░░░░░░░ | 18.1% | 9,715/53,586 | ~11h |
| ZH_TW | ██░░░░░░░░░░░░░░░░░░ | 14.5% | 7,776/53,586 | ~11h |
| IT | █░░░░░░░░░░░░░░░░░░░ | 9.2% | 4,932/53,586 | ~12h |
| SR | █░░░░░░░░░░░░░░░░░░░ | 9.0% | 4,843/53,586 | ~12h |
...
| SV | █░░░░░░░░░░░░░░░░░░░ | 7.0% | 3,726/53,586 | ~13h |
| TE | █░░░░░░░░░░░░░░░░░░░ | 6.9% | 3,714/53,586 | ~13h |

> Tempo obliczone na bazie ostatniej godziny: ~3759 kluczy/h.
...
> Świeżość: 1h temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-16 21:47:03
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 17s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-16T21:46:50.859015Z
...
| RO (Rumuński) | 9,715/53,586 | 18.13% | 2,493 | 0 |
...
- unknown item → непозната ствар (item.30001.name)
- unknown item → непозната ствар (item.30018.name)
- unknown item → непозната ствар (item.30086.name)
- unknown item → непозната ствар (item.30104.name)
- unknown item → непозната ствар (item.30338.name)
- unknown item → непозната ствар (item.30972.name)
- unknown item → непозната ствар (item.31118.name)
- unknown item → непозната ствар (item.31170.name)
- unknown item → непозната ствар (item.31444.name)
- unknown item → непозната ствар (item.31484.name)
- unknown item → непозната ствар (item.31490.name)
- unknown item → непозната ствар (item.31673.name)
- unknown item → непозната ствар (item.31721.name)
- unknown item → непозната ствар (item.31722.name)
- unknown item → непозната ствар (item.31732.name)
- unknown item → непозната ствар (item.31736.name)
- unknown item → непозната ствар (item.4037.name)
- stone wall → камени зид (item.5647.name)
- stone wall → камени зид (item.5684.name)
- stone wall → камени зид (item.5686.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **2301**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2239**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **10.06%** (280,312/2,786,472)
...
| RO | 9,621/49,731 | 19.4% | 94/3,855 | 2.4% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-16T20:47:04.453067Z → 2026-02-16T21:47:04.453067Z) |
...
| Przepustowość (kluczy/h) | **3758.6 kluczy/h** |
| Podejrzane tłumaczenia | **37727** |
| Najgorsze cele (strażnik) | pl/items.json (gf=2300), pl/npc.json (gf=939), pl/server.json (gf=338), pl/monsters.json (gf=180), ro/monsters.json (gf=131) |
...
> Świeżość: 16s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-16T21:46:52.420609Z
...
- **Języki o najsłabszej jakości:** ro(59.9, issues=6393), ru(60.1, issues=9692), it(61.4, issues=4284), tl(64.2, issues=466), zh_TW(64.8, issues=337)
...
| Heartbeat | 16s temu | 2026-02-16T21:46:52Z |
...
- 2026-02-16 21:46:44 | AUTO_TRANSLATE:heartbeat_tick | sr | ok | items.json
- 2026-02-16 21:46:44 | AUTO_TRANSLATE:parallel_start | sr | ok | items.json
- 2026-02-16 21:46:35 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-02-16 21:46:34 | AUTO_TRANSLATE:parallel_start | it | ok | items.json
- 2026-02-16 21:46:30 | AUTO_TRANSLATE:auto_done | ro | ok | items.json
- 2026-02-16 21:46:01 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **76,471** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=12.62%, reason=stable_fail_rate=12.6% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-16 21:47:03
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **10,897** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 72 |
| ❌ Błędów | 97 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (1,966), **IT** (1,638), **SR** (1,609), **SV** (1,578), **RU** (1,523) |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-16 21:47:03  
