...
npcConfig.voices = {
	interval = 15000,
	chance = 50,
	{ i18nKey = "npc.a_dead_bureaucrat2.voice_1" },
	{ i18nKey = "npc.a_dead_bureaucrat2.voice_2" },
}
...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "287") then
		...
		if player:getStorageValue(Storage.Quest.U7_9.ThePitsOfInferno.ThronePumin) == 4 then
			...
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.a_dead_bureaucrat2.say_1")
		end
	end
	return true
end

NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_WALKAWAY, "npc.a_dead_bureaucrat2.walkaway_msg_1")
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_FAREWELL, "npc.a_dead_bureaucrat2.farewell_msg_1")
