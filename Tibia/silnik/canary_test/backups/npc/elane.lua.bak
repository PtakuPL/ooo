...
-- Sniper Gloves
keywordHandler:addKeyword({ "sniper gloves" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.elane.stdmod_1" }, function(player)
...
-- Basic
keywordHandler:addKeyword({ "help" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.elane.stdmod_2" })
keywordHandler:addKeyword({ "job" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.elane.stdmod_3" })
keywordHandler:addKeyword({ "paladins" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.elane.stdmod_4" })
keywordHandler:addKeyword({ "warriors" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.elane.stdmod_5" })
keywordHandler:addKeyword({ "magicians" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.elane.stdmod_6" })
keywordHandler:addKeyword({ "missile" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.elane.stdmod_7" })
keywordHandler:addKeyword({ "news" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.elane.stdmod_8" })
keywordHandler:addKeyword({ "members" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.elane.stdmod_9" })
keywordHandler:addKeyword({ "advantages" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.elane.stdmod_10" })
keywordHandler:addKeyword({ "general" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.elane.stdmod_11" })
keywordHandler:addKeyword({ "army" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.elane.stdmod_12" })
keywordHandler:addKeyword({ "baxter" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.elane.stdmod_13" })
...
keywordHandler:addKeyword({ "gregor" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.elane.stdmod_20" })
keywordHandler:addKeyword({ "harkath bloodblade" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.elane.stdmod_21" })
keywordHandler:addKeyword({ "king tibianus" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.elane.stdmod_22" })
keywordHandler:addKeyword({ "lugri" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.elane.stdmod_23" })
keywordHandler:addKeyword({ "lynda" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.elane.stdmod_24" })
keywordHandler:addKeyword({ "marvik" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.elane.stdmod_25" })
keywordHandler:addKeyword({ "muriel" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.elane.stdmod_26" })
keywordHandler:addKeyword({ "oswald" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.elane.stdmod_27" })
