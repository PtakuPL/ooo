...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.96% / real 10.88%**. Tempo: **877.0 kluczy/h**. Tłumaczeń netto: **142,145**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 04:48:59

> **Aktualizacja:** 2026-04-29 04:48:59 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,737 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ro | Plik: items.json | Heartbeat: 2026-04-29T04:47:00Z
> **Okno godzinowe:** okno=1.0h | cykli=91 | pominięte=0.0% | odrzucone=4.2% | przepustowość=877.0/h  
> **Tłumaczeń netto:** 142,145

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 04:48:59 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T04:47:00Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 57s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 04:48:59 |
| TRANSLATION | 🟢 AKTYWNY | 19s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T04:48:45.902039Z |
| QUALITY | 🔒 NIEAKTYWNY | 18s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T04:48:47.228899Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 04:48:59 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T04:49:05.877163Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T04:47:00Z
...
| 🔄 **Ostatni cykl** | 39 kluczy, 4 odrzuconych, 103.8s, tryb: AUTO_TRANSLATE, cel: ro/items.json |
| ❤️ **Heartbeat** | 2026-04-29T04:47:00Z |
...
| ⏳ Oldest pending (visible tail) | 17631 s |
| 🌍 Top języki | RU(400) |
...
| 🌍 Recent provider mix | TM/simple(302), Free Google Translate(172), canonical_name_semantic_autofix(17), term_consistency_autofix(3) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=658/658 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 17631}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~142 dni (2,985,853 kluczy do celu 95%)
...
> Świeżość: 57s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 04:48:59
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 19s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T04:48:45.902039Z
...
- This lamp is glowing very dimly. → Această lampăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă luminează foarte slab. (item.13656.desc)
- This lamp is glowing very dimly. → Această lampăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă luminează foarte slab. (item.13658.desc)
- This is an emblem of wisdom. It was awarded by TibiaStat.com → Aceasta este o emblemăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă a înțelepciunii. A fost  (item.14760.desc)
- lamp → lampă (item.10507.name)
- ramp → rampă (item.11365.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4782**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4635**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T04:47:26.310804Z |
...
- **Profiler cyklu (ostatni):** cykl #36 (AUTO_TRANSLATE): dispatch 10399ms, mode 80594ms, status 11234ms, total 103799ms
...
| 🕒 Evidence window | 24h (span=33.95h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=33.95h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T03:49:00.707968Z → 2026-04-29T04:49:00.707968Z) |
...
> Świeżość: 18s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T04:48:47.228899Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T04:48:47.228899Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=733745), ro(60.1, issues=432309), de(60.1, issues=115145), cs(60.1, issues=93872), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 733745 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 65%, 172624 problemów
⚠️ **RU**: jakość 62%, 363528 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,737 |
| Heartbeat | 125s temu | 2026-04-29T04:47:00Z |
...
- 2026-04-29 04:47:27 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-04-29 04:47:26 | AUTO_TRANSLATE:auto_start | ro | ok | items.json
- 2026-04-29 04:46:52 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 04:48:59
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → warn (files+1, translated+22, skipped+0) — lang=ru file=monsters.json strict_skipped_done=2876 guard_fail=23 placeholder=0 command=0 pipe=0
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [cs] → warn (files+1, translated+124, skipped+0) — lang=cs file=items.json strict_skipped_done=7020 guard_fail=54 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **4,264** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 93 |
| ❌ Błędów | 170 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (893), **RU** (761), **IT** (688), **DE** (540), **TR** (495) |
| 📊 Porównanie | ↓ 48.2% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **23,244** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 04:48:59  
