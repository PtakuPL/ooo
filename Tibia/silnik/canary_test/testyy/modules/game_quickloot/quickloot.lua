...
function quickLootController:onInit()
    ...
    Keybind.new(tr("Loot"), tr("Quick Loot Nearby Corpses"), "Alt+Q", "")
    Keybind.bind(tr("Loot"), tr("Quick Loot Nearby Corpses"), {
      {
        type = KEY_DOWN,
...
function quickLootController:onTerminate()
    Keybind.delete(tr("Loot"), tr("Quick Loot Nearby Corpses"))
...
function QuickLoot.Define()
    ...
    function QuickLoot.start(quickLootFallbackToMainContainer, lootContainers)
        ...
        -- LuaFormatter off
		local slotBags = {
			{ color = "#484848", name = tr("Unassigned"), type = 31 },
			{ color = "#414141", name = tr("Gold"), type = 30 },
			{ color = "#484848", name = tr("Armors"), type = 1 },
			{ color = "#414141", name = tr("Amulets"), type = 2  },
			{ color = "#484848", name = tr("Boots"), type = 3 },
			{ color = "#414141", name = tr("Containers"), type = 4 },
			{ color = "#484848", name = tr("Creature") .. "\n" .. tr("Products"), type = 24 },
			{ color = "#414141", name = tr("Decoration"), type = 5 },
			{ color = "#484848", name = tr("Food"), type = 6 },
			{ color = "#414141", name = tr("Helmets") .. "\n" .. tr("and Hats"), type =7 },
			{ color = "#484848", name = tr("Legs"), type = 8 },
			{ color = "#414141", name = tr("Others"), type = 9 },

			{ color = "#414141", name = tr("Potions"), type = 10 },
			{ color = "#484848", name = tr("Rings"), type = 11 },
			{ color = "#414141", name = tr("Runes"), type = 12 },
			{ color = "#484848", name = tr("Shields"), type = 13 },
			{ color = "#414141", name = tr("Tools"), type = 14 },
			{ color = "#484848", name = tr("Valuables"), type = 15 },
			{ color = "#414141", name = tr("Weapons:") .. "\n" .. tr("Ammo"), type = 16 },
			{ color = "#484848", name = tr("Weapons:") .. "\n" .. tr("Axes"), type = 17 },
			{ color = "#414141", name = tr("Weapons:") .. "\n" .. tr("Clubs"), type = 18 },
			{ color = "#484848", name = tr("Weapons:") .. "\n" .. tr("Distance"), type = 19 },
			{ color = "#414141", name = tr("Weapons:") .. "\n" .. tr("Swords"), type = 20 },
			{ color = "#484848", name = tr("Weapons:") .. "\n" .. tr("Wands"), type = 21 },
			--{ color = "#414141", name = tr("Quivers") , type = 25 },
