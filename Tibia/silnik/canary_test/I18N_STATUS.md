...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-27 16:34:34

> **Aktualizacja:** 2026-04-27 16:34:34 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #16,424 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: nl | Plik: questlog.json | Heartbeat: 2026-04-27T16:32:11Z
...
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-27 16:34:34 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-27T16:32:11Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 51s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-27 16:34:34 |
| TRANSLATION | 🟢 AKTYWNY | 14min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-27T16:19:48.635194Z |
| QUALITY | 🔒 NIEAKTYWNY | 14min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-27T16:19:49.915224Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-27 16:34:34 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-27T16:34:40.569435Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-27T16:32:11Z
...
| ❤️ **Heartbeat** | 2026-04-27T16:32:11Z |
...
| ⏳ Oldest pending (visible tail) | 335838 s |
| 🌍 Top języki | NL(131), ES(117), PT(116), PL(22) |
| 🧱 Top reason_bucket | placeholder(164), provider_error(99), default(78), word_salad(21) |
| 🗂️ Deferred state keys | 7755 |
| 🕒 Deferred state freshness | fresh (15s) |
| ♻️ Deferred stats | enqueued=10, cooldown=0, deduped=0, manual_review=0, partial_staged=1, partial_completed=0 |
...
| `NO_WRITE` | OK | OK | `878` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 335838}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 51s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-27 16:34:34
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 14min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-27T16:19:48.635194Z
...
| 🕒 Evidence window | 24h (span=69.42h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=69.42h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-0.10pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-27T15:34:34.870491Z → 2026-04-27T16:34:34.870491Z) |
...
|--------|-----------|--------|----------------|
| `gt_validate_fail_placeholder` | 163 | 54.5% | pt/npc.json (54) |
| `gt_validate_fail_identical_to_en` | 69 | 23.1% | nl/npc.json (28) |
| `gt_partial_validate_word_salad` | 21 | 7.0% | es/server.json (10) |
| `gt_rejected_critical` | 19 | 6.4% | pt/npc.json (6) |
| `gt_partial_translation_mix` | 11 | 3.7% | nl/html.json (4) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 14min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-27T16:19:49.915224Z
...
| Heartbeat | 149s temu | 2026-04-27T16:32:11Z |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-27 16:34:34
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-27 16:34:34  
