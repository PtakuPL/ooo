...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.87%**. Tempo: **1569.8 kluczy/h**. Tłumaczeń netto: **121,047**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 20:02:48

> **Aktualizacja:** 2026-02-20 20:02:48 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #134 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: - | Heartbeat: 2026-02-20T20:02:44Z  
> **Okno godzinowe:** okno=1.0h | cykli=201 | pominięte=0.0% | odrzucone=67.9% | przepustowość=1569.8/h  
> **Tłumaczeń netto:** 121,047

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 20:02:48 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T20:02:44Z |
| MIGRATION | 🔒 NIEAKTYWNY | 5s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 20:02:48 |
| TRANSLATION | 🟢 AKTYWNY | 37s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T20:02:11.433720Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T20:02:49.256808Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 20:02:48 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T20:02:44Z
...
| ❤️ **Heartbeat** | 2026-02-20T20:02:44Z |
...
> **ETA globalne:** ~60 dni (2,260,500 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| PL | █████████████████░░░ | 87.8% | 47,061/53,586 | ~2h |
| ES | ████████████████░░░░ | 84.8% | 45,447/53,586 | ~3h |
| IT | ██████████░░░░░░░░░░ | 52.2% | 27,966/53,586 | ~15h |
| RU | ██████████░░░░░░░░░░ | 50.4% | 26,989/53,586 | ~15h |
| SR | █████████░░░░░░░░░░░ | 45.5% | 24,379/53,586 | ~17h |
| RO | ████████░░░░░░░░░░░░ | 43.2% | 23,141/53,586 | ~18h |
| FR | ██████░░░░░░░░░░░░░░ | 33.1% | 17,731/53,586 | ~21h |
| SV | █████░░░░░░░░░░░░░░░ | 28.7% | 15,378/53,586 | ~23h |
...
> Świeżość: 5s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 20:02:48
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 37s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T20:02:11.433720Z
...
| RO (Rumuński) | 23,141/53,586 | 43.18% | 2,349 | 0 |
...
- Raporty strażnika jakości: **6972**  
- Raporty blokad: **0**  
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T19:02:48.563228Z → 2026-02-20T20:02:48.563228Z) |
...
| Przepustowość (kluczy/h) | **1569.8 kluczy/h** |
| Podejrzane tłumaczenia | **3675** |
| Najgorsze cele (strażnik) | pl/items.json (gf=2448), pl/npc.json (gf=1452), es/items.json (gf=1042), it/npc.json (gf=95), es/server.json (gf=82) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T20:02:49.256808Z

- **Ostatni audyt:** SLOW_MODE | 29 issue(s) / 100 entries | 2026-02-20T20:02:44.241270Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=105, suspicious_log_critical=76, suspicious_log_high=46, suspicious_rejected_high=24, artifact_token=16
- **Języki o najsłabszej jakości:** es(60.1, issues=336460), pl(60.1, issues=188225), ro(60.1, issues=183421), it(61.2, issues=75039), ru(64.2, issues=212875)
...
⚠️ **PL**: jakość 60%, 188225 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 336460 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 61%, 75039 problemów
⚠️ **RU**: jakość 64%, 212875 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #134 |
| Heartbeat | 5s temu | 2026-02-20T20:02:44Z |
...
- 2026-02-20 20:02:18 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 20:02:06 | AUTO_TRANSLATE:heartbeat_tick | sv | ok | npc.json
- 2026-02-20 20:02:05 | AUTO_TRANSLATE:parallel_start | sv | ok | npc.json
- 2026-02-20 20:02:01 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | monsters.json
- 2026-02-20 20:02:00 | AUTO_TRANSLATE:parallel_start | ru | ok | monsters.json
- 2026-02-20 20:01:59 | AUTO_TRANSLATE:auto_done | it | ok | monsters.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,830 | 599 | 5412 (90.0%) | 32 |
| 🟡 ES | 84.8% | 0 | 2,160 | 671 | 2524 (79.0%) | 37 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **121,047** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=84.77%, reason=decrease_high_fail_rate=84.8% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,270 kluczy / 69 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 20:02:48
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [sr] → ok (translated+18, skipped+0) — parallel lang=sr file=server.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [sv] → ok (translated+38, skipped+0) — parallel lang=sv file=server.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+47, skipped+0) — lang=ro file=quests.json strict_skipped_done=242 guard_fail=3 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+38, skipped+0) — parallel lang=es file=quests.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+30, skipped+0) — lang=pl file=scripts.json strict_skipped_done=2123 guard_fail=11 placeholder=0 command=11 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **12,416** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 134 |
| ❌ Błędów | 291 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (3,626), **RU** (2,443), **IT** (2,037), **RO** (1,528), **PL** (1,417) |
| 📊 Porównanie | ↑ 241.0% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **110,001** kluczy
...
| 🔄 Cykli wykonanych | **#134** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 20:02:48  
