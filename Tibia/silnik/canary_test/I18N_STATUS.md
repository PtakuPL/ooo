...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.88%**. Tempo: **1304.0 kluczy/h**. Tłumaczeń netto: **122,073**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 20:44:35

> **Aktualizacja:** 2026-02-20 20:44:35 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #166 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: - | Heartbeat: 2026-02-20T20:44:21Z  
> **Okno godzinowe:** okno=1.0h | cykli=186 | pominięte=0.0% | odrzucone=80.7% | przepustowość=1304.0/h  
> **Tłumaczeń netto:** 122,073

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 20:44:35 |
| LIVE | 🟢 AKTYWNY | 15s temu | - | `activity.json / worker_state.json` | 2026-02-20T20:44:21Z |
| MIGRATION | 🔒 NIEAKTYWNY | 58s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 20:44:35 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T20:42:04.601156Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T20:44:36.410486Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 20:44:35 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 15s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T20:44:21Z
...
| ❤️ **Heartbeat** | 2026-02-20T20:44:21Z |
...
| ❌ Odrzucone (guard) | 9620 |
| 🔁 Cykli | 186 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | PL (512 kluczy) |
...
> **ETA globalne:** ~72 dni (2,260,345 kluczy do celu 95%)
...
| RO | ████████░░░░░░░░░░░░ | 43.3% | 23,199/53,586 | ~21h |
| FR | ██████░░░░░░░░░░░░░░ | 33.1% | 17,731/53,586 | ~25h |
| SV | █████░░░░░░░░░░░░░░░ | 28.7% | 15,394/53,586 | ~27h |
...
> Świeżość: 58s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 20:44:35
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T20:42:04.601156Z
...
| RO (Rumuński) | 23,199/53,586 | 43.29% | 2,345 | 0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T19:44:35.723316Z → 2026-02-20T20:44:35.723316Z) |
...
| Przepustowość (kluczy/h) | **1304.0 kluczy/h** |
| Podejrzane tłumaczenia | **3549** |
| Najgorsze cele (strażnik) | pl/items.json (gf=4080), pl/npc.json (gf=2420), es/items.json (gf=2086), es/server.json (gf=164), it/npc.json (gf=76) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T20:44:36.410486Z

- **Ostatni audyt:** SLOW_MODE | 23 issue(s) / 100 entries | 2026-02-20T20:44:20.924845Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=146, suspicious_log_critical=82, suspicious_log_high=43, artifact_token=19, suspicious_rejected_high=17
- **Języki o najsłabszej jakości:** es(60.1, issues=341445), pl(60.1, issues=190370), ro(60.1, issues=185308), tl(64.2, issues=466), zh_TW(64.8, issues=337)
...
⚠️ **PL**: jakość 60%, 190370 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 341445 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 82%, 75712 problemów
⚠️ **RU**: jakość 70%, 213621 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 70%, 31264 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #166 |
| Heartbeat | 15s temu | 2026-02-20T20:44:21Z |
...
- 2026-02-20 20:42:11 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 20:41:57 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | npc.json
- 2026-02-20 20:41:56 | AUTO_TRANSLATE:parallel_start | ro | ok | npc.json
- 2026-02-20 20:41:52 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | npc.json
- 2026-02-20 20:41:51 | AUTO_TRANSLATE:parallel_start | ru | ok | npc.json
- 2026-02-20 20:41:50 | AUTO_TRANSLATE:auto_done | it | ok | npc.json
...
| 🟡 ES | 84.8% | 0 | 2,160 | 652 | 2680 (80.4%) | 42 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **122,073** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=91.6%, reason=decrease_high_fail_rate=91.6% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,363 kluczy / 83 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 20:44:35
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ru] → ok (translated+29, skipped+0) — parallel lang=ru file=spells.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [it] → ok (translated+27, skipped+0) — parallel lang=it file=spells.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+50, skipped+0) — lang=ro file=server.json strict_skipped_done=636
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+41, skipped+0) — parallel lang=es file=raids.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+41, skipped+0) — lang=pl file=otclient_modules.json strict_skipped_done=499 guard_fail=3 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **14,232** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 166 |
| ❌ Błędów | 349 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (4,268), **RU** (2,732), **IT** (2,242), **PL** (1,743), **RO** (1,673) |
| 📊 Porównanie | ↑ 290.9% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **111,817** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 20:44:35  
