...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **18.91%**. Tempo: **2958.0 kluczy/h**. Tłumaczeń netto: **60,556**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-23 14:36:23

> **Aktualizacja:** 2026-03-23 14:36:23 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **LIVE:** Cykl #10,757 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ru | Plik: monsters.json | Heartbeat: 2026-03-23T14:36:14Z  
> **Okno godzinowe:** okno=1.0h | cykli=52 | pominięte=0.0% | odrzucone=14.8% | przepustowość=2958.0/h  
> **Tłumaczeń netto:** 60,556

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-23 14:36:23 |
| LIVE | 🟢 AKTYWNY | 11s temu | - | `activity.json / worker_state.json` | 2026-03-23T14:36:14Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-23 14:36:23 |
| TRANSLATION | 🟢 AKTYWNY | 18s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-23T14:36:07.408760Z |
| QUALITY | 🔒 NIEAKTYWNY | 17s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-23T14:36:08.205426Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-23 14:36:23 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 11s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-23T14:36:14Z
...
| ❤️ **Heartbeat** | 2026-03-23T14:36:14Z |
...
> **ETA globalne:** ~42 dni (2,949,108 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~2958 kluczy/h.
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-23 14:36:23
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 18s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-23T14:36:07.408760Z
...
- basalt wall with crystals → kristallerle dolu bazalt duvar (item.14888.name)
- basalt wall with crystals → kristallerle dolu bazalt duvar (item.14889.name)
- green crystal stalagmite → yeşil kristal dikit (item.14942.name)
- cluster of green crystals → yeşil kristal kümesi (item.14949.name)
- green crystal rods → yeşil kristal çubuklar (item.14950.name)
- green crystals → yeşil kristaller (item.14951.name)
- small green crystals → küçük yeşil kristaller (item.14952.name)
- cluster of blue crystals → mavi kristal kümesi (item.14955.name)
- blue crystal rods → mavi kristal çubuklar (item.14956.name)
- blue crystals → mavi kristaller (item.14957.name)
- small blue crystals → küçük mavi kristaller (item.14958.name)
- cluster of red crystals → kırmızı kristal kümesi (item.14961.name)
- red crystal rods → kırmızı kristal çubuklar (item.14962.name)
- red crystals → kırmızı kristaller (item.14963.name)
- small red crystals → küçük kırmızı kristaller (item.14964.name)
- red crystals → kırmızı kristaller (item.14974.name)
- coconut milk → Hindistan cevizi sütü (item.15.name)
- mossy window → yosunlu pencere (item.15067.name)
- mossy window → yosunlu pencere (item.15075.name)
- mushrooms → mantarlar (item.15100.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **3064**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2922**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **18.91%** (732,960/3,875,872)
- **Kopie EN (łącznie):** **594,466**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-23T13:36:24.204699Z → 2026-03-23T14:36:24.204699Z) |
...
| Przepustowość (kluczy/h) | **2958.0 kluczy/h** |
| Podejrzane tłumaczenia | **1612** |
...
> Świeżość: 17s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-23T14:36:08.205426Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-03-23T14:36:08.205426Z
- **Top 5 typów problemów:** suspicious_rejected_critical=197, suspicious_log_high=110, suspicious_log_medium=60, suspicious_log_low=24, suspicious_log_critical=6
- **Języki o najsłabszej jakości:** es(60.1, issues=627931), ro(60.1, issues=345077), pl(60.1, issues=330450), fr(60.1, issues=20262), it(60.4, issues=114587)
...
⚠️ **TR**: jakość 85%, 7727 problemów
⚠️ **PL**: jakość 60%, 330450 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 627931 problemów
⚠️ **PT**: jakość 61%, 22239 problemów
⚠️ **FR**: jakość 60%, 20262 problemów
⚠️ **IT**: jakość 60%, 114587 problemów
⚠️ **RU**: jakość 93%, 297446 problemów
⚠️ **NL**: jakość 65%, 14606 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #10,757 |
| Heartbeat | 11s temu | 2026-03-23T14:36:14Z |
...
- **Ostatnia aktualizacja:** 2026-03-23T14:33:55.151685Z
...
- 2026-03-23 14:36:14 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | monsters.json
- 2026-03-23 14:36:14 | AUTO_TRANSLATE:auto_start | ru | ok | monsters.json
- 2026-03-23 14:36:07 | AUTO_TRANSLATE:auto_done | tr | ok | items.json
- 2026-03-23 14:34:37 | AUTO_TRANSLATE:heartbeat_tick | tr | ok | items.json
- 2026-03-23 14:34:37 | AUTO_TRANSLATE:auto_start | tr | ok | items.json
- 2026-03-23 14:33:55 | AUTO_TRANSLATE:heartbeat_tick | es | ok | quests.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **60,556** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=14.37%, reason=stable_fail_rate=14.4% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-23 14:36:23
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **36,484** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 174 |
| ❌ Błędów | 587 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **ES** (11,277), **TR** (6,169), **RO** (4,743), **PL** (2,981), **PT** (2,141) |
| 📊 Porównanie | ↑ 76.0% vs wczoraj (20,729) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **57,213** kluczy
...
| 🔄 Cykli wykonanych | **#10,757** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #10,757 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-23 14:36:23  
