...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif MsgContains(message, "myra") then
		if player:getSex() == PLAYERSEX_FEMALE and player:getStorageValue(Storage.Quest.U7_8.MageAndSummonerOutfits.AddonHatCloak) == 10 and not player:hasOutfit(138, 2) then
			NPC_LIB.i18n.npcSayMultiple(npcHandler, npc, creature, { "npc.zoltan.say_9", "npc.zoltan.say_10", "npc.zoltan.say_11" }, 100)
...
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_GREET, "npc.zoltan.greet_msg_1")
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_FAREWELL, "npc.zoltan.farewell_msg_1")
