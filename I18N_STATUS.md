...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.33% / real 10.19%**. Tempo: **1099.0 kluczy/h**. Tłumaczeń netto: **116,433**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-21 18:22:44

> **Aktualizacja:** 2026-04-21 18:22:44 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #14,412 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ro | Plik: npc.json | Heartbeat: 2026-04-21T18:21:48Z  
> **Okno godzinowe:** okno=1.0h | cykli=169 | pominięte=0.0% | odrzucone=55.9% | przepustowość=1099.0/h  
> **Tłumaczeń netto:** 116,433

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-21 18:22:44 |
| LIVE | 🟢 AKTYWNY | 59s temu | - | `activity.json / worker_state.json` | 2026-04-21T18:21:48Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 21s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-21 18:22:44 |
| TRANSLATION | 🟢 AKTYWNY | 5min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-21T18:17:21.642490Z |
| QUALITY | 🔒 NIEAKTYWNY | 5min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-21T18:17:22.834916Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-21 18:22:44 |
| DOCTOR | 🟢 AKTYWNY | 0s temu | - | `doctor_alerts_latest.json` | 2026-04-21T18:22:47.597273Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 59s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-21T18:21:48Z
...
| ❤️ **Heartbeat** | 2026-04-21T18:21:48Z |
...
| ⏳ Oldest pending (visible tail) | 3115 s |
...
|-------|--------|----------|-------|-----------|--------|
| `HEARTBEAT_STALE` | OK | OK | `58` | `300` | Heartbeat świeży (58s). |
| `NO_WRITE` | OK | OK | `328` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | OK | OK | `{'pending': 400, 'oldest_s': 3115}` | `{'pending_min': 200, 'oldest_s': 3600}` | Queue bez sygnałów starvation. |
...
> **ETA globalne:** ~114 dni (3,010,508 kluczy do celu 95%)
...
| RU | ████████░░░░░░░░░░░░ | 41.9% | 31,259/74,536 | ~36h |
| SR | ██████░░░░░░░░░░░░░░ | 33.3% | 24,827/74,536 | ~42h |
| CS | █████████░░░░░░░░░░░ | 45.8% | 34,135/74,536 | ~33h |
| NL | ██████████████░░░░░░ | 72.5% | 54,079/74,536 | ~15h |
| PT | ██████████████░░░░░░ | 75.0% | 55,885/74,536 | ~14h |
| TR | █████░░░░░░░░░░░░░░░ | 28.2% | 21,057/74,536 | ~45h |
...
> Świeżość: 21s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-21 18:22:44
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 5min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-21T18:17:21.642490Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-21T17:22:44.494688Z → 2026-04-21T18:22:44.494688Z) |
| Cykle | **169** (TŁUMACZENIE=169, PRE_MIGRATION=0) |
...
|--------|-----------|--------|----------------|
| `gt_validate_fail_identical_to_en` | 423 | 61.5% | cs/monsters.json (113) |
| `gt_rejected_high_partial_translation_mix` | 75 | 10.9% | fr/monsters.json (17) |
| `gt_validate_fail_word_salad` | 64 | 9.3% | cs/monsters.json (17) |
| `gt_rejected_high_trimmed_en_copy` | 43 | 6.2% | cs/monsters.json (33) |
| `gt_validate_fail_quality` | 31 | 4.5% | tr/monsters.json (28) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 5min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-21T18:17:22.834916Z
...
| Heartbeat | 59s temu | 2026-04-21T18:21:48Z |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-21 18:22:44
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-21 18:22:44  
