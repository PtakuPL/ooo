...
> **Aktualizacja:** 2026-02-13 20:15:15 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #36 | Status: 🟢 RUNNING | Faza: AUTO_TRANSLATE | Etap: auto_start | Kategoria: pl | Plik: html.json | ETA: 0 | Heartbeat: 2026-02-13T20:14:51Z
...
|-------|----------------|-------------------------------|---------|--------------|
| PL (Polski) | 36,971/53,586 | 68.99% | 2,929 | 2,083 |
| ES (Hiszpański) | 34,819/53,586 | 64.98% | 17,357 | 232 |
...
- Guard reports: **1221**  
- Blocker reports: **0**  
- Widoczne raporty 'nie mogę tłumaczyć': **1171**

### 🌐 Globalne info wszystkich języków
- **Global completion:** **19.61%** (546,502/2,786,472)
- **EN-copy łącznie:** **1,336,281**
...
### 🔬 Jakość tłumaczeń
- **Ostatni audyt:** SLOW_MODE | 49 issue(s) / 100 entries | 2026-02-13T20:14:44.557741Z
- **Top 5 typów problemów:** suspicious_log_medium=155, identical_to_en=49, suspicious_log_low=41, suspicious_log_high=4
- **Języki o najsłabszej jakości:** es(60.1, issues=70521), pl(60.1, issues=61378), de(71.4, issues=3460), zh_TW(82.9, issues=0), az(83.1, issues=1126)
...
│ Info: auto translate                                          │
├─────────────────────────────────────────────────────────────────┤
│ ❤️ Heartbeat: 2026-02-13T20:14:51Z           │
└─────────────────────────────────────────────────────────────────┘
```

### 🧾 Ostatnie akcje (dla czytelności)

- 2026-02-13 20:14:51 | AUTO_TRANSLATE:auto_start | pl | ok | html.json
- 2026-02-13 20:14:41 | AUTO_TRANSLATE:parallel_start | es | ok | quests.json
- 2026-02-13 20:14:40 | AUTO_TRANSLATE:auto_done | pl | ok | scripts.json
- 2026-02-13 20:14:35 | AUTO_TRANSLATE:auto_start | pl | ok | scripts.json
- 2026-02-13 20:14:23 | AUTO_TRANSLATE:parallel_start | es | ok | server.json
- 2026-02-13 20:14:22 | AUTO_TRANSLATE:auto_done | pl | ok | quests.json
...
- 🔧 MIGRATION: mini-batch [monsters] → ok (keys+36) — mini_batch=4 processed=40/50
- 🔧 MIGRATION: mini-batch [monsters] → ok (keys+40) — mini_batch=3 processed=30/50
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-13 20:15:15  
