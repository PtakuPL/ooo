...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.05% / real 10.98%**. Tempo: **608.0 kluczy/h**. Tłumaczeń netto: **148,948**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 14:32:46

> **Aktualizacja:** 2026-04-29 14:32:46 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,542 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ru | Plik: items.json | Heartbeat: 2026-04-29T14:30:30Z
> **Okno godzinowe:** okno=1.0h | cykli=76 | pominięte=0.0% | odrzucone=5.6% | przepustowość=608.0/h  
> **Tłumaczeń netto:** 148,948

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 14:32:46 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T14:30:30Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 14:32:46 |
| TRANSLATION | 🟢 AKTYWNY | 21s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T14:32:31.514456Z |
| QUALITY | 🔒 NIEAKTYWNY | 20s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T14:32:32.599822Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 14:32:46 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T14:32:52.769212Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T14:30:30Z
...
| 🔄 **Ostatni cykl** | 30 kluczy, 1 odrzuconych, 116.9s, tryb: AUTO_TRANSLATE, cel: ru/items.json |
| ❤️ **Heartbeat** | 2026-04-29T14:30:30Z |
...
| ♻️ Deferred stats | enqueued=32, cooldown=1, deduped=1, manual_review=3, partial_staged=0, partial_completed=0 |
...
| 🌍 Recent provider mix | TM/simple(381), Free Google Translate(127), canonical_name_semantic_autofix(20), OpenAI model pool(4), term... |
| 🔁 Latest fallback | TM/simple → fallback to google translate high [high_reject_types] items.json |
| 📉 Fallback breakdown | fallback to google translate high(12), fallback chain exhausted validate fail word salad(3), fallback chain... |
...
| ❤️ Pool health | `critical` (writes=535, fallbacks=18) |
...
|-------|--------|----------|-------|-----------|--------|
| `HEARTBEAT_STALE` | OK | OK | `76` | `300` | Heartbeat świeży (76s, src=worker_runtime_heartbeat) Runtime[status=healthy, reason=heartbeat_fresh, phase=... |
| `NO_WRITE` | OK | OK | `30` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 16935}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| RU | 34,377 | 74,536 | 46.12% ↓-0.01% | 4,775 |
...
> **ETA globalne:** ~204 dni (2,982,338 kluczy do celu 95%)
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 14:32:46
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 21s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T14:32:31.514456Z
...
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14619.name)
- stone wall → каменный стена (item.1462.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14620.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14621.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14622.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14623.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14624.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14625.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14626.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14627.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14628.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14629.name)
- stone wall → каменный стена (item.1463.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14630.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14631.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14632.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14633.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14634.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14635.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14636.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4984**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4837**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T14:31:00.117945Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.05%** (699,730/3,875,872)
- **Pokrycie globalne (real):** **10.98%** (425,478/3,875,872)
- **Kopie EN (łącznie):** **410,339**
- **Placeholdery [EN]/puste (łącznie):** **2,185,933**
...
- **Profiler cyklu (ostatni):** cykl #17 (AUTO_TRANSLATE): dispatch 10475ms, mode 92146ms, status 12699ms, total 116917ms
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T13:32:47.140644Z → 2026-04-29T14:32:47.140644Z) |
...
| Podejrzane tłumaczenia | **1086** |
| Najgorsze cele (strażnik) | cs/items.json (gf=18), ro/items.json (gf=8), de/npc.json (gf=3), ru/items.json (gf=3), it/items.json (gf=2) |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 72 | 75.0% | ru/items.json (72) |
| `existing_canonical_name_quality_mixed_scripts` | 24 | 25.0% | ru/items.json (24) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 20s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T14:32:32.599822Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T14:32:32.599822Z
- **Top 5 typów problemów:** suspicious_rejected_critical=189, suspicious_log_high=79, suspicious_log_low=63, suspicious_log_medium=55, suspicious_rejected_high=11
- **Języki o najsłabszej jakości:** es(60.1, issues=750517), ro(60.1, issues=444842), de(60.1, issues=127384), cs(60.1, issues=119415), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 60%, 58706 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 750517 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 75%, 179089 problemów
⚠️ **RU**: jakość 71%, 374163 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,542 |
| Heartbeat | 142s temu | 2026-04-29T14:30:30Z |
...
- 2026-04-29 14:32:31 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
- 2026-04-29 14:31:01 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-04-29 14:31:00 | AUTO_TRANSLATE:auto_start | ru | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 14:32:46
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+4) — repair_identical lang=es file=npc.json target_identical=2 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=215.67
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → warn (files+1, translated+30, skipped+0) — lang=ru file=items.json strict_skipped_done=2873 guard_fail=1 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+7) — repair_identical lang=es file=npc.json target_identical=2 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=241.76
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **11,726** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 216 |
| ❌ Błędów | 522 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,979), **RU** (1,870), **TR** (1,846), **DE** (1,710), **IT** (1,663) |
| 📊 Porównanie | ↑ 42.5% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **30,706** kluczy
...
| 🔄 Cykli wykonanych | **#18,542** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,542 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 14:32:46  
