...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 16.56% / real 9.32%**. Tempo: **2656.0 kluczy/h**. Tłumaczeń netto: **88,506**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-29 14:55:40

> **Aktualizacja:** 2026-03-29 14:55:40 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #12,330 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: fr | Plik: items.json | Heartbeat: 2026-03-29T14:54:29Z  
> **Okno godzinowe:** okno=1.0h | cykli=96 | pominięte=0.0% | odrzucone=36.1% | przepustowość=2656.0/h  
> **Tłumaczeń netto:** 88,506

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-29 14:55:40 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-03-29T14:54:29Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 8s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-29 14:55:40 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-29T14:54:17.853822Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-29T14:54:18.479854Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-29 14:55:40 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-29T14:54:29Z
...
| ❤️ **Heartbeat** | 2026-03-29T14:54:29Z |
...
| �📊 Przetłumaczono | **2,656** kluczy |
| ❌ Odrzucone (guard) | 1503 |
| 🔁 Cykli | 96 |
| 🌍 Języków | 11 |
| 🏆 Najaktywniejszy | RO (562 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~2656 kluczy/h |
...
> **ETA globalne:** ~48 dni (3,040,153 kluczy do celu 95%)
...
| CS | ████████░░░░░░░░░░░░ | 41.1% | 30,655/74,536 | ~15h |
| NL | ██████████████░░░░░░ | 70.2% | 52,315/74,536 | ~7h |
| TR | ████░░░░░░░░░░░░░░░░ | 21.1% | 15,746/74,536 | ~21h |
...
> Tempo obliczone na bazie ostatniej godziny: ~2656 kluczy/h.
...
> Świeżość: 8s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-29 14:55:40
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-29T14:54:17.853822Z
...
- dragon hoard → tesoro del drago (item.44758.name)
- arrow pointing left → freccia che punta a sinistra (item.44763.name)
- arrow pointing up → freccia rivolta verso l'alto (item.44764.name)
- This spellbook was made from rich dark chocolate and is filled with powerful kno → Questo libro degli incantesimi è stato realizzato con un ricco cioccolato fonden (item.45639.desc)
- cocoa grimoire → Grimorio del cacao (item.45639.name)
- This spellbook was made from pure white chocolate and is brimming with magical f → Questo libro degli incantesimi è stato realizzato con puro cioccolato bianco ed  (item.45640.desc)
- creamy grimoire → grimorio cremoso (item.45640.name)
- This necklace provides a sugary barrier against attacks. → Questa collana fornisce una barriera zuccherina contro gli attacchi. (item.45641.desc)
- candy necklace → collana di caramelle (item.45641.name)
- This ring provides a delicious defense for a limited number of uses. → Questo anello fornisce una deliziosa difesa per un numero limitato di usi. (item.45642.desc)
- ring of temptation → anello della tentazione (item.45642.name)
- This tasty-looking shield protects from damage and boosts your regeneration. → Questo scudo dall'aspetto gustoso protegge dai danni e aumenta la tua rigenerazi (item.45643.desc)
- biscuit barrier → barriera biscotto (item.45643.name)
- candy-coated quiver → faretra ricoperta di caramelle (item.45644.name)
- preserved pink seed → seme rosa conservato (item.45652.name)
- preserved red seed → seme rosso conservato (item.45653.name)
- preserved light blue seed → seme azzurro conservato (item.45654.name)
- preserved violet seed → seme di viola conservato (item.45655.name)
- preserved purple seed → seme viola conservato (item.45656.name)
- preserved yellow seed → seme giallo conservato (item.45657.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **3426**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3284**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 280 | 0 | 0 | - | 2026-03-29T14:54:28.610973Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **16.56%** (641,915/3,875,872)
- **Pokrycie globalne (real):** **9.32%** (361,372/3,875,872)
- **Kopie EN (łącznie):** **433,490**
- **Placeholdery [EN]/puste (łącznie):** **2,226,871**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-29T13:55:40.268414Z → 2026-03-29T14:55:40.268414Z) |
...
| Przepustowość (kluczy/h) | **2656.0 kluczy/h** |
| Podejrzane tłumaczenia | **2131** |
...
|--------|-----------|--------|----------------|
| `gt_rejected_critical` | 96 | 46.8% | pl/monsters.json (52) |
| `gt_validate_fail_placeholder` | 45 | 22.0% | cs/npc.json (13) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-29T14:54:18.479854Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-03-29T14:54:18.479854Z
...
- **Języki o najsłabszej jakości:** cs(59.9, issues=33653), pl(60.1, issues=347796), fr(60.9, issues=34475), de(61.3, issues=76465), nl(61.9, issues=22116)
- **Pliki:** `i18n/status/quality_audit_latest.json`, `i18n/status/quality_dashboard.json`, `i18n/status/quality_report.jsonl`

### 📈 Statystyki Pracy
| Metryka | Wartość | Info |
|---------|---------|------|
| 🔄 Cykl aktualny | **#325** | od uruchomienia |
...
⚠️ **TR**: jakość 62%, 16175 problemów
⚠️ **PL**: jakość 60%, 347796 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 92%, 664567 problemów
⚠️ **PT**: jakość 62%, 28493 problemów
⚠️ **FR**: jakość 61%, 34475 problemów
⚠️ **IT**: jakość 65%, 128501 problemów
⚠️ **RU**: jakość 93%, 305863 problemów
⚠️ **NL**: jakość 62%, 22116 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #12,330 |
| Heartbeat | 72s temu | 2026-03-29T14:54:29Z |
...
- **Ostatnia aktualizacja:** 2026-03-29T14:47:38.711294Z
...
- 2026-03-29 14:54:29 | AUTO_TRANSLATE:heartbeat_tick | fr | ok | items.json
- 2026-03-29 14:54:28 | AUTO_TRANSLATE:auto_start | fr | ok | items.json
- 2026-03-29 14:54:18 | AUTO_TRANSLATE:auto_done | it | ok | items.json
- 2026-03-29 14:54:09 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-03-29 14:52:39 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-03-29 14:51:08 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **88,506** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=38.91%, reason=decrease_high_fail_rate=38.9%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-29 14:55:40
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [sr] → ok (translated+9, skipped+0) — parallel lang=sr file=server.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [sv] → ok (translated+13, skipped+0) — parallel lang=sv file=server.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+28, skipped+0) — lang=ro file=quests.json strict_skipped_done=581 guard_fail=7 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **26,565** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 308 |
| ❌ Błędów | 540 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **IT** (4,905), **CS** (3,618), **TR** (3,286), **FR** (2,948), **NL** (2,899) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **74,932** kluczy
...
| 🔄 Cykli wykonanych | **#12,330** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #12,330 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-29 14:55:40  
