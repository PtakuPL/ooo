...
local function addTravelKeyword(keyword, text, cost, destination, condition, action)
	...
	local travelKeyword = keywordHandler:addKeyword({ keyword }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.chemar.stdmod_4", i18nArgs = { keyword:titleCase() }, cost = cost, discount = "postman" })
