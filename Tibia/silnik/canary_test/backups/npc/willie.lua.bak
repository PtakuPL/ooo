...
bananaKeyword:addChildKeyword({ "yes" }, StdModule.say, {
	npcHandler = npcHandler,
	i18nKey = "npc.willie.stdmod_44",
	reset = true,
})
bananaKeyword:addChildKeyword({ "" }, StdModule.say, {
	npcHandler = npcHandler,
	i18nKey = "npc.willie.stdmod_45",
	reset = true,
})
