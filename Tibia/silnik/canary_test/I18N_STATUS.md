...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-19 15:15:11

> **Aktualizacja:** 2026-02-19 15:15:11 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #1 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: parallel_start | Kategoria: sr | Plik: otclient_modules.json | Heartbeat: 2026-02-19T15:15:13Z  
> **Okno godzinowe:** okno=1.0h | cykli=90 | pominięte=0.0% | odrzucone=0.0% | przepustowość=0.0/h  
> **Tłumaczeń netto:** 110,341

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-19 15:15:11 |
| LIVE | 🟢 AKTYWNY | 0s temu | - | `activity.json / worker_state.json` | 2026-02-19T15:15:13Z |
| MIGRATION | 🔒 NIEAKTYWNY | 2d temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-19 15:15:11 |
| TRANSLATION | 🟢 AKTYWNY | 6s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-19T15:15:07.105184Z |
| QUALITY | 🔒 NIEAKTYWNY | 31s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-19T15:14:42.218201Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-19 15:15:11 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-19T15:15:13Z
...
| ❤️ **Heartbeat** | 2026-02-19T15:15:13Z |
...
| 📄 Najczęstszy plik | example_merchant.json |
...
> Świeżość: 2d temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-19 15:15:11
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-19T15:15:07.105184Z
...
- Raporty strażnika jakości: **5321**  
- Raporty blokad: **0**  
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-19T14:15:11.396022Z → 2026-02-19T15:15:11.396022Z) |
...
| Najgorsze cele (strażnik) | ru/movements.json (gf=0), ru/globalevents.json (gf=0), it/dataroot.json (gf=0), sv/otclient_modules.json (gf=0), sr/raids.json (gf=0) |
...
> Świeżość: 31s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-19T15:14:42.218201Z

- **Ostatni audyt:** SLOW_MODE | 31 issue(s) / 100 entries | 2026-02-19T15:14:42.218201Z
- **Top 5 typów problemów:** suspicious_log_high=192, suspicious_rejected_critical=171, suspicious_rejected_high=29, artifact_token=16, identical_to_en=15
- **Języki o najsłabszej jakości:** es(60.1, issues=281917), pl(60.1, issues=160468), ru(60.1, issues=131275), ro(60.1, issues=127470), sr(60.1, issues=66781)
...
⚠️ **PL**: jakość 60%, 160468 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 281917 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 49821 problemów
⚠️ **RU**: jakość 60%, 131275 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 90%, 26605 problemów
...
| Heartbeat | 0s temu | 2026-02-19T15:15:13Z |
...
- 2026-02-19 15:15:13 | AUTO_TRANSLATE:parallel_start | sr | ok | otclient_modules.json
- 2026-02-19 15:15:09 | AUTO_TRANSLATE:heartbeat_tick | sv | ok | questlog.json
- 2026-02-19 15:15:09 | AUTO_TRANSLATE:parallel_start | sv | ok | questlog.json
- 2026-02-19 15:15:07 | AUTO_TRANSLATE:auto_done | it | ok | example_merchant.json
- 2026-02-19 15:15:03 | AUTO_TRANSLATE:heartbeat_tick | it | ok | example_merchant.json
- 2026-02-19 15:15:03 | AUTO_TRANSLATE:auto_start | it | ok | example_merchant.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-19 15:15:11

- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [sv] → ok (translated+0, skipped+0) — parallel lang=sv file=questlog.json
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [sr] → ok (translated+0, skipped+0) — parallel lang=sr file=raids.json
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-19 15:15:11  
