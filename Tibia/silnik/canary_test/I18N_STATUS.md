...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 01:45:48

> **Aktualizacja:** 2026-04-29 01:45:48 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,487 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: dispatch | Kategoria: ro | Plik: items.json | Heartbeat: 2026-04-29T01:45:22Z
> **Okno godzinowe:** okno=1.0h | cykli=71 | pominięte=0.0% | odrzucone=3.8% | przepustowość=813.0/h  
> **Tłumaczeń netto:** 139,526

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 01:45:48 |
| LIVE | 🟢 AKTYWNY | 32s temu | - | `activity.json / worker_state.json` | 2026-04-29T01:45:22Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 29s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 01:45:48 |
| TRANSLATION | 🟢 AKTYWNY | 4min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T01:41:07.922685Z |
| QUALITY | 🔒 NIEAKTYWNY | 32s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T01:45:22.304108Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 01:45:48 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T01:45:54.655647Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 32s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T01:45:22Z
...
| 🔄 **Ostatni cykl** | 34 kluczy, 1 odrzuconych, 342.1s, tryb: AUTO_TRANSLATE, cel: it/items.json |
| ❤️ **Heartbeat** | 2026-04-29T01:45:22Z |
...
| ⏳ Oldest pending (visible tail) | 17378 s |
| 🌍 Top języki | RU(398) |
...
| 🌍 Recent provider mix | TM/simple(271), Free Google Translate(206), canonical_name_semantic_autofix(15), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=495, fallbacks=21) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=517/517 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 17378}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 29s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 01:45:48
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 4min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T01:41:07.922685Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T01:45:50.021694Z |
...
- **Profiler cyklu (ostatni):** cykl #161 (AUTO_TRANSLATE): dispatch 1049ms, mode 328566ms, status 10694ms, total 342097ms
...
| 🕒 Evidence window | 24h (span=30.89h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=30.89h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T00:45:49.223222Z → 2026-04-29T01:45:49.223222Z) |
...
> Świeżość: 32s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T01:45:22.304108Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T01:45:22.304108Z
- **Top 5 typów problemów:** suspicious_rejected_critical=189, suspicious_log_low=106, suspicious_log_high=93, suspicious_rejected_high=11, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=728673), ro(60.1, issues=427946), de(60.1, issues=111191), cs(60.1, issues=87067), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 728673 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 66%, 169987 problemów
⚠️ **RU**: jakość 64%, 359974 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,487 |
| Heartbeat | 32s temu | 2026-04-29T01:45:22Z |
...
- 2026-04-29 01:44:24 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **139,526** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=5.43%, reason=stable_fail_rate=5.4%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 01:45:48
...
| 🔄 Cykli wykonanych | **#17,487** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,487 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 01:45:48  
