...
> **Aktualizacja:** 2025-12-11 02:38:23 UTC  
...
│ 🌍 Języki zsync: 0/53                                │
│ 📅 Ostatnia aktualizacja: 2025-12-11 02:38:23                 │
└─────────────────────────────────────────────────────────────────┘
```
...
- ⚡ `html` +0 kluczy @ 02:27:03
- ⚡ `php` +0 kluczy @ 02:26:55
- ⚡ `npclib` +0 kluczy @ 02:26:16
- ⚡ `startup` +0 kluczy @ 02:26:10
- ⚡ `modules` +0 kluczy @ 02:26:03
- ⚡ `chatchannels` +0 kluczy @ 02:25:55
...
|-----------|--------|--------------|-----------|--------|
| items | 13749 | 28958 | 2 | ✅ Active |
| monsters | 7341 | 0 | 4 | ⏭️ Skip 46m |
| npc | 5334 | 0 | 4 | ⏭️ Skip 35m |
| html | 1495 | 0 | 4 | ⏭️ Skip 48m |
| scripts | 385 | 0 | 4 | ⏭️ Skip 36m |
| client | 236 | 0 | 4 | ⏭️ Skip 48m |
| spells | 156 | 370 | 0 | ✅ Active |
| raids | 147 | 0 | 4 | ⏭️ Skip 46m |
| php | 40 | 27 | 2 | ✅ Active |
| startup | 23 | 0 | 4 | ⏭️ Skip 47m |
| libs | 21 | 0 | 4 | ⏭️ Skip 37m |
| modules | 16 | 0 | 4 | ⏭️ Skip 47m |
| messages | 11 | 0 | 0 | ✅ Active |
| chatchannels | 8 | 0 | 4 | ⏭️ Skip 47m |
| events | 5 | 0 | 3 | ⏭️ Skip 12m |
| actions | 0 | 0 | 0 | ⏳ Empty |
| cpp | 0 | 0 | 2 | ⏳ Empty |
| errors | 0 | 0 | 0 | ⏳ Empty |
...
|-----------|----------------|-----------|-------|
| npc | 35m | 4x | Progresywny backoff |
| scripts | 36m | 4x | Progresywny backoff |
| monsters | 46m | 4x | Progresywny backoff |
| raids | 46m | 4x | Progresywny backoff |
| world | 46m | 4x | Progresywny backoff |
| libs | 37m | 4x | Progresywny backoff |
| events | 12m | 3x | Progresywny backoff |
...
| html | 48m | 4x | Progresywny backoff |
| client | 48m | 4x | Progresywny backoff |
| sendtextmessage | 49m | 4x | Progresywny backoff |
| pending_skip | 107m | 52x | Progresywny backoff |
...
📅 Auto-updated by Worker v1.1 | Last: 2025-12-11 02:38:23  
