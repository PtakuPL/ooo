...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.81%**. Tempo: **1175.1 kluczy/h**. Tłumaczeń netto: **113,137**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 16:30:13

> **Aktualizacja:** 2026-02-20 16:30:13 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #7 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: es | Plik: - | Heartbeat: 2026-02-20T16:30:09Z  
> **Okno godzinowe:** okno=1.0h | cykli=26 | pominięte=0.0% | odrzucone=84.5% | przepustowość=1175.1/h  
> **Tłumaczeń netto:** 113,137

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 16:30:13 |
| LIVE | 🟢 AKTYWNY | 4s temu | - | `activity.json / worker_state.json` | 2026-02-20T16:30:09Z |
| MIGRATION | 🔒 NIEAKTYWNY | 32s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 16:30:13 |
| TRANSLATION | 🟢 AKTYWNY | 41s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T16:29:32.198333Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T16:30:13.716685Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 16:30:13 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 4s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T16:30:09Z
...
| ❤️ **Heartbeat** | 2026-02-20T16:30:09Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **484** kluczy |
| ❌ Odrzucone (guard) | 2638 |
| 🔁 Cykli | 26 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (94 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~1175 kluczy/h |
| 🛡️ Guard fail rate | 84.5% |
| ⚠️ Podejrzane | 803 |
...
> **ETA globalne:** ~80 dni (2,262,297 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| PL | █████████████████░░░ | 87.7% | 47,007/53,586 | ~3h |
| ES | ████████████████░░░░ | 84.5% | 45,299/53,586 | ~5h |
| IT | ██████████░░░░░░░░░░ | 51.2% | 27,420/53,586 | ~20h |
| RU | ██████████░░░░░░░░░░ | 50.4% | 26,979/53,586 | ~20h |
| SR | █████████░░░░░░░░░░░ | 45.4% | 24,318/53,586 | ~23h |
| RO | ████████░░░░░░░░░░░░ | 42.0% | 22,510/53,586 | ~24h |
| FR | ██████░░░░░░░░░░░░░░ | 33.1% | 17,731/53,586 | ~28h |
| SV | █████░░░░░░░░░░░░░░░ | 28.1% | 15,031/53,586 | ~31h |
| ZH_TW | ██░░░░░░░░░░░░░░░░░░ | 14.5% | 7,776/53,586 | ~37h |
| BN | █░░░░░░░░░░░░░░░░░░░ | 8.7% | 4,641/53,586 | ~39h |
| AR | █░░░░░░░░░░░░░░░░░░░ | 8.6% | 4,579/53,586 | ~39h |
| FA | █░░░░░░░░░░░░░░░░░░░ | 8.4% | 4,520/53,586 | ~39h |
...
> Tempo obliczone na bazie ostatniej godziny: ~1175 kluczy/h.
...
> Świeżość: 32s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 16:30:13
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 41s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T16:29:32.198333Z
...
- Raporty strażnika jakości: **6547**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3655**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T15:30:13.550943Z → 2026-02-20T16:30:13.550943Z) |
| Cykle | **26** (TŁUMACZENIE=26, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **84.5%** |
| Cykle bez postępu % | **11.1%** |
| Przepustowość (kluczy/h) | **1175.1 kluczy/h** |
| Podejrzane tłumaczenia | **803** |
| Najgorsze cele (strażnik) | pl/items.json (gf=1672), pl/npc.json (gf=666), pl/server.json (gf=87), ro/monsters.json (gf=42), es/spells.json (gf=42) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T16:30:13.716685Z

- **Ostatni audyt:** SLOW_MODE | 53 issue(s) / 100 entries | 2026-02-20T16:30:09.129645Z | recent_hidden=0
- **Alarm recent hidden HIGH/CRITICAL:** ✅ OK | hidden=0, threshold=5, trend=→ last10=0.00, prev10=0.00, latest=0
- **Regresja critical bad keys pack:** 🚨 FAIL: pl(critical=47, pack=0), es(critical=22, pack=0)
- **Top 5 typów problemów:** suspicious_rejected_critical=146, suspicious_log_high=127, suspicious_log_critical=73, suspicious_rejected_high=54, artifact_token=53
- **Języki o najsłabszej jakości:** es(60.1, issues=314823), pl(60.1, issues=178129), ro(60.1, issues=171959), sr(60.5, issues=85529), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 60%, 178129 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 314823 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 72%, 69275 problemów
⚠️ **RU**: jakość 87%, 208280 problemów
...
| Heartbeat | 4s temu | 2026-02-20T16:30:09Z |
...
- 2026-02-20 16:29:41 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 16:28:50 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | items.json
- 2026-02-20 16:28:50 | AUTO_TRANSLATE:parallel_start | pl | ok | items.json
- 2026-02-20 16:28:05 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | server.json
- 2026-02-20 16:28:05 | AUTO_TRANSLATE:parallel_start | pl | ok | server.json
- 2026-02-20 16:28:03 | AUTO_TRANSLATE:auto_done | es | ok | monsters.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.7% | 0 | 1,827 | 596 | 5779 (90.7%) | 40 |
| 🟡 ES | 84.5% | 0 | 2,160 | 560 | 1531 (73.2%) | 39 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **113,137** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=88.27%, reason=decrease_high_fail_rate=88.3% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,156 kluczy / 79 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 16:30:13
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **576** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 7 |
| ❌ Błędów | 13 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (173), **RU** (94), **IT** (86), **RO** (82), **SR** (50) |
| 📊 Porównanie | ↓ 84.2% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **98,161** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 16:30:13  
