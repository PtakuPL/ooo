...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.01% / real 10.93%**. Tempo: **925.0 kluczy/h**. Tłumaczeń netto: **145,630**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 09:20:08

> **Aktualizacja:** 2026-04-29 09:20:08 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,124 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: de | Plik: otclient_modules.json | Heartbeat: 2026-04-29T09:18:10Z
> **Okno godzinowe:** okno=1.0h | cykli=81 | pominięte=0.0% | odrzucone=4.7% | przepustowość=925.0/h  
> **Tłumaczeń netto:** 145,630

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 09:20:08 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T09:18:10Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 56s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 09:20:08 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T09:18:49.714523Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T09:18:09.852784Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 09:20:08 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T09:20:14.805931Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T09:18:10Z
...
| ❤️ **Heartbeat** | 2026-04-29T09:18:10Z |
...
| ⏳ Oldest pending (visible tail) | 15663 s |
...
| 🌍 Recent provider mix | TM/simple(290), Free Google Translate(192), canonical_name_semantic_autofix(19), term_consistency_autofix(3) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=868/868 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 386, 'oldest_s': 15663}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~134 dni (2,983,914 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 79.1% | 58,932/74,536 | ~13h |
| PL | ██████████████░░░░░░ | 71.0% | 52,911/74,536 | ~19h |
| IT | ██████████████░░░░░░ | 70.8% | 52,734/74,536 | ~20h |
...
> Świeżość: 56s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 09:20:08
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T09:18:49.714523Z
...
- Raporty strażnika jakości: **4879**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4732**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T09:18:28.726907Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.01%** (698,154/3,875,872)
- **Pokrycie globalne (real):** **10.93%** (423,786/3,875,872)
- **Kopie EN (łącznie):** **410,455**
- **Placeholdery [EN]/puste (łącznie):** **2,187,509**
...
| 🕒 Evidence window | 24h (span=38.46h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=38.46h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T08:20:08.473727Z → 2026-04-29T09:20:08.473727Z) |
...
| Przepustowość (kluczy/h) | **925.0 kluczy/h** |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 57 | 85.1% | ru/items.json (57) |
| `existing_canonical_name_quality_mixed_scripts` | 7 | 10.4% | ru/items.json (7) |
| `retry_loop_cooldown_default` | 3 | 4.5% | cs/items.json (2) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T09:18:09.852784Z

- **Ostatni audyt:** OK | 2 issue(s) / 100 entries | 2026-04-29T09:18:09.852784Z
- **Top 5 typów problemów:** suspicious_rejected_critical=189, suspicious_log_high=110, suspicious_log_low=88, suspicious_rejected_high=11, identical_to_en=2
- **Języki o najsłabszej jakości:** es(60.1, issues=742032), ro(60.1, issues=438475), de(60.1, issues=121076), cs(60.1, issues=105503), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 742032 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 66%, 175995 problemów
⚠️ **RU**: jakość 61%, 368956 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,124 |
| Heartbeat | 124s temu | 2026-04-29T09:18:10Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T09:19:06.086090Z
...
- 2026-04-29 09:19:06 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 09:18:50 | AUTO_TRANSLATE:auto_done | de | ok | otclient_modules.json
- 2026-04-29 09:18:29 | AUTO_TRANSLATE:heartbeat_tick | de | ok | otclient_modules.json
- 2026-04-29 09:18:29 | AUTO_TRANSLATE:auto_start | de | ok | otclient_modules.json
- 2026-04-29 09:18:09 | AUTO_TRANSLATE:auto_done | es | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 09:20:08
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+4) — repair_identical lang=es file=npc.json target_identical=2 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=183.82
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **8,072** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 185 |
| ❌ Błędów | 339 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,465), **RU** (1,446), **IT** (1,226), **TR** (1,113), **DE** (1,095) |
| 📊 Porównanie | ↓ 1.9% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **27,052** kluczy
...
| 🔄 Cykli wykonanych | **#18,124** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,124 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 09:20:08  
