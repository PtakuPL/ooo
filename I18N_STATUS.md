...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.93% / real 10.85%**. Tempo: **726.0 kluczy/h**. Tłumaczeń netto: **140,040**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 02:26:28

> **Aktualizacja:** 2026-04-29 02:26:28 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,545 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: cs | Plik: items.json | Heartbeat: 2026-04-29T02:24:15Z
> **Okno godzinowe:** okno=1.0h | cykli=85 | pominięte=0.0% | odrzucone=4.5% | przepustowość=726.0/h  
> **Tłumaczeń netto:** 140,040

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 02:26:28 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T02:24:15Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 02:26:28 |
| TRANSLATION | 🟢 AKTYWNY | 16s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T02:26:17.496909Z |
| QUALITY | 🔒 NIEAKTYWNY | 15s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T02:26:19.146189Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 02:26:28 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T02:26:34.265374Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T02:24:15Z
...
| 🔄 **Ostatni cykl** | 41 kluczy, 5 odrzuconych, 94.2s, tryb: AUTO_TRANSLATE, cel: cs/items.json |
| ❤️ **Heartbeat** | 2026-04-29T02:24:15Z |
...
| ⏳ Oldest pending (visible tail) | 17087 s |
| 🌍 Top języki | RU(398) |
...
| 🌍 Recent provider mix | TM/simple(305), Free Google Translate(178), canonical_name_semantic_autofix(15), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=501, fallbacks=21) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=549/549 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 17087}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| RU | 33,875 | 74,536 | 45.45% ↑+0.12% | 4,775 |
...
> **ETA globalne:** ~171 dni (2,987,152 kluczy do celu 95%)
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 02:26:28
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 16s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T02:26:17.496909Z
...
- moist wall → vlhké zdi (item.13104.name)
- moist wall → vlhké zdi (item.13105.name)
- moist wall → vlhké zdi (item.13106.name)
- moist wall → vlhké zdi (item.13107.name)
- moist wall → vlhké zdi (item.13108.name)
- moist wall → vlhké zdi (item.13109.name)
- sandstone wall → pískovcová zeď (item.1311.name)
- moist wall → vlhké zdi (item.13110.name)
- moist wall → vlhké zdi (item.13111.name)
...
- Raporty strażnika jakości: **4733**  
- Raporty blokad: **0**  
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T02:24:43.610566Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.93%** (694,916/3,875,872)
- **Pokrycie globalne (real):** **10.85%** (420,422/3,875,872)
- **Kopie EN (łącznie):** **410,581**
- **Placeholdery [EN]/puste (łącznie):** **2,190,747**
...
| 🕒 Evidence window | 24h (span=31.57h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=31.57h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T01:26:28.548456Z → 2026-04-29T02:26:28.548456Z) |
...
> Świeżość: 15s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T02:26:19.146189Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T02:26:19.146189Z
- **Top 5 typów problemów:** suspicious_rejected_critical=187, suspicious_log_low=96, suspicious_log_high=94, suspicious_rejected_high=13, suspicious_log_medium=10
- **Języki o najsłabszej jakości:** es(60.1, issues=729775), ro(60.1, issues=428995), de(60.1, issues=112134), cs(60.1, issues=88771), fr(60.1, issues=60621)
- **Pliki:** `i18n/status/quality_audit_latest.json`, `i18n/status/quality_dashboard.json`, `i18n/status/quality_report.jsonl`

### 📈 Statystyki Pracy
| Metryka | Wartość | Info |
|---------|---------|------|
| 🔄 Cykl aktualny | **#176** | od uruchomienia |
...
⚠️ **TR**: jakość 63%, 53851 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 729775 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 70%, 170493 problemów
⚠️ **RU**: jakość 65%, 360887 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,545 |
| Heartbeat | 139s temu | 2026-04-29T02:24:15Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T02:22:36.701243Z
...
- 2026-04-29 02:26:17 | AUTO_TRANSLATE:auto_done | cs | ok | items.json
- 2026-04-29 02:26:15 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | items.json
- 2026-04-29 02:24:45 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | items.json
- 2026-04-29 02:24:45 | AUTO_TRANSLATE:auto_start | cs | ok | items.json
- 2026-04-29 02:24:08 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-29 02:22:37 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **140,040** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=3.41%, reason=increase_low_fail_rate=3.4%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 02:26:28

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [cs] → warn (files+1, translated+41, skipped+0) — lang=cs file=items.json strict_skipped_done=2871 guard_fail=5 placeholder=0 command=0 pipe=0
...
- 🌍 TRANSLATION_SYNC: SYNC_FILE_DONE [de] → ok (keys+793, files+1) — lang=de file=otclient_modules.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [cs] → warn (files+0, translated+0, skipped+0) — lang=cs file=startup.json strict_skipped_done=11
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+3) — repair_identical lang=es file=npc.json target_identical=2825 limit=156 tier=high_backlog+domain_cap+suspicious_guard domain_cap=260 gt=true suspicious_pct=868.67
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **2,008** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 48 |
| ❌ Błędów | 84 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (480), **RU** (341), **DE** (270), **TR** (243), **IT** (240) |
| 📊 Porównanie | ↓ 75.6% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **20,988** kluczy
...
| 🔄 Cykli wykonanych | **#17,545** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,545 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 02:26:28  
