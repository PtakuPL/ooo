...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "mission") then
		if player:getStorageValue(Storage.Quest.U7_8.TheShatteredIsles.RaysMission4) == 1 then
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.klaus.say_1")
		...
		elseif player:getStorageValue(Storage.Quest.U7_8.TheShatteredIsles.RaysMission4) == 3 then
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.klaus.say_2")
		...
		if player:getStorageValue(Storage.Quest.U7_8.TheShatteredIsles.RaysMission4) == 3 then
			if npcHandler:getTopic(playerId) == 1 then
				if player:removeItem(6105, 1) then
					NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.klaus.say_3")
					player:setStorageValue(Storage.Quest.U7_8.TheShatteredIsles.RaysMission4, 4)
					npcHandler:setTopic(playerId, 0)
				else
					NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.klaus.say_4")
					npcHandler:setTopic(playerId, 0)
				end
			end
		end
...
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_GREET, "npc.klaus.greet_msg_1")
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_FAREWELL, "npc.klaus.farewell_msg_1")
