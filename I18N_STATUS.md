...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.59%**. Tempo: **1856.1 kluczy/h**. Tłumaczeń netto: **97,185**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-17 04:55:35

> **Aktualizacja:** 2026-02-17 04:55:35 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #256 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-02-17T04:55:18Z  
> **Okno godzinowe:** okno=1.0h | cykli=148 | pominięte=0.0% | odrzucone=47.5% | przepustowość=1856.1/h  
> **Tłumaczeń netto:** 97,185

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-17 04:55:35 |
| LIVE | 🟢 AKTYWNY | 19s temu | - | `activity.json / worker_state.json` | 2026-02-17T04:55:18Z |
| MIGRATION | 🔒 NIEAKTYWNY | 58s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-17 04:55:35 |
| TRANSLATION | 🟢 AKTYWNY | 27s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-17T04:55:09.714763Z |
| QUALITY | 🔒 NIEAKTYWNY | 11s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-17T04:55:25.950236Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-17 04:55:35 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 19s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-17T04:55:18Z
...
| ❤️ **Heartbeat** | 2026-02-17T04:55:18Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **3,279** kluczy |
| ❌ Odrzucone (guard) | 2962 |
| 🔁 Cykli | 148 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (664 kluczy) |
...
> **ETA globalne:** ~53 dni (2,351,943 kluczy do celu 95%)
...
> Świeżość: 58s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-17 04:55:35
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 27s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-17T04:55:09.714763Z
...
- **Pokrycie globalne:** **10.59%** (295,169/2,786,472)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-17T03:55:35.849956Z → 2026-02-17T04:55:35.849956Z) |
...
| Przepustowość (kluczy/h) | **1856.1 kluczy/h** |
| Podejrzane tłumaczenia | **9586** |
...
> Świeżość: 11s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-17T04:55:25.950236Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=200221), pl(60.1, issues=127425), ro(60.1, issues=41297), ru(60.1, issues=32041), it(60.7, issues=12173)
- **Pliki:** `i18n/status/quality_audit_latest.json`, `i18n/status/quality_dashboard.json`, `i18n/status/quality_report.jsonl`

### 📈 Statystyki Pracy
| Metryka | Wartość | Info |
|---------|---------|------|
| 🔄 Cykl aktualny | **#256** | od uruchomienia |
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #256 |
| Heartbeat | 19s temu | 2026-02-17T04:55:18Z |
...
- 2026-02-17 04:55:18 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-17 04:54:16 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | books.json
- 2026-02-17 04:54:16 | AUTO_TRANSLATE:parallel_start | pl | ok | books.json
- 2026-02-17 04:54:14 | AUTO_TRANSLATE:auto_done | es | ok | otclient_modules.json
- 2026-02-17 04:53:46 | AUTO_TRANSLATE:heartbeat_tick | es | ok | otclient_modules.json
- 2026-02-17 04:53:46 | AUTO_TRANSLATE:auto_start | es | ok | otclient_modules.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 47.1% | 0 | 1,899 | 1,016 | 4305 (80.9%) | 36 |
| 🟡 ES | 74.9% | 0 | 2,630 | 676 | 597 (46.9%) | 30 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **97,185** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=38.46%, reason=decrease_high_fail_rate=38.5% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,692 kluczy / 66 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-17 04:55:35
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+13, skipped+0) — lang=es file=otclient_modules.json strict_skipped_done=1820 guard_fail=31 placeholder=0 command=0 pipe=0
...
- 🌍 TRANSLATION_SYNC: SYNC_FILE_DONE [mk] → ok (keys+66, files+1) — lang=mk file=npc.json
- 🌍 TRANSLATION_SYNC: SYNC_FILE_DONE [uz] → ok (keys+1541, files+1) — lang=uz file=npc.json
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **20,176** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 195 |
| ❌ Błędów | 334 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (4,125), **IT** (3,663), **RU** (3,536), **RO** (3,217), **PL** (2,843) |
| 📊 Porównanie | ↓ 0.6% vs wczoraj (20,288) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **120,370** kluczy
...
| 🔄 Cykli wykonanych | **#256** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-17 04:55:35  
