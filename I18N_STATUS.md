...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.93%**. Tempo: **1105.3 kluczy/h**. Tłumaczeń netto: **128,095**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-21 00:15:56

> **Aktualizacja:** 2026-02-21 00:15:56 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #26 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: it | Plik: books.json | Heartbeat: 2026-02-21T00:15:36Z  
> **Okno godzinowe:** okno=1.0h | cykli=161 | pominięte=0.0% | odrzucone=49.4% | przepustowość=1105.3/h  
> **Tłumaczeń netto:** 128,095

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-21 00:15:56 |
| LIVE | 🟢 AKTYWNY | 21s temu | - | `activity.json / worker_state.json` | 2026-02-21T00:15:36Z |
| MIGRATION | 🔒 NIEAKTYWNY | 22s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-21 00:15:56 |
| TRANSLATION | 🟢 AKTYWNY | 1s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-21T00:15:56.582866Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-21T00:15:57.580004Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-21 00:15:56 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 21s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-21T00:15:36Z
...
| ❤️ **Heartbeat** | 2026-02-21T00:15:36Z |
...
> Tempo obliczone na bazie ostatniej godziny: ~1105 kluczy/h.
...
> Świeżość: 22s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-21 00:15:56
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-21T00:15:56.582866Z
...
- [ES/cpp.json] {0} physical + {1} → {0} físico + {1} (cpp.inspect.physical_plus)
...
- [ES/cpp.json] {0} ({1} +{2}%, remaining {3}) → {0} ({1} +{2}%, restante {3}) (cpp.protocol.active_prey_desc)
...
- Raporty strażnika jakości: **7435**  
- Raporty blokad: **0**  
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T23:15:56.787579Z → 2026-02-21T00:15:56.787579Z) |
...
| Przepustowość (kluczy/h) | **1105.3 kluczy/h** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-21T00:15:57.580004Z
...
| Heartbeat | 21s temu | 2026-02-21T00:15:36Z |
...
- 2026-02-21 00:15:04 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | modules.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-21 00:15:56
...
| ❌ Błędów | 24 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (134), **RU** (134), **IT** (100), **SR** (60), **SV** (55) |
| 📊 Porównanie | ↓ 97.5% vs wczoraj (23,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **88,916** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-21 00:15:56  
