...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **9.87%**. Tempo: **2598.8 kluczy/h**. Tłumaczeń netto: **69,039**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-16 20:30:41

> **Aktualizacja:** 2026-02-16 20:30:41 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #10 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ru | Plik: - | Heartbeat: 2026-02-16T20:30:36Z  
> **Okno godzinowe:** okno=1.0h | cykli=38 | pominięte=0.0% | odrzucone=14.8% | przepustowość=2598.8/h  
> **Tłumaczeń netto:** 69,039

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-16 20:30:41 |
| LIVE | 🟢 AKTYWNY | 6s temu | - | `activity.json / worker_state.json` | 2026-02-16T20:30:36Z |
| MIGRATION | 🔒 NIEAKTYWNY | 19min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-16 20:30:41 |
| TRANSLATION | 🟢 AKTYWNY | 6s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-16T20:30:35.090855Z |
| QUALITY | 🔒 NIEAKTYWNY | 6s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-16T20:30:35.684854Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-16 20:30:41 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-16T20:30:36Z
...
| ❤️ **Heartbeat** | 2026-02-16T20:30:36Z |
...
> **ETA globalne:** ~38 dni (2,372,076 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ██████████████░░░░░░ | 73.2% | 39,231/53,586 | ~4h |
| PL | ████████░░░░░░░░░░░░ | 42.2% | 22,595/53,586 | ~11h |
| RU | ██████░░░░░░░░░░░░░░ | 33.1% | 17,746/53,586 | ~13h |
| FR | ██████░░░░░░░░░░░░░░ | 33.0% | 17,709/53,586 | ~13h |
| RO | ███░░░░░░░░░░░░░░░░░ | 16.5% | 8,822/53,586 | ~16h |
...
> Świeżość: 19min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-16 20:30:41
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-16T20:30:35.090855Z
...
- LONG LIVE THE QUEEN! → LUNGA VITA ALLA REGINA! (npc.bambi_bonecrusher.greet_msg_1)
- LONG LIVE THE QUEEN! → LUNGA VITA ALLA REGINA! (npc.bambi_bonecrusher.walkaway_msg_1)
- LONG LIVE THE QUEEN! → LUNGA VITA ALLA REGINA! (npc.barbara.walkaway_msg_1)
- Good bye, |PLAYERNAME|. → Arrivederci, |PLAYERNAME|. (npc.bashira.farewell_1)
- Good Bye, |PLAYERNAME|. → Arrivederci, |PLAYERNAME|. (npc.bashira.farewell_msg_1)
- LONG LIVE THE KING! → LUNGA VITA AL RE! (npc.baxter.farewell_msg_1)
- LONG LIVE THE KING! → LUNGA VITA AL RE! (npc.baxter.walkaway_msg_1)
- Here it is. → Eccolo. (npc.beatrice.say_2)
- You don't have enough money. → Non hai abbastanza soldi. (npc.beatrice.say_3)
- Good bye, |PLAYERNAME|. → Arrivederci, |PLAYERNAME|. (npc.bertha.farewell_msg_1)
- Here it is. → Eccolo. (npc.bertha.say_2)
- You don't have enough money. → Non hai abbastanza soldi. (npc.bertha.say_3)
- Good bye, |PLAYERNAME|. → Arrivederci, |PLAYERNAME|. (npc.bertha.walkaway_msg_1)
- Bye. → Ciao. (npc.billy.farewell_msg_1)
- Sure. → Certo. (npc.billy.sendtrade_msg_1)
- Bye. → Ciao. (npc.bloodshade_rotten.walkaway_msg_1)
- Bye. → Ciao. (npc.bloodshade_sacrifice.walkaway_msg_1)
- LONG LIVE THE QUEEN! → LUNGA VITA ALLA REGINA! (npc.blossom_bonecrusher.farewell_msg_1)
- LONG LIVE THE QUEEN! → LUNGA VITA ALLA REGINA! (npc.blossom_bonecrusher.greet_msg_1)
- LONG LIVE THE QUEEN! → LUNGA VITA ALLA REGINA! (npc.blossom_bonecrusher.walkaway_msg_1)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **2115**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2054**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **9.87%** (275,036/2,786,472)
- **Kopie EN (łącznie):** **168,313**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-16T19:30:41.836858Z → 2026-02-16T20:30:41.836858Z) |
...
| Przepustowość (kluczy/h) | **2598.8 kluczy/h** |
| Podejrzane tłumaczenia | **3398** |
...
> Świeżość: 6s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-16T20:30:35.684854Z

- **Ostatni audyt:** OK | 6 issue(s) / 100 entries | 2026-02-16T20:30:35.684854Z
- **Top 5 typów problemów:** suspicious_log_high=137, suspicious_log_critical=63, suspicious_rejected_critical=20, identical_to_en_exempt=8, artifact_token=5
- **Języki o najsłabszej jakości:** es(62.6, issues=145712), tl(64.2, issues=466), zh_TW(64.8, issues=337), pl(65.0, issues=112772), fr(65.2, issues=2470)
...
⚠️ **PL**: jakość 65%, 112772 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 63%, 145712 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 84%, 2907 problemów
⚠️ **RU**: jakość 79%, 5106 problemów
...
| Heartbeat | 6s temu | 2026-02-16T20:30:36Z |
...
- 2026-02-16 20:30:32 | AUTO_TRANSLATE:heartbeat_tick | it | ok | npc.json
- 2026-02-16 20:30:32 | AUTO_TRANSLATE:parallel_start | it | ok | npc.json
- 2026-02-16 20:30:27 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | npc.json
- 2026-02-16 20:30:26 | AUTO_TRANSLATE:parallel_start | ro | ok | npc.json
- 2026-02-16 20:30:24 | AUTO_TRANSLATE:auto_done | ru | ok | npc.json
- 2026-02-16 20:30:20 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | npc.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **69,039** | — | 📊 |
| Adaptacyjna paczka | batch=13, gf_rate=22.48%, reason=decrease_high_fail_rate=22.5% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-16 20:30:41
...
| ❌ Błędów | 14 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **RU** (267), **RO** (246), **IT** (238), **ES** (206), **SR** (189) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **81,391** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-16 20:30:41  
