...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.88%**. Tempo: **1379.7 kluczy/h**. Tłumaczeń netto: **122,309**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 20:49:14

> **Aktualizacja:** 2026-02-20 20:49:14 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #171 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: es | Plik: - | Heartbeat: 2026-02-20T20:49:11Z  
> **Okno godzinowe:** okno=1.0h | cykli=197 | pominięte=0.0% | odrzucone=77.3% | przepustowość=1379.7/h  
> **Tłumaczeń netto:** 122,309

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 20:49:14 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T20:49:11Z |
| MIGRATION | 🔒 NIEAKTYWNY | 27s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 20:49:14 |
| TRANSLATION | 🟢 AKTYWNY | 39s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T20:48:36.715515Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T20:49:15.963180Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 20:49:14 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T20:49:11Z
...
| ❤️ **Heartbeat** | 2026-02-20T20:49:11Z |
...
> Świeżość: 27s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 20:49:14
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 39s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T20:48:36.715515Z
...
| RO (Rumuński) | 23,199/53,586 | 43.29% | 2,349 | 0 |
...
| RO | 21,918/49,731 | 44.1% | 1,281/3,855 | 33.2% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T19:49:15.256987Z → 2026-02-20T20:49:15.256987Z) |
...
| Przepustowość (kluczy/h) | **1379.7 kluczy/h** |
| Podejrzane tłumaczenia | **3548** |
| Najgorsze cele (strażnik) | pl/items.json (gf=3264), pl/npc.json (gf=2420), es/items.json (gf=1565), es/server.json (gf=164), pl/spells.json (gf=87) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T20:49:15.963180Z

- **Ostatni audyt:** SLOW_MODE | 37 issue(s) / 100 entries | 2026-02-20T20:49:11.177180Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=146, suspicious_log_critical=82, suspicious_log_high=41, artifact_token=32, suspicious_rejected_high=17
- **Języki o najsłabszej jakości:** es(60.1, issues=342100), pl(60.1, issues=190734), ro(60.1, issues=185744), sr(64.1, issues=86932), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 60%, 190734 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 342100 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 79%, 75791 problemów
⚠️ **RU**: jakość 84%, 213699 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 68%, 31448 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #171 |
| Heartbeat | 5s temu | 2026-02-20T20:49:11Z |
...
- 2026-02-20 20:48:44 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 20:48:31 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | monsters.json
- 2026-02-20 20:48:31 | AUTO_TRANSLATE:parallel_start | pl | ok | monsters.json
- 2026-02-20 20:48:29 | AUTO_TRANSLATE:auto_done | es | ok | npc.json
- 2026-02-20 20:48:15 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 20:48:15 | AUTO_TRANSLATE:auto_start | es | ok | npc.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,830 | 711 | 6791 (90.5%) | 41 |
| 🟡 ES | 84.8% | 0 | 2,160 | 624 | 2708 (81.3%) | 42 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **122,309** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=30.59%, reason=decrease_high_fail_rate=30.6% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,335 kluczy / 83 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 20:49:14
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+43, skipped+0) — lang=it file=scripts.json strict_skipped_done=430 guard_fail=7 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [de] → ok (translated+41, skipped+0) — parallel lang=de file=items.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+41, skipped+0) — parallel lang=es file=server.json
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **14,542** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 171 |
| ❌ Błędów | 356 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (4,339), **RU** (2,792), **IT** (2,302), **PL** (1,774), **RO** (1,701) |
| 📊 Porównanie | ↑ 299.4% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **112,127** kluczy
...
| 🔄 Cykli wykonanych | **#171** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 20:49:14  
