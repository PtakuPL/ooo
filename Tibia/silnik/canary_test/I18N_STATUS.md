...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **18.63%**. Tempo: **1137.3 kluczy/h**. Tłumaczeń netto: **44,075**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-23 03:24:53

> **Aktualizacja:** 2026-03-23 03:24:53 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **LIVE:** Cykl #9,438 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: tr | Plik: spells.json | Heartbeat: 2026-03-23T03:24:41Z  
> **Okno godzinowe:** okno=1.0h | cykli=80 | pominięte=0.0% | odrzucone=8.4% | przepustowość=1137.3/h  
> **Tłumaczeń netto:** 44,075

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-23 03:24:53 |
| LIVE | 🟢 AKTYWNY | 13s temu | - | `activity.json / worker_state.json` | 2026-03-23T03:24:41Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-23 03:24:53 |
| TRANSLATION | 🟢 AKTYWNY | 10min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-23T03:14:33.586126Z |
| QUALITY | 🔒 NIEAKTYWNY | 8min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-23T03:16:37.255442Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-23 03:24:53 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 13s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-23T03:24:41Z
...
| ❤️ **Heartbeat** | 2026-03-23T03:24:41Z |
...
| �📊 Przetłumaczono | **1,931** kluczy |
| ❌ Odrzucone (guard) | 177 |
| 🔁 Cykli | 80 |
| 🌍 Języków | 11 |
| 🏆 Najaktywniejszy | RO (847 kluczy) |
...
> **ETA globalne:** ~108 dni (2,959,997 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ██████████████████░░ | 93.9% | 69,992/74,536 | ~1h |
| PL | ███████████████░░░░░ | 76.8% | 57,266/74,536 | ~12h |
| RO | ██████████████░░░░░░ | 73.0% | 54,450/74,536 | ~14h |
| RU | ██████████████░░░░░░ | 71.7% | 53,458/74,536 | ~15h |
| IT | ██████████████░░░░░░ | 71.7% | 53,415/74,536 | ~15h |
| FR | ██████████████░░░░░░ | 70.8% | 52,806/74,536 | ~16h |
| PT | █████████████░░░░░░░ | 68.8% | 51,290/74,536 | ~17h |
| CS | █████████████░░░░░░░ | 67.0% | 49,920/74,536 | ~18h |
| NL | █████████████░░░░░░░ | 66.3% | 49,442/74,536 | ~19h |
| DE | █████████████░░░░░░░ | 66.1% | 49,281/74,536 | ~19h |
| SR | ██████░░░░░░░░░░░░░░ | 33.3% | 24,827/74,536 | ~40h |
| TR | ██░░░░░░░░░░░░░░░░░░ | 11.3% | 8,432/74,536 | ~2d |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-23 03:24:53
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 10min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-23T03:14:33.586126Z
...
- Raporty strażnika jakości: **2797**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2660**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **18.63%** (722,071/3,875,872)
- **Kopie EN (łącznie):** **604,747**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-23T02:24:53.580475Z → 2026-03-23T03:24:53.580475Z) |
...
| Przepustowość (kluczy/h) | **1137.3 kluczy/h** |
| Podejrzane tłumaczenia | **2187** |
| Najgorsze cele (strażnik) | es/questlog.json (gf=74), pt/server.json (gf=25), ru/server.json (gf=18), ro/server.json (gf=17), nl/server.json (gf=11) |
...
> Świeżość: 8min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-23T03:16:37.255442Z

- **Ostatni audyt:** OK | 5 issue(s) / 100 entries | 2026-03-23T03:16:37.255442Z
- **Top 5 typów problemów:** suspicious_log_high=198, suspicious_rejected_critical=182, suspicious_rejected_high=18, identical_to_en=5, identical_to_en_exempt=2
- **Języki o najsłabszej jakości:** es(60.1, issues=574164), it(60.1, issues=108931), pt(60.1, issues=16469), nl(60.1, issues=8983), ru(63.9, issues=285548)
...
⚠️ **TR**: jakość 68%, 3765 problemów
⚠️ **PL**: jakość 94%, 325653 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 574164 problemów
⚠️ **PT**: jakość 60%, 16469 problemów
⚠️ **FR**: jakość 79%, 15698 problemów
⚠️ **IT**: jakość 60%, 108931 problemów
⚠️ **RU**: jakość 64%, 285548 problemów
⚠️ **NL**: jakość 60%, 8983 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #9,438 |
| Heartbeat | 13s temu | 2026-03-23T03:24:41Z |
...
- **Ostatnia aktualizacja:** 2026-03-23T03:14:49.831354Z
...
- 2026-03-23 03:24:41 | AUTO_TRANSLATE:heartbeat_tick | tr | ok | spells.json
- 2026-03-23 03:23:11 | AUTO_TRANSLATE:heartbeat_tick | tr | ok | spells.json
- 2026-03-23 03:21:40 | AUTO_TRANSLATE:heartbeat_tick | tr | ok | spells.json
- 2026-03-23 03:20:10 | AUTO_TRANSLATE:heartbeat_tick | tr | ok | spells.json
- 2026-03-23 03:18:40 | AUTO_TRANSLATE:heartbeat_tick | tr | ok | spells.json
- 2026-03-23 03:17:09 | AUTO_TRANSLATE:heartbeat_tick | tr | ok | spells.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **44,075** | — | 📊 |
| Adaptacyjna paczka | batch=15, gf_rate=6.18%, reason=stable_fail_rate=6.2% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-23 03:24:53
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **10,128** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 55 |
| ❌ Błędów | 101 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **TR** (3,235), **ES** (2,613), **PL** (1,804), **RO** (969), **PT** (442) |
| 📊 Porównanie | ↓ 51.1% vs wczoraj (20,729) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **30,857** kluczy
...
| 🔄 Cykli wykonanych | **#9,438** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-23 03:24:53  
