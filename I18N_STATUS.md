...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.86% / real 10.77%**. Tempo: **885.0 kluczy/h**. Tłumaczeń netto: **135,518**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-28 20:35:05

> **Aktualizacja:** 2026-04-28 20:35:05 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,060 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: auto_done | Kategoria: ru | Plik: items.json | Heartbeat: 2026-04-28T20:33:31Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=3.2% | przepustowość=885.0/h  
> **Tłumaczeń netto:** 135,518

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-28 20:35:05 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-28T20:33:31Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 28s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-28 20:35:05 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-28T20:33:29.728951Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-28T20:33:30.945304Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-28 20:35:05 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-28T20:35:11.272289Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-28T20:33:31Z
...
| 🧭 **Surface** | Serwer |
| 📊 **Status** | 🟢 DZIAŁA |
| 📈 **Postęp** | ████████████████████████████████████████████████ 73/30 keys (243.3%) |
| 🔧 **Metoda** | Google Translate + TM fallback |
| 🧠 **Detail** | auto translate in progress |
| 🔑 **Current key** | `ru:items.json` |
| 🔄 **Ostatni cykl** | 35 kluczy, 0 odrzuconych, 36.0s, tryb: AUTO_TRANSLATE, cel: tr/items.json |
| ❤️ **Heartbeat** | 2026-04-28T20:33:31Z |
...
| ⏳ Oldest pending (visible tail) | 19476 s |
| 🌍 Top języki | RU(288), NL(41), PT(25), DE(12) |
...
| 🌍 Recent provider mix | TM/simple(256), Free Google Translate(238), OpenAI model pool(21), canonical_name_semantic_autofix(12), ter... |
| 🔁 Latest fallback | TM/simple → fallback to google translate high [high_reject_types] items.json |
| 📉 Fallback breakdown | fallback to google translate high(16), fallback chain exhausted validate fail word salad(3), fallback chain... |
...
| ❤️ Pool health | `critical` (writes=530, fallbacks=22) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=279/279 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 387, 'oldest_s': 19476}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~141 dni (2,989,763 kluczy do celu 95%)
...
> Świeżość: 28s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-28 20:35:05
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-28T20:33:29.728951Z
...
- unknown item → неизвестный предмет (item.11135.name)
- dragon spike → шип дракона (item.11153.name)
- dragon spike → шип дракона (item.11154.name)
- dragon spike → шип дракона (item.11155.name)
- carpet → ковер (item.11159.name)
- carpet → ковер (item.11160.name)
- carpet → ковер (item.11161.name)
- carpet → ковер (item.11162.name)
- carpet → ковер (item.11163.name)
- carpet → ковер (item.11164.name)
- carpet → ковер (item.11165.name)
- carpet → ковер (item.11166.name)
- carpet → ковер (item.11167.name)
- carpet → ковер (item.11168.name)
- decorative spear → декоративное копье (item.11182.name)
- decorative spear → декоративное копье (item.11183.name)
- decorative spear → декоративное копье (item.11184.name)
- decorative spear → декоративное копье (item.11185.name)
- alter → изменить (item.11186.name)
- alter → изменить (item.11187.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4611**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4464**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-28T20:33:50.572564Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.86%** (692,305/3,875,872)
- **Pokrycie globalne (real):** **10.77%** (417,512/3,875,872)
- **Kopie EN (łącznie):** **410,880**
- **Placeholdery [EN]/puste (łącznie):** **2,193,358**
...
| 🕒 Evidence window | 24h (span=25.71h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=25.71h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-28T19:35:05.839304Z → 2026-04-28T20:35:05.839304Z) |
...
| Najgorsze cele (strażnik) | ro/items.json (gf=12), cs/items.json (gf=8), it/items.json (gf=3), de/otclient_modules.json (gf=3), de/npc.json (gf=3) |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 96 | 94.1% | ru/items.json (96) |
| `retry_loop_cooldown_default` | 6 | 5.9% | ro/items.json (4) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-28T20:33:30.945304Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-28T20:33:30.945304Z
- **Top 5 typów problemów:** suspicious_rejected_critical=189, suspicious_log_medium=92, suspicious_log_low=63, suspicious_log_high=41, suspicious_rejected_high=11
- **Języki o najsłabszej jakości:** es(60.1, issues=720852), ro(60.1, issues=420192), de(60.1, issues=103368), cs(60.1, issues=77556), nl(60.1, issues=71002)
...
⚠️ **TR**: jakość 72%, 52004 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 720852 problemów
⚠️ **PT**: jakość 60%, 56696 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 76%, 166276 problemów
⚠️ **RU**: jakość 83%, 353832 problemów
⚠️ **NL**: jakość 60%, 71002 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,060 |
| Heartbeat | 100s temu | 2026-04-28T20:33:31Z |
...
│ Plik: items.json                                              │
│ Postęp: 73/30 keys                                            │
│ …73 guard_fail=0 strict_missing_key=0 strict_skipped_done=953 │
├─────────────────────────────────────────────────────────────────┤
│ ❤️ Heartbeat: 2026-04-28T20:33:31Z           │
└─────────────────────────────────────────────────────────────────┘
```
...
- 2026-04-28 20:35:07 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
- 2026-04-28 20:33:51 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-04-28 20:33:51 | AUTO_TRANSLATE:auto_start | ru | ok | items.json
- 2026-04-28 20:33:30 | AUTO_TRANSLATE:auto_done | tr | ok | items.json
- 2026-04-28 20:32:54 | AUTO_TRANSLATE:heartbeat_tick | tr | ok | items.json
- 2026-04-28 20:32:54 | AUTO_TRANSLATE:auto_start | tr | ok | items.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 71.0% | 0 | 5,861 | 67 | 304 (81.9%) | 3 |
| 🟡 ES | 78.5% | 0 | 9,730 | 276 | 4 (1.4%) | 14 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **135,518** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=2.76%, reason=increase_low_fail_rate=2.8%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 343 kluczy / 17 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-28 20:35:05
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **5,233** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 54 |
| ❌ Błędów | 208 |
| 🌍 Aktywnych języków | 9 |
| 🏆 TOP 5 | **DE** (945), **RU** (680), **IT** (636), **PT** (594), **TR** (577) |
| 📊 Porównanie | ↑ 0.9% vs wczoraj (5,188) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **28,093** kluczy
...
| 🔄 Cykli wykonanych | **#17,060** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,060 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-28 20:35:05  
