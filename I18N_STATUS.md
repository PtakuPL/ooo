...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **18.88%**. Tempo: **1028.8 kluczy/h**. Tłumaczeń netto: **56,683**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-23 11:53:01

> **Aktualizacja:** 2026-03-23 11:53:01 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **LIVE:** Cykl #10,204 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-03-23T11:52:51Z  
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=3.3% | przepustowość=1028.8/h  
> **Tłumaczeń netto:** 56,683

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-23 11:53:01 |
| LIVE | 🟢 AKTYWNY | 13s temu | - | `activity.json / worker_state.json` | 2026-03-23T11:52:51Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 16s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-23 11:53:01 |
| TRANSLATION | 🟢 AKTYWNY | 34s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-23T11:52:30.162022Z |
| QUALITY | 🔒 NIEAKTYWNY | 52s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-23T11:52:11.371144Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-23 11:53:01 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 13s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-23T11:52:51Z
...
| ❤️ **Heartbeat** | 2026-03-23T11:52:51Z |
...
> **ETA globalne:** ~119 dni (2,950,183 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ██████████████████░░ | 94.0% | 70,066/74,536 | ~1h |
| PL | ███████████████░░░░░ | 77.3% | 57,633/74,536 | ~13h |
...
> Świeżość: 16s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-23 11:53:01
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 34s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-23T11:52:30.162022Z
...
- Raporty strażnika jakości: **2991**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2854**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-23T10:53:02.045843Z → 2026-03-23T11:53:02.045843Z) |
...
| Przepustowość (kluczy/h) | **1028.8 kluczy/h** |
| Podejrzane tłumaczenia | **1816** |
| Najgorsze cele (strażnik) | ro/html.json (gf=25), ru/client.json (gf=10), pl/scripts.json (gf=10), es/scripts.json (gf=8), ro/client.json (gf=5) |
...
> Świeżość: 52s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-23T11:52:11.371144Z

- **Ostatni audyt:** OK | 1 issue(s) / 100 entries | 2026-03-23T11:52:11.371144Z
- **Top 5 typów problemów:** suspicious_log_high=174, suspicious_rejected_critical=108, suspicious_rejected_high=92, suspicious_log_medium=26, identical_to_en_exempt=5
- **Języki o najsłabszej jakości:** es(60.1, issues=616369), ru(60.1, issues=292452), tr(67.6, issues=7474), ro(69.9, issues=339693), az(70.3, issues=1417)
...
⚠️ **TR**: jakość 68%, 7474 problemów
⚠️ **PL**: jakość 77%, 328614 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 616369 problemów
⚠️ **PT**: jakość 74%, 21683 problemów
⚠️ **FR**: jakość 90%, 19230 problemów
⚠️ **IT**: jakość 90%, 114097 problemów
⚠️ **RU**: jakość 60%, 292452 problemów
⚠️ **NL**: jakość 89%, 14082 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #10,204 |
| Heartbeat | 13s temu | 2026-03-23T11:52:51Z |
...
- **Ostatnia aktualizacja:** 2026-03-23T11:52:50.943958Z
...
- 2026-03-23 11:52:51 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-03-23 11:52:30 | AUTO_TRANSLATE:auto_done | es | ok | scripts.json
- 2026-03-23 11:52:18 | AUTO_TRANSLATE:heartbeat_tick | es | ok | scripts.json
- 2026-03-23 11:52:18 | AUTO_TRANSLATE:auto_start | es | ok | scripts.json
- 2026-03-23 11:52:10 | AUTO_TRANSLATE:auto_done | pl | ok | scripts.json
- 2026-03-23 11:51:58 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | scripts.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 77.3% | 13,769 | 12,539 | 841 | 329 (28.1%) | 26 |
| 🟡 ES | 94.0% | 2,385 | 24,292 | 609 | 498 (45.0%) | 26 |
...
| Przepustowość (okno) | 1,450 kluczy / 52 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-23 11:53:01
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **31,324** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 174 |
| ❌ Błędów | 458 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **ES** (9,896), **TR** (5,947), **RO** (3,014), **PL** (2,645), **RU** (1,753) |
| 📊 Porównanie | ↑ 51.1% vs wczoraj (20,729) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **52,053** kluczy
...
| 🔄 Cykli wykonanych | **#10,204** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #10,204 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-23 11:53:01  
