...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.86%**. Tempo: **1719.1 kluczy/h**. Tłumaczeń netto: **118,982**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 19:05:53

> **Aktualizacja:** 2026-02-20 19:05:53 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #86 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: - | Heartbeat: 2026-02-20T19:05:50Z  
> **Okno godzinowe:** okno=1.0h | cykli=205 | pominięte=0.0% | odrzucone=71.2% | przepustowość=1719.1/h  
> **Tłumaczeń netto:** 118,982

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 19:05:53 |
| LIVE | 🟢 AKTYWNY | 4s temu | - | `activity.json / worker_state.json` | 2026-02-20T19:05:50Z |
| MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 19:05:53 |
| TRANSLATION | 🟢 AKTYWNY | 37s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T19:05:17.117494Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T19:05:54.629571Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 19:05:53 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 4s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T19:05:50Z
...
| ❤️ **Heartbeat** | 2026-02-20T19:05:50Z |
...
> Tempo obliczone na bazie ostatniej godziny: ~1719 kluczy/h.
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 19:05:53
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 37s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T19:05:17.117494Z
...
| IT (Włoski) | 27,871/53,586 | 52.01% | 2,142 | 0 |
...
| IT | 26,512/49,731 | 53.3% | 1,359/3,855 | 35.2% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T18:05:53.955236Z → 2026-02-20T19:05:53.955236Z) |
...
| Przepustowość (kluczy/h) | **1719.1 kluczy/h** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T19:05:54.629571Z

- **Ostatni audyt:** SLOW_MODE | 30 issue(s) / 100 entries | 2026-02-20T19:05:50.074485Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_log_critical=80, suspicious_rejected_critical=64, suspicious_log_high=44, artifact_token=25, identical_to_en_exempt=9
- **Języki o najsłabszej jakości:** es(60.1, issues=330352), pl(60.1, issues=185386), ro(60.1, issues=181030), sr(61.3, issues=86259), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 60%, 185386 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 330352 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 90%, 73376 problemów
⚠️ **RU**: jakość 71%, 211481 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #86 |
| Heartbeat | 4s temu | 2026-02-20T19:05:50Z |
...
- 2026-02-20 19:05:23 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 19:05:10 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | npc.json
- 2026-02-20 19:05:10 | AUTO_TRANSLATE:parallel_start | ro | ok | npc.json
- 2026-02-20 19:05:05 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | npc.json
- 2026-02-20 19:05:05 | AUTO_TRANSLATE:parallel_start | ru | ok | npc.json
- 2026-02-20 19:05:03 | AUTO_TRANSLATE:auto_done | it | ok | npc.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 19:05:53
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ro] → ok (translated+46, skipped+0) — parallel lang=ro file=server.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ru] → ok (translated+50, skipped+0) — parallel lang=ru file=server.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+50, skipped+0) — lang=es file=monsters.json strict_skipped_done=1715
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **9,330** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 86 |
| ❌ Błędów | 210 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (2,719), **RU** (1,847), **IT** (1,561), **RO** (1,164), **PL** (1,032) |
| 📊 Porównanie | ↑ 156.2% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **106,915** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 19:05:53  
