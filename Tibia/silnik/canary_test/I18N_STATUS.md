...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.04% / real 10.96%**. Tempo: **818.0 kluczy/h**. Tłumaczeń netto: **147,891**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 12:41:27

> **Aktualizacja:** 2026-04-29 12:41:27 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,404 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: it | Plik: items.json | Heartbeat: 2026-04-29T12:39:42Z
> **Okno godzinowe:** okno=1.0h | cykli=80 | pominięte=0.0% | odrzucone=5.3% | przepustowość=818.0/h  
> **Tłumaczeń netto:** 147,891

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 12:41:27 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T12:39:42Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 59s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 12:41:27 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T12:39:40.800312Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T12:39:41.871292Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 12:41:27 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T12:41:34.735401Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T12:39:42Z
...
| ❤️ **Heartbeat** | 2026-04-29T12:39:42Z |
...
| 🌍 Recent provider mix | TM/simple(281), Free Google Translate(198), canonical_name_semantic_autofix(18), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=500, fallbacks=18) |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 390, 'oldest_s': 17076}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
|-------|---------------|-----------|----------|----------|
| ES | 59,013 | 74,536 | 79.17% →0% | 9,604 |
...
> **ETA globalne:** ~152 dni (2,982,862 kluczy do celu 95%)
...
| RU | █████████░░░░░░░░░░░ | 46.1% | 34,386/74,536 | ~45h |
| FR | ███████████░░░░░░░░░ | 57.5% | 42,864/74,536 | ~34h |
| CS | ██████████░░░░░░░░░░ | 51.0% | 38,050/74,536 | ~40h |
...
> Świeżość: 59s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 12:41:27
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T12:39:40.800312Z
...
- This lamp is glowing very dimly. → Această lampăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă luminează foa (item.13656.desc)
- This lamp is glowing very dimly. → Această lampăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă luminează foa (item.13658.desc)
- This is an emblem of wisdom. It was awarded by TibiaStat.com → Aceasta este o emblemăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă a în (item.14760.desc)
...
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4801**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T12:40:00.488221Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.04%** (699,206/3,875,872)
- **Pokrycie globalne (real):** **10.96%** (424,918/3,875,872)
- **Kopie EN (łącznie):** **410,375**
- **Placeholdery [EN]/puste (łącznie):** **2,186,457**
...
| 🕒 Evidence window | 24h (span=41.82h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=41.82h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T11:41:28.240515Z → 2026-04-29T12:41:28.240515Z) |
...
| Najgorsze cele (strażnik) | cs/items.json (gf=25), ro/items.json (gf=12), ru/items.json (gf=3), it/items.json (gf=2), de/otclient_modules.json (gf=2) |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 89 | 90.8% | ru/items.json (89) |
| `existing_canonical_name_quality_mixed_scripts` | 7 | 7.1% | ru/items.json (7) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T12:39:41.871292Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T12:39:41.871292Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=747819), ro(60.1, issues=442608), de(60.1, issues=125228), cs(60.1, issues=114819), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 747819 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 78%, 178071 problemów
⚠️ **RU**: jakość 64%, 372485 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,404 |
| Heartbeat | 112s temu | 2026-04-29T12:39:42Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T12:34:34.430710Z
...
- 2026-04-29 12:40:01 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-04-29 12:40:01 | AUTO_TRANSLATE:auto_start | it | ok | items.json
- 2026-04-29 12:39:41 | AUTO_TRANSLATE:auto_done | ro | ok | items.json
- 2026-04-29 12:38:20 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-04-29 12:38:19 | AUTO_TRANSLATE:auto_start | ro | ok | items.json
- 2026-04-29 12:36:05 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 12:41:27

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [de] → warn (files+1, translated+207, skipped+0) — lang=de file=items.json strict_skipped_done=33 guard_fail=1 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **10,565** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 202 |
| ❌ Błędów | 460 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,853), **RU** (1,719), **TR** (1,617), **IT** (1,531), **DE** (1,485) |
| 📊 Porównanie | ↑ 28.4% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **29,545** kluczy
...
| 🔄 Cykli wykonanych | **#18,404** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,404 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 12:41:27  
