...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.3%**. Tempo: **2066.0 kluczy/h**. Tłumaczeń netto: **85,513**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-17 00:40:41

> **Aktualizacja:** 2026-02-17 00:40:41 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #87 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ru | Plik: - | Heartbeat: 2026-02-17T00:40:38Z  
> **Okno godzinowe:** okno=1.0h | cykli=153 | pominięte=0.0% | odrzucone=36.5% | przepustowość=2066.0/h  
> **Tłumaczeń netto:** 85,513

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-17 00:40:41 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-17T00:40:38Z |
| MIGRATION | 🔒 NIEAKTYWNY | 43s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-17 00:40:41 |
| TRANSLATION | 🟢 AKTYWNY | 21s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-17T00:40:21.958717Z |
| QUALITY | 🔒 NIEAKTYWNY | 4s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-17T00:40:38.479535Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-17 00:40:41 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-17T00:40:38Z
...
| ❤️ **Heartbeat** | 2026-02-17T00:40:38Z |
...
> **ETA globalne:** ~48 dni (2,360,181 kluczy do celu 95%)
...
> Świeżość: 43s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-17 00:40:41
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 21s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-17T00:40:21.958717Z
...
- Raporty strażnika jakości: **2575**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2509**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **10.3%** (286,931/2,786,472)
- **Kopie EN (łącznie):** **166,348**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-16T23:40:42.185627Z → 2026-02-17T00:40:42.185627Z) |
...
| Przepustowość (kluczy/h) | **2066.0 kluczy/h** |
| Podejrzane tłumaczenia | **9363** |
...
> Świeżość: 4s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-17T00:40:38.479535Z

- **Ostatni audyt:** OK | 7 issue(s) / 100 entries | 2026-02-17T00:40:38.479535Z
- **Top 5 typów problemów:** suspicious_rejected_critical=172, suspicious_log_high=143, suspicious_log_critical=53, suspicious_rejected_high=28, identical_to_en_exempt=11
- **Języki o najsłabszej jakości:** es(60.1, issues=170316), ro(60.2, issues=21020), sv(60.2, issues=4963), ru(60.4, issues=18544), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 71%, 118295 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 170316 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 65%, 6748 problemów
⚠️ **RU**: jakość 60%, 18544 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 60%, 4963 problemów
...
| Heartbeat | 5s temu | 2026-02-17T00:40:38Z |
...
- 2026-02-17 00:40:29 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 44.6% | 0 | 1,921 | 1,193 | 4228 (78.0%) | 33 |
...
| Przepustowość (okno) | 2,077 kluczy / 66 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-17 00:40:41
...
| ❌ Błędów | 42 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (474), **IT** (429), **RU** (375), **SV** (361), **RO** (346) |
| 📊 Porównanie | ↓ 87.2% vs wczoraj (20,288) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **102,790** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-17 00:40:41  
