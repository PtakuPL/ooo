...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.49%**. Tempo: **2065.9 kluczy/h**. Tłumaczeń netto: **93,078**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-17 03:14:31

> **Aktualizacja:** 2026-02-17 03:14:31 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #192 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: es | Plik: - | Heartbeat: 2026-02-17T03:14:27Z  
> **Okno godzinowe:** okno=1.0h | cykli=161 | pominięte=0.0% | odrzucone=41.5% | przepustowość=2065.9/h  
> **Tłumaczeń netto:** 93,078

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-17 03:14:31 |
| LIVE | 🟢 AKTYWNY | 6s temu | - | `activity.json / worker_state.json` | 2026-02-17T03:14:27Z |
| MIGRATION | 🔒 NIEAKTYWNY | 57s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-17 03:14:31 |
| TRANSLATION | 🟢 AKTYWNY | 8s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-17T03:14:24.159830Z |
| QUALITY | 🔒 NIEAKTYWNY | 6s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-17T03:14:26.950028Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-17 03:14:31 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-17T03:14:27Z
...
| ❤️ **Heartbeat** | 2026-02-17T03:14:27Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **3,837** kluczy |
| ❌ Odrzucone (guard) | 2726 |
| 🔁 Cykli | 161 |
| 🌍 Języków | 7 |
...
> **ETA globalne:** ~47 dni (2,354,854 kluczy do celu 95%)
...
> Świeżość: 57s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-17 03:14:31
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 8s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-17T03:14:24.159830Z
...
- You need to wait before using it again. → Musisz poczekać zanim użyjesz tego ponownie. (scripts.northern_fishburger.msg_1)
- %s
%s
Health: %s / %s → %s
%s
...
- You need to wait before using it again. → Musisz poczekać zanim użyjesz tego ponownie. (scripts.pot_of_blackjack.msg_1)
- The door seems to be sealed against unwanted intruders. → Drzwi wydają się być zabezpieczone przed niechcianymi intruzami. (scripts.quest_door.msg_1)
- Step inside the elevator to use it. → Aby skorzystać z windy, wejdź do środka. (scripts.rafzane_elevator.msg_1)
- You found {} while digging. → Podczas kopania znalazłeś {}. (scripts.register_actions.msg_10)
- This table is made of several old doors. One of them has a noticeable ornate loc → Ten stół jest zrobiony z kilku starych drzwi. Jedne z nich mają wyraźny, ozdobny (scripts.register_actions.msg_11)
- You already removed the old lock. → Już usunąłeś stary zamek. (scripts.register_actions.msg_12)
- This table is made of several old doors. One of them has a noticeable ornate loc → Ten stół jest zrobiony z kilku starych drzwi. Jedne z nich mają wyraźny, ozdobny (scripts.register_actions.msg_16)
- You already removed the old lock. → Już usunąłeś stary zamek. (scripts.register_actions.msg_17)
- You dug a hole! Walk onto it as long as it is open to jump down into the forest  → Wykopałeś dół! Wejdź na niego, póki jest otwarty, aby wskoczyć do leśnej jaskini (scripts.register_actions.msg_7)
- A torn scroll piece emerges. Probably gnawed off by rats. → Pojawia się rozdarty fragment zwoju. Prawdopodobnie ogryziony przez szczury. (scripts.register_actions.msg_9)
- You need to wait before using it again. → Musisz poczekać zanim użyjesz tego ponownie. (scripts.roasted_dragon_wings.msg_1)
- You don't have any business there anymore. → Nie masz już tam nic do roboty. (scripts.rook_village.msg_1)
- The flying carpet brought you back to Thais. → Latający dywan przeniósł cię z powrotem do Thais. (scripts.roshamuul_carpet.msg_1)
- You need to wait before using it again. → Musisz poczekać zanim użyjesz tego ponownie. (scripts.rotworm_stew.msg_1)
- You need level 999 to enter here. → Potrzebujesz poziomu 999, aby wejść tutaj. (scripts.schrodingers_island_teleport_lvl_999.msg_1)
- You enter the seacrest ground. → Wchodzisz na teren Seacrest. (scripts.seacrest.msg_1)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **2845**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2779**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **10.49%** (292,258/2,786,472)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-17T02:14:31.811160Z → 2026-02-17T03:14:31.811160Z) |
...
| Przepustowość (kluczy/h) | **2065.9 kluczy/h** |
| Podejrzane tłumaczenia | **14763** |
| Najgorsze cele (strażnik) | pl/items.json (gf=1039), pl/npc.json (gf=391), pl/scripts.json (gf=268), ro/monsters.json (gf=84), ru/monsters.json (gf=52) |
...
> Świeżość: 6s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-17T03:14:26.950028Z

- **Ostatni audyt:** OK | 7 issue(s) / 100 entries | 2026-02-17T03:14:26.950028Z
- **Top 5 typów problemów:** suspicious_rejected_critical=166, suspicious_log_high=120, suspicious_log_critical=75, suspicious_rejected_high=34, identical_to_en_exempt=12
- **Języki o najsłabszej jakości:** ro(60.0, issues=34327), es(60.1, issues=188329), ru(60.1, issues=26731), pl(62.3, issues=123822), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 62%, 123822 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 188329 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 69%, 9939 problemów
⚠️ **RU**: jakość 60%, 26731 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 76%, 8258 problemów
...
| Heartbeat | 6s temu | 2026-02-17T03:14:27Z |
...
- 2026-02-17 03:14:20 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | scripts.json
- 2026-02-17 03:14:20 | AUTO_TRANSLATE:parallel_start | pl | ok | scripts.json
- 2026-02-17 03:14:18 | AUTO_TRANSLATE:auto_done | es | ok | quests.json
- 2026-02-17 03:14:08 | AUTO_TRANSLATE:heartbeat_tick | es | ok | quests.json
- 2026-02-17 03:14:08 | AUTO_TRANSLATE:auto_start | es | ok | quests.json
- 2026-02-17 03:13:40 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 46.4% | 0 | 1,910 | 1,230 | 5106 (80.6%) | 37 |
| 🟡 ES | 74.7% | 0 | 2,630 | 851 | 512 (37.6%) | 35 |
...
| Przepustowość (okno) | 2,081 kluczy / 72 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-17 03:14:31
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **13,720** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 131 |
| ❌ Błędów | 223 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (2,813), **IT** (2,467), **RU** (2,329), **RO** (2,143), **PL** (2,004) |
| 📊 Porównanie | ↓ 32.4% vs wczoraj (20,288) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **113,914** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-17 03:14:31  
