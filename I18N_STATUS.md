...
> **Aktualizacja:** 2025-12-11 01:18:04 UTC  
...
| 🌐 Pozostałe (0/53) | 🔄 | 393230 | Aktualnie: NO |
...
│ Kategoria: 🌍 NO/spells.json                         │
├─────────────────────────────────────────────────────────────────┤
│ 📊 Ostatnia aktywność: NO/spells.json                                 │
│ [██████████████████████████████████████████████████] │
│ 28814/28550 kluczy (101%)                                          │
├─────────────────────────────────────────────────────────────────┤
│ ⏳ Total processed: 30710 operacji               │
│ 🌍 Języki zsync: 0/53                                │
│ 📅 Ostatnia aktualizacja: 2025-12-11 01:18:04                 │
└─────────────────────────────────────────────────────────────────┘
```
...
|---------|---------|-----------|
| 📁 Operacji wykonanych | **30710** | we wszystkich kategoriach |
...
- 🌍 `NO/spells.json` +28814 kluczy @ 01:18:03
...
|-----------|--------|--------------|-----------|--------|
| items | 13749 | 11689 | 4 | ⏭️ Skip 50m |
| monsters | 7341 | 9549 | 4 | ⏭️ Skip 50m |
| npc | 5334 | 0 | 0 | ✅ Active |
| html | 1495 | 3245 | 4 | ⏭️ Skip 55m |
| scripts | 385 | 0 | 4 | ⏭️ Skip 50m |
| raids | 147 | 351 | 4 | ⏭️ Skip 50m |
| startup | 23 | 23 | 4 | ⏭️ Skip 51m |
| libs | 21 | 53 | 4 | ⏭️ Skip 50m |
| modules | 16 | 16 | 4 | ⏭️ Skip 51m |
| spells | 15 | 0 | 0 | ✅ Active |
| messages | 11 | 0 | 0 | ✅ Active |
| chatchannels | 8 | 8 | 4 | ⏭️ Skip 51m |
| events | 5 | 5 | 4 | ⏭️ Skip 51m |
| actions | 0 | 0 | 0 | ⏳ Empty |
| client | 0 | 821 | 4 | ⏭️ Skip 55m |
| cpp | 0 | 0 | 0 | ⏳ Empty |
| errors | 0 | 0 | 0 | ⏳ Empty |
| npclib | 0 | 0 | 4 | ⏭️ Skip 51m |
| php | 0 | 4521 | 4 | ⏭️ Skip 52m |
| quests | 0 | 0 | 0 | ⏳ Empty |
| server | 0 | 0 | 0 | ⏳ Empty |
| ui | 0 | 0 | 0 | ⏳ Empty |
...
|-----------|----------------|-----------|-------|
| scripts | 50m | 4x | Progresywny backoff |
...
| libs | 50m | 4x | Progresywny backoff |
...
| html | 55m | 4x | Progresywny backoff |
| client | 55m | 4x | Progresywny backoff |
| sendtextmessage | 55m | 4x | Progresywny backoff |
| keywordhandler | 55m | 4x | Progresywny backoff |
| twig | 55m | 4x | Progresywny backoff |
...
📅 Auto-updated by Worker v1.1 | Last: 2025-12-11 01:18:04  
