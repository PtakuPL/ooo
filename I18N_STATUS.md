...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.04% / real 10.96%**. Tempo: **811.0 kluczy/h**. Tłumaczeń netto: **147,695**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 12:22:36

> **Aktualizacja:** 2026-04-29 12:22:36 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,380 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: de | Plik: otclient_modules.json | Heartbeat: 2026-04-29T12:20:27Z
> **Okno godzinowe:** okno=1.0h | cykli=80 | pominięte=0.0% | odrzucone=5.3% | przepustowość=811.0/h  
> **Tłumaczeń netto:** 147,695

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 12:22:36 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T12:20:27Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 36s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 12:22:36 |
| TRANSLATION | 🟢 AKTYWNY | 29s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T12:22:12.716893Z |
| QUALITY | 🔒 NIEAKTYWNY | 28s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T12:22:13.824576Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 12:22:36 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T12:22:42.576785Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T12:20:27Z
...
| ❤️ **Heartbeat** | 2026-04-29T12:20:27Z |
...
| ⏳ Oldest pending (visible tail) | 17299 s |
| 🌍 Top języki | RU(387) |
...
| 🌍 Recent provider mix | TM/simple(285), Free Google Translate(187), canonical_name_semantic_autofix(21), term_consistency_autofix(3) |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 387, 'oldest_s': 17299}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 36s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 12:22:36
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 29s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T12:22:12.716893Z
...
- dried grass roof → techo de pasto seco (item.1203.name)
- dried grass roof → techo de pasto seco (item.1204.name)
- frozen heart → corazón congelado (item.12041.name)
- frozen heart → corazón congelado (item.12042.name)
- draken doll → muñeca de draken (item.12043.name)
- draken doll → muñeca de draken (item.12044.name)
- music box → caja de music (item.12045.name)
- music box → caja de music (item.12046.name)
- dried grass roof → techo de pasto seco (item.1205.name)
- slime fungus → hongo de limo (item.12059.name)
...
- Raporty strażnika jakości: **4942**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4795**
...
| 🕒 Evidence window | 24h (span=41.51h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=41.51h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T11:22:36.894851Z → 2026-04-29T12:22:36.894851Z) |
...
| Najgorsze cele (strażnik) | cs/items.json (gf=24), ro/items.json (gf=12), it/items.json (gf=3), de/otclient_modules.json (gf=2), de/npc.json (gf=2) |
...
> Świeżość: 28s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T12:22:13.824576Z
...
| Heartbeat | 135s temu | 2026-04-29T12:20:27Z |
...
- 2026-04-29 12:20:57 | AUTO_TRANSLATE:heartbeat_tick | es | ok | items.json
- 2026-04-29 12:20:56 | AUTO_TRANSLATE:auto_start | es | ok | items.json
...
| Przepustowość (okno) | 571 kluczy / 26 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 12:22:36
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **10,344** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 196 |
| ❌ Błędów | 449 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,794), **RU** (1,689), **TR** (1,578), **IT** (1,531), **DE** (1,440) |
| 📊 Porównanie | ↑ 25.7% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **29,324** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 12:22:36  
