...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.04% / real 10.97%**. Tempo: **822.0 kluczy/h**. Tłumaczeń netto: **148,143**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 13:02:59

> **Aktualizacja:** 2026-04-29 13:02:59 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,435 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: it | Plik: items.json | Heartbeat: 2026-04-29T13:02:40Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=5.5% | przepustowość=822.0/h  
> **Tłumaczeń netto:** 148,143

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 13:02:59 |
| LIVE | 🟢 AKTYWNY | 25s temu | - | `activity.json / worker_state.json` | 2026-04-29T13:02:40Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 21s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 13:02:59 |
| TRANSLATION | 🟢 AKTYWNY | 39s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T13:02:26.282668Z |
| QUALITY | 🔒 NIEAKTYWNY | 38s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T13:02:27.428552Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 13:02:59 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T13:03:05.971549Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 25s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T13:02:40Z
...
| 🔄 **Ostatni cykl** | 39 kluczy, 4 odrzuconych, 118.1s, tryb: AUTO_TRANSLATE, cel: ro/items.json |
...
| ⏳ Oldest pending (visible tail) | 17026 s |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 395, 'oldest_s': 17026}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~151 dni (2,982,739 kluczy do celu 95%)
...
> Świeżość: 21s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 13:02:59
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 39s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T13:02:26.282668Z
...
- This lamp is glowing very dimly. → Această lampăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă luminează fo (item.13656.desc)
- This lamp is glowing very dimly. → Această lampăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă luminează fo (item.13658.desc)
- This is an emblem of wisdom. It was awarded by TibiaStat.com → Aceasta este o emblemăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă a î (item.14760.desc)
- lamp → lampă (item.10507.name)
- ramp → rampă (item.11365.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4956**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4809**
...
- **Profiler cyklu (ostatni):** cykl #210 (AUTO_TRANSLATE): dispatch 10819ms, mode 91728ms, status 12981ms, total 118064ms
...
| 🕒 Evidence window | 24h (span=42.18h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=42.18h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T12:02:59.694065Z → 2026-04-29T13:02:59.694065Z) |
...
| Podejrzane tłumaczenia | **1191** |
| Najgorsze cele (strażnik) | cs/items.json (gf=26), ro/items.json (gf=12), de/npc.json (gf=3), ru/items.json (gf=3), it/items.json (gf=2) |
...
> Świeżość: 38s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T13:02:27.428552Z
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,435 |
| Heartbeat | 25s temu | 2026-04-29T13:02:40Z |
...
- 2026-04-29 13:01:08 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-04-29 13:01:08 | AUTO_TRANSLATE:auto_start | ro | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 13:02:59
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **10,844** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 210 |
| ❌ Błędów | 474 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,894), **RU** (1,749), **TR** (1,670), **IT** (1,573), **DE** (1,530) |
| 📊 Porównanie | ↑ 31.8% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **29,824** kluczy
...
| 🔄 Cykli wykonanych | **#18,435** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,435 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 13:02:59  
