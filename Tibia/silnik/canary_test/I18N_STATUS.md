...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.89%**. Tempo: **1478.9 kluczy/h**. Tłumaczeń netto: **125,130**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 22:05:39

> **Aktualizacja:** 2026-02-20 22:05:39 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #8 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: - | Heartbeat: 2026-02-20T22:05:33Z  
> **Okno godzinowe:** okno=1.0h | cykli=185 | pominięte=0.0% | odrzucone=74.3% | przepustowość=1478.9/h  
> **Tłumaczeń netto:** 125,130

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 22:05:39 |
| LIVE | 🟢 AKTYWNY | 8s temu | - | `activity.json / worker_state.json` | 2026-02-20T22:05:33Z |
| MIGRATION | 🔒 NIEAKTYWNY | 8s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 22:05:39 |
| TRANSLATION | 🟢 AKTYWNY | 52s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T22:04:49.148320Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T22:05:41.014331Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 22:05:39 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 8s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T22:05:33Z
...
| ❤️ **Heartbeat** | 2026-02-20T22:05:33Z |
...
> **ETA globalne:** ~64 dni (2,259,936 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~1479 kluczy/h.
...
> Świeżość: 8s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 22:05:39
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 52s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T22:04:49.148320Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T21:05:39.841498Z → 2026-02-20T22:05:39.841498Z) |
...
| Przepustowość (kluczy/h) | **1478.9 kluczy/h** |
| Podejrzane tłumaczenia | **3577** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T22:05:41.014331Z

- **Ostatni audyt:** SLOW_MODE | 33 issue(s) / 100 entries | 2026-02-20T22:05:32.903542Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_log_critical=93, suspicious_rejected_critical=87, suspicious_log_high=38, artifact_token=33, identical_to_en_exempt=14
- **Języki o najsłabszej jakości:** es(60.1, issues=350099), pl(60.1, issues=194045), ro(60.1, issues=189631), sr(64.1, issues=87233), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 60%, 194045 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 350099 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 92%, 76962 problemów
⚠️ **RU**: jakość 85%, 214756 problemów
...
| Heartbeat | 8s temu | 2026-02-20T22:05:33Z |
...
- 2026-02-20 22:04:59 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 22:04:39 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | npc.json
- 2026-02-20 22:04:39 | AUTO_TRANSLATE:parallel_start | ro | ok | npc.json
- 2026-02-20 22:04:32 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | npc.json
- 2026-02-20 22:04:32 | AUTO_TRANSLATE:parallel_start | ru | ok | npc.json
- 2026-02-20 22:04:30 | AUTO_TRANSLATE:auto_done | it | ok | npc.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,830 | 646 | 6772 (91.3%) | 35 |
| 🟡 ES | 84.9% | 0 | 2,160 | 657 | 3129 (82.6%) | 40 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **125,130** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=90.91%, reason=decrease_high_fail_rate=90.9% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,303 kluczy / 75 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 22:05:39
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+23) — repair_identical lang=es file=npc.json target_identical=51 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=306.34
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **18,701** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 224 |
| ❌ Błędów | 454 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (5,566), **RU** (3,639), **IT** (2,957), **PL** (2,252), **RO** (2,207) |
| 📊 Porównanie | ↑ 413.6% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **116,286** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 22:05:39  
