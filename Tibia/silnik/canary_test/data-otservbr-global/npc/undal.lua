...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "talk") then
		NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.undal.say_1")
		npcHandler:setTopic(playerId, 2)
	elseif MsgContains(message, "story") then
		if npcHandler:getTopic(playerId) == 2 then
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.undal.say_2")
			npcHandler:setTopic(playerId, 3)
		end
	elseif MsgContains(message, "short") and npcHandler:getTopic(playerId) == 3 then
		NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.undal.multi_8")
		NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.undal.multi_9")
		NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.undal.multi_10")
		NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.undal.multi_11")
	...
	elseif npcHandler:getTopic(playerId) == 4 or npcHandler:getTopic(playerId) == 2 then
		if MsgContains(message, "task") then
			if player:getStorageValue(Storage.Quest.U12_00.TheDreamCourts.WardStones.Questline) >= 3 and player:getStorageValue(Storage.Quest.U12_00.TheDreamCourts.Main.TheWinterCourt) == 1 and not (player:hasOutfit(1146) or player:hasOutfit(1147)) then
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.undal.say_3")
				for i = 1146, 1147 do
					player:addOutfit(i)
				end
			...
			elseif player:getStorageValue(Storage.Quest.U12_00.TheDreamCourts.WardStones.Count) >= 8 and player:getStorageValue(Storage.Quest.U12_00.TheDreamCourts.Main.TheWinterCourt) == 1 and player:getStorageValue(Storage.Quest.U12_00.TheDreamCourts.WardStones.Questline) == 1 then
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.undal.multi_6")
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.undal.multi_7")
			...
			elseif player:getStorageValue(Storage.Quest.U12_00.TheDreamCourts.WardStones.Questline) < 1 and player:getStorageValue(Storage.Quest.U12_00.TheDreamCourts.Main.TheSummerCourt) < 1 and player:getStorageValue(Storage.Quest.U12_00.TheDreamCourts.Main.TheWinterCourt) < 1 then
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.undal.multi_1")
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.undal.multi_2")
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.undal.multi_3")
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.undal.multi_4")
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.undal.multi_5")
				...
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.undal.say_4")
				npcHandler:setTopic(playerId, 0)
			end
		end
	elseif MsgContains(message, "keys") and npcHandler:getTopic(playerId) == 5 then
		NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.undal.say_5")
	elseif MsgContains(message, "addon") then
		if player:hasOutfit(1146) or player:hasOutfit(1147) then
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.undal.say_6")
			npcHandler:setTopic(playerId, 6)
		else
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.undal.say_7")
		end
	elseif MsgContains(message, "yes") then
		if npcHandler:getTopic(playerId) == 6 then
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.undal.say_8")
			npcHandler:setTopic(playerId, 7)
		elseif npcHandler:getTopic(playerId) == 7 then
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.undal.say_9")
			npcHandler:setTopic(playerId, 8)
		end
	elseif npcHandler:getTopic(playerId) == 8 then
		if MsgContains(message, "pomegranates") then
			if player:getItemCount(30169) >= 5 then
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.undal.say_10")
				...
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.undal.say_11")
				npcHandler:setTopic(playerId, 0)
			end
		elseif MsgContains(message, "ice shield") then
			if player:getItemCount(30168) >= 1 then
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.undal.say_12")
				...
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.undal.say_13")
				npcHandler:setTopic(playerId, 0)
			end
		end
	else
		NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.undal.say_14")
	end
end

NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_GREET, "npc.undal.greet_msg_1")
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_FAREWELL, "npc.undal.farewell_msg_1")
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_WALKAWAY, "npc.undal.walkaway_msg_1")
