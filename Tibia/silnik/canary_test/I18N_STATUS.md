...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.62%**. Tempo: **1959.4 kluczy/h**. Tłumaczeń netto: **98,386**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-17 05:23:20

> **Aktualizacja:** 2026-02-17 05:23:20 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #276 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ro | Plik: scripts.json | Heartbeat: 2026-02-17T05:23:22Z  
> **Okno godzinowe:** okno=1.0h | cykli=160 | pominięte=0.0% | odrzucone=50.2% | przepustowość=1959.4/h  
> **Tłumaczeń netto:** 98,386

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-17 05:23:20 |
| LIVE | 🟢 AKTYWNY | 0s temu | - | `activity.json / worker_state.json` | 2026-02-17T05:23:22Z |
| MIGRATION | 🔒 NIEAKTYWNY | 55s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-17 05:23:20 |
| TRANSLATION | 🟢 AKTYWNY | 2s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-17T05:23:20.264476Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-17T05:22:06.282613Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-17 05:23:20 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-17T05:23:22Z
...
| ❤️ **Heartbeat** | 2026-02-17T05:23:22Z |
...
| ❌ Odrzucone (guard) | 3519 |
| 🔁 Cykli | 160 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | IT (694 kluczy) |
...
> **ETA globalne:** ~50 dni (2,351,175 kluczy do celu 95%)
...
> Świeżość: 55s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-17 05:23:20
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-17T05:23:20.264476Z
...
- Access granted! → Доступ предоставлен! (scripts.actions_totems.say_1)
- Hail %s! → Привет, %s! (scripts.dolls.12043_3)
- You pass the fire without taking any damage. It's now or never... → Вы минуете огонь, не получив никакого урона. Сейчас или никогда... (scripts.movements_cobra_mini_bosses.msg_1)
- Access granted! → Доступ предоставлен! (scripts.movements_color_puzzle.say_1)
- You took too long, the battle has ended. → Вы потратили слишком много времени, битва окончена. (scripts.movements_elemental_portals.msg_1)
- You have discovered an old writing desk that contains an ancient map. → Вы обнаружили старый письменный стол, на котором лежит древняя карта. (scripts.movements_elemental_portals.msg_3)
- Your escort has end. → Ваше сопровождение закончилось. (scripts.movements_gnomes_ordnance_end.msg_1)
- Your escort has end. → Ваше сопровождение закончилось. (scripts.movements_gnomes_ordnance_end.msg_2)
- Your escort has end. → Ваше сопровождение закончилось. (scripts.movements_lost_exiles.msg_1)
- The remains deporalize you temporaly. → Останки временно депорализуют вас. (scripts.movements_mazzinor.msg_1)
- With the power of the dark Custodian still holding away, the fog is keeping you  → Поскольку сила темного Хранителя все еще сдерживается, туман не дает вам войти в (scripts.movements_quaidden.msg_1)
- You have completed the food offering ritual! → Вы завершили ритуал подношения еды! (scripts.movements_sacrifice_foods.msg_1)
- You must wait. Someone is challenging Furious Scorpion now. → Вы должны подождать. Кто-то сейчас бросает вызов Яростному Скорпиону. (scripts.movements_teleportto.msg_1)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-17T04:23:21.097490Z → 2026-02-17T05:23:21.097490Z) |
...
| Przepustowość (kluczy/h) | **1959.4 kluczy/h** |
| Podejrzane tłumaczenia | **14102** |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-17T05:22:06.282613Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=203789), ro(60.1, issues=43940), ru(60.3, issues=33492), it(60.3, issues=12870), pl(62.5, issues=128076)
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #276 |
| Heartbeat | 0s temu | 2026-02-17T05:23:22Z |
...
- 2026-02-17 05:23:22 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | scripts.json
- 2026-02-17 05:23:22 | AUTO_TRANSLATE:parallel_start | ro | ok | scripts.json
- 2026-02-17 05:23:17 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | scripts.json
- 2026-02-17 05:23:17 | AUTO_TRANSLATE:parallel_start | ru | ok | scripts.json
- 2026-02-17 05:23:16 | AUTO_TRANSLATE:auto_done | it | ok | scripts.json
- 2026-02-17 05:22:26 | AUTO_TRANSLATE:heartbeat_tick | it | ok | scripts.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **98,386** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=46.72%, reason=decrease_high_fail_rate=46.7% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-17 05:23:20
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [de] → ok (files+1, translated+0, skipped+21) — lang=de file=actions.json
- 🌍 TRANSLATION_SYNC: SYNC_FILE_DONE [kk] → ok (keys+3, files+1) — lang=kk file=dataroot.json
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **22,045** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 215 |
| ❌ Błędów | 370 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (4,519), **IT** (4,010), **RU** (3,844), **RO** (3,526), **PL** (3,136) |
| 📊 Porównanie | ↑ 8.7% vs wczoraj (20,288) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **122,239** kluczy
...
| 🔄 Cykli wykonanych | **#276** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-17 05:23:20  
