...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.95% / real 10.87%**. Tempo: **864.0 kluczy/h**. Tłumaczeń netto: **141,335**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 03:49:56

> **Aktualizacja:** 2026-04-29 03:49:56 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,652 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: auto_done | Kategoria: de | Plik: npc.json | Heartbeat: 2026-04-29T03:49:02Z
> **Okno godzinowe:** okno=1.0h | cykli=80 | pominięte=0.0% | odrzucone=3.8% | przepustowość=864.0/h  
> **Tłumaczeń netto:** 141,335

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 03:49:56 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T03:49:02Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 42s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 03:49:56 |
| TRANSLATION | 🟢 AKTYWNY | 18s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T03:49:44.154708Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T03:49:02.073251Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 03:49:56 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T03:50:02.237411Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T03:49:02Z
...
| ❤️ **Heartbeat** | 2026-04-29T03:49:02Z |
...
|----------|------|---------|------|-------|--------|------------|--------|
| 03:49:38 | DE | Serwer | npc.json | 30 | `tm` | `npc.a_dead_bureaucrat1.say_1` | Klar, wo sonst. Jeder trifft gerne meinen Meister, er ist ein großer Dämon, nicht wah... |
| 03:48:55 | DE | Klient | otclient_modules.json | 15 | `tm` | `otclient_modules.blessing.tr_11` | - Abhängig von den Regeln des fairen Kampfes verlierst du zwischendurch |
| 03:48:03 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 03:44:44 | ES | Serwer | items.json | 22 | `simple` | `item.11419.name` | artículo desconocido |
| 03:43:12 | RO | Serwer | items.json | 39 | `google_translate` | `item.10216.name` | kit statuie dragon |
| 03:41:20 | ES | Serwer | server.json | 2 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 03:39:16 | IT | Serwer | items.json | 143 | `google_translate` | `item.12886.name` | struttura dell'alveare |
| 03:36:59 | CS | Serwer | items.json | 41 | `simple` | `item.13232.name` | patro úlu |
| 03:35:20 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 03:32:06 | RU | Serwer | items.json | 30 | `simple` | `item.13057.name` | структура улья |
| 03:30:32 | TR | Serwer | items.json | 59 | `google_translate` | `item.11931.name` | kumlu kiremit |
| 03:29:18 | ES | Serwer | server.json | 2 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 03:27:16 | DE | Serwer | npc.json | 30 | `tm` | `npc.a_dead_bureaucrat1.say_1` | Klar, wo sonst. Jeder trifft gerne meinen Meister, er ist ein großer Dämon, nicht wah... |
| 03:26:32 | DE | Klient | otclient_modules.json | 15 | `tm` | `otclient_modules.blessing.tr_11` | - Abhängig von den Regeln des fairen Kampfes verlierst du zwischendurch |
| 03:25:40 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 03:22:31 | ES | Serwer | items.json | 18 | `simple` | `item.11408.name` | artículo desconocido |
| 03:20:54 | RO | Serwer | items.json | 39 | `google_translate` | `item.10216.name` | kit statuie dragon |
| 03:19:16 | ES | Serwer | server.json | 2 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 03:16:50 | IT | Serwer | items.json | 102 | `google_translate` | `item.12608.name` | spazzatura |
| 03:14:33 | CS | Serwer | items.json | 41 | `simple` | `item.13198.name` | struktura úlu |
...
|----------|------|---------|-----------|-------|----------|--------------|-----|
| 03:49:34 | DE | Serwer | npc.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `npc.a_fluffy_squirrel.stdmod_1` |
| 03:48:51 | DE | Klient | otclient_modules.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `otclient_modules.charms.tr_34` |
| 03:46:53 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.say_1` |
| 03:46:51 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.multi_1` |
| 03:42:24 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10193.name` |
| 03:42:22 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10192.name` |
| 03:42:21 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10191.name` |
| 03:42:19 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10190.name` |
| 03:38:18 | IT | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 03:36:31 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.11586.name` |
| 03:36:29 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 03:36:27 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10456.name` |
| 03:36:26 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10338.name` |
| 03:36:24 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10026.name` |
| 03:34:14 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.say_2` |
| 03:31:38 | RU | Serwer | items.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `item.11541.name` |
| 03:27:10 | DE | Serwer | npc.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `npc.a_fluffy_squirrel.stdmod_1` |
| 03:26:29 | DE | Klient | otclient_modules.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `otclient_modules.charms.tr_34` |
| 03:24:38 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.say_1` |
| 03:24:36 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.multi_1` |
...
| ⏳ Oldest pending (visible tail) | 18074 s |
| 🌍 Top języki | RU(399) |
| 🧱 Top reason_bucket | quality(399) |
| 🗂️ Deferred state keys | 7696 |
...
| 🧮 OpenAI budget | `201/250 stale:2026-04-28 5 h` |
| ♻️ Provider debt | `1246` |
| 🌍 Recent provider mix | TM/simple(271), Free Google Translate(205), canonical_name_semantic_autofix(21), canonical_name_case_autofi... |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=611/611 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 399, 'oldest_s': 18074}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| �📊 Przetłumaczono | **864** kluczy |
| ❌ Odrzucone (guard) | 34 |
| 🔁 Cykli | 80 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | IT (303 kluczy) |
| 📄 Najczęstszy plik | items.json |
| ⚡ Przepustowość | ~864 kluczy/h |
| 🛡️ Odrzucone (strażnik) | 3.8% |
| ⚠️ Podejrzane | 1099 |
...
> **ETA globalne:** ~144 dni (2,986,302 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 78.9% | 58,794/74,536 | ~14h |
| PL | ██████████████░░░░░░ | 71.0% | 52,911/74,536 | ~21h |
| IT | █████████████░░░░░░░ | 69.9% | 52,099/74,536 | ~22h |
| RO | █████████████░░░░░░░ | 69.7% | 51,972/74,536 | ~22h |
| RU | █████████░░░░░░░░░░░ | 45.8% | 34,101/74,536 | ~42h |
| FR | ███████████░░░░░░░░░ | 57.5% | 42,864/74,536 | ~32h |
| PT | ████████████████░░░░ | 81.2% | 60,516/74,536 | ~12h |
| SR | ██████░░░░░░░░░░░░░░ | 33.3% | 24,827/74,536 | ~2d |
| CS | █████████░░░░░░░░░░░ | 49.8% | 37,147/74,536 | ~39h |
| NL | ███████████████░░░░░ | 77.6% | 57,814/74,536 | ~15h |
| TR | ██████░░░░░░░░░░░░░░ | 33.6% | 25,071/74,536 | ~2d |
...
> Tempo obliczone na bazie ostatniej godziny: ~864 kluczy/h.
...
> Świeżość: 42s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 03:49:56
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 18s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T03:49:44.154708Z
...
|-------|-----------|--------|----------|--------------|--------------|
| ES (Hiszpański) | 78.88% (58,794/74,536) | 67.70% (50,464/74,536) | 9,719 | 14,377 | 0 |
| PL (Polski) | 70.99% (52,911/74,536) | 65.08% (48,507/74,536) | 5,861 | 20,194 | 0 |
| IT (Włoski) | 69.90% (52,099/74,536) | 61.68% (45,975/74,536) | 10,028 | 18,558 | 0 |
| RO (Rumuński) | 69.73% (51,972/74,536) | 56.69% (42,253/74,536) | 13,005 | 19,303 | 0 |
| RU (Rosyjski) | 45.75% (34,101/74,536) | 44.18% (32,931/74,536) | 4,775 | 36,848 | 0 |
...
| CS (Czeski) | 49.84% (37,147/74,536) | 32.00% (23,855/74,536) | 29,904 | 20,803 | 0 |
| NL (Niderlandzki) | 77.57% (57,814/74,536) | 31.96% (23,823/74,536) | 49,478 | 1,260 | 0 |
| TR (Turecki) | 33.64% (25,071/74,536) | 30.15% (22,474/74,536) | 3,832 | 48,244 | 0 |
...
- Raporty strażnika jakości: **4761**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4614**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T03:49:19.206494Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.95%** (695,766/3,875,872)
- **Pokrycie globalne (real):** **10.87%** (421,290/3,875,872)
- **Kopie EN (łącznie):** **410,563**
- **Placeholdery [EN]/puste (łącznie):** **2,189,897**
...
|-------|--------|--------------------------|----------|----------------------------|
| ES | 55,634/70,637 | 78.8% / 67.1% | 3,160/3,899 | 81.0% / 79.2% |
| PL | 49,763/70,637 | 70.5% / 64.3% | 3,148/3,899 | 80.7% / 78.4% |
| IT | 49,126/70,637 | 69.5% / 61.0% | 2,973/3,899 | 76.2% / 73.1% |
| RO | 49,186/70,637 | 69.6% / 56.0% | 2,786/3,899 | 71.5% / 69.6% |
| RU | 30,957/70,637 | 43.8% / 42.2% | 3,144/3,899 | 80.6% / 79.3% |
...
| CS | 35,457/70,637 | 50.2% / 31.6% | 1,690/3,899 | 43.3% / 39.0% |
| NL | 55,803/70,637 | 79.0% / 31.1% | 2,011/3,899 | 51.6% / 47.2% |
| TR | 23,112/70,637 | 32.7% / 29.1% | 1,959/3,899 | 50.2% / 48.7% |
...
| #3 | 🔴 Server | 10.94% | +0.19 pp | 51 | ZH 0.2%, TL 0.8%, BS 0.9% |
...
| 🕒 Evidence window | 24h (span=32.96h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=32.96h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T02:49:56.637521Z → 2026-04-29T03:49:56.637521Z) |
| Cykle | **80** (TŁUMACZENIE=80, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **3.8%** |
| Cykle bez postępu % | **0.0%** |
| Przepustowość (kluczy/h) | **864.0 kluczy/h** |
| Podejrzane tłumaczenia | **1099** |
| Najgorsze cele (strażnik) | cs/items.json (gf=15), ro/items.json (gf=8), it/items.json (gf=3), de/otclient_modules.json (gf=3), de/npc.json (gf=3) |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 47 | 73.4% | ru/items.json (47) |
| `existing_canonical_name_quality_mixed_scripts` | 17 | 26.6% | ru/items.json (17) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T03:49:02.073251Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T03:49:02.073251Z
- **Top 5 typów problemów:** suspicious_rejected_critical=187, suspicious_log_low=115, suspicious_log_high=53, suspicious_log_medium=31, suspicious_rejected_high=13
- **Języki o najsłabszej jakości:** es(60.1, issues=731787), ro(60.1, issues=430802), de(60.1, issues=113703), cs(60.1, issues=91514), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 60%, 54142 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 731787 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 62%, 171861 problemów
⚠️ **RU**: jakość 69%, 362297 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,652 |
| Heartbeat | 60s temu | 2026-04-29T03:49:02Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T03:50:00.173772Z
...
│ Plik: npc.json                                                │
│ Postęp: 30/30 keys                                            │
│ …=30 guard_fail=1 strict_missing_key=0 strict_skipped_done=79 │
├─────────────────────────────────────────────────────────────────┤
│ ❤️ Heartbeat: 2026-04-29T03:49:02Z           │
└─────────────────────────────────────────────────────────────────┘
```
...
- 2026-04-29 03:49:44 | AUTO_TRANSLATE:auto_done | de | ok | npc.json
- 2026-04-29 03:49:20 | AUTO_TRANSLATE:heartbeat_tick | de | ok | npc.json
- 2026-04-29 03:49:19 | AUTO_TRANSLATE:auto_start | de | ok | npc.json
- 2026-04-29 03:49:01 | AUTO_TRANSLATE:auto_done | de | ok | otclient_modules.json
- 2026-04-29 03:48:38 | AUTO_TRANSLATE:heartbeat_tick | de | ok | otclient_modules.json
- 2026-04-29 03:48:37 | AUTO_TRANSLATE:auto_start | de | ok | otclient_modules.json
...
| 🟡 ES | 78.9% | 0 | 9,719 | 574 | 0 (0.0%) | 25 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **141,335** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=3.29%, reason=increase_low_fail_rate=3.3%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 574 kluczy / 25 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 03:49:56
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **3,385** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 72 |
| ❌ Błędów | 133 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **RU** (664), **CS** (610), **IT** (591), **DE** (450), **TR** (374) |
| 📊 Porównanie | ↓ 58.9% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **22,365** kluczy
...
| 🔄 Cykli wykonanych | **#17,652** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,652 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 03:49:56  
