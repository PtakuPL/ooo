...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.9%**. Tempo: **1452.0 kluczy/h**. Tłumaczeń netto: **125,945**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 22:26:16

> **Aktualizacja:** 2026-02-20 22:26:16 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #6 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ru | Plik: - | Heartbeat: 2026-02-20T22:26:12Z  
> **Okno godzinowe:** okno=1.0h | cykli=166 | pominięte=0.0% | odrzucone=74.9% | przepustowość=1452.0/h  
> **Tłumaczeń netto:** 125,945

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 22:26:16 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T22:26:12Z |
| MIGRATION | 🔒 NIEAKTYWNY | 49s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 22:26:16 |
| TRANSLATION | 🟢 AKTYWNY | 37s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T22:25:40.320772Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T22:26:17.400521Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 22:26:16 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T22:26:12Z
...
| ❤️ **Heartbeat** | 2026-02-20T22:26:12Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **2,508** kluczy |
| ❌ Odrzucone (guard) | 7465 |
| 🔁 Cykli | 166 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (625 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~1452 kluczy/h |
| 🛡️ Guard fail rate | 74.9% |
| ⚠️ Podejrzane | 25301 |
| 🌐 GT aktywny (1h) | ✅ TAK |
| 🔤 GT tłumaczeń (1h) | 34 |
...
| 📌 Hotspoty GF (dispatch) | pl:spells.json [S] gf=145, 96.7%, +10c | es:spells.json [S] gf=139, 92.7%, +10c | ro:monsters.json [S] gf=130, 86.7%, +10c |
...
| SR | 24,370 | 53,586 | 45.48% | 1,077 |
| RO | 23,400 | 53,586 | 43.67% | 2,343 |
| FR | 17,731 | 53,586 | 33.09% | 3,788 |
| SV | 15,659 | 53,586 | 29.22% | 2,133 |
...
> **ETA globalne:** ~65 dni (2,259,686 kluczy do celu 95%)
...
| SR | █████████░░░░░░░░░░░ | 45.5% | 24,370/53,586 | ~18h |
| RO | ████████░░░░░░░░░░░░ | 43.7% | 23,400/53,586 | ~19h |
| FR | ██████░░░░░░░░░░░░░░ | 33.1% | 17,731/53,586 | ~23h |
| SV | █████░░░░░░░░░░░░░░░ | 29.2% | 15,659/53,586 | ~24h |
...
> Tempo obliczone na bazie ostatniej godziny: ~1452 kluczy/h.
...
> Świeżość: 49s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 22:26:16
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 37s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T22:25:40.320772Z
...
- Raporty strażnika jakości: **7257**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4363**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **13.9%** (387,426/2,786,472)
- **Kopie EN (łącznie):** **162,194**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T21:26:16.622687Z → 2026-02-20T22:26:16.622687Z) |
| Cykle | **166** (TŁUMACZENIE=166, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **74.9%** |
| Cykle bez postępu % | **0.9%** |
| Przepustowość (kluczy/h) | **1452.0 kluczy/h** |
| Podejrzane tłumaczenia | **3160** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T22:26:17.400521Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=350877), pl(60.1, issues=194333), ro(60.3, issues=190054), tl(64.2, issues=466), sr(64.5, issues=87233)
...
| Heartbeat | 5s temu | 2026-02-20T22:26:12Z |
...
- 2026-02-20 22:25:48 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 22:25:34 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-02-20 22:25:34 | AUTO_TRANSLATE:parallel_start | it | ok | items.json
- 2026-02-20 22:25:25 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | npc.json
- 2026-02-20 22:25:25 | AUTO_TRANSLATE:parallel_start | ro | ok | npc.json
- 2026-02-20 22:25:23 | AUTO_TRANSLATE:auto_done | ru | ok | npc.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,830 | 570 | 5460 (90.5%) | 31 |
| 🟡 ES | 85.0% | 0 | 2,151 | 648 | 2549 (79.7%) | 37 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **125,945** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=21.77%, reason=decrease_high_fail_rate=21.8% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,218 kluczy / 68 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 22:26:16

- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+23) — repair_identical lang=es file=npc.json target_identical=43 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=273.10
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → warn (files+1, translated+30, skipped+0) — lang=ru file=npc.json strict_skipped_done=334 guard_fail=34 placeholder=2 command=0 pipe=32
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [pl] → ok (translated+11, skipped+0) — parallel lang=pl file=questlog.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [sr] → ok (translated+30, skipped+0) — parallel lang=sr file=server.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [sv] → warn (files+1, translated+3, skipped+0) — lang=sv file=server.json strict_skipped_done=1132 guard_fail=27 placeholder=5 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **19,915** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 224 |
| ❌ Błędów | 475 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (5,920), **RU** (3,909), **IT** (3,200), **RO** (2,373), **PL** (2,313) |
| 📊 Porównanie | ↑ 447.0% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **117,500** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 22:26:16  
