...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-29 05:45:35

> **Aktualizacja:** 2026-03-29 05:45:35 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #11,306 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: it | Plik: items.json | Heartbeat: 2026-03-29T05:45:36Z  
...
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-29 05:45:35 |
| LIVE | 🟢 AKTYWNY | 1s temu | - | `activity.json / worker_state.json` | 2026-03-29T05:45:36Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 52s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-29 05:45:35 |
| TRANSLATION | 🟢 AKTYWNY | 12min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-29T05:33:12.626691Z |
| QUALITY | 🔒 NIEAKTYWNY | 12min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-29T05:33:13.386797Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-29 05:45:35 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-29T05:45:36Z
...
| ❤️ **Heartbeat** | 2026-03-29T05:45:36Z |
...
> Świeżość: 52s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-29 05:45:35
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 12min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-29T05:33:12.626691Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-29T04:45:36.222516Z → 2026-03-29T05:45:36.222516Z) |
...
|--------|-----------|--------|----------------|
| `gt_rejected_critical` | 195 | 32.8% | pl/monsters.json (52) |
| `gt_validate_fail_word_salad` | 109 | 18.4% | es/npc.json (29) |
| `gt_validate_fail_placeholder` | 101 | 17.0% | ru/html.json (19) |
| `gt_validate_fail_wrong_script` | 80 | 13.5% | ru/html.json (79) |
| `gt_rejected_high_partial_translation_mix` | 47 | 7.9% | pl/monsters.json (11) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 12min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-29T05:33:13.386797Z
...
| Heartbeat | 1s temu | 2026-03-29T05:45:36Z |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-29 05:45:35
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-29 05:45:35  
