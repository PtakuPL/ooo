...
local function addTravelKeyword(keyword, text, cost, destination, condition, action)
	...
	local travelKeyword = keywordHandler:addKeyword({ keyword }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.gewen.stdmod_3", i18nArgs = { text }, cost = cost, discount = "postman" })
