...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.02% / real 10.94%**. Tempo: **736.0 kluczy/h**. Tłumaczeń netto: **145,888**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 09:46:56

> **Aktualizacja:** 2026-04-29 09:46:56 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,164 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: tr | Plik: items.json | Heartbeat: 2026-04-29T09:46:19Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=5.0% | przepustowość=736.0/h  
> **Tłumaczeń netto:** 145,888

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 09:46:56 |
| LIVE | 🟢 AKTYWNY | 45s temu | - | `activity.json / worker_state.json` | 2026-04-29T09:46:19Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 30s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 09:46:56 |
| TRANSLATION | 🟢 AKTYWNY | 46s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T09:46:18.076258Z |
| QUALITY | 🔒 NIEAKTYWNY | 45s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T09:46:19.164319Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 09:46:56 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T09:47:04.610863Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 45s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T09:46:19Z
...
| ❤️ **Heartbeat** | 2026-04-29T09:46:19Z |
...
| 09:31:06 | CS | Serwer | items.json | 41 | `simple` | `item.14452.name` | REZERVOVANÝ SPRITE |
| 09:29:26 | RU | Serwer | items.json | 32 | `transliteration_cyrillic` | `item.14265.name` | РЕСЕРВЕД СПРИТЕ |
| 09:25:47 | ES | Serwer | server.json | 1 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 09:23:49 | TR | Serwer | items.json | 39 | `simple` | `item.13093.name` | nemli duvar |
| 09:22:47 | DE | Serwer | npc.json | 30 | `tm` | `npc.a_dead_bureaucrat1.say_1` | Klar, wo sonst. Jeder trifft gerne meinen Meister, er ist ein großer Dämon, nicht wah... |
| 09:21:49 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 09:18:44 | DE | Klient | otclient_modules.json | 15 | `tm` | `otclient_modules.blessing.tr_11` | - Abhängig von den Regeln des fairen Kampfes verlierst du zwischendurch |
| 09:17:58 | ES | Serwer | items.json | 19 | `simple` | `item.11851.name` | arena mágica |
...
| 09:44:23 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.say_1` |
| 09:44:20 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.multi_1` |
| 09:42:16 | DE | Klient | otclient_modules.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `otclient_modules.charms.tr_34` |
| 09:37:15 | IT | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 09:35:23 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10193.name` |
| 09:35:21 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10192.name` |
| 09:35:19 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10191.name` |
| 09:35:17 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10190.name` |
| 09:33:12 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.say_2` |
| 09:30:41 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.14250.name` |
| 09:30:40 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.14077.name` |
| 09:30:38 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.14023.name` |
| 09:30:36 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.11586.name` |
| 09:30:34 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 09:30:32 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10456.name` |
| 09:30:29 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10338.name` |
| 09:30:27 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10026.name` |
| 09:29:03 | RU | Serwer | items.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `item.11541.name` |
| 09:22:42 | DE | Serwer | npc.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `npc.a_fluffy_squirrel.stdmod_1` |
...
| ⏳ Oldest pending (visible tail) | 15987 s |
| 🌍 Top języki | RU(383), CS(3) |
| 🧱 Top reason_bucket | quality(383), default(3) |
| 🗂️ Deferred state keys | 8208 |
...
| 🌍 Recent provider mix | TM/simple(319), Free Google Translate(162), canonical_name_semantic_autofix(19), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=503, fallbacks=19) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=889/889 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
|-------|--------|----------|-------|-----------|--------|
| `HEARTBEAT_STALE` | OK | OK | `15` | `300` | Heartbeat świeży (15s, src=worker_runtime_heartbeat) Runtime[status=healthy, reason=heartbeat_fresh, phase=... |
| `NO_WRITE` | OK | OK | `50` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 386, 'oldest_s': 15987}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 30s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 09:46:56
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 46s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T09:46:18.076258Z
...
|-------|-----------|--------|----------|--------------|--------------|
| ES (Hiszpański) | 79.07% (58,939/74,536) | 67.99% (50,675/74,536) | 9,653 | 14,232 | 0 |
| PL (Polski) | 70.99% (52,911/74,536) | 65.08% (48,507/74,536) | 5,861 | 20,194 | 0 |
| IT (Włoski) | 70.79% (52,764/74,536) | 62.57% (46,638/74,536) | 10,030 | 17,893 | 0 |
...
| CS (Czeski) | 50.73% (37,814/74,536) | 32.97% (24,574/74,536) | 29,852 | 20,136 | 0 |
...
| TR (Turecki) | 34.58% (25,776/74,536) | 31.10% (23,179/74,536) | 3,832 | 47,539 | 0 |
...
- Raporty strażnika jakości: **4888**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4741**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T09:46:36.709786Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.02%** (698,248/3,875,872)
- **Pokrycie globalne (real):** **10.94%** (423,888/3,875,872)
- **Kopie EN (łącznie):** **410,447**
- **Placeholdery [EN]/puste (łącznie):** **2,187,415**
...
|-------|--------|--------------------------|----------|----------------------------|
| ES | 55,779/70,637 | 79.0% / 67.4% | 3,160/3,899 | 81.0% / 79.2% |
| PL | 49,763/70,637 | 70.5% / 64.3% | 3,148/3,899 | 80.7% / 78.4% |
| IT | 49,791/70,637 | 70.5% / 62.0% | 2,973/3,899 | 76.2% / 73.1% |
...
| CS | 36,124/70,637 | 51.1% / 32.6% | 1,690/3,899 | 43.3% / 39.0% |
...
| TR | 23,817/70,637 | 33.7% / 30.1% | 1,959/3,899 | 50.2% / 48.7% |
...
| 🕒 Evidence window | 24h (span=38.91h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=38.91h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T08:46:56.996719Z → 2026-04-29T09:46:56.996719Z) |
...
> Świeżość: 45s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T09:46:19.164319Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T09:46:19.164319Z
- **Top 5 typów problemów:** suspicious_rejected_critical=190, suspicious_log_medium=91, suspicious_log_low=55, suspicious_log_high=53, suspicious_rejected_high=10
- **Języki o najsłabszej jakości:** es(60.1, issues=742890), ro(60.1, issues=439075), de(60.1, issues=121706), cs(60.1, issues=106831), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 65%, 56237 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 742890 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 61%, 176342 problemów
⚠️ **RU**: jakość 73%, 369435 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,164 |
| Heartbeat | 45s temu | 2026-04-29T09:46:19Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T09:42:39.387284Z
...
- 2026-04-29 09:46:37 | AUTO_TRANSLATE:heartbeat_tick | tr | ok | items.json
- 2026-04-29 09:46:37 | AUTO_TRANSLATE:auto_start | tr | ok | items.json
- 2026-04-29 09:46:18 | AUTO_TRANSLATE:auto_done | de | ok | npc.json
- 2026-04-29 09:45:56 | AUTO_TRANSLATE:heartbeat_tick | de | ok | npc.json
- 2026-04-29 09:45:56 | AUTO_TRANSLATE:auto_start | de | ok | npc.json
- 2026-04-29 09:44:10 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
| 🟡 ES | 79.1% | 0 | 9,653 | 536 | 0 (0.0%) | 25 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **145,888** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=5.84%, reason=stable_fail_rate=5.8%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 536 kluczy / 25 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 09:46:56
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → warn (files+1, translated+33, skipped+0) — lang=ru file=items.json strict_skipped_done=1930 guard_fail=1 placeholder=0 command=0 pipe=0
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [nl] → warn (files+1, translated+202, skipped+0) — lang=nl file=npc.json strict_skipped_done=2628 guard_fail=92 placeholder=44 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+0) — repair_identical lang=es file=otclient_modules.json target_identical=37 limit=180 tier=low_backlog domain_cap=220 gt=true suspicious_pct=6.47
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [de] → warn (files+1, translated+32, skipped+0) — lang=de file=html.json strict_skipped_done=779 guard_fail=14 placeholder=0 command=3 pipe=0
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+38, skipped+0) — lang=pl file=npc.json strict_skipped_done=2597 guard_fail=75 placeholder=32 command=0 pipe=0
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+0, translated+0, skipped+0) — lang=ro file=example_merchant.json strict_skipped_done=13
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **8,361** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 185 |
| ❌ Błędów | 355 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,506), **RU** (1,478), **IT** (1,256), **DE** (1,170), **TR** (1,152) |
| 📊 Porównanie | ↑ 1.6% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **27,341** kluczy
...
| 🔄 Cykli wykonanych | **#18,164** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,164 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 09:46:56  
