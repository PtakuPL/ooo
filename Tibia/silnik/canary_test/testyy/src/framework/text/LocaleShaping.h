...
public:
  ...
  // Aktualna domyślna lokalizacja tekstu (BCP-47), sterowana z UI/configu.
  static void setDefaultLocaleTag(const std::string& tag);
  static const std::string& getDefaultLocaleTag();

  // Pomocnicy budujący ShapeParams na podstawie tagu lub zawartości UTF-8
  static ShapeParams paramsFromLocaleTag(std::string_view tag);
  static ShapeParams paramsFromUtf8(std::string_view utf8, std::string_view fallbackTag = {});
