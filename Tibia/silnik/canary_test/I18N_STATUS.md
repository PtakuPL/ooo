...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.35%**. Tempo: **2384.0 kluczy/h**. Tłumaczeń netto: **87,788**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-17 01:20:10

> **Aktualizacja:** 2026-02-17 01:20:10 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #116 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: pl | Plik: - | Heartbeat: 2026-02-17T01:20:07Z  
> **Okno godzinowe:** okno=1.0h | cykli=170 | pominięte=0.0% | odrzucone=44.5% | przepustowość=2384.0/h  
> **Tłumaczeń netto:** 87,788

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-17 01:20:10 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-17T01:20:07Z |
| MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-17 01:20:10 |
| TRANSLATION | 🟢 AKTYWNY | 7s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-17T01:20:04.662193Z |
| QUALITY | 🔒 NIEAKTYWNY | 5s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-17T01:20:06.884285Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-17 01:20:10 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-17T01:20:07Z
...
| ❤️ **Heartbeat** | 2026-02-17T01:20:07Z |
...
> **ETA globalne:** ~41 dni (2,358,651 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~2384 kluczy/h.
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-17 01:20:10
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 7s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-17T01:20:04.662193Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-17T00:20:10.888173Z → 2026-02-17T01:20:10.888173Z) |
...
| Przepustowość (kluczy/h) | **2384.0 kluczy/h** |
| Podejrzane tłumaczenia | **14772** |
...
> Świeżość: 5s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-17T01:20:06.884285Z

- **Ostatni audyt:** OK | 7 issue(s) / 100 entries | 2026-02-17T01:20:06.884285Z
- **Top 5 typów problemów:** suspicious_rejected_critical=172, suspicious_log_high=131, suspicious_log_critical=67, suspicious_rejected_high=28, identical_to_en_exempt=12
- **Języki o najsłabszej jakości:** ro(60.1, issues=25024), ru(60.1, issues=20741), es(60.2, issues=174920), it(60.2, issues=7697), sv(62.6, issues=6109)
...
⚠️ **PL**: jakość 64%, 119752 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 174920 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 7697 problemów
⚠️ **RU**: jakość 60%, 20741 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 63%, 6109 problemów
...
| Heartbeat | 5s temu | 2026-02-17T01:20:07Z |
...
- 2026-02-17 01:20:00 | AUTO_TRANSLATE:heartbeat_tick | es | ok | modules.json
- 2026-02-17 01:20:00 | AUTO_TRANSLATE:parallel_start | es | ok | modules.json
- 2026-02-17 01:19:58 | AUTO_TRANSLATE:auto_done | pl | ok | php.json
- 2026-02-17 01:19:54 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | php.json
- 2026-02-17 01:19:54 | AUTO_TRANSLATE:auto_start | pl | ok | php.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 45.0% | 0 | 1,917 | 1,206 | 3177 (72.5%) | 34 |
| 🟡 ES | 74.4% | 0 | 2,635 | 791 | 368 (31.8%) | 33 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **87,788** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=12.2%, reason=stable_fail_rate=12.2% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,997 kluczy / 67 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-17 01:20:10
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **5,688** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 55 |
| ❌ Błędów | 90 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (1,116), **IT** (963), **RU** (914), **RO** (862), **PL** (777) |
| 📊 Porównanie | ↓ 72.0% vs wczoraj (20,288) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **105,882** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-17 01:20:10  
