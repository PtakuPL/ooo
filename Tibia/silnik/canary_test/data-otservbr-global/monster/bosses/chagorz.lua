...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "The light... that... drains!", yell = false , i18nKey = "monster.chagorz.voice_1"},
	{ text = "RAAAR!", yell = false , i18nKey = "monster.chagorz.voice_2"},
	{ text = "WILL ... PUNISH ... YOU!", yell = false , i18nKey = "monster.chagorz.voice_3"},
	{ text = "Darkness ... devours!", yell = false , i18nKey = "monster.chagorz.voice_4"},
}
