...
keywordHandler:addKeyword({ "outfit" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.eruaran.stdmod_1" })
local node1 = keywordHandler:addKeyword({ "dream warden mask" }, StdModule.say, { npcHandler = npcHandler, onlyFocus = true, i18nKey = "npc.eruaran.stdmod_2" })
node1:addChildKeyword({ "yes" }, dreamFirst, {})
node1:addChildKeyword({ "no" }, StdModule.say, { npcHandler = npcHandler, onlyFocus = true, i18nKey = "npc.eruaran.stdmod_3", reset = true })

local node2 = keywordHandler:addKeyword({ "dream warden claw" }, StdModule.say, { npcHandler = npcHandler, onlyFocus = true, i18nKey = "npc.eruaran.stdmod_4" })
node2:addChildKeyword({ "yes" }, dreamSecond, {})
node2:addChildKeyword({ "no" }, StdModule.say, { npcHandler = npcHandler, onlyFocus = true, i18nKey = "npc.eruaran.stdmod_5", reset = true })

-- Greeting message
keywordHandler:addGreetKeyword({ "ashari" }, { npcHandler = npcHandler, text = "Greetings, |PLAYERNAME|.", i18nKey = "npc.eruaran.greet_1" })
--Farewell message
keywordHandler:addFarewellKeyword({ "asgha thrazi" }, { npcHandler = npcHandler, text = "Goodbye, |PLAYERNAME|.", i18nKey = "npc.eruaran.farewell_1" })
