...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.61%**. Tempo: **1280.8 kluczy/h**. Tłumaczeń netto: **103,850**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-17 08:10:13

> **Aktualizacja:** 2026-02-17 08:10:13 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #364 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ro | Plik: - | Heartbeat: 2026-02-17T08:10:09Z  
> **Okno godzinowe:** okno=1.0h | cykli=109 | pominięte=0.0% | odrzucone=46.9% | przepustowość=1280.8/h  
> **Tłumaczeń netto:** 103,850

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-17 08:10:13 |
| LIVE | 🟢 AKTYWNY | 6s temu | - | `activity.json / worker_state.json` | 2026-02-17T08:10:09Z |
| MIGRATION | 🔒 NIEAKTYWNY | 38s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-17 08:10:13 |
| TRANSLATION | 🟢 AKTYWNY | 39s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-17T08:09:36.323253Z |
| QUALITY | 🔒 NIEAKTYWNY | 5s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-17T08:10:09.606400Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-17 08:10:13 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-17T08:10:09Z
...
| ❤️ **Heartbeat** | 2026-02-17T08:10:09Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **2,367** kluczy |
| ❌ Odrzucone (guard) | 2092 |
| 🔁 Cykli | 109 |
| 🌍 Języków | 7 |
...
> **ETA globalne:** ~74 dni (2,267,768 kluczy do celu 95%)
...
> Świeżość: 38s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-17 08:10:13
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 39s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-17T08:09:36.323253Z
...
- Raporty strażnika jakości: **3291**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3221**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-17T07:10:13.802208Z → 2026-02-17T08:10:13.802208Z) |
...
| Przepustowość (kluczy/h) | **1280.8 kluczy/h** |
| Podejrzane tłumaczenia | **6978** |
...
> Świeżość: 5s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-17T08:10:09.606400Z

- **Ostatni audyt:** SLOW_MODE | 16 issue(s) / 100 entries | 2026-02-17T08:10:09.606400Z
- **Top 5 typów problemów:** suspicious_rejected_critical=185, suspicious_log_high=152, suspicious_log_critical=43, artifact_token=16, suspicious_rejected_high=15
- **Języki o najsłabszej jakości:** es(60.1, issues=221810), pl(60.1, issues=132283), ro(60.1, issues=52649), it(60.1, issues=16662), ru(63.3, issues=40674)
- **Pliki:** `i18n/status/quality_audit_latest.json`, `i18n/status/quality_dashboard.json`, `i18n/status/quality_report.jsonl`

### 📈 Statystyki Pracy
| Metryka | Wartość | Info |
|---------|---------|------|
| 🔄 Cykl aktualny | **#364** | od uruchomienia |
...
⚠️ **PL**: jakość 60%, 132283 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 221810 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 16662 problemów
⚠️ **RU**: jakość 63%, 40674 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 66%, 12462 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #364 |
| Heartbeat | 6s temu | 2026-02-17T08:10:09Z |
...
- 2026-02-17 08:09:44 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-17 08:09:31 | AUTO_TRANSLATE:heartbeat_tick | sr | ok | items.json
- 2026-02-17 08:09:30 | AUTO_TRANSLATE:parallel_start | sr | ok | items.json
- 2026-02-17 08:09:25 | AUTO_TRANSLATE:heartbeat_tick | sv | ok | items.json
- 2026-02-17 08:09:25 | AUTO_TRANSLATE:parallel_start | sv | ok | items.json
- 2026-02-17 08:09:24 | AUTO_TRANSLATE:auto_done | ro | ok | books.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.2% | 0 | 1,786 | 734 | 3020 (80.4%) | 26 |
| 🟡 ES | 84.2% | 0 | 2,122 | 543 | 692 (56.0%) | 28 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **103,850** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=30.0%, reason=decrease_high_fail_rate=30.0% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,277 kluczy / 54 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-17 08:10:13

- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+25) — repair_identical lang=es file=npc.json target_identical=51 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=218.66
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+15, skipped+0) — lang=ro file=books.json strict_skipped_done=331 guard_fail=35 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **31,097** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 303 |
| ❌ Błędów | 528 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (6,513), **IT** (5,666), **RU** (5,584), **RO** (5,019), **PL** (3,965) |
| 📊 Porównanie | ↑ 53.3% vs wczoraj (20,288) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **131,291** kluczy
...
| 🔄 Cykli wykonanych | **#364** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-17 08:10:13  
