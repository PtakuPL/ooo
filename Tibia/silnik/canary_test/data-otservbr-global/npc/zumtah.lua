...
--Basic
keywordHandler:addKeyword({ "job" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.zumtah.stdmod_1" })
keywordHandler:addKeyword({ "name" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.zumtah.stdmod_2" })
keywordHandler:addAliasKeyword({ "djinn" })
keywordHandler:addAliasKeyword({ "zumtah" })
keywordHandler:addKeyword({ "zao" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.zumtah.stdmod_3" })
keywordHandler:addKeyword({ "humans" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.zumtah.stdmod_4" })
keywordHandler:addKeyword({ "lizard" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.zumtah.stdmod_5" })
