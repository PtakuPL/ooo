...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.21%**. Tempo: **1375.3 kluczy/h**. Tłumaczeń netto: **78,316**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-14 21:12:35

> **Aktualizacja:** 2026-02-14 21:12:35 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #1 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: achievements.json | Heartbeat: 2026-02-14T21:11:58Z  
> **Okno godzinowe:** okno=1.0h | cykli=53 | pominięte=0.0% | odrzucone=22.5% | przepustowość=1375.3/h  
> **Tłumaczeń netto:** 78,316

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-14 21:12:35 |
| LIVE | 🟢 AKTYWNY | 37s temu | - | `activity.json / worker_state.json` | 2026-02-14T21:11:58Z |
| MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-14 21:12:35 |
| TRANSLATION | 🟢 AKTYWNY | 6min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-14T21:06:17.082732Z |
| QUALITY | 🔒 NIEAKTYWNY | 6min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-14T21:06:17.487869Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-14 21:12:35 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 37s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-14T21:11:58Z
...
| ❤️ **Heartbeat** | 2026-02-14T21:11:58Z |
...
> **ETA globalne:** ~72 dni (2,362,487 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 76.4% | 40,939/53,586 | ~7h |
| PL | █████████░░░░░░░░░░░ | 47.7% | 25,568/53,586 | ~18h |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-14 21:12:35
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 6min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-14T21:06:17.082732Z
...
|-------|----------------|-------------------------------|---------|--------------|
| ES (Hiszpański) | 40,939/53,586 | 76.40% | 2,727 | 0 |
...
- **Pokrycie globalne:** **10.21%** (284,625/2,786,472)
- **Kopie EN (łącznie):** **173,473**
...
- **Profiler cyklu (ostatni):** cykl #1 (AUTO_TRANSLATE): dispatch 503ms, mode 133507ms, status 6584ms, total 143834ms
...
|-------|--------|----------|----------|------------|
| ES | 38,339/49,731 | 77.1% | 2,600/3,855 | 67.4% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-14T20:12:35.533538Z → 2026-02-14T21:12:35.533538Z) |
...
| Najgorsze cele (strażnik) | pl/quests.json (gf=38), es/questlog.json (gf=26), pl/monsters.json (gf=22), es/scripts.json (gf=16), pl/html.json (gf=12) |
...
> Świeżość: 6min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-14T21:06:17.487869Z

- **Ostatni audyt:** SLOW_MODE | 28 issue(s) / 100 entries | 2026-02-14T21:06:17.487869Z
- **Top 5 typów problemów:** suspicious_log_high=91, suspicious_log_critical=61, suspicious_log_medium=46, identical_to_en_exempt=22, artifact_token=15
- **Języki o najsłabszej jakości:** es(60.1, issues=211114), pl(60.1, issues=132916), tl(64.2, issues=466), zh_TW(64.8, issues=337), fr(66.5, issues=2470)
...
⚠️ **PL**: jakość 60%, 132916 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 211114 problemów
...
| Heartbeat | 37s temu | 2026-02-14T21:11:58Z |
...
- 2026-02-14 21:11:58 | AUTO_TRANSLATE:heartbeat_tick | es | ok | achievements.json
- 2026-02-14 21:11:58 | AUTO_TRANSLATE:auto_start | es | ok | achievements.json
- 2026-02-14 21:11:03 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | modules.json
- 2026-02-14 21:09:33 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | modules.json
- 2026-02-14 21:08:02 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | modules.json
- 2026-02-14 21:06:32 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | modules.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 47.7% | 0 | 2,059 | 2,469 | 7649 (75.6%) | 93 |
| 🟡 ES | 76.4% | 0 | 2,727 | 3,299 | 497 (13.1%) | 107 |
...
| Przepustowość (okno) | 5,768 kluczy / 200 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-14 21:12:35
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **53,187** kluczy |
| ⏭️ Pominięte | 1 |
| 🔁 Cykli | 141 |
| ❌ Błędów | 828 |
| 🌍 Aktywnych języków | 52 |
| 🏆 TOP 5 | **ES** (20,562), **PL** (9,462), **IT** (971), **PT** (960), **DE** (890) |
| 📊 Porównanie | ↑ 15.4% vs wczoraj (46,073) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **100,609** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-14 21:12:35  
