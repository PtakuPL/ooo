#ifndef __SRC_LUA_FUNCTIONS_CORE_CORE_FUNCTIONS_HPP_
#define __SRC_LUA_FUNCTIONS_CORE_CORE_FUNCTIONS_HPP_
...
#endif // __SRC_LUA_FUNCTIONS_CORE_CORE_FUNCTIONS_HPP_
