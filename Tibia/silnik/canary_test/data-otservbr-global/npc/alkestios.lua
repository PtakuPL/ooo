...
keywordHandler:addKeyword({ "deer" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.alkestios.stdmod_1" })
keywordHandler:addKeyword({ "realm" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.alkestios.stdmod_2" })
keywordHandler:addKeyword({ "siblings" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.alkestios.stdmod_3" })
keywordHandler:addKeyword({ "kind" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.alkestios.stdmod_4" })
keywordHandler:addKeyword({ "protect" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.alkestios.stdmod_5" })
