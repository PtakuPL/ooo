...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-28 23:59:21

> **Aktualizacja:** 2026-04-28 23:59:21 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,352 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: cs | Plik: items.json | Heartbeat: 2026-04-28T23:57:53Z
...
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-28 23:59:21 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-28T23:57:53Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 54s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-28 23:59:21 |
| TRANSLATION | 🟢 AKTYWNY | 3min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-28T23:55:59.953126Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-28T23:57:52.420316Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-28 23:59:21 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-28T23:59:27.933927Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-28T23:57:53Z
...
| ❤️ **Heartbeat** | 2026-04-28T23:57:53Z |
...
| ⏳ Oldest pending (visible tail) | 16195 s |
...
| 🌍 Recent provider mix | TM/simple(262), Free Google Translate(226), canonical_name_semantic_autofix(16), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=507, fallbacks=12) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=439/439 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 390, 'oldest_s': 16195}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 54s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-28 23:59:21
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-28T23:55:59.953126Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-28T23:58:19.891163Z |
...
| 🕒 Evidence window | 24h (span=29.12h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=29.12h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-28T22:59:22.479825Z → 2026-04-28T23:59:22.479825Z) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-28T23:57:52.420316Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-28T23:57:52.420316Z
- **Top 5 typów problemów:** suspicious_rejected_critical=193, suspicious_log_low=76, suspicious_log_medium=63, suspicious_log_high=61, suspicious_rejected_high=7
- **Języki o najsłabszej jakości:** es(60.1, issues=726194), ro(60.1, issues=425321), de(60.1, issues=108802), cs(60.1, issues=83176), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 64%, 53069 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 726194 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 67%, 168718 problemów
⚠️ **RU**: jakość 71%, 358026 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,352 |
| Heartbeat | 94s temu | 2026-04-28T23:57:53Z |
...
- 2026-04-28 23:58:21 | AUTO_TRANSLATE:auto_start | cs | ok | items.json
- 2026-04-28 23:57:46 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-28 23:59:21
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [tr] → warn (files+1, translated+104, skipped+0) — lang=tr file=npc.json strict_skipped_done=4166 guard_fail=184 placeholder=93 command=0 pipe=0
- 🌍 TRANSLATION_SYNC: SYNC_FILE_DONE [it] → ok (keys+4567, files+1) — lang=it file=npc.json
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [tr] → warn (files+1, translated+119, skipped+0) — lang=tr file=client.json strict_skipped_done=10 guard_fail=1 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+71) — repair_identical lang=es file=npc.json target_identical=350 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=119.72
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [nl] → warn (files+1, translated+282, skipped+0) — lang=nl file=scripts.json strict_skipped_done=357 guard_fail=5 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **8,165** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 127 |
| ❌ Błędów | 333 |
| 🌍 Aktywnych języków | 9 |
| 🏆 TOP 5 | **DE** (1,370), **RU** (1,269), **IT** (1,021), **TR** (916), **RO** (911) |
| 📊 Porównanie | ↑ 57.4% vs wczoraj (5,188) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **31,025** kluczy
...
| 🔄 Cykli wykonanych | **#17,352** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,352 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-28 23:59:21  
