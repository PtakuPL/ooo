...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.22%**. Tempo: **2284.0 kluczy/h**. Tłumaczeń netto: **82,895**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-16 23:45:57

> **Aktualizacja:** 2026-02-16 23:45:57 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #52 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ru | Plik: - | Heartbeat: 2026-02-16T23:45:53Z  
> **Okno godzinowe:** okno=1.0h | cykli=154 | pominięte=0.0% | odrzucone=44.2% | przepustowość=2284.0/h  
> **Tłumaczeń netto:** 82,895

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-16 23:45:57 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-16T23:45:53Z |
| MIGRATION | 🔒 NIEAKTYWNY | 33s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-16 23:45:57 |
| TRANSLATION | 🟢 AKTYWNY | 19s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-16T23:45:39.028136Z |
| QUALITY | 🔒 NIEAKTYWNY | 4s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-16T23:45:53.578119Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-16 23:45:57 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-16T23:45:53Z
...
| ❤️ **Heartbeat** | 2026-02-16T23:45:53Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **4,090** kluczy |
| ❌ Odrzucone (guard) | 3245 |
| 🔁 Cykli | 154 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | IT (822 kluczy) |
...
> Świeżość: 33s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-16 23:45:57
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 19s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-16T23:45:39.028136Z
...
- Raporty strażnika jakości: **2483**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2420**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **10.22%** (284,821/2,786,472)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-16T22:45:57.462488Z → 2026-02-16T23:45:57.462488Z) |
...
> Świeżość: 4s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-16T23:45:53.578119Z

- **Ostatni audyt:** OK | 7 issue(s) / 100 entries | 2026-02-16T23:45:53.578119Z
- **Top 5 typów problemów:** suspicious_rejected_critical=159, suspicious_log_high=128, suspicious_log_critical=68, suspicious_rejected_high=41, identical_to_en_exempt=11
- **Języki o najsłabszej jakości:** es(60.1, issues=164344), ro(60.3, issues=16361), ru(60.4, issues=15539), sv(63.9, issues=3368), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 78%, 117090 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 164344 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 68%, 6039 problemów
⚠️ **RU**: jakość 60%, 15539 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 64%, 3368 problemów
...
| Heartbeat | 5s temu | 2026-02-16T23:45:53Z |
...
- 2026-02-16 23:45:45 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-16 23:45:37 | AUTO_TRANSLATE:heartbeat_tick | sv | ok | server.json
- 2026-02-16 23:45:37 | AUTO_TRANSLATE:parallel_start | sv | ok | server.json
- 2026-02-16 23:44:27 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | quests.json
- 2026-02-16 23:44:27 | AUTO_TRANSLATE:parallel_start | ro | ok | quests.json
- 2026-02-16 23:44:25 | AUTO_TRANSLATE:auto_done | ru | ok | quests.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 44.0% | 0 | 1,923 | 1,139 | 3339 (74.6%) | 26 |
...
| Przepustowość (okno) | 2,290 kluczy / 59 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-16 23:45:57
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **19,330** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 87 |
| ❌ Błędów | 204 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (3,760), **IT** (3,151), **RU** (2,875), **RO** (2,706), **SV** (2,344) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **99,236** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-16 23:45:57  
