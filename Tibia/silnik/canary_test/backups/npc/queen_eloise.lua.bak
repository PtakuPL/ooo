...
-- Greeting
keywordHandler:addGreetKeyword({ "hail queen" }, { npcHandler = npcHandler, i18nKey = "npc.queen_eloise.greet_1" })
keywordHandler:addGreetKeyword({ "salutations queen" }, { npcHandler = npcHandler, i18nKey = "npc.queen_eloise.greet_2" })
