...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.86%**. Tempo: **1573.2 kluczy/h**. Tłumaczeń netto: **118,086**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 18:46:14

> **Aktualizacja:** 2026-02-20 18:46:14 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #69 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: pl | Plik: - | Heartbeat: 2026-02-20T18:46:10Z  
> **Okno godzinowe:** okno=1.0h | cykli=205 | pominięte=0.0% | odrzucone=74.4% | przepustowość=1573.2/h  
> **Tłumaczeń netto:** 118,086

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 18:46:14 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T18:46:10Z |
| MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 18:46:14 |
| TRANSLATION | 🟢 AKTYWNY | 5s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T18:46:10.108233Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T18:46:15.618755Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 18:46:14 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T18:46:10Z
...
| ❤️ **Heartbeat** | 2026-02-20T18:46:10Z |
...
> **ETA globalne:** ~60 dni (2,261,017 kluczy do celu 95%)
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 18:46:14
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T18:46:10.108233Z
...
- Raporty strażnika jakości: **6802**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3910**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T17:46:14.872399Z → 2026-02-20T18:46:14.872399Z) |
...
| Najgorsze cele (strażnik) | pl/items.json (gf=3264), es/items.json (gf=2070), pl/npc.json (gf=1936), es/server.json (gf=164), it/npc.json (gf=124) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T18:46:15.618755Z

- **Ostatni audyt:** SLOW_MODE | 40 issue(s) / 100 entries | 2026-02-20T18:46:10.732448Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_log_critical=76, suspicious_rejected_critical=64, suspicious_log_high=59, artifact_token=35, identical_to_en=5
- **Języki o najsłabszej jakości:** es(60.1, issues=328717), pl(60.1, issues=184077), ro(60.1, issues=179841), sr(61.0, issues=86259), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 60%, 184077 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 328717 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 86%, 73188 problemów
...
| Heartbeat | 5s temu | 2026-02-20T18:46:10Z |
...
- 2026-02-20 18:45:50 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-02-20 18:45:50 | AUTO_TRANSLATE:parallel_start | es | ok | server.json
- 2026-02-20 18:45:44 | AUTO_TRANSLATE:heartbeat_tick | es | ok | monsters.json
- 2026-02-20 18:45:44 | AUTO_TRANSLATE:parallel_start | es | ok | monsters.json
- 2026-02-20 18:45:43 | AUTO_TRANSLATE:auto_done | pl | ok | monsters.json
- 2026-02-20 18:45:37 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | monsters.json
...
| 🟡 ES | 84.7% | 0 | 2,160 | 743 | 3048 (80.4%) | 39 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **118,086** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=70.34%, reason=decrease_high_fail_rate=70.3% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,315 kluczy / 73 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 18:46:14
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **8,063** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 69 |
| ❌ Błędów | 184 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (2,359), **RU** (1,547), **IT** (1,337), **RO** (964), **PL** (909) |
| 📊 Porównanie | ↑ 121.5% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **105,648** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 18:46:14  
