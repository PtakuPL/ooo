...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.8%**. Tempo: **722.8 kluczy/h**. Tłumaczeń netto: **112,265**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-19 22:21:18

> **Aktualizacja:** 2026-02-19 22:21:18 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #2 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: - | Heartbeat: 2026-02-19T22:21:11Z  
> **Okno godzinowe:** okno=1.0h | cykli=45 | pominięte=0.0% | odrzucone=39.3% | przepustowość=722.8/h  
> **Tłumaczeń netto:** 112,265

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-19 22:21:18 |
| LIVE | 🟢 AKTYWNY | 12s temu | - | `activity.json / worker_state.json` | 2026-02-19T22:21:11Z |
| MIGRATION | 🔒 NIEAKTYWNY | 2d temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-19 22:21:18 |
| TRANSLATION | 🟢 AKTYWNY | 56s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-19T22:20:26.755855Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-19T22:21:23.163472Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-19 22:21:18 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 12s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-19T22:21:11Z
...
| ❤️ **Heartbeat** | 2026-02-19T22:21:11Z |
...
> **ETA globalne:** ~130 dni (2,262,678 kluczy do celu 95%)
...
| SR | █████████░░░░░░░░░░░ | 45.4% | 24,316/53,586 | ~37h |
| RO | ████████░░░░░░░░░░░░ | 41.9% | 22,437/53,586 | ~39h |
...
> Świeżość: 2d temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-19 22:21:18
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 56s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-19T22:20:26.755855Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-19T21:21:19.244052Z → 2026-02-19T22:21:19.244052Z) |
| Cykle | **45** (TŁUMACZENIE=45, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **39.3%** |
| Cykle bez postępu % | **53.7%** |
| Przepustowość (kluczy/h) | **722.8 kluczy/h** |
| Podejrzane tłumaczenia | **7530** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-19T22:21:23.163472Z
...
| Heartbeat | 12s temu | 2026-02-19T22:21:11Z |
...
- 2026-02-19 22:19:32 | AUTO_TRANSLATE:parallel_start | ru | ok | spells.json
- 2026-02-19 22:19:28 | AUTO_TRANSLATE:auto_done | it | ok | spells.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **112,265** | — | 📊 |
| Adaptacyjna paczka | batch=9, gf_rate=28.13%, reason=decrease_high_fail_rate=28.1% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-19 22:21:18
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+3, skipped+0) — lang=it file=spells.json strict_skipped_done=1416 guard_fail=47 placeholder=0 command=0 pipe=0
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [sv] → warn (files+1, translated+50, skipped+0) — lang=sv file=npc.json strict_skipped_done=5467
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ro] → ok (translated+0, skipped+0) — parallel lang=ro file=talkactions.json
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-19 22:21:18  
