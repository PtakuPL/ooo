...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.02% / real 10.95%**. Tempo: **695.0 kluczy/h**. Tłumaczeń netto: **146,575**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 10:50:54

> **Aktualizacja:** 2026-04-29 10:50:54 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,252 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: de | Plik: otclient_modules.json | Heartbeat: 2026-04-29T10:48:47Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=6.3% | przepustowość=695.0/h  
> **Tłumaczeń netto:** 146,575

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 10:50:54 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T10:48:47Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 25s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 10:50:54 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T10:49:26.835338Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T10:48:46.314640Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 10:50:54 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T10:51:01.611226Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T10:48:47Z
...
| ❤️ **Heartbeat** | 2026-04-29T10:48:47Z |
...
| 10:34:41 | ES | Serwer | server.json | 1 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 10:32:38 | TR | Serwer | items.json | 39 | `simple` | `item.13198.name` | kovan yapısı |
...
|----------|------|---------|-----------|-------|----------|--------------|-----|
| 10:49:18 | DE | Klient | otclient_modules.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `otclient_modules.charms.tr_34` |
| 10:44:25 | IT | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 10:42:26 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10193.name` |
| 10:42:24 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10192.name` |
| 10:42:22 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10191.name` |
| 10:42:20 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10190.name` |
| 10:40:16 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.say_2` |
| 10:37:37 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.14250.name` |
| 10:37:36 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.14077.name` |
| 10:37:34 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.14023.name` |
| 10:37:33 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.11586.name` |
| 10:37:31 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 10:37:29 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10456.name` |
| 10:37:28 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10338.name` |
| 10:37:26 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10026.name` |
| 10:35:59 | RU | Serwer | items.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `item.11541.name` |
...
| ⏳ Oldest pending (visible tail) | 15770 s |
| 🌍 Top języki | RU(384), CS(1) |
| 🧱 Top reason_bucket | quality(384), default(1) |
| 🗂️ Deferred state keys | 8304 |
| 🕒 Deferred state freshness | fresh (92s) |
...
| 🌍 Recent provider mix | TM/simple(349), Free Google Translate(126), canonical_name_semantic_autofix(18), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=496, fallbacks=27) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=938/938 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 385, 'oldest_s': 15770}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Tempo obliczone na bazie ostatniej godziny: ~695 kluczy/h.
...
> Świeżość: 25s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 10:50:54
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T10:49:26.835338Z
...
|-------|-----------|--------|----------|--------------|--------------|
| ES (Hiszpański) | 79.08% (58,945/74,536) | 68.04% (50,711/74,536) | 9,623 | 14,226 | 0 |
| PL (Polski) | 70.99% (52,911/74,536) | 65.08% (48,507/74,536) | 5,861 | 20,194 | 0 |
| IT (Włoski) | 70.95% (52,882/74,536) | 62.73% (46,756/74,536) | 10,030 | 17,775 | 0 |
| RO (Rumuński) | 69.73% (51,972/74,536) | 56.69% (42,253/74,536) | 13,005 | 19,303 | 0 |
| RU (Rosyjski) | 46.15% (34,395/74,536) | 44.58% (33,225/74,536) | 4,775 | 36,554 | 0 |
| FR (Francuski) | 57.51% (42,864/74,536) | 41.87% (31,206/74,536) | 26,153 | 17,199 | 0 |
| CS (Czeski) | 50.84% (37,896/74,536) | 33.09% (24,664/74,536) | 29,844 | 20,054 | 0 |
...
| TR (Turecki) | 34.71% (25,873/74,536) | 31.23% (23,276/74,536) | 3,832 | 47,442 | 0 |
...
- Raporty strażnika jakości: **4911**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4764**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T10:49:05.398208Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.02%** (698,545/3,875,872)
- **Pokrycie globalne (real):** **10.95%** (424,223/3,875,872)
- **Kopie EN (łącznie):** **410,409**
- **Placeholdery [EN]/puste (łącznie):** **2,187,118**
...
|-------|--------|--------------------------|----------|----------------------------|
| ES | 55,785/70,637 | 79.0% / 67.4% | 3,160/3,899 | 81.0% / 79.2% |
| PL | 49,763/70,637 | 70.5% / 64.3% | 3,148/3,899 | 80.7% / 78.4% |
| IT | 49,909/70,637 | 70.7% / 62.2% | 2,973/3,899 | 76.2% / 73.1% |
| RO | 49,186/70,637 | 69.6% / 56.0% | 2,786/3,899 | 71.5% / 69.6% |
| RU | 31,251/70,637 | 44.2% / 42.7% | 3,144/3,899 | 80.6% / 79.3% |
| FR | 39,937/70,637 | 56.5% / 40.1% | 2,927/3,899 | 75.1% / 73.7% |
| CS | 36,206/70,637 | 51.3% / 32.8% | 1,690/3,899 | 43.3% / 39.0% |
...
| TR | 23,914/70,637 | 33.9% / 30.3% | 1,959/3,899 | 50.2% / 48.7% |
...
| 🕒 Evidence window | 24h (span=39.98h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=39.98h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T09:50:54.815362Z → 2026-04-29T10:50:54.815362Z) |
...
| Przepustowość (kluczy/h) | **695.0 kluczy/h** |
| Podejrzane tłumaczenia | **1024** |
| Najgorsze cele (strażnik) | cs/items.json (gf=24), ro/items.json (gf=12), ru/items.json (gf=3), it/items.json (gf=3), de/otclient_modules.json (gf=3) |
...
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T10:48:46.314640Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T10:48:46.314640Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=744638), ro(60.1, issues=440300), de(60.1, issues=123006), cs(60.1, issues=109783), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 63%, 56810 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 744638 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 66%, 177026 problemów
⚠️ **RU**: jakość 61%, 370553 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,252 |
| Heartbeat | 134s temu | 2026-04-29T10:48:47Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T10:49:42.259915Z
...
- 2026-04-29 10:49:42 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 10:49:27 | AUTO_TRANSLATE:auto_done | de | ok | otclient_modules.json
- 2026-04-29 10:49:06 | AUTO_TRANSLATE:heartbeat_tick | de | ok | otclient_modules.json
- 2026-04-29 10:49:05 | AUTO_TRANSLATE:auto_start | de | ok | otclient_modules.json
- 2026-04-29 10:48:45 | AUTO_TRANSLATE:auto_done | es | ok | items.json
- 2026-04-29 10:47:30 | AUTO_TRANSLATE:heartbeat_tick | es | ok | items.json
...
| Przepustowość (okno) | 544 kluczy / 26 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 10:50:54
...
- 🤖 AUTO_TRANSLATE: TIER_QUALITY_GATE [-] → ok — __TIER_GATE__ tier1_avg=68.7% pass=False tier2_avg=34.2% pass=False rec=TIER1_INCOMPLETE: priorytet na PL/ES
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+4) — repair_identical lang=es file=npc.json target_identical=2 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=198.00
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **9,121** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 185 |
| ❌ Błędów | 395 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,629), **RU** (1,568), **IT** (1,374), **TR** (1,276), **DE** (1,275) |
| 📊 Porównanie | ↑ 10.9% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **28,101** kluczy
...
| 🔄 Cykli wykonanych | **#18,252** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,252 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 10:50:54  
