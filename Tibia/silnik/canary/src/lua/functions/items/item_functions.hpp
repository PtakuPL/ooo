#ifndef __SRC_LUA_FUNCTIONS_ITEMS_ITEM_FUNCTIONS_HPP_
#define __SRC_LUA_FUNCTIONS_ITEMS_ITEM_FUNCTIONS_HPP_
...
#endif // __SRC_LUA_FUNCTIONS_ITEMS_ITEM_FUNCTIONS_HPP_
