...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.07% / real 11.0%**. Tempo: **631.0 kluczy/h**. Tłumaczeń netto: **150,358**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 16:30:15

> **Aktualizacja:** 2026-04-29 16:30:15 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,669 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: cs | Plik: items.json | Heartbeat: 2026-04-29T16:28:36Z
> **Okno godzinowe:** okno=1.0h | cykli=55 | pominięte=0.0% | odrzucone=1.1% | przepustowość=631.0/h  
> **Tłumaczeń netto:** 150,358

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 16:30:15 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T16:28:36Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 29s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 16:30:15 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T16:28:01.540699Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T16:28:03.242574Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 16:30:15 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T16:30:23.893352Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T16:28:36Z

| Metryka | Wartość |
|---------|---------|
| 🛠️ **Co robi** | Tłumaczenie automatyczne (Google Translate + TM) |
| 🌍 **Aktywne języki (10 min)** | CS, DE, RU, TR |
| 📝 **Faza** | AUTO_TRANSLATE |
| 📋 **Etap** | sygnał życia |
| 📂 **Kategoria / Język** | cs |
| 📄 **Plik** | items.json |
...
| 🔄 **Ostatni cykl** | 42 kluczy, 2 odrzuconych, 170.0s, tryb: AUTO_TRANSLATE, cel: ru/items.json |
| ❤️ **Heartbeat** | 2026-04-29T16:28:36Z |
...
| ⏳ Oldest pending (visible tail) | 15713 s |
...
| 📉 Fallback breakdown | fallback to google translate high(31), fallback chain exhausted high reject types(2) |
...
| ❤️ Pool health | `critical` (writes=553, fallbacks=33) |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 399, 'oldest_s': 15713}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| �📊 Przetłumaczono | **716** kluczy |
| ❌ Odrzucone (guard) | 8 |
| 🔁 Cykli | 55 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (142 kluczy) |
| 📄 Najczęstszy plik | items.json |
| ⚡ Przepustowość | ~631 kluczy/h |
...
> **ETA globalne:** ~197 dni (2,981,631 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~631 kluczy/h.
...
> Świeżość: 29s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 16:30:15
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T16:28:01.540699Z
...
- Raporty strażnika jakości: **5021**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4874**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T15:30:16.059387Z → 2026-04-29T16:30:16.059387Z) |
...
| Przepustowość (kluczy/h) | **631.0 kluczy/h** |
| Podejrzane tłumaczenia | **1326** |
...
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T16:28:03.242574Z
...
| Heartbeat | 107s temu | 2026-04-29T16:28:36Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T16:25:29.325347Z
...
- 2026-04-29 16:26:44 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-04-29 16:25:13 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-04-29 16:25:12 | AUTO_TRANSLATE:auto_start | ru | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 16:30:15
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **13,168** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 216 |
| ❌ Błędów | 578 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (2,317), **RU** (2,091), **TR** (2,075), **DE** (1,935), **IT** (1,817) |
| 📊 Porównanie | ↑ 60.0% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **32,148** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 16:30:15  
