...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.91% / real 10.82%**. Tempo: **727.0 kluczy/h**. Tłumaczeń netto: **138,633**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 00:40:00

> **Aktualizacja:** 2026-04-29 00:40:00 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,408 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: tr | Plik: items.json | Heartbeat: 2026-04-29T00:39:02Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=4.2% | przepustowość=727.0/h  
> **Tłumaczeń netto:** 138,633

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 00:40:00 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T00:39:02Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 00:40:00 |
| TRANSLATION | 🟢 AKTYWNY | 5min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T00:34:46.063135Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T00:38:33.596127Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 00:40:00 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T00:40:07.630985Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T00:39:02Z
...
| ❤️ **Heartbeat** | 2026-04-29T00:39:02Z |
...
| 🌍 Recent provider mix | TM/simple(264), Free Google Translate(227), canonical_name_semantic_autofix(17), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=511, fallbacks=13) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=470/470 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 392, 'oldest_s': 17378}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 00:40:00
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 5min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T00:34:46.063135Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T00:39:01.041817Z |
...
| 🕒 Evidence window | 24h (span=29.80h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=29.80h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-28T23:40:00.898927Z → 2026-04-29T00:40:00.898927Z) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T00:38:33.596127Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T00:38:33.596127Z
- **Top 5 typów problemów:** suspicious_rejected_critical=192, suspicious_log_medium=91, suspicious_log_low=56, suspicious_log_high=52, suspicious_rejected_high=8
- **Języki o najsłabszej jakości:** es(60.1, issues=727239), ro(60.1, issues=426457), de(60.1, issues=109782), cs(60.1, issues=84644), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 727239 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 60%, 169315 problemów
⚠️ **RU**: jakość 70%, 358927 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,408 |
| Heartbeat | 65s temu | 2026-04-29T00:39:02Z |
...
- 2026-04-29 00:39:01 | AUTO_TRANSLATE:auto_start | tr | ok | items.json
- 2026-04-29 00:38:02 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **138,633** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=3.83%, reason=increase_low_fail_rate=3.8%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 00:40:00
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **493** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 13 |
| ❌ Błędów | 23 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **DE** (90), **IT** (89), **CS** (80), **RO** (78), **ES** (69) |
| 📊 Porównanie | ↓ 94.0% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **19,473** kluczy
...
| 🔄 Cykli wykonanych | **#17,408** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,408 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 00:40:00  
