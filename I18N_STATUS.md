...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.06% / real 10.98%**. Tempo: **721.0 kluczy/h**. Tłumaczeń netto: **149,355**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 15:06:25

> **Aktualizacja:** 2026-04-29 15:06:25 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,585 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-04-29T15:02:49Z
> **Okno godzinowe:** okno=1.0h | cykli=80 | pominięte=0.0% | odrzucone=6.4% | przepustowość=721.0/h  
> **Tłumaczeń netto:** 149,355

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 15:06:25 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-04-29T15:02:49Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 16s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 15:06:25 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T15:04:32.834000Z |
| QUALITY | 🔒 NIEAKTYWNY | 4min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T15:02:29.691996Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 15:06:25 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T15:06:32.746337Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T15:02:49Z
...
| 🔄 **Ostatni cykl** | 33 kluczy, 1 odrzuconych, 104.0s, tryb: AUTO_TRANSLATE, cel: it/items.json |
| ❤️ **Heartbeat** | 2026-04-29T15:02:49Z |
...
| ⏳ Oldest pending (visible tail) | 17556 s |
...
| 🧮 OpenAI budget | `12/250 (4.4%)` |
| ♻️ Provider debt | `1248` |
| 🌍 Recent provider mix | TM/simple(339), Free Google Translate(130), canonical_name_semantic_autofix(20), OpenAI model pool(10), ter... |
...
| ❤️ Pool health | `critical` (writes=502, fallbacks=33) |
...
|-------|--------|----------|-------|-----------|--------|
| `HEARTBEAT_STALE` | OK | OK | `207` | `300` | Heartbeat świeży (207s, src=worker_runtime_heartbeat) Runtime[status=healthy, reason=heartbeat_fresh, phase... |
| `NO_WRITE` | OK | OK | `131` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 397, 'oldest_s': 17556}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~172 dni (2,982,138 kluczy do celu 95%)
...
> Świeżość: 16s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 15:06:25
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T15:04:32.834000Z
...
- RESERVED SPRITE → SPRITE RISERVATO (item.14420.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14421.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14422.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14423.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14424.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14425.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14426.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14427.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14428.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14429.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14430.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14431.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14432.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14433.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14434.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14435.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.14436.name)
- lava wall → muro di lava (item.1441.name)
- lava wall → muro di lava (item.1442.name)
- lava wall → muro di lava (item.1443.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4995**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4848**
...
- **Pokrycie globalne (nominal):** **18.06%** (699,930/3,875,872)
- **Pokrycie globalne (real):** **10.98%** (425,720/3,875,872)
- **Kopie EN (łącznie):** **410,297**
- **Placeholdery [EN]/puste (łącznie):** **2,185,733**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T14:06:25.587643Z → 2026-04-29T15:06:25.587643Z) |
...
| Najgorsze cele (strażnik) | cs/items.json (gf=27), ro/items.json (gf=12), ru/items.json (gf=3), it/items.json (gf=3), de/otclient_modules.json (gf=2) |
...
> Świeżość: 4min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T15:02:29.691996Z
...
| Heartbeat | 223s temu | 2026-04-29T15:02:49Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T15:04:49.175689Z
...
- 2026-04-29 15:06:20 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 15:04:49 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 15:04:33 | AUTO_TRANSLATE:auto_done | it | ok | items.json
- 2026-04-29 15:04:20 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 15:06:25
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **12,175** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 216 |
| ❌ Błędów | 542 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (2,137), **RU** (1,900), **TR** (1,885), **DE** (1,755), **IT** (1,726) |
| 📊 Porównanie | ↑ 48.0% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **31,155** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 15:06:25  
