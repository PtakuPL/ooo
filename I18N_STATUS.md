...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.0% / real 10.92%**. Tempo: **688.0 kluczy/h**. Tłumaczeń netto: **144,751**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 08:20:18

> **Aktualizacja:** 2026-04-29 08:20:18 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,044 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: cs | Plik: items.json | Heartbeat: 2026-04-29T08:18:09Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=5.0% | przepustowość=688.0/h  
> **Tłumaczeń netto:** 144,751

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 08:20:18 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T08:18:09Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 08:20:18 |
| TRANSLATION | 🟢 AKTYWNY | 30s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T08:19:54.694396Z |
| QUALITY | 🔒 NIEAKTYWNY | 29s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T08:19:55.761839Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 08:20:18 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T08:20:25.358919Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T08:18:09Z
...
| 🔄 **Ostatni cykl** | 36 kluczy, 1 odrzuconych, 78.0s, tryb: AUTO_TRANSLATE, cel: ru/items.json |
| ❤️ **Heartbeat** | 2026-04-29T08:18:09Z |
...
| ⏳ Oldest pending (visible tail) | 15983 s |
...
| 🌍 Recent provider mix | TM/simple(327), Free Google Translate(163), canonical_name_semantic_autofix(16), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=509, fallbacks=19) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=823/823 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 389, 'oldest_s': 15983}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 08:20:18
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 30s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T08:19:54.694396Z
...
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.13931.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.13932.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.13933.name)
- ornamented wall → орнаментированная стена (item.1394.name)
- hivecomb floor → хивекомб пол (item.13943.name)
- hivecomb floor → хивекомб пол (item.13944.name)
- hivecomb floor → хивекомб пол (item.13945.name)
- hivecomb floor → хивекомб пол (item.13946.name)
- hivecomb floor → хивекомб пол (item.13947.name)
- hivecomb floor → хивекомб пол (item.13948.name)
- hivecomb floor → хивекомб пол (item.13949.name)
- ornamented wall → орнаментированная стена (item.1395.name)
- hivecomb floor → хивекомб пол (item.13950.name)
- hivecomb floor → хивекомб пол (item.13951.name)
- unknown item → неизвестный предмет (item.13895.name)
- unknown item → неизвестный предмет (item.13896.name)
- drinks → напитки (item.13908.name)
- drinks → напитки (item.13909.name)
- golden anchor → золотой якорь (item.13941.name)
- golden anchor → золотой якорь (item.13942.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4858**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4711**
...
- **Pokrycie globalne (nominal):** **18.0%** (697,613/3,875,872)
- **Pokrycie globalne (real):** **10.92%** (423,222/3,875,872)
- **Kopie EN (łącznie):** **410,478**
- **Placeholdery [EN]/puste (łącznie):** **2,188,050**
...
| 🕒 Evidence window | 24h (span=37.47h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=37.47h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T07:20:19.289095Z → 2026-04-29T08:20:19.289095Z) |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 82 | 78.1% | ru/items.json (82) |
| `existing_canonical_name_quality_mixed_scripts` | 14 | 13.3% | ru/items.json (14) |
| `retry_loop_cooldown_default` | 9 | 8.6% | cs/items.json (4) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 29s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T08:19:55.761839Z
...
| Heartbeat | 136s temu | 2026-04-29T08:18:09Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T08:16:26.800772Z
...
- 2026-04-29 08:18:37 | AUTO_TRANSLATE:auto_start | ru | ok | items.json
- 2026-04-29 08:17:57 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 08:20:18
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **7,117** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 170 |
| ❌ Błędów | 302 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,339), **RU** (1,279), **TR** (1,032), **DE** (990), **IT** (967) |
| 📊 Porównanie | ↓ 13.5% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **26,097** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 08:20:18  
