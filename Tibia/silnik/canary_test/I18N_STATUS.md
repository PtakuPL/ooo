...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.03% / real 10.96%**. Tempo: **758.0 kluczy/h**. Tłumaczeń netto: **147,355**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 11:58:36

> **Aktualizacja:** 2026-04-29 11:58:36 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,345 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: es | Plik: items.json | Heartbeat: 2026-04-29T11:56:42Z
> **Okno godzinowe:** okno=1.0h | cykli=81 | pominięte=0.0% | odrzucone=5.7% | przepustowość=758.0/h  
> **Tłumaczeń netto:** 147,355

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 11:58:36 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T11:56:42Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 11:58:36 |
| TRANSLATION | 🟢 AKTYWNY | 11s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T11:58:31.768196Z |
| QUALITY | 🔒 NIEAKTYWNY | 10s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T11:58:32.840308Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 11:58:36 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T11:58:42.999389Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T11:56:42Z
...
| 🔄 **Ostatni cykl** | 31 kluczy, 0 odrzuconych, 82.4s, tryb: AUTO_TRANSLATE, cel: es/items.json |
| ❤️ **Heartbeat** | 2026-04-29T11:56:42Z |
...
| ⏳ Oldest pending (visible tail) | 17165 s |
| 🌍 Top języki | RU(386) |
...
| 🌍 Recent provider mix | TM/simple(294), Free Google Translate(180), canonical_name_semantic_autofix(21), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=498, fallbacks=25) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=990/990 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 386, 'oldest_s': 17165}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Tempo obliczone na bazie ostatniej godziny: ~758 kluczy/h.
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 11:58:36
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 11s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T11:58:31.768196Z
...
- the fist of the Colossus → fist de coloso (item.12011.name)
- the fist of the Colossus → fist de coloso (item.12012.name)
- the fist of the Colossus → fist de coloso (item.12013.name)
- dried grass roof → techo de pasto seco (item.1202.name)
- black jade cobra → cobra de jade negro (item.11695.name)
- the face of the Colossus → el rostro del coloso (item.12001.name)
- the face of the Colossus → el rostro del coloso (item.12002.name)
- the face of the Colossus → el rostro del coloso (item.12003.name)
- the beard of the Colossus → la barba del coloso (item.12004.name)
- the beard of the Colossus → la barba del coloso (item.12005.name)
- the beard of the Colossus → la barba del coloso (item.12006.name)
- the thumb of the Colossus → el pulgar del coloso (item.12009.name)
- the thumb of the Colossus → el pulgar del coloso (item.12010.name)
- the toes of the Colossus → los dedos del pie del coloso (item.12015.name)
- the toes of the Colossus → los dedos del pie del coloso (item.12016.name)
- the toes of the Colossus → los dedos del pie del coloso (item.12018.name)
- the toes of the Colossus → los dedos del pie del coloso (item.12019.name)
...
- Raporty strażnika jakości: **4934**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4787**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T11:57:10.071857Z |
...
| 🕒 Evidence window | 24h (span=41.11h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=41.11h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T10:58:37.108572Z → 2026-04-29T11:58:37.108572Z) |
...
| Przepustowość (kluczy/h) | **758.0 kluczy/h** |
| Podejrzane tłumaczenia | **1000** |
...
> Świeżość: 10s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T11:58:32.840308Z
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,345 |
| Heartbeat | 121s temu | 2026-04-29T11:56:42Z |
...
- 2026-04-29 11:57:10 | AUTO_TRANSLATE:auto_start | es | ok | items.json
- 2026-04-29 11:56:29 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 11:58:36

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+31, skipped+0) — lang=es file=items.json strict_skipped_done=1836
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **9,978** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 188 |
| ❌ Błędów | 435 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,753), **RU** (1,659), **IT** (1,501), **TR** (1,426), **DE** (1,395) |
| 📊 Porównanie | ↑ 21.3% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **28,958** kluczy
...
| 🔄 Cykli wykonanych | **#18,345** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,345 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 11:58:36  
