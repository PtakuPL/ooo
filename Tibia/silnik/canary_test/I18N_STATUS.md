...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-19 09:16:42

> **Aktualizacja:** 2026-02-19 09:16:42 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #1 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: parallel_start | Kategoria: ru | Plik: globalevents.json | Heartbeat: 2026-02-19T09:16:44Z  
...
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-19 09:16:42 |
| LIVE | 🟢 AKTYWNY | 1s temu | - | `activity.json / worker_state.json` | 2026-02-19T09:16:44Z |
| MIGRATION | 🔒 NIEAKTYWNY | 1d temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-19 09:16:42 |
| TRANSLATION | 🟢 AKTYWNY | 7s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-19T09:16:37.850983Z |
| QUALITY | 🔒 NIEAKTYWNY | 33s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-19T09:16:11.738764Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-19 09:16:42 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-19T09:16:44Z

| Metryka | Wartość |
|---------|---------|
| 🛠️ **Co robi** | Tłumaczenie automatyczne (Google Translate + TM) → tłumaczenie równoległe |
| 🌍 **Aktywne języki (10 min)** | IT, RU, SV |
| 📝 **Faza** | AUTO_TRANSLATE |
...
| ❤️ **Heartbeat** | 2026-02-19T09:16:44Z |
...
> Świeżość: 1d temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-19 09:16:42
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 7s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-19T09:16:37.850983Z
...
- Raporty strażnika jakości: **4009**  
- Raporty blokad: **0**  
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-19T08:16:42.753549Z → 2026-02-19T09:16:42.753549Z) |
...
| Najgorsze cele (strażnik) | es/npc.json (gf=0), pl/monsters.json (gf=0), es/server.json (gf=0), it/npc.json (gf=0), ru/npc.json (gf=0) |
...
> Świeżość: 33s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-19T09:16:11.738764Z

- **Ostatni audyt:** SLOW_MODE | 31 issue(s) / 100 entries | 2026-02-19T09:16:11.738764Z
- **Top 5 typów problemów:** suspicious_rejected_critical=171, suspicious_log_high=169, suspicious_rejected_high=29, suspicious_log_critical=20, artifact_token=16
- **Języki o najsłabszej jakości:** es(60.1, issues=256683), pl(60.1, issues=143920), ro(60.1, issues=77698), ru(60.1, issues=58983), it(60.1, issues=28181)
...
⚠️ **PL**: jakość 60%, 143920 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 256683 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 28181 problemów
⚠️ **RU**: jakość 60%, 58983 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 60%, 21881 problemów
...
| Heartbeat | 1s temu | 2026-02-19T09:16:44Z |
...
- 2026-02-19 09:16:44 | AUTO_TRANSLATE:parallel_start | ru | ok | globalevents.json
- 2026-02-19 09:16:39 | AUTO_TRANSLATE:heartbeat_tick | it | ok | dataroot.json
- 2026-02-19 09:16:39 | AUTO_TRANSLATE:parallel_start | it | ok | dataroot.json
- 2026-02-19 09:16:38 | AUTO_TRANSLATE:auto_done | sv | ok | otclient_modules.json
- 2026-02-19 09:16:35 | AUTO_TRANSLATE:heartbeat_tick | sv | ok | otclient_modules.json
- 2026-02-19 09:16:35 | AUTO_TRANSLATE:auto_start | sv | ok | otclient_modules.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-19 09:16:42

- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [it] → ok (translated+0, skipped+0) — parallel lang=it file=dataroot.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [sv] → ok (files+0, translated+0, skipped+0) — lang=sv file=otclient_modules.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [it] → ok (translated+0, skipped+0) — parallel lang=it file=dataroot.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → ok (files+0, translated+0, skipped+0) — lang=ru file=movements.json
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [it] → ok (translated+0, skipped+0) — parallel lang=it file=globalevents.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ro] → ok (translated+0, skipped+0) — parallel lang=ro file=globalevents.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [sr] → ok (files+0, translated+0, skipped+0) — lang=sr file=dataroot.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [sr] → ok (translated+0, skipped+0) — parallel lang=sr file=messages.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [sv] → ok (files+0, translated+0, skipped+0) — lang=sv file=globalevents.json
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-19 09:16:42  
