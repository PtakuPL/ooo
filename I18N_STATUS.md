...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.13%**. Tempo: **2044.1 kluczy/h**. Tłumaczeń netto: **79,539**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-16 22:48:48

> **Aktualizacja:** 2026-02-16 22:48:48 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #15 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: pl | Plik: items.json | Heartbeat: 2026-02-16T22:48:11Z  
> **Okno godzinowe:** okno=1.0h | cykli=119 | pominięte=0.0% | odrzucone=23.2% | przepustowość=2044.1/h  
> **Tłumaczeń netto:** 79,539

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-16 22:48:48 |
| LIVE | 🟢 AKTYWNY | 39s temu | - | `activity.json / worker_state.json` | 2026-02-16T22:48:11Z |
| MIGRATION | 🔒 NIEAKTYWNY | 14s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-16 22:48:48 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-16T22:47:02.541022Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-16T22:47:33.452376Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-16 22:48:48 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 39s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-16T22:48:11Z
...
| ❤️ **Heartbeat** | 2026-02-16T22:48:11Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **3,576** kluczy |
| ❌ Odrzucone (guard) | 1080 |
| 🔁 Cykli | 119 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | IT (701 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~2044 kluczy/h |
| 🛡️ Guard fail rate | 23.2% |
| ⚠️ Podejrzane | 13912 |
...
> **ETA globalne:** ~48 dni (2,364,827 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ██████████████░░░░░░ | 73.9% | 39,581/53,586 | ~6h |
| PL | ████████░░░░░░░░░░░░ | 43.4% | 23,261/53,586 | ~14h |
...
> Tempo obliczone na bazie ostatniej godziny: ~2044 kluczy/h.
...
> Świeżość: 14s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-16 22:48:48
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-16T22:47:02.541022Z
...
- Raporty strażnika jakości: **2383**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2321**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **10.13%** (282,285/2,786,472)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-16T21:48:49.202352Z → 2026-02-16T22:48:49.202352Z) |
...
| Przepustowość (kluczy/h) | **2044.1 kluczy/h** |
| Podejrzane tłumaczenia | **13912** |
| Najgorsze cele (strażnik) | pl/npc.json (gf=522), ro/monsters.json (gf=105), pl/monsters.json (gf=72), ru/monsters.json (gf=64), ru/raids.json (gf=46) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-16T22:47:33.452376Z

- **Ostatni audyt:** OK | 8 issue(s) / 100 entries | 2026-02-16T22:47:33.452376Z
- **Top 5 typów problemów:** suspicious_rejected_critical=161, suspicious_log_critical=102, suspicious_log_high=93, suspicious_rejected_high=39, identical_to_en_exempt=13
- **Języki o najsłabszej jakości:** es(60.1, issues=158311), ru(60.5, issues=12071), ro(60.7, issues=11317), tl(64.2, issues=466), zh_TW(64.8, issues=337)
...
⚠️ **PL**: jakość 94%, 115669 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 158311 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 71%, 5222 problemów
⚠️ **RU**: jakość 60%, 12071 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 91%, 2478 problemów
...
| Heartbeat | 39s temu | 2026-02-16T22:48:11Z |
...
- 2026-02-16 22:46:57 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | actions.json
- 2026-02-16 22:46:56 | AUTO_TRANSLATE:parallel_start | ro | ok | actions.json
- 2026-02-16 22:46:23 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | raids.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-16 22:48:48
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **14,841** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 87 |
| ❌ Błędów | 140 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (2,796), **IT** (2,339), **RU** (2,109), **SV** (2,070), **SR** (2,049) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **94,747** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-16 22:48:48  
