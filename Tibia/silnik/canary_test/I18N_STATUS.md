...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.88% / real 10.79%**. Tempo: **799.0 kluczy/h**. Tłumaczeń netto: **136,421**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-28 21:45:26

> **Aktualizacja:** 2026-04-28 21:45:26 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,160 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: cs | Plik: items.json | Heartbeat: 2026-04-28T21:44:17Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=3.3% | przepustowość=799.0/h  
> **Tłumaczeń netto:** 136,421

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-28 21:45:26 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-28T21:44:17Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 51s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-28 21:45:26 |
| TRANSLATION | 🟢 AKTYWNY | 3min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-28T21:42:27.876142Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-28T21:44:17.201472Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-28 21:45:26 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-28T21:45:32.620370Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-28T21:44:17Z
...
| ❤️ **Heartbeat** | 2026-04-28T21:44:17Z |
...
| ⏳ Oldest pending (visible tail) | 14968 s |
...
| 🌍 Recent provider mix | TM/simple(284), Free Google Translate(196), OpenAI model pool(31), canonical_name_semantic_autofix(15), ter... |
...
| ❤️ Pool health | `critical` (writes=529, fallbacks=15) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=334/334 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 389, 'oldest_s': 14968}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 51s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-28 21:45:26
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-28T21:42:27.876142Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-28T21:44:44.826234Z |
...
| 🕒 Evidence window | 24h (span=26.89h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=26.89h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-28T20:45:26.700398Z → 2026-04-28T21:45:26.700398Z) |
...
| Przepustowość (kluczy/h) | **799.0 kluczy/h** |
| Podejrzane tłumaczenia | **1168** |
| Najgorsze cele (strażnik) | cs/items.json (gf=10), ro/items.json (gf=8), de/otclient_modules.json (gf=3), de/npc.json (gf=3), it/items.json (gf=2) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-28T21:44:17.201472Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-28T21:44:17.201472Z
- **Top 5 typów problemów:** suspicious_rejected_critical=196, suspicious_log_low=76, suspicious_log_high=62, suspicious_log_medium=61, suspicious_rejected_high=4
- **Języki o najsłabszej jakości:** es(60.1, issues=722634), ro(60.1, issues=421762), ru(60.1, issues=355503), de(60.1, issues=105194), cs(60.1, issues=79123)
...
⚠️ **TR**: jakość 65%, 52320 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 722634 problemów
⚠️ **PT**: jakość 68%, 57379 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 78%, 166934 problemów
⚠️ **RU**: jakość 60%, 355503 problemów
⚠️ **NL**: jakość 60%, 72129 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,160 |
| Heartbeat | 75s temu | 2026-04-28T21:44:17Z |
...
- 2026-04-28 21:44:14 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **136,421** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=2.78%, reason=increase_low_fail_rate=2.8%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-28 21:45:26
...
| 🔄 Cykli wykonanych | **#17,160** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,160 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-28 21:45:26  
