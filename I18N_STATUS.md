...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.85%**. Tempo: **1371.5 kluczy/h**. Tłumaczeń netto: **116,880**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 18:17:07

> **Aktualizacja:** 2026-02-20 18:17:07 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #45 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: es | Plik: - | Heartbeat: 2026-02-20T18:17:04Z  
> **Okno godzinowe:** okno=1.0h | cykli=190 | pominięte=0.0% | odrzucone=67.6% | przepustowość=1371.5/h  
> **Tłumaczeń netto:** 116,880

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 18:17:07 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T18:17:04Z |
| MIGRATION | 🔒 NIEAKTYWNY | 50s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 18:17:07 |
| TRANSLATION | 🟢 AKTYWNY | 44s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T18:16:24.791105Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T18:17:08.951858Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 18:17:07 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T18:17:04Z
...
| ❤️ **Heartbeat** | 2026-02-20T18:17:04Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **2,473** kluczy |
| ❌ Odrzucone (guard) | 5162 |
| 🔁 Cykli | 190 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (596 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~1371 kluczy/h |
...
> Tempo obliczone na bazie ostatniej godziny: ~1371 kluczy/h.
...
> Świeżość: 50s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 18:17:07
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 44s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T18:16:24.791105Z
...
- Raporty strażnika jakości: **6743**  
- Raporty blokad: **0**  
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T17:17:08.292533Z → 2026-02-20T18:17:08.292533Z) |
| Cykle | **190** (TŁUMACZENIE=190, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **67.6%** |
| Cykle bez postępu % | **9.1%** |
| Przepustowość (kluczy/h) | **1371.5 kluczy/h** |
| Podejrzane tłumaczenia | **4041** |
| Najgorsze cele (strażnik) | pl/items.json (gf=1632), pl/npc.json (gf=1452), es/items.json (gf=1034), es/server.json (gf=82), es/spells.json (gf=73) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T18:17:08.951858Z

- **Ostatni audyt:** SLOW_MODE | 53 issue(s) / 100 entries | 2026-02-20T18:16:59.945738Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=114, artifact_token=48, suspicious_log_critical=45, suspicious_log_high=29, suspicious_rejected_high=23
- **Języki o najsłabszej jakości:** es(60.1, issues=326166), pl(60.1, issues=182677), ro(60.1, issues=178281), it(60.1, issues=72456), sr(62.1, issues=86199)
...
⚠️ **PL**: jakość 60%, 182677 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 326166 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 72456 problemów
⚠️ **RU**: jakość 80%, 210929 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #45 |
| Heartbeat | 5s temu | 2026-02-20T18:17:04Z |
...
- 2026-02-20 18:16:33 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 18:16:25 | AUTO_TRANSLATE:auto_done | es | ok | server.json
- 2026-02-20 18:16:04 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-02-20 18:16:04 | AUTO_TRANSLATE:auto_start | es | ok | server.json
- 2026-02-20 18:15:20 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 18:15:07 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | monsters.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,829 | 714 | 5895 (89.2%) | 38 |
| 🟡 ES | 84.7% | 0 | 2,163 | 792 | 3410 (81.2%) | 42 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **116,880** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=66.75%, reason=decrease_high_fail_rate=66.8% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,506 kluczy / 80 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 18:17:07
...
- 🤖 AUTO_TRANSLATE: TIER_QUALITY_GATE [-] → ok — __TIER_GATE__ tier1_avg=55.3% pass=False tier2_avg=9.1% pass=False rec=TIER1_INCOMPLETE: priorytet na PL/ES
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ru] → ok (translated+26, skipped+0) — parallel lang=ru file=monsters.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [it] → ok (translated+50, skipped+0) — parallel lang=it file=monsters.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+34, skipped+0) — lang=ro file=items.json strict_skipped_done=5027 guard_fail=16 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: TIER_QUALITY_GATE [-] → ok — __TIER_GATE__ tier1_avg=23.3% pass=False tier2_avg=8.5% pass=False rec=TIER1_INCOMPLETE: priorytet na PL/ES
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+24) — repair_identical lang=es file=npc.json target_identical=24 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=259.65
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [pl] → ok (translated+50, skipped+0) — parallel lang=pl file=items.json
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **6,349** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 45 |
| ❌ Błędów | 148 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (1,789), **RU** (1,187), **IT** (1,053), **PL** (753), **RO** (740) |
| 📊 Porównanie | ↑ 74.4% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **103,934** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 18:17:07  
