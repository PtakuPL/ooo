...
local function greetCallback(npc, creature, message)
	...
	if player:getStorageValue(Storage.Quest.U7_4.DjinnWar.MaridFaction.Mission03) ~= 3 then
		...
		if player:getStorageValue(Storage.Quest.U7_4.DjinnWar.EfreetFaction.Start) == 1 then
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nah_bob.multi_1")
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nah_bob.multi_2")
			endConversationWithDelay(npcHandler, npc, creature)
			return false
		end
	end
...
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_FAREWELL, "npc.nah_bob.farewell_msg_1")
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_WALKAWAY, "npc.nah_bob.walkaway_msg_1")
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_SENDTRADE, "npc.nah_bob.sendtrade_msg_1")
