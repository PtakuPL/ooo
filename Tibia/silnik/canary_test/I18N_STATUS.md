...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.93%**. Tempo: **1112.4 kluczy/h**. Tłumaczeń netto: **128,445**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-21 00:34:06

> **Aktualizacja:** 2026-02-21 00:34:06 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #36 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: - | Heartbeat: 2026-02-21T00:33:58Z  
> **Okno godzinowe:** okno=1.0h | cykli=153 | pominięte=0.0% | odrzucone=64.2% | przepustowość=1112.4/h  
> **Tłumaczeń netto:** 128,445

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-21 00:34:06 |
| LIVE | 🟢 AKTYWNY | 11s temu | - | `activity.json / worker_state.json` | 2026-02-21T00:33:58Z |
| MIGRATION | 🔒 NIEAKTYWNY | 46s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-21 00:34:06 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-21T00:32:58.519790Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-21T00:34:09.287558Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-21 00:34:06 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 11s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-21T00:33:58Z
...
| ❤️ **Heartbeat** | 2026-02-21T00:33:58Z |
...
| IT | 28,390 | 53,586 | 52.98% | 2,125 |
| RU | 27,058 | 53,586 | 50.49% | 1,494 |
| SR | 24,422 | 53,586 | 45.58% | 1,103 |
| RO | 23,569 | 53,586 | 43.98% | 2,342 |
...
> **ETA globalne:** ~85 dni (2,258,925 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| PL | █████████████████░░░ | 87.9% | 47,084/53,586 | ~3h |
| ES | █████████████████░░░ | 85.2% | 45,635/53,586 | ~5h |
| IT | ██████████░░░░░░░░░░ | 53.0% | 28,390/53,586 | ~20h |
| RU | ██████████░░░░░░░░░░ | 50.5% | 27,058/53,586 | ~21h |
| SR | █████████░░░░░░░░░░░ | 45.6% | 24,422/53,586 | ~24h |
| RO | ████████░░░░░░░░░░░░ | 44.0% | 23,569/53,586 | ~25h |
...
> Świeżość: 46s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-21 00:34:06
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-21T00:32:58.519790Z
...
| IT (Włoski) | 28,390/53,586 | 52.98% | 2,125 | 0 |
| RU (Rosyjski) | 27,058/53,586 | 50.49% | 1,494 | 0 |
| SR (SR) | 24,422/53,586 | 45.58% | 1,103 | 0 |
| RO (Rumuński) | 23,569/53,586 | 43.98% | 2,342 | 0 |
...
- Raporty strażnika jakości: **7465**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4569**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **13.93%** (388,187/2,786,472)
- **Kopie EN (łącznie):** **162,191**
...
| IT | 26,971/49,731 | 54.2% | 1,419/3,855 | 36.8% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T23:34:07.867517Z → 2026-02-21T00:34:07.867517Z) |
| Cykle | **153** (TŁUMACZENIE=153, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **64.2%** |
| Cykle bez postępu % | **4.7%** |
| Przepustowość (kluczy/h) | **1112.4 kluczy/h** |
| Podejrzane tłumaczenia | **4247** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-21T00:34:09.287558Z
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #36 |
| Heartbeat | 11s temu | 2026-02-21T00:33:58Z |
...
- 2026-02-21 00:33:16 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-21 00:32:40 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | monsters.json
- 2026-02-21 00:32:39 | AUTO_TRANSLATE:parallel_start | ro | ok | monsters.json
- 2026-02-21 00:32:31 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | monsters.json
- 2026-02-21 00:32:31 | AUTO_TRANSLATE:parallel_start | ru | ok | monsters.json
- 2026-02-21 00:32:28 | AUTO_TRANSLATE:auto_done | it | ok | monsters.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.9% | 0 | 1,831 | 473 | 2413 (83.6%) | 36 |
| 🟡 ES | 85.2% | 0 | 2,151 | 380 | 1884 (83.2%) | 30 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **128,445** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=63.3%, reason=decrease_high_fail_rate=63.3% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 853 kluczy / 66 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-21 00:34:06
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+11, skipped+0) — lang=es file=php.json strict_skipped_done=44 guard_fail=3 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **1,254** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 23 |
| ❌ Błędów | 40 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (323), **RU** (321), **IT** (225), **RO** (120), **PL** (116) |
| 📊 Porównanie | ↓ 94.6% vs wczoraj (23,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **89,583** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-21 00:34:06  
