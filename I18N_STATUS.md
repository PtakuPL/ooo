...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **11.13%**. Tempo: **627.2 kluczy/h**. Tłumaczeń netto: **80,935**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-15 14:28:49

> **Aktualizacja:** 2026-02-15 14:28:49 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #8,918 | Status: ✅ BEZCZYNNY | Faza: IDLE | Etap: cycle_start | Kategoria: - | Plik: - | Heartbeat: 2026-02-15T14:28:49Z  
> **Okno godzinowe:** okno=1.0h | cykli=196 | pominięte=0.0% | odrzucone=41.3% | przepustowość=627.2/h  
> **Tłumaczeń netto:** 80,935

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-15 14:28:49 |
| LIVE | 🟢 AKTYWNY | 1s temu | - | `activity.json / worker_state.json` | 2026-02-15T14:28:49Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 13s temu | worker w trybie IDLE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-15 14:28:49 |
| TRANSLATION | 🔒 NIEAKTYWNY | 37min temu | worker w trybie IDLE | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-15T13:51:26.415489Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie IDLE | `quality_audit_latest.json` | 2026-02-15T14:27:40.800567Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-15 14:28:49 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-15T14:28:49Z
...
| ❤️ **Heartbeat** | 2026-02-15T14:28:49Z |
...
> **ETA globalne:** ~155 dni (2,337,068 kluczy do celu 95%)
...
> Świeżość: 13s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-15 14:28:49
...
> Świeżość: 37min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-15T13:51:26.415489Z
...
- /startup/tables/load.lua → /inicio/tables/load.lua (startup.startup.msg1)
...
- **Profiler cyklu (ostatni):** cykl #10 (PRE_MIGRATION): dispatch 856ms, mode 660ms, status 6124ms, total 9701ms
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-15T13:28:49.387171Z → 2026-02-15T14:28:49.387171Z) |
| Cykle | **196** (TŁUMACZENIE=72, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **41.3%** |
| Cykle bez postępu % | **21.1%** |
| Przepustowość (kluczy/h) | **627.2 kluczy/h** |
| Podejrzane tłumaczenia | **37** |
| Najgorsze cele (strażnik) | es/server.json (gf=150), pl/npc.json (gf=20), es/npc.json (gf=20), el/npc.json (gf=8), lt/npc.json (gf=2) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-15T14:27:40.800567Z

- **Ostatni audyt:** OK | 7 issue(s) / 100 entries | 2026-02-15T14:27:40.800567Z
...
|-----------|--------|-----------|
| Worker | ✅ BEZCZYNNY | Cykl #8,918 |
| Heartbeat | 1s temu | 2026-02-15T14:28:49Z |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-15 14:28:49
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-15 14:28:49  
