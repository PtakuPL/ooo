...
> **[META]** 🟢 ACTIVE  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-14 02:07:28

> **Aktualizacja:** 2026-02-14 02:07:28 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #9 | Status: 🟢 RUNNING | Faza: AUTO_TRANSLATE | Etap: auto_done | Kategoria: es | Plik: html.json | ETA: 0 | Heartbeat: 2026-02-14T02:06:43Z  
> **Strict hourly (JSONL-only):** okno=1.0h | cycles=87 | pending_skip=0.0% | guard_fail=2.4% | throughput=1884.1/h  
> **Net effective translated:** 50,405

### 🧩 Status sekcji (P0.1)
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 ACTIVE | teraz | - | `update_github_status()` | 2026-02-14 02:07:28 |
| LIVE | 🟢 ACTIVE | 46s temu | - | `activity.json / worker_state.json` | 2026-02-14T02:06:43Z |
| MIGRATION | 🔒 INACTIVE | 7h temu | worker w trybie AUTO_TRANSLATE | `i18n_file_status.json` | 2026-02-14 02:07:28 |
| TRANSLATION | 🟢 ACTIVE | 46s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-14T02:06:42.883283Z |
| QUALITY | 🔒 INACTIVE | 57s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-14T02:06:31.062478Z |
| HISTORY | 🟢 ACTIVE | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-14 02:07:28 |
...
> **[LIVE]** 🟢 ACTIVE  
> Świeżość: 46s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-14T02:06:43Z
...
- **Plik:** `html.json`
- **Status:** 🟢 RUNNING
- **Heartbeat:** `2026-02-14T02:06:43Z`
...
> Świeżość: 7h temu | Źródło: `i18n_file_status.json` | Ostatnia aktualizacja: 2026-02-14 02:07:28
...
> **[TRANSLATION]** 🟢 ACTIVE  
> Świeżość: 46s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-14T02:06:42.883283Z
...
|-------|----------------|-------------------------------|---------|--------------|
| ES (Hiszpański) | 42,002/53,586 | 78.38% | 13,362 | 232 |
...
- Guard reports: **1777**  
- Blocker reports: **0**  
- Widoczne raporty 'nie mogę tłumaczyć': **1727**

### 🌐 Globalne info wszystkich języków
- **Global completion:** **20.43%** (569,150/2,786,472)
- **EN-copy łącznie:** **1,337,641**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-14T01:07:28.624105Z → 2026-02-14T02:07:28.624105Z) |
| Cykle | **87** (AUTO=87, MIGRATION=0) |
| Pending skip | **0** (all=0.0%, migration=0.0%) |
| Guard fail rate | **2.4%** |
| No progress rate | **0.0%** |
| Throughput | **1884.1 kluczy/h** |
| Suspicious | **866** |
...
> Świeżość: 57s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-14T02:06:31.062478Z

- **Ostatni audyt:** SLOW_MODE | 35 issue(s) / 100 entries | 2026-02-14T02:06:31.062478Z
- **Top 5 typów problemów:** suspicious_rejected_critical=200, suspicious_log_high=169, identical_to_en=35, suspicious_log_low=20, suspicious_log_critical=11
- **Języki o najsłabszej jakości:** es(60.1, issues=119036), pl(60.1, issues=95395), ru(60.3, issues=3598), he(60.4, issues=785), el(60.6, issues=913)
...
│ Plik: html.json                                               │
│ Postęp: 73/73 keys                                            │
│ …73 guard_fail=7 strict_missing_key=0 strict_skipped_done=517 │
├─────────────────────────────────────────────────────────────────┤
│ ❤️ Heartbeat: 2026-02-14T02:06:43Z           │
└─────────────────────────────────────────────────────────────────┘
```

### 🧾 Ostatnie akcje (dla czytelności)

- 2026-02-14 02:06:43 | AUTO_TRANSLATE:auto_done | es | ok | html.json
- 2026-02-14 02:06:36 | AUTO_TRANSLATE:auto_start | es | ok | html.json
- 2026-02-14 02:06:25 | AUTO_TRANSLATE:parallel_start | pl | ok | client.json
- 2026-02-14 02:05:43 | AUTO_TRANSLATE:auto_done | zh_TW | ok | npc.json
- 2026-02-14 02:04:57 | AUTO_TRANSLATE:auto_start | zh_TW | ok | npc.json
- 2026-02-14 02:04:49 | AUTO_TRANSLATE:parallel_start | zh | ok | npc.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 74.1% | 2,083 | 2,917 | 464 | 191 (29.2%) | 16 |
| 🟡 ES | 78.4% | 232 | 13,362 | 668 | 143 (17.6%) | 17 |

| KPI | Wartość | Target | Status |
|-----|---------|--------|--------|
| Net effective translated | **50,405** | — | 📊 |
| Adaptive batch | batch=50, gf_rate=5.33%, reason=stable_fail_rate=5.3% | gf <5% → increase | 📊 |
| Throughput (last window) | 1,132 keys / 33 entries | >50/h | 📊 |
...
> **[HISTORY]** 🟢 ACTIVE  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-14 02:07:28
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-14 02:07:28  
