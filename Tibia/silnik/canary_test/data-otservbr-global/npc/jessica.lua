...
npcConfig.voices = {
	interval = 15000,
	chance = 50,
	{ i18nKey = "npc.jessica.voice_1", yell = false },
}
...
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_GREET, "npc.jessica.greet_msg_1")
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_FAREWELL, "npc.jessica.farewell_msg_1")
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_WALKAWAY, "npc.jessica.walkaway_msg_1")
