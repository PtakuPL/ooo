...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.88% / real 10.79%**. Tempo: **908.0 kluczy/h**. Tłumaczeń netto: **136,596**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-28 21:54:48

> **Aktualizacja:** 2026-04-28 21:54:48 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,172 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: server.json | Heartbeat: 2026-04-28T21:53:01Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=3.7% | przepustowość=908.0/h  
> **Tłumaczeń netto:** 136,596

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-28 21:54:48 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-28T21:53:01Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 41s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-28 21:54:48 |
| TRANSLATION | 🟢 AKTYWNY | 20s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-28T21:54:33.943690Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-28T21:52:58.508633Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-28 21:54:48 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-28T21:54:54.311553Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-28T21:53:01Z
...
| 🧠 **Detail** | translated=18 guard_fail=0 strict_missing_key=0 strict_skipped_done=742 |
| 🔑 **Current key** | `es:server.json` |
| 🔄 **Ostatni cykl** | 18 kluczy, 0 odrzuconych, 76.0s, tryb: AUTO_TRANSLATE, cel: es/items.json |
| ❤️ **Heartbeat** | 2026-04-28T21:53:01Z |
...
| ⏳ Oldest pending (visible tail) | 15529 s |
...
| 🌍 Recent provider mix | TM/simple(286), Free Google Translate(199), OpenAI model pool(26), canonical_name_semantic_autofix(20), ter... |
...
| ❤️ Pool health | `critical` (writes=534, fallbacks=18) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=341/341 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 389, 'oldest_s': 15529}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~137 dni (2,989,067 kluczy do celu 95%)
...
> Świeżość: 41s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-28 21:54:48
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 20s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-28T21:54:33.943690Z
...
- skull pillar → pilar de cráneo (item.10838.name)
- skull pillar → pilar de cráneo (item.10839.name)
- corrupted wall → muro corrompido (item.10877.name)
- corrupted wall → muro corrompido (item.10878.name)
- corrupted wall → muro corrompido (item.10879.name)
- corrupted wall → muro corrompido (item.10880.name)
- corrupted wall → muro corrompido (item.10881.name)
- corrupted wall → muro corrompido (item.10882.name)
- corrupted wall → muro corrompido (item.10883.name)
- corrupted wall → muro corrompido (item.10884.name)
...
- Raporty strażnika jakości: **4640**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4493**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-28T21:53:18.330712Z |
...
| 🕒 Evidence window | 24h (span=27.04h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=27.04h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-28T20:54:48.831372Z → 2026-04-28T21:54:48.831372Z) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-28T21:52:58.508633Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-28T21:52:58.508633Z
- **Top 5 typów problemów:** suspicious_rejected_critical=197, suspicious_log_low=118, suspicious_log_high=80, suspicious_rejected_high=3, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=722791), ro(60.1, issues=421917), ru(60.1, issues=355725), de(60.1, issues=105330), cs(60.1, issues=79384)
...
⚠️ **ES**: jakość 60%, 722791 problemów
⚠️ **PT**: jakość 68%, 57427 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 67%, 167045 problemów
⚠️ **RU**: jakość 60%, 355725 problemów
⚠️ **NL**: jakość 60%, 72216 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,172 |
| Heartbeat | 113s temu | 2026-04-28T21:53:01Z |
...
- **Ostatnia aktualizacja:** 2026-04-28T21:54:49.126741Z
...
- 2026-04-28 21:54:49 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-28 21:54:34 | AUTO_TRANSLATE:auto_done | es | ok | items.json
- 2026-04-28 21:53:19 | AUTO_TRANSLATE:heartbeat_tick | es | ok | items.json
- 2026-04-28 21:53:18 | AUTO_TRANSLATE:auto_start | es | ok | items.json
- 2026-04-28 21:52:57 | AUTO_TRANSLATE:auto_done | ro | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-28 21:54:48
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **6,487** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 83 |
| ❌ Błędów | 256 |
| 🌍 Aktywnych języków | 9 |
| 🏆 TOP 5 | **DE** (1,092), **RU** (983), **IT** (787), **TR** (690), **RO** (687) |
| 📊 Porównanie | ↑ 25.0% vs wczoraj (5,188) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **29,347** kluczy
...
| 🔄 Cykli wykonanych | **#17,172** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,172 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-28 21:54:48  
