...
> **Aktualizacja:** 2025-12-12 03:59:25 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 21626
...
| 🔍 **Przeskanowane** | **1,022** | **13.2%** | historia workera |
| ⏳ Nie przeskanowane | **6,727** | 86.8% | czekają na skan |
...
|--------|-------|---------|------|
| ✅ Zmigrowane | **48** | 4.7% | mają klucze i18n |
...
|---------|---------|------|
| 🔑 **Klucze EN (źródłowe)** | **21,626** | wszystkie kategorie |
| 📊 NPC | 5,339 | dialogi NPC |
| 📊 Items | 13,749 | przedmioty |
| 📊 Monsters | 110 | potwory |
...
| 🔑 Kluczy wyekstrahowanych | **48** | w tej sesji |
...
│ Kategoria: 📁 MONSTERS                               │
├─────────────────────────────────────────────────────────────────┤
│ 📊 Pliki przeskanowane:     56 (wszystkie kategorie)          │
│    ├─ Kategoria MONSTERS:    110 kluczy EN                    │
│    └─ Total kluczy EN:  21626                                 │
├─────────────────────────────────────────────────────────────────┤
│ 📅 Ostatnia aktualizacja: 2025-12-12 03:59:25            │
└─────────────────────────────────────────────────────────────────┘
```
...
|---------|---------|-----------|
| 📁 Plików przeskanowanych | **48** | w tej sesji |
| ✅ Plików z kluczami | **48** | zawierały hardcoded strings |
| ⬜ Plików bez kluczy | **0** | czyste (brak hardcoded) |
| 🔑 Kluczy wyciągniętych | **48** | przez workera w tej sesji |
...
- 👹 `monsters` +43270 kluczy @ 03:59:23
...
| otclient_tools | 0m | 8x | Progresywny backoff |
| errors | 0m | 8x | Progresywny backoff |
...
📅 Auto-updated by Worker v1.1 | Last: 2025-12-12 03:59:25  
...
- ✅ `the_distorted_astral_source` - ukończono 2025-12-12 03:59
- ✅ `cosmic_energy_prism_b` - ukończono 2025-12-12 03:59
- ✅ `unbound_blightwalker` - ukończono 2025-12-12 03:59
- ✅ `frozen_man` - ukończono 2025-12-12 03:59
- ✅ `thorn_minion` - ukończono 2025-12-12 03:59
- ✅ `dragon_egg` - ukończono 2025-12-12 03:59
- ✅ `lost_time` - ukończono 2025-12-12 03:59
- ✅ `animated_sword` - ukończono 2025-12-12 03:59
- ✅ `soulcatcher` - ukończono 2025-12-12 03:59
- ✅ `icicle` - ukończono 2025-12-12 03:59
