...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.05% / real 10.97%**. Tempo: **671.0 kluczy/h**. Tłumaczeń netto: **148,340**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 13:25:35

> **Aktualizacja:** 2026-04-29 13:25:35 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,463 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: it | Plik: items.json | Heartbeat: 2026-04-29T13:22:16Z
> **Okno godzinowe:** okno=1.0h | cykli=83 | pominięte=0.0% | odrzucone=5.6% | przepustowość=671.0/h  
> **Tłumaczeń netto:** 148,340

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 13:25:35 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-04-29T13:22:16Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 13:25:35 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T13:24:36.522562Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T13:24:38.652087Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 13:25:35 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T13:25:44.656165Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T13:22:16Z

| Metryka | Wartość |
|---------|---------|
| 🛠️ **Co robi** | Tłumaczenie automatyczne (Google Translate + TM) |
| 🌍 **Aktywne języki (10 min)** | CS, IT, RO, RU |
| 📝 **Faza** | AUTO_TRANSLATE |
| 📋 **Etap** | sygnał życia |
| 📂 **Kategoria / Język** | it |
| 📄 **Plik** | items.json |
...
| ❤️ **Heartbeat** | 2026-04-29T13:22:16Z |
...
| ♻️ Deferred stats | enqueued=0, cooldown=4, deduped=4, manual_review=59, partial_staged=0, partial_completed=0 |
...
| 🌍 Recent provider mix | TM/simple(316), Free Google Translate(153), canonical_name_semantic_autofix(17), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=489, fallbacks=23) |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 397, 'oldest_s': 17027}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~185 dni (2,982,618 kluczy do celu 95%)
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 13:25:35
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T13:24:36.522562Z
...
- This lamp is glowing very dimly. → Această lampăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă luminează f (item.13656.desc)
- This lamp is glowing very dimly. → Această lampăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă luminează f (item.13658.desc)
- This is an emblem of wisdom. It was awarded by TibiaStat.com → Aceasta este o emblemăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă a  (item.14760.desc)
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T13:25:26.132649Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.05%** (699,450/3,875,872)
- **Pokrycie globalne (real):** **10.97%** (425,183/3,875,872)
- **Kopie EN (łącznie):** **410,354**
- **Placeholdery [EN]/puste (łącznie):** **2,186,213**
...
| 🕒 Evidence window | 24h (span=42.56h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=42.56h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T12:25:35.881859Z → 2026-04-29T13:25:35.881859Z) |
...
| Najgorsze cele (strażnik) | cs/items.json (gf=18), ro/items.json (gf=12), de/npc.json (gf=3), ru/items.json (gf=3), it/items.json (gf=2) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T13:24:38.652087Z
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,463 |
| Heartbeat | 208s temu | 2026-04-29T13:22:16Z |
...
- 2026-04-29 13:23:48 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 13:25:35
...
| 🔄 Cykli wykonanych | **#18,463** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,463 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 13:25:35  
