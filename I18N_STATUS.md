...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.62% / real 8.89%**. Tempo: **1572.0 kluczy/h**. Tłumaczeń netto: **72,606**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-29 05:23:51

> **Aktualizacja:** 2026-03-29 05:23:51 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #11,261 | Status: ✅ BEZCZYNNY | Faza: IDLE | Etap: cycle_start | Kategoria: - | Plik: - | Heartbeat: 2026-03-29T05:23:45Z  
> **Okno godzinowe:** okno=1.0h | cykli=139 | pominięte=0.0% | odrzucone=25.8% | przepustowość=1572.0/h  
> **Tłumaczeń netto:** 72,606

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-29 05:23:51 |
| LIVE | 🟢 AKTYWNY | 8s temu | - | `activity.json / worker_state.json` | 2026-03-29T05:23:45Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie IDLE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-29 05:23:51 |
| TRANSLATION | 🔒 NIEAKTYWNY | 33s temu | worker w trybie IDLE | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-29T05:23:19.886466Z |
| QUALITY | 🔒 NIEAKTYWNY | 13s temu | worker w trybie IDLE | `quality_audit_latest.json` | 2026-03-29T05:23:40.525471Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-29 05:23:51 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 8s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-29T05:23:45Z
...
| ❤️ **Heartbeat** | 2026-03-29T05:23:45Z |
...
| RU | 54,748 | 74,536 | 73.45% ↑+0.01% | 40,341 |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-29 05:23:51
...
> Świeżość: 33s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-29T05:23:19.886466Z
...
| RU (Rosyjski) | 73.45% (54,748/74,536) | 39.72% (29,602/74,536) | 40,341 | 939 | 3,704 |
...
- Raporty strażnika jakości: **3186**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3044**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 279 | 1 | 44,766 | - | 2026-03-29T05:23:03.876674Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.62%** (721,746/3,875,872)
- **Pokrycie globalne (real):** **8.89%** (344,532/3,875,872)
- **Kopie EN (łącznie):** **558,818**
- **Placeholdery [EN]/puste (łącznie):** **2,073,714**
- **Referencje `#i18n:` (łącznie):** **8,476**
- **Braki kluczy (łącznie):** **901,185**
...
- **Profiler cyklu (ostatni):** cykl #57 (AUTO_TRANSLATE): dispatch 11119ms, mode 36400ms, status 42ms, total 48757ms
...
| RU | 51,688/70,637 | 73.2% / 37.6% | 3,060/3,899 | 78.5% / 77.2% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-29T04:23:52.291827Z → 2026-03-29T05:23:52.291827Z) |
| Cykle | **139** (TŁUMACZENIE=119, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **25.8%** |
...
|--------|-----------|--------|----------------|
| `gt_rejected_critical` | 134 | 27.2% | cs/monsters.json (28) |
| `gt_validate_fail_placeholder` | 112 | 22.8% | es/npc.json (30) |
| `gt_validate_fail_word_salad` | 95 | 19.3% | es/npc.json (36) |
| `gt_validate_fail_wrong_script` | 80 | 16.3% | ru/html.json (79) |
| `gt_rejected_high_partial_translation_mix` | 29 | 5.9% | fr/html.json (9) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie IDLE)  
> Świeżość: 13s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-29T05:23:40.525471Z

- **Ostatni audyt:** OK | 2 issue(s) / 100 entries | 2026-03-29T05:23:40.525471Z
- **Top 5 typów problemów:** suspicious_rejected_critical=156, suspicious_log_high=113, suspicious_log_medium=64, suspicious_rejected_high=44, suspicious_log_critical=20
- **Języki o najsłabszej jakości:** es(60.1, issues=647125), ro(60.1, issues=348819), ru(60.1, issues=300088), de(60.1, issues=71043), pt(60.1, issues=24819)
...
⚠️ **TR**: jakość 86%, 8931 problemów
⚠️ **PL**: jakość 98%, 334709 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 647125 problemów
⚠️ **PT**: jakość 60%, 24819 problemów
⚠️ **FR**: jakość 60%, 23443 problemów
⚠️ **IT**: jakość 64%, 118122 problemów
⚠️ **RU**: jakość 60%, 300088 problemów
⚠️ **NL**: jakość 85%, 17217 problemów
...
|-----------|--------|-----------|
| Worker | ✅ BEZCZYNNY | Cykl #11,261 |
| Heartbeat | 8s temu | 2026-03-29T05:23:45Z |
...
- **Ostatnia aktualizacja:** 2026-03-29T05:23:34.357279Z
...
| 🌐 Pozostałe (3/53) | 🔄 | 563065 | Aktualnie: RU |

### 📦 Etap 1: Przygotowanie (SYNC)
- Języki z plikami przygotowanymi: 52/53
- Ostatni sync: RU/otclient_modules.json
...
- 2026-03-29 05:23:34 | AUTO_TRANSLATE:heartbeat_tick | es | ok | quests.json
- 2026-03-29 05:23:20 | AUTO_TRANSLATE:auto_done | nl | ok | client.json
- 2026-03-29 05:23:04 | AUTO_TRANSLATE:heartbeat_tick | nl | ok | client.json
- 2026-03-29 05:23:04 | AUTO_TRANSLATE:auto_start | nl | ok | client.json
- 2026-03-29 05:22:47 | TRANSLATION_SYNC:sync_done | ru | ok | otclient_modules.json
- 2026-03-29 05:22:47 | TRANSLATION_SYNC:sync_start | ru | ok | otclient_modules.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 70.1% | 0 | 5,871 | 656 | 852 (56.5%) | 26 |
| 🟡 ES | 75.2% | 0 | 9,677 | 972 | 389 (28.6%) | 23 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **72,606** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=35.56%, reason=decrease_high_fail_rate=35.6%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,628 kluczy / 49 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-29 05:23:51
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **3,886** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 41 |
| ❌ Błędów | 70 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **CS** (898), **RO** (897), **FR** (703), **NL** (576), **PT** (326) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **52,253** kluczy
...
| 🔄 Cykli wykonanych | **#11,261** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #11,261 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-29 05:23:51  
