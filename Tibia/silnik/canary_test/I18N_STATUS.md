...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.95%**. Tempo: **704.9 kluczy/h**. Tłumaczeń netto: **129,903**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-21 02:26:39

> **Aktualizacja:** 2026-02-21 02:26:39 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #55 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: auto_done | Kategoria: it | Plik: questlog.json | Heartbeat: 2026-02-21T02:26:40Z  
> **Okno godzinowe:** okno=1.0h | cykli=136 | pominięte=0.0% | odrzucone=69.8% | przepustowość=704.9/h  
> **Tłumaczeń netto:** 129,903

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-21 02:26:39 |
| LIVE | 🟢 AKTYWNY | 3s temu | - | `activity.json / worker_state.json` | 2026-02-21T02:26:40Z |
| MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-21 02:26:39 |
| TRANSLATION | 🟢 AKTYWNY | 3s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-21T02:26:39.531455Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-21T02:26:42.902581Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-21 02:26:39 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-21T02:26:40Z
...
| ❤️ **Heartbeat** | 2026-02-21T02:26:40Z |
...
> **ETA globalne:** ~133 dni (2,258,432 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| PL | █████████████████░░░ | 87.9% | 47,087/53,586 | ~5h |
| ES | █████████████████░░░ | 85.2% | 45,684/53,586 | ~7h |
| IT | ██████████░░░░░░░░░░ | 53.4% | 28,597/53,586 | ~32h |
| RU | ██████████░░░░░░░░░░ | 50.6% | 27,133/53,586 | ~34h |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-21 02:26:39
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 3s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-21T02:26:39.531455Z
...
- Raporty strażnika jakości: **7624**  
- Raporty blokad: **0**  
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-21T01:26:40.705544Z → 2026-02-21T02:26:40.705544Z) |
...
| Przepustowość (kluczy/h) | **704.9 kluczy/h** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-21T02:26:42.902581Z
...
| Heartbeat | 3s temu | 2026-02-21T02:26:40Z |
...
│ Plik: questlog.json                                           │
│ Postęp: 16/30 keys                                            │
│ …6 guard_fail=14 strict_missing_key=0 strict_skipped_done=147 │
├─────────────────────────────────────────────────────────────────┤
│ ❤️ Heartbeat: 2026-02-21T02:26:40Z           │
└─────────────────────────────────────────────────────────────────┘
```
...
- 2026-02-21 02:26:40 | AUTO_TRANSLATE:auto_done | it | ok | questlog.json
- 2026-02-21 02:26:27 | AUTO_TRANSLATE:heartbeat_tick | it | ok | questlog.json
- 2026-02-21 02:26:27 | AUTO_TRANSLATE:auto_start | it | ok | questlog.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-21 02:26:39
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-21 02:26:39  
