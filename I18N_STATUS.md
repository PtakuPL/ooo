...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.03% / real 10.95%**. Tempo: **733.0 kluczy/h**. Tłumaczeń netto: **146,772**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 11:07:43

> **Aktualizacja:** 2026-04-29 11:07:43 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,276 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: server.json | Heartbeat: 2026-04-29T11:07:27Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=6.0% | przepustowość=733.0/h  
> **Tłumaczeń netto:** 146,772

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 11:07:43 |
| LIVE | 🟢 AKTYWNY | 26s temu | - | `activity.json / worker_state.json` | 2026-04-29T11:07:27Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 11:07:43 |
| TRANSLATION | 🟢 AKTYWNY | 26s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T11:07:26.969633Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T11:05:32.717448Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 11:07:43 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T11:07:53.827145Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 26s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T11:07:27Z
...
| 🧠 **Detail** | translated=33 guard_fail=1 strict_missing_key=0 strict_skipped_done=3651 |
| 🔑 **Current key** | `es:server.json` |
| 🔄 **Ostatni cykl** | 33 kluczy, 1 odrzuconych, 96.0s, tryb: AUTO_TRANSLATE, cel: it/items.json |
| ❤️ **Heartbeat** | 2026-04-29T11:07:27Z |
...
| ⏳ Oldest pending (visible tail) | 15379 s |
...
| 🌍 Recent provider mix | TM/simple(330), Free Google Translate(143), canonical_name_semantic_autofix(18), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=494, fallbacks=18) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=951/951 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 385, 'oldest_s': 15379}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 11:07:43
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 26s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T11:07:26.969633Z
...
- hivecomb floor → pavimento dell'alveare (item.13956.name)
- hivecomb floor → pavimento dell'alveare (item.13957.name)
- hivecomb floor → pavimento dell'alveare (item.13958.name)
- hivecomb floor → pavimento dell'alveare (item.13959.name)
- ornamented wall → muro ornato (item.1396.name)
- hivecomb floor → pavimento dell'alveare (item.13960.name)
- hivecomb floor → pavimento dell'alveare (item.13961.name)
- hivecomb floor → pavimento dell'alveare (item.13962.name)
- hivecomb floor → pavimento dell'alveare (item.13963.name)
- hivecomb floor → pavimento dell'alveare (item.13964.name)
- hivecomb floor → pavimento dell'alveare (item.13965.name)
- hivecomb floor → pavimento dell'alveare (item.13966.name)
- hivecomb floor → pavimento dell'alveare (item.13967.name)
- ornamented wall → muro ornato (item.1397.name)
- ornamented wall → muro ornato (item.1398.name)
- shallow water → acque poco profonde (item.13988.name)
- shallow water → acque poco profonde (item.13989.name)
- wall fountain → fontana a muro (item.1399.name)
- wall fountain → fontana a muro (item.1400.name)
- trophy of Tanjis → trofeo di Tanjis (item.14004.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4917**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4770**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T11:05:50.326130Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.03%** (698,632/3,875,872)
- **Pokrycie globalne (real):** **10.95%** (424,312/3,875,872)
- **Kopie EN (łącznie):** **410,407**
- **Placeholdery [EN]/puste (łącznie):** **2,187,031**
...
| 🕒 Evidence window | 24h (span=40.26h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=40.26h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T10:07:44.462694Z → 2026-04-29T11:07:44.462694Z) |
...
| Podejrzane tłumaczenia | **1165** |
| Najgorsze cele (strażnik) | cs/items.json (gf=24), ro/items.json (gf=12), de/npc.json (gf=3), ru/items.json (gf=3), it/items.json (gf=3) |
...
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T11:05:32.717448Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T11:05:32.717448Z
- **Top 5 typów problemów:** suspicious_rejected_critical=190, suspicious_log_high=117, suspicious_log_low=82, suspicious_rejected_high=10, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=745151), ro(60.1, issues=440644), de(60.1, issues=123418), cs(60.1, issues=110632), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 745151 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 78%, 177160 problemów
⚠️ **RU**: jakość 62%, 370899 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,276 |
| Heartbeat | 26s temu | 2026-04-29T11:07:27Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T11:07:42.313692Z
...
- 2026-04-29 11:07:43 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-29 11:07:27 | AUTO_TRANSLATE:auto_done | it | ok | items.json
- 2026-04-29 11:07:22 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-04-29 11:05:52 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-04-29 11:05:51 | AUTO_TRANSLATE:auto_start | it | ok | items.json
- 2026-04-29 11:05:31 | AUTO_TRANSLATE:auto_done | ro | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **146,772** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=7.89%, reason=stable_fail_rate=7.9%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 11:07:43

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+33, skipped+0) — lang=it file=items.json strict_skipped_done=3651 guard_fail=1 placeholder=0 command=0 pipe=0
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+18, skipped+0) — lang=es file=items.json strict_skipped_done=1127
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+0) — repair_identical lang=es file=otclient_modules.json target_identical=37 limit=180 tier=low_backlog domain_cap=220 gt=true suspicious_pct=5.42
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [tr] → warn (files+1, translated+543, skipped+0) — lang=tr file=npc.json strict_skipped_done=2473 guard_fail=156 placeholder=87 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **9,342** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 185 |
| ❌ Błędów | 406 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,670), **RU** (1,598), **IT** (1,407), **TR** (1,315), **DE** (1,305) |
| 📊 Porównanie | ↑ 13.5% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **28,322** kluczy
...
| 🔄 Cykli wykonanych | **#18,276** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,276 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 11:07:43  
