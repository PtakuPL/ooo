...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.88% / real 10.8%**. Tempo: **931.0 kluczy/h**. Tłumaczeń netto: **136,905**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-28 22:18:12

> **Aktualizacja:** 2026-04-28 22:18:12 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,204 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: items.json | Heartbeat: 2026-04-28T22:17:14Z
> **Okno godzinowe:** okno=1.0h | cykli=83 | pominięte=0.0% | odrzucone=3.7% | przepustowość=931.0/h  
> **Tłumaczeń netto:** 136,905

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-28 22:18:12 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-28T22:17:14Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 11s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-28 22:18:12 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-28T22:16:56.924424Z |
| QUALITY | 🔒 NIEAKTYWNY | 3min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-28T22:15:12.624112Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-28 22:18:12 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-28T22:18:19.119636Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-28T22:17:14Z
...
| 🔄 **Ostatni cykl** | 18 kluczy, 0 odrzuconych, 73.0s, tryb: AUTO_TRANSLATE, cel: es/items.json |
| ❤️ **Heartbeat** | 2026-04-28T22:17:14Z |
...
| ⏳ Oldest pending (visible tail) | 15601 s |
...
| 🕒 Deferred state freshness | fresh (81s) |
...
| 🌍 Recent provider mix | TM/simple(268), Free Google Translate(214), canonical_name_semantic_autofix(21), OpenAI model pool(19), ter... |
...
| ❤️ Pool health | `critical` (writes=525, fallbacks=22) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=359/359 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 389, 'oldest_s': 15601}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~134 dni (2,988,874 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 78.6% | 58,563/74,536 | ~13h |
...
> Świeżość: 11s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-28 22:18:12
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-28T22:16:56.924424Z
...
- corrupted wall → muro corrompido (item.10885.name)
- corrupted wall → muro corrompido (item.10886.name)
- corrupted wall → muro corrompido (item.10887.name)
- corrupted wall → muro corrompido (item.10888.name)
- corrupted wall → muro corrompido (item.10889.name)
- corrupted wall → muro corrompido (item.10890.name)
- corrupted wall → muro corrompido (item.10891.name)
- corrupted wall → muro corrompido (item.10892.name)
- corrupted wall → muro corrompido (item.10893.name)
- corrupted wall → muro corrompido (item.10894.name)
- corrupted wall → muro corrompido (item.10895.name)
- corrupted wall → muro corrompido (item.10896.name)
...
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4501**
...
| 🕒 Evidence window | 24h (span=27.43h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=27.43h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-28T21:18:13.338867Z → 2026-04-28T22:18:13.338867Z) |
...
| Przepustowość (kluczy/h) | **931.0 kluczy/h** |
| Podejrzane tłumaczenia | **1116** |
...
> Świeżość: 3min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-28T22:15:12.624112Z
...
| Heartbeat | 65s temu | 2026-04-28T22:17:14Z |
...
- **Ostatnia aktualizacja:** 2026-04-28T22:17:13.596788Z
...
- 2026-04-28 22:17:14 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-28 22:16:57 | AUTO_TRANSLATE:auto_done | es | ok | items.json
...
| Przepustowość (okno) | 333 kluczy / 15 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-28 22:18:12

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+18, skipped+0) — lang=es file=items.json strict_skipped_done=753
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-28 22:18:12  
