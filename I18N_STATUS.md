...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.84%**. Tempo: **1466.4 kluczy/h**. Tłumaczeń netto: **115,798**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 17:47:48

> **Aktualizacja:** 2026-02-20 17:47:48 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #19 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: es | Plik: - | Heartbeat: 2026-02-20T17:47:45Z  
> **Okno godzinowe:** okno=1.0h | cykli=155 | pominięte=0.0% | odrzucone=59.3% | przepustowość=1466.4/h  
> **Tłumaczeń netto:** 115,798

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 17:47:48 |
| LIVE | 🟢 AKTYWNY | 4s temu | - | `activity.json / worker_state.json` | 2026-02-20T17:47:45Z |
| MIGRATION | 🔒 NIEAKTYWNY | 26s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 17:47:48 |
| TRANSLATION | 🟢 AKTYWNY | 39s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T17:47:09.961497Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T17:47:49.653250Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 17:47:48 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 4s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T17:47:45Z
...
| ❤️ **Heartbeat** | 2026-02-20T17:47:45Z |
...
> **ETA globalne:** ~64 dni (2,261,331 kluczy do celu 95%)
...
> Świeżość: 26s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 17:47:48
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 39s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T17:47:09.961497Z
...
- Raporty strażnika jakości: **6681**  
- Raporty blokad: **0**  
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T16:47:49.038373Z → 2026-02-20T17:47:49.038373Z) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T17:47:49.653250Z

- **Ostatni audyt:** SLOW_MODE | 32 issue(s) / 100 entries | 2026-02-20T17:47:44.892054Z | recent_hidden=0
- **Alarm recent hidden HIGH/CRITICAL:** ✅ OK | hidden=0, threshold=5, trend=→ last10=0.00, prev10=0.00, latest=0
- **Regresja critical bad keys pack:** 🚨 FAIL: pl(critical=48, pack=0), es(critical=40, pack=0)
- **Top 5 typów problemów:** suspicious_rejected_critical=157, suspicious_log_critical=48, suspicious_log_high=35, artifact_token=32, suspicious_rejected_high=23
- **Języki o najsłabszej jakości:** es(60.1, issues=322318), ro(60.1, issues=176376), it(60.1, issues=71004), pl(63.3, issues=181182), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 63%, 181182 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 322318 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 71004 problemów
⚠️ **RU**: jakość 71%, 210401 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 78%, 29978 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #19 |
| Heartbeat | 4s temu | 2026-02-20T17:47:45Z |
...
- 2026-02-20 17:47:18 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 17:46:46 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | talkactions.json
- 2026-02-20 17:46:46 | AUTO_TRANSLATE:parallel_start | pl | ok | talkactions.json
- 2026-02-20 17:46:45 | AUTO_TRANSLATE:auto_done | es | ok | modules.json
- 2026-02-20 17:46:39 | AUTO_TRANSLATE:heartbeat_tick | es | ok | modules.json
- 2026-02-20 17:46:39 | AUTO_TRANSLATE:auto_start | es | ok | modules.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,829 | 812 | 5880 (87.9%) | 39 |
| 🟡 ES | 84.7% | 0 | 2,164 | 785 | 2936 (78.9%) | 40 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **115,798** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=34.78%, reason=decrease_high_fail_rate=34.8% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,597 kluczy / 79 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 17:47:48
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+50, skipped+0) — lang=ro file=npc.json strict_skipped_done=207
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+24) — repair_identical lang=es file=npc.json target_identical=24 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=61.42
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → warn (files+1, translated+50, skipped+0) — lang=ru file=npc.json strict_skipped_done=154
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **4,662** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 19 |
| ❌ Błędów | 107 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (1,235), **RU** (875), **IT** (801), **RO** (543), **PL** (501) |
| 📊 Porównanie | ↑ 28.0% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **102,247** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 17:47:48  
