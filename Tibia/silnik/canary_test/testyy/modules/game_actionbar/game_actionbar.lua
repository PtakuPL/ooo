...
function createMenu(slotId)
    ...
    slotToEdit = slotId
    menu:addOption(tr("otclient_modules.game_actionbar.tr_7"), function()
        openSpellAssignWindow()
    end)
    menu:addOption(tr("otclient_modules.game_actionbar.tr_6"), function()
        startChooseItem()
        openObjectAssignWindow()
    end)
    menu:addOption(tr("otclient_modules.game_actionbar.tr_5"), function()
        openTextAssignWindow()
    end)
    menu:addOption(tr("otclient_modules.game_actionbar.tr_4"), function()
    ...
    if actionSlot.itemId or actionSlot.words or actionSlot.text or actionSlot.useType or actionSlot.hotkey then
        menu:addOption(tr("otclient_modules.game_actionbar.tr_3"), function()
            clearSlot()
            clearHotkey()
        end)
    end
...
function hotkeyCapture(assignWindow, keyCode, keyboardModifiers)
    ...
    comboPreview:setText(tr("otclient_modules.game_actionbar.tr_2", keyCombo))
...
function hotkeyClear(assignWindow)
    local comboPreview = assignWindow:recursiveGetChildById('comboPreview')
    comboPreview:setText(tr("otclient_modules.game_actionbar.tr_1"))
