...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-27 16:27:44

> **Aktualizacja:** 2026-04-27 16:27:44 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #16,424 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: nl | Plik: questlog.json | Heartbeat: 2026-04-27T16:24:27Z
...
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-27 16:27:44 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-04-27T16:24:27Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 57s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-27 16:27:44 |
| TRANSLATION | 🟢 AKTYWNY | 8min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-27T16:19:48.635194Z |
| QUALITY | 🔒 NIEAKTYWNY | 8min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-27T16:19:49.915224Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-27 16:27:44 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-27T16:27:51.174245Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-27T16:24:27Z
...
| 🔄 **Ostatni cykl** | 26 kluczy, 0 odrzuconych, 0s, tryb: AUTO_TRANSLATE, cel: nl/scripts.json |
| ❤️ **Heartbeat** | 2026-04-27T16:24:27Z |
...
| ⏳ Oldest pending (visible tail) | 335429 s |
| 🌍 Top języki | NL(127), ES(117), PT(114), PL(28) |
| 🧱 Top reason_bucket | placeholder(164), provider_error(105), default(78), word_salad(19) |
| 🗂️ Deferred state keys | 7749 |
...
| ❤️ Pool health | `critical` (writes=418, fallbacks=106) |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 335429}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 57s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-27 16:27:44
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 8min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-27T16:19:48.635194Z
...
| 🕒 Evidence window | 24h (span=69.31h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=69.31h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-0.10pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-27T15:27:44.745958Z → 2026-04-27T16:27:44.745958Z) |
...
|--------|-----------|--------|----------------|
| `gt_validate_fail_placeholder` | 164 | 55.8% | pt/npc.json (54) |
| `gt_validate_fail_identical_to_en` | 69 | 23.5% | nl/npc.json (28) |
| `gt_partial_validate_word_salad` | 19 | 6.5% | es/server.json (10) |
| `gt_rejected_critical` | 15 | 5.1% | pt/npc.json (6) |
| `gt_partial_translation_mix` | 11 | 3.7% | nl/html.json (4) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 8min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-27T16:19:49.915224Z
...
| Heartbeat | 204s temu | 2026-04-27T16:24:27Z |
...
- **TOP 5 języków:** DE (19,929), NL (16,438), CS (15,290), PT (14,617), FR (13,232)
- **Aktualnie naprawia:** ES / -
- **Ostatnia aktualizacja:** 2026-04-27T16:27:40.635620Z
...
- 2026-04-27 16:27:28 | AUTO_TRANSLATE:heartbeat_tick | nl | ok | questlog.json
- 2026-04-27 16:25:58 | AUTO_TRANSLATE:heartbeat_tick | nl | ok | questlog.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-27 16:27:44
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-27 16:27:44  
