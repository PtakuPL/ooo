...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.97% / real 8.9%**. Tempo: **1758.0 kluczy/h**. Tłumaczeń netto: **72,201**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-29 04:53:18

> **Aktualizacja:** 2026-03-29 04:53:18 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #11,146 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-03-29T04:52:28Z  
> **Okno godzinowe:** okno=1.0h | cykli=37 | pominięte=0.0% | odrzucone=18.5% | przepustowość=1758.0/h  
> **Tłumaczeń netto:** 72,201

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-29 04:53:18 |
| LIVE | 🟢 AKTYWNY | 52s temu | - | `activity.json / worker_state.json` | 2026-03-29T04:52:28Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 34s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-29 04:53:18 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-29T04:52:14.100746Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-29T04:51:57.325879Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-29 04:53:18 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 52s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-29T04:52:28Z
...
| ❤️ **Heartbeat** | 2026-03-29T04:52:28Z |
...
> **ETA globalne:** ~70 dni (2,946,628 kluczy do celu 95%)
...
> Świeżość: 34s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-29 04:53:18
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-29T04:52:14.100746Z
...
- player_datatable table table-striped table-bordered table-responsive d-md-table → player_datatable table table-striped table-bordered table-responsywny d-md-table (php.players.text4)
...
- Raporty strażnika jakości: **3162**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3020**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 279 | 1 | 47,151 | - | 2026-03-29T04:52:03.135551Z |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-29T03:53:18.635794Z → 2026-03-29T04:53:18.635794Z) |
| Cykle | **37** (TŁUMACZENIE=33, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **18.5%** |
| Cykle bez postępu % | **11.1%** |
| Przepustowość (kluczy/h) | **1758.0 kluczy/h** |
| Podejrzane tłumaczenia | **1045** |
| Najgorsze cele (strażnik) | cs/monsters.json (gf=173), nl/monsters.json (gf=103), pt/monsters.json (gf=80), pl/html.json (gf=21), es/html.json (gf=11) |
...
|--------|-----------|--------|----------------|
| `gt_rejected_critical` | 258 | 55.7% | cs/monsters.json (99) |
| `gt_validate_fail_word_salad` | 105 | 22.7% | es/npc.json (35) |
| `gt_rejected_high_trimmed_en_copy` | 33 | 7.1% | cs/monsters.json (31) |
| `gt_rejected_high_partial_translation_mix` | 31 | 6.7% | cs/monsters.json (16) |
| `gt_validate_fail_placeholder` | 26 | 5.6% | es/npc.json (26) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-29T04:51:57.325879Z

- **Ostatni audyt:** SLOW_MODE | 15 issue(s) / 100 entries | 2026-03-29T04:51:57.325879Z
- **Top 5 typów problemów:** suspicious_rejected_critical=158, suspicious_log_high=151, suspicious_log_critical=49, suspicious_rejected_high=42, artifact_token=15
- **Języki o najsłabszej jakości:** es(60.1, issues=642696), it(60.1, issues=117464), cs(60.2, issues=18033), ro(60.3, issues=348093), pt(66.7, issues=24273)
...
⚠️ **PL**: jakość 71%, 334506 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 642696 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #11,146 |
| Heartbeat | 52s temu | 2026-03-29T04:52:28Z |
...
- **Ostatnia aktualizacja:** 2026-03-29T04:52:28.342580Z
...
- 2026-03-29 04:52:28 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-03-29 04:52:14 | AUTO_TRANSLATE:auto_done | pl | ok | php.json
- 2026-03-29 04:52:03 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | php.json
- 2026-03-29 04:52:03 | AUTO_TRANSLATE:auto_start | pl | ok | php.json
- 2026-03-29 04:51:56 | AUTO_TRANSLATE:auto_done | es | ok | client.json
- 2026-03-29 04:51:49 | AUTO_TRANSLATE:heartbeat_tick | es | ok | client.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 70.1% | 0 | 5,871 | 633 | 852 (57.4%) | 26 |
| 🟡 ES | 94.1% | 2,341 | 23,527 | 968 | 389 (28.7%) | 22 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **72,201** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=19.32%, reason=stable_fail_rate=19.3%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,601 kluczy / 48 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-29 04:53:18
...
| 🔄 Cykli wykonanych | **#11,146** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #11,146 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-29 04:53:18  
