...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.94%**. Tempo: **785.5 kluczy/h**. Tłumaczeń netto: **129,472**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-21 01:53:22

> **Aktualizacja:** 2026-02-21 01:53:22 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #36 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: server.json | Heartbeat: 2026-02-21T01:52:50Z  
> **Okno godzinowe:** okno=1.0h | cykli=140 | pominięte=0.0% | odrzucone=76.9% | przepustowość=785.5/h  
> **Tłumaczeń netto:** 129,472

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-21 01:53:22 |
| LIVE | 🟢 AKTYWNY | 34s temu | - | `activity.json / worker_state.json` | 2026-02-21T01:52:50Z |
| MIGRATION | 🔒 NIEAKTYWNY | 38s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-21 01:53:22 |
| TRANSLATION | 🟢 AKTYWNY | 10s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-21T01:53:13.970755Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-21T01:53:24.466508Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-21 01:53:22 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 34s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-21T01:52:50Z
...
| ❤️ **Heartbeat** | 2026-02-21T01:52:50Z |
...
> **ETA globalne:** ~120 dni (2,258,554 kluczy do celu 95%)
...
> Świeżość: 38s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-21 01:53:22
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 10s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-21T01:53:13.970755Z
...
- [ES/server.json] You have chosen your vocation. You cannot go back. → Has elegido tu vocación. No puedes regresar. (data.otservbr.global.scripts.movements.others.dawnport.tiles.L48.2334)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **7579**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4683**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **13.94%** (388,558/2,786,472)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-21T00:53:23.161670Z → 2026-02-21T01:53:23.161670Z) |
| Cykle | **140** (TŁUMACZENIE=140, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **76.9%** |
| Cykle bez postępu % | **5.5%** |
| Przepustowość (kluczy/h) | **785.5 kluczy/h** |
| Podejrzane tłumaczenia | **2360** |
| Najgorsze cele (strażnik) | pl/items.json (gf=1634), pl/npc.json (gf=1008), es/items.json (gf=956), sr/server.json (gf=56), es/server.json (gf=55) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-21T01:53:24.466508Z
...
| Heartbeat | 34s temu | 2026-02-21T01:52:50Z |
...
- 2026-02-21 01:52:50 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-02-21 01:52:49 | AUTO_TRANSLATE:parallel_start | es | ok | server.json
- 2026-02-21 01:52:39 | AUTO_TRANSLATE:heartbeat_tick | es | ok | monsters.json
- 2026-02-21 01:52:39 | AUTO_TRANSLATE:parallel_start | es | ok | monsters.json
- 2026-02-21 01:52:36 | AUTO_TRANSLATE:auto_done | pl | ok | monsters.json
- 2026-02-21 01:52:24 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | monsters.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.9% | 0 | 1,831 | 517 | 4098 (88.8%) | 42 |
| 🟡 ES | 85.2% | 0 | 2,152 | 342 | 1890 (84.7%) | 31 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **129,472** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=95.16%, reason=decrease_high_fail_rate=95.2% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 859 kluczy / 73 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-21 01:53:22

- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+3, skipped+0) — parallel lang=es file=server.json
...
| ❌ Błędów | 122 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **RU** (748), **ES** (722), **IT** (517), **PL** (452), **SR** (293) |
| 📊 Porównanie | ↓ 86.2% vs wczoraj (23,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **91,535** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-21 01:53:22  
