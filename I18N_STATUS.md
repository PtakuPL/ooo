...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.03% / real 10.95%**. Tempo: **711.0 kluczy/h**. Tłumaczeń netto: **147,218**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 11:46:53

> **Aktualizacja:** 2026-04-29 11:46:53 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,332 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: cs | Plik: items.json | Heartbeat: 2026-04-29T11:45:33Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=4.7% | przepustowość=711.0/h  
> **Tłumaczeń netto:** 147,218

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 11:46:53 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T11:45:33Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 39s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 11:46:53 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T11:45:31.535970Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T11:45:32.673607Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 11:46:53 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T11:47:01.417831Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T11:45:33Z
...
| 🔄 **Ostatni cykl** | 30 kluczy, 1 odrzuconych, 85.0s, tryb: AUTO_TRANSLATE, cel: ru/items.json |
| ❤️ **Heartbeat** | 2026-04-29T11:45:33Z |
...
| ⏳ Oldest pending (visible tail) | 16463 s |
| 🌍 Top języki | RU(386) |
...
| 🌍 Recent provider mix | TM/simple(330), Free Google Translate(163), canonical_name_semantic_autofix(16), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=512, fallbacks=20) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=982/982 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 386, 'oldest_s': 16463}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~175 dni (2,983,232 kluczy do celu 95%)
...
> Świeżość: 39s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 11:46:53
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T11:45:31.535970Z
...
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14428.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14429.name)
- lava wall → лавовая стена (item.1443.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14430.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14431.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14432.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14433.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14434.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14435.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14436.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14437.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14438.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14439.name)
- lava wall → лавовая стена (item.1444.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14440.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14441.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14442.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14443.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14444.name)
- RESERVED SPRITE → РЕСЕРВЕД СПРИТЕ (item.14445.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4930**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4783**
...
- **Pokrycie globalne (nominal):** **18.03%** (698,836/3,875,872)
- **Pokrycie globalne (real):** **10.95%** (424,538/3,875,872)
- **Kopie EN (łącznie):** **410,385**
- **Placeholdery [EN]/puste (łącznie):** **2,186,827**
...
| 🕒 Evidence window | 24h (span=40.91h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=40.91h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T10:46:54.734579Z → 2026-04-29T11:46:54.734579Z) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T11:45:32.673607Z
...
| Heartbeat | 88s temu | 2026-04-29T11:45:33Z |
...
- 2026-04-29 11:44:06 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-04-29 11:44:06 | AUTO_TRANSLATE:auto_start | ru | ok | items.json
- 2026-04-29 11:43:27 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 11:46:53
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **9,823** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 185 |
| ❌ Błędów | 428 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,711), **RU** (1,659), **IT** (1,463), **TR** (1,426), **DE** (1,395) |
| 📊 Porównanie | ↑ 19.4% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **28,803** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 11:46:53  
