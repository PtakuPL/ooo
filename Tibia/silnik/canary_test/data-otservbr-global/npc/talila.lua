...
npcConfig.voices = {
	interval = 15000,
	chance = 50,
	{ i18nKey = "npc.talila.voice_1" },
	{ i18nKey = "npc.talila.voice_2" },
	{ i18nKey = "npc.talila.voice_3" },
}
...
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_GREET, "npc.talila.greet_msg_1")
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_SENDTRADE, "npc.talila.sendtrade_msg_1")
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_FAREWELL, "npc.talila.farewell_msg_1")
