...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **9.91%**. Tempo: **3227.6 kluczy/h**. Tłumaczeń netto: **70,687**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-16 20:46:52

> **Aktualizacja:** 2026-02-16 20:46:52 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #23 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: pl | Plik: - | Heartbeat: 2026-02-16T20:46:46Z  
> **Okno godzinowe:** okno=1.0h | cykli=90 | pominięte=0.0% | odrzucone=16.0% | przepustowość=3227.6/h  
> **Tłumaczeń netto:** 70,687

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-16 20:46:52 |
| LIVE | 🟢 AKTYWNY | 7s temu | - | `activity.json / worker_state.json` | 2026-02-16T20:46:46Z |
| MIGRATION | 🔒 NIEAKTYWNY | 35min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-16 20:46:52 |
| TRANSLATION | 🟢 AKTYWNY | 31s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-16T20:46:21.952704Z |
| QUALITY | 🔒 NIEAKTYWNY | 7s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-16T20:46:46.126323Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-16 20:46:52 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 7s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-16T20:46:46Z
...
| ❤️ **Heartbeat** | 2026-02-16T20:46:46Z |
...
| ⚡ Przepustowość | ~3228 kluczy/h |
| 🛡️ Guard fail rate | 16.0% |
| ⚠️ Podejrzane | 10057 |
...
|-------|---------------|-----------|----------|----------|
| ES | 39,284 | 53,586 | 73.31% | 2,649 |
| PL | 22,754 | 53,586 | 42.46% | 1,853 |
...
> **ETA globalne:** ~31 dni (2,370,887 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ██████████████░░░░░░ | 73.3% | 39,284/53,586 | ~4h |
| PL | ████████░░░░░░░░░░░░ | 42.5% | 22,754/53,586 | ~9h |
...
> Tempo obliczone na bazie ostatniej godziny: ~3228 kluczy/h.
...
> Świeżość: 35min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-16 20:46:52
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 31s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-16T20:46:21.952704Z
...
|-------|----------------|-------------------------------|---------|--------------|
| ES (Hiszpański) | 39,284/53,586 | 73.31% | 2,649 | 0 |
| PL (Polski) | 22,754/53,586 | 42.46% | 1,853 | 0 |
...
| SR (SR) | 3,870/53,586 | 7.22% | 2,636 | 0 |
...
- Raporty strażnika jakości: **2154**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2092**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **9.91%** (276,225/2,786,472)
- **Kopie EN (łącznie):** **167,948**
...
|-------|--------|----------|----------|------------|
| ES | 36,808/49,731 | 74.0% | 2,476/3,855 | 64.2% |
| PL | 20,107/49,731 | 40.4% | 2,647/3,855 | 68.7% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-16T19:46:52.828417Z → 2026-02-16T20:46:52.828417Z) |
...
| Przepustowość (kluczy/h) | **3227.6 kluczy/h** |
| Podejrzane tłumaczenia | **10057** |
| Najgorsze cele (strażnik) | pl/items.json (gf=169), pl/npc.json (gf=133), pl/monsters.json (gf=66), pl/server.json (gf=62), es/books.json (gf=43) |
...
> Świeżość: 7s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-16T20:46:46.126323Z

- **Ostatni audyt:** SLOW_MODE | 34 issue(s) / 100 entries | 2026-02-16T20:46:46.126323Z
- **Top 5 typów problemów:** suspicious_log_high=130, suspicious_log_critical=70, suspicious_rejected_critical=33, identical_to_en=26, identical_to_en_exempt=13
- **Języki o najsłabszej jakości:** es(60.1, issues=147728), sv(64.0, issues=989), tl(64.2, issues=466), zh_TW(64.8, issues=337), fr(65.2, issues=2470)
...
⚠️ **PL**: jakość 68%, 113347 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 147728 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 75%, 3156 problemów
⚠️ **RU**: jakość 69%, 5627 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 64%, 989 problemów
...
| Heartbeat | 7s temu | 2026-02-16T20:46:46Z |
...
- 2026-02-16 20:46:33 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-16 20:46:18 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | server.json
- 2026-02-16 20:46:18 | AUTO_TRANSLATE:parallel_start | ru | ok | server.json
- 2026-02-16 20:46:08 | AUTO_TRANSLATE:heartbeat_tick | es | ok | monsters.json
- 2026-02-16 20:46:08 | AUTO_TRANSLATE:parallel_start | es | ok | monsters.json
- 2026-02-16 20:46:05 | AUTO_TRANSLATE:auto_done | pl | ok | monsters.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 42.5% | 0 | 1,853 | 1,502 | 856 (36.3%) | 48 |
| 🟡 ES | 73.3% | 0 | 2,649 | 1,221 | 391 (24.3%) | 34 |
...
| Przepustowość (okno) | 2,723 kluczy / 82 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-16 20:46:52
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [he] → ok (translated+80, skipped+0) — parallel lang=he file=items.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [fa] → warn (files+1, translated+80, skipped+0) — lang=fa file=items.json strict_skipped_done=1672
...
| ❌ Błędów | 30 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (624), **RU** (550), **SR** (489), **SV** (489), **IT** (488) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **83,451** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-16 20:46:52  
