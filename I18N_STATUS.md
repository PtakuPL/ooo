...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.97% / real 10.89%**. Tempo: **710.0 kluczy/h**. Tłumaczeń netto: **142,677**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 05:38:58

> **Aktualizacja:** 2026-04-29 05:38:58 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,812 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: server.json | Heartbeat: 2026-04-29T05:37:37Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=5.1% | przepustowość=710.0/h  
> **Tłumaczeń netto:** 142,677

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 05:38:58 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T05:37:37Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 50s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 05:38:58 |
| TRANSLATION | 🟢 AKTYWNY | 44s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T05:38:19.986754Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T05:37:37.255347Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 05:38:58 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T05:39:04.693194Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T05:37:37Z
...
| ❤️ **Heartbeat** | 2026-04-29T05:37:37Z |
...
| 05:24:16 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 05:21:01 | RU | Serwer | items.json | 30 | `simple` | `item.13224.name` | структура улья |
| 05:19:31 | TR | Serwer | items.json | 30 | `simple` | `item.12219.name` | karanlık kum |
| 05:18:21 | ES | Serwer | server.json | 2 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 05:16:30 | DE | Serwer | npc.json | 30 | `tm` | `npc.a_dead_bureaucrat1.say_1` | Klar, wo sonst. Jeder trifft gerne meinen Meister, er ist ein großer Dämon, nicht wah... |
| 05:15:43 | DE | Klient | otclient_modules.json | 15 | `tm` | `otclient_modules.blessing.tr_11` | - Abhängig von den Regeln des fairen Kampfes verlierst du zwischendurch |
| 05:14:39 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 05:11:32 | ES | Serwer | items.json | 18 | `simple` | `item.11553.name` | portal mágico |
| 05:09:58 | RO | Serwer | items.json | 39 | `google_translate` | `item.10216.name` | kit statuie dragon |
| 05:08:12 | ES | Serwer | server.json | 2 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 05:06:13 | IT | Serwer | items.json | 30 | `simple` | `item.13010.name` | struttura dell'alveare |
| 05:04:24 | CS | Serwer | items.json | 41 | `simple` | `item.1376.name` | zdobená stěna |
...
| 05:35:33 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.multi_1` |
| 05:31:19 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10193.name` |
| 05:31:18 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10192.name` |
| 05:31:13 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10191.name` |
| 05:31:12 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10190.name` |
| 05:27:18 | IT | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 05:25:33 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.11586.name` |
| 05:25:32 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 05:25:30 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10456.name` |
| 05:25:28 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10338.name` |
| 05:25:27 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10026.name` |
| 05:23:13 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.say_2` |
| 05:20:34 | RU | Serwer | items.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `item.11541.name` |
| 05:16:24 | DE | Serwer | npc.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `npc.a_fluffy_squirrel.stdmod_1` |
| 05:15:39 | DE | Klient | otclient_modules.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `otclient_modules.charms.tr_34` |
| 05:13:39 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.say_1` |
| 05:13:37 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.multi_1` |
...
| ⏳ Oldest pending (visible tail) | 17886 s |
| 🌍 Top języki | RU(400) |
| 🧱 Top reason_bucket | quality(400) |
| 🗂️ Deferred state keys | 7856 |
...
| 🧮 OpenAI budget | `201/250 stale:2026-04-28 7 h` |
...
| 📉 Fallback breakdown | fallback to next provider validate fail(10), fallback to google translate high(7), fallback to google trans... |
...
| ❤️ Pool health | `critical` (writes=495, fallbacks=19) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=697/697 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 17886}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
|-------|---------------|-----------|----------|----------|
| ES | 58,855 | 74,536 | 78.96% →0% | 9,718 |
| PL | 52,911 | 74,536 | 70.99% →0% | 5,861 |
| IT | 52,256 | 74,536 | 70.11% | 10,028 |
...
| CS | 37,437 | 74,536 | 50.23% | 29,858 |
| SR | 24,827 | 74,536 | 33.31% | 1,218 |
| NL | 57,814 | 74,536 | 77.57% | 49,478 |
| TR | 25,252 | 74,536 | 33.88% | 3,832 |
...
> Świeżość: 50s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 05:38:58
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 44s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T05:38:19.986754Z
...
|-------|-----------|--------|----------|--------------|--------------|
| ES (Hiszpański) | 78.96% (58,855/74,536) | 67.79% (50,526/74,536) | 9,718 | 14,316 | 0 |
| PL (Polski) | 70.99% (52,911/74,536) | 65.08% (48,507/74,536) | 5,861 | 20,194 | 0 |
| IT (Włoski) | 70.11% (52,256/74,536) | 61.89% (46,132/74,536) | 10,028 | 18,401 | 0 |
...
| CS (Czeski) | 50.23% (37,437/74,536) | 32.46% (24,191/74,536) | 29,858 | 20,513 | 0 |
...
| TR (Turecki) | 33.88% (25,252/74,536) | 30.39% (22,655/74,536) | 3,832 | 48,063 | 0 |
...
- Raporty strażnika jakości: **4801**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4654**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T05:37:56.073698Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.97%** (696,452/3,875,872)
- **Pokrycie globalne (real):** **10.89%** (422,023/3,875,872)
- **Kopie EN (łącznie):** **410,516**
- **Placeholdery [EN]/puste (łącznie):** **2,189,211**
...
|-------|--------|--------------------------|----------|----------------------------|
| ES | 55,695/70,637 | 78.8% / 67.2% | 3,160/3,899 | 81.0% / 79.2% |
| PL | 49,763/70,637 | 70.5% / 64.3% | 3,148/3,899 | 80.7% / 78.4% |
| IT | 49,283/70,637 | 69.8% / 61.3% | 2,973/3,899 | 76.2% / 73.1% |
...
| CS | 35,747/70,637 | 50.6% / 32.1% | 1,690/3,899 | 43.3% / 39.0% |
| SR | 24,726/70,637 | 35.0% / 33.7% | 101/3,899 | 2.6% / 2.3% |
| NL | 55,803/70,637 | 79.0% / 31.1% | 2,011/3,899 | 51.6% / 47.2% |
| TR | 23,293/70,637 | 33.0% / 29.4% | 1,959/3,899 | 50.2% / 48.7% |
...
| #3 | 🔴 Server | 10.96% | +0.21 pp | 51 | ZH 0.2%, TL 0.8%, BS 0.9% |
...
| 🕒 Evidence window | 24h (span=34.78h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=34.78h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T04:38:59.305851Z → 2026-04-29T05:38:59.305851Z) |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 61 | 95.3% | ru/items.json (61) |
| `existing_canonical_name_quality_mixed_scripts` | 3 | 4.7% | ru/items.json (3) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T05:37:37.255347Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T05:37:37.255347Z
- **Top 5 typów problemów:** suspicious_rejected_critical=188, suspicious_log_low=113, suspicious_log_high=55, suspicious_log_medium=31, suspicious_rejected_high=12
- **Języki o najsłabszej jakości:** es(60.1, issues=735438), ro(60.1, issues=433593), de(60.1, issues=116399), cs(60.1, issues=95979), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 62%, 54699 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 735438 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 62%, 173253 problemów
⚠️ **RU**: jakość 71%, 364345 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,812 |
| Heartbeat | 87s temu | 2026-04-29T05:37:37Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T05:38:35.646168Z
...
- 2026-04-29 05:38:36 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-29 05:38:20 | AUTO_TRANSLATE:auto_done | de | ok | npc.json
- 2026-04-29 05:37:57 | AUTO_TRANSLATE:heartbeat_tick | de | ok | npc.json
- 2026-04-29 05:37:56 | AUTO_TRANSLATE:auto_start | de | ok | npc.json
- 2026-04-29 05:37:36 | AUTO_TRANSLATE:auto_done | de | ok | otclient_modules.json
- 2026-04-29 05:37:17 | AUTO_TRANSLATE:heartbeat_tick | de | ok | otclient_modules.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 05:38:58
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **4,852** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 112 |
| ❌ Błędów | 203 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,001), **RU** (821), **IT** (748), **DE** (675), **TR** (555) |
| 📊 Porównanie | ↓ 41.0% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **23,832** kluczy
...
| 🔄 Cykli wykonanych | **#17,812** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,812 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 05:38:58  
