...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **11.1%**. Tempo: **1323.5 kluczy/h**. Tłumaczeń netto: **79,591**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-15 09:26:41

> **Aktualizacja:** 2026-02-15 09:26:41 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #7,322 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: html.json | Heartbeat: 2026-02-15T09:26:04Z  
> **Okno godzinowe:** okno=1.0h | cykli=90 | pominięte=0.0% | odrzucone=60.5% | przepustowość=1323.5/h  
> **Tłumaczeń netto:** 79,591

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-15 09:26:41 |
| LIVE | 🟢 AKTYWNY | 38s temu | - | `activity.json / worker_state.json` | 2026-02-15T09:26:04Z |
| MIGRATION | 🔒 NIEAKTYWNY | 25s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-15 09:26:41 |
| TRANSLATION | 🟢 AKTYWNY | 0s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-15T09:26:41.871582Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-15T09:25:18.760764Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-15 09:26:41 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 38s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-15T09:26:04Z
...
| ❤️ **Heartbeat** | 2026-02-15T09:26:04Z |
...
| ❌ Odrzucone (guard) | 3571 |
| 🔁 Cykli | 90 |
| 🌍 Języków | 2 |
| 🏆 Najaktywniejszy | PL (1,445 kluczy) |
...
| ES | 44,261 | 53,586 | 82.6% ↑+0.12% | 2,641 |
| RU | 18,137 | 53,586 | 33.85% →0% | 1,760 |
| FR | 17,849 | 53,586 | 33.31% →0% | 3,949 |
...
> **ETA globalne:** ~74 dni (2,337,839 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| PL | █████████████████░░░ | 87.4% | 46,839/53,586 | ~3h |
| ES | ████████████████░░░░ | 82.6% | 44,261/53,586 | ~5h |
| RU | ██████░░░░░░░░░░░░░░ | 33.9% | 18,137/53,586 | ~25h |
...
> Świeżość: 25s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-15 09:26:41
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-15T09:26:41.871582Z
...
| ES (Hiszpański) | 44,261/53,586 | 82.60% | 2,641 | 0 |
| RU (Rosyjski) | 18,137/53,586 | 33.85% | 1,760 | 0 |
| FR (Francuski) | 17,849/53,586 | 33.31% | 3,949 | 0 |
...
- Raporty strażnika jakości: **2656**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2549**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **11.1%** (309,273/2,786,472)
- **Kopie EN (łącznie):** **172,428**
...
| ES | 41,195/49,731 | 82.8% | 3,066/3,855 | 79.5% |
| RU | 15,411/49,731 | 31.0% | 2,726/3,855 | 70.7% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-15T08:26:41.916162Z → 2026-02-15T09:26:41.916162Z) |
...
| Przepustowość (kluczy/h) | **1323.5 kluczy/h** |
| Podejrzane tłumaczenia | **1788** |
| Najgorsze cele (strażnik) | es/npc.json (gf=1899), pl/html.json (gf=520), pl/monsters.json (gf=262), es/monsters.json (gf=157), es/scripts.json (gf=132) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-15T09:25:18.760764Z

- **Ostatni audyt:** SLOW_MODE | 19 issue(s) / 100 entries | 2026-02-15T09:25:18.760764Z
- **Top 5 typów problemów:** suspicious_rejected_critical=200, suspicious_log_high=90, suspicious_log_low=80, suspicious_log_medium=30, identical_to_en=17
- **Języki o najsłabszej jakości:** es(60.1, issues=218760), pl(60.1, issues=148071), tl(64.2, issues=466), zh_TW(64.8, issues=337), fr(66.5, issues=2470)
...
⚠️ **PL**: jakość 60%, 148071 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 218760 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #7,322 |
| Heartbeat | 38s temu | 2026-02-15T09:26:04Z |
...
- **Ostatnia aktualizacja:** 2026-02-15T09:25:17.373051Z
...
- 2026-02-15 09:26:04 | AUTO_TRANSLATE:heartbeat_tick | es | ok | html.json
- 2026-02-15 09:26:04 | AUTO_TRANSLATE:parallel_start | es | ok | html.json
- 2026-02-15 09:26:03 | AUTO_TRANSLATE:auto_done | pl | ok | html.json
- 2026-02-15 09:25:28 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | html.json
- 2026-02-15 09:25:28 | AUTO_TRANSLATE:auto_start | pl | ok | html.json
- 2026-02-15 09:25:17 | AUTO_TRANSLATE:auto_done | es | ok | questlog.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.4% | 0 | 2,338 | 3,098 | 3574 (53.6%) | 90 |
| 🟡 ES | 82.6% | 0 | 2,641 | 3,107 | 4071 (56.7%) | 110 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **79,591** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=67.96%, reason=decrease_high_fail_rate=68.0% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 6,205 kluczy / 200 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-15 09:26:41
...
| ❌ Błędów | 50 |
| 🌍 Aktywnych języków | 2 |
| 🏆 TOP 5 | **PL** (1,599), **ES** (889), **?** (0) |
| 📊 Porównanie | ↓ 95.4% vs wczoraj (54,494) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **104,404** kluczy
...
| 🔄 Cykli wykonanych | **#7,322** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-15 09:26:41  
