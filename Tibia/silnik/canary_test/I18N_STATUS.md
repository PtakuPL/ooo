...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **18.73%**. Tempo: **1058.7 kluczy/h**. Tłumaczeń netto: **48,224**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-23 04:56:06

> **Aktualizacja:** 2026-03-23 04:56:06 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **LIVE:** Cykl #9,534 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-03-23T04:55:30Z  
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=6.2% | przepustowość=1058.7/h  
> **Tłumaczeń netto:** 48,224

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-23 04:56:06 |
| LIVE | 🟢 AKTYWNY | 37s temu | - | `activity.json / worker_state.json` | 2026-03-23T04:55:30Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 10s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-23 04:56:06 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-23T04:53:16.419139Z |
| QUALITY | 🔒 NIEAKTYWNY | 51s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-23T04:55:15.531235Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-23 04:56:06 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 37s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-23T04:55:30Z
...
| ❤️ **Heartbeat** | 2026-03-23T04:55:30Z |
...
> **ETA globalne:** ~116 dni (2,956,203 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~1059 kluczy/h.
...
> Świeżość: 10s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-23 04:56:06
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-23T04:53:16.419139Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-23T03:56:06.508476Z → 2026-03-23T04:56:06.508476Z) |
...
| Przepustowość (kluczy/h) | **1058.7 kluczy/h** |
| Podejrzane tłumaczenia | **2143** |
...
> Świeżość: 51s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-23T04:55:15.531235Z

- **Ostatni audyt:** SLOW_MODE | 12 issue(s) / 100 entries | 2026-03-23T04:55:15.531235Z
- **Top 5 typów problemów:** suspicious_log_high=200, suspicious_rejected_critical=164, suspicious_rejected_high=36, identical_to_en=12, identical_to_en_exempt=1
- **Języki o najsłabszej jakości:** es(60.1, issues=579990), ru(60.1, issues=286529), pl(61.9, issues=326231), tr(67.9, issues=4218), az(70.3, issues=1417)
...
⚠️ **TR**: jakość 68%, 4218 problemów
⚠️ **PL**: jakość 62%, 326231 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 579990 problemów
⚠️ **PT**: jakość 71%, 17541 problemów
⚠️ **FR**: jakość 92%, 15919 problemów
⚠️ **IT**: jakość 84%, 109390 problemów
⚠️ **RU**: jakość 60%, 286529 problemów
⚠️ **NL**: jakość 76%, 9757 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #9,534 |
| Heartbeat | 37s temu | 2026-03-23T04:55:30Z |
...
- 2026-03-23 04:55:30 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-03-23 04:55:30 | AUTO_TRANSLATE:auto_start | es | ok | npc.json
- 2026-03-23 04:55:04 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **48,224** | — | 📊 |
| Adaptacyjna paczka | batch=27, gf_rate=27.11%, reason=decrease_high_fail_rate=27.1% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-23 04:56:06
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **15,251** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 79 |
| ❌ Błędów | 145 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **TR** (3,999), **ES** (3,665), **PL** (1,976), **RO** (1,267), **RU** (1,238) |
| 📊 Porównanie | ↓ 26.4% vs wczoraj (20,729) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **35,980** kluczy
...
| 🔄 Cykli wykonanych | **#9,534** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-23 04:56:06  
