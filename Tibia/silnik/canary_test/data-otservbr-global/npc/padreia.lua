...
keywordHandler:addKeyword({ "job" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.padreia.stdmod_1" })
keywordHandler:addKeyword({ "magic" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.padreia.stdmod_2" })
--keywordHandler:addKeyword({'spell'}, StdModule.say, {npcHandler = npcHandler, i18nKey = "npc.padreia.stdmod_3"})
keywordHandler:addKeyword({ "name" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.padreia.stdmod_4" })
keywordHandler:addKeyword({ "time" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.padreia.stdmod_5" })
