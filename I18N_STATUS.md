...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.72% / real 11.69%**. Tempo: **938.0 kluczy/h**. Tłumaczeń netto: **170,123**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-05-02 06:49:39

> **Aktualizacja:** 2026-05-02 06:49:39 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** local-only (--no-git)
> **LIVE:** Cykl #19,364 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ru | Plik: items.json | Heartbeat: 2026-05-02T06:46:55Z
> **Okno godzinowe:** okno=1.0h | cykli=65 | pominięte=0.0% | odrzucone=0.0% | przepustowość=938.0/h  
> **Tłumaczeń netto:** 170,123

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-05-02 06:49:39 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-05-02T06:46:55Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 21h temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-05-02 06:49:39 |
| TRANSLATION | 🟢 AKTYWNY | 13s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-05-02T06:49:31.997959Z |
| QUALITY | 🔒 NIEAKTYWNY | 12s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-05-02T06:49:33.354244Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-05-02 06:49:39 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-05-02T06:49:45.963870Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-05-02T06:46:55Z
...
| 🔄 **Ostatni cykl** | 3 kluczy, 0 odrzuconych, 158.5s, tryb: AUTO_TRANSLATE, cel: ru/items.json |
...
| ⏳ Oldest pending (visible tail) | 18352 s |
| 🌍 Top języki | RU(400) |
...
| ♻️ Provider debt | `767` |
| 🌍 Recent provider mix | OpenAI model pool(91), tm_dedup_file(80), canonical_name_semantic_autofix(23), term_consistency_autofix(1) |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 18352}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| �📊 Przetłumaczono | **938** kluczy |
| ❌ Odrzucone (guard) | 0 |
| 🔁 Cykli | 65 |
| 🌍 Języków | 6 |
| 🏆 Najaktywniejszy | TR (802 kluczy) |
...
> **ETA globalne:** ~131 dni (2,956,444 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| PL | ████████████████░░░░ | 84.2% | 62,753/74,536 | ~9h |
| ES | ███████████████░░░░░ | 79.9% | 59,560/74,536 | ~12h |
| RO | ███████████████░░░░░ | 78.5% | 58,478/74,536 | ~13h |
| IT | ██████████████░░░░░░ | 72.2% | 53,802/74,536 | ~18h |
| RU | █████████░░░░░░░░░░░ | 46.0% | 34,311/74,536 | ~39h |
| FR | ███████████░░░░░░░░░ | 57.5% | 42,864/74,536 | ~30h |
| TR | ████████░░░░░░░░░░░░ | 43.6% | 32,511/74,536 | ~41h |
| CS | ██████████░░░░░░░░░░ | 52.2% | 38,916/74,536 | ~34h |
| PT | ████████████████░░░░ | 81.2% | 60,516/74,536 | ~11h |
| SR | ██████░░░░░░░░░░░░░░ | 33.3% | 24,827/74,536 | ~2d |
| NL | ███████████████░░░░░ | 77.6% | 57,814/74,536 | ~14h |
| DE | ██████████████░░░░░░ | 70.0% | 52,184/74,536 | ~20h |
...
> Świeżość: 21h temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-05-02 06:49:39
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 13s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-05-02T06:49:31.997959Z
...
- Raporty strażnika jakości: **5197**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **5049**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-05-02T06:46:54.429996Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.72%** (725,624/3,875,872)
- **Pokrycie globalne (real):** **11.69%** (453,242/3,875,872)
- **Kopie EN (łącznie):** **407,175**
- **Placeholdery [EN]/puste (łącznie):** **2,161,333**
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=34.27h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=+0.00pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-05-02T05:49:39.825641Z → 2026-05-02T06:49:39.825641Z) |
...
| Przepustowość (kluczy/h) | **938.0 kluczy/h** |
...
> Świeżość: 12s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-05-02T06:49:33.354244Z
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #19,364 |
| Heartbeat | 170s temu | 2026-05-02T06:46:55Z |
...
- **Ostatnia aktualizacja:** 2026-05-02T06:45:04.407474Z
...
- 2026-05-02 06:46:55 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-05-02 06:46:55 | AUTO_TRANSLATE:auto_start | ru | ok | items.json
- 2026-05-02 06:46:35 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-05-02 06:45:05 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-05-02 06:49:39

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → warn (files+1, translated+3, skipped+0) — lang=ru file=items.json strict_skipped_done=5111
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **13,588** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 69 |
| ❌ Błędów | 91 |
| 🌍 Aktywnych języków | 6 |
| 🏆 TOP 5 | **RO** (7,449), **TR** (5,561), **ES** (221), **RU** (147), **IT** (132) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **46,568** kluczy
...
| 🔄 Cykli wykonanych | **#19,364** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #19,364 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-05-02 06:49:39  
