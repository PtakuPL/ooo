...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.42% / real 11.38%**. Tempo: **206.2 kluczy/h**. Tłumaczeń netto: **156,798**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-05-02 01:45:38

> **Aktualizacja:** 2026-05-02 01:45:38 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #19,071 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: cs | Plik: items.json | Heartbeat: 2026-05-02T01:42:56Z
> **Okno godzinowe:** okno=1.0h | cykli=55 | pominięte=0.0% | odrzucone=3.7% | przepustowość=206.2/h  
> **Tłumaczeń netto:** 156,798

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-05-02 01:45:38 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-05-02T01:42:56Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 16h temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-05-02 01:45:38 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-05-02T01:42:47.976805Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-05-02T01:42:49.075795Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-05-02 01:45:38 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-05-02T01:45:46.581050Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-05-02T01:42:56Z
...
| 🔄 **Ostatni cykl** | 30 kluczy, 0 odrzuconych, 106.0s, tryb: AUTO_TRANSLATE, cel: tr/items.json |
| ❤️ **Heartbeat** | 2026-05-02T01:42:56Z |
...
| ⏳ Oldest pending (visible tail) | 188405 s |
...
| 🧮 OpenAI budget | `38/250 (14.8%); policy=telemetry_only` |
| ♻️ Provider debt | `767` |
| 🌍 Recent provider mix | OpenAI model pool(329), TM/simple(65), Free Google Translate(49), canonical_name_semantic_autofix(26), tm_d... |
...
| ❤️ Pool health | `degraded` (writes=484, fallbacks=19) |
...
| `NO_WRITE` | OK | OK | `183` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 391, 'oldest_s': 188405}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 16h temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-05-02 01:45:38
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-05-02T01:42:47.976805Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-05-02T01:44:55.581189Z |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=29.20h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=+0.00pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-05-02T00:45:39.170853Z → 2026-05-02T01:45:39.170853Z) |
...
| Przepustowość (kluczy/h) | **206.2 kluczy/h** |
...
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-05-02T01:42:49.075795Z
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #19,071 |
| Heartbeat | 170s temu | 2026-05-02T01:42:56Z |
...
- **Ostatnia aktualizacja:** 2026-05-02T01:38:50.926466Z
...
- 2026-05-02 01:44:57 | AUTO_TRANSLATE:auto_start | cs | ok | items.json
- 2026-05-02 01:44:28 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-05-02 01:42:56 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-05-02 01:42:56 | AUTO_TRANSLATE:auto_start | ru | ok | items.json
- 2026-05-02 01:42:48 | AUTO_TRANSLATE:auto_done | tr | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-05-02 01:45:38
...
| 🔄 Cykli wykonanych | **#19,071** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #19,071 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-05-02 01:45:38  
