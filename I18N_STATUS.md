...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.14%**. Tempo: **1495.0 kluczy/h**. Tłumaczeń netto: **71,111**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-14 16:55:59

> **Aktualizacja:** 2026-02-14 16:55:59 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #4 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: spells.json | Heartbeat: 2026-02-14T16:55:30Z  
> **Okno godzinowe:** okno=1.0h | cykli=144 | pominięte=0.0% | odrzucone=58.2% | przepustowość=1495.0/h  
> **Tłumaczeń netto:** 71,111

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-14 16:55:59 |
| LIVE | 🟢 AKTYWNY | 30s temu | - | `activity.json / worker_state.json` | 2026-02-14T16:55:30Z |
| MIGRATION | 🔒 NIEAKTYWNY | 23s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-14 16:55:59 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-14T16:54:59.104039Z |
| QUALITY | 🔒 NIEAKTYWNY | 42s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-14T16:55:18.156570Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-14 16:55:59 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 30s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-14T16:55:30Z
...
| ❤️ **Heartbeat** | 2026-02-14T16:55:30Z |
...
| ❌ Odrzucone (guard) | 3835 |
| 🔁 Cykli | 144 |
| 🌍 Języków | 2 |
| 🏆 Najaktywniejszy | PL (1,565 kluczy) |
| 📄 Najczęstszy plik | monsters.json |
| ⚡ Przepustowość | ~1495 kluczy/h |
| 🛡️ Guard fail rate | 58.2% |
| ⚠️ Podejrzane | 6139 |
...
|-------|---------------|-----------|-----|-------|
| PL | 1,565 | 3382 | 68.4% | 17 |
| ES | 1,195 | 453 | 27.5% | 18 |
...
> **ETA globalne:** ~66 dni (2,364,575 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 75.0% | 40,202/53,586 | ~7h |
| PL | █████████░░░░░░░░░░░ | 45.8% | 24,537/53,586 | ~18h |
| FR | ██████░░░░░░░░░░░░░░ | 33.3% | 17,847/53,586 | ~22h |
| RU | ██████░░░░░░░░░░░░░░ | 33.1% | 17,764/53,586 | ~22h |
...
> Świeżość: 23s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-14 16:55:59
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-14T16:54:59.104039Z
...
| PL (Polski) | 24,537/53,586 | 45.79% | 2,053 | 0 |
...
- Raporty strażnika jakości: **2218**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2151**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **10.14%** (282,537/2,786,472)
- **Kopie EN (łącznie):** **173,872**
...
| PL | 21,852/49,731 | 43.9% | 2,685/3,855 | 69.7% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-14T15:56:00.095357Z → 2026-02-14T16:56:00.095357Z) |
| Cykle | **144** (TŁUMACZENIE=144, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **58.2%** |
| Cykle bez postępu % | **16.4%** |
| Przepustowość (kluczy/h) | **1495.0 kluczy/h** |
| Podejrzane tłumaczenia | **6139** |
...
> Świeżość: 42s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-14T16:55:18.156570Z

- **Ostatni audyt:** SLOW_MODE | 16 issue(s) / 100 entries | 2026-02-14T16:55:18.156570Z
- **Top 5 typów problemów:** suspicious_rejected_critical=200, suspicious_log_high=103, suspicious_log_critical=85, identical_to_en_exempt=25, artifact_token=10
- **Języki o najsłabszej jakości:** es(60.1, issues=163077), pl(60.1, issues=118948), tl(64.2, issues=466), zh_TW(64.8, issues=337), fr(66.5, issues=2470)
...
⚠️ **PL**: jakość 60%, 118948 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 163077 problemów
...
| Heartbeat | 30s temu | 2026-02-14T16:55:30Z |
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 45.8% | 0 | 2,053 | 3,876 | 4605 (54.3%) | 96 |
| 🟡 ES | 75.0% | 0 | 2,748 | 2,892 | 1134 (28.2%) | 81 |
...
| Przepustowość (okno) | 6,768 kluczy / 177 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-14 16:55:59
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+57, skipped+0) — lang=es file=npc.json strict_skipped_done=10140 guard_fail=23 placeholder=1 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → ok (files+0, translated+0, skipped+0) — lang=pl file=server.json
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+24) — repair_identical lang=es file=npc.json target_identical=24 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=314.53
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+80, skipped+0) — lang=pl file=items.json strict_skipped_done=4480 guard_fail=279 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+24) — repair_identical lang=es file=npc.json target_identical=24 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=251.98
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **39,085** kluczy |
| ⏭️ Pominięte | 1 |
| 🔁 Cykli | 49 |
| ❌ Błędów | 486 |
| 🌍 Aktywnych języków | 52 |
| 🏆 TOP 5 | **ES** (11,119), **PL** (4,803), **IT** (971), **PT** (960), **DE** (890) |
| 📊 Porównanie | ↓ 15.2% vs wczoraj (46,073) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **86,507** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-14 16:55:59  
