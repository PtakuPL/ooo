...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 14:37:30

> **Aktualizacja:** 2026-04-29 14:37:30 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,549 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ro | Plik: items.json | Heartbeat: 2026-04-29T14:34:56Z
> **Okno godzinowe:** okno=1.0h | cykli=81 | pominięte=0.0% | odrzucone=6.0% | przepustowość=705.0/h  
> **Tłumaczeń netto:** 149,036

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 14:37:30 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T14:34:56Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 14:37:30 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T14:34:40.406143Z |
| QUALITY | 🔒 NIEAKTYWNY | 59s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T14:36:37.693858Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 14:37:30 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T14:37:37.080195Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T14:34:56Z
...
| ❤️ **Heartbeat** | 2026-04-29T14:34:56Z |
...
| ⏳ Oldest pending (visible tail) | 17220 s |
...
| 🌍 Recent provider mix | TM/simple(354), Free Google Translate(147), canonical_name_semantic_autofix(17), OpenAI model pool(4), term... |
...
| ❤️ Pool health | `critical` (writes=525, fallbacks=30) |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 17220}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 14:37:30
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T14:34:40.406143Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T14:37:06.811339Z |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T13:37:31.171496Z → 2026-04-29T14:37:31.171496Z) |
...
> Świeżość: 59s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T14:36:37.693858Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T14:36:37.693858Z
- **Top 5 typów problemów:** suspicious_rejected_critical=190, suspicious_log_high=112, suspicious_log_low=85, suspicious_rejected_high=10, suspicious_log_critical=2
- **Języki o najsłabszej jakości:** es(60.1, issues=750584), ro(60.1, issues=444882), de(60.1, issues=127404), cs(60.1, issues=119558), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 60%, 58749 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 750584 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 77%, 179099 problemów
⚠️ **RU**: jakość 66%, 374240 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,549 |
| Heartbeat | 161s temu | 2026-04-29T14:34:56Z |
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **149,036** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=6.63%, reason=stable_fail_rate=6.6%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 14:37:30
...
| 🔄 Cykli wykonanych | **#18,549** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,549 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 14:37:30  
