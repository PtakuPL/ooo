...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "temple") then
		npcHandler:sayLocalized("npc.ivalisse.well_i_hope_1", npc, creature)
		npcHandler:setTopic(playerId, 1)
	elseif MsgContains(message, "mission") then
		npcHandler:sayLocalized("npc.ivalisse.besides_my_various_2", npc, creature)
		npcHandler:setTopic(playerId, 1)
	...
	elseif MsgContains(message, "father") and npcHandler:getTopic(playerId) == 1 then
		...
		elseif player:getStorageValue(Storage.Quest.U11_02.ForgottenKnowledge.Ivalisse) == 1 or player:getStorageValue(Storage.Quest.U11_02.ForgottenKnowledge.Chalice) == 1 then
			npcHandler:sayLocalized("npc.ivalisse.well_i_hope_3", npc, creature)
			npcHandler:setTopic(playerId, 0)
	...
	elseif MsgContains(message, "yes") then
		...
		elseif npcHandler:getTopic(playerId) == 3 then
			npcHandler:sayLocalized("npc.ivalisse.you_would_thats_4", npc, creature)
	...
	elseif MsgContains(message, "no") then
		npcHandler:sayLocalized("npc.ivalisse.oh_nevermind_i_5", npc, creature)
		npcHandler:setTopic(playerId, 0)
	end
