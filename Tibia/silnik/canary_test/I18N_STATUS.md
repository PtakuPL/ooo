...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **11.13%**. Tempo: **542.7 kluczy/h**. Tłumaczeń netto: **81,169**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-15 15:22:09

> **Aktualizacja:** 2026-02-15 15:22:09 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #9,127 | Status: ✅ BEZCZYNNY | Faza: IDLE | Etap: cycle_start | Kategoria: - | Plik: - | Heartbeat: 2026-02-15T15:22:06Z  
> **Okno godzinowe:** okno=1.0h | cykli=248 | pominięte=0.0% | odrzucone=57.2% | przepustowość=542.7/h  
> **Tłumaczeń netto:** 81,169

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-15 15:22:09 |
| LIVE | 🟢 AKTYWNY | 3s temu | - | `activity.json / worker_state.json` | 2026-02-15T15:22:06Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 26s temu | worker w trybie IDLE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-15 15:22:09 |
| TRANSLATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie IDLE | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-15T15:20:22.297407Z |
| QUALITY | 🔒 NIEAKTYWNY | 13s temu | worker w trybie IDLE | `quality_audit_latest.json` | 2026-02-15T15:21:56.948088Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-15 15:22:09 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-15T15:22:06Z
...
| ❤️ **Heartbeat** | 2026-02-15T15:22:06Z |
...
> **ETA globalne:** ~179 dni (2,337,068 kluczy do celu 95%)
...
> Świeżość: 26s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-15 15:22:09
...
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-15T15:20:22.297407Z
...
- **Profiler cyklu (ostatni):** cykl #61 (AUTO_TRANSLATE): dispatch 8607ms, mode 136348ms, status 4280ms, total 150591ms
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-15T14:22:09.314223Z → 2026-02-15T15:22:09.314223Z) |
| Cykle | **248** (TŁUMACZENIE=80, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **57.2%** |
| Cykle bez postępu % | **5.0%** |
| Przepustowość (kluczy/h) | **542.7 kluczy/h** |
| Podejrzane tłumaczenia | **854** |
| Najgorsze cele (strażnik) | es/questlog.json (gf=238), es/books.json (gf=192), es/server.json (gf=150), es/html.json (gf=112), pl/monsters.json (gf=69) |
...
> Świeżość: 13s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-15T15:21:56.948088Z

- **Ostatni audyt:** SLOW_MODE | 38 issue(s) / 100 entries | 2026-02-15T15:21:56.948088Z
- **Top 5 typów problemów:** suspicious_rejected_critical=200, suspicious_log_high=118, suspicious_log_low=80, identical_to_en_exempt=25, identical_to_en=22
- **Języki o najsłabszej jakości:** es(60.1, issues=245741), pl(60.1, issues=166768), tl(64.2, issues=466), zh_TW(64.8, issues=337), fr(66.5, issues=2470)
...
⚠️ **PL**: jakość 60%, 166768 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 245741 problemów
...
|-----------|--------|-----------|
| Worker | ✅ BEZCZYNNY | Cykl #9,127 |
| Heartbeat | 3s temu | 2026-02-15T15:22:06Z |
...
- **Ostatnia aktualizacja:** 2026-02-15T15:20:28.907249Z
...
- 2026-02-15 15:20:29 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-15 15:20:22 | AUTO_TRANSLATE:auto_done | es | ok | html.json
- 2026-02-15 15:19:40 | AUTO_TRANSLATE:heartbeat_tick | es | ok | html.json
- 2026-02-15 15:19:40 | AUTO_TRANSLATE:auto_start | es | ok | html.json
- 2026-02-15 15:19:16 | AUTO_TRANSLATE:auto_done | es | ok | books.json
- 2026-02-15 15:18:16 | AUTO_TRANSLATE:heartbeat_tick | es | ok | books.json
...
| 🟡 ES | 84.1% | 0 | 2,623 | 3,581 | 6225 (63.5%) | 97 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **81,169** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=61.38%, reason=decrease_high_fail_rate=61.4% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 7,301 kluczy / 180 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-15 15:22:09

- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+15) — repair_identical lang=es file=npc.json target_identical=15 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=153.28
...
| ❌ Błędów | 252 |
| 🌍 Aktywnych języków | 6 |
| 🏆 TOP 5 | **ES** (3,603), **PL** (3,417), **EL** (68), **IT** (45), **CS** (32) |
| 📊 Porównanie | ↓ 86.8% vs wczoraj (54,494) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **109,109** kluczy
...
| 🔄 Cykli wykonanych | **#9,127** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-15 15:22:09  
