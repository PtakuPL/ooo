...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.04%**. Tempo: **3737.6 kluczy/h**. Tłumaczeń netto: **75,554**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-16 21:35:53

> **Aktualizacja:** 2026-02-16 21:35:53 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #64 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: - | Heartbeat: 2026-02-16T21:35:40Z  
> **Okno godzinowe:** okno=1.0h | cykli=196 | pominięte=0.0% | odrzucone=37.4% | przepustowość=3737.6/h  
> **Tłumaczeń netto:** 75,554

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-16 21:35:53 |
| LIVE | 🟢 AKTYWNY | 14s temu | - | `activity.json / worker_state.json` | 2026-02-16T21:35:40Z |
| MIGRATION | 🔒 NIEAKTYWNY | 1h temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-16 21:35:53 |
| TRANSLATION | 🟢 AKTYWNY | 15s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-16T21:35:39.201443Z |
| QUALITY | 🔒 NIEAKTYWNY | 14s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-16T21:35:40.037284Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-16 21:35:53 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 14s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-16T21:35:40Z
...
| ❤️ **Heartbeat** | 2026-02-16T21:35:40Z |
...
> **ETA globalne:** ~26 dni (2,367,367 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~3738 kluczy/h.
...
> Świeżość: 1h temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-16 21:35:53
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 15s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-16T21:35:39.201443Z
...
| IT (Włoski) | 4,814/53,586 | 8.98% | 2,452 | 0 |
...
- closed door → stängd dörr (item.6201.name)
- closed door → stängd dörr (item.6203.name)
- closed door → stängd dörr (item.6248.name)
- closed door → stängd dörr (item.6249.name)
- closed door → stängd dörr (item.6251.name)
- closed door → stängd dörr (item.6252.name)
- closed door → stängd dörr (item.6254.name)
- closed door → stängd dörr (item.6256.name)
- closed door → stängd dörr (item.6258.name)
- closed door → stängd dörr (item.6260.name)
- closed door → stängd dörr (item.6891.name)
- closed door → stängd dörr (item.6892.name)
- closed door → stängd dörr (item.6894.name)
- closed door → stängd dörr (item.6898.name)
- closed door → stängd dörr (item.6900.name)
- closed door → stängd dörr (item.6901.name)
- closed door → stängd dörr (item.6903.name)
- closed door → stängd dörr (item.6907.name)
- closed door → stängd dörr (item.7033.name)
- closed door → stängd dörr (item.7034.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **2277**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2215**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **10.04%** (279,745/2,786,472)
...
- **Profiler cyklu (ostatni):** cykl #64 (AUTO_TRANSLATE): dispatch 3140ms, mode 18330ms, status 7103ms, total 33827ms
...
| IT | 4,764/49,731 | 9.6% | 50/3,855 | 1.3% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-16T20:35:53.341666Z → 2026-02-16T21:35:53.341666Z) |
...
| Przepustowość (kluczy/h) | **3737.6 kluczy/h** |
| Podejrzane tłumaczenia | **37229** |
...
> Świeżość: 14s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-16T21:35:40.037284Z

- **Ostatni audyt:** OK | 5 issue(s) / 100 entries | 2026-02-16T21:35:40.037284Z
- **Top 5 typów problemów:** suspicious_rejected_critical=125, suspicious_log_high=123, suspicious_rejected_high=75, suspicious_log_critical=72, identical_to_en_exempt=10
- **Języki o najsłabszej jakości:** ro(59.9, issues=4912), ru(60.2, issues=8657), es(60.6, issues=153179), tl(64.2, issues=466), it(64.3, issues=4063)
...
⚠️ **ES**: jakość 61%, 153179 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 64%, 4063 problemów
⚠️ **RU**: jakość 60%, 8657 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 80%, 1862 problemów
...
| Heartbeat | 14s temu | 2026-02-16T21:35:40Z |
...
- 2026-02-16 21:35:35 | AUTO_TRANSLATE:heartbeat_tick | sv | ok | items.json
- 2026-02-16 21:35:35 | AUTO_TRANSLATE:parallel_start | sv | ok | items.json
- 2026-02-16 21:35:29 | AUTO_TRANSLATE:heartbeat_tick | sr | ok | items.json
- 2026-02-16 21:35:28 | AUTO_TRANSLATE:parallel_start | sr | ok | items.json
- 2026-02-16 21:35:26 | AUTO_TRANSLATE:auto_done | it | ok | items.json
- 2026-02-16 21:35:22 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **75,554** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=15.15%, reason=stable_fail_rate=15.1% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 2,198 kluczy / 50 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-16 21:35:53
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+5, skipped+0) — lang=pl file=html.json strict_skipped_done=59 guard_fail=2 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **9,703** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 64 |
| ❌ Błędów | 85 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (1,729), **IT** (1,438), **SV** (1,435), **SR** (1,431), **RU** (1,343) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **89,609** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-16 21:35:53  
