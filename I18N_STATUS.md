...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.74% / real 10.62%**. Tempo: **2070.0 kluczy/h**. Tłumaczeń netto: **128,418**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-27 17:17:56

> **Aktualizacja:** 2026-04-27 17:17:56 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #16,436 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: pt | Plik: books.json | Heartbeat: 2026-04-27T17:15:22Z
> **Okno godzinowe:** okno=1.0h | cykli=23 | pominięte=0.0% | odrzucone=0.6% | przepustowość=2070.0/h  
> **Tłumaczeń netto:** 128,418

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-27 17:17:56 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-27T17:15:22Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 27s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-27 17:17:56 |
| TRANSLATION | 🟢 AKTYWNY | 9min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-27T17:09:02.473064Z |
| QUALITY | 🔒 NIEAKTYWNY | 8min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-27T17:09:03.585577Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-27 17:17:56 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-27T17:18:02.849481Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-27T17:15:22Z
...
| ❤️ **Heartbeat** | 2026-04-27T17:15:22Z |
...
| ⏳ Oldest pending (visible tail) | 338440 s |
...
| 🕒 Deferred state freshness | fresh (134s) |
...
| 🔁 Latest fallback | OpenAI model pool → fallback chain exhausted critical issue [critical_issue] books.json |
| 📉 Fallback breakdown | fallback chain exhausted invalid output(6), fallback chain exhausted critical issue(2), fallback chain exha... |
...
| ❤️ Pool health | `critical` (writes=431, fallbacks=13) |
...
| `NO_WRITE` | OK | OK | `543` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 338440}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Tempo obliczone na bazie ostatniej godziny: ~2070 kluczy/h.
...
> Świeżość: 27s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-27 17:17:56
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 9min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-27T17:09:02.473064Z
...
| 🕒 Evidence window | 24h (span=70.15h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=70.15h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-0.10pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-27T16:17:56.963532Z → 2026-04-27T17:17:56.963532Z) |
...
| Przepustowość (kluczy/h) | **2070.0 kluczy/h** |
| Podejrzane tłumaczenia | **3264** |
| Najgorsze cele (strażnik) | nl/questlog.json (gf=10), nl/cpp.json (gf=2), nl/quests.json (gf=0), nl/scripts.json (gf=0), pt/cpp.json (gf=0) |
...
> Świeżość: 8min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-27T17:09:03.585577Z
...
| Heartbeat | 160s temu | 2026-04-27T17:15:22Z |
...
- 2026-04-27 17:16:52 | AUTO_TRANSLATE:heartbeat_tick | pt | ok | books.json
- 2026-04-27 17:15:22 | AUTO_TRANSLATE:heartbeat_tick | pt | ok | books.json
- 2026-04-27 17:13:51 | AUTO_TRANSLATE:heartbeat_tick | pt | ok | books.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-27 17:17:56
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-27 17:17:56  
