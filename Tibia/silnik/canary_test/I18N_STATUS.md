...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.92%**. Tempo: **914.9 kluczy/h**. Tłumaczeń netto: **127,256**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 23:35:56

> **Aktualizacja:** 2026-02-20 23:35:56 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #6 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: es | Plik: - | Heartbeat: 2026-02-20T23:35:50Z  
> **Okno godzinowe:** okno=1.0h | cykli=135 | pominięte=0.0% | odrzucone=59.3% | przepustowość=914.9/h  
> **Tłumaczeń netto:** 127,256

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 23:35:56 |
| LIVE | 🟢 AKTYWNY | 8s temu | - | `activity.json / worker_state.json` | 2026-02-20T23:35:50Z |
| MIGRATION | 🔒 NIEAKTYWNY | 13s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 23:35:56 |
| TRANSLATION | 🟢 AKTYWNY | 53s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T23:35:05.177323Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T23:35:58.727667Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 23:35:56 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 8s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T23:35:50Z
...
| ❤️ **Heartbeat** | 2026-02-20T23:35:50Z |
...
> Świeżość: 13s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 23:35:56
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 53s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T23:35:05.177323Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T22:35:57.437468Z → 2026-02-20T23:35:57.437468Z) |
...
| Przepustowość (kluczy/h) | **914.9 kluczy/h** |
| Podejrzane tłumaczenia | **3942** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T23:35:58.727667Z
...
| Heartbeat | 8s temu | 2026-02-20T23:35:50Z |
...
- 2026-02-20 23:34:31 | AUTO_TRANSLATE:parallel_start | it | ok | otclient_modules.json
- 2026-02-20 23:34:29 | AUTO_TRANSLATE:auto_done | es | ok | otclient_data.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **127,256** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=26.97%, reason=decrease_high_fail_rate=27.0% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 23:35:56

- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+23) — repair_identical lang=es file=npc.json target_identical=43 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=245.55
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ru] → ok (translated+30, skipped+0) — parallel lang=ru file=books.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [it] → ok (translated+28, skipped+0) — parallel lang=it file=otclient_modules.json
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 23:35:56  
