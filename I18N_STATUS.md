...
> Worker tłumaczy **53** języków. Klucze EN: **4,466**. Pokrycie globalne: **nominal 4.85% / real 4.79%**. Tempo: **344.0 kluczy/h**. Tłumaczeń netto: **172,937**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-06-07 19:35:23

> **Aktualizacja:** 2026-06-07 19:35:23 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 4466
> **Publikacja:** git-enabled
> **LIVE:** Cykl #21,291 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: de | Plik: website_i18n.json | Heartbeat: 2026-06-07T19:35:02Z
> **Okno godzinowe:** okno=1.0h | cykli=253 | pominięte=0.0% | odrzucone=0.0% | przepustowość=344.0/h  
> **Tłumaczeń netto:** 172,937

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-06-07 19:35:23 |
| LIVE | 🟢 AKTYWNY | 26s temu | - | `activity.json / worker_state.json` | 2026-06-07T19:35:02Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 6min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-06-07 19:35:23 |
| TRANSLATION | 🟢 AKTYWNY | 40s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-06-07T19:34:48.352358Z |
| QUALITY | 🔒 NIEAKTYWNY | 39s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-06-07T19:34:49.095813Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-06-07 19:35:23 |
| DOCTOR | 🟠 AKTYWNY | 2s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-06-07T19:35:26.347627Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 26s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-06-07T19:35:02Z

| Metryka | Wartość |
|---------|---------|
| 🛠️ **Co robi** | Tłumaczenie automatyczne (Google Translate + TM) |
| 🌍 **Aktywne języki (10 min)** | DE, FR, IT, NL |
| 📝 **Faza** | AUTO_TRANSLATE |
| 📋 **Etap** | sygnał życia |
| 📂 **Kategoria / Język** | de |
...
| 🔄 **Ostatni cykl** | 10 kluczy, 0 odrzuconych, 84.0s, tryb: AUTO_TRANSLATE, cel: fr/website_i18n.json |
...
| ⏳ Oldest pending (visible tail) | 3155101 s |
...
| ❓ OpenAI/GPT teraz | pool_reason=all_models_blocked; models_blocked=3 (next_unblock~16 min); tm_or_free_gt_currently_serving |
| 🧮 OpenAI budget | `15/250 (6.0%); policy=telemetry_only` |
| ♻️ Provider debt | `711` |
| 🌍 Recent provider mix | TM/simple(98), Free Google Translate(79), tm_dedup_file(77), tm_dedup_propagate(1) |
| 🔁 Latest fallback | OpenAI model pool → fallback to google translate all models blocked [all_models_blocked] website_i18n.json |
| 📉 Fallback breakdown | fallback to google translate all models blocked(86), fallback to openai model pool high(3) |
| ☁️ Cloud policy | `disabled` |
| 🤖 OpenAI pool | `degraded` |
| ⛔ OpenAI blocked models | `3` (next unblock: `16 min`) |
| 🩺 Health signals | recent_fallback, provider_consistency_debt:711 |
| ❤️ Pool health | `degraded` (writes=255, fallbacks=89) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=32/454 (7.05%), fail=422, Δchecks=-102, dir=improving |
...
| `NO_WRITE` | OK | OK | `70` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 348, 'oldest_s': 3155101}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~25 dni (209,323 kluczy do celu 95%)
...
> Świeżość: 6min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-06-07 19:35:23
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 40s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-06-07T19:34:48.352358Z
...
| DE (Niemiecki) | 14.78% (660/4,466) | 14.60% (652/4,466) | 215 | 3,599 | 0 |
...
- `DE/website_i18n.json` You do not have active local Tibia guild invitations. → Du hast keine aktiven lokalen Tibia-Gildeneinladungen. (`account.guilds.invites.none`, `google_translate`)
- `DE/website_i18n.json` Invitation date → Einladungsdatum (`account.guilds.invites.date_label`, `google_translate`)
- `DE/website_i18n.json` No active guild: → Keine aktive Gilde: (`account.guilds.empty_state_label`, `google_translate`)
- `DE/website_i18n.json` Found a guild → Eine Gilde gegründet (`account.guilds.create_link`, `google_translate`)
- `DE/website_i18n.json` Browse guilds → Durchsuchen Sie Gilden (`account.guilds.browse_link`, `google_translate`)
- `DE/website_i18n.json` My applications: → Meine Bewerbungen: (`account.guilds.applications_label`, `google_translate`)
...
- Raporty strażnika jakości: **5609**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **5312**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 33 | 0 | 0 | - | 2026-06-07T19:35:01.260160Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **4.85%** (11,261/232,232)
- **Pokrycie globalne (real):** **4.79%** (11,116/232,232)
- **Kopie EN (łącznie):** **6,099**
- **Placeholdery [EN]/puste (łącznie):** **95,634**
...
| DE | 0/0 | 0.0% / 0.0% | 660/4,466 | 14.8% / 14.6% |
...
| DE | 5.3% / 5.3% | 24.1% / 23.9% | 66.1% / 61.0% | - | - |
...
| OpenAI/GPT pool teraz | `degraded` (pool_reason=all_models_blocked; models_blocked=3 (next_unblock~16 min); tm_or_free_gt_current...) |
...
|--------|-------|---------------------|--------------------|------------------------------|--------------------------------------------|
| RedAxe/MyAAC strona WWW | `website` | 3/3 | 4,466 | 3,806 | 14.8% / 14.6% |
| Tibia WWW/Wiki publiczne | `www_tibia` | 3/14 | 4,466 | 3,806 | 14.8% / 14.6% |
...
| 🕒 Evidence window | 24h (span=338.04h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=338.04h; client.json: id=-31.40pp, ws=+0, otclient_modules.json: id=-29.79pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-06-07T18:35:23.491005Z → 2026-06-07T19:35:23.491005Z) |
| Cykle | **253** (TŁUMACZENIE=209, PRE_MIGRATION=0) |
...
| Podejrzane tłumaczenia | **418** |
| Najgorsze cele (strażnik) | cs/html.json (gf=0), ro/php.json (gf=0), it/website_i18n.json (gf=0), fr/website_i18n.json (gf=0), pt/website_i18n.json (gf=0) |
...
|--------|-----------|--------|----------------|
| `retry_loop_cooldown_default` | 23 | 88.5% | it/website_i18n.json (8) |
| `gt_identity_retry_identical_to_en` | 3 | 11.5% | tr/website_i18n.json (1) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 39s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-06-07T19:34:49.095813Z

- **Ostatni audyt:** OK | 1 issue(s) / 100 entries | 2026-06-07T19:34:49.095813Z
- **Top 5 typów problemów:** suspicious_rejected_high=104, suspicious_log_critical=99, suspicious_rejected_critical=96, suspicious_log_warning=83, identical_to_en_exempt=50
- **Języki o najsłabszej jakości:** ru(60.1, issues=433316), it(60.1, issues=192308), de(60.1, issues=165743), cs(60.1, issues=163973), nl(60.1, issues=80638)
...
⚠️ **TR**: jakość 77%, 69140 problemów
⚠️ **PL**: jakość 76%, 398098 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 82%, 783045 problemów
⚠️ **PT**: jakość 60%, 64679 problemów
⚠️ **FR**: jakość 67%, 69844 problemów
⚠️ **IT**: jakość 60%, 192308 problemów
⚠️ **RU**: jakość 60%, 433316 problemów
⚠️ **NL**: jakość 60%, 80638 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #21,291 |
| Heartbeat | 26s temu | 2026-06-07T19:35:02Z |
...
- 2026-06-07 19:33:26 | AUTO_TRANSLATE:heartbeat_tick | fr | ok | website_i18n.json
- 2026-06-07 19:33:24 | AUTO_TRANSLATE:auto_start | fr | ok | website_i18n.json
- 2026-06-07 19:32:42 | AUTO_TRANSLATE:auto_done | it | ok | website_i18n.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-06-07 19:35:23
...
- 🌍 TRANSLATION_SYNC: SYNC_FILE_DONE [es] → ok (keys+20, files+1) — lang=es file=html.json
- • DOCTOR_REMEDIATION: AUTO_COMMAND [-] → ok — action=force_sync reason=write_starvation_or_queue_starvation
- 🤖 AUTO_TRANSLATE: TIER_QUALITY_GATE [-] → ok — __TIER_GATE__ tier1_avg=76.6% pass=False tier2_avg=36.7% pass=False rec=TIER1_INCOMPLETE: priorytet na PL/ES
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → warn (files+1, translated+6, skipped+0) — lang=ru file=items.json strict_skipped_done=5087
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+4) — repair_identical lang=es file=npc.json target_identical=2 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=238.71
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+18, skipped+0) — lang=es file=items.json strict_skipped_done=1383
...
| 🔄 Cykli wykonanych | **#21,291** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #21,291 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-06-07 19:35:23  
