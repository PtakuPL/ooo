...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-19 17:48:36

> **Aktualizacja:** 2026-02-19 17:48:36 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #1 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: sv | Plik: npclib.json | Heartbeat: 2026-02-19T17:48:35Z  
...
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-19 17:48:36 |
| LIVE | 🟢 AKTYWNY | 4s temu | - | `activity.json / worker_state.json` | 2026-02-19T17:48:35Z |
| MIGRATION | 🔒 NIEAKTYWNY | 2d temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-19 17:48:36 |
| TRANSLATION | 🟢 AKTYWNY | 5s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-19T17:48:33.625357Z |
| QUALITY | 🔒 NIEAKTYWNY | 33s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-19T17:48:06.059054Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-19 17:48:36 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 4s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-19T17:48:35Z
...
| ❤️ **Heartbeat** | 2026-02-19T17:48:35Z |
...
> Świeżość: 2d temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-19 17:48:36
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-19T17:48:33.625357Z
...
- Raporty strażnika jakości: **5891**  
- Raporty blokad: **0**  
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-19T16:48:36.993127Z → 2026-02-19T17:48:36.993127Z) |
...
| Najgorsze cele (strażnik) | sv/otclient_modules.json (gf=0), it/dataroot.json (gf=0), ru/globalevents.json (gf=0), sr/raids.json (gf=0), sv/questlog.json (gf=0) |
...
> Świeżość: 33s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-19T17:48:06.059054Z

- **Ostatni audyt:** SLOW_MODE | 31 issue(s) / 100 entries | 2026-02-19T17:48:06.059054Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=293380), ru(60.1, issues=170897), pl(60.1, issues=167929), ro(60.1, issues=148814), sr(60.1, issues=76443)
...
⚠️ **PL**: jakość 60%, 167929 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 293380 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 59101 problemów
⚠️ **RU**: jakość 60%, 170897 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 90%, 27765 problemów
...
| Heartbeat | 4s temu | 2026-02-19T17:48:35Z |
...
- 2026-02-19 17:48:35 | AUTO_TRANSLATE:heartbeat_tick | sv | ok | npclib.json
- 2026-02-19 17:48:35 | AUTO_TRANSLATE:parallel_start | sv | ok | npclib.json
- 2026-02-19 17:48:33 | AUTO_TRANSLATE:auto_done | sr | ok | talkactions.json
- 2026-02-19 17:48:30 | AUTO_TRANSLATE:heartbeat_tick | sr | ok | talkactions.json
- 2026-02-19 17:48:30 | AUTO_TRANSLATE:auto_start | sr | ok | talkactions.json
- 2026-02-19 17:48:00 | AUTO_TRANSLATE:heartbeat_tick | sr | ok | otclient_data.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-19 17:48:36

- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [sv] → ok (translated+0, skipped+0) — parallel lang=sv file=npclib.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [sr] → ok (files+0, translated+0, skipped+0) — lang=sr file=talkactions.json
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-19 17:48:36  
