...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.94% / real 8.82%**. Tempo: **1955.0 kluczy/h**. Tłumaczeń netto: **69,566**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-23 20:05:18

> **Aktualizacja:** 2026-03-23 20:05:18 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #11,098 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ro | Plik: monsters.json | Heartbeat: 2026-03-23T20:04:50Z  
> **Okno godzinowe:** okno=1.0h | cykli=71 | pominięte=0.0% | odrzucone=20.4% | przepustowość=1955.0/h  
> **Tłumaczeń netto:** 69,566

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-23 20:05:18 |
| LIVE | 🟢 AKTYWNY | 30s temu | - | `activity.json / worker_state.json` | 2026-03-23T20:04:50Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-23 20:05:18 |
| TRANSLATION | 🟢 AKTYWNY | 11min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-23T19:54:14.964194Z |
| QUALITY | 🔒 NIEAKTYWNY | 10min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-23T19:54:56.897538Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-23 20:05:18 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 30s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-23T20:04:50Z
...
| ❤️ **Heartbeat** | 2026-03-23T20:04:50Z |
...
| PL | 52,233 | 74,536 | 70.08% ↓-7.44% | 5,871 |
...
> **ETA globalne:** ~63 dni (2,947,887 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ██████████████████░░ | 94.1% | 70,131/74,536 | ~0h |
| PL | ██████████████░░░░░░ | 70.1% | 52,233/74,536 | ~10h |
| IT | ██████████████░░░░░░ | 73.5% | 54,808/74,536 | ~8h |
| RO | ███████████████░░░░░ | 75.6% | 56,361/74,536 | ~7h |
| RU | ██████████████░░░░░░ | 73.4% | 54,740/74,536 | ~8h |
| FR | ██████████████░░░░░░ | 72.9% | 54,320/74,536 | ~8h |
| SR | ██████░░░░░░░░░░░░░░ | 33.3% | 24,827/74,536 | ~24h |
| PT | ██████████████░░░░░░ | 71.2% | 53,055/74,536 | ~9h |
| CS | █████████████░░░░░░░ | 69.5% | 51,770/74,536 | ~10h |
| NL | █████████████░░░░░░░ | 69.1% | 51,502/74,536 | ~10h |
| TR | ███░░░░░░░░░░░░░░░░░ | 17.2% | 12,857/74,536 | ~30h |
...
> Tempo obliczone na bazie ostatniej godziny: ~1955 kluczy/h.
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-23 20:05:18
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 11min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-23T19:54:14.964194Z
...
- convince creature rune → convincere la runa della creatura (item.3177.name)
- chameleon rune → runa camaleonte (item.3178.name)
- stalagmite rune → runa stalagmitica (item.3179.name)
- magic wall rune → runa magica del muro (item.3180.name)
- spell rune → runa magica (item.3181.name)
- holy missile rune → runa del missile sacro (item.3182.name)
- fire field rune → runa del campo di fuoco (item.3188.name)
- fireball rune → runa della palla di fuoco (item.3189.name)
- fire wall rune → runa del muro di fuoco (item.3190.name)
- An extremely old book on the concept of time which once contained a variety of s → Un libro estremamente antico sul concetto di tempo che un tempo conteneva una va (item.31908.desc)
- Time Distort Almanac → Almanacco della distorsione del tempo (item.31908.name)
- great fireball rune → grande runa della palla di fuoco (item.3191.name)
- It is a mark of distinction, awarded by the priesthood of Bastesh to those who h → È un segno di distinzione, assegnato dal sacerdozio di Bastesh a coloro che aiut (item.31911.desc)
- golden sea horse figurine → statuetta di cavalluccio marino dorato (item.31911.name)
- There is reed flour dough on it → Sopra c'è un impasto di farina di canna (item.31913.desc)
- baking tray → teglia (item.31913.name)
- lump of reed flour dough → grumo di pasta di farina di canna (item.31914.name)
- Sleeping human here. → Umano che dorme qui. (item.31916.desc)
- fire bomb rune → runa della bomba incendiaria (item.3192.name)
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 279 | 1 | 47,195 | - | 2026-03-23T19:55:47.472084Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.94%** (734,181/3,875,872)
- **Pokrycie globalne (real):** **8.82%** (341,774/3,875,872)
- **Kopie EN (łącznie):** **576,127**
- **Placeholdery [EN]/puste (łącznie):** **2,056,744**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-23T19:05:18.905902Z → 2026-03-23T20:05:18.905902Z) |
| Cykle | **71** (TŁUMACZENIE=63, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **20.4%** |
| Cykle bez postępu % | **0.0%** |
| Przepustowość (kluczy/h) | **1955.0 kluczy/h** |
| Podejrzane tłumaczenia | **927** |
...
|--------|-----------|--------|----------------|
| `gt_rejected_critical` | 275 | 51.7% | ro/npc.json (53) |
| `gt_validate_fail_placeholder` | 206 | 38.7% | it/npc.json (54) |
| `gt_validate_fail_word_salad` | 41 | 7.7% | es/server.json (16) |
| `gt_validate_fail_quality` | 8 | 1.5% | cs/npc.json (2) |
| `gt_rejected_high_cyrillic_latin_mix` | 1 | 0.2% | ru/items.json (1) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 10min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-23T19:54:56.897538Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-03-23T19:54:56.897538Z
- **Top 5 typów problemów:** suspicious_rejected_critical=187, suspicious_log_high=119, suspicious_log_low=66, suspicious_rejected_high=13, suspicious_log_critical=10
- **Języki o najsłabszej jakości:** it(60.1, issues=116946), fr(60.1, issues=22225), cs(60.1, issues=16989), pt(62.3, issues=24038), pl(63.3, issues=334413)
...
⚠️ **TR**: jakość 92%, 8853 problemów
⚠️ **PL**: jakość 63%, 334413 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 66%, 640497 problemów
⚠️ **PT**: jakość 62%, 24038 problemów
⚠️ **FR**: jakość 60%, 22225 problemów
⚠️ **IT**: jakość 60%, 116946 problemów
⚠️ **RU**: jakość 95%, 298856 problemów
⚠️ **NL**: jakość 71%, 16733 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #11,098 |
| Heartbeat | 30s temu | 2026-03-23T20:04:50Z |
...
- **Ostatnia aktualizacja:** 2026-03-23T20:05:06.932806Z
...
- 2026-03-23 20:04:50 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | monsters.json
- 2026-03-23 20:03:20 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | monsters.json
- 2026-03-23 20:01:50 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | monsters.json
- 2026-03-23 20:00:19 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | monsters.json
- 2026-03-23 19:58:49 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | monsters.json
- 2026-03-23 19:57:18 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | monsters.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 70.1% | 0 | 5,871 | 660 | 832 (55.8%) | 27 |
| 🟡 ES | 94.1% | 2,385 | 23,533 | 994 | 380 (27.7%) | 24 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **69,566** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=7.51%, reason=stable_fail_rate=7.5%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-23 20:05:18
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [cs] → warn (files+1, translated+65, skipped+0) — lang=cs file=achievements.json strict_skipped_done=983 guard_fail=1 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **48,367** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 174 |
| ❌ Błędów | 749 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **ES** (13,220), **TR** (7,880), **RO** (5,889), **FR** (3,545), **PL** (3,229) |
| 📊 Porównanie | ↑ 133.3% vs wczoraj (20,729) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **69,096** kluczy
...
| 🔄 Cykli wykonanych | **#11,098** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #11,098 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-23 20:05:18  
