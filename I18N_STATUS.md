...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.89% / real 10.81%**. Tempo: **766.0 kluczy/h**. Tłumaczeń netto: **137,567**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-28 23:11:58

> **Aktualizacja:** 2026-04-28 23:11:58 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,284 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: server.json | Heartbeat: 2026-04-28T23:10:05Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=4.1% | przepustowość=766.0/h  
> **Tłumaczeń netto:** 137,567

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-28 23:11:58 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-28T23:10:05Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 31s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-28 23:11:58 |
| TRANSLATION | 🟢 AKTYWNY | 28s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-28T23:11:35.194392Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-28T23:10:04.750542Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-28 23:11:58 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-28T23:12:03.383916Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-28T23:10:05Z
...
| 🔄 **Ostatni cykl** | 30 kluczy, 1 odrzuconych, 73.0s, tryb: AUTO_TRANSLATE, cel: ru/items.json |
| ❤️ **Heartbeat** | 2026-04-28T23:10:05Z |
...
| ⏳ Oldest pending (visible tail) | 16087 s |
...
| 🌍 Recent provider mix | TM/simple(324), Free Google Translate(195), canonical_name_semantic_autofix(15), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=537, fallbacks=3) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=402/402 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 388, 'oldest_s': 16087}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~163 dni (2,988,553 kluczy do celu 95%)
...
> Świeżość: 31s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-28 23:11:58
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 28s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-28T23:11:35.194392Z
...
- stone wall → каменный стена (item.11878.name)
- stone wall → каменный стена (item.11879.name)
- wooden roof → деревянная крыша (item.1188.name)
- stone wall → каменный стена (item.11880.name)
- stone wall → каменный стена (item.11881.name)
- stone wall → каменный стена (item.11882.name)
- pillar → колонна (item.11883.name)
- pillar → колонна (item.11884.name)
- pillar → колонна (item.11885.name)
- pillar → колонна (item.11886.name)
- pillar → колонна (item.11887.name)
- pillar → колонна (item.11888.name)
- pillar → колонна (item.11889.name)
- wooden roof → деревянная крыша (item.1189.name)
- pillar → колонна (item.11890.name)
- pillar → колонна (item.11891.name)
- pillar → колонна (item.11892.name)
- stone wall → каменный стена (item.11893.name)
- stone wall → каменный стена (item.11894.name)
- stone wall → каменный стена (item.11895.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4668**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4521**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-28T23:10:21.457088Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.89%** (693,515/3,875,872)
- **Pokrycie globalne (real):** **10.81%** (418,877/3,875,872)
- **Kopie EN (łącznie):** **410,725**
- **Placeholdery [EN]/puste (łącznie):** **2,192,148**
...
| 🕒 Evidence window | 24h (span=28.33h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=28.33h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-28T22:11:58.763127Z → 2026-04-28T23:11:58.763127Z) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-28T23:10:04.750542Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-28T23:10:04.750542Z
- **Top 5 typów problemów:** suspicious_rejected_critical=195, suspicious_log_medium=91, suspicious_log_low=64, suspicious_log_high=44, suspicious_rejected_high=5
- **Języki o najsłabszej jakości:** es(60.1, issues=724943), ro(60.1, issues=424075), de(60.1, issues=107482), cs(60.1, issues=81694), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 61%, 52721 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 724943 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 66%, 168042 problemów
⚠️ **RU**: jakość 81%, 357202 problemów
⚠️ **NL**: jakość 79%, 72744 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,284 |
| Heartbeat | 118s temu | 2026-04-28T23:10:05Z |
...
- 2026-04-28 23:11:52 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-28 23:11:35 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
- 2026-04-28 23:10:22 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-04-28 23:10:22 | AUTO_TRANSLATE:auto_start | ru | ok | items.json
- 2026-04-28 23:10:04 | AUTO_TRANSLATE:auto_done | tr | ok | items.json
- 2026-04-28 23:09:20 | AUTO_TRANSLATE:heartbeat_tick | tr | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-28 23:11:58
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **7,552** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 111 |
| ❌ Błędów | 305 |
| 🌍 Aktywnych języków | 9 |
| 🏆 TOP 5 | **DE** (1,280), **RU** (1,177), **IT** (923), **RO** (833), **TR** (832) |
| 📊 Porównanie | ↑ 45.6% vs wczoraj (5,188) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **30,412** kluczy
...
| 🔄 Cykli wykonanych | **#17,284** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,284 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-28 23:11:58  
