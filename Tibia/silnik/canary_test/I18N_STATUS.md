...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.87%**. Tempo: **1865.5 kluczy/h**. Tłumaczeń netto: **120,058**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 19:27:23

> **Aktualizacja:** 2026-02-20 19:27:23 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #105 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ru | Plik: - | Heartbeat: 2026-02-20T19:27:19Z  
> **Okno godzinowe:** okno=1.0h | cykli=209 | pominięte=0.0% | odrzucone=49.5% | przepustowość=1865.5/h  
> **Tłumaczeń netto:** 120,058

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 19:27:23 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T19:27:19Z |
| MIGRATION | 🔒 NIEAKTYWNY | 48s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 19:27:23 |
| TRANSLATION | 🟢 AKTYWNY | 42s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T19:26:41.770227Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T19:27:24.406239Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 19:27:23 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T19:27:19Z
...
| ❤️ **Heartbeat** | 2026-02-20T19:27:19Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **3,246** kluczy |
| ❌ Odrzucone (guard) | 3178 |
| 🔁 Cykli | 209 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (882 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~1865 kluczy/h |
| 🛡️ Guard fail rate | 49.5% |
| ⚠️ Podejrzane | 25159 |
| 🌐 GT aktywny (1h) | ✅ TAK |
| 🔤 GT tłumaczeń (1h) | 20 |
...
> **ETA globalne:** ~50 dni (2,260,742 kluczy do celu 95%)
...
> Świeżość: 48s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 19:27:23
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 42s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T19:26:41.770227Z
...
- Raporty strażnika jakości: **6898**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4006**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T18:27:23.693335Z → 2026-02-20T19:27:23.693335Z) |
...
| Przepustowość (kluczy/h) | **1865.5 kluczy/h** |
| Podejrzane tłumaczenia | **3290** |
| Najgorsze cele (strażnik) | es/items.json (gf=1039), pl/items.json (gf=816), pl/npc.json (gf=484), it/npc.json (gf=171), es/server.json (gf=123) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T19:27:24.406239Z

- **Ostatni audyt:** SLOW_MODE | 27 issue(s) / 100 entries | 2026-02-20T19:27:15.643763Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=94, suspicious_log_high=62, suspicious_log_critical=44, artifact_token=27, identical_to_en_exempt=11
- **Języki o najsłabszej jakości:** es(60.1, issues=332306), ro(60.1, issues=181861), it(60.1, issues=73906), ru(60.2, issues=211905), sv(61.0, issues=30409)
...
⚠️ **PL**: jakość 64%, 186407 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 332306 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 73906 problemów
⚠️ **RU**: jakość 60%, 211905 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 61%, 30409 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #105 |
| Heartbeat | 5s temu | 2026-02-20T19:27:19Z |
...
- 2026-02-20 19:26:49 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 19:26:34 | AUTO_TRANSLATE:heartbeat_tick | it | ok | quests.json
- 2026-02-20 19:26:34 | AUTO_TRANSLATE:parallel_start | it | ok | quests.json
- 2026-02-20 19:26:32 | AUTO_TRANSLATE:auto_done | ru | ok | spells.json
- 2026-02-20 19:26:20 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | spells.json
- 2026-02-20 19:26:20 | AUTO_TRANSLATE:auto_start | ru | ok | spells.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,829 | 637 | 6242 (90.7%) | 34 |
| 🟡 ES | 84.8% | 0 | 2,160 | 745 | 3005 (80.1%) | 36 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **120,058** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=27.74%, reason=decrease_high_fail_rate=27.7% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,382 kluczy / 70 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 19:27:23
...
- 🤖 AUTO_TRANSLATE: TIER_QUALITY_GATE [-] → ok — __TIER_GATE__ tier1_avg=55.9% pass=False tier2_avg=9.5% pass=False rec=TIER1_INCOMPLETE: priorytet na PL/ES
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+22, skipped+0) — parallel lang=es file=client.json
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **10,756** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 105 |
| ❌ Błędów | 237 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (3,070), **RU** (2,159), **IT** (1,825), **RO** (1,339), **PL** (1,176) |
| 📊 Porównanie | ↑ 195.4% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **108,341** kluczy
...
| 🔄 Cykli wykonanych | **#105** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 19:27:23  
