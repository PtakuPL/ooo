...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 16.87% / real 9.69%**. Tempo: **1699.0 kluczy/h**. Tłumaczeń netto: **102,530**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-02 18:45:45

> **Aktualizacja:** 2026-04-02 18:45:45 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #13,064 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: de | Plik: monsters.json | Heartbeat: 2026-04-02T18:45:36Z  
> **Okno godzinowe:** okno=1.0h | cykli=52 | pominięte=0.0% | odrzucone=30.7% | przepustowość=1699.0/h  
> **Tłumaczeń netto:** 102,530

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-02 18:45:45 |
| LIVE | 🟢 AKTYWNY | 11s temu | - | `activity.json / worker_state.json` | 2026-04-02T18:45:36Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 13s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-02 18:45:45 |
| TRANSLATION | 🟢 AKTYWNY | 46s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-02T18:45:00.865044Z |
| QUALITY | 🔒 NIEAKTYWNY | 26s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-02T18:45:21.160548Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-02 18:45:45 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 11s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-02T18:45:36Z
...
| ❤️ **Heartbeat** | 2026-04-02T18:45:36Z |
...
> **ETA globalne:** ~74 dni (3,028,096 kluczy do celu 95%)
...
> Świeżość: 13s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-02 18:45:45
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 46s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-02T18:45:00.865044Z
...
- Raporty strażnika jakości: **3609**  
- Raporty blokad: **0**  
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 280 | 0 | 0 | - | 2026-04-02T18:45:35.943902Z |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-02T17:45:45.535108Z → 2026-04-02T18:45:45.535108Z) |
...
|--------|-----------|--------|----------------|
| `gt_rejected_critical` | 375 | 72.1% | es/questlog.json (258) |
| `gt_validate_fail_word_salad` | 103 | 19.8% | es/questlog.json (68) |
| `gt_rejected_high_partial_translation_mix` | 32 | 6.2% | fr/monsters.json (17) |
| `gt_validate_fail_placeholder` | 8 | 1.5% | es/questlog.json (6) |
| `gt_validate_fail_quality` | 2 | 0.4% | tr/npc.json (1) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 26s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-02T18:45:21.160548Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-02T18:45:21.160548Z
- **Top 5 typów problemów:** suspicious_log_high=191, suspicious_rejected_critical=165, suspicious_rejected_high=35, suspicious_log_critical=9
- **Języki o najsłabszej jakości:** es(60.1, issues=678124), ro(60.1, issues=376925), pl(60.1, issues=360690), pt(60.1, issues=29860), nl(60.1, issues=28111)
...
⚠️ **TR**: jakość 83%, 19001 problemów
⚠️ **PL**: jakość 60%, 360690 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 678124 problemów
⚠️ **PT**: jakość 60%, 29860 problemów
⚠️ **FR**: jakość 61%, 40937 problemów
⚠️ **IT**: jakość 61%, 136187 problemów
⚠️ **RU**: jakość 63%, 309999 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #13,064 |
| Heartbeat | 11s temu | 2026-04-02T18:45:36Z |
...
- 2026-04-02 18:45:14 | AUTO_TRANSLATE:heartbeat_tick | es | ok | otclient_modules.json
- 2026-04-02 18:45:01 | AUTO_TRANSLATE:auto_done | fr | ok | monsters.json
- 2026-04-02 18:44:58 | AUTO_TRANSLATE:heartbeat_tick | fr | ok | monsters.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **102,530** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=23.16%, reason=decrease_high_fail_rate=23.2%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-02 18:45:45
...
| 🔄 Cykli wykonanych | **#13,064** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #13,064 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-02 18:45:45  
