...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-19 10:05:22

> **Aktualizacja:** 2026-02-19 10:05:22 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #1 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: chatchannels.json | Heartbeat: 2026-02-19T10:05:21Z  
...
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-19 10:05:22 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-19T10:05:21Z |
| MIGRATION | 🔒 NIEAKTYWNY | 1d temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-19 10:05:22 |
| TRANSLATION | 🟢 AKTYWNY | 6s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-19T10:05:19.545539Z |
| QUALITY | 🔒 NIEAKTYWNY | 32s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-19T10:04:54.443163Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-19 10:05:22 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-19T10:05:21Z
...
| ❤️ **Heartbeat** | 2026-02-19T10:05:21Z |
...
> Świeżość: 1d temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-19 10:05:22
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-19T10:05:19.545539Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-19T09:05:22.609813Z → 2026-02-19T10:05:22.609813Z) |
...
| Najgorsze cele (strażnik) | ru/globalevents.json (gf=0), sv/otclient_modules.json (gf=0), sr/raids.json (gf=0), it/example_merchant.json (gf=0), sv/questlog.json (gf=0) |
...
> Świeżość: 32s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-19T10:04:54.443163Z

- **Ostatni audyt:** SLOW_MODE | 31 issue(s) / 100 entries | 2026-02-19T10:04:54.443163Z
- **Top 5 typów problemów:** suspicious_log_high=186, suspicious_rejected_critical=171, suspicious_rejected_high=29, artifact_token=16, identical_to_en=15
- **Języki o najsłabszej jakości:** es(60.1, issues=259939), pl(60.1, issues=145949), ro(60.1, issues=84506), ru(60.1, issues=65083), sr(60.1, issues=32390)
...
⚠️ **PL**: jakość 60%, 145949 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 259939 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 31141 problemów
⚠️ **RU**: jakość 60%, 65083 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 65%, 24052 problemów
...
| Heartbeat | 5s temu | 2026-02-19T10:05:21Z |
...
- 2026-02-19 10:05:21 | AUTO_TRANSLATE:heartbeat_tick | es | ok | chatchannels.json
- 2026-02-19 10:05:21 | AUTO_TRANSLATE:parallel_start | es | ok | chatchannels.json
- 2026-02-19 10:05:19 | AUTO_TRANSLATE:auto_done | pl | ok | example_merchant.json
- 2026-02-19 10:05:15 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | example_merchant.json
- 2026-02-19 10:05:14 | AUTO_TRANSLATE:auto_start | pl | ok | example_merchant.json
- 2026-02-19 10:04:49 | AUTO_TRANSLATE:heartbeat_tick | sr | ok | spells.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-19 10:05:22
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → ok (files+0, translated+0, skipped+0) — lang=ro file=otclient_data.json
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [it] → ok (translated+0, skipped+0) — parallel lang=it file=talkactions.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → ok (files+0, translated+0, skipped+0) — lang=ro file=achievements.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ru] → ok (translated+0, skipped+0) — parallel lang=ru file=client.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [it] → ok (translated+0, skipped+0) — parallel lang=it file=cpp.json
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-19 10:05:22  
