...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.37% / real 10.24%**. Tempo: **1792.0 kluczy/h**. Tłumaczeń netto: **117,844**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-21 19:50:49

> **Aktualizacja:** 2026-04-21 19:50:49 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #14,557 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ru | Plik: - | Heartbeat: 2026-04-21T19:50:45Z  
> **Okno godzinowe:** okno=1.0h | cykli=121 | pominięte=0.0% | odrzucone=49.0% | przepustowość=1792.0/h  
> **Tłumaczeń netto:** 117,844

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-21 19:50:49 |
| LIVE | 🟢 AKTYWNY | 8s temu | - | `activity.json / worker_state.json` | 2026-04-21T19:50:45Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 19s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-21 19:50:49 |
| TRANSLATION | 🟢 AKTYWNY | 42s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-21T19:50:11.430962Z |
| QUALITY | 🔒 NIEAKTYWNY | 8s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-21T19:50:44.600698Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-21 19:50:49 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-21T19:50:53.545866Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 8s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-21T19:50:45Z
...
| ❤️ **Heartbeat** | 2026-04-21T19:50:45Z |
...
|----------|------|---------|-----------|-------|----------|--------------|-----|
| 19:50:06 | RU | Klient | html.json | `hard_block` | `validate_command` | `command` | `html.readonly.text3` |
| 19:50:06 | RU | Klient | html.json | `hard_block` | `validate_command` | `command` | `html.xhtmlstyle.text3` |
| 19:50:04 | RU | Klient | html.json | `hard_block` | `high_reject_types` | `cyrillic_latin_mix` | `html.configfilename.text2` |
| 19:50:04 | RU | Klient | html.json | `hard_block` | `validate_wrong_script` | `wrong_script` | `html.account.login.html.text3` |
| 19:50:04 | RU | Klient | html.json | `hard_block` | `validate_wrong_script` | `wrong_script` | `html.success.html.text1` |
| 19:50:04 | RU | Klient | html.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `html.networks.html.text2` |
| 19:50:04 | RU | Klient | html.json | `hard_block` | `validate_wrong_script` | `wrong_script` | `html.networks.html.text1` |
| 19:50:02 | RU | Klient | html.json | `hard_block` | `validate_wrong_script` | `wrong_script` | `html.news.html.text3` |
| 19:50:02 | RU | Klient | html.json | `hard_block` | `validate_wrong_script` | `wrong_script` | `html.27_downloads.text4` |
| 19:50:02 | RU | Klient | html.json | `hard_block` | `validate_wrong_script` | `wrong_script` | `html.27_downloads.text2` |
| 19:50:02 | RU | Klient | html.json | `hard_block` | `validate_wrong_script` | `wrong_script` | `html.commands.html.text1` |
| 19:50:02 | RU | Klient | html.json | `hard_block` | `validate_wrong_script` | `wrong_script` | `html.guilds.delete_guild.html.text2` |
| 19:49:59 | RU | Klient | html.json | `hard_block` | `validate_wrong_script` | `wrong_script` | `html.lastkills.html.text1` |
| 19:49:59 | RU | Klient | html.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `html.forum.admin.links.html.text1` |
| 19:49:59 | RU | Klient | html.json | `hard_block` | `validate_wrong_script` | `wrong_script` | `html.guilds.change_description.html.text1` |
| 19:49:59 | RU | Klient | html.json | `hard_block` | `validate_wrong_script` | `wrong_script` | `html.account.characters.create.html.text5` |
| 19:49:59 | RU | Klient | html.json | `hard_block` | `validate_placeholder` | `placeholder` | `html.account.characters.create.html.text3` |
| 19:49:56 | RU | Klient | html.json | `hard_block` | `validate_placeholder` | `placeholder` | `html.account.characters.create.html.text1` |
| 19:49:56 | RU | Klient | html.json | `hard_block` | `validate_wrong_script` | `wrong_script` | `html.gallery.form.html.text2` |
| 19:49:56 | RU | Klient | html.json | `hard_block` | `validate_placeholder` | `placeholder` | `html.gallery.form.html.text1` |
...
| ⏳ Oldest pending (visible tail) | 8174 s |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 8174}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| �📊 Przetłumaczono | **1,792** kluczy |
| ❌ Odrzucone (guard) | 1722 |
| 🔁 Cykli | 121 |
| 🌍 Języków | 11 |
| 🏆 Najaktywniejszy | RO (539 kluczy) |
| 📄 Najczęstszy plik | monsters.json |
| ⚡ Przepustowość | ~1792 kluczy/h |
...
> Tempo obliczone na bazie ostatniej godziny: ~1792 kluczy/h.
...
> Świeżość: 19s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-21 19:50:49
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 42s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-21T19:50:11.430962Z
...
- Raporty strażnika jakości: **3977**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3834**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-21T18:50:49.603740Z → 2026-04-21T19:50:49.603740Z) |
...
| Przepustowość (kluczy/h) | **1792.0 kluczy/h** |
| Podejrzane tłumaczenia | **2170** |
...
|--------|-----------|--------|----------------|
| `gt_validate_fail_placeholder` | 101 | 57.1% | ru/html.json (28) |
| `gt_validate_fail_quality` | 35 | 19.8% | tr/npc.json (25) |
| `gt_validate_fail_identical_to_en` | 23 | 13.0% | it/items.json (17) |
| `gt_validate_fail_command` | 7 | 4.0% | pl/html.json (3) |
| `gt_rejected_critical` | 5 | 2.8% | tr/npc.json (3) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 8s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-21T19:50:44.600698Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-21T19:50:44.600698Z
- **Top 5 typów problemów:** suspicious_rejected_critical=195, suspicious_log_high=120, suspicious_log_medium=60, suspicious_log_low=14, suspicious_log_critical=6
- **Języki o najsłabszej jakości:** ro(60.1, issues=398230), pl(60.1, issues=376984), ru(60.1, issues=321714), de(60.2, issues=86736), az(70.3, issues=1417)
...
⚠️ **TR**: jakość 83%, 34179 problemów
⚠️ **PL**: jakość 60%, 376984 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 80%, 698178 problemów
⚠️ **PT**: jakość 79%, 36341 problemów
⚠️ **FR**: jakość 78%, 51920 problemów
⚠️ **IT**: jakość 80%, 150465 problemów
⚠️ **RU**: jakość 60%, 321714 problemów
⚠️ **NL**: jakość 88%, 40040 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #14,557 |
| Heartbeat | 8s temu | 2026-04-21T19:50:45Z |
...
- **Ostatnia aktualizacja:** 2026-04-21T19:50:31.796813Z
...
- 2026-04-21 19:50:32 | AUTO_TRANSLATE:heartbeat_tick | es | ok | otclient_modules.json
- 2026-04-21 19:50:12 | AUTO_TRANSLATE:auto_done | ru | ok | html.json
- 2026-04-21 19:49:28 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | html.json
...
| Przepustowość (okno) | 1,394 kluczy / 48 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-21 19:50:49
...
| 🔄 Cykli wykonanych | **#14,557** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #14,557 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-21 19:50:49  
