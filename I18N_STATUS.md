...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 19.07% / real 8.69%**. Tempo: **656.1 kluczy/h**. Tłumaczeń netto: **67,986**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-23 19:00:54

> **Aktualizacja:** 2026-03-23 19:00:54 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #11,027 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: it | Plik: items.json | Heartbeat: 2026-03-23T18:59:48Z  
> **Okno godzinowe:** okno=1.0h | cykli=33 | pominięte=0.0% | odrzucone=39.1% | przepustowość=656.1/h  
> **Tłumaczeń netto:** 67,986

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-23 19:00:54 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-03-23T18:59:48Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 40s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-23 19:00:54 |
| TRANSLATION | 🟢 AKTYWNY | 10min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-23T18:50:22.319041Z |
| QUALITY | 🔒 NIEAKTYWNY | 10min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-23T18:50:23.197216Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-23 19:00:54 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-23T18:59:48Z
...
| ❤️ **Heartbeat** | 2026-03-23T18:59:48Z |
...
> Świeżość: 40s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-23 19:00:54
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 10min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-23T18:50:22.319041Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-23T18:00:54.823787Z → 2026-03-23T19:00:54.823787Z) |
...
| Przepustowość (kluczy/h) | **656.1 kluczy/h** |
...
|--------|-----------|--------|----------------|
| `gt_rejected_critical` | 121 | 45.7% | pl/monsters.json (41) |
| `gt_rejected_high_partial_translation_mix` | 46 | 17.4% | es/monsters.json (21) |
| `gt_validate_fail_placeholder` | 40 | 15.1% | pl/npc.json (37) |
| `gt_validate_fail_word_salad` | 30 | 11.3% | pl/items.json (8) |
| `gt_rejected_high_trimmed_en_copy` | 16 | 6.0% | pl/monsters.json (15) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 10min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-23T18:50:23.197216Z
...
| Heartbeat | 68s temu | 2026-03-23T18:59:48Z |
...
- 2026-03-23 18:55:01 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-03-23 18:53:30 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-03-23 18:52:00 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-23 19:00:54
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-23 19:00:54  
