...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.94% / real 10.86%**. Tempo: **999.0 kluczy/h**. Tłumaczeń netto: **140,908**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 03:21:27

> **Aktualizacja:** 2026-04-29 03:21:27 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,612 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: items.json | Heartbeat: 2026-04-29T03:19:21Z
> **Okno godzinowe:** okno=1.0h | cykli=72 | pominięte=0.0% | odrzucone=3.2% | przepustowość=999.0/h  
> **Tłumaczeń netto:** 140,908

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 03:21:27 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T03:19:21Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 31s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 03:21:27 |
| TRANSLATION | 🟢 AKTYWNY | 29s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T03:21:04.302335Z |
| QUALITY | 🔒 NIEAKTYWNY | 28s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T03:21:05.507004Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 03:21:27 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T03:21:33.661872Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T03:19:21Z
...
| 🔄 **Ostatni cykl** | 39 kluczy, 4 odrzuconych, 74.0s, tryb: AUTO_TRANSLATE, cel: ro/items.json |
| ❤️ **Heartbeat** | 2026-04-29T03:19:21Z |
...
| ⏳ Oldest pending (visible tail) | 17746 s |
| 🌍 Top języki | RU(398) |
| 🧱 Top reason_bucket | quality(398) |
| 🗂️ Deferred state keys | 7664 |
| 🕒 Deferred state freshness | fresh (28s) |
| ♻️ Deferred stats | enqueued=0, cooldown=4, deduped=4, manual_review=72, partial_staged=0, partial_completed=0 |
...
| 🌍 Recent provider mix | TM/simple(240), Free Google Translate(225), canonical_name_semantic_autofix(18), canonical_name_case_autofi... |
...
| ❤️ Pool health | `critical` (writes=498, fallbacks=24) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=589/589 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 17746}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~125 dni (2,986,546 kluczy do celu 95%)
...
> Świeżość: 31s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 03:21:27
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 29s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T03:21:04.302335Z
...
- This lamp is glowing very dimly. → Această lampăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă luminează foarte slab. (item.13656.desc)
- This lamp is glowing very dimly. → Această lampăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă luminează foarte slab. (item.13658.desc)
- This is an emblem of wisdom. It was awarded by TibiaStat.com → Aceasta este o emblemăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă a înțelepciunii. A fost acor (item.14760.desc)
- lamp → lampă (item.10507.name)
- ramp → rampă (item.11365.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4750**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4603**
...
| 🕒 Evidence window | 24h (span=32.49h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=32.49h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T02:21:28.219989Z → 2026-04-29T03:21:28.219989Z) |
...
> Świeżość: 28s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T03:21:05.507004Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T03:21:05.507004Z
- **Top 5 typów problemów:** suspicious_rejected_critical=187, suspicious_log_low=113, suspicious_log_high=86, suspicious_rejected_high=13, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=730954), ro(60.1, issues=430086), de(60.1, issues=113031), cs(60.1, issues=90473), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 730954 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 64%, 171278 problemów
⚠️ **RU**: jakość 62%, 361882 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,612 |
| Heartbeat | 132s temu | 2026-04-29T03:19:21Z |
...
- 2026-04-29 03:19:50 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-04-29 03:19:50 | AUTO_TRANSLATE:auto_start | ro | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 03:21:27
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **2,927** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 61 |
| ❌ Błędów | 114 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **RU** (634), **CS** (569), **IT** (448), **DE** (360), **TR** (315) |
| 📊 Porównanie | ↓ 64.4% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **21,907** kluczy
...
| 🔄 Cykli wykonanych | **#17,612** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,612 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 03:21:27  
