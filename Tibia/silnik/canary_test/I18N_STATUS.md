...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **9.91%**. Tempo: **3152.5 kluczy/h**. Tłumaczeń netto: **70,570**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-16 20:45:49

> **Aktualizacja:** 2026-02-16 20:45:49 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #22 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: - | Heartbeat: 2026-02-16T20:45:43Z  
> **Okno godzinowe:** okno=1.0h | cykli=86 | pominięte=0.0% | odrzucone=15.9% | przepustowość=3152.5/h  
> **Tłumaczeń netto:** 70,570

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-16 20:45:49 |
| LIVE | 🟢 AKTYWNY | 7s temu | - | `activity.json / worker_state.json` | 2026-02-16T20:45:43Z |
| MIGRATION | 🔒 NIEAKTYWNY | 34min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-16 20:45:49 |
| TRANSLATION | 🟢 AKTYWNY | 7s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-16T20:45:42.568405Z |
| QUALITY | 🔒 NIEAKTYWNY | 7s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-16T20:45:43.180177Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-16 20:45:49 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 7s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-16T20:45:43Z
...
| ❤️ **Heartbeat** | 2026-02-16T20:45:43Z |
...
> Świeżość: 34min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-16 20:45:49
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 7s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-16T20:45:42.568405Z
...
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2089**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **9.91%** (276,173/2,786,472)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-16T19:45:49.924677Z → 2026-02-16T20:45:49.924677Z) |
...
| Przepustowość (kluczy/h) | **3152.5 kluczy/h** |
| Podejrzane tłumaczenia | **9500** |
...
> Świeżość: 7s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-16T20:45:43.180177Z

- **Ostatni audyt:** SLOW_MODE | 43 issue(s) / 100 entries | 2026-02-16T20:45:43.180177Z
- **Top 5 typów problemów:** suspicious_log_low=95, suspicious_log_critical=65, suspicious_log_high=40, identical_to_en=36, suspicious_rejected_critical=33
- **Języki o najsłabszej jakości:** es(60.1, issues=147520), sv(64.0, issues=971), tl(64.2, issues=466), zh_TW(64.8, issues=337), fr(65.2, issues=2470)
...
| Heartbeat | 7s temu | 2026-02-16T20:45:43Z |
...
- 2026-02-16 20:45:40 | AUTO_TRANSLATE:heartbeat_tick | sv | ok | monsters.json
- 2026-02-16 20:45:39 | AUTO_TRANSLATE:parallel_start | sv | ok | monsters.json
- 2026-02-16 20:45:34 | AUTO_TRANSLATE:heartbeat_tick | sr | ok | monsters.json
- 2026-02-16 20:45:33 | AUTO_TRANSLATE:parallel_start | sr | ok | monsters.json
- 2026-02-16 20:45:31 | AUTO_TRANSLATE:auto_done | it | ok | monsters.json
- 2026-02-16 20:45:28 | AUTO_TRANSLATE:heartbeat_tick | it | ok | monsters.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **70,570** | — | 📊 |
| Adaptacyjna paczka | batch=6, gf_rate=32.19%, reason=decrease_high_fail_rate=32.2% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-16 20:45:49
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **3,371** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 22 |
| ❌ Błędów | 28 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (550), **RU** (500), **SR** (489), **SV** (489), **IT** (488) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **83,277** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-16 20:45:49  
