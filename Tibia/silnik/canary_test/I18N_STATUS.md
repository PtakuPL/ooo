...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **11.13%**. Tempo: **488.6 kluczy/h**. Tłumaczeń netto: **81,424**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-15 17:52:11

> **Aktualizacja:** 2026-02-15 17:52:11 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #9,361 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: server.json | Heartbeat: 2026-02-15T17:51:04Z  
> **Okno godzinowe:** okno=1.0h | cykli=256 | pominięte=0.0% | odrzucone=51.7% | przepustowość=488.6/h  
> **Tłumaczeń netto:** 81,424

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-15 17:52:11 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-02-15T17:51:04Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-15 17:52:11 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-15T17:50:33.852952Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-15T17:50:34.695961Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-15 17:52:11 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-15T17:51:04Z
...
| ❤️ **Heartbeat** | 2026-02-15T17:51:04Z |
...
> **ETA globalne:** ~199 dni (2,337,031 kluczy do celu 95%)
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-15 17:52:11
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-15T17:50:33.852952Z
...
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2673**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-15T16:52:12.170133Z → 2026-02-15T17:52:12.170133Z) |
...
| Przepustowość (kluczy/h) | **488.6 kluczy/h** |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-15T17:50:34.695961Z

- **Ostatni audyt:** SLOW_MODE | 22 issue(s) / 100 entries | 2026-02-15T17:50:34.695961Z
- **Top 5 typów problemów:** suspicious_log_high=200, suspicious_rejected_critical=200, identical_to_en_exempt=15, identical_to_en=12, artifact_token=10
- **Języki o najsłabszej jakości:** es(60.1, issues=247037), pl(60.1, issues=170247), tl(64.2, issues=466), zh_TW(64.8, issues=337), fr(66.5, issues=2470)
...
⚠️ **PL**: jakość 60%, 170247 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 247037 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #9,361 |
| Heartbeat | 69s temu | 2026-02-15T17:51:04Z |
...
- 2026-02-15 17:51:04 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-02-15 17:51:04 | AUTO_TRANSLATE:auto_start | es | ok | server.json
- 2026-02-15 17:50:34 | AUTO_TRANSLATE:auto_done | es | ok | monsters.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.5% | 0 | 2,329 | 3,854 | 2733 (41.5%) | 83 |
| 🟡 ES | 84.1% | 0 | 2,625 | 3,491 | 6004 (63.2%) | 97 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **81,424** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=43.61%, reason=decrease_high_fail_rate=43.6% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 7,345 kluczy / 180 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-15 17:52:11

- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+23) — repair_identical lang=es file=npc.json target_identical=23 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=153.28
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+51, skipped+0) — parallel lang=es file=npc.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+25, skipped+0) — lang=pl file=items.json strict_skipped_done=6560 guard_fail=1060 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+80, skipped+0) — lang=pl file=items.json strict_skipped_done=7008 guard_fail=1 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **7,807** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 60 |
| ❌ Błędów | 276 |
| 🌍 Aktywnych języków | 6 |
| 🏆 TOP 5 | **PL** (3,854), **ES** (3,780), **EL** (68), **IT** (45), **CS** (32) |
| 📊 Porównanie | ↓ 85.7% vs wczoraj (54,494) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **109,723** kluczy
...
| 🔄 Cykli wykonanych | **#9,361** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-15 17:52:11  
