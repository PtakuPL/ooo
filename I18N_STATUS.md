...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.7% / real 11.67%**. Tempo: **288.0 kluczy/h**. Tłumaczeń netto: **168,791**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-05-02 04:45:49

> **Aktualizacja:** 2026-05-02 04:45:49 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #19,227 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: cs | Plik: items.json | Heartbeat: 2026-05-02T04:43:32Z
> **Okno godzinowe:** okno=1.0h | cykli=60 | pominięte=0.0% | odrzucone=0.0% | przepustowość=288.0/h  
> **Tłumaczeń netto:** 168,791

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-05-02 04:45:49 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-05-02T04:43:32Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 19h temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-05-02 04:45:49 |
| TRANSLATION | 🟢 AKTYWNY | 5min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-05-02T04:40:40.638643Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-05-02T04:43:31.486556Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-05-02 04:45:49 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-05-02T04:45:57.148797Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-05-02T04:43:32Z
...
| 🔄 **Ostatni cykl** | 47 kluczy, 0 odrzuconych, 86.0s, tryb: AUTO_TRANSLATE, cel: tr/items.json |
| ❤️ **Heartbeat** | 2026-05-02T04:43:32Z |
...
| ⏳ Oldest pending (visible tail) | 120917 s |
...
| 🧮 OpenAI budget | `78/250 (31.2%); policy=telemetry_only` |
| ♻️ Provider debt | `767` |
| 🌍 Recent provider mix | tm_dedup_file(99), OpenAI model pool(89), canonical_name_semantic_autofix(21), tm_dedup_propagate(15), term... |
...
| ❤️ Pool health | `degraded` (writes=225, fallbacks=31) |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 393, 'oldest_s': 120917}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| �📊 Przetłumaczono | **288** kluczy |
| ❌ Odrzucone (guard) | 0 |
| 🔁 Cykli | 60 |
| 🌍 Języków | 6 |
| 🏆 Najaktywniejszy | TR (148 kluczy) |
...
> Świeżość: 19h temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-05-02 04:45:49
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 5min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-05-02T04:40:40.638643Z
...
- titanic mushroom → titanická houba (item.15551.name)
- broken stone wall → poškozená kamenná zeď (item.1582.name)
- scattered crystals → rozptýlené krystaly (item.15846.name)



### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **5162**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **5014**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-05-02T04:43:59.948245Z |
...
| 🕒 Evidence window | 24h (span=32.20h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=32.20h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=+0.00pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-05-02T03:45:50.282085Z → 2026-05-02T04:45:50.282085Z) |
...
| Przepustowość (kluczy/h) | **288.0 kluczy/h** |
...
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-05-02T04:43:31.486556Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-05-02T04:43:31.486556Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=761106), ro(60.1, issues=456664), ru(60.1, issues=385966), de(60.1, issues=139335), cs(60.1, issues=138180)
...
⚠️ **TR**: jakość 60%, 62335 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 761106 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 86%, 182189 problemów
⚠️ **RU**: jakość 60%, 385966 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #19,227 |
| Heartbeat | 145s temu | 2026-05-02T04:43:32Z |
...
- **Ostatnia aktualizacja:** 2026-05-02T04:40:57.795767Z
...
- 2026-05-02 04:45:31 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | items.json
- 2026-05-02 04:44:01 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | items.json
- 2026-05-02 04:44:00 | AUTO_TRANSLATE:auto_start | cs | ok | items.json
- 2026-05-02 04:42:28 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-05-02 04:40:58 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-05-02 04:40:40 | AUTO_TRANSLATE:auto_done | tr | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-05-02 04:45:49
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **12,256** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 34 |
| ❌ Błędów | 56 |
| 🌍 Aktywnych języków | 6 |
| 🏆 TOP 5 | **RO** (7,302), **TR** (4,516), **ES** (163), **RU** (117), **IT** (100) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **45,236** kluczy
...
| 🔄 Cykli wykonanych | **#19,227** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #19,227 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-05-02 04:45:49  
