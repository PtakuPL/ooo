...
local lionsRock = {
	[25006] = {
		...
		item = 3030,
		fieldId = 2123,
		messageKey = "scripts.gems.lions_rock_ruby",
		effect = CONST_ME_MAGIC_RED,
	},
	[25007] = {
		itemId = 21442,
		...
		item = 3029,
		fieldId = 21463,
		messageKey = "scripts.gems.lions_rock_sapphire",
	...
	[25008] = {
		...
		item = 3033,
		fieldId = 7465,
		messageKey = "scripts.gems.lions_rock_amethyst",
	...
	[25009] = {
		...
		item = 9057,
		fieldId = 21465,
		messageKey = "scripts.gems.lions_rock_topaz",
	...
	for index, value in pairs(shrine) do
		if target.actionid == value.targetAction then
			if player:getStorageValue(ThreatenedDreams.Mission01[1]) == 16 then
				...
				player:sayLocalized("scripts.gems.shrine_not_ready", {itemName = item:getName()})
				return true
			end
		end
	end
