...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "Pucataaan!", yell = false , i18nKey = "monster.iks_chuka.voice_1"},
	{ text = "Mahrrrca!", yell = false , i18nKey = "monster.iks_chuka.voice_2"},
	{ text = "Puccahtaaan!", yell = false , i18nKey = "monster.iks_chuka.voice_3"},
}
