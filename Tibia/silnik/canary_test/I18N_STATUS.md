...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **9.93%**. Tempo: **3309.5 kluczy/h**. Tłumaczeń netto: **71,184**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-16 20:51:53

> **Aktualizacja:** 2026-02-16 20:51:53 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #27 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: sr | Plik: - | Heartbeat: 2026-02-16T20:51:51Z  
> **Okno godzinowe:** okno=1.0h | cykli=106 | pominięte=0.0% | odrzucone=18.0% | przepustowość=3309.5/h  
> **Tłumaczeń netto:** 71,184

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-16 20:51:53 |
| LIVE | 🟢 AKTYWNY | 4s temu | - | `activity.json / worker_state.json` | 2026-02-16T20:51:51Z |
| MIGRATION | 🔒 NIEAKTYWNY | 40min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-16 20:51:53 |
| TRANSLATION | 🟢 AKTYWNY | 29s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-16T20:51:25.851769Z |
| QUALITY | 🔒 NIEAKTYWNY | 3s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-16T20:51:51.346894Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-16 20:51:53 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 4s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-16T20:51:51Z
...
| ❤️ **Heartbeat** | 2026-02-16T20:51:51Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **3,812** kluczy |
| ❌ Odrzucone (guard) | 834 |
| 🔁 Cykli | 106 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (600 kluczy) |
| 📄 Najczęstszy plik | items.json |
| ⚡ Przepustowość | ~3309 kluczy/h |
| 🛡️ Guard fail rate | 18.0% |
| ⚠️ Podejrzane | 14278 |
...
> Tempo obliczone na bazie ostatniej godziny: ~3309 kluczy/h.
...
> Świeżość: 40min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-16 20:51:53
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 29s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-16T20:51:25.851769Z
...
| IT (Włoski) | 4,259/53,586 | 7.95% | 2,536 | 0 |
...
| SR (SR) | 3,967/53,586 | 7.40% | 2,602 | 0 |
...
- Raporty strażnika jakości: **2166**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2104**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **9.93%** (276,672/2,786,472)
...
| IT | 4,209/49,731 | 8.5% | 50/3,855 | 1.3% |
| DE | 4,084/49,731 | 8.2% | 114/3,855 | 3.0% |

### ⏱️ Ścisłe okno godzinowe (JSONL-only)
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-16T19:51:54.638721Z → 2026-02-16T20:51:54.638721Z) |
...
| Przepustowość (kluczy/h) | **3309.5 kluczy/h** |
| Podejrzane tłumaczenia | **14278** |
| Najgorsze cele (strażnik) | pl/items.json (gf=300), pl/server.json (gf=143), pl/npc.json (gf=133), pl/monsters.json (gf=66), es/books.json (gf=43) |
...
> Świeżość: 3s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-16T20:51:51.346894Z

- **Ostatni audyt:** OK | 7 issue(s) / 100 entries | 2026-02-16T20:51:51.346894Z
- **Top 5 typów problemów:** suspicious_log_high=153, suspicious_log_critical=47, suspicious_rejected_critical=33, suspicious_rejected_high=13, identical_to_en_exempt=11
- **Języki o najsłabszej jakości:** tl(64.2, issues=466), zh_TW(64.8, issues=337), fr(65.2, issues=2470), es(65.4, issues=148215), ro(66.7, issues=1075)
...
⚠️ **PL**: jakość 68%, 113506 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 65%, 148215 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 86%, 3221 problemów
⚠️ **RU**: jakość 75%, 5693 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 67%, 989 problemów
...
| Heartbeat | 4s temu | 2026-02-16T20:51:51Z |
...
- 2026-02-16 20:51:38 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-16 20:51:17 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | items.json
- 2026-02-16 20:51:16 | AUTO_TRANSLATE:parallel_start | pl | ok | items.json
- 2026-02-16 20:51:11 | AUTO_TRANSLATE:heartbeat_tick | sv | ok | items.json
- 2026-02-16 20:51:10 | AUTO_TRANSLATE:parallel_start | sv | ok | items.json
- 2026-02-16 20:51:07 | AUTO_TRANSLATE:auto_done | sr | ok | items.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 42.6% | 0 | 1,853 | 1,557 | 1068 (40.7%) | 50 |
| 🟡 ES | 73.4% | 0 | 2,649 | 1,271 | 391 (23.5%) | 35 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **71,184** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=15.58%, reason=stable_fail_rate=15.6% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 2,828 kluczy / 85 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-16 20:51:53
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+105) — repair_identical lang=es file=npc.json target_identical=3030
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [cs] → ok (translated+80, skipped+0) — parallel lang=cs file=items.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [fi] → warn (files+1, translated+80, skipped+0) — lang=fi file=items.json strict_skip missing_file=0 missing_key=163 skipped_done=3225 strict_skipped_done=3225
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **4,148** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 27 |
| ❌ Błędów | 35 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (722), **RU** (600), **SR** (589), **SV** (589), **IT** (588) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **84,054** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-16 20:51:53  
