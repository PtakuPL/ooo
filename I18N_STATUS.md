...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.97% / real 10.89%**. Tempo: **721.0 kluczy/h**. Tłumaczeń netto: **142,792**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 05:48:33

> **Aktualizacja:** 2026-04-29 05:48:33 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,825 | Status: ✅ BEZCZYNNY | Faza: IDLE | Etap: cycle_start | Kategoria: cs | Plik: items.json | Heartbeat: 2026-04-29T05:46:29Z
> **Okno godzinowe:** okno=1.0h | cykli=91 | pominięte=0.0% | odrzucone=5.1% | przepustowość=721.0/h  
> **Tłumaczeń netto:** 142,792

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 05:48:33 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T05:46:29Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 42s temu | worker w trybie IDLE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 05:48:33 |
| TRANSLATION | 🔒 NIEAKTYWNY | 23s temu | worker w trybie IDLE | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T05:48:15.953954Z |
| QUALITY | 🔒 NIEAKTYWNY | 22s temu | worker w trybie IDLE | `quality_audit_latest.json` | 2026-04-29T05:48:17.186578Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 05:48:33 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T05:48:39.623969Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T05:46:29Z
...
| 🔄 **Ostatni cykl** | 50 kluczy, 6 odrzuconych, 105.7s, tryb: AUTO_TRANSLATE, cel: cs/items.json |
| ❤️ **Heartbeat** | 2026-04-29T05:46:29Z |
...
| ⏳ Oldest pending (visible tail) | 16569 s |
...
| ♻️ Deferred stats | enqueued=1, cooldown=5, deduped=5, manual_review=0, partial_staged=0, partial_completed=0 |
...
| 🌍 Recent provider mix | TM/simple(355), Free Google Translate(132), canonical_name_semantic_autofix(15), term_consistency_autofix(3) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=705/705 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 16569}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~173 dni (2,985,538 kluczy do celu 95%)
...
> Świeżość: 42s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 05:48:33
...
> Świeżość: 23s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T05:48:15.953954Z
...
- wall fountain → nástěnná fontána (item.1399.name)
- wall fountain → nástěnná fontána (item.1400.name)
- wall fountain → nástěnná fontána (item.1401.name)
- wall fountain → nástěnná fontána (item.1402.name)
- insectoid queen → hmyzoidní královna (item.14045.name)
- insectoid queen → hmyzoidní královna (item.14046.name)
- insectoid queen → hmyzoidní královna (item.14047.name)
- insectoid queen → hmyzoidní královna (item.14048.name)
- insectoid queen → hmyzoidní královna (item.14049.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4804**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4657**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T05:46:57.382171Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.97%** (696,530/3,875,872)
- **Pokrycie globalne (real):** **10.89%** (422,101/3,875,872)
- **Kopie EN (łącznie):** **410,516**
- **Placeholdery [EN]/puste (łącznie):** **2,189,133**
...
- **Profiler cyklu (ostatni):** cykl #58 (AUTO_TRANSLATE): dispatch 12497ms, mode 79472ms, status 12005ms, total 105747ms
...
| 🕒 Evidence window | 24h (span=34.94h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=34.94h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T04:48:33.503280Z → 2026-04-29T05:48:33.503280Z) |
...
| Najgorsze cele (strażnik) | cs/items.json (gf=16), ro/items.json (gf=12), de/otclient_modules.json (gf=3), de/npc.json (gf=3), ru/items.json (gf=3) |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 89 | 91.8% | ru/items.json (89) |
| `existing_canonical_name_quality_mixed_scripts` | 7 | 7.2% | ru/items.json (7) |
| `gt_validate_fail_identical_to_en` | 1 | 1.0% | cs/items.json (1) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie IDLE)  
> Świeżość: 22s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T05:48:17.186578Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T05:48:17.186578Z
- **Top 5 typów problemów:** suspicious_rejected_critical=187, suspicious_log_low=103, suspicious_log_high=95, suspicious_rejected_high=13, suspicious_log_medium=2
- **Języki o najsłabszej jakości:** es(60.1, issues=735783), ro(60.1, issues=433837), de(60.1, issues=116745), cs(60.1, issues=96287), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 60%, 54801 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 735783 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 73%, 173322 problemów
⚠️ **RU**: jakość 65%, 364531 problemów
...
|-----------|--------|-----------|
| Worker | ✅ BEZCZYNNY | Cykl #17,825 |
| Heartbeat | 130s temu | 2026-04-29T05:46:29Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T05:43:15.374238Z
...
- 2026-04-29 05:48:16 | AUTO_TRANSLATE:auto_done | cs | ok | items.json
- 2026-04-29 05:46:58 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | items.json
- 2026-04-29 05:46:57 | AUTO_TRANSLATE:auto_start | cs | ok | items.json
- 2026-04-29 05:46:17 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 05:44:47 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 05:43:16 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **142,792** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=5.35%, reason=stable_fail_rate=5.3%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 05:48:33

- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+2) — repair_identical lang=es file=server.json target_identical=9 limit=108 tier=low_backlog+suspicious_guard domain_cap=240 gt=true suspicious_pct=507.78
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+27, skipped+0) — lang=es file=items.json strict_skipped_done=626
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **4,980** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 115 |
| ❌ Błędów | 208 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,051), **RU** (853), **IT** (748), **DE** (675), **TR** (595) |
| 📊 Porównanie | ↓ 39.5% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **23,960** kluczy
...
| 🔄 Cykli wykonanych | **#17,825** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,825 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 05:48:33  
