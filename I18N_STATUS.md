...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.18%**. Tempo: **1380.2 kluczy/h**. Tłumaczeń netto: **72,963**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-14 18:06:12

> **Aktualizacja:** 2026-02-14 18:06:12 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #4 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: pl | Plik: raids.json | Heartbeat: 2026-02-14T18:05:57Z  
> **Okno godzinowe:** okno=1.0h | cykli=173 | pominięte=0.0% | odrzucone=43.7% | przepustowość=1380.2/h  
> **Tłumaczeń netto:** 72,963

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-14 18:06:12 |
| LIVE | 🟢 AKTYWNY | 15s temu | - | `activity.json / worker_state.json` | 2026-02-14T18:05:57Z |
| MIGRATION | 🔒 NIEAKTYWNY | 40s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-14 18:06:12 |
| TRANSLATION | 🟢 AKTYWNY | 41s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-14T18:05:31.497521Z |
| QUALITY | 🔒 NIEAKTYWNY | 26s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-14T18:05:46.498720Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-14 18:06:12 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 15s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-14T18:05:57Z
...
| ❤️ **Heartbeat** | 2026-02-14T18:05:57Z |
...
|-------|---------------|-----------|-----|-------|
| PL | 1,340 | 1679 | 55.6% | 18 |
| ES | 1,136 | 245 | 17.7% | 18 |
...
|-------|---------------|-----------|----------|----------|
| ES | 40,507 | 53,586 | 75.59% | 2,760 |
| PL | 25,039 | 53,586 | 46.73% | 2,063 |
...
> **ETA globalne:** ~71 dni (2,363,448 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 75.6% | 40,507/53,586 | ~8h |
| PL | █████████░░░░░░░░░░░ | 46.7% | 25,039/53,586 | ~19h |
| RU | ██████░░░░░░░░░░░░░░ | 33.8% | 18,083/53,586 | ~24h |
| FR | ██████░░░░░░░░░░░░░░ | 33.3% | 17,848/53,586 | ~24h |
...
> Świeżość: 40s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-14 18:06:12
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 41s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-14T18:05:31.497521Z
...
|-------|----------------|-------------------------------|---------|--------------|
| ES (Hiszpański) | 40,507/53,586 | 75.59% | 2,760 | 0 |
| PL (Polski) | 25,039/53,586 | 46.73% | 2,063 | 0 |
...
- Well, bye then. → Bueno, adiós entonces. (npc.cipfried.walkaway_msg_1)
- <gulp gulp> → <gulp gulp> (npc.cruleo.voice_1)
- Well, bye then. → Bueno, adiós entonces. (npc.denominator.walkaway_msg_1)
- Greetings, |PLAYERNAME|. → Saludos, |PLAYERNAME|. (npc.edala.greet_1)
- <nods> → <nods> (npc.elliott.greet_msg_1)
- Greetings, |PLAYERNAME|. → Saludos, |PLAYERNAME|. (npc.eruaran.greet_1)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **2303**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2236**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **10.18%** (283,664/2,786,472)
...
|-------|--------|----------|----------|------------|
| ES | 37,920/49,731 | 76.2% | 2,587/3,855 | 67.1% |
| PL | 22,354/49,731 | 45.0% | 2,685/3,855 | 69.7% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-14T17:06:12.607155Z → 2026-02-14T18:06:12.607155Z) |
...
| Podejrzane tłumaczenia | **3836** |
| Najgorsze cele (strażnik) | pl/npc.json (gf=993), pl/quests.json (gf=157), pl/scripts.json (gf=123), pl/monsters.json (gf=110), pl/server.json (gf=109) |
...
> Świeżość: 26s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-14T18:05:46.498720Z

- **Ostatni audyt:** SLOW_MODE | 25 issue(s) / 100 entries | 2026-02-14T18:05:46.498720Z
- **Top 5 typów problemów:** suspicious_log_high=109, suspicious_log_critical=81, identical_to_en_exempt=25, identical_to_en=13, artifact_token=12
- **Języki o najsłabszej jakości:** es(60.1, issues=177733), pl(60.1, issues=125497), tl(64.2, issues=466), zh_TW(64.8, issues=337), fr(66.5, issues=2470)
...
⚠️ **PL**: jakość 60%, 125497 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 177733 problemów
...
| Heartbeat | 15s temu | 2026-02-14T18:05:57Z |
...
- 2026-02-14 18:05:57 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | raids.json
- 2026-02-14 18:05:57 | AUTO_TRANSLATE:auto_start | pl | ok | raids.json
- 2026-02-14 18:05:39 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-14 18:05:11 | AUTO_TRANSLATE:heartbeat_tick | es | ok | scripts.json
- 2026-02-14 18:05:10 | AUTO_TRANSLATE:parallel_start | es | ok | scripts.json
- 2026-02-14 18:05:10 | AUTO_TRANSLATE:auto_done | pl | ok | scripts.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 46.7% | 0 | 2,063 | 4,129 | 5795 (58.4%) | 102 |
| 🟡 ES | 75.6% | 0 | 2,760 | 3,141 | 1217 (27.9%) | 98 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **72,963** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=56.5%, reason=decrease_high_fail_rate=56.5% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 7,270 kluczy / 200 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-14 18:06:12
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+13, skipped+0) — lang=pl file=otclient_modules.json strict_skipped_done=1974 guard_fail=33 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+24) — repair_identical lang=es file=npc.json target_identical=24 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=287.67
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **42,811** kluczy |
| ⏭️ Pominięte | 1 |
| 🔁 Cykli | 49 |
| ❌ Błędów | 570 |
| 🌍 Aktywnych języków | 52 |
| 🏆 TOP 5 | **ES** (13,326), **PL** (6,322), **IT** (971), **PT** (960), **DE** (890) |
| 📊 Porównanie | ↓ 7.1% vs wczoraj (46,073) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **90,233** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-14 18:06:12  
