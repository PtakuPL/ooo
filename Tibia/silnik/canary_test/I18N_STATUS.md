...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.45%**. Tempo: **2320.1 kluczy/h**. Tłumaczeń netto: **91,582**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-17 02:40:56

> **Aktualizacja:** 2026-02-17 02:40:56 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #171 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: - | Heartbeat: 2026-02-17T02:40:52Z  
> **Okno godzinowe:** okno=1.0h | cykli=162 | pominięte=0.0% | odrzucone=44.6% | przepustowość=2320.1/h  
> **Tłumaczeń netto:** 91,582

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-17 02:40:56 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-17T02:40:52Z |
| MIGRATION | 🔒 NIEAKTYWNY | 21s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-17 02:40:56 |
| TRANSLATION | 🟢 AKTYWNY | 21s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-17T02:40:35.932193Z |
| QUALITY | 🔒 NIEAKTYWNY | 5s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-17T02:40:52.407034Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-17 02:40:56 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-17T02:40:52Z
...
| ❤️ **Heartbeat** | 2026-02-17T02:40:52Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **4,123** kluczy |
| ❌ Odrzucone (guard) | 3314 |
| 🔁 Cykli | 162 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | IT (825 kluczy) |
...
> Świeżość: 21s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-17 02:40:56
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 21s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-17T02:40:35.932193Z
...
| RU (Rosyjski) | 19,990/53,586 | 37.30% | 2,587 | 0 |
...
| RU | 17,248/49,731 | 34.7% | 2,742/3,855 | 71.1% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-17T01:40:56.299078Z → 2026-02-17T02:40:56.299078Z) |
...
| Przepustowość (kluczy/h) | **2320.1 kluczy/h** |
| Podejrzane tłumaczenia | **14376** |
...
> Świeżość: 5s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-17T02:40:52.407034Z

- **Ostatni audyt:** OK | 7 issue(s) / 100 entries | 2026-02-17T02:40:52.407034Z
- **Top 5 typów problemów:** suspicious_rejected_critical=166, suspicious_log_high=143, suspicious_log_critical=55, suspicious_rejected_high=34, identical_to_en_exempt=10
- **Języki o najsłabszej jakości:** es(60.1, issues=184490), pl(60.1, issues=122727), ro(60.2, issues=32188), ru(60.2, issues=24969), it(60.9, issues=9318)
...
⚠️ **PL**: jakość 60%, 122727 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 184490 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 61%, 9318 problemów
⚠️ **RU**: jakość 60%, 24969 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 83%, 7512 problemów
...
| Heartbeat | 5s temu | 2026-02-17T02:40:52Z |
...
- 2026-02-17 02:40:43 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-17 02:40:24 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | scripts.json
- 2026-02-17 02:40:24 | AUTO_TRANSLATE:parallel_start | ro | ok | scripts.json
- 2026-02-17 02:40:12 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | scripts.json
- 2026-02-17 02:40:11 | AUTO_TRANSLATE:parallel_start | ru | ok | scripts.json
- 2026-02-17 02:40:10 | AUTO_TRANSLATE:auto_done | it | ok | scripts.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **91,582** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=36.9%, reason=decrease_high_fail_rate=36.9% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-17 02:40:56
...
- 🔧 MIGRATION: mini-batch [otclient_tools] → ok (keys+0) — mini_batch=1 processed=10/50
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **11,572** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 110 |
| ❌ Błędów | 182 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (2,417), **IT** (2,022), **RU** (1,934), **PL** (1,775), **RO** (1,755) |
| 📊 Porównanie | ↓ 43.0% vs wczoraj (20,288) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **111,766** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-17 02:40:56  
