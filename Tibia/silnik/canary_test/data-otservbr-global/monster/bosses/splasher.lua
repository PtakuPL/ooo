...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "Qua hah tsh!", yell = false , i18nKey = "monster.splasher.voice_1"},
	{ text = "Teech tsha tshul!", yell = false , i18nKey = "monster.splasher.voice_2"},
	{ text = "Quara tsha Fach!", yell = false , i18nKey = "monster.splasher.voice_3"},
	{ text = "Tssssha Quara!", yell = false , i18nKey = "monster.splasher.voice_4"},
	{ text = "Blubber.", yell = false , i18nKey = "monster.splasher.voice_5"},
	{ text = "Blup.", yell = false , i18nKey = "monster.splasher.voice_6"},
}
