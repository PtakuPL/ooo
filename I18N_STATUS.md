...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.7% / real 11.67%**. Tempo: **307.0 kluczy/h**. Tłumaczeń netto: **168,577**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-05-02 03:59:01

> **Aktualizacja:** 2026-05-02 03:59:01 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #19,179 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: cs | Plik: items.json | Heartbeat: 2026-05-02T03:53:42Z
> **Okno godzinowe:** okno=1.0h | cykli=52 | pominięte=0.0% | odrzucone=0.0% | przepustowość=307.0/h  
> **Tłumaczeń netto:** 168,577

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-05-02 03:59:01 |
| LIVE | 🟢 AKTYWNY | 5min temu | - | `activity.json / worker_state.json` | 2026-05-02T03:53:42Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 18h temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-05-02 03:59:01 |
| TRANSLATION | 🟢 AKTYWNY | 5min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-05-02T03:53:41.843257Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-05-02T03:56:41.230974Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-05-02 03:59:01 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-05-02T03:59:10.809203Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-05-02T03:53:42Z

| Metryka | Wartość |
|---------|---------|
| 🛠️ **Co robi** | Tłumaczenie automatyczne (Google Translate + TM) |
| 🌍 **Aktywne języki (10 min)** | CS, ES, RO, TR |
| 📝 **Faza** | AUTO_TRANSLATE |
| 📋 **Etap** | sygnał życia |
| 📂 **Kategoria / Język** | cs |
| 📄 **Plik** | items.json |
...
| ⏳ Oldest pending (visible tail) | 130455 s |
...
| 🧮 OpenAI budget | `68/250 (27.2%); policy=telemetry_only` |
| ♻️ Provider debt | `767` |
| 🌍 Recent provider mix | tm_dedup_file(138), OpenAI model pool(88), canonical_name_semantic_autofix(25), tm_dedup_propagate(15), can... |
...
| ❤️ Pool health | `degraded` (writes=276, fallbacks=31) |
...
| `NO_WRITE` | OK | OK | `337` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 393, 'oldest_s': 130455}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~401 dni (2,957,351 kluczy do celu 95%)
...
> Świeżość: 18h temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-05-02 03:59:01
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 5min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-05-02T03:53:41.843257Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-05-02T03:57:11.884934Z |
...
| 🕒 Evidence window | 24h (span=31.43h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=31.43h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=+0.00pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-05-02T02:59:01.932172Z → 2026-05-02T03:59:01.932172Z) |
...
| Najgorsze cele (strażnik) | tr/items.json (gf=0), ru/items.json (gf=0), cs/items.json (gf=0), it/items.json (gf=0), es/items.json (gf=0) |
...
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-05-02T03:56:41.230974Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-05-02T03:56:41.230974Z
- **Top 5 typów problemów:** suspicious_rejected_critical=130, suspicious_log_low=99, suspicious_log_high=98, suspicious_rejected_high=70, suspicious_log_medium=2
- **Języki o najsłabszej jakości:** es(60.1, issues=760272), ro(60.1, issues=455589), ru(60.1, issues=384922), de(60.1, issues=138828), cs(60.1, issues=137000)
...
⚠️ **TR**: jakość 64%, 61866 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 760272 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 86%, 182098 problemów
⚠️ **RU**: jakość 60%, 384922 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #19,179 |
| Heartbeat | 328s temu | 2026-05-02T03:53:42Z |
...
- 2026-05-02 03:58:43 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | items.json
- 2026-05-02 03:57:13 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | items.json
- 2026-05-02 03:57:12 | AUTO_TRANSLATE:auto_start | cs | ok | items.json
- 2026-05-02 03:55:32 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-05-02 03:54:01 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-05-02 03:59:01

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [tr] → warn (files+1, translated+31, skipped+0) — lang=tr file=items.json strict_skipped_done=4300
...
| 🔄 Cykli wykonanych | **#19,179** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #19,179 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-05-02 03:59:01  
