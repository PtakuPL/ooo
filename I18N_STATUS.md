...
<!-- TARGETS {'game': 100, 'items': 40000, 'misc': 100, 'monsters': 6000, 'npc': 15000, 'player': 200, 'quests': 700, 'scripts': 2500, 'server': 3000, 'spells': 2000, 'system': 2000, 'ui': 200, 'php': 3000, 'cpp': 900, 'html': 1500, 'client': 300, 'otclient_modules': 2500, 'otclient_data': 200, 'otclient_src': 300, 'otclient_mods': 100, 'otclient_tools': 50, 'achievements': 1048, 'actions': 100, 'arena': 184, 'books': 1403, 'chatchannels': 100, 'creaturescripts': 100, 'dataroot': 100, 'errors': 100, 'events': 100, 'example_merchant': 100, 'globalevents': 100, 'libs': 100, 'messages': 100, 'modules': 100, 'mounts': 100, 'movements': 100, 'npclib': 147, 'questlog': 1918, 'raids': 273, 'startup': 100, 'talkactions': 199, 'website_i18n': 1749, 'world': 100} -->

## 📝 PODSUMOWANIE

> Worker tłumaczy **53** języków. Klucze EN: **76,285**. Pokrycie globalne: **nominal 18.33% / real 11.47%**. Tempo: **41.8 kluczy/h**. Tłumaczeń netto: **170,947**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-05-03 19:07:11

> **Aktualizacja:** 2026-05-03 19:07:11 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 76285
> **Publikacja:** git-enabled
> **LIVE:** Cykl #19,576 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: auto_done | Kategoria: it | Plik: php.json | Heartbeat: 2026-05-03T19:06:08Z
> **Okno godzinowe:** okno=1.0h | cykli=64 | pominięte=0.0% | odrzucone=22.5% | przepustowość=41.8/h  
> **Tłumaczeń netto:** 170,947

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-05-03 19:07:11 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-05-03T19:06:08Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 2d temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-05-03 19:07:11 |
| TRANSLATION | 🟢 AKTYWNY | 17s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-05-03T19:06:57.522112Z |
| QUALITY | 🔒 NIEAKTYWNY | 16s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-05-03T19:06:58.235914Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-05-03 19:07:11 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-05-03T19:07:15.059204Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-05-03T19:06:08Z
...
| 🧠 **Detail** | translated=0 guard_fail=0 strict_missing_key=0 strict_skipped_done=12 |
| 🔑 **Current key** | `it:php.json` |
| 🔄 **Ostatni cykl** | 0 kluczy, 0 odrzuconych, 24.0s, tryb: AUTO_TRANSLATE, cel: it/php.json |
| ❤️ **Heartbeat** | 2026-05-03T19:06:08Z |

**Ostatnie operacje:**
- → AUTO_TRANSLATE_DONE (IT) [warn]
- → WEBSITE_I18N_IMPORT (EN) [ok]
...
|----------|------|---------|------|-------|--------|------------|--------|
| 19:02:48 | RU | WWW | php.json | 4 | `transliteration_cyrillic` | `php.validator.text5` | квертюиопасдфгджклзксквбнмКВЕРТЮИОПАСДФГДжКЛЗКсКВБНМ0123456789- |
| 19:01:27 | TR | WWW | html.json | 8 | `tm` | `html.forum.new_thread.html.text1` | [oyuncu]Nick[/player] |
| 19:00:36 | CS | WWW | html.json | 1 | `tm` | `web.tpl.guilds.manager.b_10` | [[PH0]&nbsp;&nbsp;[[PH3]&nbsp;Jméno |
| 18:49:49 | IT | WWW | html.json | 4 | `tm` | `html.forum.new_thread.html.text2` | [url]http://address.com/[/url] |
| 18:48:00 | RU | WWW | html.json | 6 | `tm` | `html.forum.new_thread.html.text3` | [имг]хттп://имагес.ком/имагес3.гиф[/имг] |
| 18:45:02 | ES | WWW | html.json | 4 | `tm` | `html.forum.new_thread.html.text2` | [url]http://address.com/[/url] |
...
|----------|------|---------|-----------|-------|----------|--------------|-----|
| 19:02:41 | RU | WWW | php.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `php.rfc6238.text3` |
| 19:02:39 | RU | WWW | php.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `php.rfc6238.text2` |
| 19:02:39 | RU | WWW | php.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `php.monsters.text2` |
| 19:02:39 | RU | WWW | php.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `php.monsters.text1` |
| 19:02:37 | RU | WWW | php.json | `hard_block` | `high_reject_types` | `cyrillic_latin_mix, mixed_scripts` | `php.mailer.text1` |
| 18:47:54 | RU | WWW | html.json | `hard_block` | `validate_wrong_script` | `wrong_script` | `html.forum.new_thread.html.text2` |
| 18:47:52 | RU | WWW | html.json | `hard_block` | `high_reject_types` | `cyrillic_latin_mix, mixed_scripts` | `html.forum.new_thread.html.text1` |
| 18:40:56 | PL | WWW | html.json | `hard_block` | `validate_command` | `command` | `html.forum.new_thread.html.text1` |
| 18:36:31 | RU | Serwer | monsters.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `monster.cosmic_energy_prism_b.name` |
| 02:15:39 | RU | Serwer | items.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `item.14670.name` |
| 02:15:37 | RU | Serwer | items.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `item.11541.name` |
| 01:43:50 | RU | Serwer | items.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `item.14670.name` |
| 01:43:48 | RU | Serwer | items.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `item.11541.name` |
| 01:38:08 | DE | Serwer | npc.json | `hard_block` | `too_many_issues` | `canonical_term_missing, canonical_term_missin...` | `npc.arkulius.multi_16` |
| 01:38:05 | DE | Serwer | npc.json | `hard_block` | `too_many_issues` | `canonical_term_missing, canonical_term_missin...` | `npc.angelo.say_14` |
| 01:28:17 | RU | Serwer | items.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `item.14670.name` |
| 01:28:14 | RU | Serwer | items.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `item.11541.name` |
| 01:20:58 | DE | Serwer | npc.json | `hard_block` | `too_many_issues` | `canonical_term_missing, canonical_term_missin...` | `npc.arkulius.say_15` |
| 01:20:56 | DE | Serwer | npc.json | `hard_block` | `too_many_issues` | `canonical_term_missing, canonical_term_missin...` | `npc.arkulius.multi_16` |
| 01:20:54 | DE | Serwer | npc.json | `hard_block` | `too_many_issues` | `canonical_term_missing, canonical_term_missin...` | `npc.angelo.say_14` |
...
| 📌 Blocker candidates | 46 |
| 📨 Pending queue (visible tail) | 400 z ostatnich 400 poprawnych wpisów JSONL |
| ⏳ Oldest pending (visible tail) | 138582 s |
| 🌍 Top języki | RU(397), DE(1), RO(1), TR(1) |
| 🧱 Top reason_bucket | quality(388), default(10), command(1), provider_error(1) |
| 🗂️ Deferred state keys | 9765 |
...
| 🧠 Active model | `openai/gpt-4.1-mini` |
...
| 🧮 OpenAI budget | `1/250 (0.4%); policy=telemetry_only` |
| ♻️ Provider debt | `711` |
| 🌍 Recent provider mix | tm_dedup_file(58), Free Google Translate(38), TM/simple(12), canonical_name_semantic_autofix(9), term_consi... |
| 🔁 Latest fallback | TM/simple → fallback to next provider validate fail [validate_word_salad] server.json |
| 📉 Fallback breakdown | fallback to next provider validate fail(35), fallback to google translate validate fail(7), fallback to goo... |
| ☁️ Cloud policy | `disabled` |
| 🤖 OpenAI pool | `active` |
| 🩺 Health signals | recent_fallback, provider_consistency_debt:711 |
| ❤️ Pool health | `degraded` (writes=118, fallbacks=46) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=36/36 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
|-------|--------|----------|-------|-----------|--------|
| `HEARTBEAT_STALE` | OK | OK | `38` | `300` | Heartbeat świeży (38s, src=worker_runtime_heartbeat) Runtime[status=healthy, reason=heartbeat_fresh, phase=... |
| `NO_WRITE` | OK | OK | `266` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 138582}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| 🆕 Newly opened (cycle) | - |
| ✅ Resolved (cycle) | - |
| 📌 Active alarm codes | LANG_PARITY_WARN, NATIVE_READINESS_BELOW_THRESHOLD, PROGRESS_REGRESSION_UNTRACKED, QUEUE_STARVATION_DETECTE... |
...
| 🧊 Cooldown active | tak (pozostało: 1 cykli) |
...
| �📊 Przetłumaczono | **31** kluczy |
| ❌ Odrzucone (guard) | 9 |
| 🔁 Cykli | 64 |
| 🌍 Języków | 11 |
| 🏆 Najaktywniejszy | RU (10 kluczy) |
| 📄 Najczęstszy plik | html.json |
| ⚡ Przepustowość | ~42 kluczy/h |
| 🛡️ Odrzucone (strażnik) | 22.5% |
| ⚠️ Podejrzane | 86 |
...
|-------|---------------|-----------|----------|----------|
| PL | 63,971 | 76,285 | 83.86% ↓-0.33% | 5,023 |
| ES | 59,618 | 76,285 | 78.15% ↓-1.84% | 9,501 |
| RO | 58,478 | 76,285 | 76.66% | 12,346 |
| IT | 53,802 | 76,285 | 70.53% | 10,029 |
| RU | 34,121 | 76,285 | 44.73% ↓-1.05% | 4,771 |
| FR | 42,864 | 76,285 | 56.19% ↓-1.32% | 26,153 |
| TR | 33,018 | 76,285 | 43.28% | 3,840 |
| CS | 38,920 | 76,285 | 51.02% | 29,600 |
| PT | 60,516 | 76,285 | 79.33% ↓-1.86% | 48,839 |
| SR | 24,827 | 76,285 | 32.55% | 1,218 |
| NL | 57,814 | 76,285 | 75.79% | 49,478 |
| DE | 52,184 | 76,285 | 68.41% ↓-1.60% | 63,488 |
| BN | 4,787 | 76,285 | 6.28% | 3,991 |
| AR | 4,662 | 76,285 | 6.11% | 3,974 |
| LT | 3,606 | 76,285 | 4.73% | 2,792 |
| FA | 4,661 | 76,285 | 6.11% | 4,199 |
| HI | 4,294 | 76,285 | 5.63% | 3,960 |
| ID | 4,287 | 76,285 | 5.62% | 4,006 |
| AZ | 3,511 | 76,285 | 4.6% | 2,997 |
| BG | 3,502 | 76,285 | 4.59% | 3,019 |
...
> **ETA globalne:** ~3031 dni (3,041,219 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| PL | ████████████████░░░░ | 83.9% | 63,971/76,285 | ~8d |
| ES | ███████████████░░░░░ | 78.2% | 59,618/76,285 | ~13d |
| RO | ███████████████░░░░░ | 76.7% | 58,478/76,285 | ~14d |
| IT | ██████████████░░░░░░ | 70.5% | 53,802/76,285 | ~19d |
| RU | ████████░░░░░░░░░░░░ | 44.7% | 34,121/76,285 | ~38d |
| FR | ███████████░░░░░░░░░ | 56.2% | 42,864/76,285 | ~30d |
| TR | ████████░░░░░░░░░░░░ | 43.3% | 33,018/76,285 | ~39d |
| CS | ██████████░░░░░░░░░░ | 51.0% | 38,920/76,285 | ~33d |
| PT | ███████████████░░░░░ | 79.3% | 60,516/76,285 | ~12d |
| SR | ██████░░░░░░░░░░░░░░ | 32.5% | 24,827/76,285 | ~47d |
| NL | ███████████████░░░░░ | 75.8% | 57,814/76,285 | ~15d |
| DE | █████████████░░░░░░░ | 68.4% | 52,184/76,285 | ~20d |
| BN | █░░░░░░░░░░░░░░░░░░░ | 6.3% | 4,787/76,285 | ~67d |
| AR | █░░░░░░░░░░░░░░░░░░░ | 6.1% | 4,662/76,285 | ~68d |
| LT | ░░░░░░░░░░░░░░░░░░░░ | 4.7% | 3,606/76,285 | ~69d |
| FA | █░░░░░░░░░░░░░░░░░░░ | 6.1% | 4,661/76,285 | ~68d |
| HI | █░░░░░░░░░░░░░░░░░░░ | 5.6% | 4,294/76,285 | ~68d |
| ID | █░░░░░░░░░░░░░░░░░░░ | 5.6% | 4,287/76,285 | ~68d |
| AZ | ░░░░░░░░░░░░░░░░░░░░ | 4.6% | 3,511/76,285 | ~69d |
| BG | ░░░░░░░░░░░░░░░░░░░░ | 4.6% | 3,502/76,285 | ~69d |

> Tempo obliczone na bazie ostatniej godziny: ~42 kluczy/h.
...
> Świeżość: 2d temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-05-03 19:07:11

### 📁 Pliki Projektu (pełny skan)
| Metryka | Wartość | Procent | Info |
|---------|---------|---------|------|
| 📂 **Wszystkie pliki** | **22,203** | 100% | cały projekt |
| 📜 Do skanowania (kod) | **10,427** | 47.0% | pliki z kodem/tekstami |
| 🔍 **Przeskanowane (historia)** | **6,443** | **61.8%** | `i18n_processed_files.txt` |
| 🧭 Przeskanowane (LIVE) | **15** | **0.1%** | `i18n_file_status.json` |
| ⏳ Nie przeskanowane (historia) | **3,984** | 38.2% | wg historii workera |
| ⏳ Nie przeskanowane (LIVE) | **10,412** | 99.9% | wg rejestru LIVE |
...
|---------|---------|------|
| 🔑 **Klucze EN (źródłowe)** | **76,285** | wszystkie kategorie |
| 🧮 **Klucze wyekstrahowane (LIVE)** | **76,285** | realny stan `i18n/en/*.json` |
...
| ➕ Klucze poza rejestrem workera | **1,749** | ręczne zmiany / starsze migracje |
| 📊 NPC | 14,815 | dialogi NPC |
| 📊 Items | 36,733 | przedmioty |
| 📊 Monsters | 5,915 | potwory |
| 📊 HTML | 1,495 | widoki web |
| 📊 Pozostałe | 17,327 | scripts, spells, etc. |

## 🌍 TŁUMACZENIA

> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 17s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-05-03T19:06:57.522112Z
...
|-------|-----------|--------|----------|--------------|--------------|
| PL (Polski) | 83.86% (63,971/76,285) | 79.18% (60,405/76,285) | 5,023 | 10,654 | 229 |
| ES (Hiszpański) | 78.15% (59,618/76,285) | 67.52% (51,506/76,285) | 9,501 | 13,553 | 1,749 |
| RO (Rumuński) | 76.66% (58,478/76,285) | 64.78% (49,418/76,285) | 12,346 | 12,797 | 1,749 |
| IT (Włoski) | 70.53% (53,802/76,285) | 62.50% (47,677/76,285) | 10,029 | 16,855 | 1,749 |
| RU (Rosyjski) | 44.73% (34,121/76,285) | 43.20% (32,953/76,285) | 4,771 | 36,830 | 1,749 |
| FR (Francuski) | 56.19% (42,864/76,285) | 40.91% (31,206/76,285) | 26,153 | 17,199 | 1,749 |
| TR (Turecki) | 43.28% (33,018/76,285) | 39.87% (30,413/76,285) | 3,840 | 40,297 | 1,749 |
| CS (Czeski) | 51.02% (38,920/76,285) | 33.99% (25,932/76,285) | 29,600 | 19,030 | 1,749 |
| PT (Portugalski) | 79.33% (60,516/76,285) | 32.16% (24,530/76,285) | 48,839 | 1,189 | 1,749 |
| SR (SR) | 32.55% (24,827/76,285) | 31.31% (23,885/76,285) | 1,218 | 28,698 | 22,542 |
| NL (Niderlandzki) | 75.79% (57,814/76,285) | 31.23% (23,823/76,285) | 49,478 | 1,260 | 1,749 |
| DE (Niemiecki) | 68.41% (52,184/76,285) | 12.89% (9,833/76,285) | 63,488 | 1,240 | 1,749 |
| BN (BN) | 6.28% (4,787/76,285) | 2.51% (1,912/76,285) | 3,991 | 47,898 | 22,542 |
| AR (Arabski) | 6.11% (4,662/76,285) | 2.36% (1,804/76,285) | 3,974 | 48,023 | 22,542 |
| LT (LT) | 4.73% (3,606/76,285) | 2.17% (1,654/76,285) | 2,792 | 49,355 | 22,542 |
| FA (FA) | 6.11% (4,661/76,285) | 2.07% (1,578/76,285) | 4,199 | 48,024 | 22,542 |
| HI (HI) | 5.63% (4,294/76,285) | 1.90% (1,450/76,285) | 3,960 | 48,391 | 22,542 |
| ID (ID) | 5.62% (4,287/76,285) | 1.83% (1,397/76,285) | 4,006 | 48,398 | 22,542 |
| AZ (AZ) | 4.60% (3,511/76,285) | 1.80% (1,375/76,285) | 2,997 | 49,429 | 22,542 |
| BG (BG) | 4.59% (3,502/76,285) | 1.80% (1,374/76,285) | 3,019 | 49,408 | 22,542 |
...
- `RU/php.json` fas fa-pencil-alt → фас фа-пенцил-алт (`php.accounts.text5`, `transliteration_cyrillic`)
- `RU/php.json` 234567QWERTYUIOPASDFGHJKLZXCVBNM → 234567КВЕРТЮИОПАСДФГДжКЛЗКсКВБНМ (`php.rfc6238.text1`, `transliteration_cyrillic`)
- `RU/php.json` . FORUM_TABLE_PREFIX . → . ФОРУМ_ТАБЛЕ_ПРЕФИКс . (`php.forum.text1`, `transliteration_cyrillic`)
- `RU/php.json` qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM0123456789- → квертюиопасдфгджклзксквбнмКВЕРТЮИОПАСДФГДжКЛЗКсКВБНМ0123456789- (`php.validator.text5`, `transliteration_cyrillic`)
...
- `ES/html.json` [url]http://address.com/[/url] → [url]http://address.com/[/url] (`html.forum.edit_post.html.text2`, `tm_dedup_file`)
- `ES/html.json` [url]http://address.com/[/url] → [url]http://address.com/[/url] (`html.forum.new_post.html.text2`, `tm_dedup_file`)
- `ES/html.json` [url]http://address.com/[/url] → [url]http://address.com/[/url] (`html.forum.new_thread.html.text2`, `tm_dedup_file`)
...
- `RO/items.json` wooden roof → acoperiș de lemn (`item.1179.name`, `canonical_name_semantic_autofix`)
- `RO/items.json` This is an emblem of wisdom. It was awarded by TibiaStat.com → Aceasta este o emblemăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă (`item.14760.desc`, `term_consistency_autofix`)
- `RO/items.json` tattered curtain → perdea zdrențuită (`item.11817.name`, `google_translate`)
- `RO/items.json` dead draken abomination → abominație draken moartă (`item.11669.name`, `google_translate`)
- `RO/items.json` dead orc marauder → jefuitor orc mort (`item.10337.name`, `google_translate`)
- `RO/items.json` dead draken warmaster → războinic draken mort (`item.10192.name`, `google_translate`)
- `ES/items.json` large spider web → telaraña grande (`item.12767.name`, `canonical_name_semantic_autofix`)
- `ES/items.json` hive structure → estructura de colmena (`item.12857.name`, `google_translate`)
- `ES/items.json` rocky floor → suelo rocoso (`item.12365.name`, `google_translate`)
...
- `TR/items.json` buttress → payanda (`item.36434.name`, `tm_dedup_file`)
- `TR/items.json` buttress → payanda (`item.36433.name`, `tm_dedup_file`)
- `TR/items.json` buttress → payanda (`item.36432.name`, `tm_dedup_file`)
- `TR/items.json` buttress → payanda (`item.36431.name`, `tm_dedup_file`)
- `TR/items.json` buttress → payanda (`item.36430.name`, `tm_dedup_file`)
- `TR/items.json` buttress → payanda (`item.33627.name`, `tm_dedup_file`)
- `TR/items.json` buttress → payanda (`item.33626.name`, `tm_dedup_file`)
- `TR/items.json` buttress → payanda (`item.33625.name`, `tm_dedup_file`)
- `TR/items.json` buttress → payanda (`item.33624.name`, `tm_dedup_file`)
- `TR/items.json` buttress → payanda (`item.33623.name`, `tm_dedup_file`)
- `TR/items.json` buttress → payanda (`item.33270.name`, `tm_dedup_file`)
- `TR/items.json` buttress → payanda (`item.33269.name`, `tm_dedup_file`)

> Brak świeżych fizycznie potwierdzonych wpisów dla aktywnego celu `IT/php.json`. Pokazuję globalne ostatnie wpisy.

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **5250**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **5100**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 46 | 10 | 229 | - | 2026-05-03T19:06:33.334265Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.33%** (727,221/3,966,820)
- **Pokrycie globalne (real):** **11.47%** (454,839/3,966,820)
- **Kopie EN (łącznie):** **407,173**
- **Placeholdery [EN]/puste (łącznie):** **2,161,258**
- **Referencje `#i18n:` (łącznie):** **7,934**
- **Braki kluczy (łącznie):** **945,663**
- **Brakujące pliki językowe:** **62**
- **Cache STATUSPY (per-lang):** **mixed** | hit **50**, miss **2**, hit-rate **96.2%**
- **Cache STATUSPY (per-file):** hit **2078**, miss **2**, hit-rate **99.9%**
...
|-------|----------------|-----------|-----------------|
| HU | 49,854 | 76,285 | 65.35% |
| SK | 49,937 | 76,285 | 65.46% |
| TR | 40,297 | 76,285 | 52.82% |
...
|-------|--------|--------------------------|----------|----------------------------|
| PL | 60,823/72,386 | 84.0% / 79.2% | 3,148/3,899 | 80.7% / 78.4% |
| ES | 56,458/72,386 | 78.0% / 66.9% | 3,160/3,899 | 81.0% / 79.2% |
| RO | 55,692/72,386 | 76.9% / 64.5% | 2,786/3,899 | 71.5% / 69.6% |
| IT | 50,829/72,386 | 70.2% / 61.9% | 2,973/3,899 | 76.2% / 73.1% |
| RU | 30,975/72,386 | 42.8% / 41.2% | 3,146/3,899 | 80.7% / 79.4% |
| FR | 39,937/72,386 | 55.2% / 39.1% | 2,927/3,899 | 75.1% / 73.7% |
| TR | 31,059/72,386 | 42.9% / 39.4% | 1,959/3,899 | 50.2% / 48.7% |
| CS | 37,230/72,386 | 51.4% / 33.7% | 1,690/3,899 | 43.3% / 39.0% |
| PT | 58,449/72,386 | 80.8% / 31.2% | 2,067/3,899 | 53.0% / 50.0% |
| SR | 24,726/72,386 | 34.2% / 32.9% | 101/3,899 | 2.6% / 2.3% |
| NL | 55,803/72,386 | 77.1% / 30.4% | 2,011/3,899 | 51.6% / 47.2% |
| DE | 50,214/72,386 | 69.4% / 11.0% | 1,970/3,899 | 50.5% / 47.5% |
...
| RU | 65.5% / 65.4% | 83.0% / 83.0% | 99.2% / 96.7% | 88.9% / 86.8% |
...
| 🥉 Worst | Website 10.85% |
| ↕️ Spread | 7.46 pp |
| 📉 Largest regression 24h | Server (-0.25 pp) |
| 🕒 Window | 24h, samples=36 |
...
| #3 | 🔴 Server | 11.58% | -0.25 pp | 51 | ZH 0.2%, TL 0.8%, BS 0.8% |
...
| 🕒 Evidence window | 24h (span=33.88h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=33.88h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=+0.00pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-05-03T18:07:12.314888Z → 2026-05-03T19:07:12.314888Z) |
| Cykle | **64** (TŁUMACZENIE=60, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **22.5%** |
| Cykle bez postępu % | **56.2%** |
| Przepustowość (kluczy/h) | **41.8 kluczy/h** |
| Podejrzane tłumaczenia | **86** |
| Najgorsze cele (strażnik) | ru/php.json (gf=5), ru/html.json (gf=2), pl/html.json (gf=1), ro/php.json (gf=1), es/html.json (gf=0) |
...
|--------|-----------|--------|----------------|
| `gt_rejected_high_mixed_scripts` | 5 | 41.7% | ru/php.json (4) |
| `gt_rejected_high_cyrillic_latin_mix` | 2 | 16.7% | ru/html.json (1) |
| `gt_identity_retry_identical_to_en` | 2 | 16.7% | de/html.json (1) |
| `gt_validate_fail_wrong_script` | 1 | 8.3% | ru/html.json (1) |
| `gt_no_result` | 1 | 8.3% | tr/html.json (1) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 16s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-05-03T19:06:58.235914Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-05-03T19:06:58.235914Z
- **Top 5 typów problemów:** suspicious_rejected_critical=123, suspicious_log_high=115, suspicious_rejected_high=77, suspicious_log_low=73, identical_to_en_exempt=12
- **Języki o najsłabszej jakości:** es(60.1, issues=766601), ro(60.1, issues=462659), ru(60.1, issues=394456), cs(60.1, issues=145868), de(60.1, issues=142891)
...
| 🔑 Kluczy wyekstrahowanych (LIVE) | **76,285** | realny stan EN |
...
⚠️ **TR**: jakość 60%, 66673 problemów
⚠️ **PL**: jakość 98%, 389634 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 766601 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 62%, 183024 problemów
⚠️ **RU**: jakość 60%, 394456 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #19,576 |
| Heartbeat | 67s temu | 2026-05-03T19:06:08Z |
...
- **Ostatnia aktualizacja:** 2026-05-03T19:04:53.589799Z
...
│ Plik: php.json                                                │
│ Postęp: batch: 10 keys/cykl                                   │
│ …d=0 guard_fail=0 strict_missing_key=0 strict_skipped_done=12 │
├─────────────────────────────────────────────────────────────────┤
│ ❤️ Heartbeat: 2026-05-03T19:06:08Z           │
└─────────────────────────────────────────────────────────────────┘
```
...
- 2026-05-03 19:06:57 | AUTO_TRANSLATE:auto_done | it | ok | php.json
- 2026-05-03 19:06:34 | AUTO_TRANSLATE:heartbeat_tick | it | ok | php.json
- 2026-05-03 19:06:33 | AUTO_TRANSLATE:auto_start | it | ok | php.json
- 2026-05-03 19:06:08 | TRANSLATION_SYNC:sync_done | pl | ok | website_i18n.json
- 2026-05-03 19:06:07 | TRANSLATION_SYNC:sync_start | pl | ok | website_i18n.json
- 2026-05-03 19:04:54 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 83.9% | 229 | 5,023 | 4 | 1 (20.0%) | 2 |
| 🟡 ES | 78.2% | 1,749 | 9,501 | 917 | 0 (0.0%) | 32 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **170,947** | — | 📊 |
| Adaptacyjna paczka | batch=27, gf_rate=26.09%, reason=decrease_high_fail_rate=26.1%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 921 kluczy / 34 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-05-03 19:07:11

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+0, translated+0, skipped+0) — lang=it file=php.json strict_skipped_done=12
- 🤖 AUTO_TRANSLATE: WEBSITE_I18N_IMPORT [en] → ok — changed=1 keys=1749
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+4, skipped+0) — lang=es file=html.json strict_skipped_done=119
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+7, skipped+0) — lang=ro file=items.json strict_skipped_done=360
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+0) — repair_identical lang=es file=npc.json target_identical=2 limit=180 tier=low_backlog domain_cap=260 gt=true suspicious_pct=100.00
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+11, skipped+0) — lang=ro file=items.json strict_skipped_done=360
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+0) — repair_identical lang=es file=npc.json target_identical=2 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=106.60
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+17, skipped+0) — lang=es file=items.json strict_skipped_done=2492
...
| ❌ Błędów | 20 |
| 🌍 Aktywnych języków | 6 |
| 🏆 TOP 5 | **RU** (10), **TR** (8), **ES** (4), **IT** (4), **PL** (4) |
| 📊 Porównanie | ↓ 99.8% vs wczoraj (14,388) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **47,399** kluczy
...
| 🔑 Kluczy wyciągniętych (LIVE) | **76,285** | realny stan `i18n/en/*.json` |
...
| 🧩 Reconcile korekta rejestru | **74,529** | zmiany EN poza workerem |
| ➕ Kluczy poza rejestrem workera | **1,749** | ręczne/Codex/Claude/starsze |
| 🌍 Języków | **53** | EN + tłumaczenia |
| 🔄 Cykli wykonanych | **#19,576** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #19,576 |
...
| 🎨 Ui | 0 | ░░░░░░░░░░░░░░░░░░░░ | 200 | ⏳ 0% |
| 📁 Website_i18n | 1749 | ████████████████████ | 1749 | ✅ 100% |
| 🌎 World | 0 | ░░░░░░░░░░░░░░░░░░░░ | 100 | ⏳ 0% |

---

🤖 Machine-readable: `i18n_file_status.json`  
📅 Auto-updated by Worker v1.1 | Last: 2026-05-03 19:07:11  
