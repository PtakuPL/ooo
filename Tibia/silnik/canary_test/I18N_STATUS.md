...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.06% / real 10.98%**. Tempo: **714.0 kluczy/h**. Tłumaczeń netto: **149,284**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 15:01:34

> **Aktualizacja:** 2026-04-29 15:01:34 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,581 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ro | Plik: items.json | Heartbeat: 2026-04-29T15:00:32Z
> **Okno godzinowe:** okno=1.0h | cykli=81 | pominięte=0.0% | odrzucone=5.9% | przepustowość=714.0/h  
> **Tłumaczeń netto:** 149,284

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 15:01:34 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T15:00:32Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 18s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 15:01:34 |
| TRANSLATION | 🟢 AKTYWNY | 3min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T14:58:26.896220Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T15:00:31.645621Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 15:01:34 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T15:01:41.880917Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T15:00:32Z
...
| ❤️ **Heartbeat** | 2026-04-29T15:00:32Z |
...
| 🌍 Recent provider mix | TM/simple(337), Free Google Translate(139), canonical_name_semantic_autofix(18), OpenAI model pool(10), ter... |
...
| ❤️ Pool health | `critical` (writes=507, fallbacks=32) |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 397, 'oldest_s': 17266}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~174 dni (2,982,173 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~714 kluczy/h.
...
> Świeżość: 18s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 15:01:34
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T14:58:26.896220Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T15:00:58.837633Z |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T14:01:34.796673Z → 2026-04-29T15:01:34.796673Z) |
...
| Przepustowość (kluczy/h) | **714.0 kluczy/h** |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T15:00:31.645621Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T15:00:31.645621Z
- **Top 5 typów problemów:** suspicious_rejected_critical=190, suspicious_log_high=125, suspicious_log_low=73, suspicious_rejected_high=10, suspicious_log_critical=1
- **Języki o najsłabszej jakości:** es(60.1, issues=751246), ro(60.1, issues=445423), de(60.1, issues=127860), cs(60.1, issues=120606), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 751246 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 77%, 179315 problemów
⚠️ **RU**: jakość 64%, 374681 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,581 |
| Heartbeat | 69s temu | 2026-04-29T15:00:32Z |
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **149,284** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=6.44%, reason=stable_fail_rate=6.4%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 15:01:34
...
| 🔄 Cykli wykonanych | **#18,581** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,581 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 15:01:34  
