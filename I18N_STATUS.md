...
> **Aktualizacja:** 2025-12-11 21:26:43 UTC  
...
|---------|---------|---------|------|
| 📂 Wszystkie pliki | **16,611** | 100% | cały projekt |
| 📜 Pliki do skanowania | **5,541** | 33.4% | .lua + .xml |
| 🔍 Przeskanowane | **354** | 6.4% | worker history |
| ✅ Zmigrowane (z kluczami) | **0** | 0.0% | mają klucze i18n |
| ⏳ Do zmigrowania | **354** | - | bez kluczy jeszcze |
...
| 📊 NPC | 5,339 | główna kategoria |
| 📊 Items | 13,749 | przedmioty |
| 📊 Monsters | 7,341 | potwory |
| 📊 Pozostałe | 2,374 | scripts, spells, etc. |

### 🌍 Języki i Tłumaczenia
| Metryka | Wartość | Info |
|---------|---------|------|
| 🌐 Wszystkie języki | **53** | foldery w i18n/ |
| 📋 Przygotowane ([EN]) | **52** | mają pliki JSON |
| ✅ Przetłumaczone | **52** | mają prawdziwe tłumaczenia |
...
| 🚀 Rozpoczętych prac | **0** | pliki in_progress |
...
├─────────────────────────────────────────────────────────────────┤
│ 📅 Ostatnia aktualizacja: 2025-12-11 21:26:43            │
└─────────────────────────────────────────────────────────────────┘
```
...
|---------|---------|-----------|
| 📁 Plików przeskanowanych | **354** | wszystkie kategorie |
| ✅ Plików z kluczami | **0** | zawierały hardcoded strings |
| ⬜ Plików bez kluczy | **354** | czyste (brak hardcoded) |
...
📅 Auto-updated by Worker v1.1 | Last: 2025-12-11 21:26:43  
...
- ✅ `the_lootmonger` - ukończono 2025-12-11 21:26
- ✅ `tandros` - ukończono 2025-12-11 21:26
- ✅ `sundara` - ukończono 2025-12-11 21:26
- ✅ `sigurd` - ukończono 2025-12-11 21:26
- ✅ `shiriel` - ukończono 2025-12-11 21:26
- ✅ `seymour` - ukończono 2025-12-11 21:26
- ✅ `romir` - ukończono 2025-12-11 21:26
- ✅ `rock_in_a_hard_place` - ukończono 2025-12-11 21:26
- ✅ `nipuna` - ukończono 2025-12-11 21:26
- ✅ `nelly` - ukończono 2025-12-11 21:26
