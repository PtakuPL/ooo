...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.84%**. Tempo: **1647.0 kluczy/h**. Tłumaczeń netto: **115,349**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 17:29:39

> **Aktualizacja:** 2026-02-20 17:29:39 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #6 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: sv | Plik: - | Heartbeat: 2026-02-20T17:29:35Z  
> **Okno godzinowe:** okno=1.0h | cykli=152 | pominięte=0.0% | odrzucone=61.0% | przepustowość=1647.0/h  
> **Tłumaczeń netto:** 115,349

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 17:29:39 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T17:29:35Z |
| MIGRATION | 🔒 NIEAKTYWNY | 54s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 17:29:39 |
| TRANSLATION | 🟢 AKTYWNY | 5s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T17:29:35.146143Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T17:29:40.565339Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 17:29:39 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T17:29:35Z
...
| ❤️ **Heartbeat** | 2026-02-20T17:29:35Z |
...
> **ETA globalne:** ~57 dni (2,261,507 kluczy do celu 95%)
...
> Świeżość: 54s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 17:29:39
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T17:29:35.146143Z
...
- You successfully hunted 300 gnarlhounds. If you want to you may complete this ta → Udało Ci się upolować 300 Gnarlhoundów. Jeśli chcesz, możesz wykonać to zadanie  (questlog.quest_11.mission_13.state_1)
- You succesfully hunted 300 gnarlhounds. → Udało Ci się upolować 300 Gnarlhoundów. (questlog.quest_11.mission_13.state_2)
- Paw and Fur: Terramites → Paw and Fur: Terramites (questlog.quest_11.mission_14.name)
- You successfully hunted 300 terramites. If you want to you may complete this tas → Udało Ci się upolować 300 termitów. Jeśli chcesz, możesz wykonać to zadanie jesz (questlog.quest_11.mission_14.state_1)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **6646**  
- Raporty blokad: **0**  
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T16:29:39.883287Z → 2026-02-20T17:29:39.883287Z) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T17:29:40.565339Z
...
| Heartbeat | 5s temu | 2026-02-20T17:29:35Z |
...
- 2026-02-20 17:29:16 | AUTO_TRANSLATE:parallel_start | pl | ok | questlog.json
- 2026-02-20 17:29:11 | AUTO_TRANSLATE:heartbeat_tick | sr | ok | server.json
- 2026-02-20 17:29:11 | AUTO_TRANSLATE:parallel_start | sr | ok | server.json
- 2026-02-20 17:29:10 | AUTO_TRANSLATE:auto_done | sv | ok | server.json
- 2026-02-20 17:28:49 | AUTO_TRANSLATE:heartbeat_tick | sv | ok | server.json
...
| 🟡 ES | 84.7% | 0 | 2,164 | 709 | 2954 (80.6%) | 40 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **115,349** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=40.6%, reason=decrease_high_fail_rate=40.6% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,456 kluczy / 78 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 17:29:39
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **3,902** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 17 |
| ❌ Błędów | 84 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (997), **RU** (730), **IT** (700), **RO** (460), **PL** (428) |
| 📊 Porównanie | ↑ 7.2% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **101,487** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 17:29:39  
