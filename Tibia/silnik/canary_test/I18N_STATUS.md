...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.05% / real 10.97%**. Tempo: **503.0 kluczy/h**. Tłumaczeń netto: **148,582**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 13:57:49

> **Aktualizacja:** 2026-04-29 13:57:49 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,493 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: items.json | Heartbeat: 2026-04-29T13:56:37Z
> **Okno godzinowe:** okno=1.0h | cykli=65 | pominięte=0.0% | odrzucone=5.5% | przepustowość=503.0/h  
> **Tłumaczeń netto:** 148,582

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 13:57:49 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T13:56:37Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 39s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 13:57:49 |
| TRANSLATION | 🟢 AKTYWNY | 4min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T13:53:31.910465Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T13:56:37.231103Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 13:57:49 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T13:57:56.329143Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T13:56:37Z
...
| ❤️ **Heartbeat** | 2026-04-29T13:56:37Z |
...
| ⏳ Oldest pending (visible tail) | 17614 s |
...
| 🌍 Recent provider mix | TM/simple(327), Free Google Translate(154), canonical_name_semantic_autofix(17), OpenAI model pool(6), term... |
...
| ❤️ Pool health | `critical` (writes=507, fallbacks=27) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=1079/1079 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 17614}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~247 dni (2,982,483 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 79.2% | 59,029/74,536 | ~23h |
| PL | ██████████████░░░░░░ | 71.0% | 52,911/74,536 | ~36h |
| IT | ██████████████░░░░░░ | 71.3% | 53,166/74,536 | ~35h |
| RO | █████████████░░░░░░░ | 69.7% | 51,972/74,536 | ~37h |
...
> Tempo obliczone na bazie ostatniej godziny: ~503 kluczy/h.
...
> Świeżość: 39s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 13:57:49
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 4min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T13:53:31.910465Z
...
- Please. Wait. I. Can. Not. Han-Han-Han*chhhhhrrrchrk*Handle. *chhhhrchrk* This.  → Por favor. Espera. Yo. No. Pue-Pue-Pue- *chhhhhrrrchrk* Puedo. *chhhhrchrk* Mane (npc.broken_servant_sentry.multi_1)
- If. You. Bring. Slime. Fungus. Samples. Fro-Fro-Fro-Frrrr*chhhhchrk*From. Other. → Si. Traes. Muestras. De Limo. Hongo. De. Otra. Torre. Debes. Ser. El. Maestro. ¿ (npc.broken_servant_sentry.say_1)
...
- Raporty strażnika jakości: **4971**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4824**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T13:57:05.480906Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.05%** (699,585/3,875,872)
- **Pokrycie globalne (real):** **10.97%** (425,329/3,875,872)
- **Kopie EN (łącznie):** **410,343**
- **Placeholdery [EN]/puste (łącznie):** **2,186,078**
...
| 🕒 Evidence window | 24h (span=43.09h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=43.09h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T12:57:49.997968Z → 2026-04-29T13:57:49.997968Z) |
...
| Przepustowość (kluczy/h) | **503.0 kluczy/h** |
| Podejrzane tłumaczenia | **878** |
| Najgorsze cele (strażnik) | ro/items.json (gf=12), cs/items.json (gf=9), it/items.json (gf=2), de/otclient_modules.json (gf=2), de/npc.json (gf=2) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T13:56:37.231103Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T13:56:37.231103Z
- **Top 5 typów problemów:** suspicious_rejected_critical=190, suspicious_log_high=108, suspicious_log_low=91, suspicious_rejected_high=10, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=749350), ro(60.1, issues=443918), de(60.1, issues=126410), cs(60.1, issues=117696), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 749350 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 70%, 178686 problemów
⚠️ **RU**: jakość 61%, 373663 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,493 |
| Heartbeat | 79s temu | 2026-04-29T13:56:37Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T13:53:49.779328Z
...
- 2026-04-29 13:57:06 | AUTO_TRANSLATE:auto_start | es | ok | items.json
- 2026-04-29 13:55:20 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 13:53:50 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 13:53:32 | AUTO_TRANSLATE:auto_done | it | ok | items.json
- 2026-04-29 13:53:23 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **148,582** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=6.29%, reason=stable_fail_rate=6.3%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 13:57:49

- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+4) — repair_identical lang=es file=npc.json target_identical=2 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=207.14
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+18, skipped+0) — lang=es file=items.json strict_skipped_done=1223
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+7) — repair_identical lang=es file=npc.json target_identical=2 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=232.52
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **11,325** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 216 |
| ❌ Błędów | 500 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,935), **RU** (1,809), **TR** (1,764), **IT** (1,633), **DE** (1,620) |
| 📊 Porównanie | ↑ 37.6% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **30,305** kluczy
...
| 🔄 Cykli wykonanych | **#18,493** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,493 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 13:57:49  
