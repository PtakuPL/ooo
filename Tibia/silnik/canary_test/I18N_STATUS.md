...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-05-02 06:54:07

> **Aktualizacja:** 2026-05-02 06:54:07 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #19,367 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-05-02T06:51:39Z
...
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-05-02 06:54:07 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-05-02T06:51:39Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 21h temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-05-02 06:54:07 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-05-02T06:51:20.975080Z |
| QUALITY | 🔒 NIEAKTYWNY | 4min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-05-02T06:49:33.354244Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-05-02 06:54:07 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-05-02T06:54:15.064481Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-05-02T06:51:39Z
...
| ⏳ Oldest pending (visible tail) | 18621 s |
| 🌍 Top języki | RU(400) |
...
| 🧮 OpenAI budget | `109/250 (43.6%); policy=telemetry_only` |
| ♻️ Provider debt | `767` |
| 🌍 Recent provider mix | tm_dedup_file(100), OpenAI model pool(88), canonical_name_semantic_autofix(20), term_consistency_autofix(1) |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 18621}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 21h temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-05-02 06:54:07
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-05-02T06:51:20.975080Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-05-02T06:49:52.139349Z |
...
| 🕒 Evidence window | 24h (span=34.34h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=34.34h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=+0.00pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-05-02T05:54:08.108062Z → 2026-05-02T06:54:08.108062Z) |
...
> Świeżość: 4min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-05-02T06:49:33.354244Z

- **Ostatni audyt:** OK | 1 issue(s) / 100 entries | 2026-05-02T06:49:33.354244Z
- **Top 5 typów problemów:** suspicious_rejected_critical=130, suspicious_log_high=119, suspicious_log_low=78, suspicious_rejected_high=70, suspicious_log_medium=2
- **Języki o najsłabszej jakości:** es(60.1, issues=763443), ro(60.1, issues=459524), ru(60.1, issues=389187), cs(60.1, issues=141581), de(60.1, issues=140817)
...
⚠️ **TR**: jakość 60%, 63967 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 763443 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 84%, 182459 problemów
⚠️ **RU**: jakość 60%, 389187 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #19,367 |
| Heartbeat | 156s temu | 2026-05-02T06:51:39Z |
...
- 2026-05-02 06:49:53 | AUTO_TRANSLATE:heartbeat_tick | tr | ok | items.json
- 2026-05-02 06:49:52 | AUTO_TRANSLATE:auto_start | tr | ok | items.json
- 2026-05-02 06:49:32 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-05-02 06:54:07

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [tr] → warn (files+1, translated+62, skipped+0) — lang=tr file=items.json strict_skipped_done=5380
...
| 🔄 Cykli wykonanych | **#19,367** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #19,367 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-05-02 06:54:07  
