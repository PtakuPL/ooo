...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.92% / real 10.84%**. Tempo: **850.0 kluczy/h**. Tłumaczeń netto: **139,456**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 01:36:31

> **Aktualizacja:** 2026-04-29 01:36:31 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,476 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: server.json | Heartbeat: 2026-04-29T01:34:08Z
> **Okno godzinowe:** okno=1.0h | cykli=72 | pominięte=0.0% | odrzucone=3.1% | przepustowość=850.0/h  
> **Tłumaczeń netto:** 139,456

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 01:36:31 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T01:34:08Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 58s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 01:36:31 |
| TRANSLATION | 🟢 AKTYWNY | 53s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T01:35:46.235408Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T01:34:08.388585Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 01:36:31 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T01:36:39.288453Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T01:34:08Z
...
| 🔄 **Ostatni cykl** | 36 kluczy, 1 odrzuconych, 80.0s, tryb: AUTO_TRANSLATE, cel: ru/items.json |
| ❤️ **Heartbeat** | 2026-04-29T01:34:08Z |
...
| ⏳ Oldest pending (visible tail) | 16822 s |
| 🌍 Top języki | RU(398) |
...
| 🌍 Recent provider mix | TM/simple(287), Free Google Translate(208), canonical_name_semantic_autofix(16), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=514, fallbacks=9) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=510/510 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 16822}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~146 dni (2,987,460 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~850 kluczy/h.
...
> Świeżość: 58s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 01:36:31
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 53s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T01:35:46.235408Z
...
- stone → каменный (item.12297.name)
- stone → каменный (item.12298.name)
- stone → каменный (item.12299.name)
- mill board → мельница доска (item.1230.name)
- stone → каменный (item.12300.name)
- mill board → мельница доска (item.1231.name)
- mill board → мельница доска (item.1232.name)
- mill board → мельница доска (item.1233.name)
- mill board → мельница доска (item.1234.name)
- slime fungus → слизевый гриб (item.12345.name)
- slime fungus → слизевый гриб (item.12346.name)
- slime fungus → слизевый гриб (item.12347.name)
- slime fungus → слизевый гриб (item.12348.name)
- slime fungus → слизевый гриб (item.12349.name)
- pressed winterberries → прессованная зимняя ягода (item.12253.name)
- pressed winterberries → прессованная зимняя ягода (item.12254.name)
- pressed winterberries → прессованная зимняя ягода (item.12255.name)
- pressed winterberries → прессованная зимняя ягода (item.12256.name)
- pressed winterberries → прессованная зимняя ягода (item.12257.name)
- pressed winterberries → прессованная зимняя ягода (item.12258.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4716**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4569**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T01:34:26.117285Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.92%** (694,608/3,875,872)
- **Pokrycie globalne (real):** **10.84%** (420,085/3,875,872)
- **Kopie EN (łącznie):** **410,610**
- **Placeholdery [EN]/puste (łącznie):** **2,191,055**
...
| 🕒 Evidence window | 24h (span=30.74h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=30.74h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T00:36:32.274692Z → 2026-04-29T01:36:32.274692Z) |
...
| Przepustowość (kluczy/h) | **850.0 kluczy/h** |
| Podejrzane tłumaczenia | **962** |
| Najgorsze cele (strażnik) | cs/items.json (gf=10), ro/items.json (gf=8), ru/items.json (gf=3), it/items.json (gf=2), de/otclient_modules.json (gf=2) |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 85 | 88.5% | ru/items.json (85) |
| `existing_canonical_name_quality_mixed_scripts` | 11 | 11.5% | ru/items.json (11) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T01:34:08.388585Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T01:34:08.388585Z
- **Top 5 typów problemów:** suspicious_rejected_critical=190, suspicious_log_medium=91, suspicious_log_low=57, suspicious_log_high=51, suspicious_rejected_high=10
- **Języki o najsłabszej jakości:** es(60.1, issues=728506), ro(60.1, issues=427778), de(60.1, issues=111028), cs(60.1, issues=86734), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 60%, 53599 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 728506 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 65%, 169915 problemów
⚠️ **RU**: jakość 78%, 359746 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,476 |
| Heartbeat | 151s temu | 2026-04-29T01:34:08Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T01:36:02.762623Z
...
- 2026-04-29 01:36:03 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-29 01:35:46 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
- 2026-04-29 01:34:27 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-04-29 01:34:26 | AUTO_TRANSLATE:auto_start | ru | ok | items.json
- 2026-04-29 01:34:06 | AUTO_TRANSLATE:auto_done | tr | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **139,456** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=3.88%, reason=increase_low_fail_rate=3.9%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 01:36:31
...
| ❌ Błędów | 54 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (356), **RU** (194), **DE** (180), **IT** (173), **TR** (170) |
| 📊 Porównanie | ↓ 83.4% vs wczoraj (8,228) |
...
| 🔄 Cykli wykonanych | **#17,476** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,476 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 01:36:31  
