...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.89%**. Tempo: **1523.0 kluczy/h**. Tłumaczeń netto: **124,982**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 21:58:58

> **Aktualizacja:** 2026-02-20 21:58:58 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #4 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: es | Plik: - | Heartbeat: 2026-02-20T21:58:55Z  
> **Okno godzinowe:** okno=1.0h | cykli=189 | pominięte=0.0% | odrzucone=72.3% | przepustowość=1523.0/h  
> **Tłumaczeń netto:** 124,982

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 21:58:58 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T21:58:55Z |
| MIGRATION | 🔒 NIEAKTYWNY | 53s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 21:58:58 |
| TRANSLATION | 🟢 AKTYWNY | 7s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T21:58:52.832014Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T21:59:00.054884Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 21:58:58 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T21:58:55Z
...
| ❤️ **Heartbeat** | 2026-02-20T21:58:55Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **2,697** kluczy |
| ❌ Odrzucone (guard) | 7047 |
| 🔁 Cykli | 189 |
| 🌍 Języków | 7 |
...
| 📌 Hotspoty GF (dispatch) | pl:items.json [S] gf=4080, 99.8%, +26c | pl:spells.json [S] gf=145, 96.7%, +10c | es:spells.json [S] gf=140, 93.3%, +10c | ro:monsters.json [S] gf=130, 86.7%, +10c |
...
> **ETA globalne:** ~62 dni (2,259,958 kluczy do celu 95%)
...
> Świeżość: 53s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 21:58:58
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 7s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T21:58:52.832014Z
...
- Raporty strażnika jakości: **7209**  
- Raporty blokad: **0**  
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T20:58:59.315648Z → 2026-02-20T21:58:59.315648Z) |
...
| Najgorsze cele (strażnik) | pl/items.json (gf=3264), es/items.json (gf=1569), pl/npc.json (gf=1452), it/npc.json (gf=114), es/server.json (gf=82) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T21:59:00.054884Z
...
| Heartbeat | 5s temu | 2026-02-20T21:58:55Z |
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,830 | 613 | 6324 (91.2%) | 36 |
...
| Przepustowość (okno) | 1,192 kluczy / 73 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 21:58:58
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **18,427** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 224 |
| ❌ Błędów | 446 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (5,423), **RU** (3,609), **IT** (2,946), **PL** (2,192), **RO** (2,177) |
| 📊 Porównanie | ↑ 406.1% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **116,012** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 21:58:58  
