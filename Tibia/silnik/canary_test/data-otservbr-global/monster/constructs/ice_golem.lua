...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "Chrrr.", yell = false , i18nKey = "monster.ice_golem.voice_1"},
	{ text = "Crrrrk.", yell = false , i18nKey = "monster.ice_golem.voice_2"},
	{ text = "Gnarr.", yell = false , i18nKey = "monster.ice_golem.voice_3"},
}
