...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.85%**. Tempo: **1490.4 kluczy/h**. Tłumaczeń netto: **116,808**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 18:13:46

> **Aktualizacja:** 2026-02-20 18:13:46 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #42 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ru | Plik: - | Heartbeat: 2026-02-20T18:13:42Z  
> **Okno godzinowe:** okno=1.0h | cykli=181 | pominięte=0.0% | odrzucone=64.3% | przepustowość=1490.4/h  
> **Tłumaczeń netto:** 116,808

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 18:13:46 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T18:13:42Z |
| MIGRATION | 🔒 NIEAKTYWNY | 34s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 18:13:46 |
| TRANSLATION | 🟢 AKTYWNY | 38s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T18:13:08.487650Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T18:13:47.198528Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 18:13:46 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T18:13:42Z
...
| ❤️ **Heartbeat** | 2026-02-20T18:13:42Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **2,576** kluczy |
| ❌ Odrzucone (guard) | 4633 |
| 🔁 Cykli | 181 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (616 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~1490 kluczy/h |
| 🛡️ Guard fail rate | 64.3% |
| ⚠️ Podejrzane | 24233 |
| 🌐 GT aktywny (1h) | ✅ TAK |
| 🔤 GT tłumaczeń (1h) | 121 |
...
> Tempo obliczone na bazie ostatniej godziny: ~1490 kluczy/h.
...
> Świeżość: 34s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 18:13:46
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 38s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T18:13:08.487650Z
...
| RO (Rumuński) | 22,842/53,586 | 42.63% | 2,355 | 0 |
...
- Raporty strażnika jakości: **6737**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3845**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **13.85%** (385,949/2,786,472)
...
| RO | 21,576/49,731 | 43.4% | 1,266/3,855 | 32.8% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T17:13:46.508084Z → 2026-02-20T18:13:46.508084Z) |
| Cykle | **181** (TŁUMACZENIE=181, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **64.3%** |
| Cykle bez postępu % | **9.2%** |
| Przepustowość (kluczy/h) | **1490.4 kluczy/h** |
| Podejrzane tłumaczenia | **4089** |
| Najgorsze cele (strażnik) | pl/items.json (gf=1632), es/items.json (gf=1034), pl/npc.json (gf=968), es/spells.json (gf=73), it/spells.json (gf=60) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T18:13:47.198528Z

- **Ostatni audyt:** SLOW_MODE | 29 issue(s) / 100 entries | 2026-02-20T18:13:42.381861Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=111, suspicious_log_high=52, suspicious_log_critical=48, suspicious_rejected_high=26, suspicious_log_low=19
- **Języki o najsłabszej jakości:** es(60.1, issues=325843), pl(60.1, issues=182452), ro(60.1, issues=178138), it(60.1, issues=72375), sr(62.1, issues=86199)
...
⚠️ **PL**: jakość 60%, 182452 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 325843 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 72375 problemów
⚠️ **RU**: jakość 76%, 210855 problemów
...
| Heartbeat | 5s temu | 2026-02-20T18:13:42Z |
...
- 2026-02-20 18:13:15 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 18:13:04 | AUTO_TRANSLATE:heartbeat_tick | it | ok | monsters.json
- 2026-02-20 18:13:04 | AUTO_TRANSLATE:parallel_start | it | ok | monsters.json
- 2026-02-20 18:12:53 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-02-20 18:12:52 | AUTO_TRANSLATE:parallel_start | ro | ok | items.json
- 2026-02-20 18:12:51 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 18:13:46
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+41, skipped+0) — lang=es file=npc.json strict_skipped_done=10127 guard_fail=9 placeholder=0 command=0 pipe=0
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+50, skipped+0) — lang=ro file=server.json strict_skipped_done=166
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **6,183** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 42 |
| ❌ Błędów | 143 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (1,718), **RU** (1,157), **IT** (1,053), **RO** (735), **PL** (693) |
| 📊 Porównanie | ↑ 69.8% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **103,768** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 18:13:46  
