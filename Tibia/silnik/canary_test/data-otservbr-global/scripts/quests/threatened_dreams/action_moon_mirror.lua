...
local config = {
	[25729] = {
		...
		usablePeriod = "night",
		failMessageKey = "scripts.threatened_dreams.moon_mirror_wait_night",
		successMessageKey = "scripts.threatened_dreams.moon_mirror_charged",
	},
	[25730] = {
		targetPos = {
		...
		usablePeriod = "night",
		failMessageKey = "scripts.threatened_dreams.moon_mirror_wait_night_2",
		successMessageKey = {
			"scripts.threatened_dreams.moon_mirror_barrier_strengthens",
			"scripts.threatened_dreams.moon_mirror_last_sculpture",
		},
