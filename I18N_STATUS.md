...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.87%**. Tempo: **1498.7 kluczy/h**. Tłumaczeń netto: **120,661**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 19:54:05

> **Aktualizacja:** 2026-02-20 19:54:05 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #126 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ro | Plik: - | Heartbeat: 2026-02-20T19:54:01Z  
> **Okno godzinowe:** okno=1.0h | cykli=201 | pominięte=0.0% | odrzucone=60.1% | przepustowość=1498.7/h  
> **Tłumaczeń netto:** 120,661

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 19:54:05 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T19:54:01Z |
| MIGRATION | 🔒 NIEAKTYWNY | 40s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 19:54:05 |
| TRANSLATION | 🟢 AKTYWNY | 38s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T19:53:28.062472Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T19:54:06.147719Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 19:54:05 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T19:54:01Z
...
| ❤️ **Heartbeat** | 2026-02-20T19:54:01Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **2,661** kluczy |
| ❌ Odrzucone (guard) | 4015 |
| 🔁 Cykli | 201 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (656 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~1499 kluczy/h |
| 🛡️ Guard fail rate | 60.1% |
| ⚠️ Podejrzane | 25806 |
| 🌐 GT aktywny (1h) | ✅ TAK |
| 🔤 GT tłumaczeń (1h) | 115 |
...
> **ETA globalne:** ~63 dni (2,260,542 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~1499 kluczy/h.
...
> Świeżość: 40s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 19:54:05
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 38s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T19:53:28.062472Z
...
| RO (Rumuński) | 23,128/53,586 | 43.16% | 2,348 | 0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T18:54:05.467026Z → 2026-02-20T19:54:05.467026Z) |
...
| Przepustowość (kluczy/h) | **1498.7 kluczy/h** |
| Podejrzane tłumaczenia | **3685** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T19:54:06.147719Z

- **Ostatni audyt:** SLOW_MODE | 16 issue(s) / 100 entries | 2026-02-20T19:54:01.124249Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=123, suspicious_log_high=64, suspicious_log_critical=41, suspicious_rejected_high=34, artifact_token=16
- **Języki o najsłabszej jakości:** es(60.1, issues=335742), ru(60.1, issues=212618), ro(60.1, issues=182843), it(60.1, issues=74794), pl(60.2, issues=187322)
...
⚠️ **PL**: jakość 60%, 187322 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 335742 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 74794 problemów
⚠️ **RU**: jakość 60%, 212618 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 77%, 30831 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #126 |
| Heartbeat | 5s temu | 2026-02-20T19:54:01Z |
...
- 2026-02-20 19:53:34 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 19:53:24 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-02-20 19:53:24 | AUTO_TRANSLATE:parallel_start | ru | ok | items.json
- 2026-02-20 19:53:17 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-02-20 19:53:17 | AUTO_TRANSLATE:parallel_start | it | ok | items.json
- 2026-02-20 19:53:15 | AUTO_TRANSLATE:auto_done | ro | ok | npc.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **120,661** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=90.39%, reason=decrease_high_fail_rate=90.4% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 19:54:05
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+30, skipped+0) — lang=ro file=npc.json strict_skipped_done=5800
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+50, skipped+0) — lang=it file=items.json strict_skipped_done=765
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+1, skipped+0) — parallel lang=es file=items.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+41, skipped+0) — lang=pl file=items.json strict_skipped_done=686
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **11,800** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 126 |
| ❌ Błędów | 277 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (3,465), **RU** (2,323), **IT** (1,936), **RO** (1,446), **PL** (1,295) |
| 📊 Porównanie | ↑ 224.1% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **109,385** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 19:54:05  
