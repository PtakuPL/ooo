...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.02% / real 10.95%**. Tempo: **624.0 kluczy/h**. Tłumaczeń netto: **146,575**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 10:53:17

> **Aktualizacja:** 2026-04-29 10:53:17 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,255 | Status: ✅ BEZCZYNNY | Faza: IDLE | Etap: cycle_start | Kategoria: de | Plik: otclient_modules.json | Heartbeat: 2026-04-29T10:52:49Z
> **Okno godzinowe:** okno=1.0h | cykli=83 | pominięte=0.0% | odrzucone=5.7% | przepustowość=624.0/h  
> **Tłumaczeń netto:** 146,575

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 10:53:17 |
| LIVE | 🟢 AKTYWNY | 34s temu | - | `activity.json / worker_state.json` | 2026-04-29T10:52:49Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 21s temu | worker w trybie IDLE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 10:53:17 |
| TRANSLATION | 🔒 NIEAKTYWNY | 3min temu | worker w trybie IDLE | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T10:49:26.835338Z |
| QUALITY | 🔒 NIEAKTYWNY | 48s temu | worker w trybie IDLE | `quality_audit_latest.json` | 2026-04-29T10:52:35.820427Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 10:53:17 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T10:53:23.922732Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 34s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T10:52:49Z
...
| 🔄 **Ostatni cykl** | 15 kluczy, 1 odrzuconych, 239.4s, tryb: AUTO_TRANSLATE, cel: de/otclient_modules.json |
| ❤️ **Heartbeat** | 2026-04-29T10:52:49Z |
...
| 🌍 Recent provider mix | TM/simple(331), Free Google Translate(128), canonical_name_semantic_autofix(18), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=480, fallbacks=27) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=940/940 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 385, 'oldest_s': 15912}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 21s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 10:53:17
...
> Świeżość: 3min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T10:49:26.835338Z
...
- **Profiler cyklu (ostatni):** cykl #165 (AUTO_TRANSLATE): dispatch 1275ms, mode 222847ms, status 13516ms, total 239370ms
...
| 🕒 Evidence window | 24h (span=40.02h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=40.02h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T09:53:17.767924Z → 2026-04-29T10:53:17.767924Z) |
...
> Świeżość: 48s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T10:52:35.820427Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T10:52:35.820427Z
- **Top 5 typów problemów:** suspicious_rejected_critical=190, suspicious_log_high=92, suspicious_log_low=76, suspicious_log_medium=31, suspicious_rejected_high=10
- **Języki o najsłabszej jakości:** es(60.1, issues=744725), ro(60.1, issues=440360), de(60.1, issues=123057), cs(60.1, issues=109929), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 744725 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 64%, 177067 problemów
⚠️ **RU**: jakość 65%, 370568 problemów
...
|-----------|--------|-----------|
| Worker | ✅ BEZCZYNNY | Cykl #18,255 |
| Heartbeat | 34s temu | 2026-04-29T10:52:49Z |
...
- 2026-04-29 10:51:13 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 10:53:17

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [tr] → warn (files+1, translated+32, skipped+0) — lang=tr file=items.json strict_skipped_done=1595
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → warn (files+1, translated+37, skipped+0) — lang=ru file=html.json strict_skipped_done=1052 guard_fail=405 placeholder=79 command=5 pipe=0
...
| 🔄 Cykli wykonanych | **#18,255** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,255 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 10:53:17  
