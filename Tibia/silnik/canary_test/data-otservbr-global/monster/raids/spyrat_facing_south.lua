...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "Catch me if you can!!", yell = false , i18nKey = "monster.spyrat_facing_south.voice_1"},
	{ text = "Never cross the rat line!", yell = false , i18nKey = "monster.spyrat_facing_south.voice_2"},
	{ text = "Smoke on the water!", yell = false , i18nKey = "monster.spyrat_facing_south.voice_3"},
}
