...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "Ungh! Ungh!", yell = false , i18nKey = "monster.kongra.voice_1"},
	{ text = "Hugah!", yell = false , i18nKey = "monster.kongra.voice_2"},
	{ text = "Huaauaauaauaa!", yell = false , i18nKey = "monster.kongra.voice_3"},
}
