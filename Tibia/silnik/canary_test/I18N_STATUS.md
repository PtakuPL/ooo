...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.69% / real 11.67%**. Tempo: **7886.0 kluczy/h**. Tłumaczeń netto: **168,070**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-05-02 02:20:27

> **Aktualizacja:** 2026-05-02 02:20:27 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #19,091 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: it | Plik: items.json | Heartbeat: 2026-05-02T02:15:57Z
> **Okno godzinowe:** okno=1.0h | cykli=51 | pominięte=0.0% | odrzucone=0.1% | przepustowość=7886.0/h  
> **Tłumaczeń netto:** 168,070

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-05-02 02:20:27 |
| LIVE | 🟢 AKTYWNY | 4min temu | - | `activity.json / worker_state.json` | 2026-05-02T02:15:57Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 17h temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-05-02 02:20:27 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-05-02T02:18:44.314121Z |
| QUALITY | 🔒 NIEAKTYWNY | 6min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-05-02T02:13:45.669271Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-05-02 02:20:27 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-05-02T02:20:34.652074Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 4min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-05-02T02:15:57Z
...
| 🔄 **Ostatni cykl** | 4 kluczy, 0 odrzuconych, 160.0s, tryb: AUTO_TRANSLATE, cel: cs/items.json |
...
| ⏳ Oldest pending (visible tail) | 187644 s |
...
| 🧮 OpenAI budget | `48/250 (18.4%); policy=telemetry_only` |
| ♻️ Provider debt | `767` |
| 🌍 Recent provider mix | OpenAI model pool(264), tm_dedup_file(72), TM/simple(62), Free Google Translate(27), canonical_name_semanti... |
...
| ❤️ Pool health | `degraded` (writes=466, fallbacks=20) |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 391, 'oldest_s': 187644}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~16 dni (2,957,565 kluczy do celu 95%)
...
> Świeżość: 17h temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-05-02 02:20:27
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-05-02T02:18:44.314121Z
...
- Raporty strażnika jakości: **5128**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4980**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-05-02T02:19:16.054892Z |
...
| 🕒 Evidence window | 24h (span=29.78h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=29.78h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=+0.00pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-05-02T01:20:27.709720Z → 2026-05-02T02:20:27.709720Z) |
...
| Przepustowość (kluczy/h) | **7886.0 kluczy/h** |
| Podejrzane tłumaczenia | **1656** |
...
> Świeżość: 6min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-05-02T02:13:45.669271Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=758901), ro(60.1, issues=453618), ru(60.1, issues=382732), de(60.1, issues=137892), tr(60.1, issues=61022)
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #19,091 |
| Heartbeat | 277s temu | 2026-05-02T02:15:57Z |
...
- 2026-05-02 02:19:04 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-05-02 02:18:44 | AUTO_TRANSLATE:auto_done | cs | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-05-02 02:20:27
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **11,535** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 7 |
| ❌ Błędów | 22 |
| 🌍 Aktywnych języków | 6 |
| 🏆 TOP 5 | **RO** (7,155), **TR** (4,161), **ES** (91), **IT** (66), **CS** (34) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **44,515** kluczy
...
| 🔄 Cykli wykonanych | **#19,091** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #19,091 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-05-02 02:20:27  
