...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **11.11%**. Tempo: **1184.9 kluczy/h**. Tłumaczeń netto: **80,049**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-15 09:57:07

> **Aktualizacja:** 2026-02-15 09:57:07 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #7,549 | Status: 🟢 DZIAŁA | Faza: PRE_MIGRATION | Etap: cycle_start | Kategoria: pending_skip | Plik: - | Heartbeat: 2026-02-15T09:57:07Z  
> **Okno godzinowe:** okno=1.0h | cykli=285 | pominięte=0.0% | odrzucone=58.5% | przepustowość=1184.9/h  
> **Tłumaczeń netto:** 80,049

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-15 09:57:07 |
| LIVE | 🟢 AKTYWNY | 1s temu | - | `activity.json / worker_state.json` | 2026-02-15T09:57:07Z |
| MIGRATION | 🟢 AKTYWNY | 47s temu | - | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-15 09:57:07 |
| TRANSLATION | 🔒 NIEAKTYWNY | 7min temu | worker w trybie PRE_MIGRATION | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-15T09:49:55.021039Z |
| QUALITY | 🔒 NIEAKTYWNY | 7min temu | worker w trybie PRE_MIGRATION | `quality_audit_latest.json` | 2026-02-15T09:49:55.487530Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-15 09:57:07 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-15T09:57:07Z

| Metryka | Wartość |
|---------|---------|
| 🛠️ **Co robi** | Skan plików źródłowych (bez modyfikacji) → cycle_start |
...
| ❤️ **Heartbeat** | 2026-02-15T09:57:07Z |
...
> **ETA globalne:** ~82 dni (2,337,474 kluczy do celu 95%)
...
> **[MIGRATION]** 🟢 AKTYWNY  
> Świeżość: 47s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-15 09:57:07
...
> Świeżość: 7min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-15T09:49:55.021039Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-15T08:57:07.925489Z → 2026-02-15T09:57:07.925489Z) |
| Cykle | **285** (TŁUMACZENIE=116, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **58.5%** |
| Cykle bez postępu % | **2.1%** |
| Przepustowość (kluczy/h) | **1184.9 kluczy/h** |
| Podejrzane tłumaczenia | **2045** |
| Najgorsze cele (strażnik) | es/npc.json (gf=1904), pl/monsters.json (gf=331), es/monsters.json (gf=208), es/scripts.json (gf=198), pl/items.json (gf=168) |
...
> Świeżość: 7min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-15T09:49:55.487530Z
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #7,549 |
| Heartbeat | 1s temu | 2026-02-15T09:57:07Z |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-15 09:57:07

- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+23) — repair_identical lang=es file=npc.json target_identical=23 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=159.40
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [pl] → ok (translated+20, skipped+0) — parallel lang=pl file=cpp.json
...
| 🔄 Cykli wykonanych | **#7,549** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-15 09:57:07  
