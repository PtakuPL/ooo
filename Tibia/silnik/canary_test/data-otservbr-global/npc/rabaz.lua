...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "mission") then
		if player:getStorageValue(Storage.Quest.U8_6.AnInterestInBotany.Questline) < 1 then
			...
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.rabaz.multi_4")
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.rabaz.multi_5")
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.rabaz.multi_6")
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.rabaz.multi_7")
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.rabaz.multi_8")
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.rabaz.multi_9")
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.rabaz.multi_10")
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.rabaz.multi_11")
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.rabaz.multi_12")
	...
	elseif MsgContains(message, "yes") then
		...
		elseif npcHandler:getTopic(playerId) == 2 then
			if player:removeItem(11699, 1) then
				...
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.rabaz.multi_1")
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.rabaz.multi_2")
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.rabaz.multi_3")
				npcHandler:setTopic(playerId, 0)
			else
...
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_GREET, "npc.rabaz.greet_msg_1")
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_FAREWELL, "npc.rabaz.farewell_msg_1")
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_WALKAWAY, "npc.rabaz.walkaway_msg_1")
npcHandler:setLocalizedMessage(MESSAGE_SENDTRADE, "npclib.handler.sendtrade_have_a_look_with_categories", { args = function(_player) return { GetFormattedShopCategoryNames(itemsTable) } end })
