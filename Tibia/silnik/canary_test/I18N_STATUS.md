...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **9.89%**. Tempo: **2939.0 kluczy/h**. Tłumaczeń netto: **69,972**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-16 20:40:16

> **Aktualizacja:** 2026-02-16 20:40:16 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #17 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ru | Plik: - | Heartbeat: 2026-02-16T20:40:10Z  
> **Okno godzinowe:** okno=1.0h | cykli=66 | pominięte=0.0% | odrzucone=13.2% | przepustowość=2939.0/h  
> **Tłumaczeń netto:** 69,972

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-16 20:40:16 |
| LIVE | 🟢 AKTYWNY | 7s temu | - | `activity.json / worker_state.json` | 2026-02-16T20:40:10Z |
| MIGRATION | 🔒 NIEAKTYWNY | 28min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-16 20:40:16 |
| TRANSLATION | 🟢 AKTYWNY | 31s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-16T20:39:45.315012Z |
| QUALITY | 🔒 NIEAKTYWNY | 6s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-16T20:40:10.606275Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-16 20:40:16 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 7s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-16T20:40:10Z
...
| ❤️ **Heartbeat** | 2026-02-16T20:40:10Z |
...
| RU | ██████░░░░░░░░░░░░░░ | 33.2% | 17,808/53,586 | ~11h |
| FR | ██████░░░░░░░░░░░░░░ | 33.0% | 17,709/53,586 | ~11h |
| RO | ███░░░░░░░░░░░░░░░░░ | 16.7% | 8,963/53,586 | ~14h |
...
> Tempo obliczone na bazie ostatniej godziny: ~2939 kluczy/h.
...
> Świeżość: 28min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-16 20:40:16
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 31s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-16T20:39:45.315012Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-16T19:40:16.815345Z → 2026-02-16T20:40:16.815345Z) |
...
| Przepustowość (kluczy/h) | **2939.0 kluczy/h** |
...
> Świeżość: 6s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-16T20:40:10.606275Z
...
| Heartbeat | 7s temu | 2026-02-16T20:40:10Z |
...
- 2026-02-16 20:39:32 | AUTO_TRANSLATE:parallel_start | ro | ok | items.json
- 2026-02-16 20:39:29 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **69,972** | — | 📊 |
| Adaptacyjna paczka | batch=16, gf_rate=16.7%, reason=stable_fail_rate=16.7% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-16 20:40:16
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → warn (files+1, translated+50, skipped+0) — lang=ru file=items.json strict_skipped_done=494 guard_fail=3 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [az] → ok (translated+80, skipped+0) — parallel lang=az file=items.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ar] → warn (files+1, translated+80, skipped+0) — lang=ar file=items.json strict_skip missing_file=0 missing_key=163 skipped_done=3305 strict_skipped_done=3305
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+15, skipped+0) — parallel lang=es file=monsters.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+76, skipped+0) — lang=pl file=monsters.json strict_skipped_done=4515 guard_fail=4 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [da] → ok (translated+80, skipped+0) — parallel lang=da file=items.json
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-16 20:40:16  
