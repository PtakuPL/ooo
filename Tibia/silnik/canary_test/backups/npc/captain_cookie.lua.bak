...
-- Travel
local travelKeyword = keywordHandler:addKeyword({ "liberty bay" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.captain_cookie.stdmod_1", cost = 400, discount = "postman" })
...
travelKeyword:addChildKeyword({ "no" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.captain_cookie.stdmod_2", reset = true })
keywordHandler:addAliasKeyword({ "passage" })

keywordHandler:addKeyword({ "sail" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.captain_cookie.stdmod_3" })
keywordHandler:addKeyword({ "job" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.captain_cookie.stdmod_4" })
