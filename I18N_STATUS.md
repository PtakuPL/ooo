...
> Worker tłumaczy **53** języków. Klucze EN: **4,466**. Pokrycie globalne: **nominal 4.83% / real 4.77%**. Tempo: **279.4 kluczy/h**. Tłumaczeń netto: **172,854**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-06-07 19:13:28

> **Aktualizacja:** 2026-06-07 19:13:28 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 4466
> **Publikacja:** git-enabled
> **LIVE:** Cykl #21,231 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: it | Plik: website_i18n.json | Heartbeat: 2026-06-07T19:08:18Z
> **Okno godzinowe:** okno=1.0h | cykli=349 | pominięte=0.0% | odrzucone=2.9% | przepustowość=279.4/h  
> **Tłumaczeń netto:** 172,854

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-06-07 19:13:28 |
| LIVE | 🟢 AKTYWNY | 5min temu | - | `activity.json / worker_state.json` | 2026-06-07T19:08:18Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-06-07 19:13:28 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-06-07T19:12:28.243590Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-06-07T19:12:29.663787Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-06-07 19:13:28 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-06-07T19:13:46.197719Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-06-07T19:08:18Z

| Metryka | Wartość |
|---------|---------|
| 🛠️ **Co robi** | Tłumaczenie automatyczne (Google Translate + TM) |
| 🌍 **Aktywne języki (10 min)** | CS, DE, IT, TR |
| 📝 **Faza** | AUTO_TRANSLATE |
| 📋 **Etap** | sygnał życia |
| 📂 **Kategoria / Język** | it |
...
| 🔄 **Ostatni cykl** | 0 kluczy, 0 odrzuconych, 25.0s, tryb: AUTO_TRANSLATE, cel: de/php.json |
...
| ⏳ Oldest pending (visible tail) | 3153788 s |
...
| ♻️ Deferred stats | enqueued=0, cooldown=1, deduped=1, manual_review=0, partial_staged=1, partial_completed=0 |
...
| ❓ OpenAI/GPT teraz | pool_reason=all_models_blocked; models_blocked=3 (next_unblock~38 min); tm_or_free_gt_currently_serving |
| 🧮 OpenAI budget | `15/250 (6.0%); policy=telemetry_only` |
| ♻️ Provider debt | `711` |
| 🌍 Recent provider mix | TM/simple(121), tm_dedup_file(84), Free Google Translate(74), tm_dedup_propagate(1) |
...
| ⛔ OpenAI blocked models | `3` (next unblock: `38 min`) |
| 🩺 Health signals | recent_fallback, provider_consistency_debt:711 |
| ❤️ Pool health | `degraded` (writes=280, fallbacks=90) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=19/441 (4.31%), fail=422, Δchecks=-102, dir=improving |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 350, 'oldest_s': 3153788}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-06-07 19:13:28
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-06-07T19:12:28.243590Z
...
| OpenAI/GPT pool teraz | `degraded` (pool_reason=all_models_blocked; models_blocked=3 (next_unblock~38 min); tm_or_free_gt_current...) |
...
| 🕒 Evidence window | 24h (span=337.68h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=337.68h; client.json: id=-31.40pp, ws=+0, otclient_modules.json: id=-29.79pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-06-07T18:13:30.300016Z → 2026-06-07T19:13:30.300016Z) |
| Cykle | **349** (TŁUMACZENIE=241, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **2.9%** |
| Cykle bez postępu % | **20.0%** |
| Przepustowość (kluczy/h) | **279.4 kluczy/h** |
| Podejrzane tłumaczenia | **451** |
| Najgorsze cele (strażnik) | ru/html.json (gf=8), ro/html.json (gf=4), fr/website_i18n.json (gf=0), pt/website_i18n.json (gf=0), nl/website_i18n.json (gf=0) |
...
|--------|-----------|--------|----------------|
| `retry_loop_cooldown_default` | 24 | 63.2% | it/website_i18n.json (7) |
| `gt_identity_retry_identical_to_en` | 12 | 31.6% | cs/website_i18n.json (4) |
| `gt_structure_retry_placeholder` | 2 | 5.3% | ro/html.json (2) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-06-07T19:12:29.663787Z

- **Ostatni audyt:** OK | 3 issue(s) / 100 entries | 2026-06-07T19:12:29.663787Z
- **Top 5 typów problemów:** suspicious_rejected_high=104, suspicious_log_critical=97, suspicious_rejected_critical=96, suspicious_log_warning=81, identical_to_en_exempt=40
- **Języki o najsłabszej jakości:** ru(60.1, issues=431516), it(60.1, issues=191560), de(60.1, issues=164709), cs(60.1, issues=163401), nl(60.1, issues=80110)
...
⚠️ **TR**: jakość 66%, 68956 problemów
⚠️ **PL**: jakość 76%, 397918 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 82%, 782910 problemów
⚠️ **PT**: jakość 60%, 64213 problemów
⚠️ **FR**: jakość 62%, 69608 problemów
⚠️ **IT**: jakość 60%, 191560 problemów
⚠️ **RU**: jakość 60%, 431516 problemów
⚠️ **NL**: jakość 60%, 80110 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #21,231 |
| Heartbeat | 328s temu | 2026-06-07T19:08:18Z |
...
- 2026-06-07 19:12:55 | AUTO_TRANSLATE:auto_start | it | ok | website_i18n.json
- 2026-06-07 19:12:28 | AUTO_TRANSLATE:auto_done | de | ok | php.json
- 2026-06-07 19:12:03 | AUTO_TRANSLATE:heartbeat_tick | de | ok | php.json
- 2026-06-07 19:12:03 | AUTO_TRANSLATE:auto_start | de | ok | php.json
- 2026-06-07 19:11:43 | AUTO_TRANSLATE:auto_done | tr | ok | html.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-06-07 19:13:28
...
- 🤖 AUTO_TRANSLATE: WEBSITE_I18N_APPLY [pt] → ok — keys_updated=160 files_changed=1
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pt] → warn (files+1, translated+5, skipped+0) — lang=pt file=website_i18n.json strict_skipped_done=4
- 🤖 AUTO_TRANSLATE: WWW_KEY_DISCOVERY [en] → ok — php=0 html=1 batch=3
- 🤖 AUTO_TRANSLATE: TIER_QUALITY_GATE [-] → ok — __TIER_GATE__ tier1_avg=74.5% pass=False tier2_avg=35.7% pass=False rec=TIER1_INCOMPLETE: priorytet na PL/ES
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+0) — repair_identical lang=es file=npc.json target_identical=2 limit=180 tier=low_backlog domain_cap=260 gt=true suspicious_pct=73.08
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **1,942** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 97 |
| ❌ Błędów | 515 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **TR** (258), **FR** (220), **IT** (216), **ES** (209), **PT** (196) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **1,942** kluczy
...
| 🔄 Cykli wykonanych | **#21,231** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #21,231 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-06-07 19:13:28  
