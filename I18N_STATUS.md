...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.89%**. Tempo: **1539.8 kluczy/h**. Tłumaczeń netto: **123,403**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 21:11:03

> **Aktualizacja:** 2026-02-20 21:11:03 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #191 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ro | Plik: - | Heartbeat: 2026-02-20T21:10:59Z  
> **Okno godzinowe:** okno=1.0h | cykli=201 | pominięte=0.0% | odrzucone=65.6% | przepustowość=1539.8/h  
> **Tłumaczeń netto:** 123,403

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 21:11:03 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T21:10:59Z |
| MIGRATION | 🔒 NIEAKTYWNY | 33s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 21:11:03 |
| TRANSLATION | 🟢 AKTYWNY | 6s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T21:10:58.486635Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T21:11:04.537813Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 21:11:03 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T21:10:59Z
...
| ❤️ **Heartbeat** | 2026-02-20T21:10:59Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **2,738** kluczy |
| ❌ Odrzucone (guard) | 5221 |
| 🔁 Cykli | 201 |
| 🌍 Języków | 7 |
...
> **ETA globalne:** ~61 dni (2,260,201 kluczy do celu 95%)
...
> Świeżość: 33s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 21:11:03
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T21:10:58.486635Z
...
- Raporty strażnika jakości: **7116**  
- Raporty blokad: **0**  
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T20:11:03.811140Z → 2026-02-20T21:11:03.811140Z) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T21:11:04.537813Z

- **Ostatni audyt:** SLOW_MODE | 29 issue(s) / 100 entries | 2026-02-20T21:10:59.636558Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_log_high=91, suspicious_rejected_critical=64, suspicious_log_low=17, artifact_token=16, identical_to_en=13
- **Języki o najsłabszej jakości:** es(60.1, issues=344463), ro(60.1, issues=187004), ru(60.2, issues=214229), sr(61.1, issues=87022), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 73%, 191727 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 344463 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 67%, 76303 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #191 |
| Heartbeat | 5s temu | 2026-02-20T21:10:59Z |
...
- 2026-02-20 21:10:55 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | monsters.json
- 2026-02-20 21:10:54 | AUTO_TRANSLATE:parallel_start | ru | ok | monsters.json
- 2026-02-20 21:10:49 | AUTO_TRANSLATE:heartbeat_tick | it | ok | monsters.json
- 2026-02-20 21:10:48 | AUTO_TRANSLATE:parallel_start | it | ok | monsters.json
- 2026-02-20 21:10:47 | AUTO_TRANSLATE:auto_done | ro | ok | items.json
- 2026-02-20 21:10:37 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,830 | 642 | 6794 (91.4%) | 37 |
| 🟡 ES | 84.8% | 0 | 2,160 | 642 | 3159 (83.1%) | 41 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **123,403** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=18.33%, reason=stable_fail_rate=18.3% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,284 kluczy / 78 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 21:11:03
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+36, skipped+0) — parallel lang=es file=spells.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+36, skipped+0) — lang=pl file=spells.json strict_skipped_done=1208 guard_fail=14 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+1, skipped+0) — parallel lang=es file=items.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+50, skipped+0) — lang=pl file=items.json strict_skipped_done=1444
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **15,981** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 191 |
| ❌ Błędów | 386 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (4,698), **RU** (3,152), **IT** (2,586), **RO** (1,925), **PL** (1,866) |
| 📊 Porównanie | ↑ 338.9% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **113,566** kluczy
...
| 🔄 Cykli wykonanych | **#191** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 21:11:03  
