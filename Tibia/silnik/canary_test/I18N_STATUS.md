...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.07% / real 11.0%**. Tempo: **769.6 kluczy/h**. Tłumaczeń netto: **150,476**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 16:53:07

> **Aktualizacja:** 2026-04-29 16:53:07 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,679 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: de | Plik: otclient_modules.json | Heartbeat: 2026-04-29T16:50:53Z
> **Okno godzinowe:** okno=1.0h | cykli=46 | pominięte=0.0% | odrzucone=0.6% | przepustowość=769.6/h  
> **Tłumaczeń netto:** 150,476

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 16:53:07 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T16:50:53Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 25s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 16:53:07 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T16:51:34.004623Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T16:50:28.489437Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 16:53:07 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T16:53:13.780835Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T16:50:53Z
...
| 🔄 **Ostatni cykl** | 15 kluczy, 0 odrzuconych, 22.0s, tryb: AUTO_TRANSLATE, cel: de/otclient_modules.json |
| ❤️ **Heartbeat** | 2026-04-29T16:50:53Z |
...
|----------|------|---------|------|-------|--------|------------|--------|
| 16:51:30 | DE | Klient | otclient_modules.json | 15 | `tm` | `otclient_modules.blessing.tr_11` | - Abhängig von den Regeln des fairen Kampfes verlierst du zwischendurch |
| 16:50:15 | ES | Serwer | items.json | 25 | `simple` | `item.1234.name` | tablero de molino |
| 16:42:36 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 16:38:16 | IT | Serwer | items.json | 31 | `simple` | `item.14529.name` | SPRITE RISERVATO |
| 16:34:55 | RO | Serwer | items.json | 47 | `simple` | `item.11739.name` | podea din lemn |
| 16:34:13 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 16:30:10 | CS | Serwer | items.json | 54 | `openai:openai/gpt-4.1...` | `item.11586.name` | hrnec blackjacku |
| 16:27:43 | RU | Serwer | items.json | 42 | `transliteration_cyrillic` | `item.14841.name` | РЕСЕРВЕД СПРИТЕ |
| 16:25:03 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 16:24:58 | TR | Serwer | items.json | 52 | `google_translate` | `item.1263.name` | tic-tac-toe tahtası |
...
| ⏳ Oldest pending (visible tail) | 17083 s |
| 🌍 Top języki | RU(379), CS(10), ES(8), DE(2) |
| 🧱 Top reason_bucket | quality(377), default(15), word_salad(7) |
| 🗂️ Deferred state keys | 8784 |
| 🕒 Deferred state freshness | fresh (97s) |
...
| 🧮 OpenAI budget | `36/250 (14.4%); policy=telemetry_only` |
| ♻️ Provider debt | `56` |
| 🌍 Recent provider mix | TM/simple(308), Free Google Translate(136), OpenAI model pool(69), canonical_name_semantic_autofix(18), ter... |
| 🔁 Latest fallback | TM/simple → fallback to google translate high [high_reject_types] npc.json |
| 📉 Fallback breakdown | fallback to google translate high(14) |
| ☁️ Cloud policy | `disabled` |
| 🤖 OpenAI pool | `active` |
| 🩺 Health signals | recent_fallback, provider_consistency_debt:56, provider_circuit:provider_error_threshold_critical |
| ❤️ Pool health | `critical` (writes=534, fallbacks=14) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=1094/1094 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
|-------|--------|----------|-------|-----------|--------|
| `HEARTBEAT_STALE` | OK | OK | `115` | `300` | Heartbeat świeży (115s, src=worker_runtime_heartbeat) Runtime[status=healthy, reason=heartbeat_fresh, phase... |
| `NO_WRITE` | OK | OK | `102` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 399, 'oldest_s': 17083}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| ✅ Resolved (cycle) | - |
| 📌 Active alarm codes | DEFERRED_RETRY_PIPELINE_WARNING, DISPATCH_STALE, FIXTURE_REGRESSION, GUARD_REPORT_STALE, LANG_PARITY_WARN, ... |
...
|-------|---------------|-----------|----------|----------|
| ES | 59,092 | 74,536 | 79.28% ↑+0.01% | 9,549 |
| PL | 52,911 | 74,536 | 70.99% →0% | 5,861 |
| IT | 53,379 | 74,536 | 71.62% | 10,029 |
| RO | 52,007 | 74,536 | 69.77% | 12,998 |
| RU | 34,437 | 74,536 | 46.2% →0% | 4,775 |
| FR | 42,864 | 74,536 | 57.51% →0% | 26,153 |
| CS | 38,457 | 74,536 | 51.6% | 29,753 |
| PT | 60,516 | 74,536 | 81.19% →0% | 48,839 |
| TR | 26,529 | 74,536 | 35.59% | 3,838 |
...
> **ETA globalne:** ~161 dni (2,981,585 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 79.3% | 59,092/74,536 | ~15h |
| PL | ██████████████░░░░░░ | 71.0% | 52,911/74,536 | ~23h |
| IT | ██████████████░░░░░░ | 71.6% | 53,379/74,536 | ~23h |
| RO | █████████████░░░░░░░ | 69.8% | 52,007/74,536 | ~24h |
| RU | █████████░░░░░░░░░░░ | 46.2% | 34,437/74,536 | ~47h |
| FR | ███████████░░░░░░░░░ | 57.5% | 42,864/74,536 | ~36h |
| CS | ██████████░░░░░░░░░░ | 51.6% | 38,457/74,536 | ~42h |
| PT | ████████████████░░░░ | 81.2% | 60,516/74,536 | ~13h |
| TR | ███████░░░░░░░░░░░░░ | 35.6% | 26,529/74,536 | ~2d |
...
> Świeżość: 25s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 16:53:07
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T16:51:34.004623Z
...
|-------|-----------|--------|----------|--------------|--------------|
| ES (Hiszpański) | 79.28% (59,092/74,536) | 68.33% (50,932/74,536) | 9,549 | 14,079 | 0 |
| PL (Polski) | 70.99% (52,911/74,536) | 65.08% (48,507/74,536) | 5,861 | 20,194 | 0 |
| IT (Włoski) | 71.62% (53,379/74,536) | 63.40% (47,254/74,536) | 10,029 | 17,278 | 0 |
| RO (Rumuński) | 69.77% (52,007/74,536) | 56.74% (42,295/74,536) | 12,998 | 19,268 | 0 |
| RU (Rosyjski) | 46.20% (34,437/74,536) | 44.63% (33,267/74,536) | 4,775 | 36,512 | 0 |
| FR (Francuski) | 57.51% (42,864/74,536) | 41.87% (31,206/74,536) | 26,153 | 17,199 | 0 |
| CS (Czeski) | 51.60% (38,457/74,536) | 33.96% (25,316/74,536) | 29,753 | 19,493 | 0 |
| PT (Portugalski) | 81.19% (60,516/74,536) | 32.91% (24,530/74,536) | 48,839 | 1,189 | 0 |
| TR (Turecki) | 35.59% (26,529/74,536) | 32.10% (23,926/74,536) | 3,838 | 46,786 | 0 |
...
- Raporty strażnika jakości: **5026**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4879**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T16:51:11.533641Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.07%** (700,483/3,875,872)
- **Pokrycie globalne (real):** **11.0%** (426,328/3,875,872)
- **Kopie EN (łącznie):** **410,242**
- **Placeholdery [EN]/puste (łącznie):** **2,185,180**
...
|-------|--------|--------------------------|----------|----------------------------|
| ES | 55,932/70,637 | 79.2% / 67.7% | 3,160/3,899 | 81.0% / 79.2% |
| PL | 49,763/70,637 | 70.5% / 64.3% | 3,148/3,899 | 80.7% / 78.4% |
| IT | 50,406/70,637 | 71.4% / 62.9% | 2,973/3,899 | 76.2% / 73.1% |
| RO | 49,221/70,637 | 69.7% / 56.0% | 2,786/3,899 | 71.5% / 69.6% |
| RU | 31,293/70,637 | 44.3% / 42.7% | 3,144/3,899 | 80.6% / 79.3% |
| FR | 39,937/70,637 | 56.5% / 40.1% | 2,927/3,899 | 75.1% / 73.7% |
| CS | 36,767/70,637 | 52.0% / 33.7% | 1,690/3,899 | 43.3% / 39.0% |
| PT | 58,449/70,637 | 82.8% / 32.0% | 2,067/3,899 | 53.0% / 50.0% |
| TR | 24,570/70,637 | 34.8% / 31.2% | 1,959/3,899 | 50.2% / 48.7% |
...
| #3 | 🔴 Server | 11.08% | +0.30 pp | 51 | ZH 0.2%, TL 0.8%, BS 0.9% |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=24.03h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-0.74pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T15:53:08.069903Z → 2026-04-29T16:53:08.069903Z) |
| Cykle | **46** (TŁUMACZENIE=46, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **0.6%** |
| Cykle bez postępu % | **0.0%** |
| Przepustowość (kluczy/h) | **769.6 kluczy/h** |
| Podejrzane tłumaczenia | **1007** |
| Najgorsze cele (strażnik) | ru/items.json (gf=4), de/otclient_modules.json (gf=0), de/npc.json (gf=0), tr/items.json (gf=0), cs/items.json (gf=0) |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 61 | 71.8% | ru/items.json (61) |
| `gt_identity_retry_identical_to_en` | 11 | 12.9% | cs/items.json (9) |
| `gt_partial_validate_word_salad` | 7 | 8.2% | es/server.json (5) |
| `existing_canonical_name_quality_mixed_scripts` | 3 | 3.5% | ru/items.json (3) |
| `gt_rejected_high_mixed_scripts` | 2 | 2.4% | ru/items.json (2) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T16:50:28.489437Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T16:50:28.489437Z
- **Top 5 typów problemów:** suspicious_rejected_critical=184, suspicious_log_low=108, suspicious_log_high=91, suspicious_rejected_high=16, suspicious_log_critical=1
- **Języki o najsłabszej jakości:** es(60.1, issues=752738), ro(60.1, issues=447292), cs(60.1, issues=123474), fr(60.1, issues=60621), de(60.2, issues=129045)
...
⚠️ **TR**: jakość 85%, 59360 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 752738 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 68%, 179938 problemów
⚠️ **RU**: jakość 62%, 375893 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,679 |
| Heartbeat | 140s temu | 2026-04-29T16:50:53Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T16:51:56.864417Z
...
- 2026-04-29 16:51:57 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 16:51:34 | AUTO_TRANSLATE:auto_done | de | ok | otclient_modules.json
- 2026-04-29 16:51:12 | AUTO_TRANSLATE:heartbeat_tick | de | ok | otclient_modules.json
- 2026-04-29 16:51:12 | AUTO_TRANSLATE:auto_start | de | ok | otclient_modules.json
- 2026-04-29 16:50:27 | AUTO_TRANSLATE:auto_done | es | ok | items.json
- 2026-04-29 16:50:01 | AUTO_TRANSLATE:heartbeat_tick | es | ok | items.json
...
| 🟡 ES | 79.3% | 0 | 9,549 | 536 | 0 (0.0%) | 24 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **150,476** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=0.56%, reason=increase_low_fail_rate=0.6%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 536 kluczy / 24 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 16:53:07
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+31, skipped+0) — lang=it file=items.json strict_skipped_done=4229
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [cs] → warn (files+1, translated+54, skipped+0) — lang=cs file=items.json strict_skipped_done=5012
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [tr] → warn (files+1, translated+52, skipped+0) — lang=tr file=items.json strict_skipped_done=3873
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+1) — repair_identical lang=es file=server.json target_identical=9 limit=180 tier=low_backlog domain_cap=240 gt=true suspicious_pct=1300.00
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+31, skipped+0) — lang=it file=items.json strict_skipped_done=4199
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+4) — repair_identical lang=es file=npc.json target_identical=2 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=266.13
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [cs] → warn (files+1, translated+81, skipped+0) — lang=cs file=items.json strict_skipped_done=4940
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+1) — repair_identical lang=es file=server.json target_identical=9 limit=180 tier=low_backlog domain_cap=240 gt=true suspicious_pct=1000.00
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **13,340** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 216 |
| ❌ Błędów | 587 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (2,371), **RU** (2,091), **TR** (2,075), **DE** (1,950), **IT** (1,848) |
| 📊 Porównanie | ↑ 62.1% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **32,320** kluczy
...
| 🔄 Cykli wykonanych | **#18,679** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,679 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 16:53:07  
