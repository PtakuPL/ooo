...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **18.98%**. Tempo: **3853.0 kluczy/h**. Tłumaczeń netto: **64,825**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-23 16:25:26

> **Aktualizacja:** 2026-03-23 16:25:26 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **LIVE:** Cykl #10,833 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: it | Plik: server.json | Heartbeat: 2026-03-23T16:24:22Z  
> **Okno godzinowe:** okno=1.0h | cykli=64 | pominięte=0.0% | odrzucone=8.2% | przepustowość=3853.0/h  
> **Tłumaczeń netto:** 64,825

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-23 16:25:26 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-03-23T16:24:22Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-23 16:25:26 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-23T16:23:35.331791Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-23T16:23:58.734274Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-23 16:25:26 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-23T16:24:22Z
...
| ❤️ **Heartbeat** | 2026-03-23T16:24:22Z |
...
| TR | ███░░░░░░░░░░░░░░░░░ | 16.8% | 12,539/74,536 | ~15h |
| ZH_TW | ██░░░░░░░░░░░░░░░░░░ | 10.2% | 7,565/74,536 | ~16h |
| BN | █░░░░░░░░░░░░░░░░░░░ | 6.4% | 4,787/74,536 | ~17h |
| AR | █░░░░░░░░░░░░░░░░░░░ | 6.3% | 4,723/74,536 | ~17h |
| FA | █░░░░░░░░░░░░░░░░░░░ | 6.2% | 4,661/74,536 | ~17h |
| HI | █░░░░░░░░░░░░░░░░░░░ | 5.8% | 4,325/74,536 | ~17h |
| ID | █░░░░░░░░░░░░░░░░░░░ | 5.8% | 4,287/74,536 | ~17h |
| KO | █░░░░░░░░░░░░░░░░░░░ | 5.7% | 4,220/74,536 | ~17h |
| HE | █░░░░░░░░░░░░░░░░░░░ | 5.6% | 4,200/74,536 | ~17h |

> Tempo obliczone na bazie ostatniej godziny: ~3853 kluczy/h.
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-23 16:25:26
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-23T16:23:35.331791Z
...
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2941**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **18.98%** (735,613/3,875,872)
- **Kopie EN (łącznie):** **591,485**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-23T15:25:26.857857Z → 2026-03-23T16:25:26.857857Z) |
...
| Przepustowość (kluczy/h) | **3853.0 kluczy/h** |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-23T16:23:58.734274Z

- **Ostatni audyt:** OK | 2 issue(s) / 100 entries | 2026-03-23T16:23:58.734274Z
- **Top 5 typów problemów:** suspicious_log_high=196, suspicious_rejected_critical=187, suspicious_rejected_high=13, suspicious_log_low=3, artifact_token=2
- **Języki o najsłabszej jakości:** es(60.1, issues=630831), nl(60.1, issues=15662), cs(60.1, issues=14950), tr(60.1, issues=8152), pt(60.9, issues=23169)
...
⚠️ **TR**: jakość 60%, 8152 problemów
⚠️ **PL**: jakość 83%, 330747 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 630831 problemów
⚠️ **PT**: jakość 61%, 23169 problemów
⚠️ **FR**: jakość 65%, 20489 problemów
⚠️ **IT**: jakość 72%, 115244 problemów
⚠️ **RU**: jakość 70%, 297656 problemów
⚠️ **NL**: jakość 60%, 15662 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #10,833 |
| Heartbeat | 66s temu | 2026-03-23T16:24:22Z |
...
- 2026-03-23 16:24:22 | AUTO_TRANSLATE:heartbeat_tick | it | ok | server.json
- 2026-03-23 16:24:22 | AUTO_TRANSLATE:auto_start | it | ok | server.json
- 2026-03-23 16:23:51 | AUTO_TRANSLATE:heartbeat_tick | es | ok | quests.json
- 2026-03-23 16:23:35 | AUTO_TRANSLATE:auto_done | ro | ok | server.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **64,825** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=13.98%, reason=stable_fail_rate=14.0% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-23 16:25:26
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **41,488** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 174 |
| ❌ Błędów | 622 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **ES** (11,626), **TR** (7,538), **RO** (5,711), **PL** (3,031), **FR** (2,888) |
| 📊 Porównanie | ↑ 100.1% vs wczoraj (20,729) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **62,217** kluczy
...
| 🔄 Cykli wykonanych | **#10,833** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #10,833 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-23 16:25:26  
