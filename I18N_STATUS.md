...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.95% / real 10.87%**. Tempo: **908.0 kluczy/h**. Tłumaczeń netto: **141,478**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 04:01:36

> **Aktualizacja:** 2026-04-29 04:01:36 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,668 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: it | Plik: items.json | Heartbeat: 2026-04-29T03:59:12Z
> **Okno godzinowe:** okno=1.0h | cykli=83 | pominięte=0.0% | odrzucone=3.7% | przepustowość=908.0/h  
> **Tłumaczeń netto:** 141,478

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 04:01:36 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T03:59:12Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 18s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 04:01:36 |
| TRANSLATION | 🟢 AKTYWNY | 49s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T04:00:53.861941Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T03:59:11.620925Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 04:01:36 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T04:01:43.182123Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T03:59:12Z
...
| 🔄 **Ostatni cykl** | 37 kluczy, 1 odrzuconych, 83.0s, tryb: AUTO_TRANSLATE, cel: it/items.json |
| ❤️ **Heartbeat** | 2026-04-29T03:59:12Z |
...
| ⏳ Oldest pending (visible tail) | 17452 s |
| 🌍 Top języki | RU(399) |
...
| 🌍 Recent provider mix | TM/simple(286), Free Google Translate(214), canonical_name_semantic_autofix(16), canonical_name_case_autofi... |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=620/620 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 399, 'oldest_s': 17452}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Tempo obliczone na bazie ostatniej godziny: ~908 kluczy/h.
...
> Świeżość: 18s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 04:01:36
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 49s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T04:00:53.861941Z
...
- framework wall → muro quadro (item.1293.name)
- hive structure → struttura dell'alveare (item.12931.name)
- hive structure → struttura dell'alveare (item.12932.name)
- hive structure → struttura dell'alveare (item.12933.name)
- hive structure → struttura dell'alveare (item.12934.name)
- hive structure → struttura dell'alveare (item.12939.name)
- stone wall → muro di pietra (item.1294.name)
- hive structure → struttura dell'alveare (item.12940.name)
- hive structure → struttura dell'alveare (item.12941.name)
- hive structure → struttura dell'alveare (item.12942.name)
- hive structure → struttura dell'alveare (item.12943.name)
- hive structure → struttura dell'alveare (item.12944.name)
- hive structure → struttura dell'alveare (item.12945.name)
- hive pillar → pilastro dell'alveare (item.12926.name)
- hive pillar → pilastro dell'alveare (item.12927.name)
- hive pillar → pilastro dell'alveare (item.12928.name)
- hive pillar → pilastro dell'alveare (item.12929.name)
- hive pillar → pilastro dell'alveare (item.12930.name)
- insectoid cell → cellula insettoide (item.12937.name)
- insectoid cell → cellula insettoide (item.12938.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4765**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4618**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T03:59:31.093388Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.95%** (695,843/3,875,872)
- **Pokrycie globalne (real):** **10.87%** (421,397/3,875,872)
- **Kopie EN (łącznie):** **410,533**
- **Placeholdery [EN]/puste (łącznie):** **2,189,820**
...
| 🕒 Evidence window | 24h (span=33.16h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=33.16h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T03:01:36.732190Z → 2026-04-29T04:01:36.732190Z) |
...
| Przepustowość (kluczy/h) | **908.0 kluczy/h** |
...
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T03:59:11.620925Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T03:59:11.620925Z
- **Top 5 typów problemów:** suspicious_rejected_critical=187, suspicious_log_high=95, suspicious_log_low=68, suspicious_log_medium=37, suspicious_rejected_high=13
- **Języki o najsłabszej jakości:** es(60.1, issues=732116), ro(60.1, issues=431049), de(60.1, issues=114092), cs(60.1, issues=91805), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 60%, 54232 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 732116 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 72%, 171933 problemów
⚠️ **RU**: jakość 65%, 362479 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,668 |
| Heartbeat | 151s temu | 2026-04-29T03:59:12Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T04:01:08.917228Z
...
- 2026-04-29 04:01:09 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-29 04:00:54 | AUTO_TRANSLATE:auto_done | it | ok | items.json
- 2026-04-29 03:59:32 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-04-29 03:59:31 | AUTO_TRANSLATE:auto_start | it | ok | items.json
- 2026-04-29 03:59:10 | AUTO_TRANSLATE:auto_done | cs | ok | items.json
- 2026-04-29 03:58:06 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 04:01:36

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+37, skipped+0) — lang=it file=items.json strict_skipped_done=2690 guard_fail=1 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+2) — repair_identical lang=es file=server.json target_identical=9 limit=180 tier=low_backlog domain_cap=240 gt=true suspicious_pct=646.84
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+22, skipped+0) — lang=es file=items.json strict_skipped_done=405
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **3,541** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 76 |
| ❌ Błędów | 140 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **RU** (694), **CS** (651), **IT** (628), **DE** (450), **TR** (416) |
| 📊 Porównanie | ↓ 57.0% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **22,521** kluczy
...
| 🔄 Cykli wykonanych | **#17,668** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,668 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 04:01:36  
