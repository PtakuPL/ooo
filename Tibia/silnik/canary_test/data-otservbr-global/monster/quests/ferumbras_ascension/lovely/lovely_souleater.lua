...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "Life is such a fickle thing!", yell = false , i18nKey = "monster.lovely_souleater.voice_1"},
	{ text = "I will devour your soul.", yell = false , i18nKey = "monster.lovely_souleater.voice_2"},
	{ text = "Souuuls!", yell = false , i18nKey = "monster.lovely_souleater.voice_3"},
	{ text = "I will feed on you.", yell = false , i18nKey = "monster.lovely_souleater.voice_4"},
	{ text = "Aaaahh", yell = false , i18nKey = "monster.lovely_souleater.voice_5"},
}
