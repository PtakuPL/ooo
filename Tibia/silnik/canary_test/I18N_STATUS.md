...
> **Aktualizacja:** 2026-02-13 13:40:35 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #694 | Status: 🟢 RUNNING | Faza: MIGRATION | Etap: mini_batch | Kategoria: npclib | Plik: - | ETA: 0 | Heartbeat: 2026-02-13T13:40:34Z
...
### 🔬 Jakość tłumaczeń
- **Ostatni audyt:** SLOW_MODE | 30 issue(s) / 100 entries | 2026-02-13T13:39:09.524499Z
- **Top 5 typów problemów:** suspicious_log_medium=170, identical_to_en=30, suspicious_log_low=27, suspicious_log_high=3
- **Języki o najsłabszej jakości:** es(60.1, issues=61646), pl(60.1, issues=56087), de(71.4, issues=3460), zh_TW(82.9, issues=0), az(83.1, issues=1126)
- **Pliki:** `i18n/status/quality_audit_latest.json`, `i18n/status/quality_dashboard.json`, `i18n/status/quality_report.jsonl`

### 📈 Statystyki Pracy
| Metryka | Wartość | Info |
|---------|---------|------|
| 🔄 Cykl aktualny | **#694** | od uruchomienia |
...
│ Info: batch 1 size=5                                          │
├─────────────────────────────────────────────────────────────────┤
│ ❤️ Heartbeat: 2026-02-13T13:40:34Z           │
└─────────────────────────────────────────────────────────────────┘
```
...
| 🔄 Cykli wykonanych | **#694** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-13 13:40:35  
...
- ✅ `creature` - ukończono 2026-02-13 14:40
- ✅ `player` - ukończono 2026-02-13 14:40
- ✅ `monster` - ukończono 2026-02-13 14:40
- ✅ `party` - ukończono 2026-02-13 14:40
- ✅ `lib` - ukończono 2026-02-13 14:39
- ✅ `load` - ukończono 2026-02-13 14:39
- ✅ `storages` - ukończono 2026-02-13 14:39
- ✅ `quests` - ukończono 2026-02-13 14:39
- ✅ `lib` - ukończono 2026-02-13 14:39
- ✅ `load` - ukończono 2026-02-13 14:39
