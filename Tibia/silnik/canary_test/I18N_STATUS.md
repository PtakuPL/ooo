...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.01% / real 10.94%**. Tempo: **794.0 kluczy/h**. Tłumaczeń netto: **145,797**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 09:37:33

> **Aktualizacja:** 2026-04-29 09:37:33 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,148 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: it | Plik: items.json | Heartbeat: 2026-04-29T09:36:12Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=5.5% | przepustowość=794.0/h  
> **Tłumaczeń netto:** 145,797

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 09:37:33 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T09:36:12Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 09:37:33 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T09:36:10.969661Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T09:36:12.093178Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 09:37:33 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T09:37:39.167369Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T09:36:12Z
...
| 🔄 **Ostatni cykl** | 39 kluczy, 4 odrzuconych, 79.0s, tryb: AUTO_TRANSLATE, cel: ro/items.json |
| ❤️ **Heartbeat** | 2026-04-29T09:36:12Z |
...
| ⏳ Oldest pending (visible tail) | 15422 s |
...
| 🌍 Recent provider mix | TM/simple(275), Free Google Translate(202), canonical_name_semantic_autofix(18), term_consistency_autofix(3) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=881/881 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 386, 'oldest_s': 15422}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
|-------|---------------|-----------|----------|----------|
| ES | 58,932 | 74,536 | 79.07% →0% | 9,658 |
...
> **ETA globalne:** ~157 dni (2,983,857 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 79.1% | 58,932/74,536 | ~15h |
| PL | ██████████████░░░░░░ | 71.0% | 52,911/74,536 | ~23h |
| IT | ██████████████░░░░░░ | 70.8% | 52,734/74,536 | ~23h |
| RO | █████████████░░░░░░░ | 69.7% | 51,972/74,536 | ~24h |
| RU | █████████░░░░░░░░░░░ | 46.1% | 34,401/74,536 | ~46h |
| FR | ███████████░░░░░░░░░ | 57.5% | 42,864/74,536 | ~35h |
| CS | ██████████░░░░░░░░░░ | 50.7% | 37,814/74,536 | ~42h |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 09:37:33
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T09:36:10.969661Z
...
|-------|-----------|--------|----------|--------------|--------------|
| ES (Hiszpański) | 79.07% (58,932/74,536) | 67.97% (50,663/74,536) | 9,658 | 14,239 | 0 |
...
- This lamp is glowing very dimly. → Această lampăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă luminează foarte slab (item.13656.desc)
- This lamp is glowing very dimly. → Această lampăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă luminează foarte slab (item.13658.desc)
- This is an emblem of wisdom. It was awarded by TibiaStat.com → Aceasta este o emblemăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă a înțelepciu (item.14760.desc)
...
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4737**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T09:36:29.910048Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.01%** (698,211/3,875,872)
- **Pokrycie globalne (real):** **10.94%** (423,846/3,875,872)
- **Kopie EN (łącznie):** **410,452**
- **Placeholdery [EN]/puste (łącznie):** **2,187,452**
...
|-------|--------|--------------------------|----------|----------------------------|
| ES | 55,772/70,637 | 79.0% / 67.3% | 3,160/3,899 | 81.0% / 79.2% |
...
| 🕒 Evidence window | 24h (span=38.76h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=38.76h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T08:37:33.266509Z → 2026-04-29T09:37:33.266509Z) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T09:36:12.093178Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T09:36:12.093178Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=742488), ro(60.1, issues=438775), de(60.1, issues=121477), cs(60.1, issues=106172), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 742488 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 77%, 176137 problemów
⚠️ **RU**: jakość 63%, 369230 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,148 |
| Heartbeat | 87s temu | 2026-04-29T09:36:12Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T09:31:28.293845Z
...
- 2026-04-29 09:36:30 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-04-29 09:36:30 | AUTO_TRANSLATE:auto_start | it | ok | items.json
- 2026-04-29 09:36:11 | AUTO_TRANSLATE:auto_done | ro | ok | items.json
- 2026-04-29 09:34:53 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-04-29 09:34:52 | AUTO_TRANSLATE:auto_start | ro | ok | items.json
- 2026-04-29 09:32:59 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
| 🟡 ES | 79.1% | 0 | 9,658 | 542 | 0 (0.0%) | 25 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **145,797** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=7.57%, reason=stable_fail_rate=7.6%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 09:37:33
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **8,262** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 185 |
| ❌ Błędów | 348 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,506), **RU** (1,478), **IT** (1,226), **TR** (1,152), **DE** (1,125) |
| 📊 Porównanie | ↑ 0.4% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **27,242** kluczy
...
| 🔄 Cykli wykonanych | **#18,148** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,148 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 09:37:33  
