...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.82% / real 10.72%**. Tempo: **686.9 kluczy/h**. Tłumaczeń netto: **132,960**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-28 17:40:39

> **Aktualizacja:** 2026-04-28 17:40:39 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #16,817 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-04-28T17:37:16Z
> **Okno godzinowe:** okno=1.0h | cykli=75 | pominięte=0.0% | odrzucone=3.4% | przepustowość=686.9/h  
> **Tłumaczeń netto:** 132,960

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-28 17:40:39 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-04-28T17:37:16Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 52s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-28 17:40:39 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-28T17:38:33.659977Z |
| QUALITY | 🔒 NIEAKTYWNY | 3min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-28T17:36:56.058559Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-28 17:40:39 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-28T17:40:55.134928Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-28T17:37:16Z
...
| ❤️ **Heartbeat** | 2026-04-28T17:37:16Z |
...
| ⏳ Oldest pending (visible tail) | 9726 s |
...
| ♻️ Deferred stats | enqueued=1, cooldown=0, deduped=0, manual_review=0, partial_staged=1, partial_completed=0 |
...
| 🌍 Recent provider mix | TM/simple(176), Free Google Translate(117), OpenAI model pool(114), canonical_name_case_autofix(67), canoni... |
...
| ❤️ Pool health | `critical` (writes=510, fallbacks=13) |
...
|---------|---------|
| 📂 Surface | `items` |
| 🌍 Lang / plik | `cs` / `items.json` |
| 🗂 Registry terms | `7249` |
| 🔎 Keys with term usages | `128` / `340` scanned |
| ⚠️ Keys with conflicts | `70` |
| 🧮 Conflict rate | `54.688%` (Δ `54.688pp`) |
| 🛠 Auto-fixed EN leaks | `0` |
| 🧬 Inflection suspects | `32` |
| 🧾 Manual review | `129` |
| 🧷 Top conflicts | item.10216.desc:socha draka, item.10216.desc:socha draka, item.10216.desc:socha draka, item.10216.desc:soch... |
...
|-------|--------|----------|-------|-----------|--------|
| `HEARTBEAT_STALE` | OK | OK | `167` | `300` | Heartbeat świeży (167s, src=worker_runtime_heartbeat) Runtime[status=healthy, reason=heartbeat_fresh, phase... |
| `NO_WRITE` | OK | OK | `151` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 9726}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~181 dni (2,991,252 kluczy do celu 95%)
...
> Świeżość: 52s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-28 17:40:39
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-28T17:38:33.659977Z
...
- some twigs → nějaké větvičky (item.10481.name)
- some twigs → nějaké větvičky (item.10482.name)
- some twigs → nějaké větvičky (item.10483.name)
- some twigs → nějaké větvičky (item.10484.name)
- some twigs → nějaké větvičky (item.10485.name)
- some twigs → nějaké větvičky (item.10486.name)
- some twigs → nějaké větvičky (item.10487.name)
- some twigs → nějaké větvičky (item.10488.name)
- tainted soil → znečištěná půda (item.10495.name)
- tainted soil → znečištěná půda (item.10496.name)
- tainted soil → znečištěná půda (item.10497.name)
- tainted soil → znečištěná půda (item.10498.name)
- tainted soil → znečištěná půda (item.10499.name)
- tainted soil → znečištěná půda (item.10500.name)
- tainted soil → znečištěná půda (item.10501.name)
- tainted soil → znečištěná půda (item.10502.name)
- tainted soil → znečištěná půda (item.10503.name)
- tainted soil → znečištěná půda (item.10504.name)
- tainted soil → znečištěná půda (item.10505.name)
- tainted soil → znečištěná půda (item.10506.name)
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-28T17:37:15.422533Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.82%** (690,816/3,875,872)
- **Pokrycie globalne (real):** **10.72%** (415,637/3,875,872)
- **Kopie EN (łącznie):** **411,277**
- **Placeholdery [EN]/puste (łącznie):** **2,194,836**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-28T16:40:40.062718Z → 2026-04-28T17:40:40.062718Z) |
...
| Przepustowość (kluczy/h) | **686.9 kluczy/h** |
| Podejrzane tłumaczenia | **872** |
| Najgorsze cele (strażnik) | pt/monsters.json (gf=7), nl/monsters.json (gf=5), de/client.json (gf=4), cs/items.json (gf=4), nl/otclient_modules.json (gf=4) |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 19 | 50.0% | ru/items.json (19) |
| `existing_canonical_name_quality_mixed_scripts` | 13 | 34.2% | ru/items.json (13) |
| `gt_validate_fail_identical_to_en` | 3 | 7.9% | cs/items.json (2) |
| `gt_partial_validate_word_salad` | 2 | 5.3% | es/npc.json (2) |
| `retry_loop_cooldown_default` | 1 | 2.6% | de/monsters.json (1) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 3min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-28T17:36:56.058559Z
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #16,817 |
| Heartbeat | 219s temu | 2026-04-28T17:37:16Z |
...
- 2026-04-28 17:37:16 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | items.json
- 2026-04-28 17:37:16 | AUTO_TRANSLATE:auto_start | cs | ok | items.json
- 2026-04-28 17:36:54 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **132,960** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=1.45%, reason=increase_low_fail_rate=1.4%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-28 17:40:39

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [cs] → warn (files+1, translated+68, skipped+0) — lang=cs file=items.json strict_skipped_done=460 guard_fail=3 placeholder=0 command=0 pipe=0
- • DOCTOR_REMEDIATION: ALARM_RESOLVED [-] → ok — resolved_count=1
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [nl] → warn (files+1, translated+32, skipped+0) — lang=nl file=monsters.json strict_skipped_done=5874 guard_fail=5 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pt] → warn (files+1, translated+12, skipped+0) — lang=pt file=startup.json strict_skipped_done=11
...
| 🔄 Cykli wykonanych | **#16,817** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #16,817 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-28 17:40:39  
