...
| # | Zadanie | Opis | Status |
|---|---------|------|--------|
| B1 | **Naprawić progress 0/0** | Przekazywać prawdziwe wartości `done/total` z translate_batch do activity.json. Źródło: `translate_limit`, `translated_count`, `guard_fail_count` — te zmienne istnieją w auto_translate ale nie są zapisywane do activity progress | ✅ DONE 2026-02-17: fix w `i18n_status.py` — zachowuj prev progress gdy 0/0 |
...
| # | Zadanie | Opis | Status |
|---|---------|------|--------|
| E1 | **ETA per język** | Na podstawie obecnego tempa (kluczy/h) wyliczyć ile godzin do 95% pokrycia per język. Wyświetlić: `PL: ~120h do 95%` | ✅ DONE 2026-02-17 |
| E2 | **ETA globalne** | Ile godzin/dni do ukończenia WSZYSTKICH języków (95% coverage) | ✅ DONE 2026-02-17 |
| E3 | **Paski postępu per język (TOP 20)** | Bardziej wizualne paski ASCII: `ES ████████████████░░░░ 73%` — już istnieją w Roadmap, ale trzeba dodać do głównej tabeli języków | ✅ DONE 2026-02-17 |
| E4 | **Zmiana pokrycia (trend 24h)** | `PL: 42.02% → 42.14% (+0.12%)` per język — porównanie z 24h temu | ✅ DONE 2026-02-17: kolumna Δ dziś w tabeli ETA |
