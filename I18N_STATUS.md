...
> **Aktualizacja:** 2026-02-13 13:00:28 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #623 | Status: 🟢 RUNNING | Faza: MIGRATION | Etap: pending_skip | Kategoria: pending_skip | Plik: - | ETA: 0 | Heartbeat: 2026-02-13T13:00:20Z
...
### 🔬 Jakość tłumaczeń
- **Ostatni audyt:** SLOW_MODE | 30 issue(s) / 100 entries | 2026-02-13T12:54:05.510606Z
- **Top 5 typów problemów:** suspicious_log_medium=170, identical_to_en=30, suspicious_log_low=27, suspicious_log_high=3
- **Języki o najsłabszej jakości:** es(60.1, issues=61516), pl(60.1, issues=55987), de(71.4, issues=3460), zh_TW(82.9, issues=0), az(83.1, issues=1126)
- **Pliki:** `i18n/status/quality_audit_latest.json`, `i18n/status/quality_dashboard.json`, `i18n/status/quality_report.jsonl`

### 📈 Statystyki Pracy
| Metryka | Wartość | Info |
|---------|---------|------|
| 🔄 Cykl aktualny | **#623** | od uruchomienia |
...
├─────────────────────────────────────────────────────────────────┤
│ ❤️ Heartbeat: 2026-02-13T13:00:20Z           │
└─────────────────────────────────────────────────────────────────┘
```
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [no] → ok (files+1, translated+0, skipped+6880) — lang=no file=npc.json
...
| 🔄 Cykli wykonanych | **#623** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-13 13:00:28  
