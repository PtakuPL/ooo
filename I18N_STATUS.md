...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.89%**. Tempo: **1570.4 kluczy/h**. Tłumaczeń netto: **123,869**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 21:22:31

> **Aktualizacja:** 2026-02-20 21:22:31 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #200 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ru | Plik: - | Heartbeat: 2026-02-20T21:22:28Z  
> **Okno godzinowe:** okno=1.0h | cykli=199 | pominięte=0.0% | odrzucone=54.7% | przepustowość=1570.4/h  
> **Tłumaczeń netto:** 123,869

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 21:22:31 |
| LIVE | 🟢 AKTYWNY | 4s temu | - | `activity.json / worker_state.json` | 2026-02-20T21:22:28Z |
| MIGRATION | 🔒 NIEAKTYWNY | 40s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 21:22:31 |
| TRANSLATION | 🟢 AKTYWNY | 39s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T21:21:53.503761Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T21:22:32.640102Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 21:22:31 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 4s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T21:22:28Z
...
| ❤️ **Heartbeat** | 2026-02-20T21:22:28Z |
...
> **ETA globalne:** ~60 dni (2,260,134 kluczy do celu 95%)
...
> Świeżość: 40s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 21:22:31
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 39s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T21:21:53.503761Z
...
- Raporty strażnika jakości: **7140**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4246**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T20:22:31.940785Z → 2026-02-20T21:22:31.940785Z) |
...
| Przepustowość (kluczy/h) | **1570.4 kluczy/h** |
| Podejrzane tłumaczenia | **3096** |
| Najgorsze cele (strażnik) | es/items.json (gf=1045), pl/items.json (gf=816), pl/npc.json (gf=484), pl/spells.json (gf=116), it/npc.json (gf=114) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T21:22:32.640102Z

- **Ostatni audyt:** SLOW_MODE | 33 issue(s) / 100 entries | 2026-02-20T21:22:27.703832Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=77, suspicious_log_high=62, suspicious_log_critical=44, artifact_token=32, identical_to_en_exempt=12
- **Języki o najsłabszej jakości:** es(60.1, issues=345449), ro(60.1, issues=187458), sr(60.6, issues=87082), tl(64.2, issues=466), pl(64.8, issues=192147)
...
| Metryka | Wartość | Info |
|---------|---------|------|
| 🔄 Cykl aktualny | **#200** | od uruchomienia |
...
⚠️ **PL**: jakość 65%, 192147 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 345449 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 81%, 76402 problemów
⚠️ **RU**: jakość 68%, 214317 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 69%, 31835 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #200 |
| Heartbeat | 4s temu | 2026-02-20T21:22:28Z |
...
- 2026-02-20 21:22:01 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 21:21:46 | AUTO_TRANSLATE:heartbeat_tick | it | ok | quests.json
- 2026-02-20 21:21:45 | AUTO_TRANSLATE:parallel_start | it | ok | quests.json
- 2026-02-20 21:21:44 | AUTO_TRANSLATE:auto_done | ru | ok | spells.json
- 2026-02-20 21:21:31 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | spells.json
- 2026-02-20 21:21:31 | AUTO_TRANSLATE:auto_start | ru | ok | spells.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,830 | 687 | 5973 (89.7%) | 37 |
| 🟡 ES | 84.8% | 0 | 2,160 | 617 | 2681 (81.3%) | 39 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **123,869** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=22.6%, reason=decrease_high_fail_rate=22.6% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,304 kluczy / 76 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 21:22:31
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → warn (files+1, translated+50, skipped+0) — lang=ru file=scripts.json strict_skipped_done=407
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+50, skipped+0) — parallel lang=es file=raids.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+42, skipped+0) — lang=pl file=otclient_modules.json strict_skipped_done=693 guard_fail=5 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **16,636** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 200 |
| ❌ Błędów | 399 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (4,855), **RU** (3,284), **IT** (2,689), **RO** (1,984), **PL** (1,950) |
| 📊 Porównanie | ↑ 356.9% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **114,221** kluczy
...
| 🔄 Cykli wykonanych | **#200** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 21:22:31  
