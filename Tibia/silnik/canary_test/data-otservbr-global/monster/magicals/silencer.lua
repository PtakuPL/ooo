...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "Prrrroooaaaah!!! PRROAAAH!!", yell = false , i18nKey = "monster.silencer.voice_1"},
	{ text = "PRRRROOOOOAAAAAHHHH!!!", yell = true , i18nKey = "monster.silencer.voice_2"},
	{ text = "HUUUSSSSSSSSH!!", yell = true , i18nKey = "monster.silencer.voice_3"},
	{ text = "Hussssssh!!", yell = false , i18nKey = "monster.silencer.voice_4"},
}
