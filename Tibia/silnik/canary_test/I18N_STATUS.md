...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.94% / real 10.86%**. Tempo: **899.0 kluczy/h**. Tłumaczeń netto: **140,772**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 03:16:19

> **Aktualizacja:** 2026-04-29 03:16:19 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,604 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: it | Plik: items.json | Heartbeat: 2026-04-29T03:14:44Z
> **Okno godzinowe:** okno=1.0h | cykli=72 | pominięte=0.0% | odrzucone=3.0% | przepustowość=899.0/h  
> **Tłumaczeń netto:** 140,772

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 03:16:19 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T03:14:44Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 17s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 03:16:19 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T03:14:41.707443Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T03:14:43.520681Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 03:16:19 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T03:16:25.399247Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T03:14:44Z
...
| 🔄 **Ostatni cykl** | 41 kluczy, 5 odrzuconych, 75.0s, tryb: AUTO_TRANSLATE, cel: cs/items.json |
| ❤️ **Heartbeat** | 2026-04-29T03:14:44Z |
...
| ⏳ Oldest pending (visible tail) | 17438 s |
| 🌍 Top języki | RU(398) |
...
| 🌍 Recent provider mix | TM/simple(260), Free Google Translate(224), canonical_name_semantic_autofix(17), canonical_name_case_autofi... |
...
| ❤️ Pool health | `critical` (writes=516, fallbacks=13) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=585/585 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 17438}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~138 dni (2,986,648 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 78.8% | 58,766/74,536 | ~13h |
| PL | ██████████████░░░░░░ | 71.0% | 52,911/74,536 | ~20h |
| IT | █████████████░░░░░░░ | 69.6% | 51,854/74,536 | ~21h |
| RO | █████████████░░░░░░░ | 69.7% | 51,972/74,536 | ~21h |
| RU | █████████░░░░░░░░░░░ | 45.8% | 34,103/74,536 | ~41h |
...
> Świeżość: 17s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 03:16:19
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T03:14:41.707443Z
...
- hive structure → struktura úlu (item.13198.name)
- hive structure → struktura úlu (item.13199.name)
- hive structure → struktura úlu (item.13200.name)
- hive structure → struktura úlu (item.13201.name)
- hive structure → struktura úlu (item.13202.name)
- hive structure → struktura úlu (item.13203.name)
- hive structure → struktura úlu (item.13204.name)
- hive structure → struktura úlu (item.13205.name)
- hive structure → struktura úlu (item.13206.name)
...
- Raporty strażnika jakości: **4748**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4601**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T03:15:00.825525Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.94%** (695,420/3,875,872)
- **Pokrycie globalne (real):** **10.86%** (420,936/3,875,872)
- **Kopie EN (łącznie):** **410,571**
- **Placeholdery [EN]/puste (łącznie):** **2,190,243**
...
| 🕒 Evidence window | 24h (span=32.40h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=32.40h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T02:16:20.186852Z → 2026-04-29T03:16:20.186852Z) |
...
| Podejrzane tłumaczenia | **1119** |
| Najgorsze cele (strażnik) | cs/items.json (gf=15), ro/items.json (gf=4), ru/items.json (gf=3), it/items.json (gf=2), de/otclient_modules.json (gf=2) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T03:14:43.520681Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T03:14:43.520681Z
- **Top 5 typów problemów:** suspicious_rejected_critical=187, suspicious_log_low=93, suspicious_log_high=81, suspicious_log_medium=26, suspicious_rejected_high=13
- **Języki o najsłabszej jakości:** es(60.1, issues=730829), ro(60.1, issues=429958), de(60.1, issues=112979), cs(60.1, issues=90215), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 730829 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 71%, 171115 problemów
⚠️ **RU**: jakość 64%, 361808 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,604 |
| Heartbeat | 101s temu | 2026-04-29T03:14:44Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T03:09:33.547663Z
...
- 2026-04-29 03:15:02 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-04-29 03:15:01 | AUTO_TRANSLATE:auto_start | it | ok | items.json
- 2026-04-29 03:14:42 | AUTO_TRANSLATE:auto_done | cs | ok | items.json
- 2026-04-29 03:13:28 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | items.json
- 2026-04-29 03:13:27 | AUTO_TRANSLATE:auto_start | cs | ok | items.json
- 2026-04-29 03:12:35 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **140,772** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=2.5%, reason=increase_low_fail_rate=2.5%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 03:16:19
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **2,784** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 59 |
| ❌ Błędów | 110 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **RU** (634), **CS** (569), **DE** (360), **IT** (346), **TR** (315) |
| 📊 Porównanie | ↓ 66.2% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **21,764** kluczy
...
| 🔄 Cykli wykonanych | **#17,604** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,604 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 03:16:19  
