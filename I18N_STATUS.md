...
> **Aktualizacja:** 2025-12-12 04:04:02 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 21768
...
| 🔍 **Przeskanowane** | **2,092** | **27.0%** | historia workera |
| ⏳ Nie przeskanowane | **5,657** | 73.0% | czekają na skan |
...
|--------|-------|---------|------|
| ✅ Zmigrowane | **22** | 1.1% | mają klucze i18n |
...
|---------|---------|------|
| 🔑 **Klucze EN (źródłowe)** | **21,768** | wszystkie kategorie |
| 📊 NPC | 5,339 | dialogi NPC |
| 📊 Items | 13,749 | przedmioty |
| 📊 Monsters | 252 | potwory |
...
│    ├─ Kategoria MONSTERS:    252 kluczy EN                    │
│    └─ Total kluczy EN:  21768                                 │
├─────────────────────────────────────────────────────────────────┤
│ 📅 Ostatnia aktualizacja: 2025-12-12 04:04:02            │
└─────────────────────────────────────────────────────────────────┘
```
...
|---------|---------|-----------|
| 📁 Plików przeskanowanych | **22** | w tej sesji |
...
📅 Auto-updated by Worker v1.1 | Last: 2025-12-12 04:04:02  
...
- ✅ `muglex_clan_assassin` - ukończono 2025-12-12 04:04
- ✅ `dawn_bat` - ukończono 2025-12-12 04:04
- ✅ `behemoth` - ukończono 2025-12-12 04:03
- ✅ `orclops_ravager` - ukończono 2025-12-12 04:03
- ✅ `frost_giant` - ukończono 2025-12-12 04:03
- ✅ `ogre_brute` - ukończono 2025-12-12 04:03
- ✅ `ogre_ruffian` - ukończono 2025-12-12 04:03
- ✅ `frost_giantess` - ukończono 2025-12-12 04:03
- ✅ `cyclops_smith` - ukończono 2025-12-12 04:03
- ✅ `orclops_doomhauler` - ukończono 2025-12-12 04:03
