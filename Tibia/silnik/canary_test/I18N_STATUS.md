...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.17% / real 10.01%**. Tempo: **1742.0 kluczy/h**. Tłumaczeń netto: **111,955**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-19 16:42:05

> **Aktualizacja:** 2026-04-19 16:42:05 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #13,741 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: pl | Plik: - | Heartbeat: 2026-04-19T16:41:59Z  
> **Okno godzinowe:** okno=1.0h | cykli=82 | pominięte=0.0% | odrzucone=47.8% | przepustowość=1742.0/h  
> **Tłumaczeń netto:** 111,955

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-19 16:42:05 |
| LIVE | 🟢 AKTYWNY | 10s temu | - | `activity.json / worker_state.json` | 2026-04-19T16:41:59Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-19 16:42:05 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-19T16:40:41.353527Z |
| QUALITY | 🔒 NIEAKTYWNY | 11s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-19T16:41:58.602915Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-19 16:42:05 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 10s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-19T16:41:59Z
...
| ❤️ **Heartbeat** | 2026-04-19T16:41:59Z |
...
| ❌ Odrzucone (guard) | 1597 |
| 🔁 Cykli | 82 |
| 🌍 Języków | 10 |
| 🏆 Najaktywniejszy | NL (345 kluczy) |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-19 16:42:05
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-19T16:40:41.353527Z
...
| CS (Czeski) | 44.88% (33,455/74,536) | 26.33% (19,628/74,536) | 32,368 | 22,563 | 0 |
...
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3635**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 280 | 0 | 0 | - | 2026-04-19T16:37:52.298730Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.17%** (665,450/3,875,872)
- **Pokrycie globalne (real):** **10.01%** (388,046/3,875,872)
- **Kopie EN (łącznie):** **425,659**
- **Placeholdery [EN]/puste (łącznie):** **2,208,028**
...
| CS | 31,773/70,637 | 45.0% / 25.6% | 1,682/3,899 | 43.1% / 38.8% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-19T15:42:06.270511Z → 2026-04-19T16:42:06.270511Z) |
...
| Podejrzane tłumaczenia | **2455** |
| Najgorsze cele (strażnik) | pl/npc.json (gf=458), tr/npc.json (gf=191), ro/items.json (gf=162), ro/monsters.json (gf=143), fr/npc.json (gf=112) |
...
|--------|-----------|--------|----------------|
| `gt_rejected_critical` | 304 | 47.6% | ro/items.json (152) |
| `gt_validate_fail_placeholder` | 251 | 39.3% | tr/npc.json (93) |
| `gt_validate_fail_quality` | 42 | 6.6% | tr/npc.json (34) |
| `gt_validate_fail_word_salad` | 37 | 5.8% | cs/npc.json (9) |
| `gt_rejected_high_partial_translation_mix` | 3 | 0.5% | es/monsters.json (3) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 11s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-19T16:41:58.602915Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-19T16:41:58.602915Z
- **Top 5 typów problemów:** suspicious_log_high=173, suspicious_rejected_critical=161, suspicious_rejected_high=39, suspicious_log_medium=18, suspicious_log_critical=9
- **Języki o najsłabszej jakości:** ro(60.1, issues=391634), pl(60.1, issues=370646), fr(60.1, issues=46132), pt(60.1, issues=32496), es(60.5, issues=687031)
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #13,741 |
| Heartbeat | 10s temu | 2026-04-19T16:41:59Z |
...
- **Ostatnia aktualizacja:** 2026-04-19T16:40:56.318063Z
...
- 2026-04-19 16:40:57 | AUTO_TRANSLATE:heartbeat_tick | es | ok | monsters.json
- 2026-04-19 16:40:41 | AUTO_TRANSLATE:auto_done | pl | ok | npc.json
- 2026-04-19 16:39:21 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | npc.json
- 2026-04-19 16:37:53 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | npc.json
- 2026-04-19 16:37:53 | AUTO_TRANSLATE:auto_start | pl | ok | npc.json
- 2026-04-19 16:37:45 | AUTO_TRANSLATE:auto_done | es | ok | items.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 70.8% | 0 | 5,888 | 911 | 3425 (79.0%) | 24 |
| 🟡 ES | 77.8% | 0 | 9,726 | 2,639 | 944 (26.3%) | 34 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **111,955** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=47.49%, reason=decrease_high_fail_rate=47.5%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 3,550 kluczy / 58 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-19 16:42:05
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **3,005** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 22 |
| ❌ Błędów | 75 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **ES** (692), **CS** (473), **RO** (420), **NL** (345), **PL** (265) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **3,005** kluczy
...
| 🔄 Cykli wykonanych | **#13,741** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #13,741 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-19 16:42:05  
