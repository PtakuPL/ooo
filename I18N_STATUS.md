...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.86%**. Tempo: **1637.5 kluczy/h**. Tłumaczeń netto: **118,450**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 18:55:02

> **Aktualizacja:** 2026-02-20 18:55:02 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #76 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ro | Plik: npc.json | Heartbeat: 2026-02-20T18:53:30Z  
> **Okno godzinowe:** okno=1.0h | cykli=196 | pominięte=0.0% | odrzucone=75.7% | przepustowość=1637.5/h  
> **Tłumaczeń netto:** 118,450

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 18:55:02 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-02-20T18:53:30Z |
| MIGRATION | 🔒 NIEAKTYWNY | 30s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 18:55:02 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T18:53:37.131874Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T18:55:03.896525Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 18:55:02 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T18:53:30Z
...
| ❤️ **Heartbeat** | 2026-02-20T18:53:30Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **2,834** kluczy |
| ❌ Odrzucone (guard) | 8831 |
| 🔁 Cykli | 196 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (702 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~1638 kluczy/h |
...
> **ETA globalne:** ~58 dni (2,260,959 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~1638 kluczy/h.
...
> Świeżość: 30s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 18:55:02
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T18:53:37.131874Z
...
| RO (Rumuński) | 22,946/53,586 | 42.82% | 2,347 | 0 |
...
- You need to donate {helmet} addon first. → Mai întâi trebuie să donezi suplimentul {helmet}. (npc.queen_eloise.say_14)
- So you wold like to donate 500.000.000 gold pieces which in return will entitle  → Așadar, ați dori să donați 500.000.000 de piese de aur care, în schimb, vă vor d (npc.queen_eloise.say_15)
- So you would like to donate 250.000.000 gold pieces which in return will entitle → Așadar, ați dori să donați 250.000.000 de piese de aur care, în schimb, vă vor d (npc.queen_eloise.say_16)
- So you would like to donate 250.000.000 gold pieces which in return will entitle → Așadar, ai dori să donezi 250.000.000 de piese de aur care, în schimb, îți vor d (npc.queen_eloise.say_17)
- In that case, return to me once you made up your mind. → În acest caz, întoarce-te la mine după ce te-ai hotărât. (npc.queen_eloise.say_2)
- Take this armor as a token of great gratitude. Let us forever remember this day, → Luați această armură ca pe un semn de mare recunoștință. Să ne amintim pentru to (npc.queen_eloise.say_3)
- You do not have enough money to donate that amount. → Nu ai suficienți bani pentru a dona acea sumă. (npc.queen_eloise.say_5)
- You alread have that addon. → Ai deja acel supliment. (npc.queen_eloise.say_6)
- Take this helmet as a token of great gratitude. Let us forever remember this day → Luați această cască ca pe un semn de mare recunoștință. Să ne amintim pentru tot (npc.queen_eloise.say_7)
- You do not have enough money to donate that amount. → Nu ai suficienți bani pentru a dona acea sumă. (npc.queen_eloise.say_8)
- You alread have that outfit. → Ai deja acea ținută. (npc.queen_eloise.say_9)
- I can promote you for 20000 gold coins. Do you want me to promote you? → Te pot promova cu 20000 de monede de aur. Vrei să te promovez? (npc.queen_eloise.stdmod_1)
- Thank you, I'm fine. → Multumesc, sunt bine. (npc.queen_eloise.stdmod_13)
- Congratulations! You are now promoted. → Felicitări! Acum ești promovat. (npc.queen_eloise.stdmod_2)
- Alright then, come back when you are ready. → Bine atunci, revino când ești gata. (npc.queen_eloise.stdmod_3)
- Farewell, |PLAYERNAME|! → La revedere, |PLAYERNAME|! (npc.queen_eloise.walkaway_msg_1)
- So receive the protection of the twist of fate, pilgrim. → Așa că primește protecția întorsăturii destinului, pelerine. (npc.quentin.keyword_1)
- Keep your adventurer's stone well. → Păstrează-ți bine piatra de aventurier. (npc.quentin.stdmod_10)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **6820**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3928**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **13.86%** (386,153/2,786,472)
- **Kopie EN (łącznie):** **162,338**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T17:55:03.178279Z → 2026-02-20T18:55:03.178279Z) |
...
| Przepustowość (kluczy/h) | **1637.5 kluczy/h** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T18:55:03.896525Z

- **Ostatni audyt:** SLOW_MODE | 28 issue(s) / 100 entries | 2026-02-20T18:53:37.739331Z | recent_hidden=0
- **Alarm recent hidden HIGH/CRITICAL:** ✅ OK | hidden=0, threshold=5, trend=→ last10=0.00, prev10=0.00, latest=0
- **Regresja critical bad keys pack:** 🚨 FAIL: pl(critical=26, pack=0), es(critical=10, pack=0)
- **Top 5 typów problemów:** suspicious_log_critical=67, suspicious_rejected_critical=64, suspicious_log_high=62, artifact_token=28, identical_to_en_exempt=9
- **Języki o najsłabszej jakości:** es(60.1, issues=329346), pl(60.1, issues=184422), ro(60.1, issues=180351), sr(61.3, issues=86259), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 60%, 184422 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 329346 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 78%, 73249 problemów
⚠️ **RU**: jakość 68%, 211297 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #76 |
| Heartbeat | 93s temu | 2026-02-20T18:53:30Z |
...
- 2026-02-20 18:53:30 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | npc.json
- 2026-02-20 18:53:30 | AUTO_TRANSLATE:parallel_start | ro | ok | npc.json
- 2026-02-20 18:53:25 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | npc.json
- 2026-02-20 18:53:25 | AUTO_TRANSLATE:parallel_start | ru | ok | npc.json
- 2026-02-20 18:53:24 | AUTO_TRANSLATE:auto_done | it | ok | npc.json
- 2026-02-20 18:53:06 | AUTO_TRANSLATE:heartbeat_tick | it | ok | npc.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **118,450** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=85.37%, reason=decrease_high_fail_rate=85.4% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 18:55:02
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [pl] → ok (translated+42, skipped+0) — parallel lang=pl file=items.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [sr] → ok (files+1, translated+5, skipped+0) — lang=sr file=globalevents.json
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+16, skipped+0) — lang=ro file=monsters.json strict_skipped_done=361 guard_fail=34 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **8,587** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 76 |
| ❌ Błędów | 194 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (2,504), **RU** (1,667), **IT** (1,419), **RO** (1,048), **PL** (942) |
| 📊 Porównanie | ↑ 135.8% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **106,172** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 18:55:02  
