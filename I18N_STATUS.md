...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **18.94%**. Tempo: **2941.0 kluczy/h**. Tłumaczeń netto: **63,231**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-23 15:46:09

> **Aktualizacja:** 2026-03-23 15:46:09 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **LIVE:** Cykl #10,785 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: cs | Plik: monsters.json | Heartbeat: 2026-03-23T15:46:04Z  
> **Okno godzinowe:** okno=1.0h | cykli=24 | pominięte=0.0% | odrzucone=10.8% | przepustowość=2941.0/h  
> **Tłumaczeń netto:** 63,231

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-23 15:46:09 |
| LIVE | 🟢 AKTYWNY | 7s temu | - | `activity.json / worker_state.json` | 2026-03-23T15:46:04Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 30s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-23 15:46:09 |
| TRANSLATION | 🟢 AKTYWNY | 50s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-23T15:45:20.864847Z |
| QUALITY | 🔒 NIEAKTYWNY | 24s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-23T15:45:46.466376Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-23 15:46:09 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 7s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-23T15:46:04Z
...
| ❤️ **Heartbeat** | 2026-03-23T15:46:04Z |
...
> **ETA globalne:** ~42 dni (2,948,057 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~2941 kluczy/h.
...
> Świeżość: 30s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-23 15:46:09
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 50s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-23T15:45:20.864847Z
...
- **Pokrycie globalne:** **18.94%** (734,011/3,875,872)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-23T14:46:09.614442Z → 2026-03-23T15:46:09.614442Z) |
...
| Przepustowość (kluczy/h) | **2941.0 kluczy/h** |
| Podejrzane tłumaczenia | **612** |
| Najgorsze cele (strażnik) | it/monsters.json (gf=95), ro/monsters.json (gf=85), nl/monsters.json (gf=70), pt/monsters.json (gf=67), fr/monsters.json (gf=28) |
...
> Świeżość: 24s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-23T15:45:46.466376Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-03-23T15:45:46.466376Z
...
- **Języki o najsłabszej jakości:** ro(60.1, issues=345813), it(60.1, issues=115239), cs(60.7, issues=14184), es(62.2, issues=628527), fr(65.3, issues=20471)
...
⚠️ **ES**: jakość 62%, 628527 problemów
⚠️ **PT**: jakość 70%, 22559 problemów
⚠️ **FR**: jakość 65%, 20471 problemów
⚠️ **IT**: jakość 60%, 115239 problemów
⚠️ **RU**: jakość 88%, 297518 problemów
⚠️ **NL**: jakość 72%, 14894 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #10,785 |
| Heartbeat | 7s temu | 2026-03-23T15:46:04Z |
...
- 2026-03-23 15:45:21 | AUTO_TRANSLATE:auto_done | nl | ok | monsters.json
- 2026-03-23 15:44:32 | AUTO_TRANSLATE:heartbeat_tick | nl | ok | monsters.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **63,231** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=10.02%, reason=stable_fail_rate=10.0% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-23 15:46:09
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **39,542** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 174 |
| ❌ Błędów | 602 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **ES** (11,355), **TR** (6,169), **RO** (5,527), **PL** (2,981), **FR** (2,888) |
| 📊 Porównanie | ↑ 90.8% vs wczoraj (20,729) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **60,271** kluczy
...
| 🔄 Cykli wykonanych | **#10,785** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #10,785 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-23 15:46:09  
