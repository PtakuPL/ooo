...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.92% / real 10.84%**. Tempo: **846.0 kluczy/h**. Tłumaczeń netto: **139,526**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 01:41:22

> **Aktualizacja:** 2026-04-29 01:41:22 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,484 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: auto_done | Kategoria: it | Plik: items.json | Heartbeat: 2026-04-29T01:39:37Z
> **Okno godzinowe:** okno=1.0h | cykli=72 | pominięte=0.0% | odrzucone=3.8% | przepustowość=846.0/h  
> **Tłumaczeń netto:** 139,526

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 01:41:22 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T01:39:37Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 53s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 01:41:22 |
| TRANSLATION | 🟢 AKTYWNY | 19s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T01:41:07.922685Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T01:39:35.528505Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 01:41:22 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T01:41:27.718791Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T01:39:37Z
...
| 🧠 **Detail** | translated=34 guard_fail=1 strict_missing_key=0 strict_skipped_done=1940 |
| 🔑 **Current key** | `it:items.json` |
| 🔄 **Ostatni cykl** | 34 kluczy, 1 odrzuconych, 75.0s, tryb: AUTO_TRANSLATE, cel: it/items.json |
| ❤️ **Heartbeat** | 2026-04-29T01:39:37Z |
...
| ⏳ Oldest pending (visible tail) | 17111 s |
| 🌍 Top języki | RU(398) |
...
| 🌍 Recent provider mix | TM/simple(269), Free Google Translate(223), canonical_name_semantic_autofix(16), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=511, fallbacks=19) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=514/514 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 17111}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| �📊 Przetłumaczono | **846** kluczy |
| ❌ Odrzucone (guard) | 33 |
| 🔁 Cykli | 72 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | CS (318 kluczy) |
...
|-------|---------------|-----------|----------|----------|
| ES | 58,691 | 74,536 | 78.74% →0% | 9,719 |
...
> Świeżość: 53s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 01:41:22
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 19s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T01:41:07.922685Z
...
- cake tile → piastrella per torta (item.12103.name)
- cake tile → piastrella per torta (item.12104.name)
- cake tile → piastrella per torta (item.12112.name)
- cake tile → piastrella per torta (item.12113.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.12124.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.12125.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.12126.name)
- RESERVED SPRITE → SPRITE RISERVATO (item.12127.name)
- unknown item → oggetto sconosciuto (item.12129.name)
- unknown item → oggetto sconosciuto (item.12130.name)
- unknown item → oggetto sconosciuto (item.12131.name)
- unknown item → oggetto sconosciuto (item.12132.name)
- unknown item → oggetto sconosciuto (item.12133.name)
- unknown item → oggetto sconosciuto (item.12134.name)
- alter of fire → altare del fuoco (item.12136.name)
- alter of fire → altare del fuoco (item.12137.name)
- chess board → scacchiera (item.1210.name)
- chess board → scacchiera (item.1211.name)
- mill board → tavola del mulino (item.1212.name)
- mill board → tavola del mulino (item.1213.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4718**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4571**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T01:39:53.402918Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.92%** (694,671/3,875,872)
- **Pokrycie globalne (real):** **10.84%** (420,150/3,875,872)
- **Kopie EN (łącznie):** **410,608**
- **Placeholdery [EN]/puste (łącznie):** **2,190,992**
...
| 🕒 Evidence window | 24h (span=30.82h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=30.82h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T00:41:22.455635Z → 2026-04-29T01:41:22.455635Z) |
...
| Przepustowość (kluczy/h) | **846.0 kluczy/h** |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T01:39:35.528505Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T01:39:35.528505Z
- **Top 5 typów problemów:** suspicious_rejected_critical=189, suspicious_log_low=97, suspicious_log_high=94, suspicious_rejected_high=11, suspicious_log_medium=9
- **Języki o najsłabszej jakości:** es(60.1, issues=728618), ro(60.1, issues=427890), de(60.1, issues=111163), cs(60.1, issues=86935), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 60%, 53659 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 728618 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 70%, 169943 problemów
⚠️ **RU**: jakość 66%, 359898 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,484 |
| Heartbeat | 110s temu | 2026-04-29T01:39:37Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T01:41:23.221982Z
...
│ Plik: items.json                                              │
│ Postęp: 34/30 keys                                            │
│ …4 guard_fail=1 strict_missing_key=0 strict_skipped_done=1940 │
├─────────────────────────────────────────────────────────────────┤
│ ❤️ Heartbeat: 2026-04-29T01:39:37Z           │
└─────────────────────────────────────────────────────────────────┘
```
...
- 2026-04-29 01:41:08 | AUTO_TRANSLATE:auto_done | it | ok | items.json
- 2026-04-29 01:39:54 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-04-29 01:39:53 | AUTO_TRANSLATE:auto_start | it | ok | items.json
- 2026-04-29 01:39:34 | AUTO_TRANSLATE:auto_done | cs | ok | items.json
- 2026-04-29 01:38:08 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | items.json
- 2026-04-29 01:38:08 | AUTO_TRANSLATE:auto_start | cs | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **139,526** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=4.95%, reason=increase_low_fail_rate=4.9%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 01:41:22
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **1,445** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 33 |
| ❌ Błędów | 58 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (398), **IT** (207), **RU** (194), **DE** (180), **TR** (170) |
| 📊 Porównanie | ↓ 82.4% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **20,425** kluczy
...
| 🔄 Cykli wykonanych | **#17,484** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,484 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 01:41:22  
