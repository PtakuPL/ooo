...
function storeCoin.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	player:sendLocalizedTextMessage(MESSAGE_EVENT_ADVANCE, "scripts.store_coins.msg_1" .. count .. " tibia coins to your balance. Your total is now " .. player:getTransferableCoins() .. ".")
