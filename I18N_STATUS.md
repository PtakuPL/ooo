...
> **Aktualizacja:** 2025-12-11 02:20:17 UTC  
...
│ 0/1000 kluczy (0%)                                          │
├─────────────────────────────────────────────────────────────────┤
│ ⏳ Total processed: 29328 operacji               │
│ 🌍 Języki zsync: 0/53                                │
│ 📅 Ostatnia aktualizacja: 2025-12-11 02:20:17                 │
└─────────────────────────────────────────────────────────────────┘
```
...
|---------|---------|-----------|
| 📁 Operacji wykonanych | **29328** | we wszystkich kategoriach |
| ✅ NPC zmigrowanych | **26** (318 z i18nKey) | z 1026 plików NPC |
| 🔑 Kluczy wyciągniętych | **28958** | we wszystkich kategoriach |
...
- ⚡ `pending_skip` +0 kluczy @ 02:20:16
- 🎒 `items` +0 kluczy @ 02:17:30
- ⚡ `twig` +0 kluczy @ 02:17:16
- ⚡ `keywordhandler` +0 kluczy @ 02:17:07
- ⚡ `sendtextmessage` +0 kluczy @ 02:16:59
- ⚡ `client` +0 kluczy @ 02:16:45
- ⚡ `cpp` +0 kluczy @ 02:16:38
- ⚡ `html` +0 kluczy @ 02:16:31
...
| events | 0m | 1x | Progresywny backoff |
...
| sendtextmessage | 6m | 2x | Progresywny backoff |
| keywordhandler | 6m | 2x | Progresywny backoff |
...
📅 Auto-updated by Worker v1.1 | Last: 2025-12-11 02:20:17  
