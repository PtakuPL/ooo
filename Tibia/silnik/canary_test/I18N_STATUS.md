...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.58% / real 10.45%**. Tempo: **1159.0 kluczy/h**. Tłumaczeń netto: **123,389**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-23 00:38:44

> **Aktualizacja:** 2026-04-23 00:38:44 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #15,667 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: pt | Plik: html.json | Heartbeat: 2026-04-23T00:38:38Z  
> **Okno godzinowe:** okno=1.0h | cykli=132 | pominięte=0.0% | odrzucone=63.0% | przepustowość=1159.0/h  
> **Tłumaczeń netto:** 123,389

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-23 00:38:44 |
| LIVE | 🟢 AKTYWNY | 15s temu | - | `activity.json / worker_state.json` | 2026-04-23T00:38:38Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-23 00:38:44 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-23T00:37:44.424097Z |
| QUALITY | 🔒 NIEAKTYWNY | 43s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-23T00:38:09.871714Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-23 00:38:44 |
| DOCTOR | 🟢 AKTYWNY | 0s temu | - | `doctor_alerts_latest.json` | 2026-04-23T00:38:53.264730Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 15s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-23T00:38:38Z
...
| ❤️ **Heartbeat** | 2026-04-23T00:38:38Z |
...
| 00:33:49 | RU | Klient | html.json | 22 | `tm` | `html.account.characters.change_comment.html.text4` | [макс. ленгт: 2000 чарс, 50 линес (ЕНТЕРс)] |
...
|----------|------|---------|-----------|-------|----------|--------------|-----|
| 00:37:40 | DE | Klient | html.json | `hard_block` | `high_reject_types` | `partial_translation_mix` | `html.admin.open_source.html.text1` |
| 00:37:40 | DE | Klient | html.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `web.tpl.guilds.create.b_2` |
| 00:37:38 | DE | Klient | html.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `web.tpl.guilds.manager.b_10` |
| 00:37:03 | FR | Klient | html.json | `hard_block` | `validate_word_salad` | `word_salad` | `html.networks.html.text2` |
| 00:37:01 | FR | Klient | html.json | `hard_block` | `validate_command` | `command` | `html.forum.edit_post.html.text1` |
| 00:37:01 | FR | Klient | html.json | `hard_block` | `validate_command` | `command` | `html.forum.new_post.html.text1` |
| 00:37:01 | FR | Klient | html.json | `hard_block` | `validate_command` | `command` | `html.forum.new_thread.html.text1` |
| 00:35:57 | IT | Klient | html.json | `hard_block` | `validate_word_salad` | `word_salad` | `html.glossary.text5` |
| 00:35:57 | IT | Klient | html.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `html.credits.text4` |
| 00:35:55 | IT | Klient | html.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `html.check_relations.text5` |
| 00:35:55 | IT | Klient | html.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `html.check_relations.text3` |
| 00:35:52 | IT | Klient | html.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `html.header.text1` |
| 00:35:52 | IT | Klient | html.json | `hard_block` | `validate_word_salad` | `word_salad` | `html.payment.html.text2` |
| 00:35:48 | IT | Klient | html.json | `hard_block` | `high_reject_types` | `partial_translation_mix` | `html.api.text5` |
| 00:35:48 | IT | Klient | html.json | `hard_block` | `high_reject_types` | `partial_translation_mix` | `html.easyimage.text2` |
| 00:35:48 | IT | Klient | html.json | `hard_block` | `high_reject_types` | `partial_translation_mix` | `html.index.text1` |
| 00:35:46 | IT | Klient | html.json | `hard_block` | `validate_word_salad` | `word_salad` | `html.networks.html.text2` |
| 00:35:37 | IT | Klient | html.json | `hard_block` | `high_reject_types` | `partial_translation_mix` | `html.admin.open_source.html.text1` |
| 00:35:02 | RO | Klient | html.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `html.base.html.text4` |
| 00:35:02 | RO | Klient | html.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `html.enterkey.text1` |
...
| ⏳ Oldest pending (visible tail) | 1227 s |
| 🌍 Top języki | RU(349), DE(17), IT(9), RO(6) |
| 🧱 Top reason_bucket | default(388), placeholder(11), command(1) |
...
| 🧮 OpenAI budget | `3/250` |
| ♻️ Provider debt | `0` |
| 🌍 Recent provider mix | Free Google Translate(193), TM/simple(166) |
| 🔁 Latest fallback | OpenAI model pool → fallback chain exhausted all models blocked [all_models_blocked] html.json |
| 📉 Fallback breakdown | fallback chain exhausted all models blocked(64), fallback to google translate high(36), fallback to google ... |
| ☁️ Cloud policy | `disabled` |
| 🤖 OpenAI pool | `degraded` |
| 🩺 Health signals | recent_fallback |
| ❤️ Pool health | `degraded` (writes=359, fallbacks=102) |
...
| `QUEUE_STARVATION` | OK | OK | `{'pending': 400, 'oldest_s': 1227}` | `{'pending_min': 200, 'oldest_s': 3600}` | Queue bez sygnałów starvation. |
...
| 📨 Selected command | `AUTO:pt:html.json:30` |
...
| �📊 Przetłumaczono | **1,159** kluczy |
| ❌ Odrzucone (guard) | 1972 |
| 🔁 Cykli | 132 |
| 🌍 Języków | 11 |
| 🏆 Najaktywniejszy | RU (302 kluczy) |
| 📄 Najczęstszy plik | monsters.json |
| ⚡ Przepustowość | ~1159 kluczy/h |
| 🛡️ Odrzucone (strażnik) | 63.0% |
| ⚠️ Podejrzane | 2405 |
...
> **ETA globalne:** ~108 dni (3,000,647 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~1159 kluczy/h.
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-23 00:38:44
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-23T00:37:44.424097Z
...
- Raporty strażnika jakości: **4253**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4110**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 280 | 0 | 0 | - | 2026-04-23T00:38:36.957226Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.58%** (681,421/3,875,872)
- **Pokrycie globalne (real):** **10.45%** (405,133/3,875,872)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-22T23:38:45.287736Z → 2026-04-23T00:38:45.287736Z) |
| Cykle | **132** (TŁUMACZENIE=132, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **63.0%** |
| Cykle bez postępu % | **18.2%** |
| Przepustowość (kluczy/h) | **1159.0 kluczy/h** |
| Podejrzane tłumaczenia | **2405** |
| Najgorsze cele (strażnik) | ru/server.json (gf=531), tr/npc.json (gf=227), ru/html.json (gf=223), cs/monsters.json (gf=184), ro/items.json (gf=179) |
...
|--------|-----------|--------|----------------|
| `gt_validate_fail_identical_to_en` | 759 | 59.6% | ro/items.json (168) |
| `gt_rejected_high_mixed_scripts` | 202 | 15.9% | ru/server.json (199) |
| `gt_validate_fail_wrong_script` | 128 | 10.1% | ru/html.json (127) |
| `gt_rejected_high_cyrillic_latin_mix` | 108 | 8.5% | ru/server.json (99) |
| `gt_validate_fail_placeholder` | 38 | 3.0% | tr/npc.json (21) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 43s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-23T00:38:09.871714Z

- **Ostatni audyt:** OK | 3 issue(s) / 100 entries | 2026-04-23T00:38:09.871714Z
- **Top 5 typów problemów:** suspicious_rejected_critical=170, suspicious_log_high=102, suspicious_log_warning=64, suspicious_log_medium=34, suspicious_rejected_high=30
- **Języki o najsłabszej jakości:** pl(60.1, issues=383520), de(60.2, issues=90788), ru(60.5, issues=339365), cs(61.3, issues=70308), it(63.1, issues=160673)
- **Pliki:** `i18n/status/quality_audit_latest.json`, `i18n/status/quality_dashboard.json`, `i18n/status/quality_report.jsonl`

### 📈 Statystyki Pracy
| Metryka | Wartość | Info |
|---------|---------|------|
| 🔄 Cykl aktualny | **#129** | od uruchomienia |
...
⚠️ **TR**: jakość 88%, 42338 problemów
⚠️ **PL**: jakość 60%, 383520 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 94%, 704618 problemów
⚠️ **PT**: jakość 66%, 40001 problemów
⚠️ **FR**: jakość 67%, 57710 problemów
⚠️ **IT**: jakość 63%, 160673 problemów
⚠️ **RU**: jakość 60%, 339365 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #15,667 |
| Heartbeat | 15s temu | 2026-04-23T00:38:38Z |
...
- **Ostatnia aktualizacja:** 2026-04-23T00:37:59.538058Z
...
- 2026-04-23 00:38:38 | AUTO_TRANSLATE:heartbeat_tick | pt | ok | html.json
- 2026-04-23 00:38:37 | AUTO_TRANSLATE:auto_start | pt | ok | html.json
- 2026-04-23 00:38:00 | AUTO_TRANSLATE:heartbeat_tick | es | ok | otclient_modules.json
- 2026-04-23 00:37:44 | AUTO_TRANSLATE:auto_done | de | ok | html.json
- 2026-04-23 00:37:28 | AUTO_TRANSLATE:heartbeat_tick | de | ok | html.json
- 2026-04-23 00:37:28 | AUTO_TRANSLATE:auto_start | de | ok | html.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 71.0% | 0 | 5,874 | 380 | 1544 (80.2%) | 17 |
| 🟡 ES | 78.1% | 0 | 9,791 | 812 | 555 (40.6%) | 28 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **123,389** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=55.41%, reason=decrease_high_fail_rate=55.4%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,192 kluczy / 45 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-23 00:38:44

- • DOCTOR_REMEDIATION: AUTO_COMMAND [-] → ok — action=force_auto reason=deferred_or_dlq_pressure
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → warn (files+1, translated+37, skipped+0) — lang=ru file=items.json strict_skipped_done=1380 guard_fail=1 placeholder=0 command=0 pipe=0
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+2, skipped+0) — lang=pl file=otclient_data.json strict_skipped_done=70
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [cs] → warn (files+1, translated+180, skipped+0) — lang=cs file=scripts.json strict_skipped_done=665 guard_fail=2 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pt] → warn (files+1, translated+3, skipped+0) — lang=pt file=libs.json strict_skipped_done=2
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **451** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 23 |
| ❌ Błędów | 44 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **DE** (119), **PT** (56), **NL** (54), **FR** (48), **IT** (47) |
| 📊 Porównanie | ↓ 96.3% vs wczoraj (12,108) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **28,135** kluczy
...
| 🔄 Cykli wykonanych | **#15,667** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #15,667 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-23 00:38:44  
