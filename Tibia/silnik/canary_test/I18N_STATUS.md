...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.91%**. Tempo: **1049.8 kluczy/h**. Tłumaczeń netto: **126,853**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 23:14:58

> **Aktualizacja:** 2026-02-20 23:14:58 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #2 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: - | Heartbeat: 2026-02-20T23:14:54Z  
> **Okno godzinowe:** okno=1.0h | cykli=131 | pominięte=0.0% | odrzucone=55.9% | przepustowość=1049.8/h  
> **Tłumaczeń netto:** 126,853

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 23:14:58 |
| LIVE | 🟢 AKTYWNY | 6s temu | - | `activity.json / worker_state.json` | 2026-02-20T23:14:54Z |
| MIGRATION | 🔒 NIEAKTYWNY | 16s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 23:14:58 |
| TRANSLATION | 🟢 AKTYWNY | 34s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T23:14:25.476228Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T23:14:59.894993Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 23:14:58 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T23:14:54Z
...
| ❤️ **Heartbeat** | 2026-02-20T23:14:54Z |
...
| ❌ Odrzucone (guard) | 2186 |
| 🔁 Cykli | 131 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (508 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~1050 kluczy/h |
| 🛡️ Guard fail rate | 55.9% |
| ⚠️ Podejrzane | 15648 |
| 🌐 GT aktywny (1h) | ✅ TAK |
| 🔤 GT tłumaczeń (1h) | 168 |
...
| IT | 28,225 | 53,586 | 52.67% | 2,127 |
| RU | 27,021 | 53,586 | 50.43% | 1,469 |
...
> **ETA globalne:** ~90 dni (2,259,393 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| PL | █████████████████░░░ | 87.8% | 47,077/53,586 | ~4h |
| ES | █████████████████░░░ | 85.1% | 45,616/53,586 | ~5h |
| IT | ██████████░░░░░░░░░░ | 52.7% | 28,225/53,586 | ~22h |
| RU | ██████████░░░░░░░░░░ | 50.4% | 27,021/53,586 | ~23h |
| SR | █████████░░░░░░░░░░░ | 45.4% | 24,349/53,586 | ~25h |
| RO | ████████░░░░░░░░░░░░ | 43.9% | 23,506/53,586 | ~26h |
| FR | ██████░░░░░░░░░░░░░░ | 33.1% | 17,731/53,586 | ~32h |
| SV | █████░░░░░░░░░░░░░░░ | 29.2% | 15,674/53,586 | ~34h |
...
> Świeżość: 16s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 23:14:58
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 34s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T23:14:25.476228Z
...
| IT (Włoski) | 28,225/53,586 | 52.67% | 2,127 | 0 |
| RU (Rosyjski) | 27,021/53,586 | 50.43% | 1,469 | 0 |
...
- Raporty strażnika jakości: **7326**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4431**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **13.91%** (387,719/2,786,472)
- **Kopie EN (łącznie):** **162,179**
...
| IT | 26,862/49,731 | 54.0% | 1,363/3,855 | 35.4% |
| RU | 24,222/49,731 | 48.7% | 2,799/3,855 | 72.6% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T22:14:59.185938Z → 2026-02-20T23:14:59.185938Z) |
...
| Najgorsze cele (strażnik) | pl/items.json (gf=813), es/items.json (gf=520), pl/npc.json (gf=178), ru/npc.json (gf=101), it/npc.json (gf=54) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T23:14:59.894993Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=350877), pl(60.1, issues=194333), ro(60.6, issues=190054), tl(64.2, issues=466), zh_TW(64.8, issues=337)
...
| Heartbeat | 6s temu | 2026-02-20T23:14:54Z |
...
- 2026-02-20 23:14:33 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 23:14:18 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | monsters.json
- 2026-02-20 23:14:17 | AUTO_TRANSLATE:parallel_start | ro | ok | monsters.json
- 2026-02-20 23:14:12 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | monsters.json
- 2026-02-20 23:14:12 | AUTO_TRANSLATE:parallel_start | ru | ok | monsters.json
- 2026-02-20 23:14:11 | AUTO_TRANSLATE:auto_done | it | ok | monsters.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,831 | 574 | 6415 (91.8%) | 34 |
| 🟡 ES | 85.1% | 0 | 2,151 | 598 | 2440 (80.3%) | 34 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **126,853** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=74.88%, reason=decrease_high_fail_rate=74.9% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,172 kluczy / 68 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 23:14:58

- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+23) — repair_identical lang=es file=npc.json target_identical=43 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=255.38
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ro] → ok (translated+22, skipped+0) — parallel lang=ro file=monsters.json
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+23) — repair_identical lang=es file=npc.json target_identical=43 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=256.71
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [pl] → ok (translated+30, skipped+0) — parallel lang=pl file=monsters.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+24, skipped+0) — lang=es file=npc.json strict_skipped_done=11419 guard_fail=6 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+23) — repair_identical lang=es file=npc.json target_identical=43 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=261.38
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [sv] → ok (translated+29, skipped+0) — parallel lang=sv file=raids.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ro] → ok (translated+0, skipped+0) — parallel lang=ro file=libs.json
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **21,478** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 224 |
| ❌ Błędów | 519 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (6,349), **RU** (4,297), **IT** (3,431), **RO** (2,554), **PL** (2,470) |
| 📊 Porównanie | ↑ 489.9% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **119,063** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 23:14:58  
