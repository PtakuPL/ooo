...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.0% / real 10.93%**. Tempo: **865.0 kluczy/h**. Tłumaczeń netto: **145,049**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 08:34:29

> **Aktualizacja:** 2026-04-29 08:34:29 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,060 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-04-29T08:32:57Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=5.2% | przepustowość=865.0/h  
> **Tłumaczeń netto:** 145,049

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 08:34:29 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T08:32:57Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 47s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 08:34:29 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T08:33:33.542606Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T08:32:56.068435Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 08:34:29 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T08:34:36.061037Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T08:32:57Z
...
| ❤️ **Heartbeat** | 2026-04-29T08:32:57Z |
...
|----------|------|---------|------|-------|--------|------------|--------|
| 08:33:28 | DE | Klient | otclient_modules.json | 15 | `tm` | `otclient_modules.blessing.tr_11` | - Abhängig von den Regeln des fairen Kampfes verlierst du zwischendurch |
| 08:32:43 | ES | Serwer | items.json | 32 | `simple` | `item.11837.name` | artículo desconocido |
| 08:30:58 | ES | Serwer | server.json | 2 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 08:28:59 | IT | Serwer | items.json | 185 | `google_translate` | `item.13504.name` | tesoro d'oro |
| 08:26:16 | RO | Serwer | items.json | 39 | `google_translate` | `item.10216.name` | kit statuie dragon |
| 08:24:33 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 08:21:24 | CS | Serwer | items.json | 41 | `simple` | `item.14368.name` | REZERVOVANÝ SPRITE |
| 08:19:46 | RU | Serwer | items.json | 36 | `transliteration_cyrillic` | `item.13931.name` | РЕСЕРВЕД СПРИТЕ |
| 08:18:03 | ES | Serwer | server.json | 2 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 08:16:07 | TR | Serwer | items.json | 39 | `simple` | `item.13007.name` | kovan yapısı |
...
|----------|------|---------|-----------|-------|----------|--------------|-----|
| 08:33:25 | DE | Klient | otclient_modules.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `otclient_modules.charms.tr_34` |
| 08:27:38 | IT | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 08:25:41 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10193.name` |
| 08:25:40 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10192.name` |
| 08:25:38 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10191.name` |
| 08:25:37 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10190.name` |
| 08:23:29 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.say_2` |
| 08:21:02 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.14250.name` |
| 08:20:59 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.14077.name` |
| 08:20:58 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.14023.name` |
| 08:20:56 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.11586.name` |
| 08:20:54 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 08:20:52 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10456.name` |
| 08:20:50 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10338.name` |
| 08:20:48 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10026.name` |
| 08:19:16 | RU | Serwer | items.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `item.11541.name` |
...
| ⏳ Oldest pending (visible tail) | 15567 s |
| 🌍 Top języki | RU(384), CS(3) |
| 🧱 Top reason_bucket | quality(384), default(3) |
| 🗂️ Deferred state keys | 8112 |
...
| 🌍 Recent provider mix | TM/simple(320), Free Google Translate(163), canonical_name_semantic_autofix(18), term_consistency_autofix(3) |
| 🔁 Latest fallback | TM/simple → fallback to google translate high [high_reject_types] npc.json |
| 📉 Fallback breakdown | fallback to google translate high(6), fallback to next provider validate fail(5), fallback to google transl... |
...
| ❤️ Pool health | `critical` (writes=504, fallbacks=12) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=833/833 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 387, 'oldest_s': 15567}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 47s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 08:34:29
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T08:33:33.542606Z
...
|-------|-----------|--------|----------|--------------|--------------|
| ES (Hiszpański) | 79.06% (58,925/74,536) | 67.94% (50,639/74,536) | 9,675 | 14,246 | 0 |
| PL (Polski) | 70.99% (52,911/74,536) | 65.08% (48,507/74,536) | 5,861 | 20,194 | 0 |
| IT (Włoski) | 70.65% (52,660/74,536) | 62.43% (46,536/74,536) | 10,028 | 17,997 | 0 |
| RO (Rumuński) | 69.73% (51,972/74,536) | 56.69% (42,253/74,536) | 13,005 | 19,303 | 0 |
| RU (Rosyjski) | 46.02% (34,299/74,536) | 44.45% (33,129/74,536) | 4,775 | 36,650 | 0 |
...
| CS (Czeski) | 50.62% (37,727/74,536) | 32.84% (24,481/74,536) | 29,858 | 20,223 | 0 |
...
| TR (Turecki) | 34.46% (25,683/74,536) | 30.97% (23,086/74,536) | 3,832 | 47,632 | 0 |
...
- Raporty strażnika jakości: **4863**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4716**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T08:33:13.148674Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.0%** (697,848/3,875,872)
- **Pokrycie globalne (real):** **10.93%** (423,462/3,875,872)
- **Kopie EN (łącznie):** **410,473**
- **Placeholdery [EN]/puste (łącznie):** **2,187,815**
...
| #3 | 🔴 Server | 11.00% | +0.25 pp | 51 | ZH 0.2%, TL 0.8%, BS 0.9% |
...
| 🕒 Evidence window | 24h (span=37.70h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=37.70h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T07:34:29.578108Z → 2026-04-29T08:34:29.578108Z) |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 58 | 78.4% | ru/items.json (58) |
| `retry_loop_cooldown_default` | 10 | 13.5% | cs/items.json (5) |
| `existing_canonical_name_quality_mixed_scripts` | 6 | 8.1% | ru/items.json (6) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T08:32:56.068435Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T08:32:56.068435Z
- **Top 5 typów problemów:** suspicious_rejected_critical=189, suspicious_log_low=145, suspicious_log_high=53, suspicious_rejected_high=11, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=740755), ro(60.1, issues=437551), de(60.1, issues=120106), cs(60.1, issues=103455), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 70%, 55808 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 740755 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 66%, 175421 problemów
⚠️ **RU**: jakość 73%, 367810 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,060 |
| Heartbeat | 99s temu | 2026-04-29T08:32:57Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T08:33:50.509141Z
...
- 2026-04-29 08:33:51 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 08:33:33 | AUTO_TRANSLATE:auto_done | de | ok | otclient_modules.json
- 2026-04-29 08:33:14 | AUTO_TRANSLATE:heartbeat_tick | de | ok | otclient_modules.json
- 2026-04-29 08:33:13 | AUTO_TRANSLATE:auto_start | de | ok | otclient_modules.json
- 2026-04-29 08:32:55 | AUTO_TRANSLATE:auto_done | es | ok | items.json
- 2026-04-29 08:31:34 | AUTO_TRANSLATE:heartbeat_tick | es | ok | items.json
...
| 🟡 ES | 79.1% | 0 | 9,675 | 581 | 0 (0.0%) | 26 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **145,049** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=3.47%, reason=increase_low_fail_rate=3.5%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 581 kluczy / 26 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 08:34:29
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+6) — repair_identical lang=es file=npc.json target_identical=2 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=186.11
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **7,435** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 174 |
| ❌ Błędów | 311 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,380), **RU** (1,279), **IT** (1,152), **TR** (1,032), **DE** (1,005) |
| 📊 Porównanie | ↓ 9.6% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **26,415** kluczy
...
| 🔄 Cykli wykonanych | **#18,060** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,060 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 08:34:29  
