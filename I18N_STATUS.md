...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.02% / real 10.94%**. Tempo: **669.0 kluczy/h**. Tłumaczeń netto: **146,223**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 10:17:28

> **Aktualizacja:** 2026-04-29 10:17:28 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,204 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: cs | Plik: items.json | Heartbeat: 2026-04-29T10:14:45Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=6.0% | przepustowość=669.0/h  
> **Tłumaczeń netto:** 146,223

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 10:17:28 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T10:14:45Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 26s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 10:17:28 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T10:16:11.796411Z |
| QUALITY | 🔒 NIEAKTYWNY | 3min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T10:14:27.071689Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 10:17:28 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T10:17:34.286624Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T10:14:45Z
...
| 🔄 **Ostatni cykl** | 41 kluczy, 8 odrzuconych, 89.0s, tryb: AUTO_TRANSLATE, cel: cs/items.json |
| ❤️ **Heartbeat** | 2026-04-29T10:14:45Z |
...
| 🌍 Recent provider mix | TM/simple(324), Free Google Translate(163), canonical_name_semantic_autofix(15), term_consistency_autofix(3) |
| 🔁 Latest fallback | TM/simple → fallback to google translate high [high_reject_types] npc.json |
| 📉 Fallback breakdown | fallback to google translate high(15), fallback to next provider validate fail(5), fallback to google trans... |
...
| ❤️ Pool health | `critical` (writes=505, fallbacks=21) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=912/912 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 386, 'oldest_s': 15138}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Tempo obliczone na bazie ostatniej godziny: ~669 kluczy/h.
...
> Świeżość: 26s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 10:17:28
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T10:16:11.796411Z
...
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14507.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14508.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14509.name)
- stone wall → kamenná zeď (item.1451.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14510.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14511.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14512.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14513.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14514.name)
...
- Raporty strażnika jakości: **4899**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4752**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T10:14:43.977788Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.02%** (698,398/3,875,872)
- **Pokrycie globalne (real):** **10.94%** (424,053/3,875,872)
- **Kopie EN (łącznie):** **410,432**
- **Placeholdery [EN]/puste (łącznie):** **2,187,265**
...
| 🕒 Evidence window | 24h (span=39.42h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=39.42h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T09:17:28.658764Z → 2026-04-29T10:17:28.658764Z) |
...
| Przepustowość (kluczy/h) | **669.0 kluczy/h** |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 81 | 84.4% | ru/items.json (81) |
| `existing_canonical_name_quality_mixed_scripts` | 15 | 15.6% | ru/items.json (15) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 3min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T10:14:27.071689Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T10:14:27.071689Z
- **Top 5 typów problemów:** suspicious_rejected_critical=189, suspicious_log_high=77, suspicious_log_low=74, suspicious_log_medium=49, suspicious_rejected_high=11
- **Języki o najsłabszej jakości:** es(60.1, issues=743700), ro(60.1, issues=439633), de(60.1, issues=122377), cs(60.1, issues=108139), fr(60.1, issues=60621)
- **Pliki:** `i18n/status/quality_audit_latest.json`, `i18n/status/quality_dashboard.json`, `i18n/status/quality_report.jsonl`

### 📈 Statystyki Pracy
| Metryka | Wartość | Info |
|---------|---------|------|
| 🔄 Cykl aktualny | **#153** | od uruchomienia |
...
⚠️ **TR**: jakość 61%, 56531 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 743700 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 72%, 176611 problemów
⚠️ **RU**: jakość 70%, 369925 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,204 |
| Heartbeat | 169s temu | 2026-04-29T10:14:45Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T10:16:28.937223Z
...
- 2026-04-29 10:16:29 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 10:16:13 | AUTO_TRANSLATE:auto_done | cs | ok | items.json
- 2026-04-29 10:14:45 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | items.json
- 2026-04-29 10:14:44 | AUTO_TRANSLATE:auto_start | cs | ok | items.json
- 2026-04-29 10:14:26 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
- 2026-04-29 10:13:11 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **146,223** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=5.06%, reason=stable_fail_rate=5.1%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 10:17:28

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [cs] → warn (files+1, translated+41, skipped+0) — lang=cs file=items.json strict_skipped_done=4185 guard_fail=8 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+4) — repair_identical lang=es file=npc.json target_identical=2 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=190.38
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+46, skipped+0) — lang=it file=items.json strict_skipped_done=1884 guard_fail=1 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **8,732** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 185 |
| ❌ Błędów | 374 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,588), **RU** (1,538), **IT** (1,286), **TR** (1,237), **DE** (1,215) |
| 📊 Porównanie | ↑ 6.1% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **27,712** kluczy
...
| 🔄 Cykli wykonanych | **#18,204** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,204 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 10:17:28  
