...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 23:45:43

> **Aktualizacja:** 2026-04-29 23:45:43 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,880 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ro | Plik: items.json | Heartbeat: 2026-04-29T23:43:46Z
> **Okno godzinowe:** okno=1.0h | cykli=28 | pominięte=0.0% | odrzucone=0.7% | przepustowość=671.0/h  
> **Tłumaczeń netto:** 154,116

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 23:45:43 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T23:43:46Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 41s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 23:45:43 |
| TRANSLATION | 🟢 AKTYWNY | 4min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T23:41:35.374608Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T23:43:45.799627Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 23:45:43 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T23:45:48.830648Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T23:43:46Z
...
| ❤️ **Heartbeat** | 2026-04-29T23:43:46Z |
...
| ⏳ Oldest pending (visible tail) | 30331 s |
...
| 🧮 OpenAI budget | `279/250 (109.6%); policy=telemetry_only` |
| ♻️ Provider debt | `518` |
| 🌍 Recent provider mix | OpenAI model pool(263), TM/simple(138), Free Google Translate(111), canonical_name_semantic_autofix(22), te... |
...
| ❤️ Pool health | `degraded` (writes=537, fallbacks=21) |
...
| `NO_WRITE` | OK | OK | `268` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 30331}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 41s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 23:45:43
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 4min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T23:41:35.374608Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T23:45:07.313771Z |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T22:45:43.887459Z → 2026-04-29T23:45:43.887459Z) |
...
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T23:43:45.799627Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T23:43:45.799627Z
- **Top 5 typów problemów:** suspicious_rejected_critical=167, suspicious_log_low=104, suspicious_log_high=95, suspicious_rejected_high=33, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=756340), ro(60.1, issues=450701), ru(60.1, issues=379290), cs(60.1, issues=129450), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 756340 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 80%, 181096 problemów
⚠️ **RU**: jakość 60%, 379290 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,880 |
| Heartbeat | 122s temu | 2026-04-29T23:43:46Z |
...
- 2026-04-29 23:45:11 | AUTO_TRANSLATE:auto_start | ro | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **154,116** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=0.84%, reason=increase_low_fail_rate=0.8%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 23:45:43
...
| 🔄 Cykli wykonanych | **#18,880** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,880 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 23:45:43  
