...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 16.57% / real 9.34%**. Tempo: **2340.0 kluczy/h**. Tłumaczeń netto: **89,304**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-29 15:15:58

> **Aktualizacja:** 2026-03-29 15:15:58 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #12,358 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: pl | Plik: npc.json | Heartbeat: 2026-03-29T15:15:49Z  
> **Okno godzinowe:** okno=1.0h | cykli=76 | pominięte=0.0% | odrzucone=30.3% | przepustowość=2340.0/h  
> **Tłumaczeń netto:** 89,304

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-29 15:15:58 |
| LIVE | 🟢 AKTYWNY | 11s temu | - | `activity.json / worker_state.json` | 2026-03-29T15:15:49Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 14s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-29 15:15:58 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-29T15:13:32.118910Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-29T15:13:56.739821Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-29 15:15:58 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 11s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-29T15:15:49Z
...
| ❤️ **Heartbeat** | 2026-03-29T15:15:49Z |
...
> **ETA globalne:** ~54 dni (3,039,797 kluczy do celu 95%)
...
> Świeżość: 14s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-29 15:15:58
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-29T15:13:32.118910Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 280 | 0 | 0 | - | 2026-03-29T15:14:18.599420Z |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-29T14:15:59.101937Z → 2026-03-29T15:15:59.101937Z) |
...
| Podejrzane tłumaczenia | **1657** |
| Najgorsze cele (strażnik) | ro/npc.json (gf=165), it/npc.json (gf=140), it/monsters.json (gf=114), fr/npc.json (gf=107), ro/items.json (gf=97) |
...
|--------|-----------|--------|----------------|
| `gt_validate_fail_placeholder` | 91 | 64.5% | pl/npc.json (56) |
| `gt_rejected_critical` | 38 | 27.0% | ro/items.json (14) |
| `gt_validate_fail_quality` | 11 | 7.8% | it/items.json (4) |
| `gt_validate_fail_word_salad` | 1 | 0.7% | pt/npc.json (1) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-29T15:13:56.739821Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-03-29T15:13:56.739821Z
- **Top 5 typów problemów:** suspicious_rejected_critical=182, suspicious_log_high=141, suspicious_log_medium=46, suspicious_rejected_high=18, suspicious_log_low=12
- **Języki o najsłabszej jakości:** cs(59.9, issues=33838), ro(60.1, issues=363420), pl(60.1, issues=347796), pt(62.2, issues=28493), it(64.8, issues=128889)
...
⚠️ **TR**: jakość 83%, 16380 problemów
⚠️ **PL**: jakość 60%, 347796 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 82%, 664779 problemów
⚠️ **PT**: jakość 62%, 28493 problemów
⚠️ **FR**: jakość 91%, 34834 problemów
⚠️ **IT**: jakość 65%, 128889 problemów
⚠️ **RU**: jakość 82%, 305973 problemów
⚠️ **NL**: jakość 66%, 22671 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #12,358 |
| Heartbeat | 11s temu | 2026-03-29T15:15:49Z |
...
- **Ostatnia aktualizacja:** 2026-03-29T15:13:48.284159Z
...
- 2026-03-29 15:15:49 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | npc.json
- 2026-03-29 15:14:19 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | npc.json
- 2026-03-29 15:14:19 | AUTO_TRANSLATE:auto_start | pl | ok | npc.json
- 2026-03-29 15:13:48 | AUTO_TRANSLATE:heartbeat_tick | es | ok | otclient_modules.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **89,304** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=15.89%, reason=stable_fail_rate=15.9%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-29 15:15:58

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [tr] → warn (files+1, translated+1, skipped+0) — lang=tr file=raids.json strict_skipped_done=112
...
| 🔄 Cykli wykonanych | **#12,358** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #12,358 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-29 15:15:58  
