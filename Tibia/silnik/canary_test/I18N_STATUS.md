...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.01% / real 10.93%**. Tempo: **877.0 kluczy/h**. Tłumaczeń netto: **145,191**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 08:46:18

> **Aktualizacja:** 2026-04-29 08:46:18 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,076 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-04-29T08:43:02Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=4.7% | przepustowość=877.0/h  
> **Tłumaczeń netto:** 145,191

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 08:46:18 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-04-29T08:43:02Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 08:46:18 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T08:44:27.105858Z |
| QUALITY | 🔒 NIEAKTYWNY | 3min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T08:42:29.617899Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 08:46:18 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T08:46:25.969242Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T08:43:02Z
...
| ❤️ **Heartbeat** | 2026-04-29T08:43:02Z |
...
| ⏳ Oldest pending (visible tail) | 14917 s |
...
| 🌍 Recent provider mix | TM/simple(301), Free Google Translate(193), canonical_name_semantic_autofix(16), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=513, fallbacks=23) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=842/842 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 386, 'oldest_s': 14917}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~142 dni (2,984,151 kluczy do celu 95%)
...
| RU | █████████░░░░░░░░░░░ | 46.0% | 34,308/74,536 | ~42h |
| FR | ███████████░░░░░░░░░ | 57.5% | 42,864/74,536 | ~32h |
| PT | ████████████████░░░░ | 81.2% | 60,516/74,536 | ~12h |
| CS | ██████████░░░░░░░░░░ | 50.7% | 37,757/74,536 | ~38h |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 08:46:18
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T08:44:27.105858Z
...
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14395.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14396.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14397.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14398.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14399.name)
- wall fountain → nástěnná fontána (item.1440.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14400.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14401.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14402.name)
...
- Raporty strażnika jakości: **4867**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4720**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T08:43:01.439631Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.01%** (697,917/3,875,872)
- **Pokrycie globalne (real):** **10.93%** (423,531/3,875,872)
- **Kopie EN (łącznie):** **410,473**
- **Placeholdery [EN]/puste (łącznie):** **2,187,746**
...
| 🕒 Evidence window | 24h (span=37.90h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=37.90h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T07:46:18.675284Z → 2026-04-29T08:46:18.675284Z) |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 89 | 85.6% | ru/items.json (89) |
| `retry_loop_cooldown_default` | 8 | 7.7% | ro/items.json (4) |
| `existing_canonical_name_quality_mixed_scripts` | 7 | 6.7% | ru/items.json (7) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 3min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T08:42:29.617899Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T08:42:29.617899Z
- **Top 5 typów problemów:** suspicious_rejected_critical=188, suspicious_log_high=79, suspicious_log_low=72, suspicious_log_medium=49, suspicious_rejected_high=12
- **Języki o najsłabszej jakości:** es(60.1, issues=741156), ro(60.1, issues=437772), de(60.1, issues=120573), cs(60.1, issues=103830), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 62%, 55979 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 741156 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 74%, 175655 problemów
⚠️ **RU**: jakość 70%, 367941 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,076 |
| Heartbeat | 203s temu | 2026-04-29T08:43:02Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T08:44:42.040309Z
...
- 2026-04-29 08:46:13 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 08:44:42 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 08:44:27 | AUTO_TRANSLATE:auto_done | cs | ok | items.json
- 2026-04-29 08:43:02 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | items.json
- 2026-04-29 08:43:01 | AUTO_TRANSLATE:auto_start | cs | ok | items.json
- 2026-04-29 08:42:28 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 08:46:18

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [cs] → warn (files+1, translated+41, skipped+0) — lang=cs file=items.json strict_skipped_done=4061 guard_fail=8 placeholder=0 command=0 pipe=0
...
| ❌ Błędów | 318 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,421), **RU** (1,321), **IT** (1,152), **TR** (1,071), **DE** (1,035) |
| 📊 Porównanie | ↓ 7.7% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **26,573** kluczy
...
| 🔄 Cykli wykonanych | **#18,076** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,076 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 08:46:18  
