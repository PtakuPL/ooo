...
local function greetCallback(npc, creature, message)
	...
	if player:getStorageValue(HiddenThreats.CorymRescued01) < 0 then
		npcHandler:setLocalizedMessage(MESSAGE_GREET, "npc.corym_worker_01.greet_msg_2")
		...
		NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_GREET, "npc.corym_worker_01.greet_msg_1")
	end
	return true
end
...
-- Greeting message
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_FAREWELL, "npc.corym_worker_01.farewell_msg_1")
