...
> Worker tłumaczy **53** języków. Klucze EN: **4,466**. Pokrycie globalne: **nominal 4.82% / real 4.76%**. Tempo: **262.0 kluczy/h**. Tłumaczeń netto: **172,794**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-06-07 19:08:22

> **Aktualizacja:** 2026-06-07 19:08:22 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 4466
> **Publikacja:** git-enabled
> **LIVE:** Cykl #21,203 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: cs | Plik: website_i18n.json | Heartbeat: 2026-06-07T19:03:34Z
> **Okno godzinowe:** okno=1.0h | cykli=354 | pominięte=0.0% | odrzucone=5.6% | przepustowość=262.0/h  
> **Tłumaczeń netto:** 172,794

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-06-07 19:08:22 |
| LIVE | 🟢 AKTYWNY | 4min temu | - | `activity.json / worker_state.json` | 2026-06-07T19:03:34Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 5min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-06-07 19:08:22 |
| TRANSLATION | 🟢 AKTYWNY | 8s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-06-07T19:08:16.153239Z |
| QUALITY | 🔒 NIEAKTYWNY | 7s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-06-07T19:08:17.402528Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-06-07 19:08:22 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-06-07T19:08:24.813254Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 4min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-06-07T19:03:34Z
...
| 🔄 **Ostatni cykl** | 1 kluczy, 0 odrzuconych, 43.5s, tryb: AUTO_TRANSLATE, cel: cs/website_i18n.json |
| ❤️ **Heartbeat** | 2026-06-07T19:03:34Z |
...
| ⏳ Oldest pending (visible tail) | 3153479 s |
...
| ♻️ Deferred stats | enqueued=5, cooldown=1, deduped=4, manual_review=0, partial_staged=0, partial_completed=0 |
...
| ♻️ Provider debt | `711` |
| 🌍 Recent provider mix | TM/simple(92), Free Google Translate(83), tm_dedup_file(68) |
| 🔁 Latest fallback | OpenAI model pool → fallback to google translate all models blocked [all_models_blocked] website_i18n.json |
| 📉 Fallback breakdown | fallback to google translate all models blocked(83), fallback to google translate high(1), fallback to goog... |
...
| ❤️ Pool health | `degraded` (writes=243, fallbacks=85) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=15/437 (3.43%), fail=422, Δchecks=-102, dir=improving |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 350, 'oldest_s': 3153479}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| TR | 943 | 4,466 | 21.12% | 45 |
| IT | 896 | 4,466 | 20.06% | 67 |
...
> **ETA globalne:** ~33 dni (209,393 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| PL | ███████████░░░░░░░░░ | 59.6% | 2,664/4,466 | ~6h |
| RU | ████░░░░░░░░░░░░░░░░ | 24.9% | 1,112/4,466 | ~12h |
| ES | ████░░░░░░░░░░░░░░░░ | 21.8% | 973/4,466 | ~12h |
| TR | ████░░░░░░░░░░░░░░░░ | 21.1% | 943/4,466 | ~13h |
| IT | ████░░░░░░░░░░░░░░░░ | 20.1% | 896/4,466 | ~13h |
| FR | ███░░░░░░░░░░░░░░░░░ | 19.6% | 877/4,466 | ~13h |
| RO | ███░░░░░░░░░░░░░░░░░ | 18.0% | 803/4,466 | ~13h |
| PT | ███░░░░░░░░░░░░░░░░░ | 17.1% | 762/4,466 | ~13h |
| NL | ███░░░░░░░░░░░░░░░░░ | 16.2% | 722/4,466 | ~13h |
| CS | ███░░░░░░░░░░░░░░░░░ | 15.6% | 698/4,466 | ~14h |
| DE | ██░░░░░░░░░░░░░░░░░░ | 14.7% | 658/4,466 | ~14h |
| ZH_TW | ░░░░░░░░░░░░░░░░░░░░ | 0.2% | 7/4,466 | ~16h |
| AR | ░░░░░░░░░░░░░░░░░░░░ | 0.1% | 4/4,466 | ~16h |
| BN | ░░░░░░░░░░░░░░░░░░░░ | 0.1% | 4/4,466 | ~16h |
| FA | ░░░░░░░░░░░░░░░░░░░░ | 0.1% | 4/4,466 | ~16h |
| HE | ░░░░░░░░░░░░░░░░░░░░ | 0.1% | 4/4,466 | ~16h |
...
> Tempo obliczone na bazie ostatniej godziny: ~262 kluczy/h.
...
> Świeżość: 5min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-06-07 19:08:22
...
| 🔍 **Przeskanowane (historia)** | **6,544** | **62.5%** | `i18n_processed_files.txt` |
| 🧭 Przeskanowane (LIVE) | **117** | **1.1%** | `i18n_file_status.json` |
| ⏳ Nie przeskanowane (historia) | **3,934** | 37.5% | wg historii workera |
| ⏳ Nie przeskanowane (LIVE) | **10,361** | 98.9% | wg rejestru LIVE |
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 8s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-06-07T19:08:16.153239Z
...
| TR (Turecki) | 21.12% (943/4,466) | 21.03% (939/4,466) | 45 | 3,482 | 0 |
| IT (Włoski) | 20.06% (896/4,466) | 19.95% (891/4,466) | 67 | 3,508 | 0 |
...
- Raporty strażnika jakości: **5588**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **5291**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 33 | 0 | 0 | - | 2026-06-07T19:07:32.682622Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **4.82%** (11,191/232,232)
- **Pokrycie globalne (real):** **4.76%** (11,046/232,232)
- **Kopie EN (łącznie):** **6,028**
- **Placeholdery [EN]/puste (łącznie):** **95,775**
...
|--------|-------|---------------------|--------------------|------------------------------|--------------------------------------------|
| RedAxe/MyAAC strona WWW | `website` | 3/3 | 4,466 | 3,768 | 15.6% / 15.4% |
| Tibia WWW/Wiki publiczne | `www_tibia` | 3/14 | 4,466 | 3,768 | 15.6% / 15.4% |
...
| 🕒 Evidence window | 24h (span=337.59h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=337.59h; client.json: id=-31.40pp, ws=+0, otclient_modules.json: id=-29.79pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-06-07T18:08:22.099381Z → 2026-06-07T19:08:22.099381Z) |
| Cykle | **354** (TŁUMACZENIE=242, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **5.6%** |
| Cykle bez postępu % | **19.7%** |
| Przepustowość (kluczy/h) | **262.0 kluczy/h** |
| Podejrzane tłumaczenia | **478** |
| Najgorsze cele (strażnik) | ru/html.json (gf=16), ro/html.json (gf=6), nl/website_i18n.json (gf=0), tr/website_i18n.json (gf=0), it/html.json (gf=0) |
...
|--------|-----------|--------|----------------|
| `retry_loop_cooldown_default` | 24 | 57.1% | it/website_i18n.json (7) |
| `gt_identity_retry_identical_to_en` | 15 | 35.7% | cs/website_i18n.json (4) |
| `gt_structure_retry_placeholder` | 3 | 7.1% | ro/html.json (3) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 7s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-06-07T19:08:17.402528Z

- **Ostatni audyt:** OK | 9 issue(s) / 100 entries | 2026-06-07T19:08:17.402528Z
- **Top 5 typów problemów:** suspicious_rejected_high=104, suspicious_log_critical=97, suspicious_rejected_critical=96, suspicious_log_warning=84, identical_to_en_exempt=41
- **Języki o najsłabszej jakości:** ru(60.1, issues=430796), it(60.1, issues=191295), de(60.1, issues=164317), cs(60.1, issues=163143), nl(60.1, issues=79912)
...
⚠️ **TR**: jakość 72%, 68850 problemów
⚠️ **PL**: jakość 76%, 397846 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 82%, 782856 problemów
⚠️ **PT**: jakość 60%, 64033 problemów
⚠️ **FR**: jakość 61%, 69494 problemów
⚠️ **IT**: jakość 60%, 191295 problemów
⚠️ **RU**: jakość 60%, 430796 problemów
⚠️ **NL**: jakość 60%, 79912 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #21,203 |
| Heartbeat | 290s temu | 2026-06-07T19:03:34Z |
...
- 2026-06-07 19:08:16 | AUTO_TRANSLATE:auto_done | cs | ok | website_i18n.json
- 2026-06-07 19:07:34 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | website_i18n.json
- 2026-06-07 19:07:34 | AUTO_TRANSLATE:auto_start | cs | ok | website_i18n.json
- 2026-06-07 19:07:21 | AUTO_TRANSLATE:auto_done | nl | ok | website_i18n.json
- 2026-06-07 19:06:41 | AUTO_TRANSLATE:heartbeat_tick | nl | ok | website_i18n.json
- 2026-06-07 19:06:41 | AUTO_TRANSLATE:auto_start | nl | ok | website_i18n.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 59.6% | 0 | 54 | 0 | 0 (0.0%) | 11 |
| 🔴 ES | 21.8% | 0 | 29 | 0 | 0 (0.0%) | 12 |
...
| Przepustowość (okno) | 0 kluczy / 23 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-06-07 19:08:22

- 🤖 AUTO_TRANSLATE: WEBSITE_I18N_APPLY [cs] → ok — keys_updated=139 files_changed=1
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [cs] → warn (files+1, translated+1, skipped+0) — lang=cs file=website_i18n.json strict_skipped_done=10
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [nl] → warn (files+0, translated+0, skipped+0) — lang=nl file=html.json strict_skipped_done=120
- 🌍 TRANSLATION_SYNC: SYNC_FILE_DONE [ru] → ok (keys+64, files+1) — lang=ru file=html.json
...
- 🤖 AUTO_TRANSLATE: WEBSITE_I18N_APPLY [es] → ok — keys_updated=164 files_changed=1
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+9, skipped+0) — lang=es file=website_i18n.json strict_skipped_done=2
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [cs] → warn (files+1, translated+3, skipped+0) — lang=cs file=items.json strict_skipped_done=5384
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **1,882** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 97 |
| ❌ Błędów | 503 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **TR** (226), **FR** (220), **ES** (209), **IT** (206), **PT** (196) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **1,882** kluczy
...
|---------|---------|-----------|
| 📁 Plików przeskanowanych (LIVE registry) | **117** | z `i18n_file_status.json` |
| 📚 Plików przeskanowanych (historia) | **6,544** | z `i18n_processed_files.txt` |
| ↕️ Historia minus LIVE | **+6,427** | dodatnie = historia > LIVE |
| ✅ Plików z kluczami | **51** | zawierały hardcoded strings |
| ⬜ Plików bez kluczy | **66** | czyste (brak hardcoded) |
...
| 🔄 Cykli wykonanych | **#21,203** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #21,203 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-06-07 19:08:22  
...
- ✅ `MigrateToCommand.php` - ukończono 2026-06-07 21:02
