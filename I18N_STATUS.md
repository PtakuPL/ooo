...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.05% / real 10.98%**. Tempo: **548.0 kluczy/h**. Tłumaczeń netto: **148,785**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 14:14:19

> **Aktualizacja:** 2026-04-29 14:14:19 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,517 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ro | Plik: items.json | Heartbeat: 2026-04-29T14:12:40Z
> **Okno godzinowe:** okno=1.0h | cykli=65 | pominięte=0.0% | odrzucone=5.8% | przepustowość=548.0/h  
> **Tłumaczeń netto:** 148,785

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 14:14:19 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T14:12:40Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 14:14:19 |
| TRANSLATION | 🟢 AKTYWNY | 3min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T14:10:35.530795Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T14:12:39.162767Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 14:14:19 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T14:14:26.592737Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T14:12:40Z
...
| 🔄 **Ostatni cykl** | 44 kluczy, 9 odrzuconych, 91.0s, tryb: AUTO_TRANSLATE, cel: cs/items.json |
| ❤️ **Heartbeat** | 2026-04-29T14:12:40Z |
...
| ⏳ Oldest pending (visible tail) | 17120 s |
...
| 🧮 OpenAI budget | `5/250 (2.0%)` |
| ♻️ Provider debt | `1248` |
| 🌍 Recent provider mix | TM/simple(354), Free Google Translate(146), canonical_name_semantic_autofix(19), OpenAI model pool(8), term... |
| 🔁 Latest fallback | TM/simple → fallback to google translate high [high_reject_types] items.json |
| 📉 Fallback breakdown | fallback to google translate high(17), fallback to next provider validate fail(5), fallback chain exhausted... |
...
| ❤️ Pool health | `critical` (writes=530, fallbacks=27) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=1092/1092 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 17120}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| �📊 Przetłumaczono | **548** kluczy |
| ❌ Odrzucone (guard) | 34 |
| 🔁 Cykli | 65 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | TR (133 kluczy) |
| 📄 Najczęstszy plik | items.json |
| ⚡ Przepustowość | ~548 kluczy/h |
...
> **ETA globalne:** ~227 dni (2,982,411 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 79.2% | 59,040/74,536 | ~21h |
| PL | ██████████████░░░░░░ | 71.0% | 52,911/74,536 | ~33h |
| IT | ██████████████░░░░░░ | 71.3% | 53,166/74,536 | ~32h |
| RO | █████████████░░░░░░░ | 69.7% | 51,973/74,536 | ~34h |
...
> Tempo obliczone na bazie ostatniej godziny: ~548 kluczy/h.
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 14:14:19
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T14:10:35.530795Z
...
- tiled roof → acoperiș cu țiglă (item.1164.name)
...
- This lamp is glowing very dimly. → Această lampăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă luminează (item.13656.desc)
- This lamp is glowing very dimly. → Această lampăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă luminează (item.13658.desc)
- This is an emblem of wisdom. It was awarded by TibiaStat.com → Aceasta este o emblemăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă  (item.14760.desc)
- golden rune emblem → emblemăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă de rună de aur (item.11640.name)
- lamp → lampă (item.10507.name)
- ramp → rampă (item.11365.name)
- silver rune emblem → emblemăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăăă de rună de argint (item.11641.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4977**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4830**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T14:13:07.161255Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.05%** (699,657/3,875,872)
- **Pokrycie globalne (real):** **10.98%** (425,404/3,875,872)
- **Kopie EN (łącznie):** **410,340**
- **Placeholdery [EN]/puste (łącznie):** **2,186,006**
...
| 🕒 Evidence window | 24h (span=43.37h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=43.37h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T13:14:20.214645Z → 2026-04-29T14:14:20.214645Z) |
...
| Przepustowość (kluczy/h) | **548.0 kluczy/h** |
| Podejrzane tłumaczenia | **1058** |
| Najgorsze cele (strażnik) | cs/items.json (gf=18), ro/items.json (gf=8), ru/items.json (gf=3), de/otclient_modules.json (gf=2), de/npc.json (gf=2) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T14:12:39.162767Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T14:12:39.162767Z
- **Top 5 typów problemów:** suspicious_rejected_critical=189, suspicious_log_high=108, suspicious_log_low=90, suspicious_rejected_high=11, suspicious_log_critical=1
- **Języki o najsłabszej jakości:** es(60.1, issues=749910), ro(60.1, issues=444335), de(60.1, issues=126856), cs(60.1, issues=118502), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 749910 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 75%, 178882 problemów
⚠️ **RU**: jakość 66%, 373896 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,517 |
| Heartbeat | 106s temu | 2026-04-29T14:12:40Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T14:10:51.484875Z
...
- 2026-04-29 14:13:08 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-04-29 14:13:07 | AUTO_TRANSLATE:auto_start | ro | ok | items.json
- 2026-04-29 14:12:22 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-29 14:10:52 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-29 14:10:35 | AUTO_TRANSLATE:auto_done | cs | ok | items.json
- 2026-04-29 14:09:04 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | items.json
...
| 🟡 ES | 79.2% | 0 | 9,580 | 539 | 0 (0.0%) | 25 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **148,785** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=7.83%, reason=stable_fail_rate=7.8%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 14:14:19
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+143, skipped+0) — lang=it file=items.json strict_skipped_done=2547 guard_fail=1 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+2) — repair_identical lang=es file=server.json target_identical=9 limit=180 tier=low_backlog domain_cap=240 gt=true suspicious_pct=662.34
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+19, skipped+0) — lang=es file=items.json strict_skipped_done=211
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **11,509** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 216 |
| ❌ Błędów | 510 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,979), **RU** (1,840), **TR** (1,803), **DE** (1,665), **IT** (1,633) |
| 📊 Porównanie | ↑ 39.9% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **30,489** kluczy
...
| 🔄 Cykli wykonanych | **#18,517** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,517 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 14:14:19  
