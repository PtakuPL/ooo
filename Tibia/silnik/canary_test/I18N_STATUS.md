...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.86% / real 10.77%**. Tempo: **866.0 kluczy/h**. Tłumaczeń netto: **135,518**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-28 20:37:22

> **Aktualizacja:** 2026-04-28 20:37:22 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,063 | Status: ✅ BEZCZYNNY | Faza: IDLE | Etap: cycle_start | Kategoria: ru | Plik: items.json | Heartbeat: 2026-04-28T20:36:58Z
> **Okno godzinowe:** okno=1.0h | cykli=91 | pominięte=0.0% | odrzucone=3.1% | przepustowość=866.0/h  
> **Tłumaczeń netto:** 135,518

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-28 20:37:22 |
| LIVE | 🟢 AKTYWNY | 29s temu | - | `activity.json / worker_state.json` | 2026-04-28T20:36:58Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 23s temu | worker w trybie IDLE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-28 20:37:22 |
| TRANSLATION | 🔒 NIEAKTYWNY | 2min temu | worker w trybie IDLE | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-28T20:35:06.790258Z |
| QUALITY | 🔒 NIEAKTYWNY | 29s temu | worker w trybie IDLE | `quality_audit_latest.json` | 2026-04-28T20:36:58.030677Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-28 20:37:22 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-28T20:37:27.172603Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 29s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-28T20:36:58Z
...
| 🔄 **Ostatni cykl** | 73 kluczy, 0 odrzuconych, 200.7s, tryb: AUTO_TRANSLATE, cel: ru/items.json |
| ❤️ **Heartbeat** | 2026-04-28T20:36:58Z |
...
| ⏳ Oldest pending (visible tail) | 19612 s |
...
| 🌍 Recent provider mix | TM/simple(240), Free Google Translate(239), OpenAI model pool(20), canonical_name_semantic_autofix(12), ter... |
...
| ❤️ Pool health | `critical` (writes=514, fallbacks=29) |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 387, 'oldest_s': 19612}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 23s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-28 20:37:22
...
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-28T20:35:06.790258Z
...
- Raporty strażnika jakości: **4612**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4465**
...
- **Profiler cyklu (ostatni):** cykl #55 (AUTO_TRANSLATE): dispatch 1142ms, mode 187134ms, status 10837ms, total 200730ms
...
| 🕒 Evidence window | 24h (span=25.75h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=25.75h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-28T19:37:22.318369Z → 2026-04-28T20:37:22.318369Z) |
...
| Przepustowość (kluczy/h) | **866.0 kluczy/h** |
| Podejrzane tłumaczenia | **1094** |
| Najgorsze cele (strażnik) | ro/items.json (gf=12), cs/items.json (gf=8), de/otclient_modules.json (gf=3), de/npc.json (gf=3), it/items.json (gf=2) |
...
> Świeżość: 29s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-28T20:36:58.030677Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-28T20:36:58.030677Z
- **Top 5 typów problemów:** suspicious_rejected_critical=189, suspicious_log_low=89, suspicious_log_high=76, suspicious_log_medium=32, suspicious_rejected_high=11
- **Języki o najsłabszej jakości:** es(60.1, issues=720907), ro(60.1, issues=420220), de(60.1, issues=103434), cs(60.1, issues=77587), nl(60.1, issues=71044)
...
⚠️ **TR**: jakość 67%, 52040 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 720907 problemów
⚠️ **PT**: jakość 60%, 56726 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 81%, 166282 problemów
⚠️ **RU**: jakość 74%, 353938 problemów
⚠️ **NL**: jakość 60%, 71044 problemów
...
|-----------|--------|-----------|
| Worker | ✅ BEZCZYNNY | Cykl #17,063 |
| Heartbeat | 29s temu | 2026-04-28T20:36:58Z |
...
- 2026-04-28 20:35:22 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-28 20:37:22
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **5,308** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 55 |
| ❌ Błędów | 209 |
| 🌍 Aktywnych języków | 9 |
| 🏆 TOP 5 | **DE** (945), **RU** (753), **IT** (636), **PT** (594), **TR** (577) |
| 📊 Porównanie | ↑ 2.3% vs wczoraj (5,188) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **28,168** kluczy
...
| 🔄 Cykli wykonanych | **#17,063** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,063 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-28 20:37:22  
