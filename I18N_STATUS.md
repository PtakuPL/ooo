...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.16%**. Tempo: **1375.1 kluczy/h**. Tłumaczeń netto: **71,354**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-14 17:13:53

> **Aktualizacja:** 2026-02-14 17:13:53 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #8 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-02-14T17:13:18Z  
> **Okno godzinowe:** okno=1.0h | cykli=141 | pominięte=0.0% | odrzucone=60.9% | przepustowość=1375.1/h  
> **Tłumaczeń netto:** 71,354

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-14 17:13:53 |
| LIVE | 🟢 AKTYWNY | 36s temu | - | `activity.json / worker_state.json` | 2026-02-14T17:13:18Z |
| MIGRATION | 🔒 NIEAKTYWNY | 22s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-14 17:13:53 |
| TRANSLATION | 🟢 AKTYWNY | 6s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-14T17:13:47.598857Z |
| QUALITY | 🔒 NIEAKTYWNY | 53s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-14T17:13:00.562402Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-14 17:13:53 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 36s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-14T17:13:18Z
...
| ❤️ **Heartbeat** | 2026-02-14T17:13:18Z |
...
| ❌ Odrzucone (guard) | 3547 |
| 🔁 Cykli | 141 |
| 🌍 Języków | 2 |
| 🏆 Najaktywniejszy | PL (1,322 kluczy) |
...
|-------|---------------|-----------|----------|----------|
| ES | 40,287 | 53,586 | 75.18% | 2,757 |
| PL | 24,701 | 53,586 | 46.1% | 2,062 |
...
> **ETA globalne:** ~72 dni (2,364,019 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 75.2% | 40,287/53,586 | ~8h |
| PL | █████████░░░░░░░░░░░ | 46.1% | 24,701/53,586 | ~19h |
| RU | ██████░░░░░░░░░░░░░░ | 33.7% | 18,071/53,586 | ~24h |
...
> Świeżość: 22s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-14 17:13:53
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-14T17:13:47.598857Z
...
|-------|----------------|-------------------------------|---------|--------------|
| ES (Hiszpański) | 40,287/53,586 | 75.18% | 2,757 | 0 |
| PL (Polski) | 24,701/53,586 | 46.10% | 2,062 | 0 |
...
- <wiggles> → <wiggles> (npc.noodles.voice_2)
- <sniff> → <sniff> (npc.noodles.voice_3)
...
- <groan> → <groan> (npc.omrabas.voice_3)
...
- <mumbles> → <mumbles> (npc.robson.voice_1)
...
- I see. → I see. (npc.the_orc_king.say_8)
- I see. → I see. (npc.wyda.say_8)
- I see. → I see. (npc.yaman.say_14)
- See you, |PLAYERNAME|. → Nos vemos, |PLAYERNAME|. (npc.alexander.farewell_msg_1)
- See you, |PLAYERNAME|. → Nos vemos, |PLAYERNAME|. (npc.alexander.walkaway_msg_1)
- No problem. → Ningún problema. (npc.alia.stdmod_10)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **2238**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2171**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **10.16%** (283,093/2,786,472)
...
|-------|--------|----------|----------|------------|
| ES | 37,703/49,731 | 75.8% | 2,584/3,855 | 67.0% |
| PL | 22,016/49,731 | 44.3% | 2,685/3,855 | 69.7% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-14T16:13:54.015023Z → 2026-02-14T17:13:54.015023Z) |
...
| Cykle bez postępu % | **14.9%** |
| Przepustowość (kluczy/h) | **1375.1 kluczy/h** |
| Podejrzane tłumaczenia | **4454** |
| Najgorsze cele (strażnik) | pl/items.json (gf=2133), pl/server.json (gf=218), pl/npc.json (gf=167), pl/quests.json (gf=129), pl/scripts.json (gf=96) |
...
> Świeżość: 53s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-14T17:13:00.562402Z

- **Ostatni audyt:** SLOW_MODE | 33 issue(s) / 100 entries | 2026-02-14T17:13:00.562402Z
- **Top 5 typów problemów:** suspicious_rejected_critical=200, suspicious_log_high=104, suspicious_log_critical=96, identical_to_en_exempt=48, artifact_token=22
- **Języki o najsłabszej jakości:** es(60.1, issues=166311), pl(60.1, issues=120479), tl(64.2, issues=466), zh_TW(64.8, issues=337), fr(66.5, issues=2470)
...
⚠️ **PL**: jakość 60%, 120479 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 166311 problemów
...
| Heartbeat | 36s temu | 2026-02-14T17:13:18Z |
...
- 2026-02-14 17:13:18 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-14 17:13:17 | AUTO_TRANSLATE:parallel_start | es | ok | npc.json
- 2026-02-14 17:13:17 | AUTO_TRANSLATE:auto_done | pl | ok | npc.json
- 2026-02-14 17:13:11 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | npc.json
- 2026-02-14 17:13:11 | AUTO_TRANSLATE:auto_start | pl | ok | npc.json
- 2026-02-14 17:12:52 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 46.1% | 0 | 2,062 | 3,984 | 4759 (54.4%) | 96 |
| 🟡 ES | 75.2% | 0 | 2,757 | 2,860 | 1161 (28.9%) | 81 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **71,354** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=84.68%, reason=decrease_high_fail_rate=84.7% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 6,844 kluczy / 177 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-14 17:13:53

- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+57, skipped+0) — parallel lang=es file=npc.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+80, skipped+0) — lang=pl file=npc.json strict_skipped_done=2126 guard_fail=167 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+24) — repair_identical lang=es file=npc.json target_identical=24 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=272.92
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **39,834** kluczy |
| ⏭️ Pominięte | 1 |
| 🔁 Cykli | 49 |
| ❌ Błędów | 510 |
| 🌍 Aktywnych języków | 52 |
| 🏆 TOP 5 | **ES** (11,525), **PL** (5,146), **IT** (971), **PT** (960), **DE** (890) |
| 📊 Porównanie | ↓ 13.5% vs wczoraj (46,073) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **87,256** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-14 17:13:53  
