...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.6%**. Tempo: **1882.2 kluczy/h**. Tłumaczeń netto: **97,395**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-17 04:59:05

> **Aktualizacja:** 2026-02-17 04:59:05 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #258 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ro | Plik: - | Heartbeat: 2026-02-17T04:59:02Z  
> **Okno godzinowe:** okno=1.0h | cykli=153 | pominięte=0.0% | odrzucone=46.2% | przepustowość=1882.2/h  
> **Tłumaczeń netto:** 97,395

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-17 04:59:05 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-17T04:59:02Z |
| MIGRATION | 🔒 NIEAKTYWNY | 21s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-17 04:59:05 |
| TRANSLATION | 🟢 AKTYWNY | 17s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-17T04:58:49.303293Z |
| QUALITY | 🔒 NIEAKTYWNY | 5s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-17T04:59:01.917664Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-17 04:59:05 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-17T04:59:02Z
...
| ❤️ **Heartbeat** | 2026-02-17T04:59:02Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **3,466** kluczy |
| ❌ Odrzucone (guard) | 2975 |
| 🔁 Cykli | 153 |
| 🌍 Języków | 7 |
...
> **ETA globalne:** ~52 dni (2,351,858 kluczy do celu 95%)
...
> Świeżość: 21s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-17 04:59:05
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 17s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-17T04:58:49.303293Z
...
- Raporty strażnika jakości: **3020**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2953**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **10.6%** (295,254/2,786,472)
- **Kopie EN (łącznie):** **166,176**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-17T03:59:05.638490Z → 2026-02-17T04:59:05.638490Z) |
...
| Przepustowość (kluczy/h) | **1882.2 kluczy/h** |
| Podejrzane tłumaczenia | **9787** |
...
> Świeżość: 5s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-17T04:59:01.917664Z

- **Ostatni audyt:** SLOW_MODE | 37 issue(s) / 100 entries | 2026-02-17T04:59:01.917664Z
- **Top 5 typów problemów:** suspicious_rejected_critical=166, suspicious_log_high=114, suspicious_log_low=72, suspicious_rejected_high=34, identical_to_en=32
- **Języki o najsłabszej jakości:** es(60.1, issues=200484), ro(60.2, issues=41512), ru(60.2, issues=32239), it(60.4, issues=12309), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 68%, 127453 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 200484 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 12309 problemów
⚠️ **RU**: jakość 60%, 32239 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 95%, 10113 problemów
...
| Heartbeat | 5s temu | 2026-02-17T04:59:02Z |
...
- 2026-02-17 04:58:55 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-17 04:58:35 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | questlog.json
- 2026-02-17 04:58:34 | AUTO_TRANSLATE:parallel_start | ru | ok | questlog.json
- 2026-02-17 04:58:30 | AUTO_TRANSLATE:heartbeat_tick | it | ok | raids.json
- 2026-02-17 04:58:30 | AUTO_TRANSLATE:parallel_start | it | ok | raids.json
- 2026-02-17 04:58:28 | AUTO_TRANSLATE:auto_done | ro | ok | raids.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **97,395** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=29.45%, reason=decrease_high_fail_rate=29.4% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-17 04:59:05
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **20,447** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 197 |
| ❌ Błędów | 338 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (4,141), **IT** (3,752), **RU** (3,611), **RO** (3,308), **PL** (2,843) |
| 📊 Porównanie | ↑ 0.8% vs wczoraj (20,288) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **120,641** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-17 04:59:05  
