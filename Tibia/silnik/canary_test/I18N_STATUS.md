...
> Worker tłumaczy **53** języków. Klucze EN: **4,466**. Pokrycie globalne: **nominal 4.8% / real 4.73%**. Tempo: **276.1 kluczy/h**. Tłumaczeń netto: **172,687**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-06-07 18:56:16

> **Aktualizacja:** 2026-06-07 18:56:16 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 4466
> **Publikacja:** git-enabled
> **LIVE:** Cykl #21,147 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: pt | Plik: website_i18n.json | Heartbeat: 2026-06-07T18:53:46Z
> **Okno godzinowe:** okno=1.0h | cykli=365 | pominięte=0.0% | odrzucone=8.4% | przepustowość=276.1/h  
> **Tłumaczeń netto:** 172,687

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-06-07 18:56:16 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-06-07T18:53:46Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 3min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-06-07 18:56:16 |
| TRANSLATION | 🟢 AKTYWNY | 42s temu | ostatnie zapisy są historyczne | `translation_guard_latest.json / translation_recent_latest.json` | 2026-06-07T18:55:37.478222Z |
| QUALITY | 🔒 NIEAKTYWNY | 42s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-06-07T18:55:38.290436Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-06-07 18:56:16 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-06-07T18:56:20.331387Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-06-07T18:53:46Z
...
| 🔄 **Ostatni cykl** | 2 kluczy, 0 odrzuconych, 40.0s, tryb: AUTO_TRANSLATE, cel: de/website_i18n.json |
| ❤️ **Heartbeat** | 2026-06-07T18:53:46Z |
...
| 18:53:31 | IT | WWW | website_i18n.json | 1 | `google_translate` | `account.email_request.notice_prefix` | È stata inviata una richiesta per modificare l'indirizzo email di questo account in |
| 18:51:02 | TR | WWW | html.json | 10 | `tm` | `web.tpl.guilds.list.set_2` | _sbutton_foundguild |
| 18:50:22 | CS | WWW | html.json | 10 | `tm` | `web.tpl.guilds.list.set_2` | _sbutton_foundguild |
| 18:49:33 | IT | WWW | html.json | 10 | `tm` | `web.tpl.guilds.list.set_2` | _sbutton_foundguild |
...
| 18:34:49 | IT | WWW | html.json | 10 | `tm` | `web.tpl.guilds.list.set_2` | _sbutton_foundguild |
...
> Uwaga: Recent Writes pokazuje tylko próbki nadal zgodne z fizycznymi plikami JSON; pominięto 10 historycznych próbek (physical_marker=10).
...
| 📨 Pending queue (visible tail) | 364 z ostatnich 400 poprawnych wpisów JSONL |
| ⏳ Oldest pending (visible tail) | 3154109 s |
| 🌍 Top języki | RU(258), DE(25), PL(15), FR(13) |
| 🧱 Top reason_bucket | quality(207), default(147), placeholder(4), command(2) |
| 🗂️ Deferred state keys | 9833 |
| 🕒 Deferred state freshness | fresh (43s) |
| ♻️ Deferred stats | enqueued=0, cooldown=7, deduped=8, manual_review=0, partial_staged=0, partial_completed=0 |
...
| ❓ OpenAI/GPT teraz | pool_reason=all_models_blocked; models_blocked=3 (next_unblock~55 min); tm_or_free_gt_currently_serving |
| 🧮 OpenAI budget | `15/250 (6.0%); policy=telemetry_only` |
| ♻️ Provider debt | `711` |
| 🌍 Recent provider mix | tm_dedup_file(83), Free Google Translate(68), TM/simple(49) |
| 🔁 Latest fallback | OpenAI model pool → fallback to google translate all models blocked [all_models_blocked] website_i18n.json |
| 📉 Fallback breakdown | fallback to google translate all models blocked(107), fallback to google translate high(1), fallback to goo... |
| ☁️ Cloud policy | `disabled` |
| 🤖 OpenAI pool | `degraded` |
| ⛔ OpenAI blocked models | `3` (next unblock: `55 min`) |
| 🩺 Health signals | recent_fallback, provider_consistency_debt:711 |
| ❤️ Pool health | `degraded` (writes=200, fallbacks=109) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=8/430 (1.86%), fail=422, Δchecks=-102, dir=improving |
...
|-------|--------|----------|-------|-----------|--------|
| `HEARTBEAT_STALE` | OK | OK | `6` | `300` | Heartbeat świeży (6s, src=worker_runtime_heartbeat) Runtime[status=healthy, reason=heartbeat_fresh, phase=A... |
| `NO_WRITE` | OK | OK | `46` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 364, 'oldest_s': 3154109}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| 🔔 Open alarms | 7 |
| 🆕 Newly opened (cycle) | - |
| ✅ Resolved (cycle) | WORKER_PROCESS_DUPLICATION_WARNING |
...
| �📊 Przetłumaczono | **391** kluczy |
| ❌ Odrzucone (guard) | 36 |
| 🔁 Cykli | 365 |
| 🌍 Języków | 9 |
| 🏆 Najaktywniejszy | TR (84 kluczy) |
| 📄 Najczęstszy plik | website_i18n.json |
| ⚡ Przepustowość | ~276 kluczy/h |
| 🛡️ Odrzucone (strażnik) | 8.4% |
| ⚠️ Podejrzane | 478 |
...
| TR | 938 | 4,466 | 21.0% | 30 |
| IT | 895 | 4,466 | 20.04% | 54 |
| FR | 871 | 4,466 | 19.5% ↑+0.06% | 67 |
| RO | 802 | 4,466 | 17.96% | 49 |
| PT | 749 | 4,466 | 16.77% →0% | 164 |
| NL | 701 | 4,466 | 15.7% | 187 |
| CS | 694 | 4,466 | 15.54% | 178 |
| DE | 656 | 4,466 | 14.69% ↑+0.05% | 215 |
...
> **ETA globalne:** ~32 dni (209,446 kluczy do celu 95%)
...
| TR | ████░░░░░░░░░░░░░░░░ | 21.0% | 938/4,466 | ~12h |
| IT | ████░░░░░░░░░░░░░░░░ | 20.0% | 895/4,466 | ~12h |
| FR | ███░░░░░░░░░░░░░░░░░ | 19.5% | 871/4,466 | ~12h |
| RO | ███░░░░░░░░░░░░░░░░░ | 18.0% | 802/4,466 | ~12h |
| PT | ███░░░░░░░░░░░░░░░░░ | 16.8% | 749/4,466 | ~13h |
| NL | ███░░░░░░░░░░░░░░░░░ | 15.7% | 701/4,466 | ~13h |
| CS | ███░░░░░░░░░░░░░░░░░ | 15.5% | 694/4,466 | ~13h |
| DE | ██░░░░░░░░░░░░░░░░░░ | 14.7% | 656/4,466 | ~13h |
...
> Tempo obliczone na bazie ostatniej godziny: ~276 kluczy/h.
...
> Świeżość: 3min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-06-07 18:56:16
...
| 🔍 **Przeskanowane (historia)** | **6,540** | **62.4%** | `i18n_processed_files.txt` |
| 🧭 Przeskanowane (LIVE) | **113** | **1.1%** | `i18n_file_status.json` |
| ⏳ Nie przeskanowane (historia) | **3,938** | 37.6% | wg historii workera |
| ⏳ Nie przeskanowane (LIVE) | **10,365** | 98.9% | wg rejestru LIVE |
...
> Świeżość: 42s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-06-07T18:55:37.478222Z
...
| TR (Turecki) | 21.00% (938/4,466) | 20.91% (934/4,466) | 30 | 3,502 | 0 |
| IT (Włoski) | 20.04% (895/4,466) | 19.93% (890/4,466) | 54 | 3,522 | 0 |
| FR (Francuski) | 19.50% (871/4,466) | 19.37% (865/4,466) | 67 | 3,534 | 0 |
...
| CS (Czeski) | 15.54% (694/4,466) | 15.36% (686/4,466) | 178 | 3,602 | 0 |
| DE (Niemiecki) | 14.69% (656/4,466) | 14.51% (648/4,466) | 215 | 3,603 | 0 |
...
- Raporty strażnika jakości: **5573**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **5276**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 33 | 0 | 0 | - | 2026-06-07T18:56:03.125064Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **4.8%** (11,138/232,232)
- **Pokrycie globalne (real):** **4.73%** (10,993/232,232)
- **Kopie EN (łącznie):** **5,975**
- **Placeholdery [EN]/puste (łącznie):** **95,881**
...
| TR | 0/0 | 0.0% / 0.0% | 938/4,466 | 21.0% / 20.9% |
| IT | 0/0 | 0.0% / 0.0% | 895/4,466 | 20.0% / 19.9% |
| FR | 0/0 | 0.0% / 0.0% | 871/4,466 | 19.5% / 19.4% |
| RO | 0/0 | 0.0% / 0.0% | 802/4,466 | 18.0% / 17.8% |
| PT | 0/0 | 0.0% / 0.0% | 749/4,466 | 16.8% / 16.6% |
| NL | 0/0 | 0.0% / 0.0% | 701/4,466 | 15.7% / 15.5% |
| CS | 0/0 | 0.0% / 0.0% | 694/4,466 | 15.5% / 15.4% |
| DE | 0/0 | 0.0% / 0.0% | 656/4,466 | 14.7% / 14.5% |
...
| OpenAI/GPT pool teraz | `degraded` (pool_reason=all_models_blocked; models_blocked=3 (next_unblock~55 min); tm_or_free_gt_current...) |
...
|--------|-------|---------------------|--------------------|------------------------------|--------------------------------------------|
| RedAxe/MyAAC strona WWW | `website` | 3/3 | 4,466 | 3,717 | 16.8% / 16.6% |
| Tibia WWW/Wiki publiczne | `www_tibia` | 3/14 | 4,466 | 3,717 | 16.8% / 16.6% |
...
| 🥉 Worst | Server 0.00% |
| ↕️ Spread | 4.83 pp |
| 📉 Largest regression 24h | Website (-0.41 pp) |
| 🕒 Window | 24h, samples=430 |

| Rank | Surface | Real coverage | Δ24h | Langs | Regression focus (lowest langs) |
|------|---------|---------------|------|-------|----------------------------------|
| #1 | 🔴 Website | 4.83% | -0.41 pp | 51 | AR 0.0%, AZ 0.0%, BG 0.0% |
...
| 🕒 Evidence window | 24h (span=337.39h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=337.39h; client.json: id=-31.40pp, ws=+0, otclient_modules.json: id=-29.79pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-06-07T17:56:16.390883Z → 2026-06-07T18:56:16.390883Z) |
| Cykle | **365** (TŁUMACZENIE=245, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **8.4%** |
| Cykle bez postępu % | **21.3%** |
| Przepustowość (kluczy/h) | **276.1 kluczy/h** |
| Podejrzane tłumaczenia | **478** |
| Najgorsze cele (strażnik) | ru/html.json (gf=24), ro/html.json (gf=7), ru/php.json (gf=5), fr/website_i18n.json (gf=0), de/website_i18n.json (gf=0) |
...
|--------|-----------|--------|----------------|
| `gt_identity_retry_identical_to_en` | 23 | 44.2% | cs/website_i18n.json (7) |
| `retry_loop_cooldown_default` | 19 | 36.5% | de/website_i18n.json (5) |
| `gt_structure_retry_placeholder` | 4 | 7.7% | ro/html.json (4) |
| `gt_rejected_high_mixed_scripts` | 4 | 7.7% | ru/php.json (4) |
| `retry_loop_cooldown_provider_error` | 1 | 1.9% | tr/html.json (1) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 42s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-06-07T18:55:38.290436Z

- **Ostatni audyt:** SLOW_MODE | 14 issue(s) / 100 entries | 2026-06-07T18:55:38.290436Z
- **Top 5 typów problemów:** suspicious_log_warning=104, suspicious_rejected_high=104, suspicious_rejected_critical=96, suspicious_log_critical=81, identical_to_en_exempt=32
- **Języki o najsłabszej jakości:** ru(60.1, issues=428996), it(60.1, issues=190616), de(60.1, issues=163540), cs(60.1, issues=162332), nl(60.1, issues=79359)
...
⚠️ **TR**: jakość 87%, 68672 problemów
⚠️ **PL**: jakość 76%, 397666 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 82%, 782721 problemów
⚠️ **PT**: jakość 60%, 63489 problemów
⚠️ **FR**: jakość 60%, 69076 problemów
⚠️ **IT**: jakość 60%, 190616 problemów
⚠️ **RU**: jakość 60%, 428996 problemów
⚠️ **NL**: jakość 60%, 79359 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #21,147 |
| Heartbeat | 154s temu | 2026-06-07T18:53:46Z |
...
- **TOP 5 języków:** DE (17,948), CS (14,482), NL (13,405), FR (12,499), PT (10,805)
- **Aktualnie naprawia:** ES / -
- **Ostatnia aktualizacja:** 2026-06-07T18:49:05.820628Z
...
- 2026-06-07 18:56:04 | AUTO_TRANSLATE:heartbeat_tick | pt | ok | website_i18n.json
- 2026-06-07 18:56:04 | AUTO_TRANSLATE:auto_start | pt | ok | website_i18n.json
- 2026-06-07 18:55:37 | AUTO_TRANSLATE:auto_done | de | ok | website_i18n.json
- 2026-06-07 18:54:57 | AUTO_TRANSLATE:heartbeat_tick | de | ok | website_i18n.json
- 2026-06-07 18:54:57 | AUTO_TRANSLATE:auto_start | de | ok | website_i18n.json
- 2026-06-07 18:54:38 | AUTO_TRANSLATE:auto_done | fr | ok | website_i18n.json
...
| Przepustowość (okno) | 0 kluczy / 26 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-06-07 18:56:16

- • DOCTOR_REMEDIATION: ALARM_RESOLVED [-] → ok — resolved_count=1
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → warn (files+1, translated+1, skipped+0) — lang=ru file=html.json strict_skipped_done=14 guard_fail=8 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+10, skipped+0) — lang=ro file=html.json strict_skipped_done=2
- 🌍 TRANSLATION_SYNC: SYNC_FILE_DONE [ru] → ok (keys+580, files+1) — lang=ru file=html.json
- • DOCTOR_REMEDIATION: AUTO_COMMAND [-] → ok — action=force_sync reason=write_starvation_or_queue_starvation
- 🤖 AUTO_TRANSLATE: WEBSITE_I18N_APPLY [pt] → ok — keys_updated=133 files_changed=1
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pt] → warn (files+1, translated+14, skipped+0) — lang=pt file=website_i18n.json strict_skipped_done=1
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+0, translated+0, skipped+0) — lang=it file=php.json strict_skipped_done=12
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [tr] → warn (files+1, translated+13, skipped+0) — lang=tr file=html.json strict_skipped_done=173
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → warn (files+1, translated+7, skipped+0) — lang=ru file=html.json strict_skipped_done=142 guard_fail=5 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **1,775** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 97 |
| ❌ Błędów | 482 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **FR** (214), **ES** (209), **TR** (206), **IT** (192), **PT** (179) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **1,775** kluczy
...
|---------|---------|-----------|
| 📁 Plików przeskanowanych (LIVE registry) | **113** | z `i18n_file_status.json` |
| 📚 Plików przeskanowanych (historia) | **6,540** | z `i18n_processed_files.txt` |
| ↕️ Historia minus LIVE | **+6,427** | dodatnie = historia > LIVE |
| ✅ Plików z kluczami | **51** | zawierały hardcoded strings |
| ⬜ Plików bez kluczy | **62** | czyste (brak hardcoded) |
...
| 🔄 Cykli wykonanych | **#21,147** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #21,147 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-06-07 18:56:16  
...
- ✅ `MigrateToCommand.php` - ukończono 2026-06-07 20:52
