...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.82%**. Tempo: **1496.5 kluczy/h**. Tłumaczeń netto: **113,819**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 16:48:24

> **Aktualizacja:** 2026-02-20 16:48:24 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #12 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: pl | Plik: - | Heartbeat: 2026-02-20T16:48:20Z  
> **Okno godzinowe:** okno=1.0h | cykli=75 | pominięte=0.0% | odrzucone=72.5% | przepustowość=1496.5/h  
> **Tłumaczeń netto:** 113,819

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 16:48:24 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T16:48:20Z |
| MIGRATION | 🔒 NIEAKTYWNY | 29s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 16:48:24 |
| TRANSLATION | 🟢 AKTYWNY | 38s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T16:47:46.885849Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T16:48:24.944304Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 16:48:24 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T16:48:20Z
...
| ❤️ **Heartbeat** | 2026-02-20T16:48:20Z |
...
> **ETA globalne:** ~63 dni (2,262,022 kluczy do celu 95%)
...
> Świeżość: 29s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 16:48:24
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 38s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T16:47:46.885849Z
...
- Raporty strażnika jakości: **6580**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3688**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **13.82%** (385,090/2,786,472)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T15:48:24.693573Z → 2026-02-20T16:48:24.693573Z) |
| Cykle | **75** (TŁUMACZENIE=75, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **72.5%** |
| Cykle bez postępu % | **5.9%** |
| Przepustowość (kluczy/h) | **1496.5 kluczy/h** |
| Podejrzane tłumaczenia | **8013** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T16:48:24.944304Z

- **Ostatni audyt:** SLOW_MODE | 50 issue(s) / 100 entries | 2026-02-20T16:48:20.437567Z | recent_hidden=0
- **Alarm recent hidden HIGH/CRITICAL:** ✅ OK | hidden=0, threshold=5, trend=→ last10=0.00, prev10=0.00, latest=0
- **Regresja critical bad keys pack:** 🚨 FAIL: pl(critical=68, pack=0), es(critical=61, pack=0)
- **Top 5 typów problemów:** suspicious_rejected_critical=172, suspicious_log_critical=94, suspicious_log_high=56, suspicious_log_low=50, suspicious_rejected_high=28
- **Języki o najsłabszej jakości:** es(60.1, issues=317000), pl(60.1, issues=179173), ro(60.1, issues=172893), sr(60.2, issues=85877), it(60.8, issues=69639)
...
⚠️ **PL**: jakość 60%, 179173 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 317000 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 61%, 69639 problemów
⚠️ **RU**: jakość 69%, 208910 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 73%, 29599 problemów
...
| Heartbeat | 5s temu | 2026-02-20T16:48:20Z |
...
- 2026-02-20 16:47:54 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 16:47:36 | AUTO_TRANSLATE:heartbeat_tick | es | ok | questlog.json
- 2026-02-20 16:47:36 | AUTO_TRANSLATE:parallel_start | es | ok | questlog.json
- 2026-02-20 16:47:35 | AUTO_TRANSLATE:auto_done | pl | ok | questlog.json
- 2026-02-20 16:47:05 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | questlog.json
- 2026-02-20 16:47:05 | AUTO_TRANSLATE:auto_start | pl | ok | questlog.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,831 | 703 | 5864 (89.3%) | 38 |
| 🟡 ES | 84.6% | 0 | 2,162 | 709 | 2264 (76.2%) | 40 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **113,819** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=52.67%, reason=decrease_high_fail_rate=52.7% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,412 kluczy / 78 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 16:48:24
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+31, skipped+0) — lang=pl file=questlog.json strict_skipped_done=100 guard_fail=19 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+24) — repair_identical lang=es file=npc.json target_identical=24 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=308.75
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+17, skipped+0) — lang=es file=otclient_modules.json strict_skipped_done=1786 guard_fail=27 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ro] → ok (translated+46, skipped+0) — parallel lang=ro file=monsters.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ru] → ok (translated+48, skipped+0) — parallel lang=ru file=monsters.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+50, skipped+0) — lang=es file=npc.json strict_skipped_done=7669
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+78) — repair_identical lang=es file=npc.json target_identical=2501
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [it] → ok (translated+80, skipped+0) — parallel lang=it file=npc.json
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **1,654** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 12 |
| ❌ Błędów | 37 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (460), **RU** (303), **IT** (273), **RO** (216), **SR** (150) |
| 📊 Porównanie | ↓ 54.6% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **99,239** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 16:48:24  
