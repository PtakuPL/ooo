...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.29%**. Tempo: **2010.0 kluczy/h**. Tłumaczeń netto: **85,305**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-17 00:36:20

> **Aktualizacja:** 2026-02-17 00:36:20 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #85 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ru | Plik: - | Heartbeat: 2026-02-17T00:36:16Z  
> **Okno godzinowe:** okno=1.0h | cykli=157 | pominięte=0.0% | odrzucone=37.1% | przepustowość=2010.0/h  
> **Tłumaczeń netto:** 85,305

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-17 00:36:20 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-17T00:36:16Z |
| MIGRATION | 🔒 NIEAKTYWNY | 28s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-17 00:36:20 |
| TRANSLATION | 🟢 AKTYWNY | 19s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-17T00:36:01.589804Z |
| QUALITY | 🔒 NIEAKTYWNY | 4s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-17T00:36:16.562999Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-17 00:36:20 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-17T00:36:16Z
...
| ❤️ **Heartbeat** | 2026-02-17T00:36:16Z |
...
> **ETA globalne:** ~49 dni (2,360,399 kluczy do celu 95%)
...
> Świeżość: 28s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-17 00:36:20
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 19s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-17T00:36:01.589804Z
...
| IT (Włoski) | 6,339/53,586 | 11.83% | 2,434 | 0 |
...
- Raporty strażnika jakości: **2569**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2503**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **10.29%** (286,713/2,786,472)
- **Kopie EN (łącznie):** **166,356**
...
| IT | 6,105/49,731 | 12.3% | 234/3,855 | 6.1% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-16T23:36:20.268816Z → 2026-02-17T00:36:20.268816Z) |
...
> Świeżość: 4s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-17T00:36:16.562999Z

- **Ostatni audyt:** OK | 7 issue(s) / 100 entries | 2026-02-17T00:36:16.562999Z
- **Top 5 typów problemów:** suspicious_rejected_critical=176, suspicious_log_high=127, suspicious_log_critical=71, suspicious_rejected_high=24, identical_to_en_exempt=10
- **Języki o najsłabszej jakości:** es(60.1, issues=170032), ro(60.1, issues=20789), sv(60.1, issues=4900), ru(60.2, issues=18373), it(63.7, issues=6711)
...
⚠️ **PL**: jakość 69%, 118267 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 170032 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 64%, 6711 problemów
⚠️ **RU**: jakość 60%, 18373 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 60%, 4900 problemów
...
| Heartbeat | 5s temu | 2026-02-17T00:36:16Z |
...
- 2026-02-17 00:36:08 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-17 00:36:20
...
| ❌ Błędów | 38 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (450), **IT** (385), **PL** (319), **SV** (319), **SR** (292) |
| 📊 Porównanie | ↓ 88.6% vs wczoraj (20,288) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **102,512** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-17 00:36:20  
