...
local function addTravelKeyword(keyword, text, cost, destination, condition, action)
	if condition then
		keywordHandler:addKeyword({ keyword }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.iyad.stdmod_1" }, condition)
	end

	local travelKeyword = keywordHandler:addKeyword({ keyword }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.iyad.stdmod_4", i18nArgs = { text }, cost = cost, discount = "postman" })
...
-- Basic
keywordHandler:addKeyword({ "job" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.iyad.stdmod_4" })
keywordHandler:addKeyword({ "fly" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.iyad.stdmod_5" })
keywordHandler:addKeyword({ "transport" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.iyad.stdmod_6" })
keywordHandler:addKeyword({ "passage" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.iyad.stdmod_7" })
keywordHandler:addKeyword({ "ride" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.iyad.stdmod_8" })
keywordHandler:addKeyword({ "name" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.iyad.stdmod_9" })
keywordHandler:addKeyword({ "ferumbras" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.iyad.stdmod_10" })
keywordHandler:addKeyword({ "carlin" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.iyad.stdmod_11" })
keywordHandler:addKeyword({ "thais" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.iyad.stdmod_12" })
keywordHandler:addKeyword({ "go" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.iyad.stdmod_13" })
keywordHandler:addKeyword({ "excalibug" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.iyad.stdmod_14" })
keywordHandler:addKeyword({ "continent" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.iyad.stdmod_15" })
keywordHandler:addKeyword({ "drefia" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.iyad.stdmod_16" })
keywordHandler:addKeyword({ "news" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.iyad.stdmod_17" })
keywordHandler:addKeyword({ "time" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.iyad.stdmod_18" })
