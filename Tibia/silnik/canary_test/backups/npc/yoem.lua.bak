...
keywordHandler:addKeyword({ "furniture" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.yoem.stdmod_1" })

NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_GREET, "npc.yoem.greet_msg_1")
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_SENDTRADE, "npc.yoem.sendtrade_msg_1")
