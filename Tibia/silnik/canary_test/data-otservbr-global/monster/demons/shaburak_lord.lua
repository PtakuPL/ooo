...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "GREEN IS MEAN!", yell = true , i18nKey = "monster.shaburak_lord.voice_1"},
	{ text = "WE RULE!", yell = true , i18nKey = "monster.shaburak_lord.voice_2"},
	{ text = "POWER TO THE SHABURAK!", yell = true , i18nKey = "monster.shaburak_lord.voice_3"},
	{ text = "DEATH TO THE ASKARAK!", yell = true , i18nKey = "monster.shaburak_lord.voice_4"},
	{ text = "ONLY WE ARE TRUE DEMONS!", yell = true , i18nKey = "monster.shaburak_lord.voice_5"},
}
