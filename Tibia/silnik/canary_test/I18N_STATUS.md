...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.85% / real 10.76%**. Tempo: **1028.0 kluczy/h**. Tłumaczeń netto: **134,967**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-28 19:59:53

> **Aktualizacja:** 2026-04-28 19:59:53 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,005 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: items.json | Heartbeat: 2026-04-28T19:59:42Z
> **Okno godzinowe:** okno=1.0h | cykli=82 | pominięte=0.0% | odrzucone=2.6% | przepustowość=1028.0/h  
> **Tłumaczeń netto:** 134,967

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-28 19:59:53 |
| LIVE | 🟢 AKTYWNY | 17s temu | - | `activity.json / worker_state.json` | 2026-04-28T19:59:42Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 13s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-28 19:59:53 |
| TRANSLATION | 🟢 AKTYWNY | 3min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-28T19:56:27.806998Z |
| QUALITY | 🔒 NIEAKTYWNY | 17s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-28T19:59:42.262096Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-28 19:59:53 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-28T19:59:59.544606Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 17s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-28T19:59:42Z
...
| 🔄 **Ostatni cykl** | 74 kluczy, 1 odrzuconych, 277.1s, tryb: AUTO_TRANSLATE, cel: it/items.json |
| ❤️ **Heartbeat** | 2026-04-28T19:59:42Z |
...
| ⏳ Oldest pending (visible tail) | 17442 s |
| 🌍 Top języki | RU(224), NL(111), PT(25), DE(12) |
| 🧱 Top reason_bucket | quality(226), default(124), word_salad(23), partial_translation_mix(11) |
...
| 🧮 OpenAI budget | `184/250` |
| ♻️ Provider debt | `1266` |
| 🌍 Recent provider mix | TM/simple(248), Free Google Translate(233), OpenAI model pool(31), canonical_name_semantic_autofix(13), ter... |
...
| ❤️ Pool health | `critical` (writes=528, fallbacks=11) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=251/251 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 393, 'oldest_s': 17442}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~121 dni (2,990,108 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 78.5% | 58,498/74,536 | ~12h |
| PL | ██████████████░░░░░░ | 71.0% | 52,911/74,536 | ~17h |
| IT | █████████████░░░░░░░ | 68.5% | 51,058/74,536 | ~19h |
| RO | █████████████░░░░░░░ | 69.4% | 51,699/74,536 | ~19h |
...
> Tempo obliczone na bazie ostatniej godziny: ~1028 kluczy/h.
...
> Świeżość: 13s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-28 19:59:53
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-28T19:56:27.806998Z
...
- Raporty strażnika jakości: **4598**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4451**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-28T19:55:04.669749Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.85%** (691,960/3,875,872)
- **Pokrycie globalne (real):** **10.76%** (417,144/3,875,872)
- **Kopie EN (łącznie):** **410,903**
- **Placeholdery [EN]/puste (łącznie):** **2,193,703**
...
| 🕒 Evidence window | 24h (span=25.13h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=25.13h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-28T18:59:54.092811Z → 2026-04-28T19:59:54.092811Z) |
...
| Przepustowość (kluczy/h) | **1028.0 kluczy/h** |
| Podejrzane tłumaczenia | **1040** |
| Najgorsze cele (strażnik) | cs/items.json (gf=12), ro/items.json (gf=8), it/items.json (gf=3), de/npc.json (gf=2), de/otclient_modules.json (gf=2) |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 86 | 86.9% | ru/items.json (86) |
| `existing_canonical_name_quality_mixed_scripts` | 10 | 10.1% | ru/items.json (10) |
| `retry_loop_cooldown_default` | 3 | 3.0% | cs/items.json (2) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 17s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-28T19:59:42.262096Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-28T19:59:42.262096Z
- **Top 5 typów problemów:** suspicious_rejected_critical=188, suspicious_log_low=139, suspicious_log_high=60, suspicious_rejected_high=12, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=720009), ro(60.1, issues=419457), de(60.1, issues=102346), cs(60.1, issues=76810), nl(60.1, issues=70302)
...
⚠️ **TR**: jakość 62%, 51735 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 720009 problemów
⚠️ **PT**: jakość 60%, 56276 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 78%, 165926 problemów
⚠️ **RU**: jakość 65%, 353317 problemów
⚠️ **NL**: jakość 60%, 70302 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,005 |
| Heartbeat | 17s temu | 2026-04-28T19:59:42Z |
...
- **Ostatnia aktualizacja:** 2026-04-28T19:56:43.707603Z
...
- 2026-04-28 19:58:12 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-28 19:56:44 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-28 19:56:28 | AUTO_TRANSLATE:auto_done | it | ok | items.json
- 2026-04-28 19:55:05 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-04-28 19:55:05 | AUTO_TRANSLATE:auto_start | it | ok | items.json
- 2026-04-28 19:54:46 | AUTO_TRANSLATE:auto_done | cs | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **134,967** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=3.42%, reason=increase_low_fail_rate=3.4%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-28 19:59:53

- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+6) — repair_identical lang=es file=npc.json target_identical=2 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=241.54
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+74, skipped+0) — lang=it file=items.json strict_skipped_done=884 guard_fail=1 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **4,718** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 41 |
| ❌ Błędów | 187 |
| 🌍 Aktywnych języków | 9 |
| 🏆 TOP 5 | **DE** (847), **RU** (608), **PT** (594), **IT** (570), **TR** (511) |
| 📊 Porównanie | ↓ 9.1% vs wczoraj (5,188) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **27,578** kluczy
...
| 🔄 Cykli wykonanych | **#17,005** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,005 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-28 19:59:53  
