...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 16.87% / real 9.69%**. Tempo: **1730.0 kluczy/h**. Tłumaczeń netto: **102,551**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-02 18:47:53

> **Aktualizacja:** 2026-04-02 18:47:53 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #13,068 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: pt | Plik: monsters.json | Heartbeat: 2026-04-02T18:47:31Z  
> **Okno godzinowe:** okno=1.0h | cykli=56 | pominięte=0.0% | odrzucone=30.6% | przepustowość=1730.0/h  
> **Tłumaczeń netto:** 102,551

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-02 18:47:53 |
| LIVE | 🟢 AKTYWNY | 23s temu | - | `activity.json / worker_state.json` | 2026-04-02T18:47:31Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 7s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-02 18:47:53 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-02T18:45:56.270332Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-02T18:45:56.972782Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-02 18:47:53 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 23s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-02T18:47:31Z
...
| ❤️ **Heartbeat** | 2026-04-02T18:47:31Z |
...
> **ETA globalne:** ~73 dni (3,028,096 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 76.8% | 57,257/74,536 | ~8h |
| PL | ██████████████░░░░░░ | 70.7% | 52,690/74,536 | ~10h |
| IT | ████████████░░░░░░░░ | 63.6% | 47,422/74,536 | ~14h |
| RO | ████████████░░░░░░░░ | 60.9% | 45,382/74,536 | ~15h |
| RU | ████████░░░░░░░░░░░░ | 41.7% | 31,112/74,536 | ~23h |
| FR | ██████████░░░░░░░░░░ | 54.6% | 40,668/74,536 | ~17h |
| SR | ██████░░░░░░░░░░░░░░ | 33.3% | 24,827/74,536 | ~27h |
| CS | ████████░░░░░░░░░░░░ | 43.5% | 32,426/74,536 | ~22h |
| PT | ██████████████░░░░░░ | 73.2% | 54,593/74,536 | ~9h |
| NL | ██████████████░░░░░░ | 70.8% | 52,785/74,536 | ~10h |
| TR | ████░░░░░░░░░░░░░░░░ | 23.1% | 17,246/74,536 | ~31h |
...
> Tempo obliczone na bazie ostatniej godziny: ~1730 kluczy/h.
...
> Świeżość: 7s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-02 18:47:53
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-02T18:45:56.270332Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-02T17:47:53.473929Z → 2026-04-02T18:47:53.473929Z) |
...
| Przepustowość (kluczy/h) | **1730.0 kluczy/h** |
| Podejrzane tłumaczenia | **1624** |
| Najgorsze cele (strażnik) | tr/npc.json (gf=176), ro/items.json (gf=142), it/monsters.json (gf=114), cs/npc.json (gf=102), nl/npc.json (gf=89) |
...
|--------|-----------|--------|----------------|
| `gt_rejected_critical` | 441 | 73.5% | es/questlog.json (258) |
| `gt_validate_fail_word_salad` | 116 | 19.3% | es/questlog.json (68) |
| `gt_rejected_high_partial_translation_mix` | 34 | 5.7% | fr/monsters.json (17) |
| `gt_validate_fail_placeholder` | 7 | 1.2% | es/questlog.json (6) |
| `gt_validate_fail_quality` | 2 | 0.3% | tr/npc.json (1) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-02T18:45:56.972782Z
...
| Heartbeat | 23s temu | 2026-04-02T18:47:31Z |
...
- 2026-04-02 18:45:36 | AUTO_TRANSLATE:auto_start | de | ok | monsters.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-02 18:47:53
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-02 18:47:53  
