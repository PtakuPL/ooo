...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.95% / real 10.87%**. Tempo: **888.0 kluczy/h**. Tłumaczeń netto: **141,406**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 03:54:34

> **Aktualizacja:** 2026-04-29 03:54:34 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,660 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: auto_done | Kategoria: ru | Plik: items.json | Heartbeat: 2026-04-29T03:53:06Z
> **Okno godzinowe:** okno=1.0h | cykli=80 | pominięte=0.0% | odrzucone=3.3% | przepustowość=888.0/h  
> **Tłumaczeń netto:** 141,406

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 03:54:34 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T03:53:06Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 30s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 03:54:34 |
| TRANSLATION | 🟢 AKTYWNY | 10s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T03:54:30.459524Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T03:53:05.933194Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 03:54:34 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T03:54:41.261616Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T03:53:06Z
...
| 🔄 **Ostatni cykl** | 30 kluczy, 1 odrzuconych, 66.0s, tryb: AUTO_TRANSLATE, cel: ru/items.json |
| ❤️ **Heartbeat** | 2026-04-29T03:53:06Z |
...
| ⏳ Oldest pending (visible tail) | 17030 s |
| 🌍 Top języki | RU(399) |
...
| 🌍 Recent provider mix | TM/simple(299), Free Google Translate(196), canonical_name_semantic_autofix(16), canonical_name_case_autofi... |
...
| ❤️ Pool health | `critical` (writes=526, fallbacks=8) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=615/615 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 399, 'oldest_s': 17030}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 30s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 03:54:34
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 10s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T03:54:30.459524Z
...
- moist wall → мойст стена (item.13086.name)
- moist wall → мойст стена (item.13087.name)
- moist wall → мойст стена (item.13088.name)
- moist wall → мойст стена (item.13089.name)
- sandstone wall → песчаниковая стена (item.1309.name)
- moist wall → мойст стена (item.13090.name)
- moist wall → мойст стена (item.13091.name)
- moist wall → мойст стена (item.13092.name)
- moist wall → мойст стена (item.13093.name)
- moist wall → мойст стена (item.13094.name)
- moist wall → мойст стена (item.13095.name)
- moist wall → мойст стена (item.13096.name)
- moist wall → мойст стена (item.13097.name)
- moist wall → мойст стена (item.13098.name)
- moist wall → мойст стена (item.13099.name)
- sandstone wall → песчаниковая стена (item.1310.name)
- moist wall → мойст стена (item.13100.name)
- moist wall → мойст стена (item.13101.name)
- moist wall → мойст стена (item.13102.name)
- moist wall → мойст стена (item.13103.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4763**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4616**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T03:53:23.883903Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.95%** (695,806/3,875,872)
- **Pokrycie globalne (real):** **10.87%** (421,330/3,875,872)
- **Kopie EN (łącznie):** **410,563**
- **Placeholdery [EN]/puste (łącznie):** **2,189,857**
...
| 🕒 Evidence window | 24h (span=33.04h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=33.04h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T02:54:35.057197Z → 2026-04-29T03:54:35.057197Z) |
...
| Najgorsze cele (strażnik) | cs/items.json (gf=10), ro/items.json (gf=8), it/items.json (gf=3), de/otclient_modules.json (gf=3), de/npc.json (gf=3) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T03:53:05.933194Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T03:53:05.933194Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=731980), ro(60.1, issues=430946), de(60.1, issues=113935), cs(60.1, issues=91644), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 60%, 54172 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 731980 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 66%, 171908 problemów
⚠️ **RU**: jakość 74%, 362321 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,660 |
| Heartbeat | 95s temu | 2026-04-29T03:53:06Z |
...
│ Plik: items.json                                              │
│ Postęp: 30/30 keys                                            │
│ …0 guard_fail=1 strict_missing_key=0 strict_skipped_done=2873 │
├─────────────────────────────────────────────────────────────────┤
│ ❤️ Heartbeat: 2026-04-29T03:53:06Z           │
└─────────────────────────────────────────────────────────────────┘
```
...
- 2026-04-29 03:54:30 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
- 2026-04-29 03:53:24 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-04-29 03:53:24 | AUTO_TRANSLATE:auto_start | ru | ok | items.json
- 2026-04-29 03:53:04 | AUTO_TRANSLATE:auto_done | tr | ok | items.json
- 2026-04-29 03:52:20 | AUTO_TRANSLATE:heartbeat_tick | tr | ok | items.json
- 2026-04-29 03:52:19 | AUTO_TRANSLATE:auto_start | tr | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 03:54:34
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **3,429** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 73 |
| ❌ Błędów | 134 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **RU** (664), **CS** (610), **IT** (591), **DE** (450), **TR** (416) |
| 📊 Porównanie | ↓ 58.3% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **22,409** kluczy
...
| 🔄 Cykli wykonanych | **#17,660** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,660 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 03:54:34  
