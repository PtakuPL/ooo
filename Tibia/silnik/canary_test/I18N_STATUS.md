...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 16.8% / real 9.61%**. Tempo: **1626.0 kluczy/h**. Tłumaczeń netto: **99,639**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-02 16:26:01

> **Aktualizacja:** 2026-04-02 16:26:01 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #12,888 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: cs | Plik: npc.json | Heartbeat: 2026-04-02T16:25:28Z  
> **Okno godzinowe:** okno=1.0h | cykli=83 | pominięte=0.0% | odrzucone=46.4% | przepustowość=1626.0/h  
> **Tłumaczeń netto:** 99,639

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-02 16:26:01 |
| LIVE | 🟢 AKTYWNY | 35s temu | - | `activity.json / worker_state.json` | 2026-04-02T16:25:28Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-02 16:26:01 |
| TRANSLATION | 🟢 AKTYWNY | 5min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-02T16:20:20.708711Z |
| QUALITY | 🔒 NIEAKTYWNY | 5min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-02T16:20:43.456377Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-02 16:26:01 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 35s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-02T16:25:28Z
...
| ❤️ **Heartbeat** | 2026-04-02T16:25:28Z |
...
| �📊 Przetłumaczono | **1,626** kluczy |
| ❌ Odrzucone (guard) | 1405 |
| 🔁 Cykli | 83 |
| 🌍 Języków | 11 |
...
> **ETA globalne:** ~78 dni (3,030,950 kluczy do celu 95%)
...
| CS | ████████░░░░░░░░░░░░ | 42.9% | 32,003/74,536 | ~24h |
| PT | ██████████████░░░░░░ | 73.0% | 54,408/74,536 | ~10h |
| NL | ██████████████░░░░░░ | 70.7% | 52,716/74,536 | ~11h |
| TR | ████░░░░░░░░░░░░░░░░ | 22.4% | 16,720/74,536 | ~33h |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-02 16:26:01
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 5min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-02T16:20:20.708711Z
...
- Raporty strażnika jakości: **3565**  
- Raporty blokad: **0**  
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 280 | 0 | 0 | - | 2026-04-02T16:21:02.706492Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **16.8%** (651,118/3,875,872)
- **Pokrycie globalne (real):** **9.61%** (372,395/3,875,872)
- **Kopie EN (łącznie):** **430,277**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-02T15:26:01.272981Z → 2026-04-02T16:26:01.272981Z) |
...
| Przepustowość (kluczy/h) | **1626.0 kluczy/h** |
...
|--------|-----------|--------|----------------|
| `gt_validate_fail_placeholder` | 535 | 45.6% | it/npc.json (126) |
| `gt_rejected_critical` | 491 | 41.9% | ro/monsters.json (124) |
| `gt_validate_fail_word_salad` | 106 | 9.0% | pl/npc.json (19) |
| `gt_validate_fail_quality` | 18 | 1.5% | es/items.json (6) |
| `gt_rejected_high_partial_translation_mix` | 12 | 1.0% | es/monsters.json (11) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 5min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-02T16:20:43.456377Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-02T16:20:43.456377Z
- **Top 5 typów problemów:** suspicious_rejected_critical=200, suspicious_log_high=72, suspicious_log_medium=60, suspicious_log_low=40, suspicious_log_critical=28
- **Języki o najsłabszej jakości:** pt(60.1, issues=29480), it(60.3, issues=134832), ro(60.5, issues=374009), cs(61.7, issues=41146), fr(62.3, issues=39369)
...
⚠️ **ES**: jakość 73%, 672432 problemów
⚠️ **PT**: jakość 60%, 29480 problemów
⚠️ **FR**: jakość 62%, 39369 problemów
⚠️ **IT**: jakość 60%, 134832 problemów
⚠️ **RU**: jakość 81%, 309106 problemów
⚠️ **NL**: jakość 72%, 27010 problemów
...
| Heartbeat | 35s temu | 2026-04-02T16:25:28Z |
...
- 2026-04-02 16:21:03 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | npc.json
- 2026-04-02 16:21:03 | AUTO_TRANSLATE:auto_start | cs | ok | npc.json
- 2026-04-02 16:20:34 | AUTO_TRANSLATE:heartbeat_tick | es | ok | modules.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-02 16:26:01
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **2,302** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 24 |
| ❌ Błędów | 51 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **FR** (455), **RO** (349), **ES** (273), **NL** (261), **TR** (232) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **42,589** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-02 16:26:01  
