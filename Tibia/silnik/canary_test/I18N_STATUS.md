...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **18.46%**. Tempo: **1373.9 kluczy/h**. Tłumaczeń netto: **35,243**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-22 22:53:19

> **Aktualizacja:** 2026-03-22 22:53:19 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **LIVE:** Cykl #9,130 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-03-22T22:52:46Z  
> **Okno godzinowe:** okno=1.0h | cykli=64 | pominięte=0.0% | odrzucone=11.8% | przepustowość=1373.9/h  
> **Tłumaczeń netto:** 35,243

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-22 22:53:19 |
| LIVE | 🟢 AKTYWNY | 34s temu | - | `activity.json / worker_state.json` | 2026-03-22T22:52:46Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 58s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-22 22:53:19 |
| TRANSLATION | 🟢 AKTYWNY | 50s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-22T22:52:30.299538Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-22T22:50:47.022082Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-22 22:53:19 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 34s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-22T22:52:46Z
...
| ❤️ **Heartbeat** | 2026-03-22T22:52:46Z |
...
> **ETA globalne:** ~90 dni (2,966,503 kluczy do celu 95%)
...
> Świeżość: 58s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-22 22:53:19
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 50s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-22T22:52:30.299538Z
...
- dead yalahari → Yalahari morto (item.18266.name)
- dead yalahari → Yalahari morto (item.18267.name)
- dead yalahari → Yalahari morto (item.18268.name)
- dead yalahari → Yalahari morto (item.18269.name)
- dead zarabustor → Zarabustor morto (item.18270.name)
- dead zarabustor → Zarabustor morto (item.18271.name)
- dead zarabustor → Zarabustor morto (item.18272.name)
- dead zarabustor → Zarabustor morto (item.18273.name)
- dead fernfang → fernfang morto (item.18282.name)
- dead fernfang → fernfang morto (item.18283.name)
- dead fernfang → fernfang morto (item.18284.name)
- dead fernfang → fernfang morto (item.18285.name)
- dead hemming → bainha morta (item.18286.name)
- dead hemming → bainha morta (item.18287.name)
- dead hemming → bainha morta (item.18288.name)
- dead hemming → bainha morta (item.18289.name)
- dead necropharus → necrófago morto (item.18290.name)
- dead necropharus → necrófago morto (item.18291.name)
- dead necropharus → necrófago morto (item.18292.name)
- dead necropharus → necrófago morto (item.18293.name)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-22T21:53:19.602604Z → 2026-03-22T22:53:19.602604Z) |
...
| Przepustowość (kluczy/h) | **1373.9 kluczy/h** |
| Podejrzane tłumaczenia | **2274** |
...
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-22T22:50:47.022082Z
...
| Heartbeat | 34s temu | 2026-03-22T22:52:46Z |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-22 22:53:19
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **17,910** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 44 |
| ❌ Błędów | 127 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **ES** (5,251), **RO** (3,900), **RU** (1,877), **IT** (1,778), **PT** (1,204) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **17,910** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-22 22:53:19  
