...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.87%**. Tempo: **1758.8 kluczy/h**. Tłumaczeń netto: **120,118**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 19:31:16

> **Aktualizacja:** 2026-02-20 19:31:16 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #107 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: pl | Plik: - | Heartbeat: 2026-02-20T19:31:12Z  
> **Okno godzinowe:** okno=1.0h | cykli=201 | pominięte=0.0% | odrzucone=50.7% | przepustowość=1758.8/h  
> **Tłumaczeń netto:** 120,118

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 19:31:16 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T19:31:12Z |
| MIGRATION | 🔒 NIEAKTYWNY | 34s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 19:31:16 |
| TRANSLATION | 🟢 AKTYWNY | 39s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T19:30:38.287786Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T19:31:17.344905Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 19:31:16 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T19:31:12Z
...
| ❤️ **Heartbeat** | 2026-02-20T19:31:12Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **3,082** kluczy |
| ❌ Odrzucone (guard) | 3172 |
| 🔁 Cykli | 201 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (792 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~1759 kluczy/h |
| 🛡️ Guard fail rate | 50.7% |
| ⚠️ Podejrzane | 25171 |
| 🌐 GT aktywny (1h) | ✅ TAK |
| 🔤 GT tłumaczeń (1h) | 23 |
...
> **ETA globalne:** ~54 dni (2,260,740 kluczy do celu 95%)
...
> Świeżość: 34s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 19:31:16
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 39s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T19:30:38.287786Z
...
- Raporty strażnika jakości: **6903**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4011**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **13.87%** (386,372/2,786,472)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T18:31:16.591475Z → 2026-02-20T19:31:16.591475Z) |
...
| Przepustowość (kluczy/h) | **1758.8 kluczy/h** |
| Podejrzane tłumaczenia | **3363** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T19:31:17.344905Z

- **Ostatni audyt:** SLOW_MODE | 60 issue(s) / 100 entries | 2026-02-20T19:31:12.396383Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=101, suspicious_log_high=43, suspicious_log_critical=43, suspicious_log_low=39, artifact_token=32
- **Języki o najsłabszej jakości:** es(60.1, issues=332698), ro(60.1, issues=181968), it(60.1, issues=73984), tl(64.2, issues=466), pl(64.7, issues=186469)
...
⚠️ **PL**: jakość 65%, 186469 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 332698 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 73984 problemów
⚠️ **RU**: jakość 80%, 211928 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 78%, 30435 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #107 |
| Heartbeat | 5s temu | 2026-02-20T19:31:12Z |
...
- 2026-02-20 19:30:46 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 19:30:34 | AUTO_TRANSLATE:heartbeat_tick | es | ok | questlog.json
- 2026-02-20 19:30:33 | AUTO_TRANSLATE:parallel_start | es | ok | questlog.json
- 2026-02-20 19:30:32 | AUTO_TRANSLATE:auto_done | pl | ok | questlog.json
- 2026-02-20 19:30:13 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | questlog.json
- 2026-02-20 19:30:13 | AUTO_TRANSLATE:auto_start | pl | ok | questlog.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,830 | 619 | 6253 (91.0%) | 33 |
| 🟡 ES | 84.8% | 0 | 2,160 | 758 | 2977 (79.7%) | 36 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **120,118** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=38.77%, reason=decrease_high_fail_rate=38.8% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,377 kluczy / 69 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 19:31:16
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+11, skipped+0) — lang=pl file=questlog.json strict_skipped_done=127 guard_fail=19 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ro] → ok (translated+47, skipped+0) — parallel lang=ro file=scripts.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → warn (files+1, translated+50, skipped+0) — lang=ru file=scripts.json strict_skipped_done=340
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [de] → ok (translated+27, skipped+0) — parallel lang=de file=otclient_modules.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+10, skipped+0) — parallel lang=es file=modules.json
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **10,857** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 107 |
| ❌ Błędów | 241 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (3,123), **RU** (2,159), **IT** (1,825), **RO** (1,343), **PL** (1,187) |
| 📊 Porównanie | ↑ 198.2% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **108,442** kluczy
...
| 🔄 Cykli wykonanych | **#107** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 19:31:16  
