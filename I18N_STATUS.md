...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **11.13%**. Tempo: **567.7 kluczy/h**. Tłumaczeń netto: **81,481**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-15 15:58:38

> **Aktualizacja:** 2026-02-15 15:58:38 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #9,287 | Status: ✅ BEZCZYNNY | Faza: IDLE | Etap: cycle_start | Kategoria: - | Plik: - | Heartbeat: 2026-02-15T15:58:34Z  
> **Okno godzinowe:** okno=1.0h | cykli=279 | pominięte=0.0% | odrzucone=53.9% | przepustowość=567.7/h  
> **Tłumaczeń netto:** 81,481

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-15 15:58:38 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-15T15:58:34Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 30s temu | worker w trybie IDLE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-15 15:58:38 |
| TRANSLATION | 🔒 NIEAKTYWNY | 16s temu | worker w trybie IDLE | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-15T15:58:23.848433Z |
| QUALITY | 🔒 NIEAKTYWNY | 15s temu | worker w trybie IDLE | `quality_audit_latest.json` | 2026-02-15T15:58:24.692989Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-15 15:58:38 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-15T15:58:34Z
...
| ❤️ **Heartbeat** | 2026-02-15T15:58:34Z |
...
> **ETA globalne:** ~172 dni (2,337,031 kluczy do celu 95%)
...
> Świeżość: 30s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-15 15:58:38
...
> Świeżość: 16s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-15T15:58:23.848433Z
...
- **Profiler cyklu (ostatni):** cykl #101 (AUTO_TRANSLATE): dispatch 11072ms, mode 44579ms, status 4455ms, total 61597ms
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-15T14:58:39.191543Z → 2026-02-15T15:58:39.191543Z) |
| Cykle | **279** (TŁUMACZENIE=111, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **53.9%** |
| Cykle bez postępu % | **11.1%** |
| Przepustowość (kluczy/h) | **567.7 kluczy/h** |
| Podejrzane tłumaczenia | **1347** |
| Najgorsze cele (strażnik) | es/server.json (gf=300), pl/monsters.json (gf=207), pl/items.json (gf=126), es/questlog.json (gf=119), es/monsters.json (gf=106) |
...
> Świeżość: 15s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-15T15:58:24.692989Z
...
|-----------|--------|-----------|
| Worker | ✅ BEZCZYNNY | Cykl #9,287 |
| Heartbeat | 5s temu | 2026-02-15T15:58:34Z |
...
- **Ostatnia aktualizacja:** 2026-02-15T15:55:50.134473Z
...
- 2026-02-15 15:57:40 | AUTO_TRANSLATE:auto_start | pl | ok | items.json
- 2026-02-15 15:55:50 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-15 15:55:43 | AUTO_TRANSLATE:auto_done | es | ok | quests.json
- 2026-02-15 15:55:32 | AUTO_TRANSLATE:heartbeat_tick | es | ok | quests.json
...
| Przepustowość (okno) | 7,109 kluczy / 180 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-15 15:58:38
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **7,981** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 101 |
| ❌ Błędów | 290 |
| 🌍 Aktywnych języków | 6 |
| 🏆 TOP 5 | **PL** (3,954), **ES** (3,854), **EL** (68), **IT** (45), **CS** (32) |
| 📊 Porównanie | ↓ 85.4% vs wczoraj (54,494) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **109,897** kluczy
...
| 🔄 Cykli wykonanych | **#9,287** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-15 15:58:38  
