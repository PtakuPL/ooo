...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.7% / real 11.67%**. Tempo: **315.0 kluczy/h**. Tłumaczeń netto: **169,231**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-05-02 06:05:53

> **Aktualizacja:** 2026-05-02 06:05:53 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #19,319 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: tr | Plik: items.json | Heartbeat: 2026-05-02T06:00:40Z
> **Okno godzinowe:** okno=1.0h | cykli=68 | pominięte=0.0% | odrzucone=0.0% | przepustowość=315.0/h  
> **Tłumaczeń netto:** 169,231

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-05-02 06:05:53 |
| LIVE | 🟢 AKTYWNY | 5min temu | - | `activity.json / worker_state.json` | 2026-05-02T06:00:40Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 20h temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-05-02 06:05:53 |
| TRANSLATION | 🟢 AKTYWNY | 49s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-05-02T06:05:11.845403Z |
| QUALITY | 🔒 NIEAKTYWNY | 48s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-05-02T06:05:13.005660Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-05-02 06:05:53 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-05-02T06:06:01.052881Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-05-02T06:00:40Z
...
| 🔄 **Ostatni cykl** | 6 kluczy, 0 odrzuconych, 148.0s, tryb: AUTO_TRANSLATE, cel: ru/items.json |
| ❤️ **Heartbeat** | 2026-05-02T06:00:40Z |
...
|----------|------|---------|------|-------|--------|------------|--------|
| 06:05:04 | RU | Serwer | items.json | 6 | `openai:openai/gpt-4.1...` | `item.14859.name` | басальтовая стена |
| 06:00:11 | RO | Serwer | items.json | 25 | `openai:openai/gpt-4.1...` | `item.10190.name` | războinic draken mort |
| 05:57:50 | ES | Serwer | items.json | 9 | `openai:openai/gpt-4.1...` | `item.11695.name` | cobra de jade negro |
| 05:52:22 | IT | Serwer | items.json | 3 | `openai:openai/gpt-4.1...` | `item.14690.name` | cavalletto dell'artista |
| 05:50:18 | CS | Serwer | items.json | 3 | `openai:openai/gpt-4.1...` | `item.1261.name` | tic-tac-toe deska |
...
| ⏳ Oldest pending (visible tail) | 18457 s |
| 🌍 Top języki | RU(381), DE(17) |
| 🧱 Top reason_bucket | quality(381), default(17) |
| 🗂️ Deferred state keys | 9505 |
...
| 🧮 OpenAI budget | `99/250 (39.2%); policy=telemetry_only` |
| ♻️ Provider debt | `767` |
| 🌍 Recent provider mix | OpenAI model pool(103), tm_dedup_file(77), canonical_name_semantic_autofix(23), tm_dedup_propagate(3), term... |
...
| ❤️ Pool health | `degraded` (writes=207, fallbacks=22) |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 18457}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| RU | 34,375 | 74,536 | 46.12% ↓-0.13% | 4,775 |
...
> **ETA globalne:** ~391 dni (2,957,182 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| PL | ████████████████░░░░ | 84.2% | 62,753/74,536 | ~26h |
| ES | ███████████████░░░░░ | 79.9% | 59,560/74,536 | ~36h |
| RO | ███████████████░░░░░ | 78.5% | 58,478/74,536 | ~39h |
| IT | ██████████████░░░░░░ | 72.2% | 53,802/74,536 | ~2d |
| RU | █████████░░░░░░░░░░░ | 46.1% | 34,375/74,536 | ~5d |
...
> Tempo obliczone na bazie ostatniej godziny: ~315 kluczy/h.
...
> Świeżość: 20h temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-05-02 06:05:53
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 49s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-05-02T06:05:11.845403Z
...
- Raporty strażnika jakości: **5185**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **5037**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-05-02T06:05:19.420350Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.7%** (724,886/3,875,872)
- **Pokrycie globalne (real):** **11.67%** (452,504/3,875,872)
- **Kopie EN (łącznie):** **407,175**
- **Placeholdery [EN]/puste (łącznie):** **2,162,071**
...
| 🕒 Evidence window | 24h (span=33.54h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=33.54h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=+0.00pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-05-02T05:05:53.928624Z → 2026-05-02T06:05:53.928624Z) |
...
| Przepustowość (kluczy/h) | **315.0 kluczy/h** |
...
> Świeżość: 48s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-05-02T06:05:13.005660Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-05-02T06:05:13.005660Z
- **Top 5 typów problemów:** suspicious_rejected_critical=130, suspicious_log_high=123, suspicious_log_low=74, suspicious_rejected_high=70, suspicious_log_medium=2
- **Języki o najsłabszej jakości:** es(60.1, issues=762645), ro(60.1, issues=458542), ru(60.1, issues=388091), cs(60.1, issues=140427), de(60.1, issues=140310)
...
⚠️ **TR**: jakość 60%, 63396 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 762645 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 86%, 182364 problemów
⚠️ **RU**: jakość 60%, 388091 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #19,319 |
| Heartbeat | 321s temu | 2026-05-02T06:00:40Z |
...
- **Ostatnia aktualizacja:** 2026-05-02T06:00:40.251720Z
...
- 2026-05-02 06:05:20 | AUTO_TRANSLATE:heartbeat_tick | tr | ok | items.json
- 2026-05-02 06:05:20 | AUTO_TRANSLATE:auto_start | tr | ok | items.json
- 2026-05-02 06:05:12 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
- 2026-05-02 06:04:15 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-05-02 06:02:44 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-05-02 06:02:44 | AUTO_TRANSLATE:auto_start | ru | ok | items.json
...
| 🟡 ES | 79.9% | 0 | 9,501 | 1,090 | 0 (0.0%) | 28 |
...
| Przepustowość (okno) | 1,090 kluczy / 28 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-05-02 06:05:53

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [cs] → warn (files+1, translated+50, skipped+0) — lang=cs file=items.json strict_skipped_done=3690 guard_fail=6 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+56, skipped+0) — lang=ro file=items.json strict_skipped_done=1040 guard_fail=4 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **12,696** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 57 |
| ❌ Błędów | 79 |
| 🌍 Aktywnych języków | 6 |
| 🏆 TOP 5 | **RO** (7,400), **TR** (4,759), **ES** (200), **RU** (140), **IT** (125) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **45,676** kluczy
...
| 🔄 Cykli wykonanych | **#19,319** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #19,319 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-05-02 06:05:53  
