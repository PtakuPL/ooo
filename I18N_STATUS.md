...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.7% / real 11.67%**. Tempo: **243.0 kluczy/h**. Tłumaczeń netto: **168,625**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-05-02 04:10:12

> **Aktualizacja:** 2026-05-02 04:10:12 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #19,191 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ro | Plik: items.json | Heartbeat: 2026-05-02T04:07:05Z
> **Okno godzinowe:** okno=1.0h | cykli=56 | pominięte=0.0% | odrzucone=0.0% | przepustowość=243.0/h  
> **Tłumaczeń netto:** 168,625

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-05-02 04:10:12 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-05-02T04:07:05Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 18h temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-05-02 04:10:12 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-05-02T04:09:13.468650Z |
| QUALITY | 🔒 NIEAKTYWNY | 3min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-05-02T04:06:47.183447Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-05-02 04:10:12 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-05-02T04:10:21.612605Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-05-02T04:07:05Z
...
| ⏳ Oldest pending (visible tail) | 131126 s |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=118/118 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 393, 'oldest_s': 131126}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~507 dni (2,957,344 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| PL | ████████████████░░░░ | 84.2% | 62,753/74,536 | ~33h |
| ES | ███████████████░░░░░ | 79.9% | 59,560/74,536 | ~46h |
...
> Tempo obliczone na bazie ostatniej godziny: ~243 kluczy/h.
...
> Świeżość: 18h temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-05-02 04:10:12
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-05-02T04:09:13.468650Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-05-02T04:07:04.373751Z |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=31.61h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=+0.00pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-05-02T03:10:12.855586Z → 2026-05-02T04:10:12.855586Z) |
...
| Przepustowość (kluczy/h) | **243.0 kluczy/h** |
| Podejrzane tłumaczenia | **305** |
| Najgorsze cele (strażnik) | cs/items.json (gf=0), it/items.json (gf=0), es/items.json (gf=0), ro/items.json (gf=0), tr/items.json (gf=0) |
...
> Świeżość: 3min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-05-02T04:06:47.183447Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-05-02T04:06:47.183447Z
- **Top 5 typów problemów:** suspicious_rejected_critical=130, suspicious_log_high=129, suspicious_rejected_high=70, suspicious_log_low=66, suspicious_log_medium=3
- **Języki o najsłabszej jakości:** es(60.1, issues=760488), ro(60.1, issues=455823), ru(60.1, issues=385159), de(60.1, issues=138945), cs(60.1, issues=137297)
...
⚠️ **TR**: jakość 61%, 61944 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 760488 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 86%, 182119 problemów
⚠️ **RU**: jakość 60%, 385159 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #19,191 |
| Heartbeat | 196s temu | 2026-05-02T04:07:05Z |
...
- 2026-05-02 04:08:35 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-05-02 04:07:05 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-05-02 04:07:04 | AUTO_TRANSLATE:auto_start | ro | ok | items.json
- 2026-05-02 04:06:46 | AUTO_TRANSLATE:auto_done | es | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-05-02 04:10:12
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+60, skipped+0) — lang=ro file=items.json strict_skipped_done=1725
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+8) — repair_identical lang=es file=npc.json target_identical=2 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=200.81
...
| 🔄 Cykli wykonanych | **#19,191** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #19,191 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-05-02 04:10:12  
