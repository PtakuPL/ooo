...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.89%**. Tempo: **1623.7 kluczy/h**. Tłumaczeń netto: **124,600**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 21:45:51

> **Aktualizacja:** 2026-02-20 21:45:51 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #219 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: - | Heartbeat: 2026-02-20T21:45:37Z  
> **Okno godzinowe:** okno=1.0h | cykli=207 | pominięte=0.0% | odrzucone=59.5% | przepustowość=1623.7/h  
> **Tłumaczeń netto:** 124,600

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 21:45:51 |
| LIVE | 🟢 AKTYWNY | 15s temu | - | `activity.json / worker_state.json` | 2026-02-20T21:45:37Z |
| MIGRATION | 🔒 NIEAKTYWNY | 11s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 21:45:51 |
| TRANSLATION | 🟢 AKTYWNY | 15s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T21:45:36.830400Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T21:45:52.513459Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 21:45:51 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 15s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T21:45:37Z
...
| ❤️ **Heartbeat** | 2026-02-20T21:45:37Z |
...
> Świeżość: 11s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 21:45:51
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 15s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T21:45:36.830400Z
...
- This is a special blessing I can bestow upon you once you have obtained at least → Detta är en speciell välsignelse som jag kan skänka dig när du har fått åtminsto (npc.rock_with_a_soft_spot.stdmod_25)
- Keep your adventurer's stone well. → Håll din äventyrarsten väl. (npc.rock_with_a_soft_spot.stdmod_3)
- Ah, you want to replace your adventurer's stone for free? → Ah, vill du byta ut din äventyrarsten gratis? (npc.rock_with_a_soft_spot.stdmod_4)
- Here you are. Take care. → Här är du. Ta hand om dig. (npc.rock_with_a_soft_spot.stdmod_5)
- Ah, you want to replace your adventurer's stone for 30 gold? → Ah, vill du byta ut din äventyrarsten mot 30 guld? (npc.rock_with_a_soft_spot.stdmod_7)
- Here you are. Take care. → Här är du. Ta hand om dig. (npc.rock_with_a_soft_spot.stdmod_8)
- Sorry, you don't have enough money. → Tyvärr, du har inte tillräckligt med pengar. (npc.rock_with_a_soft_spot.stdmod_9)
- Don't forget to deposit your money here in the Global Bank before you head out f → Glöm inte att sätta in dina pengar här i Global Bank innan du ger dig ut på även (npc.rokyn.voice_1)
- Of course, just browse through my wares. You can also look at {}. → Naturligtvis, bara bläddra igenom mina varor. Du kan också titta på {}. (npc.romir.say_1)
- Good bye. Come back soon. → Hej då. Kom tillbaka snart. (npc.rowenna.farewell_msg_1)
- Good bye. Come back soon. → Hej då. Kom tillbaka snart. (npc.rowenna.walkaway_msg_1)
- You don't have it... → Du har det inte... (npc.sam.say_10)
- Then no. → Då nej. (npc.sam.say_15)
- Good bye and come again. → Hej då och kom igen. (npc.sam.walkaway_msg_1)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **7187**  
- Raporty blokad: **0**  
...
- **Profiler cyklu (ostatni):** cykl #219 (AUTO_TRANSLATE): dispatch 1872ms, mode 21059ms, status 5353ms, total 36191ms
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T20:45:51.737112Z → 2026-02-20T21:45:51.737112Z) |
...
| Najgorsze cele (strażnik) | es/items.json (gf=1569), pl/npc.json (gf=968), pl/items.json (gf=816), it/npc.json (gf=133), pl/spells.json (gf=87) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T21:45:52.513459Z

- **Ostatni audyt:** SLOW_MODE | 29 issue(s) / 100 entries | 2026-02-20T21:45:37.527306Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=139, suspicious_log_high=82, suspicious_log_critical=36, artifact_token=16, identical_to_en=13
- **Języki o najsłabszej jakości:** es(60.1, issues=348506), pl(60.1, issues=192912), ro(60.1, issues=188917), tl(64.2, issues=466), zh_TW(64.8, issues=337)
...
⚠️ **PL**: jakość 60%, 192912 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 348506 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 70%, 76730 problemów
⚠️ **RU**: jakość 72%, 214721 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 66%, 32192 problemów
...
| Heartbeat | 15s temu | 2026-02-20T21:45:37Z |
...
- 2026-02-20 21:45:30 | AUTO_TRANSLATE:heartbeat_tick | sv | ok | npc.json
- 2026-02-20 21:45:30 | AUTO_TRANSLATE:parallel_start | sv | ok | npc.json
- 2026-02-20 21:45:24 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | monsters.json
- 2026-02-20 21:45:24 | AUTO_TRANSLATE:parallel_start | ru | ok | monsters.json
- 2026-02-20 21:45:22 | AUTO_TRANSLATE:auto_done | it | ok | monsters.json
- 2026-02-20 21:45:16 | AUTO_TRANSLATE:heartbeat_tick | it | ok | monsters.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,830 | 638 | 4670 (88.0%) | 34 |
| 🟡 ES | 84.9% | 0 | 2,160 | 640 | 3144 (83.1%) | 40 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **124,600** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=80.17%, reason=decrease_high_fail_rate=80.2% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,278 kluczy / 74 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 21:45:51
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **17,853** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 219 |
| ❌ Błędów | 432 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (5,251), **RU** (3,519), **IT** (2,875), **RO** (2,123), **PL** (2,095) |
| 📊 Porównanie | ↑ 390.3% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **115,438** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 21:45:51  
