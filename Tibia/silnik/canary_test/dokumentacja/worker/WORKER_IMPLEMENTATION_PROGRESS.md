...
- ✅ Dopiąć dodatkowe delty dla `COMPACT_KEYS` (np. `exported_langs`) jeśli chcesz widzieć je w daily. → DONE 2026-02-14: `export_done` loguje teraz `exported_langs=...` + `count=N`.
