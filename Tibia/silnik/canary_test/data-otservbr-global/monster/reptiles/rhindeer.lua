...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "Harrumph!!", yell = false , i18nKey = "monster.rhindeer.voice_1"},
	{ text = "Destroy!", yell = false , i18nKey = "monster.rhindeer.voice_2"},
	{ text = "Snort!", yell = false , i18nKey = "monster.rhindeer.voice_3"},
}
