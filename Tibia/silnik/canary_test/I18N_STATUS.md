...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 16.59% / real 9.36%**. Tempo: **2432.0 kluczy/h**. Tłumaczeń netto: **90,323**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-29 15:55:41

> **Aktualizacja:** 2026-03-29 15:55:41 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #12,421 | Status: ✅ BEZCZYNNY | Faza: IDLE | Etap: cycle_start | Kategoria: - | Plik: - | Heartbeat: 2026-03-29T15:55:38Z  
> **Okno godzinowe:** okno=1.0h | cykli=91 | pominięte=0.0% | odrzucone=34.7% | przepustowość=2432.0/h  
> **Tłumaczeń netto:** 90,323

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-29 15:55:41 |
| LIVE | 🟢 AKTYWNY | 6s temu | - | `activity.json / worker_state.json` | 2026-03-29T15:55:38Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 48s temu | worker w trybie IDLE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-29 15:55:41 |
| TRANSLATION | 🔒 NIEAKTYWNY | 42s temu | worker w trybie IDLE | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-29T15:55:01.441680Z |
| QUALITY | 🔒 NIEAKTYWNY | 17s temu | worker w trybie IDLE | `quality_audit_latest.json` | 2026-03-29T15:55:26.090839Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-29 15:55:41 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-29T15:55:38Z
...
| ❤️ **Heartbeat** | 2026-03-29T15:55:38Z |
...
> **ETA globalne:** ~52 dni (3,038,932 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~2432 kluczy/h.
...
> Świeżość: 48s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-29 15:55:41
...
> Świeżość: 42s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-29T15:55:01.441680Z
...
- Raporty strażnika jakości: **3449**  
- Raporty blokad: **0**  
...
- **Pokrycie globalne (nominal):** **16.59%** (643,136/3,875,872)
- **Pokrycie globalne (real):** **9.36%** (362,881/3,875,872)
...
- **Profiler cyklu (ostatni):** cykl #347 (AUTO_TRANSLATE): dispatch 1005ms, mode 141059ms, status 6707ms, total 150185ms
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-29T14:55:42.102100Z → 2026-03-29T15:55:42.102100Z) |
...
| Przepustowość (kluczy/h) | **2432.0 kluczy/h** |
| Podejrzane tłumaczenia | **2223** |
...
|--------|-----------|--------|----------------|
| `gt_validate_fail_placeholder` | 246 | 65.3% | ro/npc.json (81) |
| `gt_rejected_critical` | 100 | 26.5% | it/npc.json (46) |
| `gt_validate_fail_word_salad` | 19 | 5.0% | es/server.json (16) |
| `gt_validate_fail_quality` | 12 | 3.2% | es/items.json (6) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie IDLE)  
> Świeżość: 17s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-29T15:55:26.090839Z

- **Ostatni audyt:** OK | 8 issue(s) / 100 entries | 2026-03-29T15:55:26.090839Z
- **Top 5 typów problemów:** suspicious_rejected_critical=186, suspicious_log_high=142, suspicious_log_low=26, suspicious_log_critical=20, suspicious_rejected_high=14
- **Języki o najsłabszej jakości:** es(60.1, issues=666380), pl(60.1, issues=350662), cs(60.1, issues=35045), pt(62.2, issues=28493), ro(66.1, issues=363739)
...
⚠️ **ES**: jakość 60%, 666380 problemów
⚠️ **PT**: jakość 62%, 28493 problemów
⚠️ **FR**: jakość 93%, 34843 problemów
⚠️ **IT**: jakość 66%, 129432 problemów
...
|-----------|--------|-----------|
| Worker | ✅ BEZCZYNNY | Cykl #12,421 |
| Heartbeat | 6s temu | 2026-03-29T15:55:38Z |
...
- 2026-03-29 15:55:18 | AUTO_TRANSLATE:heartbeat_tick | es | ok | otclient_modules.json
- 2026-03-29 15:55:01 | AUTO_TRANSLATE:auto_done | it | ok | npc.json
- 2026-03-29 15:54:35 | AUTO_TRANSLATE:heartbeat_tick | it | ok | npc.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-29 15:55:41
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **29,003** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 331 |
| ❌ Błędów | 586 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **IT** (4,960), **CS** (4,433), **TR** (3,366), **FR** (3,232), **NL** (3,170) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **77,370** kluczy
...
| 🔄 Cykli wykonanych | **#12,421** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #12,421 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-29 15:55:41  
