...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.98% / real 10.9%**. Tempo: **904.0 kluczy/h**. Tłumaczeń netto: **143,611**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 06:45:13

> **Aktualizacja:** 2026-04-29 06:45:13 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,904 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: de | Plik: otclient_modules.json | Heartbeat: 2026-04-29T06:42:43Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=4.3% | przepustowość=904.0/h  
> **Tłumaczeń netto:** 143,611

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 06:45:13 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T06:42:43Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 53s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 06:45:13 |
| TRANSLATION | 🟢 AKTYWNY | 4min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T06:40:57.179666Z |
| QUALITY | 🔒 NIEAKTYWNY | 45s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T06:44:34.121760Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 06:45:13 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T06:45:19.989279Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T06:42:43Z
...
| 🔄 **Ostatni cykl** | 19 kluczy, 0 odrzuconych, 76.0s, tryb: AUTO_TRANSLATE, cel: es/items.json |
| ❤️ **Heartbeat** | 2026-04-29T06:42:43Z |
...
| ⏳ Oldest pending (visible tail) | 17228 s |
...
| 🌍 Recent provider mix | TM/simple(295), Free Google Translate(153), canonical_name_semantic_autofix(20), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=471, fallbacks=27) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=748/748 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 17228}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~138 dni (2,985,014 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~904 kluczy/h.
...
> Świeżość: 53s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 06:45:13
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 4min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T06:40:57.179666Z
...
- Raporty strażnika jakości: **4823**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4676**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T06:45:02.973993Z |
...
| 🕒 Evidence window | 24h (span=35.88h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=35.88h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T05:45:13.893193Z → 2026-04-29T06:45:13.893193Z) |
...
| Przepustowość (kluczy/h) | **904.0 kluczy/h** |
| Podejrzane tłumaczenia | **1106** |
| Najgorsze cele (strażnik) | cs/items.json (gf=20), ro/items.json (gf=12), it/items.json (gf=3), de/otclient_modules.json (gf=2), de/npc.json (gf=2) |
...
> Świeżość: 45s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T06:44:34.121760Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T06:44:34.121760Z
- **Top 5 typów problemów:** suspicious_rejected_critical=188, suspicious_log_high=121, suspicious_log_low=77, suspicious_rejected_high=12, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=737424), ro(60.1, issues=435138), de(60.1, issues=117701), cs(60.1, issues=98719), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 737424 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 63%, 174018 problemów
⚠️ **RU**: jakość 61%, 365622 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,904 |
| Heartbeat | 156s temu | 2026-04-29T06:42:43Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T06:41:12.029830Z
...
- 2026-04-29 06:45:03 | AUTO_TRANSLATE:auto_start | de | ok | otclient_modules.json
- 2026-04-29 06:44:13 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 06:42:43 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 06:41:12 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 06:40:57 | AUTO_TRANSLATE:auto_done | es | ok | items.json
...
| 🟡 ES | 79.0% | 0 | 9,703 | 557 | 0 (0.0%) | 26 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **143,611** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=4.63%, reason=increase_low_fail_rate=4.6%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 06:45:13

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [tr] → warn (files+1, translated+53, skipped+0) — lang=tr file=items.json strict_skipped_done=848
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **5,864** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 134 |
| ❌ Błędów | 241 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,163), **RU** (1,075), **IT** (838), **DE** (765), **TR** (762) |
| 📊 Porównanie | ↓ 28.7% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **24,844** kluczy
...
| 🔄 Cykli wykonanych | **#17,904** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,904 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 06:45:13  
