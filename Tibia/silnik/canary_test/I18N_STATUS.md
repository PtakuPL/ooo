...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.64%**. Tempo: **1690.7 kluczy/h**. Tłumaczeń netto: **105,385**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-17 08:49:11

> **Aktualizacja:** 2026-02-17 08:49:11 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #388 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: pl | Plik: otclient_modules.json | Heartbeat: 2026-02-17T08:48:55Z  
> **Okno godzinowe:** okno=1.0h | cykli=144 | pominięte=0.0% | odrzucone=45.9% | przepustowość=1690.7/h  
> **Tłumaczeń netto:** 105,385

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-17 08:49:11 |
| LIVE | 🟢 AKTYWNY | 18s temu | - | `activity.json / worker_state.json` | 2026-02-17T08:48:55Z |
| MIGRATION | 🔒 NIEAKTYWNY | 13s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-17 08:49:11 |
| TRANSLATION | 🟢 AKTYWNY | 20s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-17T08:48:53.706147Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-17T08:48:04.975477Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-17 08:49:11 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 18s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-17T08:48:55Z
...
> **ETA globalne:** ~56 dni (2,266,971 kluczy do celu 95%)
...
> Świeżość: 13s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-17 08:49:11
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 20s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-17T08:48:53.706147Z
...
- I will be still around when my 'noble' race is gone. → Још увек ћу бити ту када моја трка 'noble' нестане. (monster.zevelon_duskbringer.voice_3)
- Munster → __ПХ0__ (monster.munster.name)
- Munster → __ПХ0__ (monster.munster.desc)
- Teleskor → __ПХ0__ (monster.teleskor.name)
- Teleskor → __ПХ0__ (monster.teleskor.desc)
- Ahkahra exura belil mort! → Ахкахра exura белил морт! (monster.mummy.voice_11)
- klonk klonk klonk → клонк клонк клонк (monster.training_machine.voice_15)
- Bssssss → Бсссссс (monster.wasp.voice_2)
- Apprentice Sheng → Шегрт __ПХ0__ (monster.apprentice_sheng.name)
- Apprentice Sheng → Шегрт __ПХ0__ (monster.apprentice_sheng.desc)
- Cyclops Drone → __ПХ0__ Дрон (monster.cyclops_drone.name)
- Cyclops Smith → __ПХ0__ Смитх (monster.cyclops_smith.name)
- Azerus barada nikto! → __ПХ0__ барада никто! (monster.war_golem.voice_1)
- Metal Gargoyle → Метал __ПХ0__ (monster.metal_gargoyle.name)
- Error. LOAD 'PROGRAM',8,1 → Грешка. ЛОАД __ПХ0__,8,1 (monster.diamond_servant.voice_1)
- Error. LOAD 'PROGRAM',8,1 → Грешка. ЛОАД __ПХ0__,8,1 (monster.iron_servant.voice_1)
- Error. LOAD 'PROGRAM',8,1 → Грешка. ЛОАД __ПХ0__,8,1 (monster.golden_servant.voice_1)
- Kzzchhhh → Кззцхххх (monster.acid_blob.voice_1)
- Brrr → Бррр (monster.frost_troll.voice_1)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **3354**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3283**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **13.64%** (380,141/2,786,472)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-17T07:49:11.835709Z → 2026-02-17T08:49:11.835709Z) |
...
| Przepustowość (kluczy/h) | **1690.7 kluczy/h** |
| Podejrzane tłumaczenia | **8728** |
| Najgorsze cele (strażnik) | pl/items.json (gf=822), pl/npc.json (gf=605), es/books.json (gf=96), ro/spells.json (gf=82), es/questlog.json (gf=78) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-17T08:48:04.975477Z
...
| Metryka | Wartość | Info |
|---------|---------|------|
| 🔄 Cykl aktualny | **#388** | od uruchomienia |
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #388 |
| Heartbeat | 18s temu | 2026-02-17T08:48:55Z |
...
- 2026-02-17 08:48:55 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | otclient_modules.json
- 2026-02-17 08:48:55 | AUTO_TRANSLATE:parallel_start | pl | ok | otclient_modules.json
- 2026-02-17 08:48:34 | AUTO_TRANSLATE:heartbeat_tick | sr | ok | monsters.json
- 2026-02-17 08:48:34 | AUTO_TRANSLATE:parallel_start | sr | ok | monsters.json
- 2026-02-17 08:48:32 | AUTO_TRANSLATE:auto_done | sv | ok | monsters.json
- 2026-02-17 08:48:29 | AUTO_TRANSLATE:heartbeat_tick | sv | ok | monsters.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **105,385** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=27.16%, reason=decrease_high_fail_rate=27.2% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-17 08:49:11
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+32, skipped+0) — lang=pl file=otclient_modules.json strict_skipped_done=1419 guard_fail=7 placeholder=0 command=1 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **33,357** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 327 |
| ❌ Błędów | 568 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (6,964), **IT** (6,135), **RU** (5,962), **RO** (5,418), **PL** (4,228) |
| 📊 Porównanie | ↑ 64.4% vs wczoraj (20,288) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **133,551** kluczy
...
| 🔄 Cykli wykonanych | **#388** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-17 08:49:11  
