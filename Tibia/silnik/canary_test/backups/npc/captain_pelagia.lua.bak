...
local function addTravelKeyword(keyword, cost, destination)
	local travelKeyword = keywordHandler:addKeyword({ keyword }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.captain_pelagia.stdmod_2", i18nArgs = { keyword:titleCase() }, cost = cost, discount = "postman" })
