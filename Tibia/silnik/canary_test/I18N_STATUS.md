...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **11.13%**. Tempo: **255.4 kluczy/h**. Tłumaczeń netto: **81,549**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-15 18:47:11

> **Aktualizacja:** 2026-02-15 18:47:11 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #9,574 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: pl | Plik: - | Heartbeat: 2026-02-15T18:47:03Z  
> **Okno godzinowe:** okno=1.0h | cykli=246 | pominięte=0.0% | odrzucone=59.0% | przepustowość=255.4/h  
> **Tłumaczeń netto:** 81,549

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-15 18:47:11 |
| LIVE | 🟢 AKTYWNY | 9s temu | - | `activity.json / worker_state.json` | 2026-02-15T18:47:03Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-15 18:47:11 |
| TRANSLATION | 🟢 AKTYWNY | 3min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-15T18:43:37.823949Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-15T18:45:42.261355Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-15 18:47:11 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 9s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-15T18:47:03Z
...
| ❤️ **Heartbeat** | 2026-02-15T18:47:03Z |
...
| Metryka | Wartość |
|---------|---------|
| � PRE_MIGRATION cykli | **195** (kategorii przeskanowanych: 21) |
...
> **ETA globalne:** ~381 dni (2,337,031 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| PL | █████████████████░░░ | 87.5% | 46,891/53,586 | ~16h |
| ES | ████████████████░░░░ | 84.1% | 45,088/53,586 | ~23h |
| RU | ██████░░░░░░░░░░░░░░ | 33.9% | 18,142/53,586 | ~5d |
| FR | ██████░░░░░░░░░░░░░░ | 33.3% | 17,855/53,586 | ~5d |
| RO | ███░░░░░░░░░░░░░░░░░ | 16.3% | 8,725/53,586 | ~7d |
| ZH_TW | ██░░░░░░░░░░░░░░░░░░ | 14.1% | 7,565/53,586 | ~7d |
...
> Tempo obliczone na bazie ostatniej godziny: ~255 kluczy/h.
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-15 18:47:11
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-15T18:43:37.823949Z
...
- Raporty strażnika jakości: **2802**  
- Raporty blokad: **0**  
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-15T17:47:11.479106Z → 2026-02-15T18:47:11.479106Z) |
| Cykle | **246** (TŁUMACZENIE=51, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **59.0%** |
| Cykle bez postępu % | **21.4%** |
| Przepustowość (kluczy/h) | **255.4 kluczy/h** |
| Podejrzane tłumaczenia | **711** |
| Najgorsze cele (strażnik) | es/server.json (gf=300), es/monsters.json (gf=106), pl/monsters.json (gf=69), pl/items.json (gf=42), pl/scripts.json (gf=35) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-15T18:45:42.261355Z

- **Ostatni audyt:** SLOW_MODE | 21 issue(s) / 100 entries | 2026-02-15T18:45:42.261355Z
- **Top 5 typów problemów:** suspicious_rejected_critical=200, suspicious_log_high=170, suspicious_log_medium=30, identical_to_en_exempt=16, artifact_token=16
- **Języki o najsłabszej jakości:** es(60.1, issues=252094), pl(60.1, issues=173230), tl(64.2, issues=466), zh_TW(64.8, issues=337), fr(66.5, issues=2470)
...
⚠️ **PL**: jakość 60%, 173230 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 252094 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #9,574 |
| Heartbeat | 9s temu | 2026-02-15T18:47:03Z |
...
- 2026-02-15 18:43:08 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | scripts.json
- 2026-02-15 18:42:56 | AUTO_TRANSLATE:auto_start | pl | ok | scripts.json
- 2026-02-15 18:31:03 | AUTO_TRANSLATE:auto_done | pl | ok | quests.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.5% | 0 | 2,329 | 3,917 | 2869 (42.3%) | 84 |
| 🟡 ES | 84.1% | 0 | 2,623 | 3,409 | 6224 (64.6%) | 96 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **81,549** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=55.12%, reason=decrease_high_fail_rate=55.1% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 7,326 kluczy / 180 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-15 18:47:11
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+11) — repair_identical lang=es file=npc.json target_identical=11 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=67.06
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+22, skipped+0) — lang=pl file=scripts.json strict_skipped_done=2148 guard_fail=35 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **8,209** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 93 |
| ❌ Błędów | 302 |
| 🌍 Aktywnych języków | 6 |
| 🏆 TOP 5 | **PL** (4,071), **ES** (3,965), **EL** (68), **IT** (45), **CS** (32) |
| 📊 Porównanie | ↓ 84.9% vs wczoraj (54,494) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **110,125** kluczy
...
| 🔄 Cykli wykonanych | **#9,574** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-15 18:47:11  
