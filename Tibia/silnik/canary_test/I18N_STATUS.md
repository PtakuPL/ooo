...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.11% / real 9.95%**. Tempo: **645.6 kluczy/h**. Tłumaczeń netto: **110,434**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-09 18:36:31

> **Aktualizacja:** 2026-04-09 18:36:31 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #13,556 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ro | Plik: npc.json | Heartbeat: 2026-04-09T18:35:19Z  
> **Okno godzinowe:** okno=1.0h | cykli=54 | pominięte=0.0% | odrzucone=42.0% | przepustowość=645.6/h  
> **Tłumaczeń netto:** 110,434

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-09 18:36:31 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-09T18:35:19Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 38s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-09 18:36:31 |
| TRANSLATION | 🟢 AKTYWNY | 4min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-09T18:32:21.962800Z |
| QUALITY | 🔒 NIEAKTYWNY | 3min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-09T18:33:10.828566Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-09 18:36:31 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-09T18:35:19Z
...
| ❤️ **Heartbeat** | 2026-04-09T18:35:19Z |
...
> **ETA globalne:** ~195 dni (3,018,910 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 77.7% | 57,891/74,536 | ~20h |
| PL | ██████████████░░░░░░ | 70.8% | 52,749/74,536 | ~28h |
| IT | █████████████░░░░░░░ | 65.5% | 48,801/74,536 | ~34h |
| RO | ████████████░░░░░░░░ | 64.7% | 48,206/74,536 | ~35h |
| RU | ████████░░░░░░░░░░░░ | 41.8% | 31,177/74,536 | ~3d |
| FR | ███████████░░░░░░░░░ | 55.5% | 41,396/74,536 | ~46h |
| SR | ██████░░░░░░░░░░░░░░ | 33.3% | 24,827/74,536 | ~3d |
| CS | ████████░░░░░░░░░░░░ | 44.4% | 33,070/74,536 | ~2d |
| PT | ██████████████░░░░░░ | 74.0% | 55,186/74,536 | ~24h |
| NL | ██████████████░░░░░░ | 71.5% | 53,259/74,536 | ~27h |
| TR | █████░░░░░░░░░░░░░░░ | 25.5% | 19,032/74,536 | ~3d |
| DE | █████████████░░░░░░░ | 67.2% | 50,072/74,536 | ~32h |
...
> Świeżość: 38s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-09 18:36:31
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 4min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-09T18:32:21.962800Z
...
- Raporty strażnika jakości: **3732**  
- Raporty blokad: **0**  
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 280 | 0 | 0 | - | 2026-04-09T18:33:53.997649Z |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-09T17:36:31.795342Z → 2026-04-09T18:36:31.795342Z) |
...
| Przepustowość (kluczy/h) | **645.6 kluczy/h** |
| Podejrzane tłumaczenia | **1183** |
| Najgorsze cele (strażnik) | pl/monsters.json (gf=113), tr/monsters.json (gf=112), es/monsters.json (gf=55), cs/items.json (gf=54), es/server.json (gf=28) |
...
|--------|-----------|--------|----------------|
| `gt_validate_fail_placeholder` | 257 | 36.3% | pl/npc.json (127) |
| `gt_rejected_critical` | 244 | 34.5% | pl/monsters.json (52) |
| `gt_validate_fail_word_salad` | 123 | 17.4% | es/npc.json (21) |
| `gt_rejected_high_partial_translation_mix` | 29 | 4.1% | es/monsters.json (15) |
| `gt_rejected_high_cyrillic_latin_mix` | 19 | 2.7% | ru/server.json (16) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 3min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-09T18:33:10.828566Z

- **Ostatni audyt:** OK | 1 issue(s) / 100 entries | 2026-04-09T18:33:10.828566Z
- **Top 5 typów problemów:** suspicious_rejected_critical=156, suspicious_log_high=144, suspicious_log_medium=50, suspicious_rejected_high=44, suspicious_log_critical=6
- **Języki o najsłabszej jakości:** es(60.1, issues=684140), nl(60.1, issues=32306), pt(60.1, issues=31826), it(60.5, issues=141841), pl(60.7, issues=368129)
...
⚠️ **PL**: jakość 61%, 368129 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 684140 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #13,556 |
| Heartbeat | 78s temu | 2026-04-09T18:35:19Z |
...
- 2026-04-09 18:35:19 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | npc.json
- 2026-04-09 18:33:52 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | npc.json
- 2026-04-09 18:33:54 | AUTO_TRANSLATE:auto_start | ro | ok | npc.json
- 2026-04-09 18:32:47 | AUTO_TRANSLATE:heartbeat_tick | es | ok | talkactions.json
- 2026-04-09 18:32:22 | AUTO_TRANSLATE:auto_done | es | ok | server.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-09 18:36:31
...
| ❌ Błędów | 27 |
| 🌍 Aktywnych języków | 5 |
| 🏆 TOP 5 | **TR** (295), **ES** (195), **CS** (83), **RU** (60), **PL** (29) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **2,126** kluczy
...
| 🔄 Cykli wykonanych | **#13,556** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #13,556 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-09 18:36:31  
