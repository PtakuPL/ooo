...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.48%**. Tempo: **2017.9 kluczy/h**. Tłumaczeń netto: **92,858**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-17 03:08:56

> **Aktualizacja:** 2026-02-17 03:08:56 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #188 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ro | Plik: - | Heartbeat: 2026-02-17T03:08:52Z  
> **Okno godzinowe:** okno=1.0h | cykli=157 | pominięte=0.0% | odrzucone=41.4% | przepustowość=2017.9/h  
> **Tłumaczeń netto:** 92,858

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-17 03:08:56 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-17T03:08:52Z |
| MIGRATION | 🔒 NIEAKTYWNY | 30s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-17 03:08:56 |
| TRANSLATION | 🟢 AKTYWNY | 5s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-17T03:08:51.771969Z |
| QUALITY | 🔒 NIEAKTYWNY | 5s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-17T03:08:52.491554Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-17 03:08:56 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-17T03:08:52Z
...
| ❤️ **Heartbeat** | 2026-02-17T03:08:52Z |
...
> **ETA globalne:** ~49 dni (2,355,024 kluczy do celu 95%)
...
> Świeżość: 30s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-17 03:08:56
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-17T03:08:51.771969Z
...
| RO (Rumuński) | 12,471/53,586 | 23.27% | 2,424 | 0 |
...
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2769**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **10.48%** (292,088/2,786,472)
...
| RO | 12,031/49,731 | 24.2% | 440/3,855 | 11.4% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-17T02:08:56.318031Z → 2026-02-17T03:08:56.318031Z) |
...
| Przepustowość (kluczy/h) | **2017.9 kluczy/h** |
| Podejrzane tłumaczenia | **11729** |
...
> Świeżość: 5s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-17T03:08:52.491554Z

- **Ostatni audyt:** OK | 7 issue(s) / 100 entries | 2026-02-17T03:08:52.491554Z
- **Top 5 typów problemów:** suspicious_log_high=200, suspicious_rejected_critical=173, suspicious_rejected_high=27, identical_to_en_exempt=10, artifact_token=7
- **Języki o najsłabszej jakości:** es(60.1, issues=187750), ro(60.2, issues=33916), ru(60.2, issues=26453), it(60.2, issues=9807), pl(60.5, issues=123588)
...
⚠️ **PL**: jakość 60%, 123588 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 187750 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 9807 problemów
⚠️ **RU**: jakość 60%, 26453 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 84%, 8038 problemów
...
| Heartbeat | 5s temu | 2026-02-17T03:08:52Z |
...
- 2026-02-17 03:08:48 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-02-17 03:08:48 | AUTO_TRANSLATE:parallel_start | ru | ok | items.json
- 2026-02-17 03:08:43 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-02-17 03:08:43 | AUTO_TRANSLATE:parallel_start | it | ok | items.json
- 2026-02-17 03:08:41 | AUTO_TRANSLATE:auto_done | ro | ok | npc.json
- 2026-02-17 03:08:31 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | npc.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **92,858** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=74.34%, reason=decrease_high_fail_rate=74.3% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-17 03:08:56
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [de] → ok (files+1, translated+0, skipped+21) — lang=de file=actions.json
- 🌍 TRANSLATION_SYNC: SYNC_FILE_DONE [el] → ok (keys+5, files+1) — lang=el file=npc.json
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **13,328** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 127 |
| ❌ Błędów | 215 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (2,727), **IT** (2,417), **RU** (2,305), **RO** (2,093), **PL** (1,918) |
| 📊 Porównanie | ↓ 34.3% vs wczoraj (20,288) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **113,522** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-17 03:08:56  
