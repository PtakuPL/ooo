...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.99% / real 10.92%**. Tempo: **779.0 kluczy/h**. Tłumaczeń netto: **144,390**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 07:49:21

> **Aktualizacja:** 2026-04-29 07:49:21 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,996 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: de | Plik: otclient_modules.json | Heartbeat: 2026-04-29T07:47:35Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=5.2% | przepustowość=779.0/h  
> **Tłumaczeń netto:** 144,390

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 07:49:21 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T07:47:35Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 41s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 07:49:21 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T07:48:13.971396Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T07:47:35.039244Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 07:49:21 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T07:49:27.824185Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T07:47:35Z
...
| ❤️ **Heartbeat** | 2026-04-29T07:47:35Z |
...
| 07:36:36 | CS | Serwer | items.json | 41 | `simple` | `item.14313.name` | REZERVOVANÝ SPRITE |
| 07:34:48 | RU | Serwer | items.json | 30 | `simple` | `item.13761.name` | листья |
| 07:33:04 | ES | Serwer | server.json | 2 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 07:31:12 | TR | Serwer | items.json | 41 | `simple` | `item.12953.name` | kovan yapısı |
...
|----------|------|---------|-----------|-------|----------|--------------|-----|
| 07:48:07 | DE | Klient | otclient_modules.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `otclient_modules.charms.tr_34` |
| 07:43:06 | IT | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 07:41:12 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10193.name` |
| 07:41:10 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10192.name` |
| 07:41:07 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10191.name` |
| 07:41:05 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10190.name` |
| 07:38:42 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.say_2` |
| 07:36:18 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.14250.name` |
| 07:36:18 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.14077.name` |
| 07:36:16 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.14023.name` |
| 07:36:13 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.11586.name` |
| 07:36:08 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 07:36:04 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10456.name` |
| 07:36:02 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10338.name` |
| 07:36:00 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10026.name` |
| 07:34:20 | RU | Serwer | items.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `item.11541.name` |
...
| 📨 Pending queue (visible tail) | 394 z ostatnich 400 poprawnych wpisów JSONL |
| ⏳ Oldest pending (visible tail) | 16833 s |
| 🌍 Top języki | RU(391), CS(3) |
| 🧱 Top reason_bucket | quality(391), default(3) |
| 🗂️ Deferred state keys | 8048 |
| 🕒 Deferred state freshness | fresh (70s) |
...
| 🌍 Recent provider mix | TM/simple(327), Free Google Translate(147), canonical_name_semantic_autofix(20), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=497, fallbacks=27) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=798/798 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
|-------|--------|----------|-------|-----------|--------|
| `HEARTBEAT_STALE` | OK | OK | `71` | `300` | Heartbeat świeży (71s, src=worker_runtime_heartbeat) Runtime[status=healthy, reason=heartbeat_fresh, phase=... |
| `NO_WRITE` | OK | OK | `77` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 394, 'oldest_s': 16833}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| �📊 Przetłumaczono | **779** kluczy |
| ❌ Odrzucone (guard) | 43 |
| 🔁 Cykli | 84 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | TR (192 kluczy) |
| 📄 Najczęstszy plik | items.json |
| ⚡ Przepustowość | ~779 kluczy/h |
| 🛡️ Odrzucone (strażnik) | 5.2% |
| ⚠️ Podejrzane | 1148 |
...
> Tempo obliczone na bazie ostatniej godziny: ~779 kluczy/h.
...
> Świeżość: 41s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 07:49:21
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T07:48:13.971396Z
...
|-------|-----------|--------|----------|--------------|--------------|
| ES (Hiszpański) | 79.01% (58,890/74,536) | 67.88% (50,597/74,536) | 9,682 | 14,281 | 0 |
| PL (Polski) | 70.99% (52,911/74,536) | 65.08% (48,507/74,536) | 5,861 | 20,194 | 0 |
| IT (Włoski) | 70.36% (52,443/74,536) | 62.14% (46,319/74,536) | 10,028 | 18,214 | 0 |
| RO (Rumuński) | 69.73% (51,972/74,536) | 56.69% (42,253/74,536) | 13,005 | 19,303 | 0 |
| RU (Rosyjski) | 45.98% (34,273/74,536) | 44.41% (33,103/74,536) | 4,775 | 36,676 | 0 |
...
| CS (Czeski) | 50.54% (37,667/74,536) | 32.76% (24,421/74,536) | 29,858 | 20,283 | 0 |
...
| TR (Turecki) | 34.38% (25,623/74,536) | 30.89% (23,026/74,536) | 3,832 | 47,692 | 0 |
...
- Raporty strażnika jakości: **4847**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4700**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T07:47:54.455127Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.99%** (697,450/3,875,872)
- **Pokrycie globalne (real):** **10.92%** (423,057/3,875,872)
- **Kopie EN (łącznie):** **410,480**
- **Placeholdery [EN]/puste (łącznie):** **2,188,213**
...
| 🕒 Evidence window | 24h (span=36.95h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=36.95h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T06:49:21.601456Z → 2026-04-29T07:49:21.601456Z) |
| Cykle | **84** (TŁUMACZENIE=84, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **5.2%** |
| Cykle bez postępu % | **0.0%** |
| Przepustowość (kluczy/h) | **779.0 kluczy/h** |
| Podejrzane tłumaczenia | **1148** |
| Najgorsze cele (strażnik) | cs/items.json (gf=24), ro/items.json (gf=8), ru/items.json (gf=3), it/items.json (gf=3), de/otclient_modules.json (gf=3) |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 85 | 82.5% | ru/items.json (85) |
| `existing_canonical_name_quality_mixed_scripts` | 11 | 10.7% | ru/items.json (11) |
| `retry_loop_cooldown_default` | 6 | 5.8% | cs/items.json (4) |
| `gt_validate_fail_identical_to_en` | 1 | 1.0% | cs/items.json (1) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T07:47:35.039244Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T07:47:35.039244Z
- **Top 5 typów problemów:** suspicious_rejected_critical=188, suspicious_log_high=110, suspicious_log_low=88, suspicious_rejected_high=12, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=739402), ro(60.1, issues=436591), de(60.1, issues=119182), cs(60.1, issues=101584), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 66%, 55531 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 739402 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 63%, 174775 problemów
⚠️ **RU**: jakość 61%, 367041 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,996 |
| Heartbeat | 112s temu | 2026-04-29T07:47:35Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T07:48:28.931831Z
...
- 2026-04-29 07:48:29 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 07:48:14 | AUTO_TRANSLATE:auto_done | de | ok | otclient_modules.json
- 2026-04-29 07:47:55 | AUTO_TRANSLATE:heartbeat_tick | de | ok | otclient_modules.json
- 2026-04-29 07:47:55 | AUTO_TRANSLATE:auto_start | de | ok | otclient_modules.json
- 2026-04-29 07:47:34 | AUTO_TRANSLATE:auto_done | es | ok | items.json
- 2026-04-29 07:46:08 | AUTO_TRANSLATE:heartbeat_tick | es | ok | items.json
...
| 🟡 ES | 79.0% | 0 | 9,682 | 561 | 0 (0.0%) | 26 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **144,390** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=5.47%, reason=stable_fail_rate=5.5%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 561 kluczy / 26 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 07:49:21
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+6) — repair_identical lang=es file=npc.json target_identical=2 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=183.52
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **6,720** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 158 |
| ❌ Błędów | 283 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,298), **RU** (1,189), **TR** (954), **IT** (935), **DE** (915) |
| 📊 Porównanie | ↓ 18.3% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **25,700** kluczy
...
| 🔄 Cykli wykonanych | **#17,996** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,996 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 07:49:21  
