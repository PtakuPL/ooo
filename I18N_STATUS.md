...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.88%**. Tempo: **1377.3 kluczy/h**. Tłumaczeń netto: **121,163**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 20:09:20

> **Aktualizacja:** 2026-02-20 20:09:20 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #139 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ru | Plik: - | Heartbeat: 2026-02-20T20:09:16Z  
> **Okno godzinowe:** okno=1.0h | cykli=197 | pominięte=0.0% | odrzucone=70.7% | przepustowość=1377.3/h  
> **Tłumaczeń netto:** 121,163

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 20:09:20 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T20:09:16Z |
| MIGRATION | 🔒 NIEAKTYWNY | 26s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 20:09:20 |
| TRANSLATION | 🟢 AKTYWNY | 38s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T20:08:42.918883Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T20:09:21.617164Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 20:09:20 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T20:09:16Z
...
| ❤️ **Heartbeat** | 2026-02-20T20:09:16Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **2,428** kluczy |
| ❌ Odrzucone (guard) | 5849 |
| 🔁 Cykli | 197 |
| 🌍 Języków | 7 |
...
> Świeżość: 26s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 20:09:20
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 38s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T20:08:42.918883Z
...
- Raporty strażnika jakości: **6983**  
- Raporty blokad: **0**  
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T19:09:20.927506Z → 2026-02-20T20:09:20.927506Z) |
...
| Przepustowość (kluczy/h) | **1377.3 kluczy/h** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T20:09:21.617164Z

- **Ostatni audyt:** SLOW_MODE | 32 issue(s) / 100 entries | 2026-02-20T20:09:16.750015Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=100, suspicious_log_high=62, suspicious_log_critical=44, artifact_token=32, suspicious_rejected_high=30
- **Języki o najsłabszej jakości:** es(60.1, issues=337184), pl(60.1, issues=188506), ro(60.1, issues=183639), sr(62.8, issues=86650), ru(63.4, issues=213036)
...
⚠️ **PL**: jakość 60%, 188506 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 337184 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 64%, 75214 problemów
⚠️ **RU**: jakość 63%, 213036 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 80%, 30927 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #139 |
| Heartbeat | 5s temu | 2026-02-20T20:09:16Z |
...
- 2026-02-20 20:08:50 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 20:08:33 | AUTO_TRANSLATE:heartbeat_tick | it | ok | quests.json
- 2026-02-20 20:08:33 | AUTO_TRANSLATE:parallel_start | it | ok | quests.json
- 2026-02-20 20:08:32 | AUTO_TRANSLATE:auto_done | ru | ok | spells.json
- 2026-02-20 20:08:19 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | spells.json
- 2026-02-20 20:08:19 | AUTO_TRANSLATE:auto_start | ru | ok | spells.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **121,163** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=40.07%, reason=decrease_high_fail_rate=40.1% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 20:09:20
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+43, skipped+0) — lang=es file=npc.json strict_skipped_done=10129 guard_fail=7 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+41, skipped+0) — parallel lang=es file=monsters.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+41, skipped+0) — lang=pl file=monsters.json strict_skipped_done=2161
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **12,621** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 139 |
| ❌ Błędów | 299 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (3,691), **RU** (2,485), **IT** (2,069), **RO** (1,534), **PL** (1,447) |
| 📊 Porównanie | ↑ 246.6% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **110,206** kluczy
...
| 🔄 Cykli wykonanych | **#139** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 20:09:20  
