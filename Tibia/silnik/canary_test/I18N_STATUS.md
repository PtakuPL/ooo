...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **18.63%**. Tempo: **1440.4 kluczy/h**. Tłumaczeń netto: **44,066**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-23 03:11:52

> **Aktualizacja:** 2026-03-23 03:11:52 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **LIVE:** Cykl #9,426 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: auto_done | Kategoria: pt | Plik: quests.json | Heartbeat: 2026-03-23T03:11:41Z  
> **Okno godzinowe:** okno=1.0h | cykli=72 | pominięte=0.0% | odrzucone=6.9% | przepustowość=1440.4/h  
> **Tłumaczeń netto:** 44,066

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-23 03:11:52 |
| LIVE | 🟢 AKTYWNY | 12s temu | - | `activity.json / worker_state.json` | 2026-03-23T03:11:41Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 57s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-23 03:11:52 |
| TRANSLATION | 🟢 AKTYWNY | 12s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-23T03:11:41.127151Z |
| QUALITY | 🔒 NIEAKTYWNY | 29s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-23T03:11:24.086289Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-23 03:11:52 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 12s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-23T03:11:41Z
...
| ❤️ **Heartbeat** | 2026-03-23T03:11:41Z |
...
> Świeżość: 57s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-23 03:11:52
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 12s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-23T03:11:41.127151Z
...
- You are playing the Peacock Ballad and the portal opens. → Você está tocando Peacock Ballad e o portal se abre. (quests.actions_bonefiddle.msg_2)
- The remains of the Raging Mage are scattered on the floor of his Tower. \z
	The  → Os restos mortais do Raging Mage estão espalhados no chão de sua Torre. \z
	O po (quests.creaturescripts_raging_mage_2.broadcast_2)
- The remains of the Raging Mage are scattered on the floor of his Tower. The dime → Os restos mortais do Raging Mage estão espalhados no chão de sua Torre. O portal (quests.creaturescripts_raging_mage_kill.broadcast_2)
- ARGG! TORTURE IT!! KILL IT SLOWLY MY MINION!! → ARGG! TORTURE-O!! MATA LENTAMENTE MEU MINION!! (quests.demon_oak.sound_9)
- <clong!> <clong!> <scrit scrit scrit>This should do it. → <clong!> <clong!> <scrit scrit scrit>Isso deve bastar. (quests.oramond.sewer_fix_2)
- Use on Silencer Plateau is located in the south-eastern part of Roshamuul → O uso no Silencer Plateau está localizado na parte sudeste de Roshamuul (quests.roshamuul_quest.use_on_silencer_plateau_is_located)
- You have defeated Goshnar's Megalomania. Report the 'task' to Flickering Soul an → Você derrotou a Megalomania de Goshnar. Reporte o 'task' para Flickering Soul e  (quests.soul_war.megalomania_report)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-23T02:11:52.442498Z → 2026-03-23T03:11:52.442498Z) |
...
| Przepustowość (kluczy/h) | **1440.4 kluczy/h** |
...
> Świeżość: 29s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-23T03:11:24.086289Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-03-23T03:11:24.086289Z
- **Top 5 typów problemów:** suspicious_rejected_critical=182, suspicious_log_high=140, suspicious_log_medium=60, suspicious_rejected_high=18, identical_to_en_exempt=2
- **Języki o najsłabszej jakości:** es(60.1, issues=573585), it(60.1, issues=108841), nl(60.1, issues=8879), pt(60.2, issues=16329), ru(63.3, issues=285494)
...
⚠️ **TR**: jakość 68%, 3717 problemów
⚠️ **PL**: jakość 94%, 325644 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 573585 problemów
⚠️ **PT**: jakość 60%, 16329 problemów
⚠️ **FR**: jakość 77%, 15668 problemów
⚠️ **IT**: jakość 60%, 108841 problemów
⚠️ **RU**: jakość 63%, 285494 problemów
⚠️ **NL**: jakość 60%, 8879 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #9,426 |
| Heartbeat | 12s temu | 2026-03-23T03:11:41Z |
...
- **TOP 5 języków:** DE (23,859), NL (23,794), CS (23,166), PT (22,065), FR (19,040)
- **Aktualnie naprawia:** ES / -
- **Ostatnia aktualizacja:** 2026-03-23T03:09:11.238442Z
...
│ Plik: quests.json                                             │
│ Postęp: 7/30 keys                                             │
│ …=7 guard_fail=2 strict_missing_key=0 strict_skipped_done=603 │
├─────────────────────────────────────────────────────────────────┤
│ ❤️ Heartbeat: 2026-03-23T03:11:41Z           │
└─────────────────────────────────────────────────────────────────┘
```
...
- 2026-03-23 03:11:17 | AUTO_TRANSLATE:heartbeat_tick | de | ok | quests.json
- 2026-03-23 03:11:16 | AUTO_TRANSLATE:auto_start | de | ok | quests.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-23 03:11:52
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **9,973** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 53 |
| ❌ Błędów | 97 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **TR** (3,235), **ES** (2,471), **PL** (1,804), **RO** (969), **PT** (442) |
| 📊 Porównanie | ↓ 51.9% vs wczoraj (20,729) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **30,702** kluczy
...
| 🔄 Cykli wykonanych | **#9,426** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-23 03:11:52  
