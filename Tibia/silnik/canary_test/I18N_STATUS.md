...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.0% / real 10.92%**. Tempo: **781.0 kluczy/h**. Tłumaczeń netto: **144,610**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 08:08:21

> **Aktualizacja:** 2026-04-29 08:08:21 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,021 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: items.json | Heartbeat: 2026-04-29T08:08:08Z
> **Okno godzinowe:** okno=1.0h | cykli=83 | pominięte=0.0% | odrzucone=5.6% | przepustowość=781.0/h  
> **Tłumaczeń netto:** 144,610

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 08:08:21 |
| LIVE | 🟢 AKTYWNY | 20s temu | - | `activity.json / worker_state.json` | 2026-04-29T08:08:08Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 14s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 08:08:21 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T08:06:13.935086Z |
| QUALITY | 🔒 NIEAKTYWNY | 20s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T08:08:07.543330Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 08:08:21 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T08:08:28.066108Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 20s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T08:08:08Z
...
| 🔄 **Ostatni cykl** | 32 kluczy, 1 odrzuconych, 214.1s, tryb: AUTO_TRANSLATE, cel: it/items.json |
| ❤️ **Heartbeat** | 2026-04-29T08:08:08Z |
...
| ⏳ Oldest pending (visible tail) | 16606 s |
...
| 🌍 Recent provider mix | TM/simple(298), Free Google Translate(172), canonical_name_semantic_autofix(17), term_consistency_autofix(3) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=813/813 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 389, 'oldest_s': 16606}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 14s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 08:08:21
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T08:06:13.935086Z
...
- Raporty strażnika jakości: **4853**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4706**
...
- **Pokrycie globalne (nominal):** **18.0%** (697,564/3,875,872)
- **Pokrycie globalne (real):** **10.92%** (423,171/3,875,872)
- **Kopie EN (łącznie):** **410,480**
- **Placeholdery [EN]/puste (łącznie):** **2,188,099**
...
- **Profiler cyklu (ostatni):** cykl #107 (AUTO_TRANSLATE): dispatch 1371ms, mode 199936ms, status 11058ms, total 214072ms
...
| 🕒 Evidence window | 24h (span=37.27h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=37.27h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T07:08:21.959077Z → 2026-04-29T08:08:21.959077Z) |
...
> Świeżość: 20s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T08:08:07.543330Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T08:08:07.543330Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=739934), ro(60.1, issues=436975), de(60.1, issues=119587), cs(60.1, issues=102361), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 739934 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 69%, 174947 problemów
⚠️ **RU**: jakość 62%, 367446 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,021 |
| Heartbeat | 20s temu | 2026-04-29T08:08:08Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T08:06:28.418658Z
...
- 2026-04-29 08:07:59 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-29 08:06:29 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-29 08:06:14 | AUTO_TRANSLATE:auto_done | it | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 08:08:21
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+32, skipped+0) — lang=it file=items.json strict_skipped_done=3054 guard_fail=1 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+2) — repair_identical lang=es file=server.json target_identical=9 limit=180 tier=low_backlog domain_cap=240 gt=true suspicious_pct=650.00
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **6,967** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 164 |
| ❌ Błędów | 294 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,339), **RU** (1,243), **TR** (993), **IT** (967), **DE** (945) |
| 📊 Porównanie | ↓ 15.3% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **25,947** kluczy
...
| 🔄 Cykli wykonanych | **#18,021** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,021 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 08:08:21  
