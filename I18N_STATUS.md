...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.67%**. Tempo: **1984.8 kluczy/h**. Tłumaczeń netto: **100,545**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-17 06:12:13

> **Aktualizacja:** 2026-02-17 06:12:13 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #310 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ro | Plik: books.json | Heartbeat: 2026-02-17T06:11:45Z  
> **Okno godzinowe:** okno=1.0h | cykli=164 | pominięte=0.0% | odrzucone=36.1% | przepustowość=1984.8/h  
> **Tłumaczeń netto:** 100,545

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-17 06:12:13 |
| LIVE | 🟢 AKTYWNY | 30s temu | - | `activity.json / worker_state.json` | 2026-02-17T06:11:45Z |
| MIGRATION | 🔒 NIEAKTYWNY | 18s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-17 06:12:13 |
| TRANSLATION | 🟢 AKTYWNY | 32s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-17T06:11:43.679205Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-17T06:10:36.291556Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-17 06:12:13 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 30s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-17T06:11:45Z
...
| ❤️ **Heartbeat** | 2026-02-17T06:11:45Z |
...
> **ETA globalne:** ~49 dni (2,349,729 kluczy do celu 95%)
...
> Świeżość: 18s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-17 06:12:13
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 32s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-17T06:11:43.679205Z
...
- **Pokrycie globalne:** **10.67%** (297,383/2,786,472)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-17T05:12:13.846137Z → 2026-02-17T06:12:13.846137Z) |
...
| Przepustowość (kluczy/h) | **1984.8 kluczy/h** |
| Podejrzane tłumaczenia | **10145** |
| Najgorsze cele (strażnik) | pl/npc.json (gf=461), pl/scripts.json (gf=152), es/scripts.json (gf=96), ro/spells.json (gf=78), sv/server.json (gf=71) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-17T06:10:36.291556Z

- **Ostatni audyt:** SLOW_MODE | 13 issue(s) / 100 entries | 2026-02-17T06:10:36.291556Z
- **Top 5 typów problemów:** suspicious_rejected_critical=184, suspicious_log_high=133, suspicious_log_critical=66, identical_to_en_exempt=18, suspicious_rejected_high=16
- **Języki o najsłabszej jakości:** es(60.1, issues=210318), ro(60.1, issues=47734), it(60.3, issues=14320), pl(60.8, issues=129019), sv(64.0, issues=11724)
...
⚠️ **PL**: jakość 61%, 129019 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 210318 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 14320 problemów
⚠️ **RU**: jakość 65%, 36167 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 64%, 11724 problemów
...
| Heartbeat | 30s temu | 2026-02-17T06:11:45Z |
...
- 2026-02-17 06:10:56 | AUTO_TRANSLATE:heartbeat_tick | it | ok | cpp.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-17 06:12:13
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **25,469** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 249 |
| ❌ Błędów | 432 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (5,142), **IT** (4,613), **RU** (4,559), **RO** (4,150), **PL** (3,470) |
| 📊 Porównanie | ↑ 25.5% vs wczoraj (20,288) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **125,663** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-17 06:12:13  
