...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.53% / real 10.4%**. Tempo: **1077.0 kluczy/h**. Tłumaczeń netto: **122,409**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-22 22:27:18

> **Aktualizacja:** 2026-04-22 22:27:18 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #15,427 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ru | Plik: npc.json | Heartbeat: 2026-04-22T22:24:07Z  
> **Okno godzinowe:** okno=1.0h | cykli=148 | pominięte=0.0% | odrzucone=58.4% | przepustowość=1077.0/h  
> **Tłumaczeń netto:** 122,409

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-22 22:27:18 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-04-22T22:24:07Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 30s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-22 22:27:18 |
| TRANSLATION | 🟢 AKTYWNY | 7min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-22T22:20:21.541844Z |
| QUALITY | 🔒 NIEAKTYWNY | 6min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-22T22:20:48.441217Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-22 22:27:18 |
| DOCTOR | 🟢 AKTYWNY | 0s temu | - | `doctor_alerts_latest.json` | 2026-04-22T22:27:25.663556Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-22T22:24:07Z
...
| ❤️ **Heartbeat** | 2026-04-22T22:24:07Z |
...
|----------|------|---------|-----------|-------|----------|--------------|-----|
| 22:27:15 | RU | Serwer | npc.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `npc.captain_gulliver.greet_msg_1` |
| 22:27:15 | RU | Serwer | npc.json | `hard_block` | `validate_placeholder` | `placeholder` | `npc.captain_greyhound.stdmod_19` |
| 22:27:15 | RU | Serwer | npc.json | `hard_block` | `validate_placeholder` | `placeholder` | `npc.captain_greyhound.stdmod_18` |
| 22:27:15 | RU | Serwer | npc.json | `hard_block` | `validate_placeholder` | `placeholder` | `npc.captain_greyhound.stdmod_17` |
| 22:27:15 | RU | Serwer | npc.json | `hard_block` | `validate_placeholder` | `placeholder` | `npc.captain_greyhound.stdmod_16` |
| 22:27:15 | RU | Serwer | npc.json | `hard_block` | `validate_placeholder` | `placeholder` | `npc.captain_greyhound.stdmod_15` |
| 22:27:15 | RU | Serwer | npc.json | `hard_block` | `validate_placeholder` | `placeholder` | `npc.captain_greyhound.stdmod_14` |
| 22:27:13 | RU | Serwer | npc.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `npc.captain_greyhound.greet_msg_1` |
| 22:27:03 | RU | Serwer | npc.json | `hard_block` | `validate_placeholder` | `placeholder` | `npc.captain_fearless.stdmod_9` |
| 22:27:03 | RU | Serwer | npc.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `npc.captain_fearless.stdmod_5` |
| 22:27:03 | RU | Serwer | npc.json | `hard_block` | `validate_placeholder` | `placeholder` | `npc.captain_fearless.stdmod_10` |
| 22:27:03 | RU | Serwer | npc.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `npc.captain_fearless.greet_msg_1` |
| 22:27:03 | RU | Serwer | npc.json | `hard_block` | `validate_placeholder` | `placeholder` | `npc.captain_cookie.stdmod_3` |
| 22:27:03 | RU | Serwer | npc.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `npc.captain_cookie.stdmod_1` |
| 22:27:03 | RU | Serwer | npc.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `npc.captain_cookie.greet_msg_1` |
| 22:27:03 | RU | Serwer | npc.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `npc.captain_chelop.stdmod_6` |
| 22:27:03 | RU | Serwer | npc.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `npc.captain_chelop.stdmod_5` |
| 22:27:03 | RU | Serwer | npc.json | `hard_block` | `validate_placeholder` | `placeholder` | `npc.captain_chelop.stdmod_4` |
| 22:27:03 | RU | Serwer | npc.json | `hard_block` | `high_reject_types` | `cyrillic_latin_mix, mixed_scripts` | `npc.captain_chelop.stdmod_2` |
| 22:27:03 | RU | Serwer | npc.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `npc.captain_chelop.greet_msg_1` |
...
| ⏳ Oldest pending (visible tail) | 2115 s |
| 🌍 Top języki | RU(258), FR(32), CS(28), PT(26) |
| 🧱 Top reason_bucket | default(221), placeholder(125), word_salad(20), partial_translation_mix(16) |
| 🗂️ Deferred state keys | 6767 |
| 🕒 Deferred state freshness | fresh (6s) |
| ♻️ Deferred stats | enqueued=88, cooldown=0, deduped=337, manual_review=0 |
...
| 📉 Fallback breakdown | fallback chain exhausted all models blocked(143) |
| ☁️ Cloud policy | `disabled` |
| 🤖 OpenAI pool | `degraded` |
| 🩺 Health signals | recent_fallback |
| ❤️ Pool health | `degraded` (writes=395, fallbacks=143) |
...
|-------|--------|----------|-------|-----------|--------|
| `HEARTBEAT_STALE` | OK | OK | `167` | `300` | Heartbeat świeży (167s, src=worker_runtime_heartbeat) Runtime[status=degraded, reason=heartbeat_stale_or_gu... |
| `NO_WRITE` | OK | OK | `428` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | OK | OK | `{'pending': 400, 'oldest_s': 2115}` | `{'pending_min': 200, 'oldest_s': 3600}` | Queue bez sygnałów starvation. |
...
> **ETA globalne:** ~116 dni (3,002,474 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 78.1% | 58,199/74,536 | ~12h |
| PL | ██████████████░░░░░░ | 70.9% | 52,850/74,536 | ~17h |
| IT | █████████████░░░░░░░ | 67.3% | 50,171/74,536 | ~19h |
| RO | █████████████░░░░░░░ | 69.0% | 51,418/74,536 | ~18h |
| FR | ███████████░░░░░░░░░ | 57.0% | 42,496/74,536 | ~26h |
| RU | ████████░░░░░░░░░░░░ | 43.0% | 32,056/74,536 | ~36h |
| SR | ██████░░░░░░░░░░░░░░ | 33.3% | 24,827/74,536 | ~43h |
| CS | █████████░░░░░░░░░░░ | 47.4% | 35,356/74,536 | ~33h |
| PT | ███████████████░░░░░ | 76.1% | 56,745/74,536 | ~13h |
| NL | ██████████████░░░░░░ | 73.3% | 54,671/74,536 | ~15h |
| TR | ██████░░░░░░░░░░░░░░ | 31.0% | 23,098/74,536 | ~44h |
...
> Tempo obliczone na bazie ostatniej godziny: ~1077 kluczy/h.
...
> Świeżość: 30s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-22 22:27:18
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 7min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-22T22:20:21.541844Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-22T21:27:19.035304Z → 2026-04-22T22:27:19.035304Z) |
...
| Przepustowość (kluczy/h) | **1077.0 kluczy/h** |
| Podejrzane tłumaczenia | **4213** |
...
|--------|-----------|--------|----------------|
| `gt_rejected_high_mixed_scripts` | 230 | 44.2% | ru/server.json (146) |
| `gt_validate_fail_placeholder` | 129 | 24.8% | ru/html.json (31) |
| `gt_rejected_high_cyrillic_latin_mix` | 68 | 13.1% | ru/server.json (62) |
| `gt_validate_fail_identical_to_en` | 30 | 5.8% | cs/html.json (9) |
| `gt_validate_fail_word_salad` | 20 | 3.8% | fr/html.json (6) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 6min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-22T22:20:48.441217Z
...
| Heartbeat | 198s temu | 2026-04-22T22:24:07Z |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-22 22:27:18
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-22 22:27:18  
