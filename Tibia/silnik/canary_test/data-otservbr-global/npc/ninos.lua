...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "measurements") then
		...
		if player:getStorageValue(Storage.Quest.U7_24.ThePostmanMissions.Mission07) >= 1 and player:getStorageValue(Storage.Quest.U7_24.ThePostmanMissions.MeasurementsBenjamin) ~= 1 then
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.ninos.say_1")
			...
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.ninos.say_2")
			npcHandler:setTopic(playerId, 0)
		end
	end
	return true
...
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_GREET, "npc.ninos.greet_msg_1")
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_FAREWELL, "npc.ninos.farewell_msg_1")
