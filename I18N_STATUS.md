...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.39% / real 10.25%**. Tempo: **114.0 kluczy/h**. Tłumaczeń netto: **118,383**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-22 16:32:21

> **Aktualizacja:** 2026-04-22 16:32:21 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #14,726 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: html.json | Heartbeat: 2026-04-22T16:32:05Z  
> **Okno godzinowe:** okno=1.0h | cykli=33 | pominięte=0.0% | odrzucone=80.4% | przepustowość=114.0/h  
> **Tłumaczeń netto:** 118,383

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-22 16:32:21 |
| LIVE | 🟢 AKTYWNY | 22s temu | - | `activity.json / worker_state.json` | 2026-04-22T16:32:05Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 39s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-22 16:32:21 |
| TRANSLATION | 🟢 AKTYWNY | 37s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-22T16:31:49.729947Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-22T16:31:26.008738Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-22 16:32:21 |
| DOCTOR | 🟢 AKTYWNY | 0s temu | - | `doctor_alerts_latest.json` | 2026-04-22T16:32:27.392350Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 22s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-22T16:32:05Z
...
| ❤️ **Heartbeat** | 2026-04-22T16:32:05Z |
...
|----------|------|---------|-----------|-------|----------|--------------|-----|
| 16:32:24 | ES | Klient | html.json | `hard_block` | `high_reject_types` | `partial_translation_mix` | `html.api.text5` |
| 16:32:24 | ES | Klient | html.json | `hard_block` | `validate_word_salad` | `word_salad` | `html.networks.html.text2` |
| 16:32:19 | ES | Klient | html.json | `hard_block` | `validate_command` | `command` | `html.forum.edit_post.html.text1` |
| 16:32:18 | ES | Klient | html.json | `hard_block` | `validate_command` | `command` | `html.forum.new_post.html.text1` |
| 16:31:43 | PL | Klient | html.json | `hard_block` | `validate_word_salad` | `word_salad` | `html.login.html.text3` |
| 16:31:42 | PL | Klient | html.json | `hard_block` | `validate_command` | `command` | `html.forum.edit_post.html.text1` |
| 16:31:42 | PL | Klient | html.json | `hard_block` | `validate_command` | `command` | `html.forum.new_post.html.text1` |
| 16:31:42 | PL | Klient | html.json | `hard_block` | `validate_command` | `command` | `html.forum.new_thread.html.text1` |
| 16:31:12 | TR | Serwer | monsters.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `monster.mummy.voice_12` |
| 16:31:12 | TR | Serwer | monsters.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `monster.mummy.voice_11` |
| 16:31:12 | TR | Serwer | monsters.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `monster.frost_giant.voice_6` |
| 16:31:10 | TR | Serwer | monsters.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `monster.frost_giantess.voice_1` |
| 16:31:10 | TR | Serwer | monsters.json | `hard_block` | `high_reject_types` | `partial_translation_mix` | `monster.cyclops.voice_2` |
| 16:31:10 | TR | Serwer | monsters.json | `hard_block` | `high_reject_types` | `partial_translation_mix` | `monster.yielothax.voice_2` |
| 16:31:10 | TR | Serwer | monsters.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `monster.warlord_ruzad.voice_1` |
| 16:31:06 | TR | Serwer | monsters.json | `hard_block` | `validate_quality` | `quality` | `monster.grandfather_tridian.voice_4` |
| 16:31:06 | TR | Serwer | monsters.json | `hard_block` | `validate_quality` | `quality` | `monster.apprentice_sheng.voice_1` |
| 16:31:06 | TR | Serwer | monsters.json | `hard_block` | `validate_quality` | `quality` | `monster.mad_technomancer.voice_1` |
| 16:31:06 | TR | Serwer | monsters.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `monster.chikhaton.voice_1` |
| 16:31:06 | TR | Serwer | monsters.json | `hard_block` | `validate_quality` | `quality` | `monster.the_abomination.voice_1` |
...
| ⏳ Oldest pending (visible tail) | 1166 s |
| 🌍 Top języki | TR(113), NL(106), FR(56), PT(38) |
| 🧱 Top reason_bucket | default(270), partial_translation_mix(50), quality(29), word_salad(28) |
...
| 🌍 Recent provider mix | Free Google Translate(254), TM/simple(174) |
| 🔁 Latest fallback | TM/simple → fallback to google translate [critical_issue] html.json |
| 📉 Fallback breakdown | fallback to google translate high(60), fallback to google translate(7), fallback to google translate valida... |
| ☁️ Cloud policy | `disabled` |
| 🤖 OpenAI pool | `planned_not_implemented` |
| ❤️ Pool health | `degraded` (writes=428, fallbacks=71) |
...
| `QUEUE_STARVATION` | OK | OK | `{'pending': 400, 'oldest_s': 1166}` | `{'pending_min': 200, 'oldest_s': 3600}` | Queue bez sygnałów starvation. |
...
| �📊 Przetłumaczono | **114** kluczy |
| ❌ Odrzucone (guard) | 467 |
| 🔁 Cykli | 33 |
| 🌍 Języków | 8 |
| 🏆 Najaktywniejszy | TR (30 kluczy) |
| 📄 Najczęstszy plik | monsters.json |
| ⚡ Przepustowość | ~114 kluczy/h |
| 🛡️ Odrzucone (strażnik) | 80.4% |
| ⚠️ Podejrzane | 427 |
...
> **ETA globalne:** ~1099 dni (3,008,152 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 77.9% | 58,084/74,536 | ~5d |
| PL | ██████████████░░░░░░ | 70.9% | 52,830/74,536 | ~7d |
| IT | █████████████░░░░░░░ | 67.0% | 49,944/74,536 | ~8d |
| RO | █████████████░░░░░░░ | 68.4% | 51,009/74,536 | ~7d |
| FR | ███████████░░░░░░░░░ | 56.5% | 42,137/74,536 | ~10d |
| RU | ████████░░░░░░░░░░░░ | 41.9% | 31,264/74,536 | ~14d |
| SR | ██████░░░░░░░░░░░░░░ | 33.3% | 24,827/74,536 | ~17d |
| CS | █████████░░░░░░░░░░░ | 46.3% | 34,493/74,536 | ~13d |
| NL | ██████████████░░░░░░ | 72.8% | 54,260/74,536 | ~6d |
| PT | ███████████████░░░░░ | 75.2% | 56,092/74,536 | ~5d |
| TR | █████░░░░░░░░░░░░░░░ | 28.7% | 21,407/74,536 | ~18d |
| DE | █████████████░░░░░░░ | 67.2% | 50,077/74,536 | ~8d |
| BN | █░░░░░░░░░░░░░░░░░░░ | 6.4% | 4,787/74,536 | ~24d |
| AR | █░░░░░░░░░░░░░░░░░░░ | 6.3% | 4,723/74,536 | ~24d |
| LT | ░░░░░░░░░░░░░░░░░░░░ | 4.8% | 3,606/74,536 | ~25d |
| FA | █░░░░░░░░░░░░░░░░░░░ | 6.2% | 4,661/74,536 | ~24d |
| HI | █░░░░░░░░░░░░░░░░░░░ | 5.8% | 4,325/74,536 | ~24d |
| ID | █░░░░░░░░░░░░░░░░░░░ | 5.8% | 4,287/74,536 | ~24d |
| AZ | ░░░░░░░░░░░░░░░░░░░░ | 4.7% | 3,511/74,536 | ~25d |
| BG | ░░░░░░░░░░░░░░░░░░░░ | 4.7% | 3,502/74,536 | ~25d |

> Tempo obliczone na bazie ostatniej godziny: ~114 kluczy/h.
...
> Świeżość: 39s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-22 16:32:21
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 37s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-22T16:31:49.729947Z
...
- Raporty strażnika jakości: **4019**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3876**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 280 | 0 | 0 | - | 2026-04-22T16:32:04.223815Z |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-22T15:32:22.396755Z → 2026-04-22T16:32:22.396755Z) |
| Cykle | **33** (TŁUMACZENIE=33, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **80.4%** |
| Cykle bez postępu % | **25.0%** |
| Przepustowość (kluczy/h) | **114.0 kluczy/h** |
| Podejrzane tłumaczenia | **427** |
...
|--------|-----------|--------|----------------|
| `gt_validate_fail_identical_to_en` | 333 | 70.1% | it/monsters.json (86) |
| `gt_rejected_high_partial_translation_mix` | 56 | 11.8% | fr/monsters.json (17) |
| `gt_validate_fail_word_salad` | 30 | 6.3% | nl/monsters.json (9) |
| `gt_validate_fail_quality` | 29 | 6.1% | tr/monsters.json (28) |
| `gt_rejected_critical` | 10 | 2.1% | tr/monsters.json (5) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-22T16:31:26.008738Z

- **Ostatni audyt:** OK | 2 issue(s) / 100 entries | 2026-04-22T16:31:26.008738Z
- **Top 5 typów problemów:** suspicious_log_high=150, suspicious_rejected_critical=139, suspicious_log_medium=40, suspicious_rejected_high=32, suspicious_rejected_medium=29
- **Języki o najsłabszej jakości:** it(60.1, issues=152544), fr(60.1, issues=52937), nl(60.1, issues=41426), tr(60.1, issues=35851), ro(60.9, issues=399674)
...
⚠️ **TR**: jakość 60%, 35851 problemów
⚠️ **PL**: jakość 78%, 378085 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 78%, 698777 problemów
...
⚠️ **NL**: jakość 60%, 41426 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #14,726 |
| Heartbeat | 22s temu | 2026-04-22T16:32:05Z |
...
- 2026-04-22 16:32:05 | AUTO_TRANSLATE:heartbeat_tick | es | ok | html.json
- 2026-04-22 16:32:04 | AUTO_TRANSLATE:auto_start | es | ok | html.json
- 2026-04-22 16:31:50 | AUTO_TRANSLATE:auto_done | pl | ok | html.json
- 2026-04-22 16:31:36 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | html.json
- 2026-04-22 16:31:35 | AUTO_TRANSLATE:auto_start | pl | ok | html.json
- 2026-04-22 16:31:22 | AUTO_TRANSLATE:auto_done | tr | ok | monsters.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 70.9% | 0 | 5,874 | 328 | 702 (68.2%) | 23 |
| 🟡 ES | 77.9% | 0 | 9,790 | 587 | 296 (33.5%) | 17 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **118,383** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=79.97%, reason=decrease_high_fail_rate=80.0%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 915 kluczy / 40 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-22 16:32:21
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **118** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 9 |
| ❌ Błędów | 16 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **TR** (30), **NL** (24), **DE** (21), **IT** (20), **FR** (16) |
| 📊 Porównanie | ↓ 98.6% vs wczoraj (8,628) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **15,694** kluczy
...
| 🔄 Cykli wykonanych | **#14,726** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #14,726 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-22 16:32:21  
