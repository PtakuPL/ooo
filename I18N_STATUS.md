...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.87%**. Tempo: **1536.5 kluczy/h**. Tłumaczeń netto: **120,957**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 20:01:39

> **Aktualizacja:** 2026-02-20 20:01:39 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #133 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: - | Heartbeat: 2026-02-20T20:01:36Z  
> **Okno godzinowe:** okno=1.0h | cykli=205 | pominięte=0.0% | odrzucone=68.0% | przepustowość=1536.5/h  
> **Tłumaczeń netto:** 120,957

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 20:01:39 |
| LIVE | 🟢 AKTYWNY | 4s temu | - | `activity.json / worker_state.json` | 2026-02-20T20:01:36Z |
| MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 20:01:39 |
| TRANSLATION | 🟢 AKTYWNY | 5s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T20:01:35.017677Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T20:01:40.668045Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 20:01:39 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 4s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T20:01:36Z
...
| ❤️ **Heartbeat** | 2026-02-20T20:01:36Z |
...
> **ETA globalne:** ~61 dni (2,260,517 kluczy do celu 95%)
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 20:01:39
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T20:01:35.017677Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T19:01:39.942413Z → 2026-02-20T20:01:39.942413Z) |
...
| Przepustowość (kluczy/h) | **1536.5 kluczy/h** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T20:01:40.668045Z

- **Ostatni audyt:** SLOW_MODE | 16 issue(s) / 100 entries | 2026-02-20T20:01:35.841078Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=106, suspicious_log_high=100, suspicious_rejected_high=24, artifact_token=16, identical_to_en_exempt=5
- **Języki o najsłabszej jakości:** es(60.1, issues=336361), pl(60.1, issues=188197), ro(60.1, issues=183371), it(61.9, issues=75007), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 60%, 188197 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 336361 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 62%, 75007 problemów
⚠️ **RU**: jakość 67%, 212850 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 93%, 30879 problemów
...
| Heartbeat | 4s temu | 2026-02-20T20:01:36Z |
...
- 2026-02-20 20:01:25 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-02-20 20:01:25 | AUTO_TRANSLATE:parallel_start | ro | ok | items.json
- 2026-02-20 20:01:20 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-02-20 20:01:20 | AUTO_TRANSLATE:parallel_start | ru | ok | items.json
- 2026-02-20 20:01:19 | AUTO_TRANSLATE:auto_done | it | ok | items.json
- 2026-02-20 20:01:14 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **120,957** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=86.75%, reason=decrease_high_fail_rate=86.8% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 20:01:39
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+30, skipped+0) — lang=it file=items.json strict_skipped_done=4207
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+24) — repair_identical lang=es file=npc.json target_identical=24 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=324.25
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **12,303** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 133 |
| ❌ Błędów | 290 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (3,603), **RU** (2,413), **IT** (2,007), **RO** (1,528), **PL** (1,417) |
| 📊 Porównanie | ↑ 237.9% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **109,888** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 20:01:39  
