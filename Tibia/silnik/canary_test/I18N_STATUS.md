...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.9% / real 10.82%**. Tempo: **782.0 kluczy/h**. Tłumaczeń netto: **138,246**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 00:06:31

> **Aktualizacja:** 2026-04-29 00:06:31 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,361 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ro | Plik: items.json | Heartbeat: 2026-04-29T00:04:40Z
> **Okno godzinowe:** okno=1.0h | cykli=85 | pominięte=0.0% | odrzucone=4.5% | przepustowość=782.0/h  
> **Tłumaczeń netto:** 138,246

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 00:06:31 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T00:04:40Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 49s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 00:06:31 |
| TRANSLATION | 🟢 AKTYWNY | 15s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T00:06:23.515058Z |
| QUALITY | 🔒 NIEAKTYWNY | 14s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T00:06:24.945667Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 00:06:31 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T00:06:39.089400Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T00:04:40Z
...
| 🔄 **Ostatni cykl** | 39 kluczy, 4 odrzuconych, 78.6s, tryb: AUTO_TRANSLATE, cel: ro/items.json |
| ❤️ **Heartbeat** | 2026-04-29T00:04:40Z |
...
| ⏳ Oldest pending (visible tail) | 16626 s |
...
| 🌍 Recent provider mix | TM/simple(268), Free Google Translate(221), canonical_name_semantic_autofix(18), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=510, fallbacks=16) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=445/445 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 390, 'oldest_s': 16626}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
|---------|---------|
| 🔔 Open alarms | 11 |
| 🆕 Newly opened (cycle) | PROVIDER_BUDGET_UNAVAILABLE |
| ✅ Resolved (cycle) | - |
...
> **ETA globalne:** ~159 dni (2,988,190 kluczy do celu 95%)
...
> Świeżość: 49s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 00:06:31
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 15s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T00:06:23.515058Z
...
- This lamp is glowing very dimly. → Această lampăăăăăăăăăăăăăăăăăăăăăă luminează foarte slab. (item.13656.desc)
- This lamp is glowing very dimly. → Această lampăăăăăăăăăăăăăăăăăăăăăă luminează foarte slab. (item.13658.desc)
- This is an emblem of wisdom. It was awarded by TibiaStat.com → Aceasta este o emblemăăăăăăăăăăăăăăăăăăăăăă a înțelepciunii. A fost acordat de T (item.14760.desc)
- lamp → lampă (item.10507.name)
- ramp → rampă (item.11365.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4687**  
- Raporty blokad: **0**  
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T00:05:05.966262Z |
...
| 🕒 Evidence window | 24h (span=29.24h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=29.24h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-28T23:06:32.398314Z → 2026-04-29T00:06:32.398314Z) |
...
> Świeżość: 14s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T00:06:24.945667Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T00:06:24.945667Z
- **Top 5 typów problemów:** suspicious_rejected_critical=193, suspicious_log_low=121, suspicious_log_high=78, suspicious_rejected_high=7, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=726417), ro(60.1, issues=425579), de(60.1, issues=109002), cs(60.1, issues=83538), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 726417 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 63%, 168838 problemów
⚠️ **RU**: jakość 61%, 358326 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,361 |
| Heartbeat | 119s temu | 2026-04-29T00:04:40Z |
...
- 2026-04-29 00:06:24 | AUTO_TRANSLATE:auto_done | ro | ok | items.json
- 2026-04-29 00:05:06 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-04-29 00:05:06 | AUTO_TRANSLATE:auto_start | ro | ok | items.json
- 2026-04-29 00:04:25 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **138,246** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=4.71%, reason=increase_low_fail_rate=4.7%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 00:06:31
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+1) — repair_identical lang=es file=quests.json target_identical=1 limit=180 tier=low_backlog domain_cap=180 gt=true suspicious_pct=100.00
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+1647, skipped+0) — lang=ro file=items.json strict_skipped_done=12228 guard_fail=169 placeholder=0 command=0 pipe=0
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+71) — repair_identical lang=es file=npc.json target_identical=350 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=119.72
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [tr] → warn (files+1, translated+52, skipped+0) — lang=tr file=quests.json strict_skipped_done=72 guard_fail=3 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **73** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 2 |
| ❌ Błędów | 4 |
| 🌍 Aktywnych języków | 3 |
| 🏆 TOP 5 | **RO** (39), **IT** (30), **ES** (4) |
| 📊 Porównanie | ↓ 99.1% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **19,053** kluczy
...
| 🔄 Cykli wykonanych | **#17,361** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,361 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 00:06:31  
