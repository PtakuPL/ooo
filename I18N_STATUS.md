...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.73% / real 11.7%**. Tempo: **347.0 kluczy/h**. Tłumaczeń netto: **170,431**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-05-02 07:37:49

> **Aktualizacja:** 2026-05-02 07:37:49 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #19,415 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-05-02T07:31:50Z
> **Okno godzinowe:** okno=1.0h | cykli=64 | pominięte=0.0% | odrzucone=0.0% | przepustowość=347.0/h  
> **Tłumaczeń netto:** 170,431

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-05-02 07:37:49 |
| LIVE | 🟢 AKTYWNY | 6min temu | - | `activity.json / worker_state.json` | 2026-05-02T07:31:50Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 22h temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-05-02 07:37:49 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-05-02T07:35:58.084294Z |
| QUALITY | 🔒 NIEAKTYWNY | 3min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-05-02T07:34:14.264553Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-05-02 07:37:49 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-05-02T07:37:56.340202Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 6min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-05-02T07:31:50Z
...
| 🔄 **Ostatni cykl** | 61 kluczy, 0 odrzuconych, 86.0s, tryb: AUTO_TRANSLATE, cel: tr/items.json |
...
| ⏳ Oldest pending (visible tail) | 18133 s |
| 🌍 Top języki | RU(400) |
...
| ♻️ Provider debt | `767` |
| 🌍 Recent provider mix | tm_dedup_file(107), OpenAI model pool(81), canonical_name_semantic_autofix(20), tm_dedup_propagate(14), ter... |
...
| ❤️ Pool health | `degraded` (writes=223, fallbacks=22) |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 18133}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| �📊 Przetłumaczono | **347** kluczy |
| ❌ Odrzucone (guard) | 0 |
| 🔁 Cykli | 64 |
| 🌍 Języków | 6 |
| 🏆 Najaktywniejszy | TR (159 kluczy) |
| 📄 Najczęstszy plik | items.json |
| ⚡ Przepustowość | ~347 kluczy/h |
...
> Tempo obliczone na bazie ostatniej godziny: ~347 kluczy/h.
...
> Świeżość: 22h temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-05-02 07:37:49
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-05-02T07:35:58.084294Z
...
- Raporty strażnika jakości: **5210**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **5062**
...
| 🕒 Evidence window | 24h (span=35.07h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=35.07h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=+0.00pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-05-02T06:37:50.376892Z → 2026-05-02T07:37:50.376892Z) |
...
| Przepustowość (kluczy/h) | **347.0 kluczy/h** |
...
> Świeżość: 3min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-05-02T07:34:14.264553Z
...
| Heartbeat | 366s temu | 2026-05-02T07:31:50Z |
...
- **Ostatnia aktualizacja:** 2026-05-02T07:36:15.776910Z
...
- 2026-05-02 07:37:46 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-05-02 07:36:16 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-05-02 07:35:58 | AUTO_TRANSLATE:auto_done | tr | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-05-02 07:37:49
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **13,896** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 82 |
| ❌ Błędów | 104 |
| 🌍 Aktywnych języków | 6 |
| 🏆 TOP 5 | **RO** (7,495), **TR** (5,720), **ES** (299), **RU** (151), **IT** (140) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **46,876** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-05-02 07:37:49  
