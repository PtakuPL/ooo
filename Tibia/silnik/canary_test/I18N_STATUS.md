...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.01%**. Tempo: **3823.7 kluczy/h**. Tłumaczeń netto: **74,365**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-16 21:22:23

> **Aktualizacja:** 2026-02-16 21:22:23 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #54 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: pl | Plik: items.json | Heartbeat: 2026-02-16T21:22:17Z  
> **Okno godzinowe:** okno=1.0h | cykli=200 | pominięte=0.0% | odrzucone=29.6% | przepustowość=3823.7/h  
> **Tłumaczeń netto:** 74,365

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-16 21:22:23 |
| LIVE | 🟢 AKTYWNY | 7s temu | - | `activity.json / worker_state.json` | 2026-02-16T21:22:17Z |
| MIGRATION | 🔒 NIEAKTYWNY | 1h temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-16 21:22:23 |
| TRANSLATION | 🟢 AKTYWNY | 9s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-16T21:22:15.142753Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-16T21:21:09.238791Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-16 21:22:23 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 7s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-16T21:22:17Z
...
| ❤️ **Heartbeat** | 2026-02-16T21:22:17Z |
...
> **ETA globalne:** ~26 dni (2,368,190 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~3824 kluczy/h.
...
> Świeżość: 1h temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-16 21:22:23
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 9s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-16T21:22:15.142753Z
...
- closed door → stängd dörr (item.5006.name)
- closed door → stängd dörr (item.5007.name)
- closed door → stängd dörr (item.5082.name)
- closed door → stängd dörr (item.5084.name)
- closed door → stängd dörr (item.5097.name)
- closed door → stängd dörr (item.5098.name)
- closed door → stängd dörr (item.5100.name)
- closed door → stängd dörr (item.5104.name)
- closed door → stängd dörr (item.5106.name)
- closed door → stängd dörr (item.5107.name)
- closed door → stängd dörr (item.5109.name)
- closed door → stängd dörr (item.5113.name)
- closed door → stängd dörr (item.5115.name)
- closed door → stängd dörr (item.5116.name)
- closed door → stängd dörr (item.5118.name)
- closed door → stängd dörr (item.5122.name)
- closed door → stängd dörr (item.5124.name)
- closed door → stängd dörr (item.5125.name)
- closed door → stängd dörr (item.5127.name)
- closed door → stängd dörr (item.5131.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **2246**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2184**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **10.01%** (278,922/2,786,472)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-16T20:22:23.662164Z → 2026-02-16T21:22:23.662164Z) |
...
| Przepustowość (kluczy/h) | **3823.7 kluczy/h** |
| Podejrzane tłumaczenia | **31782** |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-16T21:21:09.238791Z
...
| Heartbeat | 7s temu | 2026-02-16T21:22:17Z |
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 42.9% | 0 | 1,854 | 1,564 | 2796 (64.1%) | 39 |
...
| Przepustowość (okno) | 2,779 kluczy / 65 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-16 21:22:23
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-16 21:22:23  
