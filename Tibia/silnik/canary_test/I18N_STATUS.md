...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.02% / real 10.94%**. Tempo: **678.0 kluczy/h**. Tłumaczeń netto: **146,330**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 10:27:11

> **Aktualizacja:** 2026-04-29 10:27:11 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,219 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: de | Plik: otclient_modules.json | Heartbeat: 2026-04-29T10:26:49Z
> **Okno godzinowe:** okno=1.0h | cykli=87 | pominięte=0.0% | odrzucone=6.4% | przepustowość=678.0/h  
> **Tłumaczeń netto:** 146,330

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 10:27:11 |
| LIVE | 🟢 AKTYWNY | 28s temu | - | `activity.json / worker_state.json` | 2026-04-29T10:26:49Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 22s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 10:27:11 |
| TRANSLATION | 🟢 AKTYWNY | 30s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T10:26:47.490587Z |
| QUALITY | 🔒 NIEAKTYWNY | 29s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T10:26:48.711316Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 10:27:11 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T10:27:17.721509Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 28s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T10:26:49Z
...
| 🔄 **Ostatni cykl** | 19 kluczy, 0 odrzuconych, 77.0s, tryb: AUTO_TRANSLATE, cel: es/items.json |
...
| ⏳ Oldest pending (visible tail) | 15721 s |
...
| 🌍 Recent provider mix | TM/simple(322), Free Google Translate(142), canonical_name_semantic_autofix(20), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=487, fallbacks=25) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=920/920 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 386, 'oldest_s': 15721}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~183 dni (2,983,613 kluczy do celu 95%)
...
> Świeżość: 22s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 10:27:11
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 30s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T10:26:47.490587Z
...
- stone wall → muro de piedra (item.11895.name)
- stone wall → muro de piedra (item.11896.name)
- tomb wall → muro de tumba (item.11898.name)
- tomb wall → muro de tumba (item.11899.name)
- wooden roof → techo de madera (item.1190.name)
- tomb wall → muro de tumba (item.11900.name)
- tomb wall → muro de tumba (item.11901.name)
- tomb wall → muro de tumba (item.11902.name)
- tomb wall → muro de tumba (item.11903.name)
- tomb wall → muro de tumba (item.11904.name)
- tomb wall → muro de tumba (item.11905.name)
- tomb wall → muro de tumba (item.11906.name)
...
- Raporty strażnika jakości: **4902**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4755**
...
| 🕒 Evidence window | 24h (span=39.58h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=39.58h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T09:27:12.143106Z → 2026-04-29T10:27:12.143106Z) |
...
> Świeżość: 29s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T10:26:48.711316Z
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,219 |
| Heartbeat | 28s temu | 2026-04-29T10:26:49Z |
...
- 2026-04-29 10:25:30 | AUTO_TRANSLATE:heartbeat_tick | es | ok | items.json
- 2026-04-29 10:25:30 | AUTO_TRANSLATE:auto_start | es | ok | items.json
- 2026-04-29 10:24:52 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 10:27:11
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **8,849** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 185 |
| ❌ Błędów | 379 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,588), **RU** (1,538), **IT** (1,340), **TR** (1,237), **DE** (1,215) |
| 📊 Porównanie | ↑ 7.5% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **27,829** kluczy
...
| 🔄 Cykli wykonanych | **#18,219** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,219 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 10:27:11  
