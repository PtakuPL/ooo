...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "DEATH TO THE SHABURAK!", yell = true , i18nKey = "monster.askarak_demon.voice_1"},
	{ text = "GREEN WILL RULE!", yell = true , i18nKey = "monster.askarak_demon.voice_2"},
	{ text = "ONLY WE ARE TRUE DEMONS!", yell = true , i18nKey = "monster.askarak_demon.voice_3"},
	{ text = "RED IS MAD!", yell = true , i18nKey = "monster.askarak_demon.voice_4"},
	{ text = "WE RULE!", yell = true , i18nKey = "monster.askarak_demon.voice_5"},
}
