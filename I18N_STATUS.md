...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.96% / real 10.88%**. Tempo: **824.0 kluczy/h**. Tłumaczeń netto: **142,303**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 05:05:49

> **Aktualizacja:** 2026-04-29 05:05:49 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,764 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: it | Plik: items.json | Heartbeat: 2026-04-29T05:04:36Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=4.0% | przepustowość=824.0/h  
> **Tłumaczeń netto:** 142,303

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 05:05:49 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T05:04:36Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 45s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 05:05:49 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T05:04:33.038184Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T05:04:35.494136Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 05:05:49 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T05:05:55.326459Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T05:04:36Z
...
| ❤️ **Heartbeat** | 2026-04-29T05:04:36Z |
...
| ⏳ Oldest pending (visible tail) | 17322 s |
| 🌍 Top języki | RU(400) |
...
| 🌍 Recent provider mix | TM/simple(339), Free Google Translate(147), canonical_name_semantic_autofix(15), term_consistency_autofix(3) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=671/671 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 17322}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~151 dni (2,985,786 kluczy do celu 95%)
...
> Świeżość: 45s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 05:05:49
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T05:04:33.038184Z
...
- ornamented wall → zdobená stěna (item.1376.name)
- ornamented wall → zdobená stěna (item.1377.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.13779.name)
- ornamented wall → zdobená stěna (item.1378.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.13780.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.13781.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.13782.name)
- ornamented wall → zdobená stěna (item.1379.name)
- ornamented wall → zdobená stěna (item.1380.name)
...
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4641**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T05:04:53.872039Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.96%** (696,282/3,875,872)
- **Pokrycie globalne (real):** **10.88%** (421,852/3,875,872)
- **Kopie EN (łącznie):** **410,517**
- **Placeholdery [EN]/puste (łącznie):** **2,189,381**
...
| 🕒 Evidence window | 24h (span=34.23h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=34.23h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T04:05:49.748097Z → 2026-04-29T05:05:49.748097Z) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T05:04:35.494136Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T05:04:35.494136Z
- **Top 5 typów problemów:** suspicious_rejected_critical=187, suspicious_log_low=98, suspicious_log_high=95, suspicious_rejected_high=13, suspicious_log_medium=7
- **Języki o najsłabszej jakości:** es(60.1, issues=734368), ro(60.1, issues=432769), de(60.1, issues=115698), cs(60.1, issues=94505), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 60%, 54573 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 734368 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 73%, 172826 problemów
⚠️ **RU**: jakość 65%, 363767 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,764 |
| Heartbeat | 79s temu | 2026-04-29T05:04:36Z |
...
- 2026-04-29 05:04:54 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-04-29 05:04:54 | AUTO_TRANSLATE:auto_start | it | ok | items.json
- 2026-04-29 05:04:33 | AUTO_TRANSLATE:auto_done | cs | ok | items.json
- 2026-04-29 05:03:21 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | items.json
- 2026-04-29 05:03:20 | AUTO_TRANSLATE:auto_start | cs | ok | items.json
- 2026-04-29 05:01:30 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 05:05:49
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **4,440** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 99 |
| ❌ Błędów | 180 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (934), **RU** (791), **IT** (688), **DE** (585), **TR** (525) |
| 📊 Porównanie | ↓ 46.0% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **23,420** kluczy
...
| 🔄 Cykli wykonanych | **#17,764** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,764 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 05:05:49  
