...
> **Aktualizacja:** 2025-12-11 01:37:17 UTC  
...
| 🌐 Pozostałe (0/53) | 🔄 | 792776 | Aktualnie: RU |
...
│ Kategoria: 🌍 RU/spells.json                         │
├─────────────────────────────────────────────────────────────────┤
│ 📊 Ostatnia aktywność: RU/spells.json                                 │
│ [█████████████████████████████████████████████████░] │
│ 28516/28550 kluczy (100%)                                          │
├─────────────────────────────────────────────────────────────────┤
│ ⏳ Total processed: 30712 operacji               │
│ 🌍 Języki zsync: 0/53                                │
│ 📅 Ostatnia aktualizacja: 2025-12-11 01:37:17                 │
└─────────────────────────────────────────────────────────────────┘
```
...
- 🌍 `RU/spells.json` +28516 kluczy @ 01:37:17
...
|-----------|--------|--------------|-----------|--------|
| items | 13749 | 11689 | 4 | ⏭️ Skip 31m |
| monsters | 7341 | 9549 | 4 | ⏭️ Skip 31m |
| npc | 5334 | 2 | 0 | ✅ Active |
| html | 1495 | 3245 | 4 | ⏭️ Skip 36m |
| scripts | 385 | 0 | 4 | ⏭️ Skip 31m |
| raids | 147 | 351 | 4 | ⏭️ Skip 31m |
| startup | 23 | 23 | 4 | ⏭️ Skip 32m |
| libs | 21 | 53 | 4 | ⏭️ Skip 31m |
| modules | 16 | 16 | 4 | ⏭️ Skip 32m |
| spells | 15 | 0 | 0 | ✅ Active |
| messages | 11 | 0 | 0 | ✅ Active |
| chatchannels | 8 | 8 | 4 | ⏭️ Skip 31m |
| events | 5 | 5 | 4 | ⏭️ Skip 31m |
| actions | 0 | 0 | 0 | ⏳ Empty |
| client | 0 | 821 | 6 | ⏭️ Skip 112m |
| cpp | 0 | 0 | 0 | ⏳ Empty |
| errors | 0 | 0 | 0 | ⏳ Empty |
| npclib | 0 | 0 | 4 | ⏭️ Skip 32m |
| php | 0 | 4521 | 8 | ⏭️ Skip 112m |
| quests | 0 | 0 | 0 | ⏳ Empty |
| server | 0 | 0 | 0 | ⏳ Empty |
| ui | 0 | 0 | 0 | ⏳ Empty |
| world | 0 | 0 | 4 | ⏭️ Skip 31m |
...
|-----------|----------------|-----------|-------|
| scripts | 31m | 4x | Progresywny backoff |
| monsters | 31m | 4x | Progresywny backoff |
| raids | 31m | 4x | Progresywny backoff |
| world | 31m | 4x | Progresywny backoff |
| items | 31m | 4x | Progresywny backoff |
| libs | 31m | 4x | Progresywny backoff |
| events | 31m | 4x | Progresywny backoff |
| chatchannels | 31m | 4x | Progresywny backoff |
| modules | 32m | 4x | Progresywny backoff |
| startup | 32m | 4x | Progresywny backoff |
| npclib | 32m | 4x | Progresywny backoff |
| php | 112m | 8x | Progresywny backoff |
| html | 36m | 4x | Progresywny backoff |
| client | 112m | 6x | Progresywny backoff |
| sendtextmessage | 36m | 4x | Progresywny backoff |
| keywordhandler | 36m | 4x | Progresywny backoff |
| twig | 36m | 4x | Progresywny backoff |
...
📅 Auto-updated by Worker v1.1 | Last: 2025-12-11 01:37:17  
