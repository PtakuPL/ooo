...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.03% / real 10.95%**. Tempo: **703.0 kluczy/h**. Tłumaczeń netto: **146,772**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 11:10:11

> **Aktualizacja:** 2026-04-29 11:10:11 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,280 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: items.json | Heartbeat: 2026-04-29T11:09:52Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=6.1% | przepustowość=703.0/h  
> **Tłumaczeń netto:** 146,772

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 11:10:11 |
| LIVE | 🟢 AKTYWNY | 26s temu | - | `activity.json / worker_state.json` | 2026-04-29T11:09:52Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 11:10:11 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T11:07:26.969633Z |
| QUALITY | 🔒 NIEAKTYWNY | 54s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T11:09:23.787346Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 11:10:11 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T11:10:18.016217Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 26s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T11:09:52Z
...
| 🌍 Recent provider mix | TM/simple(321), Free Google Translate(133), canonical_name_semantic_autofix(18), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=475, fallbacks=24) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=953/953 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 385, 'oldest_s': 15523}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~177 dni (2,983,436 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~703 kluczy/h.
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 11:10:11
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T11:07:26.969633Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T11:09:51.249239Z |
...
| 🕒 Evidence window | 24h (span=40.30h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=40.30h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T10:10:11.613824Z → 2026-04-29T11:10:11.613824Z) |
...
| Przepustowość (kluczy/h) | **703.0 kluczy/h** |
...
> Świeżość: 54s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T11:09:23.787346Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T11:09:23.787346Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=745218), ro(60.1, issues=440708), de(60.1, issues=123438), cs(60.1, issues=110777), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 745218 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 71%, 177202 problemów
⚠️ **RU**: jakość 61%, 370961 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,280 |
| Heartbeat | 26s temu | 2026-04-29T11:09:52Z |
...
- 2026-04-29 11:09:52 | AUTO_TRANSLATE:heartbeat_tick | es | ok | items.json
- 2026-04-29 11:09:52 | AUTO_TRANSLATE:auto_start | es | ok | items.json
- 2026-04-29 11:09:13 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **146,772** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=6.18%, reason=stable_fail_rate=6.2%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 11:10:11
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **9,343** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 185 |
| ❌ Błędów | 406 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,670), **RU** (1,598), **IT** (1,407), **TR** (1,315), **DE** (1,305) |
| 📊 Porównanie | ↑ 13.6% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **28,323** kluczy
...
| 🔄 Cykli wykonanych | **#18,280** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,280 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 11:10:11  
