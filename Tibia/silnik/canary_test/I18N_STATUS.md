...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **18.77%**. Tempo: **604.2 kluczy/h**. Tłumaczeń netto: **50,823**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-23 07:23:06

> **Aktualizacja:** 2026-03-23 07:23:06 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **LIVE:** Cykl #9,768 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: pt | Plik: otclient_data.json | Heartbeat: 2026-03-23T07:22:38Z  
> **Okno godzinowe:** okno=1.0h | cykli=105 | pominięte=0.0% | odrzucone=6.3% | przepustowość=604.2/h  
> **Tłumaczeń netto:** 50,823

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-23 07:23:06 |
| LIVE | 🟢 AKTYWNY | 29s temu | - | `activity.json / worker_state.json` | 2026-03-23T07:22:38Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-23 07:23:06 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-23T07:20:17.276152Z |
| QUALITY | 🔒 NIEAKTYWNY | 50s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-23T07:22:17.476346Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-23 07:23:06 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 29s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-23T07:22:38Z
...
| ❤️ **Heartbeat** | 2026-03-23T07:22:38Z |
...
> **ETA globalne:** ~204 dni (2,954,459 kluczy do celu 95%)
...
| FR | ██████████████░░░░░░ | 71.2% | 53,096/74,536 | ~29h |
| PT | █████████████░░░░░░░ | 69.3% | 51,680/74,536 | ~32h |
| CS | █████████████░░░░░░░ | 67.4% | 50,239/74,536 | ~34h |
| NL | █████████████░░░░░░░ | 67.0% | 49,913/74,536 | ~35h |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-23 07:23:06
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-23T07:20:17.276152Z
...
- Raporty strażnika jakości: **2881**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2744**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **18.77%** (727,609/3,875,872)
- **Kopie EN (łącznie):** **600,301**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-23T06:23:06.532247Z → 2026-03-23T07:23:06.532247Z) |
...
| Przepustowość (kluczy/h) | **604.2 kluczy/h** |
| Podejrzane tłumaczenia | **2051** |
| Najgorsze cele (strażnik) | ro/otclient_modules.json (gf=16), cs/otclient_modules.json (gf=15), pl/questlog.json (gf=11), es/scripts.json (gf=8), ru/php.json (gf=7) |
...
> Świeżość: 50s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-23T07:22:17.476346Z

- **Ostatni audyt:** OK | 4 issue(s) / 100 entries | 2026-03-23T07:22:17.476346Z
- **Top 5 typów problemów:** suspicious_log_high=199, suspicious_rejected_critical=196, identical_to_en=4, suspicious_rejected_high=4, identical_to_en_exempt=1
- **Języki o najsłabszej jakości:** es(60.1, issues=591764), ro(60.1, issues=336638), it(60.1, issues=111579), pt(60.1, issues=19048), nl(60.1, issues=11254)
...
⚠️ **TR**: jakość 68%, 5006 problemów
⚠️ **PL**: jakość 94%, 327085 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 591764 problemów
⚠️ **PT**: jakość 60%, 19048 problemów
⚠️ **FR**: jakość 83%, 17468 problemów
⚠️ **IT**: jakość 60%, 111579 problemów
⚠️ **RU**: jakość 90%, 287900 problemów
⚠️ **NL**: jakość 60%, 11254 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #9,768 |
| Heartbeat | 29s temu | 2026-03-23T07:22:38Z |
...
- **TOP 5 języków:** DE (23,792), NL (23,325), CS (22,861), PT (21,673), FR (18,749)
- **Aktualnie naprawia:** ES / -
- **Ostatnia aktualizacja:** 2026-03-23T07:20:34.027325Z
...
- 2026-03-23 07:22:38 | AUTO_TRANSLATE:heartbeat_tick | pt | ok | otclient_data.json
- 2026-03-23 07:22:38 | AUTO_TRANSLATE:auto_start | pt | ok | otclient_data.json
- 2026-03-23 07:22:04 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-03-23 07:20:34 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-03-23 07:20:17 | AUTO_TRANSLATE:auto_done | de | ok | otclient_data.json
- 2026-03-23 07:19:39 | AUTO_TRANSLATE:heartbeat_tick | de | ok | otclient_data.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **50,823** | — | 📊 |
| Adaptacyjna paczka | batch=33, gf_rate=5.84%, reason=stable_fail_rate=5.8% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-23 07:23:06
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **20,474** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 133 |
| ❌ Błędów | 263 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **ES** (5,778), **TR** (4,592), **PL** (2,062), **RO** (1,703), **RU** (1,330) |
| 📊 Porównanie | ↓ 1.2% vs wczoraj (20,729) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **41,203** kluczy
...
| 🔄 Cykli wykonanych | **#9,768** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-23 07:23:06  
