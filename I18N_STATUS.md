...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.93% / real 10.84%**. Tempo: **725.0 kluczy/h**. Tłumaczeń netto: **139,901**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 02:16:45

> **Aktualizacja:** 2026-04-29 02:16:45 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,532 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-04-29T02:14:56Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=5.0% | przepustowość=725.0/h  
> **Tłumaczeń netto:** 139,901

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 02:16:45 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T02:14:56Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 02:16:45 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T02:15:37.749618Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T02:14:55.706351Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 02:16:45 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T02:16:51.919696Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T02:14:56Z
...
| 🔄 **Ostatni cykl** | 30 kluczy, 1 odrzuconych, 26.0s, tryb: AUTO_TRANSLATE, cel: de/npc.json |
| ❤️ **Heartbeat** | 2026-04-29T02:14:56Z |
...
|----------|------|---------|------|-------|--------|------------|--------|
| 02:15:29 | DE | Serwer | npc.json | 30 | `tm` | `npc.a_dead_bureaucrat1.say_1` | Klar, wo sonst. Jeder trifft gerne meinen Meister, er ist ein großer Dämon, nicht wah... |
| 02:14:50 | DE | Klient | otclient_modules.json | 15 | `tm` | `otclient_modules.blessing.tr_11` | - Abhängig von den Regeln des fairen Kampfes verlierst du zwischendurch |
| 02:13:52 | ES | Serwer | server.json | 2 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 02:11:51 | ES | Serwer | items.json | 18 | `simple` | `item.1131.name` | piedra |
| 02:10:15 | RO | Serwer | items.json | 39 | `google_translate` | `item.10216.name` | kit statuie dragon |
| 02:07:57 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 02:04:19 | IT | Serwer | items.json | 33 | `simple` | `item.12160.name` | oggetto sconosciuto |
| 02:02:28 | CS | Serwer | items.json | 41 | `simple` | `item.13075.name` | struktura úlu |
| 02:00:51 | ES | Serwer | server.json | 2 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 01:58:50 | RU | Serwer | items.json | 84 | `google_translate` | `item.12445.name` | ниша |
| 01:56:55 | TR | Serwer | items.json | 32 | `simple` | `item.11760.name` | ahşap zemin |
| 01:55:28 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 01:52:16 | DE | Serwer | npc.json | 30 | `tm` | `npc.a_dead_bureaucrat1.say_1` | Klar, wo sonst. Jeder trifft gerne meinen Meister, er ist ein großer Dämon, nicht wah... |
| 01:51:34 | DE | Klient | otclient_modules.json | 15 | `tm` | `otclient_modules.blessing.tr_11` | - Abhängig von den Regeln des fairen Kampfes verlierst du zwischendurch |
| 01:50:46 | ES | Serwer | server.json | 2 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 01:48:46 | ES | Serwer | items.json | 18 | `simple` | `item.11299.name` | artículo desconocido |
| 01:47:07 | RO | Serwer | items.json | 39 | `google_translate` | `item.10216.name` | kit statuie dragon |
| 01:45:17 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 01:40:59 | IT | Serwer | items.json | 34 | `simple` | `item.12103.name` | piastrella per torta |
| 01:39:24 | CS | Serwer | items.json | 42 | `simple` | `item.13048.name` | hmyzoidní úl |
...
|----------|------|---------|-----------|-------|----------|--------------|-----|
| 02:15:25 | DE | Serwer | npc.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `npc.a_fluffy_squirrel.stdmod_1` |
| 02:14:48 | DE | Klient | otclient_modules.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `otclient_modules.charms.tr_34` |
| 02:09:31 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10193.name` |
| 02:09:30 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10192.name` |
| 02:09:28 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10191.name` |
| 02:09:27 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10190.name` |
| 02:06:26 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.say_1` |
| 02:06:25 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.multi_1` |
| 02:03:48 | IT | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 02:01:59 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.11586.name` |
| 02:01:58 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 02:01:56 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10456.name` |
| 02:01:54 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10338.name` |
| 02:01:53 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10026.name` |
| 01:57:59 | RU | Serwer | items.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `item.11541.name` |
| 01:54:16 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.say_2` |
| 01:52:12 | DE | Serwer | npc.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `npc.a_fluffy_squirrel.stdmod_1` |
| 01:51:30 | DE | Klient | otclient_modules.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `otclient_modules.charms.tr_34` |
| 01:46:20 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10193.name` |
| 01:46:18 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10192.name` |
...
| ⏳ Oldest pending (visible tail) | 17857 s |
| 🌍 Top języki | RU(398) |
| 🧱 Top reason_bucket | quality(397), default(1) |
| 🗂️ Deferred state keys | 7568 |
| 🕒 Deferred state freshness | fresh (75s) |
...
| 🌍 Recent provider mix | TM/simple(330), Free Google Translate(145), canonical_name_semantic_autofix(18), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=496, fallbacks=15) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=541/541 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
|-------|--------|----------|-------|-----------|--------|
| `HEARTBEAT_STALE` | OK | OK | `51` | `300` | Heartbeat świeży (51s, src=worker_runtime_heartbeat) Runtime[status=healthy, reason=heartbeat_fresh, phase=... |
| `NO_WRITE` | OK | OK | `81` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 17857}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| �📊 Przetłumaczono | **725** kluczy |
| ❌ Odrzucone (guard) | 38 |
| 🔁 Cykli | 84 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | DE (135 kluczy) |
| 📄 Najczęstszy plik | items.json |
| ⚡ Przepustowość | ~725 kluczy/h |
| 🛡️ Odrzucone (strażnik) | 5.0% |
| ⚠️ Podejrzane | 996 |
...
> **ETA globalne:** ~172 dni (2,987,227 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 78.8% | 58,714/74,536 | ~17h |
| PL | ██████████████░░░░░░ | 71.0% | 52,911/74,536 | ~25h |
| IT | █████████████░░░░░░░ | 69.4% | 51,748/74,536 | ~26h |
| RO | █████████████░░░░░░░ | 69.7% | 51,971/74,536 | ~26h |
| RU | █████████░░░░░░░░░░░ | 45.4% | 33,844/74,536 | ~2d |
| FR | ███████████░░░░░░░░░ | 57.5% | 42,864/74,536 | ~39h |
| PT | ████████████████░░░░ | 81.2% | 60,516/74,536 | ~14h |
| SR | ██████░░░░░░░░░░░░░░ | 33.3% | 24,827/74,536 | ~3d |
| NL | ███████████████░░░░░ | 77.6% | 57,814/74,536 | ~18h |
| CS | █████████░░░░░░░░░░░ | 49.7% | 37,071/74,536 | ~47h |
| TR | ██████░░░░░░░░░░░░░░ | 33.4% | 24,911/74,536 | ~3d |
| DE | █████████████░░░░░░░ | 67.8% | 50,562/74,536 | ~28h |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 02:16:45
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T02:15:37.749618Z
...
|-------|-----------|--------|----------|--------------|--------------|
| ES (Hiszpański) | 78.77% (58,714/74,536) | 67.60% (50,384/74,536) | 9,719 | 14,457 | 0 |
| PL (Polski) | 70.99% (52,911/74,536) | 65.08% (48,507/74,536) | 5,861 | 20,194 | 0 |
| IT (Włoski) | 69.43% (51,748/74,536) | 61.22% (45,630/74,536) | 10,022 | 18,909 | 0 |
| RO (Rumuński) | 69.73% (51,971/74,536) | 56.69% (42,252/74,536) | 13,005 | 19,304 | 0 |
| RU (Rosyjski) | 45.41% (33,844/74,536) | 43.84% (32,674/74,536) | 4,775 | 37,105 | 0 |
...
| CS (Czeski) | 49.74% (37,071/74,536) | 31.83% (23,728/74,536) | 29,955 | 20,879 | 0 |
| TR (Turecki) | 33.42% (24,911/74,536) | 29.94% (22,314/74,536) | 3,832 | 48,404 | 0 |
...
- Raporty strażnika jakości: **4730**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4583**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T02:15:11.919565Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.93%** (694,841/3,875,872)
- **Pokrycie globalne (real):** **10.84%** (420,320/3,875,872)
- **Kopie EN (łącznie):** **410,608**
- **Placeholdery [EN]/puste (łącznie):** **2,190,822**
...
|-------|--------|--------------------------|----------|----------------------------|
| ES | 55,554/70,637 | 78.7% / 67.0% | 3,160/3,899 | 81.0% / 79.2% |
| PL | 49,763/70,637 | 70.5% / 64.3% | 3,148/3,899 | 80.7% / 78.4% |
| IT | 48,775/70,637 | 69.0% / 60.6% | 2,973/3,899 | 76.2% / 73.1% |
| RO | 49,185/70,637 | 69.6% / 56.0% | 2,786/3,899 | 71.5% / 69.6% |
| RU | 30,700/70,637 | 43.5% / 41.9% | 3,144/3,899 | 80.6% / 79.3% |
...
| CS | 35,381/70,637 | 50.1% / 31.4% | 1,690/3,899 | 43.3% / 39.0% |
| TR | 22,952/70,637 | 32.5% / 28.9% | 1,959/3,899 | 50.2% / 48.7% |
...
| #3 | 🔴 Server | 10.92% | +0.17 pp | 51 | ZH 0.2%, TL 0.8%, BS 0.9% |
...
| 🕒 Evidence window | 24h (span=31.41h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=31.41h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T01:16:46.032339Z → 2026-04-29T02:16:46.032339Z) |
| Cykle | **84** (TŁUMACZENIE=84, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **5.0%** |
| Cykle bez postępu % | **0.0%** |
| Przepustowość (kluczy/h) | **725.0 kluczy/h** |
| Podejrzane tłumaczenia | **996** |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 55 | 85.9% | ru/items.json (55) |
| `existing_canonical_name_quality_mixed_scripts` | 9 | 14.1% | ru/items.json (9) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T02:14:55.706351Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T02:14:55.706351Z
- **Top 5 typów problemów:** suspicious_rejected_critical=188, suspicious_log_low=88, suspicious_log_high=79, suspicious_log_medium=32, suspicious_rejected_high=12
- **Języki o najsłabszej jakości:** es(60.1, issues=729487), ro(60.1, issues=428743), de(60.1, issues=111788), cs(60.1, issues=88468), fr(60.1, issues=60621)
- **Pliki:** `i18n/status/quality_audit_latest.json`, `i18n/status/quality_dashboard.json`, `i18n/status/quality_report.jsonl`

### 📈 Statystyki Pracy
| Metryka | Wartość | Info |
|---------|---------|------|
| 🔄 Cykl aktualny | **#173** | od uruchomienia |
...
⚠️ **TR**: jakość 74%, 53752 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 729487 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 62%, 170405 problemów
⚠️ **RU**: jakość 67%, 360663 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,532 |
| Heartbeat | 115s temu | 2026-04-29T02:14:56Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T02:15:54.044271Z
...
- 2026-04-29 02:15:54 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 02:15:38 | AUTO_TRANSLATE:auto_done | de | ok | npc.json
- 2026-04-29 02:15:12 | AUTO_TRANSLATE:heartbeat_tick | de | ok | npc.json
- 2026-04-29 02:15:12 | AUTO_TRANSLATE:auto_start | de | ok | npc.json
- 2026-04-29 02:14:54 | AUTO_TRANSLATE:auto_done | de | ok | otclient_modules.json
- 2026-04-29 02:14:34 | AUTO_TRANSLATE:heartbeat_tick | de | ok | otclient_modules.json
...
| 🟡 ES | 78.8% | 0 | 9,719 | 514 | 0 (0.0%) | 23 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **139,901** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=4.13%, reason=increase_low_fail_rate=4.1%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 514 kluczy / 23 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 02:16:45
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [cs] → warn (files+1, translated+1, skipped+0) — lang=cs file=html.json strict_skipped_done=239
- • DOCTOR_REMEDIATION: AUTO_COMMAND [-] → ok — action=force_auto reason=deferred_or_dlq_pressure
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+1) — repair_identical lang=es file=quests.json target_identical=1 limit=180 tier=low_backlog domain_cap=180 gt=true suspicious_pct=96.67
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+55, skipped+0) — lang=ro file=items.json strict_skipped_done=3091 guard_fail=38 placeholder=0 command=0 pipe=0
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+3) — repair_identical lang=es file=npc.json target_identical=2821 limit=156 tier=high_backlog+domain_cap+suspicious_guard domain_cap=260 gt=true suspicious_pct=1339.33
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [de] → warn (files+0, translated+0, skipped+0) — lang=de file=startup.json strict_skipped_done=11
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+1, skipped+0) — lang=pl file=arena.json strict_skipped_done=164
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+2, skipped+0) — lang=ro file=npc.json strict_skipped_done=611
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **1,857** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 45 |
| ❌ Błędów | 79 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (439), **RU** (278), **DE** (270), **IT** (240), **RO** (234) |
| 📊 Porównanie | ↓ 77.4% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **20,837** kluczy
...
| 🔄 Cykli wykonanych | **#17,532** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,532 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 02:16:45  
