...
keywordHandler:addKeyword({ "hi" }, StdModule.say, { npcHandler = npcHandler, onlyUnfocus = true, i18nKey = "npc.barbara.stdmod_1" })
keywordHandler:addKeyword({ "hello" }, StdModule.say, { npcHandler = npcHandler, onlyUnfocus = true, i18nKey = "npc.barbara.stdmod_2" })
...
-- Greeting
keywordHandler:addGreetKeyword({ "hail queen" }, { npcHandler = npcHandler, i18nKey = "npc.barbara.greet_1" })
keywordHandler:addGreetKeyword({ "salutations queen" }, { npcHandler = npcHandler, i18nKey = "npc.barbara.greet_2" })
