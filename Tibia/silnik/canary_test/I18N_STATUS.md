...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.88% / real 10.8%**. Tempo: **873.0 kluczy/h**. Tłumaczeń netto: **136,952**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-28 22:20:39

> **Aktualizacja:** 2026-04-28 22:20:39 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,212 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: auto_done | Kategoria: de | Plik: npc.json | Heartbeat: 2026-04-28T22:19:43Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=4.2% | przepustowość=873.0/h  
> **Tłumaczeń netto:** 136,952

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-28 22:20:39 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-28T22:19:43Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 13s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-28 22:20:39 |
| TRANSLATION | 🟢 AKTYWNY | 19s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-28T22:20:27.009566Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-28T22:19:40.682619Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-28 22:20:39 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-28T22:20:46.270591Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-28T22:19:43Z
...
| 🧭 **Surface** | Serwer |
| 📊 **Status** | 🟢 DZIAŁA |
| 📈 **Postęp** | ██████████████████████ 34/30 keys (113.3%) |
| 🔧 **Metoda** | Google Translate + TM fallback |
| 🧠 **Detail** | translated=34 guard_fail=1 strict_missing_key=0 strict_skipped_done=75 |
| 🔑 **Current key** | `de:npc.json` |
| 🔄 **Ostatni cykl** | 34 kluczy, 1 odrzuconych, 27.0s, tryb: AUTO_TRANSLATE, cel: de/npc.json |
| ❤️ **Heartbeat** | 2026-04-28T22:19:43Z |
...
|----------|------|---------|------|-------|--------|------------|--------|
| 22:20:22 | DE | Serwer | npc.json | 34 | `tm` | `npc.a_dragon_lord.greet_msg_2` | Pssst! Halten Sie es ruhig! <gibt Ihnen einen ausführlichen Bericht über die Monstera... |
| 22:19:35 | DE | Klient | otclient_modules.json | 15 | `tm` | `otclient_modules.blessing.tr_11` | - Abhängig von den Regeln des fairen Kampfes verlierst du zwischendurch |
| 22:18:45 | ES | Serwer | server.json | 2 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 22:16:46 | ES | Serwer | items.json | 18 | `simple` | `item.10885.name` | muro corrompido |
| 22:15:02 | RO | Serwer | items.json | 57 | `google_translate` | `item.11495.name` | puț de lavă topită |
| 22:13:12 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 22:09:53 | IT | Serwer | items.json | 76 | `google_translate` | `item.11563.name` | palizzata |
| 22:08:08 | CS | Serwer | items.json | 32 | `simple` | `item.11875.name` | kamenná zeď |
| 22:06:25 | ES | Serwer | server.json | 2 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 22:04:30 | RU | Serwer | items.json | 58 | `google_translate` | `item.11597.name` | неизвестный предмет |
| 22:02:58 | TR | Serwer | items.json | 32 | `simple` | `item.11044.name` | ejderha heykel |
| 22:01:46 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 21:57:56 | DE | Serwer | npc.json | 34 | `tm` | `npc.a_dragon_lord.greet_msg_2` | Pssst! Halten Sie es ruhig! <gibt Ihnen einen ausführlichen Bericht über die Monstera... |
| 21:57:08 | DE | Klient | otclient_modules.json | 15 | `tm` | `otclient_modules.blessing.tr_11` | - Abhängig von den Regeln des fairen Kampfes verlierst du zwischendurch |
| 21:56:17 | ES | Serwer | server.json | 2 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 21:54:22 | ES | Serwer | items.json | 18 | `simple` | `item.10838.name` | pilar de cráneo |
| 21:52:49 | RO | Serwer | items.json | 50 | `google_translate` | `item.10216.name` | kit statuie dragon |
| 21:50:53 | ES | Serwer | npc.json | 6 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 21:47:27 | IT | Serwer | items.json | 43 | `simple` | `item.11423.name` | oggetto sconosciuto |
| 21:46:02 | CS | Serwer | items.json | 74 | `google_translate` | `item.1184.name` | dřevěná střecha |
...
|----------|------|---------|-----------|-------|----------|--------------|-----|
| 22:20:18 | DE | Serwer | npc.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `npc.a_fluffy_squirrel.stdmod_1` |
| 22:19:32 | DE | Klient | otclient_modules.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `otclient_modules.charms.tr_34` |
| 22:14:18 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10193.name` |
| 22:14:16 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10192.name` |
| 22:14:15 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10191.name` |
| 22:14:14 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10190.name` |
| 22:12:00 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.say_2` |
| 22:09:12 | IT | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 22:07:25 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.11586.name` |
| 22:07:23 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 22:07:21 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10456.name` |
| 22:07:20 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10338.name` |
| 22:07:18 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10026.name` |
| 22:03:54 | RU | Serwer | items.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `item.11541.name` |
| 22:00:03 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.say_1` |
| 22:00:01 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.multi_1` |
| 21:57:50 | DE | Serwer | npc.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `npc.a_fluffy_squirrel.stdmod_1` |
| 21:57:05 | DE | Klient | otclient_modules.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `otclient_modules.charms.tr_34` |
| 21:52:04 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10193.name` |
| 21:52:02 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10192.name` |
...
| ⏳ Oldest pending (visible tail) | 15748 s |
| 🌍 Top języki | RU(378), ES(4), RO(4), CS(2) |
| 🧱 Top reason_bucket | quality(377), default(8), critical(3), word_salad(1) |
| 🗂️ Deferred state keys | 7248 |
...
| ♻️ Provider debt | `1260` |
| 🌍 Recent provider mix | TM/simple(265), Free Google Translate(215), canonical_name_semantic_autofix(20), OpenAI model pool(9), term... |
...
| 🤖 OpenAI pool | `active` |
| 🩺 Health signals | recent_fallback, provider_consistency_debt:1260, provider_budget:provider_budget_high, provider_circuit:pro... |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=362/362 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
|-------|--------|----------|-------|-----------|--------|
| `HEARTBEAT_STALE` | OK | OK | `49` | `300` | Heartbeat świeży (49s, src=worker_runtime_heartbeat) Runtime[status=healthy, reason=heartbeat_fresh, phase=... |
| `NO_WRITE` | OK | OK | `23` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 389, 'oldest_s': 15748}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| �📊 Przetłumaczono | **873** kluczy |
| ❌ Odrzucone (guard) | 38 |
| 🔁 Cykli | 88 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RO (173 kluczy) |
| 📄 Najczęstszy plik | items.json |
| ⚡ Przepustowość | ~873 kluczy/h |
| 🛡️ Odrzucone (strażnik) | 4.2% |
| ⚠️ Podejrzane | 1052 |
...
|-------|---------------|-----------|----------|----------|
| ES | 58,563 | 74,536 | 78.57% ↑+0.05% | 9,727 |
| PL | 52,911 | 74,536 | 70.99% →0% | 5,861 |
| IT | 51,351 | 74,536 | 68.89% | 10,022 |
| RO | 51,942 | 74,536 | 69.69% | 13,008 |
| RU | 33,660 | 74,536 | 45.16% ↑+0.06% | 4,775 |
| FR | 42,864 | 74,536 | 57.51% →0% | 26,153 |
| PT | 60,516 | 74,536 | 81.19% →0% | 48,839 |
| SR | 24,827 | 74,536 | 33.31% | 1,218 |
| NL | 57,814 | 74,536 | 77.57% | 49,478 |
| CS | 36,581 | 74,536 | 49.08% | 30,122 |
| TR | 24,515 | 74,536 | 32.89% | 3,832 |
...
> **ETA globalne:** ~143 dni (2,988,874 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 78.6% | 58,563/74,536 | ~14h |
| PL | ██████████████░░░░░░ | 71.0% | 52,911/74,536 | ~21h |
| IT | █████████████░░░░░░░ | 68.9% | 51,351/74,536 | ~22h |
| RO | █████████████░░░░░░░ | 69.7% | 51,942/74,536 | ~22h |
| RU | █████████░░░░░░░░░░░ | 45.2% | 33,660/74,536 | ~43h |
| FR | ███████████░░░░░░░░░ | 57.5% | 42,864/74,536 | ~32h |
| PT | ████████████████░░░░ | 81.2% | 60,516/74,536 | ~12h |
| SR | ██████░░░░░░░░░░░░░░ | 33.3% | 24,827/74,536 | ~2d |
| NL | ███████████████░░░░░ | 77.6% | 57,814/74,536 | ~15h |
| CS | █████████░░░░░░░░░░░ | 49.1% | 36,581/74,536 | ~39h |
| TR | ██████░░░░░░░░░░░░░░ | 32.9% | 24,515/74,536 | ~2d |
| DE | █████████████░░░░░░░ | 67.8% | 50,562/74,536 | ~23h |
...
> Tempo obliczone na bazie ostatniej godziny: ~873 kluczy/h.
...
> Świeżość: 13s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-28 22:20:39
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 19s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-28T22:20:27.009566Z
...
|-------|-----------|--------|----------|--------------|--------------|
| ES (Hiszpański) | 78.57% (58,563/74,536) | 67.38% (50,225/74,536) | 9,727 | 14,608 | 0 |
| PL (Polski) | 70.99% (52,911/74,536) | 65.08% (48,507/74,536) | 5,861 | 20,194 | 0 |
| IT (Włoski) | 68.89% (51,351/74,536) | 60.69% (45,233/74,536) | 10,022 | 19,306 | 0 |
| RO (Rumuński) | 69.69% (51,942/74,536) | 56.64% (42,220/74,536) | 13,008 | 19,333 | 0 |
| RU (Rosyjski) | 45.16% (33,660/74,536) | 43.59% (32,490/74,536) | 4,775 | 37,289 | 0 |
...
| CS (Czeski) | 49.08% (36,581/74,536) | 30.95% (23,071/74,536) | 30,122 | 21,369 | 0 |
| TR (Turecki) | 32.89% (24,515/74,536) | 29.41% (21,918/74,536) | 3,832 | 48,800 | 0 |
...
- Thought so. You'll have to talk to the king though. The beggar king that is. The → Dachte schon. Allerdings musst du mit dem König reden. Der Bettlerkönig also. De (npc.a_beggar.say_6)
- Huhu, please don't hurt me with your {}! Reason of your visit? → Huhu, bitte tu mir nicht weh mit deinem {}! Grund Ihres Besuchs? (npc.a_dead_bureaucrat1.say_10)
- I was a {}, too, before I died!! What do you want from me? → Ich war auch ein {}, bevor ich starb!! Was willst du von mir? (npc.a_dead_bureaucrat3.say_5)
- {}, is that right?! What do you want from me? → {}, stimmt das?! Was willst du von mir? (npc.a_dead_bureaucrat4.say_5)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4650**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4503**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-28T22:20:00.167820Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.88%** (693,194/3,875,872)
- **Pokrycie globalne (real):** **10.8%** (418,495/3,875,872)
- **Kopie EN (łącznie):** **410,786**
- **Placeholdery [EN]/puste (łącznie):** **2,192,469**
...
|-------|--------|--------------------------|----------|----------------------------|
| ES | 55,403/70,637 | 78.4% / 66.7% | 3,160/3,899 | 81.0% / 79.2% |
| PL | 49,763/70,637 | 70.5% / 64.3% | 3,148/3,899 | 80.7% / 78.4% |
| IT | 48,378/70,637 | 68.5% / 60.0% | 2,973/3,899 | 76.2% / 73.1% |
| RO | 49,156/70,637 | 69.6% / 55.9% | 2,786/3,899 | 71.5% / 69.6% |
| RU | 30,516/70,637 | 43.2% / 41.6% | 3,144/3,899 | 80.6% / 79.3% |
...
| CS | 34,891/70,637 | 49.4% / 30.5% | 1,690/3,899 | 43.3% / 39.0% |
| TR | 22,556/70,637 | 31.9% / 28.3% | 1,959/3,899 | 50.2% / 48.7% |
...
| #3 | 🔴 Server | 10.86% | +0.11 pp | 51 | ZH 0.2%, TL 0.8%, BS 0.9% |
...
| 🕒 Evidence window | 24h (span=27.47h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=27.47h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-28T21:20:40.156993Z → 2026-04-28T22:20:40.156993Z) |
| Cykle | **88** (TŁUMACZENIE=88, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **4.2%** |
| Cykle bez postępu % | **0.0%** |
| Przepustowość (kluczy/h) | **873.0 kluczy/h** |
| Podejrzane tłumaczenia | **1052** |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 60 | 92.3% | ru/items.json (60) |
| `existing_canonical_name_quality_mixed_scripts` | 4 | 6.2% | ru/items.json (4) |
| `gt_rejected_high_mixed_scripts` | 1 | 1.5% | ru/items.json (1) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-28T22:19:40.682619Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-28T22:19:40.682619Z
- **Top 5 typów problemów:** suspicious_rejected_critical=196, suspicious_log_low=117, suspicious_log_high=50, suspicious_log_medium=32, suspicious_rejected_high=4
- **Języki o najsłabszej jakości:** es(60.1, issues=723534), ro(60.1, issues=422683), cs(60.1, issues=80143), fr(60.1, issues=60621), de(60.2, issues=106030)
- **Pliki:** `i18n/status/quality_audit_latest.json`, `i18n/status/quality_dashboard.json`, `i18n/status/quality_report.jsonl`

### 📈 Statystyki Pracy
| Metryka | Wartość | Info |
|---------|---------|------|
| 🔄 Cykl aktualny | **#93** | od uruchomienia |
...
⚠️ **TR**: jakość 62%, 52455 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 723534 problemów
⚠️ **PT**: jakość 78%, 57566 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 62%, 167455 problemów
⚠️ **RU**: jakość 76%, 356242 problemów
⚠️ **NL**: jakość 62%, 72470 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,212 |
| Heartbeat | 63s temu | 2026-04-28T22:19:43Z |
...
- **Ostatnia aktualizacja:** 2026-04-28T22:20:44.611491Z
...
│ Plik: npc.json                                                │
│ Postęp: 34/30 keys                                            │
│ …=34 guard_fail=1 strict_missing_key=0 strict_skipped_done=75 │
├─────────────────────────────────────────────────────────────────┤
│ ❤️ Heartbeat: 2026-04-28T22:19:43Z           │
└─────────────────────────────────────────────────────────────────┘
```
...
- 2026-04-28 22:20:27 | AUTO_TRANSLATE:auto_done | de | ok | npc.json
- 2026-04-28 22:20:01 | AUTO_TRANSLATE:heartbeat_tick | de | ok | npc.json
- 2026-04-28 22:20:00 | AUTO_TRANSLATE:auto_start | de | ok | npc.json
- 2026-04-28 22:19:39 | AUTO_TRANSLATE:auto_done | de | ok | otclient_modules.json
- 2026-04-28 22:19:17 | AUTO_TRANSLATE:heartbeat_tick | de | ok | otclient_modules.json
- 2026-04-28 22:19:17 | AUTO_TRANSLATE:auto_start | de | ok | otclient_modules.json
...
| 🟡 ES | 78.6% | 0 | 9,727 | 311 | 0 (0.0%) | 14 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **136,952** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=3.79%, reason=increase_low_fail_rate=3.8%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 311 kluczy / 14 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-28 22:20:39
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pt] → warn (files+0, translated+0, skipped+0) — lang=pt file=npc.json strict_skipped_done=240 guard_fail=62 placeholder=48 command=0 pipe=0
- • DOCTOR_REMEDIATION: AUTO_COMMAND [-] → ok — action=force_auto reason=write_starvation_or_queue_starvation
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pt] → warn (files+1, translated+176, skipped+0) — lang=pt file=npc.json strict_skipped_done=2826 guard_fail=69 placeholder=49 command=0 pipe=0
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [tr] → warn (files+1, translated+31, skipped+0) — lang=tr file=monsters.json strict_skipped_done=1048 guard_fail=27 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [nl] → warn (files+1, translated+38, skipped+0) — lang=nl file=monsters.json strict_skipped_done=1529 guard_fail=35 placeholder=0 command=0 pipe=0
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → warn (files+1, translated+12, skipped+0) — lang=ru file=talkactions.json strict_skipped_done=56 guard_fail=2 placeholder=2 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **6,872** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 93 |
| ❌ Błędów | 274 |
| 🌍 Aktywnych języków | 9 |
| 🏆 TOP 5 | **DE** (1,190), **RU** (1,041), **IT** (863), **RO** (744), **TR** (722) |
| 📊 Porównanie | ↑ 32.5% vs wczoraj (5,188) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **29,732** kluczy
...
| 🔄 Cykli wykonanych | **#17,212** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,212 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-28 22:20:39  
