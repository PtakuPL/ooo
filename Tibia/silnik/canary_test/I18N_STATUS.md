...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **9.84%**. Tempo: **1466.7 kluczy/h**. Tłumaczeń netto: **68,980**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-14 15:29:31

> **Aktualizacja:** 2026-02-14 15:29:31 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #19 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: pl | Plik: spells.json | Heartbeat: 2026-02-14T15:29:11Z  
> **Okno godzinowe:** okno=1.0h | cykli=73 | pominięte=0.0% | odrzucone=36.2% | przepustowość=1466.7/h  
> **Tłumaczeń netto:** 68,980

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-14 15:29:31 |
| LIVE | 🟢 AKTYWNY | 20s temu | - | `activity.json / worker_state.json` | 2026-02-14T15:29:11Z |
| MIGRATION | 🔒 NIEAKTYWNY | 28s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-14 15:29:31 |
| TRANSLATION | 🟢 AKTYWNY | 21s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-14T15:29:10.852652Z |
| QUALITY | 🔒 NIEAKTYWNY | 37s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-14T15:28:54.612756Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-14 15:29:31 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 20s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-14T15:29:11Z
...
| ❤️ **Heartbeat** | 2026-02-14T15:29:11Z |
...
|-------|---------------|-----------|----------|----------|
| ES | 39,499 | 53,586 | 73.71% | 2,617 |
| PL | 23,063 | 53,586 | 43.04% | 1,926 |
...
> **ETA globalne:** ~67 dni (2,372,907 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ██████████████░░░░░░ | 73.7% | 39,499/53,586 | ~8h |
| PL | ████████░░░░░░░░░░░░ | 43.0% | 23,063/53,586 | ~19h |
| FR | ██████░░░░░░░░░░░░░░ | 33.1% | 17,719/53,586 | ~23h |
| RU | ██████░░░░░░░░░░░░░░ | 32.8% | 17,586/53,586 | ~23h |
...
> Świeżość: 28s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-14 15:29:31

### 📁 Pliki Projektu (pełny skan)
| Metryka | Wartość | Procent | Info |
|---------|---------|---------|------|
| 📂 **Wszystkie pliki** | **20,306** | 100% | cały projekt |
| 📜 Do skanowania (kod) | **9,394** | 46.3% | pliki z kodem/tekstami |
| 🔍 **Przeskanowane (historia)** | **6,443** | **68.6%** | `i18n_processed_files.txt` |
| 🧭 Przeskanowane (LIVE) | **15** | **0.2%** | `i18n_file_status.json` |
| ⏳ Nie przeskanowane (historia) | **2,951** | 31.4% | wg historii workera |
| ⏳ Nie przeskanowane (LIVE) | **9,379** | 99.8% | wg rejestru LIVE |
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 21s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-14T15:29:10.852652Z
...
|-------|----------------|-------------------------------|---------|--------------|
| ES (Hiszpański) | 39,499/53,586 | 73.71% | 2,617 | 0 |
| PL (Polski) | 23,063/53,586 | 43.04% | 1,926 | 0 |
...
- Farewell. → Farewell. (data.otservbr.global.npc.muriel.L161.1307)
- Greetings, |PLAYERNAME|. If you are looking for sorcerer {spells} don't hesitate → Saludos, |PLAYERNAME|. Si buscas al hechicero {spells} no dudes en preguntar. (data.otservbr.global.npc.myra.L319.1418)
- Farewell. → Farewell. (data.otservbr.global.npc.myra.L321.1420)
- Hello adventurer. It is {good} to see you. → Hola aventurero. Son {good} para verte. (data.otservbr.global.npc.myzzi.L100.65)
- Bye now, Neutrala |PLAYERNAME|. Visit old Bob again one day! → Adiós, Neutrala |PLAYERNAME|. ¡Visita al viejo Bob de nuevo algún día! (data.otservbr.global.npc.nah.bob.L137.839)
- Welcome to the Tibian bank, |PLAYERNAME| What can I do for you? → Bienvenido al banco Tibiano, |PLAYERNAME| ¿Qué puedo hacer por ti? (data.otservbr.global.npc.naji.L76.1424)
- How could I help you? → ¿Cómo podría ayudarte? (data.otservbr.global.npc.narsai.L58.889)
- How could I help you? → ¿Cómo podría ayudarte? (data.otservbr.global.npc.narsai.L61.890)
- How could I help you? → ¿Cómo podría ayudarte? (data.otservbr.global.npc.narsai.L64.891)
- Hello |PLAYERNAME|, What can I do for you? I'm working for the post office, but  → Hola |PLAYERNAME|, ¿Qué puedo hacer por ti? Trabajo para la oficina de correos,  (data.otservbr.global.npc.nelly.L166.415)
- Ah, the impetuosity of youth. → Ah, la impetuosidad de la juventud. (data.otservbr.global.npc.nelly.L168.417)
- Good bye. You are welcome. → Adiós. De nada. (data.otservbr.global.npc.nielson.L101.561)
- Greetings, traveller |PLAYERNAME|. Is there anything I can {do for you}? → Saludos viajero |PLAYERNAME|. ¿Hay algo que pueda {do for you}? (data.otservbr.global.npc.nilsor.L227.1011)
- Beware, if you go any further you will have to fight a large group of Chosen. Th → Cuidado, si avanzas más tendrás que luchar contra un gran grupo de Elegidos. Est (data.otservbr.global.npc.nina.L61.878)
- Hello. How may I help you |PLAYERNAME|? Ask me for a {trade} if you want to buy  → Hola. ¿Cómo puedo ayudarte |PLAYERNAME|? Pídeme un {trade} si quieres comprar al (data.otservbr.global.npc.ninos.L84.1480)
- It was a pleasure to help you, |PLAYERNAME|. → Fue un placer ayudarte, |PLAYERNAME|. (data.otservbr.global.npc.ninos.L85.1481)
- You are....kind of tall! Hello. → Eres...un poco alto! Hola. (data.otservbr.global.npc.nokmir.L100.97)
- Ah, another diciple of the extreme... surviving the icy outdoors? Let me {help}! → Ah, otro discípulo del extremo... ¿sobrevivir al aire libre helado? ¡Déjame {hel (data.otservbr.global.npc.nomad.L108.168)
- Keep a stiff upper lip! → ¡Mantén el labio superior rígido! (data.otservbr.global.npc.nomad.L109.169)
- Keep a stiff upper lip! → ¡Mantén el labio superior rígido! (data.otservbr.global.npc.nomad.L110.170)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **2131**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2071**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **9.84%** (274,205/2,786,472)
- **Kopie EN (łącznie):** **168,248**
...
|-------|--------|----------|----------|------------|
| ES | 36,995/49,731 | 74.4% | 2,504/3,855 | 65.0% |
| PL | 20,413/49,731 | 41.0% | 2,650/3,855 | 68.7% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-14T14:29:31.765110Z → 2026-02-14T15:29:31.765110Z) |
...
| Przepustowość (kluczy/h) | **1466.7 kluczy/h** |
...
> Świeżość: 37s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-14T15:28:54.612756Z

- **Ostatni audyt:** SLOW_MODE | 32 issue(s) / 100 entries | 2026-02-14T15:28:54.612756Z
- **Top 5 typów problemów:** suspicious_log_high=135, suspicious_rejected_critical=68, suspicious_log_critical=57, identical_to_en_exempt=22, identical_to_en=18
- **Języki o najsłabszej jakości:** es(60.1, issues=148991), pl(60.1, issues=113800), tl(64.2, issues=466), zh_TW(64.8, issues=337), fr(66.5, issues=2470)
...
⚠️ **PL**: jakość 60%, 113800 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 148991 problemów
...
| Heartbeat | 20s temu | 2026-02-14T15:29:11Z |
...
- 2026-02-14 15:29:11 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | spells.json
- 2026-02-14 15:29:11 | AUTO_TRANSLATE:parallel_start | pl | ok | spells.json
- 2026-02-14 15:29:11 | AUTO_TRANSLATE:auto_done | es | ok | server.json
- 2026-02-14 15:29:05 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-02-14 15:29:05 | AUTO_TRANSLATE:auto_start | es | ok | server.json
- 2026-02-14 15:28:44 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 43.0% | 0 | 1,926 | 1,998 | 1144 (36.4%) | 60 |
| 🟡 ES | 73.7% | 0 | 2,617 | 1,800 | 551 (23.4%) | 47 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **68,980** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=48.6%, reason=decrease_high_fail_rate=48.6% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 3,798 kluczy / 107 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-14 15:29:31

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+80, skipped+0) — lang=es file=server.json strict_skipped_done=592
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [el] → ok (translated+80, skipped+0) — parallel lang=el file=items.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [bs] → warn (files+1, translated+80, skipped+0) — lang=bs file=items.json strict_skip missing_file=0 missing_key=163 skipped_done=3305 strict_skipped_done=3305
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [pt] → ok (translated+80, skipped+0) — parallel lang=pt file=items.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [de] → warn (files+1, translated+80, skipped+0) — lang=de file=items.json strict_skip missing_file=0 missing_key=163 skipped_done=3285 strict_skipped_done=3285
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ar] → ok (translated+80, skipped+0) — parallel lang=ar file=items.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [cs] → warn (files+1, translated+80, skipped+0) — lang=cs file=items.json strict_skip missing_file=0 missing_key=163 skipped_done=3145 strict_skipped_done=3145
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ms] → ok (translated+80, skipped+0) — parallel lang=ms file=npc.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ml] → warn (files+1, translated+80, skipped+0) — lang=ml file=npc.json strict_skipped_done=574
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+2, skipped+0) — parallel lang=es file=talkactions.json
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **34,613** kluczy |
| ⏭️ Pominięte | 1 |
| 🔁 Cykli | 49 |
| ❌ Błędów | 408 |
| 🌍 Aktywnych języków | 52 |
| 🏆 TOP 5 | **ES** (8,684), **PL** (2,766), **IT** (971), **PT** (960), **DE** (890) |
| 📊 Porównanie | ↓ 24.9% vs wczoraj (46,073) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **82,035** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-14 15:29:31  
