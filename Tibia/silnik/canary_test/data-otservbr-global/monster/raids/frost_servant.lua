...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "Chrrr.", yell = false , i18nKey = "monster.frost_servant.voice_1"},
	{ text = "Crrrrk.", yell = false , i18nKey = "monster.frost_servant.voice_2"},
	{ text = "Gnarr.", yell = false , i18nKey = "monster.frost_servant.voice_3"},
}
