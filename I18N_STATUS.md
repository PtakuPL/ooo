...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.55%**. Tempo: **1826.0 kluczy/h**. Tłumaczeń netto: **95,380**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-17 04:12:09

> **Aktualizacja:** 2026-02-17 04:12:09 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #227 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: pl | Plik: - | Heartbeat: 2026-02-17T04:12:09Z  
> **Okno godzinowe:** okno=1.0h | cykli=145 | pominięte=0.0% | odrzucone=43.5% | przepustowość=1826.0/h  
> **Tłumaczeń netto:** 95,380

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-17 04:12:09 |
| LIVE | 🟢 AKTYWNY | 2s temu | - | `activity.json / worker_state.json` | 2026-02-17T04:12:09Z |
| MIGRATION | 🔒 NIEAKTYWNY | 51s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-17 04:12:09 |
| TRANSLATION | 🟢 AKTYWNY | 15s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-17T04:11:56.163526Z |
| QUALITY | 🔒 NIEAKTYWNY | 2s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-17T04:12:08.810194Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-17 04:12:09 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-17T04:12:09Z
...
| ❤️ **Heartbeat** | 2026-02-17T04:12:09Z |
...
| PL | 25,035 | 53,586 | 46.72% | 1,902 |
| RU | 20,303 | 53,586 | 37.89% | 2,579 |
...
> **ETA globalne:** ~54 dni (2,353,275 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ██████████████░░░░░░ | 74.8% | 40,079/53,586 | ~6h |
| PL | █████████░░░░░░░░░░░ | 46.7% | 25,035/53,586 | ~14h |
| RU | ███████░░░░░░░░░░░░░ | 37.9% | 20,303/53,586 | ~17h |
| FR | ██████░░░░░░░░░░░░░░ | 33.1% | 17,714/53,586 | ~18h |
| RO | ████░░░░░░░░░░░░░░░░ | 24.1% | 12,927/53,586 | ~21h |
| IT | ███░░░░░░░░░░░░░░░░░ | 15.3% | 8,213/53,586 | ~23h |
| ZH_TW | ██░░░░░░░░░░░░░░░░░░ | 14.5% | 7,776/53,586 | ~24h |
| SR | ██░░░░░░░░░░░░░░░░░░ | 11.5% | 6,146/53,586 | ~25h |
...
> Świeżość: 51s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-17 04:12:09
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 15s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-17T04:11:56.163526Z
...
| PL (Polski) | 25,035/53,586 | 46.72% | 1,902 | 0 |
| RU (Rosyjski) | 20,303/53,586 | 37.89% | 2,579 | 0 |
...
- **Pokrycie globalne:** **10.55%** (293,837/2,786,472)
- **Kopie EN (łącznie):** **166,219**
...
| PL | 22,354/49,731 | 45.0% | 2,681/3,855 | 69.5% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-17T03:12:09.666992Z → 2026-02-17T04:12:09.666992Z) |
...
| Podejrzane tłumaczenia | **9859** |
| Najgorsze cele (strażnik) | pl/items.json (gf=1039), pl/scripts.json (gf=146), es/books.json (gf=96), sr/server.json (gf=79), ro/spells.json (gf=77) |
...
> Świeżość: 2s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-17T04:12:08.810194Z

- **Ostatni audyt:** OK | 8 issue(s) / 100 entries | 2026-02-17T04:12:08.810194Z
- **Top 5 typów problemów:** suspicious_rejected_critical=174, suspicious_log_high=102, suspicious_log_critical=87, identical_to_en_exempt=34, suspicious_rejected_high=26
- **Języki o najsłabszej jakości:** es(60.1, issues=194505), pl(60.1, issues=125781), ro(60.1, issues=38188), ru(60.1, issues=29763), it(60.8, issues=11296)
...
⚠️ **PL**: jakość 60%, 125781 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 194505 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 61%, 11296 problemów
⚠️ **RU**: jakość 60%, 29763 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 74%, 9288 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #227 |
| Heartbeat | 2s temu | 2026-02-17T04:12:09Z |
...
- 2026-02-17 04:12:02 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-17 04:10:59 | AUTO_TRANSLATE:heartbeat_tick | it | ok | scripts.json
- 2026-02-17 04:10:59 | AUTO_TRANSLATE:parallel_start | it | ok | scripts.json
- 2026-02-17 04:10:28 | AUTO_TRANSLATE:heartbeat_tick | es | ok | books.json
- 2026-02-17 04:10:28 | AUTO_TRANSLATE:parallel_start | es | ok | books.json
- 2026-02-17 04:10:26 | AUTO_TRANSLATE:auto_done | pl | ok | books.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 46.7% | 0 | 1,902 | 1,040 | 3224 (75.6%) | 35 |
| 🟡 ES | 74.8% | 0 | 2,632 | 691 | 598 (46.4%) | 32 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **95,380** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=37.88%, reason=decrease_high_fail_rate=37.9% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,731 kluczy / 67 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-17 04:12:09
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+50, skipped+0) — lang=pl file=items.json strict_skipped_done=2139
- 🌍 TRANSLATION_SYNC: SYNC_FILE_DONE [hu] → ok (keys+1122, files+1) — lang=hu file=spells.json
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **17,324** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 166 |
| ❌ Błędów | 285 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (3,566), **IT** (3,159), **RU** (2,993), **RO** (2,732), **PL** (2,490) |
| 📊 Porównanie | ↓ 14.6% vs wczoraj (20,288) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **117,518** kluczy
...
| 🔄 Cykli wykonanych | **#227** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-17 04:12:09  
