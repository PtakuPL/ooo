...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.81%**. Tempo: **1115.2 kluczy/h**. Tłumaczeń netto: **113,182**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 16:34:10

> **Aktualizacja:** 2026-02-20 16:34:10 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #2 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: server.json | Heartbeat: 2026-02-20T16:34:09Z  
> **Okno godzinowe:** okno=1.0h | cykli=34 | pominięte=0.0% | odrzucone=84.1% | przepustowość=1115.2/h  
> **Tłumaczeń netto:** 113,182

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 16:34:10 |
| LIVE | 🟢 AKTYWNY | 2s temu | - | `activity.json / worker_state.json` | 2026-02-20T16:34:09Z |
| MIGRATION | 🔒 NIEAKTYWNY | 42s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 16:34:10 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T16:31:59.666000Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T16:34:11.192321Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 16:34:10 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T16:34:09Z
...
| ❤️ **Heartbeat** | 2026-02-20T16:34:09Z |
...
> **ETA globalne:** ~85 dni (2,262,274 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| PL | █████████████████░░░ | 87.7% | 47,007/53,586 | ~3h |
| ES | ████████████████░░░░ | 84.6% | 45,322/53,586 | ~5h |
| IT | ██████████░░░░░░░░░░ | 51.2% | 27,420/53,586 | ~21h |
| RU | ██████████░░░░░░░░░░ | 50.4% | 26,979/53,586 | ~21h |
| SR | █████████░░░░░░░░░░░ | 45.4% | 24,318/53,586 | ~24h |
| RO | ████████░░░░░░░░░░░░ | 42.0% | 22,510/53,586 | ~25h |
| FR | ██████░░░░░░░░░░░░░░ | 33.1% | 17,731/53,586 | ~30h |
| SV | █████░░░░░░░░░░░░░░░ | 28.1% | 15,031/53,586 | ~32h |
...
> Świeżość: 42s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 16:34:10
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T16:31:59.666000Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T15:34:10.952338Z → 2026-02-20T16:34:10.952338Z) |
| Cykle | **34** (TŁUMACZENIE=34, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **84.1%** |
| Cykle bez postępu % | **9.5%** |
| Przepustowość (kluczy/h) | **1115.2 kluczy/h** |
| Podejrzane tłumaczenia | **2595** |
| Najgorsze cele (strażnik) | pl/items.json (gf=1672), pl/npc.json (gf=666), es/items.json (gf=516), pl/server.json (gf=87), es/npc.json (gf=54) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T16:34:11.192321Z

- **Ostatni audyt:** SLOW_MODE | 40 issue(s) / 100 entries | 2026-02-20T16:32:01.654361Z | recent_hidden=0
- **Alarm recent hidden HIGH/CRITICAL:** ✅ OK | hidden=0, threshold=5, trend=→ last10=0.00, prev10=0.00, latest=0
- **Regresja critical bad keys pack:** 🚨 FAIL: pl(critical=47, pack=0), es(critical=26, pack=0)
- **Top 5 typów problemów:** suspicious_rejected_critical=150, suspicious_log_critical=123, suspicious_log_high=65, suspicious_rejected_high=50, artifact_token=32
- **Języki o najsłabszej jakości:** es(60.1, issues=314892), pl(60.1, issues=178422), ro(60.1, issues=172020), sr(60.5, issues=85529), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 60%, 178422 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 314892 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 74%, 69286 problemów
⚠️ **RU**: jakość 87%, 208286 problemów
...
| Heartbeat | 2s temu | 2026-02-20T16:34:09Z |
...
- 2026-02-20 16:34:09 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-02-20 16:34:08 | AUTO_TRANSLATE:auto_start | es | ok | server.json
- 2026-02-20 16:31:53 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | monsters.json
- 2026-02-20 16:31:53 | AUTO_TRANSLATE:parallel_start | pl | ok | monsters.json
- 2026-02-20 16:31:51 | AUTO_TRANSLATE:auto_done | es | ok | npc.json
- 2026-02-20 16:31:25 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.7% | 0 | 1,827 | 646 | 5784 (90.0%) | 41 |
| 🟡 ES | 84.6% | 0 | 2,160 | 629 | 2074 (76.7%) | 41 |
...
| Przepustowość (okno) | 1,275 kluczy / 82 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 16:34:10
...
| ❌ Błędów | 17 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (242), **RU** (94), **PL** (91), **IT** (86), **RO** (82) |
| 📊 Porównanie | ↓ 80.9% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **98,280** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 16:34:10  
