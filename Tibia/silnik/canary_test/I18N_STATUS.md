...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.88%**. Tempo: **1412.0 kluczy/h**. Tłumaczeń netto: **122,411**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 20:52:36

> **Aktualizacja:** 2026-02-20 20:52:36 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #174 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: - | Heartbeat: 2026-02-20T20:52:33Z  
> **Okno godzinowe:** okno=1.0h | cykli=197 | pominięte=0.0% | odrzucone=74.0% | przepustowość=1412.0/h  
> **Tłumaczeń netto:** 122,411

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 20:52:36 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T20:52:33Z |
| MIGRATION | 🔒 NIEAKTYWNY | 43s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 20:52:36 |
| TRANSLATION | 🟢 AKTYWNY | 37s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T20:52:00.105366Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T20:52:37.928710Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 20:52:36 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T20:52:33Z
...
| ❤️ **Heartbeat** | 2026-02-20T20:52:33Z |
...
> Świeżość: 43s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 20:52:36
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 37s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T20:52:00.105366Z
...
| IT (Włoski) | 28,037/53,586 | 52.32% | 2,142 | 0 |
...
| IT | 26,674/49,731 | 53.6% | 1,363/3,855 | 35.4% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T19:52:37.244171Z → 2026-02-20T20:52:37.244171Z) |
...
| Najgorsze cele (strażnik) | pl/items.json (gf=2448), pl/npc.json (gf=1936), es/items.json (gf=1565), es/server.json (gf=164), it/npc.json (gf=95) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T20:52:37.928710Z

- **Ostatni audyt:** SLOW_MODE | 30 issue(s) / 100 entries | 2026-02-20T20:52:32.918843Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=146, suspicious_log_critical=84, suspicious_log_high=43, artifact_token=25, suspicious_rejected_high=17
- **Języki o najsłabszej jakości:** es(60.1, issues=342481), pl(60.1, issues=191044), ro(60.1, issues=185958), sr(64.1, issues=86932), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 60%, 191044 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 342481 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 83%, 75815 problemów
⚠️ **RU**: jakość 76%, 213732 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 70%, 31493 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #174 |
| Heartbeat | 5s temu | 2026-02-20T20:52:33Z |
...
- 2026-02-20 20:52:07 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 20:51:53 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | npc.json
- 2026-02-20 20:51:53 | AUTO_TRANSLATE:parallel_start | ro | ok | npc.json
- 2026-02-20 20:51:48 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | npc.json
- 2026-02-20 20:51:48 | AUTO_TRANSLATE:parallel_start | ru | ok | npc.json
- 2026-02-20 20:51:47 | AUTO_TRANSLATE:auto_done | it | ok | npc.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,830 | 715 | 6784 (90.5%) | 40 |
| 🟡 ES | 84.8% | 0 | 2,160 | 630 | 2700 (81.1%) | 42 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **122,411** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=45.48%, reason=decrease_high_fail_rate=45.5% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,345 kluczy / 82 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 20:52:36
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+46, skipped+0) — lang=pl file=cpp.json strict_skipped_done=635 guard_fail=13 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+47, skipped+0) — parallel lang=es file=quests.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+33, skipped+0) — lang=pl file=scripts.json strict_skipped_done=2137 guard_fail=12 placeholder=0 command=12 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **14,714** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 174 |
| ❌ Błędów | 362 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (4,410), **RU** (2,822), **IT** (2,313), **PL** (1,804), **RO** (1,731) |
| 📊 Porównanie | ↑ 304.1% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **112,299** kluczy
...
| 🔄 Cykli wykonanych | **#174** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 20:52:36  
