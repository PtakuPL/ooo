...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.96% / real 10.88%**. Tempo: **803.0 kluczy/h**. Tłumaczeń netto: **142,005**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 04:39:33

> **Aktualizacja:** 2026-04-29 04:39:33 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,724 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-04-29T04:36:51Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=3.9% | przepustowość=803.0/h  
> **Tłumaczeń netto:** 142,005

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 04:39:33 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T04:36:51Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 04:39:33 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T04:38:25.446112Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T04:36:50.167411Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 04:39:33 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T04:39:38.743056Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T04:36:51Z
...
| ❤️ **Heartbeat** | 2026-04-29T04:36:51Z |
...
| ⏳ Oldest pending (visible tail) | 17063 s |
| 🌍 Top języki | RU(400) |
...
| 🌍 Recent provider mix | TM/simple(322), Free Google Translate(168), canonical_name_semantic_autofix(15), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=508, fallbacks=10) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=650/650 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 17063}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~155 dni (2,985,947 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 78.9% | 58,820/74,536 | ~15h |
| PL | ██████████████░░░░░░ | 71.0% | 52,911/74,536 | ~22h |
| IT | █████████████░░░░░░░ | 70.0% | 52,166/74,536 | ~23h |
| RO | █████████████░░░░░░░ | 69.7% | 51,972/74,536 | ~23h |
| RU | █████████░░░░░░░░░░░ | 45.8% | 34,102/74,536 | ~46h |
| FR | ███████████░░░░░░░░░ | 57.5% | 42,864/74,536 | ~35h |
| PT | ████████████████░░░░ | 81.2% | 60,516/74,536 | ~13h |
| CS | ██████████░░░░░░░░░░ | 50.0% | 37,287/74,536 | ~42h |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 04:39:33
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T04:38:25.446112Z
...
- stone pillar → каменный колонна (item.13152.name)
- stone pillar → каменный колонна (item.13153.name)
- stone pillar → каменный колонна (item.13154.name)
- hive structure → структура улья (item.13170.name)
- hive structure → структура улья (item.13171.name)
- hive structure → структура улья (item.13172.name)
- hive structure → структура улья (item.13173.name)
- hive structure → структура улья (item.13174.name)
- hive structure → структура улья (item.13175.name)
- hive structure → структура улья (item.13176.name)
- hive structure → структура улья (item.13177.name)
- hive structure → структура улья (item.13178.name)
- hive structure → структура улья (item.13179.name)
- small moist stones → маленькие влажные камни (item.13161.name)
- small moist stones → маленькие влажные камни (item.13162.name)
- small moist stones → маленькие влажные камни (item.13163.name)
- small moist stones → маленькие влажные камни (item.13164.name)
- small moist stones → маленькие влажные камни (item.13165.name)
- small moist stones → маленькие влажные камни (item.13166.name)
- small moist stones → маленькие влажные камни (item.13167.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4779**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4632**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T04:37:08.719474Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.96%** (696,121/3,875,872)
- **Pokrycie globalne (real):** **10.88%** (421,685/3,875,872)
- **Kopie EN (łącznie):** **410,523**
- **Placeholdery [EN]/puste (łącznie):** **2,189,542**
...
| 🕒 Evidence window | 24h (span=33.79h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=33.79h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T03:39:33.445554Z → 2026-04-29T04:39:33.445554Z) |
...
| Przepustowość (kluczy/h) | **803.0 kluczy/h** |
...
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T04:36:50.167411Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T04:36:50.167411Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=733468), ro(60.1, issues=432089), de(60.1, issues=114984), cs(60.1, issues=93403), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 61%, 54423 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 733468 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 67%, 172514 problemów
⚠️ **RU**: jakość 73%, 363225 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,724 |
| Heartbeat | 167s temu | 2026-04-29T04:36:51Z |
...
- 2026-04-29 04:38:43 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 04:38:25 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
- 2026-04-29 04:37:09 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-04-29 04:37:09 | AUTO_TRANSLATE:auto_start | ru | ok | items.json
- 2026-04-29 04:36:49 | AUTO_TRANSLATE:auto_done | tr | ok | items.json
- 2026-04-29 04:36:08 | AUTO_TRANSLATE:heartbeat_tick | tr | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **142,005** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=3.14%, reason=increase_low_fail_rate=3.1%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 04:39:33
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **4,108** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 90 |
| ❌ Błędów | 164 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (812), **RU** (761), **IT** (658), **DE** (540), **TR** (495) |
| 📊 Porównanie | ↓ 50.1% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **23,088** kluczy
...
| 🔄 Cykli wykonanych | **#17,724** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,724 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 04:39:33  
