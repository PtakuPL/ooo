...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-19 14:42:31

> **Aktualizacja:** 2026-02-19 14:42:31 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #1 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: sv | Plik: dataroot.json | Heartbeat: 2026-02-19T14:42:28Z  
...
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-19 14:42:31 |
| LIVE | 🟢 AKTYWNY | 6s temu | - | `activity.json / worker_state.json` | 2026-02-19T14:42:28Z |
| MIGRATION | 🔒 NIEAKTYWNY | 2d temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-19 14:42:31 |
| TRANSLATION | 🟢 AKTYWNY | 8s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-19T14:42:26.736406Z |
| QUALITY | 🔒 NIEAKTYWNY | 34s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-19T14:42:00.764532Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-19 14:42:31 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-19T14:42:28Z
...
| ❤️ **Heartbeat** | 2026-02-19T14:42:28Z |
...
> Świeżość: 2d temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-19 14:42:31
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 8s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-19T14:42:26.736406Z
...
- Raporty strażnika jakości: **5189**  
- Raporty blokad: **0**  
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-19T13:42:32.104073Z → 2026-02-19T14:42:32.104073Z) |
...
| Najgorsze cele (strażnik) | es/quests.json (gf=0), pl/quests.json (gf=0), pl/raids.json (gf=0), es/raids.json (gf=0), es/scripts.json (gf=0) |
...
> Świeżość: 34s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-19T14:42:00.764532Z

- **Ostatni audyt:** SLOW_MODE | 31 issue(s) / 100 entries | 2026-02-19T14:42:00.764532Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=279467), pl(60.1, issues=158849), ru(60.1, issues=122972), ro(60.1, issues=122962), sr(60.1, issues=64747)
...
⚠️ **PL**: jakość 60%, 158849 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 279467 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 47861 problemów
⚠️ **RU**: jakość 60%, 122972 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 90%, 26360 problemów
...
| Heartbeat | 6s temu | 2026-02-19T14:42:28Z |
...
- 2026-02-19 14:42:28 | AUTO_TRANSLATE:heartbeat_tick | sv | ok | dataroot.json
- 2026-02-19 14:42:28 | AUTO_TRANSLATE:parallel_start | sv | ok | dataroot.json
- 2026-02-19 14:42:26 | AUTO_TRANSLATE:auto_done | sr | ok | dataroot.json
- 2026-02-19 14:42:23 | AUTO_TRANSLATE:heartbeat_tick | sr | ok | dataroot.json
- 2026-02-19 14:42:23 | AUTO_TRANSLATE:auto_start | sr | ok | dataroot.json
- 2026-02-19 14:41:52 | AUTO_TRANSLATE:heartbeat_tick | sr | ok | movements.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-19 14:42:31

- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [sv] → ok (translated+0, skipped+0) — parallel lang=sv file=dataroot.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [sr] → ok (files+0, translated+0, skipped+0) — lang=sr file=dataroot.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [sr] → ok (translated+0, skipped+0) — parallel lang=sr file=movements.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [sv] → ok (files+0, translated+0, skipped+0) — lang=sv file=movements.json
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-19 14:42:31  
