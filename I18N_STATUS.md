...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 06:09:52

> **Aktualizacja:** 2026-04-29 06:09:52 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,856 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: cs | Plik: items.json | Heartbeat: 2026-04-29T06:09:25Z
...
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 06:09:52 |
| LIVE | 🟢 AKTYWNY | 33s temu | - | `activity.json / worker_state.json` | 2026-04-29T06:09:25Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 06:09:52 |
| TRANSLATION | 🟢 AKTYWNY | 4min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T06:05:48.943557Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T06:08:57.586701Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 06:09:52 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T06:09:58.610531Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 33s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T06:09:25Z
...
| ❤️ **Heartbeat** | 2026-04-29T06:09:25Z |
...
| ⏳ Oldest pending (visible tail) | 16495 s |
...
| 🌍 Recent provider mix | TM/simple(344), Free Google Translate(127), canonical_name_semantic_autofix(15), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=489, fallbacks=18) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=721/721 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 16495}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 06:09:52
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 4min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T06:05:48.943557Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T06:09:24.069015Z |
...
| 🕒 Evidence window | 24h (span=35.29h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=35.29h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T05:09:52.335158Z → 2026-04-29T06:09:52.335158Z) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T06:08:57.586701Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T06:08:57.586701Z
- **Top 5 typów problemów:** suspicious_rejected_critical=187, suspicious_log_low=145, suspicious_log_high=55, suspicious_rejected_high=13
- **Języki o najsłabszej jakości:** es(60.1, issues=736437), ro(60.1, issues=434344), de(60.1, issues=117154), cs(60.1, issues=97097), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 736437 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 70%, 173595 problemów
⚠️ **RU**: jakość 68%, 365019 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,856 |
| Heartbeat | 33s temu | 2026-04-29T06:09:25Z |
...
- 2026-04-29 06:09:25 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | items.json
- 2026-04-29 06:09:24 | AUTO_TRANSLATE:auto_start | cs | ok | items.json
- 2026-04-29 06:07:35 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 06:09:52
...
| 🔄 Cykli wykonanych | **#17,856** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,856 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 06:09:52  
