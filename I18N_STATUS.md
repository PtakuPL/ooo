...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.0% / real 10.92%**. Tempo: **699.0 kluczy/h**. Tłumaczeń netto: **144,784**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 08:22:43

> **Aktualizacja:** 2026-04-29 08:22:43 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,044 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-04-29T08:20:14Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=5.8% | przepustowość=699.0/h  
> **Tłumaczeń netto:** 144,784

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 08:22:43 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T08:20:14Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 08:22:43 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T08:21:33.346445Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T08:19:55.761839Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 08:22:43 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T08:22:51.331621Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T08:20:14Z
...
| 🔄 **Ostatni cykl** | 41 kluczy, 8 odrzuconych, 79.0s, tryb: AUTO_TRANSLATE, cel: cs/items.json |
| ❤️ **Heartbeat** | 2026-04-29T08:20:14Z |
...
| ⏳ Oldest pending (visible tail) | 16129 s |
| 🌍 Top języki | RU(385), CS(3) |
| 🧱 Top reason_bucket | quality(385), default(3) |
| 🗂️ Deferred state keys | 8112 |
| 🕒 Deferred state freshness | fresh (75s) |
| ♻️ Deferred stats | enqueued=1, cooldown=6, deduped=7, manual_review=0, partial_staged=0, partial_completed=0 |
...
| 🌍 Recent provider mix | TM/simple(316), Free Google Translate(174), canonical_name_semantic_autofix(16), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=509, fallbacks=23) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=824/824 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 388, 'oldest_s': 16129}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~178 dni (2,984,425 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~699 kluczy/h.
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 08:22:43
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T08:21:33.346445Z
...
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14368.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14369.name)
- ornamented wall → zdobená stěna (item.1437.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14370.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14371.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14372.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14373.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14374.name)
- RESERVED SPRITE → REZERVOVANÝ SPRITE (item.14375.name)
...
- Raporty strażnika jakości: **4859**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4712**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T08:20:13.692233Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.0%** (697,643/3,875,872)
- **Pokrycie globalne (real):** **10.92%** (423,252/3,875,872)
- **Kopie EN (łącznie):** **410,478**
- **Placeholdery [EN]/puste (łącznie):** **2,188,020**
...
| 🕒 Evidence window | 24h (span=37.51h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=37.51h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T07:22:43.604631Z → 2026-04-29T08:22:43.604631Z) |
...
| Przepustowość (kluczy/h) | **699.0 kluczy/h** |
| Podejrzane tłumaczenia | **1183** |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 82 | 77.4% | ru/items.json (82) |
| `existing_canonical_name_quality_mixed_scripts` | 14 | 13.2% | ru/items.json (14) |
| `retry_loop_cooldown_default` | 10 | 9.4% | cs/items.json (5) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T08:19:55.761839Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T08:19:55.761839Z
- **Top 5 typów problemów:** suspicious_rejected_critical=188, suspicious_log_high=79, suspicious_log_low=70, suspicious_log_medium=51, suspicious_rejected_high=12
- **Języki o najsłabszej jakości:** es(60.1, issues=740466), ro(60.1, issues=437319), de(60.1, issues=120017), cs(60.1, issues=102976), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 63%, 55770 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 740466 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 71%, 175139 problemów
⚠️ **RU**: jakość 70%, 367619 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,044 |
| Heartbeat | 157s temu | 2026-04-29T08:20:14Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T08:21:50.510003Z
...
- 2026-04-29 08:21:51 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 08:21:33 | AUTO_TRANSLATE:auto_done | cs | ok | items.json
- 2026-04-29 08:20:14 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | items.json
- 2026-04-29 08:20:14 | AUTO_TRANSLATE:auto_start | cs | ok | items.json
- 2026-04-29 08:19:55 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
- 2026-04-29 08:18:38 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **144,784** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=4.64%, reason=increase_low_fail_rate=4.6%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 08:22:43

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [cs] → warn (files+1, translated+41, skipped+0) — lang=cs file=items.json strict_skipped_done=4030 guard_fail=8 placeholder=0 command=0 pipe=0
- • DOCTOR_REMEDIATION: ALARM_RESOLVED [-] → ok — resolved_count=1
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+6) — repair_identical lang=es file=npc.json target_identical=2 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=187.22
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **7,158** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 170 |
| ❌ Błędów | 304 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,380), **RU** (1,279), **TR** (1,032), **DE** (990), **IT** (967) |
| 📊 Porównanie | ↓ 13.0% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **26,138** kluczy
...
| 🔄 Cykli wykonanych | **#18,044** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,044 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 08:22:43  
