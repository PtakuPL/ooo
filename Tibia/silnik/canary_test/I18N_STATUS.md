...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.98% / real 10.9%**. Tempo: **933.0 kluczy/h**. Tłumaczeń netto: **143,528**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 06:33:44

> **Aktualizacja:** 2026-04-29 06:33:44 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,889 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: cs | Plik: items.json | Heartbeat: 2026-04-29T06:31:57Z
> **Okno godzinowe:** okno=1.0h | cykli=85 | pominięte=0.0% | odrzucone=4.0% | przepustowość=933.0/h  
> **Tłumaczeń netto:** 143,528

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 06:33:44 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T06:31:57Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 47s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 06:33:44 |
| TRANSLATION | 🟢 AKTYWNY | 16s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T06:33:36.388168Z |
| QUALITY | 🔒 NIEAKTYWNY | 15s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T06:33:37.450688Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 06:33:44 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T06:33:52.584250Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T06:31:57Z
...
| 🔄 **Ostatni cykl** | 41 kluczy, 7 odrzuconych, 72.3s, tryb: AUTO_TRANSLATE, cel: cs/items.json |
| ❤️ **Heartbeat** | 2026-04-29T06:31:57Z |
...
| ⏳ Oldest pending (visible tail) | 16540 s |
...
| ♻️ Deferred stats | enqueued=0, cooldown=5, deduped=7, manual_review=0, partial_staged=0, partial_completed=0 |
...
| 🌍 Recent provider mix | TM/simple(323), Free Google Translate(167), canonical_name_semantic_autofix(15), term_consistency_autofix(3) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=740/740 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 16540}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 47s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 06:33:44
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 16s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T06:33:36.388168Z
...
- unknown item → neznámá položka (item.14201.name)
- unknown item → neznámá položka (item.14202.name)
- unknown item → neznámá položka (item.14203.name)
- unknown item → neznámá položka (item.14204.name)
- unknown item → neznámá položka (item.14205.name)
- unknown item → neznámá položka (item.14206.name)
- unknown item → neznámá položka (item.14207.name)
- unknown item → neznámá položka (item.14208.name)
- unknown item → neznámá položka (item.14209.name)
...
- Raporty strażnika jakości: **4820**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4673**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T06:32:24.720139Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.98%** (697,024/3,875,872)
- **Pokrycie globalne (real):** **10.9%** (422,598/3,875,872)
- **Kopie EN (łącznie):** **410,513**
- **Placeholdery [EN]/puste (łącznie):** **2,188,639**
...
| 🕒 Evidence window | 24h (span=35.69h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=35.69h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T05:33:44.539050Z → 2026-04-29T06:33:44.539050Z) |
...
| Przepustowość (kluczy/h) | **933.0 kluczy/h** |
| Podejrzane tłumaczenia | **1259** |
| Najgorsze cele (strażnik) | cs/items.json (gf=20), ro/items.json (gf=8), de/otclient_modules.json (gf=3), de/npc.json (gf=3), ru/items.json (gf=3) |
...
> Świeżość: 15s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T06:33:37.450688Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T06:33:37.450688Z
- **Top 5 typów problemów:** suspicious_rejected_critical=188, suspicious_log_low=110, suspicious_log_high=90, suspicious_rejected_high=12
- **Języki o najsłabszej jakości:** es(60.1, issues=737194), ro(60.1, issues=434947), de(60.1, issues=117629), cs(60.1, issues=98333), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 63%, 55078 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 737194 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 73%, 173891 problemów
⚠️ **RU**: jakość 65%, 365434 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,889 |
| Heartbeat | 115s temu | 2026-04-29T06:31:57Z |
...
- 2026-04-29 06:33:36 | AUTO_TRANSLATE:auto_done | cs | ok | items.json
- 2026-04-29 06:32:25 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | items.json
- 2026-04-29 06:32:25 | AUTO_TRANSLATE:auto_start | cs | ok | items.json
- 2026-04-29 06:30:34 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 06:33:44

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [cs] → warn (files+1, translated+41, skipped+0) — lang=cs file=items.json strict_skipped_done=3846 guard_fail=7 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+66, skipped+0) — lang=ro file=items.json strict_skipped_done=1152 guard_fail=4 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **5,770** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 131 |
| ❌ Błędów | 236 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,163), **RU** (1,075), **IT** (808), **DE** (765), **TR** (762) |
| 📊 Porównanie | ↓ 29.9% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **24,750** kluczy
...
| 🔄 Cykli wykonanych | **#17,889** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,889 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 06:33:44  
