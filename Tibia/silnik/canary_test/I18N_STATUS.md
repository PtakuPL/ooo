...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.72%**. Tempo: **1593.4 kluczy/h**. Tłumaczeń netto: **109,107**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-17 10:42:00

> **Aktualizacja:** 2026-02-17 10:42:00 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #451 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-02-17T10:40:48Z  
> **Okno godzinowe:** okno=1.0h | cykli=144 | pominięte=0.0% | odrzucone=48.9% | przepustowość=1593.4/h  
> **Tłumaczeń netto:** 109,107

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-17 10:42:00 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-02-17T10:40:48Z |
| MIGRATION | 🔒 NIEAKTYWNY | 15s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-17 10:42:00 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-17T10:40:39.924549Z |
| QUALITY | 🔒 NIEAKTYWNY | 46s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-17T10:41:16.517264Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-17 10:42:00 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-17T10:40:48Z
...
| ❤️ **Heartbeat** | 2026-02-17T10:40:48Z |
...
> **ETA globalne:** ~59 dni (2,264,774 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| PL | █████████████████░░░ | 87.3% | 46,805/53,586 | ~3h |
| ES | ████████████████░░░░ | 84.3% | 45,149/53,586 | ~4h |
| RU | ██████████░░░░░░░░░░ | 50.2% | 26,884/53,586 | ~15h |
| IT | █████████░░░░░░░░░░░ | 49.6% | 26,570/53,586 | ~15h |
| SR | ████████░░░░░░░░░░░░ | 45.0% | 24,109/53,586 | ~17h |
| RO | ████████░░░░░░░░░░░░ | 40.7% | 21,826/53,586 | ~18h |
| FR | ██████░░░░░░░░░░░░░░ | 33.1% | 17,731/53,586 | ~21h |
| SV | █████░░░░░░░░░░░░░░░ | 27.5% | 14,744/53,586 | ~23h |
...
> Tempo obliczone na bazie ostatniej godziny: ~1593 kluczy/h.
...
> Świeżość: 15s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-17 10:42:00
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-17T10:40:39.924549Z
...
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3443**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **13.72%** (382,338/2,786,472)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-17T09:42:00.722240Z → 2026-02-17T10:42:00.722240Z) |
...
| Przepustowość (kluczy/h) | **1593.4 kluczy/h** |
| Podejrzane tłumaczenia | **9844** |
| Najgorsze cele (strażnik) | pl/items.json (gf=822), pl/npc.json (gf=646), it/spells.json (gf=89), ro/spells.json (gf=81), es/questlog.json (gf=78) |
...
> Świeżość: 46s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-17T10:41:16.517264Z

- **Ostatni audyt:** SLOW_MODE | 19 issue(s) / 100 entries | 2026-02-17T10:41:16.517264Z
- **Top 5 typów problemów:** suspicious_rejected_critical=186, suspicious_log_high=174, identical_to_en_exempt=26, suspicious_log_critical=26, artifact_token=16
- **Języki o najsłabszej jakości:** es(60.1, issues=241760), pl(60.1, issues=138391), ro(60.1, issues=59479), it(60.2, issues=20321), sr(60.4, issues=5015)
...
⚠️ **PL**: jakość 60%, 138391 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 241760 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 20321 problemów
⚠️ **RU**: jakość 66%, 47446 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #451 |
| Heartbeat | 75s temu | 2026-02-17T10:40:48Z |
...
- 2026-02-17 10:40:48 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-17 10:40:36 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | scripts.json
- 2026-02-17 10:40:36 | AUTO_TRANSLATE:parallel_start | ru | ok | scripts.json
- 2026-02-17 10:39:46 | AUTO_TRANSLATE:heartbeat_tick | it | ok | scripts.json
- 2026-02-17 10:39:46 | AUTO_TRANSLATE:parallel_start | it | ok | scripts.json
- 2026-02-17 10:39:45 | AUTO_TRANSLATE:auto_done | es | ok | otclient_modules.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **109,107** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=34.46%, reason=decrease_high_fail_rate=34.5% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-17 10:42:00
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **39,221** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 390 |
| ❌ Błędów | 682 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (8,233), **IT** (7,314), **RU** (7,154), **RO** (6,286), **PL** (4,757) |
| 📊 Porównanie | ↑ 93.3% vs wczoraj (20,288) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **139,415** kluczy
...
| 🔄 Cykli wykonanych | **#451** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-17 10:42:00  
