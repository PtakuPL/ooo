...
-- Basic
keywordHandler:addKeyword({ "name" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.romella.stdmod_1" })
keywordHandler:addAliasKeyword({ "job" })

keywordHandler:addKeyword({ "weapons" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.romella.stdmod_2" })
keywordHandler:addKeyword({ "offers" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.romella.stdmod_3" })
keywordHandler:addAliasKeyword({ "ware" })

keywordHandler:addKeyword({ "army" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.romella.stdmod_4" })
keywordHandler:addKeyword({ "news" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.romella.stdmod_5" })
keywordHandler:addKeyword({ "amazons" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.romella.stdmod_6" })
