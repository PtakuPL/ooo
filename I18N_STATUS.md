...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.22%**. Tempo: **2237.4 kluczy/h**. Tłumaczeń netto: **82,749**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-16 23:44:18

> **Aktualizacja:** 2026-02-16 23:44:18 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #52 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ru | Plik: quests.json | Heartbeat: 2026-02-16T23:44:07Z  
> **Okno godzinowe:** okno=1.0h | cykli=159 | pominięte=0.0% | odrzucone=44.2% | przepustowość=2237.4/h  
> **Tłumaczeń netto:** 82,749

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-16 23:44:18 |
| LIVE | 🟢 AKTYWNY | 12s temu | - | `activity.json / worker_state.json` | 2026-02-16T23:44:07Z |
| MIGRATION | 🔒 NIEAKTYWNY | 58s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-16 23:44:18 |
| TRANSLATION | 🟢 AKTYWNY | 28s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-16T23:43:50.434654Z |
| QUALITY | 🔒 NIEAKTYWNY | 28s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-16T23:43:50.990451Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-16 23:44:18 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 12s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-16T23:44:07Z
...
| ❤️ **Heartbeat** | 2026-02-16T23:44:07Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **4,091** kluczy |
| ❌ Odrzucone (guard) | 3244 |
| 🔁 Cykli | 159 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | IT (872 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~2237 kluczy/h |
...
| RU | 19,150 | 53,586 | 35.74% | 2,670 |
| FR | 17,711 | 53,586 | 33.05% | 4,028 |
| RO | 10,677 | 53,586 | 19.92% | 2,480 |
...
> Tempo obliczone na bazie ostatniej godziny: ~2237 kluczy/h.
...
> Świeżość: 58s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-16 23:44:18
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 28s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-16T23:43:50.434654Z
...
| RU (Rosyjski) | 19,150/53,586 | 35.74% | 2,670 | 0 |
| FR (Francuski) | 17,711/53,586 | 33.05% | 4,028 | 0 |
| RO (Rumuński) | 10,677/53,586 | 19.92% | 2,480 | 0 |
...
- You are cutting some snake maw. → Stai tagliando le fauci di un serpente. (quests.kilmaresh.cutting_snake_maw)
- You are cutting some veldt flowers. → Stai tagliando dei fiori del veldt. (quests.kilmaresh.cutting_veldt)
- The gryphon nest is empty. → Il nido del grifone è vuoto. (quests.kilmaresh.empty_gryphon_nest)
- This palm is empty. → Questo palmo è vuoto. (quests.kilmaresh.empty_palm)
- The sarcophagus is empty. → Il sarcofago è vuoto. (quests.kilmaresh.empty_sarcophagus)
- You have found a gryphon mask. → Hai trovato una maschera di grifone. (quests.kilmaresh.found_gryphon_mask)
- You have found a mirror mask. → Hai trovato una maschera a specchio. (quests.kilmaresh.found_mirror_mask)
- You have found a silver mask. → Hai trovato una maschera d'argento. (quests.kilmaresh.found_silver_mask)
- You are gathering some spiderweb cloud shreds. But you become entangled. → Stai raccogliendo alcuni brandelli di nuvole di ragnatela. Ma rimani intrappolat (quests.kilmaresh.gathering_spiderweb)
- The Ambassador tells another dignitary: Rathleton must never be surpassed! I wil → L'Ambasciatore dice ad un altro dignitario: Rathleton non deve mai essere supera (quests.kilmaresh.memory_word_1)
- Through a dimensional gate you can see the Ambassador of Rathleton wearing a clo → Attraverso un portale dimensionale puoi vedere l'Ambasciatore di Rathleton che i (quests.kilmaresh.memory_word_2)
- Through a dimensional gate you can see how the Ambassador of Rathleton is talkin → Attraverso un portale dimensionale puoi vedere come l'Ambasciatore di Rathleton  (quests.kilmaresh.memory_word_3)
- You place the amethyst on the small socket. A violet flame begins to burn. → Metti l'ametista sulla piccola presa. Una fiamma viola comincia a bruciare. (quests.lions_rock.amethyst_flame)
- You place the ruby on the small socket. A red flame begins to burn. → Metti il ​​rubino sulla piccola presa. Una fiamma rossa inizia a bruciare. (quests.lions_rock.ruby_flame)
- You place the sapphire on the small socket. A blue flame begins to burn. → Metti lo zaffiro sulla piccola presa. Una fiamma blu inizia a bruciare. (quests.lions_rock.sapphire_flame)
- When the time comes, '%s' will be accepted at this shrine. → Quando arriverà il momento, '%s' sarà accettato in questo santuario. (quests.lions_rock.shrine_time)
- With the aid of the old scroll you translate the inscriptions on the golden stat → Con l'aiuto dell'antico rotolo traduci le iscrizioni sulla statua d'oro: E il po (quests.lions_rock.sign_hyaena_1)
- As a sign of victory he tooks its blood, red as voracity and lust, and created a → In segno di vittoria ne prese il sangue, rosso come la voracità e la lussuria, e (quests.lions_rock.sign_hyaena_2)
- With the aid of the old scroll you translate the inscriptions on the floor: And  → Con l'aiuto del vecchio rotolo traduci le iscrizioni sul pavimento: E il potente (quests.lions_rock.sign_lizard_1)
- As a sign of victory he tooks its egg, blue as sloth and conceit, and out of a f → In segno di vittoria prese il suo uovo, azzurro come l'accidia e la presunzione, (quests.lions_rock.sign_lizard_2)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **2480**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2417**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **10.22%** (284,699/2,786,472)
- **Kopie EN (łącznie):** **166,437**
...
| RU | 16,424/49,731 | 33.0% | 2,726/3,855 | 70.7% |
| FR | 15,164/49,731 | 30.5% | 2,547/3,855 | 66.1% |
| RO | 10,492/49,731 | 21.1% | 185/3,855 | 4.8% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-16T22:44:18.358267Z → 2026-02-16T23:44:18.358267Z) |
...
| Przepustowość (kluczy/h) | **2237.4 kluczy/h** |
| Podejrzane tłumaczenia | **14385** |
...
> Świeżość: 28s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-16T23:43:50.990451Z

- **Ostatni audyt:** OK | 7 issue(s) / 100 entries | 2026-02-16T23:43:50.990451Z
- **Top 5 typów problemów:** suspicious_rejected_critical=159, suspicious_log_high=128, suspicious_log_critical=65, suspicious_rejected_high=41, identical_to_en_exempt=11
- **Języki o najsłabszej jakości:** ro(60.0, issues=16241), es(60.1, issues=164185), ru(60.2, issues=15451), it(63.2, issues=6027), sv(63.3, issues=3350)
...
⚠️ **PL**: jakość 77%, 117080 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 164185 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 63%, 6027 problemów
⚠️ **RU**: jakość 60%, 15451 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 63%, 3350 problemów
...
| Heartbeat | 12s temu | 2026-02-16T23:44:07Z |
...
- 2026-02-16 23:44:07 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | quests.json
- 2026-02-16 23:44:07 | AUTO_TRANSLATE:auto_start | ru | ok | quests.json
- 2026-02-16 23:43:19 | AUTO_TRANSLATE:heartbeat_tick | it | ok | quests.json
- 2026-02-16 23:43:18 | AUTO_TRANSLATE:parallel_start | it | ok | quests.json
- 2026-02-16 23:42:47 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | spells.json
- 2026-02-16 23:42:47 | AUTO_TRANSLATE:parallel_start | ro | ok | spells.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **82,749** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=17.23%, reason=stable_fail_rate=17.2% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-16 23:44:18
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+78, skipped+0) — lang=es file=otclient_modules.json strict_skipped_done=812 guard_fail=2 placeholder=0 command=0 pipe=0
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+6, skipped+0) — parallel lang=es file=monsters.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+6, skipped+0) — lang=pl file=monsters.json strict_skipped_done=666
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **19,158** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 87 |
| ❌ Błędów | 202 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (3,736), **IT** (3,151), **RU** (2,826), **RO** (2,657), **SV** (2,294) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **99,064** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-16 23:44:18  
