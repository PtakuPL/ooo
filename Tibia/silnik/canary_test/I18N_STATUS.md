...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **11.13%**. Tempo: **684.1 kluczy/h**. Tłumaczeń netto: **81,017**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-15 14:20:44

> **Aktualizacja:** 2026-02-15 14:20:44 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #8,997 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: es | Plik: - | Heartbeat: 2026-02-15T14:18:56Z  
> **Okno godzinowe:** okno=1.0h | cykli=315 | pominięte=0.0% | odrzucone=46.5% | przepustowość=684.1/h  
> **Tłumaczeń netto:** 81,017

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-15 14:20:44 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-02-15T14:18:56Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 4min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-15 14:20:44 |
| TRANSLATION | 🟢 AKTYWNY | 6min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-15T14:14:31.123069Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-15T14:18:01.951448Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-15 14:20:44 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-15T14:18:56Z
...
| ❤️ **Heartbeat** | 2026-02-15T14:18:56Z |
...
| Metryka | Wartość |
|---------|---------|
| 🎛️ Dominujący tryb (1h) | **PRE_MIGRATION** (164 cykli) |
| 🧭 Bieżąca faza (LIVE) | **AUTO_TRANSLATE** / es / - |
| 🌍 Statystyka bieżącej fazy | TRANSLATION: 821 przetłumaczonych, 715 odrzuconych (GF=46.5%) |
| 📊 Przetłumaczono | **821** kluczy |
| ❌ Odrzucone (guard) | 715 |
| 🔁 Cykli | 315 |
| 🌍 Języków | 6 |
| 🏆 Najaktywniejszy | ES (530 kluczy) |
...
> Świeżość: 4min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-15 14:20:44
...
| otclient_modules | **6,588** | 168 | 294 | 🔍 6588 do migracji |
...
| world | **0** | 0 | 0 | ✅ Czysta |
| **SUMA** | **112,435** | **5,423** | **18,063** | 🔍 Wymaga pracy |
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 6min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-15T14:14:31.123069Z
...
- Raporty strażnika jakości: **2766**  
- Raporty blokad: **0**  
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-15T13:20:47.197249Z → 2026-02-15T14:20:47.197249Z) |
| Cykle | **315** (TŁUMACZENIE=151, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **46.5%** |
| Cykle bez postępu % | **12.8%** |
| Przepustowość (kluczy/h) | **684.1 kluczy/h** |
...
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-15T14:18:01.951448Z

- **Ostatni audyt:** SLOW_MODE | 34 issue(s) / 100 entries | 2026-02-15T14:18:01.951448Z
- **Top 5 typów problemów:** suspicious_rejected_critical=200, suspicious_log_high=142, suspicious_log_low=58, identical_to_en_exempt=34, identical_to_en=19
- **Języki o najsłabszej jakości:** es(60.1, issues=239785), pl(60.1, issues=163887), tl(64.2, issues=466), zh_TW(64.8, issues=337), fr(66.5, issues=2470)
...
⚠️ **PL**: jakość 60%, 163887 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 239785 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 66%, 2470 problemów
⚠️ **IT**: jakość 94%, 2772 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #8,997 |
| Heartbeat | 112s temu | 2026-02-15T14:18:56Z |
...
- **Ostatnia aktualizacja:** 2026-02-15T14:14:39.522911Z
...
- 2026-02-15 14:16:11 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-15 14:14:39 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-15 14:14:31 | AUTO_TRANSLATE:auto_done | es | ok | talkactions.json
- 2026-02-15 14:14:00 | AUTO_TRANSLATE:heartbeat_tick | es | ok | talkactions.json
- 2026-02-15 14:14:00 | AUTO_TRANSLATE:auto_start | es | ok | talkactions.json
- 2026-02-15 14:11:30 | AUTO_TRANSLATE:auto_done | es | ok | modules.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.4% | 0 | 2,332 | 3,638 | 3051 (45.6%) | 85 |
| 🟡 ES | 84.1% | 0 | 2,623 | 3,588 | 6040 (62.7%) | 95 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **81,017** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=54.9%, reason=decrease_high_fail_rate=54.9% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 7,226 kluczy / 180 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-15 14:20:44
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **6,688** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 57 |
| ❌ Błędów | 232 |
| 🌍 Aktywnych języków | 6 |
| 🏆 TOP 5 | **ES** (3,285), **PL** (3,230), **EL** (68), **IT** (45), **CS** (32) |
| 📊 Porównanie | ↓ 87.7% vs wczoraj (54,494) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **108,604** kluczy
...
| 🔄 Cykli wykonanych | **#8,997** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-15 14:20:44  
