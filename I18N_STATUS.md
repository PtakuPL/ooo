...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-29 10:00:19

> **Aktualizacja:** 2026-03-29 10:00:19 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #11,770 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: pt | Plik: monsters.json | Heartbeat: 2026-03-29T09:59:01Z  
> **Okno godzinowe:** okno=1.0h | cykli=96 | pominięte=0.0% | odrzucone=25.6% | przepustowość=2589.0/h  
> **Tłumaczeń netto:** 80,834

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-29 10:00:19 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-03-29T09:59:01Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 46s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-29 10:00:19 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-29T09:58:03.261547Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-29T09:58:24.869691Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-29 10:00:19 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-29T09:59:01Z
...
| ❤️ **Heartbeat** | 2026-03-29T09:59:01Z |
...
> **ETA globalne:** ~49 dni (3,023,974 kluczy do celu 95%)
...
> Świeżość: 46s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-29 10:00:19
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-29T09:58:03.261547Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 279 | 1 | 21,114 | - | 2026-03-29T09:59:00.429223Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **16.98%** (658,094/3,875,872)
- **Pokrycie globalne (real):** **9.11%** (353,055/3,875,872)
- **Kopie EN (łącznie):** **462,624**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-29T09:00:19.727422Z → 2026-03-29T10:00:19.727422Z) |
...
|--------|-----------|--------|----------------|
| `gt_rejected_critical` | 90 | 57.7% | ro/npc.json (37) |
| `gt_validate_fail_placeholder` | 44 | 28.2% | cs/npc.json (12) |
| `gt_validate_fail_word_salad` | 13 | 8.3% | ro/items.json (4) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-29T09:58:24.869691Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-03-29T09:58:24.869691Z
- **Top 5 typów problemów:** suspicious_log_high=191, suspicious_rejected_critical=166, suspicious_rejected_high=34, suspicious_log_critical=9
- **Języki o najsłabszej jakości:** ro(60.1, issues=353163), pl(60.1, issues=339776), cs(60.1, issues=26910), it(62.4, issues=122284), nl(62.6, issues=19204)
...
⚠️ **ES**: jakość 96%, 656619 problemów
⚠️ **PT**: jakość 63%, 26386 problemów
⚠️ **FR**: jakość 65%, 28378 problemów
⚠️ **IT**: jakość 62%, 122284 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #11,770 |
| Heartbeat | 80s temu | 2026-03-29T09:59:01Z |
...
- **TOP 5 języków:** DE (22,458), NL (21,390), CS (20,856), PT (19,939), FR (16,655)
- **Aktualnie naprawia:** ES / -
- **Ostatnia aktualizacja:** 2026-03-29T09:58:17.075889Z
...
- 2026-03-29 09:59:00 | AUTO_TRANSLATE:auto_start | pt | ok | monsters.json
- 2026-03-29 09:58:46 | TRANSLATION_SYNC:sync_done | de | ok | arena.json
- 2026-03-29 09:58:45 | TRANSLATION_SYNC:sync_start | de | ok | arena.json
- 2026-03-29 09:58:17 | AUTO_TRANSLATE:heartbeat_tick | es | ok | otclient_modules.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **80,834** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=22.25%, reason=decrease_high_fail_rate=22.3%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-29 10:00:19
...
| 🔄 Cykli wykonanych | **#11,770** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #11,770 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-29 10:00:19  
