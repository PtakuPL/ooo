...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.97% / real 10.89%**. Tempo: **843.0 kluczy/h**. Tłumaczeń netto: **142,458**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 05:20:07

> **Aktualizacja:** 2026-04-29 05:20:07 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,788 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ru | Plik: items.json | Heartbeat: 2026-04-29T05:19:38Z
> **Okno godzinowe:** okno=1.0h | cykli=92 | pominięte=0.0% | odrzucone=4.3% | przepustowość=843.0/h  
> **Tłumaczeń netto:** 142,458

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 05:20:07 |
| LIVE | 🟢 AKTYWNY | 36s temu | - | `activity.json / worker_state.json` | 2026-04-29T05:19:38Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 33s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 05:20:07 |
| TRANSLATION | 🟢 AKTYWNY | 37s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T05:19:36.476325Z |
| QUALITY | 🔒 NIEAKTYWNY | 36s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T05:19:37.421185Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 05:20:07 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T05:20:14.384750Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 36s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T05:19:38Z
...
| 🔄 **Ostatni cykl** | 30 kluczy, 0 odrzuconych, 40.0s, tryb: AUTO_TRANSLATE, cel: tr/items.json |
| ❤️ **Heartbeat** | 2026-04-29T05:19:38Z |
...
| ⏳ Oldest pending (visible tail) | 18181 s |
| 🌍 Top języki | RU(400) |
...
| 🌍 Recent provider mix | TM/simple(366), Free Google Translate(110), canonical_name_semantic_autofix(15), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=494, fallbacks=14) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=683/683 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 18181}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 33s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 05:20:07
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 37s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T05:19:36.476325Z
...
- dark sand → karanlık kum (item.12219.name)
- mill board → değirmen tahtası (item.1222.name)
- dark sand → karanlık kum (item.12220.name)
- dark sand → karanlık kum (item.12221.name)
- dark sand → karanlık kum (item.12222.name)
- dark sand → karanlık kum (item.12223.name)
- dark sand → karanlık kum (item.12224.name)
- dark sand → karanlık kum (item.12225.name)
- mill board → değirmen tahtası (item.1223.name)
- energy shrine → enerji tapınağı (item.12238.name)
- energy shrine → enerji tapınağı (item.12239.name)
- mill board → değirmen tahtası (item.1224.name)
- energy shrine → enerji tapınağı (item.12240.name)
- energy shrine → enerji tapınağı (item.12241.name)
- earth shrine → Dünya tapınağı (item.12242.name)
- earth shrine → Dünya tapınağı (item.12243.name)
- earth shrine → Dünya tapınağı (item.12244.name)
- earth shrine → Dünya tapınağı (item.12245.name)
- stone → taş (item.12247.name)
- stone → taş (item.12248.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4794**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4647**
...
- **Pokrycie globalne (nominal):** **17.97%** (696,354/3,875,872)
- **Pokrycie globalne (real):** **10.89%** (421,924/3,875,872)
- **Kopie EN (łącznie):** **410,517**
- **Placeholdery [EN]/puste (łącznie):** **2,189,309**
...
| 🕒 Evidence window | 24h (span=34.46h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=34.46h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T04:20:07.953404Z → 2026-04-29T05:20:07.953404Z) |
...
> Świeżość: 36s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T05:19:37.421185Z
...
| Heartbeat | 36s temu | 2026-04-29T05:19:38Z |
...
- 2026-04-29 05:18:56 | AUTO_TRANSLATE:auto_start | tr | ok | items.json
- 2026-04-29 05:18:21 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 05:20:07
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **4,610** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 105 |
| ❌ Błędów | 190 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (934), **RU** (791), **IT** (718), **DE** (630), **TR** (555) |
| 📊 Porównanie | ↓ 44.0% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **23,590** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 05:20:07  
