...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "mission") then
		if player:getStorageValue(Storage.Quest.U8_4.TheHiddenCityOfBeregar.JusticeForAll) < 1 then
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nokmir.say_1")
		...
		elseif player:getStorageValue(Storage.Quest.U8_4.TheHiddenCityOfBeregar.JusticeForAll) == 5 then
			...
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nokmir.say_2")
		end
	...
	elseif MsgContains(message, "grombur") then
		if npcHandler:getTopic(playerId) == 2 then
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nokmir.say_3")
			npcHandler:setTopic(playerId, 3)
		end
	elseif MsgContains(message, "rerun") then
		if npcHandler:getTopic(playerId) == 3 then
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nokmir.say_4")
	...
	elseif MsgContains(message, "rehal") then
		if npcHandler:getTopic(playerId) == 4 then
			...
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.nokmir.say_5")
...
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_WALKAWAY, "npc.nokmir.walkaway_msg_1")
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_FAREWELL, "npc.nokmir.farewell_msg_1")
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_GREET, "npc.nokmir.greet_msg_1")
