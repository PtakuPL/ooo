...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.85%**. Tempo: **1402.5 kluczy/h**. Tłumaczeń netto: **116,640**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 18:11:54

> **Aktualizacja:** 2026-02-20 18:11:54 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #40 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: pl | Plik: - | Heartbeat: 2026-02-20T18:11:51Z  
> **Okno godzinowe:** okno=1.0h | cykli=179 | pominięte=0.0% | odrzucone=67.9% | przepustowość=1402.5/h  
> **Tłumaczeń netto:** 116,640

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 18:11:54 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T18:11:51Z |
| MIGRATION | 🔒 NIEAKTYWNY | 47s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 18:11:54 |
| TRANSLATION | 🟢 AKTYWNY | 38s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T18:11:17.375246Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T18:11:55.911484Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 18:11:54 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T18:11:51Z
...
| ❤️ **Heartbeat** | 2026-02-20T18:11:51Z |
...
> **ETA globalne:** ~67 dni (2,261,187 kluczy do celu 95%)
...
> Świeżość: 47s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 18:11:54
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 38s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T18:11:17.375246Z
...
- Raporty strażnika jakości: **6731**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3839**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T17:11:55.069580Z → 2026-02-20T18:11:55.069580Z) |
| Cykle | **179** (TŁUMACZENIE=179, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **67.9%** |
| Cykle bez postępu % | **9.5%** |
| Przepustowość (kluczy/h) | **1402.5 kluczy/h** |
| Podejrzane tłumaczenia | **4087** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T18:11:55.911484Z
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #40 |
| Heartbeat | 5s temu | 2026-02-20T18:11:51Z |
...
- 2026-02-20 18:10:56 | AUTO_TRANSLATE:heartbeat_tick | it | ok | npc.json
- 2026-02-20 18:10:55 | AUTO_TRANSLATE:parallel_start | it | ok | npc.json
- 2026-02-20 18:10:49 | AUTO_TRANSLATE:heartbeat_tick | es | ok | monsters.json
- 2026-02-20 18:10:49 | AUTO_TRANSLATE:parallel_start | es | ok | monsters.json
- 2026-02-20 18:10:48 | AUTO_TRANSLATE:auto_done | pl | ok | monsters.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **116,640** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=85.54%, reason=decrease_high_fail_rate=85.5% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 18:11:54
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+0, skipped+0) — parallel lang=es file=chatchannels.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+1, skipped+0) — lang=pl file=example_merchant.json strict_skipped_done=1
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **5,986** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 40 |
| ❌ Błędów | 141 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (1,695), **RU** (1,097), **IT** (993), **PL** (693), **RO** (681) |
| 📊 Porównanie | ↑ 64.4% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **103,571** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 18:11:54  
