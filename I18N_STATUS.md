...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **9.89%**. Tempo: **1479.7 kluczy/h**. Tłumaczeń netto: **70,188**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-14 16:24:43

> **Aktualizacja:** 2026-02-14 16:24:43 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #3 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-02-14T16:24:34Z  
> **Okno godzinowe:** okno=1.0h | cykli=111 | pominięte=0.0% | odrzucone=51.4% | przepustowość=1479.7/h  
> **Tłumaczeń netto:** 70,188

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-14 16:24:43 |
| LIVE | 🟢 AKTYWNY | 9s temu | - | `activity.json / worker_state.json` | 2026-02-14T16:24:34Z |
| MIGRATION | 🔒 NIEAKTYWNY | 41s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-14 16:24:43 |
| TRANSLATION | 🟢 AKTYWNY | 18s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-14T16:24:25.770654Z |
| QUALITY | 🔒 NIEAKTYWNY | 0s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-14T16:24:43.453308Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-14 16:24:43 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 9s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-14T16:24:34Z
...
| ❤️ **Heartbeat** | 2026-02-14T16:24:34Z |
...
|-------|---------------|-----------|----------|----------|
| ES | 39,880 | 53,586 | 74.42% | 2,595 |
| PL | 24,036 | 53,586 | 44.85% | 1,912 |
...
> **ETA globalne:** ~67 dni (2,371,512 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ██████████████░░░░░░ | 74.4% | 39,880/53,586 | ~7h |
| PL | ████████░░░░░░░░░░░░ | 44.9% | 24,036/53,586 | ~18h |
...
> Świeżość: 41s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-14 16:24:43

### 📁 Pliki Projektu (pełny skan)
| Metryka | Wartość | Procent | Info |
|---------|---------|---------|------|
| 📂 **Wszystkie pliki** | **20,313** | 100% | cały projekt |
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 18s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-14T16:24:25.770654Z
...
|-------|----------------|-------------------------------|---------|--------------|
| ES (Hiszpański) | 39,880/53,586 | 74.42% | 2,595 | 0 |
| PL (Polski) | 24,036/53,586 | 44.85% | 1,912 | 0 |
...
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2114**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **9.89%** (275,600/2,786,472)
- **Kopie EN (łącznie):** **167,638**
...
|-------|--------|----------|----------|------------|
| ES | 37,296/49,731 | 75.0% | 2,584/3,855 | 67.0% |
| PL | 21,351/49,731 | 42.9% | 2,685/3,855 | 69.7% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-14T15:24:43.486515Z → 2026-02-14T16:24:43.486515Z) |
...
| Przepustowość (kluczy/h) | **1479.7 kluczy/h** |
| Podejrzane tłumaczenia | **5636** |
| Najgorsze cele (strażnik) | pl/items.json (gf=1344), pl/server.json (gf=211), es/scripts.json (gf=150), pl/scripts.json (gf=125), pl/quests.json (gf=123) |
...
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-14T16:24:43.453308Z

- **Ostatni audyt:** SLOW_MODE | 17 issue(s) / 100 entries | 2026-02-14T16:24:43.453308Z
- **Top 5 typów problemów:** suspicious_rejected_critical=200, suspicious_log_high=141, suspicious_log_critical=49, identical_to_en_exempt=33, artifact_token=17
- **Języki o najsłabszej jakości:** es(60.1, issues=156185), pl(60.1, issues=116426), tl(64.2, issues=466), zh_TW(64.8, issues=337), fr(66.5, issues=2470)
...
⚠️ **PL**: jakość 60%, 116426 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 156185 problemów
...
| Heartbeat | 9s temu | 2026-02-14T16:24:34Z |
...
- 2026-02-14 16:24:34 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-14 16:24:26 | AUTO_TRANSLATE:auto_done | pl | ok | items.json
- 2026-02-14 16:24:18 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | items.json
- 2026-02-14 16:22:47 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | items.json
- 2026-02-14 16:22:47 | AUTO_TRANSLATE:auto_start | pl | ok | items.json
- 2026-02-14 16:22:29 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 44.9% | 0 | 1,912 | 3,252 | 3010 (48.1%) | 81 |
| 🟡 ES | 74.4% | 0 | 2,595 | 2,336 | 940 (28.7%) | 67 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **70,188** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=25.85%, reason=decrease_high_fail_rate=25.9% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 5,588 kluczy / 148 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-14 16:24:43
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+24) — repair_identical lang=es file=npc.json target_identical=24 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=245.55
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **37,158** kluczy |
| ⏭️ Pominięte | 1 |
| 🔁 Cykli | 49 |
| ❌ Błędów | 451 |
| 🌍 Aktywnych języków | 52 |
| 🏆 TOP 5 | **ES** (9,949), **PL** (4,046), **IT** (971), **PT** (960), **DE** (890) |
| 📊 Porównanie | ↓ 19.3% vs wczoraj (46,073) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **84,580** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-14 16:24:43  
