...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.01% / real 9.84%**. Tempo: **2663.0 kluczy/h**. Tłumaczeń netto: **107,350**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-02 22:08:29

> **Aktualizacja:** 2026-04-02 22:08:29 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #13,312 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: it | Plik: items.json | Heartbeat: 2026-04-02T22:07:46Z  
> **Okno godzinowe:** okno=1.0h | cykli=44 | pominięte=0.0% | odrzucone=31.2% | przepustowość=2663.0/h  
> **Tłumaczeń netto:** 107,350

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-02 22:08:29 |
| LIVE | 🟢 AKTYWNY | 44s temu | - | `activity.json / worker_state.json` | 2026-04-02T22:07:46Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 40s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-02 22:08:29 |
| TRANSLATION | 🟢 AKTYWNY | 4min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-02T22:04:07.113109Z |
| QUALITY | 🔒 NIEAKTYWNY | 4min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-02T22:04:27.596331Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-02 22:08:29 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 44s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-02T22:07:46Z
...
| ❤️ **Heartbeat** | 2026-04-02T22:07:46Z |
...
| ❌ Odrzucone (guard) | 1206 |
| 🔁 Cykli | 44 |
| 🌍 Języków | 9 |
| 🏆 Najaktywniejszy | RO (1,878 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~2663 kluczy/h |
| 🛡️ Odrzucone (strażnik) | 31.2% |
| ⚠️ Podejrzane | 1327 |
...
> **ETA globalne:** ~47 dni (3,022,803 kluczy do celu 95%)
...
> Tempo obliczone na bazie ostatniej godziny: ~2663 kluczy/h.
...
> Świeżość: 40s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-02 22:08:29
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 4min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-02T22:04:07.113109Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 280 | 0 | 0 | - | 2026-04-02T22:04:48.067989Z |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-02T21:08:29.294366Z → 2026-04-02T22:08:29.294366Z) |
| Cykle | **44** (TŁUMACZENIE=44, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **31.2%** |
| Cykle bez postępu % | **0.0%** |
| Przepustowość (kluczy/h) | **2663.0 kluczy/h** |
...
|--------|-----------|--------|----------------|
| `gt_validate_fail_placeholder` | 529 | 94.8% | it/npc.json (141) |
| `gt_rejected_critical` | 22 | 3.9% | ro/items.json (21) |
...
> Świeżość: 4min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-02T22:04:27.596331Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-02T22:04:27.596331Z
- **Top 5 typów problemów:** suspicious_rejected_critical=198, suspicious_log_high=191, suspicious_log_low=9, suspicious_rejected_high=2
- **Języki o najsłabszej jakości:** ro(60.1, issues=380923), pl(60.1, issues=365800), pt(60.1, issues=30845), fr(60.8, issues=43054), de(61.3, issues=80796)
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #13,312 |
| Heartbeat | 44s temu | 2026-04-02T22:07:46Z |
...
- 2026-04-02 22:04:48 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-04-02 22:04:48 | AUTO_TRANSLATE:auto_start | it | ok | items.json
- 2026-04-02 22:04:19 | AUTO_TRANSLATE:heartbeat_tick | es | ok | quests.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-02 22:08:29
...
| 🔄 Cykli wykonanych | **#13,312** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #13,312 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-02 22:08:29  
