...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.01% / real 10.93%**. Tempo: **882.0 kluczy/h**. Tłumaczeń netto: **145,255**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 08:53:27

> **Aktualizacja:** 2026-04-29 08:53:27 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,085 | Status: ✅ BEZCZYNNY | Faza: IDLE | Etap: cycle_start | Kategoria: it | Plik: items.json | Heartbeat: 2026-04-29T08:49:46Z
> **Okno godzinowe:** okno=1.0h | cykli=83 | pominięte=0.0% | odrzucone=5.0% | przepustowość=882.0/h  
> **Tłumaczeń netto:** 145,255

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 08:53:27 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-04-29T08:49:46Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie IDLE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 08:53:27 |
| TRANSLATION | 🔒 NIEAKTYWNY | 2min temu | worker w trybie IDLE | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T08:51:17.718608Z |
| QUALITY | 🔒 NIEAKTYWNY | 21s temu | worker w trybie IDLE | `quality_audit_latest.json` | 2026-04-29T08:53:12.575073Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 08:53:27 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T08:53:33.678060Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T08:49:46Z
...
| 🔄 **Ostatni cykl** | 30 kluczy, 1 odrzuconych, 220.3s, tryb: AUTO_TRANSLATE, cel: it/items.json |
| ❤️ **Heartbeat** | 2026-04-29T08:49:46Z |
...
| ⏳ Oldest pending (visible tail) | 15345 s |
...
| 🌍 Recent provider mix | TM/simple(285), Free Google Translate(177), canonical_name_semantic_autofix(18), term_consistency_autofix(3) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=848/848 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 386, 'oldest_s': 15345}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~141 dni (2,984,121 kluczy do celu 95%)
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 08:53:27
...
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T08:51:17.718608Z
...
- Raporty strażnika jakości: **4869**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4722**
...
- **Pokrycie globalne (nominal):** **18.01%** (697,947/3,875,872)
- **Pokrycie globalne (real):** **10.93%** (423,561/3,875,872)
- **Kopie EN (łącznie):** **410,473**
- **Placeholdery [EN]/puste (łącznie):** **2,187,716**
...
- **Profiler cyklu (ostatni):** cykl #123 (AUTO_TRANSLATE): dispatch 1749ms, mode 206289ms, status 10520ms, total 220267ms
...
| 🕒 Evidence window | 24h (span=38.02h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=38.02h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T07:53:27.875515Z → 2026-04-29T08:53:27.875515Z) |
...
> Świeżość: 21s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T08:53:12.575073Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T08:53:12.575073Z
- **Top 5 typów problemów:** suspicious_rejected_critical=189, suspicious_log_high=108, suspicious_log_low=91, suspicious_rejected_high=11, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=741360), ro(60.1, issues=437940), de(60.1, issues=120639), cs(60.1, issues=104259), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 741360 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 70%, 175719 problemów
⚠️ **RU**: jakość 62%, 368176 problemów
...
|-----------|--------|-----------|
| Worker | ✅ BEZCZYNNY | Cykl #18,085 |
| Heartbeat | 227s temu | 2026-04-29T08:49:46Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T08:51:33.438617Z
...
- 2026-04-29 08:53:04 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-29 08:51:34 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-29 08:51:18 | AUTO_TRANSLATE:auto_done | it | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 08:53:27
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **7,668** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 180 |
| ❌ Błędów | 322 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,421), **RU** (1,321), **IT** (1,182), **TR** (1,071), **DE** (1,035) |
| 📊 Porównanie | ↓ 6.8% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **26,648** kluczy
...
| 🔄 Cykli wykonanych | **#18,085** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,085 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 08:53:27  
