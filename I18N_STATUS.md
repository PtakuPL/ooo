...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 16.58% / real 9.35%**. Tempo: **2504.0 kluczy/h**. Tłumaczeń netto: **90,012**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-29 15:42:26

> **Aktualizacja:** 2026-03-29 15:42:26 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #12,406 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: monsters.json | Heartbeat: 2026-03-29T15:42:15Z  
> **Okno godzinowe:** okno=1.0h | cykli=85 | pominięte=0.0% | odrzucone=28.9% | przepustowość=2504.0/h  
> **Tłumaczeń netto:** 90,012

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-29 15:42:26 |
| LIVE | 🟢 AKTYWNY | 13s temu | - | `activity.json / worker_state.json` | 2026-03-29T15:42:15Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 30s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-29 15:42:26 |
| TRANSLATION | 🟢 AKTYWNY | 54s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-29T15:41:34.152398Z |
| QUALITY | 🔒 NIEAKTYWNY | 30s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-29T15:41:57.799380Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-29 15:42:26 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 13s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-29T15:42:15Z
...
| ❤️ **Heartbeat** | 2026-03-29T15:42:15Z |
...
|-------|---------------|-----------|----------|----------|
| ES | 56,909 | 74,536 | 76.35% ↑+0.13% | 9,706 |
...
> **ETA globalne:** ~51 dni (3,039,281 kluczy do celu 95%)
...
> Świeżość: 30s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-29 15:42:26
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 54s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-29T15:41:34.152398Z
...
|-------|-----------|--------|----------|--------------|--------------|
| ES (Hiszpański) | 76.35% (56,909/74,536) | 65.21% (48,605/74,536) | 9,706 | 16,244 | 0 |
...
- Raporty strażnika jakości: **3445**  
- Raporty blokad: **0**  
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 280 | 0 | 0 | - | 2026-03-29T15:42:13.780998Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **16.58%** (642,787/3,875,872)
- **Pokrycie globalne (real):** **9.35%** (362,526/3,875,872)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-29T14:42:26.477115Z → 2026-03-29T15:42:26.477115Z) |
...
| Podejrzane tłumaczenia | **2436** |
| Najgorsze cele (strażnik) | pl/npc.json (gf=456), it/monsters.json (gf=114), pl/monsters.json (gf=113), ro/items.json (gf=97), cs/items.json (gf=47) |
...
|--------|-----------|--------|----------------|
| `gt_validate_fail_placeholder` | 85 | 45.9% | pl/npc.json (75) |
| `gt_rejected_critical` | 66 | 35.7% | cs/items.json (29) |
| `gt_validate_fail_word_salad` | 18 | 9.7% | es/server.json (16) |
| `gt_validate_fail_quality` | 16 | 8.6% | es/items.json (6) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 30s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-29T15:41:57.799380Z

- **Ostatni audyt:** OK | 5 issue(s) / 100 entries | 2026-03-29T15:41:57.799380Z
- **Top 5 typów problemów:** suspicious_rejected_critical=180, suspicious_log_high=157, suspicious_log_medium=28, suspicious_rejected_high=20, suspicious_log_low=10
- **Języki o najsłabszej jakości:** cs(60.0, issues=34460), es(60.1, issues=666098), pl(60.1, issues=350388), pt(62.2, issues=28493), ru(68.5, issues=306542)
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #12,406 |
| Heartbeat | 13s temu | 2026-03-29T15:42:15Z |
...
- 2026-03-29 15:41:49 | AUTO_TRANSLATE:heartbeat_tick | es | ok | otclient_modules.json
- 2026-03-29 15:41:34 | AUTO_TRANSLATE:auto_done | ru | ok | npc.json
- 2026-03-29 15:41:23 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | npc.json
- 2026-03-29 15:41:23 | AUTO_TRANSLATE:auto_start | ru | ok | npc.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 70.5% | 0 | 5,887 | 824 | 2398 (74.4%) | 28 |
| 🟡 ES | 76.3% | 0 | 9,706 | 2,012 | 516 (20.4%) | 30 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **90,012** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=37.66%, reason=decrease_high_fail_rate=37.7%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 2,836 kluczy / 58 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-29 15:42:26
...
| 🔄 Cykli wykonanych | **#12,406** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #12,406 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-29 15:42:26  
