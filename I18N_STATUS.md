...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.85%**. Tempo: **1469.0 kluczy/h**. Tłumaczeń netto: **117,806**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 18:40:09

> **Aktualizacja:** 2026-02-20 18:40:09 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #63 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: pl | Plik: - | Heartbeat: 2026-02-20T18:39:59Z  
> **Okno godzinowe:** okno=1.0h | cykli=194 | pominięte=0.0% | odrzucone=74.2% | przepustowość=1469.0/h  
> **Tłumaczeń netto:** 117,806

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 18:40:09 |
| LIVE | 🟢 AKTYWNY | 11s temu | - | `activity.json / worker_state.json` | 2026-02-20T18:39:59Z |
| MIGRATION | 🔒 NIEAKTYWNY | 6s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 18:40:09 |
| TRANSLATION | 🟢 AKTYWNY | 13s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T18:39:57.587729Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T18:40:10.525454Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 18:40:09 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 11s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T18:39:59Z
...
| ❤️ **Heartbeat** | 2026-02-20T18:39:59Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **2,627** kluczy |
| ❌ Odrzucone (guard) | 7541 |
| 🔁 Cykli | 194 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (642 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~1469 kluczy/h |
| 🛡️ Guard fail rate | 74.2% |
| ⚠️ Podejrzane | 25000 |
| 🌐 GT aktywny (1h) | ✅ TAK |
| 🔤 GT tłumaczeń (1h) | 37 |
...
| IT | 27,847 | 53,586 | 51.97% | 2,142 |
| RU | 26,980 | 53,586 | 50.35% | 1,457 |
| SR | 24,350 | 53,586 | 45.44% | 1,070 |
| RO | 22,892 | 53,586 | 42.72% | 2,347 |
| FR | 17,731 | 53,586 | 33.09% | 3,788 |
| SV | 15,284 | 53,586 | 28.52% | 2,294 |
...
> Tempo obliczone na bazie ostatniej godziny: ~1469 kluczy/h.
...
> Świeżość: 6s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 18:40:09
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 13s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T18:39:57.587729Z
...
| IT (Włoski) | 27,847/53,586 | 51.97% | 2,142 | 0 |
| RU (Rosyjski) | 26,980/53,586 | 50.35% | 1,457 | 0 |
| SR (SR) | 24,350/53,586 | 45.44% | 1,070 | 0 |
| RO (Rumuński) | 22,892/53,586 | 42.72% | 2,347 | 0 |
| FR (Francuski) | 17,731/53,586 | 33.09% | 3,788 | 0 |
| SV (Szwedzki) | 15,284/53,586 | 28.52% | 2,294 | 0 |
...
- Raporty strażnika jakości: **6788**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3896**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **13.85%** (386,060/2,786,472)
- **Kopie EN (łącznie):** **162,339**
...
| IT | 26,488/49,731 | 53.3% | 1,359/3,855 | 35.2% |
| RU | 24,184/49,731 | 48.6% | 2,796/3,855 | 72.5% |
| SR | 24,249/49,731 | 48.8% | 101/3,855 | 2.6% |
| RO | 21,626/49,731 | 43.5% | 1,266/3,855 | 32.8% |
| FR | 15,184/49,731 | 30.5% | 2,547/3,855 | 66.1% |
| SV | 15,142/49,731 | 30.4% | 142/3,855 | 3.7% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T17:40:09.665022Z → 2026-02-20T18:40:09.665022Z) |
| Cykle | **194** (TŁUMACZENIE=194, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **74.2%** |
| Cykle bez postępu % | **4.2%** |
| Przepustowość (kluczy/h) | **1469.0 kluczy/h** |
| Podejrzane tłumaczenia | **3107** |
| Najgorsze cele (strażnik) | pl/items.json (gf=3264), pl/npc.json (gf=1936), es/items.json (gf=1551), es/server.json (gf=123), it/npc.json (gf=105) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T18:40:10.525454Z

- **Ostatni audyt:** SLOW_MODE | 32 issue(s) / 100 entries | 2026-02-20T18:39:59.600465Z | recent_hidden=0
- **Alarm recent hidden HIGH/CRITICAL:** ✅ OK | hidden=0, threshold=5, trend=→ last10=0.00, prev10=0.00, latest=0
- **Regresja critical bad keys pack:** 🚨 FAIL: pl(critical=30, pack=0), es(critical=22, pack=0)
- **Top 5 typów problemów:** suspicious_rejected_critical=62, suspicious_log_critical=43, artifact_token=32, suspicious_log_high=31, identical_to_en_exempt=5
- **Języki o najsłabszej jakości:** es(60.1, issues=328058), pl(60.1, issues=183798), ro(60.1, issues=179395), sr(61.0, issues=86259), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 60%, 183798 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 328058 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 78%, 73150 problemów
⚠️ **RU**: jakość 66%, 211195 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 78%, 30132 problemów
...
| Heartbeat | 11s temu | 2026-02-20T18:39:59Z |
...
- 2026-02-20 18:39:43 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 18:39:43 | AUTO_TRANSLATE:parallel_start | es | ok | npc.json
- 2026-02-20 18:39:41 | AUTO_TRANSLATE:auto_done | pl | ok | spells.json
- 2026-02-20 18:39:21 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | spells.json
- 2026-02-20 18:39:21 | AUTO_TRANSLATE:auto_start | pl | ok | spells.json
- 2026-02-20 18:38:34 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,829 | 631 | 7011 (91.7%) | 37 |
| 🟡 ES | 84.7% | 0 | 2,160 | 683 | 2576 (79.0%) | 37 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **117,806** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=8.33%, reason=stable_fail_rate=8.3% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,314 kluczy / 74 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 18:40:09
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [sv] → warn (files+1, translated+49, skipped+0) — lang=sv file=items.json strict_skipped_done=494 guard_fail=1 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+16) — repair_identical lang=es file=npc.json target_identical=16 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=290.52
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ro] → ok (translated+36, skipped+0) — parallel lang=ro file=items.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ru] → ok (translated+50, skipped+0) — parallel lang=ru file=items.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+50, skipped+0) — lang=es file=server.json strict_skipped_done=690 guard_fail=9 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **7,660** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 63 |
| ❌ Błędów | 175 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (2,205), **RU** (1,457), **IT** (1,266), **RO** (906), **PL** (879) |
| 📊 Porównanie | ↑ 110.4% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **105,245** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 18:40:09  
