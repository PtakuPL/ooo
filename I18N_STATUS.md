...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 16.82% / real 9.63%**. Tempo: **2104.0 kluczy/h**. Tłumaczeń netto: **100,521**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-02 16:58:05

> **Aktualizacja:** 2026-04-02 16:58:05 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #12,944 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: pl | Plik: monsters.json | Heartbeat: 2026-04-02T16:56:50Z  
> **Okno godzinowe:** okno=1.0h | cykli=80 | pominięte=0.0% | odrzucone=41.1% | przepustowość=2104.0/h  
> **Tłumaczeń netto:** 100,521

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-02 16:58:05 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-02T16:56:50Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 58s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-02 16:58:05 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-02T16:56:14.865546Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-02T16:56:34.741745Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-02 16:58:05 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-02T16:56:50Z
...
| ❤️ **Heartbeat** | 2026-04-02T16:56:50Z |
...
| �📊 Przetłumaczono | **2,104** kluczy |
| ❌ Odrzucone (guard) | 1468 |
| 🔁 Cykli | 80 |
| 🌍 Języków | 11 |
| 🏆 Najaktywniejszy | RO (574 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~2104 kluczy/h |
| 🛡️ Odrzucone (strażnik) | 41.1% |
| ⚠️ Podejrzane | 2289 |
...
> Tempo obliczone na bazie ostatniej godziny: ~2104 kluczy/h.
...
> Świeżość: 58s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-02 16:58:05
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-02T16:56:14.865546Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 280 | 0 | 0 | - | 2026-04-02T16:56:49.880385Z |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-02T15:58:05.877248Z → 2026-04-02T16:58:05.877248Z) |
| Cykle | **80** (TŁUMACZENIE=80, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **41.1%** |
| Cykle bez postępu % | **0.0%** |
| Przepustowość (kluczy/h) | **2104.0 kluczy/h** |
| Podejrzane tłumaczenia | **2289** |
...
|--------|-----------|--------|----------------|
| `gt_validate_fail_placeholder` | 410 | 50.4% | it/npc.json (126) |
| `gt_rejected_critical` | 293 | 36.0% | fr/npc.json (51) |
| `gt_validate_fail_word_salad` | 52 | 6.4% | pl/monsters.json (16) |
| `gt_validate_fail_quality` | 40 | 4.9% | tr/npc.json (25) |
| `gt_rejected_high_partial_translation_mix` | 9 | 1.1% | pl/monsters.json (7) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-02T16:56:34.741745Z

- **Ostatni audyt:** OK | 8 issue(s) / 100 entries | 2026-04-02T16:56:34.741745Z
- **Top 5 typów problemów:** suspicious_rejected_critical=182, suspicious_log_high=157, suspicious_log_medium=36, suspicious_rejected_high=18, artifact_token=8
- **Języki o najsłabszej jakości:** ro(60.1, issues=375847), pt(60.1, issues=29618), es(60.8, issues=673418), pl(62.9, issues=358519), nl(63.5, issues=27519)
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #12,944 |
| Heartbeat | 77s temu | 2026-04-02T16:56:50Z |
...
- 2026-04-02 16:56:27 | AUTO_TRANSLATE:heartbeat_tick | es | ok | quests.json
- 2026-04-02 16:56:15 | AUTO_TRANSLATE:auto_done | ru | ok | npc.json
- 2026-04-02 16:56:04 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | npc.json
- 2026-04-02 16:56:04 | AUTO_TRANSLATE:auto_start | ru | ok | npc.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **100,521** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=33.01%, reason=decrease_high_fail_rate=33.0%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-02 16:58:05
...
| 🔄 Cykli wykonanych | **#12,944** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #12,944 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-02 16:58:05  
