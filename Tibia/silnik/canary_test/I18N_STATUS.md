...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.98% / real 10.9%**. Tempo: **823.0 kluczy/h**. Tłumaczeń netto: **143,336**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 06:26:38

> **Aktualizacja:** 2026-04-29 06:26:38 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,880 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: tr | Plik: items.json | Heartbeat: 2026-04-29T06:25:12Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=4.2% | przepustowość=823.0/h  
> **Tłumaczeń netto:** 143,336

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 06:26:38 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T06:25:12Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 06:26:38 |
| TRANSLATION | 🟢 AKTYWNY | 3min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T06:23:17.429081Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T06:25:12.205126Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 06:26:38 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T06:26:44.942743Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T06:25:12Z
...
| ❤️ **Heartbeat** | 2026-04-29T06:25:12Z |
...
| ⏳ Oldest pending (visible tail) | 17501 s |
...
| 🌍 Recent provider mix | TM/simple(329), Free Google Translate(137), canonical_name_semantic_autofix(15), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=484, fallbacks=8) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=734/734 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 17501}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 06:26:38
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T06:23:17.429081Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T06:25:38.123740Z |
...
| 🕒 Evidence window | 24h (span=35.57h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=35.57h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T05:26:38.753430Z → 2026-04-29T06:26:38.753430Z) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T06:25:12.205126Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T06:25:12.205126Z
- **Top 5 typów problemów:** suspicious_rejected_critical=188, suspicious_log_medium=92, suspicious_log_high=55, suspicious_log_low=52, suspicious_rejected_high=12
- **Języki o najsłabszej jakości:** es(60.1, issues=737006), ro(60.1, issues=434799), de(60.1, issues=117445), cs(60.1, issues=98076), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 737006 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 61%, 173855 problemów
⚠️ **RU**: jakość 74%, 365265 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,880 |
| Heartbeat | 92s temu | 2026-04-29T06:25:12Z |
...
- 2026-04-29 06:25:40 | AUTO_TRANSLATE:heartbeat_tick | tr | ok | items.json
- 2026-04-29 06:25:39 | AUTO_TRANSLATE:auto_start | tr | ok | items.json
- 2026-04-29 06:25:04 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 06:26:38

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [cs] → warn (files+1, translated+32, skipped+0) — lang=cs file=items.json strict_skipped_done=1566 guard_fail=5 placeholder=0 command=0 pipe=0
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+39, skipped+0) — lang=ro file=npc.json strict_skipped_done=10022 guard_fail=242 placeholder=167 command=0 pipe=0
...
| 🔄 Cykli wykonanych | **#17,880** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,880 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 06:26:38  
