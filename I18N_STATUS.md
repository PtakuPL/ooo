...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.98% / real 10.9%**. Tempo: **890.0 kluczy/h**. Tłumaczeń netto: **143,336**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 06:24:18

> **Aktualizacja:** 2026-04-29 06:24:18 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,876 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: server.json | Heartbeat: 2026-04-29T06:22:09Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=4.4% | przepustowość=890.0/h  
> **Tłumaczeń netto:** 143,336

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 06:24:18 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T06:22:09Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 06:24:18 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T06:23:17.429081Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T06:22:08.496016Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 06:24:18 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T06:24:25.257400Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T06:22:09Z
...
| 🔄 **Ostatni cykl** | 30 kluczy, 1 odrzuconych, 51.0s, tryb: AUTO_TRANSLATE, cel: de/npc.json |
| ❤️ **Heartbeat** | 2026-04-29T06:22:09Z |
...
|----------|------|---------|------|-------|--------|------------|--------|
| 06:22:46 | DE | Serwer | npc.json | 30 | `tm` | `npc.a_dead_bureaucrat1.say_1` | Klar, wo sonst. Jeder trifft gerne meinen Meister, er ist ein großer Dämon, nicht wah... |
| 06:22:01 | DE | Klient | otclient_modules.json | 15 | `tm` | `otclient_modules.blessing.tr_11` | - Abhängig von den Regeln des fairen Kampfes verlierst du zwischendurch |
| 06:21:06 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 06:17:51 | ES | Serwer | items.json | 19 | `simple` | `item.1163.name` | techo de tejas |
| 06:16:19 | RO | Serwer | items.json | 39 | `google_translate` | `item.10216.name` | kit statuie dragon |
| 06:14:24 | ES | Serwer | server.json | 2 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 06:12:18 | IT | Serwer | items.json | 30 | `simple` | `item.13094.name` | parete umida |
| 06:10:39 | CS | Serwer | items.json | 71 | `google_translate` | `item.14123.name` | lávový proud |
| 06:08:52 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 06:05:37 | RU | Serwer | items.json | 192 | `google_translate` | `item.13504.name` | клад золота |
| 06:03:18 | TR | Serwer | items.json | 38 | `simple` | `item.1239.name` | değirmen tahtası |
| 06:02:06 | ES | Serwer | server.json | 2 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
...
|----------|------|---------|-----------|-------|----------|--------------|-----|
| 06:22:40 | DE | Serwer | npc.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `npc.a_fluffy_squirrel.stdmod_1` |
| 06:21:58 | DE | Klient | otclient_modules.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `otclient_modules.charms.tr_34` |
| 06:20:00 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.say_1` |
| 06:19:58 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.multi_1` |
| 06:15:27 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10193.name` |
| 06:15:26 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10192.name` |
| 06:15:24 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10191.name` |
| 06:15:22 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10190.name` |
| 06:11:49 | IT | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 06:10:14 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.14077.name` |
| 06:10:14 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.14023.name` |
| 06:10:12 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.11586.name` |
| 06:10:10 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 06:10:07 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10456.name` |
| 06:10:04 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10338.name` |
| 06:10:02 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10026.name` |
| 06:07:46 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.say_2` |
| 06:04:28 | RU | Serwer | items.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `item.11541.name` |
...
| ⏳ Oldest pending (visible tail) | 17362 s |
| 🌍 Top języki | RU(398), CS(2) |
| 🧱 Top reason_bucket | quality(398), default(2) |
| 🗂️ Deferred state keys | 7920 |
...
| 🌍 Recent provider mix | TM/simple(341), Free Google Translate(136), canonical_name_semantic_autofix(18), term_consistency_autofix(3) |
| 🔁 Latest fallback | TM/simple → fallback to google translate high [high_reject_types] server.json |
| 📉 Fallback breakdown | fallback to next provider validate fail(10), fallback to google translate high(9), fallback to google trans... |
...
| ❤️ Pool health | `critical` (writes=498, fallbacks=21) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=732/732 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 17362}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| �📊 Przetłumaczono | **890** kluczy |
| ❌ Odrzucone (guard) | 41 |
| 🔁 Cykli | 88 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (224 kluczy) |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 06:24:18
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T06:23:17.429081Z
...
|-------|-----------|--------|----------|--------------|--------------|
| ES (Hiszpański) | 78.99% (58,875/74,536) | 67.82% (50,549/74,536) | 9,715 | 14,296 | 0 |
| PL (Polski) | 70.99% (52,911/74,536) | 65.08% (48,507/74,536) | 5,861 | 20,194 | 0 |
| IT (Włoski) | 70.19% (52,316/74,536) | 61.97% (46,192/74,536) | 10,028 | 18,341 | 0 |
| RO (Rumuński) | 69.73% (51,972/74,536) | 56.69% (42,253/74,536) | 13,005 | 19,303 | 0 |
| RU (Rosyjski) | 45.96% (34,258/74,536) | 44.39% (33,088/74,536) | 4,775 | 36,691 | 0 |
...
| CS (Czeski) | 50.36% (37,535/74,536) | 32.59% (24,289/74,536) | 29,858 | 20,415 | 0 |
...
| TR (Turecki) | 33.98% (25,330/74,536) | 30.50% (22,733/74,536) | 3,832 | 47,985 | 0 |
...
- Raporty strażnika jakości: **4817**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4670**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T06:22:27.022245Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.98%** (696,868/3,875,872)
- **Pokrycie globalne (real):** **10.9%** (422,442/3,875,872)
- **Kopie EN (łącznie):** **410,513**
- **Placeholdery [EN]/puste (łącznie):** **2,188,795**
...
| 🕒 Evidence window | 24h (span=35.53h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=35.53h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T05:24:19.322149Z → 2026-04-29T06:24:19.322149Z) |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 55 | 83.3% | ru/items.json (55) |
| `existing_canonical_name_quality_mixed_scripts` | 9 | 13.6% | ru/items.json (9) |
| `gt_validate_fail_identical_to_en` | 2 | 3.0% | cs/items.json (2) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T06:22:08.496016Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T06:22:08.496016Z
- **Top 5 typów problemów:** suspicious_rejected_critical=188, suspicious_log_low=111, suspicious_log_high=57, suspicious_log_medium=31, suspicious_rejected_high=12
- **Języki o najsłabszej jakości:** es(60.1, issues=736904), ro(60.1, issues=434728), de(60.1, issues=117329), cs(60.1, issues=98013), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 74%, 54860 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 736904 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 61%, 173819 problemów
⚠️ **RU**: jakość 73%, 365253 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,876 |
| Heartbeat | 136s temu | 2026-04-29T06:22:09Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T06:23:33.492339Z
...
- 2026-04-29 06:23:34 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-29 06:23:18 | AUTO_TRANSLATE:auto_done | de | ok | npc.json
- 2026-04-29 06:22:28 | AUTO_TRANSLATE:heartbeat_tick | de | ok | npc.json
- 2026-04-29 06:22:27 | AUTO_TRANSLATE:auto_start | de | ok | npc.json
- 2026-04-29 06:22:07 | AUTO_TRANSLATE:auto_done | de | ok | otclient_modules.json
- 2026-04-29 06:21:45 | AUTO_TRANSLATE:heartbeat_tick | de | ok | otclient_modules.json
...
| 🟡 ES | 79.0% | 0 | 9,715 | 538 | 0 (0.0%) | 25 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **143,336** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=3.31%, reason=increase_low_fail_rate=3.3%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 538 kluczy / 25 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 06:24:18
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [cs] → warn (files+1, translated+32, skipped+0) — lang=cs file=server.json strict_skipped_done=620 guard_fail=7 placeholder=6 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [nl] → warn (files+1, translated+50, skipped+0) — lang=nl file=monsters.json strict_skipped_done=5836 guard_fail=112 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+41) — repair_identical lang=es file=monsters.json target_identical=35 limit=108 tier=low_backlog+suspicious_guard domain_cap=220 gt=true suspicious_pct=110.71
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **5,564** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 128 |
| ❌ Błędów | 231 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,122), **RU** (1,045), **IT** (808), **DE** (765), **TR** (633) |
| 📊 Porównanie | ↓ 32.4% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **24,544** kluczy
...
| 🔄 Cykli wykonanych | **#17,876** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,876 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 06:24:18  
