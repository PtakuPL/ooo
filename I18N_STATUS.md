...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.85%**. Tempo: **1430.9 kluczy/h**. Tłumaczeń netto: **116,584**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 18:10:12

> **Aktualizacja:** 2026-02-20 18:10:12 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #39 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: pl | Plik: items.json | Heartbeat: 2026-02-20T18:09:58Z  
> **Okno godzinowe:** okno=1.0h | cykli=179 | pominięte=0.0% | odrzucone=63.9% | przepustowość=1430.9/h  
> **Tłumaczeń netto:** 116,584

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 18:10:12 |
| LIVE | 🟢 AKTYWNY | 15s temu | - | `activity.json / worker_state.json` | 2026-02-20T18:09:58Z |
| MIGRATION | 🔒 NIEAKTYWNY | 6s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 18:10:12 |
| TRANSLATION | 🟢 AKTYWNY | 16s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T18:09:56.231604Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T18:10:13.090367Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 18:10:12 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 15s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T18:09:58Z
...
| ❤️ **Heartbeat** | 2026-02-20T18:09:58Z |
...
> Świeżość: 6s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 18:10:12
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 16s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T18:09:56.231604Z
...
- small golden taboret → pequeño taborete dorado (item.12477.name)
- ornate canopic jar → tarro canopo adornado (item.12479.name)
- dead golden servant → sirviente dorado muerto (item.12495.name)
- remains of a canopic jar → restos de una vasija canopa (item.12506.name)
- This hammer is a lesser version of the fabled Ban-Hammer → Este martillo es una versión menor del legendario Ban-Hammer. (item.12510.desc)
- ornate canopic jar → tarro canopo adornado (item.12511.name)
- golden scorpion pendant → colgante de escorpión dorado (item.12542.name)
- golden hyaena pendant → colgante de hiena dorada (item.12543.name)
- ominous piece of cloth → siniestro pedazo de tela (item.12551.name)
- voluminous piece of cloth → trozo de tela voluminoso (item.12553.name)
- luminous piece of cloth → trozo de tela luminosa (item.12556.name)
- This fish, and rare ingredient, can only be found in the dirtiest, murkiest and  → Este pescado, un ingrediente poco común, sólo se puede encontrar en las aguas má (item.12557.desc)
- Meandi → Meandí (item.12576.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **6727**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3835**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T17:10:12.367744Z → 2026-02-20T18:10:12.367744Z) |
...
| Najgorsze cele (strażnik) | es/items.json (gf=1551), pl/npc.json (gf=968), pl/items.json (gf=816), ro/monsters.json (gf=92), es/spells.json (gf=73) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T18:10:13.090367Z
...
| Heartbeat | 15s temu | 2026-02-20T18:09:58Z |
...
- 2026-02-20 18:09:58 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | items.json
- 2026-02-20 18:09:58 | AUTO_TRANSLATE:parallel_start | pl | ok | items.json
- 2026-02-20 18:09:56 | AUTO_TRANSLATE:auto_done | es | ok | items.json
- 2026-02-20 18:09:31 | AUTO_TRANSLATE:heartbeat_tick | es | ok | items.json
- 2026-02-20 18:09:31 | AUTO_TRANSLATE:auto_start | es | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 18:10:12

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+25, skipped+0) — lang=es file=items.json strict_skipped_done=13841 guard_fail=517 placeholder=0 command=0 pipe=0
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [sv] → ok (translated+32, skipped+0) — parallel lang=sv file=spells.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ro] → warn (files+1, translated+45, skipped+0) — lang=ro file=achievements.json strict_skipped_done=464 guard_fail=5 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+24) — repair_identical lang=es file=npc.json target_identical=24 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=208.29
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ro] → ok (translated+24, skipped+0) — parallel lang=ro file=monsters.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ru] → ok (translated+30, skipped+0) — parallel lang=ru file=monsters.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+50, skipped+0) — lang=es file=npc.json strict_skipped_done=9810
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **5,890** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 39 |
| ❌ Błędów | 139 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (1,642), **RU** (1,097), **IT** (982), **RO** (681), **PL** (661) |
| 📊 Porównanie | ↑ 61.8% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **103,475** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 18:10:12  
