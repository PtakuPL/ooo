...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.02% / real 10.94%**. Tempo: **693.0 kluczy/h**. Tłumaczeń netto: **146,344**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 10:29:29

> **Aktualizacja:** 2026-04-29 10:29:29 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,220 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: de | Plik: otclient_modules.json | Heartbeat: 2026-04-29T10:26:49Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=6.4% | przepustowość=693.0/h  
> **Tłumaczeń netto:** 146,344

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 10:29:29 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T10:26:49Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 15s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 10:29:29 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T10:27:31.009521Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T10:26:48.711316Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 10:29:29 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T10:29:35.870699Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T10:26:49Z
...
| ❤️ **Heartbeat** | 2026-04-29T10:26:49Z |
...
| ⏳ Oldest pending (visible tail) | 15860 s |
...
| 🌍 Recent provider mix | TM/simple(337), Free Google Translate(138), canonical_name_semantic_autofix(18), term_consistency_autofix(3) |
| 🔁 Latest fallback | TM/simple → fallback to google translate high [high_reject_types] npc.json |
| 📉 Fallback breakdown | fallback to google translate high(11), fallback to next provider validate fail(5), fallback to google trans... |
...
| ❤️ Pool health | `critical` (writes=496, fallbacks=17) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=921/921 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `NO_WRITE` | OK | OK | `128` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 386, 'oldest_s': 15860}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| �📊 Przetłumaczono | **693** kluczy |
| ❌ Odrzucone (guard) | 47 |
| 🔁 Cykli | 84 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | CS (123 kluczy) |
| 📄 Najczęstszy plik | items.json |
| ⚡ Przepustowość | ~693 kluczy/h |
| 🛡️ Odrzucone (strażnik) | 6.4% |
| ⚠️ Podejrzane | 1034 |
...
> Tempo obliczone na bazie ostatniej godziny: ~693 kluczy/h.
...
> Świeżość: 15s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 10:29:29
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T10:27:31.009521Z
...
- Raporty strażnika jakości: **4903**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4756**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T10:27:10.510185Z |
...
| 🕒 Evidence window | 24h (span=39.62h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=39.62h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T09:29:29.662688Z → 2026-04-29T10:29:29.662688Z) |
| Cykle | **84** (TŁUMACZENIE=84, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **6.4%** |
| Cykle bez postępu % | **0.0%** |
| Przepustowość (kluczy/h) | **693.0 kluczy/h** |
...
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T10:26:48.711316Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T10:26:48.711316Z
- **Top 5 typów problemów:** suspicious_rejected_critical=189, suspicious_log_low=100, suspicious_log_high=98, suspicious_rejected_high=11, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=743977), ro(60.1, issues=439850), de(60.1, issues=122460), cs(60.1, issues=108727), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 743977 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 66%, 176761 problemów
⚠️ **RU**: jakość 61%, 370156 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,220 |
| Heartbeat | 166s temu | 2026-04-29T10:26:49Z |
...
- 2026-04-29 10:27:11 | AUTO_TRANSLATE:heartbeat_tick | de | ok | otclient_modules.json
- 2026-04-29 10:27:11 | AUTO_TRANSLATE:auto_start | de | ok | otclient_modules.json
- 2026-04-29 10:26:47 | AUTO_TRANSLATE:auto_done | es | ok | items.json
...
| Przepustowość (okno) | 552 kluczy / 26 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 10:29:29
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+4) — repair_identical lang=es file=npc.json target_identical=2 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=192.86
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **8,864** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 185 |
| ❌ Błędów | 381 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,588), **RU** (1,538), **IT** (1,340), **TR** (1,237), **DE** (1,230) |
| 📊 Porównanie | ↑ 7.7% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **27,844** kluczy
...
| 🔄 Cykli wykonanych | **#18,220** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,220 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 10:29:29  
