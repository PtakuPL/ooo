...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-19 07:51:44

> **Aktualizacja:** 2026-02-19 07:51:44 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #1 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: sv | Plik: npclib.json | Heartbeat: 2026-02-19T07:51:42Z  
> **Okno godzinowe:** okno=1.0h | cykli=51 | pominięte=0.0% | odrzucone=0.0% | przepustowość=0.0/h  
> **Tłumaczeń netto:** 110,341

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-19 07:51:44 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-19T07:51:42Z |
| MIGRATION | 🔒 NIEAKTYWNY | 1d temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-19 07:51:44 |
| TRANSLATION | 🟢 AKTYWNY | 6s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-19T07:51:40.699650Z |
| QUALITY | 🔒 NIEAKTYWNY | 34s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-19T07:51:12.358542Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-19 07:51:44 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-19T07:51:42Z
...
| ❤️ **Heartbeat** | 2026-02-19T07:51:42Z |
...
> Świeżość: 1d temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-19 07:51:44
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-19T07:51:40.699650Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-19T06:51:44.515618Z → 2026-02-19T07:51:44.515618Z) |
...
> Świeżość: 34s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-19T07:51:12.358542Z

- **Ostatni audyt:** SLOW_MODE | 31 issue(s) / 100 entries | 2026-02-19T07:51:12.358542Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=250155), pl(60.1, issues=140561), ro(60.1, issues=65538), ru(60.1, issues=50979), it(60.1, issues=23061)
...
⚠️ **PL**: jakość 60%, 140561 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 250155 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 23061 problemów
⚠️ **RU**: jakość 60%, 50979 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 60%, 16007 problemów
...
| Heartbeat | 5s temu | 2026-02-19T07:51:42Z |
...
- 2026-02-19 07:51:42 | AUTO_TRANSLATE:heartbeat_tick | sv | ok | npclib.json
- 2026-02-19 07:51:42 | AUTO_TRANSLATE:parallel_start | sv | ok | npclib.json
- 2026-02-19 07:51:40 | AUTO_TRANSLATE:auto_done | sr | ok | talkactions.json
- 2026-02-19 07:51:37 | AUTO_TRANSLATE:heartbeat_tick | sr | ok | talkactions.json
- 2026-02-19 07:51:37 | AUTO_TRANSLATE:auto_start | sr | ok | talkactions.json
- 2026-02-19 07:51:06 | AUTO_TRANSLATE:heartbeat_tick | sr | ok | otclient_data.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.3% | 0 | 1,810 | 169 | 942 (84.8%) | 17 |
| 🟡 ES | 84.3% | 0 | 2,149 | 188 | 294 (61.0%) | 21 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **110,341** | — | 📊 |
| Adaptacyjna paczka | batch=20, gf_rate=0.0%, reason=no_data | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 357 kluczy / 38 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-19 07:51:44
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-19 07:51:44  
