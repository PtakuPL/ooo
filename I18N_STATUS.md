...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.91%**. Tempo: **1280.1 kluczy/h**. Tłumaczeń netto: **126,332**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 22:45:46

> **Aktualizacja:** 2026-02-20 22:45:46 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #18 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: - | Heartbeat: 2026-02-20T22:45:33Z  
> **Okno godzinowe:** okno=1.0h | cykli=154 | pominięte=0.0% | odrzucone=68.0% | przepustowość=1280.1/h  
> **Tłumaczeń netto:** 126,332

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 22:45:46 |
| LIVE | 🟢 AKTYWNY | 15s temu | - | `activity.json / worker_state.json` | 2026-02-20T22:45:33Z |
| MIGRATION | 🔒 NIEAKTYWNY | 20s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 22:45:46 |
| TRANSLATION | 🟢 AKTYWNY | 48s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T22:44:59.161647Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T22:45:48.042850Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 22:45:46 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 15s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T22:45:33Z
...
| ❤️ **Heartbeat** | 2026-02-20T22:45:33Z |
...
> **ETA globalne:** ~74 dni (2,259,616 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| PL | █████████████████░░░ | 87.8% | 47,065/53,586 | ~3h |
| ES | █████████████████░░░ | 85.1% | 45,583/53,586 | ~4h |
| IT | ██████████░░░░░░░░░░ | 52.6% | 28,165/53,586 | ~18h |
| RU | ██████████░░░░░░░░░░ | 50.4% | 26,998/53,586 | ~19h |
| SR | █████████░░░░░░░░░░░ | 45.4% | 24,345/53,586 | ~21h |
| RO | ████████░░░░░░░░░░░░ | 43.7% | 23,416/53,586 | ~21h |
| FR | ██████░░░░░░░░░░░░░░ | 33.1% | 17,731/53,586 | ~26h |
| SV | █████░░░░░░░░░░░░░░░ | 29.2% | 15,673/53,586 | ~28h |
...
> Świeżość: 20s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 22:45:46
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 48s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T22:44:59.161647Z
...
- **Profiler cyklu (ostatni):** cykl #18 (AUTO_TRANSLATE): dispatch 517ms, mode 64817ms, status 5555ms, total 79575ms
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T21:45:47.313022Z → 2026-02-20T22:45:47.313022Z) |
| Cykle | **154** (TŁUMACZENIE=154, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **68.0%** |
| Cykle bez postępu % | **0.0%** |
| Przepustowość (kluczy/h) | **1280.1 kluczy/h** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T22:45:48.042850Z
...
| Heartbeat | 15s temu | 2026-02-20T22:45:33Z |
...
- 2026-02-20 22:45:08 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 22:44:39 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | otclient_modules.json
- 2026-02-20 22:44:39 | AUTO_TRANSLATE:parallel_start | ro | ok | otclient_modules.json
- 2026-02-20 22:44:33 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | questlog.json
- 2026-02-20 22:44:33 | AUTO_TRANSLATE:parallel_start | ru | ok | questlog.json
- 2026-02-20 22:44:31 | AUTO_TRANSLATE:auto_done | it | ok | raids.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,831 | 548 | 5424 (90.8%) | 30 |
| 🟡 ES | 85.1% | 0 | 2,151 | 647 | 2473 (79.3%) | 35 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **126,332** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=48.24%, reason=decrease_high_fail_rate=48.2% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,195 kluczy / 65 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 22:45:46

- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+23) — repair_identical lang=es file=npc.json target_identical=43 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=265.11
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ro] → ok (translated+8, skipped+0) — parallel lang=ro file=otclient_modules.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ru] → ok (translated+30, skipped+0) — parallel lang=ru file=questlog.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [it] → warn (files+1, translated+30, skipped+0) — lang=it file=raids.json strict_skipped_done=106
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [sv] → warn (files+1, translated+30, skipped+0) — lang=sv file=items.json strict_skipped_done=410
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+24) — repair_identical lang=es file=npc.json target_identical=24 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=311.18
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **20,621** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 224 |
| ❌ Błędów | 494 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (6,132), **RU** (4,076), **IT** (3,306), **RO** (2,431), **PL** (2,383) |
| 📊 Porównanie | ↑ 466.4% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **118,206** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 22:45:46  
