...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "first rod") or MsgContains(message, "first wand") then
		if player:isMage() then
			...
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.fenech.say_4")
		end
	elseif MsgContains(message, "yes") then
		if npcHandler:getTopic(playerId) == 1 then
			player:addItem(itemId, 1)
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.fenech.say_5")
	...
	elseif categoryTable then
		...
		NPC_LIB.i18n.npcSay(npcHandler, npc, player, "npc.fenech.say_6", { remainingCategories })
