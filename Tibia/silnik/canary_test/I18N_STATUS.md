...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-28 20:32:48

> **Aktualizacja:** 2026-04-28 20:32:48 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,055 | Status: ✅ BEZCZYNNY | Faza: IDLE | Etap: cycle_start | Kategoria: de | Plik: npc.json | Heartbeat: 2026-04-28T20:29:06Z
> **Okno godzinowe:** okno=1.0h | cykli=87 | pominięte=0.0% | odrzucone=3.5% | przepustowość=898.0/h  
> **Tłumaczeń netto:** 135,410

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-28 20:32:48 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-04-28T20:29:06Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 37s temu | worker w trybie IDLE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-28 20:32:48 |
| TRANSLATION | 🔒 NIEAKTYWNY | 4min temu | worker w trybie IDLE | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-28T20:28:51.116098Z |
| QUALITY | 🔒 NIEAKTYWNY | 28s temu | worker w trybie IDLE | `quality_audit_latest.json` | 2026-04-28T20:32:25.290343Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-28 20:32:48 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-28T20:32:53.899545Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-28T20:29:06Z
...
| 🔄 **Ostatni cykl** | 34 kluczy, 1 odrzuconych, 259.1s, tryb: AUTO_TRANSLATE, cel: de/npc.json |
| ❤️ **Heartbeat** | 2026-04-28T20:29:06Z |
...
| ⏳ Oldest pending (visible tail) | 19367 s |
...
| 🌍 Recent provider mix | TM/simple(256), Free Google Translate(214), OpenAI model pool(21), canonical_name_semantic_autofix(12), ter... |
...
| 📉 Fallback breakdown | fallback to google translate high(9), fallback chain exhausted validate fail word salad(5), fallback to nex... |
...
| ❤️ Pool health | `critical` (writes=506, fallbacks=26) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=277/277 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 387, 'oldest_s': 19367}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| RU | 33,461 | 74,536 | 44.89% →0% | 4,775 |
...
> Świeżość: 37s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-28 20:32:48
...
> Świeżość: 4min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-28T20:28:51.116098Z
...
- **Profiler cyklu (ostatni):** cykl #53 (AUTO_TRANSLATE): dispatch 1232ms, mode 244615ms, status 11665ms, total 259141ms
...
| 🕒 Evidence window | 24h (span=25.68h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=25.68h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-28T19:32:48.366236Z → 2026-04-28T20:32:48.366236Z) |
...
> Świeżość: 28s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-28T20:32:25.290343Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-28T20:32:25.290343Z
- **Top 5 typów problemów:** suspicious_rejected_critical=189, suspicious_log_medium=92, suspicious_log_high=56, suspicious_log_low=45, suspicious_rejected_high=11
- **Języki o najsłabszej jakości:** es(60.1, issues=720796), ro(60.1, issues=420124), de(60.1, issues=103242), cs(60.1, issues=77525), nl(60.1, issues=70960)
...
⚠️ **TR**: jakość 79%, 51968 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 720796 problemów
⚠️ **PT**: jakość 60%, 56666 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 68%, 166270 problemów
⚠️ **RU**: jakość 79%, 353827 problemów
⚠️ **NL**: jakość 60%, 70960 problemów
...
|-----------|--------|-----------|
| Worker | ✅ BEZCZYNNY | Cykl #17,055 |
| Heartbeat | 227s temu | 2026-04-28T20:29:06Z |
...
- 2026-04-28 20:32:03 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-28 20:30:34 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-28 20:32:48
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [tr] → warn (files+1, translated+22, skipped+0) — lang=tr file=server.json strict_skipped_done=434 guard_fail=12 placeholder=6 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [fr] → warn (files+1, translated+43, skipped+0) — lang=fr file=server.json strict_skipped_done=1027 guard_fail=16 placeholder=10 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **5,198** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 53 |
| ❌ Błędów | 207 |
| 🌍 Aktywnych języków | 9 |
| 🏆 TOP 5 | **DE** (945), **RU** (680), **IT** (636), **PT** (594), **TR** (542) |
| 📊 Porównanie | ↑ 0.2% vs wczoraj (5,188) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **28,058** kluczy
...
| 🔄 Cykli wykonanych | **#17,055** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,055 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-28 20:32:48  
