...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.39%**. Tempo: **2098.9 kluczy/h**. Tłumaczeń netto: **89,138**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-17 01:54:22

> **Aktualizacja:** 2026-02-17 01:54:22 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #138 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ru | Plik: - | Heartbeat: 2026-02-17T01:54:19Z  
> **Okno godzinowe:** okno=1.0h | cykli=161 | pominięte=0.0% | odrzucone=51.1% | przepustowość=2098.9/h  
> **Tłumaczeń netto:** 89,138

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-17 01:54:22 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-17T01:54:19Z |
| MIGRATION | 🔒 NIEAKTYWNY | 11s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-17 01:54:22 |
| TRANSLATION | 🟢 AKTYWNY | 6s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-17T01:54:18.464595Z |
| QUALITY | 🔒 NIEAKTYWNY | 5s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-17T01:54:19.090714Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-17 01:54:22 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-17T01:54:19Z
...
| ❤️ **Heartbeat** | 2026-02-17T01:54:19Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **3,793** kluczy |
| ❌ Odrzucone (guard) | 3965 |
| 🔁 Cykli | 161 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (760 kluczy) |
...
> **ETA globalne:** ~47 dni (2,357,506 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ██████████████░░░░░░ | 74.5% | 39,902/53,586 | ~5h |
| PL | █████████░░░░░░░░░░░ | 45.5% | 24,392/53,586 | ~13h |
| RU | ███████░░░░░░░░░░░░░ | 36.9% | 19,786/53,586 | ~15h |
| FR | ██████░░░░░░░░░░░░░░ | 33.0% | 17,712/53,586 | ~16h |
| RO | ████░░░░░░░░░░░░░░░░ | 22.0% | 11,787/53,586 | ~19h |
| ZH_TW | ██░░░░░░░░░░░░░░░░░░ | 14.5% | 7,776/53,586 | ~21h |
| IT | ██░░░░░░░░░░░░░░░░░░ | 13.1% | 7,038/53,586 | ~21h |
...
> Świeżość: 11s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-17 01:54:22
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-17T01:54:18.464595Z
...
|-------|----------------|-------------------------------|---------|--------------|
| ES (Hiszpański) | 39,902/53,586 | 74.46% | 2,631 | 0 |
| PL (Polski) | 24,392/53,586 | 45.52% | 1,919 | 0 |
| RU (Rosyjski) | 19,786/53,586 | 36.92% | 2,596 | 0 |
...
| IT (Włoski) | 7,038/53,586 | 13.13% | 2,438 | 0 |
...
- Here you are. Take care. → Proszę bardzo. Uważaj na siebie. (npc.lorietta.stdmod_5)
- Here you are. Take care. → Proszę bardzo. Uważaj na siebie. (npc.lorietta.stdmod_8)
- Welcome to my humble hut, |PLAYERNAME|. What brings you {here}? → Witaj w mojej skromnej chacie, |PLAYERNAME|. Co cię tu {here}? (npc.lothar.greet_msg_1)
- May the gods protect you! And stay away from that hole! → Niech bogowie cię chronią! I trzymaj się z dala od tej dziury! (npc.loui.farewell_msg_1)
- BEWARE! Beware of that {hole}! → UWAGA! Uważaj na tę {hole}! (npc.loui.greet_msg_1)
- Harmless old woman. → Nieszkodliwy stary kobieta. (npc.loui.stdmod_28)
- Welcome to my adventurer shop, |PLAYERNAME|! What do you need? Ask me for a {tra → Witaj w moim sklepie dla poszukiwaczy przygód, |PLAYERNAME|! Czego potrzebujesz? (npc.lubo.greet_msg_1)
- Great! Alright, I need a while to finish this backpack for you. Come ask me late → Świetnie! Dobrze, potrzebuję chwili, żeby dokończyć ten plecak dla ciebie. Wróć  (npc.lubo.say_10)
- Ah, right, almost forgot about the backpack! Have you brought me 100 pieces of m → Ach, racja, prawie zapomniałam o plecaku! Przyniosłeś/przyniosłaś mi, tak jak pr (npc.lubo.say_2)
- Just in time! Your backpack is finished. Here you go, I hope you like it. → W samą porę! Twój plecak jest gotowy. Proszę, oto on, mam nadzieję, że ci się sp (npc.lubo.say_3)
- Sorry, but I can only make one backpack per person, else I'd have to close my sh → Przykro mi, ale mogę zrobić tylko jeden plecak na osobę, inaczej musiałabym zamk (npc.lubo.say_5)
- Well, if you really like this backpack, I could make one for you, but minotaur l → Cóż, jeśli naprawdę podoba ci się ten plecak, mogłabym zrobić jeden dla ciebie,  (npc.lubo.say_6)
- Alright then, if you bring me 100 pieces of fine minotaur leather I will see wha → No dobrze, jeśli przyniesiesz mi 100 kawałków dobrej skóry minotaura, zobaczę, c (npc.lubo.say_7)
- Sorry, but I don't run a welfare office, you know... no pain, no gain. → Wybacz, ale nie prowadzę biura pomocy społecznej, wiesz... bez bólu nie ma zysku (npc.lubo.say_8)
- Sorry, but that's not enough leather yet to make one of these backpacks. Would y → Przykro mi, ale to wciąż za mało skóry, żeby zrobić jeden z tych plecaków. Może  (npc.lubo.say_9)
- Greetings, traveller. Maybe you'd like to take a look at my {offers}... → Pozdrowienia, podróżniku. Może chcesz rzucić okiem na moje {offers}... (npc.luna.greet_msg_1)
- Welcome in the name of the gods, pilgrim |PLAYERNAME|! → Witaj w imieniu bogów, pielgrzymie |PLAYERNAME|! (npc.lynda.greet_msg_1)
- May the gods bless you, |PLAYERNAME|! → Niech bogowie ci błogosławią, |PLAYERNAME|! (npc.maealil.farewell_1)
- May the gods bless you, |PLAYERNAME|! → Niech bogowie ci błogosławią, |PLAYERNAME|! (npc.maealil.farewell_msg_1)
- So receive the protection of the twist of fate, pilgrim. → Przyjmij ochronę zrządzenia losu, pielgrzymie. (npc.maealil.keyword_1)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **2704**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2638**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **10.39%** (289,606/2,786,472)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-17T00:54:23.002964Z → 2026-02-17T01:54:23.002964Z) |
...
| Przepustowość (kluczy/h) | **2098.9 kluczy/h** |
| Podejrzane tłumaczenia | **9796** |
| Najgorsze cele (strażnik) | pl/items.json (gf=2076), pl/npc.json (gf=759), pl/scripts.json (gf=175), es/questlog.json (gf=61), ro/spells.json (gf=58) |
...
> Świeżość: 5s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-17T01:54:19.090714Z

- **Ostatni audyt:** OK | 5 issue(s) / 100 entries | 2026-02-17T01:54:19.090714Z
- **Top 5 typów problemów:** suspicious_rejected_critical=168, suspicious_log_high=150, suspicious_log_medium=38, suspicious_rejected_high=32, suspicious_log_critical=12
- **Języki o najsłabszej jakości:** sv(60.0, issues=6831), es(60.1, issues=178565), ro(60.1, issues=27883), ru(60.1, issues=22437), pl(62.0, issues=120906)
...
⚠️ **PL**: jakość 62%, 120906 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 178565 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 69%, 8187 problemów
⚠️ **RU**: jakość 60%, 22437 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 60%, 6831 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #138 |
| Heartbeat | 5s temu | 2026-02-17T01:54:19Z |
...
- 2026-02-17 01:54:12 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | npc.json
- 2026-02-17 01:54:11 | AUTO_TRANSLATE:parallel_start | pl | ok | npc.json
- 2026-02-17 01:53:10 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | items.json
- 2026-02-17 01:53:10 | AUTO_TRANSLATE:parallel_start | pl | ok | items.json
- 2026-02-17 01:53:08 | AUTO_TRANSLATE:auto_done | ru | ok | raids.json
- 2026-02-17 01:52:42 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | raids.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 45.5% | 0 | 1,919 | 1,177 | 5729 (83.0%) | 36 |
| 🟡 ES | 74.5% | 0 | 2,631 | 763 | 467 (38.0%) | 33 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **89,138** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=27.15%, reason=decrease_high_fail_rate=27.2% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,940 kluczy / 69 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-17 01:54:22
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → warn (files+0, translated+0, skipped+0) — lang=ru file=raids.json strict_skipped_done=131 guard_fail=50 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [es] → ok (translated+1, skipped+0) — parallel lang=es file=items.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+41, skipped+0) — lang=pl file=items.json strict_skipped_done=849
- 🔧 MIGRATION: zakończono kategorię [events] → ok (keys+6, files+1) — migration finished
- 🔧 MIGRATION: mini-batch stop [events] → ok (keys+0) — no new data
- 🔧 MIGRATION: mini-batch [events] → ok (keys+0) — mini_batch=2 processed=20/50
- 🔧 MIGRATION: mini-batch [events] → ok (keys+6) — mini_batch=1 processed=10/50
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **7,881** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 77 |
| ❌ Błędów | 127 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (1,571), **IT** (1,363), **RU** (1,310), **RO** (1,178), **PL** (1,177) |
| 📊 Porównanie | ↓ 61.2% vs wczoraj (20,288) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **108,075** kluczy
...
| 🔄 Cykli wykonanych | **#138** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-17 01:54:22  
