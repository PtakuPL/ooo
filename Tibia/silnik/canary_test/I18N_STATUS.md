...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.94% / real 10.86%**. Tempo: **903.0 kluczy/h**. Tłumaczeń netto: **140,736**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 03:13:53

> **Aktualizacja:** 2026-04-29 03:13:53 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,600 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: cs | Plik: items.json | Heartbeat: 2026-04-29T03:12:57Z
> **Okno godzinowe:** okno=1.0h | cykli=76 | pominięte=0.0% | odrzucone=2.7% | przepustowość=903.0/h  
> **Tłumaczeń netto:** 140,736

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 03:13:53 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T03:12:57Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 22s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 03:13:53 |
| TRANSLATION | 🟢 AKTYWNY | 4min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T03:09:18.870020Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T03:12:37.957206Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 03:13:53 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T03:14:00.369151Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T03:12:57Z
...
| ❤️ **Heartbeat** | 2026-04-29T03:12:57Z |
...
| ⏳ Oldest pending (visible tail) | 17293 s |
| 🌍 Top języki | RU(398) |
...
| 🌍 Recent provider mix | TM/simple(271), Free Google Translate(213), canonical_name_semantic_autofix(17), canonical_name_case_autofi... |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=583/583 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 17293}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~138 dni (2,986,678 kluczy do celu 95%)
...
> Świeżość: 22s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 03:13:53
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 4min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T03:09:18.870020Z
...
- Raporty strażnika jakości: **4747**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4600**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T03:13:26.926961Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.94%** (695,390/3,875,872)
- **Pokrycie globalne (real):** **10.86%** (420,906/3,875,872)
- **Kopie EN (łącznie):** **410,571**
- **Placeholdery [EN]/puste (łącznie):** **2,190,273**
...
| 🕒 Evidence window | 24h (span=32.36h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=32.36h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T02:13:54.022092Z → 2026-04-29T03:13:54.022092Z) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T03:12:37.957206Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T03:12:37.957206Z
- **Top 5 typów problemów:** suspicious_rejected_critical=186, suspicious_log_medium=89, suspicious_log_low=63, suspicious_log_high=48, suspicious_rejected_high=14
- **Języki o najsłabszej jakości:** es(60.1, issues=730786), ro(60.1, issues=429906), de(60.1, issues=112927), cs(60.1, issues=90084), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 62%, 53972 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 730786 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 69%, 171102 problemów
⚠️ **RU**: jakość 67%, 361729 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,600 |
| Heartbeat | 63s temu | 2026-04-29T03:12:57Z |
...
- 2026-04-29 03:11:04 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 03:09:34 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 03:09:19 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **140,736** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=1.88%, reason=increase_low_fail_rate=1.9%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 03:13:53
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **2,743** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 58 |
| ❌ Błędów | 108 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **RU** (634), **CS** (528), **DE** (360), **IT** (346), **TR** (315) |
| 📊 Porównanie | ↓ 66.7% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **21,723** kluczy
...
| 🔄 Cykli wykonanych | **#17,600** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,600 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 03:13:53  
