...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.91% / real 10.82%**. Tempo: **778.0 kluczy/h**. Tłumaczeń netto: **138,633**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 00:37:52

> **Aktualizacja:** 2026-04-29 00:37:52 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,404 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: de | Plik: npc.json | Heartbeat: 2026-04-29T00:35:01Z
> **Okno godzinowe:** okno=1.0h | cykli=81 | pominięte=0.0% | odrzucone=4.1% | przepustowość=778.0/h  
> **Tłumaczeń netto:** 138,633

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 00:37:52 |
| LIVE | 🟢 AKTYWNY | 3min temu | - | `activity.json / worker_state.json` | 2026-04-29T00:35:01Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 29s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 00:37:52 |
| TRANSLATION | 🟢 AKTYWNY | 3min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T00:34:46.063135Z |
| QUALITY | 🔒 NIEAKTYWNY | 3min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T00:34:06.660321Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 00:37:52 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T00:38:00.291808Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T00:35:01Z
...
| 🔄 **Ostatni cykl** | 30 kluczy, 1 odrzuconych, 23.0s, tryb: AUTO_TRANSLATE, cel: de/npc.json |
| ❤️ **Heartbeat** | 2026-04-29T00:35:01Z |
...
|----------|------|---------|------|-------|--------|------------|--------|
| 00:34:42 | DE | Serwer | npc.json | 30 | `tm` | `npc.a_dead_bureaucrat1.say_1` | Klar, wo sonst. Jeder trifft gerne meinen Meister, er ist ein großer Dämon, nicht wah... |
| 00:33:59 | DE | Klient | otclient_modules.json | 15 | `tm` | `otclient_modules.blessing.tr_11` | - Abhängig von den Regeln des fairen Kampfes verlierst du zwischendurch |
| 00:33:09 | ES | Serwer | server.json | 2 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 00:31:06 | ES | Serwer | items.json | 22 | `simple` | `item.11208.name` | muro corrompido |
| 00:29:28 | RO | Serwer | items.json | 39 | `google_translate` | `item.10216.name` | kit statuie dragon |
| 00:27:34 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 00:24:06 | IT | Serwer | items.json | 59 | `google_translate` | `item.11931.name` | piastrella sabbiosa |
| 00:22:28 | CS | Serwer | items.json | 80 | `google_translate` | `item.12491.name` | štíří oltář |
| 00:19:56 | ES | Serwer | server.json | 2 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 00:17:58 | RU | Serwer | items.json | 57 | `google_translate` | `item.12010.name` | большой палец Колосса |
| 00:16:06 | TR | Serwer | items.json | 30 | `simple` | `item.11409.name` | bilinmeyen eşya |
| 00:15:04 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
...
|----------|------|---------|-----------|-------|----------|--------------|-----|
| 00:36:44 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.say_2` |
| 00:34:37 | DE | Serwer | npc.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `npc.a_fluffy_squirrel.stdmod_1` |
| 00:33:56 | DE | Klient | otclient_modules.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `otclient_modules.charms.tr_34` |
| 00:28:38 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10193.name` |
| 00:28:37 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10192.name` |
| 00:28:34 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10191.name` |
| 00:28:32 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10190.name` |
| 00:26:12 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.say_1` |
| 00:26:10 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.multi_1` |
| 00:23:37 | IT | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 00:21:34 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.11586.name` |
| 00:21:32 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 00:21:30 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10456.name` |
| 00:21:28 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10338.name` |
| 00:21:27 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10026.name` |
| 00:17:10 | RU | Serwer | items.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `item.11541.name` |
...
| 📨 Pending queue (visible tail) | 392 z ostatnich 400 poprawnych wpisów JSONL |
| ⏳ Oldest pending (visible tail) | 17250 s |
| 🌍 Top języki | RU(391), CS(1) |
| 🧱 Top reason_bucket | quality(390), default(2) |
| 🗂️ Deferred state keys | 7440 |
...
| 🌍 Recent provider mix | TM/simple(262), Free Google Translate(223), canonical_name_semantic_autofix(20), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=508, fallbacks=15) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=468/468 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
|-------|--------|----------|-------|-----------|--------|
| `HEARTBEAT_STALE` | OK | OK | `150` | `300` | Heartbeat świeży (150s, src=worker_runtime_heartbeat) Runtime[status=healthy, reason=heartbeat_fresh, phase... |
| `NO_WRITE` | OK | OK | `197` | `900` | Recent writes wyglądają zdrowo. |
| `LEASE_CONFLICT` | OK | OK | `0` | `0` | Brak konfliktów lease/lock w oknie 1800s. |
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 392, 'oldest_s': 17250}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
| �📊 Przetłumaczono | **778** kluczy |
| ❌ Odrzucone (guard) | 33 |
| 🔁 Cykli | 81 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | CS (143 kluczy) |
| 📄 Najczęstszy plik | items.json |
| ⚡ Przepustowość | ~778 kluczy/h |
| 🛡️ Odrzucone (strażnik) | 4.1% |
| ⚠️ Podejrzane | 917 |
...
> Tempo obliczone na bazie ostatniej godziny: ~778 kluczy/h.
...
> Świeżość: 29s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 00:37:52
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 3min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T00:34:46.063135Z
...
|-------|-----------|--------|----------|--------------|--------------|
| ES (Hiszpański) | 78.70% (58,658/74,536) | 67.52% (50,328/74,536) | 9,719 | 14,513 | 0 |
| PL (Polski) | 70.99% (52,911/74,536) | 65.08% (48,507/74,536) | 5,861 | 20,194 | 0 |
| IT (Włoski) | 69.23% (51,598/74,536) | 61.02% (45,480/74,536) | 10,022 | 19,059 | 0 |
| RO (Rumuński) | 69.73% (51,971/74,536) | 56.69% (42,252/74,536) | 13,005 | 19,304 | 0 |
| RU (Rosyjski) | 45.28% (33,751/74,536) | 43.71% (32,581/74,536) | 4,775 | 37,198 | 0 |
...
| CS (Czeski) | 49.33% (36,771/74,536) | 31.40% (23,404/74,536) | 29,979 | 21,179 | 0 |
| TR (Turecki) | 33.19% (24,739/74,536) | 29.71% (22,142/74,536) | 3,832 | 48,576 | 0 |
...
- Raporty strażnika jakości: **4698**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4551**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T00:34:22.715552Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.91%** (694,070/3,875,872)
- **Pokrycie globalne (real):** **10.82%** (419,525/3,875,872)
- **Kopie EN (łącznie):** **410,632**
- **Placeholdery [EN]/puste (łącznie):** **2,191,593**
...
|-------|--------|--------------------------|----------|----------------------------|
| ES | 55,498/70,637 | 78.6% / 66.9% | 3,160/3,899 | 81.0% / 79.2% |
| PL | 49,763/70,637 | 70.5% / 64.3% | 3,148/3,899 | 80.7% / 78.4% |
| IT | 48,625/70,637 | 68.8% / 60.4% | 2,973/3,899 | 76.2% / 73.1% |
| RO | 49,185/70,637 | 69.6% / 56.0% | 2,786/3,899 | 71.5% / 69.6% |
| RU | 30,607/70,637 | 43.3% / 41.8% | 3,144/3,899 | 80.6% / 79.3% |
...
| CS | 35,081/70,637 | 49.7% / 31.0% | 1,690/3,899 | 43.3% / 39.0% |
| TR | 22,780/70,637 | 32.2% / 28.7% | 1,959/3,899 | 50.2% / 48.7% |
...
| 🕒 Evidence window | 24h (span=29.76h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=29.76h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-28T23:37:54.474561Z → 2026-04-29T00:37:54.474561Z) |
| Cykle | **81** (TŁUMACZENIE=81, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **4.1%** |
| Cykle bez postępu % | **0.0%** |
| Przepustowość (kluczy/h) | **778.0 kluczy/h** |
| Podejrzane tłumaczenia | **917** |
| Najgorsze cele (strażnik) | ro/items.json (gf=12), cs/items.json (gf=10), it/items.json (gf=3), de/otclient_modules.json (gf=3), de/npc.json (gf=3) |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 50 | 78.1% | ru/items.json (50) |
| `existing_canonical_name_quality_mixed_scripts` | 14 | 21.9% | ru/items.json (14) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 3min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T00:34:06.660321Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T00:34:06.660321Z
- **Top 5 typów problemów:** suspicious_rejected_critical=192, suspicious_log_low=89, suspicious_log_high=78, suspicious_log_medium=32, suspicious_rejected_high=8
- **Języki o najsłabszej jakości:** es(60.1, issues=727166), ro(60.1, issues=426381), de(60.1, issues=109661), cs(60.1, issues=84572), fr(60.1, issues=60621)
- **Pliki:** `i18n/status/quality_audit_latest.json`, `i18n/status/quality_dashboard.json`, `i18n/status/quality_report.jsonl`

### 📈 Statystyki Pracy
| Metryka | Wartość | Info |
|---------|---------|------|
| 🔄 Cykl aktualny | **#141** | od uruchomienia |
...
⚠️ **TR**: jakość 73%, 53342 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 727166 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 61%, 169265 problemów
⚠️ **RU**: jakość 60%, 358919 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,404 |
| Heartbeat | 180s temu | 2026-04-29T00:35:01Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T00:35:00.433090Z
...
- 2026-04-29 00:36:31 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 00:35:01 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 00:34:46 | AUTO_TRANSLATE:auto_done | de | ok | npc.json
- 2026-04-29 00:34:23 | AUTO_TRANSLATE:heartbeat_tick | de | ok | npc.json
- 2026-04-29 00:34:23 | AUTO_TRANSLATE:auto_start | de | ok | npc.json
- 2026-04-29 00:34:05 | AUTO_TRANSLATE:auto_done | de | ok | otclient_modules.json
...
| 🟡 ES | 78.7% | 0 | 9,719 | 433 | 0 (0.0%) | 19 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **138,633** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=3.63%, reason=increase_low_fail_rate=3.6%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 433 kluczy / 19 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 00:37:52
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+20, skipped+0) — lang=es file=items.json strict_skipped_done=126 guard_fail=17 placeholder=0 command=0 pipe=0
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [tr] → warn (files+0, translated+0, skipped+0) — lang=tr file=npclib.json strict_skipped_done=7
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pt] → warn (files+1, translated+13, skipped+0) — lang=pt file=items.json strict_skipped_done=2471
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [nl] → warn (files+1, translated+2, skipped+0) — lang=nl file=monsters.json strict_skipped_done=348
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **489** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 13 |
| ❌ Błędów | 23 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **DE** (90), **IT** (89), **CS** (80), **RO** (78), **ES** (65) |
| 📊 Porównanie | ↓ 94.1% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **19,469** kluczy
...
| 🔄 Cykli wykonanych | **#17,404** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,404 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 00:37:52  
