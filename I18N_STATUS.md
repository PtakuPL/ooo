...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.89%**. Tempo: **1561.5 kluczy/h**. Tłumaczeń netto: **124,432**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 21:43:49

> **Aktualizacja:** 2026-02-20 21:43:49 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #217 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: it | Plik: - | Heartbeat: 2026-02-20T21:43:45Z  
> **Okno godzinowe:** okno=1.0h | cykli=205 | pominięte=0.0% | odrzucone=59.9% | przepustowość=1561.5/h  
> **Tłumaczeń netto:** 124,432

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 21:43:49 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T21:43:45Z |
| MIGRATION | 🔒 NIEAKTYWNY | 13s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 21:43:49 |
| TRANSLATION | 🟢 AKTYWNY | 5s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T21:43:44.927133Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T21:43:50.542401Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 21:43:49 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T21:43:45Z
...
| ❤️ **Heartbeat** | 2026-02-20T21:43:45Z |
...
> **ETA globalne:** ~60 dni (2,260,058 kluczy do celu 95%)
...
> Świeżość: 13s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 21:43:49
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T21:43:44.927133Z
...
- Hold on! → Stai! (npc.uzon_back.keyword_1)
- Feel the wind in your hair during one of my carpet rides! → Simte vântul în părul tău în timpul uneia dintre plimbările mele pe covor! (npc.uzon_back.stdmod_1)
- Never heard about a place like this. → N-am auzit niciodată de un loc ca acesta. (npc.uzon_back.stdmod_2)
- Hold on! → Stai! (npc.uzon_back.stdmod_3)
- You shouldn't miss the experience. → Nu trebuie să ratezi experiența. (npc.uzon_back.stdmod_4)
- Feel the wind in your hair during one of my carpet rides! → Simte vântul în părul tău în timpul uneia dintre plimbările mele pe covor! (npc.uzon_back.voice_1)
- Sorry, I didn't understand. → Scuze, nu am inteles. (npc.vanys.say_14)
- Have you moved to a new home? I'm the specialist for equipping it. → Te-ai mutat într-o casă nouă? Sunt specialistul în dotarea lui. (npc.vera.voice_1)
- Are you sure you wish to withdraw {} gold from your bank account? → Sigur doriți să retrageți {} aur din contul dvs. bancar? (npc.wentworth.say_10)
- Are you sure you wish to withdraw {} gold from your bank account? → Sigur doriți să retrageți {} aur din contul dvs. bancar? (npc.wentworth.say_11)
- There is not enough gold on your account. → Nu există suficient aur în contul tău. (npc.wentworth.say_17)
- There is not enough gold on your account. → Nu există suficient aur în contul tău. (npc.wentworth.say_18)
- The customer is king! Come back anytime you want to if you wish to {withdraw} yo → Clientul este rege! Reveniți oricând doriți dacă doriți să vă {withdraw} banii. (npc.wentworth.say_19)
- How many platinum coins would you like to get? → Câte monede de platină ai vrea să obții? (npc.wentworth.say_20)
- Sorry, you do not have enough gold coins. → Ne pare rău, nu aveți suficiente monede de aur. (npc.wentworth.say_21)
- Sorry, you do not have enough gold coins. → Ne pare rău, nu aveți suficiente monede de aur. (npc.wentworth.say_23)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **7181**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4287**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **13.89%** (387,054/2,786,472)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T20:43:49.827795Z → 2026-02-20T21:43:49.827795Z) |
...
| Przepustowość (kluczy/h) | **1561.5 kluczy/h** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T21:43:50.542401Z

- **Ostatni audyt:** SLOW_MODE | 28 issue(s) / 100 entries | 2026-02-20T21:43:45.587890Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=143, suspicious_log_critical=77, suspicious_log_high=57, artifact_token=28, suspicious_rejected_high=14
- **Języki o najsłabszej jakości:** es(60.1, issues=348333), pl(60.1, issues=192852), ro(60.1, issues=188769), tl(64.2, issues=466), zh_TW(64.8, issues=337)
...
⚠️ **PL**: jakość 60%, 192852 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 348333 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 72%, 76701 problemów
⚠️ **RU**: jakość 74%, 214633 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 70%, 32118 problemów
...
| Heartbeat | 5s temu | 2026-02-20T21:43:45Z |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 21:43:49
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **17,656** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 217 |
| ❌ Błędów | 430 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (5,228), **RU** (3,459), **IT** (2,815), **RO** (2,099), **PL** (2,095) |
| 📊 Porównanie | ↑ 384.9% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **115,241** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 21:43:49  
