...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.89%**. Tempo: **1571.4 kluczy/h**. Tłumaczeń netto: **124,132**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 21:34:01

> **Aktualizacja:** 2026-02-20 21:34:01 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #210 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: pl | Plik: - | Heartbeat: 2026-02-20T21:33:57Z  
> **Okno godzinowe:** okno=1.0h | cykli=205 | pominięte=0.0% | odrzucone=60.7% | przepustowość=1571.4/h  
> **Tłumaczeń netto:** 124,132

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 21:34:01 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T21:33:57Z |
| MIGRATION | 🔒 NIEAKTYWNY | 47s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 21:34:01 |
| TRANSLATION | 🟢 AKTYWNY | 10s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T21:33:51.700589Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T21:34:02.506426Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 21:34:01 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T21:33:57Z
...
| ❤️ **Heartbeat** | 2026-02-20T21:33:57Z |
...
> Świeżość: 47s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 21:34:01
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 10s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T21:33:51.700589Z
...
- Raporty strażnika jakości: **7164**  
- Raporty blokad: **0**  
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T20:34:01.646414Z → 2026-02-20T21:34:01.646414Z) |
...
| Przepustowość (kluczy/h) | **1571.4 kluczy/h** |
| Podejrzane tłumaczenia | **3449** |
| Najgorsze cele (strażnik) | es/items.json (gf=1568), pl/npc.json (gf=968), pl/items.json (gf=816), es/server.json (gf=123), it/npc.json (gf=114) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T21:34:02.506426Z

- **Ostatni audyt:** SLOW_MODE | 24 issue(s) / 100 entries | 2026-02-20T21:33:52.414847Z | recent_hidden=0
...
- **Top 5 typów problemów:** suspicious_rejected_critical=143, suspicious_log_critical=76, suspicious_log_high=59, artifact_token=19, suspicious_rejected_high=10
- **Języki o najsłabszej jakości:** es(60.1, issues=347065), ro(60.1, issues=188022), pl(61.1, issues=192590), tl(64.2, issues=466), zh_TW(64.8, issues=337)
...
⚠️ **PL**: jakość 61%, 192590 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 347065 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 81%, 76583 problemów
⚠️ **RU**: jakość 84%, 214483 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 70%, 31983 problemów
...
| Heartbeat | 5s temu | 2026-02-20T21:33:57Z |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 21:34:01
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **17,170** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 210 |
| ❌ Błędów | 419 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (5,064), **RU** (3,339), **IT** (2,733), **PL** (2,063), **RO** (2,011) |
| 📊 Porównanie | ↑ 371.6% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **114,755** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 21:34:01  
