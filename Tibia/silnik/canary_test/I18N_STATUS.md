...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **18.89%**. Tempo: **0.0 kluczy/h**. Tłumaczeń netto: **57,117**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-23 12:26:47

> **Aktualizacja:** 2026-03-23 12:26:47 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **LIVE:** Cykl #10,285 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-03-23T12:26:44Z  
> **Okno godzinowe:** okno=1.0h | cykli=134 | pominięte=0.0% | odrzucone=8.1% | przepustowość=0.0/h  
> **Tłumaczeń netto:** 57,117

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-23 12:26:47 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-03-23T12:26:44Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 31s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-23 12:26:47 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-23T12:24:55.223772Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-23T12:24:42.443137Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-23 12:26:47 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-23T12:26:44Z
...
| ❤️ **Heartbeat** | 2026-03-23T12:26:44Z |
...
> **ETA globalne:** ~55222961 dni (2,949,984 kluczy do celu 95%)
...
> Świeżość: 31s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-23 12:26:47
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-23T12:24:55.223772Z
...
- Description → Description (otclient_data.30_minimap_otui.tr_3)
- Description → Description (otclient_data.40_minimap_otui.tr_4)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **3015**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2874**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-23T11:26:48.172511Z → 2026-03-23T12:26:48.172511Z) |
| Cykle | **134** (TŁUMACZENIE=133, PRE_MIGRATION=0) |
...
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-23T12:24:42.443137Z

- **Ostatni audyt:** OK | 1 issue(s) / 100 entries | 2026-03-23T12:24:42.443137Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=620442), ro(60.1, issues=340162), ru(60.1, issues=294340), az(70.3, issues=1417), cs(70.4, issues=13571)
...
⚠️ **PL**: jakość 94%, 328897 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 620442 problemów
⚠️ **PT**: jakość 73%, 21942 problemów
⚠️ **FR**: jakość 87%, 19457 problemów
⚠️ **IT**: jakość 92%, 114301 problemów
⚠️ **RU**: jakość 60%, 294340 problemów
⚠️ **NL**: jakość 84%, 14221 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #10,285 |
| Heartbeat | 5s temu | 2026-03-23T12:26:44Z |
...
- 2026-03-23 12:26:44 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-03-23 12:25:13 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-03-23 12:24:55 | AUTO_TRANSLATE:auto_done | fr | ok | otclient_data.json
- 2026-03-23 12:24:48 | AUTO_TRANSLATE:heartbeat_tick | fr | ok | otclient_data.json
- 2026-03-23 12:24:48 | AUTO_TRANSLATE:auto_start | fr | ok | otclient_data.json
- 2026-03-23 12:24:42 | AUTO_TRANSLATE:auto_done | it | ok | otclient_data.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-23 12:26:47
...
| 🔄 Cykli wykonanych | **#10,285** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #10,285 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-23 12:26:47  
