...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **11.13%**. Tempo: **751.0 kluczy/h**. Tłumaczeń netto: **80,935**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-15 13:53:45

> **Aktualizacja:** 2026-02-15 13:53:45 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #8,880 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: pl | Plik: - | Heartbeat: 2026-02-15T13:53:11Z  
> **Okno godzinowe:** okno=1.0h | cykli=313 | pominięte=0.0% | odrzucone=44.1% | przepustowość=751.0/h  
> **Tłumaczeń netto:** 80,935

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-15 13:53:45 |
| LIVE | 🟢 AKTYWNY | 35s temu | - | `activity.json / worker_state.json` | 2026-02-15T13:53:11Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 14s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-15 13:53:45 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-15T13:51:26.415489Z |
| QUALITY | 🔒 NIEAKTYWNY | 36s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-15T13:53:10.536682Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-15 13:53:45 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 35s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-15T13:53:11Z
...
| ❤️ **Heartbeat** | 2026-02-15T13:53:11Z |
...
> **ETA globalne:** ~130 dni (2,337,068 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| PL | █████████████████░░░ | 87.4% | 46,854/53,586 | ~5h |
| ES | ████████████████░░░░ | 84.1% | 45,088/53,586 | ~8h |
| RU | ██████░░░░░░░░░░░░░░ | 33.9% | 18,142/53,586 | ~44h |
| FR | ██████░░░░░░░░░░░░░░ | 33.3% | 17,855/53,586 | ~44h |
...
> Świeżość: 14s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-15 13:53:45
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-15T13:51:26.415489Z
...
- **Profiler cyklu (ostatni):** cykl #11 (AUTO_TRANSLATE): dispatch 11364ms, mode 110884ms, status 32260ms, total 156059ms
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-15T12:53:46.079516Z → 2026-02-15T13:53:46.079516Z) |
| Cykle | **313** (TŁUMACZENIE=160, PRE_MIGRATION=0) |
...
> Świeżość: 36s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-15T13:53:10.536682Z

- **Ostatni audyt:** SLOW_MODE | 12 issue(s) / 100 entries | 2026-02-15T13:53:10.536682Z
- **Top 5 typów problemów:** suspicious_rejected_critical=200, suspicious_log_high=184, suspicious_log_low=14, identical_to_en_exempt=8, identical_to_en=8
- **Języki o najsłabszej jakości:** es(60.1, issues=236846), pl(60.1, issues=162580), tl(64.2, issues=466), zh_TW(64.8, issues=337), fr(66.5, issues=2470)
...
⚠️ **PL**: jakość 60%, 162580 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 236846 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #8,880 |
| Heartbeat | 35s temu | 2026-02-15T13:53:11Z |
...
- 2026-02-15 13:53:06 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-15 13:53:45
...
| ❌ Błędów | 212 |
| 🌍 Aktywnych języków | 6 |
| 🏆 TOP 5 | **PL** (3,123), **ES** (3,018), **EL** (68), **IT** (45), **CS** (32) |
| 📊 Porównanie | ↓ 88.4% vs wczoraj (54,494) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **108,230** kluczy
...
| 🔄 Cykli wykonanych | **#8,880** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-15 13:53:45  
