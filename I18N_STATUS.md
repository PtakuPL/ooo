...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.35%**. Tempo: **2316.2 kluczy/h**. Tłumaczeń netto: **87,531**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-17 01:15:38

> **Aktualizacja:** 2026-02-17 01:15:38 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #113 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ro | Plik: - | Heartbeat: 2026-02-17T01:15:35Z  
> **Okno godzinowe:** okno=1.0h | cykli=165 | pominięte=0.0% | odrzucone=45.2% | przepustowość=2316.2/h  
> **Tłumaczeń netto:** 87,531

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-17 01:15:38 |
| LIVE | 🟢 AKTYWNY | 4s temu | - | `activity.json / worker_state.json` | 2026-02-17T01:15:35Z |
| MIGRATION | 🔒 NIEAKTYWNY | 39s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-17 01:15:38 |
| TRANSLATION | 🟢 AKTYWNY | 21s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-17T01:15:17.846150Z |
| QUALITY | 🔒 NIEAKTYWNY | 4s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-17T01:15:34.969186Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-17 01:15:38 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 4s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-17T01:15:35Z
...
| ❤️ **Heartbeat** | 2026-02-17T01:15:35Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **4,168** kluczy |
| ❌ Odrzucone (guard) | 3431 |
| 🔁 Cykli | 165 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | IT (769 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~2316 kluczy/h |
...
| RO | 11,454 | 53,586 | 21.37% | 2,443 |
| ZH_TW | 7,776 | 53,586 | 14.51% | 9,749 |
| IT | 6,714 | 53,586 | 12.53% | 2,441 |
...
> **ETA globalne:** ~42 dni (2,358,832 kluczy do celu 95%)
...
| RO | ████░░░░░░░░░░░░░░░░ | 21.4% | 11,454/53,586 | ~17h |
| ZH_TW | ██░░░░░░░░░░░░░░░░░░ | 14.5% | 7,776/53,586 | ~19h |
| IT | ██░░░░░░░░░░░░░░░░░░ | 12.5% | 6,714/53,586 | ~19h |
...
> Tempo obliczone na bazie ostatniej godziny: ~2316 kluczy/h.
...
> Świeżość: 39s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-17 01:15:38
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 21s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-17T01:15:17.846150Z
...
| RO (Rumuński) | 11,454/53,586 | 21.37% | 2,443 | 0 |
| ZH_TW (ZH_TW) | 7,776/53,586 | 14.51% | 9,749 | 2,155 |
| IT (Włoski) | 6,714/53,586 | 12.53% | 2,441 | 0 |
...
| RO | 11,169/49,731 | 22.5% | 285/3,855 | 7.4% |
| ZH_TW | 7,763/49,731 | 15.6% | 13/3,855 | 0.3% |
| IT | 6,430/49,731 | 12.9% | 284/3,855 | 7.4% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-17T00:15:38.729267Z → 2026-02-17T01:15:38.729267Z) |
...
| Przepustowość (kluczy/h) | **2316.2 kluczy/h** |
| Podejrzane tłumaczenia | **14365** |
...
> Świeżość: 4s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-17T01:15:34.969186Z

- **Ostatni audyt:** OK | 8 issue(s) / 100 entries | 2026-02-17T01:15:34.969186Z
- **Top 5 typów problemów:** suspicious_rejected_critical=172, suspicious_log_high=110, suspicious_log_critical=47, suspicious_log_low=43, suspicious_rejected_high=28
- **Języki o najsłabszej jakości:** es(60.1, issues=174485), ro(60.3, issues=24576), ru(60.3, issues=20428), it(61.5, issues=7617), pl(63.7, issues=119679)
...
⚠️ **PL**: jakość 64%, 119679 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 174485 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 62%, 7617 problemów
⚠️ **RU**: jakość 60%, 20428 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 68%, 5829 problemów
...
| Heartbeat | 4s temu | 2026-02-17T01:15:35Z |
...
- 2026-02-17 01:15:24 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-17 01:15:13 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | cpp.json
- 2026-02-17 01:15:13 | AUTO_TRANSLATE:parallel_start | ru | ok | cpp.json
- 2026-02-17 01:14:33 | AUTO_TRANSLATE:heartbeat_tick | it | ok | questlog.json
- 2026-02-17 01:14:33 | AUTO_TRANSLATE:parallel_start | it | ok | questlog.json
- 2026-02-17 01:14:31 | AUTO_TRANSLATE:auto_done | ro | ok | questlog.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-17 01:15:38
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **5,381** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 52 |
| ❌ Błędów | 84 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (1,090), **IT** (921), **RU** (864), **RO** (775), **PL** (774) |
| 📊 Porównanie | ↓ 73.5% vs wczoraj (20,288) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **105,575** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-17 01:15:38  
