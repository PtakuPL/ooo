...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 19.07% / real 8.68%**. Tempo: **601.0 kluczy/h**. Tłumaczeń netto: **67,986**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-23 18:45:08

> **Aktualizacja:** 2026-03-23 18:45:08 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #11,019 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: pl | Plik: monsters.json | Heartbeat: 2026-03-23T18:45:09Z  
> **Okno godzinowe:** okno=1.0h | cykli=78 | pominięte=0.0% | odrzucone=21.4% | przepustowość=601.0/h  
> **Tłumaczeń netto:** 67,986

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-23 18:45:08 |
| LIVE | 🟢 AKTYWNY | 1s temu | - | `activity.json / worker_state.json` | 2026-03-23T18:45:09Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 25s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-23 18:45:08 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-23T18:42:46.018589Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-23T18:43:10.831505Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-23 18:45:08 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-23T18:45:09Z
...
| ❤️ **Heartbeat** | 2026-03-23T18:45:09Z |
...
> **ETA globalne:** ~204 dni (2,943,019 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ██████████████████░░ | 94.1% | 70,129/74,536 | ~1h |
| PL | ███████████████░░░░░ | 77.5% | 57,778/74,536 | ~22h |
| IT | ██████████████░░░░░░ | 73.5% | 54,805/74,536 | ~27h |
| RO | ███████████████░░░░░ | 75.6% | 56,340/74,536 | ~24h |
| RU | ██████████████░░░░░░ | 73.4% | 54,740/74,536 | ~27h |
| FR | ██████████████░░░░░░ | 72.7% | 54,147/74,536 | ~28h |
| SR | ██████░░░░░░░░░░░░░░ | 33.3% | 24,827/74,536 | ~3d |
| PT | ██████████████░░░░░░ | 71.1% | 53,007/74,536 | ~30h |
| CS | █████████████░░░░░░░ | 69.2% | 51,609/74,536 | ~32h |
...
> Świeżość: 25s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-23 18:45:08
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-23T18:42:46.018589Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-23T17:45:09.179963Z → 2026-03-23T18:45:09.179963Z) |
| Cykle | **78** (TŁUMACZENIE=78, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **21.4%** |
| Cykle bez postępu % | **15.0%** |
| Przepustowość (kluczy/h) | **601.0 kluczy/h** |
| Podejrzane tłumaczenia | **1447** |
| Najgorsze cele (strażnik) | pl/npc.json (gf=100), pl/items.json (gf=26), es/items.json (gf=8), ru/npc.json (gf=8), ru/php.json (gf=5) |
...
|--------|-----------|--------|----------------|
| `gt_rejected_critical` | 118 | 45.0% | pl/npc.json (35) |
| `gt_rejected_high_partial_translation_mix` | 42 | 16.0% | es/monsters.json (20) |
| `gt_validate_fail_placeholder` | 40 | 15.3% | pl/npc.json (37) |
| `gt_validate_fail_word_salad` | 33 | 12.6% | pl/items.json (8) |
| `gt_rejected_high_trimmed_en_copy` | 12 | 4.6% | pl/monsters.json (11) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-23T18:43:10.831505Z
...
| Heartbeat | 1s temu | 2026-03-23T18:45:09Z |
...
- **Ostatnia aktualizacja:** 2026-03-23T18:43:03.580551Z
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-23 18:45:08
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **46,043** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 174 |
| ❌ Błędów | 713 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **ES** (12,880), **TR** (7,778), **RO** (5,755), **FR** (3,289), **PL** (3,194) |
| 📊 Porównanie | ↑ 122.1% vs wczoraj (20,729) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **66,772** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-23 18:45:08  
