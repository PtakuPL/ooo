...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.16%**. Tempo: **1357.9 kluczy/h**. Tłumaczeń netto: **71,318**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-14 17:09:31

> **Aktualizacja:** 2026-02-14 17:09:31 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #3 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-02-14T17:09:28Z  
> **Okno godzinowe:** okno=1.0h | cykli=125 | pominięte=0.0% | odrzucone=59.8% | przepustowość=1357.9/h  
> **Tłumaczeń netto:** 71,318

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-14 17:09:31 |
| LIVE | 🟢 AKTYWNY | 3s temu | - | `activity.json / worker_state.json` | 2026-02-14T17:09:28Z |
| MIGRATION | 🔒 NIEAKTYWNY | 30s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-14 17:09:31 |
| TRANSLATION | 🟢 AKTYWNY | 11s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-14T17:09:20.328387Z |
| QUALITY | 🔒 NIEAKTYWNY | 38s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-14T17:08:53.423152Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-14 17:09:31 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 3s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-14T17:09:28Z
...
| ❤️ **Heartbeat** | 2026-02-14T17:09:28Z |
...
| 🔁 Cykli | 125 |
| 🌍 Języków | 2 |
| 🏆 Najaktywniejszy | PL (1,299 kluczy) |
...
> **ETA globalne:** ~73 dni (2,364,085 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 75.2% | 40,283/53,586 | ~8h |
| PL | █████████░░░░░░░░░░░ | 46.0% | 24,639/53,586 | ~19h |
...
> Świeżość: 30s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-14 17:09:31
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 11s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-14T17:09:20.328387Z
...
- Territorial → Territorial (achievement.30.name)
- Jamjam → Jamjam (achievement.93.name)
- Peazzekeeper → Peazzekeeper (achievement.165.name)
- Biodegradable → Biodegradable (achievement.209.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **2229**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2162**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-14T16:09:31.653503Z → 2026-02-14T17:09:31.653503Z) |
...
| Cykle bez postępu % | **17.7%** |
| Przepustowość (kluczy/h) | **1357.9 kluczy/h** |
| Podejrzane tłumaczenia | **4240** |
...
> Świeżość: 38s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-14T17:08:53.423152Z

- **Ostatni audyt:** SLOW_MODE | 33 issue(s) / 100 entries | 2026-02-14T17:08:53.423152Z
- **Top 5 typów problemów:** suspicious_rejected_critical=200, suspicious_log_high=84, suspicious_log_low=76, suspicious_log_critical=40, identical_to_en_exempt=31
- **Języki o najsłabszej jakości:** es(60.1, issues=164725), pl(60.1, issues=119866), tl(64.2, issues=466), zh_TW(64.8, issues=337), fr(66.5, issues=2470)
...
⚠️ **PL**: jakość 60%, 119866 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 164725 problemów
...
| Heartbeat | 3s temu | 2026-02-14T17:09:28Z |
...
- 2026-02-14 17:09:28 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-14 17:09:11 | AUTO_TRANSLATE:heartbeat_tick | es | ok | achievements.json
- 2026-02-14 17:09:10 | AUTO_TRANSLATE:parallel_start | es | ok | achievements.json
- 2026-02-14 17:09:10 | AUTO_TRANSLATE:auto_done | pl | ok | client.json
- 2026-02-14 17:09:04 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | client.json
- 2026-02-14 17:09:04 | AUTO_TRANSLATE:auto_start | pl | ok | client.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 46.0% | 0 | 2,055 | 4,040 | 4660 (53.6%) | 97 |
| 🟡 ES | 75.2% | 0 | 2,757 | 2,812 | 1162 (29.2%) | 80 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **71,318** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=30.92%, reason=decrease_high_fail_rate=30.9% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 6,852 kluczy / 177 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-14 17:09:31
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **39,564** kluczy |
| ⏭️ Pominięte | 1 |
| 🔁 Cykli | 49 |
| ❌ Błędów | 500 |
| 🌍 Aktywnych języków | 52 |
| 🏆 TOP 5 | **ES** (11,342), **PL** (5,059), **IT** (971), **PT** (960), **DE** (890) |
| 📊 Porównanie | ↓ 14.1% vs wczoraj (46,073) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **86,986** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-14 17:09:31  
