...
function checkTaint.onSay(player, words, param)
	...
	if taintLevel ~= nil and taintName ~= nil then
		player:sendLocalizedMessage(MESSAGE_EVENT_ADVANCE, "scripts.soul_war.taint_current", taintLevel, taintName)
	else
...
function setTaint.onSay(player, words, param)
	...
	if taintName ~= nil then
		...
		target:sendLocalizedMessage(MESSAGE_EVENT_ADVANCE, "scripts.soul_war.taint_new", taintLevel, taintName)
		player:sendLocalizedMessage(MESSAGE_EVENT_ADVANCE, "scripts.soul_war.taint_added", taintLevel, taintName, target:getName())
		target:setTaintIcon()
	end
end
...
function setTaint.onSay(player, words, param)
	...
	if taintName ~= nil then
		...
		target:sendLocalizedMessage(MESSAGE_EVENT_ADVANCE, "scripts.soul_war.taint_lost", taintLevel, taintName)
		player:sendLocalizedMessage(MESSAGE_EVENT_ADVANCE, "scripts.soul_war.taint_removed", taintLevel, taintName, target:getName())
	end
end
