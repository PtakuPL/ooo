...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.96% / real 10.88%**. Tempo: **822.0 kluczy/h**. Tłumaczeń netto: **142,267**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 05:01:01

> **Aktualizacja:** 2026-04-29 05:01:01 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,756 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ru | Plik: items.json | Heartbeat: 2026-04-29T04:58:33Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=3.9% | przepustowość=822.0/h  
> **Tłumaczeń netto:** 142,267

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 05:01:01 |
| LIVE | 🟢 AKTYWNY | 2min temu | - | `activity.json / worker_state.json` | 2026-04-29T04:58:33Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 49s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 05:01:01 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T04:59:43.631303Z |
| QUALITY | 🔒 NIEAKTYWNY | 2min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T04:58:14.810307Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 05:01:01 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T05:01:07.716078Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T04:58:33Z
...
| 🔄 **Ostatni cykl** | 30 kluczy, 1 odrzuconych, 72.0s, tryb: AUTO_TRANSLATE, cel: ru/items.json |
| ❤️ **Heartbeat** | 2026-04-29T04:58:33Z |
...
| ⏳ Oldest pending (visible tail) | 17034 s |
| 🌍 Top języki | RU(400) |
| 🧱 Top reason_bucket | quality(400) |
| 🗂️ Deferred state keys | 7824 |
| 🕒 Deferred state freshness | fresh (82s) |
...
| 🌍 Recent provider mix | TM/simple(348), Free Google Translate(135), canonical_name_semantic_autofix(15), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=501, fallbacks=10) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=667/667 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 17034}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 49s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 05:01:01
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T04:59:43.631303Z
...
- hive structure → структура улья (item.13190.name)
- hive structure → структура улья (item.13191.name)
- hive structure → структура улья (item.13192.name)
- hive structure → структура улья (item.13193.name)
- hive structure → структура улья (item.13194.name)
- hive structure → структура улья (item.13195.name)
- hive structure → структура улья (item.13196.name)
- hive structure → структура улья (item.13197.name)
- hive structure → структура улья (item.13198.name)
- hive structure → структура улья (item.13199.name)
- hive structure → структура улья (item.13200.name)
- hive structure → структура улья (item.13201.name)
- hive structure → структура улья (item.13202.name)
- hive structure → структура улья (item.13203.name)
- hive structure → структура улья (item.13204.name)
- hive structure → структура улья (item.13205.name)
- hive structure → структура улья (item.13206.name)
- hive structure → структура улья (item.13207.name)
- hive structure → структура улья (item.13208.name)
- hive structure → структура улья (item.13209.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4787**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4640**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T04:58:32.012943Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.96%** (696,252/3,875,872)
- **Pokrycie globalne (real):** **10.88%** (421,822/3,875,872)
- **Kopie EN (łącznie):** **410,517**
- **Placeholdery [EN]/puste (łącznie):** **2,189,411**
...
| 🕒 Evidence window | 24h (span=34.15h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=34.15h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T04:01:02.076982Z → 2026-04-29T05:01:02.076982Z) |
...
> Świeżość: 2min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T04:58:14.810307Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T04:58:14.810307Z
- **Top 5 typów problemów:** suspicious_rejected_critical=188, suspicious_log_medium=92, suspicious_log_low=57, suspicious_log_high=50, suspicious_rejected_high=12
- **Języki o najsłabszej jakości:** es(60.1, issues=734224), ro(60.1, issues=432669), de(60.1, issues=115572), cs(60.1, issues=94317), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 60%, 54513 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 734224 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 67%, 172802 problemów
⚠️ **RU**: jakość 74%, 363609 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,756 |
| Heartbeat | 154s temu | 2026-04-29T04:58:33Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T04:59:59.424385Z
...
- 2026-04-29 05:00:00 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 04:59:44 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
- 2026-04-29 04:58:33 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-04-29 04:58:32 | AUTO_TRANSLATE:auto_start | ru | ok | items.json
- 2026-04-29 04:58:14 | AUTO_TRANSLATE:auto_done | tr | ok | items.json
- 2026-04-29 04:57:32 | AUTO_TRANSLATE:heartbeat_tick | tr | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 05:01:01

- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → warn (files+1, translated+30, skipped+0) — lang=ru file=items.json strict_skipped_done=2980 guard_fail=1 placeholder=0 command=0 pipe=0
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **4,395** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 98 |
| ❌ Błędów | 178 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (893), **RU** (791), **IT** (688), **DE** (585), **TR** (525) |
| 📊 Porównanie | ↓ 46.6% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **23,375** kluczy
...
| 🔄 Cykli wykonanych | **#17,756** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,756 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 05:01:01  
