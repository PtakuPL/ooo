...
npcHandler:setLocalizedMessage(MESSAGE_SENDTRADE, "npclib.handler.sendtrade_with_categories", { args = function(_player) return { GetFormattedShopCategoryNames(SupplyShopConfigTable) } end })
