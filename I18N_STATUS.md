...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.86%**. Tempo: **1756.2 kluczy/h**. Tłumaczeń netto: **118,922**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 19:04:32

> **Aktualizacja:** 2026-02-20 19:04:32 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #85 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: es | Plik: - | Heartbeat: 2026-02-20T19:04:29Z  
> **Okno godzinowe:** okno=1.0h | cykli=205 | pominięte=0.0% | odrzucone=70.8% | przepustowość=1756.2/h  
> **Tłumaczeń netto:** 118,922

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 19:04:32 |
| LIVE | 🟢 AKTYWNY | 4s temu | - | `activity.json / worker_state.json` | 2026-02-20T19:04:29Z |
| MIGRATION | 🔒 NIEAKTYWNY | 43s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 19:04:32 |
| TRANSLATION | 🟢 AKTYWNY | 7s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T19:04:26.573556Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T19:04:33.709031Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 19:04:32 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 4s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T19:04:29Z
...
| ❤️ **Heartbeat** | 2026-02-20T19:04:29Z |
...
> Świeżość: 43s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 19:04:32
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 7s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T19:04:26.573556Z
...
- Raporty strażnika jakości: **6843**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3951**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T18:04:32.992022Z → 2026-02-20T19:04:32.992022Z) |
...
| Przepustowość (kluczy/h) | **1756.2 kluczy/h** |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T19:04:33.709031Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=330148), pl(60.1, issues=185316), ro(60.1, issues=180888), sr(61.3, issues=86259), tl(64.2, issues=466)
...
| Heartbeat | 4s temu | 2026-02-20T19:04:29Z |
...
- 2026-02-20 19:04:21 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | monsters.json
- 2026-02-20 19:04:21 | AUTO_TRANSLATE:parallel_start | pl | ok | monsters.json
- 2026-02-20 19:04:19 | AUTO_TRANSLATE:auto_done | es | ok | npc.json
- 2026-02-20 19:04:05 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 19:04:04 | AUTO_TRANSLATE:auto_start | es | ok | npc.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,829 | 615 | 6764 (91.7%) | 36 |
...
| Przepustowość (okno) | 1,348 kluczy / 76 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 19:04:32
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+24) — repair_identical lang=es file=npc.json target_identical=24 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=325.34
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [it] → ok (translated+37, skipped+0) — parallel lang=it file=spells.json
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **9,236** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 85 |
| ❌ Błędów | 208 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (2,696), **RU** (1,817), **IT** (1,550), **RO** (1,134), **PL** (1,032) |
| 📊 Porównanie | ↑ 153.7% vs wczoraj (3,641) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **106,821** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 19:04:32  
