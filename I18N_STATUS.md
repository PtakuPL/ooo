...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **13.84%**. Tempo: **1641.8 kluczy/h**. Tłumaczeń netto: **115,589**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-20 17:36:18

> **Aktualizacja:** 2026-02-20 17:36:18 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #11 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ru | Plik: - | Heartbeat: 2026-02-20T17:36:14Z  
> **Okno godzinowe:** okno=1.0h | cykli=157 | pominięte=0.0% | odrzucone=58.8% | przepustowość=1641.8/h  
> **Tłumaczeń netto:** 115,589

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-20 17:36:18 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-20T17:36:14Z |
| MIGRATION | 🔒 NIEAKTYWNY | 17s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-20 17:36:18 |
| TRANSLATION | 🟢 AKTYWNY | 37s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-20T17:35:42.112186Z |
| QUALITY | 🟢 AKTYWNY | 0s temu | - | `quality_audit_latest.json + guard_fail_breakdown_latest.json` | 2026-02-20T17:36:19.606549Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-20 17:36:18 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-20T17:36:14Z
...
| ❤️ **Heartbeat** | 2026-02-20T17:36:14Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **2,853** kluczy |
| ❌ Odrzucone (guard) | 4068 |
| 🔁 Cykli | 157 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (591 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~1642 kluczy/h |
| 🛡️ Guard fail rate | 58.8% |
| ⚠️ Podejrzane | 23767 |
| 🌐 GT aktywny (1h) | ✅ TAK |
| 🔤 GT tłumaczeń (1h) | 148 |
...
> Świeżość: 17s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-20 17:36:18
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 37s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-20T17:35:42.112186Z
...
| IT (Włoski) | 27,757/53,586 | 51.80% | 2,142 | 0 |
...
- Raporty strażnika jakości: **6660**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3768**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **13.84%** (385,693/2,786,472)
- **Kopie EN (łącznie):** **162,361**
...
| IT | 26,426/49,731 | 53.1% | 1,331/3,855 | 34.5% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-20T16:36:18.941913Z → 2026-02-20T17:36:18.941913Z) |
...
| Przepustowość (kluczy/h) | **1641.8 kluczy/h** |
| Podejrzane tłumaczenia | **4045** |
| Najgorsze cele (strażnik) | es/items.json (gf=1033), pl/items.json (gf=836), pl/npc.json (gf=666), ro/monsters.json (gf=182), es/server.json (gf=122) |
...
> **[QUALITY]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `quality_audit_latest.json + guard_fail_breakdown_latest.json` | Ostatnia aktualizacja: 2026-02-20T17:36:19.606549Z

- **Ostatni audyt:** SLOW_MODE | 48 issue(s) / 100 entries | 2026-02-20T17:36:14.743777Z | recent_hidden=0
- **Alarm recent hidden HIGH/CRITICAL:** ✅ OK | hidden=0, threshold=5, trend=→ last10=0.00, prev10=0.00, latest=0
- **Regresja critical bad keys pack:** 🚨 FAIL: pl(critical=41, pack=0), es(critical=38, pack=0)
- **Top 5 typów problemów:** suspicious_rejected_critical=161, suspicious_log_high=51, suspicious_log_critical=45, identical_to_en=32, suspicious_rejected_high=25
- **Języki o najsłabszej jakości:** es(60.1, issues=321258), ro(60.1, issues=175681), it(60.1, issues=70698), tl(64.2, issues=466), sr(64.4, issues=86058)
...
⚠️ **PL**: jakość 87%, 180962 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 321258 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 70698 problemów
⚠️ **RU**: jakość 65%, 210193 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 74%, 29872 problemów
...
| Heartbeat | 5s temu | 2026-02-20T17:36:14Z |
...
- 2026-02-20 17:35:48 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-20 17:35:38 | AUTO_TRANSLATE:heartbeat_tick | sv | ok | monsters.json
- 2026-02-20 17:35:38 | AUTO_TRANSLATE:parallel_start | sv | ok | monsters.json
- 2026-02-20 17:35:15 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | otclient_modules.json
- 2026-02-20 17:35:15 | AUTO_TRANSLATE:parallel_start | ro | ok | otclient_modules.json
- 2026-02-20 17:35:14 | AUTO_TRANSLATE:auto_done | ru | ok | questlog.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🟡 PL | 87.8% | 0 | 1,829 | 797 | 5812 (87.9%) | 38 |
| 🟡 ES | 84.7% | 0 | 2,164 | 779 | 2924 (79.0%) | 41 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **115,589** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=28.38%, reason=decrease_high_fail_rate=28.4% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 1,576 kluczy / 79 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-20 17:36:18
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **4,283** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 17 |
| ❌ Błędów | 93 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (1,137), **RU** (785), **IT** (744), **RO** (514), **PL** (486) |
| 📊 Porównanie | ↑ 17.6% vs wczoraj (3,641) |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-20 17:36:18  
