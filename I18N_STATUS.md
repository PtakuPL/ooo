...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.58%**. Tempo: **1896.7 kluczy/h**. Tłumaczeń netto: **96,850**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-17 04:43:13

> **Aktualizacja:** 2026-02-17 04:43:13 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #248 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: sv | Plik: - | Heartbeat: 2026-02-17T04:43:09Z  
> **Okno godzinowe:** okno=1.0h | cykli=149 | pominięte=0.0% | odrzucone=51.8% | przepustowość=1896.7/h  
> **Tłumaczeń netto:** 96,850

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-17 04:43:13 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-17T04:43:09Z |
| MIGRATION | 🔒 NIEAKTYWNY | 58s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-17 04:43:13 |
| TRANSLATION | 🟢 AKTYWNY | 19s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-17T04:42:54.868170Z |
| QUALITY | 🔒 NIEAKTYWNY | 5s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-17T04:43:09.465528Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-17 04:43:13 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-17T04:43:09Z
...
| ❤️ **Heartbeat** | 2026-02-17T04:43:09Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **3,463** kluczy |
| ❌ Odrzucone (guard) | 3725 |
| 🔁 Cykli | 149 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | RU (768 kluczy) |
...
> **ETA globalne:** ~52 dni (2,352,299 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ██████████████░░░░░░ | 74.8% | 40,079/53,586 | ~6h |
| PL | █████████░░░░░░░░░░░ | 46.9% | 25,152/53,586 | ~14h |
...
> Świeżość: 58s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-17 04:43:13
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 19s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-17T04:42:54.868170Z
...
| PL (Polski) | 25,152/53,586 | 46.94% | 1,899 | 0 |
...
- Raporty strażnika jakości: **2994**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2927**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **10.58%** (294,813/2,786,472)
- **Kopie EN (łącznie):** **166,201**
...
| PL | 22,471/49,731 | 45.2% | 2,681/3,855 | 69.5% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-17T03:43:13.353158Z → 2026-02-17T04:43:13.353158Z) |
...
| Przepustowość (kluczy/h) | **1896.7 kluczy/h** |
| Podejrzane tłumaczenia | **14863** |
...
> Świeżość: 5s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-17T04:43:09.465528Z

- **Ostatni audyt:** SLOW_MODE | 13 issue(s) / 100 entries | 2026-02-17T04:43:09.465528Z
- **Top 5 typów problemów:** suspicious_rejected_critical=166, suspicious_log_high=127, suspicious_log_critical=65, suspicious_rejected_high=34, identical_to_en_exempt=11
- **Języki o najsłabszej jakości:** ro(59.9, issues=40449), es(60.1, issues=198424), pl(60.1, issues=126911), ru(60.1, issues=31366), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 60%, 126911 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 198424 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 72%, 11964 problemów
⚠️ **RU**: jakość 60%, 31366 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 77%, 10062 problemów
...
| Heartbeat | 5s temu | 2026-02-17T04:43:09Z |
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 46.9% | 0 | 1,899 | 896 | 4144 (82.2%) | 36 |
...
| Przepustowość (okno) | 1,453 kluczy / 64 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-17 04:43:13
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [pl] → ok (translated+34, skipped+0) — parallel lang=pl file=spells.json
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **19,444** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 187 |
| ❌ Błędów | 319 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (3,902), **IT** (3,593), **RU** (3,427), **RO** (3,121), **PL** (2,671) |
| 📊 Porównanie | ↓ 4.2% vs wczoraj (20,288) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **119,638** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-17 04:43:13  
