...
npcConfig.voices = {
	interval = 15000,
	chance = 50,
	{ i18nKey = "npc.mother_of_jack.voice_1" },
	{ i18nKey = "npc.mother_of_jack.voice_2" },
	{ i18nKey = "npc.mother_of_jack.voice_3" },
	{ i18nKey = "npc.mother_of_jack.voice_4" },
}
	...
	if MsgContains(message, "jack") then
		if player:getStorageValue(Storage.Quest.U8_7.JackFutureQuest.QuestLine) == 5 then
			if player:getStorageValue(Storage.Quest.U8_7.JackFutureQuest.Mother) < 1 then
				NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.mother_of_jack.say_1")
				npcHandler:setTopic(playerId, 1)
			end
		end
	elseif MsgContains(message, "no") then
		if npcHandler:getTopic(playerId) == 2 then
			NPC_LIB.i18n.npcSay(npcHandler, npc, creature, "npc.mother_of_jack.say_2")
...
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_GREET, "npc.mother_of_jack.greet_msg_1")
