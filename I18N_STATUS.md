...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.94% / real 10.86%**. Tempo: **1001.0 kluczy/h**. Tłumaczeń netto: **140,873**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 03:19:06

> **Aktualizacja:** 2026-04-29 03:19:06 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,604 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: server.json | Heartbeat: 2026-04-29T03:15:02Z
> **Okno godzinowe:** okno=1.0h | cykli=71 | pominięte=0.0% | odrzucone=2.8% | przepustowość=1001.0/h  
> **Tłumaczeń netto:** 140,873

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 03:19:06 |
| LIVE | 🟢 AKTYWNY | 4min temu | - | `activity.json / worker_state.json` | 2026-04-29T03:15:02Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 36s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 03:19:06 |
| TRANSLATION | 🟢 AKTYWNY | 2min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T03:17:01.022839Z |
| QUALITY | 🔒 NIEAKTYWNY | 4min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T03:14:43.520681Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 03:19:06 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T03:19:12.761405Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 4min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T03:15:02Z
...
| 🔄 **Ostatni cykl** | 102 kluczy, 1 odrzuconych, 120.0s, tryb: AUTO_TRANSLATE, cel: it/items.json |
| ❤️ **Heartbeat** | 2026-04-29T03:15:02Z |
...
| ⏳ Oldest pending (visible tail) | 17606 s |
| 🌍 Top języki | RU(398) |
...
| 🌍 Recent provider mix | TM/simple(258), Free Google Translate(242), canonical_name_semantic_autofix(17), canonical_name_case_autofi... |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=586/586 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 398, 'oldest_s': 17606}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Tempo obliczone na bazie ostatniej godziny: ~1001 kluczy/h.
...
> Świeżość: 36s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 03:19:06
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 2min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T03:17:01.022839Z
...
- rubbish → spazzatura (item.12608.name)
- rubbish → spazzatura (item.12609.name)
- tic-tac-toe board → tavola da tris (item.1261.name)
- rubbish → spazzatura (item.12610.name)
- rubbish → spazzatura (item.12611.name)
- rubbish → spazzatura (item.12612.name)
- rubbish → spazzatura (item.12613.name)
- rubbish → spazzatura (item.12614.name)
- rubbish → spazzatura (item.12615.name)
- rubbish → spazzatura (item.12616.name)
- tic-tac-toe board → tavola da tris (item.1262.name)
- small shed → piccolo capannone (item.12624.name)
- small shed → piccolo capannone (item.12625.name)
- small shed → piccolo capannone (item.12626.name)
- small shed → piccolo capannone (item.12627.name)
- small shed → piccolo capannone (item.12628.name)
- small shed → piccolo capannone (item.12629.name)
- tic-tac-toe board → tavola da tris (item.1263.name)
- small shed → piccolo capannone (item.12630.name)
- small shed → piccolo capannone (item.12631.name)
...
- **Pokrycie globalne (nominal):** **17.94%** (695,522/3,875,872)
- **Pokrycie globalne (real):** **10.86%** (421,038/3,875,872)
- **Kopie EN (łącznie):** **410,571**
- **Placeholdery [EN]/puste (łącznie):** **2,190,141**
...
| 🕒 Evidence window | 24h (span=32.45h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=32.45h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T02:19:07.339637Z → 2026-04-29T03:19:07.339637Z) |
...
| Przepustowość (kluczy/h) | **1001.0 kluczy/h** |
...
> Świeżość: 4min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T03:14:43.520681Z
...
| Heartbeat | 250s temu | 2026-04-29T03:15:02Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T03:17:16.285231Z
...
- 2026-04-29 03:18:47 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-29 03:17:16 | AUTO_TRANSLATE:heartbeat_tick | es | ok | server.json
- 2026-04-29 03:17:01 | AUTO_TRANSLATE:auto_done | it | ok | items.json
- 2026-04-29 03:16:32 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 03:19:06
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **2,886** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 60 |
| ❌ Błędów | 112 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **RU** (634), **CS** (569), **IT** (448), **DE** (360), **TR** (315) |
| 📊 Porównanie | ↓ 64.9% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **21,866** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 03:19:06  
