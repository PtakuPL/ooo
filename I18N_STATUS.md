...
> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-19 09:56:08

> **Aktualizacja:** 2026-02-19 09:56:08 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #1 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: parallel_start | Kategoria: sv | Plik: monsters.json | Heartbeat: 2026-02-19T09:56:11Z  
> **Okno godzinowe:** okno=1.0h | cykli=92 | pominięte=0.0% | odrzucone=0.0% | przepustowość=0.0/h  
> **Tłumaczeń netto:** 110,341

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-19 09:56:08 |
| LIVE | 🟢 AKTYWNY | 0s temu | - | `activity.json / worker_state.json` | 2026-02-19T09:56:11Z |
| MIGRATION | 🔒 NIEAKTYWNY | 1d temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-19 09:56:08 |
| TRANSLATION | 🟢 AKTYWNY | 6s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-19T09:56:04.588603Z |
| QUALITY | 🔒 NIEAKTYWNY | 29s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-19T09:55:41.602299Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-19 09:56:08 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 0s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-19T09:56:11Z
...
| ❤️ **Heartbeat** | 2026-02-19T09:56:11Z |
...
> Świeżość: 1d temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-19 09:56:08
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-19T09:56:04.588603Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-19T08:56:08.764679Z → 2026-02-19T09:56:08.764679Z) |
...
| Podejrzane tłumaczenia | **19** |
| Najgorsze cele (strażnik) | it/libs.json (gf=0), ru/chatchannels.json (gf=0), es/startup.json (gf=0), it/client.json (gf=0), ru/libs.json (gf=0) |
...
> Świeżość: 29s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-19T09:55:41.602299Z

- **Ostatni audyt:** SLOW_MODE | 31 issue(s) / 100 entries | 2026-02-19T09:55:41.602299Z
- **Top 5 typów problemów:** suspicious_log_high=178, suspicious_rejected_critical=171, suspicious_rejected_high=29, artifact_token=16, identical_to_en=15
- **Języki o najsłabszej jakości:** es(60.1, issues=259323), pl(60.1, issues=145557), ro(60.1, issues=83218), ru(60.1, issues=63838), sr(60.1, issues=30738)
...
⚠️ **PL**: jakość 60%, 145557 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 259323 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 30581 problemów
⚠️ **RU**: jakość 60%, 63838 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 60%, 23771 problemów
...
| Heartbeat | 0s temu | 2026-02-19T09:56:11Z |
...
- 2026-02-19 09:56:11 | AUTO_TRANSLATE:parallel_start | sv | ok | monsters.json
- 2026-02-19 09:56:06 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | otclient_modules.json
- 2026-02-19 09:56:06 | AUTO_TRANSLATE:parallel_start | ro | ok | otclient_modules.json
- 2026-02-19 09:56:04 | AUTO_TRANSLATE:auto_done | ru | ok | questlog.json
- 2026-02-19 09:56:01 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | questlog.json
- 2026-02-19 09:56:01 | AUTO_TRANSLATE:auto_start | ru | ok | questlog.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-19 09:56:08
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [it] → ok (translated+0, skipped+0) — parallel lang=it file=raids.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ro] → ok (translated+0, skipped+0) — parallel lang=ro file=raids.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → ok (files+0, translated+0, skipped+0) — lang=ru file=raids.json
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ro] → ok (translated+0, skipped+0) — parallel lang=ro file=scripts.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [ru] → ok (files+0, translated+0, skipped+0) — lang=ru file=scripts.json
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-19 09:56:08  
