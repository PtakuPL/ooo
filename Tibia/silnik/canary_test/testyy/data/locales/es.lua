...
locale = {
  ...
  translation = {
    ...
    ["%s has logged in."] = "%s ha iniciado sesiÃ³n.",
    ["%s has logged out."] = "%s ha cerrado sesiÃ³n.",
    ...
    ["Add new server"] = "AÃ±adir nuevo servidor",
    ...
    ["Audio"] = false,
    ["Authenticator Token"] = "Token de autenticaciÃ³n",
    ["Author"] = "Autor",
    ...
    ["Channel appended to %s"] = "Canal aÃ±adido a %s",
    ["Channels"] = "Canales",
    ...
    ["Connection failed, the server address does not exist."] = "ConexiÃ³n fallida, la direcciÃ³n del servidor no existe.",
    ["Connection failed."] = "ConexiÃ³n fallida.",
    ...
    ["Critical Hit Chance"] = "Probabilidad de golpe crÃ­tico",
    ["Critical Hit Damage"] = "DaÃ±o de golpe crÃ­tico",
    ...
    ["Display player mana bar"] = "Mostrar barra de manÃ¡",
    ...
    ["Enable dash walking"] = "Activar caminar rÃ¡pido",
    ["Enable lights"] = "Activar luces",
    ["Enable music sound"] = "Activar mÃºsica",
    ...
    ["Game"] = "Juego",
    ["Global ignore settings"] = "ConfiguraciÃ³n global de ignorados",
    ["Global whitelist settings"] = "ConfiguraciÃ³n global de lista blanca",
    ...
    ["No"] = "No",
    ["Notation"] = "Notación",
    ["Notify-Login"] = "Notificar inicio de sesiÃ³n",
    ...
    ["Report Rule Violation"] = "Reportar violaciÃ³n de reglas",
