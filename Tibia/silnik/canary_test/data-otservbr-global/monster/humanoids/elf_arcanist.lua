...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "I'll bring balance upon you!", yell = false , i18nKey = "monster.elf_arcanist.voice_1"},
	{ text = "Vihil Ealuel!", yell = false , i18nKey = "monster.elf_arcanist.voice_2"},
	{ text = "For the Daughter of the Stars!", yell = false , i18nKey = "monster.elf_arcanist.voice_3"},
	{ text = "Tha'shi Cenath!", yell = false , i18nKey = "monster.elf_arcanist.voice_4"},
	{ text = "Feel my wrath!", yell = false , i18nKey = "monster.elf_arcanist.voice_5"},
}
