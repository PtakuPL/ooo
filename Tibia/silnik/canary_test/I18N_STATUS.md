...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 16.61% / real 9.38%**. Tempo: **1758.0 kluczy/h**. Tłumaczeń netto: **90,913**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-29 16:35:25

> **Aktualizacja:** 2026-03-29 16:35:25 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #12,454 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: it | Plik: items.json | Heartbeat: 2026-03-29T16:34:32Z  
> **Okno godzinowe:** okno=1.0h | cykli=64 | pominięte=0.0% | odrzucone=39.6% | przepustowość=1758.0/h  
> **Tłumaczeń netto:** 90,913

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-29 16:35:25 |
| LIVE | 🟢 AKTYWNY | 55s temu | - | `activity.json / worker_state.json` | 2026-03-29T16:34:32Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 14s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-29 16:35:25 |
| TRANSLATION | 🟢 AKTYWNY | 14min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-29T16:21:26.913050Z |
| QUALITY | 🔒 NIEAKTYWNY | 13min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-29T16:21:50.103853Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-29 16:35:25 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 55s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-29T16:34:32Z
...
| ❤️ **Heartbeat** | 2026-03-29T16:34:32Z |
...
| ❌ Odrzucone (guard) | 1152 |
| 🔁 Cykli | 64 |
| 🌍 Języków | 11 |
| 🏆 Najaktywniejszy | RO (541 kluczy) |
...
> **ETA globalne:** ~72 dni (3,038,263 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 76.3% | 56,909/74,536 | ~8h |
| PL | ██████████████░░░░░░ | 70.5% | 52,562/74,536 | ~10h |
| IT | ████████████░░░░░░░░ | 61.1% | 45,510/74,536 | ~14h |
| RO | ███████████░░░░░░░░░ | 57.3% | 42,699/74,536 | ~16h |
| RU | ████████░░░░░░░░░░░░ | 41.7% | 31,097/74,536 | ~23h |
| FR | ██████████░░░░░░░░░░ | 51.9% | 38,714/74,536 | ~18h |
| SR | ██████░░░░░░░░░░░░░░ | 33.3% | 24,827/74,536 | ~26h |
| PT | ██████████████░░░░░░ | 72.7% | 54,190/74,536 | ~9h |
| CS | ████████░░░░░░░░░░░░ | 42.1% | 31,361/74,536 | ~22h |
| NL | ██████████████░░░░░░ | 70.5% | 52,518/74,536 | ~10h |
| TR | ████░░░░░░░░░░░░░░░░ | 21.3% | 15,854/74,536 | ~31h |
...
> Świeżość: 14s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-29 16:35:25
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 14min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-29T16:21:26.913050Z
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 280 | 0 | 0 | - | 2026-03-29T16:22:12.106971Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **16.61%** (643,805/3,875,872)
- **Pokrycie globalne (real):** **9.38%** (363,615/3,875,872)
- **Kopie EN (łącznie):** **432,789**
- **Placeholdery [EN]/puste (łącznie):** **2,225,329**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-29T15:35:25.460359Z → 2026-03-29T16:35:25.460359Z) |
...
| Najgorsze cele (strażnik) | ro/npc.json (gf=165), pl/npc.json (gf=155), it/npc.json (gf=147), tr/npc.json (gf=141), fr/npc.json (gf=107) |
...
|--------|-----------|--------|----------------|
| `gt_validate_fail_placeholder` | 327 | 60.4% | ro/npc.json (81) |
| `gt_rejected_critical` | 184 | 34.0% | fr/npc.json (50) |
| `gt_validate_fail_quality` | 23 | 4.3% | tr/npc.json (16) |
| `gt_validate_fail_word_salad` | 6 | 1.1% | es/server.json (5) |
| `gt_rejected_high_trimmed_en_copy` | 1 | 0.2% | ro/items.json (1) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 13min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-29T16:21:50.103853Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-03-29T16:21:50.103853Z
- **Top 5 typów problemów:** suspicious_rejected_critical=198, suspicious_log_high=177, suspicious_log_low=17, suspicious_log_critical=6, suspicious_rejected_high=2
- **Języki o najsłabszej jakości:** cs(60.0, issues=35431), pl(60.1, issues=350662), pt(60.1, issues=28715), fr(60.6, issues=35456), nl(60.6, issues=23264)
...
⚠️ **TR**: jakość 64%, 16617 problemów
...
⚠️ **RU**: jakość 82%, 306697 problemów
⚠️ **NL**: jakość 61%, 23264 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #12,454 |
| Heartbeat | 55s temu | 2026-03-29T16:34:32Z |
...
- **Ostatnia aktualizacja:** 2026-03-29T16:33:01.868117Z
...
- 2026-03-29 16:34:32 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-03-29 16:32:46 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-03-29 16:31:15 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-03-29 16:29:45 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-03-29 16:28:14 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-03-29 16:26:44 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **90,913** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=44.32%, reason=decrease_high_fail_rate=44.3%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-29 16:35:25
...
| 🔄 Cykli wykonanych | **#12,454** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #12,454 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-29 16:35:25  
