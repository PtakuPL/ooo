...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "Eeeeek! Eeeeek!", yell = false , i18nKey = "monster.sibang.voice_1"},
	{ text = "Huh! Huh! Huh!", yell = false , i18nKey = "monster.sibang.voice_2"},
	{ text = "Ahhuuaaa!", yell = false , i18nKey = "monster.sibang.voice_3"},
}
