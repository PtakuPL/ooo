...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **18.91%**. Tempo: **625.6 kluczy/h**. Tłumaczeń netto: **57,882**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-23 13:21:06

> **Aktualizacja:** 2026-03-23 13:21:06 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **LIVE:** Cykl #10,513 | Status: 🟢 DZIAŁA | Faza: STARTUP | Etap: runtime_preflight_failed | Kategoria: - | Plik: - | Heartbeat: 2026-03-23T13:20:25Z  
> **Okno godzinowe:** okno=1.0h | cykli=240 | pominięte=0.0% | odrzucone=7.6% | przepustowość=625.6/h  
> **Tłumaczeń netto:** 57,882

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-23 13:21:06 |
| LIVE | 🔒 NIEAKTYWNY | 43s temu | worker w trybie STARTUP | `activity.json / worker_state.json` | 2026-03-23T13:20:25Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 11s temu | worker w trybie STARTUP | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-23 13:21:06 |
| TRANSLATION | 🔒 NIEAKTYWNY | 5min temu | worker w trybie STARTUP | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-23T13:15:20.235504Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie STARTUP | `quality_audit_latest.json` | 2026-03-23T13:19:12.694311Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-23 13:21:06 |
...
> Świeżość: 43s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-23T13:20:25Z
...
| ❤️ **Heartbeat** | 2026-03-23T13:20:25Z |
...
> **ETA globalne:** ~196 dni (2,949,305 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ██████████████████░░ | 94.0% | 70,074/74,536 | ~1h |
| PL | ███████████████░░░░░ | 77.3% | 57,654/74,536 | ~21h |
| RO | ██████████████░░░░░░ | 74.5% | 55,567/74,536 | ~24h |
| RU | ██████████████░░░░░░ | 73.4% | 54,698/74,536 | ~26h |
| IT | ██████████████░░░░░░ | 73.0% | 54,445/74,536 | ~26h |
| FR | ██████████████░░░░░░ | 71.7% | 53,408/74,536 | ~28h |
| PT | ██████████████░░░░░░ | 70.2% | 52,293/74,536 | ~30h |
| CS | █████████████░░░░░░░ | 68.4% | 50,993/74,536 | ~32h |
| NL | █████████████░░░░░░░ | 68.1% | 50,742/74,536 | ~32h |
| DE | █████████████░░░░░░░ | 66.4% | 49,499/74,536 | ~34h |
...
> Świeżość: 11s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-23 13:21:06
...
> Świeżość: 5min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-23T13:15:20.235504Z
...
- **Profiler cyklu (ostatni):** cykl #30 (IDLE): dispatch 657ms, mode 6ms, status 49ms, total 2334ms
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-23T12:21:06.751808Z → 2026-03-23T13:21:06.751808Z) |
| Cykle | **240** (TŁUMACZENIE=128, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **7.6%** |
| Cykle bez postępu % | **8.6%** |
| Przepustowość (kluczy/h) | **625.6 kluczy/h** |
| Podejrzane tłumaczenia | **1923** |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-23T13:19:12.694311Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-03-23T13:19:12.694311Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=626819), ro(60.1, issues=341034), ru(60.1, issues=297203), it(60.6, issues=114557), fr(61.0, issues=19717)
...
⚠️ **TR**: jakość 89%, 7712 problemów
⚠️ **PL**: jakość 90%, 329116 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 626819 problemów
⚠️ **PT**: jakość 90%, 22102 problemów
⚠️ **FR**: jakość 61%, 19717 problemów
⚠️ **IT**: jakość 61%, 114557 problemów
⚠️ **RU**: jakość 60%, 297203 problemów
⚠️ **NL**: jakość 83%, 14453 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #10,513 |
| Heartbeat | 43s temu | 2026-03-23T13:20:25Z |
...
- **Ostatnia aktualizacja:** 2026-03-23T13:15:38.157927Z
...
- 2026-03-23 13:14:45 | AUTO_TRANSLATE:auto_done | tr | ok | quests.json
- 2026-03-23 13:14:39 | AUTO_TRANSLATE:heartbeat_tick | tr | ok | quests.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **57,882** | — | 📊 |
| Adaptacyjna paczka | batch=10, gf_rate=4.33%, reason=increase_low_fail_rate=4.3% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-23 13:21:06
...
| 🔄 Cykli wykonanych | **#10,513** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #10,513 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-23 13:21:06  
