...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "Feel the power of death unleashed!", yell = false , i18nKey = "monster.cerebellum.voice_1"},
	{ text = "I will rule again and my realm of death will span the world!", yell = false , i18nKey = "monster.cerebellum.voice_2"},
	{ text = "My lich-knights will conquer this world for me!", yell = false , i18nKey = "monster.cerebellum.voice_3"},
}
