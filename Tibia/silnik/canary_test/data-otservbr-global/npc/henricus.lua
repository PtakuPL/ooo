...
keywordHandler:addKeyword({ "paladin" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.henricus.stdmod_1" })
keywordHandler:addKeyword({ "knight" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.henricus.stdmod_2" })
keywordHandler:addKeyword({ "sorcerer" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.henricus.stdmod_3" })
keywordHandler:addKeyword({ "druid" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.henricus.stdmod_4" })
keywordHandler:addKeyword({ "dwarf" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.henricus.stdmod_5" })
keywordHandler:addKeyword({ "kazordoon" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.henricus.stdmod_6" })
keywordHandler:addKeyword({ "elves" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.henricus.stdmod_7" })
keywordHandler:addKeyword({ "ab'dendriel" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.henricus.stdmod_8" })
keywordHandler:addKeyword({ "venore" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.henricus.stdmod_9" })
keywordHandler:addKeyword({ "drefia" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.henricus.stdmod_10" })
keywordHandler:addKeyword({ "darashia" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.henricus.stdmod_11" })
keywordHandler:addKeyword({ "demon" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.henricus.stdmod_12" })
keywordHandler:addKeyword({ "carlin" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.henricus.stdmod_13" })
keywordHandler:addKeyword({ "zathroth" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.henricus.stdmod_14" })
keywordHandler:addKeyword({ "crunor" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.henricus.stdmod_15" })
keywordHandler:addKeyword({ "gods" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.henricus.stdmod_16" })
keywordHandler:addKeyword({ "church" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.henricus.stdmod_17" })
keywordHandler:addKeyword({ "inquisitor" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.henricus.stdmod_18" })
keywordHandler:addKeyword({ "believer" }, StdModule.say, { npcHandler = npcHandler, i18nKey = "npc.henricus.stdmod_19" })
