...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.92% / real 10.83%**. Tempo: **859.0 kluczy/h**. Tłumaczeń netto: **139,147**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 01:12:15

> **Aktualizacja:** 2026-04-29 01:12:15 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,444 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: ru | Plik: items.json | Heartbeat: 2026-04-29T01:11:44Z
> **Okno godzinowe:** okno=1.0h | cykli=72 | pominięte=0.0% | odrzucone=2.9% | przepustowość=859.0/h  
> **Tłumaczeń netto:** 139,147

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 01:12:15 |
| LIVE | 🟢 AKTYWNY | 38s temu | - | `activity.json / worker_state.json` | 2026-04-29T01:11:44Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 01:12:15 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T01:11:12.244845Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T01:11:13.225250Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 01:12:15 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T01:12:22.615372Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 38s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T01:11:44Z
...
| 🔄 **Ostatni cykl** | 30 kluczy, 0 odrzuconych, 38.0s, tryb: AUTO_TRANSLATE, cel: tr/items.json |
| ❤️ **Heartbeat** | 2026-04-29T01:11:44Z |
...
| ⏳ Oldest pending (visible tail) | 18015 s |
...
| 🌍 Recent provider mix | TM/simple(286), Free Google Translate(209), canonical_name_semantic_autofix(16), term_consistency_autofix(3) |
| 🔁 Latest fallback | TM/simple → fallback to google translate high [high_reject_types] items.json |
| 📉 Fallback breakdown | fallback to google translate high(26) |
...
| ❤️ Pool health | `critical` (writes=514, fallbacks=26) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=492/492 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 396, 'oldest_s': 18015}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Tempo obliczone na bazie ostatniej godziny: ~859 kluczy/h.
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 01:12:15
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T01:11:12.244845Z
...
- tiled roof → kiremitli çatı (item.1163.name)
- tiled roof → kiremitli çatı (item.1164.name)
- tiled roof → kiremitli çatı (item.1165.name)
- tiled roof → kiremitli çatı (item.1166.name)
- tiled roof → kiremitli çatı (item.1167.name)
- tiled roof → kiremitli çatı (item.1168.name)
- tiled roof → kiremitli çatı (item.1169.name)
- statue → heykel (item.11696.name)
- statue → heykel (item.11697.name)
- tiled roof → kiremitli çatı (item.1170.name)
- tiled roof → kiremitli çatı (item.1171.name)
- lush grass → yemyeşil çimen (item.11711.name)
- lush grass → yemyeşil çimen (item.11712.name)
- lush grass → yemyeşil çimen (item.11713.name)
- lush grass → yemyeşil çimen (item.11717.name)
- lush grass → yemyeşil çimen (item.11718.name)
- lush grass → yemyeşil çimen (item.11719.name)
- tiled roof → kiremitli çatı (item.1172.name)
- lush grass → yemyeşil çimen (item.11720.name)
- lush grass → yemyeşil çimen (item.11721.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4707**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4560**
...
- **Pokrycie globalne (nominal):** **17.92%** (694,453/3,875,872)
- **Pokrycie globalne (real):** **10.83%** (419,928/3,875,872)
- **Kopie EN (łącznie):** **410,612**
- **Placeholdery [EN]/puste (łącznie):** **2,191,210**
...
| 🕒 Evidence window | 24h (span=30.33h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=30.33h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T00:12:16.322634Z → 2026-04-29T01:12:16.322634Z) |
...
| Przepustowość (kluczy/h) | **859.0 kluczy/h** |
| Podejrzane tłumaczenia | **910** |
| Najgorsze cele (strażnik) | cs/items.json (gf=10), ro/items.json (gf=8), ru/items.json (gf=2), it/items.json (gf=2), de/otclient_modules.json (gf=2) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T01:11:13.225250Z
...
| Heartbeat | 38s temu | 2026-04-29T01:11:44Z |
...
- 2026-04-29 01:10:34 | AUTO_TRANSLATE:auto_start | tr | ok | items.json
- 2026-04-29 01:08:10 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 01:12:15
...
| ❌ Błędów | 38 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (315), **TR** (140), **DE** (135), **IT** (127), **RO** (117) |
| 📊 Porównanie | ↓ 87.5% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **20,012** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 01:12:15  
