...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.2%**. Tempo: **1776.1 kluczy/h**. Tłumaczeń netto: **74,459**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-14 18:45:10

> **Aktualizacja:** 2026-02-14 18:45:10 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #41 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-02-14T18:45:10Z  
> **Okno godzinowe:** okno=1.0h | cykli=209 | pominięte=0.0% | odrzucone=62.4% | przepustowość=1776.1/h  
> **Tłumaczeń netto:** 74,459

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-14 18:45:10 |
| LIVE | 🟢 AKTYWNY | 1s temu | - | `activity.json / worker_state.json` | 2026-02-14T18:45:10Z |
| MIGRATION | 🔒 NIEAKTYWNY | 30s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-14 18:45:10 |
| TRANSLATION | 🟢 AKTYWNY | 9s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-14T18:45:01.907216Z |
| QUALITY | 🔒 NIEAKTYWNY | 45s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-14T18:44:26.143216Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-14 18:45:10 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-14T18:45:10Z
...
| ❤️ **Heartbeat** | 2026-02-14T18:45:10Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **3,234** kluczy |
| ❌ Odrzucone (guard) | 5363 |
| 🔁 Cykli | 209 |
| 🌍 Języków | 2 |
| 🏆 Najaktywniejszy | PL (1,624 kluczy) |
...
|-------|---------------|-----------|-----|-------|
| PL | 1,624 | 5121 | 75.9% | 13 |
| ES | 1,610 | 242 | 13.1% | 15 |
...
> **ETA globalne:** ~55 dni (2,363,018 kluczy do celu 95%)
...
> Świeżość: 30s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-14 18:45:10
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 9s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-14T18:45:01.907216Z
...
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2304**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-14T17:45:11.085591Z → 2026-02-14T18:45:11.085591Z) |
...
| Przepustowość (kluczy/h) | **1776.1 kluczy/h** |
| Podejrzane tłumaczenia | **5887** |
| Najgorsze cele (strażnik) | pl/items.json (gf=2121), pl/npc.json (gf=2040), pl/scripts.json (gf=457), pl/quests.json (gf=266), pl/monsters.json (gf=154) |
...
> Świeżość: 45s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-14T18:44:26.143216Z

- **Ostatni audyt:** SLOW_MODE | 42 issue(s) / 100 entries | 2026-02-14T18:44:26.143216Z
- **Top 5 typów problemów:** suspicious_log_high=168, suspicious_log_critical=31, identical_to_en_exempt=30, identical_to_en=27, artifact_token=15
- **Języki o najsłabszej jakości:** es(60.1, issues=185467), pl(60.4, issues=127636), tl(64.2, issues=466), zh_TW(64.8, issues=337), fr(66.5, issues=2470)
...
⚠️ **PL**: jakość 60%, 127636 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 185467 problemów
...
| Heartbeat | 1s temu | 2026-02-14T18:45:10Z |
...
- 2026-02-14 18:45:10 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-14 18:44:58 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | monsters.json
- 2026-02-14 18:44:58 | AUTO_TRANSLATE:parallel_start | pl | ok | monsters.json
- 2026-02-14 18:44:57 | AUTO_TRANSLATE:auto_done | es | ok | npc.json
- 2026-02-14 18:44:38 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-14 18:44:37 | AUTO_TRANSLATE:auto_start | es | ok | npc.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 47.2% | 0 | 2,064 | 3,542 | 8759 (71.2%) | 101 |
| 🟡 ES | 75.9% | 0 | 2,760 | 3,168 | 774 (19.6%) | 99 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **74,459** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=84.27%, reason=decrease_high_fail_rate=84.3% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 6,710 kluczy / 200 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-14 18:45:10
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **45,831** kluczy |
| ⏭️ Pominięte | 1 |
| 🔁 Cykli | 49 |
| ❌ Błędów | 635 |
| 🌍 Aktywnych języków | 52 |
| 🏆 TOP 5 | **ES** (15,302), **PL** (7,366), **IT** (971), **PT** (960), **DE** (890) |
| 📊 Porównanie | ↓ 0.5% vs wczoraj (46,073) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **93,253** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-14 18:45:10  
