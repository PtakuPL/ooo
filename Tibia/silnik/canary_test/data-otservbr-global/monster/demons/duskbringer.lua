...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "Death!", yell = false , i18nKey = "monster.duskbringer.voice_1"},
	{ text = "Come a little closer!", yell = false , i18nKey = "monster.duskbringer.voice_2"},
	{ text = "The end is near!", yell = false , i18nKey = "monster.duskbringer.voice_3"},
}
