...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.97% / real 8.87%**. Tempo: **936.1 kluczy/h**. Tłumaczeń netto: **71,449**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-29 04:31:29

> **Aktualizacja:** 2026-03-29 04:31:29 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #11,122 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: cs | Plik: monsters.json | Heartbeat: 2026-03-29T04:30:11Z  
> **Okno godzinowe:** okno=1.0h | cykli=17 | pominięte=0.0% | odrzucone=15.1% | przepustowość=936.1/h  
> **Tłumaczeń netto:** 71,449

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-29 04:31:29 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-03-29T04:30:11Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 25s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-29 04:31:29 |
| TRANSLATION | 🟢 AKTYWNY | 15min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-29T04:16:09.708857Z |
| QUALITY | 🔒 NIEAKTYWNY | 15min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-03-29T04:16:10.464885Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-29 04:31:29 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-29T04:30:11Z
...
| ❤️ **Heartbeat** | 2026-03-29T04:30:11Z |
...
> Tempo obliczone na bazie ostatniej godziny: ~936 kluczy/h.
...
> Świeżość: 25s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-29 04:31:29
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 15min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-29T04:16:09.708857Z
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-29T03:31:29.828275Z → 2026-03-29T04:31:29.828275Z) |
...
| Przepustowość (kluczy/h) | **936.1 kluczy/h** |
...
|--------|-----------|--------|----------------|
| `gt_rejected_critical` | 252 | 58.3% | cs/monsters.json (80) |
| `gt_validate_fail_word_salad` | 81 | 18.8% | nl/monsters.json (22) |
| `gt_rejected_high_partial_translation_mix` | 42 | 9.7% | fr/monsters.json (15) |
| `gt_rejected_high_trimmed_en_copy` | 32 | 7.4% | cs/monsters.json (30) |
| `gt_validate_fail_placeholder` | 22 | 5.1% | es/npc.json (22) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 15min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-29T04:16:10.464885Z
...
| Heartbeat | 80s temu | 2026-03-29T04:30:11Z |
...
- 2026-03-29 04:30:11 | AUTO_TRANSLATE:heartbeat_tick | cs | ok | monsters.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-29 04:31:29
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-29 04:31:29  
