...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.6%**. Tempo: **1963.6 kluczy/h**. Tłumaczeń netto: **97,527**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-17 04:59:56

> **Aktualizacja:** 2026-02-17 04:59:56 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #259 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: ro | Plik: - | Heartbeat: 2026-02-17T04:59:53Z  
> **Okno godzinowe:** okno=1.0h | cykli=153 | pominięte=0.0% | odrzucone=45.2% | przepustowość=1963.6/h  
> **Tłumaczeń netto:** 97,527

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-17 04:59:56 |
| LIVE | 🟢 AKTYWNY | 5s temu | - | `activity.json / worker_state.json` | 2026-02-17T04:59:53Z |
| MIGRATION | 🔒 NIEAKTYWNY | 10s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-17 04:59:56 |
| TRANSLATION | 🟢 AKTYWNY | 6s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-17T04:59:52.135857Z |
| QUALITY | 🔒 NIEAKTYWNY | 5s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-17T04:59:52.985557Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-17 04:59:56 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 5s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-17T04:59:53Z
...
| ❤️ **Heartbeat** | 2026-02-17T04:59:53Z |
...
> Świeżość: 10s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-17 04:59:56
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 6s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-17T04:59:52.135857Z
...
- a sphere of wrath → сфера гнева (monster.sphere_of_wrath.desc)
- Dread Minion → Дреад Минион (monster.dread_minion.name)
- a dread minion → ужасан слуга (monster.dread_minion.desc)
- Stolen Soul → Украдена душа (monster.stolen_soul.name)
- a stolen soul → украдена душа (monster.stolen_soul.desc)
- Soul Reaper → Соул Реапер (monster.soul_reaper.name)
- a soul reaper → жетелац душа (monster.soul_reaper.desc)
- Voidshard → Воидсхард (monster.voidshard.name)
- a voidshard → а воидсхард (monster.voidshard.desc)
- Freed Soul → Фреед Соул (monster.freed_soul.name)
- a Freed Soul → ослобођена душа (monster.freed_soul.desc)
- Free at last! Free to take revenge on our captor!  → Коначно слободан! Слободни да се осветимо нашем отмичару!  (monster.freed_soul.voice_1)
-  We will make the despoiler of souls suffer! → Учинићемо да страда разбојник душа! (monster.freed_soul.voice_2)
- We will have our revenge on the despoiler! → Ми ћемо се осветити разарачу! (monster.freed_soul.voice_3)
- Now the despoiler will pay! → Сада ће разбојник платити! (monster.freed_soul.voice_4)
- Sand Brood → Санд Броод (monster.sand_brood.name)
- a sand brood → пешчано легло (monster.sand_brood.desc)
- Dark Soul → Дарк Соул (monster.dark_soul.name)
- a dark soul → мрачна душа (monster.dark_soul.desc)
- The Sinister Hermit → Злокобни пустињак (monster.the_sinister_hermit_clean.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **3023**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2956**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **10.6%** (295,340/2,786,472)
- **Kopie EN (łącznie):** **166,177**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-17T03:59:56.785766Z → 2026-02-17T04:59:56.785766Z) |
...
| Przepustowość (kluczy/h) | **1963.6 kluczy/h** |
| Podejrzane tłumaczenia | **9828** |
| Najgorsze cele (strażnik) | pl/items.json (gf=1039), pl/npc.json (gf=409), pl/scripts.json (gf=152), es/scripts.json (gf=95), ro/spells.json (gf=78) |
...
> Świeżość: 5s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-17T04:59:52.985557Z

- **Ostatni audyt:** SLOW_MODE | 28 issue(s) / 100 entries | 2026-02-17T04:59:52.985557Z
- **Top 5 typów problemów:** suspicious_rejected_critical=166, suspicious_log_high=126, suspicious_log_low=53, suspicious_rejected_high=34, identical_to_en=23
- **Języki o najsłabszej jakości:** es(60.1, issues=200604), ro(60.1, issues=41601), ru(60.1, issues=32323), it(60.2, issues=12343), tl(64.2, issues=466)
...
⚠️ **PL**: jakość 69%, 127467 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 200604 problemów
⚠️ **PT**: jakość 74%, 1991 problemów
⚠️ **FR**: jakość 65%, 2470 problemów
⚠️ **IT**: jakość 60%, 12343 problemów
⚠️ **RU**: jakość 60%, 32323 problemów
⚠️ **NL**: jakość 74%, 649 problemów
⚠️ **SV**: jakość 81%, 10192 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #259 |
| Heartbeat | 5s temu | 2026-02-17T04:59:53Z |
...
- 2026-02-17 04:59:46 | AUTO_TRANSLATE:parallel_start | sv | ok | monsters.json
- 2026-02-17 04:59:44 | AUTO_TRANSLATE:auto_done | ro | ok | otclient_modules.json
- 2026-02-17 04:59:21 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | otclient_modules.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **97,527** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=26.39%, reason=decrease_high_fail_rate=26.4% | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-17 04:59:56
...
- 🌍 TRANSLATION_SYNC: SYNC_FILE_DONE [ka] → ok (keys+1541, files+1) — lang=ka file=npc.json
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **20,588** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 198 |
| ❌ Błędów | 340 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (4,141), **IT** (3,752), **RU** (3,611), **RO** (3,349), **PL** (2,843) |
| 📊 Porównanie | ↑ 1.5% vs wczoraj (20,288) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **120,782** kluczy
...
| 🔄 Cykli wykonanych | **#259** | continuous mode |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-17 04:59:56  
