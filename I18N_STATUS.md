...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **9.98%**. Tempo: **3525.6 kluczy/h**. Tłumaczeń netto: **73,230**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-16 21:11:38

> **Aktualizacja:** 2026-02-16 21:11:38 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #45 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: sr | Plik: items.json | Heartbeat: 2026-02-16T21:10:56Z  
> **Okno godzinowe:** okno=1.0h | cykli=177 | pominięte=0.0% | odrzucone=21.3% | przepustowość=3525.6/h  
> **Tłumaczeń netto:** 73,230

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-16 21:11:38 |
| LIVE | 🟢 AKTYWNY | 42s temu | - | `activity.json / worker_state.json` | 2026-02-16T21:10:56Z |
| MIGRATION | 🔒 NIEAKTYWNY | 59min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-16 21:11:38 |
| TRANSLATION | 🟢 AKTYWNY | 56s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-16T21:10:42.478739Z |
| QUALITY | 🔒 NIEAKTYWNY | 55s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-16T21:10:42.940893Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-16 21:11:38 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 42s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-16T21:10:56Z
...
| ❤️ **Heartbeat** | 2026-02-16T21:10:56Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **6,174** kluczy |
| ❌ Odrzucone (guard) | 1669 |
| 🔁 Cykli | 177 |
| 🌍 Języków | 7 |
| 🏆 Najaktywniejszy | IT (988 kluczy) |
| 📄 Najczęstszy plik | npc.json |
| ⚡ Przepustowość | ~3526 kluczy/h |
| 🛡️ Guard fail rate | 21.3% |
| ⚠️ Podejrzane | 25632 |
...
> **ETA globalne:** ~28 dni (2,369,033 kluczy do celu 95%)
...
> Świeżość: 59min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-16 21:11:38
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 56s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-16T21:10:42.478739Z
...
- It is locked. → È chiuso a chiave. (item.20452.desc)
- closed door → porta chiusa (item.20452.name)
- closed door → porta chiusa (item.20453.name)
- open door → porta aperta (item.20454.name)
- closed door → porta chiusa (item.20455.name)
- open door → porta aperta (item.20456.name)
- closed door → porta chiusa (item.20459.name)
- open door → porta aperta (item.20460.name)
- stairs → scale (item.20491.name)
- stairs → scale (item.20492.name)
- stairs → scale (item.20493.name)
- stairs → scale (item.20494.name)
- stairs → scale (item.20495.name)
- stairs → scale (item.20496.name)
- stairs → scale (item.20750.name)
- stairs → scale (item.20751.name)
- stairs → scale (item.20752.name)
- stairs → scale (item.20753.name)
- stairs → scale (item.20754.name)
- stairs → scale (item.20755.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **2217**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2155**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **9.98%** (278,079/2,786,472)
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-16T20:11:38.308177Z → 2026-02-16T21:11:38.308177Z) |
...
| Przepustowość (kluczy/h) | **3525.6 kluczy/h** |
| Podejrzane tłumaczenia | **25632** |
...
> Świeżość: 55s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-16T21:10:42.940893Z

- **Ostatni audyt:** OK | 7 issue(s) / 100 entries | 2026-02-16T21:10:42.940893Z
- **Top 5 typów problemów:** suspicious_log_high=198, suspicious_rejected_critical=74, suspicious_rejected_high=42, identical_to_en_exempt=12, artifact_token=7
- **Języki o najsłabszej jakości:** ru(60.5, issues=6610), ro(61.3, issues=2267), tl(64.2, issues=466), zh_TW(64.8, issues=337), sv(65.0, issues=1390)
...
| Heartbeat | 42s temu | 2026-02-16T21:10:56Z |
...
- 2026-02-16 21:10:56 | AUTO_TRANSLATE:heartbeat_tick | sr | ok | items.json
- 2026-02-16 21:10:55 | AUTO_TRANSLATE:auto_start | sr | ok | items.json
- 2026-02-16 21:10:40 | AUTO_TRANSLATE:heartbeat_tick | it | ok | items.json
- 2026-02-16 21:10:39 | AUTO_TRANSLATE:parallel_start | it | ok | items.json
- 2026-02-16 21:10:33 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-02-16 21:10:33 | AUTO_TRANSLATE:parallel_start | ro | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-16 21:11:38
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **6,702** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 44 |
| ❌ Błędów | 57 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **ES** (1,214), **IT** (988), **RU** (957), **SR** (939), **SV** (939) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **86,608** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-16 21:11:38  
