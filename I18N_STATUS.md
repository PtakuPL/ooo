...
> Worker tłumaczy **53** języków. Klucze EN: **53,586**. Pokrycie globalne: **10.16%**. Tempo: **1482.3 kluczy/h**. Tłumaczeń netto: **71,492**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-14 17:16:02

> **Aktualizacja:** 2026-02-14 17:16:02 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 53586  
> **LIVE:** Cykl #10 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: cycle_end | Kategoria: pl | Plik: - | Heartbeat: 2026-02-14T17:15:56Z  
> **Okno godzinowe:** okno=1.0h | cykli=139 | pominięte=0.0% | odrzucone=60.1% | przepustowość=1482.3/h  
> **Tłumaczeń netto:** 71,492

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-14 17:16:02 |
| LIVE | 🟢 AKTYWNY | 7s temu | - | `activity.json / worker_state.json` | 2026-02-14T17:15:56Z |
| MIGRATION | 🔒 NIEAKTYWNY | 18s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-14 17:16:02 |
| TRANSLATION | 🟢 AKTYWNY | 23s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-14T17:15:39.342659Z |
| QUALITY | 🔒 NIEAKTYWNY | 7s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-14T17:15:55.881439Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-14 17:16:02 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 7s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-14T17:15:56Z
...
| ❤️ **Heartbeat** | 2026-02-14T17:15:56Z |
...
| Metryka | Wartość |
|---------|---------|
| 📊 Przetłumaczono | **2,443** kluczy |
| ❌ Odrzucone (guard) | 3678 |
| 🔁 Cykli | 139 |
| 🌍 Języków | 2 |
| 🏆 Najaktywniejszy | PL (1,404 kluczy) |
| 📄 Najczęstszy plik | monsters.json |
| ⚡ Przepustowość | ~1482 kluczy/h |
...
|-------|---------------|-----------|-----|-------|
| PL | 1,404 | 3246 | 69.8% | 17 |
| ES | 1,039 | 432 | 29.4% | 16 |
...
|-------|---------------|-----------|----------|----------|
| ES | 40,299 | 53,586 | 75.2% | 2,757 |
| PL | 24,703 | 53,586 | 46.1% | 2,062 |
| RU | 18,071 | 53,586 | 33.72% | 2,843 |
...
> **ETA globalne:** ~66 dni (2,364,005 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 75.2% | 40,299/53,586 | ~7h |
| PL | █████████░░░░░░░░░░░ | 46.1% | 24,703/53,586 | ~18h |
| RU | ██████░░░░░░░░░░░░░░ | 33.7% | 18,071/53,586 | ~22h |
| FR | ██████░░░░░░░░░░░░░░ | 33.3% | 17,847/53,586 | ~22h |
...
> Tempo obliczone na bazie ostatniej godziny: ~1482 kluczy/h.
...
> Świeżość: 18s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-14 17:16:02

### 📁 Pliki Projektu (pełny skan)
| Metryka | Wartość | Procent | Info |
|---------|---------|---------|------|
| 📂 **Wszystkie pliki** | **20,333** | 100% | cały projekt |
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 23s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-14T17:15:39.342659Z
...
|-------|----------------|-------------------------------|---------|--------------|
| ES (Hiszpański) | 40,299/53,586 | 75.20% | 2,757 | 0 |
| PL (Polski) | 24,703/53,586 | 46.10% | 2,062 | 0 |
| RU (Rosyjski) | 18,071/53,586 | 33.72% | 2,843 | 0 |
...
- I see. → I see. (npc.ariella.say_15)
- <mumbles> → <mumbles> (npc.arkulius.stdmod_3)
- <mumbles> → <mumbles> (npc.arkulius.voice_3)
- I see. → I see. (npc.avar_tar.say_5)
...
- <nods> → <nods> (npc.elliott.greet_msg_1)
- No problem. → Ningún problema. (npc.ferus.stdmod_6)
- See you, |PLAYERNAME|. → Nos vemos, |PLAYERNAME|. (npc.gelidrazahs_thirst.farewell_msg_1)
- See you, |PLAYERNAME|. → Nos vemos, |PLAYERNAME|. (npc.gelidrazahs_thirst.walkaway_msg_1)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **2241**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **2174**

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne:** **10.16%** (283,107/2,786,472)
- **Kopie EN (łącznie):** **173,551**
...
- **Profiler cyklu (ostatni):** cykl #10 (AUTO_TRANSLATE): dispatch 847ms, mode 66414ms, status 4456ms, total 72826ms
...
|-------|--------|----------|----------|------------|
| ES | 37,715/49,731 | 75.8% | 2,584/3,855 | 67.0% |
| PL | 22,018/49,731 | 44.3% | 2,685/3,855 | 69.7% |
| RU | 15,345/49,731 | 30.9% | 2,726/3,855 | 70.7% |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-14T16:16:02.990416Z → 2026-02-14T17:16:02.990416Z) |
...
| Przepustowość (kluczy/h) | **1482.3 kluczy/h** |
| Podejrzane tłumaczenia | **4750** |
| Najgorsze cele (strażnik) | pl/items.json (gf=2133), pl/server.json (gf=327), pl/npc.json (gf=167), pl/quests.json (gf=129), pl/scripts.json (gf=96) |
...
> Świeżość: 7s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-14T17:15:55.881439Z

- **Ostatni audyt:** SLOW_MODE | 41 issue(s) / 100 entries | 2026-02-14T17:15:55.881439Z
- **Top 5 typów problemów:** suspicious_rejected_critical=200, suspicious_log_high=160, suspicious_log_critical=40, identical_to_en=24, identical_to_en_exempt=21
- **Języki o najsłabszej jakości:** es(60.1, issues=167300), pl(60.1, issues=120807), tl(64.2, issues=466), zh_TW(64.8, issues=337), fr(66.5, issues=2470)
...
⚠️ **PL**: jakość 60%, 120807 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 167300 problemów
...
| Heartbeat | 7s temu | 2026-02-14T17:15:56Z |
...
- 2026-02-14 17:15:48 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-14 17:15:39 | AUTO_TRANSLATE:auto_done | pl | ok | server.json
- 2026-02-14 17:14:49 | AUTO_TRANSLATE:heartbeat_tick | pl | ok | server.json
- 2026-02-14 17:14:49 | AUTO_TRANSLATE:auto_start | pl | ok | server.json
- 2026-02-14 17:14:32 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-02-14 17:14:18 | AUTO_TRANSLATE:heartbeat_tick | es | ok | monsters.json
...
|-------|----------|-----------|---------|-----------------|------------|---------|
| 🔴 PL | 46.1% | 0 | 2,062 | 4,062 | 4880 (54.6%) | 96 |
| 🟡 ES | 75.2% | 0 | 2,757 | 2,865 | 1156 (28.7%) | 81 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **71,492** | — | 📊 |
| Adaptacyjna paczka | batch=5, gf_rate=49.26%, reason=decrease_high_fail_rate=49.3% | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 6,927 kluczy / 177 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-14 17:16:02

- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+24) — repair_identical lang=es file=npc.json target_identical=24 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=146.04
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [pl] → warn (files+1, translated+2, skipped+0) — lang=pl file=server.json strict_skipped_done=2572 guard_fail=109 placeholder=5 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+24) — repair_identical lang=es file=npc.json target_identical=24 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=265.20
...
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [pl] → ok (translated+69, skipped+0) — parallel lang=pl file=raids.json
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+1, translated+18, skipped+0) — lang=es file=scripts.json strict_skipped_done=2145 guard_fail=77 placeholder=0 command=0 pipe=0
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+24) — repair_identical lang=es file=npc.json target_identical=24 limit=108 tier=low_backlog+suspicious_guard domain_cap=260 gt=true suspicious_pct=69.85
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **40,068** kluczy |
| ⏭️ Pominięte | 1 |
| 🔁 Cykli | 49 |
| ❌ Błędów | 514 |
| 🌍 Aktywnych języków | 52 |
| 🏆 TOP 5 | **ES** (11,677), **PL** (5,228), **IT** (971), **PT** (960), **DE** (890) |
| 📊 Porównanie | ↓ 13.0% vs wczoraj (46,073) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **87,490** kluczy
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-14 17:16:02  
