...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.83% / real 10.74%**. Tempo: **798.0 kluczy/h**. Tłumaczeń netto: **133,952**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-28 18:56:54

> **Aktualizacja:** 2026-04-28 18:56:54 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #16,916 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: server.json | Heartbeat: 2026-04-28T18:55:12Z
> **Okno godzinowe:** okno=1.0h | cykli=82 | pominięte=0.0% | odrzucone=3.5% | przepustowość=798.0/h  
> **Tłumaczeń netto:** 133,952

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-28 18:56:54 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-28T18:55:12Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 54s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-28 18:56:54 |
| TRANSLATION | 🟢 AKTYWNY | 24s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-28T18:56:35.001933Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-28T18:55:12.146938Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-28 18:56:54 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-28T18:56:59.628393Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-28T18:55:12Z
...
| 🧠 **Detail** | translated=22 guard_fail=0 strict_missing_key=0 strict_skipped_done=405 |
| 🔑 **Current key** | `es:server.json` |
| 🔄 **Ostatni cykl** | 22 kluczy, 0 odrzuconych, 68.0s, tryb: AUTO_TRANSLATE, cel: es/items.json |
| ❤️ **Heartbeat** | 2026-04-28T18:55:12Z |
...
| ⏳ Oldest pending (visible tail) | 13938 s |
...
| 🌍 Recent provider mix | TM/simple(342), Free Google Translate(195), OpenAI model pool(21), canonical_name_semantic_autofix(9), term... |
...
| ❤️ Pool health | `critical` (writes=572, fallbacks=24) |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 397, 'oldest_s': 13938}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~156 dni (2,990,860 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 78.4% | 58,449/74,536 | ~15h |
| PL | ██████████████░░░░░░ | 71.0% | 52,911/74,536 | ~22h |
| IT | █████████████░░░░░░░ | 68.2% | 50,857/74,536 | ~25h |
| RO | █████████████░░░░░░░ | 69.3% | 51,648/74,536 | ~24h |
...
> Świeżość: 54s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-28 18:56:54
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 24s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-28T18:56:35.001933Z
...
- sparkling gems → gems chispeante (item.1024.name)
- stone wall → muro de piedra (item.10284.name)
- stone wall → muro de piedra (item.10285.name)
- earth → tierra (item.1031.name)
- earth → tierra (item.1032.name)
- earth → tierra (item.1040.name)
- withered plants → plantas marchitas (item.10348.name)
- withered plants → plantas marchitas (item.10349.name)
- withered plants → plantas marchitas (item.10350.name)
- withered plants → plantas marchitas (item.10351.name)
...
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-28T18:55:28.495371Z |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=24.08h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-28T17:56:54.421373Z → 2026-04-28T18:56:54.421373Z) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-28T18:55:12.146938Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-28T18:55:12.146938Z
- **Top 5 typów problemów:** suspicious_rejected_critical=188, suspicious_log_low=117, suspicious_log_high=73, suspicious_rejected_high=12, suspicious_log_critical=9
- **Języki o najsłabszej jakości:** es(60.1, issues=718357), de(60.1, issues=100674), nl(60.1, issues=68701), fr(60.1, issues=60621), pt(60.1, issues=55271)
...
⚠️ **TR**: jakość 62%, 51032 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 718357 problemów
⚠️ **PT**: jakość 60%, 55271 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 67%, 165468 problemów
⚠️ **RU**: jakość 62%, 352267 problemów
⚠️ **NL**: jakość 60%, 68701 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #16,916 |
| Heartbeat | 107s temu | 2026-04-28T18:55:12Z |
...
- 2026-04-28 18:55:29 | AUTO_TRANSLATE:auto_start | es | ok | items.json
- 2026-04-28 18:55:10 | AUTO_TRANSLATE:auto_done | ro | ok | items.json
...
|-----|---------|--------|--------|
| Tłumaczeń netto | **133,952** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=4.24%, reason=increase_low_fail_rate=4.2%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-28 18:56:54
...
| 🔄 Cykli wykonanych | **#16,916** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #16,916 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-28 18:56:54  
