...
> Worker tłumaczy **53** języków. Klucze EN: **74,308**. Pokrycie globalne: **9.03%**. Tempo: **867.8 kluczy/h**. Tłumaczeń netto: **122,262**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-02-25 18:58:48

> **Aktualizacja:** 2026-02-25 18:58:48 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74308  
> **LIVE:** Cykl #8,959 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: pt | Plik: monsters.json | Heartbeat: 2026-02-25T18:57:46Z  
> **Okno godzinowe:** okno=1.0h | cykli=4 | pominięte=0.0% | odrzucone=4.8% | przepustowość=867.8/h  
> **Tłumaczeń netto:** 122,262

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-02-25 18:58:48 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-02-25T18:57:46Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 20h temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-02-25 18:58:48 |
| TRANSLATION | 🟢 AKTYWNY | 4min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-02-25T18:54:41.752178Z |
| QUALITY | 🔒 NIEAKTYWNY | 15min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-02-25T18:43:20.917936Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-02-25 18:58:48 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-02-25T18:57:46Z
...
| ❤️ **Heartbeat** | 2026-02-25T18:57:46Z |
...
> **ETA globalne:** ~159 dni (3,321,893 kluczy do celu 95%)
...
> Świeżość: 20h temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-02-25 18:58:48
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 4min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-02-25T18:54:41.752178Z
...
- Gnarr. → Gnarr. (monster.ice_golem.voice_3)
- Error. LOAD 'PROGRAM',8,1 → Fehler. LADE 'PROGRAM',8,1 (monster.golden_servant.voice_1)
- Remain. Obedient. → Bleiben. Gehorsam. (monster.golden_servant.voice_2)
- Hunger! → Hunger! (monster.goggle_cake.voice_3)
- Ribbit! → Ribbit! (monster.green_frog.voice_1)
- Chrrch! → Chrrch! (monster.salamander.voice_1)
- Ribbit! → Ribbit! (monster.infernal_frog.voice_1)
- No Kisses for you! → Keine Küsse für dich! (monster.infernal_frog.voice_3)
- Ribbit! → Ribbit! (monster.orchid_frog.voice_1)
- Ribbit! → Ribbit! (monster.azure_frog.voice_1)
- Ribbit! → Ribbit! (monster.bog_frog.voice_1)
- waddle waddle → watscheln watscheln (monster.makara.voice_1)
- Nihahaha! → Nihahaha! (monster.makara.voice_2)
- Ribbit! → Ribbit! (monster.crimson_frog.voice_1)
- Ribbit! → Ribbit! (monster.toad.voice_2)
- Ribbit! → Ribbit! (monster.coral_frog.voice_1)
- Blubb → Blubb (monster.squidgy_slime.voice_1)
- *Bruaarrr!* → *Bruaarrr!* (monster.devourer.voice_2)
- Blubb → Blubb (monster.slime.voice_1)
- Crackle → Knistern (monster.mercury_blob.voice_1)
...
- **Pokrycie globalne:** **9.03%** (348,891/3,864,016)
- **Kopie EN (łącznie):** **170,786**
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-02-25T17:58:48.816015Z → 2026-02-25T18:58:48.816015Z) |
...
| Najgorsze cele (strażnik) | it/monsters.json (gf=112), fr/monsters.json (gf=44), de/monsters.json (gf=16) |
...
> Świeżość: 15min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-02-25T18:43:20.917936Z
...
| Heartbeat | 63s temu | 2026-02-25T18:57:46Z |
...
- 2026-02-25 18:57:46 | AUTO_TRANSLATE:heartbeat_tick | pt | ok | monsters.json
- 2026-02-25 18:56:16 | AUTO_TRANSLATE:heartbeat_tick | pt | ok | monsters.json
- 2026-02-25 18:54:45 | AUTO_TRANSLATE:heartbeat_tick | pt | ok | monsters.json
- 2026-02-25 18:54:45 | AUTO_TRANSLATE:parallel_start | pt | ok | monsters.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-02-25 18:58:48
...
📅 Auto-updated by Worker v1.1 | Last: 2026-02-25 18:58:48  
