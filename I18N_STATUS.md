...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.01% / real 8.93%**. Tempo: **2235.0 kluczy/h**. Tłumaczeń netto: **74,489**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-03-29 06:09:28

> **Aktualizacja:** 2026-03-29 06:09:28 UTC  
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536  
> **Publikacja:** git-enabled  
> **LIVE:** Cykl #11,333 | Status: ✅ BEZCZYNNY | Faza: IDLE | Etap: cycle_start | Kategoria: - | Plik: - | Heartbeat: 2026-03-29T06:09:20Z  
> **Okno godzinowe:** okno=1.0h | cykli=135 | pominięte=0.0% | odrzucone=16.3% | przepustowość=2235.0/h  
> **Tłumaczeń netto:** 74,489

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-03-29 06:09:28 |
| LIVE | 🟢 AKTYWNY | 10s temu | - | `activity.json / worker_state.json` | 2026-03-29T06:09:20Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 49s temu | worker w trybie IDLE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-03-29 06:09:28 |
| TRANSLATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie IDLE | `translation_guard_latest.json / translation_recent_latest.json` | 2026-03-29T06:08:23.358824Z |
| QUALITY | 🔒 NIEAKTYWNY | 27s temu | worker w trybie IDLE | `quality_audit_latest.json` | 2026-03-29T06:09:02.408409Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-03-29 06:09:28 |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 10s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-03-29T06:09:20Z
...
| ❤️ **Heartbeat** | 2026-03-29T06:09:20Z |
...
| 🔁 Cykli | 135 |
| 🌍 Języków | 11 |
| 🏆 Najaktywniejszy | IT (1,343 kluczy) |
| 📄 Najczęstszy plik | html.json |
| ⚡ Przepustowość | ~2235 kluczy/h |
| 🛡️ Odrzucone (strażnik) | 16.3% |
| ⚠️ Podejrzane | 1171 |
...
| RU | 31,087 | 74,536 | 41.71% ↓-31.73% | 5,302 |
...
> Tempo obliczone na bazie ostatniej godziny: ~2235 kluczy/h.
...
> Świeżość: 49s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-03-29 06:09:28
...
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-03-29T06:08:23.358824Z
...
- Raporty strażnika jakości: **3202**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **3060**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 279 | 1 | 41,082 | - | 2026-03-29T06:09:30.013355Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.01%** (698,232/3,875,872)
- **Pokrycie globalne (real):** **8.93%** (346,303/3,875,872)
- **Kopie EN (łącznie):** **522,174**
- **Placeholdery [EN]/puste (łącznie):** **2,112,271**
...
- **Profiler cyklu (ostatni):** cykl #75 (AUTO_TRANSLATE): dispatch 783ms, mode 61525ms, status 42ms, total 63516ms
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-03-29T05:09:28.563936Z → 2026-03-29T06:09:28.563936Z) |
| Cykle | **135** (TŁUMACZENIE=119, PRE_MIGRATION=0) |
| Pominięte (kat. nieaktywna) | **0** (ogółem=0.0%, migracja=0.0%) |
| Odrzucone (strażnik jakości) % | **16.3%** |
| Cykle bez postępu % | **23.3%** |
| Przepustowość (kluczy/h) | **2235.0 kluczy/h** |
| Podejrzane tłumaczenia | **1171** |
| Najgorsze cele (strażnik) | pl/monsters.json (gf=113), ru/html.json (gf=107), es/monsters.json (gf=25), fr/html.json (gf=24), ro/html.json (gf=19) |
...
|--------|-----------|--------|----------------|
| `gt_rejected_critical` | 167 | 40.1% | pl/monsters.json (52) |
| `gt_validate_fail_wrong_script` | 68 | 16.3% | ru/html.json (66) |
| `gt_validate_fail_word_salad` | 63 | 15.1% | pl/monsters.json (21) |
| `gt_rejected_high_partial_translation_mix` | 46 | 11.1% | pl/monsters.json (11) |
| `gt_validate_fail_placeholder` | 22 | 5.3% | ru/html.json (18) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie IDLE)  
> Świeżość: 27s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-03-29T06:09:02.408409Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-03-29T06:09:02.408409Z
- **Top 5 typów problemów:** suspicious_log_high=177, suspicious_rejected_critical=135, suspicious_rejected_high=65, suspicious_log_critical=10, suspicious_log_low=7
- **Języki o najsłabszej jakości:** es(60.1, issues=648981), pl(60.1, issues=336008), nl(63.5, issues=17756), az(70.3, issues=1417), et(70.4, issues=672)
...
⚠️ **TR**: jakość 95%, 9022 problemów
⚠️ **PL**: jakość 60%, 336008 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 648981 problemów
⚠️ **PT**: jakość 85%, 25154 problemów
⚠️ **FR**: jakość 86%, 23926 problemów
⚠️ **IT**: jakość 74%, 118592 problemów
⚠️ **RU**: jakość 75%, 300696 problemów
⚠️ **NL**: jakość 64%, 17756 problemów
...
|-----------|--------|-----------|
| Worker | ✅ BEZCZYNNY | Cykl #11,333 |
| Heartbeat | 10s temu | 2026-03-29T06:09:20Z |
...
- 2026-03-29 06:08:37 | AUTO_TRANSLATE:heartbeat_tick | es | ok | monsters.json
- 2026-03-29 06:08:23 | AUTO_TRANSLATE:auto_done | ru | ok | monsters.json
- 2026-03-29 06:08:14 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | monsters.json
- 2026-03-29 06:08:13 | AUTO_TRANSLATE:auto_start | ru | ok | monsters.json
- 2026-03-29 06:08:07 | AUTO_TRANSLATE:auto_done | tr | ok | items.json
- 2026-03-29 06:07:10 | AUTO_TRANSLATE:heartbeat_tick | tr | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-03-29 06:09:28
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **5,970** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 59 |
| ❌ Błędów | 100 |
| 🌍 Aktywnych języków | 11 |
| 🏆 TOP 5 | **IT** (1,409), **NL** (922), **CS** (900), **RO** (897), **FR** (757) |
| 📊 Porównanie | brak danych z wczoraj |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **54,337** kluczy
...
| 🔄 Cykli wykonanych | **#11,333** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #11,333 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-03-29 06:09:28  
