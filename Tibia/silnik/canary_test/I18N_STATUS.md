...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.95% / real 10.87%**. Tempo: **915.0 kluczy/h**. Tłumaczeń netto: **141,653**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 04:15:53

> **Aktualizacja:** 2026-04-29 04:15:53 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,692 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: es | Plik: npc.json | Heartbeat: 2026-04-29T04:14:14Z
> **Okno godzinowe:** okno=1.0h | cykli=88 | pominięte=0.0% | odrzucone=3.6% | przepustowość=915.0/h  
> **Tłumaczeń netto:** 141,653

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 04:15:53 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T04:14:14Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 04:15:53 |
| TRANSLATION | 🟢 AKTYWNY | 21s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T04:15:37.786753Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T04:14:13.687955Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 04:15:53 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T04:15:59.759314Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T04:14:14Z
...
| 🧠 **Detail** | translated=30 guard_fail=1 strict_missing_key=0 strict_skipped_done=2903 |
| 🔑 **Current key** | `es:npc.json` |
| 🔄 **Ostatni cykl** | 30 kluczy, 1 odrzuconych, 68.0s, tryb: AUTO_TRANSLATE, cel: ru/items.json |
| ❤️ **Heartbeat** | 2026-04-29T04:14:14Z |
...
| ⏳ Oldest pending (visible tail) | 16974 s |
| 🌍 Top języki | RU(400) |
...
| 🌍 Recent provider mix | TM/simple(338), Free Google Translate(166), canonical_name_semantic_autofix(15), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=522, fallbacks=8) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=632/632 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 400, 'oldest_s': 16974}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> Świeżość: 1min temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 04:15:53
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 21s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T04:15:37.786753Z
...
- moist wall → мойст стена (item.13113.name)
- moist wall → мойст стена (item.13114.name)
- moist wall → мойст стена (item.13115.name)
- moist wall → мойст стена (item.13116.name)
- moist wall → мойст стена (item.13117.name)
- moist wall → мойст стена (item.13118.name)
- moist wall → мойст стена (item.13119.name)
- sandstone wall → песчаниковая стена (item.1312.name)
- moist wall → мойст стена (item.13120.name)
- moist wall → мойст стена (item.13121.name)
- stone pillar → каменный колонна (item.13122.name)
- stone pillar → каменный колонна (item.13123.name)
- stone pillar → каменный колонна (item.13124.name)
- archway → арка (item.13125.name)
- archway → арка (item.13126.name)
- archway → арка (item.13127.name)
- archway → арка (item.13128.name)
- archway → арка (item.13129.name)
- sandstone wall → песчаниковая стена (item.1313.name)
- archway → арка (item.13130.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4771**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4624**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T04:14:30.300504Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **17.95%** (695,899/3,875,872)
- **Pokrycie globalne (real):** **10.87%** (421,453/3,875,872)
- **Kopie EN (łącznie):** **410,533**
- **Placeholdery [EN]/puste (łącznie):** **2,189,764**
...
| 🕒 Evidence window | 24h (span=33.39h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=33.39h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T03:15:54.339054Z → 2026-04-29T04:15:54.339054Z) |
...
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T04:14:13.687955Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T04:14:13.687955Z
...
- **Języki o najsłabszej jakości:** es(60.1, issues=732698), ro(60.1, issues=431509), de(60.1, issues=114479), cs(60.1, issues=92416), fr(60.1, issues=60621)
...
⚠️ **TR**: jakość 64%, 54333 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 732698 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 66%, 172227 problemów
⚠️ **RU**: jakość 70%, 362844 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,692 |
| Heartbeat | 105s temu | 2026-04-29T04:14:14Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T04:15:54.527503Z
...
- 2026-04-29 04:15:55 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
- 2026-04-29 04:15:38 | AUTO_TRANSLATE:auto_done | ru | ok | items.json
- 2026-04-29 04:14:31 | AUTO_TRANSLATE:heartbeat_tick | ru | ok | items.json
- 2026-04-29 04:14:30 | AUTO_TRANSLATE:auto_start | ru | ok | items.json
- 2026-04-29 04:14:12 | AUTO_TRANSLATE:auto_done | tr | ok | items.json
- 2026-04-29 04:13:21 | AUTO_TRANSLATE:heartbeat_tick | tr | ok | items.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 04:15:53
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **3,731** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 82 |
| ❌ Błędów | 150 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **RU** (724), **CS** (651), **IT** (628), **DE** (495), **TR** (460) |
| 📊 Porównanie | ↓ 54.7% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **22,711** kluczy
...
| 🔄 Cykli wykonanych | **#17,692** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,692 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 04:15:53  
