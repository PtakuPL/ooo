...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 18.04% / real 10.97%**. Tempo: **663.0 kluczy/h**. Tłumaczeń netto: **148,234**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 13:14:32

> **Aktualizacja:** 2026-04-29 13:14:32 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #18,452 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: heartbeat_tick | Kategoria: tr | Plik: items.json | Heartbeat: 2026-04-29T13:13:33Z
> **Okno godzinowe:** okno=1.0h | cykli=84 | pominięte=0.0% | odrzucone=5.8% | przepustowość=663.0/h  
> **Tłumaczeń netto:** 148,234

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 13:14:32 |
| LIVE | 🟢 AKTYWNY | 1min temu | - | `activity.json / worker_state.json` | 2026-04-29T13:13:33Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 42s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 13:14:32 |
| TRANSLATION | 🟢 AKTYWNY | 1min temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T13:13:31.368431Z |
| QUALITY | 🔒 NIEAKTYWNY | 1min temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T13:13:32.477619Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 13:14:32 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T13:14:39.786431Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T13:13:33Z
...
| ❤️ **Heartbeat** | 2026-04-29T13:13:33Z |
...
|----------|------|---------|------|-------|--------|------------|--------|
| 13:13:26 | DE | Serwer | npc.json | 30 | `tm` | `npc.a_dead_bureaucrat1.say_1` | Klar, wo sonst. Jeder trifft gerne meinen Meister, er ist ein großer Dämon, nicht wah... |
| 13:12:15 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 13:09:08 | DE | Klient | otclient_modules.json | 15 | `tm` | `otclient_modules.blessing.tr_11` | - Abhängig von den Regeln des fairen Kampfes verlierst du zwischendurch |
| 13:08:20 | ES | Serwer | items.json | 19 | `simple` | `item.12086.name` | pastel gigante |
| 13:06:31 | ES | Serwer | server.json | 1 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 13:04:29 | IT | Serwer | items.json | 30 | `simple` | `item.1428.name` | muro ornato |
| 13:02:17 | RO | Serwer | items.json | 39 | `google_translate` | `item.10216.name` | kit statuie dragon |
| 13:00:32 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 12:57:10 | CS | Serwer | items.json | 41 | `simple` | `item.14725.name` | REZERVOVANÝ SPRITE |
| 12:55:21 | RU | Serwer | items.json | 30 | `simple` | `item.1451.name` | каменный стена |
| 12:53:25 | ES | Serwer | server.json | 1 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 12:51:28 | TR | Serwer | items.json | 53 | `google_translate` | `item.1264.name` | tic-tac-toe tahtası |
| 12:50:10 | DE | Serwer | npc.json | 30 | `tm` | `npc.a_dead_bureaucrat1.say_1` | Klar, wo sonst. Jeder trifft gerne meinen Meister, er ist ein großer Dämon, nicht wah... |
| 12:49:15 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
| 12:46:08 | DE | Klient | otclient_modules.json | 15 | `tm` | `otclient_modules.blessing.tr_11` | - Abhängig von den Regeln des fairen Kampfes verlierst du zwischendurch |
| 12:45:20 | ES | Serwer | items.json | 19 | `simple` | `item.1206.name` | techo de pasto seco |
| 12:43:39 | ES | Serwer | server.json | 1 | `google_translate` | `data.otservbr.global.npc.noodles.L105.679` | <sniff> ¡Guau! <sniff> |
| 12:41:30 | IT | Serwer | items.json | 42 | `simple` | `item.14263.name` | SPRITE RISERVATO |
| 12:39:30 | RO | Serwer | items.json | 39 | `google_translate` | `item.10216.name` | kit statuie dragon |
| 12:37:28 | ES | Serwer | npc.json | 4 | `tm` | `npc.barnabas_dee.say_5` | No no no, necesito 15 dosis de polen recién cosechado! Por favor, coseche esas 15 dos... |
...
|----------|------|---------|-----------|-------|----------|--------------|-----|
| 13:13:20 | DE | Serwer | npc.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `npc.a_fluffy_squirrel.stdmod_1` |
| 13:11:11 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.say_1` |
| 13:11:09 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.multi_1` |
| 13:09:04 | DE | Klient | otclient_modules.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `otclient_modules.charms.tr_34` |
| 13:03:51 | IT | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 13:01:39 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10193.name` |
| 13:01:37 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10192.name` |
| 13:01:35 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10191.name` |
| 13:01:33 | RO | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10190.name` |
| 12:59:21 | ES | Serwer | npc.json | `hard_block` | `critical_issue` | `garble_en_chunk` | `npc.broken_servant_sentry.say_2` |
| 12:56:38 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.14670.name` |
| 12:56:37 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.14250.name` |
| 12:56:35 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.14077.name` |
| 12:56:33 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.14023.name` |
| 12:56:32 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.11586.name` |
| 12:56:30 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.1069.name` |
| 12:56:29 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10456.name` |
| 12:56:27 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10338.name` |
| 12:56:25 | CS | Serwer | items.json | `hard_block` | `validate_identical_to_en` | `identical_to_en` | `item.10026.name` |
| 12:54:43 | RU | Serwer | items.json | `hard_block` | `high_reject_types` | `mixed_scripts` | `item.11541.name` |
...
| 📨 Pending queue (visible tail) | 395 z ostatnich 400 poprawnych wpisów JSONL |
| ⏳ Oldest pending (visible tail) | 17720 s |
| 🌍 Top języki | RU(394), CS(1) |
| 🧱 Top reason_bucket | quality(394), default(1) |
| 🗂️ Deferred state keys | 8496 |
...
| 🧮 OpenAI budget | `201/250 stale:2026-04-28 15 h` |
| ♻️ Provider debt | `1246` |
| 🌍 Recent provider mix | TM/simple(329), Free Google Translate(151), canonical_name_semantic_autofix(18), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=501, fallbacks=19) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=1049/1049 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 395, 'oldest_s': 17720}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~187 dni (2,982,708 kluczy do celu 95%)

| Język | Pasek | Pokrycie | Przetłumaczono | ETA do 95% |
|-------|-------|----------|---------------|------------|
| ES | ███████████████░░░░░ | 79.2% | 59,025/74,536 | ~18h |
| PL | ██████████████░░░░░░ | 71.0% | 52,911/74,536 | ~27h |
| IT | ██████████████░░░░░░ | 71.2% | 53,106/74,536 | ~27h |
| RO | █████████████░░░░░░░ | 69.7% | 51,972/74,536 | ~28h |
| RU | █████████░░░░░░░░░░░ | 46.1% | 34,384/74,536 | ~2d |
| FR | ███████████░░░░░░░░░ | 57.5% | 42,864/74,536 | ~42h |
| CS | ██████████░░░░░░░░░░ | 51.1% | 38,078/74,536 | ~2d |
| PT | ████████████████░░░░ | 81.2% | 60,516/74,536 | ~16h |
| SR | ██████░░░░░░░░░░░░░░ | 33.3% | 24,827/74,536 | ~3d |
| NL | ███████████████░░░░░ | 77.6% | 57,814/74,536 | ~20h |
| TR | ███████░░░░░░░░░░░░░ | 35.2% | 26,213/74,536 | ~3d |
...
> Tempo obliczone na bazie ostatniej godziny: ~663 kluczy/h.
...
> Świeżość: 42s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 13:14:32
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 1min temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T13:13:31.368431Z
...
|-------|-----------|--------|----------|--------------|--------------|
| ES (Hiszpański) | 79.19% (59,025/74,536) | 68.18% (50,822/74,536) | 9,592 | 14,146 | 0 |
| PL (Polski) | 70.99% (52,911/74,536) | 65.08% (48,507/74,536) | 5,861 | 20,194 | 0 |
| IT (Włoski) | 71.25% (53,106/74,536) | 63.03% (46,980/74,536) | 10,030 | 17,551 | 0 |
| RO (Rumuński) | 69.73% (51,972/74,536) | 56.69% (42,253/74,536) | 13,005 | 19,303 | 0 |
| RU (Rosyjski) | 46.13% (34,384/74,536) | 44.56% (33,214/74,536) | 4,775 | 36,565 | 0 |
| FR (Francuski) | 57.51% (42,864/74,536) | 41.87% (31,206/74,536) | 26,153 | 17,199 | 0 |
| CS (Czeski) | 51.09% (38,078/74,536) | 33.36% (24,863/74,536) | 29,827 | 19,872 | 0 |
...
| TR (Turecki) | 35.17% (26,213/74,536) | 31.68% (23,616/74,536) | 3,832 | 47,102 | 0 |
...
- Raporty strażnika jakości: **4960**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4813**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T13:13:51.160424Z |

### 🌐 Globalne info wszystkich języków
- **Pokrycie globalne (nominal):** **18.04%** (699,360/3,875,872)
- **Pokrycie globalne (real):** **10.97%** (425,086/3,875,872)
- **Kopie EN (łącznie):** **410,361**
- **Placeholdery [EN]/puste (łącznie):** **2,186,303**
...
|-------|--------|--------------------------|----------|----------------------------|
| ES | 55,865/70,637 | 79.1% / 67.6% | 3,160/3,899 | 81.0% / 79.2% |
| PL | 49,763/70,637 | 70.5% / 64.3% | 3,148/3,899 | 80.7% / 78.4% |
| IT | 50,133/70,637 | 71.0% / 62.5% | 2,973/3,899 | 76.2% / 73.1% |
| RO | 49,186/70,637 | 69.6% / 56.0% | 2,786/3,899 | 71.5% / 69.6% |
| RU | 31,240/70,637 | 44.2% / 42.6% | 3,144/3,899 | 80.6% / 79.3% |
| FR | 39,937/70,637 | 56.5% / 40.1% | 2,927/3,899 | 75.1% / 73.7% |
| CS | 36,388/70,637 | 51.5% / 33.0% | 1,690/3,899 | 43.3% / 39.0% |
...
| TR | 24,254/70,637 | 34.3% / 30.7% | 1,959/3,899 | 50.2% / 48.7% |
...
| 🕒 Evidence window | 24h (span=42.37h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=42.37h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T12:14:33.276568Z → 2026-04-29T13:14:33.276568Z) |
...
| Przepustowość (kluczy/h) | **663.0 kluczy/h** |
| Podejrzane tłumaczenia | **1066** |
...
|--------|-----------|--------|----------------|
| `existing_canonical_name_quality_cyrillic_latin_mix` | 61 | 93.8% | ru/items.json (61) |
| `existing_canonical_name_quality_mixed_scripts` | 3 | 4.6% | ru/items.json (3) |
| `gt_validate_fail_identical_to_en` | 1 | 1.5% | cs/items.json (1) |

## 🔬 JAKOŚĆ TŁUMACZEŃ

> **[QUALITY]** 🔒 NIEAKTYWNY (worker w trybie AUTO_TRANSLATE)  
> Świeżość: 1min temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T13:13:32.477619Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T13:13:32.477619Z
- **Top 5 typów problemów:** suspicious_rejected_critical=190, suspicious_log_medium=91, suspicious_log_high=59, suspicious_log_low=49, suspicious_rejected_high=10
- **Języki o najsłabszej jakości:** es(60.1, issues=748802), ro(60.1, issues=443350), de(60.1, issues=125877), cs(60.1, issues=116446), fr(60.1, issues=60621)
- **Pliki:** `i18n/status/quality_audit_latest.json`, `i18n/status/quality_dashboard.json`, `i18n/status/quality_report.jsonl`

### 📈 Statystyki Pracy
| Metryka | Wartość | Info |
|---------|---------|------|
| 🔄 Cykl aktualny | **#215** | od uruchomienia |
...
⚠️ **TR**: jakość 63%, 58100 problemów
⚠️ **PL**: jakość 65%, 389619 problemów
⚠️ **AZ**: jakość 70%, 1417 problemów
⚠️ **ES**: jakość 60%, 748802 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 62%, 178459 problemów
⚠️ **RU**: jakość 71%, 373082 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #18,452 |
| Heartbeat | 66s temu | 2026-04-29T13:13:33Z |
...
- **Ostatnia aktualizacja:** 2026-04-29T13:09:28.250575Z
...
- 2026-04-29 13:13:52 | AUTO_TRANSLATE:heartbeat_tick | tr | ok | items.json
- 2026-04-29 13:13:52 | AUTO_TRANSLATE:auto_start | tr | ok | items.json
- 2026-04-29 13:13:31 | AUTO_TRANSLATE:auto_done | de | ok | npc.json
- 2026-04-29 13:13:06 | AUTO_TRANSLATE:heartbeat_tick | de | ok | npc.json
- 2026-04-29 13:13:06 | AUTO_TRANSLATE:auto_start | de | ok | npc.json
- 2026-04-29 13:10:59 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
| 🟡 ES | 79.2% | 0 | 9,592 | 540 | 0 (0.0%) | 25 |

| Wskaźnik | Wartość | Cel | Status |
|-----|---------|--------|--------|
| Tłumaczeń netto | **148,234** | — | 📊 |
| Adaptacyjna paczka | batch=50, gf_rate=5.92%, reason=stable_fail_rate=5.9%, filter=exclude_repair | odrzucenia <5% → zwiększ | 📊 |
| Przepustowość (okno) | 540 kluczy / 25 wpisów | >50/h | 📊 |
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 13:14:32
...
- 🤖 AUTO_TRANSLATE: REPAIR_IDENTICAL_DONE [es] → ok (translated+0) — repair_identical lang=es file=otclient_modules.json target_identical=37 limit=180 tier=low_backlog domain_cap=220 gt=true suspicious_pct=0.93
...
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [fr] → warn (files+1, translated+14, skipped+0) — lang=fr file=raids.json strict_skipped_done=126
- 🤖 AUTO_TRANSLATE: AUTO_TRANSLATE_DONE [es] → warn (files+0, translated+0, skipped+0) — lang=es file=items.json strict_skipped_done=1005
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ro] → ok (translated+11, skipped+0) — parallel lang=ro file=npc.json
- 🤖 AUTO_TRANSLATE: PARALLEL_TRANSLATE_DONE [ru] → ok (translated+30, skipped+0) — parallel lang=ru file=npc.json
...
| Metryka | Wartość |
|---------|---------|
| ✅ Przetłumaczono | **10,943** kluczy |
| ⏭️ Pominięte | 0 |
| 🔁 Cykli | 214 |
| ❌ Błędów | 481 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (1,894), **RU** (1,749), **TR** (1,670), **IT** (1,603), **DE** (1,575) |
| 📊 Porównanie | ↑ 33.0% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **29,923** kluczy
...
| 🔄 Cykli wykonanych | **#18,452** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #18,452 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 13:14:32  
