...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "Hooooot-Toooooot!", yell = false , i18nKey = "monster.elephant.voice_1"},
	{ text = "Tooooot!", yell = false , i18nKey = "monster.elephant.voice_2"},
	{ text = "Trooooot!", yell = false , i18nKey = "monster.elephant.voice_3"},
}
