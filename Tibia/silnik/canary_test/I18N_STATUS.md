...
> Worker tłumaczy **53** języków. Klucze EN: **74,536**. Pokrycie globalne: **nominal 17.92% / real 10.83%**. Tempo: **896.0 kluczy/h**. Tłumaczeń netto: **139,047**.

## 🧭 META

> **[META]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `update_github_status()` | Ostatnia aktualizacja: 2026-04-29 01:00:15

> **Aktualizacja:** 2026-04-29 01:00:15 UTC
> **Worker:** v1.1 Simple | **Guardian:** v2.0 | **Języki:** 53 | **Klucze EN:** 74536
> **Publikacja:** git-enabled
> **LIVE:** Cykl #17,428 | Status: 🟢 DZIAŁA | Faza: AUTO_TRANSLATE | Etap: auto_start | Kategoria: es | Plik: items.json | Heartbeat: 2026-04-29T00:59:39Z
> **Okno godzinowe:** okno=1.0h | cykli=72 | pominięte=0.0% | odrzucone=3.3% | przepustowość=896.0/h  
> **Tłumaczeń netto:** 139,047

### 🧩 Status sekcji
| Sekcja | Stan | Świeżość | Powód | Źródło | Ostatnia aktualizacja |
|--------|------|----------|-------|--------|-----------------------|
| META | 🟢 AKTYWNY | teraz | - | `update_github_status()` | 2026-04-29 01:00:15 |
| LIVE | 🟢 AKTYWNY | 43s temu | - | `activity.json / worker_state.json` | 2026-04-29T00:59:39Z |
| PRE_MIGRATION | 🔒 NIEAKTYWNY | 22s temu | worker w trybie AUTO_TRANSLATE | `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | 2026-04-29 01:00:15 |
| TRANSLATION | 🟢 AKTYWNY | 44s temu | - | `translation_guard_latest.json / translation_recent_latest.json` | 2026-04-29T00:59:37.943255Z |
| QUALITY | 🔒 NIEAKTYWNY | 43s temu | worker w trybie AUTO_TRANSLATE | `quality_audit_latest.json` | 2026-04-29T00:59:39.037126Z |
| HISTORY | 🟢 AKTYWNY | teraz | - | `daily/*.json / ops.jsonl` | 2026-04-29 01:00:15 |
| DOCTOR | 🟠 AKTYWNY | 0s temu | 1 alarmów | `doctor_alerts_latest.json` | 2026-04-29T01:00:22.625409Z |
...
> **[LIVE]** 🟢 AKTYWNY  
> Świeżość: 43s temu | Źródło: `activity.json / worker_state.json` | Ostatnia aktualizacja: 2026-04-29T00:59:39Z
...
| 🔄 **Ostatni cykl** | 39 kluczy, 4 odrzuconych, 184.0s, tryb: AUTO_TRANSLATE, cel: ro/items.json |
| ❤️ **Heartbeat** | 2026-04-29T00:59:39Z |
...
| ⏳ Oldest pending (visible tail) | 17295 s |
...
| 🌍 Recent provider mix | Free Google Translate(241), TM/simple(238), canonical_name_semantic_autofix(18), term_consistency_autofix(3) |
...
| ❤️ Pool health | `critical` (writes=500, fallbacks=15) |
...
| 🚫 Failing langs | - |
| 📈 Trend 24h | pass=483/483 (100.00%), fail=0, Δchecks=+0, dir=stable |
...
| `QUEUE_STARVATION` | ALERT | WARNING | `{'pending': 396, 'oldest_s': 17295}` | `{'pending_min': 200, 'oldest_s': 3600}` | Duży pending i stara kolejka sugerują głodzenie queue. |
...
> **ETA globalne:** ~139 dni (2,987,666 kluczy do celu 95%)
...
> Świeżość: 22s temu | Źródło: `i18n/en/*.json (LIVE) + i18n_file_status.json + i18n_processed_files.txt` | Ostatnia aktualizacja: 2026-04-29 01:00:15
...
> **[TRANSLATION]** 🟢 AKTYWNY  
> Świeżość: 44s temu | Źródło: `translation_guard_latest.json / translation_recent_latest.json` | Ostatnia aktualizacja: 2026-04-29T00:59:37.943255Z
...
- This lamp is glowing very dimly. → Această lampăăăăăăăăăăăăăăăăăăăăăăăă luminează foarte slab. (item.13656.desc)
- This lamp is glowing very dimly. → Această lampăăăăăăăăăăăăăăăăăăăăăăăă luminează foarte slab. (item.13658.desc)
- This is an emblem of wisdom. It was awarded by TibiaStat.com → Aceasta este o emblemăăăăăăăăăăăăăăăăăăăăăăăă a înțelepciunii. A fost acordat de (item.14760.desc)
- lamp → lampă (item.10507.name)
- ramp → rampă (item.11365.name)

### 🚫 Raporty strażnika jakości
- Raporty strażnika jakości: **4703**  
- Raporty blokad: **0**  
- Widoczne raporty 'nie mogę przetłumaczyć': **4556**

### 🧱 Blockers snapshot (strict)
| State | Candidates | Missing files | Missing keys | Reason | Timestamp |
|-------|------------|---------------|--------------|--------|-----------|
| 🟠 active | 96 | 0 | 0 | - | 2026-04-29T01:00:06.876294Z |
...
| 🕒 Evidence window | 24h (span=30.13h) |
...
| Trend 24h `identical_to_en` + `word_salad` | ✅ PASS | window=30.13h; client.json: id=+0.00pp, ws=+0, otclient_modules.json: id=-1.38pp, ws=+0 |
...
| Metryka | Wartość |
|---------|---------|
| Okno | **1.0h** (2026-04-29T00:00:17.397543Z → 2026-04-29T01:00:17.397543Z) |
...
| Przepustowość (kluczy/h) | **896.0 kluczy/h** |
| Podejrzane tłumaczenia | **830** |
| Najgorsze cele (strażnik) | ro/items.json (gf=12), cs/items.json (gf=10), it/items.json (gf=3), de/otclient_modules.json (gf=2), de/npc.json (gf=2) |
...
> Świeżość: 43s temu | Źródło: `quality_audit_latest.json` | Ostatnia aktualizacja: 2026-04-29T00:59:39.037126Z

- **Ostatni audyt:** OK | 0 issue(s) / 100 entries | 2026-04-29T00:59:39.037126Z
- **Top 5 typów problemów:** suspicious_rejected_critical=191, suspicious_log_low=113, suspicious_log_high=86, suspicious_rejected_high=9, suspicious_log_medium=1
- **Języki o najsłabszej jakości:** es(60.1, issues=727485), ro(60.1, issues=426786), de(60.1, issues=110071), cs(60.1, issues=85235), fr(60.1, issues=60621)
...
⚠️ **ES**: jakość 60%, 727485 problemów
⚠️ **PT**: jakość 91%, 57675 problemów
⚠️ **FR**: jakość 60%, 60621 problemów
⚠️ **IT**: jakość 63%, 169449 problemów
⚠️ **RU**: jakość 62%, 359201 problemów
...
|-----------|--------|-----------|
| Worker | 🟢 DZIAŁA | Cykl #17,428 |
| Heartbeat | 43s temu | 2026-04-29T00:59:39Z |
...
- 2026-04-29 01:00:07 | AUTO_TRANSLATE:auto_start | es | ok | items.json
- 2026-04-29 00:59:38 | AUTO_TRANSLATE:auto_done | ro | ok | items.json
- 2026-04-29 00:58:06 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-04-29 00:56:34 | AUTO_TRANSLATE:heartbeat_tick | ro | ok | items.json
- 2026-04-29 00:56:34 | AUTO_TRANSLATE:auto_start | ro | ok | items.json
- 2026-04-29 00:55:25 | AUTO_TRANSLATE:heartbeat_tick | es | ok | npc.json
...
> **[HISTORY]** 🟢 AKTYWNY  
> Świeżość: teraz | Źródło: `daily/*.json / ops.jsonl` | Ostatnia aktualizacja: 2026-04-29 01:00:15
...
| ❌ Błędów | 32 |
| 🌍 Aktywnych języków | 7 |
| 🏆 TOP 5 | **CS** (315), **IT** (127), **RO** (117), **TR** (110), **DE** (90) |
| 📊 Porównanie | ↓ 88.8% vs wczoraj (8,228) |

## 📆 Ten tydzień (7 dni)

> Suma tygodnia: **19,904** kluczy
...
| 🔄 Cykli wykonanych | **#17,428** | continuous mode |
...
| System | Status | Info |
|--------|--------|------|
| Worker v1.1 | 🟢 DZIAŁA | Cykl #17,428 |
...
📅 Auto-updated by Worker v1.1 | Last: 2026-04-29 01:00:15  
