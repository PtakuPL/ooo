...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "Grow truk grrrrr.", yell = false , i18nKey = "monster.dworc_voodoomaster.voice_1"},
	{ text = "Brak brrretz!", yell = false , i18nKey = "monster.dworc_voodoomaster.voice_2"},
	{ text = "Prek tars, dekklep zurk.", yell = false , i18nKey = "monster.dworc_voodoomaster.voice_3"},
}
