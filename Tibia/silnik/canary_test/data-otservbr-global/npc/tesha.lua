...
npcConfig.voices = {
	interval = 15000,
	chance = 50,
	{ i18nKey = "npc.tesha.voice_1", yell = false },
}
...
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_GREET, "npc.tesha.greet_msg_1")
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_FAREWELL, "npc.tesha.farewell_msg_1")
NPC_LIB.i18n.setLocalizedMessage(npcHandler, MESSAGE_WALKAWAY, "npc.tesha.walkaway_msg_1")
